---
title: "Método System::Globalization::CompareInfo::IndexOf"
linktitle: "IndexOf"
second_title: "Referencia de API de Aspose.PDF para C++"
description: "Método System::Globalization::CompareInfo::IndexOf. Busca el carácter especificado en C++."
type: docs
weight: 900
url: /es/cpp/system.globalization/compareinfo/indexof/
---
## CompareInfo::IndexOf(const String\&, char16_t) const method


Busca el carácter especificado.
...
| --- | --- | --- |
| origen | const String\& | Cadena de origen. |
| valor | char16_t | Carácter. |
...
Busca el carácter especificado. Solo se admite el modo ordinal.
...
| origen | const String\& | Cadena de origen. |
| valor | char16_t | Carácter. |
| opciones | CompareOptions | Opciones de búsqueda. |
...
| origen | const String\& | Cadena de origen. |
| valor | char16_t | Carácter. |
| start_index | int | Índice de inicio de búsqueda en la cadena de origen. |
...
| valor | char16_t | Carácter. |
| start_index | int | Índice de inicio de búsqueda en la cadena de origen. |
| count | int | Número de caracteres en la cadena de origen. |
...
| --- | --- | --- |
| origen | const String\& | Cadena de origen. |
| valor | const String\& | Valor de búsqueda. |
...
Busca una subcadena. Solo se admite el modo ordinal.
