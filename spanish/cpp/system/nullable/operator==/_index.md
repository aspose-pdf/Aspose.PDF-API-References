...
description: "System::Nullable::operator== método. Determina si el valor representado por el objeto actual es igual al valor representado por el objeto Nullable especificado en C++."
type: docs
weight: 1900
