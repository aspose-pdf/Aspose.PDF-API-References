...
Cambia la contraseña de usuario y la contraseña del propietario, permite restablecer la seguridad del documento [Pdf](../../../aspose.pdf/) . La nueva contraseña de usuario y la nueva contraseña del propietario pueden ser nulas o vacías. La contraseña del propietario será reemplazada por una cadena aleatoria si la nueva contraseña del propietario es nula o vacía. Hay 6 combinaciones posibles de los valores de [KeySize](../../keysize/) y [Algorithm](../../algorithm/). Sin embargo, ([KeySize.x40](../../keysize/), [Algorithm.AES](../../algorithm/)) y ([KeySize.x256](../../keysize/), [Algorithm.RC4](../../algorithm/)) son inválidas y se lanzará una excepción correspondiente si el kit encuentra esta combinación. Lanza una excepción si el proceso falla.
