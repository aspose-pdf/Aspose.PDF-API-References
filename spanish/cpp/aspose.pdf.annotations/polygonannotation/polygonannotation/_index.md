...
description: "Aspose::Pdf::Annotations::PolygonAnnotation::PolygonAnnotation constructor. Crea una nueva anotación Polygon en la página especificada en C++."
type: docs
weight: 100
url: /es/cpp/aspose.pdf.annotations/polygonannotation/polygonannotation/
---
...
Crea una nueva anotación Polygon en la página especificada.
...
| vértices | const System::ArrayPtr\<System::SharedPtr\<Point\>\>\& | Una matriz de puntos de vértices del polígono. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| document | const System::SharedPtr\<Document\>\& | [Document](../../../aspose.pdf/document/) donde se añadirá la anotación. |
| vértices | const System::ArrayPtr\<System::SharedPtr\<Point\>\>\& | Matriz de puntos. |
