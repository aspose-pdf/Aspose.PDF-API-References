---
title: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import método"
linktitle: "Import"
second_title: "Referencia de API de Aspose.PDF para C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import método. Importa información de los datos de certificado especificados en C++."
type: docs
weight: 2400
...
| --- | --- | --- |
| datos | const ByteArrayPtr\& | El nombre del archivo del certificado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filename | const String\& | El nombre del archivo del certificado. |
