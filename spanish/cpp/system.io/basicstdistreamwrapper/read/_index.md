...
description: "Método System::IO::BasicSTDIStreamWrapper::Read. Si el modo de encapsulado es binario, lee la cantidad especificada de bytes del flujo; de lo contrario, lee la cantidad especificada de caracteres y los convierte al tipo uint8_t. Escribe el resultado de la lectura en el arreglo de bytes especificado en C++."
type: docs
weight: 400
