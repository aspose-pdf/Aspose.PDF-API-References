...
description: "System::IO::TextWriter::WriteLine método. Escribe caracteres de terminación de línea al flujo en C++."
type: docs
weight: 1000
...
Escribe la representación en cadena del valor booleano especificado seguida de los caracteres de terminación de línea al flujo.
...
| --- | --- | --- |
| valor | bool | El valor a escribir |
...
Escribe el carácter especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | char_t | El valor a escribir |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | const char_t * | La c-string a escribir |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | const SharedPtr\<Object\>\& | El objeto a escribir |
...
Escribe los valores especificados formateados según el formato especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | const TypeInfo\& | El objeto a escribir |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | Decimal | El objeto a escribir |
...
Escribe la representación en cadena del valor de punto flotante de doble precisión especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | double | El valor a escribir |
...
Escribe la representación en cadena del valor de punto flotante de precisión simple especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | float | El valor a escribir |
...
Escribe la representación en cadena del valor entero de 32 bits especificado seguido de los caracteres de terminación de línea al flujo.
...
Escribe la representación en cadena del valor entero de 64 bits especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int64_t | El valor a escribir |
...
Escribe la representación en cadena del valor entero sin signo de 32 bits especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | uint32_t | El valor a escribir |
...
Escribe la representación en cadena del valor entero sin signo de 64 bits especificado seguido de los caracteres de terminación de línea al flujo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | uint64_t | El valor a escribir |
