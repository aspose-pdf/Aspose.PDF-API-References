---
title: "Aspose::Pdf::LoadOptions::get_DisableFontLicenseVerifications método"
linktitle: "get_DisableFontLicenseVerifications"
second_title: "Referencia de API de Aspose.PDF para C++"
description: "Aspose::Pdf::LoadOptions::get_DisableFontLicenseVerifications método. Obtiene la bandera para desactivar cualquier restricción de licencia para todas las fuentes al cargar el archivo. Cuando es verdadero, permite ejecutar operaciones con fuentes que están prohibidas por una licencia de esa fuente, por ejemplo permite incrustar una fuente en un documento PDF incluso si las reglas de la licencia desactivan la incrustación de esa fuente. Por defecto es falso en C++."
type: docs
weight: 200
url: /es/cpp/aspose.pdf/loadoptions/get_disablefontlicenseverifications/
---
## LoadOptions::get_DisableFontLicenseVerifications method


Obtiene la bandera para desactivar cualquier restricción de licencia para todas las fuentes al cargar el archivo. Cuando **true**
