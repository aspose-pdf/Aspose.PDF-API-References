...
description: "Eliminar anotaciones de PDF-document."
type: docs
url: /es/go-cpp/organize/removeannotations/
---

_Eliminar anotaciones del documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// RemoveAnnotations() elimina anotaciones del documento PDF
