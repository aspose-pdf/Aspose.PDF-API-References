...
description: "Eliminar scripts Java de PDF-document."
type: docs
url: /es/go-cpp/organize/removejavascripts/
---

_Eliminar scripts Java del documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// RemoveJavaScripts() elimina scripts Java del documento PDF
