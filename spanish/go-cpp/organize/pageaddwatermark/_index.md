...
description: "Agregar marca de agua en la página."
type: docs
url: /es/go-cpp/organize/pageaddwatermark/
---
...
func main() {
        ...
        defer pdf.Close()
        // PageAddWatermark(num int32, text string, fontName string, fontSize float64, foregroundColor string, xPosition int32, yPosition int32, rotation int32, isBackground bool, opacity float64) añade una marca de agua en la página
