...
type: docs
url: /es/go-cpp/organize/removepdfacompliance/
---

_Elimina el cumplimiento PDF/A de un documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// RemovePdfaCompliance() elimina el cumplimiento PDF/A del documento PDF
