...
description: "Validar un documento PDF para el cumplimiento con el formato PDF."
type: docs
url: /es/go-cpp/organize/validate/
---

_Valida un documento PDF para el cumplimiento con el formato PDF._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) valida el documento PDF para el cumplimiento PDF/A
	ok, logStr, err := pdf.Validate(asposepdf.PDF_A_2A)
	if err != nil {
		log.Fatal("Validate PDF/A error:", err)
	}

	// Imprime el resultado de la validación y el registro completo
