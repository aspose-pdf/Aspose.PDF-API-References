...
description: "Firmar un documento PDF usando firmas digitales PKCS#7."
type: docs
url: /es/go-cpp/security/signpkcs7/
---
...
func main() {
	...
	// SignPKCS7 firma un PDF-document usando firmas digitales PKCS#7
