...
description: "Firmar un documento PDF usando firmas digitales PKCS#7 desacopladas."
type: docs
url: /es/go-cpp/security/signpkcs7detached/
---
...
func main() {
	...
	// SignPKCS7Detached firma un PDF-document usando firmas digitales PKCS#7 Detached
