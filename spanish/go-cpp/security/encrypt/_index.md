...
description: "Cifrar el documento PDF."
type: docs
url: /es/go-cpp/security/encrypt/
---
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) cifra PDF-document
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
