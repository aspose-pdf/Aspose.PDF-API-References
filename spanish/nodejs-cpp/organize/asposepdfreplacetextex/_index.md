...
description: "Reemplazar múltiples fragmentos de texto en un archivo PDF con control de alineación."
type: docs
url: /es/nodejs-cpp/organize/asposepdfreplacetextex/
---

_Reemplazar múltiples fragmentos de texto en un archivo PDF con control de alineación._
...
La dirección también puede forzarse explícitamente anteponiendo `replaceText`
con caracteres Unicode especiales:
`\u200F` (RTL) o `\u200E` (LTR), preferiblemente como el primer carácter
