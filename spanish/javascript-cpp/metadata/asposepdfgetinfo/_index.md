...
description: "Obtener información (metadatos) de un archivo PDF."
type: docs
url: /es/javascript-cpp/metadata/asposepdfgetinfo/
---

_Obtener información (metadatos) de un archivo PDF._
