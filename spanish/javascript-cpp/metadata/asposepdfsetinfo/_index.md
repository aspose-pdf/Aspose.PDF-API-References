...
description: "Establecer información (metadatos) en un archivo PDF."
type: docs
url: /es/javascript-cpp/metadata/asposepdfsetinfo/
---

_Establecer información (metadatos) en un archivo PDF._
...
Para 'title', 'creator', 'author', 'subject', 'keywords', 'creation' y 'mod', si no es necesario establecer un valor, use undefined o "" (cadena vacía)
