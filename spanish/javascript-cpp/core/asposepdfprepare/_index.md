...
description: "Guardar el BLOB en el sistema de archivos en memoria para su procesamiento."
type: docs
url: /es/javascript-cpp/core/asposepdfprepare/
---

_Guardar el BLOB en el FS de Memoria para su procesamiento._
