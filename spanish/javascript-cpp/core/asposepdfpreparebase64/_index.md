...
description: "Guardar la representación en cadena del BLOB en el sistema de archivos en memoria para su procesamiento."
type: docs
url: /es/javascript-cpp/core/asposepdfpreparebase64/
---

_Guardar la representación en cadena del BLOB en el FS de Memoria para su procesamiento._
