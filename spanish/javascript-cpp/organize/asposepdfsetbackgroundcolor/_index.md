...
description: "Establecer el color de fondo para el archivo PDF."
type: docs
url: /es/javascript-cpp/organize/asposepdfsetbackgroundcolor/
---

_Establecer el color de fondo para el archivo PDF._
