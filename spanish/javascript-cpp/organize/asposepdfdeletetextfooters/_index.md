...
description: "Eliminar pies de página de texto de un archivo PDF."
type: docs
url: /es/javascript-cpp/organize/asposepdfdeletetextfooters/
---

_Eliminar pies de texto de un PDF-file._
