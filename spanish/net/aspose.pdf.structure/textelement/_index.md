...
description: Clase Aspose.Pdf.Structure.TextElement. Elemento de texto general de la estructura lógica del documento
type: docs
weight: 10190
url: /es/net/aspose.pdf.structure/textelement/
---
## Clase TextElement

Elemento de texto general de la estructura lógica del documento.
...
| [Text](../../aspose.pdf.structure/textelement/text/) { get; } | Obtiene el valor del elemento de texto de estructura. |
