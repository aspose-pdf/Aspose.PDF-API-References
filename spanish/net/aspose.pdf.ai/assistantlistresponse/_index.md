...
description: Clase Aspose.Pdf.AI.AssistantListResponse. Representa la respuesta que contiene una lista de respuestas de asistentes
type: docs
weight: 120
url: /es/net/aspose.pdf.ai/assistantlistresponse/
---
## Clase AssistantListResponse

Representa la respuesta que contiene una lista de respuestas de asistentes.
...
| Nombre | Descripción |
| --- | --- |
| [AssistantListResponse](assistantlistresponse/)() | El constructor predeterminado. |
