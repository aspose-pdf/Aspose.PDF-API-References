...
description: Clase Aspose.Pdf.AI.VectorStoreListQueryParameters. Objeto de parámetros de consulta para listar almacenes de vectores
type: docs
weight: 1360
url: /es/net/aspose.pdf.ai/vectorstorelistqueryparameters/
---
## Clase VectorStoreListQueryParameters

Objeto de parámetros de consulta para listar almacenes de vectores.
...
| Nombre | Descripción |
| --- | --- |
| [VectorStoreListQueryParameters](vectorstorelistqueryparameters/)() | El constructor predeterminado. |
...
| Nombre | Descripción |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorelistqueryparameters/getqueryparameters/)() | Obtiene los parámetros de consulta para listar almacenes de vectores. |
