...
description: Clase Aspose.Pdf.AI.AssistantModifyRequest. Objeto de solicitud para modificar un asistente
type: docs
weight: 130
url: /es/net/aspose.pdf.ai/assistantmodifyrequest/
---
## Clase AssistantModifyRequest

Objeto de solicitud para modificar un asistente.
...
| Nombre | Descripción |
| --- | --- |
| [AssistantModifyRequest](assistantmodifyrequest/)() | El constructor predeterminado. |
...
| [Model](../../aspose.pdf.ai/assistantcreaterequest/model/) { get; set; } | Obtiene o establece el ID del modelo a utilizar. Puede usar la API de Listar modelos para ver todos sus modelos disponibles, o ver nuestra descripción general del modelo para obtener descripciones de ellos. |
...
| [Tools](../../aspose.pdf.ai/assistantcreaterequest/tools/) { get; set; } | Obtiene o establece una lista de herramientas habilitadas en el asistente. Puede haber un máximo de 128 herramientas por asistente. Las herramientas pueden ser de tipos code_interpreter, file_search o function. |
...
* clase [AssistantCreateRequest](../assistantcreaterequest/)
