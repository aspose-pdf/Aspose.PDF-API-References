...
description: Método IOpenAIClient. Recupera una lista de pasos para una ejecución específica dentro de un hilo de manera asíncrona
type: docs
weight: 260
url: /es/net/aspose.pdf.ai/iopenaiclient/getrunstepsasync/
---
