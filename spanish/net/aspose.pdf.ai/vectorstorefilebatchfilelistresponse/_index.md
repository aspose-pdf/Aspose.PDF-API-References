...
description: Clase Aspose.Pdf.AI.VectorStoreFileBatchFileListResponse. Representa una respuesta de lista que contiene datos de lote de archivos de almacenamiento vectorial
type: docs
weight: 1300
url: /es/net/aspose.pdf.ai/vectorstorefilebatchfilelistresponse/
---
## Clase VectorStoreFileBatchFileListResponse

Representa una respuesta de lista que contiene datos de lote de archivos de almacenamiento vectorial.
...
| Nombre | Descripción |
| --- | --- |
| [VectorStoreFileBatchFileListResponse](vectorstorefilebatchfilelistresponse/)() | El constructor predeterminado. |
...
* clase [ListDataResponse&lt;T&gt;](../listdataresponse-1/)
