...
description: La clase describe el artefacto Header. Este artifacgt se puede usar para establecer el encabezado de la página.
type: docs
weight: 3340
...
La clase describe el artefacto Header. Este artifacgt se puede usar para establecer el encabezado de la página.
...
| Nombre | Descripción |
| --- | --- |
| [HeaderArtifact](headerartifact)() | Crea una instancia de artefacto de encabezado. |
