...
description: Clase Aspose.Pdf.HeaderArtifact. La clase describe el artefacto de encabezado. Este artefacto puede ser utilizado para establecer el encabezado de la página.
type: docs
weight: 5420
url: /es/net/aspose.pdf/headerartifact/
---
## Clase HeaderArtifact

La clase describe el artefacto de encabezado. Este artefacto puede ser utilizado para establecer el encabezado de la página.
...
| Nombre | Descripción |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Crea una instancia del artefacto de encabezado. |
