...
description: Clase Aspose.Pdf.FooterArtifact. Describe el artefacto de pie de página. Esto puede ser utilizado para establecer el pie de página de la página
type: docs
weight: 4930
url: /es/net/aspose.pdf/footerartifact/
---
## Clase FooterArtifact

Describe el artefacto de pie de página. Esto puede ser utilizado para establecer el pie de página de la página.
...
| Nombre | Descripción |
| --- | --- |
| [FooterArtifact](footerartifact/)() | Crea una instancia de artefacto de pie de página. |
