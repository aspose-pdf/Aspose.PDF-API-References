...
description: Guardar opciones para exportar a formato APS XML.
type: docs
weight: 1300
...
Guardar opciones para exportar a formato APS XML.
...
| Nombre | Descripción |
| --- | --- |
| [ApsSaveOptions](apssaveoptions)() | Constructor predeterminado |
