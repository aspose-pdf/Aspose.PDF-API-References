...
description: Clase Aspose.Pdf.BackgroundArtifact. La clase describe el artefacto de fondo. Este artefacto permite establecer el fondo de la página.
type: docs
weight: 2810
url: /es/net/aspose.pdf/backgroundartifact/
---
## Clase BackgroundArtifact
...
| Nombre | Descripción |
| --- | --- |
| [BackgroundArtifact](backgroundartifact/)() | Inicializa el objeto BackgroundArtifact. |
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | Obtiene o establece el color de fondo del artefacto de fondo. |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | Obtiene o establece la imagen de fondo del artefacto de fondo. |
