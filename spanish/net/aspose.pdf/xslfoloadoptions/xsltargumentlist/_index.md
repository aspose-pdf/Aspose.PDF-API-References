...
description: Propiedad XslFoLoadOptions. XsltArgumentList para insertar valores en parámetros xls existentes. El archivo XLS tiene un parámetro 'animal' sin valor: XsltArgumentList args = new XsltArgumentList(); args.AddParam("animal", "", "cat"); ahora el convertidor asume que hay un parámetro 'animal' con el valor 'cat' en el archivo XLS.
type: docs
weight: 30
