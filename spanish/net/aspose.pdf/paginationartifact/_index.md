...
description: Clase Aspose.Pdf.PaginationArtifact. Representa una clase base abstracta para artefactos de paginación en un documento
type: docs
weight: 8260
url: /es/net/aspose.pdf/paginationartifact/
---
...
| [Opacity](../../aspose.pdf/artifact/opacity/) { get; set; } | Obtiene o establece la opacidad del artefacto. Los valores posibles están en el rango de 0 a 1. |
...
| [Subset](../../aspose.pdf/paginationartifact/subset/) { get; set; } | Obtiene o establece el subconjunto de páginas al que se aplica el artefacto (por ejemplo, todas las páginas, páginas pares, páginas impares). |
| [Subtype](../../aspose.pdf/artifact/subtype/) { get; set; } | Obtiene el subtipo del artefacto. Si el artefacto tiene un subtipo no estándar, el nombre del subtipo puede leerse a través de CustomSubtype. |
...
| [Dispose](../../aspose.pdf/artifact/dispose/)() | Elimina el artefacto. |
...
| [SetLinesAndState](../../aspose.pdf/artifact/setlinesandstate/)(string[], TextState) | Establece el texto y las propiedades del texto del artefacto. Permite especificar múltiples líneas. |
...
| [SetTextAndState](../../aspose.pdf/artifact/settextandstate/)(string, TextState) | Establece el texto y las propiedades del texto del artefacto. |
