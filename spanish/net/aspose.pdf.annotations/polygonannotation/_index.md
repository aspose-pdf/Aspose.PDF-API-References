...
description: Clase que representa la anotación de polígono.
type: docs
weight: 920
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept)(AnnotationSelector) | Acepta el objeto de visitante para el procesamiento de anotaciones. |
