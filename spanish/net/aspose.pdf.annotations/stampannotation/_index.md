...
description: Representa la anotación de sello de goma. Este tipo de anotación muestra texto o gráficos destinados a parecer como si estuvieran estampados en la página con un sello de goma.
type: docs
weight: 1160
...
Representa la anotación de sello de goma. Este tipo de anotación muestra texto o gráficos destinados a parecer como si estuvieran estampados en la página con un sello de goma.
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon) { get; set; } | Obtiene o establece el icono del sello de caucho. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept)(AnnotationSelector) | Acepta[`AnnotationSelector`](../annotationselector) visitante cuando navega por la colección de anotaciones. |
...
El siguiente fragmento de código muestra cómo agregar 2 sellos en la primera página del documento pdf. El documento de entrada proviene de inFile y los cambios se guardan en outFile. El primer sello tiene el ícono NotForPublicRelease y el segundo viene con una imagen de rubber.jpg.
