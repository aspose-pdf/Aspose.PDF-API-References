...
description: Clase Aspose.Pdf.Annotations.StampAnnotation. Representa una anotación de sello de goma. Este tipo de anotación muestra texto o gráficos que parecen haber sido estampados en la página con un sello de goma.
type: docs
weight: 2610
url: /es/net/aspose.pdf.annotations/stampannotation/
---
## Clase StampAnnotation
...
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | Crea una nueva anotación de sello en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/stampannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | Obtiene o establece el ícono para el sello de goma. |
| [Image](../../aspose.pdf.annotations/stampannotation/image/) { get; set; } | Obtiene o establece la imagen de la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | Acepta [`AnnotationSelector`](../annotationselector/) visitante al navegar por la colección de anotaciones. |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matrix) | Actualiza parámetros y apariencia, de acuerdo con la transformación de matriz. |
...
El siguiente fragmento de código demuestra cómo agregar 2 sellos en la primera página del documento pdf. El documento de entrada proviene de inFile y los cambios se guardan en outFile. El primer sello tiene el ícono NotForPublicRelease y el segundo viene con la imagen de rubber.jpg.
