...
description: Clase que representa la anotación de círculo.
type: docs
weight: 250
...
| Nombre | Descripción |
| --- | --- |
| [CircleAnnotation](circleannotation#constructor)(Document) | Constructor para anotación de círculo. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
