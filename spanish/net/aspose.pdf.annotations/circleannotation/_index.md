...
description: Clase Aspose.Pdf.Annotations.CircleAnnotation. Clase que representa la anotación de círculo
type: docs
weight: 1590
url: /es/net/aspose.pdf.annotations/circleannotation/
---
## Clase CircleAnnotation

Clase que representa la anotación de círculo.
...
| Nombre | Descripción |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Constructor para la anotación de círculo. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Crea una nueva anotación de círculo en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | Color interior con el que llenar el rectángulo o elipse de la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
...
* clase [CommonFigureAnnotation](../commonfigureannotation/)
