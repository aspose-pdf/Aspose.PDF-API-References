...
description: La clase describe el objeto de anotación de marca de agua.
type: docs
weight: 1250
...
La clase describe el objeto de anotación de marca de agua.
...
| Nombre | Descripción |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Constructor para clase de anotación de marca de agua. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint) { get; } | Objeto de impresión fijo de anotación de marca de agua. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Aplicar visitante para anotación. |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext)(FormattedText) | Establecer texto de la anotación. |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate)(string[], TextState) | Establecer texto de la anotación. |
