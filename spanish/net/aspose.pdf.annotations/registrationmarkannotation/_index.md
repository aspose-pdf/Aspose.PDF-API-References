...
description: Clase Aspose.Pdf.Annotations.RegistrationMarkAnnotation. Representa una anotación de Marca de Registro
type: docs
weight: 2410
url: /es/net/aspose.pdf.annotations/registrationmarkannotation/
---
## Clase RegistrationMarkAnnotation

Representa una anotación de Marca de Registro.
...
| Nombre | Descripción |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Página, PosiciónDeMarcaDeImpresora) | Inicializa una nueva instancia de la clase `RegistrationMarkAnnotation` en la página dada en la ubicación dada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Obtiene o establece la posición de la marca de registro en una página. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(SelectorDeAnotaciones) | Acepta un visitante para el procesamiento de anotaciones. |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matriz) | Actualiza parámetros y apariencia, de acuerdo con la transformación de la matriz. |
...
Las marcas de registro son símbolos añadidos a las planchas de impresión o pantallas para asegurar la alineación adecuada de los colores durante el proceso de impresión.
