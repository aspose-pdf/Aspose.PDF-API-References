...
description: La clase describe la anotación de archivos adjuntos.
type: docs
weight: 330
...
La clase describe la anotación de archivos adjuntos.
...
| Nombre | Descripción |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation)(Page, Rectangle, FileSpecification) | Crea una nueva anotación de archivo adjunto en la página especificada. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon) { get; set; } | Obtiene o establece el icono que se utilizará para mostrar la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar anotación. |
