...
description: Clase Aspose.Pdf.Annotations.FileAttachmentAnnotation. La clase describe la anotación de archivo adjunto
type: docs
weight: 1710
url: /es/net/aspose.pdf.annotations/fileattachmentannotation/
---
## Clase FileAttachmentAnnotation

La clase describe la anotación de archivo adjunto.
...
| Nombre | Descripción |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Página, Rectángulo, EspecificaciónDeArchivo) | Crea una nueva anotación de archivo adjunto en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | La especificación del archivo asociado con esta anotación. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Obtiene o establece el ícono que se utilizará para mostrar la anotación. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Obtiene o establece la opacidad del ícono de 0 a 1: 0 - completamente transparente, 1 - completamente opaco. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
