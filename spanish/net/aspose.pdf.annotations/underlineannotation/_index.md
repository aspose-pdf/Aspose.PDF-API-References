...
description: Clase Aspose.Pdf.Annotations.UnderlineAnnotation. Representa una anotación subrayada que aparece como un subrayado en el texto del documento
type: docs
weight: 2700
url: /es/net/aspose.pdf.annotations/underlineannotation/
---
## Clase UnderlineAnnotation

Representa una anotación subrayada que aparece como un subrayado en el texto del documento.
...
| Nombre | Descripción |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Página, Rectángulo) | Crea una nueva anotación subrayada en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | Obtiene o establece un arreglo de puntos que especifica las coordenadas de n cuadriláteros. Cada cuadrilátero abarca una palabra o grupo de palabras contiguas en el texto subyacente a la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
