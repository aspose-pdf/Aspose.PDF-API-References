...
description: Representa una anotación subrayada que aparece como un subrayado en el texto del documento.
type: docs
weight: 1240
...
| Nombre | Descripción |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | Crea una nueva anotación de subrayado en la página especificada. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
