...
description: Clase Aspose.Pdf.Annotations.TrimMarkAnnotation. Representa una anotación de marca de recorte
type: docs
weight: 2690
url: /es/net/aspose.pdf.annotations/trimmarkannotation/
---
## Clase TrimMarkAnnotation

Representa una anotación de marca de recorte.
...
| Nombre | Descripción |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Página, PosiciónEsquinaMarcaImpresora) | Inicializa una nueva instancia de la clase `TrimMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Obtiene o establece la posición de la marca en la página. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(SelectorDeAnotación) | Acepta un visitante para el procesamiento de anotaciones. |
...
Las marcas de recorte se colocan en las esquinas de una página impresa para indicar dónde se debe recortar la página.

### Véase también

* clase [CornerPrinterMarkAnnotation](../cornerprintermarkannotation/)
