...
description: Representa una anotación resaltada que resalta un rango de texto en el documento.
type: docs
weight: 490
...
Representa una anotación resaltada que resalta un rango de texto en el documento.
...
| Nombre | Descripción |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | Crea una nueva anotación Resaltar en la página especificada. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
