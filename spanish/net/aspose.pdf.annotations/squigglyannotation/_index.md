...
| Nombre | Descripción |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation)(Page, Rectangle) | Crea una nueva anotación Squiggly en la página especificada. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
