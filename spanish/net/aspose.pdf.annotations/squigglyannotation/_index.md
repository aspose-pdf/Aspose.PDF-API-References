...
description: Clase Aspose.Pdf.Annotations.SquigglyAnnotation. Representa la anotación ondulada que aparece como un subrayado irregular en el texto de un documento
type: docs
weight: 2600
url: /es/net/aspose.pdf.annotations/squigglyannotation/
---
## Clase SquigglyAnnotation
...
| Nombre | Descripción |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Página, Rectángulo) | Crea una nueva anotación ondulada en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
