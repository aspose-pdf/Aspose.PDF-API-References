...
description: Clase Aspose.Pdf.Annotations.LineAnnotation. Clase que representa una anotación de línea
type: docs
weight: 1980
url: /es/net/aspose.pdf.annotations/lineannotation/
---
## Clase LineAnnotation
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Obtiene o establece el desplazamiento del texto del título desde su posición normal. |
...
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Obtiene o establece el estilo de finalización para el punto final de la línea. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | Obtiene o establece la longitud de la línea líder. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | Obtiene o establece la longitud de la extensión de la línea líder. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Obtiene o establece el desplazamiento de la línea líder. |
...
| [Measure](../../aspose.pdf.annotations/lineannotation/measure/) { get; set; } | Unidades de medida especificadas para esta anotación. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Obtiene o establece una bandera boolean que determina si el contenido debe mostrarse como título. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Obtiene o establece el punto de inicio de la línea. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Obtiene o establece el estilo de inicio de la línea para el punto de inicio de la línea. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept/)(AnnotationSelector) | Acepta un visitante para el procesamiento de anotaciones. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Actualiza los puntos de inicio y final, de acuerdo con la transformación de la matriz. |
