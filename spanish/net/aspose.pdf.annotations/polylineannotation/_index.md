...
description: Representa una anotación de polilínea que es similar a un polígono excepto que el primer y el último vértice no están conectados implícitamente.
type: docs
weight: 930
...
Representa una anotación de polilínea que es similar a un polígono, excepto que el primer y el último vértice no están conectados implícitamente.
...
| Nombre | Descripción |
| --- | --- |
| [PolylineAnnotation](polylineannotation)(Page, Rectangle, Point[]) | Crea una nueva anotación de polilínea en la página especificada. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
