...
description: Clase Aspose.Pdf.Annotations.PolylineAnnotation. Representa una anotación de polilínea que es similar a un polígono, excepto que el primer y último vértice no están conectados implícitamente.
type: docs
weight: 2320
url: /es/net/aspose.pdf.annotations/polylineannotation/
---
## Clase PolylineAnnotation

Representa una anotación de polilínea que es similar a un polígono, excepto que el primer y último vértice no están conectados implícitamente.
...
| Nombre | Descripción |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Página, Rectángulo, Punto[]) | Crea una nueva anotación de polilínea en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Obtiene o establece el color interior con el que se rellenarán los extremos de la línea de la anotación. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Obtiene o establece el estilo del primer final de línea. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
