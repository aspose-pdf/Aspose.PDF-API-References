...
description: Clase Aspose.Pdf.Annotations.PolyAnnotation. Clase base abstracta para anotaciones poligonales
type: docs
weight: 2290
url: /es/net/aspose.pdf.annotations/polyannotation/
---
## Clase PolyAnnotation
...
| [IsInLineParagraph](../../aspose.pdf/baseparagraph/isinlineparagraph/) { get; set; } | Obtiene o establece si un párrafo está en línea. El valor predeterminado es falso. (para generación de pdf) |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Obtiene o establece un arreglo de puntos que representan las coordenadas horizontales y verticales de cada vértice. |
