...
description: Clase abstracta que representa la anotación de marcado.
type: docs
weight: 640
...
Clase abstracta que representa la anotación de marcado.
...
| Nombre | Descripción |
| --- | --- |
| [MarkupAnnotation](markupannotation)(Document) | Constructor para anotación de marcas. |
