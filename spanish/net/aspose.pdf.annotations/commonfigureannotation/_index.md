...
description: Clase abstracta que representa la anotación de figura común.
type: docs
weight: 260
...
Clase abstracta que representa la anotación de figura común.
...
| Nombre | Descripción |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation)(Document) | Constructor para usar en Generator. |
