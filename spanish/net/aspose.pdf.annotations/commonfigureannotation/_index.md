...
description: Clase Aspose.Pdf.Annotations.CommonFigureAnnotation. Clase abstracta que representa una anotación de figura común
type: docs
weight: 1620
url: /es/net/aspose.pdf.annotations/commonfigureannotation/
---
...
| Nombre | Descripción |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | Constructor para usar en el Generador. |
