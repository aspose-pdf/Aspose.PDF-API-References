...
description: Clase Aspose.Pdf.Annotations.TextAnnotation. Representa una anotación de texto que es una nota adhesiva unida a un punto en el documento PDF
type: docs
weight: 2650
url: /es/net/aspose.pdf.annotations/textannotation/
---
## Clase TextAnnotation

Representa una anotación de texto que es una 'nota adhesiva' unida a un punto en el documento PDF.
...
| Nombre | Descripción |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Constructor para la anotación cuando se utiliza en el Generador. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Obtiene o establece un ícono que se utilizará para mostrar la anotación. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Obtiene o establece una bandera que especifica si la anotación debe mostrarse inicialmente abierta. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Sobrescribe la definición en la clase base con un cuerpo vacío. |
