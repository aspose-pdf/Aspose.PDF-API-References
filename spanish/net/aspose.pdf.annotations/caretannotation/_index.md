...
description: Clase Aspose.Pdf.Annotations.CaretAnnotation. Clase que representa la anotación Caret
type: docs
weight: 1560
url: /es/net/aspose.pdf.annotations/caretannotation/
---
## Clase CaretAnnotation

Clase que representa la anotación Caret.
...
| Nombre | Descripción |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Constructor para usar en Generator. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Crea una nueva anotación Caret en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Obtiene o establece el rectángulo del caret. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Obtiene o establece el símbolo asociado con el caret. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
