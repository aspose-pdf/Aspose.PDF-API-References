...
description: Clase que representa la anotación Caret.
type: docs
weight: 220
...
| [CaretAnnotation](caretannotation#constructor_1)(Page, Rectangle) | Crea una nueva anotación de intercalación en la página especificada. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame) { get; set; } | Obtiene o establece el rectángulo de intercalación. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol) { get; set; } | Obtiene o establece el símbolo asociado con caret. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
