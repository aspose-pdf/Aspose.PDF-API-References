...
description: Clase Aspose.Pdf.Annotations.PrinterMarkAnnotation. Clase abstracta que representa la anotación de marca de impresora
type: docs
weight: 2350
url: /es/net/aspose.pdf.annotations/printermarkannotation/
---
## Clase PrinterMarkAnnotation

Clase abstracta que representa la anotación de marca de impresora.
...
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks)(Document, PrinterMarksKind) | Agrega marcas de impresora a todas las páginas en el documento especificado. |
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks_1)(Page, PrinterMarksKind) | Agrega marcas de impresora a la página especificada. |
