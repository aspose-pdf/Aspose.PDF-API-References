...
description: Clase Aspose.Pdf.Annotations.StrikeOutAnnotation. Representa una anotación de tachado que aparece como un tachado en el texto del documento
type: docs
weight: 2630
url: /es/net/aspose.pdf.annotations/strikeoutannotation/
---
## Clase StrikeOutAnnotation
...
| Nombre | Descripción |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Página, Rectángulo) | Crea una nueva anotación de tachado en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
