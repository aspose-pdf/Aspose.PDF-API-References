...
description: Representa una anotación tachada que aparece tachada en el texto del documento.
type: docs
weight: 1180
...
Representa una anotación tachada que aparece tachada en el texto del documento.
...
| Nombre | Descripción |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation)(Page, Rectangle) | Crea una nueva anotación Tachada en la página especificada. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
