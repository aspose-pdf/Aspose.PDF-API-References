...
description: Representa una anotación de sonido que contiene sonido grabado desde el micrófono de la computadora o importado desde un archivo.
type: docs
weight: 1080
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | Obtiene o establece un icono que se utilizará para mostrar la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
