...
description: Clase Aspose.Pdf.Annotations.SoundAnnotation. Representa una anotación de sonido que contiene sonido grabado desde el micrófono de la computadora o importado desde un archivo
type: docs
weight: 2530
url: /es/net/aspose.pdf.annotations/soundannotation/
---
## Clase SoundAnnotation

Representa una anotación de sonido que contiene sonido grabado desde el micrófono de la computadora o importado desde un archivo.
...
| Nombre | Descripción |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | Crea una nueva anotación de sonido en la página especificada. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | Crea una nueva anotación de sonido en la página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | Obtiene o establece un ícono que se utilizará para mostrar la anotación. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | Obtiene un objeto de sonido que define el sonido que se reproducirá cuando se active la anotación. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
