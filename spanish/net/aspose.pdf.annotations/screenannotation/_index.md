...
description: Clase Aspose.Pdf.Annotations.ScreenAnnotation. Una anotación de pantalla que especifica una región de una página sobre la cual se pueden reproducir clips multimedia.
type: docs
weight: 2510
url: /es/net/aspose.pdf.annotations/screenannotation/
---
## Clase ScreenAnnotation

Una anotación de pantalla que especifica una región de una página sobre la cual se pueden reproducir clips multimedia.
...
| Nombre | Descripción |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Página, Rectángulo, string) | Crea una nueva anotación de pantalla en la página especificada. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Obtiene o establece una acción que se realizará cuando se active la anotación. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Obtiene o establece el título de la anotación de pantalla. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
