...
description: Clase Aspose.Pdf.Annotations.LinkAnnotation. Representa un enlace de hipertexto a un destino en otro lugar del documento o una acción a realizar
type: docs
weight: 2010
url: /es/net/aspose.pdf.annotations/linkannotation/
---
## Clase LinkAnnotation

Representa un enlace de hipertexto a un destino en otro lugar del documento o una acción a realizar.
...
| Nombre | Descripción |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Página, Rectángulo) | Crea una nueva anotación de enlace en la página especificada. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | Una acción a realizar cuando se activa la anotación de enlace. |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype/) { get; } | Obtiene el tipo de anotación. |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination/) { get; set; } | Un destino que se mostrará cuando se active la anotación. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | El efecto visual que se utilizará cuando se presione o mantenga presionado el botón del mouse dentro de su área activa. |
| virtual [Hyperlink](../../aspose.pdf/baseparagraph/hyperlink/) { get; set; } | Obtiene o establece el hipervínculo de fragmento (para generador de pdf). |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | Acepta un objeto visitante para procesar la anotación. |
