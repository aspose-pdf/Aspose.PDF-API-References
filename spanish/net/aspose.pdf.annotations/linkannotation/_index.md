...
description: Representa un enlace de hipertexto a un destino en otra parte del documento o una acción que se debe realizar.
type: docs
weight: 630
...
Representa un enlace de hipertexto a un destino en otra parte del documento o una acción que se debe realizar.
...
| Nombre | Descripción |
| --- | --- |
| [LinkAnnotation](linkannotation)(Page, Rectangle) | Crea una nueva anotación de enlace en la página especificada. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | El efecto visual que se usará cuando se presione o se mantenga presionado el botón del mouse dentro de su área activa. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept)(AnnotationSelector) | Acepta objeto visitante para procesar la anotación. |
