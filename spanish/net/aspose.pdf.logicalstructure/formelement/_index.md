...
description: Clase Aspose.Pdf.LogicalStructure.FormElement. Representa el elemento de estructura de formulario en la estructura lógica
type: docs
weight: 6350
url: /es/net/aspose.pdf.logicalstructure/formelement/
---
## Clase FormElement

Representa el elemento de estructura de formulario en la estructura lógica.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | Agrega una imagen al elemento de ilustración actual. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | Agrega una imagen al elemento de ilustración actual. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XImage) | Vincula un elemento de estructura al XImage. |
...
* clase [IllustrationElement](../illustrationelement/)
