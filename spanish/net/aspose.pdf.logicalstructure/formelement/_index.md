...
description: Representa el elemento de estructura de formulario en la estructura lógica.
type: docs
weight: 4180
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double) | Agrega la imagen al elemento de ilustración actual. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double, double) | Agrega la imagen al elemento de ilustración actual. |
