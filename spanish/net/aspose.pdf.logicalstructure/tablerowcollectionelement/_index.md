...
description: Clase Aspose.Pdf.LogicalStructure.TableRowCollectionElement. Representa una clase base para los elementos hijos de la Cabeza, Cuerpo y Pie de la Tabla en la estructura lógica
type: docs
weight: 6790
url: /es/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## Clase TableRowCollectionElement

Representa una clase base para los elementos hijos de la Cabeza, Cuerpo y Pie de la Tabla en la estructura lógica.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | Crea [`TableTRElement`](../tabletrelement/) y lo agrega a la tabla actual. |
