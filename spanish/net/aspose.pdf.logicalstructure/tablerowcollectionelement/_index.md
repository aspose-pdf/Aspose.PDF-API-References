...
description: Representa una clase base para los elementos hijos de la cabecera el cuerpo y el pie de la tabla en la estructura lógica.
type: docs
weight: 4620
...
Representa una clase base para los elementos hijos de la cabecera, el cuerpo y el pie de la tabla en la estructura lógica.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | Crea[`TableTRElement`](../tabletrelement) y lo agregó a la tabla actual. |
