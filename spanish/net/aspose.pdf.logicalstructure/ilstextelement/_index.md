...
description: Clase Aspose.Pdf.LogicalStructure.ILSTextElement. Representa una clase base para elementos de estructura de texto en línea en la estructura lógica
type: docs
weight: 6400
url: /es/net/aspose.pdf.logicalstructure/ilstextelement/
---
## Clase ILSTextElement

Representa una clase base para elementos de estructura de texto en línea en la estructura lógica.
