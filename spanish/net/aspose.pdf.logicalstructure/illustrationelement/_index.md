...
description: Clase Aspose.Pdf.LogicalStructure.IllustrationElement. Representa una clase base para elementos de estructura de ilustración en la estructura lógica
type: docs
weight: 6420
url: /es/net/aspose.pdf.logicalstructure/illustrationelement/
---
## Clase IllustrationElement

Representa una clase base para elementos de estructura de ilustración en la estructura lógica.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | Agrega una imagen al elemento de ilustración actual. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | Agrega una imagen al elemento de ilustración actual. |
...
* clase [StructureElement](../structureelement/)
