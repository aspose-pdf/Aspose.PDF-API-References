...
description: Representa una clase base para elementos de estructura de ilustración en estructura lógica.
type: docs
weight: 4250
...
Representa una clase base para elementos de estructura de ilustración en estructura lógica.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage)(string, double) | Agrega la imagen al elemento de ilustración actual. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage_1)(string, double, double) | Agrega la imagen al elemento de ilustración actual. |
