...
description: Clase Aspose.Pdf.LogicalStructure.WarichuChildElement. Representa una clase base para elementos hijos del Warichu en la estructura lógica
type: docs
weight: 6860
url: /es/net/aspose.pdf.logicalstructure/warichuchildelement/
---
## Clase WarichuChildElement

Representa una clase base para elementos hijos del Warichu en la estructura lógica.
