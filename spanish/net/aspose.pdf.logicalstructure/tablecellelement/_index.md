...
description: Clase Aspose.Pdf.LogicalStructure.TableCellElement. Representa una clase base para elementos de celda de tabla TH y TD en la estructura lógica
type: docs
weight: 6760
url: /es/net/aspose.pdf.logicalstructure/tablecellelement/
---
## Clase TableCellElement

Representa una clase base para elementos de celda de tabla (TH y TD) en la estructura lógica.
...
| [ColSpan](../../aspose.pdf.logicalstructure/tablecellelement/colspan/) { get; set; } | Obtiene o establece el span de columna. |
...
| [RowSpan](../../aspose.pdf.logicalstructure/tablecellelement/rowspan/) { get; set; } | Obtiene o establece el span de fila. |
