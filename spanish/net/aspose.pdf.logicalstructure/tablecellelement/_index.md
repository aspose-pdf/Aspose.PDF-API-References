...
description: Representa una clase base para elementos de celda de tabla TH y TD en estructura lógica.
type: docs
weight: 4590
url: /es/net/aspose.pdf.logicalstructure/tablecellelement/
---
## TableCellElement class

Representa una clase base para elementos de celda de tabla (TH y TD) en estructura lógica.
...
| [ColSpan](../../aspose.pdf.logicalstructure/tablecellelement/colspan) { get; set; } | Obtiene o establece la extensión de la columna. |
...
| [IsNoBorder](../../aspose.pdf.logicalstructure/tablecellelement/isnoborder) { get; set; } | Obtiene o establece que la celda tenga borde. |
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped) { get; set; } | Obtiene o establece el ajuste de palabra del texto de la celda. |
...
| [RowSpan](../../aspose.pdf.logicalstructure/tablecellelement/rowspan) { get; set; } | Obtiene o establece el intervalo de filas. |
| [StructureTextState](../../aspose.pdf.logicalstructure/tablecellelement/structuretextstate) { get; } | ObtieneStructureTextState objeto para el elemento actual. |
...
| [SetText](../../aspose.pdf.logicalstructure/tablecellelement/settext)(string) | Agrega contenido de texto al elemento de texto actual. |
