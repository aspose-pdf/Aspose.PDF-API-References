...
description: Clase Aspose.Pdf.LogicalStructure.QuoteElement. Representa el elemento de estructura Quote en la estructura lógica
type: docs
weight: 6570
url: /es/net/aspose.pdf.logicalstructure/quoteelement/
---
## Clase QuoteElement

Representa el elemento de estructura Quote en la estructura lógica.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Obtiene el objeto StructureTextState para el elemento actual. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(Artifact) | Vincula un elemento de estructura al Artifact. |
...
* clase [ILSTextElement](../ilstextelement/)
