...
description: Clase Aspose.Pdf.LogicalStructure.BLSTextElement. Representa una clase base para elementos de estructura de texto a nivel de bloque en la estructura lógica
type: docs
weight: 6250
url: /es/net/aspose.pdf.logicalstructure/blstextelement/
---
## Clase BLSTextElement

Representa una clase base para elementos de estructura de texto a nivel de bloque en la estructura lógica.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | Obtiene el objeto StructureTextState para el elemento actual. |
