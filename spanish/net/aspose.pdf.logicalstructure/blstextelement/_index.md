...
description: Representa una clase base para elementos de estructura de texto a nivel de bloque en estructura lógica.
type: docs
weight: 4080
...
Representa una clase base para elementos de estructura de texto a nivel de bloque en estructura lógica.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate) { get; } | ObtieneStructureTextState objeto para el elemento actual. |
...
| [SetText](../../aspose.pdf.logicalstructure/blstextelement/settext)(string) | Agrega contenido de texto al elemento de texto actual. |
