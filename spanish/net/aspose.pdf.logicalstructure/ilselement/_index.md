...
description: Clase Aspose.Pdf.LogicalStructure.ILSElement. Representa una clase base para elementos de estructura de nivel en línea en la estructura lógica
type: docs
weight: 6390
url: /es/net/aspose.pdf.logicalstructure/ilselement/
---
## Clase ILSElement

Representa una clase base para elementos de estructura de nivel en línea en la estructura lógica.
