...
description: Clase Aspose.Pdf.LogicalStructure.RubyChildElement. Representa una clase base para los elementos hijos del Ruby en la estructura lógica
type: docs
weight: 6590
url: /es/net/aspose.pdf.logicalstructure/rubychildelement/
---
## Clase RubyChildElement

Representa una clase base para los elementos hijos del Ruby en la estructura lógica.
