...
description: Clase Aspose.Pdf.LogicalStructure.AnnotationElement. Representa una clase base para elementos de estructura de anotación en la estructura lógica
type: docs
weight: 6190
url: /es/net/aspose.pdf.logicalstructure/annotationelement/
---
## Clase AnnotationElement

Representa una clase base para elementos de estructura de anotación en la estructura lógica.
