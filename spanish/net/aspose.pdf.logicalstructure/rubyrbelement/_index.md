...
description: Clase Aspose.Pdf.LogicalStructure.RubyRBElement. Representa el elemento de estructura RB en la estructura lógica del Ruby
type: docs
weight: 6610
url: /es/net/aspose.pdf.logicalstructure/rubyrbelement/
---
## Clase RubyRBElement

Representa el elemento de estructura RB en la estructura lógica del Ruby.
...
* clase [RubyChildElement](../rubychildelement/)
