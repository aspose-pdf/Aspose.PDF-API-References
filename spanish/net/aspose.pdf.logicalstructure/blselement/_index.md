...
description: Clase Aspose.Pdf.LogicalStructure.BLSElement. Representa una clase base para elementos de estructura a nivel de bloque en la estructura lógica
type: docs
weight: 6240
url: /es/net/aspose.pdf.logicalstructure/blselement/
---
## Clase BLSElement

Representa una clase base para elementos de estructura a nivel de bloque en la estructura lógica.
