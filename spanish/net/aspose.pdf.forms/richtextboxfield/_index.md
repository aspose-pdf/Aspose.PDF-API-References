...
description: Clase Aspose.Pdf.Forms.RichTextBoxField. La clase describe el componente del editor de texto enriquecido
type: docs
weight: 5230
url: /es/net/aspose.pdf.forms/richtextboxfield/
---
## Clase RichTextBoxField
...
| Nombre | Descripción |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Página, Rectángulo) | Constructor para el campo de cuadro de texto enriquecido. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Obtiene o establece el valor de texto enriquecido formateado con marcado. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Obtiene o establece el valor de texto enriquecido. |
...
| [ExportValueToJson](../../aspose.pdf.forms/field/exportvaluetojson/)(Stream, bool) | Exporta el contenido del campo especificado a un flujo JSON. Los valores de los campos de botón no se exportan. |
