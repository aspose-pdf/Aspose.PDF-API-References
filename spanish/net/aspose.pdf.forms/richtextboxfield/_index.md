...
description: La clase describe el componente del editor de texto enriquecido.
type: docs
weight: 3180
url: /es/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField class

La clase describe el componente del editor de texto enriquecido.
...
| Nombre | Descripción |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | Constructor para el campo Cuadro de texto enriquecido. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Obtiene o establece un valor de texto enriquecido formateado con marcado. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Obtiene o establece la justificación del cuadro de texto enriquecido. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue) { get; set; } | Obtiene o establece valor de texto enriquecido. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | Obtiene o establece la cadena de estilo predeterminada del campo de texto enriquecido. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value) { get; set; } | Valor de RichTextField. |
