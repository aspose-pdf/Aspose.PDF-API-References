...
description: Campo para elemento de cuadro de selección de archivo.
type: docs
weight: 3010
url: /es/net/aspose.pdf.forms/fileselectboxfield/
---
## FileSelectBoxField class

Campo para elemento de cuadro de selección de archivo.
