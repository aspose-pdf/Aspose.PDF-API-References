...
description: Clase Aspose.Pdf.Forms.FileSelectBoxField. Campo para el elemento de cuadro de selección de archivos
type: docs
weight: 5060
url: /es/net/aspose.pdf.forms/fileselectboxfield/
---
## Clase FileSelectBoxField

Campo para el elemento de cuadro de selección de archivos.
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtiene o establece el indicador que indica si el campo está dividido en posiciones espaciadas. |
