...
description: Clase Aspose.Pdf.Forms.RadioButtonField. Clase que representa un campo de botón de opción
type: docs
weight: 5210
url: /es/net/aspose.pdf.forms/radiobuttonfield/
---
## Clase RadioButtonField
...
| Nombre | Descripción |
| --- | --- |
| [RadioButtonField](radiobuttonfield/#constructor)(Document) | Constructor para RadioButtonField. |
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Constructor para RadioButtonField |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Obtiene o establece la bandera que permite que el botón de opción no tenga un valor seleccionado. Si `true`, exactamente un botón de opción debe estar seleccionado en todo momento; seleccionar el botón actualmente seleccionado no tiene efecto. Si `false`, hacer clic en el botón seleccionado lo deselecciona, dejando ningún botón seleccionado. |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options/) { get; } | Obtiene la colección de opciones del botón de opción. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Obtiene el índice de la página que contiene este campo RadioButton. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Obtiene o establece el índice del elemento seleccionado. La numeración de los elementos comienza desde 1. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Obtiene o establece un arreglo de elementos seleccionados. Para la lista de multiselección, el arreglo contiene más de un elemento. Para la lista de selección única, contiene un solo elemento. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtiene el diccionario de apariencia de la anotación. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Estilo de la caja del campo. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value/) { get; set; } | Obtiene o establece el valor del campo. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add/)(RadioButtonOptionField) | Agrega un nuevo campo de opción al campo RadioButton |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Agrega una opción al botón de opción. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Agrega al botón de opción con un rectángulo especificado. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Mueve todos los subelementos del botón de opción a las posiciones especificadas en la página. |
