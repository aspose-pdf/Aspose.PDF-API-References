...
description: Clase que representa el campo del botón de opción.
type: docs
weight: 3160
...
Clase que representa el campo del botón de opción.
...
| [RadioButtonField](radiobuttonfield#constructor_1)(Page) | Constructor para RadiouttonField |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | Obtiene o establece el índice del elemento seleccionado. La numeración de artículos se inicia desde 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Estilo de cuadro de campo. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | Agrega un nuevo campo de opción a RadioButton field |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Agregar opción al botón de opción. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | Agregar a la opción del botón de radio con el rectángulo especificado. |
