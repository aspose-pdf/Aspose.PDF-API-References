...
description: Clase Aspose.Pdf.Forms.NumberField. Campo de texto con caracteres válidos especificados
type: docs
weight: 5140
...
| Nombre | Descripción |
| --- | --- |
| [NumberField](numberfield/#constructor)() | Inicializa una nueva instancia de la clase `NumberField`. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | Inicializa una nueva instancia de la clase `NumberField`. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | Inicializa una nueva instancia de la clase `NumberField`. |
...
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtiene o establece el indicador de revisión ortográfica para el campo. Si es verdadero, el campo será revisado ortográficamente. |
