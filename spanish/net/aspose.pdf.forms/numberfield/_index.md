...
description: Campo de texto con caracteres válidos especificados
type: docs
weight: 3090
url: /es/net/aspose.pdf.forms/numberfield/
---
## NumberField class

Campo de texto con caracteres válidos especificados
...
| Nombre | Descripción |
| --- | --- |
| [NumberField](numberfield#constructor)() | Inicializa una nueva instancia del[`NumberField`](../numberfield) clase. |
| [NumberField](numberfield#constructor_1)(Document, Rectangle) | Inicializa una nueva instancia del[`NumberField`](../numberfield) clase. |
| [NumberField](numberfield#constructor_2)(Page, Rectangle) | Inicializa una nueva instancia del[`NumberField`](../numberfield) clase. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars) { get; set; } | Obtiene o establece los caracteres permitidos. |
