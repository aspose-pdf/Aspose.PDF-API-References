...
description: La clase describe el campo de texto para ingresar la contraseña.
type: docs
weight: 3150
url: /es/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField class

La clase describe el campo de texto para ingresar la contraseña.
