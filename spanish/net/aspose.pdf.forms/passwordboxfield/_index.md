...
description: Clase Aspose.Pdf.Forms.PasswordBoxField. La clase describe un campo de texto para ingresar una contraseña
type: docs
weight: 5200
url: /es/net/aspose.pdf.forms/passwordboxfield/
---
## Clase PasswordBoxField

La clase describe un campo de texto para ingresar una contraseña.
...
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Obtiene o establece la bandera de desplazamiento del campo. Si es verdadero, el campo puede desplazarse. |
