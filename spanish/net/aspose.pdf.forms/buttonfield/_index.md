...
| Nombre | Descripción |
| --- | --- |
| [ButtonField](buttonfield#constructor)() | Constructor de campos de botón para Generador. |
| [ButtonField](buttonfield#constructor_1)(Document, Rectangle) | Constructor de ButtonField. |
| [ButtonField](buttonfield#constructor_2)(Page, Rectangle) | Constructor de campo de botones. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | Obtiene o establece un título alternativo del botón que se mostrará cuando se presiona el botón del mouse dentro de su área activa. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | Obtiene o establece un icono alternativo que se mostrará cuando se presione el botón del mouse dentro de su área activa. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | Obtiene el objeto de ajuste de icono que especifica cómo se mostrará el icono de la anotación del widget dentro de su rectángulo de anotación. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition) { get; set; } | Obtiene o establece la posición del título del icono. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | Obtiene o establece el título de rollover del botón que se mostrará cuando el usuario mueva el cursor a su área activa sin presionar el botón del mouse. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | Obtiene o establece el ícono de rollover del botón que se mostrará cuando el usuario mueva el cursor a su área activa sin presionar el botón del mouse. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage)(Image) | Agrega imagen a los recursos de campo y la dibuja. |
