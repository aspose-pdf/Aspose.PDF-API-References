...
description: La clase representa el elemento del campo RadioButton.
type: docs
weight: 3170
...
La clase representa el elemento del campo RadioButton.
...
| Nombre | Descripción |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | Crear nueva instancia de RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | Crea un botón de radio en el rectángulo especificado en la página especificada. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption) { get; set; } | Obtiene o establece caption. |
