...
description: Clase Aspose.Pdf.Forms.RadioButtonOptionField. La clase representa un elemento del campo RadioButton
type: docs
weight: 5220
url: /es/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## Clase RadioButtonOptionField

La clase representa un elemento del campo RadioButton.
...
| Nombre | Descripción |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Crea una nueva instancia de RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Página, Rectángulo) | Crea un radiobutton en el rectángulo especificado en la página especificada. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Obtiene o establece el título. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Obtiene o establece el nombre de la opción. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Obtiene o establece el estilo de la casilla de verificación. |
