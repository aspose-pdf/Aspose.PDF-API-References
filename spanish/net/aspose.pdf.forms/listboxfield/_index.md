...
description: Clase Aspose.Pdf.Forms.ListBoxField. La clase representa el campo ListBox
type: docs
weight: 5130
url: /es/net/aspose.pdf.forms/listboxfield/
---
## Clase ListBoxField
...
| Nombre | Descripción |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | Constructor para ListBoxField que se utilizará en el Generador. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | Constructor para el campo ListBox. |
| [ListBoxField](listboxfield/#constructor_2)(Page, Rectangle) | Crea un nuevo campo ListBox. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | Obtiene o establece el índice del elemento seleccionado. Los elementos se numeran desde 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Obtiene o establece el arreglo de los elementos seleccionados en la lista de multiselección. Para la lista de selección única, devuelve un arreglo con un solo elemento. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Obtiene o establece el índice del elemento visible superior de la lista. |
