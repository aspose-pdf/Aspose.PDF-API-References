...
| Nombre | Descripción |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | Constructor para ListBoxField que se usará en Generator. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | Obtiene o establece el índice del elemento seleccionado. Los artículos están numerados desde 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | Obtiene o establece una matriz de los elementos seleccionados en la lista de selección múltiple. Para una lista de selección única, devuelve una matriz con un solo elemento. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex) { get; set; } | Obtiene o establece el índice del elemento superior visible de la lista. |
