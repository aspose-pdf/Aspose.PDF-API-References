...
description: Clase que representa el campo de casilla de verificación
type: docs
weight: 2930
...
Clase que representa el campo de casilla de verificación
...
| Nombre | Descripción |
| --- | --- |
| [CheckboxField](checkboxfield#constructor)() | Crear instancia de CheckboxField. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate) { get; set; } | Obtiene o establece el estado actual de apariencia de la anotación. |
...
| override [Clone](../../aspose.pdf.forms/checkboxfield/clone)() | Clonar la casilla de verificación. |
