...
description: Clase Aspose.Pdf.Forms.DateField. Campo de fecha con vista de calendario
type: docs
weight: 5010
...
| Nombre | Descripción |
| --- | --- |
| [DateField](datefield/#constructor)() | Inicializa una nueva instancia de `DateField` |
| [DateField](datefield/#constructor_1)(Document) | Constructor que debe ser utilizado con Generator. |
| [DateField](datefield/#constructor_2)(Document, Rectangle) | Inicializa una nueva instancia de `DateField` |
| [DateField](datefield/#constructor_3)(Page, Rectangle) | Inicializa una nueva instancia de `DateField` |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtiene o establece la bandera que indica si el campo está dividido en posiciones espaciadas. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Obtiene o establece la bandera de multilinea del campo. Si Multiline es verdadero, el campo puede contener múltiples líneas de texto. |
...
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Obtiene o establece la bandera desplazable del campo. Si es verdadero, el campo puede desplazarse. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtiene o establece la bandera de verificación ortográfica para el campo. Si es verdadero, el campo será verificado ortográficamente. |
...
| [Value](../../aspose.pdf.forms/datefield/value/) { get; set; } | Obtiene o establece la fecha. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | La adición de imágenes está denegada para este campo. (2 métodos) |
