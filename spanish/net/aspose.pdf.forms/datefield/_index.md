...
description: Campo de fecha con vista de calendario.
type: docs
weight: 2960
url: /es/net/aspose.pdf.forms/datefield/
---
## DateField class

Campo de fecha con vista de calendario.
...
| Nombre | Descripción |
| --- | --- |
| [DateField](datefield#constructor)() | Inicializa una nueva instancia del[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | Constructor que debe usarse con Generator. |
| [DateField](datefield#constructor_2)(Document, Rectangle) | Inicializa una nueva instancia del[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | Inicializa una nueva instancia del[`DateField`](../datefield) |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat) { get; set; } | Obtiene o establece el formato de fecha. |
...
| [Value](../../aspose.pdf.forms/datefield/value) { get; set; } | Obtiene o establece Fecha. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | Adición de imagen denegada para este campo. (2 methods) |
...
| [Init](../../aspose.pdf.forms/datefield/init)(Page) | Inicializa la Acción JS. |
...
DateField dateField = new DateField(página, rect); doc.Form.Add(dateField); dateField.Init(page);
