...
| Nombre | Descripción |
| --- | --- |
| [Field](field)(Document) | Crea un campo para usar en Generator. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | Si es verdadero, el tamaño de fuente se reducirá para ajustar el texto al rectángulo especificado. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Tamaño de fuente Maximail que se puede utilizar para el contenido del campo. -1 para no comprobar el tamaño. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | Tamaño de fuente mínimo que se puede utilizar para el contenido del campo. -1 para no comprobar el tamaño. |
