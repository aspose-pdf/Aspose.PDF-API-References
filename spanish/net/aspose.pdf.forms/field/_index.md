...
description: Clase Aspose.Pdf.Forms.Field. Clase base para campos de formulario acro
type: docs
weight: 5050
url: /es/net/aspose.pdf.forms/field/
---
## Clase Campo
...
| Nombre | Descripción |
| --- | --- |
| [Field](field/)(Document) | Crea un campo para su uso en el Generador. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Si es verdadero, el tamaño de la fuente se reducirá para ajustar el texto al rectángulo especificado. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Tamaño máximo de fuente que se puede utilizar para el contenido del campo. -1 para no verificar el tamaño. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Tamaño mínimo de fuente que se puede utilizar para el contenido del campo. -1 para no verificar el tamaño. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Copia los subcampos de este campo en un arreglo comenzando desde el índice especificado. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Importa datos en los campos especificados desde un flujo JSON, basado en una coincidencia exacta de los nombres completos de los campos. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Importa datos en el campo especificado desde un flujo JSON, utilizando el nombre completo especificado en la variable 'fieldFullNameInJSON' para la coincidencia. |
...
* clase [WidgetAnnotation](../../aspose.pdf.annotations/widgetannotation/)
