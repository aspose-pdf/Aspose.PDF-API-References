...
description: Clase Aspose.Pdf.Forms.ChoiceField. Representa la clase base para campos de elección
type: docs
weight: 4990
url: /es/net/aspose.pdf.forms/choicefield/
---
## Clase ChoiceField

Representa la clase base para campos de elección.
...
| Nombre | Descripción |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Crea un campo de elección (para Generator) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | Constructor para ChoiceField. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | Constructor para ChoiceField. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | Agrega una nueva opción con el nombre especificado. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | Agrega una nueva opción con el valor de exportación y el nombre especificados. |
