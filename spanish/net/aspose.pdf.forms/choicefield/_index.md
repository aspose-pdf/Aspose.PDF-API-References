...
description: Representa la clase base para los campos de elección.
type: docs
weight: 2940
...
Representa la clase base para los campos de elección.
...
| Nombre | Descripción |
| --- | --- |
| [ChoiceField](choicefield#constructor)(Document) | Crea campo de elección (para Generador) |
