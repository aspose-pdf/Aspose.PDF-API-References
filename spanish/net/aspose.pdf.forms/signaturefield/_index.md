...
description: Representa el campo del formulario de firma.
type: docs
weight: 3230
url: /es/net/aspose.pdf.forms/signaturefield/
---
## SignatureField class

Representa el campo del formulario de firma.
...
| Nombre | Descripción |
| --- | --- |
| [SignatureField](signaturefield#constructor)(Document, Rectangle) | Inicializa una nueva instancia del[`SignatureField`](../signaturefield) clase. |
| [SignatureField](signaturefield#constructor_1)(Page, Rectangle) | Inicializa una nueva instancia del[`SignatureField`](../signaturefield) clase. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature) { get; } | Obtiene el objeto de firma. Este objeto contiene datos de firma sobre estándares criptográficos de clave pública. Clases[`PKCS1`](../pkcs1) ,[`PKCS7`](../pkcs7) y[`PKCS7Detached`](../pkcs7detached) representan todos los tipos admitidos de objetos de firma. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate)() | Extrae el certificado único X.509 en formato DER como una secuencia. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage)() | Extrae la imagen de la firma como secuencia codificada en jpeg. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage_1)(ImageFormat) | Extrae la imagen de la firma como flujo codificado. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign)(Signature) | Firme el documento utilizando este campo de firma. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign_1)(Signature, Stream, string) | Firma el documento usando este campo de firma. |
