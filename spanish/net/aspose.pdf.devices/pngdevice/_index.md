...
description: Clase Aspose.Pdf.Devices.PngDevice. Representa un dispositivo de imagen que ayuda a guardar las páginas del documento pdf en png
type: docs
weight: 3650
...
| Nombre | Descripción |
| --- | --- |
| [PngDevice](pngdevice/#constructor)() | Inicializa una nueva instancia de la clase `PngDevice` con resolución predeterminada. |
| [PngDevice](pngdevice/#constructor_2)(PageSize) | Inicializa una nueva instancia de la clase `PngDevice` con el tamaño de página proporcionado, resolución predeterminada (=150). |
| [PngDevice](pngdevice/#constructor_1)(Resolution) | Inicializa una nueva instancia de la clase `PngDevice`. Resolución para el archivo de imagen resultante, ver clase [`Resolution`](../resolution/). |
| [PngDevice](pngdevice/#constructor_4)(int, int) | Inicializa una nueva instancia de la clase `PngDevice` con las dimensiones de imagen proporcionadas, resolución predeterminada (=150). |
| [PngDevice](pngdevice/#constructor_3)(PageSize, Resolution) | Inicializa una nueva instancia de la clase `PngDevice` con el tamaño de página y la resolución proporcionados. |
| [PngDevice](pngdevice/#constructor_5)(int, int, Resolution) | Inicializa una nueva instancia de la clase `PngDevice` con las dimensiones de imagen y la resolución proporcionadas. |
...
| [TransparentBackground](../../aspose.pdf.devices/pngdevice/transparentbackground/) { get; set; } | Obtiene o establece si la imagen tiene un fondo transparente. |
