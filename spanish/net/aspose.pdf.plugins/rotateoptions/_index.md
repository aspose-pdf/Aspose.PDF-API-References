...
description: Clase Aspose.Pdf.Plugins.RotateOptions. Representa opciones de rotación para el plugin Optimizer
type: docs
weight: 9210
url: /es/net/aspose.pdf.plugins/rotateoptions/
---
## Clase RotateOptions

Representa opciones de rotación para el plugin [`Optimizer`](../optimizer/).
...
| Nombre | Descripción |
| --- | --- |
| [RotateOptions](rotateoptions/)() | El constructor por defecto. |
...
| [Rotation](../../aspose.pdf.plugins/rotateoptions/rotation/) { get; set; } | Obtiene o establece la nueva rotación de las páginas. |
