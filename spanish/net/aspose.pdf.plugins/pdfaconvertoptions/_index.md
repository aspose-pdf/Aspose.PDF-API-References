...
description: Clase Aspose.Pdf.Plugins.PdfAConvertOptions. Representa opciones para convertir documentos PDF al formato PDF/A con el plugin PdfAConverter
type: docs
weight: 8990
url: /es/net/aspose.pdf.plugins/pdfaconvertoptions/
---
## Clase PdfAConvertOptions

Representa opciones para convertir documentos PDF al formato PDF/A con el [`PdfAConverter`](../pdfaconverter/) plugin.
...
| Nombre | Descripción |
| --- | --- |
| [PdfAConvertOptions](pdfaconvertoptions/)() | El constructor por defecto. |
...
| [NonSpecificationFlags](../../aspose.pdf.plugins/pdfaoptionsbase/nonspecificationflags/) { get; } | Obtiene las banderas que controlan la conversión a PDF/A para casos en los que el documento PDF de origen no corresponde a la especificación PDF. |
...
| [Outputs](../../aspose.pdf.plugins/pdfaconvertoptions/outputs/) { get; } | Obtiene la colección de destinos añadidos (fuentes de datos de archivo o flujo) para guardar los resultados de la operación. |
...
| [SymbolicFontEncodingStrategy](../../aspose.pdf.plugins/pdfaoptionsbase/symbolicfontencodingstrategy/) { get; set; } | Obtiene o establece la estrategia para codificar fuentes simbólicas al convertir al formato PDF/A. |
...
| [AddOutput](../../aspose.pdf.plugins/pdfaconvertoptions/addoutput/)(IDataSource) | Agrega un nuevo destino de guardado de resultados. |

### Ver También

* clase [PdfAOptionsBase](../pdfaoptionsbase/)
