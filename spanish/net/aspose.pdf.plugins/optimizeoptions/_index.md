...
description: Clase Aspose.Pdf.Plugins.OptimizeOptions. Representa opciones de optimización para el plugin Optimizer
type: docs
weight: 8960
url: /es/net/aspose.pdf.plugins/optimizeoptions/
---
## Clase OptimizeOptions

Representa opciones de optimización para el plugin [`Optimizer`](../optimizer/).
...
| Nombre | Descripción |
| --- | --- |
| [OptimizeOptions](optimizeoptions/)() | El constructor por defecto. |
