...
description: Clase Aspose.Pdf.Plugins.PdfAValidateOptions. Representa opciones para validar la conformidad PDF/A de documentos PDF con el complemento PdfAConverter
type: docs
weight: 9030
url: /es/net/aspose.pdf.plugins/pdfavalidateoptions/
---
## Clase PdfAValidateOptions

Representa opciones para validar la conformidad PDF/A de documentos PDF con el complemento [`PdfAConverter`](../pdfaconverter/).
...
| Nombre | Descripción |
| --- | --- |
| [PdfAValidateOptions](pdfavalidateoptions/)() | El constructor predeterminado. |
