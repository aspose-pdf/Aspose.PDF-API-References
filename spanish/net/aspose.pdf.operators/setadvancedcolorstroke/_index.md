...
description: Clase que representa al operador SCN establece el color para las operaciones de trazado.
type: docs
weight: 5330
...
Clase que representa al operador SCN (establece el color para las operaciones de trazado).
...
| Nombre | Descripción |
| --- | --- |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor)() | Inicializa operador. |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor_1)(double) | Constructor para operador scn |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor_4)(double, string) | Constructor para el operador scn. |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor_3)(double, double, double, string) | Constructor para operador scn. |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor_2)(double, double, double, double, string) | Constructor para operador scn. |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/setadvancedcolorstroke/accept)(IOperatorSelector) | Acepta objeto visitante para procesar operador. |
