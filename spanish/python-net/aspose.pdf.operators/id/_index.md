...
description: "Clase que representa el operador ID (Iniciar datos de imagen en línea)."
type: docs
weight: 340
url: /es/python-net/aspose.pdf.operators/id/
---

## ID class

Clase que representa el operador ID (Iniciar datos de imagen en línea).

El tipo ID expone los siguientes miembros:
## Propiedades
| Nombre | Descripción |
| :- | :- |
