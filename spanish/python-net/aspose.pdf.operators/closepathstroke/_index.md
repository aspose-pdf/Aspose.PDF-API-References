...
description: "Clase que representa el operador s (Close and stroke path)."
type: docs
weight: 130
url: /es/python-net/aspose.pdf.operators/closepathstroke/
---

## ClosePathStroke class

Clase que representa el operador s (Close and stroke path).

El tipo ClosePathStroke expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ClosePathStroke() | Inicializa el operador. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
