...
description: "Clase que representa el operador n (finalizar la ruta sin rellenar ni trazar)."
type: docs
weight: 270
url: /es/python-net/aspose.pdf.operators/endpath/
---

## EndPath class

Clase que representa el operador n (finalizar la ruta sin rellenar ni trazar).

El tipo EndPath expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| EndPath() | Inicializa el operador. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
