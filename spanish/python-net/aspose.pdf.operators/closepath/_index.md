...
description: "Clase que representa el operador h (close path)."
type: docs
weight: 100
url: /es/python-net/aspose.pdf.operators/closepath/
---

## ClosePath class

Clase que representa el operador h (close path).

El tipo ClosePath expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ClosePath() | Inicializa el operador. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
