...
description: "Clase que representa el operador W (set clipping path using non-zero winding rule)."
type: docs
weight: 90
url: /es/python-net/aspose.pdf.operators/clip/
---

## Clip class

Clase que representa el operador W (set clipping path using non-zero winding rule).

El tipo Clip expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| Clip() | Inicializa el operador. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
