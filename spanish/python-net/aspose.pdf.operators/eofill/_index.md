...
description: "Clase que representa el operador f* (rellenar la ruta usando la regla par-impar)."
type: docs
weight: 230
url: /es/python-net/aspose.pdf.operators/eofill/
---

## EOFill class

Clase que representa el operador f* (rellenar la ruta usando la regla par-impar).

El tipo EOFill expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| EOFill() | Inicializa el operador. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
