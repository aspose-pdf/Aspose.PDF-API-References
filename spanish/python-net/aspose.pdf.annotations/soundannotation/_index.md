...
type: docs
weight: 740
url: /es/python-net/aspose.pdf.annotations/soundannotation/
---
...
El tipo SoundAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Inicializa una nueva instancia de la clase SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Inicializa una nueva instancia de la clase SoundAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| sound_data | Obtiene un objeto de sonido que define el sonido a reproducir cuando se activa la anotación. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
