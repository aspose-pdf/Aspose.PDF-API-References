...
description: "Representa un enlace hipertexto a un destino en otra parte del documento o una acción a realizar."
type: docs
weight: 390
url: /es/python-net/aspose.pdf.annotations/linkannotation/
---

## LinkAnnotation class

Representa un enlace hipertexto a un destino en otra parte del documento o una acción a realizar.

El tipo LinkAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| LinkAnnotation(page, rect) | Inicializa una nueva instancia de la clase LinkAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| action | Una acción a realizar cuando la anotación de enlace se activa. |
| destino | Un destino a mostrar cuando la anotación se activa. |
| resaltado | El efecto visual a usar cuando se presiona o mantiene pulsado el botón del ratón dentro de su área activa. |
## Métodos
| Nombre | Descripción |
| :- | :- |
