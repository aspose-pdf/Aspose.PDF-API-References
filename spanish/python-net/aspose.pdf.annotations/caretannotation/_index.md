...
type: docs
weight: 80
url: /es/python-net/aspose.pdf.annotations/caretannotation/
---
...
El tipo CaretAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| CaretAnnotation(document) | Inicializa una nueva instancia de la clase CaretAnnotation |
| CaretAnnotation(page, rect) | Inicializa una nueva instancia de la clase CaretAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| marco | Obtiene o establece el rectángulo del cursor. |
| símbolo | Obtiene o establece el símbolo asociado al cursor. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
