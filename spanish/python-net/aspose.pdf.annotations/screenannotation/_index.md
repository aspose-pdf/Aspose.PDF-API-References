...
type: docs
weight: 720
url: /es/python-net/aspose.pdf.annotations/screenannotation/
---
...
El tipo ScreenAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | Inicializa una nueva instancia de la clase ScreenAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| title | Obtiene o establece el título de la anotación de pantalla. |
| action | Obtiene o establece una acción que se ejecutará cuando la anotación se active. |
## Métodos
| Nombre | Descripción |
| :- | :- |
