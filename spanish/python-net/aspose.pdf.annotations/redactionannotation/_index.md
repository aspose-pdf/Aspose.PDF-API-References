...
description: "Representa la anotación de Redacción."
type: docs
weight: 680
url: /es/python-net/aspose.pdf.annotations/redactionannotation/
---
...
El tipo RedactionAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| RedactionAnnotation(document) | Inicializa una nueva instancia de la clase RedactionAnnotation |
| RedactionAnnotation(page, rect) | Inicializa una nueva instancia de la clase RedactionAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| quad_point | Una matriz de números 8xN que especifica las coordenadas de la región de contenido que se pretende eliminar. |
| default_appearance | Obtiene o establece la cadena de apariencia predeterminada que se usará al formatear el texto. |
| fill_color | Obtiene o establece el color para rellenar la anotación. |
| border_color | Obtiene o establece el color del borde que se dibuja cuando la redacción no está activa. |
| overlay_text | Texto para imprimir en la anotación de redacción. |
| repeat | Si es verdadero, el texto superpuesto se repetirá en la anotación. |
| text_alignment | Obtiene o establece. Alineación del texto superpuesto. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
...
| flatten() | Aplana la anotación, es decir, elimina la anotación y agrega su |
| change_after_resize(transform) | Actualiza los parámetros y la apariencia, según la transformación de la matriz. |
| redact() | Aplana la anotación y redacta el contenido de la página (es decir, elimina texto e imagen bajo la anotación redactada) |
