...
description: "La clase describe la anotación de adjunto de archivo."
type: docs
weight: 170
url: /es/python-net/aspose.pdf.annotations/fileattachmentannotation/
---

## FileAttachmentAnnotation class

La clase describe la anotación de adjunto de archivo.

El tipo FileAttachmentAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | Inicializa una nueva instancia de la clase FileAttachmentAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| opacity | Obtiene o establece la opacidad del ícono de 0 a 1: 0 - completamente transparente, 1 - completamente opaco. |
...
| file | La especificación del archivo asociado con esta anotación. |
| icon | Obtiene o establece el ícono que se utilizará al mostrar la anotación. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
