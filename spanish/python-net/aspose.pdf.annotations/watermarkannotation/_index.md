...
description: "Clase que describe el objeto de anotación de marca de agua."
type: docs
weight: 860
url: /es/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Clase que describe el objeto de anotación de marca de agua.

El tipo WatermarkAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| WatermarkAnnotation(page, rect) | Inicializa una nueva instancia de la clase WatermarkAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| fixed_print | Objeto de impresión fija de la anotación Watermark. |
| opacity | Obtiene o establece la opacidad de la anotación. |
## Métodos
| Nombre | Descripción |
| :- | :- |
...
| accept(visitor) | Aplica un visitante a la anotación. |
...
| set_text(text) | Establece el texto de la anotación. |
| set_text_and_state(text, text_state) | Establece el texto de la anotación. |
