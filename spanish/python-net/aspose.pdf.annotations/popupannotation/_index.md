...
type: docs
weight: 670
url: /es/python-net/aspose.pdf.annotations/popupannotation/
---
...
El tipo PopupAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PopupAnnotation(document) | Inicializa una nueva instancia de la clase PopupAnnotation |
| PopupAnnotation(page, rect) | Inicializa una nueva instancia de la clase PopupAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| abrir | Obtiene o establece una bandera que indica si la anotación emergente debe mostrarse inicialmente abierta. |
| padre | Obtiene o establece la anotación principal con la que esta anotación emergente debe estar asociada.<br/>            Si esta entrada está presente, los campos Contents, M, C y T de la anotación principal sobrescribirán los de la propia anotación emergente. |
## Métodos
| Nombre | Descripción |
| :- | :- |
