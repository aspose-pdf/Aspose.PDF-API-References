...
description: "Representa la anotación ondulada que aparece como un subrayado irregular en el texto de un documento."
type: docs
weight: 780
url: /es/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

Representa la anotación ondulada que aparece como un subrayado irregular en el texto de un documento.

El tipo SquigglyAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| SquigglyAnnotation(page, rect) | Inicializa una nueva instancia de la clase SquigglyAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| quad_points | Obtiene o establece una matriz de puntos que especifican las coordenadas de n cuadriláteros. Cada cuadrilátero abarca una palabra o un grupo de palabras contiguas en el texto subyacente a la anotación. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
...
| flatten() | Ninguno |
| change_after_resize(transform) | Actualiza los QuadPoints, de acuerdo con la transformación matricial. |
| get_marked_text() | Obtiene el texto bajo la anotación de marcado como cadena. |
| get_marked_text_fragments() | Obtiene el texto bajo la anotación de marcado como [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/). |
