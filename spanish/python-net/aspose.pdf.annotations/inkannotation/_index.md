...
type: docs
weight: 350
url: /es/python-net/aspose.pdf.annotations/inkannotation/
---
...
El tipo InkAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| InkAnnotation(document, ink_list) | Inicializa una nueva instancia de la clase InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Inicializa una nueva instancia de la clase InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Inicializa una nueva instancia de la clase InkAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| cap_style | Estilo de los finales de línea de la anotación de tinta. |
| ink_list | Obtiene o establece la lista de gestos que son líneas independientes representadas por matrices Point[]. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
...
| change_after_resize(transform) | Actualiza los puntos en InkList, según la transformación de la matriz. |
