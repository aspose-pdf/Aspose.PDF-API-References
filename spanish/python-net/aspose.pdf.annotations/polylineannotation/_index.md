...
description: "Representa una anotación de polilínea que es similar a un polígono, excepto que el primer y último vértice no están conectados implícitamente."
type: docs
weight: 660
url: /es/python-net/aspose.pdf.annotations/polylineannotation/
---
...
El tipo PolylineAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PolylineAnnotation(page, rect, vertices) | Inicializa una nueva instancia de la clase PolylineAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
