...
description: "Representa una anotación de resaltado que destaca un rango de texto en el documento."
type: docs
weight: 310
url: /es/python-net/aspose.pdf.annotations/highlightannotation/
---

## HighlightAnnotation class

Representa una anotación de resaltado que destaca un rango de texto en el documento.

El tipo HighlightAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| HighlightAnnotation(page, rect) | Inicializa una nueva instancia de la clase HighlightAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
