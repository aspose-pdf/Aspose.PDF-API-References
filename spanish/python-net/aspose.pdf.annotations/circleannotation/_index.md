...
description: "Clase que representa una anotación de círculo."
type: docs
weight: 100
url: /es/python-net/aspose.pdf.annotations/circleannotation/
---

## CircleAnnotation class

Clase que representa una anotación de círculo.

El tipo CircleAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| CircleAnnotation(document) | Inicializa una nueva instancia de la clase CircleAnnotation |
| CircleAnnotation(page, rect) | Inicializa una nueva instancia de la clase CircleAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| interior_color | Color interior con el que rellenar el rectángulo o elipse de la anotación. |
| marco | El rectángulo que describe las diferencias numéricas entre dos rectángulos:<br/>            la entrada Rect de la anotación y los límites reales del cuadrado o círculo subyacente. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Ninguno |
