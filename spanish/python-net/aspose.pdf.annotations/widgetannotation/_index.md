...
type: docs
weight: 870
url: /es/python-net/aspose.pdf.annotations/widgetannotation/
---
...
El tipo WidgetAnnotation expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| WidgetAnnotation(doc) | Inicializa una nueva instancia de la clase WidgetAnnotation |
## Propiedades
| Nombre | Descripción |
| :- | :- |
