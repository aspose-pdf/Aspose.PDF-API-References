...
description: "Esta clase representa opciones de guardado que <br/>            utiliza una forma de conversión unificada (con un modelo interno de documento unificado)"
type: docs
weight: 1590
url: /es/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Esta clase representa opciones de guardado que <br/>            utiliza una forma de conversión unificada (con un modelo interno de documento unificado)

El tipo UnifiedSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| UnifiedSaveOptions() | Inicializa una nueva instancia de la clase UnifiedSaveOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
