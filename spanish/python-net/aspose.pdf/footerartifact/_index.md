...
description: "Describe el artefacto de pie de página. Esto puede usarse para establecer el pie de página de la página."
type: docs
weight: 400
url: /es/python-net/aspose.pdf/footerartifact/
---

## FooterArtifact class

Describe el artefacto de pie de página. Esto puede usarse para establecer el pie de página de la página.

El tipo FooterArtifact expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| FooterArtifact() | Crea una instancia de Footer Artifact. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
