...
description: "Opciones de guardado para el formato PdfXml."
type: docs
weight: 1260
url: /es/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
El tipo PdfXmlSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PdfXmlSaveOptions() | Inicializa una nueva instancia de la clase PdfXmlSaveOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
