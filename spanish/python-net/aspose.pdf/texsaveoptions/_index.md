...
type: docs
weight: 1540
url: /es/python-net/aspose.pdf/texsaveoptions/
---
...
El tipo TeXSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| TeXSaveOptions() | Inicializa una nueva instancia de la clase TeXSaveOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
