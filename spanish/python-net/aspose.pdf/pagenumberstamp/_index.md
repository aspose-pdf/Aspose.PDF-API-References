...
type: docs
weight: 1140
url: /es/python-net/aspose.pdf/pagenumberstamp/
---
...
El tipo PageNumberStamp expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PageNumberStamp(format) | Inicializa una nueva instancia de la clase PageNumberStamp |
| PageNumberStamp() | Inicializa una nueva instancia de la clase [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/). El formato se establece en "#". |
| PageNumberStamp(formatted_text) | Inicializa una nueva instancia de la clase PageNumberStamp |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| formato | Valor de cadena para estampar números de página. <br/>            El valor debe incluir el carácter '#' que se reemplaza con el número de página durante el proceso de estampado. |
| starting_number | Obtiene o establece el valor del número de la página inicial. Las demás páginas se numerarán a partir de este valor. |
| numbering_style | Estilo de numeración que utiliza este sello. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| put(page) | Agrega número de página. |
