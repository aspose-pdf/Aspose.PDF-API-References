...
description: "Opciones de guardado para exportar al formato Xml"
type: docs
weight: 960
url: /es/python-net/aspose.pdf/mobixmlsaveoptions/
---

## MobiXmlSaveOptions class

Opciones de guardado para exportar al formato Xml

El tipo MobiXmlSaveOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| MobiXmlSaveOptions() | Inicializa una nueva instancia de la clase MobiXmlSaveOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
