...
type: docs
weight: 1310
url: /es/python-net/aspose.pdf/psloadoptions/
---
...
El tipo PsLoadOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PsLoadOptions() | Inicializa una nueva instancia de la clase PsLoadOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| fonts_folders | Obtiene o establece las rutas de las carpetas de fuentes. |
