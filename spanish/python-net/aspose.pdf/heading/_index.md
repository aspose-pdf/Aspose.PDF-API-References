...
type: docs
weight: 460
url: /es/python-net/aspose.pdf/heading/
---
...
El tipo Heading expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| Heading(level) | Inicializa una nueva instancia de la clase Heading |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| toc_page | Obtiene la página que contiene este encabezado. |
| top | Obtiene la coordenada Y superior de este encabezado. |
| start_number | Obtiene el número de inicio del encabezado. |
| is_auto_sequence | Obtiene si el encabezado debe numerarse automáticamente. |
| is_in_list | Obtiene si el encabezado debe estar en la lista del índice. |
| destination_page | Obtiene la página de destino. |
| nivel | Obtiene el nivel. |
| style | Obtiene o establece el estilo. |
| user_label | Obtiene o establece la etiqueta de usuario. |
## Métodos
| Nombre | Descripción |
| :- | :- |
| clone() | Clona el encabezado. |
...
| clone_with_segments() | Clona el encabezado con todos los segmentos. |
