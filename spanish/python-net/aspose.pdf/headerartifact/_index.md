...
description: "Clase que describe el artefacto Heaader. Este artefacto puede usarse para establecer el encabezado de la página."
type: docs
weight: 440
url: /es/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

Clase que describe el artefacto Heaader. Este artefacto puede usarse para establecer el encabezado de la página.

El tipo HeaderArtifact expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| HeaderArtifact() | Crea una instancia de Header Artifact. |
## Propiedades
| Nombre | Descripción |
| :- | :- |
