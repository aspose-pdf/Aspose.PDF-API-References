...
description: "Clase describe el artefacto de fondo. Este artefacto permite establecer el fondo de la página."
type: docs
weight: 50
url: /es/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Clase describe el artefacto de fondo. Este artefacto permite establecer el fondo de la página.

El tipo BackgroundArtifact expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
...
| background_color | Obtiene o establece el color de fondo del artefacto de fondo. |
| background_image | Obtiene o establece la imagen de fondo del artefacto de fondo. |
## Métodos
| Nombre | Descripción |
| :- | :- |
