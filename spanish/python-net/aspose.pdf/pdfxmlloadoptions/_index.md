...
description: "Opciones de carga para el formato PdfXml."
type: docs
weight: 1250
url: /es/python-net/aspose.pdf/pdfxmlloadoptions/
---

## PdfXmlLoadOptions class

Opciones de carga para el formato PdfXml.

El tipo PdfXmlLoadOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PdfXmlLoadOptions() | Inicializa una nueva instancia de la clase PdfXmlLoadOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
