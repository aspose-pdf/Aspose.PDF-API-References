...
description: "Representa un fragmento formateado abstracto."
type: docs
weight: 410
url: /es/python-net/aspose.pdf/formattedfragment/
---
...
El tipo FormattedFragment expone los siguientes miembros:
## Propiedades
| Nombre | Descripción |
| :- | :- |
