...
description: "Opciones de carga para la conversión al formato Markdown."
type: docs
weight: 920
url: /es/python-net/aspose.pdf/mdloadoptions/
---

## MdLoadOptions class

Opciones de carga para la conversión al formato Markdown.

El tipo MdLoadOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| MdLoadOptions() | Inicializa una nueva instancia de la clase MdLoadOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
