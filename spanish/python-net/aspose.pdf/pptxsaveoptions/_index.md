...
type: docs
weight: 1290
url: /es/python-net/aspose.pdf/pptxsaveoptions/
---
...
| Nombre | Descripción |
| :- | :- |
| PptxSaveOptions() | Inicializa una nueva instancia de la clase PptxSaveOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| slides_as_images | Si se establece en true, todo el contenido se reconoce como imágenes (una por página) |
| image_resolution | Obtiene o establece la resolución de imagen (dpi). El valor predeterminado es 192 dpi. |
| separate_images | Si se establece en true, las imágenes se separan de todos los demás gráficos |
| optimize_text_boxes | Alterna el reconocimiento de columnas de texto |
