...
type: docs
weight: 820
url: /es/python-net/aspose.pdf/latexloadoptions/
---
...
El tipo LatexLoadOptions expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| LatexLoadOptions() | Inicializa una nueva instancia de la clase LatexLoadOptions |
## Propiedades
| Nombre | Descripción |
| :- | :- |
