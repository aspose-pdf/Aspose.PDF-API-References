...
description: "Clase representa el objeto PDF Artifact."
type: docs
weight: 30
url: /es/python-net/aspose.pdf/artifact/
---

## Artifact class

Clase representa el objeto PDF Artifact.

El tipo Artifact expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| Artifact(type, sub_type) | Inicializa una nueva instancia de la clase Artifact |
| Artifact(type, sub_type) | Inicializa una nueva instancia de la clase Artifact |
## Propiedades
| Nombre | Descripción |
| :- | :- |
