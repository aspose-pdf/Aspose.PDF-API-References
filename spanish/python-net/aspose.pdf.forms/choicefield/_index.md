...
description: "Representa la clase base para campos de selección."
type: docs
weight: 40
url: /es/python-net/aspose.pdf.forms/choicefield/
---
...
El tipo ChoiceField expone los siguientes miembros:
## Propiedades
| Nombre | Descripción |
| :- | :- |
