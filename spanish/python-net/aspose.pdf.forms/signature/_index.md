...
description: "Una clase abstracta que representa el objeto de firma en el documento pdf. <br/>            Las firmas son campos con valores de objetos de firma, los cuales contienen datos que se utilizan para<br/>            verificar la validez del documento."
type: docs
weight: 250
url: /es/python-net/aspose.pdf.forms/signature/
---

## Signature class

Una clase abstracta que representa el objeto de firma en el documento pdf. <br/>            Las firmas son campos con valores de objetos de firma, los cuales contienen datos que se utilizan para<br/>            verificar la validez del documento.

El tipo Signature expone los siguientes miembros:
## Propiedades
| Nombre | Descripción |
| :- | :- |
