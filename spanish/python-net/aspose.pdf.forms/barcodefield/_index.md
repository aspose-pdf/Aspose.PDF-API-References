...
type: docs
weight: 10
url: /es/python-net/aspose.pdf.forms/barcodefield/
---
...
El tipo BarcodeField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| BarcodeField(page, rect) | Inicializa una nueva instancia de la clase BarcodeField |
| BarcodeField(doc, rect) | Inicializa una nueva instancia de la clase BarcodeField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| resolution | Obtiene la resolución, en puntos por pulgada (dpi), a la que se renderiza el objeto de código de barras. |
| caption | Obtiene el título del objeto de código de barras. |
| symbology | Especifica qué tecnología de código de barras o glifo se debe usar en esta anotación,<br/>            vea [symbology](/pdf/python-net/aspose.pdf.forms/barcodefield/) para más detalles. |
| x_sym_width | Obtiene la distancia horizontal, en píxeles, entre dos módulos de código de barras. |
| x_sym_height | Obtiene la distancia vertical entre dos módulos de código de barras, medida en píxeles. <br/>            La razón XSymHeight/XSymWidth debe ser un valor entero. <br/>            Para PDF417, el rango aceptable de la razón es de 1 a 4. Para QRCode y DataMatrix, <br/>            esta razón debe ser siempre 1 |
| ecc | Obtiene un valor entero que representa el coeficiente de corrección de errores. <br/>            Para PDF417, debe estar entre 0 y 8. Para QRCode, debe estar entre 0 y 3 <br/>            (0 para �L�, 1 para �M�, 2 para �Q�, y 3 para �H�). |
## Indexer
| Nombre | Descripción |
| :- | :- |
