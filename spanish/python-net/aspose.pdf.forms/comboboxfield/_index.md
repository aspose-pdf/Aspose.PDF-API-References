...
description: "Clase que representa un campo de cuadro combinado del formulario."
type: docs
weight: 50
url: /es/python-net/aspose.pdf.forms/comboboxfield/
---
...
El tipo ComboBoxField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| ComboBoxField() | Constructor de ComboBoxField para ser usado en Generator. |
| ComboBoxField(doc) | Inicializa una nueva instancia de la clase ComboBoxField |
| ComboBoxField(page, rect) | Inicializa una nueva instancia de la clase ComboBoxField |
| ComboBoxField(doc, rect) | Inicializa una nueva instancia de la clase ComboBoxField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| selected | Obtiene o establece el índice de la opción seleccionada. Esta propiedad permite cambiar la selección. |
...
| editable | Obtiene o establece el estado editable del campo. |
| spell_check | Obtiene o establece el estado de la actividad de spellchaeck. |
## Indexer
| Nombre | Descripción |
| :- | :- |
