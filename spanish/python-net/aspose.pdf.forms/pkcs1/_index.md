...
description: "Representa el objeto de firma según el estándar PKCS#1.<br/>            Se utilizan el algoritmo de cifrado RSA y el método de resumen SHA-1 para la firma."
type: docs
weight: 180
url: /es/python-net/aspose.pdf.forms/pkcs1/
---

## PKCS1 class

Representa el objeto de firma según el estándar PKCS#1.<br/>            Se utilizan el algoritmo de cifrado RSA y el método de resumen SHA-1 para la firma.

El tipo PKCS1 expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| PKCS1(image) | Inicializa una nueva instancia de la clase PKCS1 |
| PKCS1() | Inicializa una nueva instancia de la clase [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/). |
| PKCS1(pfx, password) | Inicializa una nueva instancia de la clase PKCS1 |
| PKCS1(pfx, password) | Inicializa una nueva instancia de la clase PKCS1 |
## Propiedades
| Nombre | Descripción |
| :- | :- |
