...
description: "Clase que describe el campo de texto para introducir la contraseña."
type: docs
weight: 210
url: /es/python-net/aspose.pdf.forms/passwordboxfield/
---

## PasswordBoxField class

Clase que describe el campo de texto para introducir la contraseña.

El tipo PasswordBoxField expone los siguientes miembros:
## Propiedades
| Nombre | Descripción |
| :- | :- |
