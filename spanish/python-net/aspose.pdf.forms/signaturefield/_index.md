...
description: "Representa el campo de formulario de firma."
type: docs
weight: 270
url: /es/python-net/aspose.pdf.forms/signaturefield/
---
...
El tipo SignatureField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| SignatureField(page, rect) | Inicializa una nueva instancia de la clase SignatureField |
| SignatureField(doc, rect) | Inicializa una nueva instancia de la clase SignatureField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| signature | Obtiene el objeto de firma.<br/>            Este objeto contiene datos de firma relacionados con los estándares criptográficos de clave pública.<br/>            Las clases [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/), [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) y [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) <br/>            representan todos los tipos de objetos de firma admitidos. |
## Indexer
| Nombre | Descripción |
| :- | :- |
...
| Nombre | Descripción |
| :- | :- |
| sign(signature, pfx, pass) | Firma el documento usando este campo de firma. |
| sign(signature) | Firma el documento usando este campo de firma. |
| extract_image() | Extrae la imagen de la firma como flujo codificado en jpeg. |
| extract_image(format) | Extrae la imagen de la firma como flujo codificado. |
| clone() | Ninguno |
...
| extract_certificate() | Extrae el único certificado X.509 en formato DER como un flujo. |
