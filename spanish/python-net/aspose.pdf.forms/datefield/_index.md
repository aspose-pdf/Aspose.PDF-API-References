...
type: docs
weight: 60
url: /es/python-net/aspose.pdf.forms/datefield/
---
...
El tipo DateField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| DateField() | Inicializa una nueva instancia de [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Inicializa una nueva instancia de la clase DateField |
| DateField(page, rect) | Inicializa una nueva instancia de la clase DateField |
| DateField(doc, rect) | Inicializa una nueva instancia de la clase DateField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| value | Obtiene o establece la fecha. |
...
| date_format | Obtiene o establece el formato de fecha. |
## Indexer
| Nombre | Descripción |
| :- | :- |
...
| Nombre | Descripción |
| :- | :- |
| add_image(image) | Se denegó la adición de imagen para este campo. |
| add_image(image) | Se denegó la adición de imagen para este campo. |
| clone() | Ninguno |
...
| init(page) | Inicializa la acción JS. |
