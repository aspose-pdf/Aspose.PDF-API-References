...
type: docs
weight: 150
url: /es/python-net/aspose.pdf.forms/numberfield/
---
...
El tipo NumberField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| NumberField() | Inicializa una nueva instancia de la clase [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/). |
| NumberField(page, rect) | Inicializa una nueva instancia de la clase NumberField |
| NumberField(doc, rect) | Inicializa una nueva instancia de la clase NumberField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| allowed_chars | Obtiene o establece los caracteres permitidos. |
## Indexer
| Nombre | Descripción |
| :- | :- |
