...
type: docs
weight: 30
url: /es/python-net/aspose.pdf.forms/checkboxfield/
---
...
El tipo CheckboxField expone los siguientes miembros:
## Constructores
| Nombre | Descripción |
| :- | :- |
| CheckboxField(page, rect) | Inicializa una nueva instancia de la clase CheckboxField |
| CheckboxField(doc, rect) | Inicializa una nueva instancia de la clase CheckboxField |
| CheckboxField() | Crear instancia de CheckboxField. |
| CheckboxField(doc) | Inicializa una nueva instancia de la clase CheckboxField |
## Propiedades
| Nombre | Descripción |
| :- | :- |
...
| value | Obtiene o establece el valor del campo de casilla de verificación. |
...
| allowed_states | Devuelve una lista de estados permitidos. |
| style | Obtiene o establece el estilo de la casilla de verificación. |
| checked | Obtiene o establece el estado de la casilla de verificación. |
| export_value | Obtiene o establece el valor de exportación del campo CheckBox. |
## Indexer
| Nombre | Descripción |
| :- | :- |
...
| Nombre | Descripción |
| :- | :- |
| clone() | Clona la casilla de verificación. |
