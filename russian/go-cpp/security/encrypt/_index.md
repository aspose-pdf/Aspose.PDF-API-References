...
description: "Зашифровать PDF-документ."
type: docs
url: /ru/go-cpp/security/encrypt/
---

_Зашифровать PDF-документ._
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) шифрует PDF-документ
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
