...
type: docs
url: /ru/go-cpp/security/signpkcs7/
---

_Подписать PDF-документ с использованием цифровой подписи PKCS#7._
...
func main() {
	...
	// SignPKCS7 подписывает PDF-документ с использованием цифровой подписи PKCS#7
