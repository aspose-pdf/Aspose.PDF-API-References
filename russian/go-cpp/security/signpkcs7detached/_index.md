...
type: docs
url: /ru/go-cpp/security/signpkcs7detached/
---

_Подписать PDF-документ с использованием цифровой подписи PKCS#7 Detached._
...
func main() {
	...
	// SignPKCS7Detached подписывает PDF-документ с использованием цифровой подписи PKCS#7 Detached
