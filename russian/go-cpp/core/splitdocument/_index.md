...
description: "Создать несколько новых PDF-documents, извлекая страницы из исходного PDF-document."
type: docs
url: /ru/go-cpp/core/splitdocument/
---

_Создать несколько новых PDF-документов, извлекая страницы из исходного PDF-документа._
...
func main() {
	...
	// SplitDocument(document *Document, pagerange string) создает несколько новых PDF-документов
