...
description: "Удалить текстовые колонтитулы на странице."
type: docs
url: /ru/go-cpp/organize/pageremovetextfooters/
---

_Удалить текстовые колонтитулы на странице._
...
func main() {
        ...
        defer pdf.Close()
        // PageRemoveTextFooters(num int32) удаляет текстовые колонтитулы на странице
