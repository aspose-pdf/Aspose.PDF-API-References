...
description: "Проверить PDF-документ на соответствие формату PDF."
type: docs
url: /ru/go-cpp/organize/validate/
---

_Проверить PDF-документ на соответствие формату PDF._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) проверяет PDF-документ на соответствие PDF/A
