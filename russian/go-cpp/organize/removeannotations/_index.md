...
description: "Удалить аннотации из PDF-документа."
type: docs
url: /ru/go-cpp/organize/removeannotations/
---

_Удалить аннотации из PDF-документа._
...
func main() {
	...
	defer pdf.Close()
	// RemoveAnnotations() удаляет аннотации из PDF-документа
