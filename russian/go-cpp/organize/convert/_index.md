...
description: "Преобразовать PDF-документ в PDF-документ с указанным форматом PDF."
type: docs
url: /ru/go-cpp/organize/convert/
---

_Конвертировать PDF-документ в PDF-документ с указанным форматом PDF._
...
```go
// Перечисление возможных действий при ошибках конвертации.
...
func main() {
	...
	// Convert(pdfFormat PdfFormat, action ConvertErrorAction) конвертирует PDF-документ в PDF/A
	...
	// Сохранить преобразованный PDF-документ
