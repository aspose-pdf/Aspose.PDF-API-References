...
description: "Удалить аннотации на странице."
type: docs
url: /ru/go-cpp/organize/pageremoveannotations/
---

_Удалить аннотации на странице._
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveAnnotations(num int32) удаляет аннотации на странице
