...
description: Представляет аннотацию подчеркивания, которая отображается как подчеркивание в тексте документа.
type: docs
weight: 395
url: /ru/java/com.aspose.pdf/underlineannotation/
---
**Наследование:**
...
Представляет аннотацию подчеркивания, которая отображается как подчеркивание в тексте документа.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [UnderlineAnnotation(Page page, Rectangle rect)](#UnderlineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Underline на указанной странице. |
## Методы
