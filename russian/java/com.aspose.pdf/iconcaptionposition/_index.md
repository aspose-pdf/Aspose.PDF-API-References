...
type: docs
weight: 163
url: /ru/java/com.aspose.pdf/iconcaptionposition/
---
**Наследование:**
...
| Поле | Описание |
| --- | --- |
| [CaptionAboveIcon](#CaptionAboveIcon) | Надпись над иконкой. |
| [CaptionBelowIcon](#CaptionBelowIcon) | Надпись находится под иконкой. |
| [CaptionOverlaid](#CaptionOverlaid) | Надпись наложена. |
| [CaptionToTheLeft](#CaptionToTheLeft) | Надпись слева. |
| [CaptionToTheRight](#CaptionToTheRight) | Надпись справа. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NoCaption](#NoCaption) | Надпись не отображается. |
| [NoIcon](#NoIcon) | Значок не отображается. |
## Методы
