...
description: "Содержит различные сообщения об ошибках для операций экспорта и импорта полей формы."
type: docs
weight: 1330
url: /ru/java/com.aspose.pdf/exportimportmessages/
---
**Inheritance:**
...
Содержит различные сообщения об ошибках для операций экспорта и импорта полей формы.
