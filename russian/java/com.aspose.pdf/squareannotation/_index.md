...
type: docs
weight: 333
url: /ru/java/com.aspose.pdf/squareannotation/
---
**Наследование:**
...
| --- | --- |
| [SquareAnnotation(IDocument document)](#SquareAnnotation-com.aspose.pdf.IDocument-) | Конструктор для использования с генератором. |
| [SquareAnnotation(Page page, Rectangle rect)](#SquareAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую квадратную аннотацию на указанной странице. |
## Методы
