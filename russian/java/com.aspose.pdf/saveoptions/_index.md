...
description: Тип SaveOptions удерживает уровень абстракции для отдельных параметров сохранения.
type: docs
weight: 318
url: /ru/java/com.aspose.pdf/saveoptions/
---
**Наследование:**
java.lang.Object
```
...
Тип SaveOptions удерживает уровень абстракции для отдельных параметров сохранения.
## Конструкторы
