...
Некоторые PDF-документы имеют специальные символы Unicode, которые относятся к области частного использования (PUA), см. описание на странице https://en.wikipedia.org/wiki/Private.\_Использовать\_Области. Эти символы вызывают ошибки, совместимые с PDF/A, такие как «Текст сопоставлен с частной областью использования Unicode, но запись ActualText отсутствует». Это перечисление объявляет стратегии, которые можно использовать для обработки символов PUA.
## Поля
