...
type: docs
weight: 81
url: /ru/java/com.aspose.pdf/datefield/
---
**Наследование:**
...
| --- | --- |
| [DateField()](#DateField--) |  Инициализирует новый экземпляр[DateField](../../com.aspose.pdf/datefield) |
| [DateField(Document doc)](#DateField-com.aspose.pdf.Document-) | Конструктор, который следует использовать с генератором. |
| [DateField(Page page, Rectangle rect)](#DateField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) |  Инициализирует новый экземпляр[DateField](../../com.aspose.pdf/datefield) |
| [DateField(Document doc, Rectangle rect)](#DateField-com.aspose.pdf.Document-com.aspose.pdf.Rectangle-) |  Инициализирует новый экземпляр[DateField](../../com.aspose.pdf/datefield) |
## Поля
...
| [addImage_DateField_New(BufferedImage image)](#addImage-DateField-New-java.awt.image.BufferedImage-) | Добавление изображения запрещено для этого поля. |
...
| [getDateFormat()](#getDateFormat--) | Получает или задает формат даты. |
...
| [getValue_DateField_New()](#getValue-DateField-New--) | Получает или задает дату. |
...
| [hashCode()](#hashCode--) |  |
| [init(Page page)](#init-com.aspose.pdf.Page-) | Инициализирует действие JS. |
...
| [setDateFormat(String value)](#setDateFormat-java.lang.String-) | Получает или задает формат даты. |
...
| [setValue_DateField_New(Date value)](#setValue-DateField-New-java.util.Date-) | Получает или задает дату. |
...
```
 ...
 Инициализирует новый экземпляр[DateField](../../com.aspose.pdf/datefield)
...
| --- | --- | --- |
| doc | [Document](../../com.aspose.pdf/document) | Документ, в котором будет создано поле. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница нужна для создания. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, в котором текстовое поле будет размещено на странице. |
...
| --- | --- | --- |
| doc | [Document](../../com.aspose.pdf/document) | Документ, в котором будет создано поле. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник поля. |
...
Значение: формат даты. По умолчанию дд/мм/гггг
...
**Возвращает:**
[Date](../../java.util/date) - экземпляр java.util.Date
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.util.Date | экземпляр java.util.Date |
