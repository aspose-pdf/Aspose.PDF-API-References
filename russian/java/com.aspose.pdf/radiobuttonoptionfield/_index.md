...
type: docs
weight: 299
url: /ru/java/com.aspose.pdf/radiobuttonoptionfield/
---
**Наследование:**
...
| --- | --- |
| [RadioButtonOptionField()](#RadioButtonOptionField--) | Создайте новый экземпляр RadioButtonOptionField. |
| [RadioButtonOptionField(Page page, Rectangle rect)](#RadioButtonOptionField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает радиокнопку в указанном прямоугольнике на указанной странице. |
## Поля
...
| [getCaption()](#getCaption--) | Получает заголовок. |
...
| [getOptionName_Rename_Namesake()](#getOptionName-Rename-Namesake--) | Получает имя опции. |
...
| [setCaption(TextFragment value)](#setCaption-com.aspose.pdf.TextFragment-) | Устанавливает заголовок. |
...
| [setOptionName(String value)](#setOptionName-java.lang.String-) | Устанавливает имя опции. |
| [setOptionName_Rename_Namesake(String value)](#setOptionName-Rename-Namesake-java.lang.String-) | Устанавливает имя опции. |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещен RadioButton; |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник RadioButton. |
