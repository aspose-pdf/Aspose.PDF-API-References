...
description: Сохранить параметры для экспорта в формат Excel
type: docs
weight: 101
url: /ru/java/com.aspose.pdf/excelsaveoptions/
---
**Наследование:**
...
Сохранить параметры для экспорта в формат Excel
## Конструкторы
...
| [getClass()](#getClass--) |  |
| [getFormat()](#getFormat--) | Выходной формат. |
| [getMinimizeTheNumberOfWorksheets()](#getMinimizeTheNumberOfWorksheets--) | Установите значение true, если вам нужно свести к минимуму количество рабочих листов в результирующей рабочей книге. |
...
| [isInsertBlankColumnAtFirst()](#isInsertBlankColumnAtFirst--) | Установите false, если вам нужно подавить вставку пустого столбца в качестве первого столбца рабочего листа. |
...
| [isUniformWorksheets()](#isUniformWorksheets--) | Установите значение true для использования равномерного разделения столбцов в документе. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFormat(int value)](#setFormat-int-) | Выходной формат |
| [setInsertBlankColumnAtFirst(boolean value)](#setInsertBlankColumnAtFirst-boolean-) | Установите false, если вам нужно подавить вставку пустого столбца в качестве первого столбца рабочего листа. |
| [setMinimizeTheNumberOfWorksheets(boolean value)](#setMinimizeTheNumberOfWorksheets-boolean-) | Установите значение true, если вам нужно свести к минимуму количество рабочих листов в результирующей рабочей книге. |
...
| [setUniformWorksheets(boolean value)](#setUniformWorksheets-boolean-) | Установите значение true для использования равномерного разделения столбцов в документе. |
...
Возвращает ExcelSaveOptions.ExcelFormat.XMLSpreadSheet2003 или ExcelSaveOptions.ExcelFormat.XLSX или ExcelSaveOptions.ExcelFormat.CSV 

**Возвращает:**
int - элемент ExcelFormat
...
Установите значение true, если вам нужно свести к минимуму количество рабочих листов в результирующей рабочей книге. Значение по умолчанию — ложь; это означает сохранение каждой страницы PDF в виде отдельного рабочего листа.
...
Установите false, если вам нужно подавить вставку пустого столбца в качестве первого столбца рабочего листа. Значение по умолчанию — истина; это означает, что будет вставлен пустой столбец.
...
Установите значение true для использования равномерного разделения столбцов в документе. Значение по умолчанию — ложь; это означает, что разделение столбцов будет независимым для каждой страницы.
...
Используйте файл ExcelSaveOptions.ExcelFormat.XMLSpreadSheet2003 или ExcelSaveOptions.ExcelFormat.XLSX. 

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент ExcelFormat |
