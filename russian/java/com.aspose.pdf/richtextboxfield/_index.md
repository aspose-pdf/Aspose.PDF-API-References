...
description: Класс описывает компонент редактора форматированного текста.
type: docs
weight: 313
url: /ru/java/com.aspose.pdf/richtextboxfield/
---
**Наследование:**
...
Класс описывает компонент редактора форматированного текста.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [RichTextBoxField(Page page, Rectangle rect)](#RichTextBoxField-com.aspose.pdf.Page-java.awt.Rectangle-) | Конструктор для поля Rich Text Box. |
| [RichTextBoxField(Page page, Rectangle rect)](#RichTextBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор для поля Rich Text Box. |
## Поля
...
| [addBarcode(String code)](#addBarcode-java.lang.String-) | Добавляет штрих-код 128 в поле. |
...
| [getForceCombs()](#getForceCombs--) | Получает флаг, указывающий, что поле разделено на интервальные позиции. |
| [getFormattedValue()](#getFormattedValue--) | Получает отформатированное значение форматированного текста с разметкой. |
...
| [getJustify()](#getJustify--) | Получает выравнивание поля форматированного текста. |
...
| [getMaxLen()](#getMaxLen--) | Получает максимальную длину текста в поле. |
...
| [getMultiline()](#getMultiline--) | Получает многострочный флаг поля. |
...
| [getRichTextValue()](#getRichTextValue--) | Получает форматированное текстовое значение. |
| [getScrollable()](#getScrollable--) | Получает прокручиваемый флаг поля. |
| [getSpellCheck()](#getSpellCheck--) | Получает флаг проверки орфографии для поля. |
| [getStates()](#getStates--) | Получает словарь внешнего вида аннотации. |
| [getStyle()](#getStyle--) | Получает строку стиля по умолчанию для поля форматированного текста. |
...
| [getTextVerticalAlignment()](#getTextVerticalAlignment--) | Получает или задает вертикальное выравнивание текста для аннотации. |
| [getValue()](#getValue--) | Получить значение RichTextField. |
...
| [setForceCombs(boolean value)](#setForceCombs-boolean-) | Устанавливает флаг, указывающий, что поле разделено на интервальные позиции. |
| [setFormattedValue(String value)](#setFormattedValue-java.lang.String-) | Задает значение форматированного форматированного текста с разметкой. |
...
| [setJustification(boolean value)](#setJustification-boolean-) | Устанавливает обоснование |
| [setJustify(int value)](#setJustify-int-) | Устанавливает выравнивание поля форматированного текста. |
...
| [setMaxLen(int value)](#setMaxLen-int-) | Устанавливает максимальную длину текста в поле. |
...
| [setMultiline(boolean value)](#setMultiline-boolean-) | Устанавливает многострочный флаг поля. |
...
| [setRichTextValue(String value)](#setRichTextValue-java.lang.String-) | Устанавливает значение форматированного текста. |
| [setScrollable(boolean value)](#setScrollable-boolean-) | Устанавливает прокручиваемый флаг поля. |
| [setSharedField(boolean value)](#setSharedField-boolean-) | Свойство для поддержки генератора. |
| [setSpellCheck(boolean value)](#setSpellCheck-boolean-) | Устанавливает флаг проверки орфографии для поля. |
| [setStyle(String value)](#setStyle-java.lang.String-) | Задает строку стиля по умолчанию для поля форматированного текста. |
...
| [setTextVerticalAlignment(int value)](#setTextVerticalAlignment-int-) | Получает или задает вертикальное выравнивание текста для аннотации. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Установите значение RichTextField. |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещено поле. |
| rect | java.awt.Rectangle | java.awt.Rectangle Позиция поля на странице. |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещено поле. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | com.aspose.pdf.Rectangle Положение поля на странице. |
...
Добавляет штрих-код 128 в поле. Значение поля будет изменено на код, и поле станет доступным только для чтения.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| code | java.lang.String | Текст для создания штрих-кода 128. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| image | java.awt.image.BufferedImage | Изображение для добавления в текстовое поле. |
...
Получает флаг, указывающий, что поле разделено на интервальные позиции.
...
Получает отформатированное значение форматированного текста с разметкой.
...
Получает выравнивание поля форматированного текста.

**Возвращает:**
int - Значение обоснования
...
Получает максимальную длину текста в поле.
...
Получает многострочный флаг поля. Если Multiline имеет значение true, поле может содержать несколько строк текста.
...
Получает форматированное текстовое значение.
...
Получает прокручиваемый флаг поля. Если true поле можно прокручивать.
...
Получает флаг проверки орфографии для поля. Если истина, поле должно быть проверено на орфографию.
...
Получает строку стиля по умолчанию для поля форматированного текста.
...
Получить значение RichTextField.
...
Устанавливает флаг, указывающий, что поле разделено на интервальные позиции.
...
Задает значение форматированного форматированного текста с разметкой.
...
Устанавливает выравнивание поля форматированного текста.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Значение обоснования |
...
Устанавливает максимальную длину текста в поле.
...
Устанавливает многострочный флаг поля. Если Multiline имеет значение true, поле может содержать несколько строк текста.
...
Устанавливает значение форматированного текста.
...
Устанавливает прокручиваемый флаг поля. Если true поле можно прокручивать.
...
Устанавливает флаг проверки орфографии для поля. Если истина, поле должно быть проверено на орфографию.
...
Задает строку стиля по умолчанию для поля форматированного текста.
...
Установите значение RichTextField.
