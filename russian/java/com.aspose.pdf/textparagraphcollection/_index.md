...
description: Представляет коллекцию текстовых абзацев
type: docs
weight: 382
url: /ru/java/com.aspose.pdf/textparagraphcollection/
---
**Наследование:**
java.lang.Object
...
Представляет коллекцию текстовых абзацев
## Методы

| Метод | Описание |
| --- | --- |
| [add(TextParagraph paragraph)](#add-com.aspose.pdf.TextParagraph-) | Добавляет элемент текстового абзаца по указанному индексу. |
| [clear()](#clear--) | Удаляет все элементы из коллекции. |
| [contains(TextParagraph item)](#contains-com.aspose.pdf.TextParagraph-) | Определяет, содержит ли коллекция определенное значение. |
| [copyTo(TextParagraph[] array, int index)](#copyTo-com.aspose.pdf.TextParagraph---int-) | Копирует всю коллекцию в совместимый одномерный массив, начиная с указанного индекса целевого массива. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getSyncRoot()](#getSyncRoot--) | Получает объект, который можно использовать для синхронизации доступа к коллекции. |
| [get_Item(int index)](#get-Item-int-) | Получает элемент текстового абзаца по указанному индексу. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(TextParagraph item)](#remove-com.aspose.pdf.TextParagraph-) | Удаляет указанный элемент из коллекции. |
| [size()](#size--) | Получает количество элементов объекта TextParagraph, фактически содержащихся в коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Добавляет элемент текстового абзаца по указанному индексу.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| paragraph | [TextParagraph](../../com.aspose.pdf/textparagraph) | Экземпляр TextParagraph |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| item | [TextParagraph](../../com.aspose.pdf/textparagraph) | Объект, который нужно найти в коллекции |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| array | [TextParagraph\[\]](../../com.aspose.pdf/textparagraph) | Коллекция массивов |
...
Получает элемент текстового абзаца по указанному индексу.
...
**Возвращает:**
[TextParagraph](../../com.aspose.pdf/textparagraph) - Объект Текстовый Параграф
### hashCode() {#hashCode--}
```
...
**Возвращает:**
com.aspose.ms.System.Collections.IEnumerator<com.aspose.pdf.TextParagraph> — объект IEnumerator
### notify() {#notify--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| item | [TextParagraph](../../com.aspose.pdf/textparagraph) | Объект для удаления |
...
Получает количество элементов объекта TextParagraph, фактически содержащихся в коллекции.
