...
description: Представляет поле формы подписи.
type: docs
weight: 325
url: /ru/java/com.aspose.pdf/signaturefield/
---
**Наследование:**
...
| --- | --- |
| [SignatureField(Page page, Rectangle rect)](#SignatureField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Инициализирует новый экземпляр класса SignatureField. |
| [SignatureField(IDocument doc, Rectangle rect)](#SignatureField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Инициализирует новый экземпляр класса SignatureField. |
## Поля
...
| [clear()](#clear--) | Удаляет объект подписи из поля. |
...
| [extractCertificate()](#extractCertificate--) | Извлекает один сертификат X.509 в формате DER в виде потока. |
| [extractImage()](#extractImage--) | Извлекает изображение подписи как закодированный поток jpeg. |
| [extractImage(ImageType format)](#extractImage-com.aspose.pdf.ImageType-) | Извлекает изображение подписи в виде закодированного потока. |
...
| [getSignature()](#getSignature--) | Получает объект подписи. |
...
| [sign(Signature signature)](#sign-com.aspose.pdf.Signature-) | Подпишите документ, используя это поле для подписи. |
| [sign(Signature signature, InputStream pfx, String pass)](#sign-com.aspose.pdf.Signature-java.io.InputStream-java.lang.String-) | Подписывает документ, используя это поле подписи. |
...
Инициализирует новый экземпляр класса SignatureField.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой должно быть размещено поле для подписи. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Положение и размер поля подписи. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Страница, на которой должно быть размещено поле для подписи. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Положение и размер поля подписи. |
...
Удаляет объект подписи из поля.
...
Извлекает изображение подписи как закодированный поток jpeg.

**Возвращает:**
java.io.InputStream — если изображение было успешно найдено, возвращает объект потока в формате jpeg; в противном случае ноль.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| format | [ImageType](../../com.aspose.pdf/imagetype) | Формат изображения для кодирования. |

**Возвращает:**
java.io.InputStream — если изображение было успешно найдено, возвращает объект encodedstream; в противном случае ноль.
### flatten() {#flatten--}
```
public void flatten()
```
...
Получает объект подписи. Этот объект содержит данные подписи относительно криптографических стандартов с открытым ключом. Классы PKCS1, PKCS7 и PKCS7Detached представляют все поддерживаемые типы объектов подписи.

**Возвращает:**
[Signature](../../com.aspose.pdf/signature) - Объект подписи
### getStates() {#getStates--}
```
...
Подпишите документ, используя это поле для подписи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| signature | [Signature](../../com.aspose.pdf/signature) | Объект подписи, см. PKCS1, PKCS7 и PKCS7Detached. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| signature | [Signature](../../com.aspose.pdf/signature) | Объект подписи, см. PKCS1, PKCS7, PKCS7Detached. |
| pfx | java.io.InputStream | Стрим с сертификатом. |
| pass | java.lang.String | Пароль для доступа к привату в pfx. |
