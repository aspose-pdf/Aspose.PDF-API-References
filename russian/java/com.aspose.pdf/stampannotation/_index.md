...
description: Представляет аннотацию штампа.
type: docs
weight: 336
url: /ru/java/com.aspose.pdf/stampannotation/
---
**Наследование:**
...
Представляет аннотацию штампа. Этот тип аннотаций отображает текст или графику, которые должны выглядеть так, как если бы они были отпечатаны на странице резиновым штампом.
...
| --- | --- |
| [StampAnnotation(IDocument document)](#StampAnnotation-com.aspose.pdf.IDocument-) | Конструктор |
| [StampAnnotation(Page page, Rectangle rect)](#StampAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Stamp на указанной странице. |
## Методы

| Метод | Описание |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | Принимает посетителя AnnotationSelector при просмотре коллекции аннотаций. |
...
| [getIcon()](#getIcon--) | Получает значок для штампа. |
| [getImage()](#getImage--) | Получает изображение аннотации. |
...
| [setIcon(int value)](#setIcon-int-) | Устанавливает значок для штампа. |
| [setImage(InputStream value)](#setImage-java.io.InputStream-) | Устанавливает изображение аннотации. |
...
Принимает посетителя AnnotationSelector при просмотре коллекции аннотаций.
...
Получает значок для штампа.

**Возвращает:**
int - значение StampIcon
### getImage() {#getImage--}
```
...
Получает изображение аннотации.
...
Устанавливает значок для штампа.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Значение StampIcon |
...
Устанавливает изображение аннотации.
