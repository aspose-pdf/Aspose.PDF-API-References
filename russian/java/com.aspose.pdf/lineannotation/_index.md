...
type: docs
weight: 195
url: /ru/java/com.aspose.pdf/lineannotation/
---
**Наследование:**
...
| --- | --- |
| [LineAnnotation(IDocument document, Point start, Point end)](#LineAnnotation-com.aspose.pdf.IDocument-com.aspose.pdf.Point-com.aspose.pdf.Point-) | Конструктор для использования с генератором. |
| [LineAnnotation(Page page, Rectangle rect, Point start, Point end)](#LineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.Point-com.aspose.pdf.Point-) | Создает новую линейную аннотацию на указанной странице. |
## Методы

| Метод | Описание |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | Допускает посетителя к обработке аннотаций. |
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | Обновляет начальную и конечную точки в соответствии с преобразованием матрицы. |
...
| [getCaptionOffset()](#getCaptionOffset--) | Получает смещение текста заголовка относительно его нормального положения. |
| [getCaptionPosition()](#getCaptionPosition--) | Получает позицию заголовка аннотации. |
...
| [getEnding()](#getEnding--) | Получает конечную точку строки. |
| [getEndingStyle()](#getEndingStyle--) | Получает конечный стиль для конечной точки линии. |
...
| [getIntent()](#getIntent--) | Получает назначение аннотации строки. |
| [getInteriorColor()](#getInteriorColor--) | Получает внутренний цвет аннотации. |
| [getLeaderLine()](#getLeaderLine--) | Получает длину линии выноски. |
| [getLeaderLineExtension()](#getLeaderLineExtension--) | Получает длину продолжения линии выноски. |
| [getLeaderLineOffset()](#getLeaderLineOffset--) | Получает смещение линии выноски. |
...
| [getShowCaption()](#getShowCaption--) | Получает логический флаг, определяющий, что содержимое должно отображаться как заголовок. |
| [getStarting()](#getStarting--) | Получает начальную точку линии. |
| [getStartingStyle()](#getStartingStyle--) | Получает стиль окончания линии для начальной точки линии. |
...
| [setCaptionOffset(Point value)](#setCaptionOffset-com.aspose.pdf.Point-) | Устанавливает смещение текста заголовка относительно его нормального положения. |
| [setCaptionPosition(int value)](#setCaptionPosition-int-) | Устанавливает положение заголовка аннотации. |
...
| [setEnding(Point value)](#setEnding-com.aspose.pdf.Point-) | Устанавливает конечную точку линии. |
| [setEndingStyle(int value)](#setEndingStyle-int-) | Устанавливает стиль окончания для конечной точки линии. |
...
| [setIntent(int value)](#setIntent-int-) | Задает назначение аннотации строки. |
| [setInteriorColor(Color value)](#setInteriorColor-com.aspose.pdf.Color-) | Устанавливает внутренний цвет аннотации. |
...
| [setLeaderLine(double value)](#setLeaderLine-double-) | Устанавливает длину линии выноски. |
| [setLeaderLineExtension(double value)](#setLeaderLineExtension-double-) | Устанавливает длину продолжения линии выноски. |
| [setLeaderLineOffset(double value)](#setLeaderLineOffset-double-) | Устанавливает смещение линии выноски. |
...
| [setShowCaption(boolean value)](#setShowCaption-boolean-) | Устанавливает логический флаг, определяющий, что содержимое должно отображаться в качестве заголовка. |
| [setStarting(Point value)](#setStarting-com.aspose.pdf.Point-) | Устанавливает начальную точку линии. |
| [setStartingStyle(int value)](#setStartingStyle-int-) | Устанавливает стиль окончания линии для начальной точки линии. |
...
| start | [Point](../../com.aspose.pdf/point) | Отправная точка. |
| end | [Point](../../com.aspose.pdf/point) | Конечная точка. |
...
| start | [Point](../../com.aspose.pdf/point) | Точка, указывающая начальную координату линии. |
| end | [Point](../../com.aspose.pdf/point) | Точка, указывающая конечную координату линии. |
...
Допускает посетителя к обработке аннотаций.
...
Получает смещение текста заголовка относительно его нормального положения.

**Возвращает:**
[Point](../../com.aspose.pdf/point) - Точечный объект
...
Получает позицию заголовка аннотации.

**Возвращает:**
int — элемент CaptionPosition
...
Получает конечную точку строки.

**Возвращает:**
[Point](../../com.aspose.pdf/point) - Значение балла
...
Получает конечный стиль для конечной точки линии.
...
Получает назначение аннотации строки.

**Возвращает:**
int - элемент LineIntent
...
Получает внутренний цвет аннотации.
...
Получает длину продолжения линии выноски.
...
Получает смещение линии выноски.
...
**Возвращает:**
[Measure](../../com.aspose.pdf/measure) - Объект измерения
...
Получает логический флаг, определяющий, что содержимое должно отображаться как заголовок.
...
Получает стиль окончания линии для начальной точки линии.
...
Устанавливает смещение текста заголовка относительно его нормального положения.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Point](../../com.aspose.pdf/point) | Точечный объект |
...
Устанавливает положение заголовка аннотации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент CaptionPosition |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Point](../../com.aspose.pdf/point) | Стоимость балла |
...
Устанавливает стиль окончания для конечной точки линии.
...
Задает назначение аннотации строки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент LineIntent |
...
Устанавливает внутренний цвет аннотации.
...
Устанавливает длину линии выноски.
...
Устанавливает длину продолжения линии выноски.
...
Устанавливает смещение линии выноски.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Measure](../../com.aspose.pdf/measure) | Объект измерения |
...
Устанавливает логический флаг, определяющий, что содержимое должно отображаться в качестве заголовка.
...
Устанавливает стиль окончания линии для начальной точки линии.
