...
description: Представляет волнистую аннотацию, которая отображается в виде зубчатого подчеркивания в тексте документа.
type: docs
weight: 334
url: /ru/java/com.aspose.pdf/squigglyannotation/
---
**Наследование:**
...
Представляет волнистую аннотацию, которая отображается в виде зубчатого подчеркивания в тексте документа.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SquigglyAnnotation(Page page, Rectangle rect)](#SquigglyAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Squiggly на указанной странице. |
## Методы
...
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | Обновляет QuadPoints в соответствии с матричным преобразованием. |
...
| [getMarkedText()](#getMarkedText--) | Получает текст под аннотацией разметки в виде строки. |
| [getMarkedTextFragments()](#getMarkedTextFragments--) | Получает текст под аннотацией разметки как TextFragmentCollection . |
...
Создает новую аннотацию Squiggly на указанной странице.
...
Обновляет QuadPoints в соответствии с матричным преобразованием.
...
**Возвращает:**
java.lang.String — строка, содержащая текст, который находится под аннотацией разметки.
...
Получает текст под аннотацией разметки как TextFragmentCollection .

**Возвращает:**
[TextFragmentCollection](../../com.aspose.pdf/textfragmentcollection) - TextFragmentCollection, содержащий TextFragment s, который находится под аннотацией разметки.
