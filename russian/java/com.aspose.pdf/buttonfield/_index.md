...
type: docs
weight: 46
url: /ru/java/com.aspose.pdf/buttonfield/
---
**Наследование:**
...
| --- | --- |
| [ButtonField()](#ButtonField--) | Конструктор поля кнопки для Генератора. |
| [ButtonField(Page page, Rectangle rect)](#ButtonField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор поля кнопок. |
| [ButtonField(IDocument doc, Rectangle rect)](#ButtonField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Конструктор ButtonField. |
## Поля
...
| [addImage(BufferedImage image)](#addImage-java.awt.image.BufferedImage-) | Добавляет изображение в ресурсы поля и рисует его. |
| [addImage(BufferedImage image, boolean fillArea)](#addImage-java.awt.image.BufferedImage-boolean-) | Добавляет изображение в ресурсы поля и рисует его. |
...
| [getAlternateCaption()](#getAlternateCaption--) | Получает альтернативный заголовок кнопки, который должен отображаться при нажатии кнопки мыши в пределах ее активной области. |
| [getAlternateIcon()](#getAlternateIcon--) | Получает альтернативную иконку, которая будет отображаться при нажатии кнопки мыши в ее активной области. |
...
| [getICPosition()](#getICPosition--) | Получает позицию заголовка значка. |
| [getIconFit()](#getIconFit--) | Получает объект, соответствующий значку, указывающий, как значок аннотации виджета должен отображаться в пределах его прямоугольника аннотации. |
...
| [getNormalCaption()](#getNormalCaption--) | Получает нормальную подпись. |
| [getNormalIcon()](#getNormalIcon--) | Получает обычный значок кнопки, который должен отображаться, когда он не взаимодействует с пользователем. |
...
| [getRolloverCaption()](#getRolloverCaption--) | Получает заголовок кнопки, который должен отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши. |
| [getRolloverIcon()](#getRolloverIcon--) | Получает значок прокрутки кнопки, который должен отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши. |
...
| [getValue()](#getValue--) | Получает значение поля. |
...
| [setAlternateCaption(String value)](#setAlternateCaption-java.lang.String-) | Задает альтернативный заголовок кнопки, который будет отображаться при нажатии кнопки мыши в пределах ее активной области. |
| [setAlternateIcon(XForm value)](#setAlternateIcon-com.aspose.pdf.XForm-) | Задает альтернативную иконку, которая будет отображаться при нажатии кнопки мыши в ее активной области. |
...
| [setICPosition(int value)](#setICPosition-int-) | Устанавливает положение заголовка значка. |
...
| [setNormalCaption(String value)](#setNormalCaption-java.lang.String-) | Устанавливает обычный заголовок. |
| [setNormalIcon(XForm value)](#setNormalIcon-com.aspose.pdf.XForm-) | Устанавливает обычную иконку кнопки, которая будет отображаться, когда она не взаимодействует с пользователем. |
...
| [setRolloverCaption(String value)](#setRolloverCaption-java.lang.String-) | Устанавливает заголовок кнопки, который будет отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши. |
| [setRolloverIcon(XForm value)](#setRolloverIcon-com.aspose.pdf.XForm-) | Устанавливает иконку прокрутки кнопки, которая будет отображаться, когда пользователь наводит курсор в ее активную область, не нажимая кнопку мыши. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Установить значение. |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещена кнопка. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, в котором находится кнопка на странице. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документируйте, где будет создано новое поле. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольная кнопка размещена на странице. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| image | java.awt.image.BufferedImage | Изображение или добавить в текстовое поле. |
...
| --- | --- | --- |
| image | java.awt.image.BufferedImage | Изображение или добавить в текстовое поле. |
| fillArea | boolean | логические значения |
...
Получает альтернативный заголовок кнопки, который должен отображаться при нажатии кнопки мыши в пределах ее активной области.
...
Получает альтернативную иконку, которая будет отображаться при нажатии кнопки мыши в ее активной области.
...
Получает позицию заголовка значка.

**Возвращает:**
int - позиция заголовка иконки.
...
**Возвращает:**
[IconFit](../../com.aspose.pdf/iconfit) - Объект IconFit
...
Получает обычный значок кнопки, который должен отображаться, когда он не взаимодействует с пользователем.
...
Получает заголовок кнопки, который должен отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши.
...
Получает значок прокрутки кнопки, который должен отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши.
...
Задает альтернативный заголовок кнопки, который будет отображаться при нажатии кнопки мыши в пределах ее активной области.
...
Задает альтернативную иконку, которая будет отображаться при нажатии кнопки мыши в ее активной области.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [XForm](../../com.aspose.pdf/xform) | объект XForm |
...
Устанавливает положение заголовка значка.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | положение заголовка значка. |
...
Устанавливает обычный заголовок.
...
Устанавливает обычную иконку кнопки, которая будет отображаться, когда она не взаимодействует с пользователем.
...
Устанавливает заголовок кнопки, который будет отображаться, когда пользователь перемещает курсор в его активную область, не нажимая кнопку мыши.
...
Устанавливает иконку прокрутки кнопки, которая будет отображаться, когда пользователь наводит курсор в ее активную область, не нажимая кнопку мыши.
