...
type: docs
weight: 228
url: /ru/java/com.aspose.pdf/numberfield/
---
**Наследование:**
...
| --- | --- |
| [NumberField()](#NumberField--) |  Инициализирует новый экземпляр[NumberField](../../com.aspose.pdf/numberfield) учебный класс. |
| [NumberField(Page page, Rectangle rect)](#NumberField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) |  Инициализирует новый экземпляр[NumberField](../../com.aspose.pdf/numberfield) учебный класс. |
| [NumberField(Document doc, Rectangle rect)](#NumberField-com.aspose.pdf.Document-com.aspose.pdf.Rectangle-) |  Инициализирует новый экземпляр[NumberField](../../com.aspose.pdf/numberfield) учебный класс. |
## Поля
...
| [getAllowedChars()](#getAllowedChars--) | Получает или задает разрешенные символы. |
...
| [setAllowedChars(String value)](#setAllowedChars-java.lang.String-) | Получает или задает разрешенные символы. |
...
```
 ...
 Инициализирует новый экземпляр[NumberField](../../com.aspose.pdf/numberfield) учебный класс.
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой размещено текстовое поле. |
...
Значение: допустимая строка символов. 0123456789 по умолчанию
