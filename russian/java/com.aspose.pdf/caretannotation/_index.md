...
description: Класс, представляющий аннотацию Caret.
type: docs
weight: 49
url: /ru/java/com.aspose.pdf/caretannotation/
---
**Наследование:**
...
| --- | --- |
| [CaretAnnotation(IDocument document)](#CaretAnnotation-com.aspose.pdf.IDocument-) | Конструктор для использования в Generator. |
| [CaretAnnotation(Page page, Rectangle rect)](#CaretAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Caret на указанной странице. |
## Методы
...
| [getFrame()](#getFrame--) | Получает прямоугольник вставки. |
...
| [getSymbol()](#getSymbol--) | Получает символ, связанный с кареткой. |
...
| [setFrame(Rectangle value)](#setFrame-com.aspose.pdf.Rectangle-) | Устанавливает прямоугольник вставки. |
...
| [setSymbol(int value)](#setSymbol-int-) | Задает размер выходной страницы для импорта. |
...
Получает прямоугольник вставки.

**Возвращает:**
[Rectangle](../../com.aspose.pdf/rectangle) - прямоугольник каретки.
...
Получает символ, связанный с кареткой.

 КаретСимвол 

**Возвращает:**
int - элемент CaretSymbol
...
Устанавливает прямоугольник вставки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.pdf/rectangle) | каретный прямоугольник. |
...
Задает размер выходной страницы для импорта.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент CaretSymbol |
