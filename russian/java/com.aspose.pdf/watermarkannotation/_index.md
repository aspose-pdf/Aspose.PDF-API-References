...
type: docs
weight: 402
url: /ru/java/com.aspose.pdf/watermarkannotation/
---
**Наследование:**
...
| --- | --- |
| [WatermarkAnnotation(Page page, Rectangle rect)](#WatermarkAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор класса аннотации водяного знака. |
## Методы

| Метод | Описание |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | Применить посетителя для аннотации. |
...
| [getFixedPrint()](#getFixedPrint--) | Исправлен объект печати аннотации водяного знака. |
...
| [getOpacity()](#getOpacity--) | Получает или задает прозрачность аннотации. |
...
| [setOpacity(double value)](#setOpacity-double-) | Получает или задает прозрачность аннотации. |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | Задает прямоугольник аннотации. |
| [setText(FormattedText text)](#setText-com.aspose.pdf.facades.FormattedText-) | Установите текст аннотации. |
| [setTextAndState(String[] text, TextState textState)](#setTextAndState-java.lang.String---com.aspose.pdf.TextState-) | Установите текст аннотации. |
...
Конструктор класса аннотации водяного знака.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой должна быть размещена аннотация. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Положение аннотации. |
...
**Возвращает:**
[FixedPrint](../../com.aspose.pdf/fixedprint) - Объект FixedPrint
### getFlags() {#getFlags--}
```
public int getFlags()
```
...
Установите текст аннотации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| text | [FormattedText](../../com.aspose.pdf.facades/formattedtext) | Форматированный текст Текстовое значение. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| text | java.lang.String[] | Массив строк (текстовое значение) |
| textState | [TextState](../../com.aspose.pdf/textstate) | Объект TextState |
