...
description: Представляет абстрактный отформатированный фрагмент.
type: docs
weight: 141
url: /ru/java/com.aspose.pdf/formattedfragment/
---
**Наследование:**
...
Представляет абстрактный отформатированный фрагмент.
## Методы
