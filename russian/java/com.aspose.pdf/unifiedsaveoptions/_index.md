...
description: Этот класс представляет параметры сохранения для сохранения, использующего единый способ преобразования с единой внутренней моделью документа.
type: docs
weight: 396
url: /ru/java/com.aspose.pdf/unifiedsaveoptions/
---
**Наследование:**
...
Этот класс представляет параметры сохранения для сохранения, использующего единый способ преобразования (с единой внутренней моделью документа).
## Конструкторы
