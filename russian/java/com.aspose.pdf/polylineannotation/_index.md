...
description: Представляет аннотацию полилинии, аналогичную полигону, за исключением того, что первая и последняя вершины не связаны неявным образом.
type: docs
weight: 289
url: /ru/java/com.aspose.pdf/polylineannotation/
---
**Наследование:**
...
| --- | --- |
| [PolylineAnnotation(Page page, Rectangle rect, Point[] vertices)](#PolylineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.Point---) | Создает новую полилинию на указанной странице. |
## Методы
