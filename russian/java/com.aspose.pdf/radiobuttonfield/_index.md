...
description: Класс, представляющий поле переключателя.
type: docs
weight: 298
url: /ru/java/com.aspose.pdf/radiobuttonfield/
---
**Наследование:**
...
Класс, представляющий поле переключателя.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [RadioButtonField(Page page, Rectangle rect)](#RadioButtonField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Устанавливает поле переключателя |
| [RadioButtonField(Page page)](#RadioButtonField-com.aspose.pdf.Page-) | Конструктор для RadiouttonField |
| [RadioButtonField(IDocument doc)](#RadioButtonField-com.aspose.pdf.IDocument-) | Конструктор для RadioButtonField. |
## Поля
...
| [add(RadioButtonOptionField newItem)](#add-com.aspose.pdf.RadioButtonOptionField-) | Добавляет новое поле параметра в поле RadioButton |
| [add(WidgetAnnotation item)](#add-com.aspose.pdf.WidgetAnnotation-) |  |
| [addOption(String optionName)](#addOption-java.lang.String-) | Добавить опцию к кнопке Radion. |
| [addOption(String optionName, Rectangle rect)](#addOption-java.lang.String-com.aspose.pdf.Rectangle-) | Добавить в опцию переключателя с указанным прямоугольником. |
| [addOption(String export, String name)](#addOption-java.lang.String-java.lang.String-) | Добавляет новую опцию с указанным значением экспорта и именем. |
...
| [deleteOption(String optionName)](#deleteOption-java.lang.String-) | Удаляет опцию по ее имени. |
...
| [getCommitImmediately()](#getCommitImmediately--) | Получает фиксацию флага изменения выбора. |
...
| [getMultiSelect()](#getMultiSelect--) | Получает флаг множественного выбора. |
...
| [getOptions()](#getOptions--) | Получает набор параметров переключателя. |
| [getPage()](#getPage--) | Получает объект страницы, с которым связана эта аннотация. |
| [getPageIndex()](#getPageIndex--) | Получает индекс страницы, которая содержит это поле RadioButton. |
...
| [getSelected()](#getSelected--) | Получает индекс выбранного элемента. |
| [getSelectedItems()](#getSelectedItems--) | Задает массив выбранных элементов. |
| [getStates()](#getStates--) | Получает словарь внешнего вида аннотации. |
| [getStyle()](#getStyle--) | Стиль поля поля. |
...
| [setCommitImmediately(boolean value)](#setCommitImmediately-boolean-) | Устанавливает флаг фиксации при изменении выбора. |
...
| [setMultiSelect(boolean value)](#setMultiSelect-boolean-) | Устанавливает флаг множественного выбора. |
...
| [setPosition(Point point)](#setPosition-com.aspose.pdf.Point-) | Переместите все подэлементы переключателя в указанные позиции на странице. |
...
| [setSelected(int value)](#setSelected-int-) | Устанавливает индекс выбранного элемента. |
| [setSelectedItems(int[] value)](#setSelectedItems-int---) | Задает массив выбранных элементов. |
| [setSharedField(boolean value)](#setSharedField-boolean-) | Свойство для поддержки генератора. |
| [setStyle(int value)](#setStyle-int-) | Стиль поля поля. |
...
Устанавливает поле переключателя
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещена радиокнопка. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана радиокнопка. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| newItem | [RadioButtonOptionField](../../com.aspose.pdf/radiobuttonoptionfield) | Пункт, который следует добавить. |
...
Добавить опцию к кнопке Radion.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| optionName | java.lang.String | Имя опции, которая будет добавлена. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| optionName | java.lang.String | Имя новой опции. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник нового элемента. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| export | java.lang.String | Экспорт стоимости. |
| name | java.lang.String | Имя новой опции. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| optionName | java.lang.String | Имя опции, которую необходимо удалить. |
...
Получает фиксацию флага изменения выбора.
...
Получает флаг множественного выбора.
...
Получает набор параметров переключателя.

**Возвращает:**
[OptionCollection](../../com.aspose.pdf/optioncollection) - Объект OptionCollection
### getPage() {#getPage--}
```
public Page getPage()
```
...
Получает индекс выбранного элемента. Нумерация предметов начинается с 1.
...
Задает массив выбранных элементов. Для массива списка с множественным выбором содержится более одного элемента. Для одного списка выбора он содержит один элемент.
...
Устанавливает флаг фиксации при изменении выбора.
...
Устанавливает флаг множественного выбора.
...
Переместите все подэлементы переключателя в указанные позиции на странице.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| point | [Point](../../com.aspose.pdf/point) | Устанавливает положение аннотаций поля RadioButton. |
...
Устанавливает индекс выбранного элемента. Нумерация предметов начинается с 1.
