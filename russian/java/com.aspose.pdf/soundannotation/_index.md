...
type: docs
weight: 326
url: /ru/java/com.aspose.pdf/soundannotation/
---
**Наследование:**
...
| --- | --- |
| [SoundAnnotation(Page page, Rectangle rect, String soundFile)](#SoundAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.lang.String-) | Создает новую звуковую аннотацию на указанной странице. |
| [SoundAnnotation(Page page, Rectangle rect, String soundFile, SoundSampleData soundSampleData)](#SoundAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.lang.String-com.aspose.pdf.SoundSampleData-) | Создает новую звуковую аннотацию на указанной странице. |
## Методы
...
| [getSoundData()](#getSoundData--) | Получает звуковой объект, определяющий звук, который будет воспроизводиться при активации аннотации. |
...
| soundFile | java.lang.String | Звуковой файл, определяющий звук, который будет воспроизводиться при активации аннотации. |
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник аннотации, определяющий расположение аннотации на странице. |
| soundFile | java.lang.String | Звуковой файл, определяющий звук, который будет воспроизводиться при активации аннотации. |
| soundSampleData | [SoundSampleData](../../com.aspose.pdf/soundsampledata) | Данные звукового образца содержат дополнительные звуковые параметры, такие как частота дискретизации, количество битов на образец и так далее. |
...
**Возвращает:**
[SoundData](../../com.aspose.pdf/sounddata) - Значение SoundData
### getStates() {#getStates--}
```
