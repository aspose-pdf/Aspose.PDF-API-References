...
description: Представляет зачеркнутую аннотацию, которая отображается как зачеркнутая в тексте документа.
type: docs
weight: 339
url: /ru/java/com.aspose.pdf/strikeoutannotation/
---
**Наследование:**
...
Представляет зачеркнутую аннотацию, которая отображается как зачеркнутая в тексте документа.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [StrikeOutAnnotation(Page page, Rectangle rect)](#StrikeOutAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию StrikeOut на указанной странице. |
## Методы
