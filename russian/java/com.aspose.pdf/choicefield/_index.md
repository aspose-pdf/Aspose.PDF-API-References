...
description: Представляет базовый класс для полей выбора.
type: docs
weight: 60
url: /ru/java/com.aspose.pdf/choicefield/
---
**Наследование:**
...
| --- | --- |
| [ChoiceField(Page page, Rectangle rect)](#ChoiceField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор для ChoiceField. |
| [ChoiceField(IDocument doc)](#ChoiceField-com.aspose.pdf.IDocument-) | Создает поле выбора (для Генератора) |
| [ChoiceField(IDocument doc, Rectangle rect)](#ChoiceField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Конструктор для ChoiceField. |
## Поля
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой находится поле. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создано поле выбора. |
