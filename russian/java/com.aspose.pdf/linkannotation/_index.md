...
description: Представляет либо гипертекстовую ссылку на пункт назначения в другом месте документа, либо действие, которое необходимо выполнить.
type: docs
weight: 200
url: /ru/java/com.aspose.pdf/linkannotation/
---
**Наследование:**
...
| --- | --- |
| [LinkAnnotation(Page page, Rectangle rect)](#LinkAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Link на указанной странице. |
## Методы
...
| [getAction()](#getAction--) | Получить действие, которое будет выполняться при активации аннотации ссылки. |
...
| [getDestination()](#getDestination--) | Получить место назначения, которое будет отображаться при активации аннотации. |
...
| [getHighlighting()](#getHighlighting--) | Получите визуальный эффект, который будет использоваться, когда кнопка мыши нажата или удерживается внутри ее активной области. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAction(PdfAction value)](#setAction-com.aspose.pdf.PdfAction-) | Установите действие, которое будет выполняться при активации аннотации ссылки. |
...
| [setDestination(IAppointment value)](#setDestination-com.aspose.pdf.IAppointment-) | Установите пункт назначения, который будет отображаться при активации аннотации. |
...
| [setHighlighting(int value)](#setHighlighting-int-) | Установите визуальный эффект, который будет использоваться при нажатии или удерживании кнопки мыши внутри ее активной области. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент HighlightingMode |
