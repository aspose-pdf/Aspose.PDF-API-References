...
type: docs
weight: 69
url: /ru/java/com.aspose.pdf/comboboxfield/
---
**Наследование:**
...
| --- | --- |
| [ComboBoxField()](#ComboBoxField--) | Конструктор ComboBoxField для использования в Generator. |
| [ComboBoxField(IDocument doc)](#ComboBoxField-com.aspose.pdf.IDocument-) | Создает поле CombBox для работы с генератором. |
| [ComboBoxField(Page page, Rectangle rect)](#ComboBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор поля ComboBox. |
| [ComboBoxField(IDocument doc, Rectangle rect)](#ComboBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Конструктор поля Combobox. |
## Поля
...
| [addOption(String optionName)](#addOption-java.lang.String-) | Добавляет новую опцию с указанным именем. |
...
| [getEditable()](#getEditable--) | Получает редактируемый статус поля. |
...
| [getOptions()](#getOptions--) | Получает коллекцию вариантов выбора. |
...
| [getSelected()](#getSelected--) | Получает индекс выбранного параметра. |
| [getSelectedItems()](#getSelectedItems--) | Задает массив выбранных элементов. |
| [getSpellCheck()](#getSpellCheck--) | Получает статус активности проверки правописания. |
...
| [setEditable(boolean value)](#setEditable-boolean-) | Устанавливает редактируемый статус поля. |
...
| [setSelected(int value)](#setSelected-int-) | Устанавливает индекс выбранной опции. |
...
| [setSpellCheck(boolean value)](#setSpellCheck-boolean-) | Устанавливает статус активности проверки правописания. |
...
Конструктор ComboBoxField для использования в Generator.
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, определяющий размер и положение поля на странице. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором должно быть создано поле. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, определяющий размер и положение поля. |
...
Получает редактируемый статус поля.
...
Получает индекс выбранного параметра. Это свойство позволяет изменить выделение.
...
Получает статус активности проверки правописания.
...
Устанавливает редактируемый статус поля.
...
Устанавливает индекс выбранной опции. Это свойство позволяет изменить выделение.
...
Устанавливает статус активности проверки правописания.
