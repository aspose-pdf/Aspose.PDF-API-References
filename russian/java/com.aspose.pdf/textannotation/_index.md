...
description: Представляет текстовую аннотацию, представляющую собой заметку, прикрепленную к точке в документе PDF.
type: docs
weight: 362
url: /ru/java/com.aspose.pdf/textannotation/
---
**Наследование:**
...
Представляет текстовую аннотацию, которая представляет собой «заметку», прикрепленную к точке в документе PDF.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TextAnnotation(IDocument document)](#TextAnnotation-com.aspose.pdf.IDocument-) | Конструктор для аннотации при использовании в Генераторе. |
| [TextAnnotation(Page page, Rectangle rect)](#TextAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую текстовую аннотацию на указанной странице. |
| [TextAnnotation()](#TextAnnotation--) | Создать экземпляр TextAnnotation |
## Методы
...
| [getIcon()](#getIcon--) | Получает значок, который будет использоваться при отображении аннотации. |
...
| [getOpen()](#getOpen--) | Получает флаг, указывающий, должна ли аннотация изначально отображаться открытой. |
...
| [getState()](#getState--) | Получает состояние, в которое следует установить исходную аннотацию. |
| [getStateModel()](#getStateModel--) | Получает модель состояния |
...
| [setIcon(int value)](#setIcon-int-) | Задает значок, который будет использоваться при отображении аннотации. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Устанавливает флаг, указывающий, должна ли аннотация изначально отображаться открытой. |
...
| [setState(int value)](#setState-int-) | Устанавливает состояние, в которое должна быть установлена исходная аннотация. |
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана текстовая аннотация. |
...
Создать экземпляр TextAnnotation
...
Получает значок, который будет использоваться при отображении аннотации.

**Возвращает:**
int — значение TextIcon
...
Получает флаг, указывающий, должна ли аннотация изначально отображаться открытой.
...
Получает состояние, в которое следует установить исходную аннотацию.

**Возвращает:**
int — значение AnnotationState
...
Получает модель состояния

**Возвращает:**
int — значение AnnotationStateModel
### getStates() {#getStates--}
```
...
Задает значок, который будет использоваться при отображении аннотации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Значение TextIcon |
...
Устанавливает флаг, указывающий, должна ли аннотация изначально отображаться открытой.
...
Устанавливает состояние, в которое должна быть установлена исходная аннотация.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Значение AnnotationState |
