...
type: docs
weight: 211
url: /ru/java/com.aspose.pdf/mdloadoptions/
---
**Наследование:**
...
| --- | --- |
| [MdLoadOptions()](#MdLoadOptions--) | Создает параметры загрузки для преобразования уценки в документ PDF. |
## Методы
...
### MdLoadOptions() {#MdLoadOptions--}
```
public MdLoadOptions()
```


Создает параметры загрузки для преобразования уценки в документ PDF.
