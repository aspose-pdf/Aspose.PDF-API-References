...
description: Некоторые документы имеют большой размер после преобразования в формат PDF/A.
type: docs
weight: 12
...
| [RemoveDuplicatedFonts](#RemoveDuplicatedFonts) | Эта стратегия удаляет все шрифты, которые имеют дубликаты в документе. |
| [RemoveSimilarFontsWithDifferentWidths](#RemoveSimilarFontsWithDifferentWidths) | Эта стратегия похожа на RemoveDuplicatedFonts, но удаляет не полностью дублированные шрифты, а шрифты, похожие друг на друга и отличающиеся только параметром «Ширина». |
| [SubsetFonts](#SubsetFonts) | Это наиболее эффективная стратегия для уменьшения размера документа. |
## Методы
