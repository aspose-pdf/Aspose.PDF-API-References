...
description: Представляет класс для Collection12.3.5 Collections.
type: docs
weight: 62
url: /ru/java/com.aspose.pdf/collection/
---
**Наследование:**
...
| [getClass()](#getClass--) |  |
| [getDefaultEntry()](#getDefaultEntry--) | Имя встроенного файла по умолчанию. |
