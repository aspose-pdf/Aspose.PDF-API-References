...
description: Класс, представляющий аннотацию Circle.
type: docs
weight: 61
url: /ru/java/com.aspose.pdf/circleannotation/
---
**Наследование:**
...
Класс, представляющий аннотацию Circle.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CircleAnnotation(IDocument document)](#CircleAnnotation-com.aspose.pdf.IDocument-) | Конструктор круговой аннотации. |
| [CircleAnnotation(Page page, Rectangle rect)](#CircleAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую аннотацию Circle на указанной странице. |
## Методы
...
| [getFrame()](#getFrame--) | Прямоугольник, описывающий числовые различия между двумя прямоугольниками: запись Rect аннотации и фактические границы основного квадрата или круга. |
...
| [getInteriorColor()](#getInteriorColor--) | Внутренний цвет, которым заполняется прямоугольник или эллипс аннотации. |
...
| [setFrame(Rectangle value)](#setFrame-com.aspose.pdf.Rectangle-) | Прямоугольник, описывающий числовые различия между двумя прямоугольниками: запись Rect аннотации и фактические границы основного квадрата или круга. |
...
| [setInteriorColor(Color value)](#setInteriorColor-com.aspose.pdf.Color-) | Внутренний цвет, которым заполняется прямоугольник или эллипс аннотации. |
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Обязательный прямоугольник, который устанавливает границу аннотации. |
...
Прямоугольник, описывающий числовые различия между двумя прямоугольниками: запись Rect аннотации и фактические границы основного квадрата или круга.

**Возвращает:**
[Rectangle](../../com.aspose.pdf/rectangle) - прямоугольная рамка
...
**Возвращает:**
[Color](../../com.aspose.pdf/color) - внутренний цвет, которым заполняется прямоугольник или эллипс аннотации.
### getMargin() {#getMargin--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.pdf/rectangle) | прямоугольная рамка |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Color](../../com.aspose.pdf/color) | цвет салона |
