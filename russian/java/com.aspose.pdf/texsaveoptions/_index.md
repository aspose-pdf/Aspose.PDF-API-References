...
type: docs
weight: 359
url: /ru/java/com.aspose.pdf/texsaveoptions/
---
**Наследование:**
...
| --- | --- |
| [TeXSaveOptions()](#TeXSaveOptions--) | Инициализирует новый экземпляр класса LaTeXSaveOptions. |
## Методы

| Метод | Описание |
| --- | --- |
| [addFontEncs(String[] fontEncs)](#addFontEncs-java.lang.String...-) | Добавляет кодировку шрифта в список кодировок шрифтов. |
| [clearFontEncs()](#clearFontEncs--) | Очищает список кодировок шрифтов |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getOutDirectoryPath()](#getOutDirectoryPath--) |  Недвижимость для\Параметр _outDirectoryPath. |
| [getPagesCount()](#getPagesCount--) | Получить количество страниц |
...
| [setOutDirectoryPath(String value)](#setOutDirectoryPath-java.lang.String-) |  Недвижимость для\Параметр _outDirectoryPath. |
| [setPagesCount(int value)](#setPagesCount-int-) | Установить количество страниц |
...
Инициализирует новый экземпляр класса LaTeXSaveOptions.

### addFontEncs(String[] fontEncs) {#addFontEncs-java.lang.String...-}
```
...
| --- | --- | --- |
| fontEncs | java.lang.String[] | Шрифты в список кодировок |
...
```
 ...
 Недвижимость для\Параметр _outDirectoryPath.
...
### setPagesCount(int value) {#setPagesCount-int-}
```
