...
description: Представляет явное место назначения, которое отображает страницу с горизонтальной координатой слева, расположенной на левом краю окна, а содержимое страницы увеличивается настолько, чтобы соответствовать всей высоте ее ограничивающей рамки в окне.
type: docs
weight: 121
url: /ru/java/com.aspose.pdf/fitbvexplicitdestination/
---
**Наследование:**
...
Представляет явное место назначения, которое отображает страницу с горизонтальной координатой слева, расположенной на левом краю окна, а содержимое страницы увеличивается настолько, чтобы соответствовать всей высоте ее ограничивающей рамки в окне. Нулевое значение для левого указывает, что текущее значение этого параметра должно быть сохранено без изменений.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FitBVExplicitDestination(Page page, double left)](#FitBVExplicitDestination-com.aspose.pdf.Page-double-) | Создает экземпляр и инициализирует его с помощью объекта страницы DOM и левого параметра. |
| [FitBVExplicitDestination(Document document, int pageNumber, double left)](#FitBVExplicitDestination-com.aspose.pdf.Document-int-double-) | Создает удаленный явный пункт назначения. |
| [FitBVExplicitDestination(int pageNumber, double left)](#FitBVExplicitDestination-int-double-) | Создает удаленный явный пункт назначения. |
## Методы
...
| [getClass()](#getClass--) |  |
| [getLeft()](#getLeft--) | Получает горизонтальную координату слева от левого края окна. |
...
Создает экземпляр и инициализирует его с помощью объекта страницы DOM и левого параметра.
