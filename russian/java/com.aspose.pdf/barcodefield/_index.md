...
description: Класс представляет поле штрих-кода.
type: docs
weight: 31
url: /ru/java/com.aspose.pdf/barcodefield/
---
**Наследование:**
...
| --- | --- |
| [BarcodeField(Page page, Rectangle rect)](#BarcodeField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Инициализирует новый экземпляр класса BarcodeField. |
| [BarcodeField(IDocument doc, Rectangle rect)](#BarcodeField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Инициализирует новый экземпляр класса BarcodeField. |
## Поля
...
| [getCaption()](#getCaption--) | Получает заголовок объекта штрих-кода. |
...
| [getECC()](#getECC--) | Получает целочисленное значение, представляющее коэффициент коррекции ошибок. |
...
| [getResolution()](#getResolution--) | Получает разрешение в точках на дюйм (dpi), при котором отображается объект штрих-кода. |
...
| [getSymbology()](#getSymbology--) | Указывает, какая технология штрих-кода или глифа должна использоваться в этой аннотации. Подробности см. в разделе Символы. |
...
| [getXSymHeight()](#getXSymHeight--) | Получает расстояние по вертикали между двумя модулями штрих-кода, измеренное в пикселях. |
| [getXSymWidth()](#getXSymWidth--) | Получает горизонтальное расстояние в пикселях между двумя модулями штрих-кода. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Устанавливает значение поля. |
...
Инициализирует новый экземпляр класса BarcodeField.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, где разместить новый штрих-код. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Размеры штрих-кода указаны в прямоугольнике. |
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, в котором поле будет размещено на странице. |
...
```
 ...
 Получает целочисленное значение, представляющее коэффициент коррекции ошибок. Для PDF417 должно быть от 0 до 8. Для QRCode должно быть от 0 до 3 (0 для\\u2018L\ \u2019, 1 для\\u2018M\ \u2019, 2 для\\u2018Q\\u2019 и 3 для\\u2018Ч\\u2019).
...
Указывает, какая технология штрих-кода или глифа должна использоваться в этой аннотации. Подробности см. в разделе Символы.

**Возвращает:**
int - элемент символики
...
Получает расстояние по вертикали между двумя модулями штрих-кода, измеренное в пикселях. Отношение XSymHeight/XSymWidth должно быть целым числом. Для PDF417 допустимый диапазон соотношения составляет от 1 до 4. Для QRCode и DataMatrix это соотношение всегда должно быть равно 1.
