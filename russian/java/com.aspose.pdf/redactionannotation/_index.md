...
type: docs
weight: 302
url: /ru/java/com.aspose.pdf/redactionannotation/
---
**Наследование:**
...
| --- | --- |
| [RedactionAnnotation(IDocument document)](#RedactionAnnotation-com.aspose.pdf.IDocument-) | Конструктор для RedactionAnnotation. |
| [RedactionAnnotation(Page page, Rectangle rect)](#RedactionAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор для RedactAnnotation. |
## Методы
...
| [flatten()](#flatten--) | Сглаживает аннотацию, т. е. удаляет аннотацию и добавляет ее содержимое |
...
| [getBorderColor()](#getBorderColor--) | Получает цвет границы, которая рисуется, когда редактирование неактивно. |
...
| [getDefaultAppearance()](#getDefaultAppearance--) | Получает или задает строку оформления по умолчанию, которая будет использоваться при форматировании текста. |
| [getEngineDict()](#getEngineDict--) | Только внутренний |
| [getEngineObj()](#getEngineObj--) | Только для внутреннего использования |
| [getFillColor()](#getFillColor--) | Получает цвет для заполнения аннотации. |
...
| [getOverlayText()](#getOverlayText--) | Текст для печати на редактируемой аннотации. |
...
| [getQuadPoint()](#getQuadPoint--) | Массив из 8xN чисел, указывающих координаты области содержимого, которую предполагается удалить. |
| [getQuadPoints()](#getQuadPoints--) | Получает массив точек, определяющих координаты n четырехугольников. |
...
| [getTextAlignment()](#getTextAlignment--) | Получает выравнивание текста наложения. |
...
| [isRepeat()](#isRepeat--) | Если true, текст наложения будет повторяться в аннотации. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [redact()](#redact--) | Сглаживает аннотацию и редактирует содержимое страницы (т. е. удаляет текст и изображение под отредактированной аннотацией). |
| [redactExact()](#redactExact--) | Сглаживает аннотацию и редактирует содержимое страницы (т. е. удаляет текст и изображение точно под отредактированной аннотацией). |
...
| [setBorderColor(Color value)](#setBorderColor-com.aspose.pdf.Color-) | Устанавливает цвет границы, которая рисуется, когда редактирование не активно. |
...
| [setDefaultAppearance(String value)](#setDefaultAppearance-java.lang.String-) | Получает или задает строку оформления по умолчанию, которая будет использоваться при форматировании текста. |
| [setFillColor(Color value)](#setFillColor-com.aspose.pdf.Color-) | Устанавливает цвет для заливки аннотации. |
...
| [setFontSize(double fontSize)](#setFontSize-double-) | Размер шрифта текста для печати на редактируемой аннотации. |
...
| [setOverlayText(String value)](#setOverlayText-java.lang.String-) | Текст для печати на редактируемой аннотации. |
...
| [setQuadPoint(Point[] value)](#setQuadPoint-com.aspose.pdf.Point---) | Массив из 8xN чисел, указывающих координаты области содержимого, которую предполагается удалить. |
| [setQuadPoints(Point[] value)](#setQuadPoints-com.aspose.pdf.Point---) | Задает массив точек, определяющих координаты n четырехугольников. |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | Задает прямоугольник аннотации. |
| [setRepeat(boolean value)](#setRepeat-boolean-) | Если true, текст наложения будет повторяться в аннотации. |
...
| [setTextAlignment(int value)](#setTextAlignment-int-) | Устанавливает выравнивание текста наложения. |
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана новая аннотация. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещена аннотация. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Положение аннотации на странице. |
...
Сглаживает аннотацию, т. е. удаляет аннотацию и добавляет ее содержимое
...
Получает цвет границы, которая рисуется, когда редактирование неактивно.
...
Получает цвет для заполнения аннотации.
...
Массив из 8xN чисел, указывающих координаты области содержимого, которую предполагается удалить.
...
Получает массив точек, определяющих координаты n четырехугольников. Каждый четырехугольник охватывает слово или группу смежных слов в тексте, лежащем в основе аннотации.
...
Получает выравнивание текста наложения.
...
Сглаживает аннотацию и редактирует содержимое страницы (т. е. удаляет текст и изображение точно под отредактированной аннотацией).
...
Устанавливает цвет границы, которая рисуется, когда редактирование не активно.
...
Устанавливает цвет для заливки аннотации.
...
Размер шрифта текста для печати на редактируемой аннотации.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fontSize | double | целое значение |
...
Задает массив точек, определяющих координаты n четырехугольников. Каждый четырехугольник охватывает слово или группу смежных слов в тексте, лежащем в основе аннотации.
...
Устанавливает выравнивание текста наложения.
