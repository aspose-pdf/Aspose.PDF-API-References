...
description: Класс представляет поле ListBox.
type: docs
weight: 201
url: /ru/java/com.aspose.pdf/listboxfield/
---
**Наследование:**
...
| --- | --- |
| [ListBoxField()](#ListBoxField--) | Конструктор для ListBoxField, который будет использоваться в Generator. |
| [ListBoxField(Page page, Rectangle rect)](#ListBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новое поле ListBox. |
| [ListBoxField(IDocument doc, Rectangle rect)](#ListBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Конструктор поля ListBox. |
## Поля
...
| [getTopIndex()](#getTopIndex--) | Получает индекс верхнего видимого элемента списка. |
...
| [setSelected(int value)](#setSelected-int-) | Получает индекс выбранного элемента. |
| [setSelectedItems(int[] value)](#setSelectedItems-int---) | Задает массив выбранных элементов в списке множественного выбора. |
...
| [setTopIndex(int value)](#setTopIndex-int-) | Устанавливает индекс верхнего видимого элемента списка. |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещен список. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, в котором на странице будет размещен список. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документ, которому будет принадлежать это поле. |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | Прямоугольник, в котором будет размещен список. |
...
Получает индекс верхнего видимого элемента списка.
...
Получает индекс выбранного элемента. Элементы нумеруются с 1.
...
Задает массив выбранных элементов в списке множественного выбора. Для списка с одним выбором возвращается массив с одним элементом.
...
Устанавливает индекс верхнего видимого элемента списка.
