...
type: docs
weight: 394
url: /ru/java/com.aspose.pdf/txtloadoptions/
---
**Наследование:**
...
| --- | --- |
| [TxtLoadOptions()](#TxtLoadOptions--) | Создает параметры загрузки для преобразования текста в документ PDF. |
## Методы
...
Создает параметры загрузки для преобразования текста в документ PDF.
