...
description: Класс описывает аннотацию вложенного файла.
type: docs
weight: 110
url: /ru/java/com.aspose.pdf/fileattachmentannotation/
---
**Наследование:**
...
Класс описывает аннотацию вложенного файла.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FileAttachmentAnnotation(Page page, Rectangle rect, FileSpecification fileSpec)](#FileAttachmentAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.FileSpecification-) | Создает новую аннотацию FileAttachment на указанной странице. |
## Методы
...
| [getFile()](#getFile--) | Получить спецификацию файла, связанного с этой аннотацией. |
...
| [setFile(FileSpecification value)](#setFile-com.aspose.pdf.FileSpecification-) | Установите спецификацию файла, связанного с этой аннотацией. |
...
| [setIcon(int value)](#setIcon-int-) | Устанавливает значок, который будет использоваться при отображении аннотации. |
...
| fileSpec | [FileSpecification](../../com.aspose.pdf/filespecification) | Описывает файл, который должен быть связан с аннотацией. |
...
Получить спецификацию файла, связанного с этой аннотацией.

**Возвращает:**
[FileSpecification](../../com.aspose.pdf/filespecification) - спецификация файла.
### getFlags() {#getFlags--}
```
public int getFlags()
```
...
Установите спецификацию файла, связанного с этой аннотацией.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [FileSpecification](../../com.aspose.pdf/filespecification) | спецификация файла. |
...
Устанавливает значок, который будет использоваться при отображении аннотации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Значение FileIcon |
