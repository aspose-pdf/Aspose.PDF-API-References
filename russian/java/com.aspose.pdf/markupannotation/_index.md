...
type: docs
weight: 206
url: /ru/java/com.aspose.pdf/markupannotation/
---
**Наследование:**
...
| --- | --- |
| [MarkupAnnotation(IDocument document)](#MarkupAnnotation-com.aspose.pdf.IDocument-) | Конструктор для разметки аннотаций. |
| [MarkupAnnotation()](#MarkupAnnotation--) | Конструктор |
## Методы
...
Конструктор для разметки аннотаций.
