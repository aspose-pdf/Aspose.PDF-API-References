...
type: docs
weight: 72
url: /ru/java/com.aspose.pdf/contentdisposition/
---
**Наследование:**
...
| Поле | Описание |
| --- | --- |
| [Attachment](#Attachment) | Результат сохраняется как вложение. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inline](#Inline) | Результат отображается в строке. |
## Методы
...
Результат сохраняется как вложение.
...
Результат отображается в строке.
