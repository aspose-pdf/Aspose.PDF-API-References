...
description: Класс, представляющий поле текстового поля.
type: docs
weight: 363
url: /ru/java/com.aspose.pdf/textboxfield/
---
**Наследование:**
...
| --- | --- |
| [TextBoxField(IDocument doc)](#TextBoxField-com.aspose.pdf.IDocument-) | Конструктор, который следует использовать с генератором. |
| [TextBoxField()](#TextBoxField--) | Создайте экземпляр TextBoxField. |
| [TextBoxField(Page page, Rectangle rect)](#TextBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Конструктор поля TextBox. |
| [TextBoxField(IDocument doc, Rectangle rect)](#TextBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | Конструктор поля TextBox. |
## Поля
...
Создайте экземпляр TextBoxField.
