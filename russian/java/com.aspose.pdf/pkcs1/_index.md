...
description: Представляет объект подписи в соответствии со стандартом PKCS1.
type: docs
weight: 254
url: /ru/java/com.aspose.pdf/pkcs1/
---
**Наследование:**
...
| --- | --- |
| [PKCS1(InputStream image)](#PKCS1-java.io.InputStream-) | Инициализирует новый экземпляр класса PKCS1. |
| [PKCS1()](#PKCS1--) | Инициализирует новый экземпляр класса PKCS1. |
| [PKCS1(String pfx, String password)](#PKCS1-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса PKCS1. |
| [PKCS1(InputStream pfx, String password)](#PKCS1-java.io.InputStream-java.lang.String-) | Инициализирует новый экземпляр класса PKCS1. |
## Методы
