...
type: docs
weight: 114
url: /ru/java/com.aspose.pdf/fileicon/
---
**Наследование:**
...
| [Graph](#Graph) | Значок графика. |
| [Paperclip](#Paperclip) | Значок скрепки. |
| [PushPin](#PushPin) | Значок PushPin (значение по умолчанию). |
| [Tag](#Tag) | Это значок тега. |
## Методы
...
Значок PushPin (значение по умолчанию).
