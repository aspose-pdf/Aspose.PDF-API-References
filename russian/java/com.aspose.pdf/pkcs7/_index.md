...
type: docs
weight: 255
url: /ru/java/com.aspose.pdf/pkcs7/
---
**Наследование:**
...
Представляет PKCS\Объект #7, соответствующий PKCS\ Спецификация #7 в Internet RFC 2315, PKCS\#7: Синтаксис криптографических сообщений, версия 1.5. Дайджест SHA1 диапазона байтов документа инкапсулируется в PKCS.\# 7 Поле SignedData.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PKCS7()](#PKCS7--) | Инициализирует новый экземпляр класса PKCS7. |
| [PKCS7(String pfx, String password)](#PKCS7-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса PKCS7. |
| [PKCS7(InputStream pfx, String password)](#PKCS7-java.io.InputStream-java.lang.String-) | Инициализирует новый экземпляр класса PKCS7. |
## Методы
