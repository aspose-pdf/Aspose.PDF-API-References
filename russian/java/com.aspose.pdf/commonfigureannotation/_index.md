...
description: Абстрактный класс, представляющий общую аннотацию фигуры.
type: docs
weight: 70
url: /ru/java/com.aspose.pdf/commonfigureannotation/
---
**Наследование:**
...
Абстрактный класс, представляющий общую аннотацию фигуры.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CommonFigureAnnotation(IDocument document)](#CommonFigureAnnotation-com.aspose.pdf.IDocument-) | Конструктор для использования в генераторе. |
## Методы
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет размещена аннотация. |
