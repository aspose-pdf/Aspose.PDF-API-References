...
description: Класс представляет объект PDF Artifact.
type: docs
weight: 28
url: /ru/java/com.aspose.pdf/artifact/
---
**Наследование:**
java.lang.Object
...
| --- | --- |
| [Artifact(ArtifactCollection owner, Artifact.ArtifactContext context, System.Collections.Generic.List<Operator> _contents, IPdfDictionary _properties)](#Artifact-com.aspose.pdf.ArtifactCollection-com.aspose.pdf.Artifact.ArtifactContext-com.aspose.ms.System.Collections.Generic.List-com.aspose.pdf.Operator--com.aspose.pdf.engine.data.IPdfDictionary-) | Этот конструктор используется, когда артефакт считывается со страницы. |
| [Artifact(String type, String subType)](#Artifact-java.lang.String-java.lang.String-) | Конструктор артефакта с указанным типом и подтипом |
| [Artifact(int type, int subType)](#Artifact-int-int-) | Конструктор артефакта с указанным типом и подтипом |
## Методы
...
Этот конструктор используется, когда артефакт считывается со страницы. ARtifactCollection передает ресурсы страницы, исходную матрицу, операторы артефакта («содержимое») и словарь свойств.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| owner | [ArtifactCollection](../../com.aspose.pdf/artifactcollection) | Объект ArtifactCollection |
| context | com.aspose.pdf.Artifact.ArtifactContext | Объект ArtifactContext |
| _contents | com.aspose.ms.System.Collections.Generic.List<com.aspose.pdf.Operator> | Сборник операторов |
| _properties | [IPdfDictionary](../../com.aspose.pdf.engine.data/ipdfdictionary) | Объект IPdfDictionary |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| type | java.lang.String | Имя типа артефакта. |
| subType | java.lang.String | Имя подтипа артефакта. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| type | int | Тип артефакта. |
| subType | int | Подтип артефакта. |
