...
type: docs
weight: 100
url: /ru/java/com.aspose.pdf/epubsaveoptions/
---
**Наследование:**
...
| --- | --- |
| [EpubSaveOptions()](#EpubSaveOptions--) | Конструктор |
## Методы
...
| [getClass()](#getClass--) |  |
| [getContentRecognitionMode()](#getContentRecognitionMode--) | Когда PDF-файл (который обычно имеет фиксированный макет) преобразуется, механизм преобразования пытается выполнить группировку и многоуровневый анализ, чтобы восстановить замысел автора исходного документа и получить результат в потоковом макете. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| contentRecognitionMode | int | Элемент RecognitionMode |
