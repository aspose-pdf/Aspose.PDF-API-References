...
description: Представляет собой набросок от руки, состоящий из одного или нескольких непересекающихся путей.
type: docs
weight: 179
url: /ru/java/com.aspose.pdf/inkannotation/
---
**Наследование:**
...
Представляет собой «набросок» от руки, состоящий из одного или нескольких непересекающихся путей.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [InkAnnotation(IDocument document, List<Point[]> inkList)](#InkAnnotation-com.aspose.pdf.IDocument-java.util.List-com.aspose.pdf.Point----) | Конструктор рукописной аннотации для генератора. |
| [InkAnnotation(Page page, Rectangle rect, List<Point[]> inkList)](#InkAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.util.List-com.aspose.pdf.Point----) | Создает новую рукописную аннотацию на указанной странице. |
## Методы
...
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | Обновляет точки в InkList в соответствии с матричным преобразованием. |
...
| [getCapStyle()](#getCapStyle--) | получить стиль окончаний строк рукописных аннотаций. |
...
| [getInkList()](#getInkList--) | Получает список жестов, которые представляют собой независимые линии, представленные Point[] массивы. |
...
| [setCapStyle(int value)](#setCapStyle-int-) | Установите стиль окончания строк рукописных аннотаций. |
...
| [setInkList(List<Point[]> value)](#setInkList-java.util.List-com.aspose.pdf.Point----) | Устанавливает список жестов, которые представляют собой независимые линии, представленные Point[] массивы. |
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана рукописная аннотация. |
| inkList | java.util.List<com.aspose.pdf.Point[]> | Массив точек[] массивы, каждый из которых представляет заштрихованный путь. |
...
получить стиль окончаний строк рукописных аннотаций.

**Возвращает:**
int - элемент CapStyle
...
Получает список жестов, которые представляют собой независимые линии, представленные Point[] массивы.

**Возвращает:**
java.util.List<com.aspose.pdf.Point[]> - Список объектов
### getMargin() {#getMargin--}
```
...
Установите стиль окончания строк рукописных аннотаций.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Элемент CapStyle |
...
Устанавливает список жестов, которые представляют собой независимые линии, представленные Point[] массивы.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.util.List<com.aspose.pdf.Point[]> |  Список объектов |
