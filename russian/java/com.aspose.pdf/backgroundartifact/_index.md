...
description: Класс описывает фоновый артефакт.
type: docs
weight: 30
url: /ru/java/com.aspose.pdf/backgroundartifact/
---
**Наследование:**
...
| [getBackgroundColor()](#getBackgroundColor--) | Получает фоновый цвет фонового артефакта |
| [getBackgroundImage()](#getBackgroundImage--) | Получает фоновое изображение фонового артефакта |
| [getBackgroundImageInternal()](#getBackgroundImageInternal--) | Только для внутреннего использования |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-java.awt.Color-) | Устанавливает фоновый цвет фонового артефакта |
| [setBackgroundImage(InputStream value)](#setBackgroundImage-java.io.InputStream-) | Устанавливает фоновое изображение фонового артефакта |
...
Получает фоновый цвет фонового артефакта
...
Получает фоновое изображение фонового артефакта
...
**Возвращает:**
com.aspose.ms.System.IO.Stream — внутренний объект
...
Устанавливает фоновый цвет фонового артефакта

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.awt.Color | Значение цвета |
...
Устанавливает фоновое изображение фонового артефакта
