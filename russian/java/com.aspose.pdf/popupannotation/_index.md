...
type: docs
weight: 290
url: /ru/java/com.aspose.pdf/popupannotation/
---
**Наследование:**
...
| --- | --- |
| [PopupAnnotation(IDocument document)](#PopupAnnotation-com.aspose.pdf.IDocument-) | Конструктор. для использования в генераторе. |
| [PopupAnnotation(Page page, Rectangle rect)](#PopupAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Создает новую всплывающую аннотацию на указанной странице. |
## Методы
...
| [getOpen()](#getOpen--) | Получает флаг, указывающий, должна ли всплывающая аннотация изначально отображаться открытой. |
...
| [getParent()](#getParent--) | Получает родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Устанавливает флаг, указывающий, должна ли всплывающая аннотация изначально отображаться открытой. |
| [setParent(MarkupAnnotation value)](#setParent-com.aspose.pdf.MarkupAnnotation-) | Задает родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. |
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана новая всплывающая аннотация. |
...
Получает флаг, указывающий, должна ли всплывающая аннотация изначально отображаться открытой.
...
Получает родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. Если эта запись присутствует, записи Contents, M, C и T родительской аннотации должны переопределять записи самой всплывающей аннотации.

**Возвращает:**
[Annotation](../../com.aspose.pdf/annotation) - Объект РазметкаАннотация
...
Устанавливает флаг, указывающий, должна ли всплывающая аннотация изначально отображаться открытой.
...
Задает родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. Если эта запись присутствует, записи Contents, M, C и T родительской аннотации должны переопределять записи самой всплывающей аннотации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [MarkupAnnotation](../../com.aspose.pdf/markupannotation) | Объект MarkupAnnotation |
