...
description: Представляет аннотацию к фильму, содержащую анимированную графику и звук для воспроизведения на экране компьютера и через динамики.
type: docs
weight: 224
url: /ru/java/com.aspose.pdf/movieannotation/
---
**Наследование:**
...
Представляет аннотацию к фильму, содержащую анимированную графику и звук для воспроизведения на экране компьютера и через динамики. Когда аннотация активирована, воспроизводится фильм.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [MovieAnnotation(IDocument document, String movieFile)](#MovieAnnotation-com.aspose.pdf.IDocument-java.lang.String-) | Конструктор для использования с генератором. |
| [MovieAnnotation(Page page, Rectangle rect, String movieFile)](#MovieAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.lang.String-) | Создает новую звуковую аннотацию на указанной странице. |
## Методы
...
| [getAspect()](#getAspect--) | Получает или задает ширину и высоту фильма\Ограничительная рамка \ufffds, в пикселях. |
...
| [getFile()](#getFile--) | Получает спецификацию файла, идентифицирующую файл фильма с самоописанием. |
...
| [getPoster()](#getPoster--) | Получает или задает флаг или поток, определяющий, будет ли отображаться изображение постера, представляющее фильм, и каким образом. |
...
| [getRotate()](#getRotate--) | Получает или задает число градусов, на которое фильм должен быть повернут по часовой стрелке относительно страницы. |
...
| [getTitle()](#getTitle--) | Получает название аннотации к фильму. |
...
| [setAspect(Point value)](#setAspect-com.aspose.pdf.Point-) | Получает или задает ширину и высоту фильма\Ограничительная рамка \ufffds, в пикселях. |
...
| [setFile(FileSpecification value)](#setFile-com.aspose.pdf.FileSpecification-) | Задает спецификацию файла, идентифицирующую файл фильма с самоописанием. |
...
| [setPoster(boolean value)](#setPoster-boolean-) | Получает или задает флаг или поток, определяющий, будет ли отображаться изображение постера, представляющее фильм, и каким образом. |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | Задает прямоугольник аннотации. |
| [setRotate(int value)](#setRotate-int-) | Получает или задает число градусов, на которое фильм должен быть повернут по часовой стрелке относительно страницы. |
| [setTextHorizontalAlignment(int value)](#setTextHorizontalAlignment-int-) | Устанавливает выравнивание текста для аннотации. |
| [setTitle(String value)](#setTitle-java.lang.String-) | Устанавливает название аннотации к фильму. |
...
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана аннотация к фильму. |
| movieFile | java.lang.String | Имя файла фильма. |
...
| movieFile | java.lang.String | Файл фильма, который будет воспроизводиться при активации аннотации. |
...
**Возвращает:**
int — элемент AnnotationType как значение int
...
Получает или задает ширину и высоту фильма\Ограничительная рамка \ufffds, в пикселях.
...
Получает спецификацию файла, идентифицирующую файл фильма с самоописанием.
...
Получает или задает флаг или поток, определяющий, будет ли отображаться изображение постера, представляющее фильм, и каким образом. Если true, изображение постера должно быть получено из файла фильма; если оно ложно, постер не будет отображаться.
...
Получает или задает число градусов, на которое фильм должен быть повернут по часовой стрелке относительно страницы. Значение должно быть кратно 90.
...
Получает название аннотации к фильму.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Point](../../com.aspose.pdf/point) | Экземпляр точки |
...
Задает спецификацию файла, идентифицирующую файл фильма с самоописанием.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [FileSpecification](../../com.aspose.pdf/filespecification) | Объект FileSpecification |
...
Устанавливает название аннотации к фильму.
