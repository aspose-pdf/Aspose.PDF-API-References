...
description: Класс, представляющий аннотацию виджета.
type: docs
weight: 405
url: /ru/java/com.aspose.pdf/widgetannotation/
---
**Наследование:**
...
| --- | --- |
| [WidgetAnnotation(IDocument doc)](#WidgetAnnotation-com.aspose.pdf.IDocument-) | Создать аннотацию (используется для Генератора) |
## Методы
...
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | Документ, в котором будет создана аннотация. |
