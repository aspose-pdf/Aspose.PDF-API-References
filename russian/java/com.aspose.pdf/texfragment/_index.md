...
description: Представляет фрагмент LaTeX.
type: docs
weight: 356
url: /ru/java/com.aspose.pdf/texfragment/
---
**Наследование:**
...
Представляет фрагмент LaTeX.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TeXFragment(String text)](#TeXFragment-java.lang.String-) | Инициализирует новый экземпляр класса HtmlFragment. |
| [TeXFragment(String text, boolean removeIndents)](#TeXFragment-java.lang.String-boolean-) | Инициализирует новый экземпляр класса HtmlFragment. |
## Методы
