...
description: Абстрактный класс, представляющий объект подписи в документе PDF.
type: docs
weight: 323
url: /ru/java/com.aspose.pdf/signature/
---
**Наследование:**
java.lang.Object
```
...
| [Signature(String pfx, String password)](#Signature-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса Signature. |
| [Signature(InputStream pfx, String password)](#Signature-java.io.InputStream-java.lang.String-) | Инициализирует новый экземпляр класса Signature. |
## Методы
...
Инициализирует новый экземпляр класса Signature.
