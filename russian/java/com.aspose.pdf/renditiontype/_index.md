...
type: docs
weight: 308
url: /ru/java/com.aspose.pdf/renditiontype/
---
**Наследование:**
...
| [Media](#Media) | Объект медиа-представления. |
| [Selector](#Selector) | Объект представления селектора. |
| [Undefined](#Undefined) | Тип представления не определен. |
## Методы
...
Тип представления не определен.
