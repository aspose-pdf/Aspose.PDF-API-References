...
description: Создает отсоединенную подпись PKCS7Detached, используя сертификат X509Certificate2.
type: docs
weight: 106
url: /ru/java/com.aspose.pdf/externalsignature/
---
**Наследование:**
...
Создает отдельный PKCS\#7Отдельная подпись с использованием X509Certificate2. Он поддерживает смарт-карты USB, токены без экспортируемых закрытых ключей.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ExternalSignature(System.Security.Cryptography.X509Certificates.X509Certificate2 certificate)](#ExternalSignature-com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2-) | Создает отдельный PKCS\#7Отдельная подпись с использованием X509Certificate2. |
## Методы
...
| [getCertificate()](#getCertificate--) | Сертификат с закрытым ключом. |
| [getClass()](#getClass--) |  |
...
| --- | --- | --- |
| certificate | com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2 | Сертификат с закрытым ключом |
...
**Возвращает:**
com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2 — экземпляр X509Certificate2 с закрытым ключом
### getClass() {#getClass--}
```
