...
description: Представляет явное место назначения, которое отображает страницу с горизонтальной координатой слева, расположенной на левом краю окна, а содержимое страницы увеличивается настолько, чтобы соответствовать всей высоте страницы в окне.
type: docs
weight: 125
url: /ru/java/com.aspose.pdf/fitvexplicitdestination/
---
**Наследование:**
...
| --- | --- |
| [FitVExplicitDestination(Page page, double left)](#FitVExplicitDestination-com.aspose.pdf.Page-double-) | Создает экземпляр и инициализирует его с помощью объекта страницы DOM и левого параметра. |
| [FitVExplicitDestination(Document document, int pageNumber, double left)](#FitVExplicitDestination-com.aspose.pdf.Document-int-double-) | Создает удаленный явный пункт назначения. |
| [FitVExplicitDestination(int pageNumber, double left)](#FitVExplicitDestination-int-double-) | Создает удаленный явный пункт назначения. |
## Методы
