...
description: Представляет класс DocumentWeb
type: docs
weight: 95
url: /ru/java/com.aspose.pdf/documentweb/
---
**Наследование:**
...
Представляет класс DocumentWeb
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentWeb()](#DocumentWeb--) | Инициализирует пустой DocumentWeb. |
| [DocumentWeb(InputStream input)](#DocumentWeb-java.io.InputStream-) | Инициализировать новый экземпляр DocumentWeb из входного потока. |
| [DocumentWeb(InputStream input, String password)](#DocumentWeb-java.io.InputStream-java.lang.String-) |  |
| [DocumentWeb(InputStream input, LoadOptions options)](#DocumentWeb-java.io.InputStream-com.aspose.pdf.LoadOptions-) | Открывает существующий DocumentWeb из потока, обеспечивая необходимое преобразование для получения pdf DocumentWeb. |
| [DocumentWeb(String filename, LoadOptions options)](#DocumentWeb-java.lang.String-com.aspose.pdf.LoadOptions-) |  |
| [DocumentWeb(String filename)](#DocumentWeb-java.lang.String-) | Просто запустите DocumentWeb, используя имя файла . |
| [DocumentWeb(String filename, String password)](#DocumentWeb-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса DocumentWeb для работы с зашифрованным DocumentWeb. |
## Поля
...
| [getMetadataStream()](#getMetadataStream--) | Только для внутреннего использования! |
...
| [getPdfFormat()](#getPdfFormat--) | Получает формат PDF. |
...
| [processParagraphs()](#processParagraphs--) | Сохраняет документ в генератор. |
...
| [save()](#save--) | Сохраняйте документ инкрементально (т. е. используя метод инкрементного обновления). |
| [save(System.IO.Stream output)](#save-com.aspose.ms.System.IO.Stream-) | Только для внутреннего использования |
...
| [save(HttpServletResponse response, String outputFileName, int disposition, SaveOptions options)](#save-javax.servlet.http.HttpServletResponse-java.lang.String-int-com.aspose.pdf.SaveOptions-) | Сохраняет документ в поток ответов с параметрами сохранения. |
...
| [setAbsentFontTryToSubstitute(boolean substitute)](#setAbsentFontTryToSubstitute-boolean-) | Установка флага для замены отсутствующего шрифта. |
...
Инициализирует пустой DocumentWeb.
...
Инициализировать новый экземпляр DocumentWeb из входного потока.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| input | java.io.InputStream | Поток с pdf DocumentWeb. |
...
Открывает существующий DocumentWeb из потока, обеспечивая необходимое преобразование для получения pdf DocumentWeb.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| input | java.io.InputStream | Входной поток для преобразования в pdf DocumentWeb. |
| options | [LoadOptions](../../com.aspose.pdf/loadoptions) | Представляет свойства для преобразования входных данных в формат PDF DocumentWeb. |
...
Просто запустите DocumentWeb, используя имя файла . То же, что и DocumentWeb(Stream) .

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| filename | java.lang.String | Имя pdf-файла DocumentWeb. |
...
Инициализирует новый экземпляр класса DocumentWeb для работы с зашифрованным DocumentWeb.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| filename | java.lang.String | Имя файла DocumentWeb. |
...
**Возвращает:**
boolean - логическое значение True - если документ восстановлен; в противном случае ложно.
### close() {#close--}
```
public void close()
```
...
```
public boolean convert(int fixup, OutputStream outputLog)
```
...
```
public boolean convert(int fixup, OutputStream outputLog, boolean onlyValidation, Object[] parameters)
```
...
**Возвращает:**
[PdfFormat](../../com.aspose.pdf/pdfformat) - Формат PDF
...
Сохраняет документ в генератор.
...
Сохраняйте документ инкрементально (т. е. используя метод инкрементного обновления).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| output | com.aspose.ms.System.IO.Stream | Только для внутреннего использования |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| response | javax.servlet.http.HttpServletResponse | Инкапсулирует информацию HTTP-ответа. |
| outputFileName | java.lang.String | Простое имя файла, т.е. без пути. |
| disposition | int | Представляет заголовок Content-Disposition протокола MIME. |
| options | [SaveOptions](../../com.aspose.pdf/saveoptions) | Сохранить параметры. |
...
### setAbsentFontTryToSubstitute(boolean substitute) {#setAbsentFontTryToSubstitute-boolean-}
```
public void setAbsentFontTryToSubstitute(boolean substitute)
```


Установка флага для замены отсутствующего шрифта.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | логические значения |
