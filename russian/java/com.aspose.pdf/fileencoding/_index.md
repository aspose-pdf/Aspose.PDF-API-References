...
description: Кодировка прикрепленного файла.
type: docs
weight: 111
url: /ru/java/com.aspose.pdf/fileencoding/
---
**Наследование:**
...
| [None](#None) | Файл не сжат. |
| [Zip](#Zip) | Файл сжат с помощью алгоритма ZIP. |
## Методы
...
Файл сжат с помощью алгоритма ZIP.
