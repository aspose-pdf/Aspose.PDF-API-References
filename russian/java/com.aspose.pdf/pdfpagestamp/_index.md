...
type: docs
weight: 279
url: /ru/java/com.aspose.pdf/pdfpagestamp/
---
**Наследование:**
...
| --- | --- |
| [PdfPageStamp(Page pdfPage)](#PdfPageStamp-com.aspose.pdf.Page-) | Конструктор PdfPageStamp. |
| [PdfPageStamp(String fileName, int pageIndex)](#PdfPageStamp-java.lang.String-int-) | Создает штамп страницы Pdf из указанной страницы документа в указанном файле. |
| [PdfPageStamp(InputStream stream, int pageIndex)](#PdfPageStamp-java.io.InputStream-int-) | Создает штамп страницы Pdf из указанной страницы в документе из потока. |
## Методы
...
| [getPdfPage()](#getPdfPage--) | Получает страницу, которая будет использоваться в качестве штампа. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [put(Page page)](#put-com.aspose.pdf.Page-) | Поставить штамп на указанной странице. |
...
| [setPdfPage(Page value)](#setPdfPage-com.aspose.pdf.Page-) | Устанавливает страницу, которая будет использоваться в качестве штампа. |
...
| --- | --- | --- |
| pdfPage | [Page](../../com.aspose.pdf/page) | Страница, которая используется для штамповки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fileName | java.lang.String | Имя и страница файла PDF. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stream | java.io.InputStream | Поток, содержащий PDF |
| pageIndex | int | Индекс страницы. |
...
**Возвращает:**
[Page](../../com.aspose.pdf/page) - Значение страницы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Страница, на которой будет размещен штамп. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Page](../../com.aspose.pdf/page) | Объект страницы |
