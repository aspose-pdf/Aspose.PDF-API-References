...
type: docs
weight: 79
url: /ru/java/com.aspose.pdf/customexplicitdestination/
---
**Наследование:**
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) | Преобразует в номер страницы. |
| [wait()](#wait--) |  |
...
Возвращает пункт назначения PageNumber

**Возвращает:**
java.lang.String — интерпретация строк.
### wait() {#wait--}
```
