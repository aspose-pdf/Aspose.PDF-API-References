...
type: docs
weight: 230
url: /ru/java/com.aspose.pdf/numberingstyle/
---
**Наследование:**
...
| [LettersLowercase](#LettersLowercase) | Строчные латинские буквы (a, b, c...). |
| [LettersUppercase](#LettersUppercase) | Прописные латинские буквы (A, B, C...). |
| [None](#None) | Нет нумерации. |
| [NumeralsArabic](#NumeralsArabic) | Арабские десятичные числа. |
| [NumeralsRomanLowercase](#NumeralsRomanLowercase) | Строчные римские цифры (i, ii, iii...). |
| [NumeralsRomanUppercase](#NumeralsRomanUppercase) | Прописные римские цифры (I, II, III...). |
## Методы
