...
type: docs
weight: 91
url: /ru/java/com.aspose.pdf/document/
---
**Наследование:**
...
| [Document(byte[] input)](#Document-byte---) | Инициализировать новый экземпляр документа из входного массива байтов. |
| [Document(InputStream input)](#Document-java.io.InputStream-) | Инициализировать новый экземпляр документа из входного потока. |
| [Document(InputStream input, String password)](#Document-java.io.InputStream-java.lang.String-) | Инициализировать новый экземпляр документа из входного потока. |
| [Document(System.IO.Stream input)](#Document-com.aspose.ms.System.IO.Stream-) | Инициализировать новый экземпляр документа из входного потока. |
| [Document(InputStream input, String password, boolean isManagedStream)](#Document-java.io.InputStream-java.lang.String-boolean-) | Инициализировать новый экземпляр документа из входного потока. |
| [Document(InputStream input, boolean isManagedStream)](#Document-java.io.InputStream-boolean-) | Инициализировать новый экземпляр документа из входного потока. |
| [Document(InputStream input, LoadOptions options)](#Document-java.io.InputStream-com.aspose.pdf.LoadOptions-) | Открывает существующий документ из потока, обеспечивая необходимое преобразование для получения pdf-документа. |
| [Document(String filename, LoadOptions options)](#Document-java.lang.String-com.aspose.pdf.LoadOptions-) | Открывает существующий документ из файла, обеспечивая необходимое преобразование для получения документа в формате pdf. |
| [Document(System.IO.Stream input, String password)](#Document-com.aspose.ms.System.IO.Stream-java.lang.String-) | Открывает существующий документ из потока. |
| [Document(String filename)](#Document-java.lang.String-) | Просто запустите документ, используя имя файла. |
| [Document(String filename, String password)](#Document-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса Document для работы с зашифрованным документом. |
| [Document(String filename, String password, boolean isManagedStream)](#Document-java.lang.String-java.lang.String-boolean-) | Инициализирует новый экземпляр класса Document для работы с зашифрованным документом. |
## Поля

| Поле | Описание |
| --- | --- |
| [FontSubstitution](#FontSubstitution) | Это происходит, когда шрифт заменяет другой шрифт в документе. |
## Методы
...
| [bindXml(InputStream xmlStream, InputStream xslStream)](#bindXml-java.io.InputStream-java.io.InputStream-) | Привязать xml/xsl к документу |
| [bindXml(InputStream xmlStream, InputStream xslStream, System.Xml.XmlReaderSettings settings)](#bindXml-java.io.InputStream-java.io.InputStream-com.aspose.ms.System.Xml.XmlReaderSettings-) | Привязать xml/xsl к документу |
...
| [convert(Document.CallBackGetHocr callback, boolean isTextVisible, boolean isOriginalImage)](#convert-com.aspose.pdf.Document.CallBackGetHocr-boolean-boolean-) | Преобразование документа и сохранение ошибок в указанный файл. |
...
| [convert(int fixup, OutputStream outputLog)](#convert-int-java.io.OutputStream-) | Преобразуйте документ, применив Fixup. |
| [convert(int fixup, OutputStream outputLog, boolean onlyValidation, Object[] parameters)](#convert-int-java.io.OutputStream-boolean-java.lang.Object---) | Преобразуйте документ, применив Fixup. |
| [convert(int fixup, String outputLog)](#convert-int-java.lang.String-) | Преобразуйте документ, применив Fixup. |
| [convert(int fixup, String outputLog, boolean onlyValidation, Object[] parameters)](#convert-int-java.lang.String-boolean-java.lang.Object---) | Преобразуйте документ, применив Fixup. |
| [convert(InputStream srcStream, LoadOptions loadOptions, OutputStream dstStream, SaveOptions saveOptions)](#convert-java.io.InputStream-com.aspose.pdf.LoadOptions-java.io.OutputStream-com.aspose.pdf.SaveOptions-) | Преобразует поток в исходном формате в поток в целевом формате. |
| [convert(InputStream srcStream, LoadOptions loadOptions, String dstFileName, SaveOptions saveOptions)](#convert-java.io.InputStream-com.aspose.pdf.LoadOptions-java.lang.String-com.aspose.pdf.SaveOptions-) | Преобразует поток в исходном формате в целевой файл в целевом формате. |
| [convert(OutputStream outputLogStream, PdfFormat format, int action)](#convert-java.io.OutputStream-com.aspose.pdf.PdfFormat-int-) | Преобразование документа и сохранение ошибок в указанный поток. |
| [convert(OutputStream outputLogStream, PdfFormat format, int action, int transparencyAction)](#convert-java.io.OutputStream-com.aspose.pdf.PdfFormat-int-int-) | Преобразование документа и сохранение ошибок в указанный файл. |
| [convert(String srcFileName, LoadOptions loadOptions, OutputStream dstStream, SaveOptions saveOptions)](#convert-java.lang.String-com.aspose.pdf.LoadOptions-java.io.OutputStream-com.aspose.pdf.SaveOptions-) | Преобразует исходный файл в исходном формате в поток в целевом формате. |
| [convert(String srcFileName, LoadOptions loadOptions, String dstFileName, SaveOptions saveOptions)](#convert-java.lang.String-com.aspose.pdf.LoadOptions-java.lang.String-com.aspose.pdf.SaveOptions-) | Преобразует исходный файл в исходном формате в целевой файл в целевом формате. |
...
| [convertInternal(System.IO.Stream outputLogStream, PdfFormat format, int action)](#convertInternal-com.aspose.ms.System.IO.Stream-com.aspose.pdf.PdfFormat-int-) | Преобразование документа и сохранение ошибок в указанный поток. |
| [convertPageToPNGMemoryStream(Page page)](#convertPageToPNGMemoryStream-com.aspose.pdf.Page-) | Конвертируйте страницу в PNG для потока изображений DSR, OMR, OCR. |
...
| [exportAnnotationsToXfdf(OutputStream output)](#exportAnnotationsToXfdf-java.io.OutputStream-) | Экспорт всех аннотаций документа в поток. |
...
| [getAbsentFontHandler()](#getAbsentFontHandler--) | Уведомление об отсутствии шрифтов при обработке документов. |
| [getActions()](#getActions--) | Получает действия документа. |
| [getAllowReusePageContent()](#getAllowReusePageContent--) | Позволяет объединять содержимое страниц для оптимизации размера документа. |
...
| [getFontUtilities()](#getFontUtilities--) | Экземпляр IDocumentFontUtilities |
...
| [getJavaScript()](#getJavaScript--) | Коллекция JavaScript уровня документа. |
...
| [getPdfFormat()](#getPdfFormat--) | Получает формат pdfa |
| [getPermissions()](#getPermissions--) | Получает разрешения документа. |
| [getTaggedContent()](#getTaggedContent--) | Получает доступ к содержимому TaggedPdf. |
| [getVersion()](#getVersion--) | Получает версию Pdf из заголовка файла Pdf. |
| [getXmpMetadata(OutputStream output)](#getXmpMetadata-java.io.OutputStream-) | Получить метаданные XMP из документа. |
| [hashCode()](#hashCode--) |  |
| [importAnnotationsFromXfdf(InputStream stream)](#importAnnotationsFromXfdf-java.io.InputStream-) | Импорт аннотаций из потока в документ. |
...
| [isAbsentFontTryToSubstitute()](#isAbsentFontTryToSubstitute--) | Флаг, информирующий о замене отсутствующего шрифта. |
...
| [isEnableObjectUnload()](#isEnableObjectUnload--) | Получить или установить флаг, разрешающий частичную выгрузку документа из памяти. |
...
| [isHandleSignatureChange()](#isHandleSignatureChange--) | Выбросить исключение, если документ сохранится с изменениями и будет иметь подпись |
...
| [isHideWindowUI()](#isHideWindowUI--) | Получает флаг, указывающий, должны ли быть скрыты элементы пользовательского интерфейса, когда документ активен. |
| [isLicensed()](#isLicensed--) | Получает лицензированное состояние системы. |
| [isLinearized()](#isLinearized--) | Получает значение, указывающее, является ли документ линеаризованным. |
...
| [isPdfaCompliant()](#isPdfaCompliant--) | Получает документ, совместимый с pdfa. |
| [isSkippedPdfaCompliantValidationBeforeSave()](#isSkippedPdfaCompliantValidationBeforeSave--) | По умолчанию процесс проверки pdfa необходим для обновления или удаления данных, совместимых с pdfa, если некоторые правила были нарушены. |
...
| [preSave(PageCollection pages, SaveOptions saveOptions)](#preSave-com.aspose.pdf.PageCollection-com.aspose.pdf.SaveOptions-) | Внутренний метод |
...
| [save(System.IO.Stream output)](#save-com.aspose.ms.System.IO.Stream-) | Сохраняет документ в поток. |
| [save(SaveOptions options)](#save-com.aspose.pdf.SaveOptions-) | Сохраняет документ с параметрами сохранения. |
| [save(OutputStream output)](#save-java.io.OutputStream-) | Сохраняет документ в поток. |
| [save(OutputStream outputStream, SaveFormat format)](#save-java.io.OutputStream-com.aspose.pdf.SaveFormat-) | Сохраняет документ с новым именем вместе с форматом файла. |
| [save(OutputStream outputStream, SaveOptions options)](#save-java.io.OutputStream-com.aspose.pdf.SaveOptions-) | Сохраняет документ в поток с параметрами сохранения. |
| [save(String outputFileName)](#save-java.lang.String-) | Сохраняет документ в указанный файл. |
| [save(String outputFileName, SaveFormat format)](#save-java.lang.String-com.aspose.pdf.SaveFormat-) | Сохраняет документ с новым именем вместе с форматом файла. |
...
| [setAbsentFontHandler(ADocument.AbsentFontHandler absentFontHandler)](#setAbsentFontHandler-com.aspose.pdf.ADocument.AbsentFontHandler-) | Уведомление об отсутствии шрифтов при обработке документов. |
...
| [setAllowReusePageContent(boolean value)](#setAllowReusePageContent-boolean-) | Позволяет объединять содержимое страниц для оптимизации размера документа. |
...
| [setEnableObjectUnload(boolean value)](#setEnableObjectUnload-boolean-) | Получить или установить флаг, разрешающий частичную выгрузку документа из памяти. |
...
| [setHandleSignatureChange(boolean value)](#setHandleSignatureChange-boolean-) | Выбросить исключение, если документ сохранится с изменениями и будет иметь подпись |
...
| [setIgnoreCorruptedObjects(boolean value)](#setIgnoreCorruptedObjects-boolean-) | Получает или устанавливает флаг игнорирования ошибок в исходных файлах. |
...
| [setPageMode(int pageMode)](#setPageMode-int-) | Устанавливает режим страницы, определяя, как документ должен отображаться при открытии. |
| [setSkipPdfaCompliantValidationBeforeSave(boolean pdfaCompliantValidationBeforeSave)](#setSkipPdfaCompliantValidationBeforeSave-boolean-) | По умолчанию процесс проверки pdfa необходим для обновления или удаления pdfa, если некоторые правила были нарушены. |
...
| [suppressUpdate()](#suppressUpdate--) | Подавляет обновление данных содержимого для всех страниц Содержимое не обновляется до тех пор, пока не будет вызвано ResumeUpdate |
| [toString()](#toString--) |  |
| [updatePages()](#updatePages--) |  |
| [validate(PdfFormatConversionOptions options)](#validate-com.aspose.pdf.PdfFormatConversionOptions-) | Подтвердить документ в указанный файл. |
...
| --- | --- | --- |
| input | byte[] | байтовый массив с pdf-документом. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| input | com.aspose.ms.System.IO.Stream | Поток с документом PDF. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| input | com.aspose.ms.System.IO.Stream | Входной файл для преобразования в PDF-документ. |
| password | java.lang.String | Пароль пользователя или владельца. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| xmlStream | java.io.InputStream | XML-поток. |
| xslStream | java.io.InputStream | Поток xsl, если используется XSLT. |
...
| xmlStream | java.io.InputStream | XML-поток. |
| xslStream | java.io.InputStream | Поток xsl, если используется XSLT. |
| settings | com.aspose.ms.System.Xml.XmlReaderSettings | Настройки чтения xml. |
...
| --- | --- | --- |
| callback | [CallBackGetHocr](../../com.aspose.pdf/callbackgethocr) | Действие для объектов, которые нельзя конвертировать |
| isTextVisible | boolean | логическое значение |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fixup | int | Тип исправления. |
| outputLog | java.io.OutputStream | Журнал процесса. |
...
| parameters | java.lang.Object[] | Свойства Fixup, которые нельзя задать. |
...
| --- | --- | --- |
| fixup | int | Тип исправления. |
| outputLog | java.lang.String | Журнал процесса. |
...
| loadOptions | [LoadOptions](../../com.aspose.pdf/loadoptions) | Формат исходного потока. |
| dstStream | java.io.OutputStream | Целевой поток. |
| saveOptions | [SaveOptions](../../com.aspose.pdf/saveoptions) | Формат конечного файла. |
...
| srcStream | java.io.InputStream | Исходный поток. |
| loadOptions | [LoadOptions](../../com.aspose.pdf/loadoptions) | Формат исходного потока. |
| dstFileName | java.lang.String | Имя файла назначения. |
| saveOptions | [SaveOptions](../../com.aspose.pdf/saveoptions) | Формат конечного файла. |
...
| loadOptions | [LoadOptions](../../com.aspose.pdf/loadoptions) | Формат исходного файла. |
| dstStream | java.io.OutputStream | Целевой поток. |
| saveOptions | [SaveOptions](../../com.aspose.pdf/saveoptions) | Формат целевого потока. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| outputLogStream | com.aspose.ms.System.IO.Stream | Поток, где будут храниться комментарии. |
| format | [PdfFormat](../../com.aspose.pdf/pdfformat) | Формат пдф. |
| action | int | Процедура обратного вызова для распознавания hocr. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | Объект страницы для преобразования. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| output | java.io.OutputStream | Поток, где хранится XFDF. |
...
**Возвращает:**
com.aspose.pdf.ADocument.AbsentFontHandler — экземпляр ADocument.AbsentFontHandler
...
**Возвращает:**
[DestinationCollection](../../com.aspose.pdf/destinationcollection) - Элемент DestinationCollection
...
**Возвращает:**
[IDocumentFontUtilities](../../com.aspose.pdf/idocumentfontutilities) - Экземпляр IDocumentFontUtilities
### getForm() {#getForm--}
```
public Form getForm()
```
...
**Возвращает:**
[JavaScriptCollection](../../com.aspose.pdf/javascriptcollection) - Объект JavaScriptCollection
...
**Возвращает:**
[PageCollection](../../com.aspose.pdf/pagecollection) - Объект PageCollection
...
**Возвращает:**
[ITaggedContent](../../com.aspose.pdf.tagged/itaggedcontent) - Экземпляр ITaggedContent
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| output | java.io.OutputStream | Поток, в котором будут храниться метаданные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stream | java.io.InputStream | Поток содержит данные XFDF. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| pages | [PageCollection](../../com.aspose.pdf/pagecollection) | экземпляр PageCollection |
| saveOptions | [SaveOptions](../../com.aspose.pdf/saveoptions) | Экземпляр SaveOptions |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| output | com.aspose.ms.System.IO.Stream | Поток, где будет храниться оболочка документа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| outputStream | java.io.OutputStream | Поток, где документ будет храниться. |
| format | [SaveFormat](../../com.aspose.pdf/saveformat) | Параметры формата. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| outputFileName | java.lang.String | Объект OutputStream |
...
| --- | --- | --- |
| device | [DocumentDevice](../../com.aspose.pdf.devices/documentdevice) | Устройство документа, которое используется для обработки документа. |
| output | java.io.OutputStream | Выходной поток содержит результаты обработки документа на данном устройстве. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| absentFontHandler | com.aspose.pdf.ADocument.AbsentFontHandler | Экземпляр ADocument.AbsentFontHandler |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| pdfaCompliantValidationBeforeSave | boolean | логическое значение |
...
| --- | --- | --- |
| outputLogFileName | java.lang.String | Путь к файлу, в котором будут храниться комментарии. |
| format | [PdfFormat](../../com.aspose.pdf/pdfformat) | Элемент PDFFormat. |
