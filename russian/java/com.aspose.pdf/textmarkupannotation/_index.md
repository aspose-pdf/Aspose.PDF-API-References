...
description: Абстрактный базовый класс для аннотаций текстовой разметки.
type: docs
weight: 378
url: /ru/java/com.aspose.pdf/textmarkupannotation/
---
**Наследование:**
...
Абстрактный базовый класс для аннотаций текстовой разметки.
## Методы
