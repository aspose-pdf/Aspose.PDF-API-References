...
type: docs
weight: 428
url: /ru/java/com.aspose.pdf/xpssaveoptions/
---
**Наследование:**
...
| [getSaveTransparentTexts()](#getSaveTransparentTexts--) | Указывает, следует ли сохранять прозрачный (OCR) текст. |
...
| [setSaveTransparentTexts(boolean value)](#setSaveTransparentTexts-boolean-) | Указывает, следует ли сохранять прозрачный (OCR) текст. |
