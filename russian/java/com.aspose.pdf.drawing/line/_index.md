...
description: Представляет линию.
type: docs
weight: 17
url: /ru/java/com.aspose.pdf.drawing/line/
---
**Наследование:**
...
| --- | --- |
| [Line()](#Line--) | Только для внутреннего использования |
| [Line(float[] positionArray)](#Line-float---) | Инициализирует новый экземпляр класса Line. |
## Методы
...
| [getPositionArray()](#getPositionArray--) | Получает объект, указывающий массив позиций. Массив состоит из координат каждой контрольной точки линии. напрямую. |
...
| [setPositionArray(float[] value)](#setPositionArray-float---) | Задает объект, указывающий массив позиций. Массив состоит из координат каждой контрольной точки линии. напрямую. |
...
| --- | --- | --- |
| positionArray | float[] | Массив позиций строки. |
...
Задает объект, указывающий массив позиций. Массив состоит из координат каждой контрольной точки линии. напрямую.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | float[] | который указывает массив позиций. |
