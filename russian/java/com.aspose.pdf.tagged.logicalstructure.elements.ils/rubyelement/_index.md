...
description: Представляет структурный элемент Ruby в логической структуре.
type: docs
weight: 21
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/rubyelement/
---
**Наследование:**
...
Представляет структурный элемент Ruby в логической структуре.
## Конструкторы
