...
type: docs
weight: 16
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/linkelement/
---
**Наследование:**
...
| [getAlternateDescriptions()](#getAlternateDescriptions--) | Получает или задает альтернативные описания для аннотации. |
...
| [getHyperlink()](#getHyperlink--) | Получает или задает гиперссылку для элемента ссылки. |
...
| [setAlternateDescriptions(String value)](#setAlternateDescriptions-java.lang.String-) | Получает или задает альтернативные описания для аннотации. |
...
| [setHyperlink(Hyperlink value)](#setHyperlink-com.aspose.pdf.Hyperlink-) | Получает или задает гиперссылку для элемента ссылки. |
...
Получает или задает альтернативные описания для аннотации. Текст, который должен отображаться для аннотации, или, если этот тип аннотации не отображает текст, альтернативное описание содержания аннотации в удобочитаемой форме.
...
**Возвращает:**
[Hyperlink](../../com.aspose.pdf/hyperlink) - Экземпляр гиперссылки
### getID() {#getID--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Hyperlink](../../com.aspose.pdf/hyperlink) | Экземпляр гиперссылки |
