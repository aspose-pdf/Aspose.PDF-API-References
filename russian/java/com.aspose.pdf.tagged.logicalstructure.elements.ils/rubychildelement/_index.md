...
description: Представляет собой базовый класс для дочерних элементов Ruby в логической структуре.
type: docs
weight: 20
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/rubychildelement/
---
**Наследование:**
...
Представляет собой базовый класс для дочерних элементов Ruby в логической структуре.
## Методы
