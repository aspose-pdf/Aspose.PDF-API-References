...
description: Представляет базовый класс для элементов текстовой структуры встроенного уровня в логической структуре.
type: docs
weight: 15
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/ilstextelement/
---
**Наследование:**
...
Представляет базовый класс для элементов текстовой структуры встроенного уровня в логической структуре.
## Методы
