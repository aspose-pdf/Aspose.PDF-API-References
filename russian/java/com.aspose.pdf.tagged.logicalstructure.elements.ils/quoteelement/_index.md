...
description: Представляет элемент структуры Quote в логической структуре.
type: docs
weight: 18
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/quoteelement/
---
**Наследование:**
...
Представляет элемент структуры Quote в логической структуре.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [QuoteElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)](#QuoteElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-) |  |
## Методы
...
### QuoteElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity) {#QuoteElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-}
```
public QuoteElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)
```
...
Значение: объект StructureTextState для текущего элемента.
