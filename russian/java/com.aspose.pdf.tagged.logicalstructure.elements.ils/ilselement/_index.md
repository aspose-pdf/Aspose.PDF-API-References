...
description: Представляет базовый класс для элементов структуры встроенного уровня в логической структуре.
type: docs
weight: 14
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/ilselement/
---
**Наследование:**
...
Представляет базовый класс для элементов структуры встроенного уровня в логической структуре.
## Методы
