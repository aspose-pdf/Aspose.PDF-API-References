...
description: Представляет собой базовый класс для дочерних элементов Warichu в логической структуре.
type: docs
weight: 26
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/warichuchildelement/
---
**Наследование:**
...
Представляет собой базовый класс для дочерних элементов Warichu в логической структуре.
## Методы
