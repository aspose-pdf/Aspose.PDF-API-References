...
type: docs
weight: 25
url: /ru/java/com.aspose.pdf.facades/form/
---
**Наследование:**
...
| --- | --- |
| [Form()](#Form--) | Построение формы без параметров. |
| [Form(IDocument document)](#Form-com.aspose.pdf.IDocument-) | Инициализирует новый объект формы на основе документа. |
| [Form(IDocument document, OutputStream destStream)](#Form-com.aspose.pdf.IDocument-java.io.OutputStream-) | Инициализирует новый объект формы на основе документа. |
| [Form(IDocument document, String destFileName)](#Form-com.aspose.pdf.IDocument-java.lang.String-) | Инициализирует новый объект формы на основе документа. |
| [Form(InputStream srcStream)](#Form-java.io.InputStream-) | Конструктор формы. |
| [Form(InputStream srcStream, OutputStream destStream)](#Form-java.io.InputStream-java.io.OutputStream-) | Конструктор формы с двумя параметрами потока. |
| [Form(InputStream srcStream, String destFileName)](#Form-java.io.InputStream-java.lang.String-) | Конструктор формы |
| [Form(String srcFileName)](#Form-java.lang.String-) | Конструктор формы. |
| [Form(String srcFileName, OutputStream destStream)](#Form-java.lang.String-java.io.OutputStream-) | Конструктор формы. |
| [Form(String srcFileName, String destFileName)](#Form-java.lang.String-java.lang.String-) | Конструктор класса Form. |
## Методы
...
| [dispose()](#dispose--) | Закрывает все открытые ресурсы. |
...
| [getRichText(String fieldName)](#getRichText-java.lang.String-) | Получите значение поля Rich Text, включая информацию о форматировании каждого символа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | Документ пдф. Obsolete("Использовать конструктор без адресата") |
