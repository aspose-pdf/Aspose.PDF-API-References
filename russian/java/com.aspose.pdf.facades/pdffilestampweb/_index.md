...
type: docs
weight: 47
url: /ru/java/com.aspose.pdf.facades/pdffilestampweb/
---
**Наследование:**
...
| --- | --- |
| [PdfFileStampWeb()](#PdfFileStampWeb--) | Конструктор PdfFileStamp. |
| [PdfFileStampWeb(IDocument document)](#PdfFileStampWeb-com.aspose.pdf.IDocument-) | Инициализирует новый объект PdfFileStamp на основе документа. |
| [PdfFileStampWeb(IDocument document, OutputStream outputStream)](#PdfFileStampWeb-com.aspose.pdf.IDocument-java.io.OutputStream-) | Инициализирует новый объект PdfFileStamp на основе документа. |
| [PdfFileStampWeb(IDocument document, String outputFile)](#PdfFileStampWeb-com.aspose.pdf.IDocument-java.lang.String-) | Инициализирует новый объект PdfFileStamp на основе документа. |
| [PdfFileStampWeb(InputStream inputStream, OutputStream outputStream)](#PdfFileStampWeb-java.io.InputStream-java.io.OutputStream-) | Конструктор для PdfFileStamp. |
| [PdfFileStampWeb(InputStream inputStream, OutputStream outputStream, boolean keepSecurity)](#PdfFileStampWeb-java.io.InputStream-java.io.OutputStream-boolean-) | Конструктор PdfFileStamp. |
| [PdfFileStampWeb(String inputFile, String outputFile)](#PdfFileStampWeb-java.lang.String-java.lang.String-) | Конструктор для PdfFileStamp. |
| [PdfFileStampWeb(String inputFile, String outputFile, boolean keepSecurity)](#PdfFileStampWeb-java.lang.String-java.lang.String-boolean-) | Конструктор для PdfFileStamp. |
| [PdfFileStampWeb(InputStream inputStream, HttpServletResponse response)](#PdfFileStampWeb-java.io.InputStream-javax.servlet.http.HttpServletResponse-) | Создает PdfFileStampWeb, который сохраняет результат в объекте HttpResponse. |
| [PdfFileStampWeb(String inputFile, HttpServletResponse response)](#PdfFileStampWeb-java.lang.String-javax.servlet.http.HttpServletResponse-) | Создает PdfFileStampWeb, который сохраняет результат в объекте HttpResponse. |
## Поля
...
| [getPageHeight()](#getPageHeight--) | Получает высоту первой страницы в исходном файле. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stamp | [Stamp](../../com.aspose.pdf.facades/stamp) | Объект штемпеля. |
