...
description: Представляет класс для создания PDF из формата Computer Graphics MetafileCGM.
type: docs
weight: 16
url: /ru/java/com.aspose.pdf.facades/cgmpdfproducer/
---
**Наследование:**
...
Представляет класс для создания PDF из формата метафайла компьютерной графики (CGM).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CgmPdfProducer(ImportOptions options)](#CgmPdfProducer-com.aspose.pdf.ImportOptions-) | Конструктор |
## Методы
...
| --- | --- | --- |
| options | [ImportOptions](../../com.aspose.pdf/importoptions) | Объект ImportOptions |
