...
type: docs
weight: 16
url: /ru/java/com.aspose.pdf.exceptions/incorrectcmapusageexception/
---
**Наследование:**
...
| --- | --- |
| [IncorrectCMapUsageException(String message)](#IncorrectCMapUsageException-java.lang.String-) | Инициализирует новый экземпляр класса IncorrectCMapUsageException. |
## Методы
...
### IncorrectCMapUsageException(String message) {#IncorrectCMapUsageException-java.lang.String-}
```
