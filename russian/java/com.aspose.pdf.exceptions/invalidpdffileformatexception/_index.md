...
type: docs
weight: 23
url: /ru/java/com.aspose.pdf.exceptions/invalidpdffileformatexception/
---
**Наследование:**
...
| --- | --- |
| [InvalidPdfFileFormatException(String message)](#InvalidPdfFileFormatException-java.lang.String-) | Инициализирует новый экземпляр класса InvalidPdfFileFormatException. |
## Методы
...
Инициализирует новый экземпляр класса InvalidPdfFileFormatException.
