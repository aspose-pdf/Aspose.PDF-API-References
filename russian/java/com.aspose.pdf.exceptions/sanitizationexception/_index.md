...
description: Исключение, которое выдается при сбое операции очистки.
type: docs
weight: 29
url: /ru/java/com.aspose.pdf.exceptions/sanitizationexception/
---
**Наследование:**
...
Исключение, которое выдается при сбое операции очистки.
## Конструкторы
...
```
 ...
 Инициализирует новый экземпляр[SanitizationException](../../com.aspose.pdf.exceptions/sanitizationexception) учебный класс.
...
| innerException | java.lang.RuntimeException | Исключение, являющееся причиной текущего исключения, или пустая ссылка (Nothing в Visual Basic), если внутреннее исключение не указано. |
