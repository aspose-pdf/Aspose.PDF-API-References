...
description: Исключение, которое выдается, когда операция с типом формы недопустима.
type: docs
weight: 21
url: /ru/java/com.aspose.pdf.exceptions/invalidformtypeoperationexception/
---
**Наследование:**
...
Исключение, которое выдается, когда операция с типом формы недопустима.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [InvalidFormTypeOperationException(String message)](#InvalidFormTypeOperationException-java.lang.String-) | Инициализирует новый экземпляр класса InvalidFormTypeOperationException. |
## Методы
...
Инициализирует новый экземпляр класса InvalidFormTypeOperationException.
