...
description: Исключение, которое выдается, когда файл Cgm недействителен.
type: docs
weight: 19
url: /ru/java/com.aspose.pdf.exceptions/invalidcgmfileformatexception/
---
**Наследование:**
...
Исключение, которое выдается, когда файл Cgm недействителен.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [InvalidCgmFileFormatException()](#InvalidCgmFileFormatException--) | Инициализирует новый экземпляр класса InvalidCgmFileFormatException. |
| [InvalidCgmFileFormatException(String message)](#InvalidCgmFileFormatException-java.lang.String-) | Инициализирует новый экземпляр класса InvalidCgmFileFormatException. |
## Методы
...
Инициализирует новый экземпляр класса InvalidCgmFileFormatException.
