...
type: docs
weight: 10
url: /ru/java/com.aspose.pdf.operators/bdc/
---
**Наследование:**
...
класс, представляющий оператор BDC (начало последовательности помеченного содержимого)
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BDC(String tag)](#BDC-java.lang.String-) | Инициализирует оператор. |
| [BDC(int index, ICommand command)](#BDC-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
