...
description: Класс, представляющий путь отсечения оператора W, использующий ненулевое правило намотки.
type: docs
weight: 18
url: /ru/java/com.aspose.pdf.operators/clip/
---
**Наследование:**
...
| --- | --- |
| [Clip(int index, ICommand command)](#Clip-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [Clip()](#Clip--) | Конструктор для написания программы. |
## Методы
...
| [toString()](#toString--) | Возвращает текстовое представление операторов. |
