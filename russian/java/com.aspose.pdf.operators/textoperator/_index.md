...
type: docs
weight: 88
url: /ru/java/com.aspose.pdf.operators/textoperator/
---
**Наследование:**
...
| --- | --- |
| [TextOperator()](#TextOperator--) | Конструктор для нового оператора. |
| [TextOperator(TextProperties textProperties)](#TextOperator-com.aspose.pdf.facades.TextProperties-) | Текстовый оператор, который принимает текстовые свойства. |
## Методы
...
Текстовый оператор, который принимает текстовые свойства.
