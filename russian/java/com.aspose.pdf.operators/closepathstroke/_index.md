...
description: Класс, представляющий оператор s Close и обводку пути.
type: docs
weight: 22
url: /ru/java/com.aspose.pdf.operators/closepathstroke/
---
**Наследование:**
...
| --- | --- |
| [ClosePathStroke(int index, ICommand command)](#ClosePathStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
