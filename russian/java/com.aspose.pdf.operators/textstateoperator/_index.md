...
description: Абстрактный базовый класс для операторов, который изменяет текущее состояние текста Tc Tf TL и т. д.
type: docs
weight: 91
url: /ru/java/com.aspose.pdf.operators/textstateoperator/
---
**Наследование:**
...
| --- | --- |
| [TextStateOperator()](#TextStateOperator--) | Конструктор для нового TextStateOperator. |
| [TextStateOperator(TextProperties textProperties)](#TextStateOperator-com.aspose.pdf.facades.TextProperties-) | Конструктор для TextStateoperator, который позволяет передавать TextProperties. |
## Методы
...
Конструктор для нового TextStateOperator.
...
Конструктор для TextStateoperator, который позволяет передавать TextProperties.
