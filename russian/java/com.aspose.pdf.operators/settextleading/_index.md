...
description: Класс, представляющий оператор TL, устанавливает начало текста.
type: docs
weight: 80
url: /ru/java/com.aspose.pdf.operators/settextleading/
---
**Наследование:**
...
Класс, представляющий оператор TL (устанавливает начало текста).
## Конструкторы
...
| [SetTextLeading(double leading)](#SetTextLeading-double-) | Конструктор оператора ввода текста. |
## Методы
...
| [getLeading()](#getLeading--) | Получает текст ведущим. |
...
| [setLeading(double value)](#setLeading-double-) | Устанавливает текст в начале. |
...
Конструктор оператора ввода текста.
