...
description: Класс, представляющий путь штриха оператора S.
type: docs
weight: 87
url: /ru/java/com.aspose.pdf.operators/stroke/
---
**Наследование:**
...
Класс, представляющий оператор S (траектория штриха).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Stroke(int index, ICommand command)](#Stroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
