...
description: Класс, представляющий путь отсечения оператором W, использующий правило четного-нечетного.
type: docs
weight: 31
url: /ru/java/com.aspose.pdf.operators/eoclip/
---
**Наследование:**
...
Класс, представляющий W\* оператор (устанавливает путь отсечения по четно-нечетному правилу).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [EOClip()](#EOClip--) | Инициализирует оператор. |
| [EOClip(int index, ICommand command)](#EOClip-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
