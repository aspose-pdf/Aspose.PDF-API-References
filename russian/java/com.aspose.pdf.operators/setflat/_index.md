...
description: Класс, представляющий набор операторов i, допускает плоскостность.
type: docs
weight: 68
url: /ru/java/com.aspose.pdf.operators/setflat/
---
**Наследование:**
...
| --- | --- |
| [SetFlat(double flatness)](#SetFlat-double-) | Инициализирует оператор. |
| [SetFlat(int index, ICommand command)](#SetFlat-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
...
| [getFlatness()](#getFlatness--) | Получается плоскостность. |
...
| [setFlatness(double value)](#setFlatness-double-) | Устанавливает плоскостность. |
