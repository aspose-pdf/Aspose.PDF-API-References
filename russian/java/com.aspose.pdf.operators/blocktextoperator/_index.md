...
description: Абстрактный базовый класс для операторов текстового блока, т.е.
type: docs
weight: 17
url: /ru/java/com.aspose.pdf.operators/blocktextoperator/
---
**Наследование:**
...
Абстрактный базовый класс для операторов текстового блока, т. е. текстовых операторов начала и конца (BT/ET).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BlockTextOperator()](#BlockTextOperator--) | Конструктор для нового оператора. |
| [BlockTextOperator(TextProperties textProperties)](#BlockTextOperator-com.aspose.pdf.facades.TextProperties-) | Конструктор для BlockTextOperator, который принимает TextProperties. |
## Методы
...
Конструктор для нового оператора.

### BlockTextOperator(TextProperties textProperties) {#BlockTextOperator-com.aspose.pdf.facades.TextProperties-}
```
public BlockTextOperator(TextProperties textProperties)
```


Конструктор для BlockTextOperator, который принимает TextProperties.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| textProperties | [TextProperties](../../com.aspose.pdf.facades/textproperties) | Свойства текста. |
