...
description: Класс, представляющий цветовое пространство набора операторов cs для операций без штриховки
type: docs
weight: 64
url: /ru/java/com.aspose.pdf.operators/setcolorspace/
---
**Наследование:**
...
| --- | --- |
| [SetColorSpace(String name)](#SetColorSpace-java.lang.String-) | Инициализирует оператор. |
| [SetColorSpace(int index, ICommand command)](#SetColorSpace-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
...
| [getName()](#getName--) | Получает имя цветового пространства. |
...
| [setName(String value)](#setName-java.lang.String-) | Устанавливает имя цветового пространства. |
| [toCommand()](#toCommand--) |  |
...
| --- | --- | --- |
| name | java.lang.String | Имя цветового пространства. |
...
Устанавливает имя цветового пространства.
