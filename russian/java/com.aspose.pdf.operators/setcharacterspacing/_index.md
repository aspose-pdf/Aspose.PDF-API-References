...
description: Класс, представляющий набор символов оператора Tc.
type: docs
weight: 60
url: /ru/java/com.aspose.pdf.operators/setcharacterspacing/
---
**Наследование:**
...
Класс, представляющий оператор Tc (задает интервал между символами).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SetCharacterSpacing(int index, ICommand command)](#SetCharacterSpacing-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetCharacterSpacing(double charSpacing)](#SetCharacterSpacing-double-) | Инициализирует оператор. |
## Методы
...
| [getCharSpacing()](#getCharSpacing--) | Получает интервал между символами. |
| [getClass()](#getClass--) |  |
...
| [setCharSpacing(double value)](#setCharSpacing-double-) | Устанавливает интервал между символами. |
...
Получает интервал между символами.

**Возвращает:**
двойной - межсимвольный интервал.
### getClass() {#getClass--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | double | интервал между символами. |
