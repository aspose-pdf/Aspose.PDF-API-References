...
description: Класс, представляющий оператор y, добавляет кривую к реплицированной конечной точке пути.
type: docs
weight: 26
url: /ru/java/com.aspose.pdf.operators/curveto2/
---
**Наследование:**
...
| --- | --- |
| [CurveTo2(int index, ICommand command)](#CurveTo2-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [CurveTo2(double x1, double y1, double x3, double y3)](#CurveTo2-double-double-double-double-) | Инициализирует оператор кривой. |
## Методы
