...
type: docs
weight: 34
url: /ru/java/com.aspose.pdf.operators/et/
---
**Наследование:**
...
| --- | --- |
| [ET(int index, ICommand command)](#ET-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [ET()](#ET--) | Конструктор для написания программы. |
## Методы
