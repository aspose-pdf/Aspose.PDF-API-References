...
description: Класс, представляющий конечный путь n операторов без заполнения или обводки.
type: docs
weight: 36
url: /ru/java/com.aspose.pdf.operators/endpath/
---
**Наследование:**
...
| --- | --- |
| [EndPath(int index, ICommand command)](#EndPath-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [EndPath()](#EndPath--) | Конструктор для написания программы. |
## Методы
...
| [toString()](#toString--) | Текстовое представление оператора. |
