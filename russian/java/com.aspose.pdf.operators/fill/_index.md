...
description: Класс, представляющий путь заполнения оператора f с правилом ненулевого числа циклов.
type: docs
weight: 37
url: /ru/java/com.aspose.pdf.operators/fill/
---
**Наследование:**
...
Класс, представляющий оператор f (заполнить путь правилом ненулевого числа циклов).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Fill(int index, ICommand command)](#Fill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
