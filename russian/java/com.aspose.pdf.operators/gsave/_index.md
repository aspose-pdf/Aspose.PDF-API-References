...
description: Класс, представляющий оператор q сохранения графического состояния.
type: docs
weight: 41
url: /ru/java/com.aspose.pdf.operators/gsave/
---
**Наследование:**
...
| --- | --- |
| [GSave(int index, ICommand command)](#GSave-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [GSave()](#GSave--) | Конструктор для оператора q. |
## Методы
