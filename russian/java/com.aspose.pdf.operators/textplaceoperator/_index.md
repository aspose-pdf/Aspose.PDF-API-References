...
description: Абстрактный базовый класс для операторов, которые изменяют позицию текста Tm Td и т. д.
type: docs
weight: 89
url: /ru/java/com.aspose.pdf.operators/textplaceoperator/
---
**Наследование:**
...
Абстрактный базовый класс для операторов, меняющих положение текста (Tm, Td и т. д.).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TextPlaceOperator()](#TextPlaceOperator--) | Конструктор для нового TextPlaceOperator. |
| [TextPlaceOperator(TextProperties textProperties)](#TextPlaceOperator-com.aspose.pdf.facades.TextProperties-) | Конструктор для TextPlaceOperator, который принимает TextProperties. |
## Методы
...
Конструктор для нового TextPlaceOperator.
...
Конструктор для TextPlaceOperator, который принимает TextProperties.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| textProperties | [TextProperties](../../com.aspose.pdf.facades/textproperties) | Значение TextProperties |
