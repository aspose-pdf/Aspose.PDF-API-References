...
description: Класс, представляющий набор параметров оператора gs из словаря параметров графического состояния.
type: docs
weight: 40
url: /ru/java/com.aspose.pdf.operators/gs/
---
**Наследование:**
...
| --- | --- |
| [GS(int index, ICommand command)](#GS-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [GS(String name)](#GS-java.lang.String-) | Инициализирует оператор gs. |
## Методы
...
| [getName()](#getName--) | Получает имя графического ресурса состояния. |
...
| [setName(String value)](#setName-java.lang.String-) | Устанавливает имя графического ресурса состояния. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| name | java.lang.String | Имя графического состояния. |
...
Получает имя графического ресурса состояния.
...
Устанавливает имя графического ресурса состояния.
...
**Возвращает:**
java.lang.String — строковое представление оператора.
