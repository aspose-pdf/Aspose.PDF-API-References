...
description: Базовый класс для операторов набора цветов.
type: docs
weight: 16
url: /ru/java/com.aspose.pdf.operators/basicsetcoloroperator/
---
**Наследование:**
...
Базовый класс для операторов набора цветов.
## Методы
