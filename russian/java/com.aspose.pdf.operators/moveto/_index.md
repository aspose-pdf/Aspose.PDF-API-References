...
description: Класс, представляющий operator.m, перемещается и начинает новый подпуть.
type: docs
weight: 48
url: /ru/java/com.aspose.pdf.operators/moveto/
---
**Наследование:**
...
Класс, представляющий operator.m (перейти и начать новый подпуть).
## Конструкторы
...
| [MoveTo(double x, double y)](#MoveTo-double-double-) | Устанавливает новый оператор Operator.m (перейти к). |
## Методы
...
| [getX()](#getX--) | координата X |
| [getY()](#getY--) | Координата Y |
| [hashCode()](#hashCode--) |  |
...
| [setX(double value)](#setX-double-) | координата X |
| [setY(double value)](#setY-double-) | Координата Y |
...
Устанавливает новый оператор Operator.m (перейти к).
