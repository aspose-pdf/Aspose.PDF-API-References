...
description: Класс, представляющий оператор Q восстановления графического состояния.
type: docs
weight: 39
url: /ru/java/com.aspose.pdf.operators/grestore/
---
**Наследование:**
...
| --- | --- |
| [GRestore(int index, ICommand command)](#GRestore-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [GRestore()](#GRestore--) | Конструктор для оператора Q. |
## Методы
...
| [toString()](#toString--) | Возвращает текст оператора. |
