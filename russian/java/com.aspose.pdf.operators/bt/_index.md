...
type: docs
weight: 13
url: /ru/java/com.aspose.pdf.operators/bt/
---
**Наследование:**
...
| --- | --- |
| [BT(int index, ICommand command)](#BT-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [BT()](#BT--) | Конструктор для написания программы. |
## Методы
