...
type: docs
weight: 90
url: /ru/java/com.aspose.pdf.operators/textshowoperator/
---
**Наследование:**
...
| --- | --- |
| [TextShowOperator(int index, ICommand command)](#TextShowOperator-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [TextShowOperator()](#TextShowOperator--) | Конструктор для нового TextShowOperator. |
| [TextShowOperator(TextProperties textProperties)](#TextShowOperator-com.aspose.pdf.facades.TextProperties-) | Конструктор для TextShowOperator, который позволяет передавать TextProperties. |
## Методы
...
| [getText()](#getText--) | Получает текст, который оператор выводит на страницу. |
| [hashCode()](#hashCode--) |  |
...
Конструктор для нового TextShowOperator.
...
Конструктор для TextShowOperator, который позволяет передавать TextProperties.
