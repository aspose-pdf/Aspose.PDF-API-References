...
description: Класс, представляющий область рисования оператора sh с затенением.
type: docs
weight: 85
url: /ru/java/com.aspose.pdf.operators/shfill/
---
**Наследование:**
...
| --- | --- |
| [ShFill()](#ShFill--) | Инициализирует оператор. |
| [ShFill(int index, ICommand command)](#ShFill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [ShFill(String shadingName)](#ShFill-java.lang.String-) | Инициализирует оператор. |
## Методы
...
| [getName()](#getName--) | Получает имя затенения. |
...
| [setName(String value)](#setName-java.lang.String-) | Устанавливает имя затенения. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| shadingName | java.lang.String | Строка Имя затенения. |
