...
description: Класс, представляющий ширину линии оператора w.
type: docs
weight: 75
url: /ru/java/com.aspose.pdf.operators/setlinewidth/
---
**Наследование:**
...
Класс, представляющий оператор w (установка ширины строки).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SetLineWidth(int index, ICommand command)](#SetLineWidth-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetLineWidth(double width)](#SetLineWidth-double-) | Инициализирует оператор значением ширины. |
## Методы
...
| [getWidth()](#getWidth--) | Получает ширину линии. |
| [hashCode()](#hashCode--) |  |
...
| [setWidth(double value)](#setWidth-double-) | Устанавливает ширину линии. |
