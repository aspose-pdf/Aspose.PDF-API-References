...
description: Класс, представляющий путь заполнения и обводки оператора B с использованием ненулевого правила намотки
type: docs
weight: 38
url: /ru/java/com.aspose.pdf.operators/fillstroke/
---
**Наследование:**
...
Класс, представляющий оператор B (путь заполнения и обводки с использованием правила ненулевого намотки)
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [FillStroke()](#FillStroke--) | Инициализирует оператор. |
| [FillStroke(int index, ICommand command)](#FillStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
