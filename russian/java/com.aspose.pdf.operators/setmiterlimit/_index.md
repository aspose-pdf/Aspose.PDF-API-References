...
description: Класс, представляющий M-оператор, устанавливает предел митры.
type: docs
weight: 76
url: /ru/java/com.aspose.pdf.operators/setmiterlimit/
---
**Наследование:**
...
Класс, представляющий оператор M (установить предел митры).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SetMiterLimit(int index, ICommand command)](#SetMiterLimit-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetMiterLimit(double miterLimit)](#SetMiterLimit-double-) | Инициализирует оператор. |
## Методы
...
| [getMiterLimit()](#getMiterLimit--) | Получает предел митры. |
...
| [setMiterLimit(double value)](#setMiterLimit-double-) | Устанавливает предел митры. |
