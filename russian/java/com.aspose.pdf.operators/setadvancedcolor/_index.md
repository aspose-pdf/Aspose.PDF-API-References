...
description: Класс, представляющий набор цветов оператора scn для операций без штриха.
type: docs
weight: 54
url: /ru/java/com.aspose.pdf.operators/setadvancedcolor/
---
**Наследование:**
...
| --- | --- |
| [SetAdvancedColor(int index, ICommand command)](#SetAdvancedColor-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetAdvancedColor()](#SetAdvancedColor--) | Инициализирует оператор. |
| [SetAdvancedColor(double g, String patternName)](#SetAdvancedColor-double-java.lang.String-) | Конструктор для оператора scn. |
| [SetAdvancedColor(double g)](#SetAdvancedColor-double-) | Конструктор оператора scn |
| [SetAdvancedColor(double r, double g, double b, String patternName)](#SetAdvancedColor-double-double-double-java.lang.String-) | Конструктор для оператора scn. |
| [SetAdvancedColor(double c, double m, double y, double k, String patternName)](#SetAdvancedColor-double-double-double-double-java.lang.String-) | Конструктор для оператора scn. |
## Методы
...
| patternName | java.lang.String | Название шаблона. |
...
| patternName | java.lang.String | Строковый объект Имя шаблона. |
...
**Возвращает:**
[Color](../../java.awt/color) - Цвет устанавливается оператором.
