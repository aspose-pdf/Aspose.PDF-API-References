...
type: docs
weight: 11
url: /ru/java/com.aspose.pdf.operators/bi/
---
**Наследование:**
...
Класс, представляющий оператор BI (начало встроенного изображения).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BI()](#BI--) | Инициализирует оператор. |
| [BI(int index, ICommand command)](#BI-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
