...
description: Класс, представляющий путь закрытия оператора h.
type: docs
weight: 19
url: /ru/java/com.aspose.pdf.operators/closepath/
---
**Наследование:**
...
| [ClosePath(int index, ICommand command)](#ClosePath-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
