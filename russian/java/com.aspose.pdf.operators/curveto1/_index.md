...
description: Класс, представляющий оператор v, добавляет кривую к реплицированной начальной точке пути.
type: docs
weight: 25
url: /ru/java/com.aspose.pdf.operators/curveto1/
---
**Наследование:**
...
Класс, представляющий оператор v (добавляет кривую к пути, копирует начальную точку).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CurveTo1(int index, ICommand command)](#CurveTo1-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [CurveTo1(double x2, double y2, double x3, double y3)](#CurveTo1-double-double-double-double-) | Инициализирует оператор кривой. |
## Методы

| Метод | Описание |
| --- | --- |
| [accept(IOperatorSelector visitor)](#accept-com.aspose.pdf.IOperatorSelector-) | Принимает селектор оператора. |
