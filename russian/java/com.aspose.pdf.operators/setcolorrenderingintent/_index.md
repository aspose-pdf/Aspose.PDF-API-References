...
description: Класс, представляющий набор операций цветопередачи оператора ri.
type: docs
weight: 63
url: /ru/java/com.aspose.pdf.operators/setcolorrenderingintent/
---
**Наследование:**
...
| --- | --- |
| [SetColorRenderingIntent()](#SetColorRenderingIntent--) | Инициализирует оператор. |
| [SetColorRenderingIntent(String intentName)](#SetColorRenderingIntent-java.lang.String-) | Установите конструктор оператора Color Rendering Intent. |
| [SetColorRenderingIntent(int index, ICommand command)](#SetColorRenderingIntent-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
## Методы
...
| [getIntentName()](#getIntentName--) | Получает или задает имя способа цветопередачи. |
...
| [setIntentName(String value)](#setIntentName-java.lang.String-) | Получает или задает имя способа цветопередачи. |
...
Установите конструктор оператора Color Rendering Intent.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| intentName | java.lang.String | Цель цветопередачи. |
...
Получает или задает имя способа цветопередачи.
