...
description: Класс, представляющий цвет набора операторов SC для обводки операторов цвета.
type: docs
weight: 66
url: /ru/java/com.aspose.pdf.operators/setcolorstroke/
---
**Наследование:**
...
Класс, представляющий цвет набора операторов SC для обводки операторов цвета.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SetColorStroke()](#SetColorStroke--) | Инициализирует оператор. |
| [SetColorStroke(int index, ICommand command)](#SetColorStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetColorStroke(double g)](#SetColorStroke-double-) | Установите цвет для операторов штриховки для цветовых пространств DeviceGrey, CalGrey и Indexed. |
| [SetColorStroke(double r, double g, double b)](#SetColorStroke-double-double-double-) | Установить цвет для оператора поглаживания для цветовых пространств DeviceRGB, CalRGB и Lab |
| [SetColorStroke(double[] color)](#SetColorStroke-double---) | Конструктор, позволяющий задавать цветовые компоненты. |
| [SetColorStroke(double c, double m, double y, double k)](#SetColorStroke-double-double-double-double-) | Установить цвет для оператора штриховки для цветового пространства CMYK |
## Методы
...
Конструктор, позволяющий задавать цветовые компоненты.
...
Установить цвет для оператора штриховки для цветового пространства CMYK
