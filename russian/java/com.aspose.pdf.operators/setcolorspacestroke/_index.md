...
description: Класс, представляющий цвет, заданный оператором CS для операций поглаживания.
type: docs
weight: 65
url: /ru/java/com.aspose.pdf.operators/setcolorspacestroke/
---
**Наследование:**
...
| --- | --- |
| [SetColorSpaceStroke(int index, ICommand command)](#SetColorSpaceStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [SetColorSpaceStroke(String name)](#SetColorSpaceStroke-java.lang.String-) | Инициализирует оператор. |
## Методы
