...
description: Класс, представляющий оператор l, добавляет строку к пути.
type: docs
weight: 44
url: /ru/java/com.aspose.pdf.operators/lineto/
---
**Наследование:**
...
| --- | --- |
| [LineTo(int index, ICommand command)](#LineTo-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
| [LineTo(double x, double y)](#LineTo-double-double-) | Инициализирует линейный оператор. |
## Методы
...
| [getX()](#getX--) | X координата точки линии. |
| [getY()](#getY--) | Координата Y точки линии. |
| [hashCode()](#hashCode--) |  |
...
| [setX(double value)](#setX-double-) | X координата точки линии. |
| [setY(double value)](#setY-double-) | Координата Y точки линии. |
