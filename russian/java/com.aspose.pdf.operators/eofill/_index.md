...
description: Класс, представляющий путь заполнения оператора f с использованием правила четного-нечетного.
type: docs
weight: 32
url: /ru/java/com.aspose.pdf.operators/eofill/
---
**Наследование:**
...
Класс, представляющий f\* оператор (заполнить путь по четно-нечетному правилу).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [EOFill(int index, ICommand command)](#EOFill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | Конструктор класса оператора. |
