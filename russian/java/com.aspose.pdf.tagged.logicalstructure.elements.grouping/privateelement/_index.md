...
description: Представляет элемент частной структуры в логической структуре.
type: docs
weight: 19
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.grouping/privateelement/
---
**Наследование:**
...
Представляет элемент частной структуры в логической структуре.
## Конструкторы
