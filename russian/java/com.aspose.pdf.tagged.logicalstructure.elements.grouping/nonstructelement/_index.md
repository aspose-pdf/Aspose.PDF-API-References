...
description: Представляет структурный элемент NonStruct в логической структуре.
type: docs
weight: 17
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.grouping/nonstructelement/
---
**Наследование:**
...
Представляет структурный элемент NonStruct в логической структуре.
## Конструкторы
