...
description: Представляет элемент структуры документа в логической структуре.
type: docs
weight: 14
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.grouping/documentelement/
---
**Наследование:**
...
Представляет элемент структуры документа в логической структуре.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)](#DocumentElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-) |  |
## Методы
...
### DocumentElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity) {#DocumentElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-}
```
public DocumentElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)
```
