...
description: Представляет собой базовый класс для дочерних элементов Таблицы в логической структуре.
type: docs
weight: 20
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/tablechildelement/
---
**Наследование:**
...
Представляет собой базовый класс для дочерних элементов Таблицы в логической структуре.
## Методы
