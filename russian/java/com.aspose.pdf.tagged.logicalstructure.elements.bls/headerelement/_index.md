...
description: Представляет элемент структуры заголовка в логической структуре.
type: docs
weight: 12
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/headerelement/
---
**Наследование:**
...
Представляет элемент структуры заголовка в логической структуре.
## Конструкторы
