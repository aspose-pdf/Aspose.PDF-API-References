...
description: Представляет элемент структуры TFoot в логической структуре таблицы.
type: docs
weight: 25
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/tabletfootelement/
---
**Наследование:**
java.lang.Object, [com.aspose.pdf.tagged.logicalstructure.elements.Element](../../com.aspose.pdf.tagged.logicalstructure.elements/element), [com.aspose.pdf.tagged.logicalstructure.elements.StructureElement](../../com.aspose.pdf.tagged.logicalstructure.elements/structureelement), [com.aspose.pdf.tagged.logicalstructure.elements.bls.TableChildElement](../../com.aspose.pdf.tagged.logicalstructure.elements.bls/tablechildelement), [com.aspose.pdf.tagged.logicalstructure.elements.bls.TableRowCollectionElement](../../com.aspose.pdf.tagged.logicalstructure.elements.bls/tablerowcollectionelement)
```
public final class TableTFootElement extends TableRowCollectionElement
```

Представляет элемент структуры TFoot в логической структуре таблицы.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TableTFootElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)](#TableTFootElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-) |  |
## Методы
...
| [createTR()](#createTR--) |  Создает[TableTRElement](../../com.aspose.pdf.tagged.logicalstructure.elements.bls/tabletrelement) и добавил его в текущую таблицу. |
...
### TableTFootElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity) {#TableTFootElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-}
```
public TableTFootElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)
```
...
```
 ...
 Создает[TableTRElement](../../com.aspose.pdf.tagged.logicalstructure.elements.bls/tabletrelement) и добавил его в текущую таблицу.
