...
description: Представляет элемент структуры TBody в логической структуре таблицы.
type: docs
weight: 23
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/tabletbodyelement/
---
**Наследование:**
...
Представляет элемент структуры TBody в логической структуре таблицы.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TableTBodyElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)](#TableTBodyElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-) |  |
## Методы
