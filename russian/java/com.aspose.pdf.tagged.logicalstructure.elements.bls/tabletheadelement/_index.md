...
description: Представляет элемент структуры THead в логической структуре таблицы.
type: docs
weight: 27
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/tabletheadelement/
---
**Наследование:**
...
| --- | --- |
| [TableTHeadElement(TaggedContext taggedContext, IPdfPrimitive pdfEngineEntity)](#TableTHeadElement-com.aspose.pdf.tagged.TaggedContext-com.aspose.pdf.engine.data.IPdfPrimitive-) |  |
## Методы
