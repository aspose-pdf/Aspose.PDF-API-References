...
description: Представляет элемент структуры абзаца в логической структуре.
type: docs
weight: 18
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/paragraphelement/
---
**Наследование:**
...
Представляет элемент структуры абзаца в логической структуре.
## Конструкторы
