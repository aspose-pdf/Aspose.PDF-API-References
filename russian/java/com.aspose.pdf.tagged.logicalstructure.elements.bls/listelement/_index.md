...
description: Представляет элемент структуры списка в логической структуре.
type: docs
weight: 14
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/listelement/
---
**Наследование:**
...
Представляет элемент структуры списка в логической структуре.
## Конструкторы
