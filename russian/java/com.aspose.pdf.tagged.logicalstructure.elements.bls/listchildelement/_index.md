...
description: Представляет базовый класс для дочерних элементов списка в логической структуре.
type: docs
weight: 13
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/listchildelement/
---
**Наследование:**
...
```
public abstract class ListChildElement extends StructureElement
```

Представляет базовый класс для дочерних элементов списка в логической структуре.
## Методы
