...
description: Представляет элемент структуры LI в логической структуре списка.
type: docs
weight: 16
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements.bls/listlielement/
---
**Наследование:**
