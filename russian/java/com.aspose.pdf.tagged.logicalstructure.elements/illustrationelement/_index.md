...
description: Представляет базовый класс для элементов структуры иллюстрации в логической структуре.
type: docs
weight: 14
url: /ru/java/com.aspose.pdf.tagged.logicalstructure.elements/illustrationelement/
---
**Наследование:**
...
Представляет базовый класс для элементов структуры иллюстрации в логической структуре.
## Методы
...
| [setImage(String imageSrc)](#setImage-java.lang.String-) | Добавляет изображение к текущему элементу иллюстрации. |
| [setImage(String imageSrc, double imageResolution)](#setImage-java.lang.String-double-) | Добавляет изображение к текущему элементу иллюстрации. |
| [setImage(String imageSrc, double imageWidth, double imageHeight)](#setImage-java.lang.String-double-double-) | Добавляет изображение к текущему элементу иллюстрации. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| imageSrc | java.lang.String | Источник изображения. |
