---
title: "System::Net::Dns::BeginGetHostByName метод"
linktitle: "BeginGetHostByName"
second_title: "Справочник API Aspose.PDF для C++"
description: "System::Net::Dns::BeginGetHostByName метод. Инициирует асинхронную операцию по созданию нового экземпляра класса IPHostEntry с использованием указанного имени хоста в C++."
type: docs
weight: 200
