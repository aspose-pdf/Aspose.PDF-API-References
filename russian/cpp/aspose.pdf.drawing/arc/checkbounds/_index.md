---
title: "Aspose::Pdf::Drawing::Arc::CheckBounds метод"
linktitle: "CheckBounds"
second_title: "Справочник API Aspose.PDF для C++"
description: "Aspose::Pdf::Drawing::Arc::CheckBounds метод. Проверяет, помещается ли элемент в заданные размеры контейнера (включительно) в C++."
type: docs
weight: 200
url: /ru/cpp/aspose.pdf.drawing/arc/checkbounds/
---
...
True если помещается; иначе false.
