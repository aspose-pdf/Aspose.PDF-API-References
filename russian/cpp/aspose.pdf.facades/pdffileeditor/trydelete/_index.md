---
title: "метод Aspose::Pdf::Facades::PdfFileEditor::TryDelete"
linktitle: "TryDelete"
second_title: "Справочник API Aspose.PDF для C++"
description: "метод Aspose::Pdf::Facades::PdfFileEditor::TryDelete. Удаляет страницы, указанные массивом номеров, из входного файла и сохраняет его как новый PDF‑файл в C++."
type: docs
weight: 6400
url: /ru/cpp/aspose.pdf.facades/pdffileeditor/trydelete/
---
...
Метод TryDelete похож на метод Delete, за исключением того, что TryDelete не генерирует исключение при неудачной операции.
## См. также
