---
title: "System::Int16::Parse метод"
linktitle: "Разобрать"
second_title: "Справочник API Aspose.PDF для C++"
description: "System::Int16::Parse метод. Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 16-битное знаковое целое в C++."
type: docs
weight: 100
...
16-битное знаковое целое, равное числу, представленному указанной строкой.
