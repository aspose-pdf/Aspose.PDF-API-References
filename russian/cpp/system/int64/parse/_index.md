---
title: "Метод System::Int64::Parse"
linktitle: "Разобрать"
second_title: "Справочник API Aspose.PDF для C++"
description: "Метод System::Int64::Parse. Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 64‑битное знаковое целое в C++."
type: docs
weight: 100
