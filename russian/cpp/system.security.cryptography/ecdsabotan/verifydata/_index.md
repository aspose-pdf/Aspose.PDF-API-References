---
title: "Метод System::Security::Cryptography::ECDsaBotan::VerifyData"
linktitle: "VerifyData"
second_title: "Справочник API Aspose.PDF для C++"
description: "Метод System::Security::Cryptography::ECDsaBotan::VerifyData. Проверяет, действительна ли подпись указанных данных в C++."
type: docs
weight: 1400
