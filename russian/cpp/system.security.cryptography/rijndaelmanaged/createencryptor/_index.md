...
description: "System::Security::Cryptography::RijndaelManaged::CreateEncryptor метод. Создаёт объект шифратора с параметрами, определёнными объектом алгоритма в C++."
type: docs
weight: 200
