...
description: "Создаёт несколько новых PDF-documents, извлекая страницы из исходного PDF-document."
type: docs
url: /ru/rust-cpp/core/split_document/
---

_Создаёт несколько новых PDF-documents, извлекая страницы из исходного PDF-document._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Создаёт несколько новых PDF-documents, извлекая страницы из исходного PDF-document
