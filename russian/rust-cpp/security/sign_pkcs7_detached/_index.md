...
description: "Подписать PDF-документ с использованием откреплённых цифровых подписей PKCS#7."
type: docs
url: /ru/rust-cpp/security/sign_pkcs7_detached/
---

_Подписать PDF-документ с помощью PKCS#7 Detached цифровых подписей._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    // Прочитать сертификат и файлы изображений в векторы байтов
    ...
    // Подписать PDF-документ с помощью PKCS#7 Detached цифровых подписей
