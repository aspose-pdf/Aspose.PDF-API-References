...
description: "Подписать PDF-документ с использованием цифровых подписей PKCS#7."
type: docs
url: /ru/rust-cpp/security/sign_pkcs7/
---

_Подписать PDF-документ с помощью цифровых подписей PKCS#7._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Подписать PDF-документ с помощью цифровых подписей PKCS#7
    pdf.sign_pkcs7(
        1,
        &cert,
        "Pa$$w0rd2023",
