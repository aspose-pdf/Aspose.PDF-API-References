...
description: "Добавляет водяной знак на страницу."
type: docs
url: /ru/rust-cpp/organize/page_add_watermark/
---

_Добавляет водяной знак на страницу._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Добавить водяной знак на страницу
