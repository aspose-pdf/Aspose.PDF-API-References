...
description: "Удаляет скрытый текст на странице."
type: docs
url: /ru/rust-cpp/organize/page_remove_hidden_text/
---

_Удаляет скрытый текст на странице._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Удалить скрытый текст на странице
