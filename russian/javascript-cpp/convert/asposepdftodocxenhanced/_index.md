...
description: "Конвертировать PDF-файл в DocX с режимом Enhanced Recognition Mode."
type: docs
url: /ru/javascript-cpp/convert/asposepdftodocxenhanced/
---

_Преобразовать PDF-файл в DocX с улучшенным режимом распознавания (полностью редактируемые таблицы и абзацы)._
