...
type: docs
url: /ru/javascript-cpp/organize/asposepdfreplacetextex/
---

_Заменить несколько фрагментов текста в PDF-файле с управлением выравниванием._
...
Направление также может быть явно принудительно задано путем добавления префикса `replaceText`
специальными символами Unicode:
`\u200F` (RTL) или `\u200E` (LTR), желательно в качестве первого символа
