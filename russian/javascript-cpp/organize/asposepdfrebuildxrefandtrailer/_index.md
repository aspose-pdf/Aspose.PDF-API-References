...
description: "Перестроить таблицу перекрёстных ссылок и структуры трейлера PDF‑файла."
type: docs
url: /ru/javascript-cpp/organize/asposepdfrebuildxrefandtrailer/
---

_Перестроить таблицу перекрёстных ссылок и структуры трейлера PDF-файла._
