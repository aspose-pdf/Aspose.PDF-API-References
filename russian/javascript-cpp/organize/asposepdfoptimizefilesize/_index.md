...
description: "Оптимизировать размер PDF-file с качеством сжатия изображений."
type: docs
url: /ru/javascript-cpp/organize/asposepdfoptimizefilesize/
---

_Оптимизировать размер PDF-файла с учётом качества сжатия изображений._
