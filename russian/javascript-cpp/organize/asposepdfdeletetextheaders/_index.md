...
description: "Удалить текстовые заголовки из PDF-file."
type: docs
url: /ru/javascript-cpp/organize/asposepdfdeletetextheaders/
---

_Удалить текстовые заголовки из PDF-файла._
