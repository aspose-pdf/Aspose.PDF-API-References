...
type: docs
url: /ru/javascript-cpp/metadata/asposepdfsetinfo/
---
...
Для 'title', 'creator', 'author', 'subject', 'keywords', 'creation' и 'mod', если значение не требуется задавать, используйте undefined или "" (пустая строка)
