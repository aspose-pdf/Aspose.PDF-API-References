...
description: "Создаёт отдельную подпись PKCS#7Detached с использованием X509Certificate2. Поддерживает USB‑смарткарты, токены без экспортируемых закрытых ключей."
type: docs
weight: 80
url: /ru/python-net/aspose.pdf.forms/externalsignature/
---

## ExternalSignature class

Создаёт отдельную подпись PKCS#7Detached с использованием X509Certificate2. Поддерживает USB‑смарткарты, токены без экспортируемых закрытых ключей.

Тип ExternalSignature раскрывает следующие члены:
## Свойства
| Имя | Описание |
| :- | :- |
