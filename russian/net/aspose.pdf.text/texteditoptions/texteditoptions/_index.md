...
| Параметр | Тип | Описание |
| --- | --- | --- |
| allowLanguageTransformation | Boolean | Разрешает трансформацию языка, если установлено значение true. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| languageTransformationBehavior | LanguageTransformation | Объект поведения трансформации языка. |
