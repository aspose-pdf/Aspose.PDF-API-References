---
title: "Класс InkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.InkAnnotation класс. Представляет свободный набросок, состоящий из одного или более разрозненных путей."
type: docs
weight: 2010
...
Представляет свободный \"scribble\", состоящий из одного или нескольких несвязанных путей.
...
| Имя | Описание |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Конструктор для Ink‑аннотации для Generator. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Создаёт новую Ink‑аннотацию на указанной странице. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Стиль окончаний линий Ink‑аннотации. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Получает или задает список жестов, представляющих независимые линии, которые представлены массивами Point[]. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Обновляет точки в InkList в соответствии с преобразованием матрицы. |
