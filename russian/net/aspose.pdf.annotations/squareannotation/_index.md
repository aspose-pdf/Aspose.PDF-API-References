...
| Имя | Описание |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Конструктор для использования с Generator. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | Создаёт новую квадратную аннотацию на указанной странице. |
