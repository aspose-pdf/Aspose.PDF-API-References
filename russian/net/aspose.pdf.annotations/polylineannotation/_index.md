...
description: Класс Aspose.Pdf.Annotations.PolylineAnnotation. Представляет аннотацию полилинии, которая похожа на многоугольник, за исключением того, что первая и последняя вершины не соединены неявно
type: docs
weight: 2320
...
Представляет аннотацию полилинии, которая похожа на многоугольник, за исключением того, что первая и последняя вершины не соединены неявно.
...
| Имя | Описание |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | Создает новую аннотацию полилинии на указанной странице. |
