---
title: "Класс PolylineAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.PolylineAnnotation класс. Представляет полилинейную аннотацию, аналогичную полигону, за исключением того, что первая и последняя вершины не соединяются автоматически"
type: docs
weight: 2410
...
Представляет аннотацию полилиния, которая похожа на полигон, за исключением того, что первая и последняя вершины не соединяются автоматически.
...
| Имя | Описание |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | Создает новую полилинейную аннотацию на указанной странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
