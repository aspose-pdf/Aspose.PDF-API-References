...
description: Метод SquigglyAnnotation. Принимает объект посетителя для обработки аннотации
type: docs
weight: 30
url: /ru/net/aspose.pdf.annotations/squigglyannotation/accept/
---
## Метод SquigglyAnnotation.Accept
