---
title: "Класс SquigglyAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Annotations.SquigglyAnnotation. Представляет аннотацию squiggly, которая отображается как зубчатое подчеркивание в тексте документа."
type: docs
weight: 2700
...
Представляет волнистую аннотацию, которая отображается как неровное подчеркивание в тексте документа.
...
| Имя | Описание |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Создаёт новую аннотацию Squiggly на указанной странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
