...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints) { get; set; } | Получает или задает массив точек, указывающих координаты n четырехугольников. Каждый четырехугольник охватывает слово или группу смежных слов в тексте, лежащем в основе аннотации. |
