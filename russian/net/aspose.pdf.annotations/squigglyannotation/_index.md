...
description: Класс Aspose.Pdf.Annotations.SquigglyAnnotation. Представляет собой волнистую аннотацию, которая появляется в виде зубчатого подчеркивания в тексте документа
type: docs
weight: 2600
url: /ru/net/aspose.pdf.annotations/squigglyannotation/
---
## Класс SquigglyAnnotation

Представляет собой волнистую аннотацию, которая появляется в виде зубчатого подчеркивания в тексте документа.
...
| Имя | Описание |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Создает новую волнистую аннотацию на указанной странице. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки аннотации. |
