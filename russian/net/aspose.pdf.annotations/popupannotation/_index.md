---
title: "Класс PopupAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.PopupAnnotation class. Представляет всплывающую аннотацию, которая отображает текст во всплывающем окне для ввода и редактирования"
type: docs
weight: 2420
...
| Имя | Описание |
| --- | --- |
| [PopupAnnotation](popupannotation/#constructor)(Document) | Конструктор. для использования в Generator. |
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | Создаёт новую всплывающую аннотацию на указанной странице. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Получает или задаёт флаг, указывающий, должна ли всплывающая аннотация изначально отображаться открытой. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | Получает индекс страницы, содержащей аннотацию. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Получает или задаёт родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. Если эта запись присутствует, записи Contents, M, C и T родительской аннотации переопределят соответствующие записи самой всплывающей аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
