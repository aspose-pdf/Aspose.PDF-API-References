...
| [Parent](../../aspose.pdf.annotations/popupannotation/parent) { get; set; } | Получает или задает родительскую аннотацию, с которой должна быть связана эта всплывающая аннотация. Если эта запись присутствует, то родительская аннотация Contents, M, C и T должна переопределять записи самой всплывающей аннотации. |
