...
description: Класс Aspose.Pdf.Annotations.CaretAnnotation. Класс, представляющий аннотацию Caret
type: docs
weight: 1560
...
| Имя | Описание |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Конструктор для использования в генераторе. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Создает новую аннотацию Caret на указанной странице. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Получает или устанавливает прямоугольник каретки. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Получает или устанавливает символ, связанный с кареткой. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки аннотации. |
