---
title: "Класс CaretAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.CaretAnnotation класс. Класс, представляющий аннотацию Caret."
type: docs
weight: 1650
url: /ru/net/aspose.pdf.annotations/caretannotation/
---
...
| Имя | Описание |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Конструктор для использования в Generator. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Создаёт новую аннотацию Caret на указанной странице. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Получает или задает прямоугольник caret. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Получает или задает символ, связанный с caret. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
