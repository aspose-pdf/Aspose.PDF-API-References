...
| Имя | Описание |
| --- | --- |
| [LinkAnnotation](linkannotation)(Page, Rectangle) | Создает новую аннотацию Link на указанной странице. |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination) { get; set; } | Пункт назначения, отображаемый при активации аннотации. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | Визуальный эффект, используемый при нажатии или удерживании кнопки мыши внутри ее активной области. |
