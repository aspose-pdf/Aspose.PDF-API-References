...
| Имя | Описание |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action) { get; set; } | Действие, выполняемое при активации аннотации ссылки. |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination) { get; set; } | Пункт назначения, который будет отображаться при активации аннотации. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | Визуальный эффект, используемый при нажатии или удержании кнопки мыши внутри ее активной области. |
