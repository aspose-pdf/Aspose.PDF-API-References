---
title: "Класс BleedMarkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.BleedMarkAnnotation класс. Представляет аннотацию Bleed Mark."
type: docs
weight: 1590
url: /ru/net/aspose.pdf.annotations/bleedmarkannotation/
---
## BleedMarkAnnotation class

Представляет аннотацию Bleed Mark.
...
| Имя | Описание |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Page, PrinterMarkCornerPosition) | Инициализирует новый экземпляр класса `BleedMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Получает или задает позицию метки на странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Принимает посетителя для обработки аннотации. |
...
Метки обрезки размещаются в углах печатной страницы, чтобы указать, где страницу следует обрезать и насколько допускается отклонение от линий обрезки.
