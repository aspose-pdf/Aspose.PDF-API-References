...
description: Класс Aspose.Pdf.Annotations.BleedMarkAnnotation. Представляет аннотацию Bleed Mark
type: docs
weight: 1500
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Получает или устанавливает позицию метки на странице. |
...
Bleed marks размещаются в углах печатной страницы, чтобы указать, где страница должна быть обрезана и насколько она может отклоняться от меток обрезки.
