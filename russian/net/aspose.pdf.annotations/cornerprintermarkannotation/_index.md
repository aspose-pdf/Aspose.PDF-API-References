...
description: Класс Aspose.Pdf.Annotations.CornerPrinterMarkAnnotation. Представляет типы аннотаций, которые размещаются в углах печатной страницы
type: docs
weight: 1630
url: /ru/net/aspose.pdf.annotations/cornerprintermarkannotation/
---
## Класс CornerPrinterMarkAnnotation

Представляет типы аннотаций, которые размещаются в углах печатной страницы.
