---
title: "Класс RegistrationMarkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Annotations.RegistrationMarkAnnotation. Представляет аннотацию Registration Mark."
type: docs
weight: 2500
url: /ru/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation class

Представляет аннотацию Registration Mark.
...
| Имя | Описание |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Инициализирует новый экземпляр класса `RegistrationMarkAnnotation` на указанной странице в заданном месте. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Получает или задает положение регистрационной метки на странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Принимает посетителя для обработки аннотации. |
...
Регистрационные метки — это символы, добавляемые на печатные формы или экраны для обеспечения правильного выравнивания цветов в процессе печати.
