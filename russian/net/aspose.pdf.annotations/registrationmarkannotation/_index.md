...
description: Класс Aspose.Pdf.Annotations.RegistrationMarkAnnotation. Представляет аннотацию регистрационного знака
type: docs
weight: 2410
url: /ru/net/aspose.pdf.annotations/registrationmarkannotation/
---
## Класс RegistrationMarkAnnotation

Представляет аннотацию регистрационного знака.
...
| Имя | Описание |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Инициализирует новый экземпляр класса `RegistrationMarkAnnotation` на заданной странице в заданном месте. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Получает или задает положение регистрационного знака на странице. |
...
Регистрационные знаки — это символы, добавляемые на печатные пластины или экраны для обеспечения правильного выравнивания цветов в процессе печати.
