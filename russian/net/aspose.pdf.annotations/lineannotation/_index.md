...
description: Класс Aspose.Pdf.Annotations.LineAnnotation. Класс, представляющий аннотацию линии
type: docs
weight: 1980
...
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Создает новую аннотацию линии на указанной странице. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Получает или устанавливает смещение текста заголовка от его нормального положения. |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition/) { get; set; } | Получает или устанавливает положение заголовка аннотации. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | Получает или устанавливает конечную точку линии. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Получает или устанавливает стиль окончания для конечной точки линии. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | Получает или устанавливает намерение аннотации линии. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor/) { get; set; } | Получает или устанавливает внутренний цвет аннотации. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | Получает или устанавливает длину ведущей линии. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | Получает или устанавливает длину расширения ведущей линии. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Получает или устанавливает смещение ведущей линии. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Получает или устанавливает логический флаг, который определяет, должен ли содержимое отображаться как заголовок. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Получает или устанавливает начальную точку линии. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Получает или устанавливает стиль начала линии для начальной точки линии. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Обновляет начальные и конечные точки в соответствии с матричным преобразованием. |
