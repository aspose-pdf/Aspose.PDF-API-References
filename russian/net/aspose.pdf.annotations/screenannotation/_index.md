---
title: "Класс ScreenAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.ScreenAnnotation class. Экранная аннотация, указывающая область страницы, на которой могут воспроизводиться медиа‑клипы"
type: docs
weight: 2610
...
| Имя | Описание |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | Создаёт новую аннотацию Screen на указанной странице. |

## Свойства

| Имя | Описание |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Получает или задаёт действие, которое будет выполнено при активации аннотации. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Получает или задаёт заголовок экранной аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
