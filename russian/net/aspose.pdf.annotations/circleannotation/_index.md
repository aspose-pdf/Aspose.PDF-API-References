---
title: "Класс CircleAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.CircleAnnotation класс. Класс, представляющий круговую аннотацию."
type: docs
weight: 1680
...
| Имя | Описание |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Конструктор для аннотации Circle. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Создаёт новую аннотацию Circle на указанной странице. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | Прямоугольник, описывающий численные различия между двумя прямоугольниками: запись Rect аннотации и фактические границы базового квадрата или круга. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
