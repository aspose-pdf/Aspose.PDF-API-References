---
title: "Класс PrinterMarkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Annotations.PrinterMarkAnnotation. Абстрактный класс, представляющий аннотацию отметки принтера"
type: docs
weight: 2440
...
Абстрактный класс, представляющий аннотацию отметки принтера.
...
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks)(Document, PrinterMarksKind) | Добавляет отметки принтера ко всем страницам в указанном документе. |
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks_1)(Page, PrinterMarksKind) | Добавляет отметки принтера к указанной странице. |
