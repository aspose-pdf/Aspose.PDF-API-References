---
title: "Класс WatermarkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.WatermarkAnnotation класс. Класс описывает объект аннотации Watermark."
type: docs
weight: 2810
...
Класс описывает объект аннотации Watermark.
...
| Имя | Описание |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation/)(Page, Rectangle) | Конструктор класса аннотации Watermark. |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype/) { get; } | Возвращает тип аннотации. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint/) { get; } | Объект фиксированной печати аннотации Watermark. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity/) { get; set; } | Получает или задает непрозрачность аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept/)(AnnotationSelector) | Применить посетитель к аннотации. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/watermarkannotation/changeafterresize/)(Matrix) | Переопределяет определение в базовом классе пустым телом. |
