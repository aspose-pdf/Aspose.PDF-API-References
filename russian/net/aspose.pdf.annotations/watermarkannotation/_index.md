...
| Имя | Описание |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Конструктор для класса аннотаций водяных знаков. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Применить посетителя для комментирования. |
