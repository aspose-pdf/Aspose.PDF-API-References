...
description: Класс Aspose.Pdf.Annotations.WatermarkAnnotation. Класс описывает объект аннотации водяного знака
type: docs
weight: 2710
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint/) { get; } | Объект фиксированной печати аннотации водяного знака. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity/) { get; set; } | Получает или устанавливает непрозрачность аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept/)(AnnotationSelector) | Применяет посетителя к аннотации. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/watermarkannotation/changeafterresize/)(Matrix) | Переопределяет определение в базовом классе с пустым телом. |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext/)(FormattedText) | Устанавливает текст аннотации. |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate/)(string[], TextState) | Устанавливает текст аннотации. |
