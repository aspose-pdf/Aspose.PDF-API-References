...
description: Класс Aspose.Pdf.Annotations.PolygonAnnotation. Класс, представляющий аннотацию многоугольника
type: docs
weight: 2310
url: /ru/net/aspose.pdf.annotations/polygonannotation/
---
...
| Имя | Описание |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Конструктор для использования с Генератором. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Создает новую аннотацию многоугольника на указанной странице. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Получает или устанавливает стиль окончания второй линии. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Получает или устанавливает намерение аннотации многоугольника или полилинии. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Получает или устанавливает внутренний цвет, которым заполняются окончания линий аннотации. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Получает или устанавливает стиль окончания первой линии. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Получает или устанавливает массив точек, представляющих горизонтальные и вертикальные координаты каждой вершины. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки аннотации. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Обновляет точки в Vertices в соответствии с матричным преобразованием. |
...
* класс [PolyAnnotation](../polyannotation/)
