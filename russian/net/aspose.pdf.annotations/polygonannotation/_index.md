---
title: "Класс PolygonAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.PolygonAnnotation класс. Класс, представляющий полигональную аннотацию."
type: docs
weight: 2400
...
Класс, представляющий полигональную аннотацию.
...
| Имя | Описание |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Конструктор для использования с Generator. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Создает новую полигональную аннотацию на указанной странице. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Получает или задает стиль окончания второй линии. |
...
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Получает или задает внутренний цвет, которым заполняются окончания линий аннотации. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Получает или задает стиль окончания первой линии. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Обновляет точки в Vertices в соответствии с преобразованием матрицы. |
