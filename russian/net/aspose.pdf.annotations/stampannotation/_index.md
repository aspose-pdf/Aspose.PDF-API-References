...
description: Представляет аннотацию штампа. Этот тип аннотаций отображает текст или графику которые должны выглядеть так как если бы они были отпечатаны на странице резиновым штампом.
type: docs
weight: 1160
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon) { get; set; } | Получает или устанавливает значок для штампа. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept)(AnnotationSelector) | Acepts[`AnnotationSelector`](../annotationselector)посетитель при просмотре коллекции аннотаций. |
...
Следующий фрагмент кода демонстрирует, как добавить 2 штампа на первую страницу pdf-документа. Входной документ поступает из inFile, а изменения сохраняются в outFile. Первая марка имеет иконку NotForPublicRelease, а вторая идет с изображением из Rubber.jpg.
