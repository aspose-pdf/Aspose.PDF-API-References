---
title: "Класс StampAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Annotations.StampAnnotation. Представляет аннотацию штамп. Этот тип аннотации отображает текст или графику, имитирующую печать на странице резиновым штампом"
type: docs
weight: 2710
...
Представляет аннотацию резиновой печати. Этот тип аннотации отображает текст или графику, имитирующие печать на странице резиновой печатью.
...
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | Создаёт новую аннотацию Stamp на указанной странице. |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | Получает или задает значок для резиновой печати. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | Принимает посетителя [`AnnotationSelector`](../annotationselector/) при обходе коллекции аннотаций. |
...
Следующий фрагмент кода демонстрирует, как добавить 2 печати на первую страницу PDF‑документа. Входной документ берётся из inFile, а изменения сохраняются в outFile. Первая печать имеет значок NotForPublicRelease, а вторая использует изображение из rubber.jpg.
