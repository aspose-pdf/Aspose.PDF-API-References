---
title: "Класс StrikeOutAnnotation"
...
| Имя | Описание |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | Создаёт новую аннотацию StrikeOut на указанной странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
