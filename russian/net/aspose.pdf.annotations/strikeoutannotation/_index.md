...
description: Представляет зачеркнутую аннотацию которая отображается как зачеркнутый текст документа.
type: docs
weight: 1180
...
Представляет зачеркнутую аннотацию, которая отображается как зачеркнутый текст документа.
...
| Имя | Описание |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation)(Page, Rectangle) | Создает новую аннотацию StrikeOut на указанной странице. |
