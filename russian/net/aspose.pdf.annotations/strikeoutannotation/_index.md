...
description: Класс Aspose.Pdf.Annotations.StrikeOutAnnotation. Представляет аннотацию зачеркивания, которая отображается как зачеркивание в тексте документа
type: docs
weight: 2630
url: /ru/net/aspose.pdf.annotations/strikeoutannotation/
---
## Класс StrikeOutAnnotation

Представляет аннотацию зачеркивания, которая отображается как зачеркивание в тексте документа.
...
| Имя | Описание |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | Создает новую аннотацию зачеркивания на указанной странице. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Получает тип аннотации. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки аннотации. |
...
* класс [TextMarkupAnnotation](../textmarkupannotation/)
