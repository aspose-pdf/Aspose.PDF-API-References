...
description: Класс Aspose.Pdf.Annotations.PolyAnnotation. Абстрактный базовый класс для полигональных аннотаций
type: docs
weight: 2290
url: /ru/net/aspose.pdf.annotations/polyannotation/
---
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Получает или устанавливает намерение аннотации полигона или полилинии. |
