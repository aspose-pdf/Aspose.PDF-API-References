...
description: Представляет аннотацию к фильму содержащую анимированную графику и звук для воспроизведения на экране компьютера и через динамики. Когда аннотация активирована воспроизводится фильм.
type: docs
weight: 730
...
| [Poster](../../aspose.pdf.annotations/movieannotation/poster) { get; set; } | Получает или задает флаг или поток, указывающий, следует ли отображать изображение постера, представляющее фильм, и каким образом. Если true, изображение постера должно быть получено из файла фильма; если оно ложно, постер не будет отображаться. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect) { get; set; } | Получает или задает прямоугольник аннотации. |
| [Rotate](../../aspose.pdf.annotations/movieannotation/rotate) { get; set; } | Получает или задает число градусов, на которое фильм должен быть повернут по часовой стрелке относительно страницы. Значение должно быть кратно 90. |
