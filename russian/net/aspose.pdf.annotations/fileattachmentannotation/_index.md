---
title: "Класс FileAttachmentAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.FileAttachmentAnnotation class. Класс описывает аннотацию вложения файла"
type: docs
weight: 1800
...
Класс описывает file attachment annotation.
...
| Имя | Описание |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | Создает новую аннотацию FileAttachment на указанной странице. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Получает или задает значок, который будет использоваться при отображении аннотации. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Получает или задает непрозрачность значка от 0 до 1: 0 — полностью прозрачный, 1 — полностью непрозрачный. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Принимает объект‑посетитель для обработки аннотации. |
