...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon) { get; set; } | Получает или устанавливает значок, который будет использоваться при отображении аннотации. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity) { get; set; } | Получает или устанавливает прозрачность иконки от 0 до 1:0 - полностью прозрачная, 1 - полностью непрозрачная. |
