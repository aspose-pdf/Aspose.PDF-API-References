...
description: Класс Aspose.Pdf.Annotations.MarkupAnnotation. Абстрактный класс, представляющий аннотацию разметки
type: docs
weight: 2020
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/#setreviewstate)(AnnotationState) | Устанавливает состояние рецензирования для аннотации. Помеченные и непомеченные состояния игнорируются, так как они не относятся к модели состояния рецензирования. Состояние устанавливается пользователем, который создал целевую аннотацию. Значение берется из свойства Title целевой аннотации. Обратите внимание, что состояние хранится в другой текстовой аннотации, которая имеет ключи state и statemodel. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/#setreviewstate_1)(AnnotationState, string) | Устанавливает состояние рецензирования для аннотации. Помеченные и непомеченные состояния игнорируются, так как они не относятся к модели состояния рецензирования. Обратите внимание, что состояние хранится в другой текстовой аннотации, которая имеет ключи state и statemodel. |
