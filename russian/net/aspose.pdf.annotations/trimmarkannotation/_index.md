---
title: "Класс TrimMarkAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Annotations.TrimMarkAnnotation класс. Представляет аннотацию Trim Mark."
type: docs
weight: 2790
...
Метки обрезки размещаются в углах печатной страницы, чтобы указать, где страницу следует обрезать.
