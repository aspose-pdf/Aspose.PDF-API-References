---
title: "Класс HighlightAnnotation"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Annotations.HighlightAnnotation. Представляет аннотацию выделения, которая подсвечивает диапазон текста в документе"
type: docs
weight: 1960
...
Представляет highlight annotation, которая подсвечивает диапазон текста в document.
...
| Имя | Описание |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Создаёт новую аннотацию Highlight на указанной странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки annotation. |
