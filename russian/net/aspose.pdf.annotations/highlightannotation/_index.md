...
description: Класс Aspose.Pdf.Annotations.HighlightAnnotation. Представляет аннотацию выделения, которая выделяет диапазон текста в документе
type: docs
weight: 1870
...
Представляет аннотацию выделения, которая выделяет диапазон текста в документе.
...
| Имя | Описание |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Создает новую аннотацию выделения на указанной странице. |
