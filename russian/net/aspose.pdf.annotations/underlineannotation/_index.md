...
description: Класс Aspose.Pdf.Annotations.UnderlineAnnotation. Представляет аннотацию подчеркивания, которая отображается как подчеркивание в тексте документа
type: docs
weight: 2700
url: /ru/net/aspose.pdf.annotations/underlineannotation/
---
## Класс UnderlineAnnotation
...
| Имя | Описание |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | Создает новую аннотацию подчеркивания на указанной странице. |
...
| Имя | Описание |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Принимает объект посетителя для обработки аннотации. |
