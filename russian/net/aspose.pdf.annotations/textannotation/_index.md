...
description: Класс Aspose.Pdf.Annotations.TextAnnotation. Представляет текстовую аннотацию, которая является стикером, прикрепленным к точке в PDF-документе
type: docs
weight: 2650
...
Представляет текстовую аннотацию, которая является 'стикером', прикрепленным к точке в PDF-документе.
...
| Имя | Описание |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Конструктор для аннотации, когда используется в Генераторе. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Получает или устанавливает значок, который будет использоваться для отображения аннотации. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Получает или устанавливает флаг, указывающий, должна ли аннотация изначально отображаться открытой. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Переопределяет определение в базовом классе с пустым телом. |
