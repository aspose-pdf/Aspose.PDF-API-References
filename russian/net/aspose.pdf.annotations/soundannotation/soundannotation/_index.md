...
| rect | Rectangle | Прямоугольник аннотации, определяющий расположение аннотации на странице. |
| soundFile | String | Звуковой файл, определяющий звук, который будет воспроизводиться при активации аннотации. |
| soundSampleData | SoundSampleData | Данные звукового образца содержат дополнительные параметры звука, такие как частота дискретизации, количество битов на образец и так далее. |
