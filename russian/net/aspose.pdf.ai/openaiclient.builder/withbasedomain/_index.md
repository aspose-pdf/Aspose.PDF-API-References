...
type: docs
weight: 40
url: /ru/net/aspose.pdf.ai/openaiclient.builder/withbasedomain/
---
## Метод OpenAIClient.Builder.WithBaseDomain
...
| --- | --- | --- |
| baseDomain | String | Базовый домен для установки. |

### Возвращаемое значение

Текущий экземпляр [`Builder`](../).
