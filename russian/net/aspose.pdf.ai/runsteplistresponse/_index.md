...
description: Класс Aspose.Pdf.AI.RunStepListResponse. Представляет собой ответ списка, содержащий данные о шагах выполнения
type: docs
weight: 1050
url: /ru/net/aspose.pdf.ai/runsteplistresponse/
---
## Класс RunStepListResponse

Представляет собой ответ списка, содержащий данные о шагах выполнения.
...
| Name | Description |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | Конструктор по умолчанию. |
...
* класс [ListDataResponse&lt;T&gt;](../listdataresponse-1/)
