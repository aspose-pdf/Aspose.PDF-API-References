---
title: "Класс ThreadMessageListResponse"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.AI.ThreadMessageListResponse. Представляет ответ списка, содержащий данные сообщений потока."
type: docs
weight: 1230
url: /ru/net/aspose.pdf.ai/threadmessagelistresponse/
---
## ThreadMessageListResponse class

Представляет ответ со списком, содержащим данные сообщений ветки.
...
| Имя | Описание |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | Конструктор по умолчанию. |
