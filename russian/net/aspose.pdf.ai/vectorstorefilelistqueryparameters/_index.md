---
title: "Класс VectorStoreFileListQueryParameters"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.AI.VectorStoreFileListQueryParameters class. Объект параметров запроса для перечисления файлов vector store."
type: docs
weight: 1420
...
Объект параметров запроса для получения списка файлов векторного хранилища.
...
| [Filter](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/filter/) { get; set; } | Получает или задаёт фильтр по статусу файла. Один из in_progress, completed, failed, cancelled. |
...
| Имя | Описание |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/getqueryparameters/)() | Получает параметры запроса для перечисления файлов vector store. |
