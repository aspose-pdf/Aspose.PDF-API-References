...
description: Класс Aspose.Pdf.AI.RunListResponse. Представляет собой ответ списка, содержащий данные о запусках
type: docs
weight: 1000
url: /ru/net/aspose.pdf.ai/runlistresponse/
---
## Класс RunListResponse

Представляет собой ответ списка, содержащий данные о запусках.
...
| Имя | Описание |
| --- | --- |
| [RunListResponse](runlistresponse/)() | Конструктор по умолчанию. |
