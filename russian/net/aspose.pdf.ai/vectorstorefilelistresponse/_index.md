---
title: "Класс VectorStoreFileListResponse"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.AI.VectorStoreFileListResponse class. Представляет ответ списка, содержащий данные файлов векторного хранилища"
type: docs
weight: 1430
url: /ru/net/aspose.pdf.ai/vectorstorefilelistresponse/
---
## VectorStoreFileListResponse class

Представляет ответ со списком, содержащим данные файлов векторного хранилища.
...
| Имя | Описание |
| --- | --- |
| [VectorStoreFileListResponse](vectorstorefilelistresponse/)() | Конструктор по умолчанию. |
...
| Имя | Описание |
| --- | --- |
| [GetFileIdList](../../aspose.pdf.ai/vectorstorefilelistresponse/getfileidlist/)() | Получает список идентификаторов файлов из векторного хранилища. |
