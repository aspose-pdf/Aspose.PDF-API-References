---
title: "Класс AssistantListQueryParameters"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.AI.AssistantListQueryParameters класс. Представляет объект параметров запроса для перечисления помощников"
type: docs
weight: 110
...
Представляет объект параметров запроса для получения списка ассистентов.
...
| Имя | Описание |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/assistantlistqueryparameters/getqueryparameters/)() | Получает параметры запроса для перечисления помощников. |
