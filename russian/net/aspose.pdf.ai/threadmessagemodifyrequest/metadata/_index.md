...
description: Свойство ThreadMessageModifyRequest. Получает или задает набор из 16 пар ключ-значение, которые могут быть прикреплены к объекту. Это может быть полезно для хранения дополнительной информации об объекте в структурированном формате. Ключи могут иметь максимальную длину 64 символа, а значения - максимальную длину 512 символов.
type: docs
weight: 20
url: /ru/net/aspose.pdf.ai/threadmessagemodifyrequest/metadata/
---
## Свойство ThreadMessageModifyRequest.Metadata
