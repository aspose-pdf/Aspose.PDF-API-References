---
title: "Класс AssistantListResponse"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.AI.AssistantListResponse. Представляет ответ, содержащий список ответов ассистента"
type: docs
weight: 120
...
Представляет ответ, содержащий список ответов ассистента.
