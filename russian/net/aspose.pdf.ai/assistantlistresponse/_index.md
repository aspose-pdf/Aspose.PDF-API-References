...
description: Класс Aspose.Pdf.AI.AssistantListResponse. Представляет ответ, содержащий список ответов помощника
type: docs
weight: 120
url: /ru/net/aspose.pdf.ai/assistantlistresponse/
---
## Класс AssistantListResponse

Представляет ответ, содержащий список ответов помощника.
...
| Имя | Описание |
| --- | --- |
| [AssistantListResponse](assistantlistresponse/)() | Конструктор по умолчанию. |
