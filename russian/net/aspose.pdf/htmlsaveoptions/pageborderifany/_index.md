...
description: Этот атрибут представляет собой набор настроек используемых для рисования границы если есть в результирующем HTML-документе вокруг области представляющей исходную страницу PDF. По сути это касается отображения краев бумаги страницы а не границы страницы на которую ссылается сама страница PDF.
type: docs
weight: 310
