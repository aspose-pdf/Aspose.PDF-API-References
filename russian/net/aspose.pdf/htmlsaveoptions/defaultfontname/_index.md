...
description: Указывает имя установленного шрифта который используется для замены любого шрифта документа который не встроен и не установлен в системе. Если null то используется шрифт замены по умолчанию.
type: docs
weight: 50
