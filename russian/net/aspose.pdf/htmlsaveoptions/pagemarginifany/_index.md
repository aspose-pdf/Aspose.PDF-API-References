...
description: Этот атрибут представляет собой набор дополнительных полей страницы если есть в результирующем HTML-документе вокруг области представляющей исходную страницу PDF.
type: docs
weight: 320
