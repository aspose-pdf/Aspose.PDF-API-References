...
| Имя | Описание |
| --- | --- |
| [Action](../../aspose.pdf/outlineitemcollection/action) { get; set; } | Получает или задает действие для этого элемента структуры. |
...
| [Color](../../aspose.pdf/outlineitemcollection/color) { get; set; } | Получает или задает цвет текста заголовка этого элемента структуры. |
| override [Count](../../aspose.pdf/outlineitemcollection/count) { get; } | Количество предметов коллекции. Пожалуйста, не путайте с VisibleCount:VisibleCount получает количество видимых элементов контура на всех уровнях. |
...
| [First](../../aspose.pdf/outlineitemcollection/first) { get; } | Получает элемент структуры, представляющий первый элемент верхнего уровня в иерархии структуры. |
...
| [Italic](../../aspose.pdf/outlineitemcollection/italic) { get; set; } | Получает или устанавливает флаг курсива для текста заголовка этого элемента структуры |
| [Item](../../aspose.pdf/outlineitemcollection/item) { get; } | Получает элемент структуры из коллекции, используя индекс. |
| [Last](../../aspose.pdf/outlineitemcollection/last) { get; } | Получает элемент структуры, представляющий последний элемент верхнего уровня в иерархии структуры. |
| [Level](../../aspose.pdf/outlineitemcollection/level) { get; } | Получает уровень иерархии элемента схемы. |
| [Next](../../aspose.pdf/outlineitemcollection/next) { get; } | Получает элемент структуры, представляющий следующий элемент относительно этого элемента в иерархии структуры. |
...
| [Prev](../../aspose.pdf/outlineitemcollection/prev) { get; } | Получает элемент структуры, представляющий предыдущий элемент относительно этого элемента в иерархии структуры. |
...
| override [VisibleCount](../../aspose.pdf/outlineitemcollection/visiblecount) { get; } | Получает общее количество элементов структуры на всех уровнях иерархии структуры документа. |
...
| override [Clear](../../aspose.pdf/outlineitemcollection/clear)() | Удаляет все предметы из коллекции. |
...
| override [CopyTo](../../aspose.pdf/outlineitemcollection/copyto)(OutlineItemCollection[], int) | Копирует записи структуры в System.Array, начиная с определенного индекса System.Array. |
...
| [Insert](../../aspose.pdf/outlineitemcollection/insert)(int, OutlineItemCollection) | Вставляет элемент структуры в коллекцию в указанном месте. |
