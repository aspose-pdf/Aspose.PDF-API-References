...
description: Определяет перенос слов. Если для этого свойства установлено значение true и указано значение ширины текст будет разбит на несколько строк чтобы соответствовать указанной ширине. Значение по умолчаниюложь.
type: docs
weight: 120
