...
---
## Свойство TextStamp.Justify

Определяет выравнивание текста. Если это свойство установлено в true, то левый и правый края текста выровнены. Значение по умолчанию: false.
