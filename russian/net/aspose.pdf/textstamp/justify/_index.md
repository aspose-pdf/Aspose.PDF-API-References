...
description: Определяет выравнивание текста. Если для этого свойства установлено значение true выравниваются как левый так и правый края текста. Значение по умолчанию ложь.
type: docs
weight: 40
