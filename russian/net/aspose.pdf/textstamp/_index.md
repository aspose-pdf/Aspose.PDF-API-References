...
description: Повторно выводит текстовый штамп.
type: docs
weight: 7240
...
Повторно выводит текстовый штамп.
...
| Имя | Описание |
| --- | --- |
| [TextStamp](textstamp#constructor)(FormattedText) | Инициализирует новый экземпляр класса[`TextStamp`](../textstamp)с объектом formattedText |
| [TextStamp](textstamp#constructor_1)(string) | Инициализирует новый экземпляр класса[`TextStamp`](../textstamp). |
| [TextStamp](textstamp#constructor_2)(string, TextState) | Инициализирует новый экземпляр класса[`TextStamp`](../textstamp). |
...
| [TextState](../../aspose.pdf/textstamp/textstate) { get; } | Получает текстовые свойства штампа. Подробнее см.[`TextState`](./textstate). |
