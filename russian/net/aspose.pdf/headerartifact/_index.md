---
title: "Класс HeaderArtifact"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.HeaderArtifact. Класс описывает артефакт заголовка. Этот артефакт может использоваться для установки заголовка страницы"
type: docs
weight: 5540
...
Класс описывает артефакт верхнего колонтитула. Этот артефакт может использоваться для установки заголовка страницы.
...
| Имя | Описание |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Создаёт экземпляр Header Artifact. |
