...
description: Описывает одно свойство. URI пространства имен схемы http//www.aiim.org/pdfa/ns/property Обязательный префикс пространства имен схемы pdfaProperty
type: docs
weight: 7510
