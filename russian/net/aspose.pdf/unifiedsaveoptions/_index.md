...
description: Этот класс представляет параметры сохранения для сохранения которые используют унифицированный способ преобразования с единой внутренней моделью документа
type: docs
weight: 7280
...
Этот класс представляет параметры сохранения для сохранения, которые используют унифицированный способ преобразования (с единой внутренней моделью документа)
