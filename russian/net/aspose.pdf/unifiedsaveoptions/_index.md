...
description: Этот класс представляет варианты сохранения для сохранения которые используют единый способ преобразования с единой внутренней моделью документа
type: docs
weight: 7280
...
Этот класс представляет варианты сохранения для сохранения, которые используют единый способ преобразования (с единой внутренней моделью документа)
