...
| ops | Operator[] | Массив вставляемых операторов. Каждый оператор может иметь любой индекс (по умолчанию -1), потому что их индексы настраиваются автоматически, начиная с*at*. |
...
| --- | --- | --- |
| at | Int32 | Индекс, с которого начинается вставка операторов. |
| ops | IList`1 | Массив вставляемых операторов. |
