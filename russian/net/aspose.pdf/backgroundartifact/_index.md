...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor) { get; set; } | Получает или задает фоновый цвет артефакта фона |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage) { get; set; } | Получает или задает фоновое изображение фонового артефакта |
