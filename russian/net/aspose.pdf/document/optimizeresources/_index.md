...
description: Оптимизировать ресурсы в документе 1. Удалены ресурсы которые не используются на страницах документа 2. Равные ресурсы объединены в один объект 3. Неиспользуемые объекты удаляются.
type: docs
weight: 660
