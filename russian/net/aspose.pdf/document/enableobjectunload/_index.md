...
description: Получить или установить флаг разрешающий частичную выгрузку документа из памяти. Это позволяет уменьшить использование памяти но может отрицательно сказаться на производительности.
type: docs
weight: 150
