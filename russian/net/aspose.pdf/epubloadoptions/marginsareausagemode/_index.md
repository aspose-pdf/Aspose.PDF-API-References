...
description: Представляет режим использования области полей - определяет обработку инструкций если есть CSS импортированного документа  связанных с использованием полей.
type: docs
weight: 40
