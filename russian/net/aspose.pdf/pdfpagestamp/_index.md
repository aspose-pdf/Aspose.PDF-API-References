...
description: Класс представляет штамп который использует страницу PDF в качестве штампа.
type: docs
weight: 6070
...
| [PdfPageStamp](pdfpagestamp#constructor_1)(Stream, int) | Создает штамп страницы Pdf с указанной страницы в документе из потока. |
