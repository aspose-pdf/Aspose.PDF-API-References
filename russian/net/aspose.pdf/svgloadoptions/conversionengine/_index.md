...
description: Позволяет выбрать механизм преобразования который будет использоваться во время преобразования. В настоящее время новый движок находится на стадии B-тестирования поэтому по умолчанию установлено значение ConversionEngines.LegacyEngine
type: docs
weight: 40
