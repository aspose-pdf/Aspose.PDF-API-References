---
title: "Класс WatermarkArtifact"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.WatermarkArtifact class. Класс описывает артефакт водяного знака. Это может использоваться для"
type: docs
weight: 11500
url: /ru/net/aspose.pdf/watermarkartifact/
---
## WatermarkArtifact class

Класс описывает артефакт водяного знака. Это может использоваться для
...
| Имя | Описание |
| --- | --- |
| [WatermarkArtifact](watermarkartifact/)() | Создает экземпляр артефакта водяного знака. |
