...
| --- | --- | --- |
| visitor | AnnotationSelector | Посетитель селектора аннотаций |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| visitor | ImagePlacementAbsorber | Объект размещения изображения. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| visitor | TextFragmentAbsorber | Объект поглотителя фрагментов текста. |
