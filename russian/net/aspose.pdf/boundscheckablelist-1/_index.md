---
title: "Класс BoundsCheckableListT"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.BoundsCheckableList1T. Представляет оболочку BoundsCheckableList вокруг System.Collections.Generic.List"
type: docs
weight: 3040
...
Представляет BoundsCheckableList — оболочку вокруг System.Collections.Generic.List.
...
| Имя | Описание |
| --- | --- |
| [Count](../../aspose.pdf/boundscheckablelist-1/count/) { get; } | Возвращает количество элементов, содержащихся в System.Collections.Generic.List. |
| [IsReadOnly](../../aspose.pdf/boundscheckablelist-1/isreadonly/) { get; } | Возвращает значение, указывающее, является ли коллекция только для чтения. |
| [Item](../../aspose.pdf/boundscheckablelist-1/item/) { get; set; } | Получает или задает абзац из или в коллекцию. |
...
| [Contains](../../aspose.pdf/boundscheckablelist-1/contains/)(T) | Определяет, находится ли элемент в System.Collections.Generic.List. |
| [CopyTo](../../aspose.pdf/boundscheckablelist-1/copyto/)(T[], int) |  |
| [GetEnumerator](../../aspose.pdf/boundscheckablelist-1/getenumerator/)() | Возвращает перечислитель, который проходит по System.Collections.Generic.List. |
| [IndexOf](../../aspose.pdf/boundscheckablelist-1/indexof/)(T) | Ищет указанный объект и возвращает нулевой индекс первого вхождения в пределах всего System.Collections.Generic.List. |
...
| [RemoveAt](../../aspose.pdf/boundscheckablelist-1/removeat/)(int) | Удаляет элемент по указанному индексу в System.Collections.Generic.List. |
