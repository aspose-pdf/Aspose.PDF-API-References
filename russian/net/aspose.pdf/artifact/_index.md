...
| [SetImage](../../aspose.pdf/artifact/setimage#setimage)(Stream) | Задает изображение артефакта. |
| [SetImage](../../aspose.pdf/artifact/setimage#setimage_1)(string) | Задает изображение артефакта. |
...
| Имя | Описание |
| --- | --- |
| enum [ArtifactSubtype](artifact.artifactsubtype) | Перечисление подтипа возможных артефактов. |
| enum [ArtifactType](artifact.artifacttype) | Перечисление возможных типов артефактов. |
