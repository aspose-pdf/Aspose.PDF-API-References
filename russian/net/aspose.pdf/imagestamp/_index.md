...
| Имя | Описание |
| --- | --- |
| [ImageStamp](imagestamp#constructor)(Stream) | Инициализирует новый экземпляр[`ImageStamp`](../imagestamp) класс. |
...
| [Height](../../aspose.pdf/imagestamp/height) { get; set; } | Получает или задает высоту изображения. Установка этого изображения позволяет масштабировать изображение по вертикали. |
...
| [Quality](../../aspose.pdf/imagestamp/quality) { get; set; } | Получает или задает качество штампа изображения в процентах. Допустимые значения: 0..100%. |
...
| [Width](../../aspose.pdf/imagestamp/width) { get; set; } | Получает или задает ширину изображения. Установка этого свойства позволяет масштабировать изображение по горизонтали. |
