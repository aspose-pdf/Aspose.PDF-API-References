...
description: Класс Aspose.Pdf.LogicalStructure.AnnotationElement. Представляет базовый класс для элементов структуры аннотации в логической структуре
type: docs
weight: 6190
url: /ru/net/aspose.pdf.logicalstructure/annotationelement/
---
## Класс AnnotationElement

Представляет базовый класс для элементов структуры аннотации в логической структуре.
