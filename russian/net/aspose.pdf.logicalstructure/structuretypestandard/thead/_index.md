...
description: Поле StructureTypeStandard. Группа строк заголовка таблицы PDF 1.5. Группа строк, которые составляют заголовок таблицы. Если таблица разбита на несколько страниц, эти строки могут быть перерисованы в верхней части каждого фрагмента таблицы (хотя существует только один элемент THead).
type: docs
weight: 430
