...
description: Класс Aspose.Pdf.LogicalStructure.TableRowCollectionElement. Представляет базовый класс для дочерних элементов Заголовка, Тела и Низа таблицы в логической структуре
type: docs
weight: 6790
url: /ru/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## Класс TableRowCollectionElement

Представляет базовый класс для дочерних элементов Заголовка, Тела и Низа таблицы в логической структуре.
