...
description: Класс Aspose.Pdf.LogicalStructure.TOCElement. Представляет элемент структуры оглавления в логической структуре
type: docs
weight: 6740
...
Представляет элемент структуры оглавления в логической структуре.
