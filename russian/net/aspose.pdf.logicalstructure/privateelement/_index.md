...
description: Класс Aspose.Pdf.LogicalStructure.PrivateElement. Представляет частный элемент структуры в логической структуре
type: docs
weight: 6560
url: /ru/net/aspose.pdf.logicalstructure/privateelement/
---
## Класс PrivateElement

Представляет частный элемент структуры в логической структуре.
