...
description: Класс Aspose.Pdf.LogicalStructure.TableTBodyElement. Представляет элемент структуры TBody в логической структуре таблицы
type: docs
weight: 6800
url: /ru/net/aspose.pdf.logicalstructure/tabletbodyelement/
---
## Класс TableTBodyElement
