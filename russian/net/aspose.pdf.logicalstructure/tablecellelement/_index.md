...
description: Класс Aspose.Pdf.LogicalStructure.TableCellElement. Представляет базовый класс для элементов ячеек таблицы TH и TD в логической структуре
type: docs
weight: 6760
...
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped/) { get; set; } | Получает или задает перенос текста в ячейке. |
| [Language](../../aspose.pdf.logicalstructure/structureelement/language/) { get; set; } | Получает или задает язык для элемента структуры. |
| [Margin](../../aspose.pdf.logicalstructure/tablecellelement/margin/) { get; set; } | Получает или задает отступы. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(BDC) | Привязывает элемент структуры к оператору потока содержимого BDC. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XForm) | Привязывает элемент структуры к потоку содержимого XForm. |
