...
description: Класс Aspose.Pdf.LogicalStructure.IllustrationElement. Представляет базовый класс для элементов структуры иллюстрации в логической структуре
type: docs
weight: 6420
url: /ru/net/aspose.pdf.logicalstructure/illustrationelement/
---
## Класс IllustrationElement
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | Добавляет изображение к текущему элементу иллюстрации. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | Добавляет изображение к текущему элементу иллюстрации. |
