...
description: Представляет базовый класс для иллюстраций элементов структуры в логической структуре.
type: docs
weight: 4250
...
Представляет базовый класс для иллюстраций элементов структуры в логической структуре.
