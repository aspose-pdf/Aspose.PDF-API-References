...
description: Класс Aspose.Pdf.LogicalStructure.ILSTextElement. Представляет базовый класс для элементов текстовой структуры уровня inline в логической структуре
type: docs
weight: 6400
url: /ru/net/aspose.pdf.logicalstructure/ilstextelement/
---
## Класс ILSTextElement

Представляет базовый класс для элементов текстовой структуры уровня inline в логической структуре.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Получает объект StructureTextState для текущего элемента. |
