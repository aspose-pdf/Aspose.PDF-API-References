...
description: Класс Aspose.Pdf.LogicalStructure.CodeElement. Представляет элемент структуры кода в логической структуре
type: docs
weight: 6290
url: /ru/net/aspose.pdf.logicalstructure/codeelement/
---
## Класс CodeElement

Представляет элемент структуры кода в логической структуре.
