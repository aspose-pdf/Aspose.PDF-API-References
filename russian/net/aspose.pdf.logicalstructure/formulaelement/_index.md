...
description: Класс Aspose.Pdf.LogicalStructure.FormulaElement. Представляет элемент структуры формулы в логической структуре
type: docs
weight: 6360
...
Представляет элемент структуры формулы в логической структуре.
