---
title: "Класс NoteElement"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.LogicalStructure.NoteElement class. Представляет элемент структуры Note в логической структуре"
type: docs
weight: 6660
...
Представляет элемент структуры Note в логической структуре.
