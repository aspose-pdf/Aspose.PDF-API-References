...
description: Класс Aspose.Pdf.LogicalStructure.NoteElement. Представляет элемент структуры заметки в логической структуре
type: docs
weight: 6520
url: /ru/net/aspose.pdf.logicalstructure/noteelement/
---
## Класс NoteElement

Представляет элемент структуры заметки в логической структуре.
