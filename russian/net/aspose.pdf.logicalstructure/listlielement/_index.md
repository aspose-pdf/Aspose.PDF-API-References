...
description: Класс Aspose.Pdf.LogicalStructure.ListLIElement. Представляет элемент структуры LI в логической структуре списка
type: docs
weight: 6480
url: /ru/net/aspose.pdf.logicalstructure/listlielement/
---
## Класс ListLIElement

Представляет элемент структуры LI в логической структуре списка.
