...
| [IsRowBroken](../../aspose.pdf.logicalstructure/tabletrelement/isrowbroken) { get; set; } | Получает, что строка может быть разбита между двумя страницами. |
...
| [CreateTD](../../aspose.pdf.logicalstructure/tabletrelement/createtd)() | Создает[`TableTHElement`](../tablethelement) и добавил его в текущую таблицу. |
| [CreateTH](../../aspose.pdf.logicalstructure/tabletrelement/createth)() | Создает[`TableTHElement`](../tablethelement) и добавил его в текущую таблицу. |
