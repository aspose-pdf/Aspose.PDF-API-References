...
description: Класс Aspose.Pdf.LogicalStructure.BLSElement. Представляет базовый класс для элементов структуры блочного уровня в логической структуре
type: docs
weight: 6240
url: /ru/net/aspose.pdf.logicalstructure/blselement/
---
## Класс BLSElement

Представляет базовый класс для элементов структуры блочного уровня в логической структуре.
