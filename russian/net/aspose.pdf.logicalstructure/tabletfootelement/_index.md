...
description: Класс Aspose.Pdf.LogicalStructure.TableTFootElement. Представляет элемент структуры TFoot в логической структуре таблицы
type: docs
weight: 6820
url: /ru/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## Класс TableTFootElement
