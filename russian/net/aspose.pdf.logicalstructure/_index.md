...
| [DocumentElement](./documentelement/) | Представляет элемент структуры Document в логической структуре. |
| [Element](./element/) | Представляет базовый класс для элемента в логической структуре. |
| [ElementList](./elementlist/) | Представляет упорядоченную коллекцию элементов. |
...
| [ParagraphElement](./paragraphelement/) | Представляет элемент структуры Paragraph в логической структуре. |
| [PartElement](./partelement/) | Представляет элемент структуры Part в логической структуре. |
| [PrivateElement](./privateelement/) | Представляет элемент структуры Private в логической структуре. |
...
| [TableElement](./tableelement/) | Представляет элемент структуры Table в логической структуре. |
| [TableRowCollectionElement](./tablerowcollectionelement/) | Представляет базовый класс для дочерних элементов заголовка, тела и подвала таблицы в логической структуре. |
| [TableTBodyElement](./tabletbodyelement/) | Представляет элемент структуры TBody в логической структуре таблицы. |
| [TableTDElement](./tabletdelement/) | Представляет элемент структуры TD в логической структуре таблицы. |
