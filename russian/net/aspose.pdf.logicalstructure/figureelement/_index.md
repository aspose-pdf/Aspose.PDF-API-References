...
description: Класс Aspose.Pdf.LogicalStructure.FigureElement. Представляет элемент структуры Figure в логической структуре
type: docs
weight: 6340
url: /ru/net/aspose.pdf.logicalstructure/figureelement/
---
## Класс FigureElement
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | Добавляет изображение к текущему элементу иллюстрации. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | Добавляет изображение к текущему элементу иллюстрации. |
...
* класс [IllustrationElement](../illustrationelement/)
