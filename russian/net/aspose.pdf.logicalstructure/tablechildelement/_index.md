...
description: Класс Aspose.Pdf.LogicalStructure.TableChildElement. Представляет базовый класс для дочерних элементов таблицы в логической структуре
type: docs
weight: 6770
url: /ru/net/aspose.pdf.logicalstructure/tablechildelement/
---
## Класс TableChildElement

Представляет базовый класс для дочерних элементов таблицы в логической структуре.
