...
description: Класс Aspose.Pdf.LogicalStructure.TableTHElement. Представляет элемент структуры TH в логической структуре таблицы
type: docs
weight: 6830
url: /ru/net/aspose.pdf.logicalstructure/tablethelement/
---
## Класс TableTHElement
...
| [ColSpan](../../aspose.pdf.logicalstructure/tablecellelement/colspan/) { get; set; } | Получает или задает охват столбца. |
...
| [RowSpan](../../aspose.pdf.logicalstructure/tablecellelement/rowspan/) { get; set; } | Получает или задает охват строки. |
