...
| [ColSpan](../../aspose.pdf.logicalstructure/tablecellelement/colspan) { get; set; } | Получает или задает диапазон столбцов. |
...
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped) { get; set; } | Получает или задает перенос слова в тексте ячейки. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/tablecellelement/structuretextstate) { get; } | Получает объектStructureTextStateдля текущего элемента. |
