...
description: Класс Aspose.Pdf.LogicalStructure.FormElement. Представляет элемент структуры формы в логической структуре
type: docs
weight: 6350
url: /ru/net/aspose.pdf.logicalstructure/formelement/
---
## Класс FormElement

Представляет элемент структуры формы в логической структуре.
