...
description: Класс Aspose.Pdf.Structure.FigureElement. Класс, представляющий логическую структуру фигуры
type: docs
weight: 10160
...
Класс, представляющий логическую структуру фигуры.
...
| virtual [Alt](../../aspose.pdf.structure/element/alt/) { get; set; } | (Необязательно) Альтернативное описание элемента структуры и его дочерних элементов в читаемой для человека форме, которое полезно при извлечении содержимого документа в поддержку доступности для пользователей с ограниченными возможностями или для других целей. |
