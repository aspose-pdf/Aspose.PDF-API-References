...
description: Метод ObsoleteFill. Принимает объект посетителя для обработки оператора
type: docs
weight: 20
url: /ru/net/aspose.pdf.operators/obsoletefill/accept/
---
## Метод ObsoleteFill.Accept
