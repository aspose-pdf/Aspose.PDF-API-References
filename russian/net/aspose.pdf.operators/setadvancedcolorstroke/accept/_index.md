...
description: Метод SetAdvancedColorStroke. Принимает объект посетителя для обработки оператора
type: docs
weight: 20
url: /ru/net/aspose.pdf.operators/setadvancedcolorstroke/accept/
---
## Метод SetAdvancedColorStroke.Accept
