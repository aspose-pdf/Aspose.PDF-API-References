...
description: Метод SetTextMatrix. Принимает объект посетителя для обработки оператора
type: docs
weight: 30
url: /ru/net/aspose.pdf.operators/settextmatrix/accept/
---
## Метод SetTextMatrix.Accept
