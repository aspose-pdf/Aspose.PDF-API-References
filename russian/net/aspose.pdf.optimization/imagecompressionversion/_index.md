...
| Mixed | `3` | Использовать быстрый алгоритм, когда это возможно, и стандартный для других случаев. Может быть медленнее, чем "Fast", но может обеспечить лучшее сжатие. |
