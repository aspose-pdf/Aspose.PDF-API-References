...
| Имя | Описание |
| --- | --- |
| [DateField](datefield#constructor)() | Инициализирует новый экземпляр[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | Конструктор, который следует использовать с генератором. |
| [DateField](datefield#constructor_2)(Document, Rectangle) | Инициализирует новый экземпляр[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | Инициализирует новый экземпляр[`DateField`](../datefield) |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat) { get; set; } | Получает или задает формат даты. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | Добавление изображения запрещено для этого поля. (2 methods) |
...
DateField dateField = новое DateField (страница, прямоугольник); doc.Form.Add (dateField); dateField.Init (страница);
