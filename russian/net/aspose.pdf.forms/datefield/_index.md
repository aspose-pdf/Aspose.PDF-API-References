...
description: Поле даты с просмотром календаря.
type: docs
weight: 2960
...
Поле даты с просмотром календаря.
...
DateField dateField = новый DateField (страница, прямоугольник); doc.Form.Add(dateField); dateField.Init(страница);
