---
title: "Класс ButtonField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Forms.ButtonField класс. Класс представляет поле кнопки"
type: docs
weight: 5090
...
Класс представляет поле push‑button.
...
| Имя | Описание |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Конструктор поля кнопки для Generator. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Получает или задаёт альтернативный заголовок кнопки, который будет отображаться, когда кнопка мыши нажата в её активной области. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Получает или задаёт альтернативный значок, который будет отображаться, когда кнопка мыши нажата в её активной области. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Получает объект подгонки значка, указывающий, как значок аннотации виджета будет отображаться в её прямоугольнике аннотации. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Получает или задаёт положение подписи значка. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Получает или задаёт обычную подпись. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Получает или задаёт обычный значок кнопки, который будет отображаться, когда она не взаимодействует с пользователем. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Получает или задаёт подпись rollover кнопки, которая будет отображаться, когда пользователь перемещает курсор в её активную область без нажатия кнопки мыши. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Получает или задаёт rollover значок кнопки, который будет отображаться, когда пользователь перемещает курсор в её активную область без нажатия кнопки мыши. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Добавляет изображение в ресурсы поля и отрисовывает его. |
