...
---
## Свойство XFA.NamespaceManager

Получает пространство имен для формы XFA. Следующие пространства имен определены: "data" для данных формы и "tpl" для шаблона формы.
