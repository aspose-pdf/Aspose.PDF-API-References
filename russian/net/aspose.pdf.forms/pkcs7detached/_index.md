---
title: "Класс PKCS7Detached"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Forms.PKCS7Detached. Представляет объект PKCS7, соответствующий спецификации PKCS7 в Internet RFC 2315 PKCS 7 Cryptographic Message Syntax Version 1.5. Оригинальный дайджест подписанного сообщения над диапазоном байтов документа включён в обычное поле PKCS7 SignedData. Данные не инкапсулируются в поле PKCS7 SignedData."
type: docs
weight: 5310
