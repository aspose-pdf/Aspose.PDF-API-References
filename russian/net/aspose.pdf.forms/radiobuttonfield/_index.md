...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | Получает или устанавливает индекс выбранного элемента. Нумерация позиций начинается с 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Стиль окна поля. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | Добавляет новое поле параметра в поле RadioButton |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Добавить опцию к кнопке радио. |
