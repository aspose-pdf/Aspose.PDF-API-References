...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options) { get; } | Получает набор опций переключателя. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | Получает или задает индекс выбранного элемента. Нумерация позиций начинается с 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Стиль поля поля. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | Добавляет новое поле параметра в RadioButton field |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Добавить опцию к радиокнопке. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | Добавить в опцию переключателя с указанным прямоугольником. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition)(Point) | Переместить все подэлементы переключателя в указанные позиции на странице. |
