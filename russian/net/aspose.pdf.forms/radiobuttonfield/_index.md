---
title: "Класс RadioButtonField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Forms.RadioButtonField класс. Класс, представляющий поле радиокнопки"
type: docs
weight: 5330
...
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Конструктор для RadiouttonField |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Получает или задает флаг, позволяющий радиокнопке не иметь выбранного значения. Если `true`, всегда должна быть выбрана ровно одна радиокнопка; выбор уже выбранной кнопки не оказывает эффекта. Если `false`, щелчок по выбранной кнопке снимает её выбор, оставляя все кнопки невыбранными. |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options/) { get; } | Получает коллекцию вариантов радиокнопки. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Получает индекс страницы, содержащей это поле RadioButton. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Получает или задает индекс выбранного элемента. Нумерация элементов начинается с 1. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Получает или задает массив выбранных элементов. Для списка с множественным выбором массив содержит более одного элемента. Для списка с одиночным выбором он содержит один элемент. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Получает словарь внешнего вида аннотации. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Стиль поля. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value/) { get; set; } | Получает или задает значение поля. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add/)(RadioButtonOptionField) | Добавляет новое поле варианта к полю RadioButton |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Добавить вариант к radion button. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Добавить к радиокнопке вариант с указанным прямоугольником. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Переместить все подпункты радиокнопки в указанные позиции на странице. |
