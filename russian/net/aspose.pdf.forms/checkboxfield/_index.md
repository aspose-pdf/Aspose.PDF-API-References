...
| Имя | Описание |
| --- | --- |
| [CheckboxField](checkboxfield#constructor)() | Создать экземпляр CheckboxField. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue) { get; set; } | Получает или устанавливает экспортное значение поля CheckBox. |
