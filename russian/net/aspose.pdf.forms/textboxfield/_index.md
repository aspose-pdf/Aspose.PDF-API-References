...
| Имя | Описание |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Конструктор, который следует использовать с Генератором. |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | Конструктор текстового поля. |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | Конструктор текстового поля. |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | Конструктор текстового поля. |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Получает или задает флаг, который указывает, разделено ли поле на равномерные позиции. |
...
| [IsGroup](../../aspose.pdf.forms/field/isgroup/) { get; } | Получает или задает логическое значение, которое указывает, является ли это поле нетерминальным полем, т.е. группой полей. |
...
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Получает или задает флаг прокручиваемости поля. Если true, поле может быть прокручено. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Получает или задает флаг проверки правописания для поля. Если true, поле будет проверено на правописание. |
