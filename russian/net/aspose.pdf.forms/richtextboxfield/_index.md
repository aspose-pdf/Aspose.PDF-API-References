...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Получает или задает значение форматированного форматированного текста с разметкой. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Получает или задает выравнивание поля форматированного текста. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue) { get; set; } | Получает или задает значение форматированного текста. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | Получает или задает строку стиля по умолчанию для поля форматированного текста. |
