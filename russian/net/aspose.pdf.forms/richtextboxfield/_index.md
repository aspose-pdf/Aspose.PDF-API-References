---
title: "Класс RichTextBoxField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Forms.RichTextBoxField. Класс описывает компонент редактора форматированного текста."
type: docs
weight: 5350
...
| Имя | Описание |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Конструктор поля Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Получает или задаёт отформатированное значение форматированного текста с разметкой. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Получает или задаёт выравнивание Rich Text Box. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Получает или задаёт значение форматированного текста. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Получает или задает строку стиля по умолчанию поля форматированного текста. |
