...
description: Класс Aspose.Pdf.Forms.RichTextBoxField. Класс описывает компонент редактора богатого текста
type: docs
weight: 5230
url: /ru/net/aspose.pdf.forms/richtextboxfield/
---
## Класс RichTextBoxField

Класс описывает компонент редактора богатого текста.
...
| Имя | Описание |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Конструктор для поля Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Получает или устанавливает отформатированное значение богатого текста с разметкой. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Получает или устанавливает выравнивание текстового поля. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Получает или устанавливает значение богатого текста. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Получает или устанавливает строку стиля по умолчанию для поля богатого текста. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Значение RichTextField. |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | Получает или устанавливает целочисленное значение, которое указывает Z- порядок графика. График с большим ZIndex будет размещен поверх графика с меньшим ZIndex. ZIndex может быть отрицательным. График с отрицательным ZIndex будет размещен за текстом на странице. |
