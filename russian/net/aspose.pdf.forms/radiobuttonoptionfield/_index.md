...
description: Класс Aspose.Pdf.Forms.RadioButtonOptionField. Класс представляет элемент поля RadioButton
type: docs
weight: 5220
url: /ru/net/aspose.pdf.forms/radiobuttonoptionfield/
---
...
| Имя | Описание |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Создает новый экземпляр RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | Создает радиокнопку в указанном прямоугольнике на указанной странице. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Получает или устанавливает заголовок. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Получает или устанавливает имя опции. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Получает или устанавливает стиль флажка. |
