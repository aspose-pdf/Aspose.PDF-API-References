---
title: "Класс RadioButtonOptionField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Forms.RadioButtonOptionField class. Класс представляет элемент поля RadioButton."
type: docs
weight: 5340
...
Класс представляет элемент поля радиокнопки.
...
| Имя | Описание |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Создать новый экземпляр RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | Создает радиокнопку в указанном прямоугольнике на заданной странице. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Получает или задает подпись. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Получает или задает имя параметра. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Получает или задает стиль флажка. |
