...
description: Класс Aspose.Pdf.Forms.PasswordBoxField. Класс описывает текстовое поле для ввода пароля
type: docs
weight: 5200
url: /ru/net/aspose.pdf.forms/passwordboxfield/
---
## Класс PasswordBoxField
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Получает или задает флаг, который указывает, разделено ли поле на разнесенные позиции. |
...
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Получает или задает флаг проверки правописания для поля. Если true, поле будет проверяться на правописание. |
