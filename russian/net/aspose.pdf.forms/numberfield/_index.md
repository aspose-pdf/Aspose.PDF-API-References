...
| Имя | Описание |
| --- | --- |
| [NumberField](numberfield#constructor)() | Инициализирует новый экземпляр класса[`NumberField`](../numberfield). |
| [NumberField](numberfield#constructor_1)(Document, Rectangle) | Инициализирует новый экземпляр класса[`NumberField`](../numberfield). |
| [NumberField](numberfield#constructor_2)(Page, Rectangle) | Инициализирует новый экземпляр класса[`NumberField`](../numberfield). |
