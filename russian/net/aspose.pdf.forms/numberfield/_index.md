...
description: Класс Aspose.Pdf.Forms.NumberField. Текстовое поле с указанными допустимыми символами
type: docs
weight: 5140
...
| Имя | Описание |
| --- | --- |
| [NumberField](numberfield/#constructor)() | Инициализирует новый экземпляр класса `NumberField`. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | Инициализирует новый экземпляр класса `NumberField`. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | Инициализирует новый экземпляр класса `NumberField`. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | Получает или устанавливает допустимые символы. |
...
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Получает или устанавливает флаг проверки правописания для поля. Если true, поле будет проверено на правописание. |
