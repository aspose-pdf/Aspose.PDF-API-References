---
title: "Класс NumberField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Forms.NumberField класс. Текстовое поле с указанными допустимыми символами"
type: docs
weight: 5260
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | Получает или задаёт допустимые символы. |
