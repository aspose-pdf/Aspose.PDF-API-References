---
title: "Класс ComboBoxField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Forms.ComboBoxField. Класс, представляющий поле комбобокса формы"
type: docs
weight: 5120
...
Класс, представляющий поле комбобокса формы.
...
| Имя | Описание |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Конструктор ComboBoxField, используемый в Generator. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Создает поле CombBox для работы с Generator. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Конструктор поля Combobox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Конструктор поля Combobox. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Получает или задает статус редактируемости поля. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Получает или задает индекс выбранного параметра. Это свойство позволяет изменить выбор. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Получает или задает статус активности проверки орфографии. |
