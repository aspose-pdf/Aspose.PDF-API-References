...
| Имя | Описание |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Конструктор для ComboBoxField, который будет использоваться в Генераторе. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Создает поле CombBox для работы с Генератором. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Конструктор для поля комбобокса. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Конструктор для поля комбобокса. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Получает или устанавливает статус редактируемости поля. |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Получает или устанавливает массив выбранных элементов. Для списка множественного выбора массив содержит более одного элемента. Для списка с одиночным выбором он содержит один элемент. |
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Получает или устанавливает статус активности проверки правописания. |
