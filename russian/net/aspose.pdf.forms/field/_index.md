...
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Размер шрифта Maximail, который можно использовать для содержимого поля. -1, чтобы не проверять размер. |
