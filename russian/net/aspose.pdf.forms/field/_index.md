...
description: Базовый класс для полей акроформы.
type: docs
weight: 3000
...
Базовый класс для полей акроформы.
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | Если true, то размер шрифта будет уменьшен, чтобы текст соответствовал указанному прямоугольнику. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Максимальный размер шрифта, который можно использовать для содержимого поля. -1, чтобы не проверять размер. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | Минимальный размер шрифта, который можно использовать для содержимого поля. -1, чтобы не проверять размер. |
