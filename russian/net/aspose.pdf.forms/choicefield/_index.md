...
| virtual [Options](../../aspose.pdf.forms/choicefield/options) { get; } | Получает набор вариантов выбора. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption#addoption_1)(string, string) | Добавляет новую опцию с указанным значением экспорта и именем. |
