...
description: Класс Aspose.Pdf.Forms.ChoiceField. Представляет базовый класс для полей выбора
type: docs
weight: 4990
url: /ru/net/aspose.pdf.forms/choicefield/
---
## Класс ChoiceField
...
| Имя | Описание |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Создает поле выбора (для генератора) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | Конструктор для ChoiceField. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | Конструктор для ChoiceField. |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately/) { get; set; } | Получает или устанавливает флаг немедленного выполнения при изменении выбора. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Получает или устанавливает индекс выбранного варианта. Это свойство позволяет изменить выбор. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Получает или устанавливает массив выбранных элементов. Для списка с множественным выбором массив содержит более одного элемента. Для списка с одиночным выбором он содержит один элемент. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | Добавляет новый вариант с указанным именем. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | Добавляет новый вариант с указанным экспортным значением и именем. |
