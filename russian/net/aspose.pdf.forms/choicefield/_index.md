---
title: "Класс ChoiceField"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Aspose.Pdf.Forms.ChoiceField класс. Представляет базовый класс для полей выбора"
type: docs
weight: 5110
...
| Имя | Описание |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Создаёт поле выбора (для Generator) |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | Добавляет новую опцию с указанным именем. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | Добавляет новую опцию с указанным экспортным значением и именем. |
