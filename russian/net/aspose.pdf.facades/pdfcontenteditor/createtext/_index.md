...
| icon | String | Имя значка будет использоваться при отображении аннотации. Это значение может быть: «Комментарий», «Ключ», «Примечание», «Справка», «Новый абзац», «Абзац», «Вставка». |
