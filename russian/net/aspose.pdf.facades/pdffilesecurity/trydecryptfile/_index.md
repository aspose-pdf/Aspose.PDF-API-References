...
description: Расшифровывает зашифрованный документ Pdf по паролю владельца. Если документ не имеет пароля владельца можно использовать пароль пользователя. Не генерирует исключение в случае сбоя процесса.
type: docs
weight: 100
...
Расшифровывает зашифрованный документ Pdf по паролю владельца. Если документ не имеет пароля владельца, можно использовать пароль пользователя. Не генерирует исключение в случае сбоя процесса.
