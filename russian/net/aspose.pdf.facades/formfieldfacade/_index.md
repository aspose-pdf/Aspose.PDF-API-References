...
| [TextEncoding](../../aspose.pdf.facades/formfieldfacade/textencoding) { get; set; } | Тип кодировки текста поля text. |

## Методы

| Имя | Описание |
| --- | --- |
| [Reset](../../aspose.pdf.facades/formfieldfacade/reset)() | Сбросить все визуальные атрибуты до пустого значения. |
...
| const [BorderStyleUnderline](../../aspose.pdf.facades/formfieldfacade/borderstyleunderline) | Определяет подчеркнутый стиль границы. |
...
| const [CheckBoxStyleStar](../../aspose.pdf.facades/formfieldfacade/checkboxstylestar) | Определяет стиль флажка в виде звезды. |
| const [CheckBoxStyleUndefined](../../aspose.pdf.facades/formfieldfacade/checkboxstyleundefined) | Определяет неопределенный стиль флажка. |
