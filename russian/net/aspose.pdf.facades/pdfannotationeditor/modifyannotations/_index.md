...
description: Изменяет аннотации указанного типа в указанном диапазоне страниц. Он поддерживает изменение следующих свойств аннотацииИзменено Название Содержание Цвет Тема и Открыть.
type: docs
weight: 110
...
Изменяет аннотации указанного типа в указанном диапазоне страниц. Он поддерживает изменение следующих свойств аннотации:Изменено, Название, Содержание, Цвет, Тема и Открыть.
