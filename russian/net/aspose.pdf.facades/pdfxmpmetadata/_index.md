...
| [PdfXmpMetadata](pdfxmpmetadata/#constructor_1)(Document) | Инициализирует новый объект `PdfXmpMetadata` на основе *document*. |

## Свойства

| Имя | Описание |
| --- | --- |
| [Count](../../aspose.pdf.facades/pdfxmpmetadata/count/) { get; } | Возвращает количество элементов в коллекции. |
| [Document](../../aspose.pdf.facades/facade/document/) { get; } | Получает document, с которым работает фасад. |
| [ExtensionFields](../../aspose.pdf.facades/pdfxmpmetadata/extensionfields/) { get; } | Возвращает словарь полей расширения. |
| [IsFixedSize](../../aspose.pdf.facades/pdfxmpmetadata/isfixedsize/) { get; } | Возвращает true, если коллекция имеет фиксированный размер. |
| [IsReadOnly](../../aspose.pdf.facades/pdfxmpmetadata/isreadonly/) { get; } | Возвращает true, если коллекция только для чтения. |
| [IsSynchronized](../../aspose.pdf.facades/pdfxmpmetadata/issynchronized/) { get; } | Возвращает true, если коллекция синхронизирована. |
| [Item](../../aspose.pdf.facades/pdfxmpmetadata/item/) { get; set; } | Получает или задаёт значение по ключу. (2 индексатора) |
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.pdf.facades/pdfxmpmetadata/add/#add_2)(KeyValuePair&lt;string, XmpValue&gt;) | Добавляет пару ключ‑значение в словарь. |
...
| [GetNamespaceURIByPrefix](../../aspose.pdf.facades/pdfxmpmetadata/getnamespaceuribyprefix/)(string) | Получает URI пространства имён по префиксу. |
| [GetPrefixByNamespaceURI](../../aspose.pdf.facades/pdfxmpmetadata/getprefixbynamespaceuri/)(string) | Получает префикс по URI пространства имён. |
| [GetXmpMetadata](../../aspose.pdf.facades/pdfxmpmetadata/getxmpmetadata/#getxmpmetadata)() | Получить XmpMetadata входного pdf в формате xml. |
| [GetXmpMetadata](../../aspose.pdf.facades/pdfxmpmetadata/getxmpmetadata/#getxmpmetadata_1)(string) | Получить часть XmpMetadata входного pdf согласно имени метаданных. |
| [RegisterNamespaceURI](../../aspose.pdf.facades/pdfxmpmetadata/registernamespaceuri/)(string, string) | Регистрирует URI пространства имён. |
...
| [TryGetValue](../../aspose.pdf.facades/pdfxmpmetadata/trygetvalue/)(string, out XmpValue) | Пытается найти ключ в словаре и получает значение, если найдено. |
