...
description: Перемещает начало координат из 0 0 в назначенную точку. Исходная точка слева внизу единица измерения - точка 1 дюйм  72 точки.
type: docs
weight: 170
...
Перемещает начало координат из (0, 0) в назначенную точку. Исходная точка слева внизу, единица измерения - точка (1 дюйм = 72 точки).
