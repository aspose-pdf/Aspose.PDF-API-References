---
title: "Класс PdfAValidateOptions"
second_title: "Справочник API Aspose.PDF для .NET"
description: "Класс Aspose.Pdf.Plugins.PdfAValidateOptions. Представляет параметры для проверки соответствия PDF/A PDF‑документов с плагином PdfAConverter"
type: docs
weight: 9180
...
Представляет параметры для проверки соответствия PDF/A PDF‑документов с плагином [`PdfAConverter`](../pdfaconverter/).
