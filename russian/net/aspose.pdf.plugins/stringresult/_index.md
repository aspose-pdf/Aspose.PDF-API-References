...
| Имя | Описание |
| --- | --- |
| [ToFile](../../aspose.pdf.plugins/stringresult/tofile/)() | Пытается преобразовать результат в файл. |
| [ToStream](../../aspose.pdf.plugins/stringresult/tostream/)() | Пытается преобразовать результат в объект потока. |
| override [ToString](../../aspose.pdf.plugins/stringresult/tostring/)() | Пытается преобразовать результат в строку. |
