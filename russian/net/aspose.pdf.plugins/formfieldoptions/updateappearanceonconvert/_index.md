...
description: Свойство FormFieldOptions. Получает/устанавливает значение, чтобы определить, будет ли созданное/измененное поле обновлять внешний вид при конвертации или нет (если будет установлено).
type: docs
weight: 170
