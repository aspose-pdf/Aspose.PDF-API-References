...
---
## Свойство FormCheckBoxFieldSetOptions.Checked

Получает/устанавливает значение для определения свойства Checked для измененного поля (если будет установлено).
