...
type: docs
weight: 3830
url: /net/aspose.pdf.generator/iboundscheckableitem/
---
...
| Name | Description |
| --- | --- |
| [CheckBounds](../../aspose.pdf.generator/iboundscheckableitem/checkbounds/)(double, double) | Checks if the item fits within the given container dimensions (inclusive). |
