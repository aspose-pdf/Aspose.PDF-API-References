...
| [ComparisonMode](../../aspose.pdf.comparison/sidebysidecomparisonoptions/comparisonmode/) { get; set; } | Gets and sets a comparison mode. The default value is !:SideBySideComparison.ComparisonMode.IgnoreSpaces. |
