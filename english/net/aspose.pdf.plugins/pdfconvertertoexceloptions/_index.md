---
title: Class PdfConverterToExcelOptions
second_title: Aspose.PDF for .NET API Reference
description: Aspose.Pdf.Plugins.PdfConverterToExcelOptions class. Represents PDF to XLSX converter options for PdfConverter plugin
type: docs
weight: 6410
...
| Name | Description |
| --- | --- |
| enum [ExcelFormat](../../aspose.pdf.plugins/pdfconvertertoexceloptions.excelformat) | Allows to specify .xlsx, .xls/xml or csv file format. Default value is XLSX. |
