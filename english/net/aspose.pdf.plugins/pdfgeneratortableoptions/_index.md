---
title: Class PdfGeneratorTableOptions
second_title: Aspose.PDF for .NET API Reference
description: Aspose.Pdf.Plugins.PdfGeneratorTableOptions class. Represents options for add datatable to document by PdfGenerator plugin
type: docs
weight: 6670
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.pdf.plugins/pdfgeneratortableoptions/create/)() | Create instance of `PdfGeneratorTableOptions`. |
