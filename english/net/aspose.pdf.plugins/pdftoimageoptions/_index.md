...
| [DataCollection](../../aspose.pdf.plugins/pdftoimageoptions/datacollection/) { get; } | Returns [`PdfToImage`](../pdftoimage/) plugin data collection. |
...
| [SaveTargetsCollection](../../aspose.pdf.plugins/pdftoimageoptions/savetargetscollection/) { get; } |  |

## Methods

| Name | Description |
| --- | --- |
| [AddDataSource](../../aspose.pdf.plugins/pdftoimageoptions/adddatasource/)(IDataSource) | Adds new data source to the [`PdfToImage`](../pdftoimage/) plugin data collection. |
| [AddSaveDataSource](../../aspose.pdf.plugins/pdftoimageoptions/addsavedatasource/)(IDataSource) | Sets new save data source. Can only be a . If you want save images into memory streams, pass null as parameter. |
