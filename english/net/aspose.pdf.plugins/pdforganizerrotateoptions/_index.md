---
title: Class PdfOrganizerRotateOptions
second_title: Aspose.PDF for .NET API Reference
description: Aspose.Pdf.Plugins.PdfOrganizerRotateOptions class. Represents Rotate options for PdfOrganizer plugin
type: docs
weight: 6760
...
Represents Rotate options for [`PdfOrganizer`](../pdforganizer/) plugin.

```csharp
public sealed class PdfOrganizerRotateOptions : PdfOrganizerOptions
```
...
| [Rotation](../../aspose.pdf.plugins/pdforganizerrotateoptions/rotation/) { get; set; } | Gets or sets new pages rotation. |
