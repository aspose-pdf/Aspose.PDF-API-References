...
description: Aspose.Pdf.Plugins.PdfAConvertOptions class. Represents options for converting PDF documents to PDF/A format with the PdfAConverter plugin
type: docs
weight: 6810
url: /net/aspose.pdf.plugins/pdfaconvertoptions/
---
...
| [Outputs](../../aspose.pdf.plugins/pdfaconvertoptions/outputs/) { get; } | Gets the collection of added targets (file or stream data sources) for saving operation results. |
...
| [AddOutput](../../aspose.pdf.plugins/pdfaconvertoptions/addoutput/)(IDataSource) | Adds new result save target. |
