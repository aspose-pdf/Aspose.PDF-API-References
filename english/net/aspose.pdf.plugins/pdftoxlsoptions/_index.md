...
description: Aspose.Pdf.Plugins.PdfToXlsOptions class. Represents PDF to XLSX converter options for PdfXls plugin
type: docs
weight: 6990
...
Represents PDF to XLSX converter options for [`PdfXls`](../pdfxls/) plugin.
