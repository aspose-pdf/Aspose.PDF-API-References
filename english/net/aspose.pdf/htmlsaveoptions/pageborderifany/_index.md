...
description: This attribute represents set of settings used for drawing border if any in result HTML document around area that represent source PDF page. In essence it concerns of showing of pages paper edges not page border referenced in PDF page itself.
type: docs
weight: 320
