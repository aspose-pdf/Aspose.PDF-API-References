...
| Name | Description |
| --- | --- |
| [FloatingBox](floatingbox#constructor)() | Initializes a new instance of the [`FloatingBox`](../floatingbox) class. |
| [FloatingBox](floatingbox#constructor_1)(float, float) | Initializes a new instance of the [`FloatingBox`](../floatingbox) class with specified width and height. |
...
| Name | Description |
| --- | --- |
| override [Clone](../../aspose.pdf/floatingbox/clone)() | Clones a new [`FloatingBox`](../floatingbox) object. Paragraphs in the floating box are not cloned. |
