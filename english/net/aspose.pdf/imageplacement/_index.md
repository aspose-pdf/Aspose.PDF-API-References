...
When an image is placed to a page it may have dimensions other than physical dimensions defined in [`Resources`](../resources). The object [`ImagePlacement`](../imageplacement) is intended to provide such information like dimensions, resolution and so on.
