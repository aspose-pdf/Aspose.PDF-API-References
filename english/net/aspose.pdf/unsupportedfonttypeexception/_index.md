...
description: Aspose.Pdf.UnsupportedFontTypeException class. The exception that is thrown when a font type is not supported
type: docs
weight: 8240
...
| Name | Description |
| --- | --- |
| [UnsupportedFontTypeException](unsupportedfonttypeexception/#constructor)(Exception) | Initializes a new instance of the `UnsupportedFontTypeException` class with a specified error message and a reference to the inner exception that is the cause of this exception. |
