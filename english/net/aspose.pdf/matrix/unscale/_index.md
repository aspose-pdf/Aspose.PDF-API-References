...
description: Scales back x1 and y1 and returns x and y before the matrix transformation using the following formula x  D  x1 - C  y1 / A  D - C  B y  A y1 - B x1 / A D - C B
type: docs
weight: 200
