...
description: SvgLoadOptions property. Gets or sets page info that should be applied during loading of document. NOTE that this parameter only works when ConversionEngine  ConversionEngines.NewEngine
type: docs
weight: 30
