...
description: HtmlImageSavingInfo field. Represents type of saved image referenced in HTML. Set by converter and can be used in custom code to decide what should be done
type: docs
weight: 30
