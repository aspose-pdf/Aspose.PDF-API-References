...
description: Certify the document with the MDP signature. Such data as signature reason contact and location must be provided by corresponding properties of the Signature object sig.
type: docs
weight: 70
