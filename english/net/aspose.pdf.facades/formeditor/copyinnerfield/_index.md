...
description: Copies an existing field to the same position in specified page number. A new document will be produced which contains everything the source document has except for the newly copied field.
type: docs
weight: 150
