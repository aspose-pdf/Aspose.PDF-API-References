...
description: Get or sets zoom coefficient. Value 1.0 corresponds to 100. Default value is 1.0.  The following example demonstrates how to change zoom of the document pages.
type: docs
weight: 110
