...
| Name | Description |
| --- | --- |
| [BaselinePosition](../../aspose.pdf.text/textsegment/baselineposition) { get; set; } | Gets text position for text, represented with [`TextSegment`](../textsegment) object. The YIndent of the Position structure represents baseline coordinate of the text segment. |
...
| [Position](../../aspose.pdf.text/textsegment/position) { get; set; } | Gets text position for text, represented with [`TextSegment`](../textsegment) object. |
...
| [Text](../../aspose.pdf.text/textsegment/text) { get; set; } | Gets or sets String text object that the [`TextSegment`](../textsegment) object represents. |
...
| [TextState](../../aspose.pdf.text/textsegment/textstate) { get; set; } | Gets or sets text state for the text that [`TextSegment`](../textsegment) object represents. |
