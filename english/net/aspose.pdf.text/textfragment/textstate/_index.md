...
description: Gets or sets text state for the text that TextFragmentaspose.pdf.text/textfragment object represents.
type: docs
weight: 140
...
Gets or sets text state for the text that [`TextFragment`](../../textfragment) object represents.
