...
Font collections represented by [`FontCollection`](../fontcollection) class are used in several scenarios. For example, in resources with [`Fonts`](../../aspose.pdf/resources/fonts) property.
