...
description: Collection of not empty TextFragmentaspose.pdf.text/textfragment objects that are inside the section.
type: docs
weight: 10
...
Collection of not empty [`TextFragment`](../../textfragment) objects that are inside the section.
