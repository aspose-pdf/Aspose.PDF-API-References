...
| Name | Description |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) |  |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) |  |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption) { get; } |  |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } |  |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs) { get; set; } |  |
...
| [MaxLen](../../aspose.pdf.forms/textboxfield/maxlen) { get; set; } |  |
| [Modified](../../aspose.pdf.annotations/annotation/modified) { get; set; } |  |
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline) { get; set; } |  |
...
| override [PageIndex](../../aspose.pdf.forms/field/pageindex) { get; } |  |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution) { get; } |  |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable) { get; set; } |  |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck) { get; set; } |  |
| [States](../../aspose.pdf.annotations/annotation/states) { get; } |  |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } |  |
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment) { get; set; } |  |
| override [Value](../../aspose.pdf.forms/textboxfield/value) { get; set; } |  |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight) { get; } |  |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth) { get; } |  |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode)(string) |  |
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage)(Image) |  |
...
| virtual [SetPosition](../../aspose.pdf.forms/field/setposition)(Point) |  |
