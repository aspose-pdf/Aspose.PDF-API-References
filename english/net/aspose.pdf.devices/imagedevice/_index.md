...
| Name | Description |
| --- | --- |
| [ImageDevice](imagedevice#constructor)() | Abstract initializer for [`ImageDevice`](../imagedevice) descendants, set resolution to 150x150. |
...
| [ImageDevice](imagedevice#constructor_1)(Resolution) | Abstract initializer for [`ImageDevice`](../imagedevice) descendants.  Resolution for the result image file, see [`Resolution`](./resolution) class. |
