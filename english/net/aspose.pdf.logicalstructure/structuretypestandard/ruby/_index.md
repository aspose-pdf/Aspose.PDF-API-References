...
description: Ruby PDF 1.5 A side-note annotation written in a smaller text size and placed adjacent to the base text to which it refers. A Ruby element may also contain the RB RT and RP elements.
type: docs
weight: 350
