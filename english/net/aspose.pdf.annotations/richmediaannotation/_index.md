...
| Name | Description |
| --- | --- |
| enum [ActivationEvent](richmediaannotation.activationevent) | Event which activates annotation. |
| enum [ContentType](richmediaannotation.contenttype) | Type of the multimedia. |
