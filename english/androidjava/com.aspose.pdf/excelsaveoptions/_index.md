...
| [getScaleFactor()](#getScaleFactor--) | Gets or sets factor that will be applied to (virtual) scaling font size during conversion to Excel table in legacy engine. |
| [setScaleFactor(double value)](#setScaleFactor-double-) | Gets or sets factor that will be applied to (virtual) scaling font size during conversion to Excel table in legacy engine. |
