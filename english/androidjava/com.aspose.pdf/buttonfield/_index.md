...
| [getICPosition()](#getICPosition--) | Gets or sets icon caption position. |
| [setICPosition(int value)](#setICPosition-int-) | Sets icon caption position. |
| [addImage(Bitmap bitmap)](#addImage-android.graphics.Bitmap-) |  |
| [addImage(BufferedImage image)](#addImage-com.aspose.pdf.java.awt.image.BufferedImage-) | Adds image into the field resources an draws it. |
| [addImage(BufferedImage image, boolean fillArea)](#addImage-com.aspose.pdf.java.awt.image.BufferedImage-boolean-) | Adds image into the field resources an draws it. |
...
### addImage(BufferedImage image) {#addImage-com.aspose.pdf.java.awt.image.BufferedImage-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| image | [BufferedImage](../../com.aspose.pdf.java.awt.image/bufferedimage) | Image ot add into text field. |

### addImage(BufferedImage image, boolean fillArea) {#addImage-com.aspose.pdf.java.awt.image.BufferedImage-boolean-}
```
