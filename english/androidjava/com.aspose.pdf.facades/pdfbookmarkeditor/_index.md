...
| [createBookmarks(Color color, boolean boldFlag, boolean italicFlag)](#createBookmarks-com.aspose.pdf.java.awt.Color-boolean-boolean-) | Create bookmarks for all pages with specified color and style (bold, italic). |
...
### createBookmarks(Color color, boolean boldFlag, boolean italicFlag) {#createBookmarks-com.aspose.pdf.java.awt.Color-boolean-boolean-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| color | [Color](../../com.aspose.pdf.java.awt/color) | The color of title. |
...
**Returns:**
[Bookmarks](../../com.aspose.pdf.facades/bookmarks) - Bookmark collection has items with the same title.
