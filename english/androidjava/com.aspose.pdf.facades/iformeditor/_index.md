...
| [setConvertTo(int value)](#setConvertTo-int-) | Sets [PdfFormat](../../com.aspose.pdf/pdfformat) PDF file format. |
...
| [getItems()](#getItems--) |  |
| [setItems(String[] value)](#setItems-java.lang.String---) | Sets items which will be added t onewly created list box or combo box. |
...
> ```
> FormEditor editor = new FormEditor();
>  editor.setSrcStream(new FileInputStream("InFile.pdf", FileMode.Open, FileAccess.Read));
> ```
...
> ```
> FormEditor editor = new FormEditor();
>  editor.setDestStream ( new FileInputStream("OutFile.pdf", FileMode.Create, FileAccess.Write));
> ```
