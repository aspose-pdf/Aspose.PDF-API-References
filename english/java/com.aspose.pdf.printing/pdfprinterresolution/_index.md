---
title: PdfPrinterResolution
linktitle: PdfPrinterResolution
...
---
**Inheritance:**
java.lang.Object, com.aspose.pdf.printing.PdfPrinterResolution
...
| --- | --- |
| [PdfPrinterResolution](#PdfPrinterResolution--) | Initializes a new instance of the PrinterResolution class. |

## Methods

| Method | Description |
| --- | --- |
| [getKind](#getKind--) | sets the printer resolution. |
...
| [setKind](#setKind-int-) | Gets or sets the printer resolution. |
| [setX](#setX-int-) | Sets the horizontal printer resolution, in dots per inch. |
| [setY](#setY-int-) | Sets the vertical printer resolution, in dots per inch. |

### PdfPrinterResolution {#PdfPrinterResolution--}
```
...
**Returns:**
PdfPrinterResolutionKind element @see PdfPrinterResolutionKind
...
| --- | --- | --- |
| value |  | PdfPrinterResolutionKind element @see PdfPrinterResolutionKind |
