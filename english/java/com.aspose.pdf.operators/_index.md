...
| [MoveTo](./moveto/) | Class representing {@code operators.m} (move to and begin new subpath). |
| [MoveToNextLine](./movetonextline/) | Class representing T* operator (Move to start of the next line). |
| [MoveToNextLineShowText](./movetonextlineshowtext/) | Class representing ' operator (move to the next line and show text). |
...
| [SetFlat](./setflat/) | Class representing i operator (set flatness toleracne). |
...
| [SetLineJoin](./setlinejoin/) | Class representing j operator (set line join style). @see LineJoin |
...
| [SetTextMatrix](./settextmatrix/) | Class representig Tm operator (set text matrix). |
