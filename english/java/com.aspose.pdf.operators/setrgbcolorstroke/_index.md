...
| --- | --- |
| [SetRGBColorStroke](#SetRGBColorStroke-java.awt.Color-) | Initializes operator with color. |
| [SetRGBColorStroke](#SetRGBColorStroke-double-double-double-) | Constructor for writing program. |
| [SetRGBColorStroke](#SetRGBColorStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.color.SetRGBStrokingColor-) | Constructor for operator class. |
