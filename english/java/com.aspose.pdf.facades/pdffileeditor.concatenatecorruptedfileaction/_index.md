...
| Field | Description |
| --- | --- |
| [ConcatenateIgnoringCorrupted](#ConcatenateIgnoringCorrupted) | If corrupted file was met, then don't stop concatenation and don't process corrupted file. List of corrupted files is accessible in Failures property. |
