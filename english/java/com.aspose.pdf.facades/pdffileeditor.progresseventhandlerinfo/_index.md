...
---
**Inheritance:**
java.lang.Object, com.aspose.pdf.facades.PdfFileEditor.ProgressEventHandlerInfo
...
| [setDocumentNumber](#setDocumentNumber-int-) | Progress for document with number |
| [setEventType](#setEventType-int-) | Type of progress event that occurred |
...
### setDocumentNumber {#setDocumentNumber-int-}
```
