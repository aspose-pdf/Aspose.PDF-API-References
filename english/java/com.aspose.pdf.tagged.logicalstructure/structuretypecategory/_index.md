...
| [IllustrationElements](#IllustrationElements) | Illustration elements are compact sequences of content, in page content order, that are considered to be unitary objects with respect to page layout. An illustration can be treated as either a BLSE or an ILSE. |
...
| Method | Description |
| --- | --- |
| [to_StructureTypeCategory](#to_StructureTypeCategory-java.lang.String-) | Performs an explicit conversion from {@link String} to {@link StructureTypeCategory}. |
...
Performs an explicit conversion from {@link String} to {@link StructureTypeCategory}.
