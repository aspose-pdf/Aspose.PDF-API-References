...
| --- | --- |
| [TextEncodingInternal](#TextEncodingInternal-com.aspose.ms.System.Text.Encoding-) | Internal constructor |
...
| [getBigEndianUnicode](#getBigEndianUnicode--) | Gets an encoding for the UTF-16 format that uses the big endian byte order. |
| [getDefault](#getDefault--) | Gets an encoding for the operating system's current ANSI code page. |
| [getEncoding](#getEncoding-java.lang.String-) | Returns the encoding associated with the specified code page name. |
| [getInternalFormat](#getInternalFormat--) | Internal method |
| [getNames](#getNames--) | Gets an array with encoding names. |
| [getString](#getString-byte:A-) | When overridden in a derived class, decodes all the bytes in the specified byte array into a string. |
| [getUnicode](#getUnicode--) | Gets an encoding for the UTF-16 format using the little endian byte order. |
| [getUTF32](#getUTF32--) | Gets an encoding for the UTF-32 format using the little endian byte order. |
| [getUTF32BE](#getUTF32BE--) | Gets an encoding for the UTF-16 format that uses the big endian byte order. |
| [getUTF7](#getUTF7--) | Gets an encoding for the UTF-7 format. |
| [getUTF8](#getUTF8--) | Gets an encoding for the UTF-8 format. |
| [getUTF8Unmarked](#getUTF8Unmarked--) | Gets an encoding for the UTF-8 Unmarked format. |
| [toString](#toString-com.aspose.pdf.TextEncodingInternal-) | Returns a string that represents the current object. |
