...
| --- | --- |
| [TocInfo](#TocInfo--) | Initializes a new instance of the {@code TocInfo} class. |
...
| [setColumnInfo](#setColumnInfo-com.aspose.pdf.ColumnInfo-) | Sets column info. |
| [setCopyToOutlines](#setCopyToOutlines-boolean-) | Gets or sets is TOC copied to outlines. |
| [setCountTocPages](#setCountTocPages-boolean-) | Sets is count or passed toc pages. |
| [setFormatArray](#setFormatArray-com.aspose.pdf.LevelFormat:A-) | Sets format array for table of contents. |
| [setFormatArrayLength](#setFormatArrayLength-int-) | Sets format array length |
| [setLevelIndentation](#setLevelIndentation-int-) | Set Level indentation |
| [setLineDash](#setLineDash-int-) | Gets or sets TOC line dash. |
| [setPageNumbersPrefix](#setPageNumbersPrefix-java.lang.String-) | Sets is prefix before page number. |
| [setShowPageNumbers](#setShowPageNumbers-boolean-) | Sets is show page numbers at Toc. |
| [setTitle](#setTitle-com.aspose.pdf.TextFragment-) | Sets table of contents title. |
...
Initializes a new instance of the {@code TocInfo} class.
