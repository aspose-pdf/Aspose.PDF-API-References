...
| Field | Description |
| --- | --- |
| [Default](#Default) | Represents the Default color. |
...
| [equals](#equals-java.lang.Object-) | Returns true if two Colors are equal. |
...
| [fromRgb](#fromRgb-java.awt.Color-) | Gets valid pdf Color object from java.awt.Color value. |
...
| [getPatternColorSpace](#getPatternColorSpace--) | Gets a object that indicates the pattern colorspace. Internal usage only |
...
| [op_Equality](#op_Equality-com.aspose.pdf.Color-com.aspose.pdf.Color-) | Returns true if two Colors are equal. |
| [op_Inequality](#op_Inequality-com.aspose.pdf.Color-com.aspose.pdf.Color-) | Returns true if two Colors are not equal. |
| [parse](#parse-java.lang.String-) | Extracts color components from the string. |
| [setPatternColorSpace](#setPatternColorSpace-com.aspose.pdf.drawing.PatternColorSpace-) | Sets a object that indicates the pattern colorspace. Internal usage only |
...
Gets a object that indicates the pattern colorspace. Internal usage only
...
Sets a object that indicates the pattern colorspace. Internal usage only
