...
| [save(System.IO.Stream output)](#save-com.aspose.ms.System.IO.Stream-) | For internal usage only |
...
| [setAbsentFontTryToSubstitute(boolean substitute)](#setAbsentFontTryToSubstitute-boolean-) | Setting the flag to replace the missing font. |
...
**Returns:**
boolean - boolean value True - if document repaired; otherwise, false.
### close() {#close--}
```
public void close()
```
...
**Returns:**
[PdfFormat](../../com.aspose.pdf/pdfformat) - PdfFormat
...
| Parameter | Type | Description |
| --- | --- | --- |
| output | com.aspose.ms.System.IO.Stream | For internal usage only |
