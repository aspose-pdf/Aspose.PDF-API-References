...
---
**Inheritance:**
java.lang.Object, java.lang.Enum < LoadFormat > com.aspose.pdf.LoadFormat, java.lang.Enum < LoadFormat >, com.aspose.pdf.LoadFormat

**All Implemented Interfaces:**
Serializable, Comparable < LoadFormat >
...
| [CDR](#CDR) | means loading document in CDR format. |
| [CGM](#CGM) | means loading of document in CGM format |
| [DJVU](#DJVU) | means loading document in Djvu format. |
...
| [OFD](#OFD) | means loading document in OFD format. |
...
| [RTF](#RTF) | means loading document in RTF format. |
...
### CDR {#CDR}
```
public static final LoadFormat CDR
```
...
### DJVU {#DJVU}
```
public static final LoadFormat DJVU
```
...
### OFD {#OFD}
```
public static final LoadFormat OFD
```
...
### RTF {#RTF}
```
public static final LoadFormat RTF
```

means loading document in RTF format.
