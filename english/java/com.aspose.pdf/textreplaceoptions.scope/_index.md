...
| Field | Description |
| --- | --- |
| [REPLACE_ALL](#REPLACE_ALL) | Replace all text occurrences on all affected pages |
| [REPLACE_FIRST](#REPLACE_FIRST) | Replace only first occurrence of the text on each of affected pages |
