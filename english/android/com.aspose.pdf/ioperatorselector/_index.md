...
```
public abstract void visit(Operator.Fill f)
```
...
```
public abstract void visit(Operator.ObsoleteFill F)
```
...
```
public abstract void visit(Operator.EOFill f_)
```
...
```
public abstract void visit(Operator.SetGrayStroke G)
```
...
```
public abstract void visit(Operator.SetGray g)
```
...
```
public abstract void visit(Operator.GS gs)
```
...
```
public abstract void visit(Operator.ClosePath h)
```
...
```
public abstract void visit(Operator.SetFlat i)
```
...
```
public abstract void visit(Operator.ID ID)
```
...
```
public abstract void visit(Operator.SetColorRenderingIntent ri)
```
...
```
public abstract void visit(Operator.SetLineCap J)
```
...
```
public abstract void visit(Operator.SetMiterLimit M)
```
...
```
public abstract void visit(Operator.MP MP)
```
...
```
public abstract void visit(Operator.EndPath n)
```
...
```
public abstract void visit(Operator.GSave q)
```
...
```
public abstract void visit(Operator.GRestore Q)
```
...
```
public abstract void visit(Operator.Re re)
```
...
```
public abstract void visit(Operator.SetRGBColorStroke RG)
```
...
```
public abstract void visit(Operator.SetRGBColor rg)
```
...
```
public abstract void visit(Operator.SetCMYKColorStroke K)
```
...
```
public abstract void visit(Operator.SetCMYKColor k)
```
...
```
public abstract void visit(Operator.LineTo l)
```
...
```
public abstract void visit(Operator.MoveTo m)
```
...
```
public abstract void visit(Operator.SetWordSpacing Tw)
```
...
```
public abstract void visit(Operator.ClosePathStroke s)
```
...
```
public abstract void visit(Operator.MoveTextPositionSetLeading TD)
```
...
```
public abstract void visit(Operator.SelectFont Tf)
```
...
```
public abstract void visit(Operator.ShowText Tj)
```
...
```
public abstract void visit(Operator.SetGlyphsPositionShowText TJ)
```
...
```
public abstract void visit(Operator.SetTextLeading TL)
```
...
```
public abstract void visit(Operator.SetTextMatrix Tm)
```
...
```
public abstract void visit(Operator.SetTextRenderingMode Tr)
```
...
```
public abstract void visit(Operator.SetTextRise Ts)
```
...
```
public abstract void visit(Operator.Stroke S)
```
...
```
public abstract void visit(Operator.SetColorStroke SC)
```
...
```
public abstract void visit(Operator.SetColor sc)
```
...
```
public abstract void visit(Operator.SetAdvancedColorStroke SCN)
```
...
```
public abstract void visit(Operator.SetAdvancedColor scn)
```
...
```
public abstract void visit(Operator.ShFill sh)
```
...
```
public abstract void visit(Operator.MoveToNextLine T_)
```
...
```
public abstract void visit(Operator.SetCharacterSpacing Tc)
```
...
```
public abstract void visit(Operator.MoveTextPosition Td)
```
...
```
public abstract void visit(Operator.CurveTo2 y)
```
...
```
public abstract void visit(Operator.EOClip W_)
```
...
```
public abstract void visit(Operator.SetHorizontalTextScaling Tz)
```
...
```
public abstract void visit(Operator.CurveTo1 v)
```
...
```
public abstract void visit(Operator.Clip W)
```
...
```
public abstract void visit(Operator.SetLineWidth w)
```
...
```
public abstract void visit(Operator.SetLineJoin j)
```
...
```
public abstract void visit(Operator.EX EX)
```
...
```
public abstract void visit(Operator.ET ET)
```
...
```
public abstract void visit(Operator.EMC EMC)
```
...
```
public abstract void visit(Operator.EI EI)
```
...
```
public abstract void visit(Operator.DP DP)
```
...
```
public abstract void visit(Operator.Do Do)
```
...
```
public abstract void visit(Operator.SetDash d)
```
...
```
public abstract void visit(Operator.SetCharWidth d0)
```
...
```
public abstract void visit(Operator.SetCharWidthBoundingBox d1)
```
...
```
public abstract void visit(Operator.SetColorSpaceStroke CS)
```
...
```
public abstract void visit(Operator.SetColorSpace cs)
```
...
```
public abstract void visit(Operator.ConcatenateMatrix cm)
```
...
```
public abstract void visit(Operator.CurveTo c)
```
...
```
public abstract void visit(Operator.BX BX)
```
...
```
public abstract void visit(Operator.BT BT)
```
...
```
public abstract void visit(Operator.BMC BMC)
```
...
```
public abstract void visit(Operator.BI BI)
```
...
```
public abstract void visit(Operator.BDC BDC)
```
...
```
public abstract void visit(Operator.FillStroke B)
```
...
```
public abstract void visit(Operator.ClosePathFillStroke b)
```
...
```
public abstract void visit(Operator.EOFillStroke B_)
```
...
```
public abstract void visit(Operator.ClosePathEOFillStroke b_)
```
...
```
public abstract void visit(Operator.MoveToNextLineShowText nextLineShowText)
```
...
```
public abstract void visit(Operator.SetSpacingMoveToNextLineShowText nextLineShowText)
```
...
```
public abstract void visit(Operator.TextOperator textOperator)
```
