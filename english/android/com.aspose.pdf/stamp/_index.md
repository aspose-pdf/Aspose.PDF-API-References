...
| Method | Description |
| --- | --- |
| [getBackground()](#getBackground--) | Gets a bool value that indicates the content is stamped as background. |
...
| [getRotate()](#getRotate--) | Sets or gets the rotation of stamp content according  Rotation  values. |
...
| [getZoomX()](#getZoomX--) | Horizontal zooming factor of the stamp. |
| [setZoomX(double value)](#setZoomX-double-) | Horizontal zooming factor of the stamp. |
...
| [getZoomY()](#getZoomY--) | Vertical zooming factor of the stamp. |
| [setZoomY(double value)](#setZoomY-double-) |  |
| [getZoom()](#getZoom--) | Zooming factor of the stamp. |
