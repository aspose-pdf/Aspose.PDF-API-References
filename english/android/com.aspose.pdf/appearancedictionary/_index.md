...
| [contains(Object key)](#contains-java.lang.Object-) | Determines whether dictionary contains an element with the specified key. |
| [removeItemInternal(Object key)](#removeItemInternal-java.lang.Object-) | Removes the element with the specified key. |
...
| [iterator_internal()](#iterator-internal--) | Returns an IDictionaryEnumerator object for the dictionary. |
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Copies the elements of the dictionary to an Array, starting at a particular Array index. |
...
| [get(Object key)](#get-java.lang.Object-) | Represents convenient form for getting appearance streams. |
| [set(Object key, XForm value)](#set-java.lang.Object-com.aspose.pdf.XForm-) | Represents convenient form for setting appearance streams. |
...
| [getValues_Rename_Namesake()](#getValues-Rename-Namesake--) | Gets collection of values in the dictionary. |
...
**Returns:**
com.aspose.ms.System.Collections.Generic.List<java.lang.String> - List of String values
### getKeys_() {#getKeys---}
```
...
### getValues() {#getValues--}
```
public System.Collections.Generic.List<XForm> getValues()
```
...
**Returns:**
com.aspose.ms.System.Collections.Generic.List<com.aspose.pdf.XForm> - List of XForm values
...
**Returns:**
int - int value
### contains(Object key) {#contains-java.lang.Object-}
```
...
| --- | --- | --- |
| key | java.lang.Object | Key to test does it belongs to dictionary. |

**Returns:**
boolean - true if the key found in the dictionary and false otherwise.
### removeItemInternal(Object key) {#removeItemInternal-java.lang.Object-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| key | java.lang.Object | Key which should be deleted. |
...
### iterator_internal() {#iterator-internal--}
```
public AppearanceDictionary.AppearanceDictionaryEnumerator iterator_internal()
```
...
**Returns:**
com.aspose.pdf.AppearanceDictionary.AppearanceDictionaryEnumerator - Enumerator of the dictionary.
...
| Parameter | Type | Description |
| --- | --- | --- |
| array | com.aspose.ms.System.Array | Array where items must be copied. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| key | java.lang.Object | Represents path to appearance stream. If appearance dictionary has subdictionaries, then path must contain 2 parts ( Keys ), else path has only one part. |

**Returns:**
[XForm](../../com.aspose.pdf/xform) - XForm object (appearance stream) which corresponds to the given key.
### set(Object key, XForm value) {#set-java.lang.Object-com.aspose.pdf.XForm-}
```
public void set(Object key, XForm value)
```
...
| --- | --- | --- |
| key | java.lang.Object | Represents path to appearance stream. If appearance dictionary has subdictionaries, then path must contain 2 parts ( Keys ), else path has only one part. |
| value | [XForm](../../com.aspose.pdf/xform) | XForm object (appearance stream) which corresponds to the given key. |
...
### getValues_Rename_Namesake() {#getValues-Rename-Namesake--}
```
public System.Collections.Generic.IGenericCollection<XForm> getValues_Rename_Namesake()
```


Gets collection of values in the dictionary.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<com.aspose.pdf.XForm> -  IDictionary  object
...
```
public System.Collections.Generic.IGenericEnumerator<System.Collections.Generic.KeyValuePair<String,IPdfPrimitive>> iterator__Rename_Namesake()
```
...
**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.ms.System.Collections.Generic.KeyValuePair<java.lang.String,com.aspose.pdf.engine.data.IPdfPrimitive>> - enumerator of the collection items.
