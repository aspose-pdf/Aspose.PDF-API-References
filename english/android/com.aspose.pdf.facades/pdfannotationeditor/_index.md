...
| [importAnnotationFromXfdf(String xfdfFile, int[] annotType)](#importAnnotationFromXfdf-java.lang.String-int---) | Imports the specified annotations from XFDF file. |
| [importAnnotationFromXfdf(System.IO.Stream xfdfSteam, int[] annotType)](#importAnnotationFromXfdf-com.aspose.ms.System.IO.Stream-int---) | Imports the specified annotations from XFDF data stream. |
| [importAnnotationFromXfdf(System.IO.Stream xfdfSteam)](#importAnnotationFromXfdf-com.aspose.ms.System.IO.Stream-) | Imports all annotations from XFDF data stream. |
...
| [importAnnotations(System.IO.Stream[] annotFileInputStream, int[] annotType)](#importAnnotations-com.aspose.ms.System.IO.Stream---int---) | Imports the specified annotations into document from array of another PDF document streams. |
| [importAnnotations(System.IO.Stream[] annotFileInputStream)](#importAnnotations-com.aspose.ms.System.IO.Stream---) | Imports annotations into document from array of another PDF document streams. |
| [modifyAnnotations(int start, int end, System.Enum annotType, Annotation annotation)](#modifyAnnotations-int-int-com.aspose.ms.System.Enum-com.aspose.pdf.Annotation-) | Modifies the annotations of the specifed type on the specified page range. |
...
| [exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, String[] annotTypes)](#exportAnnotationsXfdf-com.aspose.ms.System.IO.Stream-int-int-java.lang.String---) | Exports the content of the specified annotation types into XFDF |
| [exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, int[] annotTypes)](#exportAnnotationsXfdf-com.aspose.ms.System.IO.Stream-int-int-int---) | Exports the content of the specified annotation types into XFDF |
...
### importAnnotationFromXfdf(String xfdfFile, int[] annotType) {#importAnnotationFromXfdf-java.lang.String-int---}
```
...
### importAnnotationFromXfdf(System.IO.Stream xfdfSteam, int[] annotType) {#importAnnotationFromXfdf-com.aspose.ms.System.IO.Stream-int---}
```
public void importAnnotationFromXfdf(System.IO.Stream xfdfSteam, int[] annotType)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| xfdfSteam | com.aspose.ms.System.IO.Stream | The input XFDF data stream. |
| annotType | int[] | The array of annotation types to be imported. |

### importAnnotationFromXfdf(System.IO.Stream xfdfSteam) {#importAnnotationFromXfdf-com.aspose.ms.System.IO.Stream-}
```
public void importAnnotationFromXfdf(System.IO.Stream xfdfSteam)
```
...
### importAnnotations(System.IO.Stream[] annotFileInputStream, int[] annotType) {#importAnnotations-com.aspose.ms.System.IO.Stream---int---}
```
public void importAnnotations(System.IO.Stream[] annotFileInputStream, int[] annotType)
```
...
> PdfAnnotationEditor editor = new PdfAnnotationEditor();
>  editor.bindPdf("example.pdf");
>  Stream[] streams = new FileInputStream[2];
...
| Parameter | Type | Description |
| --- | --- | --- |
| annotFileInputStream | com.aspose.ms.System.IO.Stream[] | The array of streams of PDF documents that contain source annotations. |
| annotType | int[] | The annotation types to be imported. |

### importAnnotations(System.IO.Stream[] annotFileInputStream) {#importAnnotations-com.aspose.ms.System.IO.Stream---}
```
public void importAnnotations(System.IO.Stream[] annotFileInputStream)
```
...
### modifyAnnotations(int start, int end, System.Enum annotType, Annotation annotation) {#modifyAnnotations-int-int-com.aspose.ms.System.Enum-com.aspose.pdf.Annotation-}
```
public void modifyAnnotations(int start, int end, System.Enum annotType, Annotation annotation)
```
...
>  annot.setModified ( DateTime.Now)
...
| annotType | com.aspose.ms.System.Enum | The annotation type. |
...
### exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, String[] annotTypes) {#exportAnnotationsXfdf-com.aspose.ms.System.IO.Stream-int-int-java.lang.String---}
```
public void exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, String[] annotTypes)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| xmlOutputStream | com.aspose.ms.System.IO.Stream | The output XFDF stream. |
...
### exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, int[] annotTypes) {#exportAnnotationsXfdf-com.aspose.ms.System.IO.Stream-int-int-int---}
```
public void exportAnnotationsXfdf(System.IO.Stream xmlOutputStream, int start, int end, int[] annotTypes)
```
...
```
public System.Collections.IList extractAnnotations(int start, int end, String[] annotTypes)
```
...
**Returns:**
com.aspose.ms.System.Collections.IList - Annotations list.
### extractAnnotations(int start, int end, int[] annotTypes) {#extractAnnotations-int-int-int---}
```
public System.Collections.IList extractAnnotations(int start, int end, int[] annotTypes)
```
