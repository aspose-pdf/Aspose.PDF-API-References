...
| [isEncrypted()](#isEncrypted--) | Checkes whether the PDF document is encrypted. |
| [isPdfFile()](#isPdfFile--) | Checkes whether the source input is a valid PDF file. |
...
| [getHeader()](#getHeader--) | Gets or sets the customized information of PDF document. |
| [setHeader(Map value)](#setHeader-java.util.Map-) | Gets or sets the customized information of PDF document. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| srcDoc | [Document](../../com.aspose.pdf/document) | The Aspose.Pdf.Document object. |
...
**Returns:**
java.util.Map
### setHeader(Map value) {#setHeader-java.util.Map-}
```
