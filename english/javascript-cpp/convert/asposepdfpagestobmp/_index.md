...
type: docs
url: /javascript-cpp/convert/asposepdfpagestobmp/
---
...
**Parameters**: 
  ...
  * **fileName** file name 
  * **fileResultName** result file name template (for sample: "ResultPdfToBmp{0:D2}.bmp" where {0}, {0:D2}, {0:D3}, {0:Dn} - format page number) 
