...
```cpp
void Aspose::Pdf::Devices::BmpDevice::Process(const System::SharedPtr<Page> &page, const System::SharedPtr<System::IO::Stream> &output) override
```
...
| output | const System::SharedPtr\<System::IO::Stream\>\& | Output stream with bmp image. |
