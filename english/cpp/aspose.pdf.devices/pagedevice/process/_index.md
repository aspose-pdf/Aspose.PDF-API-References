...
---
## PageDevice::Process(const System::SharedPtr\<Page\>\&, const System::SharedPtr\<System::IO::Stream\>\&) method


Perfoms some operation on the given page, e.g. converts page into graphic image.

```cpp
virtual void Aspose::Pdf::Devices::PageDevice::Process(const System::SharedPtr<Page> &page, const System::SharedPtr<System::IO::Stream> &output)=0
```
