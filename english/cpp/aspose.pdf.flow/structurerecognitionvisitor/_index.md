...
| virtual [Recognize](./recognize/)(const System::SharedPtr\<Document\>\&) | Start recognition of document. |
| virtual [Recognize](./recognize/)(const System::SharedPtr\<Page\>\&) | Start recognition of page. |
| [StartDocument](./startdocument/)() override | Called when the document traversal starts. |
| [VisitParagraph](./visitparagraph/)(const System::SharedPtr\<BaseParagraph\>\&) override | Called when a paragraph node is visited. |
| [VisitSectionEnd](./visitsectionend/)(const System::SharedPtr\<MarginInfo\>\&) override | Visits the end of a recognized section in the document. |
| [VisitTable](./visittable/)(const System::SharedPtr\<Table\>\&) override | Visits a recognized table in the document structure. |
## See Also
