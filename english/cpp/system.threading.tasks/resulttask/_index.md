...
| Method | Description |
| --- | --- |
| [Complete](./complete/)(const T\&) | Sets the result value for the task and completes it. |
...
| [ContinueWith](./continuewith/)(const Func\<RTaskPtr\<T\>, TNewResult\>\&) | Creates a continuation that executes when the result task completes. |
