...
| Method | Description |
| --- | --- |
| [Activate](./activate/)(const SharedPtr\<TaskScheduler\>\&) | Activates the task for execution on a scheduler. |
| [AddCompletionAction](./addcompletionaction/)(const Action<>\&) | Adds a continuation action to be executed upon completion. |
| [Cancel](./cancel/)() | Marks the task as cancelled and finishes task. |
...
| [get_Exception](./get_exception/)() const | Gets the ID for task. |
| [get_Id](./get_id/)() const |  |
...
| [set_Scheduler](./set_scheduler/)(const SharedPtr\<TaskScheduler\>\&) | Sets the scheduler associated with this task. |
