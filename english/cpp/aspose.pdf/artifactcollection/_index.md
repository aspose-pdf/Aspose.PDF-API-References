...
| [Delete](./delete/)(const System::SharedPtr\<Artifact\>\&) | Deletes specified artifact. |
| [Delete](./delete/)(int32_t) | Deletes artifact by its index. |
| [FindByValue](./findbyvalue/)(const System::String\&, const System::String\&) | Finds artifacts by custom value. |
...
| [Update](./update/)(const System::SharedPtr\<Artifact\>\&) | Update artifact inside the collection. |
## See Also
