---
title: Aspose::Pdf::RenderingOptions::get_WidthExtraUnits method
linktitle: get_WidthExtraUnits
...
```cpp
ASPOSE_PDF_SHARED_API float Aspose::Pdf::RenderingOptions::get_WidthExtraUnits() const
```
