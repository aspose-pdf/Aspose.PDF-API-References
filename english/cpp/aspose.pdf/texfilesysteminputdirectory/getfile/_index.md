...
```cpp
System::SharedPtr<System::IO::Stream> Aspose::Pdf::TeXFileSystemInputDirectory::GetFile(const System::String &fileName, System::String &fullName, bool searchSubdirectories=false) override
```
