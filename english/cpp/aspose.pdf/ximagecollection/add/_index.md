...
| --- | --- | --- |
| bitmapInfo | const System::SharedPtr\<Aspose::Pdf::BitmapInfo\>\& | Object containing array of pixels and bitmap information (Width, Height, PixelFormat). |
...
| Parameter | Type | Description |
| --- | --- | --- |
| image | const System::SharedPtr\<System::IO::Stream\>\& | Stream containing image data (in JPEG format). |
