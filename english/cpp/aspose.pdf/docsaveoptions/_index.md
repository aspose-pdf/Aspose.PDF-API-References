...
| [set_MemorySaveModePath](./set_memorysavemodepath/)(const System::String\&) | Defines the path (file name or directory name) to hold temporary data when converting in memory save mode. |
