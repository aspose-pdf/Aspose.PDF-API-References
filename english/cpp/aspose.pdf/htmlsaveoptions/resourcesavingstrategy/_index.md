...
```cpp
using Aspose::Pdf::HtmlSaveOptions::ResourceSavingStrategy =  System::MulticastDelegate<System::String(System::SharedPtr<SaveOptions::ResourceSavingInfo>)>
```
...
<parameterlist kind="param">
  <parameteritem>
    <parameternamelist>
      <parametername>resourceSavingInfo</parametername>
    </parameternamelist>
    <parameterdescription>
      <para>represents set of data for saving of resource</para>
    </parameterdescription>
  </parameteritem>
</parameterlist>
## See Also
