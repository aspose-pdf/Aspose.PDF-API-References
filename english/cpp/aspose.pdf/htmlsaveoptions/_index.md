...
| [set_DefaultFontName](./set_defaultfontname/)(const System::String\&) | Specifies the name of an installed font which is used to substitute any document font that is not embedded and not installed in the system. If null then default substitution font is used. |
...
| [set_Title](./set_title/)(const System::String\&) | Sets HTML page title. |
