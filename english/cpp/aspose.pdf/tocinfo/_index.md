---
title: Aspose::Pdf::TocInfo class
linktitle: TocInfo
...
| Method | Description |
| --- | --- |
| [get_ColumnInfo](./get_columninfo/)() const | Gets column info. |
| [get_CopyToOutlines](./get_copytooutlines/)() const | Gets is TOC copied to outlines. |
| [get_FormatArray](./get_formatarray/)() const | Gets format array for table of contents. |
| [get_FormatArrayLength](./get_formatarraylength/)() | Gets format array length. |
| [get_IsCountTocPages](./get_iscounttocpages/)() const | Gets is count or passed toc pages. |
| [get_IsShowPageNumbers](./get_isshowpagenumbers/)() const | Gets is show page numbers at Toc. |
