...
| [Add](./add/)(const System::String\&, const System::SharedPtr\<FileSpecification\>\&) | Adds file to embedded files with the specified key. |
...
| [Delete](./delete/)(const System::String\&) | Delete embedded file by name. |
| [Delete](./delete/)() | Remove all embedded files from document. |
| [DeleteByKey](./deletebykey/)(const System::String\&) | Deletes file from the collection by its key in the collection. |
| [FindByName](./findbyname/)(const System::String\&) | Returns embedded file by its name. |
...
| [idx_get](./idx_get/)(const System::String\&) | Gets embedded file by its name. |
## See Also
