---
title: Aspose::Pdf::EmbeddedFileCollection::idx_get method
linktitle: idx_get
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::EmbeddedFileCollection::idx_get method. Gets embedded file by its name in C++.'
type: docs
weight: 1100
url: /cpp/aspose.pdf/embeddedfilecollection/idx_get/
---
...
| --- | --- | --- |
| name | const System::String\& | Embedded file name. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int32_t | Index of embedded file. Numbering is started from 1. |
