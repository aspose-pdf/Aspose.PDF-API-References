...
description: 'Aspose::Pdf::PageCollectionExtensions::AddBatesNumbering method. Adds the specified Bates numbering artifact to each page in the given page collection in C++.'
type: docs
weight: 100
...
| --- | --- | --- |
| pageCollection | const System::SharedPtr\<PageCollection\>\& | The collection of pages to which the Bates numbering artifact will be added. |
| artifact | const System::SharedPtr\<BatesNArtifact\>\& | The [BatesNArtifact](../../batesnartifact/) instance to be added to each page. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| pageCollection | const System::SharedPtr\<PageCollection\>\& | The collection of pages to which the Bates numbering will be added. |
