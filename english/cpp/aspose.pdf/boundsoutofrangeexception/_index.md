---
title: Aspose::Pdf::BoundsOutOfRangeException typedef
...
```cpp
using Aspose::Pdf::BoundsOutOfRangeException =  System::ExceptionWrapper<Details_BoundsOutOfRangeException>
```
