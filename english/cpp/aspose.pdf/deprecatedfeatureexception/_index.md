---
title: Aspose::Pdf::DeprecatedFeatureException typedef
...
```cpp
using Aspose::Pdf::DeprecatedFeatureException =  System::ExceptionWrapper<Details_DeprecatedFeatureException>
```
