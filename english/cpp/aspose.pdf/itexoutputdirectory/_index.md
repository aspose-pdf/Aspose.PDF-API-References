---
title: Aspose::Pdf::ITeXOutputDirectory class
...
```cpp
class ITeXOutputDirectory : public virtual Aspose::Pdf::ITeXInputDirectory
```
...
| Method | Description |
| --- | --- |
| virtual [GetOutputFile](./getoutputfile/)(const System::String\&, System::String\&) | Returns the stream to write to. |
## See Also
