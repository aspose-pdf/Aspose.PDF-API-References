...
| [get_HeadingLevels](./get_headinglevels/)() const | Defines expected heading levels to use in FontSize recognition headers strategy. If this property value is set, then header recognition [PdfToMarkdown::HeadingRecognitionStrategy::Heuristic](../../aspose.pdf.pdftomarkdown/headingrecognitionstrategy/) strategy will be selected when set [PdfToMarkdown::HeadingRecognitionStrategy::Auto](../../aspose.pdf.pdftomarkdown/headingrecognitionstrategy/) strategies even if the document contains bookmarks. |
...
| [set_HeadingLevels](./set_headinglevels/)(System::SharedPtr\<Aspose::Pdf::PdfToMarkdown::HeadingLevels\>) | Defines expected heading levels to use in FontSize recognition headers strategy. If this property value is set, then header recognition [PdfToMarkdown::HeadingRecognitionStrategy::Heuristic](../../aspose.pdf.pdftomarkdown/headingrecognitionstrategy/) strategy will be selected when set [PdfToMarkdown::HeadingRecognitionStrategy::Auto](../../aspose.pdf.pdftomarkdown/headingrecognitionstrategy/) strategies even if the document contains bookmarks. |
