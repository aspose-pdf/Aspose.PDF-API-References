---
title: Aspose::Pdf::GraphInfo::set_ScalingRateY method
linktitle: set_ScalingRateY
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::GraphInfo::set_ScalingRateY(double value)
```
