...
| [DocumentInfo](./documentinfo/)(const System::SharedPtr\<Document\>\&) | Initialize [DocumentInfo](./) instance. |
...
| static [IsPredefinedKey](./ispredefinedkey/)(const System::String\&) | Determines if the key is predefined (Title, Author, etc.), not custom. |
| [Remove](./remove/)(const System::String\&) override | Removes the element with the specified key from the collection. |
| [set_Author](./set_author/)(const System::String\&) | Sets document author. |
...
| [set_Creator](./set_creator/)(const System::String\&) | Sets document creator. |
| [set_Keywords](./set_keywords/)(const System::String\&) | Gets or set the keywords of the document. |
...
| [set_Producer](./set_producer/)(const System::String\&) | Sets the document producer. |
| [set_Subject](./set_subject/)(const System::String\&) | Sets the subject of the document. |
| [set_Title](./set_title/)(const System::String\&) | Sets document title. |
| [set_Trapped](./set_trapped/)(const System::String\&) | Sets the trapped flag. |
