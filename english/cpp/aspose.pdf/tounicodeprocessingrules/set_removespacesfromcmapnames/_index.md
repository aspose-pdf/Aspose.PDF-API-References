---
title: Aspose::Pdf::ToUnicodeProcessingRules::set_RemoveSpacesFromCMapNames method
linktitle: set_RemoveSpacesFromCMapNames
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::ToUnicodeProcessingRules::set_RemoveSpacesFromCMapNames method. Some fonts have ToUnicode character code maps with spaces in names. These spaces could call errors with unicode text mapping. This flag commands to remove spaces from names of ToUnicode character code maps. By default false in C++.'
type: docs
weight: 500
url: /cpp/aspose.pdf/tounicodeprocessingrules/set_removespacesfromcmapnames/
---
...
```cpp
void Aspose::Pdf::ToUnicodeProcessingRules::set_RemoveSpacesFromCMapNames(bool value)
```
