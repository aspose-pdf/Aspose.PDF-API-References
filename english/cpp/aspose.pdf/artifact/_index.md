...
| Method | Description |
| --- | --- |
| [Artifact](./artifact/)(const System::String\&, const System::String\&) | Constructor of artifact with specified type and subtype. |
...
| [GetValue](./getvalue/)(const System::String\&) | Gets custom value of artifact. |
| [RemoveValue](./removevalue/)(const System::String\&) | Remove custom value from the artifact. |
...
| [set_CustomSubtype](./set_customsubtype/)(const System::String\&) | Gets name of artifact subtype. May be used if artifact subtype is not standard subtype. |
| [set_CustomType](./set_customtype/)(const System::String\&) | Gets name of artifact type. May be used if artifact type is non standard. |
...
| [set_Position](./set_position/)(const System::SharedPtr\<Point\>\&) | Sets artifact position. If this property is specified, then margins and alignments are ignored. |
...
| [set_Text](./set_text/)(const System::String\&) | Gets text of the artifact. |
| [set_TextState](./set_textstate/)(const System::SharedPtr\<Aspose::Pdf::Text::TextState\>\&) | [Text](../../aspose.pdf.text/) state for artifact text. |
...
| [SetImage](./setimage/)(const System::SharedPtr\<System::IO::Stream\>\&) | Sets image of the artifact. |
| [SetImage](./setimage/)(const System::String\&) | Sets image of the artifact. |
| [SetLinesAndState](./setlinesandstate/)(const System::ArrayPtr\<System::String\>\&, const System::SharedPtr\<Aspose::Pdf::Text::TextState\>\&) | Set text and text properties of the artifact. Allows to specify multiple lines. |
| [SetPageNumberReplacementString](./setpagenumberreplacementstring/)(const System::String\&) | Sets what string will be replaced with the page number. The default value is #. |
| [SetPdfPage](./setpdfpage/)(const System::SharedPtr\<Page\>\&) | Sets PDF page which is placed on the document page as artifact. |
| [SetText](./settext/)(const System::SharedPtr\<Facades::FormattedText\>\&) | Sets text of the artifact. |
| [SetTextAndState](./settextandstate/)(const System::String\&, const System::SharedPtr\<Aspose::Pdf::Text::TextState\>\&) | Set text and text properties of the artifact. |
| [SetValue](./setvalue/)(const System::String\&, const System::String\&) | Sets custom value of artifact. |
## See Also
