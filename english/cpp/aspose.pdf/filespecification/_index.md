...
| [FileSpecification](./filespecification/)(const System::String\&) | Constructor for [FileSpecification](./). |
| [FileSpecification](./filespecification/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::String\&) | Constructor for file specification. |
| [FileSpecification](./filespecification/)(const System::String\&, const System::String\&) | Constructor for [FileSpecification](./). |
| [FileSpecification](./filespecification/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::String\&, const System::String\&) | Constructor for [FileSpecification](./). |
| [FileSpecification](./filespecification/)(const System::String\&, const System::SharedPtr\<Annotations::Annotation\>\&) | Constructor for [FileSpecification](./). |
...
| [set_Description](./set_description/)(const System::String\&) | Sets text associated with the file specification. |
...
| [set_FileSystem](./set_filesystem/)(const System::String\&) | Sets name of the file system. |
| [set_IncludeContents](./set_includecontents/)(bool) | If true, contents of the file will be included in the file specification. |
| [set_MIMEType](./set_mimetype/)(const System::String\&) | Gets subtype of the embedded file. |
| [set_Name](./set_name/)(const System::String\&) | Sets file specification name. |
| [set_Params](./set_params/)(const System::SharedPtr\<FileParams\>\&) | Gets file paramteres. |
| [set_UnicodeName](./set_unicodename/)(const System::String\&) | Sets file specification unicode name. |
| [SetValue](./setvalue/)(const System::String\&, const System::String\&) | Sets application-specific parameter. |
## See Also
