---
title: Aspose::Pdf::InvalidValueFormatException typedef
...
```cpp
using Aspose::Pdf::InvalidValueFormatException =  System::ExceptionWrapper<Details_InvalidValueFormatException>
```
