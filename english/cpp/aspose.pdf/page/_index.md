...
| [AddImage](./addimage/)(System::SharedPtr\<System::IO::Stream\>, System::SharedPtr\<Aspose::Pdf::Rectangle\>) | Adds image onto the page and locates it in the middle of specified rectangle saving image's proportion. |
| [AddImage](./addimage/)(System::String, System::SharedPtr\<System::IO::Stream\>, System::SharedPtr\<Aspose::Pdf::Rectangle\>) | Adds searchable image onto the page and locates it in the middle of specified rectangle saving image's proportion. |
| [AddImage](./addimage/)(System::SharedPtr\<System::IO::Stream\>, System::SharedPtr\<Aspose::Pdf::Rectangle\>, int32_t, int32_t, bool) | Adds image on page and places it depend on image rectangle position. |
...
| [AddStamp](./addstamp/)(System::SharedPtr\<Stamp\>) | Put stamp into page. [Stamp](../stamp/) can be page number, image or simple text, e.g. some logo. |
| [AsByteArray](./asbytearray/)(System::SharedPtr\<Devices::Resolution\>) | Converts current page as bitmap and than returns array of bytes. |
...
| [DeleteGraphics](./deletegraphics/)(System::SharedPtr\<Vector::GraphicElementCollection\>) | Deletes graphics from the page. Works faster than deleting elements one by one with [GraphicElement::Remove](../) method. |
...
| [Resize](./resize/)(System::SharedPtr\<PageSize\>) | Resizes the page. |
| static [RotationToInt](./rotationtoint/)(Rotation) | Translates rotation enumeration member into integer value. |
| [SendTo](./sendto/)(System::SharedPtr\<Devices::PageDevice\>, System::SharedPtr\<System::IO::Stream\>) | Sends page to process with given page device. |
| [SendTo](./sendto/)(System::SharedPtr\<Devices::PageDevice\>, System::String) | Sends page to process with given page device. |
| [set_ArtBox](./set_artbox/)(System::SharedPtr\<Aspose::Pdf::Rectangle\>) | Sets art box of the page. |
| [set_Background](./set_background/)(System::SharedPtr\<Color\>) | Sets the background color of the page. |
...
| [set_Footer](./set_footer/)(System::SharedPtr\<HeaderFooter\>) | Sets page footer. |
...
| [set_Header](./set_header/)(System::SharedPtr\<HeaderFooter\>) | Sets page header. |
...
| [set_Layers](./set_layers/)(System::SharedPtr\<System::Collections::Generic::List\<System::SharedPtr\<Layer\>\>\>) | Sets layers collection. |
| [set_MediaBox](./set_mediabox/)(System::SharedPtr\<Aspose::Pdf::Rectangle\>) | Sets media box of the page. |
| [set_NoteLineStyle](./set_notelinestyle/)(System::SharedPtr\<GraphInfo\>) | Sets the line style for notes.(for generator only, not filled in when reading document) |
...
| [set_Rotate](./set_rotate/)(Rotation) | Sets rotation of the page. |
