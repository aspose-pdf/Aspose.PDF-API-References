...
| [AddGraphics](./addgraphics/)(const System::SharedPtr\<Aspose::Pdf::Vector::GraphicElementCollection\>\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Adds graphics to the page. Works faster than adding elements one by one with [GraphicElement::AddOnPage(Page)](../) method. |
| [AddImage](./addimage/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&, bool) | Adds image onto the page and locates it in the middle of specified rectangle saving image's proportion. |
| [AddImage](./addimage/)(const System::String\&, const System::SharedPtr\<System::IO::Stream\>\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Adds searchable image onto the page and locates it in the middle of specified rectangle saving image's proportion. |
| [AddImage](./addimage/)(const System::SharedPtr\<System::IO::Stream\>\&, System::SharedPtr\<Aspose::Pdf::Rectangle\>, int32_t, int32_t, bool, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Adds image on page and places it depend on image rectangle position. |
| [AddImage](./addimage/)(const System::String\&, const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Adds image onto the page and locates it in the middle of specified rectangle saving image's proportion. |
| [AddStamp](./addstamp/)(const System::SharedPtr\<Aspose::Pdf::Stamp\>\&) | Put stamp into page. [Stamp](../stamp/) can be page number, image or simple text, e.g. some logo. |
| [AsByteArray](./asbytearray/)(const System::SharedPtr\<Aspose::Pdf::Devices::Resolution\>\&) | Converts current page as bitmap and than returns array of bytes. |
...
| [DeleteGraphics](./deletegraphics/)(const System::SharedPtr\<Aspose::Pdf::Vector::GraphicElementCollection\>\&) | Deletes graphics from the page. Works faster than deleting elements one by one with [GraphicElement::Remove](../) method. |
...
| [MergeLayers](./mergelayers/)(const System::String\&) | Merges all layers on the page into a single layer with the specified new layer name. |
| [MergeLayers](./mergelayers/)(const System::String\&, const System::String\&) | Merges all layers on the page into a single layer with the specified new layer name and optional content group [Id](../id/). |
...
| [SendTo](./sendto/)(const System::SharedPtr\<Aspose::Pdf::Devices::PageDevice\>\&, const System::SharedPtr\<System::IO::Stream\>\&) | Sends page to process with given page device. |
| [SendTo](./sendto/)(const System::SharedPtr\<Aspose::Pdf::Devices::PageDevice\>\&, const System::String\&) | Sends page to process with given page device. |
| [set_ArtBox](./set_artbox/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets art box of the page. |
| [set_Background](./set_background/)(const System::SharedPtr\<Aspose::Pdf::Color\>\&) | Sets the background color of the page. |
| [set_BackgroundImage](./set_backgroundimage/)(const System::SharedPtr\<Aspose::Pdf::Image\>\&) | Sets background image for page (for generator only, not filled in when reading document). |
| [set_BleedBox](./set_bleedbox/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets bleed box of the page. |
| [set_CropBox](./set_cropbox/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets crop box of the page. |
...
| [set_Footer](./set_footer/)(const System::SharedPtr\<Aspose::Pdf::HeaderFooter\>\&) | Sets page footer. |
| [set_Group](./set_group/)(const System::SharedPtr\<Aspose::Pdf::Group\>\&) | Sets a group attributes class specifying the attributes of the page's page group for use in the transparent imaging model. |
| [set_Header](./set_header/)(const System::SharedPtr\<Aspose::Pdf::HeaderFooter\>\&) | Sets page header. |
...
| [set_Layers](./set_layers/)(const System::SharedPtr\<System::Collections::Generic::List\<System::SharedPtr\<Aspose::Pdf::Layer\>\>\>\&) | Sets layers collection. |
| [set_MediaBox](./set_mediabox/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets media box of the page. |
| [set_NoteLineStyle](./set_notelinestyle/)(const System::SharedPtr\<Aspose::Pdf::GraphInfo\>\&) | Sets the line style for notes.(for generator only, not filled in when reading document) |
...
| [set_Paragraphs](./set_paragraphs/)(const System::SharedPtr\<Aspose::Pdf::Paragraphs\>\&) | Gets the paragraphs. |
...
| [set_TocInfo](./set_tocinfo/)(const System::SharedPtr\<Aspose::Pdf::TocInfo\>\&) | Sets table of contents info. |
| [set_TrimBox](./set_trimbox/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets trim box of the page. |
...
| [set_Watermark](./set_watermark/)(const System::SharedPtr\<Aspose::Pdf::Watermark\>\&) | Sets the watermark of the page. |
| [SetPageSize](./setpagesize/)(double, double) | Sets page size for page. |
| [TrySaveVectorGraphics](./trysavevectorgraphics/)(const System::String\&) | Tries to save vector graphics if they are present on the page. The save format is SVG. |
## Typedefs
