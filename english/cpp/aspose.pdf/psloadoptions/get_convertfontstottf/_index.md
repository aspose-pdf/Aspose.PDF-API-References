---
title: Aspose::Pdf::PsLoadOptions::get_ConvertFontsToTTF method
linktitle: get_ConvertFontsToTTF
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::PsLoadOptions::get_ConvertFontsToTTF method. Specifies whether to save non-TrueType fonts to TTF. It significantly decreases the volume of the resulting document in PS to PDF conversion and increases the speed of conversion of PS files with a large quantity of text in non-TrueType fonts to any output format. However, there is small vertical shift of text when converting PostSctipt file to image in C++.'
type: docs
weight: 200
url: /cpp/aspose.pdf/psloadoptions/get_convertfontstottf/
---
