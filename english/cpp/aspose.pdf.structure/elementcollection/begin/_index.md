...
description: 'Aspose::Pdf::Structure::ElementCollection::begin method. Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection in C++.'
type: docs
weight: 100
