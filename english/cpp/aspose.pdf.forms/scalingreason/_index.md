---
title: Aspose::Pdf::Forms::ScalingReason enum
linktitle: ScalingReason
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Forms::ScalingReason enum. The circumstances under which the icon shall be scaled inside the annotation rectangle in C++.'
type: docs
weight: 3600
url: /cpp/aspose.pdf.forms/scalingreason/
---
## ScalingReason enum
