...
description: 'Aspose::Pdf::Forms::Symbology enum. A (Barcode) Symbology defines the technical details of a particular type of barcode: the width of the bars, character set, method of encoding, checksum specifications, etc in C++.'
type: docs
weight: 3800
url: /cpp/aspose.pdf.forms/symbology/
---
## Symbology enum
