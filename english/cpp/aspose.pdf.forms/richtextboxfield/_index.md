...
| [RichTextBoxField](./richtextboxfield/)(const System::SharedPtr\<Aspose::Pdf::Page\>\&, const System::SharedPtr\<Rectangle\>\&) | Constructor for Rich [Text](../../aspose.pdf.text/) Box field. |
| [set_FormattedValue](./set_formattedvalue/)(const System::String\&) | Sets formatted rich text value with markup. |
| [set_Justify](./set_justify/)(Aspose::Pdf::Annotations::Justification) | Sets justification of the rich text box. |
| [set_RichTextValue](./set_richtextvalue/)(const System::String\&) | Sets rich text value. |
| [set_Style](./set_style/)(const System::String\&) | Sets default style string of the rich text field. |
