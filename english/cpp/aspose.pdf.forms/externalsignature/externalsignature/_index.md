...
| --- | --- | --- |
| certificate | const System::SharedPtr\<System::Security::Cryptography::X509Certificates::X509Certificate2\>\& | The certificate with the private key. |
## Remarks
...
| Parameter | Type | Description |
| --- | --- | --- |
| base64 | const System::String\& | X509Certificate2 as base64 string. |
| detached | bool | True if the signature should be detached, otherwise false. |
## Remarks
