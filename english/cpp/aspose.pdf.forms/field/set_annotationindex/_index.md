---
title: Aspose::Pdf::Forms::Field::set_AnnotationIndex method
linktitle: set_AnnotationIndex
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Forms::Field::set_AnnotationIndex(int32_t value)
```
