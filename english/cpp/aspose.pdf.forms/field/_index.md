...
| [Field](./field/)(System::SharedPtr\<Document\>) | Creates field for use in [Generator](../../aspose.pdf.generator/). |
...
| [get_IsSharedField](./get_issharedfield/)() const | Property for [Generator](../../aspose.pdf.generator/) support. Used when field is added to header or footer. If true, this field will created once and it's appearance will be visible on all pages of the document. If false, separated field will be created for every document page. |
...
| [set_IsSharedField](./set_issharedfield/)(bool) | Property for [Generator](../../aspose.pdf.generator/) support. Used when field is added to header or footer. If true, this field will created once and it's appearance will be visible on all pages of the document. If false, separated field will be created for every document page. |
