...
| Method | Description |
| --- | --- |
| [CopyTo](./copyto/)(const System::ArrayPtr\<System::SharedPtr\<Field\>\>\&, int32_t) | Copies subfields of this field into array starting from specified index. |
| [CopyToWidgetArray](./copytowidgetarray/)(const System::ArrayPtr\<System::SharedPtr\<Annotations::WidgetAnnotation\>\>\&, int32_t) | Copies subfields of this field into array starting from specified index. |
| [ExecuteFieldJavaScript](./executefieldjavascript/)(const System::SharedPtr\<Annotations::JavascriptAction\>\&) | Executes a specified JavaScript action for the field. |
| [Field](./field/)(const System::SharedPtr\<Document\>\&) | Creates field for use in Generator. |
...
| [idx_get](./idx_get/)(const System::String\&) | Gets subfield contained in this field by name of the subfield. |
...
| [set_AlternateName](./set_alternatename/)(const System::String\&) | Sets alternate name of the field (An alternate field name that shall be used in place of the actual field name wherever the field shall be identified in the user interface). Alternate name is used as field tooltip in Adobe Acrobat. |
...
| [set_MappingName](./set_mappingname/)(const System::String\&) | Sets mapping name of the field that shall be used when exporting interactive form field data from the document. |
...
| [set_PartialName](./set_partialname/)(const System::String\&) | Sets partial name of the field. |
