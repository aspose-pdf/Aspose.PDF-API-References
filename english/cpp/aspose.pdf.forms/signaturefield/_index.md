...
| [ExtractImage](./extractimage/)(const System::SharedPtr\<System::Drawing::Imaging::ImageFormat\>\&) | Extracts signature's image as encoded stream. |
...
| [Sign](./sign/)(const System::SharedPtr\<Aspose::Pdf::Forms::Signature\>\&, const System::SharedPtr\<System::IO::Stream\>\&, const System::String\&) | Signs the document using this signature field. |
| [Sign](./sign/)(const System::SharedPtr\<Aspose::Pdf::Forms::Signature\>\&) | Sign the document using this signature field. |
| [SignatureField](./signaturefield/)(const System::SharedPtr\<Aspose::Pdf::Page\>\&, const System::SharedPtr\<Rectangle\>\&) | Initializes new instance of the [SignatureField](./) class. |
| [SignatureField](./signaturefield/)(const System::SharedPtr\<Document\>\&, const System::SharedPtr\<Rectangle\>\&) | Initializes new instance of the [SignatureField](./) class. |
## See Also
