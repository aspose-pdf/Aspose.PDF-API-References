...
| virtual [AddOption](../choicefield/addoption/)(System::String) | Adds new option with specified name. |
...
| virtual [get_Options](../choicefield/get_options/)() | Gets collection of choice options. |
...
| virtual [get_Selected](../choicefield/get_selected/)() | Gets index of selected option. This property allows to change selection. |
...
| [get_Value](../choicefield/get_value/)() override | Gets value of the field. |
...
| virtual [set_Selected](../choicefield/set_selected/)(int32_t) | Sets index of selected option. This property allows to change selection. |
...
| [set_Value](../choicefield/set_value/)(System::String) override | Sets value of the field. |
