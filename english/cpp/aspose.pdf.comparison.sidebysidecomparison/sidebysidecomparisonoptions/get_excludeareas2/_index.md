...
```cpp
ASPOSE_PDF_SHARED_API const System::ArrayPtr<System::SharedPtr<Rectangle>> & Aspose::Pdf::Comparison::SideBySideComparison::SideBySideComparisonOptions::get_ExcludeAreas2() const
```
