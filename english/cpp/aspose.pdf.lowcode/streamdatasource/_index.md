---
title: Aspose::Pdf::LowCode::StreamDataSource class
linktitle: StreamDataSource
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::LowCode::StreamDataSource class. Represents stream data source for load and save operations of a plugin in C++.'
type: docs
weight: 7700
url: /cpp/aspose.pdf.lowcode/streamdatasource/
---
...
```cpp
class StreamDataSource : public Aspose::Pdf::LowCode::IDataSource
```
