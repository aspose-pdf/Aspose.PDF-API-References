---
title: Aspose::Pdf::LowCode::FormEditorAddOptions class
linktitle: FormEditorAddOptions
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::LowCode::FormEditorAddOptions class. Represents options for add Fields to document by FormEditor plugin in C++.'
type: docs
weight: 1300
url: /cpp/aspose.pdf.lowcode/formeditoraddoptions/
---
...
```cpp
class FormEditorAddOptions : public Aspose::Pdf::LowCode::FormEditorOptions
```
