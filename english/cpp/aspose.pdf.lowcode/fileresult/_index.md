---
title: Aspose::Pdf::LowCode::FileResult class
linktitle: FileResult
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::LowCode::FileResult class. Represents operation result in the form of string path to file in C++.'
type: docs
weight: 600
url: /cpp/aspose.pdf.lowcode/fileresult/
---
## FileResult class
...
```cpp
class FileResult : public Aspose::Pdf::LowCode::IOperationResult
```
