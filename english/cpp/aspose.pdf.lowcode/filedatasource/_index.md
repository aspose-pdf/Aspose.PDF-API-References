---
title: Aspose::Pdf::LowCode::FileDataSource class
linktitle: FileDataSource
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::LowCode::FileDataSource class. Represents file data source for load and save operations of a plugin in C++.'
type: docs
weight: 500
url: /cpp/aspose.pdf.lowcode/filedatasource/
---
...
```cpp
class FileDataSource : public Aspose::Pdf::LowCode::IDataSource
```
