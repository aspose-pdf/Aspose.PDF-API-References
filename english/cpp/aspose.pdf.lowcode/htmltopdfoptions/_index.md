---
title: Aspose::Pdf::LowCode::HtmlToPdfOptions class
linktitle: HtmlToPdfOptions
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::LowCode::HtmlToPdfOptions class. Represents HTML to PDF converter options for Html plugin in C++.'
type: docs
weight: 3300
url: /cpp/aspose.pdf.lowcode/htmltopdfoptions/
---
...
```cpp
class HtmlToPdfOptions : public Aspose::Pdf::LowCode::PdfConverterOptions
```
