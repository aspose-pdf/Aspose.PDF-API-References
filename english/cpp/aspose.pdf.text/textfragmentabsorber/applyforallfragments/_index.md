...
description: 'Aspose::Pdf::Text::TextFragmentAbsorber::ApplyForAllFragments method. Applies font size for all text fragments that were absorbed. It works faster than looping through the fragments if all fragments on the page(s) were absorbed. Otherwise it works similar with looping in C++.'
type: docs
weight: 200
...
| Parameter | Type | Description |
| --- | --- | --- |
| font | System::SharedPtr\<Font\> | [Font](../../font/)of the text. |
