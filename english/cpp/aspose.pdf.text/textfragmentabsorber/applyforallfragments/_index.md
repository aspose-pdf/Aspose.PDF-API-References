---
title: Aspose::Pdf::Text::TextFragmentAbsorber::ApplyForAllFragments method
linktitle: ApplyForAllFragments
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Text::TextFragmentAbsorber::ApplyForAllFragments method. Applies font for all text fragments that were absorbed. It works faster than looping through the fragments if all fragments on the page(s) were absorbed. Otherwise it works similar with looping in C++.'
type: docs
weight: 200
url: /cpp/aspose.pdf.text/textfragmentabsorber/applyforallfragments/
---
...
| --- | --- | --- |
| font | const System::SharedPtr\<Font\>\& | [Font](../../font/)of the text. |
...
| --- | --- | --- |
| font | const System::SharedPtr\<Font\>\& | [Font](../../font/)of the text. |
| fontSize | float | [Font](../../font/) size of the text. |
