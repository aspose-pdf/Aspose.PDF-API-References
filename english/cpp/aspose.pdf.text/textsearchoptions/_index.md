...
| [set_Rectangle](./set_rectangle/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Sets rectangle that bounds the searched text. |
...
| [TextSearchOptions](./textsearchoptions/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&) | Initializes new instance of the [TextSearchOptions](./) object. Specifies rectangle that delimits the searched text. |
| [TextSearchOptions](./textsearchoptions/)(const System::SharedPtr\<Aspose::Pdf::Rectangle\>\&, bool) | Initializes new instance of the [TextSearchOptions](./) object. Specifies rectangle that delimits the searched text and regular expression usage mode. |
## See Also
