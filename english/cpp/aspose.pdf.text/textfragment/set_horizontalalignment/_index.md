---
title: Aspose::Pdf::Text::TextFragment::set_HorizontalAlignment method
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Text::TextFragment::set_HorizontalAlignment(Aspose::Pdf::HorizontalAlignment value) override
```
