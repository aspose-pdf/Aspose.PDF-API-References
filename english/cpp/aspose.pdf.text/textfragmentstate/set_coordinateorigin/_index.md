...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Text::TextFragmentState::set_CoordinateOrigin(Aspose::Pdf::Text::CoordinateOrigin value) override
```
