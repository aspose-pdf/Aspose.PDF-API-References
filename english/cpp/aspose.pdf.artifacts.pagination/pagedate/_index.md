---
title: Aspose::Pdf::Artifacts::Pagination::PageDate class
linktitle: PageDate
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Artifacts::Pagination::PageDate class. Represents a date format composed of day, month, and year components in C++.'
type: docs
weight: 900
url: /cpp/aspose.pdf.artifacts.pagination/pagedate/
---
## PageDate class
...
| Method | Description |
| --- | --- |
| [get_Day](./get_day/)() const | Gets the day component of the date. The format of the date will be updated based on this component. |
| [get_Delimiter](./get_delimiter/)() const | Gets the delimiter used in the date format. The format of the date will be updated based on this delimiter. |
