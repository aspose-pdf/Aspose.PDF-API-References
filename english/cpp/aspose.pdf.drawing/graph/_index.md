...
| [set_Shapes](./set_shapes/)(const System::SharedPtr\<BoundsCheckableList\<System::SharedPtr\<Shape\>\>\>\&) | Sets a [Shapes](../) collection that indicates all shapes in the graph. |
| [set_Title](./set_title/)(const System::SharedPtr\<Text::TextFragment\>\&) | Sets a string value that indicates the title of the graph. |
