---
title: Aspose::Pdf::Plugins::TiffOptions class
linktitle: TiffOptions
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Plugins::TiffOptions class. Represents Pdf to Tiff converter options for the Tiff plugin in C++.'
type: docs
weight: 8700
url: /cpp/aspose.pdf.plugins/tiffoptions/
---
## TiffOptions class
...
```cpp
class TiffOptions : public Aspose::Pdf::Plugins::PdfToImageOptions
```
...
| [set_Compression](./set_compression/)(Aspose::Pdf::Devices::CompressionType) | Sets the type of the compression. |
...
| [set_Depth](./set_depth/)(Aspose::Pdf::Devices::ColorDepth) | Sets the color depth. |
...
| [set_Shape](./set_shape/)(Aspose::Pdf::Devices::ShapeType) | Sets the type of the shape. |
