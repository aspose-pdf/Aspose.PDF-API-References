---
title: Aspose::Pdf::Plugins::IPlugin class
linktitle: IPlugin
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Plugins::IPlugin class. General plugin interface that defines common methods that concrete plugin should implement in C++.'
type: docs
weight: 3900
url: /cpp/aspose.pdf.plugins/iplugin/
---
## IPlugin class
