---
title: Aspose::Pdf::Plugins::HtmlToPdfOptions class
linktitle: HtmlToPdfOptions
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Plugins::HtmlToPdfOptions class. Represents HTML to PDF converter options for Html plugin in C++.'
type: docs
weight: 3300
url: /cpp/aspose.pdf.plugins/htmltopdfoptions/
---
