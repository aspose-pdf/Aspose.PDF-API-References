---
title: Aspose::Pdf::Plugins::FormRemoveSelectedFieldsOptions class
linktitle: FormRemoveSelectedFieldsOptions
second_title: Aspose.PDF for C++ API Reference
description: 'Aspose::Pdf::Plugins::FormRemoveSelectedFieldsOptions class. Represents options for remove selected fields in document by FormEditor plugin in C++.'
type: docs
weight: 2900
url: /cpp/aspose.pdf.plugins/formremoveselectedfieldsoptions/
---
...
```cpp
class FormRemoveSelectedFieldsOptions : public Aspose::Pdf::Plugins::FormEditorRemoveOptions
```
