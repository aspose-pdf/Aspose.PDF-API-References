...
| Method | Description |
| --- | --- |
| virtual [CalculateEncryptionKey](./calculateencryptionkey/)(const System::String\&) | Calculate the EncryptionKey. Generally the key is calculated based on the UserKey. You can use values from EncryptionParams, which contains the current parameters at the time of the call. This value is passed as the key argument in [Encrypt](./encrypt/) and [Decrypt](./decrypt/). |
| virtual [Decrypt](./decrypt/)(const System::ArrayPtr\<uint8_t\>\&, int32_t, int32_t, const System::ArrayPtr\<uint8_t\>\&) | Decrypt the data array. |
| virtual [Encrypt](./encrypt/)(const System::ArrayPtr\<uint8_t\>\&, int32_t, int32_t, const System::ArrayPtr\<uint8_t\>\&) | Encrypt the data array. |
