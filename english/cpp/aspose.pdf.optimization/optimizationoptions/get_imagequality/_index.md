---
title: Aspose::Pdf::Optimization::OptimizationOptions::get_ImageQuality method
...
```cpp
ASPOSE_PDF_SHARED_API int32_t Aspose::Pdf::Optimization::OptimizationOptions::get_ImageQuality()
```

## Remarks


<xrefsect id="deprecated_1_deprecated000130">
  <xreftitle>Deprecated</xreftitle>
  <xrefdescription>
    <para>Please use ImageCompressionOptions.ImageQuality instead. </para>
  </xrefdescription>
</xrefsect>
## See Also
