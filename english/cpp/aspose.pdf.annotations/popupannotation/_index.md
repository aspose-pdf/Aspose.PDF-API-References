...
| [PopupAnnotation](./popupannotation/)(const System::SharedPtr\<Document\>\&) | Constructor. for using in Generator. |
| [PopupAnnotation](./popupannotation/)(const System::SharedPtr\<Aspose::Pdf::Page\>\&, const System::SharedPtr\<Rectangle\>\&) | Creates new Popup annotation on the specified page. |
| [set_Open](./set_open/)(bool) | Sets a flag specifying whether the pop-up annotation should initially be displayed open. |
| [set_Parent](./set_parent/)(const System::SharedPtr\<Annotation\>\&) | Sets the parent annotation with which this pop-up annotation shall be associated. If this entry is present, the parent annotation's Contents, M, C, and T entries shall override those of the pop-up annotation itself. |
## See Also
