...
| [NumberFormat](./numberformat/)(const System::SharedPtr\<Measure\>\&) | Constructor for [NumberFormat](./) class. |
| [set_AfterText](./set_aftertext/)(const System::String\&) | [Text](../../../aspose.pdf.text/) that shall be concatenated after the label. |
| [set_BeforeText](./set_beforetext/)(const System::String\&) | [Text](../../../aspose.pdf.text/) that shall be concatenated to the left of the label. |
...
| [set_FractionSeparator](./set_fractionseparator/)(const System::String\&) | [Text](../../../aspose.pdf.text/) that shall be used as the decimal position in displaying numerical values. An empty string indicates that the default shall be used. Default is period character. |
...
| [set_ThousandsSeparator](./set_thousandsseparator/)(const System::String\&) | [Text](../../../aspose.pdf.text/) that shall be used between orders of thousands in display of numerical values. An empty string indicates that no text shall be added. Default is comma. |
| [set_UnitLabel](./set_unitlabel/)(const System::String\&) | A text string specifying a label for displaying the units. |
## See Also
