...
| [set_Callout](./set_callout/)(const System::ArrayPtr\<System::SharedPtr\<Point\>\>\&) | Array of point specifying callout line. |
...
| [set_DefaultStyle](./set_defaultstyle/)(const System::String\&) | Sets a default style string. |
...
| [set_TextStyle](./set_textstyle/)(const System::SharedPtr\<Aspose::Pdf::Annotations::TextStyle\>\&) | Sets style of the text in appearance. when text style is changed, text appearance is updated. |
| [SetTextStyle](./settextstyle/)(RichTextFontStyles, const System::String\&, double, System::Drawing::Color) | Sets the formatting determined by the parameter textStyle for all annotation text. |
