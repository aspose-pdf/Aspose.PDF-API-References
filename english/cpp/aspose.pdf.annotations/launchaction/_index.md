...
| [LaunchAction](./launchaction/)(const System::String\&) | Creates a launch action. |
| [LaunchAction](./launchaction/)(const System::SharedPtr\<Document\>\&, const System::String\&) | Creates a launch action. |
| [set_File](./set_file/)(const System::String\&) | Sets the application to be launched or the document to be opened or printed. |
