...
description: 'Aspose::Pdf::Annotations::Dash::Dash constructor. Constructor for Dash. Defines a pattern of dashes and gaps that shall be used in drawing a dashed border in C++.'
type: docs
weight: 100
url: /cpp/aspose.pdf.annotations/dash/dash/
---
## Dash::Dash(const System::ArrayPtr\<int32_t\>\&) constructor


Constructor for [Dash](../). Defines a pattern of dashes and gaps that shall be used in drawing a dashed border.

```cpp
Aspose::Pdf::Annotations::Dash::Dash(const System::ArrayPtr<int32_t> &pattern)
```


| Parameter | Type | Description |
| --- | --- | --- |
| pattern | const System::ArrayPtr\<int32_t\>\& | A dash array (of two values minimum) defining a pattern of dashes and gaps that shall be used in drawing a dashed border. |
