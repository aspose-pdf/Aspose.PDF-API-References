...
| Method | Description |
| --- | --- |
| [DocumentActionCollection](./documentactioncollection/)(const System::SharedPtr\<Document\>\&) | Constructor for [DocumentActionCollection](./). Constructs [DocumentActionCollection](./) objects from Pdf.Kit.Engine [Document](../../aspose.pdf/document/) object. |
...
| [set_AfterPrinting](./set_afterprinting/)(const System::SharedPtr\<PdfAction\>\&) | Action that will be performed after document printing. |
| [set_AfterSaving](./set_aftersaving/)(const System::SharedPtr\<PdfAction\>\&) | Sets action that will be performed after document saving. |
| [set_BeforeClosing](./set_beforeclosing/)(const System::SharedPtr\<PdfAction\>\&) | Sets action that will be performed before documetn closing. |
| [set_BeforePrinting](./set_beforeprinting/)(const System::SharedPtr\<PdfAction\>\&) | Action that will be performed before document printing. |
| [set_BeforeSaving](./set_beforesaving/)(const System::SharedPtr\<PdfAction\>\&) | Sets action performed before document saving. |
## See Also
