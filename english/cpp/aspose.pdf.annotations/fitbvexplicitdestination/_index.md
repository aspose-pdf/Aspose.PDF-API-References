...
| Method | Description |
| --- | --- |
| [FitBVExplicitDestination](./fitbvexplicitdestination/)(const System::SharedPtr\<Aspose::Pdf::Page\>\&, double) | Creates local explicit destination. |
| [FitBVExplicitDestination](./fitbvexplicitdestination/)(const System::SharedPtr\<Document\>\&, int32_t, double) | Creates remote explicit destination. |
