...
| --- | --- | --- |
| doc | const System::SharedPtr\<Document\>\& | [Document](../../../aspose.pdf/document/) where action will be created. |
| name | const System::String\& | Name of the destination. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| page | const System::SharedPtr\<Page\>\& | [Aspose.Pdf.Page](../../../aspose.pdf/page/) destination object to jump to. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| page | const System::SharedPtr\<Page\>\& | Destination page. |
