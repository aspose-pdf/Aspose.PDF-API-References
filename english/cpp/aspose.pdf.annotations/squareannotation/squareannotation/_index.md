...
description: 'Aspose::Pdf::Annotations::SquareAnnotation::SquareAnnotation constructor. Creates new Square annotation on the specified page in C++.'
type: docs
weight: 100
...
```cpp
Aspose::Pdf::Annotations::SquareAnnotation::SquareAnnotation(System::SharedPtr<Aspose::Pdf::Page> page, System::SharedPtr<Rectangle> rect)
```
