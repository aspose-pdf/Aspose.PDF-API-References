...
| [set_ExtractionAreaBound](./set_extractionareabound/)(const System::SharedPtr\<Rectangle\>\&) | Gets and sets the bounding rectangle that defines the extraction area for SVG extraction. |
