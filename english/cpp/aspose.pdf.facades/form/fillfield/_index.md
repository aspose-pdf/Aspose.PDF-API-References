...
| --- | --- | --- |
| fieldName | const System::String\& | The field's name to be filled. |
...
| fieldValues | const System::ArrayPtr\<System::String\>\& | A string array which contains several items to be selected. |
...
| --- | --- | --- |
| fieldName | const System::String\& | The field's name to be filled. |
| fieldValue | const System::String\& | The field's value which must be a valid value for some fields. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| fieldName | const System::String\& | Name of field |
| value | const System::String\& | New value of the field |
...
| Parameter | Type | Description |
| --- | --- | --- |
| fieldName | const System::String\& | Name of field to be filled. |
