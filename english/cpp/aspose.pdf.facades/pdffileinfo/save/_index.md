...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Facades::PdfFileInfo::Save(System::SharedPtr<System::IO::Stream> destStream) override
```
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Facades::PdfFileInfo::Save(System::String destFile) override
```
