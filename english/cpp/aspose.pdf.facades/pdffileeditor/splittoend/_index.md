...
description: 'Aspose::Pdf::Facades::PdfFileEditor::SplitToEnd method. Splits from location, and saves the rear part as a new file in C++.'
type: docs
weight: 5200
...
```cpp
ASPOSE_PDF_SHARED_API bool Aspose::Pdf::Facades::PdfFileEditor::SplitToEnd(System::String inputFile, int32_t location, System::String outputFile)
```
...
```cpp
ASPOSE_PDF_SHARED_API bool Aspose::Pdf::Facades::PdfFileEditor::SplitToEnd(System::SharedPtr<System::IO::Stream> inputStream, int32_t location, System::SharedPtr<System::IO::Stream> outputStream)
```
...
```cpp
ASPOSE_PDF_SHARED_API bool Aspose::Pdf::Facades::PdfFileEditor::SplitToEnd(System::SharedPtr<System::IO::Stream> inputStream, int32_t location, System::SharedPtr<System::Web::HttpResponse> response)
```
...
```cpp
ASPOSE_PDF_SHARED_API bool Aspose::Pdf::Facades::PdfFileEditor::SplitToEnd(System::String inputFile, int32_t location, System::SharedPtr<System::Web::HttpResponse> response)
```
