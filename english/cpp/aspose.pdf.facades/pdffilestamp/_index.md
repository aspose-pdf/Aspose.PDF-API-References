...
| Method | Description |
| --- | --- |
| [AddFooter](./addfooter/)(const System::SharedPtr\<FormattedText\>\&, float) | Adds footer to the pages of the document. |
| [AddFooter](./addfooter/)(const System::SharedPtr\<FormattedText\>\&, float, float, float) | Adds footer to the pages of the document. |
| [AddFooter](./addfooter/)(const System::String\&, float) | Adds image as footer to the pages of the document. |
| [AddFooter](./addfooter/)(const System::String\&, float, float, float) | Adds image as footer of the pages. |
| [AddFooter](./addfooter/)(const System::SharedPtr\<System::IO::Stream\>\&, float) | Adds image as footer of the page. |
| [AddFooter](./addfooter/)(const System::SharedPtr\<System::IO::Stream\>\&, float, float, float) | Adds image as footer of the page. |
| [AddHeader](./addheader/)(const System::SharedPtr\<FormattedText\>\&, float) | Adds header to the page. |
| [AddHeader](./addheader/)(const System::SharedPtr\<FormattedText\>\&, float, float, float) | Adds header to the pages of file. |
| [AddHeader](./addheader/)(const System::String\&, float) | Adds image as header to the pages of the file. |
| [AddHeader](./addheader/)(const System::String\&, float, float, float) | Adds image as header on the pages. |
| [AddHeader](./addheader/)(const System::SharedPtr\<System::IO::Stream\>\&, float) | Adds image as header on the pages. |
| [AddHeader](./addheader/)(const System::SharedPtr\<System::IO::Stream\>\&, float, float, float) | Adds image at the top of the page. |
| [AddPageNumber](./addpagenumber/)(const System::String\&) | Add page number to file. [Page](../../aspose.pdf/page/) number text may contain # sign which will be replaced with number of the page. [Page](../../aspose.pdf/page/) number is placed in the bottom of the page centered horizontally. |
| [AddPageNumber](./addpagenumber/)(const System::SharedPtr\<FormattedText\>\&) | Adds page number to the page. [Page](../../aspose.pdf/page/) number may contain # sign which will be replaced with page number. [Page](../../aspose.pdf/page/) number is placed in the bottom of the page centered horizontally. |
| [AddPageNumber](./addpagenumber/)(const System::String\&, int32_t, float, float, float, float) | Adds page number to the pages of document. |
| [AddPageNumber](./addpagenumber/)(const System::String\&, float, float) | Adds page number at the specified position on the page. |
| [AddPageNumber](./addpagenumber/)(const System::SharedPtr\<FormattedText\>\&, int32_t, float, float, float, float) | Adds page number to the pages of document. |
| [AddPageNumber](./addpagenumber/)(const System::SharedPtr\<FormattedText\>\&, float, float) | Adds page number at the specified position on the page. |
| [AddPageNumber](./addpagenumber/)(const System::String\&, int32_t) | Adds page number to the pages. |
| [AddPageNumber](./addpagenumber/)(const System::SharedPtr\<FormattedText\>\&, int32_t) | Adds page number to the pages. |
| [AddStamp](./addstamp/)(const System::SharedPtr\<Stamp\>\&) | Adds stamp to the file. |
...
| [PdfFileStamp](./pdffilestamp/)(const System::String\&, const System::String\&) | Constructor for [PdfFileStamp](./). |
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::SharedPtr\<System::IO::Stream\>\&) | Constructor for [PdfFileStamp](./). |
| [PdfFileStamp](./pdffilestamp/)(const System::String\&, const System::String\&, bool) | Constructor for [PdfFileStamp](./). |
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::SharedPtr\<System::IO::Stream\>\&, bool) | Constructor of [PdfFileStamp](./). |
...
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<Aspose::Pdf::Document\>\&) | Initializes new [PdfFileStamp](./) object on base of the *document* . |
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<Aspose::Pdf::Document\>\&, const System::String\&) | Initializes new [PdfFileStamp](./) object on base of the *document* . |
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<Aspose::Pdf::Document\>\&, const System::SharedPtr\<System::IO::Stream\>\&) | Initializes new [PdfFileStamp](./) object on base of the *document* . |
| [PdfFileStamp](./pdffilestamp/)(const System::SharedPtr\<System::IO::Stream\>\&, const System::SharedPtr\<System::Web::HttpResponse\>\&) | Creates [PdfFileStamp](./) which will save result into HttpResponse object. |
| [PdfFileStamp](./pdffilestamp/)(const System::String\&, const System::SharedPtr\<System::Web::HttpResponse\>\&) | Creates [PdfFileStamp](./) which will save result into HttpResponse object. |
...
| [set_InputFile](./set_inputfile/)(const System::String\&) | Sets name and path of input file. |
| [set_InputStream](./set_inputstream/)(const System::SharedPtr\<System::IO::Stream\>\&) | Sets input stream. |
...
| [set_OutputFile](./set_outputfile/)(const System::String\&) | Sets name and path of output file. |
| [set_OutputStream](./set_outputstream/)(const System::SharedPtr\<System::IO::Stream\>\&) | Sets output stream. |
