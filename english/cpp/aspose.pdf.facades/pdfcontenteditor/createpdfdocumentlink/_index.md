...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Facades::PdfContentEditor::CreatePdfDocumentLink(System::Drawing::Rectangle rect, System::String remotePdf, int32_t originalPage, int32_t destinationPage, System::Drawing::Color clr, System::ArrayPtr<System::SharedPtr<System::BoxedValueBase>> actionName)
```
...
<parameterlist kind="param">
  ...
  <parameteritem>
    ...
    <parameterdescription>
      <para>The PDF document which page will be opened.</para>
    </parameterdescription>
  </parameteritem>
  <parameteritem>
    <parameternamelist>
  ...
  <parameteritem>
    <parameternamelist>
      <parametername>destinationPage</parametername>
    </parameternamelist>
    <parameterdescription>
      <para>The destination page.</para>
    </parameterdescription>
  </parameteritem>
  <parameteritem>
    <parameternamelist>
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Facades::PdfContentEditor::CreatePdfDocumentLink(System::Drawing::Rectangle rect, System::String remotePdf, int32_t originalPage, int32_t destinationPage, System::Drawing::Color clr)
```
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::Facades::PdfContentEditor::CreatePdfDocumentLink(System::Drawing::Rectangle rect, System::String remotePdf, int32_t originalPage, int32_t destinationPage)
```
