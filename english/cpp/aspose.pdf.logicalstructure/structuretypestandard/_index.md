...
| static [to_StructureTypeStandard](./to_structuretypestandard/)(const System::String\&) | Performs an explicit conversion from [System::String](../../system/string/) to [Aspose::Pdf::LogicalStructure::StructureTypeStandard](./). |
