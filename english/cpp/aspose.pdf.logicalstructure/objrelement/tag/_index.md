...
```cpp
System::SharedPtr<MCRElement> Aspose::Pdf::LogicalStructure::OBJRElement::Tag(System::SharedPtr<Artifact> artifact) override
```
...
```cpp
System::SharedPtr<OBJRElement> Aspose::Pdf::LogicalStructure::OBJRElement::Tag(System::SharedPtr<XForm> form) override
```
...
```cpp
System::SharedPtr<OBJRElement> Aspose::Pdf::LogicalStructure::OBJRElement::Tag(System::SharedPtr<XImage> image) override
```
