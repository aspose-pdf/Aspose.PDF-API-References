---
title: Aspose::Pdf::LogicalStructure::LinkElement::SetText method
linktitle: SetText
...
```cpp
ASPOSE_PDF_SHARED_API void Aspose::Pdf::LogicalStructure::LinkElement::SetText(System::String text) override
```
