...
| static [to_StructureTypeCategory](./to_structuretypecategory/)(const System::String\&) | Performs an explicit conversion from [System::String](../../system/string/) to [Aspose::Pdf::LogicalStructure::StructureTypeCategory](./). |
