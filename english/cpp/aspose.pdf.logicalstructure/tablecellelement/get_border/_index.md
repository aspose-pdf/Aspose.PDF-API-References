---
title: Aspose::Pdf::LogicalStructure::TableCellElement::get_Border method
...
```cpp
ASPOSE_PDF_SHARED_API System::SharedPtr<BorderInfo> Aspose::Pdf::LogicalStructure::TableCellElement::get_Border() const
```
