---
title: Aspose::Pdf::Operators namespace
...
The **[Aspose.Pdf.Operators](./)** is a namespace for [Operator](../aspose.pdf/operator/) implementations. These classes describes operators used in PDF page contents.

## Classes

| Class | Description |
| --- | --- |
| [BasicSetColorAndPatternOperator](./basicsetcolorandpatternoperator/) | Base operator for all Set [Color](../aspose.pdf/color/) operators. |
| [BasicSetColorOperator](./basicsetcoloroperator/) | Base class for set color operators. |
| [BDC](./bdc/) | class representing [BDC](./bdc/) operator (Begin marked-content sequence) |
| [BI](./bi/) | Class representing [BI](./bi/) operator (Begin inline image obect). |
| [BlockTextOperator](./blocktextoperator/) | Abstract base class for text block operators i.e. Begin and End text operators (BT/ET) |
| [BMC](./bmc/) | Class representing [BMC](./bmc/) operator (Begin marked-content sequence). |
| [BT](./bt/) | Class representing [BT](./bt/) operator (Begin of text block). |
| [BX](./bx/) | Class representing [BX](./bx/) operator (begin compatibility section). |
...
| [Do](./do/) | Class representing [Do](./do/) operator (Invoke XObject). |
| [DP](./dp/) | Class represeting [DP](./dp/) operator (designamte marked content point). |
| [EI](./ei/) | Class representing [EI](./ei/) operator (End inline image object). |
| [EMC](./emc/) | Clsss representing [EMC](./emc/) oeprator (End of marked-content sequence). |
...
| [ET](./et/) | Class representing operator [ET](./et/) (End of text block). |
| [EX](./ex/) | Class representing [EX](./ex/) operator (End of compatibility section). |
...
| [ID](./id/) | Class representing [ID](./id/) operator (Begin inline image data). |
...
| [MP](./mp/) | Class representing [MP](./mp/) operator (define marked-content point). |
...
| [TextOperator](./textoperator/) | Abstract base class for text-related operators (TJ, Tj, Tm, [BT](./bt/), [ET](./et/), etc). |
