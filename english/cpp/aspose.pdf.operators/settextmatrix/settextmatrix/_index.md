...
```cpp
ASPOSE_PDF_SHARED_API Aspose::Pdf::Operators::SetTextMatrix::SetTextMatrix(double a, double b, double c, double d, double e, double f)
```
...
```cpp
ASPOSE_PDF_SHARED_API Aspose::Pdf::Operators::SetTextMatrix::SetTextMatrix(System::SharedPtr<Aspose::Pdf::Matrix> m)
```
...
<parameterlist kind="param">
  <parameteritem>
    ...
    <parameterdescription>
      <para>Transfomation matrix.</para>
    </parameterdescription>
  </parameteritem>
</parameterlist>
## See Also
