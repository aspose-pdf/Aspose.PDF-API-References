...
```cpp
void Aspose::Pdf::Comparison::GraphicalComparison::GraphicalPdfComparer::ComparePagesToPdf(System::SharedPtr<Page> page1, System::SharedPtr<Page> page2, System::SharedPtr<Document> pdfDocument)
```
...
```cpp
void Aspose::Pdf::Comparison::GraphicalComparison::GraphicalPdfComparer::ComparePagesToPdf(System::SharedPtr<Page> page1, System::SharedPtr<Page> page2, System::String resultPdfPath)
```
