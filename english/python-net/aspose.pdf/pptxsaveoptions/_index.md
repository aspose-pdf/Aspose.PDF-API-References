...
type: docs
weight: 1290
url: /python-net/aspose.pdf/pptxsaveoptions/
---
...
| Name | Description |
| :- | :- |
|PptxSaveOptions()|Initializes a new instance of the PptxSaveOptions class|
## Properties
| Name | Description |
| :- | :- |
...
|slides_as_images|If set to true then all the content is recognized as images (one per page)|
|image_resolution|Gets or sets the image resolution (dpi). Default is 192 dpi.|
|separate_images|If set to true then images are separated from all other graphics|
|optimize_text_boxes|Toggles text columns recognition|
