...
type: docs
weight: 460
url: /python-net/aspose.pdf/heading/
---
...
|toc_page|Gets the page that contains this heading.|
|top|Gets the top Y of this headings.|
|start_number|Gets the heading start number.|
|is_auto_sequence|Gets the heading should be numered automatically.|
|is_in_list|Gets the heading should be in toc list.|
|destination_page|Gets the destination page.|
|level|Gets the level.|
|style|Gets or sets style.|
|user_label|Gets or sets user label.|
## Methods
| Name | Description |
| :- | :- |
