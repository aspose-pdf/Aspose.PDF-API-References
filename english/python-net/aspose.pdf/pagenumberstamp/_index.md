...
type: docs
weight: 1140
url: /python-net/aspose.pdf/pagenumberstamp/
---
...
| Name | Description |
| :- | :- |
|PageNumberStamp(format)|Initializes a new instance of the PageNumberStamp class|
|PageNumberStamp()|Initializes a new instance of the [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/) class. Format is set to "#".|
|PageNumberStamp(formatted_text)|Initializes a new instance of the PageNumberStamp class|
## Properties
| Name | Description |
| :- | :- |
...
|format|String value for stamping page numbers. <br/>            Value must include char '#' which is replaced with the page number in the process of stamping.|
|starting_number|Gets or sets value of the number of starting page. Other pages will be numbered starting from this value.|
|numbering_style|Numbering style which used by this stamp.|
## Methods
| Name | Description |
| :- | :- |
|put(page)|Adds page number.|
