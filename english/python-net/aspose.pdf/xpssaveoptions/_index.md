...
type: docs
weight: 1810
url: /python-net/aspose.pdf/xpssaveoptions/
---
...
| Name | Description |
| :- | :- |
|XpsSaveOptions()|Initializes a new instance of the XpsSaveOptions class|
## Properties
| Name | Description |
| :- | :- |
...
|save_transparent_texts|Indicates whether to preserve transparent (OCR'ed) text.|
