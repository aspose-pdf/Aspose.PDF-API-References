...
description: This class represents saving options for saving that <br/>            uses unified conversion way (with unified internal document model)
type: docs
weight: 1590
url: /python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

This class represents saving options for saving that <br/>            uses unified conversion way (with unified internal document model)

The UnifiedSaveOptions type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|UnifiedSaveOptions()|Initializes a new instance of the UnifiedSaveOptions class|
## Properties
| Name | Description |
| :- | :- |
