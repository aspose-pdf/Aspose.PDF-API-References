...
type: docs
weight: 80
url: /python-net/aspose.pdf.devices/jpegdevice/
---
...
| Name | Description |
| :- | :- |
|JpegDevice()|Initializes a new instance of the [JpegDevice](/pdf/python-net/aspose.pdf.devices/jpegdevice/) class with default resolution and maximum quality.|
...
|resolution|Gets image resolution.|
|width|Gets image output width.|
|height|Gets image output height.|
## Methods
| Name | Description |
| :- | :- |
