...
type: docs
weight: 620
url: /python-net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
...
The TableRowCollectionElement type exposes the following members:
## Properties
| Name | Description |
| :- | :- |
|parent_element|None|
...
|create_tr()|Creates [TableTRElement](/pdf/python-net/aspose.pdf.logicalstructure/tabletrelement/) and added it to current table.|
