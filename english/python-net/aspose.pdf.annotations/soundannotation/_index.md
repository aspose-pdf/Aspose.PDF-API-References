...
type: docs
weight: 740
url: /python-net/aspose.pdf.annotations/soundannotation/
---
...
| Name | Description |
| :- | :- |
|SoundAnnotation(page, rect, sound_file)|Initializes a new instance of the SoundAnnotation class|
|SoundAnnotation(page, rect, sound_file, sound_sample_data)|Initializes a new instance of the SoundAnnotation class|
## Properties
| Name | Description |
| :- | :- |
...
|icon|Gets or sets an icon to be used in displaying the annotation.|
|sound_data|Gets a sound object defining the sound to be played when the annotation is activated.|
## Methods
| Name | Description |
| :- | :- |
|clone()|None|
