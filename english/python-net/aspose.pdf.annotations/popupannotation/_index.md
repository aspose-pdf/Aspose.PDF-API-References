...
type: docs
weight: 670
url: /python-net/aspose.pdf.annotations/popupannotation/
---
...
The PopupAnnotation type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|PopupAnnotation(document)|Initializes a new instance of the PopupAnnotation class|
|PopupAnnotation(page, rect)|Initializes a new instance of the PopupAnnotation class|
## Properties
| Name | Description |
| :- | :- |
...
|open|Gets or sets a flag specifying whether the pop-up annotation should initially be displayed open.|
|parent|Gets or sets the parent annotation with which this pop-up annotation shall be associated.<br/>            If this entry is present, the parent annotation�s Contents, M, C, and T entries shall override those of the pop-up annotation itself.|
## Methods
| Name | Description |
| :- | :- |
