...
type: docs
weight: 710
url: /python-net/aspose.pdf.annotations/richmediaannotation/
---
...
The RichMediaAnnotation type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|RichMediaAnnotation(page, rect)|Initializes a new instance of the RichMediaAnnotation class|
## Properties
| Name | Description |
| :- | :- |
...
|custom_player|Sets or gets custom flash player to play video/audio data.|
|custom_flash_variables|Sets or gets flash variables which passed to player.|
|content|Data of the Rich Media content.|
|type|Gets or sets type of content. Possible values: Audio, Video.|
|activate_on|Event which activates application.|
## Methods
| Name | Description |
| :- | :- |
...
|accept(visitor)|Accepts visitor for this annotation.|
...
|add_custom_data(name, data)|Add custom named data (for example required for flash script).|
|set_content(file_name, audio)|Set content stream.|
|set_poster(image_stream)|Set poster of the annotation.|
