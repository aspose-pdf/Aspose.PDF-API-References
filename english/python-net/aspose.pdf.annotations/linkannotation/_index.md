...
type: docs
weight: 390
url: /python-net/aspose.pdf.annotations/linkannotation/
---
...
|action|An action to be performed when the link annotation is activated.|
|destination|A destination to be displayed when the annotation is activated.|
|highlighting|The visual effect to be used when the mouse button is pressed or held down inside its active area.|
## Methods
| Name | Description |
| :- | :- |
