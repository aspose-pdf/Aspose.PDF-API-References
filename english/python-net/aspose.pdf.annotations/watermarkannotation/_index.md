...
type: docs
weight: 860
url: /python-net/aspose.pdf.annotations/watermarkannotation/
---
...
| Name | Description |
| :- | :- |
|WatermarkAnnotation(page, rect)|Initializes a new instance of the WatermarkAnnotation class|
## Properties
| Name | Description |
| :- | :- |
...
|annotation_type|Gets annotation type.|
...
|fixed_print|Fuxed print object of Watermark annotation.|
|opacity|Gets or sets opacity of the annotation.|
## Methods
| Name | Description |
| :- | :- |
...
|accept(visitor)|Apply visitor for annotation.|
...
|set_text(text)|Set text of the annotation.|
|set_text_and_state(text, text_state)|Set text of the annotation.|
