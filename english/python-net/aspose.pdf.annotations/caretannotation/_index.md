...
type: docs
weight: 80
url: /python-net/aspose.pdf.annotations/caretannotation/
---
...
The CaretAnnotation type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|CaretAnnotation(document)|Initializes a new instance of the CaretAnnotation class|
|CaretAnnotation(page, rect)|Initializes a new instance of the CaretAnnotation class|
## Properties
| Name | Description |
| :- | :- |
...
|frame|Gets or sets caret rectangle.|
|symbol|Gets or sets symbol associated with caret.|
## Methods
| Name | Description |
| :- | :- |
|clone()|None|
