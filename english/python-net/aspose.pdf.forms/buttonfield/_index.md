...
type: docs
weight: 20
url: /python-net/aspose.pdf.forms/buttonfield/
---
...
|ButtonField(page, rect)|Initializes a new instance of the ButtonField class|
|ButtonField(doc, rect)|Initializes a new instance of the ButtonField class|
## Properties
| Name | Description |
| :- | :- |
...
|normal_caption|Gets or sets normal caption.|
|rollover_caption|Gets or sets rollover caption of button which shall be displayed when the user rolls the cursor <br/>            into its active area without pressing the mouse button.|
|alternate_caption|Gets or sets alternate caption of the button which shall be displayed <br/>            when the mouse button is pressed within its active area.|
|normal_icon|Gets or sets normal icon of the button which shall be displayed when it is not interacting with the user.|
|rollover_icon|Gets or sets rollover icon of the button which shall be displayed when the user <br/>            rolls the cursor into its active area without pressing the mouse button.|
|alternate_icon|Gets or sets alternate icon which shall be displayed when the mouse button is pressed within its active area.|
|icon_fit|Gets icon fit object specifying how the widget annotation's icon shall be displayed within its annotation rectangle.|
|ic_position|Gets or sets icon caption position.|
## Indexer
| Name | Description |
| :- | :- |
