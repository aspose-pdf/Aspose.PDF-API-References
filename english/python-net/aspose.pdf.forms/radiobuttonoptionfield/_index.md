...
type: docs
weight: 230
url: /python-net/aspose.pdf.forms/radiobuttonoptionfield/
---
...
The RadioButtonOptionField type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|RadioButtonOptionField()|Create new RadioButtonOptionField instance.|
|RadioButtonOptionField(page, rect)|Initializes a new instance of the RadioButtonOptionField class|
## Properties
| Name | Description |
| :- | :- |
...
|option_name|Gets or sets name of the option.|
