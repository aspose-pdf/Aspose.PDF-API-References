...
type: docs
weight: 150
url: /python-net/aspose.pdf.forms/numberfield/
---
...
The NumberField type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|NumberField()|Initializes a new instance of the [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/) class.|
|NumberField(page, rect)|Initializes a new instance of the NumberField class|
|NumberField(doc, rect)|Initializes a new instance of the NumberField class|
## Properties
| Name | Description |
| :- | :- |
...
|allowed_chars|Gets or sets the allowed chars.|
## Indexer
| Name | Description |
| :- | :- |
