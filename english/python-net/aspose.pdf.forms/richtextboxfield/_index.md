...
type: docs
weight: 240
url: /python-net/aspose.pdf.forms/richtextboxfield/
---
...
The RichTextBoxField type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|RichTextBoxField(page, rect)|Initializes a new instance of the RichTextBoxField class|
## Properties
| Name | Description |
| :- | :- |
...
|style|Gets or sets default style string of the rich text field.|
|rich_text_value|Gets or sets rich text value.|
|formatted_value|Gets or sets formatted rich text value with markup.|
|justify|Gets or sets justification of the rich text box.|
## Indexer
| Name | Description |
| :- | :- |
