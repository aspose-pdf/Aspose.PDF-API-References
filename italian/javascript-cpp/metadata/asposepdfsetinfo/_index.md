...
description: "Imposta le informazioni (metadati) in un file PDF."
type: docs
url: /it/javascript-cpp/metadata/asposepdfsetinfo/
---

_Imposta informazioni (metadati) in un file PDF._
...
Per 'title', 'creator', 'author', 'subject', 'keywords', 'creation' e 'mod', se non è necessario impostare un valore, usa undefined o "" (stringa vuota)
