...
second_title: "Aspose.PDF per JavaScript via C++"
description: "Sostituisci più frammenti di testo in un file PDF con controllo dell'allineamento."
type: docs
url: /it/javascript-cpp/organize/asposepdfreplacetextex/
---

_Sostituisci più frammenti di testo in un file PDF con controllo dell'allineamento._
...
La direzione può anche essere forzata esplicitamente anteponendo `replaceText`
con caratteri Unicode speciali:
`\u200F` (RTL) o `\u200E` (LTR), preferibilmente come primo carattere
