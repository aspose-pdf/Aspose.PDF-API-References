...
description: "Classe che rappresenta l'operatore k (imposta il colore CMYK per le operazioni senza tracciatura)."
type: docs
weight: 530
url: /it/java/com.aspose.pdf.operators/setcmykcolor/
---
**Inheritance:**
...
Classe che rappresenta l'operatore k (imposta il colore CMYK per le operazioni senza tracciatura).
...
| [getColor](#getColor--) | Restituisce il colore. |
