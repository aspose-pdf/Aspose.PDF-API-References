...
description: "Questa classe è usata per selezionare gli operatori utilizzando l'idea del modello Visitor."
type: docs
weight: 3200
url: /it/java/com.aspose.pdf/operatorselector/
---
**Inheritance:**
...
Questa classe è usata per selezionare gli operatori utilizzando l'idea del modello Visitor.

## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [OperatorSelector](#OperatorSelector--) | Inizializza una nuova istanza della classe {@code Selector}. |
| [OperatorSelector](#OperatorSelector-com.aspose.pdf.Operator-) | Inizializza una nuova istanza della classe {@code Selector}. |
...
Inizializza una nuova istanza della classe {@code Selector}.
