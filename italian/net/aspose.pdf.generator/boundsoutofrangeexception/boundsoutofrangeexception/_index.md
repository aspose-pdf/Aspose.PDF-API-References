...
Inizializza una nuova istanza della classe [`BoundsOutOfRangeException`](../).
...
Inizializza una nuova istanza della classe [`BoundsOutOfRangeException`](../) con un messaggio di errore specificato.
