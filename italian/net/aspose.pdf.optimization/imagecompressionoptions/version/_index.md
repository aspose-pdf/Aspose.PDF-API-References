...
description: Proprietà ImageCompressionOptions. Versione dell'algoritmo di compressione. I valori possibili sono 1. compressione standard 2. compressione veloce migliorata che è più veloce della standard ma potrebbe non essere applicabile a tutte le immagini 3. compressione standard mista applicata a immagini che non possono essere compresse dall'algoritmo più veloce, questo può dare la migliore compressione ma è più lento dell'algoritmo "veloce". La versione "Veloce" non è applicabile per il ridimensionamento delle immagini (verrà utilizzato il metodo standard). Predefinito è "Standard".
type: docs
weight: 70
