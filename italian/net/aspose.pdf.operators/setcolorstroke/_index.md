...
description: "Classe Aspose.Pdf.Operators.SetColorStroke. Classe che rappresenta l'operatore SC per impostare il colore per gli operatori di tratto"
type: docs
weight: 7820
...
Classe che rappresenta l'operatore SC (imposta il colore per gli operatori di tracciatura del colore).
...
| [SetColorStroke](setcolorstroke/#constructor_1)(double) | Imposta il colore per gli operatori di tratto per gli spazi colore DeviceGray, CalGray e Indexed. |
| [SetColorStroke](setcolorstroke/#constructor_4)(double[]) | Costruttore che consente di impostare i componenti del colore. |
| [SetColorStroke](setcolorstroke/#constructor_2)(double, double, double) | Imposta il colore per l'operatore di tratto per gli spazi colore DeviceRGB, CalRGB e Lab |
| [SetColorStroke](setcolorstroke/#constructor_3)(double, double, double, double) | Imposta il colore per l'operatore di tratto per lo spazio colore CMYK |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/setcolorstroke/accept/)(IOperatorSelector) | Accetta un oggetto visitor per elaborare l'operatore. |
