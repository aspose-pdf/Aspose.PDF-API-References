...
description: Memorizza lallegato nel file.
type: docs
weight: 140
...
| --- | --- | --- |
| outputPath | String | Percorso della directory in cui verranno archiviati gli allegati. Stringa nulla o vuota significa che gli allegati verranno inseriti nella directory dell'applicazione. |
...
Salva tutti i file allegati negli stream.
...
L'array stream del file allegato nel documento pdf.
