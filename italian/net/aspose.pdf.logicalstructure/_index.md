...
---
Il **Aspose.Pdf.Tagged.LogicalStructure** è uno spazio dei nomi per le classi di Struttura Logica PDF.
...
| [BLSTextElement](./blstextelement/) | Rappresenta una classe base per gli elementi di struttura di testo a livello di blocco nella struttura logica. |
| [CaptionElement](./captionelement/) | Rappresenta l'elemento di struttura Caption nella struttura logica. |
| [CodeElement](./codeelement/) | Rappresenta l'elemento di struttura Code nella struttura logica. |
| [DivElement](./divelement/) | Rappresenta l'elemento di struttura Div nella struttura logica. |
| [DocumentElement](./documentelement/) | Rappresenta l'elemento di struttura Document nella struttura logica. |
| [Element](./element/) | Rappresenta una classe base per l'elemento nella struttura logica. |
| [ElementList](./elementlist/) | Rappresenta una collezione ordinata di elementi. |
| [FigureElement](./figureelement/) | Rappresenta l'elemento di struttura Figure nella struttura logica. |
| [FormElement](./formelement/) | Rappresenta l'elemento di struttura Form nella struttura logica. |
| [FormulaElement](./formulaelement/) | Rappresenta l'elemento di struttura Formula nella struttura logica. |
| [GroupingElement](./groupingelement/) | Rappresenta una classe base per gli elementi di struttura di raggruppamento nella struttura logica. |
| [HeaderElement](./headerelement/) | Rappresenta l'elemento di struttura Header nella struttura logica. |
| [IllustrationElement](./illustrationelement/) | Rappresenta una classe base per gli elementi di struttura di illustrazione nella struttura logica. |
| [ILSElement](./ilselement/) | Rappresenta una classe base per gli elementi di struttura a livello inline nella struttura logica. |
...
| [ParagraphElement](./paragraphelement/) | Rappresenta l'elemento di struttura Paragraph nella struttura logica. |
| [PartElement](./partelement/) | Rappresenta l'elemento di struttura Part nella struttura logica. |
| [PrivateElement](./privateelement/) | Rappresenta l'elemento di struttura Private nella struttura logica. |
| [QuoteElement](./quoteelement/) | Rappresenta l'elemento di struttura Quote nella struttura logica. |
| [ReferenceElement](./referenceelement/) | Rappresenta l'elemento di struttura Reference nella struttura logica. |
| [RubyChildElement](./rubychildelement/) | Rappresenta una classe base per gli elementi figli del Ruby nella struttura logica. |
| [RubyElement](./rubyelement/) | Rappresenta l'elemento di struttura Ruby nella struttura logica. |
| [RubyRBElement](./rubyrbelement/) | Rappresenta l'elemento di struttura RB nella struttura logica del Ruby. |
| [RubyRPElement](./rubyrpelement/) | Rappresenta l'elemento di struttura RP nella struttura logica del Ruby. |
| [RubyRTElement](./rubyrtelement/) | Rappresenta l'elemento di struttura RT nella struttura logica del Ruby. |
| [SectElement](./sectelement/) | Rappresenta l'elemento di struttura Sect nella struttura logica. |
...
| [TableTHeadElement](./tabletheadelement/) | Rappresenta l'elemento di struttura THead nella struttura logica della tabella. |
| [TableTHElement](./tablethelement/) | Rappresenta l'elemento di struttura TH nella struttura logica della tabella. |
| [TableTRElement](./tabletrelement/) | Rappresenta l'elemento di struttura TR nella struttura logica della tabella. |
| [TOCElement](./tocelement/) | Rappresenta l'elemento di struttura TOC nella struttura logica. |
| [TOCIElement](./tocielement/) | Rappresenta l'elemento di struttura TOCI nella struttura logica. |
| [WarichuChildElement](./warichuchildelement/) | Rappresenta una classe base per gli elementi figli del Warichu nella struttura logica. |
| [WarichuElement](./warichuelement/) | Rappresenta l'elemento di struttura Warichu nella struttura logica. |
| [WarichuWPElement](./warichuwpelement/) | Rappresenta l'elemento di struttura WP nella struttura logica del Warichu. |
| [WarichuWTElement](./warichuwtelement/) | Rappresenta l'elemento di struttura WT nella struttura logica del Warichu. |
## Interfacce
