...
description: Rappresenta una classe base per gli elementi figli del Tavolo Testa Corpo e Piede nella struttura logica.
type: docs
weight: 4620
...
Rappresenta una classe base per gli elementi figli del Tavolo Testa, Corpo e Piede nella struttura logica.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | Crea[`TableTRElement`](../tabletrelement) e l'ho aggiunto alla tabella corrente. |
