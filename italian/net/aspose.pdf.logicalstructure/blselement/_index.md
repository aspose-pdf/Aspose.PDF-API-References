...
description: Classe Aspose.Pdf.LogicalStructure.BLSElement. Rappresenta una classe base per elementi di struttura a livello di blocco nella struttura logica
type: docs
weight: 6240
url: /it/net/aspose.pdf.logicalstructure/blselement/
---
## Classe BLSElement

Rappresenta una classe base per elementi di struttura a livello di blocco nella struttura logica.
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XForm) | Collega un elemento di struttura all'XForm del flusso di contenuto. |
