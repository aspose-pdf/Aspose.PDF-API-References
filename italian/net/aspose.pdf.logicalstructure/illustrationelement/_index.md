...
description: "Aspose.Pdf.LogicalStructure.IllustrationElement classe. Rappresenta una classe base per gli elementi di struttura di illustrazione nella struttura logica"
type: docs
weight: 6560
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | Aggiunge immagine all'elemento di illustrazione corrente. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | Aggiunge immagine all'elemento di illustrazione corrente. |
