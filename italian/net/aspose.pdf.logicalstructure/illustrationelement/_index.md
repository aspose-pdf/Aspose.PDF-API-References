...
description: Rappresenta una classe base per gli elementi della struttura dellillustrazione nella struttura logica.
type: docs
weight: 4250
...
Rappresenta una classe base per gli elementi della struttura dell'illustrazione nella struttura logica.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage)(string, double) | Aggiunge l'immagine all'elemento dell'illustrazione corrente. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage_1)(string, double, double) | Aggiunge l'immagine all'elemento dell'illustrazione corrente. |
