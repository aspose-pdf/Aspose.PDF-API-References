...
description: "Metodo OBJRElement. Associa un elemento di struttura all'operatore BDC del flusso di contenuto"
type: docs
weight: 10
url: /it/net/aspose.pdf.logicalstructure/objrelement/tag/
---
## Tag(BDC) {#tag_1}
