...
description: Rappresenta una classe base per gli elementi della struttura del testo a livello di blocco nella struttura logica.
type: docs
weight: 4080
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate) { get; } | OttieneStructureTextState oggetto per l'elemento corrente. |
...
| [SetText](../../aspose.pdf.logicalstructure/blstextelement/settext)(string) | Aggiunge contenuto di testo all'elemento di testo corrente. |
