...
description: Classe Aspose.Pdf.LogicalStructure.BLSTextElement. Rappresenta una classe base per gli elementi della struttura del testo a livello di blocco nella struttura logica
type: docs
weight: 6250
...
Rappresenta una classe base per gli elementi della struttura del testo a livello di blocco nella struttura logica.
