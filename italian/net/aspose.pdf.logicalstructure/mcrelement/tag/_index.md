...
description: "Metodo MCRElement. Associa un elemento di struttura al flusso di contenuto tramite l'operatore BDC"
type: docs
weight: 20
url: /it/net/aspose.pdf.logicalstructure/mcrelement/tag/
---
## Tag(BDC) {#tag_1}
