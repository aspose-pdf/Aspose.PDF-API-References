...
description: Rappresenta una classe base per gli elementi figli dellelenco nella struttura logica.
type: docs
weight: 4280
...
Rappresenta una classe base per gli elementi figli dell'elenco nella struttura logica.
