...
description: Classe Aspose.Pdf.LogicalStructure.BlockQuoteElement. Rappresenta l'elemento di struttura BlockQuote nella struttura logica
type: docs
weight: 6270
url: /it/net/aspose.pdf.logicalstructure/blockquoteelement/
---
## Classe BlockQuoteElement
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Rimuove un elemento dalla struttura, un riferimento ad esso dall'oggetto padre, riferimenti ad esso dagli oggetti figli, e l'oggetto corrispondente dal documento. Inserisce gli oggetti figli dell'oggetto rimosso nella collezione di oggetti figli del suo ex elemento padre a partire dall'indice dell'oggetto rimosso. |
