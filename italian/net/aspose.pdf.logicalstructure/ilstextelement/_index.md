...
description: Classe Aspose.Pdf.LogicalStructure.ILSTextElement. Rappresenta una classe base per gli elementi della struttura del testo a livello inline nella struttura logica
type: docs
weight: 6400
url: /it/net/aspose.pdf.logicalstructure/ilstextelement/
---
## Classe ILSTextElement

Rappresenta una classe base per gli elementi della struttura del testo a livello inline nella struttura logica.
