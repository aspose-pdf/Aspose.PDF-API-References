...
description: Rappresenta lelemento della struttura TH nella struttura logica della tabella.
type: docs
weight: 4660
url: /it/net/aspose.pdf.logicalstructure/tablethelement/
---
## TableTHElement class

Rappresenta l'elemento della struttura TH nella struttura logica della tabella.
...
| [DefaultCellTextState](../../aspose.pdf.logicalstructure/tablecellelement/defaultcelltextstate) { get; set; } | Ottiene o imposta lo stato predefinito del testo della cella. |
...
| [IsNoBorder](../../aspose.pdf.logicalstructure/tablecellelement/isnoborder) { get; set; } | Ottiene o imposta la cella con bordo. |
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped) { get; set; } | Ottiene o imposta il testo della cella a capo automatico. |
...
| [Margin](../../aspose.pdf.logicalstructure/tablecellelement/margin) { get; set; } | Ottiene o imposta il riempimento. |
| [ParentElement](../../aspose.pdf.logicalstructure/element/parentelement) { get; } | Ottieni elemento padre. |
| [RowSpan](../../aspose.pdf.logicalstructure/tablecellelement/rowspan) { get; set; } | Ottiene o imposta l'intervallo di righe. |
| [StructureTextState](../../aspose.pdf.logicalstructure/tablecellelement/structuretextstate) { get; } | OttieneStructureTextState oggetto per l'elemento corrente. |
...
| [SetText](../../aspose.pdf.logicalstructure/tablecellelement/settext)(string) | Aggiunge contenuto di testo all'elemento di testo corrente. |
