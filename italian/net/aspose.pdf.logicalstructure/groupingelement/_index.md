...
description: Classe Aspose.Pdf.LogicalStructure.GroupingElement. Rappresenta una classe base per gli elementi di struttura di raggruppamento nella struttura logica
type: docs
weight: 6370
