---
title: "Classe TableCellElement"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Classe Aspose.Pdf.LogicalStructure.TableCellElement. Rappresenta una classe base per gli elementi cella di tabella TH e TD nella struttura logica"
type: docs
weight: 6900
url: /it/net/aspose.pdf.logicalstructure/tablecellelement/
---
## TableCellElement class

Rappresenta una classe base per gli elementi cella della tabella (TH e TD) nella struttura logica.
...
| [DefaultCellTextState](../../aspose.pdf.logicalstructure/tablecellelement/defaultcelltextstate/) { get; set; } | Ottiene o imposta lo stato di testo predefinito della cella. |
...
| [IsNoBorder](../../aspose.pdf.logicalstructure/tablecellelement/isnoborder/) { get; set; } | Ottiene o imposta se la cella ha il bordo. |
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped/) { get; set; } | Ottiene o imposta il testo della cella con interruzione di riga. |
