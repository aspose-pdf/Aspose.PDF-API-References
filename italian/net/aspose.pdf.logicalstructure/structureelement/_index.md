...
description: "Aspose.Pdf.LogicalStructure.StructureElement classe. Rappresenta una classe base per gli elementi di struttura nella struttura logica"
type: docs
weight: 6840
url: /it/net/aspose.pdf.logicalstructure/structureelement/
---
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_2)(Annotation) | Associa un elemento di struttura all'Annotation. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag)(Artifact) | Associa un elemento di struttura all'Artifact. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_1)(BDC) | Associa un elemento di struttura all'operatore BDC del flusso di contenuto. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_3)(XForm) | Associa un elemento di struttura al XForm del flusso di contenuto. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_4)(XImage) | Associa un elemento di struttura al XImage. |
