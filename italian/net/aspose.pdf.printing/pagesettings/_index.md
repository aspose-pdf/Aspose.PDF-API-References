...
| Nome | Descrizione |
| --- | --- |
| [PageSettings](pagesettings/#constructor)() | Inizializza una nuova istanza della classe `PageSettings` utilizzando la stampante predefinita. |
| [PageSettings](pagesettings/#constructor_1)(PrinterSettings) | Inizializza una nuova istanza della classe `PageSettings` utilizzando la stampante specificata. |
