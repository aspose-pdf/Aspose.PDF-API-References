...
| Number9Envelope | `19` | Busta #9 (3.875 in. per 8.875 in.). |
| Number10Envelope | `20` | Busta #10 (4.125 in. per 9.5 in.). |
| Number11Envelope | `21` | Busta #11 (4.5 in. per 10.375 in.). |
| Number12Envelope | `22` | Busta #12 (4.75 in. per 11 in.). |
| Number14Envelope | `23` | Busta #14 (5 in. per 11.5 in.). |
| CSheet | `24` | Carta C (17 in. per 22 in.). |
| DSheet | `25` | Carta D (22 in. per 34 in.). |
| ESheet | `26` | Carta E (34 in. per 44 in.). |
| DLEnvelope | `27` | Busta DL (110 mm per 220 mm). |
| C5Envelope | `28` | Busta C5 (162 mm per 229 mm). |
| C3Envelope | `29` | Busta C3 (324 mm per 458 mm). |
| C4Envelope | `30` | Busta C4 (229 mm per 324 mm). |
| C6Envelope | `31` | Busta C6 (114 mm per 162 mm). |
| C65Envelope | `32` | Busta C65 (114 mm per 229 mm). |
| B4Envelope | `33` | Busta B4 (250 mm per 353 mm). |
| B5Envelope | `34` | Busta B5 (176 mm per 250 mm). |
| B6Envelope | `35` | Busta B6 (176 mm per 125 mm). |
...
| JapaneseDoublePostcard | `69` | Cartolina doppia giapponese (200 mm per 148 mm). |
| A6 | `70` | Carta A6 (105 mm per 148 mm). |
| JapaneseEnvelopeKakuNumber2 | `71` | Busta giapponese Kaku #2. |
...
| JapaneseEnvelopeChouNumber3Rotated | `86` | Busta giapponese Chou #3 ruotata. |
...
| PrcEnvelopeNumber4 | `99` | Busta #4 (110 mm per 208 mm). |
| PrcEnvelopeNumber5 | `100` | Busta #5 (110 mm per 220 mm). |
| PrcEnvelopeNumber6 | `101` | Busta #6 (120 mm per 230 mm). |
| PrcEnvelopeNumber7 | `102` | Busta #7 (160 mm per 230 mm). |
| PrcEnvelopeNumber8 | `103` | Busta #8 (120 mm per 309 mm). |
| PrcEnvelopeNumber9 | `104` | Busta #9 (229 mm per 324 mm). |
...
| PrcEnvelopeNumber4Rotated | `112` | Busta #4 ruotata (208 mm per 110 mm). |
| PrcEnvelopeNumber5Rotated | `113` | Busta #5 ruotata (220 mm per 110 mm). |
