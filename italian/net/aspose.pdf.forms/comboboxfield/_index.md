...
description: Classe Aspose.Pdf.Forms.ComboBoxField. Classe che rappresenta il campo Combobox del modulo
type: docs
weight: 5000
url: /it/net/aspose.pdf.forms/comboboxfield/
---
## Classe ComboBoxField

Classe che rappresenta il campo Combobox del modulo.
...
| Nome | Descrizione |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Costruttore per ComboBoxField da utilizzare in Generator. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Crea un campo CombBox da utilizzare con Generator. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Costruttore per il campo Combobox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Costruttore per il campo Combobox. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Ottiene o imposta lo stato di modifica del campo. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Ottiene o imposta l'indice dell'opzione selezionata. Questa proprietà consente di cambiare la selezione. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Ottiene o imposta un array di elementi selezionati. Per l'elenco di selezione multipla, l'array contiene più di un elemento. Per l'elenco di selezione singola, contiene un solo elemento. |
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Ottiene o imposta lo stato di attività di controllo ortografico. |
