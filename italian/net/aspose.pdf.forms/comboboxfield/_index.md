...
description: Classe che rappresenta il campo Combobox del form.
type: docs
weight: 2950
...
Classe che rappresenta il campo Combobox del form.
...
| [ComboBoxField](comboboxfield#constructor_1)(Document) | Crea il campo CombBox per funzionare con Generator. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | Costruttore per campo Combobox. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | Costruttore per campo Combobox. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck) { get; set; } | Ottiene o imposta lo stato dell'attività di spellchaeck. |
