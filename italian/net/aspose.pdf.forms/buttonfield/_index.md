...
description: Classe Aspose.Pdf.Forms.ButtonField. Classe rappresenta un campo pulsante
type: docs
weight: 4970
url: /it/net/aspose.pdf.forms/buttonfield/
---
## Classe ButtonField

Classe rappresenta un campo pulsante.
...
| Nome | Descrizione |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Costruttore del campo pulsante per il Generatore. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | Costruttore di ButtonField. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | Costruttore di ButtonField. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Ottiene o imposta la didascalia alternativa del pulsante che sarà visualizzata quando il pulsante del mouse è premuto all'interno della sua area attiva. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Ottiene o imposta l'icona alternativa che sarà visualizzata quando il pulsante del mouse è premuto all'interno della sua area attiva. |
| [AlternateName](../../aspose.pdf.forms/field/alternatename/) { get; set; } | Ottiene o imposta il nome alternativo del campo (Un nome di campo alternativo che sarà utilizzato al posto del nome del campo effettivo ovunque il campo sarà identificato nell'interfaccia utente). Il nome alternativo è utilizzato come tooltip del campo in Adobe Acrobat. |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | Ottiene il numero di sotto-campi in questo campo. (Ad esempio, numero di elementi nel campo del pulsante radio). |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Ottiene l'oggetto di adattamento dell'icona che specifica come l'icona dell'annotazione widget deve essere visualizzata all'interno del suo rettangolo di annotazione. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Ottiene o imposta la posizione della didascalia dell'icona. |
...
| [MappingName](../../aspose.pdf.forms/field/mappingname/) { get; set; } | Ottiene o imposta il nome di mapping del campo che sarà utilizzato quando si esportano i dati del campo del modulo interattivo dal documento. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Ottiene o imposta la didascalia normale. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Ottiene o imposta l'icona normale del pulsante che sarà visualizzata quando non interagisce con l'utente. |
| [OnActivated](../../aspose.pdf.annotations/widgetannotation/onactivated/) { get; set; } | Un'azione che sarà eseguita quando l'annotazione è attivata. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Ottiene o imposta la didascalia rollover del pulsante che sarà visualizzata quando l'utente sposta il cursore nella sua area attiva senza premere il pulsante del mouse. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Ottiene o imposta l'icona rollover del pulsante che sarà visualizzata quando l'utente sposta il cursore nella sua area attiva senza premere il pulsante del mouse. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Aggiunge un'immagine alle risorse del campo e la disegna. |
