...
description: "Classe Aspose.Pdf.Forms.ButtonField. La classe rappresenta un campo pulsante."
type: docs
weight: 5090
...
Classe che rappresenta il campo pulsante.
...
| Nome | Descrizione |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Costruttore del campo pulsante per Generator. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | Costruttore ButtonField. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | Costruttore ButtonField. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Ottiene o imposta la didascalia alternativa del pulsante che deve essere visualizzata quando il pulsante del mouse è premuto all'interno della sua area attiva. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Ottiene o imposta l'icona alternativa che deve essere visualizzata quando il pulsante del mouse è premuto all'interno della sua area attiva. |
...
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Ottiene o imposta l'icona normale del pulsante che deve essere visualizzata quando non è in interazione con l'utente. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Ottiene o imposta la didascalia rollover del pulsante che deve essere visualizzata quando l'utente sposta il cursore nella sua area attiva senza premere il pulsante del mouse. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Ottiene o imposta l'icona rollover del pulsante che deve essere visualizzata quando l'utente sposta il cursore nella sua area attiva senza premere il pulsante del mouse. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Aggiunge un'immagine nelle risorse del campo e la disegna. |
