...
description: La classe rappresenta lelemento del campo RadioButton.
type: docs
weight: 3170
...
La classe rappresenta l'elemento del campo RadioButton.
...
| Nome | Descrizione |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | Crea nuova istanza RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | Crea il pulsante di opzione nel rengle specificato nella pagina specificata. |
