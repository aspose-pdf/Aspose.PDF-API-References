...
description: "Classe Aspose.Pdf.Forms.RadioButtonOptionField. La classe rappresenta l'elemento di un campo RadioButton."
type: docs
weight: 5340
...
Classe che rappresenta l'elemento del campo RadioButton.
