...
description: La classe descrive il componente delleditor di testo RTF.
type: docs
weight: 3180
...
La classe descrive il componente dell'editor di testo RTF.
...
| Nome | Descrizione |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | Campo Costruttore per Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Ottiene o imposta il valore RTF formattato con markup. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Ottiene o imposta la giustificazione della casella di testo RTF. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue) { get; set; } | Ottiene o imposta il valore RTF. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | Ottiene o imposta la stringa di stile predefinita del campo RTF. |
