...
description: "Aspose.Pdf.Forms.RichTextBoxField class. La classe descrive il componente editor di testo ricco."
type: docs
weight: 5350
...
Classe che descrive il componente editor di testo formattato.
...
| Nome | Descrizione |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Costruttore per il campo Rich Text Box. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Ottiene o imposta l'allineamento del rich text box. |
