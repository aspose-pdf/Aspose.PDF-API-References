...
description: Classe Aspose.Pdf.Forms.RichTextBoxField. La classe descrive il componente editor di testo ricco
type: docs
weight: 5230
url: /it/net/aspose.pdf.forms/richtextboxfield/
---
## Classe RichTextBoxField

La classe descrive il componente editor di testo ricco.
...
| Nome | Descrizione |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Pagina, Rettangolo) | Costruttore per il campo Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Ottiene o imposta il valore di testo ricco formattato con markup. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Ottiene o imposta la giustificazione della casella di testo ricca. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Ottiene o imposta il valore di testo ricco. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Ottiene o imposta il flag scorrevole del campo. Se vero, il campo può essere scorribile. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Ottiene o imposta la stringa di stile predefinita del campo di testo ricco. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Valore di RichTextField. |
