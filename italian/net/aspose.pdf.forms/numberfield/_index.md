...
description: Classe Aspose.Pdf.Forms.NumberField. Campo di testo con caratteri validi specificati
type: docs
weight: 5140
...
| Nome | Descrizione |
| --- | --- |
| [NumberField](numberfield/#constructor)() | Inizializza una nuova istanza della classe `NumberField`. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | Inizializza una nuova istanza della classe `NumberField`. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | Inizializza una nuova istanza della classe `NumberField`. |
...
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Ottiene o imposta il flag scrollabile del campo. Se vero, il campo può essere scorrere. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Aggiunge un codice a barre 128 nel campo. Il valore del campo verrà cambiato nel codice e il campo diventa di sola lettura. |
