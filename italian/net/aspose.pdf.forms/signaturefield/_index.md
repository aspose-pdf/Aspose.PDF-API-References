...
description: "Aspose.Pdf.Forms.SignatureField class. Rappresenta il campo modulo di firma"
type: docs
weight: 5410
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | Ottiene l'oggetto firma. Questo oggetto contiene i dati della firma relativi agli standard crittografici a chiave pubblica. Le classi [`PKCS1`](../pkcs1/), [`PKCS7`](../pkcs7/) e [`PKCS7Detached`](../pkcs7detached/) rappresentano tutti i tipi supportati di oggetti firma. |
...
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | Estrae l'oggetto certificato X.509 singolo. |
