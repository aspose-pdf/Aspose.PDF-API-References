...
description: Rappresenta il campo del modulo della firma.
type: docs
weight: 3230
...
Rappresenta il campo del modulo della firma.
...
| Nome | Descrizione |
| --- | --- |
| [SignatureField](signaturefield#constructor)(Document, Rectangle) | Inizializza la nuova istanza di[`SignatureField`](../signaturefield) classe. |
| [SignatureField](signaturefield#constructor_1)(Page, Rectangle) | Inizializza la nuova istanza di[`SignatureField`](../signaturefield) classe. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature) { get; } | Ottiene l'oggetto della firma. Questo oggetto contiene i dati della firma relativi agli standard crittografici a chiave pubblica. Classi[`PKCS1`](../pkcs1) ,[`PKCS7`](../pkcs7) e[`PKCS7Detached`](../pkcs7detached) rappresentano tutti i tipi supportati di oggetti firma. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate)() | Estrae il singolo certificato X.509 in formato DER come flusso. |
...
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage_1)(ImageFormat) | Estrae l'immagine della firma come flusso codificato. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign)(Signature) | Firma il documento utilizzando questo campo firma. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign_1)(Signature, Stream, string) | Firma il documento utilizzando questo campo firma. |
