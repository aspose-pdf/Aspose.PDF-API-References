...
description: Classe Aspose.Pdf.Forms.FileSelectBoxField. Campo per elemento di selezione file
type: docs
weight: 5060
url: /it/net/aspose.pdf.forms/fileselectboxfield/
---
## Classe FileSelectBoxField

Campo per elemento di selezione file.
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Ottiene o imposta il flag che indica se il campo è diviso in posizioni spazianti. |
...
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Ottiene o imposta il flag scorrevole del campo. Se vero, il campo può essere scorrere. |
