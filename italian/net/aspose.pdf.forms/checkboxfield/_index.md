...
description: Classe che rappresenta il campo della casella di controllo
type: docs
weight: 2930
...
Classe che rappresenta il campo della casella di controllo
...
| Nome | Descrizione |
| --- | --- |
| [CheckboxField](checkboxfield#constructor)() | Crea istanza di CheckboxField. |
| [CheckboxField](checkboxfield#constructor_1)(Document) | Costruttore da utilizzare con Generator. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate) { get; set; } | Ottiene o imposta lo stato di aspetto dell'annotazione corrente. |
