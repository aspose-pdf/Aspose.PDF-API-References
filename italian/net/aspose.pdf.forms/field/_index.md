...
description: Classe base per campi modulo acro.
type: docs
weight: 3000
...
Classe base per campi modulo acro.
...
| Nome | Descrizione |
| --- | --- |
| [Field](field)(Document) | Crea un campo da utilizzare in Generator. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | Se true, la dimensione del carattere verrà ridotta per adattare il testo al rettangolo specificato. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Dimensione del carattere Maximail che può essere utilizzata per i contenuti dei campi. -1 per non controllare la taglia. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | Dimensione minima del carattere che può essere utilizzata per il contenuto del campo. -1 per non controllare la taglia. |
