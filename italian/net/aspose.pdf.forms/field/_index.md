...
description: Classe Aspose.Pdf.Forms.Field. Classe base per i campi del modulo acro
type: docs
weight: 5050
url: /it/net/aspose.pdf.forms/field/
---
## Classe Field
...
| Nome | Descrizione |
| --- | --- |
| [Field](field/)(Document) | Crea un campo da utilizzare nel Generatore. |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | Ottiene il numero di sotto-campi in questo campo. (Ad esempio, numero di elementi nel campo del pulsante di opzione). |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Se vero, la dimensione del carattere sarà ridotta per adattare il testo al rettangolo specificato. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Dimensione massima del carattere che può essere utilizzata per i contenuti del campo. -1 per non controllare la dimensione. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Dimensione minima del carattere che può essere utilizzata per i contenuti del campo. -1 per non controllare la dimensione. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Copia i sotto-campi di questo campo in un array a partire dall'indice specificato. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Importa i dati nei campi specificati da uno stream JSON, basandosi su una corrispondenza esatta dei nomi completi dei campi. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Importa i dati nel campo specificato da uno stream JSON, utilizzando il nome completo specificato nella variabile 'fieldFullNameInJSON' per la corrispondenza. |
