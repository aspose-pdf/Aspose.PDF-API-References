...
description: "Aspose.Pdf.Forms.Field class. Classe base per i campi di modulo acro"
type: docs
weight: 5170
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Se vero, la dimensione del carattere verrà ridotta per adattare il testo al rettangolo specificato. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Dimensione massima del carattere che può essere usata per il contenuto del campo. -1 per non verificare la dimensione. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Dimensione minima del carattere che può essere usata per il contenuto del campo. -1 per non verificare la dimensione. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Importa i dati nel campo specificato da uno stream JSON, utilizzando il nome completo specificato nella variabile 'fieldFullNameInJSON' per il confronto. |
