...
description: "Classe Aspose.Pdf.Forms.BarcodeField. Classe che rappresenta il campo di codice a barre."
type: docs
weight: 5070
...
Classe che rappresenta il campo codice a barre.
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Restituisce la didascalia dell'oggetto barcode. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Restituisce un valore intero che rappresenta il coefficiente di correzione degli errori. Per PDF417, deve essere da 0 a 8. Per QRCode, deve essere da 0 a 3 (0 per 'L', 1 per 'M', 2 per 'Q' e 3 per 'H'). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Restituisce la risoluzione, in punti per pollice (dpi), con cui l'oggetto barcode viene renderizzato. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Specifica quale tecnologia di codici a barre o glifi deve essere utilizzata in questa annotazione, vedere [`Symbology`](./symbology/) per i dettagli. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | Ottiene la distanza verticale tra due moduli di codice a barre, misurata in pixel. Il rapporto XSymHeight/XSymWidth deve essere un valore intero. Per PDF417, l'intervallo di rapporto accettabile è da 1 a 4. Per QRCode e DataMatrix, questo rapporto deve essere sempre 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | Ottiene la distanza orizzontale, in pixel, tra due moduli di codice a barre. |
