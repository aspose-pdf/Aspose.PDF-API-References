...
description: La classe rappresenta il campo del codice a barre.
type: docs
weight: 2900
...
La classe rappresenta il campo del codice a barre.
...
| Nome | Descrizione |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | Inizializza la nuova istanza di[`BarcodeField`](../barcodefield) classe. |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | Inizializza la nuova istanza di[`BarcodeField`](../barcodefield) classe. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption) { get; } | Ottiene la didascalia dell'oggetto codice a barre. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } | Ottiene un valore intero che rappresenta il coefficiente di correzione dell'errore. Per PDF417, deve essere compreso tra 0 e 8. Per QRCode, deve essere compreso tra 0 e 3 (0 per �L�, 1 per �M�, 2 per �Q� e 3 per �H�). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution) { get; } | Ottiene la risoluzione, in punti per pollice (dpi), a cui viene eseguito il rendering dell'oggetto codice a barre. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | Specifica quale tecnologia codice a barre o glifo deve essere utilizzata su questa annotazione, vedere[`Symbology`](./symbology) per i dettagli. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight) { get; } | Ottiene la distanza verticale tra due moduli di codici a barre, misurata in pixel. Il rapporto XSymHeight/XSymWidth deve essere un valore intero. Per PDF417, l'intervallo di rapporti accettabile è compreso tra 1 e 4. Per QRCode e DataMatrix, questo rapporto deve sempre essere 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth) { get; } | Ottiene la distanza orizzontale, in pixel, tra due moduli di codici a barre. |
