...
description: Rappresenta loggetto firma relativo allo standard PKCS1. Per la firma vengono utilizzati lalgoritmo di crittografia RSA e il metodo digest SHA-1.
type: docs
weight: 3120
...
| Nome | Descrizione |
| --- | --- |
| [PKCS1](pkcs1#constructor)() | Inizializza la nuova istanza di[`PKCS1`](../pkcs1) classe. |
| [PKCS1](pkcs1#constructor_1)(Stream) | Inizializza la nuova istanza di[`PKCS1`](../pkcs1) classe. |
| [PKCS1](pkcs1#constructor_2)(Stream, string) | Inizializza la nuova istanza di[`PKCS1`](../pkcs1) classe. |
| [PKCS1](pkcs1#constructor_3)(string, string) | Inizializza la nuova istanza di[`PKCS1`](../pkcs1) classe. |
