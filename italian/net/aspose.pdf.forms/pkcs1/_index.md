...
description: "Aspose.Pdf.Forms.PKCS1 class. Rappresenta l'oggetto firma relativo allo standard PKCS1. L'algoritmo di crittografia RSA e il metodo di digest SHA1 sono utilizzati per la firma."
type: docs
weight: 5290
...
Rappresenta l'oggetto firma relativo allo standard PKCS#1. L'algoritmo di crittografia RSA e il metodo di digest SHA-1 sono utilizzati per la firma.
