...
description: "Aspose.Pdf.Forms.ListBoxField class. La classe rappresenta il campo ListBox"
type: docs
weight: 5250
...
| Nome | Descrizione |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | Costruttore per ListBoxField da utilizzare nel Generator. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | Ottiene o imposta l'indice dell'elemento selezionato. Gli elementi sono numerati a partire da 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Ottiene o imposta l'array degli elementi selezionati nella lista a selezione multipla. Per una lista a selezione singola restituisce un array con un solo elemento. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Ottiene o imposta l'indice dell'elemento visibile superiore della lista. |
