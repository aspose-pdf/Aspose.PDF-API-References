...
description: La classe rappresenta il campo ListBox.
type: docs
weight: 3080
...
La classe rappresenta il campo ListBox.
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | Ottiene o imposta l'indice dell'elemento selezionato. Gli articoli sono numerati da 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | Ottiene o imposta l'array degli elementi selezionati nell'elenco di selezione multipla. Per l'elenco a selezione singola restituisce un array con un singolo elemento. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex) { get; set; } | Ottiene o imposta l'indice dell'elemento visibile in alto nell'elenco. |
