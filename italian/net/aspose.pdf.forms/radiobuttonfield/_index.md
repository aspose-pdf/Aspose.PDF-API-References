...
description: Classe che rappresenta il campo del pulsante di opzione.
type: docs
weight: 3160
...
Classe che rappresenta il campo del pulsante di opzione.
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options) { get; } | Ottiene la raccolta di opzioni del pulsante di opzione. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Stile della casella di campo. |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Aggiungi opzione al pulsante di opzione. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | Aggiungi all'opzione del pulsante di opzione con il rettangolo specificato. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition)(Point) | Sposta tutte le voci secondarie del pulsante di opzione in posizioni specificate nella pagina. |
