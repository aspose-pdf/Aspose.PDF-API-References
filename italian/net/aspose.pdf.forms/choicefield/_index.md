...
description: "Classe Aspose.Pdf.Forms.ChoiceField. Rappresenta la classe base per i campi a scelta"
type: docs
weight: 5110
...
| Nome | Descrizione |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Crea un campo a scelta (per Generator) |
