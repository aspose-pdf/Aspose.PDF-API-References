...
description: Classe Aspose.Pdf.Forms.ChoiceField. Rappresenta la classe base per i campi di scelta
type: docs
weight: 4990
...
| Nome | Descrizione |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Crea un campo di scelta (per il Generatore) |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Ottiene o imposta l'array degli elementi selezionati. Per l'elenco di selezione multipla, l'array contiene più di un elemento. Per l'elenco di selezione singola, contiene un solo elemento. |
