...
description: Salva le opzioni per lesportazione in formato APS XML.
type: docs
weight: 1300
...
Salva le opzioni per l'esportazione in formato APS XML.
...
| Nome | Descrizione |
| --- | --- |
| [ApsSaveOptions](apssaveoptions)() | Default_Costruttore |
