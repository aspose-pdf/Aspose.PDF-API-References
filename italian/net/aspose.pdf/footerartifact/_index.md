...
description: Descrive lartefatto del piè di pagina. Può essere utilizzato per impostare il piè di pagina della pagina.
type: docs
weight: 2880
...
Descrive l'artefatto del piè di pagina. Può essere utilizzato per impostare il piè di pagina della pagina.
...
| Nome | Descrizione |
| --- | --- |
| [FooterArtifact](footerartifact)() | Crea un'istanza di artefatto del piè di pagina. |
