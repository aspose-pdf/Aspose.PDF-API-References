...
description: Classe Aspose.Pdf.FooterArtifact. Descrive l'artefatto del piè di pagina. Questo può essere utilizzato per impostare il piè di pagina della pagina
type: docs
weight: 4930
url: /it/net/aspose.pdf/footerartifact/
---
## Classe FooterArtifact

Descrive l'artefatto del piè di pagina. Questo può essere utilizzato per impostare il piè di pagina della pagina.
...
| Nome | Descrizione |
| --- | --- |
| [FooterArtifact](footerartifact/)() | Crea un'istanza dell'artefatto del piè di pagina. |
