...
description: La classe descrive lartefatto di sfondo. Questo artefatto permette di impostare lo sfondo della pagina.
type: docs
weight: 1350
...
La classe descrive l'artefatto di sfondo. Questo artefatto permette di impostare lo sfondo della pagina.
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor) { get; set; } | Ottiene o imposta il colore bacground dell'artefatto di sfondo |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage) { get; set; } | Ottiene o imposta l'immagine bacground dell'artefatto di sfondo |
