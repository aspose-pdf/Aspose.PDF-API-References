...
La classe descrive l'artefatto di sfondo. Questo artefatto consente di impostare lo sfondo della pagina.
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | Ottiene o imposta il colore di sfondo dell'artefatto di sfondo |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | Ottiene o imposta l'immagine di sfondo dell'artefatto di sfondo |
...
| [IsBackground](../../aspose.pdf/artifact/isbackground/) { get; set; } | Se true, l'artefatto è posizionato dietro i contenuti della pagina. |
