...
| [Broken](../../aspose.pdf/table/broken/) { get; set; } | Ottiene o imposta la rottura verticale della tabella; |
...
| [DefaultCellTextState](../../aspose.pdf/table/defaultcelltextstate/) { get; set; } | Ottiene o imposta lo stato di testo predefinito della cella. |
...
| [IsBroken](../../aspose.pdf/table/isbroken/) { get; set; } | Ottiene o imposta se la tabella è interrotta - verrà troncata per la pagina successiva. |
...
| [RepeatingRowsCount](../../aspose.pdf/table/repeatingrowscount/) { get; set; } | Ottiene il conteggio delle prime righe ripetute per diverse pagine. |
...
| [GetHeight](../../aspose.pdf/table/getheight/)(Page) | Ottieni l'altezza. |
| [GetWidth](../../aspose.pdf/table/getwidth/)() | Ottieni la larghezza. |
...
| [ImportDataTable](../../aspose.pdf/table/importdatatable/#importdatatable_2)(DataTable, int[], int[], int, int, bool, bool) | Importa un oggetto DataTable, ma non come entità intera. Solo le righe e le colonne specificate vengono importate. |
