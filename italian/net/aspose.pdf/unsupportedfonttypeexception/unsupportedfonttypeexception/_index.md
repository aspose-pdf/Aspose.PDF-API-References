...
description: "Costruttore UnsupportedFontTypeException. Inizializza una nuova istanza della classe UnsupportedFontTypeException."
type: docs
weight: 10
...
Inizializza una nuova istanza della classe [`UnsupportedFontTypeException`](../).
...
Inizializza una nuova istanza della classe [`UnsupportedFontTypeException`](../) con un messaggio di errore specificato e un riferimento all'eccezione interna che è la causa di questa eccezione.
...
Inizializza una nuova istanza della classe [`UnsupportedFontTypeException`](../) con un riferimento all'eccezione interna che è la causa di questa eccezione.
