...
description: "Classe Aspose.Pdf.ImageStamp. Rappresenta un timbro grafico"
type: docs
weight: 6060
...
| [ImageStamp](imagestamp/#constructor_1)(string) | Crea un timbro immagine a partire dall'immagine nel file specificato. |
...
| [Image](../../aspose.pdf/imagestamp/image/) { get; } | Ottiene lo stream dell'immagine usato per il timbro. |
...
| override [XIndent](../../aspose.pdf/imagestamp/xindent/) { get; set; } | Ottiene e imposta la coordinata orizzontale del timbro, a partire da sinistra. |
| override [YIndent](../../aspose.pdf/imagestamp/yindent/) { get; set; } | Ottiene e imposta la coordinata verticale del timbro, a partire dal basso. |
