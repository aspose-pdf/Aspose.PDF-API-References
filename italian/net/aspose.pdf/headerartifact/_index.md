...
description: Classe Aspose.Pdf.HeaderArtifact. La classe descrive l'artefatto Header. Questo artefatto può essere utilizzato per impostare il titolo della pagina
type: docs
weight: 5420
...
La classe descrive l'artefatto Header. Questo artefatto può essere utilizzato per impostare il titolo della pagina.
...
| Nome | Descrizione |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Crea un'istanza dell'artefatto Header. |
