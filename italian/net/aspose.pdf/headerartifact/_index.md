...
description: "Aspose.Pdf.HeaderArtifact class. La classe descrive l'artefatto Header. Questo artefatto può essere usato per impostare l'intestazione della pagina"
type: docs
weight: 5540
url: /it/net/aspose.pdf/headerartifact/
---
## HeaderArtifact class

Classe che descrive l'artefatto dell'intestazione. Questo artefatto può essere usato per impostare l'intestazione della pagina.
...
| Nome | Descrizione |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Crea un'istanza di Header Artifact. |
