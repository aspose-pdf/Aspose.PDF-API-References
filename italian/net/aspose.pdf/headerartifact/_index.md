...
description: La classe descrive lartefatto dellintestazione. Questo artefatto può essere utilizzato per impostare lintestazione della pagina.
type: docs
weight: 3340
...
La classe descrive l'artefatto dell'intestazione. Questo artefatto può essere utilizzato per impostare l'intestazione della pagina.
...
| Nome | Descrizione |
| --- | --- |
| [HeaderArtifact](headerartifact)() | Crea un'istanza di artefatto di intestazione. |
