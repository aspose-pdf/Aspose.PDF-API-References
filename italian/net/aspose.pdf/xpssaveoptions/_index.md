...
description: Salva le opzioni per lesportazione in formato Xps
type: docs
weight: 7570
...
Salva le opzioni per l'esportazione in formato Xps
...
| Nome | Descrizione |
| --- | --- |
| [BatchSize](../../aspose.pdf/xpssaveoptions/batchsize) { get; set; } | Definisce la dimensione batch se la conversione batch è applicabile alla coppia di formati di origine e destinazione. |
...
| [SaveTransparentTexts](../../aspose.pdf/xpssaveoptions/savetransparenttexts) { get; set; } | Indica se mantenere il testo trasparente (con OCR). |
