---
title: "Classe BatesNArtifact"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Classe Aspose.Pdf.BatesNArtifact. La classe descrive l'artefatto Bates Numbering"
type: docs
weight: 2960
...
La classe descrive l'artifact Bates Numbering.
...
| Nome | Descrizione |
| --- | --- |
| [BatesNArtifact](batesnartifact/)() | Inizializza una nuova istanza della classe `BatesNArtifact`. Questo costruttore è interno e crea un'istanza di artefatto header con valori predefiniti. |
...
| [EndPage](../../aspose.pdf/paginationartifact/endpage/) { get; set; } | Ottiene o imposta il numero di page finale per l'artefatto. Il valore deve essere maggiore o uguale a 0. Se viene impostato un valore inferiore a 0, verrà regolato a 0. Il valore predefinito 0 indica che non ci sono limiti di page finale. |
...
| [StartPage](../../aspose.pdf/paginationartifact/startpage/) { get; set; } | Ottiene o imposta il numero di page iniziale per l'artefatto. Il valore deve essere maggiore o uguale a 1. Se viene impostato un valore inferiore a 1, verrà regolato a 1. |
| [Subset](../../aspose.pdf/paginationartifact/subset/) { get; set; } | Ottiene o imposta il sottoinsieme di pages a cui si applica l'artefatto (ad esempio, tutte le pages, even pages, odd pages). |
