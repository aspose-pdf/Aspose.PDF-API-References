...
| static [Trivial](../../aspose.pdf/rectangle/trivial/) { get; } | Inizializza un rettangolo banale, cioè un rettangolo con posizione e dimensione zero. |
...
| static [Parse](../../aspose.pdf/rectangle/parse/)(string) | Prova a analizzare la stringa ed estrarre da essa i componenti del rettangolo llx, lly, urx, ury. |
...
| [ContainsPoint](../../aspose.pdf/rectangle/containspoint/)(double, double) | Determina se il punto fornito è contenuto nel rettangolo. |
| [Equals](../../aspose.pdf/rectangle/equals/#equals)(Rectangle) | Verifica se i rettangoli sono uguali, cioè hanno la stessa posizione e dimensioni. |
| [Intersect](../../aspose.pdf/rectangle/intersect/)(Rectangle) | Interseca due rettangoli. |
| [IsIntersect](../../aspose.pdf/rectangle/isintersect/)(Rectangle) | Determina se questo rettangolo interseca con un altro rettangolo. |
...
| [NearEquals](../../aspose.pdf/rectangle/nearequals/)(Rectangle, double) | Verifica se i rettangoli sono quasi uguali, cioè hanno posizione e dimensioni quasi identiche (entro un delta). |
