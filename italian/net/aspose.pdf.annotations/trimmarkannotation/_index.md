---
title: "Classe TrimMarkAnnotation"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Aspose.Pdf.Annotations.TrimMarkAnnotation classe. Rappresenta un'annotazione Trim Mark"
type: docs
weight: 2790
url: /it/net/aspose.pdf.annotations/trimmarkannotation/
---
## TrimMarkAnnotation class

Rappresenta un'annotazione Trim Mark.
...
| Nome | Descrizione |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | Inizializza una nuova istanza della classe `TrimMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Ottiene o imposta la posizione del segno sulla page. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | Accetta il visitor per l'elaborazione di Annotation. |
...
I segni di ritaglio sono posizionati agli angoli di una stampata page per indicare dove la page deve essere ritagliata.
