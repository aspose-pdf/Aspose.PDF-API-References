...
description: Classe Aspose.Pdf.Annotations.TrimMarkAnnotation. Rappresenta un'annotazione Trim Mark
type: docs
weight: 2690
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | Accetta il visitatore per l'elaborazione dell'annotazione. |
...
I segni di taglio sono posizionati agli angoli di una pagina stampata per indicare dove la pagina deve essere tagliata.
