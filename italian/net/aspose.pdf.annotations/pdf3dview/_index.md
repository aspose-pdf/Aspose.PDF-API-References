...
| Nome | Descrizione |
| --- | --- |
| [PDF3DView](pdf3dview/#constructor)(Document, PDF3DView, string) | Inizializza una nuova istanza della classe `PDF3DView`. |
| [PDF3DView](pdf3dview/#constructor_1)(Document, Matrix3D, double, string) | Inizializza una nuova istanza della classe `PDF3DView`. |
