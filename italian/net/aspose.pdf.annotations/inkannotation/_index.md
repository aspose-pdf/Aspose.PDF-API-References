...
description: "Classe Aspose.Pdf.Annotations.InkAnnotation. Rappresenta uno scarabocchio a mano libera composto da uno o più percorsi disgiunti."
type: docs
weight: 2010
...
| Nome | Descrizione |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Costruttore per l'annotazione Ink per Generator. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Crea una nuova annotazione Ink nella pagina specificata. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Stile delle terminazioni di linea dell'annotazione Ink. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Ottiene o imposta l'elenco di gesti che sono linee indipendenti rappresentate da array Point[]. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
