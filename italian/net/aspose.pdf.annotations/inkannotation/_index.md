...
description: Rappresenta uno scribble a mano libera composto da uno o più percorsi disgiunti.
type: docs
weight: 540
...
Rappresenta uno "scribble" a mano libera composto da uno o più percorsi disgiunti.
...
| Nome | Descrizione |
| --- | --- |
| [InkAnnotation](inkannotation#constructor)(Document, IList&lt;Point[]&gt;) | Costruttore per annotazione Ink per Generator. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle) { get; set; } | Stile delle terminazioni delle righe di annotazione dell'inchiostro. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist) { get; set; } | Ottiene o imposta un elenco di gesti che sono linee indipendenti rappresentate da matrici Point[]. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize)(Matrix) | Aggiorna i punti in InkList, in base alla trasformazione della matrice. |
