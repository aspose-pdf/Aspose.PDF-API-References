...
description: Classe Aspose.Pdf.Annotations.InkAnnotation. Rappresenta un scarabocchio a mano libera composto da uno o più percorsi disgiunti
type: docs
weight: 1920
url: /it/net/aspose.pdf.annotations/inkannotation/
---
## Classe InkAnnotation

Rappresenta un "scarabocchio" a mano libera composto da uno o più percorsi disgiunti.
...
| Nome | Descrizione |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Costruttore per annotazione Ink per il Generatore. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Crea una nuova annotazione Ink sulla pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Stile delle estremità della linea dell'annotazione Ink. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Ottiene o imposta l'elenco dei gesti che sono linee indipendenti rappresentate da array di Point[]. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Aggiorna i punti in InkList, secondo la trasformazione della matrice. |
