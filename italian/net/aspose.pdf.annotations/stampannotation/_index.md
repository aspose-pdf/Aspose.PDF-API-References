...
description: Classe Aspose.Pdf.Annotations.StampAnnotation. Rappresenta un'annotazione a timbro in gomma. Questo tipo di annotazione visualizza testo o grafica destinati a sembrare come se fossero stati timbrati sulla pagina con un timbro in gomma.
type: docs
weight: 2610
...
Rappresenta un'annotazione a timbro in gomma. Questo tipo di annotazione visualizza testo o grafica destinati a sembrare come se fossero stati timbrati sulla pagina con un timbro in gomma.
...
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | Crea una nuova annotazione a timbro sulla pagina specificata. |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | Ottiene o imposta l'icona per il timbro in gomma. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | Accetta [`AnnotationSelector`](../annotationselector/) visitatore durante la navigazione nella collezione di annotazioni. |
...
Il seguente frammento di codice dimostra come aggiungere 2 timbri nella prima pagina del documento pdf. Il documento di input proviene da inFile e le modifiche vengono salvate in outFile. Il primo timbro ha l'icona NotForPublicRelease e il secondo proviene dall'immagine rubber.jpg.
