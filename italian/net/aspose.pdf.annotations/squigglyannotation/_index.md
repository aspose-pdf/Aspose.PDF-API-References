...
description: Classe Aspose.Pdf.Annotations.SquigglyAnnotation. Rappresenta l'annotazione squiggly che appare come una sottolineatura frastagliata nel testo di un documento
type: docs
weight: 2600
url: /it/net/aspose.pdf.annotations/squigglyannotation/
---
## Classe SquigglyAnnotation

Rappresenta l'annotazione squiggly che appare come una sottolineatura frastagliata nel testo di un documento.
...
| Nome | Descrizione |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Crea una nuova annotazione Squiggly nella pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
