...
description: Rappresenta lannotazione ondulata che appare come una sottolineatura frastagliata nel testo di un documento.
type: docs
weight: 1150
...
Rappresenta l'annotazione ondulata che appare come una sottolineatura frastagliata nel testo di un documento.
...
| Nome | Descrizione |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation)(Page, Rectangle) | Crea una nuova annotazione ondulata sulla pagina specificata. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints) { get; set; } | Ottiene o imposta una matrice di punti che specifica le coordinate di n quadrilateri. Ciascun quadrilatero racchiude una parola o un gruppo di parole contigue nel testo sottostante l'annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textmarkupannotation/changeafterresize)(Matrix) | Aggiorna i QuadPoint, in base alla trasformazione della matrice. |
