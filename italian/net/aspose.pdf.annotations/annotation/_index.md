...
description: Classe che rappresenta loggetto di annotazione.
type: docs
weight: 80
...
Classe che rappresenta l'oggetto di annotazione.
...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert) { get; set; } | Se true, l'aspetto dell'annotazione verrà aggiornato prima di convertire il documento PF in immagine. Ciò consente di convertire correttamente i campi ma probabilmente richiede più tempo. |
| static [UseFontSubset](../../aspose.pdf.annotations/annotation/usefontsubset) { get; set; } | Se questa proprietà è impostata su true, i caratteri verranno aggiunti al documento come sottoinsiemi. Il valore predefinito è true. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| abstract [Accept](../../aspose.pdf.annotations/annotation/accept)(AnnotationSelector) | Accetta il visitatore per l'elaborazione delle annotazioni. |
