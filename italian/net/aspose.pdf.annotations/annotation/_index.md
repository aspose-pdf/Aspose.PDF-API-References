...
description: "Aspose.Pdf.Annotations.Annotation class. Classe che rappresenta l'oggetto Annotation"
type: docs
weight: 1500
...
Classe che rappresenta l'oggetto annotazione.
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | Ottiene o imposta le caratteristiche del bordo di Annotation. [`Border`](./border/) |
...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert/) { get; set; } | Se vero, l'aspetto di Annotation verrà aggiornato prima di convertire il PF document in immagine. Questo consente di convertire correttamente i campi ma probabilmente richiede più tempo. |
| static [UseFontSubset](../../aspose.pdf.annotations/annotation/usefontsubset/) { get; set; } | Se questa proprietà è impostata su vero, i caratteri verranno aggiunti al document come sottoinsiemi. Il valore predefinito è vero. |
