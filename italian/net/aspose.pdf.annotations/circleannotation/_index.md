...
description: Classe che rappresenta lannotazione Circle.
type: docs
weight: 250
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame) { get; set; } | Il rettangolo che descrive le differenze numeriche tra due rettangoli: la voce Rect dell'annotazione e i limiti effettivi del quadrato o del cerchio sottostante. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
