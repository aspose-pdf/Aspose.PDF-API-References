---
title: "Classe CircleAnnotation"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Aspose.Pdf.Annotations.CircleAnnotation class. Classe che rappresenta l'annotazione Circle"
type: docs
weight: 1680
url: /it/net/aspose.pdf.annotations/circleannotation/
---
## CircleAnnotation class

Classe che rappresenta l'annotazione Circle.
...
| Nome | Descrizione |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Costruttore per l'annotazione Circle. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Crea una nuova annotazione Circle nella pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | Il rettangolo che descrive le differenze numeriche tra due rettangoli: la voce Rect dell'annotazione e i confini effettivi del quadrato o cerchio sottostante. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
