...
description: Classe Aspose.Pdf.Annotations.CircleAnnotation. Classe che rappresenta l'annotazione Circolare
type: docs
weight: 1590
...
Classe che rappresenta l'annotazione Circolare.
...
| Nome | Descrizione |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Costruttore per l'annotazione Circolare. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Crea una nuova annotazione Circolare sulla pagina specificata. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | Il rettangolo che descrive le differenze numeriche tra due rettangoli: l'entrata Rect dell'annotazione e i confini reali del quadrato o cerchio sottostante. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
