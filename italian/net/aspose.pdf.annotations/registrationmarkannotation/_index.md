...
description: Aspose.Pdf.Annotazioni.RegistrationMarkAnnotation classe. Rappresenta un'annotazione di registrazione.
type: docs
weight: 2410
...
Rappresenta un'annotazione di Marchio di Registrazione.
...
| Name | Description |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Inizializza una nuova istanza della classe `RegistrationMarkAnnotation` nella pagina data nella posizione data. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Ottiene o imposta la posizione del marchio di registrazione su una pagina. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Accetta il visitatore per l'elaborazione dell'annotazione. |
...
I marchi di registrazione sono simboli aggiunti alle lastre di stampa o agli schermi per garantire un corretto allineamento dei colori durante il processo di stampa.
