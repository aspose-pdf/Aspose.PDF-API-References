...
description: "Aspose.Pdf.Annotations.PopupAnnotation classe. Rappresenta l'annotazione popup che visualizza il testo in una finestra popup per l'inserimento e la modifica"
type: docs
weight: 2420
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Ottiene o imposta un flag che specifica se l'annotazione popup deve essere inizialmente visualizzata aperta. |
...
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Ottiene o imposta l'annotazione padre con cui questa annotazione popup deve essere associata. Se questa voce è presente, le voci Contents, M, C e T dell'annotazione padre sovrascriveranno quelle dell'annotazione popup stessa. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
