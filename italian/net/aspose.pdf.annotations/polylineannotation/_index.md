...
description: "Aspose.Pdf.Annotations.PolylineAnnotation class. Rappresenta un'Annotation polilinea simile al poligono, tranne per il fatto che il primo e l'ultimo vertice non sono collegati implicitamente"
type: docs
weight: 2410
...
Rappresenta l'annotazione polilinea che è simile al poligono, tranne per il fatto che il primo e l'ultimo vertice non sono collegati implicitamente.
...
| Nome | Descrizione |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | Crea una nuova Annotation Polyline nella Page specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
