...
description: Rappresenta unannotazione polilinea simile al poligono tranne per il fatto che il primo e lultimo vertice non sono connessi in modo implicito.
type: docs
weight: 930
...
Rappresenta un'annotazione polilinea simile al poligono, tranne per il fatto che il primo e l'ultimo vertice non sono connessi in modo implicito.
...
| Nome | Descrizione |
| --- | --- |
| [PolylineAnnotation](polylineannotation)(Page, Rectangle, Point[]) | Crea una nuova annotazione Polilinea nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
