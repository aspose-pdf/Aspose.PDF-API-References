...
description: Classe Aspose.Pdf.Annotations.LineAnnotation. Classe che rappresenta l'annotazione di linea
type: docs
weight: 1980
...
| Nome | Descrizione |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Costruttore da utilizzare con il Generatore. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Crea una nuova annotazione di linea sulla pagina specificata. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Ottiene o imposta un flag booleano che determina se il contenuto deve essere mostrato come didascalia. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Ottiene o imposta il punto di partenza della linea. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Ottiene o imposta lo stile di inizio della linea per il punto di partenza della linea. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept/)(AnnotationSelector) | Accetta il visitatore per l'elaborazione dell'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Aggiorna i punti di partenza e di fine, secondo la trasformazione della matrice. |
