...
description: "Classe Aspose.Pdf.Annotations.LineAnnotation. Classe che rappresenta un'annotazione di linea"
type: docs
weight: 2070
...
| Nome | Descrizione |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Costruttore per l'uso con Generator. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Crea una nuova annotazione Line sulla pagina specificata. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Ottiene o imposta lo spostamento del testo della didascalia dalla sua posizione normale. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | Ottiene o imposta il punto finale della linea. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Ottiene o imposta lo stile di chiusura per il punto finale della linea. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | Ottiene o imposta l'intento dell'annotazione di linea. |
...
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Ottiene o imposta lo spostamento della linea guida. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Ottiene o imposta il flag booleano che determina se il contenuto deve essere mostrato come didascalia. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Ottiene o imposta il punto di partenza della linea. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Ottiene o imposta lo stile di chiusura della linea per il punto di partenza della linea. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept/)(AnnotationSelector) | Accetta un visitatore per l'elaborazione dell'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Aggiorna i punti di inizio e fine, secondo la trasformazione della matrice. |
