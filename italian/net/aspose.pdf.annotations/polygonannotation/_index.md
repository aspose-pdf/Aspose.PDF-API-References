...
description: Classe Aspose.Pdf.Annotations.PolygonAnnotation. Classe che rappresenta l'annotazione poligonale
type: docs
weight: 2310
...
Classe che rappresenta l'annotazione poligonale.
...
| Nome | Descrizione |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Costruttore da utilizzare con il Generatore. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Crea una nuova annotazione poligonale sulla pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Accetta l'oggetto visitatore per l'elaborazione dell'annotazione. |
