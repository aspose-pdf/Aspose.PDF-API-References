...
description: Classe Aspose.Pdf.Annotations.StrikeOutAnnotation. Rappresenta un'annotazione di barratura che appare come una barratura nel testo del documento
type: docs
weight: 2630
url: /it/net/aspose.pdf.annotations/strikeoutannotation/
---
## Classe StrikeOutAnnotation

Rappresenta un'annotazione di barratura che appare come una barratura nel testo del documento.
...
| Nome | Descrizione |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Pagina, Rettangolo) | Crea una nuova annotazione di barratura sulla pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | Imposta lo stato di revisione per un'annotazione. Gli stati Marcato e Non Marcato vengono ignorati poiché non appartengono al Modello di Stato di Revisione. Lo stato è impostato dall'utente che ha creato l'annotazione target. Il valore è preso dalla proprietà Title dell'annotazione target. Nota: lo stato è memorizzato in altre annotazioni di testo che hanno chiavi di stato e modello di stato. |
