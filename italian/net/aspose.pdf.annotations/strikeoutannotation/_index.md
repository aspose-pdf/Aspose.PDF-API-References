...
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation class. Rappresenta un'annotazione di barratura che appare come barratura nel testo del documento"
type: docs
weight: 2730
...
Rappresenta un'annotazione barrata che appare come barratura nel testo del documento.
...
| Nome | Descrizione |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | Crea una nuova annotazione StrikeOut nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
