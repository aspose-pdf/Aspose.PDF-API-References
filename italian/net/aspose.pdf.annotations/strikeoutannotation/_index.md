...
description: Rappresenta unannotazione barrata che appare come barrata nel testo del documento.
type: docs
weight: 1180
...
Rappresenta un'annotazione barrata che appare come barrata nel testo del documento.
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
