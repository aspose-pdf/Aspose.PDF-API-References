...
| Nome | Descrizione |
| --- | --- |
| [PDF3DCrossSectionArray](pdf3dcrosssectionarray/)(Document) | Inizializza una nuova istanza della classe `PDF3DCrossSectionArray`. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.pdf.annotations/pdf3dcrosssectionarray/add/)(PDF3DCrossSection) | Aggiunge la sezione trasversale specificata all'array delle viste. |
