...
description: La classe descrive lannotazione dellallegato del file.
type: docs
weight: 330
...
La classe descrive l'annotazione dell'allegato del file.
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity) { get; set; } | Ottiene o imposta l'opacità dell'icona da 0 a 1: 0 - completamente trasparente, 1 - completamente opaca. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
