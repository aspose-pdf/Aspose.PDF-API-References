---
title: "Classe FileAttachmentAnnotation"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Classe Aspose.Pdf.Annotations.FileAttachmentAnnotation. La classe descrive l'annotazione di allegato file"
type: docs
weight: 1800
url: /it/net/aspose.pdf.annotations/fileattachmentannotation/
---
## FileAttachmentAnnotation class

Classe che descrive l'annotazione di allegato file.
...
| Nome | Descrizione |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | Crea una nuova annotazione FileAttachment nella pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | La specifica del file associato a questa annotazione. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Ottiene o imposta l'icona da utilizzare nella visualizzazione dell'annotazione. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Ottiene o imposta l'opacità dell'icona da 0 a 1: 0 - completamente trasparente, 1 - completamente opaco. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
