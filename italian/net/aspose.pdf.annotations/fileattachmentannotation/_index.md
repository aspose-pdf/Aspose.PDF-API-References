...
La classe descrive l'annotazione di allegato file.
...
| Nome | Descrizione |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | Crea una nuova annotazione di allegato file sulla pagina specificata. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Ottiene o imposta l'icona che deve essere utilizzata per visualizzare l'annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
