...
description: Rappresenta unannotazione sottolineata che appare come sottolineatura nel testo del documento.
type: docs
weight: 1240
...
Rappresenta un'annotazione sottolineata che appare come sottolineatura nel testo del documento.
...
| Nome | Descrizione |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | Crea una nuova annotazione Sottolineato nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
