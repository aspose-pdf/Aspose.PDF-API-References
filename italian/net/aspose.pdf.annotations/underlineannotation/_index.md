...
description: Classe Aspose.Pdf.Annotations.UnderlineAnnotation. Rappresenta un'annotazione sottolineata che appare come una sottolineatura nel testo del documento
type: docs
weight: 2700
url: /it/net/aspose.pdf.annotations/underlineannotation/
---
## Classe UnderlineAnnotation

Rappresenta un'annotazione sottolineata che appare come una sottolineatura nel testo del documento.
...
| Nome | Descrizione |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | Crea una nuova annotazione sottolineata nella pagina specificata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
