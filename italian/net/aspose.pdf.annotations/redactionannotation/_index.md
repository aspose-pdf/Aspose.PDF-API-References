...
description: Rappresenta lannotazione Redact.
type: docs
weight: 960
...
| Nome | Descrizione |
| --- | --- |
| [RedactionAnnotation](redactionannotation#constructor)(Document) | Costruttore per RedactionAnnotation. Per l'utilizzo in Generator. |
...
| [DefaultAppearance](../../aspose.pdf.annotations/redactionannotation/defaultappearance) { get; set; } | Ottiene o imposta la stringa di aspetto predefinita da utilizzare nella formattazione del testo. |
...
| [OverlayText](../../aspose.pdf.annotations/redactionannotation/overlaytext) { get; set; } | Testo da stampare sull'annotazione di redazione. |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint) { get; set; } | Una matrice di 8xN numeri che specifica le coordinate dell'area del contenuto che si intende rimuovere. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect) { get; set; } | Ottiene o imposta il rettangolo di annotazione. |
| [Repeat](../../aspose.pdf.annotations/redactionannotation/repeat) { get; set; } | Se il testo di sovrapposizione vero verrà ripetuto sull'annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten)() | Appiattisce l'annotazione, ovvero rimuove l'annotazione e aggiunge la sua |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact)() | Appiattisce l'annotazione e redige il contenuto della pagina (cioè rimuove il testo e l'immagine sotto l'annotazione oscurata) |
