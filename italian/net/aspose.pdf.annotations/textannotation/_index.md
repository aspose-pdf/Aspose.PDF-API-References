...
description: "Aspose.Pdf.Annotations.TextAnnotation class. Rappresenta un'annotazione di testo che è una nota adesiva collegata a un punto nel documento PDF"
type: docs
weight: 2750
...
| Nome | Descrizione |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Costruttore per l'annotazione quando utilizzato in Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Crea una nuova annotazione Text nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
