...
description: Rappresenta unannotazione di testo che è una nota adesiva allegata a un punto nel documento PDF.
type: docs
weight: 1200
...
| Nome | Descrizione |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | Costruttore per annotazioni quando utilizzato in Generator. |
| [TextAnnotation](textannotation#constructor_1)(Page, Rectangle) | Crea una nuova annotazione di testo nella pagina specificata. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon) { get; set; } | Ottiene o imposta un'icona da utilizzare nella visualizzazione dell'annotazione. |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | Ottiene o imposta lo stato su cui deve essere impostata l'annotazione originale. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | Aggiorna i punti di inizio e fine, in base alla trasformazione della matrice. |
