...
description: Rappresenta un collegamento ipertestuale a una destinazione altrove nel documento o unazione da eseguire.
type: docs
weight: 630
...
| Nome | Descrizione |
| --- | --- |
| [LinkAnnotation](linkannotation)(Page, Rectangle) | Crea una nuova annotazione Link nella pagina specificata. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action) { get; set; } | Un'azione da eseguire quando viene attivata l'annotazione del collegamento. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | L'effetto visivo da utilizzare quando il pulsante del mouse viene premuto o tenuto premuto all'interno della sua area attiva. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
