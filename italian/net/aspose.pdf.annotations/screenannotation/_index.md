...
description: Classe Aspose.Pdf.Annotations.ScreenAnnotation. Un'annotazione dello schermo che specifica una regione di una pagina sulla quale possono essere riprodotti i clip multimediali
type: docs
weight: 2510
url: /it/net/aspose.pdf.annotations/screenannotation/
---
## Classe ScreenAnnotation

Un'annotazione dello schermo che specifica una regione di una pagina sulla quale possono essere riprodotti i clip multimediali.
...
| Nome | Descrizione |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | Crea una nuova annotazione dello schermo sulla pagina specificata. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Ottiene o imposta un'azione da eseguire quando l'annotazione viene attivata. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | Ottiene il tipo di annotazione. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Ottiene o imposta il titolo dell'annotazione dello schermo. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
