...
description: Unannotazione sullo schermo che specifica unarea di una pagina su cui possono essere riprodotti clip multimediali.
type: docs
weight: 1060
...
Un'annotazione sullo schermo che specifica un'area di una pagina su cui possono essere riprodotti clip multimediali.
...
| Nome | Descrizione |
| --- | --- |
| [ScreenAnnotation](screenannotation)(Page, Rectangle, string) | Crea una nuova annotazione schermo nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
