---
title: "Classe ScreenAnnotation"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Aspose.Pdf.Annotations.ScreenAnnotation classe. Un'annotazione screen che specifica una regione di una pagina su cui possono essere riprodotti clip multimediali"
type: docs
weight: 2610
...
Un'annotazione schermo che specifica una regione di una pagina su cui possono essere riprodotti clip multimediali.
...
| Nome | Descrizione |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | Crea una nuova annotazione Screen nella pagina specificata. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Ottiene o imposta un'azione da eseguire quando l'annotazione è attivata. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Ottiene o imposta il titolo dell'annotazione screen. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
