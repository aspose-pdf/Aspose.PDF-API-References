...
description: Classe Aspose.Pdf.Annotations.CaretAnnotation. Classe che rappresenta l'annotazione Caret
type: docs
weight: 1560
...
| Nome | Descrizione |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Costruttore per l'uso in Generator. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Crea una nuova annotazione Caret sulla pagina specificata. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Ottiene o imposta il rettangolo del cursore. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Ottiene o imposta il simbolo associato al cursore. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitatore per elaborare l'annotazione. |
