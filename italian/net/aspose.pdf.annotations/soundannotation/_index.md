...
description: Rappresenta unannotazione audio che contiene il suono registrato dal microfono del computer o importato da un file.
type: docs
weight: 1080
...
Rappresenta un'annotazione audio che contiene il suono registrato dal microfono del computer o importato da un file.
...
| Nome | Descrizione |
| --- | --- |
| [SoundAnnotation](soundannotation#constructor)(Page, Rectangle, string) | Crea una nuova annotazione Sound nella pagina specificata. |
| [SoundAnnotation](soundannotation#constructor_1)(Page, Rectangle, string, SoundSampleData) | Crea una nuova annotazione Sound nella pagina specificata. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | Ottiene o imposta un'icona da utilizzare nella visualizzazione dell'annotazione. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | Ottiene un oggetto sonoro che definisce il suono da riprodurre quando viene attivata l'annotazione. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
