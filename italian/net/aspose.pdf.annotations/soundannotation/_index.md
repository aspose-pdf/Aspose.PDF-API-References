...
description: "Aspose.Pdf.Annotations.SoundAnnotation class. Rappresenta un'Annotation audio che contiene suono registrato dal microfono del computer o importato da un file"
type: docs
weight: 2630
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | Ottiene un oggetto audio che definisce il suono da riprodurre quando l'Annotation è attivata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
