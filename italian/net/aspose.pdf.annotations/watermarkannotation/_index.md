...
description: La classe descrive loggetto di annotazione filigrana.
type: docs
weight: 1250
...
La classe descrive l'oggetto di annotazione filigrana.
...
| Nome | Descrizione |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Costruttore per la classe di annotazione filigrana. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint) { get; } | Oggetto di stampa fuso dell'annotazione filigrana. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Applica visitatore per l'annotazione. |
