...
description: Classe Aspose.Pdf.Annotations.MarkupAnnotation. Classe astratta che rappresenta un'annotazione di markup
type: docs
weight: 2020
...
| Nome | Descrizione |
| --- | --- |
| [MarkupAnnotation](markupannotation/)(Document) | Costruttore per annotazione di markup. |
