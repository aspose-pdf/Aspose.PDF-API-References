...
description: Classe astratta che rappresenta lannotazione di figure comuni.
type: docs
weight: 260
...
Classe astratta che rappresenta l'annotazione di figure comuni.
...
| Nome | Descrizione |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation)(Document) | Costruttore per l'utilizzo in Generator. |
