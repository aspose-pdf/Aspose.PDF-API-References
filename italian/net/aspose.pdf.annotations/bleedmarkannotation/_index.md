...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Accetta il visitor per l'elaborazione di Annotation. |
...
I segni di bleed vengono posizionati agli angoli di una pagina stampata per indicare dove la pagina deve essere rifilata e di quanto può discostarsi dai segni di rifilatura.
