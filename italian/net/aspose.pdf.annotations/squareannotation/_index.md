...
description: Classe che rappresenta lannotazione quadrata.
type: docs
weight: 1140
...
| Nome | Descrizione |
| --- | --- |
| [SquareAnnotation](squareannotation#constructor)(Document) | Costruttore per l'utilizzo con Generator. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept)(AnnotationSelector) | Accetta il visitatore per elaborare l'annotazione. |
