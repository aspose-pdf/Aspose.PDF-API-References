---
title: "Classe HighlightAnnotation"
...
Rappresenta un'annotazione evidenzia che mette in evidenza un intervallo di testo nel documento.
...
| Nome | Descrizione |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Crea una nuova annotazione Highlight nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Accetta un oggetto visitor per elaborare l'annotazione. |
