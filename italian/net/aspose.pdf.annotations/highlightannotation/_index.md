...
description: Rappresenta unannotazione di evidenziazione che evidenzia un intervallo di testo nel documento.
type: docs
weight: 490
...
| Nome | Descrizione |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | Crea una nuova annotazione Evidenzia nella pagina specificata. |
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | Accetta l'oggetto visitatore per elaborare l'annotazione. |
