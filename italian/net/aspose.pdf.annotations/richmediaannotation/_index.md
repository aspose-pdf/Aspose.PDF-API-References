...
description: "Aspose.Pdf.Annotations.RichMediaAnnotation classe. La classe descrive RichMediaAnnotation che consente di incorporare dati video/audio in un documento PDF"
type: docs
weight: 2570
...
| Nome | Descrizione |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/richmediaannotation/accept/)(AnnotationSelector) | Accetta un visitatore per questa annotazione. |
| [AddCustomData](../../aspose.pdf.annotations/richmediaannotation/addcustomdata/)(string, Stream) | Aggiunge dati nominati personalizzati (ad esempio richiesti per uno script flash). |
...
| [SetContent](../../aspose.pdf.annotations/richmediaannotation/setcontent/)(string, Stream) | Imposta lo stream di contenuto. |
