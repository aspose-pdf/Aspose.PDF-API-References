...
| Nome | Descrizione |
| --- | --- |
| [Tool](tool/#constructor)() | Inizializza una nuova istanza della classe `Tool`. |
| [Tool](tool/#constructor_1)(Function) | Inizializza una nuova istanza della classe `Tool` con la funzione specificata. |
| [Tool](tool/#constructor_2)(string) | Inizializza una nuova istanza della classe `Tool` con il tipo di strumento specificato. |
