...
| Nome | Descrizione |
| --- | --- |
| static [FromAssistant](../../aspose.pdf.ai/threadmessagecreaterequest/fromassistant/)() | Crea un nuovo `ThreadMessageCreateRequest` con il ruolo impostato su Assistant. |
| static [FromUser](../../aspose.pdf.ai/threadmessagecreaterequest/fromuser/)() | Crea un nuovo `ThreadMessageCreateRequest` con il ruolo impostato su User. |
