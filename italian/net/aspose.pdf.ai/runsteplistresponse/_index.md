---
title: "Classe RunStepListResponse"
second_title: "Aspose.PDF per .NET - Riferimento API"
description: "Classe Aspose.Pdf.AI.RunStepListResponse. Rappresenta una risposta di tipo elenco contenente dati dei passaggi di esecuzione"
type: docs
weight: 1130
url: /it/net/aspose.pdf.ai/runsteplistresponse/
---
## RunStepListResponse class

Rappresenta una risposta di elenco contenente i dati del passaggio dell'esecuzione.
...
| Nome | Descrizione |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | Il costruttore predefinito. |
