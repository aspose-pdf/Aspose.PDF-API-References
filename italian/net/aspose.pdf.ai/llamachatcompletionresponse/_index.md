...
description: "Aspose.Pdf.AI.LlamaChatCompletionResponse classe. Rappresenta una risposta di completamento della chat restituita dal modello in base all'input fornito."
type: docs
weight: 740
...
| Nome | Descrizione |
| --- | --- |
| [Choices](../../aspose.pdf.ai/llamachatcompletionresponse/choices/) { get; set; } | Ottiene o imposta un elenco di scelte di completamento della chat. Può essere più di una se n è maggiore di 1. |
| [Created](../../aspose.pdf.ai/llamachatcompletionresponse/created/) { get; set; } | Ottiene o imposta il timestamp Unix (in secondi) di quando è stata creata la completamento della chat. |
