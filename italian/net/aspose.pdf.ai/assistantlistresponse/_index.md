...
description: Classe Aspose.Pdf.AI.AssistantListResponse. Rappresenta la risposta contenente un elenco di risposte degli assistenti
type: docs
weight: 120
url: /it/net/aspose.pdf.ai/assistantlistresponse/
---
## Classe AssistantListResponse

Rappresenta la risposta contenente un elenco di risposte degli assistenti.
...
| Nome | Descrizione |
| --- | --- |
| [AssistantListResponse](assistantlistresponse/)() | Il costruttore predefinito. |
