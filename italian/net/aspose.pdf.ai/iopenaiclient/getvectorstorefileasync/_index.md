...
description: Metodo IOpenAIClient. Recupera i dettagli di un file specifico all'interno di un archivio vettoriale in modo asincrono
type: docs
weight: 310
url: /it/net/aspose.pdf.ai/iopenaiclient/getvectorstorefileasync/
---
## Metodo IOpenAIClient.GetVectorStoreFileAsync
