...
| Nome | Descrizione |
| --- | --- |
| [TiffSettings](tiffsettings/#constructor)() | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_8)(bool) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_1)(ColorDepth) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_2)(CompressionType) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_6)(Margins) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_7)(ShapeType) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_3)(CompressionType, ColorDepth, Margins) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_4)(CompressionType, ColorDepth, Margins, bool) | Inizializza una nuova istanza della classe `TiffSettings`. |
| [TiffSettings](tiffsettings/#constructor_5)(CompressionType, ColorDepth, Margins, bool, ShapeType) | Inizializza una nuova istanza della classe `TiffSettings`. |
