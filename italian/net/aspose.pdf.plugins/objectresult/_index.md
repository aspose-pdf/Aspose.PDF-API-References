...
| Nome | Descrizione |
| --- | --- |
| [Data](../../aspose.pdf.plugins/objectresult/data/) { get; } | Ottiene i dati grezzi. |
| [IsFile](../../aspose.pdf.plugins/objectresult/isfile/) { get; } | Indica se il risultato è un percorso a un file di output. |
