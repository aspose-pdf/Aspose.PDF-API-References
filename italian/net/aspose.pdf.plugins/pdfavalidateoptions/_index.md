...
description: "Aspose.Pdf.Plugins.PdfAValidateOptions classe. Rappresenta le opzioni per la convalida della conformità PDF/A dei Document PDF con il plugin PdfAConverter."
type: docs
weight: 9180
...
Rappresenta le opzioni per la convalida della conformità PDF/A dei Document PDF con il plugin [`PdfAConverter`](../pdfaconverter/).
