...
description: "Rappresenta uno \"scarabocchio\" a mano libera composto da uno o più percorsi disgiunti."
type: docs
weight: 350
url: /it/python-net/aspose.pdf.annotations/inkannotation/
---
...
Il tipo InkAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| InkAnnotation(document, ink_list) | Inizializza una nuova istanza della classe InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Inizializza una nuova istanza della classe InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Inizializza una nuova istanza della classe InkAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| cap_style | Stile delle terminazioni delle linee dell'annotazione a inchiostro. |
| ink_list | Ottiene o imposta l'elenco di gesti che sono linee indipendenti rappresentate da array Point[]. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
...
| change_after_resize(transform) | Aggiorna i punti in InkList, secondo la trasformazione della matrice. |
