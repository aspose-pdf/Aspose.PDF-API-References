...
description: "Rappresenta l'annotazione timbro di gomma. <br/>             Questo tipo di annotazione visualizza testo o grafica destinati a sembrare stampati sulla pagina con un timbro di gomma."
type: docs
weight: 790
url: /it/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

Rappresenta l'annotazione timbro di gomma. <br/>             Questo tipo di annotazione visualizza testo o grafica destinati a sembrare stampati sulla pagina con un timbro di gomma.

Il tipo StampAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| StampAnnotation(document) | Inizializza una nuova istanza della classe StampAnnotation |
| StampAnnotation(page, rect) | Inizializza una nuova istanza della classe StampAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| icon | Ottiene o imposta l'icona per il timbro di gomma. |
| image | Ottiene o imposta l'immagine dell'annotazione. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
| get_rectangle(consider_rotation) | Restituisce il rettangolo dell'annotazione tenendo conto della rotazione della pagina. |
| accept(visitor) | Accetta il visitatore [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) durante l'esplorazione della collezione di annotazioni. |
