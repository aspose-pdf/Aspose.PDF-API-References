...
type: docs
weight: 870
url: /it/python-net/aspose.pdf.annotations/widgetannotation/
---
...
Il tipo WidgetAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| WidgetAnnotation(doc) | Inizializza una nuova istanza della classe WidgetAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
