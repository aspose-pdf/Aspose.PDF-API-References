...
type: docs
weight: 740
url: /it/python-net/aspose.pdf.annotations/soundannotation/
---
...
Il tipo SoundAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Inizializza una nuova istanza della classe SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Inizializza una nuova istanza della classe SoundAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| sound_data | Ottiene un oggetto audio che definisce il suono da riprodurre quando l'annotazione è attivata. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
