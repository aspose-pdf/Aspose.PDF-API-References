...
description: "Classe che descrive l'oggetto annotazione Watermark."
type: docs
weight: 860
url: /it/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Classe che descrive l'oggetto annotazione Watermark.

Il tipo WatermarkAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| WatermarkAnnotation(page, rect) | Inizializza una nuova istanza della classe WatermarkAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| annotation_type | Ottiene il tipo di annotazione. |
...
| fixed_print | Oggetto di stampa fissa dell'annotazione Watermark. |
| opacità | Ottiene o imposta l'opacità dell'annotazione. |
## Metodi
| Nome | Descrizione |
| :- | :- |
...
| accept(visitor) | Applica il visitor all'annotazione. |
...
| set_text(text) | Imposta il testo dell'annotazione. |
| set_text_and_state(text, text_state) | Imposta il testo dell'annotazione. |
