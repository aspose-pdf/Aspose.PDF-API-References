...
Il tipo FitBVExplicitDestination espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| FitBVExplicitDestination(page, left) | Inizializza una nuova istanza della classe FitBVExplicitDestination |
| FitBVExplicitDestination(document, page_number, left) | Inizializza una nuova istanza della classe FitBVExplicitDestination |
| FitBVExplicitDestination(page_number, left) | Inizializza una nuova istanza della classe FitBVExplicitDestination |
## Proprietà
| Nome | Descrizione |
| :- | :- |
| pagina | Ottiene l'oggetto pagina di destinazione |
| page_number | Ottiene il numero della pagina di destinazione |
| left | Ottiene la coordinata orizzontale left posizionata al bordo sinistro della finestra. |
## Metodi
| Nome | Descrizione |
| :- | :- |
...
| to_string() | Converte lo stato dell'oggetto in valore stringa. Esempio: "1 FitBV 100". |
