...
description: "Un'annotazione schermo che specifica una regione di una pagina su cui possono essere riprodotti clip multimediali."
type: docs
weight: 720
url: /it/python-net/aspose.pdf.annotations/screenannotation/
---
...
Il tipo ScreenAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | Inizializza una nuova istanza della classe ScreenAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| title | Ottiene o imposta il titolo dell'annotazione dello schermo. |
| azione | Ottiene o imposta un'azione da eseguire quando l'annotazione è attivata. |
## Metodi
| Nome | Descrizione |
| :- | :- |
