...
type: docs
weight: 80
url: /it/python-net/aspose.pdf.annotations/caretannotation/
---
...
Il tipo CaretAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| CaretAnnotation(document) | Inizializza una nuova istanza della classe CaretAnnotation |
| CaretAnnotation(page, rect) | Inizializza una nuova istanza della classe CaretAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| cornice | Ottiene o imposta il rettangolo del caret. |
| simbolo | Ottiene o imposta il simbolo associato al caret. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
