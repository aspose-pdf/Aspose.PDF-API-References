...
description: "La classe descrive l'annotazione di allegato file."
type: docs
weight: 170
url: /it/python-net/aspose.pdf.annotations/fileattachmentannotation/
---
...
Il tipo FileAttachmentAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | Inizializza una nuova istanza della classe FileAttachmentAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| opacità | Ottiene o imposta l'opacità dell'icona da 0 a 1: 0 - completamente trasparente, 1 - completamente opaco. |
...
| file | La specifica del file associato a questa annotazione. |
| icon | Ottiene o imposta l'icona che deve essere usata nella visualizzazione dell'annotazione. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
| get_rectangle(consider_rotation) | Restituisce il rettangolo dell'annotazione tenendo conto della rotazione della pagina. |
| accept(visitor) | Accetta l'oggetto visitor per elaborare l'annotazione. |
