...
description: "Classe base astratta per le poly-annotazioni."
type: docs
weight: 640
url: /it/python-net/aspose.pdf.annotations/polyannotation/
---

## PolyAnnotation class

Classe base astratta per le poly-annotazioni.

Il tipo PolyAnnotation espone i seguenti membri:
## Proprietà
| Nome | Descrizione |
| :- | :- |
