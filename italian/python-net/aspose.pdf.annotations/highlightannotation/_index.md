...
description: "Rappresenta un'annotazione evidenzia che mette in evidenza un intervallo di testo nel documento."
type: docs
weight: 310
url: /it/python-net/aspose.pdf.annotations/highlightannotation/
---
...
Il tipo HighlightAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| HighlightAnnotation(page, rect) | Inizializza una nuova istanza della classe HighlightAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
