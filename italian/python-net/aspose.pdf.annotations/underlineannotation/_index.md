...
description: "Rappresenta un'annotazione sottolineatura che appare come una sottolineatura nel testo del documento."
type: docs
weight: 850
url: /it/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

Rappresenta un'annotazione sottolineatura che appare come una sottolineatura nel testo del documento.

Il tipo UnderlineAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| UnderlineAnnotation(page, rect) | Inizializza una nuova istanza della classe UnderlineAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
