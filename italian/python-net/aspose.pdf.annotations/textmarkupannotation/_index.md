...
description: "Classe base astratta per le annotazioni di markup testuale."
type: docs
weight: 830
url: /it/python-net/aspose.pdf.annotations/textmarkupannotation/
---

## TextMarkupAnnotation class

Classe base astratta per le annotazioni di markup testuale.

Il tipo TextMarkupAnnotation espone i seguenti membri:
## Proprietà
| Nome | Descrizione |
| :- | :- |
