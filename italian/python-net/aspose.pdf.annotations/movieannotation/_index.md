...
description: "Rappresenta un'annotazione video che contiene grafiche animate e suono da presentare sullo schermo del computer e attraverso gli altoparlanti. Quando l'annotazione è attivata, il video viene riprodotto."
type: docs
weight: 480
url: /it/python-net/aspose.pdf.annotations/movieannotation/
---
...
Il tipo MovieAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| MovieAnnotation(document, movie_file) | Inizializza una nuova istanza della classe MovieAnnotation |
| MovieAnnotation(page, rect, movie_file) | Inizializza una nuova istanza della classe MovieAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| title | Ottiene o imposta il titolo dell'annotazione video. |
| file | Ottiene o imposta una specifica di file che identifica un file video auto‑descrittivo. |
| poster | Ottiene o imposta un flag o uno stream che specifica se e come deve essere visualizzata l'immagine poster che rappresenta il video. Se vero, l'immagine poster deve essere recuperata dal file video; se è falso, non verrà visualizzato alcun poster. |
| aspect | Ottiene o imposta la larghezza e l'altezza del riquadro di delimitazione del video, in pixel. |
| ruota | Ottiene o imposta il numero di gradi di cui il video deve essere ruotato in senso orario rispetto alla pagina. Il valore deve essere un multiplo di 90. |
## Metodi
| Nome | Descrizione |
| :- | :- |
