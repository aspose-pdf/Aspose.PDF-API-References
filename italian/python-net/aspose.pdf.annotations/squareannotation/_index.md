...
description: "Classe che rappresenta l'annotazione quadrato."
type: docs
weight: 770
url: /it/python-net/aspose.pdf.annotations/squareannotation/
---

## SquareAnnotation class

Classe che rappresenta l'annotazione quadrato.

Il tipo SquareAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| SquareAnnotation(document) | Inizializza una nuova istanza della classe SquareAnnotation |
| SquareAnnotation(page, rect) | Inizializza una nuova istanza della classe SquareAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| accept(visitor) | Accetta un visitatore per elaborare l'annotazione. |
| flatten() | Nessuno |
