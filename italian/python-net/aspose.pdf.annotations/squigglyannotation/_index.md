...
description: "Rappresenta l'annotazione ondulata che appare come una sottolineatura irregolare nel testo di un documento."
type: docs
weight: 780
url: /it/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

Rappresenta l'annotazione ondulata che appare come una sottolineatura irregolare nel testo di un documento.

Il tipo SquigglyAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| SquigglyAnnotation(page, rect) | Inizializza una nuova istanza della classe SquigglyAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| quad_points | Ottiene o imposta un array di punti che specificano le coordinate di n quadrilateri. Ogni quadrilatero comprende una parola o un gruppo di parole contigue nel testo sottostante l'annotazione. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| clone() | Nessuno |
...
| flatten() | Nessuno |
| change_after_resize(transform) | Aggiorna i QuadPoints, in base alla trasformazione della matrice. |
| get_marked_text() | Ottiene il testo sotto l'annotazione di markup come stringa. |
| get_marked_text_fragments() | Ottiene il testo sotto l'annotazione di markup come [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/). |
