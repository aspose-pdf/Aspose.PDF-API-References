...
description: "Classe che rappresenta l'annotazione Cerchio."
type: docs
weight: 100
url: /it/python-net/aspose.pdf.annotations/circleannotation/
---

## CircleAnnotation class

Classe che rappresenta l'annotazione Cerchio.

Il tipo CircleAnnotation espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| CircleAnnotation(document) | Inizializza una nuova istanza della classe CircleAnnotation |
| CircleAnnotation(page, rect) | Inizializza una nuova istanza della classe CircleAnnotation |
## Proprietà
| Nome | Descrizione |
| :- | :- |
