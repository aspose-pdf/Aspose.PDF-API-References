...
description: "Rappresenta l'elemento di struttura Paragraph nella struttura logica."
type: docs
weight: 370
url: /it/python-net/aspose.pdf.logicalstructure/paragraphelement/
---

## ParagraphElement class

Rappresenta l'elemento di struttura Paragraph nella struttura logica.

Il tipo ParagraphElement espone i seguenti membri:
## Proprietà
| Nome | Descrizione |
| :- | :- |
