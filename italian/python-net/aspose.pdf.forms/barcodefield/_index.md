...
description: "La classe rappresenta un campo barcode."
type: docs
weight: 10
url: /it/python-net/aspose.pdf.forms/barcodefield/
---
...
Il tipo BarcodeField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| BarcodeField(page, rect) | Inizializza una nuova istanza della classe BarcodeField |
| BarcodeField(doc, rect) | Inizializza una nuova istanza della classe BarcodeField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| resolution | Ottiene la risoluzione, in punti per pollice (dpi), con cui viene renderizzato l'oggetto barcode. |
| caption | Ottiene la didascalia dell'oggetto barcode. |
| symbology | Specifica quale tecnologia di barcode o glifo deve essere utilizzata in questa annotazione,<br/>            vedere [symbology](/pdf/python-net/aspose.pdf.forms/barcodefield/) per i dettagli. |
| x_sym_width | Ottiene la distanza orizzontale, in pixel, tra due moduli di barcode. |
| x_sym_height | Ottiene la distanza verticale tra due moduli di barcode, misurata in pixel. <br/>            Il rapporto XSymHeight/XSymWidth deve essere un valore intero. <br/>            Per PDF417, l'intervallo di rapporto accettabile è da 1 a 4. Per QRCode e DataMatrix, <br/>            questo rapporto deve sempre essere 1 |
| ecc | Ottiene un valore intero che rappresenta il coefficiente di correzione degli errori. <br/>            Per PDF417, deve essere da 0 a 8. Per QRCode, deve essere da 0 a 3 <br/>            (0 per �L�, 1 per �M�, 2 per �Q�, e 3 per �H�). |
## Indexer
| Nome | Descrizione |
| :- | :- |
