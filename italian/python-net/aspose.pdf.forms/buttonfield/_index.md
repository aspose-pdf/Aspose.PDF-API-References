...
type: docs
weight: 20
url: /it/python-net/aspose.pdf.forms/buttonfield/
---
...
Il tipo ButtonField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ButtonField() | Costruttore del campo pulsante per Generator. |
| ButtonField(page, rect) | Inizializza una nuova istanza della classe ButtonField |
| ButtonField(doc, rect) | Inizializza una nuova istanza della classe ButtonField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| normal_caption | Ottiene o imposta la didascalia normale. |
| rollover_caption | Ottiene o imposta la didascalia rollover del pulsante che deve essere visualizzata quando l'utente sposta il cursore <br/>            nella sua area attiva senza premere il pulsante del mouse. |
| alternate_caption | Ottiene o imposta la didascalia alternativa del pulsante che deve essere visualizzata <br/>            quando il pulsante del mouse è premuto all'interno della sua area attiva. |
| normal_icon | Ottiene o imposta l'icona normale del pulsante che deve essere visualizzata quando non sta interagendo con l'utente. |
| rollover_icon | Ottiene o imposta l'icona rollover del pulsante che deve essere visualizzata quando l'utente <br/>            sposta il cursore nella sua area attiva senza premere il pulsante del mouse. |
| alternate_icon | Ottiene o imposta l'icona alternativa che deve essere visualizzata quando il pulsante del mouse è premuto all'interno della sua area attiva. |
| icon_fit | Ottiene l'oggetto di adattamento dell'icona che specifica come l'icona dell'annotazione widget deve essere visualizzata all'interno del suo rettangolo di annotazione. |
| ic_position | Ottiene o imposta la posizione della didascalia dell'icona. |
## Indexer
| Nome | Descrizione |
| :- | :- |
