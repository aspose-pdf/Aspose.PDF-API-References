...
Il tipo PKCS7Detached espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| PKCS7Detached(image) | Inizializza una nuova istanza della classe PKCS7Detached |
| PKCS7Detached() | Inizializza una nuova istanza della classe [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/). |
| PKCS7Detached(pfx, password) | Inizializza una nuova istanza della classe PKCS7Detached |
| PKCS7Detached(pfx, password) | Inizializza una nuova istanza della classe PKCS7Detached |
## Proprietà
| Nome | Descrizione |
| :- | :- |
