...
description: "Classe che descrive il campo di testo per l'inserimento della password."
type: docs
weight: 210
url: /it/python-net/aspose.pdf.forms/passwordboxfield/
---
...
Il tipo PasswordBoxField espone i seguenti membri:
## Proprietà
| Nome | Descrizione |
| :- | :- |
