...
description: "Campo data con visualizzazione calendario."
type: docs
weight: 60
url: /it/python-net/aspose.pdf.forms/datefield/
---

## DateField class

Campo data con visualizzazione calendario.

Il tipo DateField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| DateField() | Inizializza una nuova istanza di [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Inizializza una nuova istanza della classe DateField |
| DateField(page, rect) | Inizializza una nuova istanza della classe DateField |
| DateField(doc, rect) | Inizializza una nuova istanza della classe DateField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| value | Ottiene o imposta la Data. |
...
| date_format | Ottiene o imposta il formato della data. |
## Indexer
| Nome | Descrizione |
| :- | :- |
...
| Nome | Descrizione |
| :- | :- |
| add_image(image) | Aggiunta di immagine negata per questo campo. |
| add_image(image) | Aggiunta di immagine negata per questo campo. |
| clone() | Nessuno |
...
| init(page) | Inizializza l'azione JS. |
