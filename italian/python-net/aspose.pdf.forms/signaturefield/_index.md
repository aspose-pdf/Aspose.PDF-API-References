...
description: "Rappresenta il campo modulo firma."
type: docs
weight: 270
url: /it/python-net/aspose.pdf.forms/signaturefield/
---

## SignatureField class

Rappresenta il campo modulo firma.

Il tipo SignatureField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| SignatureField(page, rect) | Inizializza una nuova istanza della classe SignatureField |
| SignatureField(doc, rect) | Inizializza una nuova istanza della classe SignatureField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| signature | Ottiene l'oggetto firma.<br/>            Questo oggetto contiene dati della firma relativi agli standard crittografici a chiave pubblica.<br/>            Le classi [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/), [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) e [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) <br/>            rappresentano tutti i tipi supportati di oggetti firma. |
## Indexer
| Nome | Descrizione |
| :- | :- |
...
| Nome | Descrizione |
| :- | :- |
| sign(signature, pfx, pass) | Firma il documento utilizzando questo campo firma. |
| sign(signature) | Firma il documento utilizzando questo campo firma. |
| extract_image() | Estrae l'immagine della firma come flusso codificato JPEG. |
| extract_image(format) | Estrae l'immagine della firma come flusso codificato. |
| clone() | Nessuno |
...
| extract_certificate() | Estrae il singolo certificato X.509 in formato DER come flusso. |
