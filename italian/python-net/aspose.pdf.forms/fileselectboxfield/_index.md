...
description: "Campo per l'elemento di selezione file."
type: docs
weight: 100
url: /it/python-net/aspose.pdf.forms/fileselectboxfield/
---

## FileSelectBoxField class

Campo per l'elemento di selezione file.

Il tipo FileSelectBoxField espone i seguenti membri:
## Proprietà
| Nome | Descrizione |
| :- | :- |
