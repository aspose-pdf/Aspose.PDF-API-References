...
type: docs
weight: 280
url: /it/python-net/aspose.pdf.forms/textboxfield/
---
...
Il tipo TextBoxField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| TextBoxField(doc) | Inizializza una nuova istanza della classe TextBoxField |
| TextBoxField() | Crea un'istanza di TextBoxField. |
| TextBoxField(page, rect) | Inizializza una nuova istanza della classe TextBoxField |
| TextBoxField(doc, rect) | Inizializza una nuova istanza della classe TextBoxField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
