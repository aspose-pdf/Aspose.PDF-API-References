...
description: "Classe che descrive il componente editor di testo avanzato."
type: docs
weight: 240
url: /it/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Classe che descrive il componente editor di testo avanzato.

Il tipo RichTextBoxField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| RichTextBoxField(page, rect) | Inizializza una nuova istanza della classe RichTextBoxField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| style | Ottiene o imposta la stringa di stile predefinito del campo di testo ricco. |
| rich_text_value | Ottiene o imposta il valore del testo ricco. |
| formatted_value | Ottiene o imposta il valore formattato del testo ricco con markup. |
| justify | Ottiene o imposta l'allineamento del riquadro di testo ricco. |
## Indexer
| Nome | Descrizione |
| :- | :- |
