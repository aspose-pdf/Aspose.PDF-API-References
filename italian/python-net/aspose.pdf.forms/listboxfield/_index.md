...
description: "Classe che rappresenta il campo ListBox."
type: docs
weight: 140
url: /it/python-net/aspose.pdf.forms/listboxfield/
---

## ListBoxField class

Classe che rappresenta il campo ListBox.

Il tipo ListBoxField espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ListBoxField() | Costruttore per ListBoxField da utilizzare in Generator. |
| ListBoxField(page, rect) | Inizializza una nuova istanza della classe ListBoxField |
| ListBoxField(doc, rect) | Inizializza una nuova istanza della classe ListBoxField |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| selected | Ottiene o imposta l'indice dell'elemento selezionato. Gli elementi sono numerati a partire da 1. |
| selected_items | Ottiene o imposta l'array degli elementi selezionati nella lista a selezione multipla. Per una lista a selezione singola restituisce un array con un solo elemento. |
| opzioni | Ottiene la collezione delle opzioni di scelta. |
| top_index | Ottiene o imposta l'indice dell'elemento visibile più in alto nella lista. |
## Indexer
| Nome | Descrizione |
| :- | :- |
