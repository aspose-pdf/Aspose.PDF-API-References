...
description: "La classe descrive l'artifact di sfondo. Questo artifact consente di impostare lo sfondo della pagina."
type: docs
weight: 50
url: /it/python-net/aspose.pdf/backgroundartifact/
---
...
Il tipo BackgroundArtifact espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| BackgroundArtifact() | Inizializza l'oggetto BackgroundArtifact. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| background_color | Ottiene o imposta il colore di sfondo dell'artifact di sfondo |
| background_image | Ottiene o imposta l'immagine di sfondo dell'artifact di sfondo |
## Metodi
| Nome | Descrizione |
| :- | :- |
