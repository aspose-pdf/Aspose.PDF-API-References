...
description: "Opzioni di salvataggio per l'esportazione in formato Xml."
type: docs
weight: 960
url: /it/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
Il tipo MobiXmlSaveOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| MobiXmlSaveOptions() | Inizializza una nuova istanza della classe MobiXmlSaveOptions |
## Proprietà
| Nome | Descrizione |
| :- | :- |
