...
description: "Descrive l'artefatto del piè di pagina. Questo può essere usato per impostare il piè di pagina della pagina."
type: docs
weight: 400
url: /it/python-net/aspose.pdf/footerartifact/
---

## FooterArtifact class

Descrive l'artefatto del piè di pagina. Questo può essere usato per impostare il piè di pagina della pagina.

Il tipo FooterArtifact espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| FooterArtifact() | Crea un'istanza di Footer Artifact. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
