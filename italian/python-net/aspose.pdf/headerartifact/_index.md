...
description: "La classe descrive l'artefatto Heaader. Questo artifacgt può essere usato per impostare l'intestazione della pagina."
type: docs
weight: 440
url: /it/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

La classe descrive l'artefatto Heaader. Questo artifacgt può essere usato per impostare l'intestazione della pagina.

Il tipo HeaderArtifact espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| HeaderArtifact() | Crea un'istanza di HeaderArtifact. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
