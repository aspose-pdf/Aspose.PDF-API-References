...
type: docs
weight: 1140
url: /it/python-net/aspose.pdf/pagenumberstamp/
---
...
Il tipo PageNumberStamp espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| PageNumberStamp(format) | Inizializza una nuova istanza della classe PageNumberStamp |
| PageNumberStamp() | Inizializza una nuova istanza della classe [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/). Il formato è impostato su "#". |
| PageNumberStamp(formatted_text) | Inizializza una nuova istanza della classe PageNumberStamp |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| formato | Stringa valore per la marcatura dei numeri di pagina. <br/>            Il valore deve includere il carattere '#' che viene sostituito con il numero di pagina durante il processo di marcatura. |
| starting_number | Ottiene o imposta il valore del numero della pagina iniziale. Le altre pagine saranno numerate a partire da questo valore. |
| numbering_style | Stile di numerazione utilizzato da questo timbro. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| put(page) | Aggiunge il numero di pagina. |
