...
description: "La classe rappresenta un timbro che utilizza una pagina PDF come timbro."
type: docs
weight: 1230
url: /it/python-net/aspose.pdf/pdfpagestamp/
---
...
Il tipo PdfPageStamp espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| PdfPageStamp(pdf_page) | Inizializza una nuova istanza della classe PdfPageStamp |
| PdfPageStamp(file_name, page_index) | Inizializza una nuova istanza della classe PdfPageStamp |
| PdfPageStamp(stream, page_index) | Inizializza una nuova istanza della classe PdfPageStamp |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| pdf_page | Ottiene o imposta la pagina che verrà usata come timbro. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| put(page) | Posiziona il timbro nella pagina specificata. |
