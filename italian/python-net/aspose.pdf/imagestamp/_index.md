...
type: docs
weight: 690
url: /it/python-net/aspose.pdf/imagestamp/
---
...
Il tipo ImageStamp espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ImageStamp(image) | Inizializza una nuova istanza della classe ImageStamp |
| ImageStamp(file_name) | Inizializza una nuova istanza della classe ImageStamp |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| width | Ottiene o imposta la larghezza dell'immagine. Impostare questa proprietà consente di ridimensionare l'immagine orizzontalmente. |
| height | Ottiene o imposta l'altezza dell'immagine. Impostare questa proprietà consente di ridimensionare l'immagine verticalmente. |
...
| image | Ottiene lo stream dell'immagine utilizzato per il timbraggio. |
| qualità | Ottiene o imposta la qualità del timbro immagine in percentuale. I valori validi sono da 0 a 100%. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| put(page) | Aggiunge un timbro grafico nella pagina. |
