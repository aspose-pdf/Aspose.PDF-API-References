...
description: "Opzioni di salvataggio per l'esportazione nel formato XML APS."
type: docs
weight: 20
url: /it/python-net/aspose.pdf/apssaveoptions/
---
...
Il tipo ApsSaveOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| ApsSaveOptions() | Inizializza una nuova istanza della classe ApsSaveOptions |
## Proprietà
| Nome | Descrizione |
| :- | :- |
