...
description: "La classe rappresenta l'oggetto PDF Artifact."
type: docs
weight: 30
url: /it/python-net/aspose.pdf/artifact/
---
...
Il tipo Artifact espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| Artifact(type, sub_type) | Inizializza una nuova istanza della classe Artifact |
| Artifact(type, sub_type) | Inizializza una nuova istanza della classe Artifact |
## Proprietà
| Nome | Descrizione |
| :- | :- |
