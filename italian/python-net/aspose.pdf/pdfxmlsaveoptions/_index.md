...
type: docs
weight: 1260
url: /it/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
Il tipo PdfXmlSaveOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| PdfXmlSaveOptions() | Inizializza una nuova istanza della classe PdfXmlSaveOptions |
## Proprietà
| Nome | Descrizione |
| :- | :- |
