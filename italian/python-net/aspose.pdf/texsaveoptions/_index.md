...
description: "Opzioni di salvataggio per l'esportazione in formato TeX"
type: docs
weight: 1540
url: /it/python-net/aspose.pdf/texsaveoptions/
---
...
Il tipo TeXSaveOptions espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| TeXSaveOptions() | Inizializza una nuova istanza della classe TeXSaveOptions |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| out_directory_path | Proprietà per |
| pages_count | Restituisce il numero di pagine dopo la conversione. |
## Metodi
| Nome | Descrizione |
| :- | :- |
| add_font_encs(font_encs) | Aggiunge una codifica di carattere all'elenco delle codifiche dei font |
| clear_font_encs() | Cancella l'elenco di codifica dei font |
