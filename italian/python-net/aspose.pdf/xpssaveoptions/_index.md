...
description: "Opzioni di salvataggio per l'esportazione in formato Xps"
type: docs
weight: 1810
url: /it/python-net/aspose.pdf/xpssaveoptions/
---
...
| Nome | Descrizione |
| :- | :- |
| XpsSaveOptions() | Inizializza una nuova istanza della classe XpsSaveOptions |
## Proprietà
| Nome | Descrizione |
| :- | :- |
...
| save_transparent_texts | Indica se preservare il testo trasparente (OCRizzato). |
