...
description: "Classe che rappresenta l'operatore B (riempie e traccia il percorso usando la regola del numero di avvolgimento non zero)"
type: docs
weight: 290
url: /it/python-net/aspose.pdf.operators/fillstroke/
---
...
Il tipo FillStroke espone i seguenti membri:
## Costruttori
| Nome | Descrizione |
| :- | :- |
| FillStroke() | Inizializza l'operatore. |
## Proprietà
| Nome | Descrizione |
| :- | :- |
