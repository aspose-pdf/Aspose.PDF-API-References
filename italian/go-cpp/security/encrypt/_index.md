...
description: "Cifra il documento PDF."
type: docs
url: /it/go-cpp/security/encrypt/
---

_Cifra il documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) cifra il documento PDF
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
