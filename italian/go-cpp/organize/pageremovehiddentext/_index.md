...
description: "Rimuovi il testo nascosto nella pagina."
type: docs
url: /it/go-cpp/organize/pageremovehiddentext/
---
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveHiddenText(num int32) rimuove il testo nascosto nella pagina
