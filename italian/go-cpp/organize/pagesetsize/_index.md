...
description: "Imposta le dimensioni della pagina."
type: docs
url: /it/go-cpp/organize/pagesetsize/
---

_Imposta la dimensione della pagina._
...
func main() {
	...
	defer pdf.Close()
	// PageSetSize(num int32, pageSize int32) imposta la dimensione della pagina
