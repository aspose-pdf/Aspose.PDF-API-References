...
type: docs
url: /it/go-cpp/organize/validate/
---

_Convalida un documento PDF per la conformità al formato PDF._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) convalida il documento PDF per la conformità PDF/A
