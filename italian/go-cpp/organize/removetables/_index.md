...
description: "Rimuovi le tabelle dal documento PDF."
type: docs
url: /it/go-cpp/organize/removetables/
---

_Rimuovi le tabelle da un documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// RemoveTables() rimuove le tabelle da un documento PDF
