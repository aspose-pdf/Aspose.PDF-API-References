...
description: "Mehrere Textfragmente in einer PDF-Datei mit Ausrichtungssteuerung ersetzen."
type: docs
url: /de/javascript-cpp/organize/asposepdfreplacetextex/
---

_Ersetzen Sie mehrere Textfragmente in einer PDF-Datei mit Ausrichtungssteuerung._
...
Richtung kann auch explizit erzwungen werden, indem man `replaceText` voranstellt
mit speziellen Unicode‑Zeichen:
`\\u200F` (RTL) oder `\\u200E` (LTR), vorzugsweise als erstes Zeichen
