...
description: "Ein PDF-Dokument auf Konformität mit dem PDF-Format prüfen."
type: docs
url: /de/go-cpp/organize/validate/
---

_Ein PDF-Dokument auf Konformität mit dem PDF-Format prüfen._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) prüft das PDF-Dokument auf PDF/A-Konformität
