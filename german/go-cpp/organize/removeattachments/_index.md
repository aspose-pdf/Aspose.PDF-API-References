...
description: "Anhänge aus dem PDF-Dokument entfernen."
type: docs
url: /de/go-cpp/organize/removeattachments/
---

_Entfernt Anhänge aus dem PDF-Dokument._
...
func main() {
	...
	defer pdf.Close()
	// RemoveAttachments() entfernt Anhänge aus dem PDF-Dokument
