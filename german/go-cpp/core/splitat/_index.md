...
description: "Das aktuelle PDF-Dokument in zwei neue PDF-Dokumente aufteilen."
type: docs
url: /de/go-cpp/core/splitat/
---
...
func main() {
	...
	// SplitAt(page int) teilt das aktuelle PDF-Dokument in zwei neue PDF-Dokumente.
