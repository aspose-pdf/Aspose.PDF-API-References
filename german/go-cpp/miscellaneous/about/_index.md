...
description: "Metadateninformationen über Aspose.PDF für Go via C++ zurückgeben."
type: docs
url: /de/go-cpp/miscellaneous/about/
---

_Gibt Metadateninformationen über Aspose.PDF für Go via C++ zurück._
...
func main() {
	...
	defer pdf.Close()
	// About() gibt Metadateninformationen über Aspose.PDF für Go via C++ zurück
	info, err := pdf.About()
	if err != nil {
		log.Fatal(err)
	}
