...
description: Repräsentiert Link-Strukturelement in logischer Struktur.
type: docs
weight: 4270
...
Repräsentiert Link-Strukturelement in logischer Struktur.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions) { get; set; } | Ruft die alternativen Beschreibungen für die Anmerkung ab oder legt sie fest. Text, der für die Anmerkung angezeigt werden soll, oder, wenn dieser Anmerkungstyp keinen Text anzeigt, eine alternative Beschreibung des Inhalts der Anmerkung in menschenlesbarer Form. |
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink) { get; set; } | Holt oder setzt Hyperlink für Link-Element. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/linkelement/structuretextstate) { get; } | erhältStructureTextState Objekt für aktuelles Element. |
...
| [SetText](../../aspose.pdf.logicalstructure/linkelement/settext)(string) | Hängt Textinhalt an aktuelles Textelement an. |
