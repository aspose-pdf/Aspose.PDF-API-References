...
description: Aspose.Pdf.LogicalStructure.RubyChildElement-Klasse. Stellt eine Basisklasse für Kindelemente des Ruby in der logischen Struktur dar
type: docs
weight: 6590
url: /de/net/aspose.pdf.logicalstructure/rubychildelement/
---
## RubyChildElement-Klasse
...
| [ChildElements](../../aspose.pdf.logicalstructure/element/childelements/) { get; } | Ruft die Sammlung von Kindelementen ab. |
...
| [Page](../../aspose.pdf.logicalstructure/structureelement/page/) { get; } | Ruft die Seite ab, auf der einige oder alle Kindelemente gerendert werden. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Entfernt: ein Element aus der Struktur, eine Referenz darauf aus dem Elternelement, Referenzen darauf aus Kindelementen, das entsprechende Objekt aus dem Dokument. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Entfernt ein Element aus der Struktur, eine Referenz darauf aus dem Elternelement, Referenzen darauf aus Kindelementen und das entsprechende Objekt aus dem Dokument. Fügt die Kindelemente des entfernten Objekts in die Sammlung der Kindelemente seines ehemaligen Elternobjekts ab dem Index des entfernten Objekts ein. |
