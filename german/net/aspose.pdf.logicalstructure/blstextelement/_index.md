...
description: Aspose.Pdf.LogicalStructure.BLSTextElement-Klasse. Stellt eine Basisklasse für Blockebene-Textstruktur-Elemente in der logischen Struktur dar
type: docs
weight: 6250
url: /de/net/aspose.pdf.logicalstructure/blstextelement/
---
## BLSTextElement-Klasse

Stellt eine Basisklasse für Blockebene-Textstruktur-Elemente in der logischen Struktur dar.
...
| [ChildElements](../../aspose.pdf.logicalstructure/element/childelements/) { get; } | Ruft die Sammlung von Kind-Elementen ab. |
...
| [ExpansionText](../../aspose.pdf.logicalstructure/structureelement/expansiontext/) { get; set; } | Ruft den Erweiterungstext für das Struktur-Element ab oder legt ihn fest. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | Ruft das StructureTextState-Objekt für das aktuelle Element ab. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(BDC) | Bindet ein Struktur-Element an den Inhaltstrom BDC-Operator. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XForm) | Bindet ein Struktur-Element an den Inhaltstrom XForm. |
