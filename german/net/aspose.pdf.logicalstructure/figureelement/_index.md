...
description: Repräsentiert ein Abbildungsstrukturelement in einer logischen Struktur.
type: docs
weight: 4170
...
Repräsentiert ein Abbildungsstrukturelement in einer logischen Struktur.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double) | Fügt Bild an aktuelles Illustrationselement an. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double, double) | Fügt Bild an aktuelles Illustrationselement an. |
