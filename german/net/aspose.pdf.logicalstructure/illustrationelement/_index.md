...
description: Repräsentiert eine Basisklasse für Illustrationsstrukturelemente in einer logischen Struktur.
type: docs
weight: 4250
...
Repräsentiert eine Basisklasse für Illustrationsstrukturelemente in einer logischen Struktur.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage)(string, double) | Fügt Bild an aktuelles Illustrationselement an. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage_1)(string, double, double) | Fügt Bild an aktuelles Illustrationselement an. |
