...
description: Aspose.Pdf.LogicalStructure.NoteElement-Klasse. Stellt ein Notizstruktur-Element in der logischen Struktur dar
type: docs
weight: 6520
url: /de/net/aspose.pdf.logicalstructure/noteelement/
---
## NoteElement-Klasse

Stellt ein Notizstruktur-Element in der logischen Struktur dar.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Ruft das StructureTextState-Objekt für das aktuelle Element ab. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Entfernt: ein Element aus der Struktur, eine Referenz darauf aus dem übergeordneten Objekt, Referenzen darauf aus Kind-Objekten, das entsprechende Objekt aus dem Dokument. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Entfernt ein Element aus der Struktur, eine Referenz darauf aus dem übergeordneten Objekt, Referenzen darauf aus Kind-Objekten und das entsprechende Objekt aus dem Dokument. Fügt die Kind-Objekte des entfernten Objekts in die Sammlung der Kind-Objekte seines ehemaligen übergeordneten Objekts ab dem Index des entfernten Objekts ein. |
...
* Klasse [ILSTextElement](../ilstextelement/)
