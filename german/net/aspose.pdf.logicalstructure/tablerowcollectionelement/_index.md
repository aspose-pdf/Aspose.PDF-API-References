...
description: Repräsentiert eine Basisklasse für untergeordnete Elemente des Tabellenkopfes -körpers und -fußes in logischer Struktur.
type: docs
weight: 4620
...
Repräsentiert eine Basisklasse für untergeordnete Elemente des Tabellenkopfes, -körpers und -fußes in logischer Struktur.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | erstellt[`TableTRElement`](../tabletrelement) und zur aktuellen Tabelle hinzugefügt. |
