...
| Name | Beschreibung |
| --- | --- |
| [PdfPageStamp](pdfpagestamp#constructor)(Page) | Konstruktor von PdfPageStamp. |
| [PdfPageStamp](pdfpagestamp#constructor_1)(Stream, int) | Erstellt einen Pdf-Seitenstempel von der angegebenen Seite im Dokument aus dem Stream. |
...
| [PdfPage](../../aspose.pdf/pdfpagestamp/pdfpage) { get; set; } | Holt oder setzt Seite, die als Stempel verwendet wird. |
...
| override [Put](../../aspose.pdf/pdfpagestamp/put)(Page) | Stempel auf die angegebene Seite setzen. |
