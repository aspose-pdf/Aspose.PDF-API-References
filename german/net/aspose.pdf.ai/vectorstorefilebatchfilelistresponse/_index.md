...
description: Aspose.Pdf.AI.VectorStoreFileBatchFileListResponse-Klasse. Stellt eine Listenantwort dar, die Daten zu Vektorstore-Dateibatches enthält
type: docs
weight: 1300
url: /de/net/aspose.pdf.ai/vectorstorefilebatchfilelistresponse/
---
## Klasse VectorStoreFileBatchFileListResponse

Stellt eine Listenantwort dar, die Daten zu Vektorstore-Dateibatches enthält.
...
| Name | Beschreibung |
| --- | --- |
| [VectorStoreFileBatchFileListResponse](vectorstorefilebatchfilelistresponse/)() | Der Standardkonstruktor. |
