...
description: OpenAIClient-Methode. Lädt eine Datei asynchron auf den OpenAI-Server hoch
type: docs
weight: 450
url: /de/net/aspose.pdf.ai/openaiclient/uploadfileasync/
---
...
| Ausnahme | Bedingung |
| --- | --- |
| [AIClientException](../../aiclientexception/) | Wird ausgelöst, wenn der Zweck der Datei null oder leer ist. |
