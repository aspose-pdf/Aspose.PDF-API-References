...
description: Aspose.Pdf.AI.OpenAIChatCopilot-Klasse. Stellt einen Chat-Copilot dar, um über KI-Modelle mit Dokumenten zu interagieren. Beispiel für die Verwendung der Erstellung eines OpenAI-Clients, Konfiguration von Optionen und Verwendung des ChatCopilot zur Interaktion mit Benutzeranfragen und Verwaltung des Gesprächskontexts.
type: docs
weight: 820
url: /de/net/aspose.pdf.ai/openaichatcopilot/
---
...
| Name | Beschreibung |
| --- | --- |
| [OpenAIChatCopilot](openaichatcopilot/)(IOpenAIClient, IChatCopilotOptions&lt;OpenAIChatCopilotOptions&gt;) | Initialisiert eine neue Instanz der `OpenAIChatCopilot`-Klasse mit dem angegebenen Client und den Optionen. |
...
* Schnittstelle [IChatCopilot](../ichatcopilot/)
