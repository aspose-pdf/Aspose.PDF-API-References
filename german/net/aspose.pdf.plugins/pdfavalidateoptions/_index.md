...
description: Aspose.Pdf.Plugins.PdfAValidateOptions-Klasse. Stellt Optionen zur Validierung der PDF/A-Konformität von PDF-Dokumenten mit dem PdfAConverter-Plugin dar
type: docs
weight: 9030
url: /de/net/aspose.pdf.plugins/pdfavalidateoptions/
---
## PdfAValidateOptions-Klasse

Stellt Optionen zur Validierung der PDF/A-Konformität von PDF-Dokumenten mit dem [`PdfAConverter`](../pdfaconverter/) Plugin dar.
...
| Name | Beschreibung |
| --- | --- |
| [PdfAValidateOptions](pdfavalidateoptions/)() | Der Standardkonstruktor. |
...
| [PuaSymbolsProcessingStrategy](../../aspose.pdf.plugins/pdfaoptionsbase/puasymbolsprocessingstrategy/) { get; set; } | Ruft die Strategie zum Verarbeiten von Symbolen im Bereich der privaten Nutzung (PUA) im PDF-Dokument ab oder legt sie fest. |
| [SoftMaskAction](../../aspose.pdf.plugins/pdfaoptionsbase/softmaskaction/) { get; set; } | Ruft die Aktion ab oder legt die Aktion fest, die während der Konvertierung von Bildern mit weichen Masken durchgeführt werden soll. |
...
| [UnicodeProcessingRules](../../aspose.pdf.plugins/pdfaoptionsbase/unicodeprocessingrules/) { get; set; } | Ruft die Regeln zum Verarbeiten von ToUnicode CMap-Tabellen ab und legt sie fest, die nicht mit Unicode-Symbolen während des PDF/A-Konvertierungsprozesses verknüpft sind. |
