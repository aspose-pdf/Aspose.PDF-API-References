...
description: Klasse die das Combobox-Feld des Formulars darstellt.
type: docs
weight: 2950
...
Klasse, die das Combobox-Feld des Formulars darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [ComboBoxField](comboboxfield#constructor)() | Konstruktor für ComboBoxField zur Verwendung im Generator. |
| [ComboBoxField](comboboxfield#constructor_1)(Document) | Erstellt CombBox-Feld für die Arbeit mit Generator. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | Konstruktor für Combobox-Feld. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | Konstruktor für Combobox-Feld. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable) { get; set; } | Ruft den bearbeitbaren Status des Felds ab oder legt ihn fest. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected) { get; set; } | Ermittelt oder setzt den Index der ausgewählten Option. Diese Eigenschaft ermöglicht es, die Auswahl zu ändern. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck) { get; set; } | Ruft den Aktivitätsstatus der Zauberprüfung ab oder legt ihn fest. |
