...
description: Aspose.Pdf.Forms.NumberField-Klasse. Textfeld mit angegebenen gültigen Zeichen
type: docs
weight: 5140
...
| Name | Beschreibung |
| --- | --- |
| [NumberField](numberfield/#constructor)() | Initialisiert eine neue Instanz der `NumberField`-Klasse. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | Initialisiert eine neue Instanz der `NumberField`-Klasse. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | Initialisiert eine neue Instanz der `NumberField`-Klasse. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | Ruft die erlaubten Zeichen ab oder legt sie fest. |
...
| [IsGroup](../../aspose.pdf.forms/field/isgroup/) { get; } | Ruft einen booleschen Wert ab oder legt ihn fest, der angibt, ob dieses Feld ein nicht-terminales Feld, d.h. eine Gruppe von Feldern ist. |
...
| [TabOrder](../../aspose.pdf.forms/field/taborder/) { get; set; } | Ruft die Tab-Reihenfolge des Feldes ab oder legt sie fest. |
