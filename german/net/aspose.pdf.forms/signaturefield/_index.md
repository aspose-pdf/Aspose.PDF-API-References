...
description: Stellt das Signaturformularfeld dar.
type: docs
weight: 3230
...
| Name | Beschreibung |
| --- | --- |
| [SignatureField](signaturefield#constructor)(Document, Rectangle) | Initialisiert eine neue Instanz von[`SignatureField`](../signaturefield) Klasse. |
| [SignatureField](signaturefield#constructor_1)(Page, Rectangle) | Initialisiert eine neue Instanz von[`SignatureField`](../signaturefield) Klasse. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature) { get; } | Ruft Signaturobjekt ab. Dieses Objekt enthält Signaturdaten bezüglich Public-Key-Verschlüsselungsstandards. Klassen[`PKCS1`](../pkcs1) ,[`PKCS7`](../pkcs7) und[`PKCS7Detached`](../pkcs7detached) stehen für alle unterstützten Arten von Signaturobjekten. |
...
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage)() | Extrahiert das Bild der Signatur als JPEG-codierten Stream. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage_1)(ImageFormat) | Extrahiert das Bild der Signatur als verschlüsselten Stream. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign)(Signature) | Signieren Sie das Dokument mit diesem Signaturfeld. |
