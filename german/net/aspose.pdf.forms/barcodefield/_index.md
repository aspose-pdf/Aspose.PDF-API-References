...
description: Klasse repräsentiert Barcodefeld.
type: docs
weight: 2900
...
Klasse repräsentiert Barcodefeld.
...
| Name | Beschreibung |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | Initialisiert eine neue Instanz von[`BarcodeField`](../barcodefield) Klasse. |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | Initialisiert eine neue Instanz von[`BarcodeField`](../barcodefield) Klasse. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption) { get; } | Ruft die Beschriftung des Barcode-Objekts ab. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } | Ruft einen ganzzahligen Wert ab, der den Fehlerkorrekturkoeffizienten darstellt. Für PDF417 muss es von 0 bis 8 sein. Für QRCode muss es von 0 bis 3 sein (0 für „L“, 1 für „M“, 2 für „Q“ und 3 für „H“). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution) { get; } | Ruft die Auflösung in Punkten pro Zoll (dpi) ab, mit der das Barcode-Objekt gerendert wird. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | Gibt an, welche Barcode- oder Glyph-Technologie für diese Anmerkung verwendet werden soll, siehe[`Symbology`](./symbology) für Details. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight) { get; } | Ermittelt den vertikalen Abstand zwischen zwei Barcode-Modulen, gemessen in Pixel. Das Verhältnis XSymHeight/XSymWidth muss ein ganzzahliger Wert sein. Für PDF417 liegt der akzeptable Verhältnisbereich zwischen 1 und 4. Für QRCode und DataMatrix muss dieses Verhältnis immer 1 sein. |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth) { get; } | Ruft den horizontalen Abstand zwischen zwei Barcode-Modulen in Pixel ab. |
