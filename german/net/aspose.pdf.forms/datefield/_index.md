...
description: Datumsfeld mit Kalenderansicht.
type: docs
weight: 2960
...
| Name | Beschreibung |
| --- | --- |
| [DateField](datefield#constructor)() | Initialisiert eine neue Instanz von[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | Konstruktor, der mit Generator verwendet werden soll. |
| [DateField](datefield#constructor_2)(Document, Rectangle) | Initialisiert eine neue Instanz von[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | Initialisiert eine neue Instanz von[`DateField`](../datefield) |
...
| [Value](../../aspose.pdf.forms/datefield/value) { get; set; } | Ruft Datum ab oder legt es fest. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | Hinzufügen von Bildern für dieses Feld verweigert. (2 methods) |
