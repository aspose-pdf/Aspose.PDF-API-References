...
description: Klasse die das Textfeldfeld darstellt.
type: docs
weight: 3250
...
Klasse, die das Textfeldfeld darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [TextBoxField](textboxfield#constructor)() | Instanz von TextBoxField erstellen. |
| [TextBoxField](textboxfield#constructor_1)(Document) | Konstruktor, der mit Generator verwendet werden soll. |
| [TextBoxField](textboxfield#constructor_2)(Document, Rectangle) | Konstruktor des TextBox-Felds. |
| [TextBoxField](textboxfield#constructor_3)(Page, Rectangle) | Konstruktor des TextBox-Felds. |
