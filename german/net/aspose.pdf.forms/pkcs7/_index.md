...
description: Aspose.Pdf.Forms.PKCS7-Klasse. Stellt das PKCS7-Objekt dar, das der PKCS7-Spezifikation in Internet RFC 2315 PKCS 7 Cryptographic Message Syntax Version 1.5 entspricht. Der SHA1-Hash des Bytebereichs des Dokuments ist im PKCS7 SignedData-Feld enthalten.
type: docs
weight: 5180
url: /de/net/aspose.pdf.forms/pkcs7/
---
## PKCS7-Klasse

Stellt das PKCS#7-Objekt dar, das der PKCS#7-Spezifikation in Internet RFC 2315, PKCS #7: Cryptographic Message Syntax, Version 1.5 entspricht. Der `SHA1-Hash` des Bytebereichs des Dokuments ist im PKCS#7 SignedData-Feld enthalten.
...
| Name | Beschreibung |
| --- | --- |
| [PKCS7](pkcs7/#constructor)() | Initialisiert eine neue Instanz der `PKCS7`-Klasse. |
| [PKCS7](pkcs7/#constructor_1)(Stream, string) | Initialisiert eine neue Instanz der `PKCS7`-Klasse. |
| [PKCS7](pkcs7/#constructor_2)(string, string) | Initialisiert eine neue Instanz der `PKCS7`-Klasse. |
...
| [ByteRange](../../aspose.pdf.forms/signature/byterange/) { get; } | Ein Array von Paaren von Ganzzahlen (Start-Byte-Offset, Länge in Bytes), das den genauen Bytebereich für die Hash-Berechnung beschreibt. |
...
| [ShowProperties](../../aspose.pdf.forms/signature/showproperties/) { get; set; } | Erzwingt das Anzeigen/Verstecken von Signatureigenschaften. Falls ShowProperties true ist, hat das Signaturfeld ein vordefiniertes Format des Erscheinungsbilds (Strings zur Darstellung): ------------------------------------------- Digital signiert von {Zertifikatssubjekt} Datum: {signature.Date} Grund: {signature.Reason} Standort: {signature.Location} ------------------------------------------- wobei {X} ein Platzhalter für den X-Wert ist. Außerdem kann die Signatur ein Bild haben, in diesem Fall werden die aufgelisteten Strings über das Bild gelegt. ShowProperties ist standardmäßig true. |
...
| [Verify](../../aspose.pdf.forms/signature/verify/)() | Überprüft das Dokument hinsichtlich dieser Signatur und gibt true zurück, wenn das Dokument gültig ist, andernfalls false. |
| [Verify](../../aspose.pdf.forms/signature/verify/)(ValidationOptions, out ValidationResult) | Überprüft das Dokument hinsichtlich dieser Signatur und gibt true zurück, wenn das Dokument gültig ist, andernfalls false. |
