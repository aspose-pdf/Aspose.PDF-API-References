...
description: Aspose.Pdf.Forms.RadioButtonField-Klasse. Klasse, die ein Optionsfeld darstellt
type: docs
weight: 5210
url: /de/net/aspose.pdf.forms/radiobuttonfield/
---
## Klasse RadioButtonField

Klasse, die ein Optionsfeld darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [RadioButtonField](radiobuttonfield/#constructor)(Document) | Konstruktor für RadioButtonField. |
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Konstruktor für RadioButtonField |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately/) { get; set; } | Ruft das Flag für die sofortige Bestätigung bei Auswahländerungen ab oder legt es fest. |
...
| [IsFirstParagraphInColumn](../../aspose.pdf/baseparagraph/isfirstparagraphincolumn/) { get; set; } | Ruft einen booleschen Wert ab oder legt ihn fest, der angibt, ob dieser Absatz in der nächsten Spalte steht. Standard ist false. (für die PDF-Generierung) |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Ruft das Flag ab oder legt es fest, das es dem Optionsfeld erlaubt, keinen ausgewählten Wert zu haben. Wenn `true`, muss immer genau ein Optionsfeld ausgewählt sein; das Auswählen des derzeit ausgewählten Buttons hat keine Auswirkungen. Wenn `false`, wird der ausgewählte Button abgewählt, sodass kein Button ausgewählt bleibt. |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options/) { get; } | Ruft die Sammlung von Optionen des Optionsfeldes ab. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Ruft den Index der Seite ab, die dieses RadioButton-Feld enthält. |
| [Parent](../../aspose.pdf.annotations/widgetannotation/parent/) { get; } | Ruft den übergeordneten Annotation ab. |
| [PartialName](../../aspose.pdf.forms/field/partialname/) { get; set; } | Ruft den partiellen Namen des Feldes ab oder legt ihn fest. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Ruft den Index des ausgewählten Elements ab oder legt ihn fest. Die Nummerierung der Elemente beginnt bei 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Stil des Feldkästchens. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value/) { get; set; } | Ruft den Wert des Feldes ab oder legt ihn fest. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add/)(RadioButtonOptionField) | Fügt ein neues Optionsfeld zum RadioButton-Feld hinzu. |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Fügt eine Option zum Optionsfeld hinzu. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Fügt eine Option zum Optionsfeld mit dem angegebenen Rechteck hinzu. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/)(WidgetAnnotation[], int) | Kopiert die Unterfelder dieses Feldes in ein Array, beginnend ab dem angegebenen Index. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Verschiebt alle Unterelemente des Optionsfeldes an die angegebenen Positionen auf der Seite. |
