...
description: Klasse die das Optionsfeld darstellt.
type: docs
weight: 3160
...
Klasse, die das Optionsfeld darstellt.
...
| [RadioButtonField](radiobuttonfield#constructor_1)(Page) | Konstruktor für RadioouttonField |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options) { get; } | Ruft eine Sammlung von Optionen des Optionsfelds ab. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | Ruft den Index des ausgewählten Elements ab oder legt ihn fest. Die Nummerierung der Artikel beginnt bei 1. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems) { get; set; } | Ruft ein Array ausgewählter Elemente ab oder legt es fest. Für Multiselect-Listen-Array enthält mehr als ein Element. Für die Einzelauswahlliste enthält sie ein einzelnes Element. |
| [States](../../aspose.pdf.annotations/annotation/states) { get; } | Ruft das Darstellungswörterbuch der Anmerkung ab. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Stil der Feldbox. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value) { get; set; } | Ruft den Wert des Felds ab oder legt ihn fest. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | Fügt neues Optionsfeld zu RadioButton field hinzu |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Option zum Radion-Button hinzufügen. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | Option zum Optionsfeld mit angegebenem Rechteck hinzufügen. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition)(Point) | Verschiebt alle Unterelemente des Optionsfelds an die angegebenen Positionen auf der Seite. |
