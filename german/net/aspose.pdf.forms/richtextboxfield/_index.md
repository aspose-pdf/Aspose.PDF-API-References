...
description: Klasse beschreibt Rich-Text-Editor-Komponente.
type: docs
weight: 3180
...
Klasse beschreibt Rich-Text-Editor-Komponente.
...
| Name | Beschreibung |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | Konstruktor für das Rich-Text-Box-Feld. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Ruft formatierten Rich-Text-Wert mit Markup ab oder legt ihn fest. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Ruft die Begründung des Rich-Text-Felds ab oder legt sie fest. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | Ruft die Standardstilzeichenfolge des Rich-Text-Felds ab oder legt sie fest. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value) { get; set; } | Wert von RichTextField. |
