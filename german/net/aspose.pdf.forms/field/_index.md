...
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Maximail-Schriftgröße, die für Feldinhalte verwendet werden kann. -1, um die Größe nicht zu prüfen. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | Minimale Schriftgröße, die für Feldinhalte verwendet werden kann. -1, um die Größe nicht zu prüfen. |
