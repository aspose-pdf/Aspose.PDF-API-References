...
description: Klasse die das Kontrollkästchenfeld darstellt
type: docs
weight: 2930
...
Klasse, die das Kontrollkästchenfeld darstellt
...
| Name | Beschreibung |
| --- | --- |
| [CheckboxField](checkboxfield#constructor)() | Instanz von CheckboxField erstellen. |
| [CheckboxField](checkboxfield#constructor_1)(Document) | Konstruktor zur Verwendung mit Generator. |
| [CheckboxField](checkboxfield#constructor_2)(Document, Rectangle) | Konstruktor für CheckboxField-Klasse. |
| [CheckboxField](checkboxfield#constructor_3)(Page, Rectangle) | Konstruktor für CheckboxField-Klasse. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate) { get; set; } | Ruft den aktuellen Darstellungszustand der Anmerkung ab oder legt ihn fest. |
| [AllowedStates](../../aspose.pdf.forms/checkboxfield/allowedstates) { get; } | Gibt eine Liste der zulässigen Zustände zurück. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue) { get; set; } | Ruft den Exportwert des CheckBox-Felds ab oder legt ihn fest. |
...
| override [Value](../../aspose.pdf.forms/checkboxfield/value) { get; set; } | Ruft den Wert des Kontrollkästchens ab oder legt ihn fest. |
...
| override [Clone](../../aspose.pdf.forms/checkboxfield/clone)() | Klonen Sie das Kontrollkästchen. |
