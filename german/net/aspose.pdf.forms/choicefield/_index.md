...
description: Aspose.Pdf.Forms.ChoiceField-Klasse. Stellt die Basisklasse für Auswahlfelder dar
type: docs
weight: 4990
url: /de/net/aspose.pdf.forms/choicefield/
---
## ChoiceField-Klasse
...
| Name | Beschreibung |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Erstellt ein Auswahlfeld (für Generator) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | Konstruktor für ChoiceField. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | Konstruktor für ChoiceField. |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | Ruft die Anzahl der Unterfelder in diesem Feld ab. (Zum Beispiel die Anzahl der Elemente im Auswahlfeld). |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | Fügt eine neue Option mit dem angegebenen Namen hinzu. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | Fügt eine neue Option mit dem angegebenen Exportwert und Namen hinzu. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/)(WidgetAnnotation[], int) | Kopiert Unterfelder dieses Feldes in ein Array, beginnend mit dem angegebenen Index. |
