...
description: Die Klasse repräsentiert das Element des RadioButton-Felds.
type: docs
weight: 3170
...
Die Klasse repräsentiert das Element des RadioButton-Felds.
...
| Name | Beschreibung |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | Neue RadioButtonOptionField-Instanz erstellen. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | Erstellt einen Radiobutton im angegebenen Recangle auf der angegebenen Seite. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption) { get; set; } | Ruft die Beschriftung ab oder legt sie fest. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname) { get; set; } | Ruft den Namen der Option ab oder legt ihn fest. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style) { get; set; } | Ruft den Stil des Kontrollkästchens ab oder legt ihn fest. |
