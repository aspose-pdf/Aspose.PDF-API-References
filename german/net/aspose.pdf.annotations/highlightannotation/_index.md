...
description: Stellt eine Hervorhebungsanmerkung dar die einen Textbereich im Dokument hervorhebt.
type: docs
weight: 490
...
Stellt eine Hervorhebungsanmerkung dar, die einen Textbereich im Dokument hervorhebt.
...
| Name | Beschreibung |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | Erstellt eine neue Highlight-Anmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
