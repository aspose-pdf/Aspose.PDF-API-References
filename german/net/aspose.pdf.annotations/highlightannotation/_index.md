...
description: Aspose.Pdf.Annotations.HighlightAnnotation-Klasse. Stellt eine Hervorhebungsannotation dar, die einen Textbereich im Dokument hervorhebt
type: docs
weight: 1870
url: /de/net/aspose.pdf.annotations/highlightannotation/
---
## HighlightAnnotation-Klasse

Stellt eine Hervorhebungsannotation dar, die einen Textbereich im Dokument hervorhebt.
...
| Name | Beschreibung |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Seite, Rechteck) | Erstellt eine neue Hervorhebungsannotation auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | Gibt den Typ der Annotation zurück. |
...
| [IsInNewPage](../../aspose.pdf/baseparagraph/isinnewpage/) { get; set; } | Gibt einen booleschen Wert zurück oder legt ihn fest, der erzwingt, dass dieser Absatz auf einer neuen Seite generiert wird. Standard ist falsch. (für die PDF-Generierung) |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Gibt einen Rich-Text-String zurück oder legt ihn fest, der im Pop-up-Fenster angezeigt werden soll, wenn die Annotation geöffnet wird. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Akzeptiert ein Besucherobjekt, um die Annotation zu verarbeiten. |
