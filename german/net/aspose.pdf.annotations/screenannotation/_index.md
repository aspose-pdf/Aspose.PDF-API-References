...
description: Eine Bildschirmanmerkung die einen Bereich einer Seite angibt auf dem Medienclips abgespielt werden können.
type: docs
weight: 1060
...
Eine Bildschirmanmerkung, die einen Bereich einer Seite angibt, auf dem Medienclips abgespielt werden können.
...
| Name | Beschreibung |
| --- | --- |
| [ScreenAnnotation](screenannotation)(Page, Rectangle, string) | Erstellt eine neue Bildschirmanmerkung auf der angegebenen Seite. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action) { get; } | Ruft eine Aktion ab oder legt diese fest, die ausgeführt werden soll, wenn die Anmerkung aktiviert wird. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title) { get; set; } | Ruft den Titel der Bildschirmanmerkung ab oder legt ihn fest. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
