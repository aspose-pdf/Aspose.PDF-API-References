...
description: Stellt eine Unterstreichungsanmerkung dar die als Unterstreichung im Text des Dokuments erscheint.
type: docs
weight: 1240
...
Stellt eine Unterstreichungsanmerkung dar, die als Unterstreichung im Text des Dokuments erscheint.
...
| Name | Beschreibung |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | Erstellt eine neue Unterstreichungsanmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
