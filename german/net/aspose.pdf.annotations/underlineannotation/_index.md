...
description: Aspose.Pdf.Annotations.UnderlineAnnotation-Klasse. Stellt eine Unterstreichungsannotation dar, die als Unterstreichung im Text des Dokuments erscheint
type: docs
weight: 2700
url: /de/net/aspose.pdf.annotations/underlineannotation/
---
## Klasse UnderlineAnnotation

Stellt eine Unterstreichungsannotation dar, die als Unterstreichung im Text des Dokuments erscheint.
...
| Name | Beschreibung |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Seite, Rechteck) | Erstellt eine neue Unterstreichungsannotation auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Gibt den Typ der Annotation zurück. |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Gibt eine Rich-Text-Zeichenfolge zurück oder legt sie fest, die im Popup-Fenster angezeigt werden soll, wenn die Annotation geöffnet wird. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Akzeptiert ein Besucherobjekt, um die Annotation zu verarbeiten. |
