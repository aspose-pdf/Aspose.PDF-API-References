...
description: Klasse die Zeilenanmerkungen darstellt.
type: docs
weight: 600
...
Klasse, die Zeilenanmerkungen darstellt.
...
| [LineAnnotation](lineannotation#constructor_1)(Page, Rectangle, Point, Point) | Erstellt eine neue Zeilenanmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset) { get; set; } | Ruft den Beschriftungstext-Offset von seiner normalen Position ab oder legt ihn fest. |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition) { get; set; } | Ruft die Position der Anmerkungsunterschrift ab oder legt sie fest. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending) { get; set; } | Ruft den Endpunkt der Linie ab oder setzt ihn. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle) { get; set; } | Ruft den Endstil für den Endpunkt der Linie ab oder legt ihn fest. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent) { get; set; } | Ruft die Absicht der Zeilenanmerkung ab oder legt sie fest. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor) { get; set; } | Ruft die Innenfarbe der Anmerkung ab oder legt sie fest. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline) { get; set; } | Ruft die Länge der Führungslinie ab oder legt sie fest. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension) { get; set; } | Ruft die Länge der Verlängerung der Führungslinie ab oder legt sie fest. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset) { get; set; } | Ruft den Abstand der Führungslinie ab oder legt ihn fest. |
| [Margin](../../aspose.pdf/baseparagraph/margin) { get; set; } | Liest oder setzt einen Außenrand für Absatz (für PDF-Generierung) |
| [Measure](../../aspose.pdf.annotations/lineannotation/measure) { get; set; } | Für diese Anmerkung angegebene Maßeinheiten. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption) { get; set; } | Erhält oder setzt ein boolesches Flag, das bestimmt, ob der Inhalt als Beschriftung angezeigt werden muss. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting) { get; set; } | Ermittelt oder setzt den Startpunkt der Linie. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle) { get; set; } | Ermittelt oder legt den Linienendstil für den Linienstartpunkt fest. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept)(AnnotationSelector) | Akzeptiert Besucher zur Anmerkungsverarbeitung. |
