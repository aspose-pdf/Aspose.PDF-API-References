...
description: Stellt die verschnörkelte Anmerkung dar die als gezackte Unterstreichung im Text eines Dokuments erscheint.
type: docs
weight: 1150
...
Stellt die verschnörkelte Anmerkung dar, die als gezackte Unterstreichung im Text eines Dokuments erscheint.
...
| Name | Beschreibung |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation)(Page, Rectangle) | Erstellt eine neue Squiggly-Anmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
