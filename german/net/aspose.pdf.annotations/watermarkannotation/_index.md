...
description: Aspose.Pdf.Annotations.WatermarkAnnotation-Klasse. Klasse beschreibt das Watermark-Annotationsobjekt
type: docs
weight: 2710
url: /de/net/aspose.pdf.annotations/watermarkannotation/
---
## Klasse WatermarkAnnotation

Klasse beschreibt das Watermark-Annotationsobjekt.
...
| Name | Beschreibung |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation/)(Seite, Rechteck) | Konstruktor für die Watermark-Annotationsklasse. |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype/) { get; } | Gibt den Annotations-Typ zurück. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint/) { get; } | Festdruckobjekt der Watermark-Annotation. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity/) { get; set; } | Gibt die Opazität der Annotation zurück oder setzt sie. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept/)(AnnotationSelector) | Wendet den Besucher für die Annotation an. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/watermarkannotation/changeafterresize/)(Matrix) | Überschreibt die Definition in der Basisklasse mit einem leeren Körper. |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext/)(FormattedText) | Setzt den Text der Annotation. |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate/)(string[], TextState) | Setzt den Text der Annotation. |
