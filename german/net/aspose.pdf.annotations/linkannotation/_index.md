...
description: Stellt entweder einen Hypertext-Link zu einem anderen Ziel im Dokument oder eine auszuführende Aktion dar.
type: docs
weight: 630
...
Stellt entweder einen Hypertext-Link zu einem anderen Ziel im Dokument oder eine auszuführende Aktion dar.
...
| Name | Beschreibung |
| --- | --- |
| [LinkAnnotation](linkannotation)(Page, Rectangle) | Erstellt eine neue Link-Anmerkung auf der angegebenen Seite. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action) { get; set; } | Eine Aktion, die ausgeführt werden soll, wenn die Link-Anmerkung aktiviert wird. |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination) { get; set; } | Ein Ziel, das angezeigt werden soll, wenn die Anmerkung aktiviert ist. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | Der zu verwendende visuelle Effekt, wenn die Maustaste innerhalb ihres aktiven Bereichs gedrückt oder gehalten wird. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
