...
description: Aspose.Pdf.Annotations.FileAttachmentAnnotation-Klasse. Klasse beschreibt die Datei-Anhang-Anmerkung
type: docs
weight: 1710
url: /de/net/aspose.pdf.annotations/fileattachmentannotation/
---
## Klasse FileAttachmentAnnotation

Klasse beschreibt die Datei-Anhang-Anmerkung.
...
| Name | Beschreibung |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Seite, Rechteck, Dateispezifikation) | Erstellt eine neue Datei-Anhang-Anmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | Gibt den Typ der Anmerkung zurück. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | Die Spezifikation der Datei, die mit dieser Anmerkung verbunden ist. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Gibt das Symbol zurück oder legt es fest, das zur Anzeige der Anmerkung verwendet werden soll. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Gibt die Opazität des Symbols von 0 bis 1 zurück: 0 - vollständig transparent, 1 - vollständig undurchsichtig. |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Gibt eine Rich-Text-Zeichenfolge zurück oder legt sie fest, die im Popup-Fenster angezeigt wird, wenn die Anmerkung geöffnet wird. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Akzeptiert ein Besucherobjekt zur Verarbeitung der Anmerkung. |
