...
description: Aspose.Pdf.Annotations.PopupAnnotation-Klasse. Stellt die Popup-Annotation dar, die Text in einem Popup-Fenster zur Eingabe und Bearbeitung anzeigt
type: docs
weight: 2330
url: /de/net/aspose.pdf.annotations/popupannotation/
---
## PopupAnnotation-Klasse

Stellt die Popup-Annotation dar, die Text in einem Popup-Fenster zur Eingabe und Bearbeitung anzeigt.
...
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | Erstellt eine neue Popup-Annotation auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | Gibt den Typ der Annotation zurück. |
...
| [IsInNewPage](../../aspose.pdf/baseparagraph/isinnewpage/) { get; set; } | Gibt einen booleschen Wert zurück oder legt ihn fest, der angibt, ob dieser Absatz auf einer neuen Seite generiert werden soll. Standard ist false (für PDF-Generierung). |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Gibt einen Flag zurück oder legt ihn fest, der angibt, ob die Popup-Annotation zunächst geöffnet angezeigt werden soll. |
...
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Gibt die übergeordnete Annotation zurück oder legt sie fest, mit der diese Popup-Annotation verknüpft werden soll. Wenn dieser Eintrag vorhanden ist, überschreiben die Inhalte, M, C und T der übergeordneten Annotation die der Popup-Annotation selbst. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Akzeptiert ein Besucherobjekt zur Verarbeitung der Annotation. |
