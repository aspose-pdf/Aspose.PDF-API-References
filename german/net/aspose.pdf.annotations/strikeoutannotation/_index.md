...
description: Stellt eine durchgestrichene Anmerkung dar die im Text des Dokuments durchgestrichen erscheint.
type: docs
weight: 1180
...
Stellt eine durchgestrichene Anmerkung dar, die im Text des Dokuments durchgestrichen erscheint.
...
| Name | Beschreibung |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation)(Page, Rectangle) | Erstellt eine neue StrikeOut-Anmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
