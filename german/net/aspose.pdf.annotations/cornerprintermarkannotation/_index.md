...
description: Aspose.Pdf.Annotations.CornerPrinterMarkAnnotation-Klasse. Stellt Annotationsarten dar, die in den Ecken der gedruckten Seite platziert sind
type: docs
weight: 1630
url: /de/net/aspose.pdf.annotations/cornerprintermarkannotation/
---
## Klasse CornerPrinterMarkAnnotation

Stellt Annotationsarten dar, die in den Ecken der gedruckten Seite platziert sind.
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Gibt die Position des Zeichens auf der Seite zurück oder legt sie fest. |
