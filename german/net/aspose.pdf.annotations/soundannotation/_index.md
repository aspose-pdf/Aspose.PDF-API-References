...
description: Stellt eine Tonanmerkung dar die Ton enthält der vom Mikrofon des Computers aufgenommen oder aus einer Datei importiert wurde.
type: docs
weight: 1080
...
Stellt eine Tonanmerkung dar, die Ton enthält, der vom Mikrofon des Computers aufgenommen oder aus einer Datei importiert wurde.
...
| Name | Beschreibung |
| --- | --- |
| [SoundAnnotation](soundannotation#constructor)(Page, Rectangle, string) | Erstellt eine neue Tonanmerkung auf der angegebenen Seite. |
| [SoundAnnotation](soundannotation#constructor_1)(Page, Rectangle, string, SoundSampleData) | Erstellt eine neue Tonanmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | Ruft ein Symbol ab oder legt es fest, das zum Anzeigen der Anmerkung verwendet werden soll. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | Ruft ein Soundobjekt ab, das den Sound definiert, der abgespielt werden soll, wenn die Anmerkung aktiviert wird. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
