...
description: Klasse die die Caret-Anmerkung darstellt.
type: docs
weight: 220
...
Klasse, die die Caret-Anmerkung darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [CaretAnnotation](caretannotation#constructor)(Document) | Konstruktor für Verwendung im Generator. |
| [CaretAnnotation](caretannotation#constructor_1)(Page, Rectangle) | Erstellt eine neue Caret-Anmerkung auf der angegebenen Seite. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype) { get; } | Ruft die Art der Anmerkung ab. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame) { get; set; } | Ruft Caret-Rechteck ab oder legt es fest. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol) { get; set; } | Ruft das mit Caret verknüpfte Symbol ab oder legt es fest. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept)(AnnotationSelector) | Akzeptiert das Besucherobjekt, um die Anmerkung zu verarbeiten. |
