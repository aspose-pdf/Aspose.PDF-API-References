...
description: Klasse die die Widget-Anmerkung darstellt.
type: docs
weight: 1260
...
Klasse, die die Widget-Anmerkung darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [WidgetAnnotation](widgetannotation)(Document) | Anmerkung erstellen (für Generator verwendet) |
