...
description: Aspose.Pdf.Annotations.TextMarkupAnnotation-Klasse. Abstrakte Basisklasse für Textmarkierungsannotationen
type: docs
weight: 2670
url: /de/net/aspose.pdf.annotations/textmarkupannotation/
---
## TextMarkupAnnotation-Klasse

Abstrakte Basisklasse für Textmarkierungsannotationen.
...
| [ReplyType](../../aspose.pdf.annotations/markupannotation/replytype/) { get; set; } | Eine Zeichenfolge, die die Beziehung (den "Antworttyp") zwischen dieser Annotation und einer durch InReplyTo angegebenen angibt. |
