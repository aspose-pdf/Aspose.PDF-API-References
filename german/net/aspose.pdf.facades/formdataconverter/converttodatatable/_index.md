...
description: Dateien von Stämmen in eine Tabelle konvertieren.
type: docs
weight: 80
...
Dateien von Stämmen in eine Tabelle konvertieren.
...
| sourceType | DataType | Datenformat in Streams. Gültige Werte sind: PDF, FDF, XFDF, XML. |
