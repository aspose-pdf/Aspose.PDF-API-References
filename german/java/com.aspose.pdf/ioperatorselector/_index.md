...
description: "Definiert einen Visitor zum Durchlaufen verschiedener PDF-Operatoren."
type: docs
weight: 2520
url: /de/java/com.aspose.pdf/ioperatorselector/
---
```
public interface IOperatorSelector
```

Definiert einen Visitor zum Durchlaufen verschiedener PDF-Operatoren.
