...
description: "Klasse, die den rg-Operator (setzt die RGB-Farbe für nicht-strichende Operatoren) darstellt."
type: docs
weight: 710
url: /de/java/com.aspose.pdf.operators/setrgbcolor/
---
**Inheritance:**
...
Klasse, die den rg-Operator (setzt die RGB-Farbe für nicht-strichende Operatoren) darstellt.

## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [SetRGBColor](#SetRGBColor-java.awt.Color-) | Initialisiert den Operator mit Farbe. |
| [SetRGBColor](#SetRGBColor-double-double-double-) | Konstruktor für das Schreibprogramm. |
| [SetRGBColor](#SetRGBColor-int-com.aspose.pdf.engine.commondata.pagecontent.operators.color.SetRGBNonstrokingColor-) | Konstruktor für die Operator-Klasse. |
