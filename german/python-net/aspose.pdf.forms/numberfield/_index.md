...
type: docs
weight: 150
url: /de/python-net/aspose.pdf.forms/numberfield/
---
...
Der Typ NumberField stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| NumberField() | Initialisiert eine neue Instanz der Klasse [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/). |
| NumberField(page, rect) | Initialisiert eine neue Instanz der NumberField-Klasse |
| NumberField(doc, rect) | Initialisiert eine neue Instanz der NumberField-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| allowed_chars | Liest oder setzt die zulässigen Zeichen. |
## Indexer
| Name | Beschreibung |
| :- | :- |
