...
description: "Feld für Dateiauswahl‑Box-Element."
type: docs
weight: 100
url: /de/python-net/aspose.pdf.forms/fileselectboxfield/
---

## FileSelectBoxField class

Feld für Dateiauswahl‑Box-Element.

Der Typ FileSelectBoxField stellt die folgenden Mitglieder bereit:
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
