...
description: "Klasse, die ein Kontrollkästchen‑Feld darstellt"
type: docs
weight: 30
url: /de/python-net/aspose.pdf.forms/checkboxfield/
---

## CheckboxField class

Klasse, die ein Kontrollkästchen‑Feld darstellt

Der Typ CheckboxField stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| CheckboxField(page, rect) | Initialisiert eine neue Instanz der Klasse CheckboxField |
| CheckboxField(doc, rect) | Initialisiert eine neue Instanz der Klasse CheckboxField |
| CheckboxField() | Instanz von CheckboxField erstellen. |
| CheckboxField(doc) | Initialisiert eine neue Instanz der Klasse CheckboxField |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| Wert | Liest oder setzt den Wert des Kontrollkästchenfeldes. |
...
| allowed_states | Gibt eine Liste der zulässigen Zustände zurück. |
| style | Ruft den Stil des Kontrollkästchens ab oder legt ihn fest. |
| checked | Liest oder setzt den Zustand des Kontrollkästchens. |
| export_value | Liest oder setzt den Exportwert des CheckBox-Feldes. |
## Indexer
| Name | Beschreibung |
| :- | :- |
...
| Name | Beschreibung |
| :- | :- |
| clone() | Kopiere das Kontrollkästchen. |
