...
description: "Klasse beschreibt die Rich‑Text‑Editor‑Komponente."
type: docs
weight: 240
url: /de/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Klasse beschreibt die Rich‑Text‑Editor‑Komponente.

Der RichTextBoxField-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| RichTextBoxField(page, rect) | Initialisiert eine neue Instanz der RichTextBoxField-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| style | Liest oder setzt die Standard-Stilzeichenfolge des Rich-Text-Feldes. |
| rich_text_value | Liest oder setzt den Rich-Text-Wert. |
| formatted_value | Liest oder setzt den formatierten Rich-Text-Wert mit Markup. |
| justify | Liest oder setzt die Ausrichtung der Rich-Text-Box. |
## Indexer
| Name | Beschreibung |
| :- | :- |
