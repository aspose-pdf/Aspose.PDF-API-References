...
description: "Klasse, die ein Kombinationsfeld des Formulars darstellt"
type: docs
weight: 50
url: /de/python-net/aspose.pdf.forms/comboboxfield/
---

## ComboBoxField class

Klasse, die ein Kombinationsfeld des Formulars darstellt

Der ComboBoxField-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ComboBoxField() | Konstruktor für ComboBoxField, der im Generator verwendet wird. |
| ComboBoxField(doc) | Initialisiert eine neue Instanz der ComboBoxField-Klasse |
| ComboBoxField(page, rect) | Initialisiert eine neue Instanz der ComboBoxField-Klasse |
| ComboBoxField(doc, rect) | Initialisiert eine neue Instanz der ComboBoxField-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| ausgewählt | Liest oder setzt den Index der ausgewählten Option. Diese Eigenschaft ermöglicht das Ändern der Auswahl. |
...
| editierbar | Liest oder setzt den editierbaren Status des Feldes. |
| spell_check | Liest oder setzt den Status der Rechtschreibprüfung. |
## Indexer
| Name | Beschreibung |
| :- | :- |
