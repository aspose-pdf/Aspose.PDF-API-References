...
type: docs
weight: 280
url: /de/python-net/aspose.pdf.forms/textboxfield/
---
...
Der TextBoxField-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| TextBoxField(doc) | Initialisiert eine neue Instanz der TextBoxField-Klasse |
| TextBoxField() | Instanz von TextBoxField erstellen. |
| TextBoxField(page, rect) | Initialisiert eine neue Instanz der TextBoxField-Klasse |
| TextBoxField(doc, rect) | Initialisiert eine neue Instanz der TextBoxField-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
