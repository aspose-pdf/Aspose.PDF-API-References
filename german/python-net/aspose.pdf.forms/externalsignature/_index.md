...
description: "Erstellt eine abgetrennte PKCS#7Detached‑Signatur unter Verwendung eines X509Certificate2. Sie unterstützt USB‑Smartcards, Tokens ohne exportierbare private Schlüssel."
type: docs
weight: 80
url: /de/python-net/aspose.pdf.forms/externalsignature/
---

## ExternalSignature class

Erstellt eine abgetrennte PKCS#7Detached‑Signatur unter Verwendung eines X509Certificate2. Sie unterstützt USB‑Smartcards, Tokens ohne exportierbare private Schlüssel.

Der Typ ExternalSignature stellt die folgenden Mitglieder bereit:
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
