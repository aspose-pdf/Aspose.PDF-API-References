...
description: "Stellt das PKCS#7‑Objekt dar, das der PKCS#7‑Spezifikation im Internet‑RFC 2315 entspricht, <br/>            PKCS #7: Cryptographic Message Syntax, Version 1.5.<br/>            Der SHA1‑Digest des Byte‑Bereichs des Dokuments ist im PKCS#7‑SignedData‑Feld gekapselt."
type: docs
weight: 190
url: /de/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

Stellt das PKCS#7‑Objekt dar, das der PKCS#7‑Spezifikation im Internet‑RFC 2315 entspricht, <br/>            PKCS #7: Cryptographic Message Syntax, Version 1.5.<br/>            Der SHA1‑Digest des Byte‑Bereichs des Dokuments ist im PKCS#7‑SignedData‑Feld gekapselt.

Der Typ PKCS7 stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| PKCS7() | Initialisiert eine neue Instanz der [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) Klasse. |
| PKCS7(pfx, password) | Initialisiert eine neue Instanz der PKCS7-Klasse |
| PKCS7(pfx, password) | Initialisiert eine neue Instanz der PKCS7-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
