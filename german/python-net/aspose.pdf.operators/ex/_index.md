...
description: "Klasse, die den EX-Operator repräsentiert (Ende des Kompatibilitätsabschnitts)."
type: docs
weight: 260
url: /de/python-net/aspose.pdf.operators/ex/
---

## EX class

Klasse, die den EX-Operator repräsentiert (Ende des Kompatibilitätsabschnitts).

Der Typ EX stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| EX() | Initialisiert den Operator. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
