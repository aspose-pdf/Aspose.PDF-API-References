...
description: "Klasse, die den q-Operator darstellt (Grafikzustand speichern)."
type: docs
weight: 320
url: /de/python-net/aspose.pdf.operators/gsave/
---

## GSave class

Klasse, die den q-Operator darstellt (Grafikzustand speichern).

Der Typ GSave stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| GSave() | Initialisiert den q-Operator. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
