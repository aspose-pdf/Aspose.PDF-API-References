...
description: "Klasse, die den s-Operator repräsentiert (Pfad schließen und strichzeichnen)."
type: docs
weight: 130
url: /de/python-net/aspose.pdf.operators/closepathstroke/
---

## ClosePathStroke class

Klasse, die den s-Operator repräsentiert (Pfad schließen und strichzeichnen).

Der ClosePathStroke-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ClosePathStroke() | Initialisiert den Operator. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
