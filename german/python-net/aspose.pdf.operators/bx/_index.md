...
description: "Klasse, die den BX‑Operator (begin compatibility section) darstellt."
type: docs
weight: 50
url: /de/python-net/aspose.pdf.operators/bx/
---

## BX class

Klasse, die den BX‑Operator (begin compatibility section) darstellt.

Der BX-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| BX() | Initialisiert den Operator. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
