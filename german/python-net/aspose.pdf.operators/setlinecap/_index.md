...
description: "Klasse, die den J-Operator darstellt (Linienende-Stil festlegt)."
type: docs
weight: 640
url: /de/python-net/aspose.pdf.operators/setlinecap/
---

## SetLineCap class

Klasse, die den J-Operator darstellt (Linienende-Stil festlegt).

Der Typ SetLineCap stellt die folgenden Mitglieder bereit:
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
