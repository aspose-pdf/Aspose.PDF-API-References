...
description: "Beschreibt das Fußzeilen‑Artifact. Dies kann verwendet werden, um die Fußzeile der Seite festzulegen."
type: docs
weight: 400
url: /de/python-net/aspose.pdf/footerartifact/
---

## FooterArtifact class

Beschreibt das Fußzeilen‑Artifact. Dies kann verwendet werden, um die Fußzeile der Seite festzulegen.

Der FooterArtifact-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| FooterArtifact() | Erstellt eine Footer Artifact-Instanz. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
