...
type: docs
weight: 1550
url: /de/python-net/aspose.pdf/textstamp/
---
...
Der Typ TextStamp stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| TextStamp(value) | Initialisiert eine neue Instanz der Klasse TextStamp |
| TextStamp(value, text_state) | Initialisiert eine neue Instanz der Klasse TextStamp |
| TextStamp(formatted_text) | Initialisiert eine neue Instanz der Klasse TextStamp |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| Name | Beschreibung |
| :- | :- |
| put(page) | Fügt einen Textstempel auf der Seite hinzu. |
