...
description: "Klasse beschreibt das Header‑Artifact. Dieses Artifact kann verwendet werden, um die Überschrift der Seite festzulegen."
type: docs
weight: 440
url: /de/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

Klasse beschreibt das Header‑Artifact. Dieses Artifact kann verwendet werden, um die Überschrift der Seite festzulegen.

Der Typ HeaderArtifact stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| HeaderArtifact() | Erstellt eine HeaderArtifact-Instanz. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
