...
description: "Eine abstrakte Klasse für verschiedene Arten von Stempeln, die als Nachkommen auftreten."
type: docs
weight: 1440
url: /de/python-net/aspose.pdf/stamp/
---

## Stamp class

Eine abstrakte Klasse für verschiedene Arten von Stempeln, die als Nachkommen auftreten.
...
| Name | Beschreibung |
| :- | :- |
| put(page) | Fügt einen Stempel zur Seite hinzu. |
