...
type: docs
weight: 320
url: /de/python-net/aspose.pdf/epubsaveoptions/
---
...
Der Typ EpubSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| EpubSaveOptions() | Initialisiert eine neue Instanz der Klasse EpubSaveOptions |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| content_recognition_mode | Wenn eine PDF-Datei (die normalerweise ein festes Layout hat) konvertiert wird,<br/>            versucht die Konvertierungs-Engine, Gruppierungen und mehrstufige Analysen durchzuführen, um die ursprüngliche Absicht des Dokumentautors wiederherzustellen und ein Ergebnis im Fließlayout zu erzeugen.<br/>               Diese Eigenschaft passt diese Konvertierung für die eine oder andere<br/>            gewünschte Methode der Inhaltserkennung an. |
