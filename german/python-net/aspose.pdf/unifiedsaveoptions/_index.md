...
description: "Diese Klasse stellt Speicheroptionen für das Speichern dar, das <br/>            einen einheitlichen Konvertierungsweg verwendet (mit einheitlichem internem Dokumentmodell)"
type: docs
weight: 1590
url: /de/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Diese Klasse stellt Speicheroptionen für das Speichern dar, das <br/>            einen einheitlichen Konvertierungsweg verwendet (mit einheitlichem internem Dokumentmodell)

Der Typ UnifiedSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| UnifiedSaveOptions() | Initialisiert eine neue Instanz der Klasse UnifiedSaveOptions |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
