...
description: "Klasse beschreibt das Wasserzeichen-Artifact. Dies kann verwendet werden, um"
type: docs
weight: 1640
url: /de/python-net/aspose.pdf/watermarkartifact/
---

## WatermarkArtifact class

Klasse beschreibt das Wasserzeichen-Artifact. Dies kann verwendet werden, um

Der WatermarkArtifact-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| WatermarkArtifact() | Erstellt eine Instanz des Watermark-Artefakts. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
