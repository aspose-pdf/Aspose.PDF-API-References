...
type: docs
weight: 1810
url: /de/python-net/aspose.pdf/xpssaveoptions/
---
...
Der XpsSaveOptions-Typ stellt die folgenden Member bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| XpsSaveOptions() | Initialisiert eine neue Instanz der XpsSaveOptions-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| save_transparent_texts | Gibt an, ob transparenter (OCR‑erfasster) Text erhalten werden soll. |
