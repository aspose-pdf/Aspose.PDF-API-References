...
type: docs
weight: 960
url: /de/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
Der Typ MobiXmlSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| MobiXmlSaveOptions() | Initialisiert eine neue Instanz der Klasse MobiXmlSaveOptions |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
