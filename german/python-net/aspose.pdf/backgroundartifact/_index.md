...
description: "Klasse beschreibt das Hintergrund-Artefakt. Dieses Artefakt ermöglicht das Festlegen des Seitenhintergrunds."
type: docs
weight: 50
url: /de/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Klasse beschreibt das Hintergrund-Artefakt. Dieses Artefakt ermöglicht das Festlegen des Seitenhintergrunds.

Der Typ BackgroundArtifact stellt die folgenden Member bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| BackgroundArtifact() | Initialisiert ein BackgroundArtifact-Objekt. |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| background_color | Liest oder setzt die Hintergrundfarbe des Hintergrundartefakts. |
| background_image | Liest oder setzt das Hintergrundbild des Hintergrundartefakts. |
## Methoden
| Name | Beschreibung |
| :- | :- |
