...
description: "Speicheroptionen für das PdfXml-Format."
type: docs
weight: 1260
url: /de/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
Der Typ PdfXmlSaveOptions stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| PdfXmlSaveOptions() | Initialisiert eine neue Instanz der Klasse PdfXmlSaveOptions |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
