...
type: docs
weight: 690
url: /de/python-net/aspose.pdf/imagestamp/
---
...
Der Typ ImageStamp stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ImageStamp(image) | Initialisiert eine neue Instanz der Klasse ImageStamp |
| ImageStamp(file_name) | Initialisiert eine neue Instanz der Klasse ImageStamp |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| breite | Liest oder setzt die Bildbreite. Das Setzen dieser Eigenschaft ermöglicht das horizontale Skalieren des Bildes. |
| höhe | Liest oder setzt die Bildhöhe. Das Setzen dieser Eigenschaft ermöglicht das vertikale Skalieren des Bildes. |
...
| image | Liest den Bild-Stream, der für das Stempeln verwendet wird. |
| quality | Liest oder setzt die Qualität des Bildstempels in Prozent. Gültige Werte sind 0..100%. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| put(page) | Fügt einen grafischen Stempel auf der Seite hinzu. |
