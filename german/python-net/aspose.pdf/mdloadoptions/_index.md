...
type: docs
weight: 920
url: /de/python-net/aspose.pdf/mdloadoptions/
---
...
Der MdLoadOptions-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| MdLoadOptions() | Initialisiert eine neue Instanz der MdLoadOptions-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
