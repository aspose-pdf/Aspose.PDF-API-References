...
description: "Eine Bildschirm-Anmerkung, die einen Bereich einer Seite angibt, auf dem Medienclips abgespielt werden können."
type: docs
weight: 720
url: /de/python-net/aspose.pdf.annotations/screenannotation/
---

## ScreenAnnotation class

Eine Bildschirm-Anmerkung, die einen Bereich einer Seite angibt, auf dem Medienclips abgespielt werden können.

Der Typ ScreenAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | Initialisiert eine neue Instanz der Klasse ScreenAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| title | Liest oder setzt den Titel der Bildschirmannotation. |
| action | Liest oder setzt eine Aktion, die ausgeführt wird, wenn die Annotation aktiviert wird. |
## Methoden
| Name | Beschreibung |
| :- | :- |
