...
description: "Klasse, die eine Caret‑Annotation darstellt."
type: docs
weight: 80
url: /de/python-net/aspose.pdf.annotations/caretannotation/
---

## CaretAnnotation class

Klasse, die eine Caret‑Annotation darstellt.

Der Typ CaretAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| CaretAnnotation(document) | Initialisiert eine neue Instanz der Klasse CaretAnnotation |
| CaretAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse CaretAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| frame | Liest oder setzt das Caret-Rechteck. |
| Symbol | Liest oder setzt das Symbol, das dem Caret zugeordnet ist. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
