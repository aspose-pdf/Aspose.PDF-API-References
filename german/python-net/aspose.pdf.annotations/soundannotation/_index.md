...
description: "Stellt eine Sound-Anmerkung dar, die Klang enthält, der vom Mikrofon des Computers aufgenommen oder aus einer Datei importiert wurde."
type: docs
weight: 740
url: /de/python-net/aspose.pdf.annotations/soundannotation/
---

## SoundAnnotation class

Stellt eine Sound-Anmerkung dar, die Klang enthält, der vom Mikrofon des Computers aufgenommen oder aus einer Datei importiert wurde.

Der Typ SoundAnnotation stellt die folgenden Member bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Initialisiert eine neue Instanz der Klasse SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Initialisiert eine neue Instanz der Klasse SoundAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| sound_data | Liest ein Sound‑Objekt, das den abzuspielenden Ton definiert, wenn die Annotation aktiviert wird. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
