...
description: "Stellt eine Gummistempel-Annotation dar. <br/>             Diese Art von Annotation zeigt Text oder Grafiken, die so aussehen sollen, als wären sie mit einem Gummistempel auf die Seite gestempelt worden."
type: docs
weight: 790
url: /de/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

Stellt eine Gummistempel-Annotation dar. <br/>             Diese Art von Annotation zeigt Text oder Grafiken, die so aussehen sollen, als wären sie mit einem Gummistempel auf die Seite gestempelt worden.

Der Typ StampAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| StampAnnotation(document) | Initialisiert eine neue Instanz der Klasse StampAnnotation |
| StampAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse StampAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| icon | Liest oder setzt das Symbol für den Gummistempel. |
| image | Liest oder setzt das Bild der Anmerkung. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
| get_rectangle(consider_rotation) | Gibt das Rechteck der Anmerkung zurück, wobei die Seitenrotation berücksichtigt wird. |
| accept(visitor) | Akzeptiert den [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) Besucher beim Durchsuchen der Anmerkungssammlung. |
