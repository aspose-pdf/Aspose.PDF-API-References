...
type: docs
weight: 680
url: /de/python-net/aspose.pdf.annotations/redactionannotation/
---
...
Der RedactionAnnotation-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| RedactionAnnotation(document) | Initialisiert eine neue Instanz der RedactionAnnotation-Klasse |
| RedactionAnnotation(page, rect) | Initialisiert eine neue Instanz der RedactionAnnotation-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| quad_point | Ein Array von 8×N Zahlen, das die Koordinaten des Inhaltsbereichs angibt, der entfernt werden soll. |
| default_appearance | Liest oder setzt die Standard‑Darstellungszeichenfolge, die beim Formatieren des Textes verwendet wird. |
| fill_color | Liest oder setzt die Farbe zum Ausfüllen der Annotation. |
| border_color | Liest oder setzt die Farbe des Rahmens, der gezeichnet wird, wenn die Redaktion nicht aktiv ist. |
| overlay_text | Text, der auf der Redaktions-Annotation gedruckt wird. |
| repeat | Wenn true, wird der Überlagerungstext auf der Annotation wiederholt. |
| text_alignment | Liest oder setzt. Ausrichtung des Überlagerungstextes. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
...
| flatten() | Flacht die Annotation ab, d. h. entfernt die Annotation und fügt ihr hinzu. |
| change_after_resize(transform) | Aktualisiert Parameter und Erscheinungsbild gemäß der Matrixtransformation. |
| redact() | Flacht die Annotation ab und redigiert den Seiteninhalt (d. h. entfernt Text und Bild unter der redigierten Annotation). |
