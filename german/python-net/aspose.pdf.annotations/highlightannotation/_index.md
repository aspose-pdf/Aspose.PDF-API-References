...
description: "Stellt eine Hervorhebungs‑Annotation dar, die einen Textbereich im Dokument hervorhebt."
type: docs
weight: 310
url: /de/python-net/aspose.pdf.annotations/highlightannotation/
---

## HighlightAnnotation class

Stellt eine Hervorhebungs‑Annotation dar, die einen Textbereich im Dokument hervorhebt.

Der Typ HighlightAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| HighlightAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse HighlightAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
