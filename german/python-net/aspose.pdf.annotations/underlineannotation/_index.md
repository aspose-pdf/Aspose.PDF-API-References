...
description: "Stellt eine Unterstreichungs-Annotation dar, die im Text des Dokuments als Unterstreichung erscheint."
type: docs
weight: 850
url: /de/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

Stellt eine Unterstreichungs-Annotation dar, die im Text des Dokuments als Unterstreichung erscheint.

Der Typ UnderlineAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| UnderlineAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse UnderlineAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| quad_points | Liest oder setzt ein Array von Punkten, das die Koordinaten von n Quadrilateralen angibt. Jedes Quadrilatere umfasst ein Wort oder eine Gruppe zusammenhängender Wörter im dem der Anmerkung zugrunde liegenden Text. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
...
| flatten() | Keine |
| change_after_resize(transform) | Aktualisiert die QuadPoints gemäß der Matrixtransformation. |
| get_marked_text() | Liest den Text unter der Markup-Anmerkung als Zeichenkette. |
| get_marked_text_fragments() | Liest den Text unter der Markup-Anmerkung als [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/). |
