...
type: docs
weight: 710
url: /de/python-net/aspose.pdf.annotations/richmediaannotation/
---
...
Der Typ RichMediaAnnotation stellt die folgenden Member bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| RichMediaAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse RichMediaAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| custom_player | Legt den benutzerdefinierten Flash-Player fest oder ruft ihn ab, um Video-/Audiodaten abzuspielen. |
| custom_flash_variables | Legt Flash-Variablen fest oder ruft sie ab, die an den Player übergeben werden. |
| content | Daten des Rich-Media-Inhalts. |
| type | Liest oder setzt den Inhaltstyp. Mögliche Werte: Audio, Video. |
| activate_on | Ereignis, das die Anwendung aktiviert. |
## Methoden
| Name | Beschreibung |
| :- | :- |
...
| accept(visitor) | Akzeptiert Besucher für diese Annotation. |
...
| add_custom_data(name, data) | Fügt benutzerdefinierte benannte Daten hinzu (z. B. erforderlich für Flash‑Skript). |
| set_content(file_name, audio) | Setzt den Inhaltsstream. |
| set_poster(image_stream) | Setzt das Poster der Annotation. |
| update() | Aktualisiert Daten mit den angegebenen Parametern. |
