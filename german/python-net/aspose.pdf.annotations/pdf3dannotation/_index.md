...
description: "Klasse PDF3DAnnotation. Diese Klasse kann nicht geerbt werden."
type: docs
weight: 510
url: /de/python-net/aspose.pdf.annotations/pdf3dannotation/
---

## PDF3DAnnotation class

Klasse PDF3DAnnotation. Diese Klasse kann nicht geerbt werden.

Der Typ PDF3DAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| PDF3DAnnotation(page, rect, pdf_3d_artwork) | Initialisiert eine neue Instanz der Klasse PDF3DAnnotation |
| PDF3DAnnotation(page, rect, pdf_3d_artwork, activation) | Initialisiert eine neue Instanz der Klasse PDF3DAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| pdf_3d_artwork | Gibt das 3D‑Artwork zurück. |
| lighting_scheme | Gibt das Beleuchtungsschema zurück. |
| content | Ruft ab oder legt fest den Inhalt. |
| render_mode | Ruft den Rendermodus ab. |
| view_array | Ruft das Ansichtsarray ab. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| set_image_preview(filename) | Setzt die Bildvorschau. |
| set_image_preview(image) | Setzt die Bildvorschau. |
...
| accept(visitor) | Akzeptiert Besucher für die Annotationsverarbeitung. |
...
| set_default_view_index(index) | Setzt den Index der Standardansicht. |
| clear_image_preview() | Löscht die Bildvorschau. |
| get_image_preview() | Ruft die Bildvorschau ab. |
