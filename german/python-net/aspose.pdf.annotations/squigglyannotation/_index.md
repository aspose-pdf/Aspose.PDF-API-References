...
description: "Stellt die Zickzack-Anmerkung dar, die im Text eines Dokuments als gezackte Unterstreichung erscheint."
type: docs
weight: 780
url: /de/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

Stellt die Zickzack-Anmerkung dar, die im Text eines Dokuments als gezackte Unterstreichung erscheint.

Der Typ SquigglyAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| SquigglyAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse SquigglyAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
