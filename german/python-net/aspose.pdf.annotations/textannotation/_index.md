...
description: "Stellt eine Textannotation dar, die eine �sticky note� ist und an einem Punkt im PDF-Dokument befestigt ist."
type: docs
weight: 820
url: /de/python-net/aspose.pdf.annotations/textannotation/
---

## TextAnnotation class

Stellt eine Textannotation dar, die eine �sticky note� ist und an einem Punkt im PDF-Dokument befestigt ist.

Der Typ TextAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| TextAnnotation(document) | Initialisiert eine neue Instanz der Klasse TextAnnotation |
| TextAnnotation(page, rect) | Initialisiert eine neue Instanz der Klasse TextAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| öffnen | Ruft ab oder legt fest ein Flag, das angibt, ob die Annotation zunächst geöffnet angezeigt werden soll. |
| icon | Ruft ab oder legt fest ein Symbol, das bei der Anzeige der Annotation verwendet wird. |
| state | Ruft ab oder legt fest den Zustand, in den die ursprüngliche Annotation gesetzt werden soll. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
