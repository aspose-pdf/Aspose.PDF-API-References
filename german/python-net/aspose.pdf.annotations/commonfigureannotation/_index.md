...
description: "Abstrakte Klasse, die eine gemeinsame Figuren‑Annotation darstellt."
type: docs
weight: 110
url: /de/python-net/aspose.pdf.annotations/commonfigureannotation/
---

## CommonFigureAnnotation class

Abstrakte Klasse, die eine gemeinsame Figuren‑Annotation darstellt.

Der Typ CommonFigureAnnotation stellt die folgenden Mitglieder bereit:
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
