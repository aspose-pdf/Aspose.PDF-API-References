...
description: "Klasse beschreibt Dateianhang-Anmerkung."
type: docs
weight: 170
url: /de/python-net/aspose.pdf.annotations/fileattachmentannotation/
---

## FileAttachmentAnnotation class

Klasse beschreibt Dateianhang-Anmerkung.

Der Typ FileAttachmentAnnotation stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | Initialisiert eine neue Instanz der Klasse FileAttachmentAnnotation |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| opacity | Liest oder setzt die Deckkraft des Icons von 0 bis 1: 0 - vollständig transparent, 1 - vollständig undurchsichtig. |
...
| file | Die Spezifikation der mit dieser Anmerkung verknüpften Datei. |
| icon | Liest oder setzt das Icon, das bei der Anzeige der Anmerkung verwendet werden soll. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
