...
description: "Klasse, die eine Kreis‑Annotation darstellt."
type: docs
weight: 100
url: /de/python-net/aspose.pdf.annotations/circleannotation/
---

## CircleAnnotation class

Klasse, die eine Kreis‑Annotation darstellt.

Der CircleAnnotation-Typ stellt die folgenden Mitglieder bereit:
## Konstruktoren
| Name | Beschreibung |
| :- | :- |
| CircleAnnotation(document) | Initialisiert eine neue Instanz der CircleAnnotation-Klasse |
| CircleAnnotation(page, rect) | Initialisiert eine neue Instanz der CircleAnnotation-Klasse |
## Eigenschaften
| Name | Beschreibung |
| :- | :- |
...
| interior_color | Innenfarbe, mit der das Rechteck oder die Ellipse der Anmerkung gefüllt wird. |
| frame | Das Rechteck, das die numerischen Unterschiede zwischen zwei Rechtecken beschreibt:<br/>            den Rect-Eintrag der Anmerkung und die tatsächlichen Grenzen des zugrunde liegenden Quadrats oder Kreises. |
## Methoden
| Name | Beschreibung |
| :- | :- |
| clone() | Keine |
