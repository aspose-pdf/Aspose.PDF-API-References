...
description: Aspose.Pdf.Operators.SetTextRenderingMode 클래스. Tr 연산자를 설정하여 텍스트 렌더링 모드를 나타내는 클래스
type: docs
weight: 7840
url: /ko/net/aspose.pdf.operators/settextrenderingmode/
---
## SetTextRenderingMode 클래스

Tr 연산자(텍스트 렌더링 모드 설정)를 나타내는 클래스입니다.
...
| 이름 | 설명 |
| --- | --- |
| [SetTextRenderingMode](settextrenderingmode/)() | 연산자를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/settextrenderingmode/accept/)(IOperatorSelector) | 연산자를 처리하기 위해 방문자 객체를 수락합니다. |
