...
description: MoveToNextLineShowText 메서드. 연산자를 처리하기 위해 방문자 객체를 수락합니다.
type: docs
weight: 30
url: /ko/net/aspose.pdf.operators/movetonextlineshowtext/accept/
---
## MoveToNextLineShowText.Accept 메서드
