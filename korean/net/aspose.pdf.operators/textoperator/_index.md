---
title: "클래스 TextOperator"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Operators.TextOperator 클래스. 텍스트 관련 연산자(TJ, Tj, Tm, BT, ET 등)를 위한 추상 기본 클래스"
type: docs
weight: 8040
url: /ko/net/aspose.pdf.operators/textoperator/
---
## TextOperator class

텍스트 관련 연산자(TJ, Tj, Tm, BT, ET 등)를 위한 추상 기본 클래스.
...
| 이름 | 설명 |
| --- | --- |
| [TextOperator](textoperator/#constructor)() | 연산자를 초기화합니다. |
| [TextOperator](textoperator/#constructor_1)(TextProperties) | 텍스트 속성을 허용하는 텍스트 연산자. |
