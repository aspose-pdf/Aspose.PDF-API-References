...
| 이름 | 설명 |
| --- | --- |
| [ClosePathFillStroke](closepathfillstroke/)() | 연산자를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/closepathfillstroke/accept/)(IOperatorSelector) | 연산자를 처리하기 위해 방문자 객체를 수락합니다. |
