...
description: SetCharWidthBoundingBox 메서드. 연산자를 처리하기 위해 방문자 객체를 수락합니다.
type: docs
weight: 80
url: /ko/net/aspose.pdf.operators/setcharwidthboundingbox/accept/
---
## SetCharWidthBoundingBox.Accept 메서드
