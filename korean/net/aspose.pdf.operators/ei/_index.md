...
description: Aspose.Pdf.Operators.EI 클래스. EI 연산자 끝 인라인 이미지 객체를 나타내는 클래스
type: docs
weight: 7290
url: /ko/net/aspose.pdf.operators/ei/
---
## EI 클래스

EI 연산자(끝 인라인 이미지 객체)를 나타내는 클래스입니다.
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/ei/accept/)(IOperatorSelector) | 연산자를 처리하기 위해 방문자 객체를 수락합니다. |
