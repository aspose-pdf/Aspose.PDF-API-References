---
title: "클래스 DictionaryEditor"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.DataEditor.DictionaryEditor 클래스. 문서 트리 사전, 문서 사전, 페이지 사전, 리소스 사전을 액세스하기 위한 클래스"
type: docs
weight: 3590
...
문서 트리 사전(문서 사전, 페이지 사전, 리소스 사전)에 접근하기 위한 클래스입니다.
...
| 이름 | 설명 |
| --- | --- |
| [AllKeys](../../aspose.pdf.dataeditor/dictionaryeditor/allkeys/) { get; } | 키의 전체 컬렉션입니다. 편집 가능한 키와 편집 불가능한 키를 포함합니다. |
...
| [Item](../../aspose.pdf.dataeditor/dictionaryeditor/item/) { get; set; } | 지정된 키에 해당하는 요소를 가져오거나 설정합니다. |
| [Keys](../../aspose.pdf.dataeditor/dictionaryeditor/keys/) { get; } | 편집 가능한 키의 컬렉션. |
...
| [Contains](../../aspose.pdf.dataeditor/dictionaryeditor/contains/)(KeyValuePair&lt;string, ICosPdfPrimitive&gt;) | `DictionaryEditor`에 특정 값이 포함되어 있는지 확인합니다. |
| [ContainsKey](../../aspose.pdf.dataeditor/dictionaryeditor/containskey/)(string) | `DictionaryEditor`에 지정된 키를 가진 요소가 포함되어 있는지 확인합니다. |
| [CopyTo](../../aspose.pdf.dataeditor/dictionaryeditor/copyto/)(KeyValuePair&lt;string, ICosPdfPrimitive&gt;[], int) |  |
| [GetEnumerator](../../aspose.pdf.dataeditor/dictionaryeditor/getenumerator/)() | 컬렉션을 순회하는 열거자를 반환합니다. |
...
| [TryGetValue](../../aspose.pdf.dataeditor/dictionaryeditor/trygetvalue/)(string, out ICosPdfPrimitive) | string, name, bool, number와 같은 단순 데이터 유형에 접근하기 위해 사용됩니다. 다른 유형에 대해서는 null을 반환합니다. |
