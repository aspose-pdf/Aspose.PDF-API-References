...
| 이름 | 설명 |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Generator와 함께 사용하기 위한 생성자. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | 지정된 페이지에 새로운 Line 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | 캡션 텍스트의 일반 위치로부터의 오프셋을 가져오거나 설정합니다. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | 선 종료점을 가져오거나 설정합니다. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | 선의 끝점에 대한 종료 스타일을 가져오거나 설정합니다. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | 리더 라인의 길이를 가져오거나 설정합니다. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | 리더 라인 연장의 길이를 가져오거나 설정합니다. |
...
| [Measure](../../aspose.pdf.annotations/lineannotation/measure/) { get; set; } | 이 주석에 지정된 측정 단위입니다. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | 내용을 캡션으로 표시해야 하는지 여부를 결정하는 부울 플래그를 가져오거나 설정합니다. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | 선의 시작점을 가져오거나 설정합니다. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | 선 시작점에 대한 종료 스타일을 가져오오거나 설정합니다. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | 행렬 변환에 따라 시작점과 종료점을 업데이트합니다. |
