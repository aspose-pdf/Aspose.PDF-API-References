---
title: "클래스 StampAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.StampAnnotation 클래스. 고무 스탬프 주석을 나타냅니다. 이 유형의 주석은 텍스트나 그래픽을 표시하며 page에 고무 스탬프로 찍힌 것처럼 보이게 합니다."
type: docs
weight: 2710
...
고무 스탬프 주석을 나타냅니다. 이 유형의 주석은 페이지에 고무 스탬프로 찍은 것처럼 보이는 텍스트 또는 그래픽을 표시합니다.
...
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | 지정된 page에 새로운 Stamp 주석을 생성합니다. |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | 고무 스탬프의 아이콘을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | 주석 컬렉션을 탐색할 때 [`AnnotationSelector`](../annotationselector/) 방문자를 허용합니다. |
...
다음 코드 스니펫은 첫 번째 pdf document page에 2개의 스탬프를 추가하는 방법을 보여줍니다. 입력 문서는 inFile에서 가져오며 변경 사항은 outFile에 저장됩니다. 첫 번째 스탬프는 NotForPublicRelease 아이콘을 가지고 두 번째는 rubber.jpg 이미지와 함께 제공됩니다.
