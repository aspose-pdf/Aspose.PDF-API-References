...
description: Aspose.Pdf.Annotations.CircleAnnotation 클래스. 원 주석을 나타내는 클래스
type: docs
weight: 1590
url: /ko/net/aspose.pdf.annotations/circleannotation/
---
...
| Name | Description |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | 원 주석의 생성자. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새로운 원 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | 두 개의 사각형 간의 수치적 차이를 설명하는 사각형: 주석의 Rect 항목과 기본 사각형 또는 원의 실제 경계입니다. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
