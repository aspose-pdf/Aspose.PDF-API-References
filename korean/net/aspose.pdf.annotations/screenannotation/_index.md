---
title: "클래스 ScreenAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.ScreenAnnotation 클래스. 미디어 클립을 재생할 수 있는 페이지 영역을 지정하는 화면 주석입니다."
type: docs
weight: 2610
...
미디어 클립을 재생할 수 있는 페이지 영역을 지정하는 화면 주석.
...
| 이름 | 설명 |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | 지정된 페이지에 새로운 Screen 주석을 생성합니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | 주석이 활성화될 때 수행되는 동작을 가져오거나 설정합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | screen 주석의 제목을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
