...
description: Aspose.Pdf.Annotations.FileAttachmentAnnotation 클래스. 클래스는 파일 첨부 주석을 설명합니다.
type: docs
weight: 1710
url: /ko/net/aspose.pdf.annotations/fileattachmentannotation/
---
## FileAttachmentAnnotation 클래스
...
| 이름 | 설명 |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | 지정된 페이지에 새 파일 첨부 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | 이 주석과 관련된 파일의 사양입니다. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | 주석을 표시하는 데 사용될 아이콘을 가져오거나 설정합니다. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | 0에서 1까지의 아이콘 불투명도를 가져오거나 설정합니다: 0 - 완전히 투명, 1 - 완전히 불투명. |
