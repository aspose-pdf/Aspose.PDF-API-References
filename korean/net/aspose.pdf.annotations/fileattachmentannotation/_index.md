---
title: "클래스 FileAttachmentAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.FileAttachmentAnnotation 클래스. 파일 첨부 주석을 설명하는 클래스입니다."
type: docs
weight: 1800
url: /ko/net/aspose.pdf.annotations/fileattachmentannotation/
---
...
| 이름 | 설명 |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | 지정된 페이지에 새로운 FileAttachment 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | 이 주석과 연결된 파일의 사양입니다. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | 주석 표시 시 사용할 아이콘을 가져오거나 설정합니다. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | 아이콘의 불투명도를 0에서 1 사이로 가져오거나 설정합니다: 0 - 완전히 투명, 1 - 완전히 불투명. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
