...
description: "FitBVExplicitDestination 생성자. 로컬 명시적 목적지를 생성합니다."
type: docs
weight: 10
url: /ko/net/aspose.pdf.annotations/fitbvexplicitdestination/fitbvexplicitdestination/
---
...
| --- | --- | --- |
| 페이지 | 페이지 | 목적지 페이지 객체. |
| left | Double | 창의 왼쪽 가장자리에 배치된 수평 좌표 left. |
