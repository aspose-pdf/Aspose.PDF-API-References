---
title: "클래스 HighlightAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.HighlightAnnotation 클래스. 문서에서 텍스트 범위를 강조하는 하이라이트 주석을 나타냅니다."
type: docs
weight: 1960
...
문서에서 텍스트 범위를 강조 표시하는 하이라이트 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 Highlight 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
