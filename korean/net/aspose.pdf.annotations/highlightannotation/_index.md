...
description: Aspose.Pdf.Annotations.HighlightAnnotation 클래스. 문서에서 텍스트 범위를 강조하는 강조 주석을 나타냅니다.
type: docs
weight: 1870
url: /ko/net/aspose.pdf.annotations/highlightannotation/
---
## HighlightAnnotation class

문서에서 텍스트 범위를 강조하는 강조 주석을 나타냅니다.
...
| Name | Description |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 강조 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 주석에 대한 검토 상태를 설정합니다. 마크된 상태와 마크되지 않은 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 대상 주석을 생성한 사용자에 의해 설정됩니다. 값은 대상 주석의 Title 속성에서 가져옵니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | 주석에 대한 검토 상태를 설정합니다. 마크된 상태와 마크되지 않은 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
