---
title: "클래스 RegistrationMarkAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.RegistrationMarkAnnotation 클래스. 레지스트레이션 마크 주석을 나타냅니다"
type: docs
weight: 2500
url: /ko/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation class

Registration Mark 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | 지정된 페이지와 위치에 `RegistrationMarkAnnotation` 클래스의 새 인스턴스를 초기화합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | 페이지에서 레지스트레이션 마크의 위치를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | 주석 처리를 위해 방문자를 수락합니다. |
...
레지스트레이션 마크는 인쇄 과정에서 색상의 정확한 정렬을 보장하기 위해 인쇄판이나 스크린에 추가되는 기호입니다.
