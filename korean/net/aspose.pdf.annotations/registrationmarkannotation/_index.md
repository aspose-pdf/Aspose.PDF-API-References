...
description: Aspose.Pdf.Annotations.RegistrationMarkAnnotation 클래스. Registration Mark 주석을 나타냅니다.
type: docs
weight: 2410
url: /ko/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation 클래스
...
| 이름 | 설명 |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | 주어진 위치의 주어진 페이지에서 `RegistrationMarkAnnotation` 클래스의 새 인스턴스를 초기화합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | 페이지에서 등록 마크의 위치를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | 주석 처리를 위한 방문자를 수락합니다. |
...
등록 마크는 인쇄 과정에서 색상의 올바른 정렬을 보장하기 위해 인쇄판이나 스크린에 추가되는 기호입니다.
