---
title: "SoundAnnotation 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.SoundAnnotation 클래스. 컴퓨터 마이크에서 녹음된 사운드 또는 파일에서 가져온 사운드를 포함하는 사운드 주석을 나타냅니다."
type: docs
weight: 2630
url: /ko/net/aspose.pdf.annotations/soundannotation/
---
## SoundAnnotation class

컴퓨터 마이크에서 녹음하거나 파일에서 가져온 사운드를 포함하는 사운드 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 지정된 페이지에 새로운 Sound 주석을 생성합니다. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 지정된 페이지에 새로운 Sound 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | 주석 표시 시 사용할 아이콘을 가져오거나 설정합니다. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | 주석이 활성화될 때 재생될 사운드를 정의하는 사운드 객체를 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
