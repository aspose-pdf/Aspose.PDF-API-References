...
description: Aspose.Pdf.Annotations.SoundAnnotation 클래스. 컴퓨터의 마이크로폰에서 녹음된 소리 또는 파일에서 가져온 소리를 포함하는 소리 주석을 나타냅니다.
type: docs
weight: 2530
...
컴퓨터의 마이크로폰에서 녹음된 소리 또는 파일에서 가져온 소리를 포함하는 소리 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 지정된 페이지에 새로운 소리 주석을 생성합니다. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 지정된 페이지에 새로운 소리 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | 주석을 표시하는 데 사용될 아이콘을 가져오거나 설정합니다. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | 주석이 활성화될 때 재생될 소리를 정의하는 소리 객체를 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
