...
description: Aspose.Pdf.Annotations.StrikeOutAnnotation 클래스. 문서의 텍스트에서 취소선으로 나타나는 취소선 주석을 나타냅니다.
type: docs
weight: 2630
url: /ko/net/aspose.pdf.annotations/strikeoutannotation/
---
## StrikeOutAnnotation 클래스

문서의 텍스트에서 취소선으로 나타나는 취소선 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 취소선 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
...
* 클래스 [TextMarkupAnnotation](../textmarkupannotation/)
