---
title: "클래스 StrikeOutAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation 클래스. 문서 텍스트에 취소선으로 표시되는 스트라이크아웃 주석을 나타냅니다."
type: docs
weight: 2730
...
문서 텍스트에 취소선으로 표시되는 스트라이크아웃 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 StrikeOut 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | n개의 사각형 좌표를 지정하는 점 배열을 가져오거나 설정합니다. 각 사각형은 주석이 적용된 텍스트에서 단어 하나 또는 연속된 단어 그룹을 포함합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
...
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | 마크업 주석 아래의 텍스트를 [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/) 형태로 가져옵니다. |
