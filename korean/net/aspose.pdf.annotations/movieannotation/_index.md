---
title: "클래스 MovieAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.MovieAnnotation 클래스. 애니메이션 그래픽과 사운드를 포함하고 컴퓨터 화면 및 스피커를 통해 표시되는 영화 주석을 나타냅니다. 주석이 활성화되면 영화가 재생됩니다."
type: docs
weight: 2200
...
컴퓨터 화면과 스피커를 통해 표시되는 애니메이션 그래픽 및 사운드를 포함하는 영화 주석을 나타냅니다. 주석이 활성화되면 영화가 재생됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [MovieAnnotation](movieannotation/#constructor)(Document, string) | Generator와 함께 사용하기 위한 생성자. |
| [MovieAnnotation](movieannotation/#constructor_1)(Page, Rectangle, string) | 지정된 페이지에 새로운 Sound 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/movieannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [File](../../aspose.pdf.annotations/movieannotation/file/) { get; set; } | 자체 설명이 가능한 영화 파일을 식별하는 파일 사양을 가져오거나 설정합니다. |
...
| [Poster](../../aspose.pdf.annotations/movieannotation/poster/) { get; set; } | 영화를 나타내는 포스터 이미지의 표시 여부와 방식을 지정하는 플래그 또는 스트림을 가져오거나 설정합니다. true인 경우 포스터 이미지는 영화 파일에서 가져오며, false인 경우 포스터가 표시되지 않습니다. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect/) { get; set; } | 주석 사각형을 가져오거나 설정합니다. |
| [Rotate](../../aspose.pdf.annotations/movieannotation/rotate/) { get; set; } | 영화를 페이지에 대해 시계 방향으로 회전시킬 각도를 도 단위로 가져오거나 설정합니다. 값은 90의 배수여야 합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/movieannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
