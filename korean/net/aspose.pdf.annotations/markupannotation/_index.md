...
| 이름 | 설명 |
| --- | --- |
| [MarkupAnnotation](markupannotation/)(Document) | 마크업 주석의 생성자. |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/#setreviewstate)(AnnotationState) | 주석의 검토 상태를 설정합니다. Marked 및 Unmarked 상태는 Review StateModel에 속하지 않으므로 무시됩니다. 상태는 대상 주석을 만든 사용자가 설정하며, 값은 대상 주석의 Title 속성에서 가져옵니다. 참고: state 및 statemodel 키를 가진 다른 텍스트 주석에 저장된 상태는 그대로 유지됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/#setreviewstate_1)(AnnotationState, string) | 주석의 검토 상태를 설정합니다. Marked 및 Unmarked 상태는 Review StateModel에 속하지 않으므로 무시됩니다. 참고: state 및 statemodel 키를 가진 다른 텍스트 주석에 저장된 상태는 그대로 유지됩니다. |
