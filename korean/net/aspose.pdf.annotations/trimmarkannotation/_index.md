...
type: docs
weight: 2690
url: /ko/net/aspose.pdf.annotations/trimmarkannotation/
---
...
| Name | Description |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | `TrimMarkAnnotation` 클래스의 새 인스턴스를 초기화합니다. |
...
| virtual [ActiveState](../../aspose.pdf.annotations/annotation/activestate/) { get; set; } | 현재 주석 모양 상태를 가져오거나 설정합니다. |
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
| [Appearance](../../aspose.pdf.annotations/annotation/appearance/) { get; } | 주석의 모양 사전을 가져옵니다. |
...
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | 주석의 모양 사전을 가져옵니다. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | 주석 처리를 위한 방문자를 수락합니다. |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matrix) | 매트릭스 변환에 따라 매개변수와 모양을 업데이트합니다. |
...
트림 마크는 인쇄된 페이지의 모서리에 배치되어 페이지가 잘릴 위치를 나타냅니다.
