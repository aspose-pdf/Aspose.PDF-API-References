---
title: "클래스 TrimMarkAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.TrimMarkAnnotation 클래스. 트림 마크 주석을 나타냅니다."
type: docs
weight: 2790
...
| 이름 | 설명 |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | 새 `TrimMarkAnnotation` 클래스 인스턴스를 초기화합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | 주석 처리를 위해 방문자를 수락합니다. |
...
트림 마크는 인쇄된 페이지의 모서리에 배치되어 페이지를 자를 위치를 표시합니다.
