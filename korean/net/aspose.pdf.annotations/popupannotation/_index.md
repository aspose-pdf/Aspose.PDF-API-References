...
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새 팝업 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | 팝업 주석이 처음에 열려 있어야 하는지를 지정하는 플래그를 가져오거나 설정합니다. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | 주석이 포함된 페이지의 인덱스를 가져옵니다. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | 이 팝업 주석과 연결될 부모 주석을 가져오거나 설정합니다. 이 항목이 존재하면 부모 주석의 Contents, M, C 및 T 항목이 팝업 주석 자체의 항목을 덮어씁니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
