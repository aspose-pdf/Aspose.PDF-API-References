---
title: "클래스 PopupAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.PopupAnnotation 클래스. 입력 및 편집을 위해 팝업 창에 텍스트를 표시하는 팝업 주석을 나타냅니다."
type: docs
weight: 2420
url: /ko/net/aspose.pdf.annotations/popupannotation/
---
## PopupAnnotation class

입력 및 편집을 위해 팝업 창에 텍스트를 표시하는 팝업 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PopupAnnotation](popupannotation/#constructor)(Document) | 생성자. Generator에서 사용하기 위해. |
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새 Popup 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | 팝업 주석이 처음에 열려 있게 표시될지 여부를 지정하는 플래그를 가져오거나 설정합니다. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | 주석이 포함된 페이지의 인덱스를 가져옵니다. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | 이 팝업 주석과 연결될 상위 주석을 가져오거나 설정합니다. 이 항목이 존재하는 경우, 상위 주석의 Contents, M, C 및 T 항목이 해당 팝업 주석 자체의 항목을 대체합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
