...
description: Aspose.Pdf.Annotations.PolygonAnnotation 클래스. 다각형 주석을 나타내는 클래스
type: docs
weight: 2310
url: /ko/net/aspose.pdf.annotations/polygonannotation/
---
## PolygonAnnotation 클래스
...
| 이름 | 설명 |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | 생성기와 함께 사용할 생성자입니다. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | 지정된 페이지에 새 다각형 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | 주석 처리를 위한 방문자 객체를 수락합니다. |
