---
title: "클래스 PolygonAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.PolygonAnnotation 클래스. 폴리곤 주석을 나타내는 클래스"
type: docs
weight: 2400
...
| 이름 | 설명 |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Generator와 함께 사용하기 위한 생성자. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | 지정된 페이지에 새로운 폴리곤 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | 주석 처리를 위해 방문자 객체를 받아들입니다. |
