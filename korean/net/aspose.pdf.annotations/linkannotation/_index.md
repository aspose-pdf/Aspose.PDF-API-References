...
description: Aspose.Pdf.Annotations.LinkAnnotation 클래스. 문서의 다른 위치에 있는 목적지로의 하이퍼텍스트 링크 또는 수행할 작업을 나타냅니다.
type: docs
weight: 2010
...
문서의 다른 위치에 있는 목적지로의 하이퍼텍스트 링크 또는 수행할 작업을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Page, Rectangle) | 지정된 페이지에 새 링크 주석을 생성합니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | 링크 주석이 활성화될 때 수행할 작업입니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | 마우스 버튼이 눌리거나 활성 영역 내에서 유지될 때 사용할 시각적 효과입니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
