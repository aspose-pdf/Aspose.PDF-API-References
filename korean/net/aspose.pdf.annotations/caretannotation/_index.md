...
description: Aspose.Pdf.Annotations.CaretAnnotation 클래스. 커서 주석을 나타내는 클래스
type: docs
weight: 1560
...
| Name | Description |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | 생성기에서 사용하기 위한 생성자. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새로운 Caret 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | 커서 사각형을 가져오거나 설정합니다. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | 커서와 관련된 기호를 가져오거나 설정합니다. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
