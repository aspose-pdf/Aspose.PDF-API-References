---
title: "클래스 CommonFigureAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.CommonFigureAnnotation 클래스. 일반 도형 주석을 나타내는 추상 클래스입니다."
type: docs
weight: 1710
...
| 이름 | 설명 |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | Generator에서 사용하기 위한 생성자입니다. |
