...
description: Aspose.Pdf.Annotations.WatermarkAnnotation 클래스. 클래스는 Watermark 주석 객체를 설명합니다.
type: docs
weight: 2710
url: /ko/net/aspose.pdf.annotations/watermarkannotation/
---
## WatermarkAnnotation 클래스

클래스는 Watermark 주석 객체를 설명합니다.
...
| 이름 | 설명 |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation/)(Page, Rectangle) | Watermark 주석 클래스의 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Actions](../../aspose.pdf.annotations/annotation/actions/) { get; } | 주석 동작 목록을 가져옵니다. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint/) { get; } | Watermark 주석의 고정 인쇄 객체입니다. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/watermarkannotation/changeafterresize/)(Matrix) | 빈 본문으로 기본 클래스의 정의를 재정의합니다. |
