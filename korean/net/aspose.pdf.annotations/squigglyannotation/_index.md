...
description: Aspose.Pdf.Annotations.SquigglyAnnotation 클래스. 문서의 텍스트에 톱니 모양의 밑줄로 나타나는 스퀴글리 주석을 나타냅니다.
type: docs
weight: 2600
url: /ko/net/aspose.pdf.annotations/squigglyannotation/
---
## SquigglyAnnotation 클래스

문서의 텍스트에 톱니 모양의 밑줄로 나타나는 스퀴글리 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | 지정된 페이지에 새 스퀴글리 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
