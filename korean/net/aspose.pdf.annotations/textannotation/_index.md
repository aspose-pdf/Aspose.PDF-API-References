---
title: "클래스 TextAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.TextAnnotation 클래스. PDF 문서의 지점에 붙어 있는 스티키 노트인 텍스트 주석을 나타냅니다."
type: docs
weight: 2750
...
PDF 문서의 한 지점에 부착된 '스티키 노트'인 텍스트 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Generator에서 사용될 때 주석에 대한 생성자입니다. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새로운 텍스트 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | 주석 표시 시 사용할 아이콘을 가져오거나 설정합니다. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | 주석이 처음에 열려 표시될지 여부를 지정하는 플래그를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | 기본 클래스의 정의를 빈 본문으로 재정의합니다. |
