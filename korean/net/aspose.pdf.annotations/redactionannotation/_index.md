...
type: docs
weight: 2400
url: /ko/net/aspose.pdf.annotations/redactionannotation/
---
## RedactionAnnotation 클래스
...
| 이름 | 설명 |
| --- | --- |
| [RedactionAnnotation](redactionannotation/#constructor)(Document) | RedactionAnnotation의 생성자. Generator에서 사용하기 위해. |
| [RedactionAnnotation](redactionannotation/#constructor_1)(Page, Rectangle) | RedactAnnotation의 생성자. |
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [BorderColor](../../aspose.pdf.annotations/redactionannotation/bordercolor/) { get; set; } | Redaction이 활성화되지 않았을 때 그려지는 테두리의 색상을 가져오거나 설정합니다. |
...
| [DefaultAppearance](../../aspose.pdf.annotations/redactionannotation/defaultappearance/) { get; set; } | 텍스트 형식에 사용될 기본 외관 문자열을 가져오거나 설정합니다. |
| [FillColor](../../aspose.pdf.annotations/redactionannotation/fillcolor/) { get; set; } | 주석을 채우기 위한 색상을 가져오거나 설정합니다. |
| [Flags](../../aspose.pdf.annotations/annotation/flags/) { get; set; } | 주석의 플래그입니다. |
| [FontSize](../../aspose.pdf.annotations/redactionannotation/fontsize/) { get; set; } | OverlayText의 글꼴 크기를 가져오거나 설정합니다. |
...
| [OverlayText](../../aspose.pdf.annotations/redactionannotation/overlaytext/) { get; set; } | Redact 주석에 인쇄할 텍스트를 가져오거나 설정합니다. |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint/) { get; set; } | 제거할 콘텐츠 영역의 좌표를 지정하는 8xN 숫자 배열입니다. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect/) { get; set; } | 주석 사각형을 가져오거나 설정합니다. |
| [Repeat](../../aspose.pdf.annotations/redactionannotation/repeat/) { get; set; } | true인 경우 Overlay 텍스트가 주석에 반복됩니다. |
...
| [TextAlignment](../../aspose.pdf.annotations/redactionannotation/textalignment/) { get; set; } | Overlay Text의 정렬을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | 주석을 평면화합니다. 즉, 주석을 제거하고 그 내용을 추가합니다. |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | 주석을 평면화하고 페이지 내용을 삭제합니다(즉, Redacted 주석 아래의 텍스트 및 이미지를 제거합니다). |
| [SetMarkedState](../../aspose.pdf.annotations/markupannotation/setmarkedstate/)(bool) | 주석의 Marked 및 Unmarked 상태를 설정합니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 주석의 검토 상태를 설정합니다. Marked 및 Unmarked 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 대상 주석을 생성한 사용자에 의해 설정됩니다. 값은 대상 주석의 Title 속성에서 가져옵니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | 주석의 검토 상태를 설정합니다. Marked 및 Unmarked 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
