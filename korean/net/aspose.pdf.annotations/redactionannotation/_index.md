---
title: "클래스 RedactionAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.RedactionAnnotation 클래스. Redact 주석을 나타냅니다."
type: docs
weight: 2490
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [BorderColor](../../aspose.pdf.annotations/redactionannotation/bordercolor/) { get; set; } | Redaction이 활성화되지 않을 때 그려지는 테두리 색상을 가져오거나 설정합니다. |
...
| [DefaultAppearance](../../aspose.pdf.annotations/redactionannotation/defaultappearance/) { get; set; } | 텍스트 형식 지정에 사용되는 기본 외관 문자열을 가져오거나 설정합니다. |
| [FillColor](../../aspose.pdf.annotations/redactionannotation/fillcolor/) { get; set; } | 주석을 채우는 색상을 가져오거나 설정합니다. |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint/) { get; set; } | 제거될 콘텐츠 영역의 좌표를 지정하는 8xN 숫자 배열입니다. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect/) { get; set; } | 주석 사각형을 가져오거나 설정합니다. |
| [Repeat](../../aspose.pdf.annotations/redactionannotation/repeat/) { get; set; } | true이면 오버레이 텍스트가 주석에 반복됩니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | 주석을 평탄화합니다. 즉, 주석을 제거하고 그 내용을 추가합니다. |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | 주석을 평탄화하고 페이지 내용을 가립니다(즉, 가려진 주석 아래의 텍스트와 이미지를 제거합니다). |
