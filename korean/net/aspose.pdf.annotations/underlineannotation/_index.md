---
title: "클래스 UnderlineAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.UnderlineAnnotation 클래스. 문서 텍스트에 밑줄로 표시되는 밑줄 주석을 나타냅니다."
type: docs
weight: 2800
...
문서 텍스트에 밑줄로 표시되는 언더라인 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 Underline 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
