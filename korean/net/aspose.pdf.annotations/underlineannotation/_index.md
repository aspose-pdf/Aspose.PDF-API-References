...
description: Aspose.Pdf.Annotations.UnderlineAnnotation 클래스. 문서의 텍스트에 밑줄로 나타나는 밑줄 주석을 나타냅니다.
type: docs
weight: 2700
url: /ko/net/aspose.pdf.annotations/underlineannotation/
---
## UnderlineAnnotation class

문서의 텍스트에 밑줄로 나타나는 밑줄 주석을 나타냅니다.
...
| Name | Description |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | 지정된 페이지에 새로운 밑줄 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | n개의 사각형의 좌표를 지정하는 점 배열을 가져오거나 설정합니다. 각 사각형은 주석 아래의 텍스트에서 단어 또는 연속된 단어 그룹을 포함합니다. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
...
| [SetMarkedState](../../aspose.pdf.annotations/markupannotation/setmarkedstate/)(bool) | 주석에 대해 마크된 상태와 마크되지 않은 상태를 설정합니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 주석의 검토 상태를 설정합니다. 마크된 상태와 마크되지 않은 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 대상 주석을 생성한 사용자에 의해 설정됩니다. 값은 대상 주석의 Title 속성에서 가져옵니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | 주석의 검토 상태를 설정합니다. 마크된 상태와 마크되지 않은 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
