---
title: "클래스 RichMediaAnnotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.RichMediaAnnotation 클래스. RichMediaAnnotation 클래스를 설명하며, PDF 문서에 비디오/오디오 데이터를 삽입할 수 있게 합니다."
type: docs
weight: 2570
...
PDF 문서에 비디오/오디오 데이터를 삽입할 수 있는 RichMediaAnnotation을 설명하는 클래스.
...
| [ActivateOn](../../aspose.pdf.annotations/richmediaannotation/activateon/) { get; set; } | 애플리케이션을 활성화하는 이벤트. |
| virtual [ActiveState](../../aspose.pdf.annotations/annotation/activestate/) { get; set; } | 현재 주석 외관 상태를 가져오거나 설정합니다. |
| override [AnnotationType](../../aspose.pdf.annotations/richmediaannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Content](../../aspose.pdf.annotations/richmediaannotation/content/) { get; } | Rich Media 콘텐츠의 데이터. |
| [Contents](../../aspose.pdf.annotations/annotation/contents/) { get; set; } | 주석 텍스트를 가져오거나 설정합니다. |
| [CustomFlashVariables](../../aspose.pdf.annotations/richmediaannotation/customflashvariables/) { get; set; } | 플래시 변수를 설정하거나 가져옵니다(플레이어에 전달됨). |
| [CustomPlayer](../../aspose.pdf.annotations/richmediaannotation/customplayer/) { get; set; } | 비디오/오디오 데이터를 재생하기 위한 사용자 정의 플래시 플레이어를 설정하거나 가져옵니다. |
...
| [Type](../../aspose.pdf.annotations/richmediaannotation/type/) { get; set; } | 콘텐츠 유형을 가져오거나 설정합니다. 가능한 값: Audio, Video. |
...
| [AddCustomData](../../aspose.pdf.annotations/richmediaannotation/addcustomdata/)(string, Stream) | 사용자 정의 명명된 데이터를 추가합니다(예: 플래시 스크립트에 필요). |
...
| 이름 | 설명 |
| --- | --- |
| enum [ActivationEvent](../../aspose.pdf.annotations/richmediaannotation.activationevent) | 주석을 활성화하는 이벤트. |
| enum [ContentType](../../aspose.pdf.annotations/richmediaannotation.contenttype) | 멀티미디어 유형. |
