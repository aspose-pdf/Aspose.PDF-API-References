...
description: Aspose.Pdf.Annotations.PolylineAnnotation 클래스. 첫 번째와 마지막 정점이 암시적으로 연결되지 않는 다각형과 유사한 폴리라인 주석을 나타냅니다.
type: docs
weight: 2320
url: /ko/net/aspose.pdf.annotations/polylineannotation/
---
## PolylineAnnotation 클래스

첫 번째와 마지막 정점이 암시적으로 연결되지 않는 다각형과 유사한 폴리라인 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | 지정된 페이지에 새 폴리라인 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | 두 번째 선 끝의 스타일을 가져오거나 설정합니다. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | 다각형 또는 폴리라인 주석의 의도를 가져오거나 설정합니다. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | 주석의 선 끝을 채우는 내부 색상을 가져오거나 설정합니다. |
...
| [Measure](../../aspose.pdf.annotations/polyannotation/measure/) { get; set; } | 이 주석에 대해 지정된 측정 단위입니다. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | 첫 번째 선 끝의 스타일을 가져오거나 설정합니다. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | 각 정점의 수평 및 수직 좌표를 나타내는 점 배열을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | 행렬 변환에 따라 Vertices의 점을 업데이트합니다. |
...
* 클래스 [PolyAnnotation](../polyannotation/)
