---
title: "PolylineAnnotation 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.PolylineAnnotation 클래스. 첫 번째와 마지막 꼭짓점이 암시적으로 연결되지 않은 점을 제외하고 다각형과 유사한 폴리라인 주석을 나타냅니다."
type: docs
weight: 2410
...
다각형과 유사하지만 첫 번째와 마지막 정점이 암시적으로 연결되지 않는 폴리라인 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | 지정된 페이지에 새로운 Polyline 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Measure](../../aspose.pdf.annotations/polyannotation/measure/) { get; set; } | 이 주석에 지정된 측정 단위입니다. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | 각 정점의 가로 및 세로 좌표를 나타내는 점 배열을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | 행렬 변환에 따라 Vertices의 점들을 업데이트합니다. |
