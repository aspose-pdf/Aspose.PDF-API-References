---
title: "클래스 Annotation"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Annotations.Annotation 클래스. 주석 객체를 나타내는 클래스"
type: docs
weight: 1500
url: /ko/net/aspose.pdf.annotations/annotation/
---
## Annotation class
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | 주석 테두리 특성을 가져오거나 설정합니다. [`Border`](./border/) |
...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert/) { get; set; } | true인 경우, PF document를 이미지로 변환하기 전에 주석 모양이 업데이트됩니다. 이는 필드를 올바르게 변환하도록 허용하지만 아마도 더 많은 시간이 소요될 수 있습니다. |
| static [UseFontSubset](../../aspose.pdf.annotations/annotation/usefontsubset/) { get; set; } | 이 속성이 true로 설정되면, 폰트가 document에 서브셋으로 추가됩니다. 기본값은 true입니다. |
