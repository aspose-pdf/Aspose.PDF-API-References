...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert/) { get; set; } | true인 경우, 주석 외관은 PF 문서를 이미지로 변환하기 전에 업데이트됩니다. 이는 필드를 올바르게 변환할 수 있지만 아마도 더 많은 시간을 요구할 것입니다. |
| static [UseFontSubset](../../aspose.pdf.annotations/annotation/usefontsubset/) { get; set; } | 이 속성이 true로 설정되면, 글꼴이 문서에 서브셋으로 추가됩니다. 기본값은 true입니다. |
