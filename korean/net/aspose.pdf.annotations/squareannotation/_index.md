...
description: Aspose.Pdf.Annotations.SquareAnnotation 클래스. 사각형 주석을 나타내는 클래스
type: docs
weight: 2590
url: /ko/net/aspose.pdf.annotations/squareannotation/
---
## SquareAnnotation 클래스
...
| 이름 | 설명 |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | 생성기와 함께 사용할 생성자입니다. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새 사각형 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | 두 사각형 간의 수치적 차이를 설명하는 사각형: 주석의 Rect 항목과 기본 사각형 또는 원의 실제 경계입니다. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | 주석의 사각형 또는 타원을 채우는 내부 색상입니다. |
...
| [Opacity](../../aspose.pdf.annotations/markupannotation/opacity/) { get; set; } | 주석을 그리는 데 사용될 상수 불투명도 값을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자를 수락합니다. |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matrix) | 매트릭스 변환에 따라 매개변수와 외관을 업데이트합니다. |
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | 주석의 상태 및 상태 모델을 지웁니다. 예를 들어, 주석의 검토 상태를 지웁니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
...
| [GetState](../../aspose.pdf.annotations/markupannotation/getstate/)() | 주석의 상태를 가져옵니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [GetStateModel](../../aspose.pdf.annotations/markupannotation/getstatemodel/)() | 주석의 상태 모델을 가져옵니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetMarkedState](../../aspose.pdf.annotations/markupannotation/setmarkedstate/)(bool) | 주석의 표시 및 비표시 상태를 설정합니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 주석의 검토 상태를 설정합니다. 표시 및 비표시 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 상태는 대상 주석을 생성한 사용자에 의해 설정됩니다. 값은 대상 주석의 Title 속성에서 가져옵니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | 주석의 검토 상태를 설정합니다. 표시 및 비표시 상태는 검토 상태 모델에 속하지 않으므로 무시됩니다. 주의: 상태는 상태 및 상태 모델 키가 있는 다른 텍스트 주석에 저장됩니다. |

### 참조

* 클래스 [CommonFigureAnnotation](../commonfigureannotation/)
