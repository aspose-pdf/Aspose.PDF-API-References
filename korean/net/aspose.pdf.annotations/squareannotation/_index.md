...
| 이름 | 설명 |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Generator와 함께 사용하기 위한 생성자. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | 지정된 페이지에 새로운 Square 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | 주석의 Rect 항목과 기본 사각형 또는 원의 실제 경계 사이의 수치적 차이를 설명하는 사각형입니다. |
