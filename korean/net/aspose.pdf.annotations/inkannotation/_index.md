...
하나 이상의 분리된 경로로 구성된 자유형 "낙서"를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Generator용 Ink 주석의 생성자. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | 지정된 페이지에 새로운 Ink 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | 주석 유형을 가져옵니다. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Ink 주석 선 끝의 스타일. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Annotation을 처리하기 위해 방문자 객체를 받아들입니다. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | 행렬 변환에 따라 InkList의 점들을 업데이트합니다. |
