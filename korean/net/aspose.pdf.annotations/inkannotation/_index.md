...
description: Aspose.Pdf.Annotations.InkAnnotation 클래스. 하나 이상의 분리된 경로로 구성된 자유형 스크리블을 나타냅니다.
type: docs
weight: 1920
url: /ko/net/aspose.pdf.annotations/inkannotation/
---
## InkAnnotation 클래스

하나 이상의 분리된 경로로 구성된 자유형 "스크리블"을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | 생성기용 잉크 주석의 생성자입니다. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | 지정된 페이지에 새로운 잉크 주석을 생성합니다. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | 주석의 유형을 가져옵니다. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | 잉크 주석 선 끝의 스타일입니다. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Point[] 배열로 표현되는 독립적인 선인 제스처 목록을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | 주석을 처리하기 위해 방문자 객체를 수락합니다. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | 행렬 변환에 따라 InkList의 포인트를 업데이트합니다. |
