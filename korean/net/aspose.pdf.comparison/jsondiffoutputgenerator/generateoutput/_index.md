...
description: "JsonDiffOutputGenerator 메서드. 텍스트 간 차이의 출력을 생성하고 파일에 저장합니다."
type: docs
weight: 20
url: /ko/net/aspose.pdf.comparison/jsondiffoutputgenerator/generateoutput/
---
## GenerateOutput(List&lt;DiffOperation&gt;) {#generateoutput}

텍스트 간 차이점을 출력하고 파일에 저장합니다.
