...
description: "SignatureAlgorithmInfo 필드. PDF 문서 서명에 사용되는 서명 알고리즘 유형을 가져옵니다."
type: docs
weight: 20
url: /ko/net/aspose.pdf.security/signaturealgorithminfo/algorithmtype/
---
## SignatureAlgorithmInfo.AlgorithmType field

PDF 문서 서명에 사용되는 서명 알고리즘 유형을 가져옵니다.
