...
description: "Aspose.Pdf.Drawing.Shape 클래스. 기본 그래픽 개체인 도형을 나타냅니다."
type: docs
weight: 4120
url: /ko/net/aspose.pdf.drawing/shape/
---
## Shape class
...
| 이름 | 설명 |
| --- | --- |
| [GraphInfo](../../aspose.pdf.drawing/shape/graphinfo/) { get; set; } | `[`GraphInfo`](./graphinfo/)` 객체를 가져오거나 설정합니다. 이 객체는 색상, 선 너비 등과 같은 그래프 정보를 나타냅니다. |
