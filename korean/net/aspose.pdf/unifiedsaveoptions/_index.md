---
title: "클래스 UnifiedSaveOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.UnifiedSaveOptions 클래스. 이 클래스는 통합 내부 Document 모델을 사용한 통합 변환 방식을 사용하는 저장 옵션을 나타냅니다"
type: docs
weight: 11330
...
이 클래스는 통합 변환 방식(통합 내부 문서 모델 사용)을 이용한 저장 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [UnifiedSaveOptions](unifiedsaveoptions/)() | 기본 생성자. |
