---
title: "클래스 PsSaveOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.PsSaveOptions 클래스. PS(PostScript) 또는 EPS 형식으로 내보내기 위한 저장 옵션입니다."
type: docs
weight: 9890
...
PS (PostScript) 또는 EPS 형식으로 내보내기 위한 저장 옵션입니다.
...
| [EmbedFont](../../aspose.pdf/pssaveoptions/embedfont/) { get; set; } | 결과 PS 문서에 폰트를 포함해야 하는지를 나타내는 플래그를 가져오거나 설정합니다. |
| [EmbedFontAs](../../aspose.pdf/pssaveoptions/embedfontas/) { get; set; } | 결과 PS 문서에 폰트를 포함해야 하는 유형을 가져오거나 설정합니다. |
