...
| [Background](../../aspose.pdf/stamp/background/) { get; set; } | 콘텐츠가 배경으로 스탬프되었음을 나타내는 bool 값을 설정하거나 가져옵니다. 값이 true이면 스탬프 콘텐츠가 맨 아래에 배치됩니다. 기본값은 false이며, 스탬프 콘텐츠가 맨 위에 배치됩니다. |
...
| [Image](../../aspose.pdf/imagestamp/image/) { get; } | 스탬핑에 사용되는 이미지 스트림을 가져옵니다. |
...
| [Quality](../../aspose.pdf/imagestamp/quality/) { get; set; } | 이미지 스탬프의 품질을 퍼센트로 가져오거나 설정합니다. 유효한 값은 0..100%입니다. |
...
| override [XIndent](../../aspose.pdf/imagestamp/xindent/) { get; set; } | 왼쪽에서 시작하는 수평 스탬프 좌표를 가져오거나 설정합니다. |
| override [YIndent](../../aspose.pdf/imagestamp/yindent/) { get; set; } | 아래에서 시작하는 수직 스탬프 좌표를 가져오거나 설정합니다. |
...
| override [Put](../../aspose.pdf/imagestamp/put/)(Page) | 페이지에 그래픽 스탬프를 추가합니다. |
