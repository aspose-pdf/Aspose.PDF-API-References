...
description: "FontEmbeddingException 생성자. FontEmbeddingException 클래스의 새 인스턴스를 초기화합니다"
type: docs
weight: 10
url: /ko/net/aspose.pdf/fontembeddingexception/fontembeddingexception/
---
## FontEmbeddingException(string) {#constructor_1}

`[`FontEmbeddingException`](../)` 클래스의 새 인스턴스를 초기화합니다.
...
`[`FontEmbeddingException`](../)` 클래스의 새 인스턴스를 지정된 오류 메시지와 이 예외의 원인인 내부 예외에 대한 참조와 함께 초기화합니다.
...
`[`FontEmbeddingException`](../)` 클래스의 새 인스턴스를 이 예외의 원인인 내부 예외에 대한 참조와 함께 초기화합니다.
