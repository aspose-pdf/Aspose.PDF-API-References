...
| [Value](../../aspose.pdf/xmpfield/value/) { get; } | 값을 가져옵니다. |

## 메서드

| 이름 | 설명 |
| --- | --- |
| override [Equals](../../aspose.pdf/xmpfield/equals/)(object) | 이 인스턴스와 지정된 객체가 같은지 여부를 나타냅니다. |
| override [GetHashCode](../../aspose.pdf/xmpfield/gethashcode/)() | 이 인스턴스에 대한 해시 코드를 반환합니다. |
| [ToArray](../../aspose.pdf/xmpfield/toarray/)() | 값을 배열로 가져옵니다. |
| [ToStructure](../../aspose.pdf/xmpfield/tostructure/)() | 값을 구조체로 가져옵니다. |
