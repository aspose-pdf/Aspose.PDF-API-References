...
description: Aspose.Pdf.BackgroundArtifact 클래스. 이 클래스는 배경 아티팩트를 설명합니다. 이 아티팩트는 페이지의 배경을 설정할 수 있게 해줍니다.
type: docs
weight: 2810
url: /ko/net/aspose.pdf/backgroundartifact/
---
## BackgroundArtifact 클래스

이 클래스는 배경 아티팩트를 설명합니다. 이 아티팩트는 페이지의 배경을 설정할 수 있게 해줍니다.
...
| 이름 | 설명 |
| --- | --- |
| [BackgroundArtifact](backgroundartifact/)() | BackgroundArtifact 객체를 초기화합니다. |
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | 배경 아티팩트의 배경 색상을 가져오거나 설정합니다. |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | 배경 아티팩트의 배경 이미지를 가져오거나 설정합니다. |
...
| [Rotation](../../aspose.pdf/artifact/rotation/) { get; set; } | 아티팩트의 회전 각도를 가져오거나 설정합니다. |
