---
title: "클래스 BatesNArtifact"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.BatesNArtifact 클래스. Bates 번호 매기기 아티팩트를 설명하는 클래스"
type: docs
weight: 2960
...
| 이름 | 설명 |
| --- | --- |
| [BatesNArtifact](batesnartifact/)() | `BatesNArtifact` 클래스의 새 인스턴스를 초기화합니다. 이 생성자는 내부이며 기본값으로 헤더 아티팩트 인스턴스를 생성합니다. |
...
| [EndPage](../../aspose.pdf/paginationartifact/endpage/) { get; set; } | 아티팩트의 종료 페이지 번호를 가져오거나 설정합니다. 값은 0 이상이어야 합니다. 0보다 작은 값이 설정되면 0으로 조정됩니다. 기본값 0은 종료 페이지 경계가 없음을 의미합니다. |
...
| [NumberOfDigits](../../aspose.pdf/batesnartifact/numberofdigits/) { get; set; } | Bates 번호 매기기의 자릿수를 가져오거나 설정합니다. 값은 3에서 15 사이여야 합니다. 3보다 작은 값이 설정되면 3으로 조정됩니다. 15보다 큰 값이 설정되면 15로 조정됩니다. 기본값은 6입니다. |
...
| [Prefix](../../aspose.pdf/batesnartifact/prefix/) { get; set; } | Bates 번호에 추가될 접두사를 가져오거나 설정합니다. |
...
| [StartNumber](../../aspose.pdf/batesnartifact/startnumber/) { get; set; } | Bates 번호 매기기의 시작 번호를 가져오거나 설정합니다. 값은 1 이상이어야 합니다. 1보다 작은 값이 설정되면 1로 조정됩니다. |
| [StartPage](../../aspose.pdf/paginationartifact/startpage/) { get; set; } | 아티팩트의 시작 페이지 번호를 가져오거나 설정합니다. 값은 1 이상이어야 합니다. 1보다 작은 값이 설정되면 1로 조정됩니다. |
| [Subset](../../aspose.pdf/paginationartifact/subset/) { get; set; } | 아티팩트가 적용되는 페이지 하위 집합을 가져오거나 설정합니다 (예: 모든 페이지, 짝수 페이지, 홀수 페이지). |
...
| [Suffix](../../aspose.pdf/batesnartifact/suffix/) { get; set; } | Bates 번호에 추가될 접미사를 가져오거나 설정합니다. |
