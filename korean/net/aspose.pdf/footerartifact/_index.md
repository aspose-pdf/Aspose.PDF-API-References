---
title: "클래스 FooterArtifact"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.FooterArtifact 클래스. 푸터 아티팩트를 설명합니다. 페이지의 푸터를 설정하는 데 사용할 수 있습니다."
type: docs
weight: 5050
...
바닥글 아티팩트를 설명합니다. 이는 페이지의 바닥글을 설정하는 데 사용할 수 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [FooterArtifact](footerartifact/)() | Footer Artifact 인스턴스를 생성합니다. |
