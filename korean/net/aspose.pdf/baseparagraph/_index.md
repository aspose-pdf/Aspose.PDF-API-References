---
title: "클래스 BaseParagraph"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.BaseParagraph 클래스. 페이지 문서의 Paragraphs.Add에 추가될 수 있는 추상 기본 객체를 나타냅니다."
type: docs
weight: 2950
...
페이지(doc.Paragraphs.Add())에 추가할 수 있는 추상 기본 객체를 나타냅니다.
