...
description: "Aspose.Pdf.Artifact 클래스. 클래스는 PDF Artifact 객체를 나타냅니다"
type: docs
weight: 2870
...
| 이름 | 설명 |
| --- | --- |
| [Artifact](artifact/#constructor)(ArtifactType, ArtifactSubtype) | 지정된 유형 및 하위 유형을 가진 Artifact의 생성자 |
| [Artifact](artifact/#constructor_1)(string, string) | 지정된 유형 및 하위 유형을 가진 Artifact의 생성자 |
...
| 이름 | 설명 |
| --- | --- |
| enum [ArtifactSubtype](../../aspose.pdf/artifact.artifactsubtype) | 가능한 Artifact 하위 유형의 열거형. |
| enum [ArtifactType](../../aspose.pdf/artifact.artifacttype) | 가능한 아티팩트 유형의 열거입니다. |
