...
| 이름 | 설명 |
| --- | --- |
| [TextStamp](textstamp/#constructor)(FormattedText) | `TextStamp` 클래스의 새 인스턴스를 formattedText 객체와 함께 초기화합니다 |
...
| [AutoAdjustFontSizeToFitStampRectangle](../../aspose.pdf/textstamp/autoadjustfontsizetofitstamprectangle/) { get; set; } | 활성화된 경우, 글꼴 크기가 스탬프 사각형 크기인 [`Width`](./width/) 및 [`Height`](./height/)에 맞게 자동으로 조정됩니다. 기본 너비와 높이는 페이지 사각형에서 파생됩니다. |
...
| [TextState](../../aspose.pdf/textstamp/textstate/) { get; } | 스탬프의 텍스트 속성을 가져옵니다. 자세한 내용은 [`TextState`](./textstate/)를 참조하세요. |
...
| 이름 | 설명 |
| --- | --- |
| enum [NoCharacterAction](../../aspose.pdf/textstamp.nocharacteraction) | 글꼴에 필요한 문자가 없을 경우 수행할 작업입니다. |
