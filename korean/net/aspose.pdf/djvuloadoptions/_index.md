---
title: "클래스 DjvuLoadOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.DjvuLoadOptions 클래스. DJVU 로드 옵션을 설명하는 클래스입니다."
type: docs
weight: 3860
url: /ko/net/aspose.pdf/djvuloadoptions/
---
## DjvuLoadOptions class

클래스는 DJVU 로드 옵션을 설명합니다.
...
| 이름 | 설명 |
| --- | --- |
| [DjvuLoadOptions](djvuloadoptions/)() | 기본 생성자. |
