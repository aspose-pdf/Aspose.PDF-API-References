...
description: FontNotFoundException 생성자. FontNotFoundException 클래스의 새 인스턴스를 초기화합니다.
type: docs
weight: 10
url: /ko/net/aspose.pdf/fontnotfoundexception/fontnotfoundexception/
---
## FontNotFoundException(string) {#constructor_1}

[`FontNotFoundException`](../) 클래스의 새 인스턴스를 초기화합니다.
...
지정된 오류 메시지와 이 예외의 원인인 내부 예외에 대한 참조로 [`FontNotFoundException`](../) 클래스의 새 인스턴스를 초기화합니다.
...
이 예외의 원인인 내부 예외에 대한 참조로 [`FontNotFoundException`](../) 클래스의 새 인스턴스를 초기화합니다.
