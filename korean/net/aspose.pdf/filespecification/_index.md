...
| 이름 | 설명 |
| --- | --- |
| [FileSpecification](filespecification/#constructor)() | 새 빈 파일 사양을 생성합니다. |
| [FileSpecification](filespecification/#constructor_3)(string) | FileSpecification의 생성자 |
| [FileSpecification](filespecification/#constructor_1)(Stream, string) | 파일 사양에 대한 생성자. |
...
| 이름 | 설명 |
| --- | --- |
| [AFRelationship](../../aspose.pdf/filespecification/afrelationship/) { get; set; } | 연관된 파일 관계. |
| [CollectionItem](../../aspose.pdf/filespecification/collectionitem/) { get; } | 파일 사양의 컬렉션 항목을 가져옵니다. |
| [Contents](../../aspose.pdf/filespecification/contents/) { get; set; } | 내용 파일을 가져오거나 설정합니다. 이 속성은 메모리에 로드된 데이터를 반환하며 대용량 데이터의 경우 메모리 부족 예외가 발생할 수 있습니다. 메모리 사용량을 줄이려면 StreamContents를 사용하십시오. |
| [Description](../../aspose.pdf/filespecification/description/) { get; set; } | 파일 사양과 연관된 텍스트를 가져오거나 설정합니다. |
...
| [MIMEType](../../aspose.pdf/filespecification/mimetype/) { get; set; } | 임베디드 파일의 서브타입을 가져옵니다 |
...
| [StreamContents](../../aspose.pdf/filespecification/streamcontents/) { get; } | 파일 내용을 스트림으로 가져옵니다. 내용이 메모리에 로드되지 않아 메모리 사용량을 줄일 수 있습니다. 그러나 이 스트림은 위치 지정 및 Length 속성을 지원하지 않습니다. 이러한 기능이 필요하면 대신 Contents 속성을 사용하십시오. |
...
| 이름 | 설명 |
| --- | --- |
| [Dispose](../../aspose.pdf/filespecification/dispose/)() | 내용을 해제합니다. |
| [GetValue](../../aspose.pdf/filespecification/getvalue/)(string) | 응용 프로그램별 매개변수를 가져옵니다. |
| [SetValue](../../aspose.pdf/filespecification/setvalue/)(string, string) | 응용 프로그램별 매개변수를 설정합니다. |
