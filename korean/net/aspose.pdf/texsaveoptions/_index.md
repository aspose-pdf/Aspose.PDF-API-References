...
description: Aspose.Pdf.TeXSaveOptions 클래스. TeX 형식으로 내보내기 위한 저장 옵션
type: docs
weight: 10400
...
| 이름 | 설명 |
| --- | --- |
| [TeXSaveOptions](texsaveoptions/)() | 기본 생성자입니다. |
...
| 이름 | 설명 |
| --- | --- |
| [AddFontEncs](../../aspose.pdf/texsaveoptions/addfontencs/)(params string[]) | 글꼴 인코딩 목록에 글꼴 인코딩을 추가합니다. |
| [ClearFontEncs](../../aspose.pdf/texsaveoptions/clearfontencs/)() | 글꼴 인코딩 목록을 지웁니다. |
