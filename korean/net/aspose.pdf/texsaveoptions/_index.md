---
title: "클래스 TeXSaveOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.TeXSaveOptions 클래스. TeX 형식으로 내보내기 위한 저장 옵션입니다."
type: docs
weight: 10580
url: /ko/net/aspose.pdf/texsaveoptions/
---
## TeXSaveOptions class

TeX 형식으로 내보내기 위한 저장 옵션
...
| 이름 | 설명 |
| --- | --- |
| [TeXSaveOptions](texsaveoptions/)() | 기본 생성자. |
...
| [OutDirectoryPath](../../aspose.pdf/texsaveoptions/outdirectorypath/) { get; set; } | _outDirectoryPath 매개변수에 대한 속성입니다. |
| [PagesCount](../../aspose.pdf/texsaveoptions/pagescount/) { get; } | 변환 후 페이지 수를 반환합니다. |
...
| 이름 | 설명 |
| --- | --- |
| [AddFontEncs](../../aspose.pdf/texsaveoptions/addfontencs/)(params string[]) | 글꼴 인코딩을 글꼴 인코딩 목록에 추가합니다. |
| [ClearFontEncs](../../aspose.pdf/texsaveoptions/clearfontencs/)() | 글꼴 인코딩 목록을 비웁니다. |
...
다음 예제는 PDF 파일을 TeX 파일로 변환하는 방법을 보여줍니다.
