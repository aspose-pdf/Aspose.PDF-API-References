...
description: "Form 메서드. 완전한 필드 이름에 따라 기존 버튼 필드에 이미지를 붙여 외관으로 사용합니다."
type: docs
weight: 150
...
전체 한정 필드 이름에 따라 기존 버튼 필드에 이미지를 외관으로 붙여넣습니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| fieldName | String | 이미지 버튼 필드의 완전한 필드 이름. |
| imageFileName | String | 이미지 파일 경로이며, 상대 경로와 절대 경로 모두 사용할 수 있습니다. |
...
FillImageField 함수의 오버로드입니다. 입력은 이미지 스트림입니다.
