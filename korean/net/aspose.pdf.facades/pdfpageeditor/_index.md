---
title: "클래스 PdfPageEditor"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Facades.PdfPageEditor 클래스. PDF 파일 페이지를 회전, 확대/축소, 위치 이동 및 페이지 크기 변경을 포함하여 편집하는 클래스를 나타냅니다."
type: docs
weight: 4710
...
PDF 파일의 페이지를 편집하는 클래스를 나타냅니다. 페이지 회전, 확대/축소, 위치 이동 및 페이지 크기 변경을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfPageEditor](pdfpageeditor/#constructor)() | PdfPageEditor 클래스의 생성자. |
| [PdfPageEditor](pdfpageeditor/#constructor_1)(Document) | PdfPageEditor 클래스의 생성자. |
...
| [PageRotations](../../aspose.pdf.facades/pdfpageeditor/pagerotations/) { get; set; } | 해시 테이블에는 페이지 번호와 회전 각도가 포함되어 있으며, 키는 페이지 번호를 나타내고, 값은 회전 각도를 나타냅니다. |
| [PageSize](../../aspose.pdf.facades/pdfpageeditor/pagesize/) { get; set; } | 출력 파일의 페이지 크기를 가져오거나 설정합니다. |
| [ProcessPages](../../aspose.pdf.facades/pdfpageeditor/processpages/) { get; set; } | 편집할 페이지 번호를 가져오거나 설정합니다. 기본적으로 모든 페이지가 편집됩니다. |
| [Rotation](../../aspose.pdf.facades/pdfpageeditor/rotation/) { get; set; } | 페이지의 회전을 가져오거나 설정합니다. 회전 값은 0, 90, 180 또는 270이어야 합니다. 기본값은 0입니다. |
...
| [Zoom](../../aspose.pdf.facades/pdfpageeditor/zoom/) { get; set; } | 확대 계수를 가져오거나 설정합니다. 값 1.0은 100%에 해당합니다. 기본값은 1.0입니다. 다음 예제는 문서 페이지의 확대/축소를 변경하는 방법을 보여줍니다. |
...
| [GetPageBoxSize](../../aspose.pdf.facades/pdfpageeditor/getpageboxsize/)(int, string) | 문서에서 지정된 상자의 크기를 반환합니다. |
| [GetPageRotation](../../aspose.pdf.facades/pdfpageeditor/getpagerotation/)(int) | 지정된 페이지의 회전을 반환합니다. |
| [GetPages](../../aspose.pdf.facades/pdfpageeditor/getpages/)() | 페이지의 총 수를 반환합니다. |
...
| const [BTWIPE](../../aspose.pdf.facades/pdfpageeditor/btwipe/) | 하단-상단 와이프 |
| const [DGLITTER](../../aspose.pdf.facades/pdfpageeditor/dglitter/) | 대각선 반짝임 |
| const [DISSOLVE](../../aspose.pdf.facades/pdfpageeditor/dissolve/) | 오래된 페이지가 사라집니다 |
| const [INBOX](../../aspose.pdf.facades/pdfpageeditor/inbox/) | 내부 상자 |
| const [LRGLITTER](../../aspose.pdf.facades/pdfpageeditor/lrglitter/) | 좌우 반짝임 |
| const [LRWIPE](../../aspose.pdf.facades/pdfpageeditor/lrwipe/) | 좌우 닦기 |
| const [OUTBOX](../../aspose.pdf.facades/pdfpageeditor/outbox/) | 외부 상자 |
| const [RLWIPE](../../aspose.pdf.facades/pdfpageeditor/rlwipe/) | 우-좌 닦기 |
| const [SPLITHIN](../../aspose.pdf.facades/pdfpageeditor/splithin/) | IN 수평 분할 |
| const [SPLITHOUT](../../aspose.pdf.facades/pdfpageeditor/splithout/) | Out 수평 분할 |
| const [SPLITVIN](../../aspose.pdf.facades/pdfpageeditor/splitvin/) | In 수직 분할 |
| const [SPLITVOUT](../../aspose.pdf.facades/pdfpageeditor/splitvout/) | Out 수직 분할 |
| const [TBGLITTER](../../aspose.pdf.facades/pdfpageeditor/tbglitter/) | 상하 반짝임 |
| const [TBWIPE](../../aspose.pdf.facades/pdfpageeditor/tbwipe/) | 상하 닦기 |
