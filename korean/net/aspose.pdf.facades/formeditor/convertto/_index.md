...
description: "FormEditor 속성. PDF 파일 형식을 설정합니다. 결과 파일은 지정된 파일 형식으로 저장됩니다. 이 속성을 지정하지 않으면 파일이 변환 없이 기본 PDF 형식으로 저장됩니다."
type: docs
weight: 20
url: /ko/net/aspose.pdf.facades/formeditor/convertto/
---
