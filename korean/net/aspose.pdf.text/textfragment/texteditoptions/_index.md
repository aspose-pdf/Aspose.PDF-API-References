...
description: TextFragment 속성. 텍스트 편집 옵션을 가져오거나 설정합니다. 옵션은 요청된 기호를 글꼴로 쓸 수 없을 때의 특별한 동작을 정의합니다.
type: docs
weight: 140
url: /ko/net/aspose.pdf.text/textfragment/texteditoptions/
---
## TextFragment.TextEditOptions 속성
