...
특정 document 페이지를 tiff로 변환하고 출력 스트림에 저장합니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| document | Document | 변환할 문서. |
| fromPage | Int32 | 변환을 시작할 페이지 번호를 정의합니다. |
| toPage | Int32 | 변환을 종료할 페이지 번호를 정의합니다. |
| output | Stream | tiff 이미지가 포함된 출력 스트림. |
