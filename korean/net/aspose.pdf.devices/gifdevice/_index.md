...
PDF 문서 페이지를 GIF로 저장하는 데 도움이 되는 이미지 장치를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [GifDevice](gifdevice/#constructor)() | 기본 해상도로 `GifDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [GifDevice](gifdevice/#constructor_2)(PageSize) | 제공된 페이지 크기로 `GifDevice` 클래스의 새 인스턴스를 초기화하며, 기본 해상도 (=150)입니다. |
| [GifDevice](gifdevice/#constructor_1)(Resolution) | `GifDevice` 클래스의 새 인스턴스를 초기화합니다. 결과 이미지 파일의 해상도, [`Resolution`](../resolution/) 클래스를 참조하십시오. |
| [GifDevice](gifdevice/#constructor_4)(int, int) | 제공된 이미지 치수로 `GifDevice` 클래스의 새 인스턴스를 초기화하며, 기본 해상도 (=150)입니다. |
| [GifDevice](gifdevice/#constructor_3)(PageSize, Resolution) | 제공된 페이지 크기와 해상스로 `GifDevice` 클래스의 새 인스턴스를 초기화합니다. |
| [GifDevice](gifdevice/#constructor_5)(int, int, Resolution) | 제공된 이미지 치수와 해상스로 `GifDevice` 클래스의 새 인스턴스를 초기화합니다. |
