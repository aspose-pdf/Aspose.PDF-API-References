...
description: Aspose.Pdf.LogicalStructure.HeaderElement 클래스. 논리 구조에서 헤더 구조 요소를 나타냅니다.
type: docs
weight: 6380
url: /ko/net/aspose.pdf.logicalstructure/headerelement/
---
## HeaderElement 클래스

논리 구조에서 헤더 구조 요소를 나타냅니다.
...
* 클래스 [BLSTextElement](../blstextelement/)
