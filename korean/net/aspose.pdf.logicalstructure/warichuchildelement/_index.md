...
description: Aspose.Pdf.LogicalStructure.WarichuChildElement 클래스. 논리 구조에서 Warichu의 자식 요소에 대한 기본 클래스를 나타냅니다.
type: docs
weight: 6860
url: /ko/net/aspose.pdf.logicalstructure/warichuchildelement/
---
## WarichuChildElement 클래스

논리 구조에서 Warichu의 자식 요소에 대한 기본 클래스를 나타냅니다.
...
| [Language](../../aspose.pdf.logicalstructure/structureelement/language/) { get; set; } | 구조 요소에 대한 언어를 가져오거나 설정합니다. |
...
| [Title](../../aspose.pdf.logicalstructure/structureelement/title/) { get; set; } | 구조 요소에 대한 제목을 가져오거나 설정합니다. |
...
| [SetTag](../../aspose.pdf.logicalstructure/structureelement/settag/)(string) | 구조 요소에 대한 사용자 정의 태그를 설정합니다. |
...
* 클래스 [StructureElement](../structureelement/)
