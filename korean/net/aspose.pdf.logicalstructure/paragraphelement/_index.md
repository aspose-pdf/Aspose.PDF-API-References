...
description: Aspose.Pdf.LogicalStructure.ParagraphElement 클래스. 논리 구조에서 단락 구조 요소를 나타냅니다.
type: docs
weight: 6540
url: /ko/net/aspose.pdf.logicalstructure/paragraphelement/
---
## ParagraphElement 클래스

논리 구조에서 단락 구조 요소를 나타냅니다.
