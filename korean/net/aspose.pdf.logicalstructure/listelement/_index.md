...
description: Aspose.Pdf.LogicalStructure.ListElement 클래스. 논리 구조에서 리스트 구조 요소를 나타냅니다.
type: docs
weight: 6460
url: /ko/net/aspose.pdf.logicalstructure/listelement/
---
## ListElement 클래스

논리 구조에서 리스트 구조 요소를 나타냅니다.
