...
description: StructTreeRootElement 메서드. 구조 요소를 콘텐츠 스트림 BDC 연산자에 바인딩합니다.
type: docs
weight: 10
url: /ko/net/aspose.pdf.logicalstructure/structtreerootelement/tag/
---
## Tag(BDC) {#tag_1}

구조 요소를 콘텐츠 스트림 BDC 연산자에 바인딩합니다.
