...
description: Aspose.Pdf.LogicalStructure.BLSTextElement 클래스. 논리 구조에서 블록 수준 텍스트 구조 요소의 기본 클래스를 나타냅니다.
type: docs
weight: 6250
url: /ko/net/aspose.pdf.logicalstructure/blstextelement/
---
## BLSTextElement 클래스
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | 현재 요소에 대한 StructureTextState 객체를 가져옵니다. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 구조에서 요소를 제거하고, 부모 객체에서의 참조를 제거하며, 자식 객체에서의 참조를 제거하고, 문서에서 해당 객체를 제거합니다. 제거된 객체의 자식 객체를 제거된 객체의 이전 부모 자식 객체 컬렉션에 인덱스에서 시작하여 삽입합니다. |
