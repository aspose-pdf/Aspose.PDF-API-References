...
description: Aspose.Pdf.LogicalStructure.FigureElement 클래스. 논리 구조에서 Figure 구조 요소를 나타냅니다.
type: docs
weight: 6340
url: /ko/net/aspose.pdf.logicalstructure/figureelement/
---
## FigureElement 클래스
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | 현재 일러스트레이션 요소에 이미지를 추가합니다. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | 현재 일러스트레이션 요소에 이미지를 추가합니다. |
