...
description: Aspose.Pdf.LogicalStructure.PartElement 클래스. 논리 구조에서 Part 구조 요소를 나타냅니다.
type: docs
weight: 6550
url: /ko/net/aspose.pdf.logicalstructure/partelement/
---
## PartElement 클래스

논리 구조에서 Part 구조 요소를 나타냅니다.
