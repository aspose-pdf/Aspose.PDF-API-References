...
description: Aspose.Pdf.LogicalStructure.RubyElement 클래스. 논리 구조에서 루비 구조 요소를 나타냅니다.
type: docs
weight: 6600
url: /ko/net/aspose.pdf.logicalstructure/rubyelement/
---
## RubyElement 클래스

논리 구조에서 루비 구조 요소를 나타냅니다.
