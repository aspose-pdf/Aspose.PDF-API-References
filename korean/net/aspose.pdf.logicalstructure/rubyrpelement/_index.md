...
description: Aspose.Pdf.LogicalStructure.RubyRPElement 클래스. 루비의 논리 구조에서 RP 구조 요소를 나타냅니다.
type: docs
weight: 6620
url: /ko/net/aspose.pdf.logicalstructure/rubyrpelement/
---
## RubyRPElement 클래스

루비의 논리 구조에서 RP 구조 요소를 나타냅니다.
