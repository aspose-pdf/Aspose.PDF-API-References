...
description: Aspose.Pdf.LogicalStructure.NoteElement 클래스. 논리 구조에서 노트 구조 요소를 나타냅니다.
type: docs
weight: 6520
url: /ko/net/aspose.pdf.logicalstructure/noteelement/
---
## NoteElement 클래스

논리 구조에서 노트 구조 요소를 나타냅니다.
