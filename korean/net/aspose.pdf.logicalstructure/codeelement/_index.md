...
description: Aspose.Pdf.LogicalStructure.CodeElement 클래스. 논리 구조에서 코드 구조 요소를 나타냅니다.
type: docs
weight: 6290
url: /ko/net/aspose.pdf.logicalstructure/codeelement/
---
## CodeElement class

논리 구조에서 코드 구조 요소를 나타냅니다.
