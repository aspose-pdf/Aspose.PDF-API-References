...
description: Aspose.Pdf.LogicalStructure.QuoteElement 클래스. 논리 구조에서 Quote 구조 요소를 나타냅니다.
type: docs
weight: 6570
url: /ko/net/aspose.pdf.logicalstructure/quoteelement/
---
## QuoteElement 클래스

논리 구조에서 Quote 구조 요소를 나타냅니다.
...
* 클래스 [ILSTextElement](../ilstextelement/)
