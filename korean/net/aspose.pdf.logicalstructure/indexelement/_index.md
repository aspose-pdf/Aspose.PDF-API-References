...
description: Aspose.Pdf.LogicalStructure.IndexElement 클래스. 논리 구조에서 인덱스 구조 요소를 나타냅니다.
type: docs
weight: 6430
url: /ko/net/aspose.pdf.logicalstructure/indexelement/
---
## IndexElement 클래스

논리 구조에서 인덱스 구조 요소를 나타냅니다.
