...
description: Aspose.Pdf.LogicalStructure.AnnotElement 클래스. 논리 구조에서 Annot 구조 요소를 나타냅니다.
type: docs
weight: 6180
url: /ko/net/aspose.pdf.logicalstructure/annotelement/
---
## AnnotElement 클래스

논리 구조에서 Annot 구조 요소를 나타냅니다.
