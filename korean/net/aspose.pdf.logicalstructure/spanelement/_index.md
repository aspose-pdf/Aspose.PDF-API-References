...
description: Aspose.Pdf.LogicalStructure.SpanElement 클래스. 논리 구조에서 Span 구조 요소를 나타냅니다.
type: docs
weight: 6650
url: /ko/net/aspose.pdf.logicalstructure/spanelement/
---
## SpanElement 클래스

논리 구조에서 Span 구조 요소를 나타냅니다.
