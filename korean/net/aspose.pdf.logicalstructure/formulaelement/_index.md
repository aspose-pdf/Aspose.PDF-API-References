...
description: Aspose.Pdf.LogicalStructure.FormulaElement 클래스. 논리 구조에서 수식 구조 요소를 나타냅니다.
type: docs
weight: 6360
url: /ko/net/aspose.pdf.logicalstructure/formulaelement/
---
## FormulaElement 클래스

논리 구조에서 수식 구조 요소를 나타냅니다.
