...
description: Aspose.Pdf.LogicalStructure.ListChildElement 클래스. 논리 구조에서 List의 자식 요소에 대한 기본 클래스를 나타냅니다.
type: docs
weight: 6450
url: /ko/net/aspose.pdf.logicalstructure/listchildelement/
---
## ListChildElement 클래스

논리 구조에서 List의 자식 요소에 대한 기본 클래스를 나타냅니다.
