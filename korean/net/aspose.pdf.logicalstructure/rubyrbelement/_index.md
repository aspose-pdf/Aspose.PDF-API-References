...
description: Aspose.Pdf.LogicalStructure.RubyRBElement 클래스. 루비의 논리 구조에서 RB 구조 요소를 나타냅니다.
type: docs
weight: 6610
url: /ko/net/aspose.pdf.logicalstructure/rubyrbelement/
---
## RubyRBElement 클래스

루비의 논리 구조에서 RB 구조 요소를 나타냅니다.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 구조에서 요소를 제거하고, 부모 객체에서의 참조를 제거하며, 자식 객체에서의 참조를 제거하고, 문서에서 해당 객체를 제거합니다. 제거된 객체의 자식 객체를 제거된 객체의 인덱스에서 시작하여 이전 부모 자식 객체 컬렉션에 삽입합니다. |
