...
description: Aspose.Pdf.LogicalStructure.RubyChildElement 클래스. 논리 구조에서 루비의 자식 요소에 대한 기본 클래스를 나타냅니다.
type: docs
weight: 6590
url: /ko/net/aspose.pdf.logicalstructure/rubychildelement/
---
## RubyChildElement 클래스

논리 구조에서 루비의 자식 요소에 대한 기본 클래스를 나타냅니다.
