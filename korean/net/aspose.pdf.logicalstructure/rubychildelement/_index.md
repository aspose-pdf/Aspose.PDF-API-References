---
title: "클래스 RubyChildElement"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.RubyChildElement 클래스. 논리 구조에서 Ruby의 자식 요소에 대한 기본 클래스를 나타냅니다."
type: docs
weight: 6730
...
논리 구조에서 Ruby의 자식 요소에 대한 기본 클래스를 나타냅니다.
