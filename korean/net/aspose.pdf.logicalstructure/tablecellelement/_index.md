...
description: Aspose.Pdf.LogicalStructure.TableCellElement 클래스. 논리 구조에서 테이블 셀 요소 TH 및 TD의 기본 클래스를 나타냅니다.
type: docs
weight: 6760
url: /ko/net/aspose.pdf.logicalstructure/tablecellelement/
---
## TableCellElement 클래스

논리 구조에서 테이블 셀 요소(TH 및 TD)의 기본 클래스를 나타냅니다.
...
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped/) { get; set; } | 셀의 텍스트가 단어로 줄 바꿈되는지 여부를 가져오거나 설정합니다. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 구조에서 요소를 제거하고, 부모 객체에서의 참조를 제거하고, 자식 객체에서의 참조를 제거하며, 문서에서 해당 객체를 제거합니다. 제거된 객체의 자식 객체를 제거된 객체의 이전 부모 자식 객체 컬렉션에 삽입합니다. |
