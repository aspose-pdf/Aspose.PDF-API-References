---
title: "TableCellElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.TableCellElement 클래스. 논리 구조에서 테이블 셀 요소 TH와 TD의 기본 클래스를 나타냅니다"
type: docs
weight: 6900
...
논리 구조에서 표 셀 요소(TH 및 TD)를 위한 기본 클래스를 나타냅니다.
