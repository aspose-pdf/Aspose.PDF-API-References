...
description: Aspose.Pdf.LogicalStructure.TableTFootElement 클래스. 테이블의 논리 구조에서 TFoot 구조 요소를 나타냅니다.
type: docs
weight: 6820
url: /ko/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## TableTFootElement 클래스

테이블의 논리 구조에서 TFoot 구조 요소를 나타냅니다.
