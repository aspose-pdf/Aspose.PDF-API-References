...
description: Aspose.Pdf.LogicalStructure.ILSTextElement 클래스. 논리 구조에서 인라인 수준 텍스트 구조 요소의 기본 클래스를 나타냅니다.
type: docs
weight: 6400
url: /ko/net/aspose.pdf.logicalstructure/ilstextelement/
---
## ILSTextElement 클래스

논리 구조에서 인라인 수준 텍스트 구조 요소의 기본 클래스를 나타냅니다.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | 현재 요소에 대한 StructureTextState 객체를 가져옵니다. |
