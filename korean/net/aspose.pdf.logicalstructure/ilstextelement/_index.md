---
title: "ILSTextElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.ILSTextElement 클래스. 논리 구조에서 인라인 레벨 텍스트 구조 요소에 대한 기본 클래스를 나타냅니다"
type: docs
weight: 6540
...
논리 구조에서 인라인 수준 텍스트 구조 요소에 대한 기본 클래스를 나타냅니다.
