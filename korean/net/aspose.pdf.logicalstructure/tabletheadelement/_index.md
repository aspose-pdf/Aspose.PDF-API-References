...
description: Aspose.Pdf.LogicalStructure.TableTHeadElement 클래스. 테이블의 논리 구조에서 THead 구조 요소를 나타냅니다.
type: docs
weight: 6840
url: /ko/net/aspose.pdf.logicalstructure/tabletheadelement/
---
## TableTHeadElement 클래스

테이블의 논리 구조에서 THead 구조 요소를 나타냅니다.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | [`TableTRElement`](../tabletrelement/)를 생성하고 현재 테이블에 추가합니다. |
...
* 클래스 [TableRowCollectionElement](../tablerowcollectionelement/)
