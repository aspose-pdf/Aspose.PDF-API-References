...
description: Aspose.Pdf.LogicalStructure.NonStructElement 클래스. 논리 구조에서 NonStruct 구조 요소를 나타냅니다.
type: docs
weight: 6510
url: /ko/net/aspose.pdf.logicalstructure/nonstructelement/
---
## NonStructElement 클래스
...
* 클래스 [GroupingElement](../groupingelement/)
