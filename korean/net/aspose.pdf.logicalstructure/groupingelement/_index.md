...
description: Aspose.Pdf.LogicalStructure.GroupingElement 클래스. 논리 구조에서 구조 요소를 그룹화하는 기본 클래스를 나타냅니다.
type: docs
weight: 6370
url: /ko/net/aspose.pdf.logicalstructure/groupingelement/
---
## GroupingElement 클래스

논리 구조에서 구조 요소를 그룹화하는 기본 클래스를 나타냅니다.
