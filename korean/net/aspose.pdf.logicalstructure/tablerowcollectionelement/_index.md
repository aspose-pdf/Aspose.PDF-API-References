---
title: "TableRowCollectionElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.TableRowCollectionElement 클래스. 논리 구조에서 Table Head, Body 및 Foot의 자식 요소에 대한 기본 클래스를 나타냅니다"
type: docs
weight: 6930
...
논리 구조에서 Table Head, Body 및 Foot의 자식 요소를 위한 기본 클래스를 나타냅니다.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | 현재 테이블에 [`TableTRElement`](../tabletrelement/)을 생성하고 추가했습니다. |
