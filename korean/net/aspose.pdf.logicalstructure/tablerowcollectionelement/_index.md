...
description: Aspose.Pdf.LogicalStructure.TableRowCollectionElement 클래스. 논리 구조에서 테이블 헤드, 본문 및 풋의 자식 요소에 대한 기본 클래스를 나타냅니다.
type: docs
weight: 6790
url: /ko/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## TableRowCollectionElement 클래스

논리 구조에서 테이블 헤드, 본문 및 풋의 자식 요소에 대한 기본 클래스를 나타냅니다.
