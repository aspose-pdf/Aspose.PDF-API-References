...
description: Aspose.Pdf.LogicalStructure.TableTDElement 클래스. 테이블의 논리 구조에서 TD 구조 요소를 나타냅니다.
type: docs
weight: 6810
url: /ko/net/aspose.pdf.logicalstructure/tabletdelement/
---
## TableTDElement 클래스

테이블의 논리 구조에서 TD 구조 요소를 나타냅니다.
...
| [IsNoBorder](../../aspose.pdf.logicalstructure/tablecellelement/isnoborder/) { get; set; } | 셀에 테두리가 있는지 가져오거나 설정합니다. |
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped/) { get; set; } | 셀의 텍스트가 단어로 줄 바꿈되는지 가져오거나 설정합니다. |
