...
description: Aspose.Pdf.LogicalStructure.ILSElement 클래스. 논리 구조에서 인라인 수준 구조 요소의 기본 클래스를 나타냅니다.
type: docs
weight: 6390
url: /ko/net/aspose.pdf.logicalstructure/ilselement/
---
## ILSElement 클래스

논리 구조에서 인라인 수준 구조 요소의 기본 클래스를 나타냅니다.
