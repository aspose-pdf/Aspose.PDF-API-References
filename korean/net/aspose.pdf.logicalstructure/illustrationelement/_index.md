---
title: "IllustrationElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.IllustrationElement 클래스. 논리 구조에서 일러스트레이션 구조 요소에 대한 기본 클래스를 나타냅니다"
type: docs
weight: 6560
url: /ko/net/aspose.pdf.logicalstructure/illustrationelement/
---
## IllustrationElement class

논리 구조에서 일러스트레이션 구조 요소의 기본 클래스를 나타냅니다.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | 현재 일러스트레이션 요소에 이미지를 추가합니다. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | 현재 일러스트레이션 요소에 이미지를 추가합니다. |
