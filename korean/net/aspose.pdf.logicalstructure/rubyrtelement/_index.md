...
description: Aspose.Pdf.LogicalStructure.RubyRTElement 클래스. 루비의 논리 구조에서 RT 구조 요소를 나타냅니다.
type: docs
weight: 6630
url: /ko/net/aspose.pdf.logicalstructure/rubyrtelement/
---
## RubyRTElement 클래스

루비의 논리 구조에서 RT 구조 요소를 나타냅니다.
...
| [InsertChild](../../aspose.pdf.logicalstructure/element/insertchild/)(Element, int, bool) | 지정된 인덱스에 Element를 자식 컬렉션에 삽입합니다. |
...
* 클래스 [RubyChildElement](../rubychildelement/)
