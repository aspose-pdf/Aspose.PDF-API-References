---
title: "클래스 AnnotationElement"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.AnnotationElement 클래스. 논리 구조에서 주석 구조 요소의 기본 클래스를 나타냅니다."
type: docs
weight: 6330
url: /ko/net/aspose.pdf.logicalstructure/annotationelement/
---
## AnnotationElement class

논리 구조에서 annotation 구조 요소의 기본 클래스를 나타냅니다.
