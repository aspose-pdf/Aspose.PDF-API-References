...
description: Aspose.Pdf.LogicalStructure.LinkElement 클래스. 논리 구조에서 링크 구조 요소를 나타냅니다.
type: docs
weight: 6440
url: /ko/net/aspose.pdf.logicalstructure/linkelement/
---
## LinkElement 클래스

논리 구조에서 링크 구조 요소를 나타냅니다.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | 주석에 대한 대체 설명을 가져오거나 설정합니다. 주석에 표시될 텍스트 또는 이 유형의 주석이 텍스트를 표시하지 않는 경우 주석 내용의 인간이 읽을 수 있는 형태의 대체 설명입니다. |
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink/) { get; set; } | 링크 요소에 대한 하이퍼링크를 가져오거나 설정합니다. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/linkelement/structuretextstate/) { get; } | 현재 요소에 대한 StructureTextState 객체를 가져옵니다. |
...
| [AppendChild](../../aspose.pdf.logicalstructure/element/appendchild/)(Element, bool) | 자식 컬렉션에 요소를 추가합니다. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 구조에서 요소를 제거하고, 부모 객체에서의 참조를 제거하며, 자식 객체에서의 참조를 제거하고, 문서에서 해당 객체를 제거합니다. 제거된 객체의 자식 객체를 이전 부모 자식 객체 컬렉션에 제거된 객체의 인덱스에서 시작하여 삽입합니다. |
...
* 클래스 [AnnotationElement](../annotationelement/)
* 인터페이스 [IAdjustPosition](../../aspose.pdf.tagged/iadjustposition/)
* 인터페이스 [ITextElement](../itextelement/)
