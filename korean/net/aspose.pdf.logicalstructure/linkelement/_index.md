---
title: "LinkElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.LinkElement 클래스. 논리 구조에서 Link 구조 요소를 나타냅니다"
type: docs
weight: 6580
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | 주석에 대한 Alternate Descriptions를 가져오거나 설정합니다. 주석에 표시될 텍스트이거나, 이 유형의 주석이 텍스트를 표시하지 않을 경우 주석 내용의 인간이 읽을 수 있는 형태의 대체 설명입니다. |
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink/) { get; set; } | Link 요소의 하이퍼링크를 가져오거나 설정합니다. |
