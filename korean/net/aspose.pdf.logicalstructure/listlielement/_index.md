...
description: Aspose.Pdf.LogicalStructure.ListLIElement 클래스. 리스트의 논리 구조 내 LI 구조 요소를 나타냅니다.
type: docs
weight: 6480
url: /ko/net/aspose.pdf.logicalstructure/listlielement/
---
## ListLIElement 클래스

리스트의 논리 구조 내 LI 구조 요소를 나타냅니다.
...
| [ClearId](../../aspose.pdf.logicalstructure/structureelement/clearid/)() | 구조 요소의 ID를 제거합니다. |
| [FindElements&lt;T&gt;](../../aspose.pdf.logicalstructure/element/findelements/)(bool) | 지정된 유형의 요소들을 찾습니다. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | 구조에서 요소를 제거하고, 부모 객체에서 해당 요소에 대한 참조와 자식 객체들에서의 참조, 그리고 문서의 해당 객체를 제거합니다. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 구조에서 요소를 제거하고, 부모 객체에서의 참조와 자식 객체들의 참조, 문서의 해당 객체를 제거합니다. 제거된 객체의 자식 객체들을 제거된 객체의 인덱스 위치에서 이전 부모의 자식 컬렉션에 삽입합니다. |
| [RemoveChild](../../aspose.pdf.logicalstructure/element/removechild/)(int) | 해당 위치의 자식 요소를 제거합니다. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(BDC) | 구조 요소를 content stream BDC operator에 바인딩합니다. |
...
* 클래스 [ListChildElement](../listchildelement/)
