...
description: Aspose.Pdf.LogicalStructure.TableTBodyElement 클래스. 테이블의 논리 구조에서 TBody 구조 요소를 나타냅니다.
type: docs
weight: 6800
url: /ko/net/aspose.pdf.logicalstructure/tabletbodyelement/
---
## TableTBodyElement 클래스

테이블의 논리 구조에서 TBody 구조 요소를 나타냅니다.
