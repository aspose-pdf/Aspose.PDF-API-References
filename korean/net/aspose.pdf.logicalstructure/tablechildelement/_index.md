...
description: Aspose.Pdf.LogicalStructure.TableChildElement 클래스. 논리 구조에서 테이블의 자식 요소에 대한 기본 클래스를 나타냅니다.
type: docs
weight: 6770
url: /ko/net/aspose.pdf.logicalstructure/tablechildelement/
---
## TableChildElement 클래스

논리 구조에서 테이블의 자식 요소에 대한 기본 클래스를 나타냅니다.
