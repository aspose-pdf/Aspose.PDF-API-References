---
title: "TableChildElement 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.LogicalStructure.TableChildElement 클래스. 논리 구조에서 Table의 자식 요소에 대한 기본 클래스를 나타냅니다"
type: docs
weight: 6910
...
논리 구조에서 Table의 자식 요소를 위한 기본 클래스를 나타냅니다.
