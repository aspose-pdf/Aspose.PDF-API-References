...
description: Aspose.Pdf.Forms.PasswordBoxField 클래스. 클래스는 비밀번호 입력을 위한 텍스트 필드를 설명합니다.
type: docs
weight: 5200
url: /ko/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField 클래스

클래스는 비밀번호 입력을 위한 텍스트 필드를 설명합니다.
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | 필드의 전체 이름이 정확히 일치하는 경우 JSON 스트림에서 지정된 필드로 데이터를 가져옵니다. |
