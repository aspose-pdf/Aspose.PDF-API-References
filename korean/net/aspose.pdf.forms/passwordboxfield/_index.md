---
title: "클래스 PasswordBoxField"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.PasswordBoxField 클래스. 비밀번호 입력을 위한 텍스트 필드를 설명하는 클래스"
type: docs
weight: 5320
url: /ko/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField class

클래스는 비밀번호 입력용 텍스트 필드를 설명합니다.
