...
description: "Aspose.Pdf.Forms.Field 클래스. Acro 양식 필드의 기본 클래스"
type: docs
weight: 5170
url: /ko/net/aspose.pdf.forms/field/
---
## Field class
...
| 이름 | 설명 |
| --- | --- |
| [Field](field/)(Document) | Generator에서 사용할 필드를 생성합니다. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | true인 경우 텍스트가 지정된 사각형에 맞도록 글꼴 크기가 줄어듭니다. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | 필드 내용에 사용할 수 있는 최대 글꼴 크기입니다. -1이면 크기를 확인하지 않습니다. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | 필드 내용에 사용할 수 있는 최소 글꼴 크기입니다. -1이면 크기를 확인하지 않습니다. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | 이 필드의 하위 필드를 지정된 인덱스부터 배열에 복사합니다. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | 필드 전체 이름이 정확히 일치하는 경우 JSON 스트림에서 지정된 필드로 데이터를 가져옵니다. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | 'fieldFullNameInJSON' 변수에 지정된 전체 이름을 사용하여 JSON 스트림에서 지정된 필드로 데이터를 가져옵니다. |
