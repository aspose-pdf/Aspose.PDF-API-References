...
| 이름 | 설명 |
| --- | --- |
| [CheckboxField](checkboxfield/#constructor_1)(Document) | 생성기와 함께 사용할 생성자입니다. |
| [CheckboxField](checkboxfield/#constructor_2)(Document, Rectangle) | CheckboxField 클래스의 생성자입니다. |
| [CheckboxField](checkboxfield/#constructor_3)(Page, Rectangle) | CheckboxField 클래스의 생성자입니다. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate/) { get; set; } | 현재 주석의 외관 상태를 가져오거나 설정합니다. |
...
| [Checked](../../aspose.pdf.forms/checkboxfield/checked/) { get; set; } | 체크박스의 상태를 가져오거나 설정합니다. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue/) { get; set; } | 체크박스 필드의 내보낼 값을 가져오거나 설정합니다. |
...
| [Style](../../aspose.pdf.forms/checkboxfield/style/) { get; set; } | 체크박스의 스타일을 가져오거나 설정합니다. |
...
| override [Value](../../aspose.pdf.forms/checkboxfield/value/) { get; set; } | 체크박스 필드의 값을 가져오거나 설정합니다. |
...
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption)(string) | 체크박스 그룹에 새 체크박스를 추가합니다. 이 그룹에서는 한 번에 하나의 체크박스만 선택할 수 있습니다. 새 체크박스는 그룹의 하단에 추가됩니다. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_1)(string, Rectangle) | 체크박스 그룹에 새 체크박스를 추가합니다. 이 그룹에서는 한 번에 하나의 체크박스만 선택할 수 있습니다. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_2)(string, int, Rectangle) | 체크박스 그룹에 새 체크박스를 추가합니다. 이 그룹에서는 한 번에 하나의 체크박스만 선택할 수 있습니다. |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matrix) | 매트릭스 변환에 따라 매개변수와 외관을 업데이트합니다. |
| override [Clone](../../aspose.pdf.forms/checkboxfield/clone/)() | 체크박스를 복제합니다. |
...
이 예제는 다중 값 체크박스 필드를 만드는 방법을 보여줍니다.
