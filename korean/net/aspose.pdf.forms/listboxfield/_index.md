---
title: "ListBoxField 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.ListBoxField 클래스. 이 클래스는 ListBox 필드를 나타냅니다."
type: docs
weight: 5250
url: /ko/net/aspose.pdf.forms/listboxfield/
---
## ListBoxField class

클래스는 리스트박스 필드를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | Generator에서 사용할 ListBoxField의 생성자입니다. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | ListBox 필드의 생성자입니다. |
| [ListBoxField](listboxfield/#constructor_2)(Page, Rectangle) | 새로운 ListBox 필드를 생성합니다. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | 선택된 항목의 인덱스를 가져오거나 설정합니다. 항목은 1부터 번호가 매겨집니다. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | 다중 선택 목록에서 선택된 항목들의 배열을 가져오거나 설정합니다. 단일 선택 목록의 경우 단일 항목이 포함된 배열을 반환합니다. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | 목록에서 가장 위에 보이는 요소의 인덱스를 가져오거나 설정합니다. |
