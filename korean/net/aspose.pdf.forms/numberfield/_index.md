---
title: "클래스 NumberField"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.NumberField 클래스. 지정된 유효 문자와 함께 텍스트 필드"
type: docs
weight: 5260
url: /ko/net/aspose.pdf.forms/numberfield/
---
## NumberField class

지정된 유효 문자와 함께하는 텍스트 필드
...
| 이름 | 설명 |
| --- | --- |
| [NumberField](numberfield/#constructor)() | `NumberField` 클래스의 새 인스턴스를 초기화합니다. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | `NumberField` 클래스의 새 인스턴스를 초기화합니다. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | `NumberField` 클래스의 새 인스턴스를 초기화합니다. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | 허용된 문자를 가져오거나 설정합니다. |
