---
title: "클래스 RichTextBoxField"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.RichTextBoxField 클래스. 클래스는 리치 텍스트 편집기 구성 요소를 설명합니다."
type: docs
weight: 5350
url: /ko/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField class

리치 텍스트 편집기 구성 요소를 설명하는 클래스.
...
| 이름 | 설명 |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | 리치 텍스트 박스 필드의 생성자입니다. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | 마크업이 포함된 형식화된 리치 텍스트 값을 가져오거나 설정합니다. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | 리치 텍스트 박스의 정렬을 가져오거나 설정합니다. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | 리치 텍스트 값을 가져오거나 설정합니다. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | 리치 텍스트 필드의 기본 스타일 문자열을 가져오거나 설정합니다. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | RichTextField의 값입니다. |
