...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | 서명 객체를 가져옵니다. 이 객체는 공개키 암호화 표준에 관한 서명 데이터를 포함합니다. 클래스 [`PKCS1`](../pkcs1/), [`PKCS7`](../pkcs7/) 및 [`PKCS7Detached`](../pkcs7detached/)는 지원되는 모든 서명 객체 유형을 나타냅니다. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | 단일 X.509 인증서를 DER 형식의 스트림으로 추출합니다. |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | 단일 X.509 인증서 객체를 추출합니다. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | 서명의 이미지를 jpeg 인코딩 스트림으로 추출합니다. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign)(Signature) | 이 서명 필드를 사용하여 문서를 서명합니다. |
