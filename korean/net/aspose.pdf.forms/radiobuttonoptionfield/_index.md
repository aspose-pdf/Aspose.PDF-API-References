---
title: "RadioButtonOptionField 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.RadioButtonOptionField 클래스. 클래스는 RadioButton 필드의 항목을 나타냅니다."
type: docs
weight: 5340
url: /ko/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## RadioButtonOptionField class

RadioButton 필드의 항목을 나타내는 클래스.
...
| 이름 | 설명 |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | 새 RadioButtonOptionField 인스턴스를 생성합니다. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | 지정된 페이지의 지정된 사각형에 라디오 버튼을 생성합니다. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | 캡션을 가져오거나 설정합니다. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | 옵션의 이름을 가져오거나 설정합니다. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | 체크 박스의 스타일을 가져오거나 설정합니다. |
