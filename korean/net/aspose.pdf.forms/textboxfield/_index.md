---
title: "클래스 TextBoxField"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.TextBoxField 클래스. 텍스트 박스 필드를 나타내는 클래스"
type: docs
weight: 5440
url: /ko/net/aspose.pdf.forms/textboxfield/
---
## TextBoxField class
...
| 이름 | 설명 |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Generator와 함께 사용해야 하는 생성자입니다. |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | TextBox 필드의 생성자입니다. |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | TextBox 필드의 생성자입니다. |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | TextBox 필드의 생성자입니다. |
