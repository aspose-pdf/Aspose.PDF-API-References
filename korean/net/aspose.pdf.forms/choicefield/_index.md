...
description: "Aspose.Pdf.Forms.ChoiceField class. 선택 필드의 기본 클래스를 나타냅니다."
type: docs
weight: 5110
url: /ko/net/aspose.pdf.forms/choicefield/
---
## ChoiceField class

선택 필드의 기본 클래스를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | 선택 필드를 생성합니다 (Generator용) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | ChoiceField의 생성자입니다. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | ChoiceField의 생성자입니다. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | 지정된 이름으로 새 옵션을 추가합니다. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | 지정된 내보내기 값과 이름으로 새 옵션을 추가합니다. |
