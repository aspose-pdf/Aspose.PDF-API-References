---
title: "클래스 ComboBoxField"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.ComboBoxField 클래스. 클래스는 양식의 콤보박스 필드를 나타냅니다."
type: docs
weight: 5120
url: /ko/net/aspose.pdf.forms/comboboxfield/
---
## ComboBoxField class

클래스는 폼의 콤보박스 필드를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Generator에서 사용할 ComboBoxField의 생성자입니다. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Generator와 함께 사용할 CombBox 필드를 생성합니다. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | 콤보박스 필드의 생성자입니다. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | 콤보박스 필드의 생성자입니다. |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately/) { get; set; } | 선택 변경 시 커밋 플래그를 가져오거나 설정합니다. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | 필드의 편집 가능 상태를 가져오거나 설정합니다. |
...
| virtual [Options](../../aspose.pdf.forms/choicefield/options/) { get; } | 선택 옵션 컬렉션을 가져옵니다. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | 선택된 옵션의 인덱스를 가져오거나 설정합니다. 이 속성을 사용하면 선택을 변경할 수 있습니다. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | 선택된 항목들의 배열을 가져오거나 설정합니다. 다중 선택 목록의 경우 배열에 둘 이상의 항목이 포함됩니다. 단일 선택 목록의 경우 하나의 항목만 포함됩니다. |
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | 맞춤법 검사 활성 상태를 가져오거나 설정합니다. |
...
| override [Value](../../aspose.pdf.forms/choicefield/value/) { get; set; } | 필드의 값을 가져오거나 설정합니다. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string) | 지정된 이름으로 새 옵션을 추가합니다. |
