...
description: "Aspose.Pdf.Forms.PKCS1 클래스. PKCS1 표준에 관한 서명 객체를 나타냅니다. 서명에는 RSA 암호화 알고리즘과 SHA1 다이제스트 방법이 사용됩니다."
type: docs
weight: 5290
...
PKCS#1 표준에 관한 서명 객체를 나타냅니다. 서명에는 RSA 암호화 알고리즘과 SHA-1 다이제스트 방법이 사용됩니다.
