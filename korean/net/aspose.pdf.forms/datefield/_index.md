...
description: Aspose.Pdf.Forms.DateField 클래스. 캘린더 뷰가 있는 날짜 필드
type: docs
weight: 5010
...
| [DateField](datefield/#constructor_1)(Document) | 생성기와 함께 사용해야 하는 생성자입니다. |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | 생성기 지원을 위한 속성입니다. 필드가 머리글이나 바닥글에 추가될 때 사용됩니다. true인 경우 이 필드는 한 번 생성되며 그 외관은 문서의 모든 페이지에 표시됩니다. false인 경우 문서 페이지마다 별도의 필드가 생성됩니다. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | 이 필드에 대한 이미지 추가가 거부되었습니다. (2 메서드) |
...
| [Init](../../aspose.pdf.forms/datefield/init/)(Page) | JS 작업을 초기화합니다. |
