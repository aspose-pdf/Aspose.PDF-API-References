...
description: "Aspose.Pdf.Forms.DateField 클래스. 캘린더 보기가 있는 날짜 필드"
type: docs
weight: 5130
url: /ko/net/aspose.pdf.forms/datefield/
---
## DateField class
...
| 이름 | 설명 |
| --- | --- |
| [DateField](datefield/#constructor)() | `DateField`의 새 인스턴스를 초기화합니다. |
| [DateField](datefield/#constructor_1)(Document) | Generator와 함께 사용해야 하는 생성자입니다. |
| [DateField](datefield/#constructor_2)(Document, Rectangle) | `DateField`의 새 인스턴스를 초기화합니다. |
| [DateField](datefield/#constructor_3)(Page, Rectangle) | `DateField`의 새 인스턴스를 초기화합니다. |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat/) { get; set; } | 날짜 형식을 가져오거나 설정합니다. |
...
| [Value](../../aspose.pdf.forms/datefield/value/) { get; set; } | 날짜를 가져오거나 설정합니다. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | 이 필드에 대한 이미지 추가가 거부되었습니다. (2개의 메서드) |
...
| [Init](../../aspose.pdf.forms/datefield/init/)(Page) | JS 액션을 초기화합니다. |
