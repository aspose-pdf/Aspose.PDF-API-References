...
description: "Aspose.Pdf.Forms.ButtonField class. 클래스는 푸시 버튼 필드를 나타냅니다."
type: docs
weight: 5090
url: /ko/net/aspose.pdf.forms/buttonfield/
---
## ButtonField class

클래스는 푸시 버튼 필드를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Generator용 버튼 필드 생성자. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | ButtonField 생성자. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | ButtonField 생성자. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | 활성 영역 내에서 마우스 버튼이 눌렸을 때 표시될 버튼의 대체 캡션을 가져오거나 설정합니다. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | 마우스 버튼이 활성 영역 내에서 눌렸을 때 표시될 대체 아이콘을 가져오거나 설정합니다. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | 위젯 주석의 아이콘이 주석 사각형 내에서 어떻게 표시될지를 지정하는 아이콘 맞춤 객체를 가져옵니다. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | 아이콘 캡션 위치를 가져오거나 설정합니다. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | 일반 캡션을 가져오거나 설정합니다. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | 사용자와 상호 작용하지 않을 때 표시될 버튼의 일반 아이콘을 가져오거나 설정합니다. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | 사용자가 마우스 버튼을 누르지 않고 커서를 활성 영역으로 이동시킬 때 표시될 버튼의 롤오버 캡션을 가져오거나 설정합니다. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | 사용자가 마우스 버튼을 누르지 않고 커서를 활성 영역으로 이동시킬 때 표시될 버튼의 롤오버 아이콘을 가져오거나 설정합니다. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | 필드 리소스에 이미지를 추가하고 그립니다. |
