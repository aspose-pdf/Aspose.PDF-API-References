...
description: Aspose.Pdf.Forms.ButtonField 클래스. 클래스는 푸시 버튼 필드를 나타냅니다.
type: docs
weight: 4970
...
| 이름 | 설명 |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | 생성기용 버튼 필드 생성자. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | 마우스 버튼이 활성 영역 내에서 눌렸을 때 표시될 버튼의 대체 캡션을 가져오거나 설정합니다. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | 위젯 주석의 아이콘이 주석 사각형 내에서 어떻게 표시될지를 지정하는 아이콘 맞춤 개체를 가져옵니다. |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | 생성기 지원을 위한 속성입니다. 필드가 머리글이나 바닥글에 추가될 때 사용됩니다. true이면 이 필드는 한 번만 생성되며 모든 페이지에서 그 외관이 표시됩니다. false이면 문서의 각 페이지에 대해 별도의 필드가 생성됩니다. |
| [IsSynchronized](../../aspose.pdf.forms/field/issynchronized/) { get; } | 사전이 동기화되면 true를 반환합니다. |
...
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | 사용자가 상호작용하지 않을 때 표시될 버튼의 일반 아이콘을 가져오거나 설정합니다. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | 사용자가 마우스 버튼을 누르지 않고 활성 영역으로 커서를 올렸을 때 표시될 버튼의 롤오버 캡션을 가져오거나 설정합니다. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | 사용자가 마우스 버튼을 누르지 않고 활성 영역으로 커서를 올렸을 때 표시될 버튼의 롤오버 아이콘을 가져오거나 설정합니다. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | 주석의 외관 사전을 가져옵니다. |
| [SyncRoot](../../aspose.pdf.forms/field/syncroot/) { get; } | 동기화 개체입니다. |
