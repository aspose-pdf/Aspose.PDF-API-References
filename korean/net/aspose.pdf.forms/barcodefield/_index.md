---
title: "BarcodeField 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Forms.BarcodeField 클래스. 이 클래스는 바코드 필드를 나타냅니다."
type: docs
weight: 5070
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | 오류 정정 계수를 나타내는 정수 값을 가져옵니다. PDF417의 경우 0에서 8 사이여야 합니다. QRCode의 경우 0에서 3 사이여야 합니다 (0은 'L', 1은 'M', 2는 'Q', 3은 'H'에 해당). |
...
| [MaxLen](../../aspose.pdf.forms/textboxfield/maxlen/) { get; set; } | 필드 내 텍스트의 최대 길이를 가져오거나 설정합니다. |
| [Modified](../../aspose.pdf.annotations/annotation/modified/) { get; set; } | Annotation이 최근 수정된 날짜와 시간을 가져오거나 설정합니다. |
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | 필드의 다중 행 플래그를 가져오거나 설정합니다. Multiline이 true이면 필드에 여러 줄의 텍스트를 포함할 수 있습니다. |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | 바코드 객체가 렌더링되는 해상도(dpi)를 가져옵니다. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | 필드의 스크롤 가능 플래그를 가져오거나 설정합니다. true이면 필드를 스크롤할 수 있습니다. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | 필드의 맞춤법 검사 플래그를 가져오거나 설정합니다. true이면 필드에 맞춤법 검사가 수행됩니다. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Annotation의 외관 사전을 가져옵니다. |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | 이 주석에 사용할 바코드 또는 글리프 기술을 지정합니다. 자세한 내용은 [`Symbology`](./symbology/)를 참조하십시오. |
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | 주석에 대한 텍스트 수직 정렬을 가져오거나 설정합니다. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | 두 바코드 모듈 사이의 수직 거리를 픽셀 단위로 가져옵니다. 비율 XSymHeight/XSymWidth는 정수 값이어야 합니다. PDF417의 경우 허용 비율 범위는 1에서 4 사이입니다. QRCode 및 DataMatrix의 경우 이 비율은 항상 1이어야 합니다. |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | 두 바코드 모듈 사이의 수평 거리를 픽셀 단위로 가져옵니다. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | 필드에 barcode 128을 추가합니다. 필드 값이 코드로 변경되고 필드는 읽기 전용이 됩니다. |
