---
title: "PdfAOptionsBase 클래스"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Plugins.PdfAOptionsBase 클래스. PdfAConverter 플러그인 옵션에 대한 기본 클래스를 나타냅니다. 이 클래스는 PDF/A 변환 및 검증 프로세스를 구성하기 위한 속성과 메서드를 제공합니다."
type: docs
weight: 9160
...
`[`PdfAConverter`](../pdfaconverter/)` 플러그인 옵션에 대한 기본 클래스를 나타냅니다. 이 클래스는 PDF/A 변환 및 검증 프로세스를 구성하기 위한 속성과 메서드를 제공합니다.
