...
| 이름 | 설명 |
| --- | --- |
| [PdfToDocOptions](pdftodocoptions/#constructor)() | `PdfToDocOptions` 객체의 새 인스턴스를 기본 옵션으로 초기화합니다. |
| [PdfToDocOptions](pdftodocoptions/#constructor_1)(SaveFormat, ConversionMode) | 지정된 형식 및 모드에 대해 `PdfToDocOptions` 객체의 새 인스턴스를 초기화합니다. |
