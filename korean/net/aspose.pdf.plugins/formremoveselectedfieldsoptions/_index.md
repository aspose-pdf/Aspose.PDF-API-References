---
title: "클래스 FormRemoveSelectedFieldsOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Plugins.FormRemoveSelectedFieldsOptions 클래스. FormEditor 플러그인을 사용하여 문서에서 선택된 필드를 제거하기 위한 옵션을 나타냅니다."
type: docs
weight: 8920
url: /ko/net/aspose.pdf.plugins/formremoveselectedfieldsoptions/
---
## FormRemoveSelectedFieldsOptions class

[`FormEditor`](../formeditor/) 플러그인을 사용하여 문서에서 선택된 필드를 제거하기 위한 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [FormRemoveSelectedFieldsOptions](formremoveselectedfieldsoptions/)(SelectField) | `[`FormEditorRemoveOptions`](../formeditorremoveoptions/)` 객체의 새 인스턴스를 초기화합니다. |
