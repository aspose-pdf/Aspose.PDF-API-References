---
title: "클래스 PdfAConvertOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Plugins.PdfAConvertOptions 클래스. PdfAConverter 플러그인을 사용하여 PDF 문서를 PDF/A 형식으로 변환하는 옵션을 나타냅니다."
type: docs
weight: 9140
...
[`PdfAConverter`](../pdfaconverter/) 플러그인을 사용하여 PDF 문서를 PDF/A 형식으로 변환하는 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfAConvertOptions](pdfaconvertoptions/)() | 기본 생성자. |
...
| [Outputs](../../aspose.pdf.plugins/pdfaconvertoptions/outputs/) { get; } | 저장 작업 결과를 위한 추가된 대상(파일 또는 스트림 데이터 소스) 컬렉션을 가져옵니다. |
...
| [AddOutput](../../aspose.pdf.plugins/pdfaconvertoptions/addoutput/)(IDataSource) | 새 결과 저장 대상을 추가합니다. |
