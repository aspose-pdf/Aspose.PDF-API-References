...
description: Aspose.Pdf.Plugins.PdfAConvertOptions 클래스. PDF 문서를 PDF/A 형식으로 변환하기 위한 옵션을 나타냅니다. PdfAConverter 플러그인과 함께 사용됩니다.
type: docs
weight: 8990
url: /ko/net/aspose.pdf.plugins/pdfaconvertoptions/
---
## PdfAConvertOptions 클래스

[`PdfAConverter`](../pdfaconverter/) 플러그인과 함께 PDF 문서를 PDF/A 형식으로 변환하기 위한 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfAConvertOptions](pdfaconvertoptions/)() | 기본 생성자입니다. |
...
| [ErrorAction](../../aspose.pdf.plugins/pdfaoptionsbase/erroraction/) { get; set; } | 변환할 수 없는 객체에 대해 취할 행동을 가져오거나 설정합니다. |
...
| [IccProfileFileName](../../aspose.pdf.plugins/pdfaoptionsbase/iccprofilefilename/) { get; set; } | 기본 ICC(International Color Consortium) 프로필 대신 PDF/A 변환에 사용할 ICC 프로필의 파일 이름을 가져오거나 설정합니다. |
...
| [Outputs](../../aspose.pdf.plugins/pdfaconvertoptions/outputs/) { get; } | 저장 작업 결과를 위한 추가된 대상(파일 또는 스트림 데이터 소스)의 컬렉션을 가져옵니다. |
...
| [SoftMaskAction](../../aspose.pdf.plugins/pdfaoptionsbase/softmaskaction/) { get; set; } | 소프트 마스크가 있는 이미지 변환 중에 취할 행동을 가져오거나 설정합니다. |
...
| [UnicodeProcessingRules](../../aspose.pdf.plugins/pdfaoptionsbase/unicodeprocessingrules/) { get; set; } | PDF/A 변환 과정에서 ToUnicode CMap 테이블과 유니코드 기호와 연결되지 않은 기호를 처리하기 위한 규칙을 가져오거나 설정합니다. |
...
| [AddOutput](../../aspose.pdf.plugins/pdfaconvertoptions/addoutput/)(IDataSource) | 새로운 결과 저장 대상을 추가합니다. |
