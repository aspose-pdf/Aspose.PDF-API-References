---
title: "클래스 PdfToXlsOptions"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.Plugins.PdfToXlsOptions 클래스. XlsConverter 플러그인을 위한 PDF to XLSX 변환기 옵션을 나타냅니다."
type: docs
weight: 9300
...
[`XlsConverter`](../xlsconverter/) 플러그인을 위한 PDF to XLSX 변환기 옵션을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfToXlsOptions](pdftoxlsoptions/)() | 기본 생성자. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../aspose.pdf.plugins/pdftoxlsoptions/format/) { get; set; } | 출력 형식. |
...
| [MinimizeTheNumberOfWorksheets](../../aspose.pdf.plugins/pdftoxlsoptions/minimizethenumberofworksheets/) { get; set; } | 결과 워크북에서 워크시트 수를 최소화해야 하는 경우 true로 설정합니다. 기본값은 false이며, 이는 각 PDF 페이지를 별도의 워크시트로 저장함을 의미합니다. |
