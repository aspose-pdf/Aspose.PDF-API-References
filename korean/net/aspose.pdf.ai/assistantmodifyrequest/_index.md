---
title: "클래스 AssistantModifyRequest"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.AssistantModifyRequest 클래스. 어시스턴트를 수정하기 위한 요청 객체입니다"
type: docs
weight: 130
...
| 이름 | 설명 |
| --- | --- |
| [AssistantModifyRequest](assistantmodifyrequest/)() | 기본 생성자. |
