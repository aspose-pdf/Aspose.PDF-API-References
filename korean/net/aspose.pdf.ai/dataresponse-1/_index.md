---
title: "클래스 DataResponseT"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.DataResponse1T 클래스. 지정된 데이터를 포함하는 데이터 응답을 나타냅니다"
type: docs
weight: 310
url: /ko/net/aspose.pdf.ai/dataresponse-1/
---
## DataResponse&lt;T&gt; class

지정된 데이터를 포함하는 데이터 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [DataResponse](dataresponse/)() | 기본 생성자. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Data](../../aspose.pdf.ai/dataresponse-1/data/) { get; set; } | 응답의 데이터를 가져오거나 설정합니다. |
