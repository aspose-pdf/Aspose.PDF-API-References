---
title: "클래스 VectorStoreFileListQueryParameters"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.VectorStoreFileListQueryParameters 클래스. 벡터 스토어 파일을 나열하기 위한 쿼리 매개변수 객체입니다."
type: docs
weight: 1420
...
벡터 저장소 파일을 나열하기 위한 쿼리 매개변수 객체입니다.
...
| 이름 | 설명 |
| --- | --- |
| [VectorStoreFileListQueryParameters](vectorstorefilelistqueryparameters/)() | 기본 생성자. |
...
| [Filter](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/filter/) { get; set; } | 파일 상태별 필터를 가져오거나 설정합니다. in_progress, completed, failed, cancelled 중 하나입니다. |
...
| 이름 | 설명 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/getqueryparameters/)() | 벡터 스토어 파일을 나열하기 위한 쿼리 매개변수를 가져옵니다. |
