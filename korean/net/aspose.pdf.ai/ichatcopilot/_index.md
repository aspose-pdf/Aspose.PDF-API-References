---
title: "인터페이스 IChatCopilot"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.IChatCopilot 인터페이스. AI 모델을 통해 문서와 상호 작용하는 채팅 코파일럿을 나타냅니다."
type: docs
weight: 490
...
AI 모델을 통해 문서와 상호작용하는 채팅 코파일럿을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [DeleteContextAsync](../../aspose.pdf.ai/ichatcopilot/deletecontextasync/)(CancellationToken?) | 컨텍스트를 비동기적으로 삭제합니다. |
...
| [SaveContextAsync](../../aspose.pdf.ai/ichatcopilot/savecontextasync/)(string, CancellationToken?) | 컨텍스트를 JSON 파일에 비동기적으로 저장합니다. |
