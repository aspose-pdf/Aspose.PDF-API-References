...
description: OpenAIClient 메서드. 스레드 내에서 메시지를 비동기적으로 삭제합니다.
type: docs
weight: 160
url: /ko/net/aspose.pdf.ai/openaiclient/deletethreadmessageasync/
---
## OpenAIClient.DeleteThreadMessageAsync 메서드
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| threadId | String | 삭제할 메시지를 포함하는 스레드의 ID입니다. |
