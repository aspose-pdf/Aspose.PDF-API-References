...
description: OpenAIClient 메서드. 비동기적으로 새로운 벡터 저장소를 생성합니다.
type: docs
weight: 100
url: /ko/net/aspose.pdf.ai/openaiclient/createvectorstoreasync/
---
## OpenAIClient.CreateVectorStoreAsync 메서드

비동기적으로 새로운 벡터 저장소를 생성합니다.
...
비동기 작업을 나타내는 태스크입니다. 태스크 결과에는 벡터 저장소 생성에 대한 응답이 포함됩니다.
