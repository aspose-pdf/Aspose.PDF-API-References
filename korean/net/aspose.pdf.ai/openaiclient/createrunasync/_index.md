...
description: OpenAIClient 메서드. 지정된 스레드 내에서 비동기적으로 실행을 생성합니다.
type: docs
weight: 50
url: /ko/net/aspose.pdf.ai/openaiclient/createrunasync/
---
## OpenAIClient.CreateRunAsync 메서드
...
비동기 작업을 나타내는 태스크입니다. 태스크 결과에는 실행 생성에 대한 응답이 포함됩니다.
