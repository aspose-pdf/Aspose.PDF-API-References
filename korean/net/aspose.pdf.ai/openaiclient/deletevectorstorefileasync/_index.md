...
description: OpenAIClient 메서드. 벡터 저장소 내의 파일을 비동기적으로 삭제합니다.
type: docs
weight: 180
url: /ko/net/aspose.pdf.ai/openaiclient/deletevectorstorefileasync/
---
## OpenAIClient.DeleteVectorStoreFileAsync 메서드
