...
description: OpenAIClient 메서드. 특정 스레드에 대한 메시지 목록을 비동기적으로 검색합니다.
type: docs
weight: 320
url: /ko/net/aspose.pdf.ai/openaiclient/getthreadmessagesasync/
---
## OpenAIClient.GetThreadMessagesAsync 메서드
