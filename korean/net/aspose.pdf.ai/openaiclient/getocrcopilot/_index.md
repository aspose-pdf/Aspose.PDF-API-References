...
description: "OpenAIClient 메서드. 지정된 옵션으로 IOcrCopilot 인스턴스를 가져옵니다."
type: docs
weight: 250
url: /ko/net/aspose.pdf.ai/openaiclient/getocrcopilot/
---
## OpenAIClient.GetOcrCopilot method

지정된 옵션으로 [`IOcrCopilot`](../../iocrcopilot/) 인스턴스를 가져옵니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| 옵션 | IOcrCopilotOptions`1 | OCR 코파일럿에 대한 옵션입니다. |

### 반환 값

[`IOcrCopilot`](../../iocrcopilot/) 인스턴스입니다.
