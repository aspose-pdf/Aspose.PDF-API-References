...
description: OpenAIClient 메서드. 특정 벡터 저장소 파일 배치 내의 파일 목록을 비동기적으로 검색합니다.
type: docs
weight: 360
url: /ko/net/aspose.pdf.ai/openaiclient/getvectorstorefilebatchfilesasync/
---
## OpenAIClient.GetVectorStoreFileBatchFilesAsync 메서드
