---
title: "클래스 ListDataResponseT"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.ListDataResponse1T 클래스. 첫 번째 및 마지막 ID와 추가 항목 여부와 같은 추가 정보를 포함하는 목록 데이터 응답을 나타냅니다."
type: docs
weight: 720
url: /ko/net/aspose.pdf.ai/listdataresponse-1/
---
## ListDataResponse&lt;T&gt; class

첫 번째 및 마지막 ID와 추가 항목 여부와 같은 추가 정보를 포함하는 목록 데이터 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ListDataResponse](listdataresponse/)() | 기본 생성자. |
...
| [FirstId](../../aspose.pdf.ai/listdataresponse-1/firstid/) { get; set; } | 목록의 첫 번째 ID를 가져오거나 설정합니다. |
| [HasMore](../../aspose.pdf.ai/listdataresponse-1/hasmore/) { get; set; } | 목록에 추가 항목이 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [LastId](../../aspose.pdf.ai/listdataresponse-1/lastid/) { get; set; } | 목록의 마지막 ID를 가져오거나 설정합니다. |
