...
description: Aspose.Pdf.AI.VectorStoreFileBatchFileListResponse 클래스. 벡터 저장 파일 배치 데이터를 포함하는 목록 응답을 나타냅니다.
type: docs
weight: 1300
url: /ko/net/aspose.pdf.ai/vectorstorefilebatchfilelistresponse/
---
## VectorStoreFileBatchFileListResponse 클래스

벡터 저장 파일 배치 데이터를 포함하는 목록 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [VectorStoreFileBatchFileListResponse](vectorstorefilebatchfilelistresponse/)() | 기본 생성자입니다. |
