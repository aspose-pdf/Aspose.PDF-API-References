---
title: "클래스 VectorStoreListQueryParameters"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.VectorStoreListQueryParameters 클래스. 벡터 스토어 목록을 조회하기 위한 쿼리 매개변수 객체"
type: docs
weight: 1450
...
| 이름 | 설명 |
| --- | --- |
| [VectorStoreListQueryParameters](vectorstorelistqueryparameters/)() | 기본 생성자. |
...
| 이름 | 설명 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorelistqueryparameters/getqueryparameters/)() | 벡터 스토어 목록을 조회하기 위한 쿼리 매개변수를 가져옵니다. |
