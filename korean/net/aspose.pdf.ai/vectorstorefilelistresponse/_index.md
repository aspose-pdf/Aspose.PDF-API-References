---
title: "클래스 VectorStoreFileListResponse"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.VectorStoreFileListResponse 클래스. 벡터 스토어 파일 데이터를 포함하는 목록 응답을 나타냅니다."
type: docs
weight: 1430
url: /ko/net/aspose.pdf.ai/vectorstorefilelistresponse/
---
## VectorStoreFileListResponse class

벡터 저장소 파일 데이터를 포함하는 목록 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [VectorStoreFileListResponse](vectorstorefilelistresponse/)() | 기본 생성자. |
...
| 이름 | 설명 |
| --- | --- |
| [GetFileIdList](../../aspose.pdf.ai/vectorstorefilelistresponse/getfileidlist/)() | 벡터 스토어에서 파일 ID 목록을 가져옵니다. |
