---
title: "클래스 RunStepListQueryParameters"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.RunStepListQueryParameters 클래스. 실행 단계 목록을 위한 쿼리 매개변수 객체"
type: docs
weight: 1120
...
런 단계 목록을 조회하기 위한 쿼리 매개변수 객체입니다.
...
| 이름 | 설명 |
| --- | --- |
| [RunStepListQueryParameters](runsteplistqueryparameters/)() | 기본 생성자. |
...
| 이름 | 설명 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runsteplistqueryparameters/getqueryparameters/)() | 실행 단계 목록을 위한 쿼리 매개변수를 가져옵니다. |
