---
title: "클래스 OpenAISummaryCopilotOptions"
...
| [MaxPromptTokens](../../aspose.pdf.ai/openaisummarycopilotoptions/maxprompttokens/) { get; set; } | 실행 동안 사용할 수 있는 프롬프트 토큰의 최대 수를 가져오거나 설정합니다. |
...
| static [Create](../../aspose.pdf.ai/openaisummarycopilotoptions/create/#create_1)(Action&lt;OpenAISummaryCopilotOptions&gt;) | 제공된 대리자를 사용하여 `OpenAISummaryCopilotOptions` 인스턴스를 생성하고 구성합니다. |
...
| [WithDocument](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocument/#withdocument)(PdfDocument) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 PDF 문서를 추가합니다. |
| [WithDocument](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocument/#withdocument_2)(string) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 문서 경로를 추가합니다. |
| [WithDocument](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocument/#withdocument_1)(TextDocument) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 텍스트 문서를 추가합니다. |
...
| [WithDocuments](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocuments/#withdocuments_1)(List&lt;PdfDocument&gt;) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 여러 PDF 문서를 추가합니다. |
| [WithDocuments](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocuments/#withdocuments_3)(List&lt;string&gt;) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 여러 문서 경로를 추가합니다. |
| [WithDocuments](../../aspose.pdf.ai/openaisummarycopilotoptions/withdocuments/#withdocuments_2)(List&lt;TextDocument&gt;) | 요약 코파일럿 옵션을 위한 문서 컬렉션에 여러 텍스트 문서를 추가합니다. |
