...
description: Aspose.Pdf.AI.RunListResponse 클래스. 실행 데이터를 포함하는 목록 응답을 나타냅니다.
type: docs
weight: 1000
url: /ko/net/aspose.pdf.ai/runlistresponse/
---
## RunListResponse 클래스

실행 데이터를 포함하는 목록 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [RunListResponse](runlistresponse/)() | 기본 생성자입니다. |
