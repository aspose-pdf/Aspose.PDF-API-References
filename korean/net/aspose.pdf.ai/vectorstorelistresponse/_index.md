---
title: "클래스 VectorStoreListResponse"
second_title: "Aspose.PDF 용 .NET API 참조"
description: "Aspose.Pdf.AI.VectorStoreListResponse 클래스. 벡터 스토어 데이터를 포함하는 목록 응답을 나타냅니다."
type: docs
weight: 1460
url: /ko/net/aspose.pdf.ai/vectorstorelistresponse/
---
## VectorStoreListResponse class

벡터 저장소 데이터를 포함하는 목록 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [VectorStoreListResponse](vectorstorelistresponse/)() | 기본 생성자. |
