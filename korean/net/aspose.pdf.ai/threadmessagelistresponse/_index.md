...
description: Aspose.Pdf.AI.ThreadMessageListResponse 클래스. 스레드 메시지 데이터를 포함하는 목록 응답을 나타냅니다.
type: docs
weight: 1140
url: /ko/net/aspose.pdf.ai/threadmessagelistresponse/
---
## ThreadMessageListResponse 클래스

스레드 메시지 데이터를 포함하는 목록 응답을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | 기본 생성자입니다. |
...
| [Detail](../../aspose.pdf.ai/baseresponse/detail/) { get; set; } | 응답 세부정보를 가져오거나 설정합니다. |
...
| [ReasonPhrase](../../aspose.pdf.ai/baseresponse/reasonphrase/) { get; } | 오류 이유 문구를 가져옵니다. |
