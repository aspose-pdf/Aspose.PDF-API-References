...
description: IOpenAIClient 메서드. 지정된 스레드에 대한 실행 목록을 비동기적으로 검색합니다.
type: docs
weight: 240
url: /ko/net/aspose.pdf.ai/iopenaiclient/getrunsasync/
---
## IOpenAIClient.GetRunsAsync 메서드
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| threadId | String | 실행을 검색할 스레드의 ID입니다. |
