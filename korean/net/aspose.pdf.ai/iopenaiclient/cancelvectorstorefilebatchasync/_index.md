...
description: IOpenAIClient 메서드. 특정 벡터 저장소 파일 배치를 비동기적으로 취소합니다.
type: docs
weight: 20
url: /ko/net/aspose.pdf.ai/iopenaiclient/cancelvectorstorefilebatchasync/
---
## IOpenAIClient.CancelVectorStoreFileBatchAsync 메서드
...
비동기 작업을 나타내는 태스크입니다. 태스크 결과에는 파일 배치를 취소한 응답이 포함됩니다.
