...
description: IOpenAIClient 메서드. 스레드 내의 기존 메시지를 비동기적으로 수정합니다.
type: docs
weight: 390
url: /ko/net/aspose.pdf.ai/iopenaiclient/modifythreadmessageasync/
---
## IOpenAIClient.ModifyThreadMessageAsync 메서드
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| threadId | 문자열 | 수정할 메시지가 포함된 스레드의 ID입니다. |
| threadMessageId | 문자열 | 수정할 메시지의 ID입니다. |
