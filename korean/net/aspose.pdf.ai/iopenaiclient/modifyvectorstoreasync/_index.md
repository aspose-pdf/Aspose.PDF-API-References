...
description: IOpenAIClient 메서드. 기존 벡터 저장소를 비동기적으로 수정합니다.
type: docs
weight: 400
url: /ko/net/aspose.pdf.ai/iopenaiclient/modifyvectorstoreasync/
---
## IOpenAIClient.ModifyVectorStoreAsync 메서드
