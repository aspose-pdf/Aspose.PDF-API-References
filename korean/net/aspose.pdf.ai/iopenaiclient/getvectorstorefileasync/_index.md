...
description: IOpenAIClient 메서드. 벡터 저장소 내 특정 파일의 세부 정보를 비동기적으로 검색합니다.
type: docs
weight: 310
url: /ko/net/aspose.pdf.ai/iopenaiclient/getvectorstorefileasync/
---
## IOpenAIClient.GetVectorStoreFileAsync 메서드
