...
description: "IOpenAIClient 메서드. 어시스턴트 목록을 비동기적으로 검색합니다"
type: docs
weight: 200
url: /ko/net/aspose.pdf.ai/iopenaiclient/getassistantsasync/
---
## IOpenAIClient.GetAssistantsAsync method

어시스턴트 목록을 비동기적으로 가져옵니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| queryParameters | AssistantListQueryParameters | 어시스턴트 목록을 필터링하기 위한 선택적 쿼리 매개변수. |
