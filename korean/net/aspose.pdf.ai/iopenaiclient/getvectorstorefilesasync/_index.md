...
description: "IOpenAIClient 메서드. 특정 벡터 스토어 내 파일 목록을 비동기적으로 조회합니다"
type: docs
weight: 340
url: /ko/net/aspose.pdf.ai/iopenaiclient/getvectorstorefilesasync/
---
## IOpenAIClient.GetVectorStoreFilesAsync method

특정 벡터 스토어 내 파일 목록을 비동기적으로 가져옵니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| vectorStoreId | String | 파일을 포함하는 벡터 스토어의 ID. |
| queryParameters | VectorStoreFileListQueryParameters | 파일 목록을 필터링하기 위한 선택적 쿼리 매개변수. |
| cancellationToken | Nullable`1 | 작업을 취소하기 위한 토큰입니다. |

### 반환 값

비동기 작업을 나타내는 Task입니다. 작업 결과에는 벡터 스토어 내 파일 목록이 포함됩니다.
