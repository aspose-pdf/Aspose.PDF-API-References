...
description: IOpenAIClient 메서드. 특정 벡터 저장소가 비동기적으로 완료될 때까지 대기합니다.
type: docs
weight: 470
url: /ko/net/aspose.pdf.ai/iopenaiclient/waitforvectorstoretocompleteasync/
---
## IOpenAIClient.WaitForVectorStoreToCompleteAsync 메서드
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| vectorStoreId | 문자열 | 완료될 때까지 모니터링할 벡터 저장소의 ID입니다. |
