...
description: "PDF 파일을 향상된 인식 모드로 DocX로 변환하기."
type: docs
url: /ko/javascript-cpp/convert/asposepdftodocxenhanced/
---

_PDF 파일을 향상된 인식 모드(완전 편집 가능한 표 및 단락)를 사용하여 DocX로 변환합니다._
