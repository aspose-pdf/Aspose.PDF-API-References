...
description: "클래스는 aps 로드 옵션을 설명합니다."
type: docs
weight: 10
url: /ko/python-net/aspose.pdf/apsloadoptions/
---
...
ApsLoadOptions 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| ApsLoadOptions() | ApsLoadOptions 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
