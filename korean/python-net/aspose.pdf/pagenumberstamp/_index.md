...
description: "페이지 번호 스탬프를 나타내며 페이지 번호 매기에 사용됩니다."
type: docs
weight: 1140
url: /ko/python-net/aspose.pdf/pagenumberstamp/
---
...
The PageNumberStamp 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PageNumberStamp(format) | PageNumberStamp 클래스의 새 인스턴스를 초기화합니다 |
| PageNumberStamp() | 새 인스턴스를 초기화합니다 [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/) 클래스의. 포맷은 "#" 로 설정됩니다. |
| PageNumberStamp(formatted_text) | PageNumberStamp 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| format | 페이지 번호를 스탬프하기 위한 문자열 값입니다. <br/>            값에는 문자 '#'가 포함되어야 하며, 스탬프 과정에서 페이지 번호로 대체됩니다. |
| starting_number | 시작 페이지 번호의 값을 가져오거나 설정합니다. 다른 페이지는 이 값부터 번호가 매겨집니다. |
| numbering_style | 이 스탬프에서 사용되는 번호 매기기 스타일입니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| put(page) | 페이지 번호를 추가합니다. |
