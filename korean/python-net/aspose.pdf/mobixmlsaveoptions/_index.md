...
description: "XML 형식으로 내보내기 위한 저장 옵션."
type: docs
weight: 960
url: /ko/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
MobiXmlSaveOptions 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| MobiXmlSaveOptions() | MobiXmlSaveOptions 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
