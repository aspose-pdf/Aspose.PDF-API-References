...
description: "TXT를 PDF로 변환하기 위한 로드 옵션."
type: docs
weight: 1580
url: /ko/python-net/aspose.pdf/txtloadoptions/
---
...
TxtLoadOptions 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| TxtLoadOptions() | TxtLoadOptions 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
