...
description: "클래스는 배경 아티팩트를 설명합니다. 이 아티팩트를 사용하면 페이지의 배경을 설정할 수 있습니다."
type: docs
weight: 50
url: /ko/python-net/aspose.pdf/backgroundartifact/
---
...
BackgroundArtifact 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| BackgroundArtifact() | BackgroundArtifact 객체를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| background_color | 배경 아티팩트의 배경 색상을 가져오거나 설정합니다 |
| background_image | 배경 아티팩트의 배경 이미지를 가져오거나 설정합니다 |
## 메서드
| 이름 | 설명 |
| :- | :- |
