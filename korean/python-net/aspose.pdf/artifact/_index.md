...
description: "클래스는 PDF Artifact 객체를 나타냅니다."
type: docs
weight: 30
url: /ko/python-net/aspose.pdf/artifact/
---
...
Artifact 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| Artifact(type, sub_type) | Artifact 클래스의 새 인스턴스를 초기화합니다. |
| Artifact(type, sub_type) | Artifact 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
