...
description: "클래스는 헤더 아티팩트를 설명합니다. 이 아티팩트를 사용하여 페이지의 헤딩을 설정할 수 있습니다."
type: docs
weight: 440
url: /ko/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

클래스는 헤더 아티팩트를 설명합니다. 이 아티팩트를 사용하여 페이지의 헤딩을 설정할 수 있습니다.

HeaderArtifact 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| HeaderArtifact() | Header Artifact 인스턴스를 생성합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
