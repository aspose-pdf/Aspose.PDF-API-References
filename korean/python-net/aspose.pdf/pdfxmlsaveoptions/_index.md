...
description: "PdfXml 형식에 대한 저장 옵션."
type: docs
weight: 1260
url: /ko/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
PdfXmlSaveOptions 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PdfXmlSaveOptions() | PdfXmlSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
