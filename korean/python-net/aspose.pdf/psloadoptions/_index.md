...
description: ".mht 파일을 PDF 문서에 로드/임포트하기 위한 옵션을 나타냅니다."
type: docs
weight: 1310
url: /ko/python-net/aspose.pdf/psloadoptions/
---

## PsLoadOptions class

.mht 파일을 PDF 문서에 로드/임포트하기 위한 옵션을 나타냅니다.

PsLoadOptions 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PsLoadOptions() | PsLoadOptions 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| fonts_folders | 폰트 폴더 경로를 가져오거나 설정합니다. |
