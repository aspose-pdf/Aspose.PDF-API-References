...
description: "푸터 아티팩트를 설명합니다. 페이지의 푸터를 설정하는 데 사용할 수 있습니다."
type: docs
weight: 400
url: /ko/python-net/aspose.pdf/footerartifact/
---

## FooterArtifact class

푸터 아티팩트를 설명합니다. 페이지의 푸터를 설정하는 데 사용할 수 있습니다.

FooterArtifact 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| FooterArtifact() | Footer Artifact 인스턴스를 생성합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
