...
description: "Xps 형식으로 내보내기 위한 저장 옵션"
type: docs
weight: 1810
url: /ko/python-net/aspose.pdf/xpssaveoptions/
---
...
XpsSaveOptions 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| XpsSaveOptions() | XpsSaveOptions 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| save_transparent_texts | 투명한 (OCR된) 텍스트를 보존할지 여부를 나타냅니다. |
