...
type: docs
weight: 1290
url: /ko/python-net/aspose.pdf/pptxsaveoptions/
---
...
PptxSaveOptions 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PptxSaveOptions() | PptxSaveOptions 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| slides_as_images | true 로 설정하면 모든 콘텐츠가 이미지(페이지당 하나)로 인식됩니다. |
| image_resolution | 이미지 해상도(dpi)를 가져오거나 설정합니다. 기본값은 192 dpi입니다. |
| separate_images | true 로 설정하면 이미지가 다른 모든 그래픽과 분리됩니다. |
| optimize_text_boxes | 텍스트 열 인식을 전환합니다 |
