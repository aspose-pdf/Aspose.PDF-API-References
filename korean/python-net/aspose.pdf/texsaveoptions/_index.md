...
description: "TeX 형식으로 내보내기 위한 저장 옵션"
type: docs
weight: 1540
url: /ko/python-net/aspose.pdf/texsaveoptions/
---
...
TeXSaveOptions 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| TeXSaveOptions() | TeXSaveOptions 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| out_directory_path | 다음에 대한 속성 |
| pages_count | 변환 후 페이지 수를 반환합니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| add_font_encs(font_encs) | 글꼴 인코딩을 글꼴 인코딩 목록에 추가합니다 |
| clear_font_encs() | 글꼴 인코딩 목록을 지웁니다 |
