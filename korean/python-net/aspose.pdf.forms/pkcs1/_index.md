...
description: "PKCS#1 표준에 관한 서명 객체를 나타냅니다.<br/>            서명에는 RSA 암호화 알고리즘과 SHA-1 다이제스트 방법이 사용됩니다."
type: docs
weight: 180
url: /ko/python-net/aspose.pdf.forms/pkcs1/
---

## PKCS1 class

PKCS#1 표준에 관한 서명 객체를 나타냅니다.<br/>            서명에는 RSA 암호화 알고리즘과 SHA-1 다이제스트 방법이 사용됩니다.

PKCS1 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PKCS1(image) | PKCS1 클래스의 새 인스턴스를 초기화합니다. |
| PKCS1() | [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/) 클래스의 새 인스턴스를 초기화합니다. |
| PKCS1(pfx, password) | PKCS1 클래스의 새 인스턴스를 초기화합니다. |
| PKCS1(pfx, password) | PKCS1 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
