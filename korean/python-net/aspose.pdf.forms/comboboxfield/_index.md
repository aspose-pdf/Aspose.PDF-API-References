...
description: "폼의 콤보박스 필드를 나타내는 클래스."
type: docs
weight: 50
url: /ko/python-net/aspose.pdf.forms/comboboxfield/
---

## ComboBoxField class

폼의 콤보박스 필드를 나타내는 클래스.

ComboBoxField 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| ComboBoxField() | Generator에서 사용되는 ComboBoxField의 생성자입니다. |
| ComboBoxField(doc) | ComboBoxField 클래스의 새 인스턴스를 초기화합니다. |
| ComboBoxField(page, rect) | ComboBoxField 클래스의 새 인스턴스를 초기화합니다. |
| ComboBoxField(doc, rect) | ComboBoxField 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| 선택됨 | 선택된 옵션의 인덱스를 가져오거나 설정합니다. 이 속성을 사용하면 선택을 변경할 수 있습니다. |
...
| editable | 필드의 편집 가능 상태를 가져오거나 설정합니다. |
| spell_check | spellchaeck activiity 상태를 가져오거나 설정합니다. |
## Indexer
| 이름 | 설명 |
| :- | :- |
