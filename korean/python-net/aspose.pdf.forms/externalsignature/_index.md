...
description: "X509Certificate2를 사용하여 분리된 PKCS#7Detached 서명을 생성합니다. 내보낼 수 없는 개인 키를 가진 토큰 및 USB 스마트 카드를 지원합니다."
type: docs
weight: 80
url: /ko/python-net/aspose.pdf.forms/externalsignature/
---

## ExternalSignature class

X509Certificate2를 사용하여 분리된 PKCS#7Detached 서명을 생성합니다. 내보낼 수 없는 개인 키를 가진 토큰 및 USB 스마트 카드를 지원합니다.

ExternalSignature 유형은 다음 멤버를 노출합니다:
## 속성
| 이름 | 설명 |
| :- | :- |
