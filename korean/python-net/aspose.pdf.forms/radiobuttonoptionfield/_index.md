...
description: "RadioButton 필드 항목을 나타내는 클래스입니다."
type: docs
weight: 230
url: /ko/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---

## RadioButtonOptionField class

RadioButton 필드 항목을 나타내는 클래스입니다.

RadioButtonOptionField 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| RadioButtonOptionField() | 새 RadioButtonOptionField 인스턴스를 생성합니다. |
| RadioButtonOptionField(page, rect) | RadioButtonOptionField 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| option_name | 옵션의 이름을 가져오거나 설정합니다. |
| caption | 캡션을 가져오거나 설정합니다. |
