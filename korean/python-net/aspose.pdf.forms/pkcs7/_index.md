...
description: "인터넷 RFC 2315의 PKCS#7 사양을 준수하는 PKCS#7 객체를 나타냅니다, <br/>            PKCS #7: 암호화 메시지 구문, 버전 1.5.<br/>            문서 바이트 범위의 SHA1 다이제스트가 PKCS#7 SignedData 필드에 캡슐화됩니다."
type: docs
weight: 190
url: /ko/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

인터넷 RFC 2315의 PKCS#7 사양을 준수하는 PKCS#7 객체를 나타냅니다, <br/>            PKCS #7: 암호화 메시지 구문, 버전 1.5.<br/>            문서 바이트 범위의 SHA1 다이제스트가 PKCS#7 SignedData 필드에 캡슐화됩니다.

PKCS7 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PKCS7() | 새 인스턴스를 초기화합니다 [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) 클래스. |
| PKCS7(pfx, password) | PKCS7 클래스의 새 인스턴스를 초기화합니다 |
| PKCS7(pfx, password) | PKCS7 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
