...
description: "지정된 유효 문자와 함께 텍스트 필드"
type: docs
weight: 150
url: /ko/python-net/aspose.pdf.forms/numberfield/
---

## NumberField class

지정된 유효 문자와 함께 텍스트 필드

NumberField 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| NumberField() | 새 인스턴스를 초기화합니다 [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/) 클래스. |
| NumberField(page, rect) | 새 인스턴스를 초기화합니다 NumberField 클래스 |
| NumberField(doc, rect) | 새 인스턴스를 초기화합니다 NumberField 클래스 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| allowed_chars | 허용된 문자를 가져오거나 설정합니다. |
## Indexer
| 이름 | 설명 |
| :- | :- |
