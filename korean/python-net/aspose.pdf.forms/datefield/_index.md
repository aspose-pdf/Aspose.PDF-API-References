...
description: "캘린더 보기가 있는 날짜 필드."
type: docs
weight: 60
url: /ko/python-net/aspose.pdf.forms/datefield/
---
...
DateField 형식은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| DateField() | 새 인스턴스를 초기화합니다 [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | DateField 클래스의 새 인스턴스를 초기화합니다 |
| DateField(page, rect) | DateField 클래스의 새 인스턴스를 초기화합니다 |
| DateField(doc, rect) | DateField 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| date_format | 날짜 형식을 가져오거나 설정합니다. |
## Indexer
| 이름 | 설명 |
| :- | :- |
...
| 이름 | 설명 |
| :- | :- |
| add_image(image) | 이 필드에 대한 이미지 추가가 거부되었습니다. |
| add_image(image) | 이 필드에 대한 이미지 추가가 거부되었습니다. |
| clone() | 없음 |
