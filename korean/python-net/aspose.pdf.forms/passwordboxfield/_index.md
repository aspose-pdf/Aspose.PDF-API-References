...
description: "비밀번호 입력을 위한 텍스트 필드를 설명하는 클래스입니다."
type: docs
weight: 210
url: /ko/python-net/aspose.pdf.forms/passwordboxfield/
---

## PasswordBoxField class

비밀번호 입력을 위한 텍스트 필드를 설명하는 클래스입니다.

PasswordBoxField 유형은 다음 멤버를 노출합니다:
## 속성
| 이름 | 설명 |
| :- | :- |
