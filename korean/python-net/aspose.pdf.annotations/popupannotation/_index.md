...
description: "입력 및 편집을 위해 팝업 창에 텍스트를 표시하는 팝업 주석을 나타냅니다."
type: docs
weight: 670
url: /ko/python-net/aspose.pdf.annotations/popupannotation/
---
...
PopupAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PopupAnnotation(document) | PopupAnnotation 클래스의 새 인스턴스를 초기화합니다. |
| PopupAnnotation(page, rect) | PopupAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| open | 팝업 주석이 처음에 열려 있게 표시될지 여부를 지정하는 플래그를 가져오거나 설정합니다. |
| parent | 이 팝업 주석과 연결될 상위 주석을 가져오거나 설정합니다.<br/>            이 항목이 존재하는 경우, 상위 주석의 Contents, M, C 및 T 항목이 팝업 주석 자체의 해당 항목을 대체합니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
