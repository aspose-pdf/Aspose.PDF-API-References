...
description: "고무 스탬프 주석을 나타냅니다. <br/>             이 유형의 주석은 페이지에 고무 스탬프로 찍힌 것처럼 보이는 텍스트 또는 그래픽을 표시합니다."
type: docs
weight: 790
url: /ko/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

고무 스탬프 주석을 나타냅니다. <br/>             이 유형의 주석은 페이지에 고무 스탬프로 찍힌 것처럼 보이는 텍스트 또는 그래픽을 표시합니다.

StampAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| StampAnnotation(document) | StampAnnotation 클래스의 새 인스턴스를 초기화합니다. |
| StampAnnotation(page, rect) | StampAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| icon | 고무 도장의 아이콘을 가져오거나 설정합니다. |
| image | 주석의 이미지를 가져오거나 설정합니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| clone() | 없음 |
| get_rectangle(consider_rotation) | 페이지 회전을 고려하여 주석의 사각형을 반환합니다. |
| accept(visitor) | 주석 컬렉션을 탐색할 때 [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) 방문자를 허용합니다. |
