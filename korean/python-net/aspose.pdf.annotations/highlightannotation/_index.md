...
description: "문서에서 텍스트 범위를 강조하는 하이라이트 주석을 나타냅니다."
type: docs
weight: 310
url: /ko/python-net/aspose.pdf.annotations/highlightannotation/
---

## HighlightAnnotation class

문서에서 텍스트 범위를 강조하는 하이라이트 주석을 나타냅니다.

HighlightAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| HighlightAnnotation(page, rect) | HighlightAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
