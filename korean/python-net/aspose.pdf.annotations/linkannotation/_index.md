...
description: "문서 내 다른 위치의 목적지로 연결되는 하이퍼텍스트 링크이거나 수행될 액션을 나타냅니다."
type: docs
weight: 390
url: /ko/python-net/aspose.pdf.annotations/linkannotation/
---

## LinkAnnotation class

문서 내 다른 위치의 목적지로 연결되는 하이퍼텍스트 링크이거나 수행될 액션을 나타냅니다.

LinkAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| LinkAnnotation(page, rect) | LinkAnnotation 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| action | 링크 주석이 활성화될 때 수행되는 작업입니다. |
| destination | 주석이 활성화될 때 표시되는 대상입니다. |
| highlighting | 활성 영역 내에서 마우스 버튼을 누르거나 누른 상태를 유지할 때 사용할 시각 효과입니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
