...
description: "Caret 주석을 나타내는 클래스입니다."
type: docs
weight: 80
url: /ko/python-net/aspose.pdf.annotations/caretannotation/
---

## CaretAnnotation class

Caret 주석을 나타내는 클래스입니다.

CaretAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| CaretAnnotation(document) | CaretAnnotation 클래스의 새 인스턴스를 초기화합니다. |
| CaretAnnotation(page, rect) | CaretAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| frame | 캐럿 사각형을 가져오거나 설정합니다. |
| symbol | 캐럿과 연관된 심볼을 가져오거나 설정합니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| clone() | 없음 |
