...
description: "Watermark 주석 객체를 설명하는 클래스입니다."
type: docs
weight: 860
url: /ko/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Watermark 주석 객체를 설명하는 클래스입니다.

WatermarkAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| WatermarkAnnotation(page, rect) | WatermarkAnnotation 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
