...
description: "사각형 주석을 나타내는 클래스입니다."
type: docs
weight: 770
url: /ko/python-net/aspose.pdf.annotations/squareannotation/
---
...
SquareAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| SquareAnnotation(document) | SquareAnnotation 클래스의 새 인스턴스를 초기화합니다 |
| SquareAnnotation(page, rect) | SquareAnnotation 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| interior_color | 주석의 사각형 또는 타원을 채우는 내부 색상입니다. |
| frame | 두 사각형 사이의 수치 차이를 설명하는 사각형:<br/>            주석의 Rect 항목과 기본 사각형 또는 원의 실제 경계. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| clone() | 없음 |
| get_rectangle(consider_rotation) | 없음 |
| accept(visitor) | 주석을 처리하기 위해 방문자를 수락합니다. |
| flatten() | 없음 |
