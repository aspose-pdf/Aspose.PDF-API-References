...
description: "문서 텍스트에 취소선으로 표시되는 strikeout 주석을 나타냅니다."
type: docs
weight: 800
url: /ko/python-net/aspose.pdf.annotations/strikeoutannotation/
---

## StrikeOutAnnotation class

문서 텍스트에 취소선으로 표시되는 strikeout 주석을 나타냅니다.

StrikeOutAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| StrikeOutAnnotation(page, rect) | StrikeOutAnnotation 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
