...
description: "텍스트 마크업 주석을 위한 추상 기본 클래스입니다."
type: docs
weight: 830
url: /ko/python-net/aspose.pdf.annotations/textmarkupannotation/
---

## TextMarkupAnnotation class

텍스트 마크업 주석을 위한 추상 기본 클래스입니다.

TextMarkupAnnotation 유형은 다음 멤버를 노출합니다:
## 속성
| 이름 | 설명 |
| :- | :- |
