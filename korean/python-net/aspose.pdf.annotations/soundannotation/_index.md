...
description: "컴퓨터 마이크에서 녹음하거나 파일에서 가져온 사운드를 포함하는 사운드 주석을 나타냅니다."
type: docs
weight: 740
url: /ko/python-net/aspose.pdf.annotations/soundannotation/
---
...
SoundAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | SoundAnnotation 클래스의 새 인스턴스를 초기화합니다. |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | SoundAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| sound_data | 주석이 활성화될 때 재생될 사운드를 정의하는 사운드 객체를 가져옵니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| clone() | 없음 |
