...
description: "문서 텍스트에 밑줄로 표시되는 underline 주석을 나타냅니다."
type: docs
weight: 850
url: /ko/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

문서 텍스트에 밑줄로 표시되는 underline 주석을 나타냅니다.

UnderlineAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| UnderlineAnnotation(page, rect) | UnderlineAnnotation 클래스의 새 인스턴스를 초기화합니다 |
## 속성
| 이름 | 설명 |
| :- | :- |
