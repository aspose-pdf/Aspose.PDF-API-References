...
description: "PDF 문서의 특정 지점에 부착된 “스티키 노트” 텍스트 주석을 나타냅니다."
type: docs
weight: 820
url: /ko/python-net/aspose.pdf.annotations/textannotation/
---

## TextAnnotation class

PDF 문서의 특정 지점에 부착된 “스티키 노트” 텍스트 주석을 나타냅니다.

TextAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| TextAnnotation(document) | TextAnnotation 클래스의 새 인스턴스를 초기화합니다. |
| TextAnnotation(page, rect) | TextAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
...
| open | 주석이 처음에 열려 있는 상태로 표시될지 여부를 지정하는 플래그를 가져오거나 설정합니다. |
| icon | 주석을 표시할 때 사용할 아이콘을 가져오거나 설정합니다. |
| state | 원본 주석이 설정되어야 할 상태를 가져오거나 설정합니다. |
## 메서드
| 이름 | 설명 |
| :- | :- |
| clone() | 없음 |
