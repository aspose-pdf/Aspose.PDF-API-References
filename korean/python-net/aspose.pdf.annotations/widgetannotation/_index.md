...
description: "위젯 주석을 나타내는 클래스입니다."
type: docs
weight: 870
url: /ko/python-net/aspose.pdf.annotations/widgetannotation/
---
...
WidgetAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| WidgetAnnotation(doc) | WidgetAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
