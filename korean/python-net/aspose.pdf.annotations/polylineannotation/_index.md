...
description: "다각형과 유사하지만 첫 번째와 마지막 정점이 암시적으로 연결되지 않은 폴리라인 주석을 나타냅니다."
type: docs
weight: 660
url: /ko/python-net/aspose.pdf.annotations/polylineannotation/
---

## PolylineAnnotation class

다각형과 유사하지만 첫 번째와 마지막 정점이 암시적으로 연결되지 않은 폴리라인 주석을 나타냅니다.

PolylineAnnotation 유형은 다음 멤버를 노출합니다:
## 생성자
| 이름 | 설명 |
| :- | :- |
| PolylineAnnotation(page, rect, vertices) | PolylineAnnotation 클래스의 새 인스턴스를 초기화합니다. |
## 속성
| 이름 | 설명 |
| :- | :- |
