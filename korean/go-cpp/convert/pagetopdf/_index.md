...
description: "지정된 페이지를 Pdf로 변환하고 저장합니다."
type: docs
url: /ko/go-cpp/convert/pagetopdf/
---

_지정된 페이지를 Pdf로 변환하고 저장합니다._
...
func main() {
	...
	defer pdf.Close()
	// PageToPdf(num int32, filename string) 지정된 페이지를 Pdf 파일로 저장합니다
