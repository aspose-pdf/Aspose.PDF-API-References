...
description: "이전에 열었던 PDF-document를 Txt-document로 변환하고 저장합니다."
type: docs
url: /ko/go-cpp/convert/savetxt/
---

_이전에 열려 있던 PDF 문서를 Txt 문서로 변환하고 저장합니다._
...
func main() {
	...
	defer pdf.Close()
	// SaveTxt(filename string) 이전에 열려 있던 PDF 문서를 Txt 문서로 파일 이름과 함께 저장합니다
