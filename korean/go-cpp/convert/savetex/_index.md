...
description: "이전에 열었던 PDF-document를 TeX-document로 변환하고 저장합니다."
type: docs
url: /ko/go-cpp/convert/savetex/
---

_이전에 열려 있던 PDF-문서를 TeX-문서로 변환하고 저장합니다._
...
func main() {
	...
	defer pdf.Close()
	// SaveTeX(filename string) 이전에 열려 있던 PDF-문서를 TeX-문서로 파일 이름을 지정하여 저장합니다
