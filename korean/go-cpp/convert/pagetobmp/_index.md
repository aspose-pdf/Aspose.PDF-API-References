...
description: "지정된 페이지를 Bmp-image로 변환하고 저장합니다."
type: docs
url: /ko/go-cpp/convert/pagetobmp/
---

_지정된 페이지를 Bmp-image로 변환하고 저장합니다._
...
func main() {
	...
	defer pdf.Close()
	// PageToBmp(num int32, resolution_dpi int32, filename string) 지정된 페이지를 Bmp-image 파일로 저장합니다
