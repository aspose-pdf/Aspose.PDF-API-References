...
description: "PDF-document의 푸터에 텍스트를 추가합니다."
type: docs
url: /ko/go-cpp/organize/addtextfooter/
---

_PDF-document의 Footer에 텍스트를 추가합니다._
...
func main() {
	...
	defer pdf.Close()
	// AddTextFooter(footer string)는 PDF-document의 Footer에 텍스트를 추가합니다
