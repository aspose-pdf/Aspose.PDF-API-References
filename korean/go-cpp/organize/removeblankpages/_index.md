...
description: "PDF-document에서 빈 페이지를 제거합니다."
type: docs
url: /ko/go-cpp/organize/removeblankpages/
---

_PDF-document에서 빈 페이지를 제거합니다._
...
func main() {
	...
	defer pdf.Close()
	// RemoveBlankPages()는 PDF-document에서 빈 페이지를 제거합니다
