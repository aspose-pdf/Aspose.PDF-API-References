...
description: "페이지에서 텍스트 바닥글을 제거합니다."
type: docs
url: /ko/go-cpp/organize/pageremovetextfooters/
---

_페이지에서 텍스트 푸터를 제거합니다._
...
func main() {
        ...
        defer pdf.Close()
        // PageRemoveTextFooters(num int32)는 페이지에서 텍스트 푸터를 제거합니다
