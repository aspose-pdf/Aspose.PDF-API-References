...
description: "PDF-document에서 PDF/UA 준수를 제거합니다."
type: docs
url: /ko/go-cpp/organize/removepdfuacompliance/
---

_PDF 문서에서 PDF/UA 규정 준수를 제거합니다._
...
func main() {
	...
	defer pdf.Close()
	// RemovePdfUaCompliance()는 PDF 문서에서 PDF/UA 규정 준수를 제거합니다
