...
description: "PDF-document에서 워터마크를 제거합니다."
type: docs
url: /ko/go-cpp/organize/removewatermarks/
---

_PDF-document에서 워터마크를 제거합니다._
...
func main() {
        ...
        defer pdf.Close()
        // RemoveWatermarks() 은 PDF-document에서 워터마크를 제거합니다
