...
description: "PDF-document가 PDF 형식에 부합하는지 검증합니다."
type: docs
url: /ko/go-cpp/organize/validate/
---

_PDF-document가 PDF 형식 준수를 만족하는지 검증합니다._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat)는 PDF-document가 PDF/A 준수를 만족하는지 검증합니다
