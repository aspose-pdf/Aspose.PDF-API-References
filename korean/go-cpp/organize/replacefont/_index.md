...
description: "PDF-document의 글꼴을 교체합니다."
type: docs
url: /ko/go-cpp/organize/replacefont/
---

_PDF 문서의 폰트를 교체합니다._
...
func main() {
        ...
        defer pdf.Close()
        // ReplaceFont(findFontName, replaceFontName string) PDF 문서의 폰트를 교체합니다
