...
description: "소스 PDF 문서에서 페이지를 추출하여 여러 새 PDF 문서를 생성합니다."
type: docs
url: /ko/go-cpp/core/splitdocument/
---

_원본 PDF-document에서 페이지를 추출하여 여러 개의 새 PDF-documents를 생성합니다._
...
func main() {
	...
	// SplitDocument(document *Document, pagerange string) 은 여러 개의 새 PDF-documents를 생성합니다
