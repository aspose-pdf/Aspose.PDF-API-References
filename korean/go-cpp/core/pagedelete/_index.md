...
description: "PDF-document에서 지정된 페이지를 삭제합니다."
type: docs
url: /ko/go-cpp/core/pagedelete/
---

_PDF-document에서 지정된 페이지를 삭제합니다._
...
func main() {
	...
	defer pdf.Close()
	// PageDelete(num int32)는 PDF-document에서 지정된 페이지를 삭제합니다
