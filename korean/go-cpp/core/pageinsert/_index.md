...
description: "PDF-document에서 지정된 위치에 새 페이지를 삽입합니다."
type: docs
url: /ko/go-cpp/core/pageinsert/
---

_PDF-document에서 지정된 위치에 새 페이지를 삽입합니다._
...
func main() {
	...
	defer pdf.Close()
	// PageInsert(num int32) 은 PDF-document에서 지정된 위치에 새 페이지를 삽입합니다
