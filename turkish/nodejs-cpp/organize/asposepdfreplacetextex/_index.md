...
description: "PDF-file içinde hizalama kontrolüyle birden fazla metin parçacığını değiştir."
type: docs
url: /tr/nodejs-cpp/organize/asposepdfreplacetextex/
---
...
Yön, `replaceText` ön ekini ekleyerek de açıkça zorlanabilir.
