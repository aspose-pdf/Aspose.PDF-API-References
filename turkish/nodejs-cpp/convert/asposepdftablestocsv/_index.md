...
description: "PDF dosyasını CSV'ye dönüştür (tabloları çıkar)."
type: docs
url: /tr/nodejs-cpp/convert/asposepdftablestocsv/
---

_PDF dosyasını CSV formatına dönüştür (tabloları çıkar)._
