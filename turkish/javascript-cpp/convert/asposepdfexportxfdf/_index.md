...
description: "AcroForm içeren bir PDF dosyasından XFDF'ye dışa aktar"
type: docs
url: /tr/javascript-cpp/convert/asposepdfexportxfdf/
---

_AcroForm içeren bir PDF dosyasından XFDF'ye dışa aktar._
