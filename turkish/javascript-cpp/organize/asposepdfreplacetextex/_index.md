...
second_title: "Aspose.PDF JavaScript için C++ aracılığıyla"
description: "PDF dosyasında birden fazla metin parçacığını hizalama kontrolüyle değiştirin."
type: docs
url: /tr/javascript-cpp/organize/asposepdfreplacetextex/
---

_PDF dosyasındaki birden fazla metin parçacığını hizalama kontrolüyle değiştir._
...
Yön, `replaceText` ön ekini ekleyerek açıkça zorlanabilir.
özel Unicode karakterleriyle:
`\u200F` (RTL) veya `\u200E` (LTR), tercihen ilk karakter olarak
