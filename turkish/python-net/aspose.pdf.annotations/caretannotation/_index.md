...
description: "İmleç ek açıklamasını temsil eden sınıf."
type: docs
weight: 80
url: /tr/python-net/aspose.pdf.annotations/caretannotation/
---

## CaretAnnotation class

İmleç ek açıklamasını temsil eden sınıf.

CaretAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| CaretAnnotation(document) | CaretAnnotation sınıfının yeni bir örneğini başlatır |
| CaretAnnotation(page, rect) | CaretAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| çerçeve | İmleç dikdörtgenini alır veya ayarlar. |
| symbol | İmleç ile ilişkili sembolü alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
