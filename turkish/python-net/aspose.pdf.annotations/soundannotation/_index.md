...
description: "Bilgisayarın mikrofonundan kaydedilen veya bir dosyadan içe aktarılan sesi içeren ses ek açıklamasını temsil eder."
type: docs
weight: 740
url: /tr/python-net/aspose.pdf.annotations/soundannotation/
---

## SoundAnnotation class

Bilgisayarın mikrofonundan kaydedilen veya bir dosyadan içe aktarılan sesi içeren ses ek açıklamasını temsil eder.

SoundAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | SoundAnnotation sınıfının yeni bir örneğini başlatır |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | SoundAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| icon | Açıklamayı görüntülerken kullanılacak bir simgeyi alır veya ayarlar. |
| sound_data | Ek açıklama etkinleştirildiğinde çalınacak sesi tanımlayan bir ses nesnesini alır. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
