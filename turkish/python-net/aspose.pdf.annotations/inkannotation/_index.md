...
description: "Serbest el (freehand) \\\"karalama\\\"yı temsil eder."
type: docs
weight: 350
url: /tr/python-net/aspose.pdf.annotations/inkannotation/
---

## InkAnnotation class

Serbest el (freehand) \"karalama\"yı temsil eder.

InkAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| InkAnnotation(document, ink_list) | InkAnnotation sınıfının yeni bir örneğini başlatır |
| InkAnnotation(page, rect, ink_list) | InkAnnotation sınıfının yeni bir örneğini başlatır |
| InkAnnotation(page, rect, ink_list) | InkAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| cap_style | Mürekkep ek açıklama çizgi uçlarının stili. |
| ink_list | Bağımsız çizgiler olan ve Point[] dizileriyle temsil edilen jest listesini alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
...
| change_after_resize(transform) | InkList içindeki noktaları, matris dönüşümüne göre günceller. |
