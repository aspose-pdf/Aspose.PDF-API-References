...
description: "PDF belgesindeki bir noktaya eklenmiş “yapışkan not” olan metin ek açıklamasını temsil eder."
type: docs
weight: 820
url: /tr/python-net/aspose.pdf.annotations/textannotation/
---

## TextAnnotation class

PDF belgesindeki bir noktaya eklenmiş “yapışkan not” olan metin ek açıklamasını temsil eder.

TextAnnotation türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| TextAnnotation(document) | TextAnnotation sınıfının yeni bir örneğini başlatır |
| TextAnnotation(page, rect) | TextAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| aç | Açıklamanın başlangıçta açık olarak görüntülenip görüntülenmeyeceğini belirten bir bayrağı alır veya ayarlar. |
| icon | Açıklamayı görüntülerken kullanılacak bir simgeyi alır veya ayarlar. |
| state | Orijinal açıklamanın ayarlanacağı durumu alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
