...
description: "Belgenin metninde kırıklı bir alt çizgi olarak görünen dalgalı ek açıklamasını temsil eder."
type: docs
weight: 780
url: /tr/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

Belgenin metninde kırıklı bir alt çizgi olarak görünen dalgalı ek açıklamasını temsil eder.

SquigglyAnnotation türü aşağıdaki üyeleri ortaya çıkarır:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| SquigglyAnnotation(page, rect) | SquigglyAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| quad_points | n adet dörtgenin koordinatlarını belirten nokta dizisini alır veya ayarlar. Her dörtgen, ek açıklamanın altındaki metinde bir kelimeyi veya ardışık kelimeler grubunu kapsar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
...
| flatten() | Yok |
| change_after_resize(transform) | QuadPoints'i matris dönüşümüne göre günceller. |
| get_marked_text() | İşaretleme ek açıklamasının altındaki metni dize olarak alır. |
| get_marked_text_fragments() | İşaretleme ek açıklamasının altındaki metni [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/) olarak alır. |
