...
description: "Sınıf, dosya ekleme açıklamasını tanımlar."
type: docs
weight: 170
url: /tr/python-net/aspose.pdf.annotations/fileattachmentannotation/
---

## FileAttachmentAnnotation class

Sınıf, dosya ekleme açıklamasını tanımlar.

FileAttachmentAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | FileAttachmentAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| opaklık | Simge şeffaflığını 0 ile 1 arasında alır veya ayarlar: 0 - tamamen şeffaf, 1 - tamamen opak. |
...
| file | Bu ek açıklamayla ilişkili dosyanın belirtimi. |
| icon | Ek açıklamayı görüntülerken kullanılacak simgeyi alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
