...
description: "Belgenin metninde altı çizili olarak görünen alt çizgi ek açıklamasını temsil eder."
type: docs
weight: 850
url: /tr/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

Belgenin metninde altı çizili olarak görünen alt çizgi ek açıklamasını temsil eder.

UnderlineAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| UnderlineAnnotation(page, rect) | UnderlineAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
