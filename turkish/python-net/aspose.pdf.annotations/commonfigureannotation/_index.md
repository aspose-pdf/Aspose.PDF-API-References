...
description: "Ortak şekil ek açıklamasını temsil eden soyut sınıf."
type: docs
weight: 110
url: /tr/python-net/aspose.pdf.annotations/commonfigureannotation/
---

## CommonFigureAnnotation class

Ortak şekil ek açıklamasını temsil eden soyut sınıf.

CommonFigureAnnotation türü aşağıdaki üyeleri sunar:
## Özellikler
| Ad | Açıklama |
| :- | :- |
