...
description: "Belgenin metninde üstü çizili olarak görünen strikeout ek açıklamasını temsil eder."
type: docs
weight: 800
url: /tr/python-net/aspose.pdf.annotations/strikeoutannotation/
---

## StrikeOutAnnotation class

Belgenin metninde üstü çizili olarak görünen strikeout ek açıklamasını temsil eder.

StrikeOutAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| StrikeOutAnnotation(page, rect) | StrikeOutAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
