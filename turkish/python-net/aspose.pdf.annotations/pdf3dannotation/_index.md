...
description: "PDF3DAnnotation sınıfı. Bu sınıf miras alınamaz."
type: docs
weight: 510
url: /tr/python-net/aspose.pdf.annotations/pdf3dannotation/
---
...
PDF3DAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PDF3DAnnotation(page, rect, pdf_3d_artwork) | PDF3DAnnotation sınıfının yeni bir örneğini başlatır |
| PDF3DAnnotation(page, rect, pdf_3d_artwork, activation) | PDF3DAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| pdf_3d_artwork | 3D Artwork'ı alır. |
| lighting_scheme | Aydınlatma şemasını alır. |
| içerik | İçeriği alır veya ayarlar. |
| render_mode | Render modunu alır. |
| view_array | Görünüm dizisini alır. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| set_image_preview(filename) | Görüntü önizlemesini ayarlar. |
| set_image_preview(image) | Görüntü önizlemesini ayarlar. |
...
| set_default_view_index(index) | Varsayılan görünümün indeksini ayarlar. |
| clear_image_preview() | Görüntü önizlemesini temizler. |
| get_image_preview() | Görüntü önizlemesini alır. |
