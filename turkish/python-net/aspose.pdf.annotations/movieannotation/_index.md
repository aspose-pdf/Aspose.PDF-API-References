...
description: "Bilgisayar ekranında ve hoparlörler aracılığıyla sunulacak animasyonlu grafikler ve ses içeren bir film açıklamasını temsil eder. Açıklama etkinleştirildiğinde film oynatılır."
type: docs
weight: 480
url: /tr/python-net/aspose.pdf.annotations/movieannotation/
---

## MovieAnnotation class

Bilgisayar ekranında ve hoparlörler aracılığıyla sunulacak animasyonlu grafikler ve ses içeren bir film açıklamasını temsil eder. Açıklama etkinleştirildiğinde film oynatılır.

MovieAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| MovieAnnotation(document, movie_file) | MovieAnnotation sınıfının yeni bir örneğini başlatır |
| MovieAnnotation(page, rect, movie_file) | MovieAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| title | Film ek açıklamasının başlığını alır veya ayarlar. |
| file | Kendini tanımlayan bir film dosyasını tanımlayan dosya spesifikasyonunu alır veya ayarlar. |
| poster | Filmi temsil eden bir poster görüntüsünün nasıl ve ne zaman gösterileceğini belirten bir bayrak veya akışı alır veya ayarlar. True ise, poster görüntüsü film dosyasından alınır; false ise, hiçbir poster gösterilmez. |
| aspect | Filmin sınırlayıcı kutusunun genişliğini ve yüksekliğini piksel cinsinden alır veya ayarlar. |
| döndür | Filmin sayfaya göre saat yönünde döndürüleceği derece sayısını alır veya ayarlar. Değer 90’ın katı olmalıdır. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
