...
description: "Medya kliplerinin oynatılabileceği sayfanın bir bölgesini belirten ekran ek açıklaması."
type: docs
weight: 720
url: /tr/python-net/aspose.pdf.annotations/screenannotation/
---

## ScreenAnnotation class

Medya kliplerinin oynatılabileceği sayfanın bir bölgesini belirten ekran ek açıklaması.

ScreenAnnotation türü aşağıdaki üyeleri ortaya çıkar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | ScreenAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| title | Ekran açıklamasının başlığını alır veya ayarlar. |
| action | Açıklama etkinleştirildiğinde gerçekleştirilecek bir eylemi alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
