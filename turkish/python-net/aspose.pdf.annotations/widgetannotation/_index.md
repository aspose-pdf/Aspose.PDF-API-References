...
description: "Widget ek açıklamasını temsil eden sınıf."
type: docs
weight: 870
url: /tr/python-net/aspose.pdf.annotations/widgetannotation/
---

## WidgetAnnotation class

Widget ek açıklamasını temsil eden sınıf.

WidgetAnnotation türü aşağıdaki üyeleri ortaya çıkar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| WidgetAnnotation(doc) | WidgetAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
