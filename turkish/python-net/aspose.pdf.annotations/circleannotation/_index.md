...
type: docs
weight: 100
url: /tr/python-net/aspose.pdf.annotations/circleannotation/
---
...
CircleAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| CircleAnnotation(document) | CircleAnnotation sınıfının yeni bir örneğini başlatır |
| CircleAnnotation(page, rect) | CircleAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| interior_color | Ek açıklamanın dikdörtgenini veya elipsini doldurmak için kullanılan iç renk. |
| çerçeve | İki dikdörtgen arasındaki sayısal farkları tanımlayan dikdörtgen:<br/>            ek açıklamanın Rect girdisi ve alttaki kare veya dairenin gerçek sınırları. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| clone() | Yok |
