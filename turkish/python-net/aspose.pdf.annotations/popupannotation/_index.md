...
description: "Giriş ve düzenleme için metni bir açılır pencerede gösteren pop-up ek açıklamasını temsil eder."
type: docs
weight: 670
url: /tr/python-net/aspose.pdf.annotations/popupannotation/
---

## PopupAnnotation class

Giriş ve düzenleme için metni bir açılır pencerede gösteren pop-up ek açıklamasını temsil eder.

PopupAnnotation türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PopupAnnotation(document) | PopupAnnotation sınıfının yeni bir örneğini başlatır |
| PopupAnnotation(page, rect) | PopupAnnotation sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| aç | Açılır ek açıklamanın başlangıçta açık olarak gösterilip gösterilmeyeceğini belirten bir bayrağı alır veya ayarlar. |
| üst | Bu açılır ek açıklamanın ilişkilendirileceği üst ek açıklamayı alır veya ayarlar.<br/>            Bu giriş mevcutsa, üst ek açıklamanın Contents, M, C ve T girişleri, açılır ek açıklamanın kendi girişlerinin üzerine yazılır. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
