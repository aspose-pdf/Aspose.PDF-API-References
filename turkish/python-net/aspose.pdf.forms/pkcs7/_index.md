...
description: "Internet RFC 2315'teki PKCS#7 spesifikasyonuna uyan PKCS#7 nesnesini temsil eder, <br/>            PKCS #7: Kriptografik Mesaj Söz Dizimi, Versiyon 1.5.<br/>            Belgenin bayt aralığının SHA1 özeti, PKCS#7 SignedData alanına kapsüllenmiştir."
type: docs
weight: 190
url: /tr/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

Internet RFC 2315'teki PKCS#7 spesifikasyonuna uyan PKCS#7 nesnesini temsil eder, <br/>            PKCS #7: Kriptografik Mesaj Söz Dizimi, Versiyon 1.5.<br/>            Belgenin bayt aralığının SHA1 özeti, PKCS#7 SignedData alanına kapsüllenmiştir.

PKCS7 türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PKCS7() | [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) sınıfının yeni bir örneğini başlatır. |
| PKCS7(pfx, password) | PKCS7 sınıfının yeni bir örneğini başlatır |
| PKCS7(pfx, password) | PKCS7 sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
