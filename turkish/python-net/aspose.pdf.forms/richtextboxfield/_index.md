...
description: "Zengin metin düzenleyici bileşenini tanımlar."
type: docs
weight: 240
url: /tr/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Zengin metin düzenleyici bileşenini tanımlar.

RichTextBoxField türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| RichTextBoxField(page, rect) | RichTextBoxField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| style | Zengin metin alanının varsayılan stil dizesini alır veya ayarlar. |
| rich_text_value | Zengin metin değerini alır veya ayarlar. |
| formatted_value | Biçimlendirilmiş işaretleme içeren zengin metin değerini alır veya ayarlar. |
| justify | Zengin metin kutusunun hizalamasını alır veya ayarlar. |
## Indexer
| Ad | Açıklama |
| :- | :- |
