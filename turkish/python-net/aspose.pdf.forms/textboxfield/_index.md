...
description: "Metin kutusu alanını temsil eden sınıf."
type: docs
weight: 280
url: /tr/python-net/aspose.pdf.forms/textboxfield/
---
...
TextBoxField türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| TextBoxField(doc) | TextBoxField sınıfının yeni bir örneğini başlatır |
| TextBoxField() | TextBoxField örneği oluştur. |
| TextBoxField(page, rect) | TextBoxField sınıfının yeni bir örneğini başlatır |
| TextBoxField(doc, rect) | TextBoxField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
