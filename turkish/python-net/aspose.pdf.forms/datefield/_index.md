...
description: "Takvim görünümüne sahip tarih alanı."
type: docs
weight: 60
url: /tr/python-net/aspose.pdf.forms/datefield/
---
...
DateField türü aşağıdaki üyeleri içerir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| DateField() | Yeni bir [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) örneği başlatır. |
| DateField(doc) | DateField sınıfının yeni bir örneğini başlatır. |
| DateField(page, rect) | DateField sınıfının yeni bir örneğini başlatır. |
| DateField(doc, rect) | DateField sınıfının yeni bir örneğini başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| value | Tarihi alır veya ayarlar. |
...
| date_format | Tarih formatını alır veya ayarlar. |
## Indexer
| Ad | Açıklama |
| :- | :- |
...
| Ad | Açıklama |
| :- | :- |
| add_image(image) | Bu alan için resim ekleme reddedildi. |
| add_image(image) | Bu alan için resim ekleme reddedildi. |
| clone() | Yok |
...
| init(page) | JS Action'ı başlatır. |
