...
type: docs
weight: 220
url: /tr/python-net/aspose.pdf.forms/radiobuttonfield/
---
...
RadioButtonField türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| RadioButtonField(page) | RadioButtonField sınıfının yeni bir örneğini başlatır |
| RadioButtonField(doc) | RadioButtonField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| tam_ad | Yok |
| görünüm | Yok |
| sayfa_indeksi | Bu RadioButton alanını içeren sayfanın indeksini alır. |
...
| selected | Seçili öğenin indeksini alır veya ayarlar. Öğelerin numaralandırması 1'den başlar. |
| selected_items | Seçili öğelerin dizisini alır veya ayarlar. Çoklu seçim listesi için dizi birden fazla öğe içerir. Tek seçim listesi için ise tek öğe içerir. |
| seçenekler | Radyo düğmesinin seçenek koleksiyonunu alır. |
| style | Alan kutusunun stili. |
## Indexer
| Ad | Açıklama |
| :- | :- |
...
| Ad | Açıklama |
| :- | :- |
| add_option(option_name, rect) | Belirtilen dikdörtgenle radyo düğmesi seçeneğine ekle. |
| add_option(option_name) | Belirtilen dikdörtgenle radyo düğmesi seçeneğine ekle. |
| add_option(export, name) | Belirtilen dikdörtgenle radyo düğmesi seçeneğine ekle. |
| clone() | Yok |
...
| set_position(point) | Radyo düğmesinin tüm alt öğelerini sayfadaki belirtilen konumlara taşı. |
| delete_option(option_name) | Seçeneği adıyla siler. |
| add(new_item) | RadioButton alanına yeni seçenek alanı ekler |
