...
type: docs
weight: 30
url: /tr/python-net/aspose.pdf.forms/checkboxfield/
---
...
CheckboxField türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| CheckboxField(page, rect) | CheckboxField sınıfının yeni bir örneğini başlatır |
| CheckboxField(doc, rect) | CheckboxField sınıfının yeni bir örneğini başlatır |
| CheckboxField() | CheckboxField örneği oluştur. |
| CheckboxField(doc) | CheckboxField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| value | Onay kutusu alanının değerini alır veya ayarlar. |
...
| allowed_states | İzin verilen durumların listesini döndürür. |
| style | Onay kutusunun stilini alır veya ayarlar. |
| checked | Onay kutusunun durumunu alır veya ayarlar. |
| export_value | CheckBox alanının dışa aktarım değerini alır veya ayarlar. |
## Indexer
| Ad | Açıklama |
| :- | :- |
