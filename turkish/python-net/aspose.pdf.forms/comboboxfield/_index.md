...
type: docs
weight: 50
url: /tr/python-net/aspose.pdf.forms/comboboxfield/
---
...
ComboBoxField türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| ComboBoxField() | Generator içinde kullanılacak ComboBoxField için yapıcı. |
| ComboBoxField(doc) | ComboBoxField sınıfının yeni bir örneğini başlatır |
| ComboBoxField(page, rect) | ComboBoxField sınıfının yeni bir örneğini başlatır |
| ComboBoxField(doc, rect) | ComboBoxField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| selected | Seçili seçeneğin dizinini alır veya ayarlar. Bu özellik seçimi değiştirmeye izin verir. |
...
| düzenlenebilir | Alanının düzenlenebilir durumunu alır veya ayarlar. |
| spell_check | Yazım denetimi etkinlik durumunu alır veya ayarlar. |
## Indexer
| Ad | Açıklama |
| :- | :- |
