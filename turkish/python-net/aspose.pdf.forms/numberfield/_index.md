...
type: docs
weight: 150
url: /tr/python-net/aspose.pdf.forms/numberfield/
---
...
NumberField türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| NumberField() | Yeni bir [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/) sınıfı örneği başlatır. |
| NumberField(page, rect) | NumberField sınıfının yeni bir örneğini başlatır |
| NumberField(doc, rect) | NumberField sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| allowed_chars | İzin verilen karakterleri alır veya ayarlar. |
## Indexer
| Ad | Açıklama |
| :- | :- |
