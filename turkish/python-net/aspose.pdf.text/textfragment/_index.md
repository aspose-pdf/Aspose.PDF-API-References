...
description: "PDF metninin bir fragmentini temsil eder."
type: docs
weight: 390
url: /tr/python-net/aspose.pdf.text/textfragment/
---

## TextFragment class

PDF metninin bir fragmentini temsil eder.

TextFragment türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| TextFragment() | Yeni bir [TextFragment](/pdf/python-net/aspose.pdf.text/textfragment/) nesnesi başlatır. |
| TextFragment(tab_stops) | TextFragment sınıfının yeni bir örneğini başlatır |
| TextFragment(text) | TextFragment sınıfının yeni bir örneğini başlatır |
| TextFragment(text, tab_stops) | TextFragment sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| clone_with_segments() | Tüm segmentlerle parçayı klonla. |
