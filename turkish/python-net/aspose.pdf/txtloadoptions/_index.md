...
description: "TXT'den PDF'ye dönüşüm için yükleme seçenekleri."
type: docs
weight: 1580
url: /tr/python-net/aspose.pdf/txtloadoptions/
---

## TxtLoadOptions class

TXT'den PDF'ye dönüşüm için yükleme seçenekleri.

TxtLoadOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| TxtLoadOptions() | TxtLoadOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
