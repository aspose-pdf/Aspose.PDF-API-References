...
description: "APS XML formatına dışa aktarma için kaydetme seçenekleri."
type: docs
weight: 20
url: /tr/python-net/aspose.pdf/apssaveoptions/
---
...
ApsSaveOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| ApsSaveOptions() | ApsSaveOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
