...
description: "Soyut biçimlendirilmiş parçacığı temsil eder."
type: docs
weight: 410
url: /tr/python-net/aspose.pdf/formattedfragment/
---

## FormattedFragment class

Soyut biçimlendirilmiş parçacığı temsil eder.

FormattedFragment türü aşağıdaki üyeleri sunar:
## Özellikler
| Ad | Açıklama |
| :- | :- |
