...
type: docs
weight: 1290
url: /tr/python-net/aspose.pdf/pptxsaveoptions/
---
...
PptxSaveOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PptxSaveOptions() | PptxSaveOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| slides_as_images | Doğru olarak ayarlanırsa tüm içerik görüntüler olarak tanınır (sayfa başına bir). |
| image_resolution | Görüntü çözünürlüğünü (dpi) alır veya ayarlar. Varsayılan 192 dpi'dir. |
| separate_images | Doğru olarak ayarlanırsa görüntüler diğer tüm grafiklerden ayrılır. |
| optimize_text_boxes | Metin sütunları tanıma özelliğini değiştirir. |
