...
type: docs
weight: 1810
url: /tr/python-net/aspose.pdf/xpssaveoptions/
---
...
XpsSaveOptions türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| XpsSaveOptions() | XpsSaveOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| save_transparent_texts | Şeffaf (OCR'lenmiş) metni koruyup korumayacağını gösterir. |
