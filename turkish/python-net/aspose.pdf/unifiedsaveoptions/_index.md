...
description: "Bu sınıf, <br/>            birleşik dönüşüm yöntemi (birleşik iç belge modeliyle) kullanan kaydetme seçeneklerini temsil eder."
type: docs
weight: 1590
url: /tr/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Bu sınıf, <br/>            birleşik dönüşüm yöntemi (birleşik iç belge modeliyle) kullanan kaydetme seçeneklerini temsil eder.

UnifiedSaveOptions türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| UnifiedSaveOptions() | UnifiedSaveOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
