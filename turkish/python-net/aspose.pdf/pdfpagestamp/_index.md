...
description: "Sınıf, PDF sayfasını damga olarak kullanan damgayı temsil eder."
type: docs
weight: 1230
url: /tr/python-net/aspose.pdf/pdfpagestamp/
---

## PdfPageStamp class

Sınıf, PDF sayfasını damga olarak kullanan damgayı temsil eder.

PdfPageStamp türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| PdfPageStamp(pdf_page) | PdfPageStamp sınıfının yeni bir örneğini başlatır. |
| PdfPageStamp(file_name, page_index) | PdfPageStamp sınıfının yeni bir örneğini başlatır. |
| PdfPageStamp(stream, page_index) | PdfPageStamp sınıfının yeni bir örneğini başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| pdf_page | Damga olarak kullanılacak sayfayı alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
| put(page) | Damgayı belirtilen sayfaya yerleştir. |
