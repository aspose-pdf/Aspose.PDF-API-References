...
description: "Sınıf, Heaader artefaktını tanımlar. Bu artefakt sayfanın başlığını ayarlamak için kullanılabilir."
type: docs
weight: 440
url: /tr/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

Sınıf, Heaader artefaktını tanımlar. Bu artefakt sayfanın başlığını ayarlamak için kullanılabilir.

Bu HeaderArtifact türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| HeaderArtifact() | Header Artifact örneği oluşturur. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
