...
description: "Sınıf, filigran eserini tanımlar. Bu, kullanılabilir."
type: docs
weight: 1640
url: /tr/python-net/aspose.pdf/watermarkartifact/
---

## WatermarkArtifact class

Sınıf, filigran eserini tanımlar. Bu, kullanılabilir.

WatermarkArtifact türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| WatermarkArtifact() | Watermark artifact örneği oluşturur. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
