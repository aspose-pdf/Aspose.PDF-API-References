...
type: docs
weight: 1550
url: /tr/python-net/aspose.pdf/textstamp/
---
...
TextStamp türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| TextStamp(value) | TextStamp sınıfının yeni bir örneğini başlatır |
| TextStamp(value, text_state) | TextStamp sınıfının yeni bir örneğini başlatır |
| TextStamp(formatted_text) | TextStamp sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| Ad | Açıklama |
| :- | :- |
| put(page) | Sayfaya metin damgası ekler. |
