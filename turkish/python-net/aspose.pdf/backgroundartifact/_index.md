...
description: "Sınıf, arka plan artifact'ını açıklar. Bu artifact, sayfanın arka planını ayarlamayı sağlar."
type: docs
weight: 50
url: /tr/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Sınıf, arka plan artifact'ını açıklar. Bu artifact, sayfanın arka planını ayarlamayı sağlar.

BackgroundArtifact türü aşağıdaki üyeleri sunar:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| BackgroundArtifact() | BackgroundArtifact nesnesini başlatır. |
## Özellikler
| Ad | Açıklama |
| :- | :- |
...
| background_color | Arka plan nesnesinin arka plan rengini alır veya ayarlar. |
| background_image | Arka plan nesnesinin arka plan görüntüsünü alır veya ayarlar. |
## Yöntemler
| Ad | Açıklama |
| :- | :- |
