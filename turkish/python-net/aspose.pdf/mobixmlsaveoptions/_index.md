...
description: "Xml biçimine dışa aktarma için kaydetme seçenekleri"
type: docs
weight: 960
url: /tr/python-net/aspose.pdf/mobixmlsaveoptions/
---

## MobiXmlSaveOptions class

Xml biçimine dışa aktarma için kaydetme seçenekleri

MobiXmlSaveOptions türü aşağıdaki üyeleri gösterir:
## Yapıcılar
| Ad | Açıklama |
| :- | :- |
| MobiXmlSaveOptions() | MobiXmlSaveOptions sınıfının yeni bir örneğini başlatır |
## Özellikler
| Ad | Açıklama |
| :- | :- |
