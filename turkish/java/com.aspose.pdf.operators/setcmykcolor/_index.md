...
description: "k operatörünü temsil eden sınıf (çizim dışı işlemler için CMYK rengi ayarlar)."
type: docs
weight: 530
url: /tr/java/com.aspose.pdf.operators/setcmykcolor/
---
**Inheritance:**
...
k operatörünü temsil eden sınıf (çizim dışı işlemler için CMYK rengi ayarlar).
...
| [getColor](#getColor--) | Rengi döndürür. |
