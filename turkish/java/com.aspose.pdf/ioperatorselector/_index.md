...
description: "Farklı pdf operatörlerini ziyaret etmek için Visitor'ı tanımlar."
type: docs
weight: 2520
url: /tr/java/com.aspose.pdf/ioperatorselector/
---
```
public interface IOperatorSelector
```

Farklı pdf operatörlerini ziyaret etmek için Visitor'ı tanımlar.
