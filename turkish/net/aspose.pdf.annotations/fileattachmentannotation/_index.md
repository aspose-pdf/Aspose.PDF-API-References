...
description: Sınıf dosya eki açıklamasını açıklar.
type: docs
weight: 330
...
Sınıf, dosya eki açıklamasını açıklar.
...
| İsim | Tanım |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation)(Page, Rectangle, FileSpecification) | Belirtilen sayfada yeni FileAttachment ek açıklaması oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file) { get; set; } | Bu ek açıklamayla ilişkili dosyanın belirtimi. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon) { get; set; } | Açıklamanın görüntülenmesinde kullanılacak simgeyi alır veya ayarlar. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity) { get; set; } | Simgenin opaklığını 0'dan 1: 0'a alır veya ayarlar - tamamen şeffaf, 1 - tamamen opak. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
