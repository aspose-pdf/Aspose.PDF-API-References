...
description: Metni doğrudan sayfada görüntüleyen serbest metin açıklamasını temsil eder. Sıradan bir metin ek açıklamasından farklı olarak bir serbest metin ek açıklamasının açık veya kapalı durumu yoktur bir açılır pencerede görüntülenmek yerine metin her zaman görünür durumdadır.
type: docs
weight: 430
...
| İsim | Tanım |
| --- | --- |
| [FreeTextAnnotation](freetextannotation#constructor)(Document, DefaultAppearance) | Oluşturucu, Generator ile kullanılacak. |
| [FreeTextAnnotation](freetextannotation#constructor_1)(Page, Rectangle, DefaultAppearance) | Belirtilen sayfada yeni FreeText ek açıklaması oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/freetextannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Callout](../../aspose.pdf.annotations/freetextannotation/callout) { get; set; } | Belirtme çizgisi belirten nokta dizisi. |
...
| [DefaultAppearanceObject](../../aspose.pdf.annotations/freetextannotation/defaultappearanceobject) { get; } | FreeText ek açıklamasının varsayılan görünümünü temsil eden nesne. |
| [DefaultStyle](../../aspose.pdf.annotations/freetextannotation/defaultstyle) { get; set; } | Varsayılan bir stil dizesi alır veya ayarlar. |
| [EndingStyle](../../aspose.pdf.annotations/freetextannotation/endingstyle) { get; set; } | Satır bitiş noktası için satır bitiş stilini alır veya ayarlar. |
...
| [Intent](../../aspose.pdf.annotations/freetextannotation/intent) { get; set; } | Serbest metin ek açıklamasının amacını alır veya ayarlar. |
...
| [Justification](../../aspose.pdf.annotations/freetextannotation/justification) { get; set; } | Açıklama metninin görüntülenmesinde kullanılacak dörtlü (yaslama) biçimini belirten bir kod alır veya ayarlar. |
...
| [Rotate](../../aspose.pdf.annotations/freetextannotation/rotate) { get; set; } | Detaylandırma döndürme açısı. |
| [StartingStyle](../../aspose.pdf.annotations/freetextannotation/startingstyle) { get; set; } | Satır bitiş noktası için satır bitiş stilini alır veya ayarlar. OBu özellik artık kullanılmamıştır, lütfen EndingStyle'ı kullanın. |
...
| [TextRectangle](../../aspose.pdf.annotations/freetextannotation/textrectangle) { get; set; } | Dikdörtgen, iki dikdörtgen arasındaki sayısal farkları açıklar: annotation öğesinin Rect girişi ve bu dikdörtgenin içerdiği bir dikdörtgen. İç dikdörtgen, ek açıklama metninin görüntülenmesi gereken yerdir. |
| [TextStyle](../../aspose.pdf.annotations/freetextannotation/textstyle) { get; set; } | Metnin görünüşteki stilini alır veya ayarlar. metin stili değiştirildiğinde, metin görünümü güncellenir. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/freetextannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
