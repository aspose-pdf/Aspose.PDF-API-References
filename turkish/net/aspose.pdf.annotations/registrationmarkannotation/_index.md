...
description: Aspose.Pdf.Annotations.RegistrationMarkAnnotation sınıfı. Bir Registration Mark anotasyonunu temsil eder.
type: docs
weight: 2410
url: /tr/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation sınıfı

Bir Registration Mark anotasyonunu temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Sayfa, PrinterMarkSidePosition) | Verilen sayfadaki belirtilen konumda `RegistrationMarkAnnotation` sınıfının yeni bir örneğini başlatır. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Anotasyon türünü alır. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Bir sayfadaki kayıt markasının konumunu alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Anotasyon işleme için ziyaretçiyi kabul eder. |
...
Kayıt markaları, baskı sürecinde renklerin doğru hizalanmasını sağlamak için baskı plakalarına veya ekranlara eklenen sembollerdir.
