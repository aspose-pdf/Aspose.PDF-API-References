...
description: Ortak şekil açıklamasını temsil eden soyut sınıf.
type: docs
weight: 260
...
Ortak şekil açıklamasını temsil eden soyut sınıf.
...
| İsim | Tanım |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation)(Document) | Generator'da kullanmak için yapıcı. |
