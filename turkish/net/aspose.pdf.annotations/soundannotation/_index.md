...
description: Bilgisayarın mikrofonundan kaydedilen veya bir dosyadan içe aktarılan sesi içeren bir ses açıklamasını temsil eder.
type: docs
weight: 1080
...
Bilgisayarın mikrofonundan kaydedilen veya bir dosyadan içe aktarılan sesi içeren bir ses açıklamasını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [SoundAnnotation](soundannotation#constructor)(Page, Rectangle, string) | Belirtilen sayfada yeni Ses notu oluşturur. |
| [SoundAnnotation](soundannotation#constructor_1)(Page, Rectangle, string, SoundSampleData) | Belirtilen sayfada yeni Ses notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | Açıklamanın görüntülenmesinde kullanılacak bir simge alır veya ayarlar. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | Açıklama etkinleştirildiğinde çalınacak sesi tanımlayan bir ses nesnesi alır. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
