...
description: İlk ve son tepe noktasının dolaylı olarak bağlı olmaması dışında çokgene benzer çoklu çizgi ek açıklamasını temsil eder.
type: docs
weight: 930
...
İlk ve son tepe noktasının dolaylı olarak bağlı olmaması dışında çokgene benzer çoklu çizgi ek açıklamasını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [PolylineAnnotation](polylineannotation)(Page, Rectangle, Point[]) | Belirtilen sayfada yeni Çoklu Çizgi ek açıklaması oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
