...
description: Aspose.Pdf.Annotations.PolylineAnnotation sınıfı. İlk ve son köşenin örtük olarak bağlanmadığı çokgen benzeri poligon anotasyonunu temsil eder.
type: docs
weight: 2320
url: /tr/net/aspose.pdf.annotations/polylineannotation/
---
## PolylineAnnotation sınıfı

İlk ve son köşenin örtük olarak bağlanmadığı çokgen benzeri poligon anotasyonunu temsil eder.
...
| İsim | Açıklama |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Sayfa, Dikdörtgen, Nokta[]) | Belirtilen sayfada yeni bir Polyline anotasyonu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Anotasyon türünü alır. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | İkinci çizgi sonunun stilini alır veya ayarlar. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Poligon veya poligon anotasyonunun amacını alır veya ayarlar. |
...
| [Modified](../../aspose.pdf.annotations/annotation/modified/) { get; set; } | Anotasyonun en son ne zaman değiştirildiğini alır veya ayarlar. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | İlk çizgi sonunun stilini alır veya ayarlar. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Her köşenin yatay ve dikey koordinatlarını temsil eden bir nokta dizisini alır veya ayarlar. |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Anotasyonu işlemek için ziyaretçi nesnesini kabul eder. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Noktaları, matris dönüşümüne göre Vertices içinde günceller. |
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | Anotasyon için durumu ve durum modelini temizler. Örneğin, bir anotasyon için inceleme durumunu temizler. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |
...
| [GetState](../../aspose.pdf.annotations/markupannotation/getstate/)() | Anotasyonun durumunu alır. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |
| [GetStateModel](../../aspose.pdf.annotations/markupannotation/getstatemodel/)() | Anotasyonun durum modelini alır. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |
| [SetMarkedState](../../aspose.pdf.annotations/markupannotation/setmarkedstate/)(bool) | Anotasyon için İşaretli ve İşaretsiz durumu ayarlar. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | Bir anotasyon için inceleme durumunu ayarlar. İşaretli ve İşaretsiz durumlar, İnceleme Durum Modeline ait olmadıkları için göz ardı edilir. Durum, hedef anotasyonu oluşturan kullanıcı tarafından ayarlanır. Değer, hedef anotasyonun Başlık özelliğinden alınır. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | Bir anotasyon için inceleme durumunu ayarlar. İşaretli ve İşaretsiz durumlar, İnceleme Durum Modeline ait olmadıkları için göz ardı edilir. Not: Durum, durum ve durum modeli anahtarlarına sahip diğer metin anotasyonlarında saklanır. |

### Ayrıca Bakınız

* sınıf [PolyAnnotation](../polyannotation/)
