...
description: PDF belgesindeki bir noktaya eklenen yapışkan not olan bir metin açıklamasını temsil eder.
type: docs
weight: 1200
...
PDF belgesindeki bir noktaya eklenen "yapışkan not" olan bir metin açıklamasını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | Generator'da kullanıldığında ek açıklama için yapıcı. |
| [TextAnnotation](textannotation#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni Metin ek açıklaması oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon) { get; set; } | Açıklamanın görüntülenmesinde kullanılacak bir simge alır veya ayarlar. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open) { get; set; } | Açıklamanın başlangıçta açık olarak görüntülenip görüntülenmeyeceğini belirten bir bayrak alır veya ayarlar. |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | Orijinal ek açıklamanın ayarlanması gereken durumu alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | Başlangıç ve Bitiş noktalarını matris dönüşümüne göre günceller. |
