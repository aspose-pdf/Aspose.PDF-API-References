...
description: Aspose.Pdf.Annotations.BleedMarkAnnotation sınıfı. Bir Bleed Mark anotasyonunu temsil eder
type: docs
weight: 1500
url: /tr/net/aspose.pdf.annotations/bleedmarkannotation/
---
## BleedMarkAnnotation sınıfı

Bir Bleed Mark anotasyonunu temsil eder.
...
| İsim | Açıklama |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Sayfa, PrinterMarkCornerPosition) | `BleedMarkAnnotation` sınıfının yeni bir örneğini başlatır. |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | Anotasyonun türünü alır. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | İşaretin sayfadaki konumunu alır veya ayarlar. |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Anotasyon işleme için ziyaretçiyi kabul eder. |
...
Bleed marklar, bir sayfanın kesileceği yeri ve kesim işaretlerinden ne kadar sapmasına izin verildiğini göstermek için basılı sayfanın köşelerine yerleştirilir.
