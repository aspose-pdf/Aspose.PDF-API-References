...
description: Belgedeki bir dizi metni vurgulayan bir vurgu açıklamasını temsil eder.
type: docs
weight: 490
...
Belgedeki bir dizi metni vurgulayan bir vurgu açıklamasını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | Belirtilen sayfada yeni Vurgu notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
