...
description: Medya kliplerinin oynatılabileceği bir sayfa bölgesini belirten bir ekran açıklaması.
type: docs
weight: 1060
...
Medya kliplerinin oynatılabileceği bir sayfa bölgesini belirten bir ekran açıklaması.
...
| İsim | Tanım |
| --- | --- |
| [ScreenAnnotation](screenannotation)(Page, Rectangle, string) | Belirtilen sayfada yeni Ekran açıklaması oluşturur. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action) { get; } | Açıklama etkinleştirildiğinde gerçekleştirilecek eylemi alır veya ayarlar. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title) { get; set; } | Ekran ek açıklamasının başlığını alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
