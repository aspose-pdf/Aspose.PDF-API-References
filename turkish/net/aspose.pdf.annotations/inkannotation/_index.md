...
description: Aspose.Pdf.Annotations.InkAnnotation sınıfı. Bir veya daha fazla ayrık yol içeren serbest el ile çizilmiş bir karalamayı temsil eder.
type: docs
weight: 1920
url: /tr/net/aspose.pdf.annotations/inkannotation/
---
## InkAnnotation sınıfı

Bir veya daha fazla ayrık yol içeren serbest el "karalaması"nı temsil eder.
...
| İsim | Açıklama |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Üretici için Ink notu yapıcısı. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Belirtilen sayfada yeni bir Ink notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Not türünü alır. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Ink notu çizgi uçlarının stilidir. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Bağımsız çizgileri temsil eden Point[] dizileri olan jestler listesini alır veya ayarlar. |
...
| [Popup](../../aspose.pdf.annotations/markupannotation/popup/) { get; set; } | Bu not ile ilişkili metni girmek veya düzenlemek için açılır not. |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Notu işlemek için ziyaretçi nesnesini kabul eder. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Matris dönüşümüne göre InkList'teki noktaları günceller. |
