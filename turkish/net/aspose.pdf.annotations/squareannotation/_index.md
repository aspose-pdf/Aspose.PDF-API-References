...
description: Kare açıklamayı temsil eden sınıf.
type: docs
weight: 1140
...
Kare açıklamayı temsil eden sınıf.
...
| İsim | Tanım |
| --- | --- |
| [SquareAnnotation](squareannotation#constructor)(Document) | Generator ile kullanmak için yapıcı. |
| [SquareAnnotation](squareannotation#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni Kare notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept)(AnnotationSelector) | Ziyaretçinin ek açıklamayı işlemesini kabul eder. |
