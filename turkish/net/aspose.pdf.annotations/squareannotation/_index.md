...
description: Aspose.Pdf.Annotations.SquareAnnotation sınıfı. Kare anotasyonu temsil eden sınıf
type: docs
weight: 2590
url: /tr/net/aspose.pdf.annotations/squareannotation/
---
## SquareAnnotation sınıfı

Kare anotasyonu temsil eden sınıf.
...
| İsim | Açıklama |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Üretici ile kullanmak için yapıcı. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni bir Kare anotasyonu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | Anotasyon türünü alır. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | İki dikdörtgen arasındaki sayısal farklılıkları tanımlayan dikdörtgen: anotasyonun Rect girişi ve alttaki kare veya dairenin gerçek sınırları. |
...
| [IsKeptWithNext](../../aspose.pdf/baseparagraph/iskeptwithnext/) { get; set; } | Mevcut paragrafın bir sonraki paragrafla birlikte aynı sayfada kalıp kalmayacağını belirten bir bool değeri alır veya ayarlar. Varsayılan false'dur. (pdf üretimi için) |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | Anotasyonu işlemek için ziyaretçiyi kabul eder. |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | Bir anotasyon için inceleme durumunu ayarlar. İşaretli ve İşaretsiz durumlar, İnceleme StateModel'ine ait olmadıkları için göz ardı edilir. Durum, hedef anotasyonu oluşturan kullanıcı tarafından ayarlanır. Değer, hedef anotasyonun Başlık özelliğinden alınır. Not, durumun durum ve statemodel anahtarlarına sahip diğer metin anotasyonlarında saklandığıdır. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | Bir anotasyon için inceleme durumunu ayarlar. İşaretli ve İşaretsiz durumlar, İnceleme StateModel'ine ait olmadıkları için göz ardı edilir. Not, durumun durum ve statemodel anahtarlarına sahip diğer metin anotasyonlarında saklandığıdır. |

### Ayrıca Bakınız

* sınıf [CommonFigureAnnotation](../commonfigureannotation/)
