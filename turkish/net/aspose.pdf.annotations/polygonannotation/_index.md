...
description: Aspose.Pdf.Annotations.PolygonAnnotation sınıfı. Çokgen anotasyonunu temsil eden sınıf
type: docs
weight: 2310
url: /tr/net/aspose.pdf.annotations/polygonannotation/
---
## PolygonAnnotation sınıfı

Çokgen anotasyonunu temsil eden sınıf.
...
| İsim | Açıklama |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Üretici ile kullanmak için yapıcı. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Belirtilen sayfada yeni bir çokgen anotasyonu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | Anotasyonun türünü alır. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Çokgen veya poligon anotasyonunun amacını alır veya ayarlar. |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Anotasyon işleme için ziyaretçi nesnesini kabul eder. |
