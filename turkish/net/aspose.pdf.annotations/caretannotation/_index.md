...
description: Caret ek açıklamasını temsil eden sınıf.
type: docs
weight: 220
...
Caret ek açıklamasını temsil eden sınıf.
...
| İsim | Tanım |
| --- | --- |
| [CaretAnnotation](caretannotation#constructor)(Document) | Generator'da oturum açmak için oluşturucu. |
| [CaretAnnotation](caretannotation#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni Caret notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame) { get; set; } | Düzeltme dikdörtgenini alır veya ayarlar. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol) { get; set; } | Şapka ile ilişkili sembolü alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
