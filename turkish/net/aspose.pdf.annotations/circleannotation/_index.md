...
description: Daire ek açıklamasını temsil eden sınıf.
type: docs
weight: 250
url: /tr/net/aspose.pdf.annotations/circleannotation/
---
## CircleAnnotation class

Daire ek açıklamasını temsil eden sınıf.
...
| İsim | Tanım |
| --- | --- |
| [CircleAnnotation](circleannotation#constructor)(Document) | Daire ek açıklaması için Oluşturucu. |
| [CircleAnnotation](circleannotation#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni Circle ek açıklaması oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame) { get; set; } | İki dikdörtgen arasındaki sayısal farkları açıklayan dikdörtgen: Açıklamanın Rect girişi ve alttaki kare veya dairenin gerçek sınırları. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor) { get; set; } | Açıklamanın dikdörtgenini veya elipsini dolduracak iç renk. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
