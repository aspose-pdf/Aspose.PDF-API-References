...
description: Aspose.Pdf.Annotations.CircleAnnotation sınıfı. Daire anotasyonunu temsil eden sınıf
type: docs
weight: 1590
url: /tr/net/aspose.pdf.annotations/circleannotation/
---
## CircleAnnotation sınıfı

Daire anotasyonunu temsil eden sınıf.
...
| İsim | Açıklama |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Daire anotasyonu için yapıcı. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Belirtilen sayfada yeni bir Daire anotasyonu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Anotasyon türünü alır. |
...
| İsim | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Anotasyonu işlemek için ziyaretçi nesnesini kabul eder. |
