...
description: Sınıf Filigran açıklama nesnesini tanımlar.
type: docs
weight: 1250
...
Sınıf, Filigran açıklama nesnesini tanımlar.
...
| İsim | Tanım |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Filigran açıklama sınıfı için oluşturucu. |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint) { get; } | Filigran ek açıklamasının fuxed yazdırma nesnesi. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity) { get; set; } | Açıklamanın opaklığını alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Ek açıklama için ziyaretçiyi uygulayın. |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext)(FormattedText) | Ek açıklama metnini ayarlayın. |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate)(string[], TextState) | Ek açıklama metnini ayarlayın. |
