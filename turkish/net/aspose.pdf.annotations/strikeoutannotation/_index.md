...
description: Aspose.Pdf.Annotations.StrikeOutAnnotation sınıfı. Belgedeki metinde bir çizgi ile gösterilen bir çizgi üstü notunu temsil eder.
type: docs
weight: 2630
url: /tr/net/aspose.pdf.annotations/strikeoutannotation/
---
## StrikeOutAnnotation sınıfı

Belgedeki metinde bir çizgi ile gösterilen bir çizgi üstü notunu temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Sayfa, Dikdörtgen) | Belirtilen sayfada yeni bir Çizgi Üstü notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Notun türünü alır. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | Notun altındaki metindeki kelime veya bitişik kelime gruplarının koordinatlarını belirten bir dizi nokta alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Notu işlemek için ziyaretçi nesnesini kabul eder. |
