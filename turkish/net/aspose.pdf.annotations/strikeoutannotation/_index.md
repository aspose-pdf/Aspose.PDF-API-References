...
description: Belge metninde üstü çizili olarak görünen bir üstü çizili açıklamayı temsil eder.
type: docs
weight: 1180
...
Belge metninde üstü çizili olarak görünen bir üstü çizili açıklamayı temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation)(Page, Rectangle) | Belirtilen sayfada yeni StrikeOut notu oluşturur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype) { get; } | Açıklama türünü alır. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | Ek açıklamayı işlemek için ziyaretçi nesnesini kabul eder. |
