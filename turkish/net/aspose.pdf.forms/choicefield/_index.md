...
| İsim | Tanım |
| --- | --- |
| [ChoiceField](choicefield#constructor)(Document) | Seçim alanı oluşturur (Jeneratör için) |
| [ChoiceField](choicefield#constructor_1)(Document, Rectangle) | ChoiceField için Oluşturucu. |
| [ChoiceField](choicefield#constructor_2)(Page, Rectangle) | ChoiceField için Oluşturucu. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption#addoption)(string) | Belirtilen adla yeni seçenek ekler. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption#addoption_1)(string, string) | Belirtilen dışa aktarma değeri ve adıyla yeni seçenek ekler. |
