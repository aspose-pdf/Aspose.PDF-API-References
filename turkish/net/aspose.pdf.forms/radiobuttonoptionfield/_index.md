...
description: Sınıf RadioButton alanının öğesini temsil eder.
type: docs
weight: 3170
...
Sınıf, RadioButton alanının öğesini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | Yeni RadioButtonOptionField örneği oluşturun. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | Belirtilen sayfada belirtilen dikdörtgende radyo düğmesi oluşturur. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption) { get; set; } | Altyazı alır veya ayarlar. |
