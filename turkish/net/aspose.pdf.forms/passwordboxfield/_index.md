...
description: Aspose.Pdf.Forms.PasswordBoxField sınıfı. Sınıf, şifre girmek için metin alanını tanımlar.
type: docs
weight: 5200
url: /tr/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField sınıfı

Sınıf, şifre girmek için metin alanını tanımlar.
