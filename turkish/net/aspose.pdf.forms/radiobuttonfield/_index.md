...
| İsim | Tanım |
| --- | --- |
| [RadioButtonField](radiobuttonfield#constructor)(Document) | RadioButtonField. için Oluşturucu |
| [RadioButtonField](radiobuttonfield#constructor_1)(Page) | RadiouttonField için Oluşturucu |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options) { get; } | Radyo düğmesinin seçenekler koleksiyonunu alır. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex) { get; } | Bu RadioButton alanını içeren sayfanın dizinini alır. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | Seçili öğenin dizinini alır veya ayarlar. Öğelerin numaralandırılması 1. 'den başlatılır |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems) { get; set; } | Seçili öğelerin dizisini alır veya ayarlar. Çoklu seçim listesi için dizi birden fazla öğe içerir. Tek seçim listesi için tek öğe içerir. |
| [States](../../aspose.pdf.annotations/annotation/states) { get; } | Açıklamanın görünüm sözlüğünü alır. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | Alan kutusunun stili. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | RadioButton alanına yeni seçenek alanı ekler |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | Radyon düğmesine seçenek ekleyin. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | Belirtilen dikdörtgen ile radyo düğmesine ekle seçeneği. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition)(Point) | Radyo düğmesinin tüm alt öğelerini sayfada belirtilen konumlara taşıyın. |
