...
description: Aspose.Pdf.Forms.FileSelectBoxField sınıfı. Dosya seçim kutusu öğesi için alan
type: docs
weight: 5060
url: /tr/net/aspose.pdf.forms/fileselectboxfield/
---
## FileSelectBoxField sınıfı

Dosya seçim kutusu öğesi için alan.
...
| [MaxLen](../../aspose.pdf.forms/textboxfield/maxlen/) { get; set; } | Alanın metin maksimum uzunluğunu alır veya ayarlar. |
