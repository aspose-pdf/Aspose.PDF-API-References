...
description: Aspose.Pdf.Forms.SignatureField sınıfı. İmza form alanını temsil eder
type: docs
weight: 5290
url: /tr/net/aspose.pdf.forms/signaturefield/
---
## SignatureField sınıfı
...
| İsim | Açıklama |
| --- | --- |
| [SignatureField](signaturefield/#constructor)(Document, Rectangle) | `SignatureField` sınıfının yeni bir örneğini başlatır. |
| [SignatureField](signaturefield/#constructor_1)(Page, Rectangle) | `SignatureField` sınıfının yeni bir örneğini başlatır. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | İmza nesnesini alır. Bu nesne, genel anahtar kriptografik standartları ile ilgili imza verilerini içerir. [`PKCS1`](../pkcs1/), [`PKCS7`](../pkcs7/) ve [`PKCS7Detached`](../pkcs7detached/) sınıfları, desteklenen tüm imza nesne türlerini temsil eder. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | Tek bir X.509 sertifikasını DER formatında bir akış olarak çıkarır. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | İmzanın görüntüsünü jpeg kodlu akış olarak çıkarır. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | İmzanın görüntüsünü kodlu akış olarak çıkarır. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Belirtilen alanlara JSON akışından verileri, alanların tam adlarının tam eşleşmesine dayanarak içe aktarır. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | Belirtilen alana JSON akışından verileri, 'fieldFullNameInJSON' değişkeninde belirtilen tam adı kullanarak içe aktarır. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign)(Signature) | Bu imza alanını kullanarak belgeyi imzalar. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign_1)(Signature, Stream, string) | Bu imza alanını kullanarak belgeyi imzalar. |
