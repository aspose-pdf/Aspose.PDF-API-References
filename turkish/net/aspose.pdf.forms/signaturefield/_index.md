...
description: İmza formu alanını temsil eder.
type: docs
weight: 3230
...
| İsim | Tanım |
| --- | --- |
| [SignatureField](signaturefield#constructor)(Document, Rectangle) | Yeni örneğini başlatır[`SignatureField`](../signaturefield) sınıf. |
| [SignatureField](signaturefield#constructor_1)(Page, Rectangle) | Yeni örneğini başlatır[`SignatureField`](../signaturefield) sınıf. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature) { get; } | İmza nesnesini alır. Bu nesne, ortak anahtar şifreleme standartlarıyla ilgili imza verilerini içerir. Sınıflar[`PKCS1`](../pkcs1) ,[`PKCS7`](../pkcs7) ve[`PKCS7Detached`](../pkcs7detached) , desteklenen tüm imza nesnesi türlerini temsil eder. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate)() | Tek X.509 sertifikasını DER biçiminde bir akış olarak çıkarır. |
...
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage_1)(ImageFormat) | İmzanın görüntüsünü kodlanmış akış olarak çıkarır. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign)(Signature) | Bu imza alanını kullanarak belgeyi imzalayın. |
