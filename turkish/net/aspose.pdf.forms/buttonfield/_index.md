...
description: Sınıf düğme alanını temsil eder.
type: docs
weight: 2920
...
Sınıf, düğme alanını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [ButtonField](buttonfield#constructor)() | Jeneratör için düğme alanı oluşturucusu. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | Etkin alanı içinde fare düğmesine basıldığında görüntülenecek düğmenin alternatif başlığını alır veya ayarlar. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | Etkin alanı içinde fare düğmesine basıldığında görüntülenmesi gereken alternatif simgeyi alır veya ayarlar. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | Widget ek açıklamasının simgesinin, ek açıklama dikdörtgeni içinde nasıl görüntüleneceğini belirten simge sığdırma nesnesini alır. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition) { get; set; } | Simge başlığı konumunu alır veya ayarlar. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption) { get; set; } | Normal altyazıyı alır veya ayarlar. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon) { get; set; } | Kullanıcı ile etkileşimde olmadığında görüntülenecek düğmenin normal simgesini alır veya ayarlar. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | Kullanıcı fare düğmesine basmadan imlecini etkin alanına getirdiğinde görüntülenecek düğmenin rollover başlığını alır veya ayarlar. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | Kullanıcı imleci fare düğmesine basmadan etkin alanına getirdiğinde görüntülenecek düğmenin rollover simgesini alır veya ayarlar. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage)(Image) | Alan kaynaklarına resim ekler ve onu çizer. |
