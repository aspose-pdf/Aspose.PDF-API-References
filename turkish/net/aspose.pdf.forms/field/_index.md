...
description: Aspose.Pdf.Forms.Field sınıfı. Acro form alanları için temel sınıf
type: docs
weight: 5050
url: /tr/net/aspose.pdf.forms/field/
---
## Alan sınıfı
...
| İsim | Açıklama |
| --- | --- |
| [Field](field/)(Document) | Üreticide kullanılmak üzere alan oluşturur. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Eğer true ise, yazı tipi boyutu belirtilen dikdörtgene sığacak şekilde azaltılacaktır. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Alan içerikleri için kullanılabilecek maksimum yazı tipi boyutu. -1, boyutu kontrol etmemek için. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Alan içerikleri için kullanılabilecek minimum yazı tipi boyutu. -1, boyutu kontrol etmemek için. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Bu alanın alt alanlarını belirtilen indeksten başlayarak diziye kopyalar. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Tam adların tam eşleşmesine dayanarak belirtilen alanlara JSON akışından veri ithal eder. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | 'fieldFullNameInJSON' değişkeninde belirtilen tam adı kullanarak JSON akışından belirtilen alana veri ithal eder. |
...
* sınıf [WidgetAnnotation](../../aspose.pdf.annotations/widgetannotation/)
