...
| İsim | Tanım |
| --- | --- |
| [Field](field)(Document) | Generator'da kullanım için alan oluşturur. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | Doğruysa, yazı tipi boyutu, metni belirtilen dikdörtgene sığdırmak için küçültülür. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Alan içeriği için kullanılabilen Maximail yazı tipi boyutu. -1 boyutu kontrol etmemek için. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | Alan içeriği için kullanılabilecek minimum yazı tipi boyutu. -1 boyutu kontrol etmemek için. |
