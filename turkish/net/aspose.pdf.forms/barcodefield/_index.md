...
description: Aspose.Pdf.Forms.BarcodeField sınıfı. Sınıf barkod alanını temsil eder
type: docs
weight: 4950
url: /tr/net/aspose.pdf.forms/barcodefield/
---
## BarcodeField sınıfı
...
| İsim | Açıklama |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | `BarcodeField` sınıfının yeni bir örneğini başlatır. |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | `BarcodeField` sınıfının yeni bir örneğini başlatır. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Barkod nesnesinin başlığını alır. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Hata düzeltme katsayısını temsil eden bir tamsayı değeri alır. PDF417 için 0 ile 8 arasında olmalıdır. QRCode için 0 ile 3 arasında olmalıdır (0 'L' için, 1 'M' için, 2 'Q' için ve 3 'H' için). |
...
| [Flags](../../aspose.pdf.annotations/annotation/flags/) { get; set; } | Notasyon bayrakları. |
...
| [IsGroup](../../aspose.pdf.forms/field/isgroup/) { get; } | Bu alanın terminal olmayan bir alan yani alanlar grubu olup olmadığını gösteren boolean değerini alır veya ayarlar. |
...
| [IsKeptWithNext](../../aspose.pdf/baseparagraph/iskeptwithnext/) { get; set; } | Mevcut paragrafın bir sonraki paragrafla aynı sayfada kalıp kalmayacağını gösteren bir bool değeri alır veya ayarlar. Varsayılan false'dur. (pdf oluşturma için) |
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | Üretici desteği için özellik. Alan üst bilgi veya alt bilgiye eklendiğinde kullanılır. Eğer true ise, bu alan bir kez oluşturulacak ve görünümü belgenin tüm sayfalarında görünür olacaktır. Eğer false ise, her belge sayfası için ayrı bir alan oluşturulacaktır. |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Barkod nesnesinin render edildiği çözünürlüğü, inç başına nokta (dpi) cinsinden alır. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Bu notasyonda hangi barkod veya glif teknolojisinin kullanılacağını belirtir, detaylar için [`Symbology`](./symbology/) bölümüne bakın. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | İki barkod modülü arasındaki dikey mesafeyi, piksel cinsinden alır. XSymHeight/XSymWidth oranı bir tamsayı değeri olmalıdır. PDF417 için kabul edilebilir oran aralığı 1 ile 4 arasındadır. QRCode ve DataMatrix için bu oran her zaman 1 olmalıdır. |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | İki barkod modülü arasındaki yatay mesafeyi, piksel cinsinden alır. |
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | Grafiğin Z sırasını gösteren bir int değeri alır veya ayarlar. Daha büyük ZIndex'e sahip bir grafik, daha küçük ZIndex'e sahip grafiğin üzerine yerleştirilecektir. ZIndex negatif olabilir. Negatif ZIndex'e sahip grafik, sayfadaki metnin arkasına yerleştirilecektir. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Alan içine barkod 128 ekler. Alan değeri koda değiştirilecek ve alan salt okunur hale gelecektir. |
