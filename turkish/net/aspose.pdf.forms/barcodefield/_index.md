...
| İsim | Tanım |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | Yeni örneğini başlatır[`BarcodeField`](../barcodefield) sınıf. |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | Yeni örneğini başlatır[`BarcodeField`](../barcodefield) sınıf. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } | Hata düzeltme katsayısını temsil eden bir tamsayı değeri alır. PDF417 için 0 ile 8 arasında olacaktır. QRCode için 0 ile 3 arasında olacaktır (�L� için 0, �M� için 1, �Q� için 2 ve �H� için 3). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution) { get; } | Barkod nesnesinin oluşturulduğu inç başına nokta (dpi) cinsinden çözünürlüğü alır. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | Bu ek açıklamada hangi barkod veya glif teknolojisinin kullanılacağını belirtir, bkz.[`Symbology`](./symbology) ayrıntılar için. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight) { get; } | İki barkod modülü arasındaki piksel cinsinden ölçülen dikey mesafeyi alır. XSymHeight/XSymWidth oranı bir tamsayı değeri olacaktır. PDF417 için kabul edilebilir oran aralığı 1 ile 4 arasındadır. QRCode ve DataMatrix için bu oran her zaman 1 olacaktır. |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth) { get; } | İki barkod modülü arasındaki piksel cinsinden yatay mesafeyi alır. |
