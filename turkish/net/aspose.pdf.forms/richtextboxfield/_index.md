...
description: Sınıf zengin metin düzenleyici bileşenini açıklar.
type: docs
weight: 3180
...
Sınıf, zengin metin düzenleyici bileşenini açıklar.
...
| İsim | Tanım |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | Zengin Metin Kutusu alanı için oluşturucu. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Biçimlendirilmiş zengin metin değerini biçimlendirme ile alır veya ayarlar. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Zengin metin kutusunun gerekçesini alır veya ayarlar. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value) { get; set; } | RichTextField. Değeri |
