...
description: Formun Combobox alanını temsil eden sınıf.
type: docs
weight: 2950
...
| İsim | Tanım |
| --- | --- |
| [ComboBoxField](comboboxfield#constructor)() | Generator'da kullanılacak ComboBoxField için Oluşturucu. |
| [ComboBoxField](comboboxfield#constructor_1)(Document) | Generator ile çalışmak için CombBox alanı oluşturur. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | Combobox alanı için oluşturucu. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | Combobox Alanı için Oluşturucu. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected) { get; set; } | Seçilen seçeneğin dizinini alır veya ayarlar. Bu özellik, seçimi değiştirmeye izin verir. |
