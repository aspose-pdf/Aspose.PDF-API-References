...
description: Aspose.Pdf.Forms.ComboBoxField sınıfı. Formun ComboBox alanını temsil eden sınıf
type: docs
weight: 5000
url: /tr/net/aspose.pdf.forms/comboboxfield/
---
## ComboBoxField sınıfı

Formun ComboBox alanını temsil eden sınıf.
...
| İsim | Açıklama |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Üreticide kullanılacak ComboBoxField için yapıcı. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Üretici ile çalışacak CombBox alanı oluşturur. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | ComboBox alanı için yapıcı. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | ComboBox Alanı için yapıcı. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Alanın düzenlenebilir durumunu alır veya ayarlar. |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Seçilen öğelerin dizisini alır veya ayarlar. Çoklu seçim listesi dizisi birden fazla öğe içerir. Tekil seçim listesi tek bir öğe içerir. |
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Yazım denetimi etkinlik durumunu alır veya ayarlar. |
