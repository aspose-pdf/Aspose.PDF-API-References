...
| İsim | Tanım |
| --- | --- |
| [TextBoxField](textboxfield#constructor)() | TextBoxField. örneğini oluşturun |
| [TextBoxField](textboxfield#constructor_1)(Document) | Generator ile kullanılması gereken yapıcı. |
| [TextBoxField](textboxfield#constructor_2)(Document, Rectangle) | TextBox alanının kurucusu. |
| [TextBoxField](textboxfield#constructor_3)(Page, Rectangle) | TextBox alanının kurucusu. |
