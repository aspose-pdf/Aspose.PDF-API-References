...
description: Aspose.Pdf.Forms.DateField sınıfı. Takvim görünümüne sahip tarih alanı
type: docs
weight: 5010
url: /tr/net/aspose.pdf.forms/datefield/
---
## DateField sınıfı

Takvim görünümüne sahip tarih alanı.
...
| Ad | Açıklama |
| --- | --- |
| [DateField](datefield/#constructor)() | `DateField`'in yeni bir örneğini başlatır. |
| [DateField](datefield/#constructor_1)(Document) | Üretici ile kullanılacak yapıcı. |
| [DateField](datefield/#constructor_2)(Document, Rectangle) | `DateField`'in yeni bir örneğini başlatır. |
| [DateField](datefield/#constructor_3)(Page, Rectangle) | `DateField`'in yeni bir örneğini başlatır. |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat/) { get; set; } | Tarih formatını alır veya ayarlar. |
...
| [IsGroup](../../aspose.pdf.forms/field/isgroup/) { get; } | Bu alanın terminal olmayan bir alan, yani alanlar grubu olup olmadığını belirten boolean değerini alır. |
...
| [Value](../../aspose.pdf.forms/datefield/value/) { get; set; } | Tarihi alır veya ayarlar. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | Bu alan için resim ekleme reddedildi. (2 yöntem) |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Alanların tam adlarının tam eşleşmesine dayalı olarak belirtilen alanlara JSON akışından veri aktarır. |
...
| [Init](../../aspose.pdf.forms/datefield/init/)(Page) | JS Eylemini başlatır. |
