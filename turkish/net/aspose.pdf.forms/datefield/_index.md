...
| İsim | Tanım |
| --- | --- |
| [DateField](datefield#constructor)() | Yeni bir örneğini başlatır[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | Generator ile kullanılması gereken yapıcı. |
| [DateField](datefield#constructor_2)(Document, Rectangle) | Yeni bir örneğini başlatır[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | Yeni bir örneğini başlatır[`DateField`](../datefield) |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat) { get; set; } | Tarih biçimini alır veya ayarlar. |
...
| [Value](../../aspose.pdf.forms/datefield/value) { get; set; } | Tarih alır veya ayarlar. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | Bu alan için resim ekleme reddedildi. (2 methods) |
...
DateField dateField = new DateField(sayfa, rect); doc.Form.Add(dateField); dateField.Init(sayfa);
