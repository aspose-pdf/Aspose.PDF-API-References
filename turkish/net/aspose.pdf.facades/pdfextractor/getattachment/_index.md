...
description: PdfExtractor metodu. Eki dosyaya kaydeder
type: docs
weight: 140
...
| --- | --- | --- |
| outputPath | String | Ekin kaydedileceği dizin yolu. Null veya boş bir dize, ekin uygulama dizinine yerleştirileceği anlamına gelir. |
...
Tüm ek dosyalarını akışlara kaydeder.
