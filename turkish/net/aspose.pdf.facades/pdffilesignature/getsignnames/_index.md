...
description: Boş olmayan tüm imzaların adlarını alır.
type: docs
weight: 220
...
Boş olmayan tüm imzaların adlarını alır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| onlyActive | Boolean | doğruysa, yalnızca etkin imzaları döndür; aksi takdirde, tüm imzaları iade edin. |

### Geri dönüş değeri

Bir IList&lt;string&gt; döndürün.
