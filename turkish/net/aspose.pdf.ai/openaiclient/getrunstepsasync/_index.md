...
description: OpenAIClient metodu. Bir iş parçacığı içindeki belirli bir çalışmanın adımlarını asenkron olarak alır
type: docs
weight: 280
url: /tr/net/aspose.pdf.ai/openaiclient/getrunstepsasync/
---
## OpenAIClient.GetRunStepsAsync metodu

Bir iş parçacığı içindeki belirli bir çalışmanın adımlarını asenkron olarak alır.
