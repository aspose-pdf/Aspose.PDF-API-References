...
description: Aspose.Pdf.AI.RunListQueryParameters sınıfı. Koşuları listelemek için sorgu parametreleri nesnesi
type: docs
weight: 990
url: /tr/net/aspose.pdf.ai/runlistqueryparameters/
---
## RunListQueryParameters sınıfı

Koşuları listelemek için sorgu parametreleri nesnesi.
...
| İsim | Açıklama |
| --- | --- |
| [RunListQueryParameters](runlistqueryparameters/)() | Varsayılan yapıcı. |
...
| İsim | Açıklama |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runlistqueryparameters/getqueryparameters/)() | Koşuları listelemek için sorgu parametrelerini alır. |
