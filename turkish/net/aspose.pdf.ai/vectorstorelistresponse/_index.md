...
description: Aspose.Pdf.AI.VectorStoreListResponse sınıfı. Vektör mağaza verilerini içeren bir liste yanıtını temsil eder.
type: docs
weight: 1370
url: /tr/net/aspose.pdf.ai/vectorstorelistresponse/
---
## VectorStoreListResponse sınıfı

Vektör mağaza verilerini içeren bir liste yanıtını temsil eder.
...
| İsim | Açıklama |
| --- | --- |
| [VectorStoreListResponse](vectorstorelistresponse/)() | Varsayılan yapıcı. |
