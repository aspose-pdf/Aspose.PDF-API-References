...
description: Aspose.Pdf.AI.ThreadMessageListResponse sınıfı. Thread mesaj verilerini içeren bir liste yanıtını temsil eder.
type: docs
weight: 1140
url: /tr/net/aspose.pdf.ai/threadmessagelistresponse/
---
## ThreadMessageListResponse sınıfı

Thread mesaj verilerini içeren bir liste yanıtını temsil eder.
...
| İsim | Açıklama |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | Varsayılan yapıcı. |
...
| [ErrorMessage](../../aspose.pdf.ai/baseresponse/errormessage/) { get; } | Hata bilgilerini alır. |
...
* sınıf [ListDataResponse&lt;T&gt;](../listdataresponse-1/)
