...
---
## HtmlSaveOptions.CustomProgressHandler alanı

Bu işleyici, dönüşüm ilerleme olaylarını yönetmek için kullanılabilir, örneğin ilerleme çubuğu veya işlenen sayfa sayısı hakkında mesajlar göstermek için kullanılabilir, konsolda ilerlemeyi gösteren işleyici kodu örneği şudur:
