...
description: Sınıfı filigran yapısını tanımlar. Bu için kullanılabilir
type: docs
weight: 7360
...
Sınıfı, filigran yapısını tanımlar. Bu, için kullanılabilir
...
| İsim | Tanım |
| --- | --- |
| [WatermarkArtifact](watermarkartifact)() | Filigran yapısı örneğini oluşturur. |
