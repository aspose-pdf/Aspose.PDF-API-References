...
| İsim | Tanım |
| --- | --- |
| [Artifact](artifact#constructor)(ArtifactType, ArtifactSubtype) | Belirtilen türe ve alt türe sahip yapıtın yapıcısı |
| [Artifact](artifact#constructor_1)(string, string) | Belirtilen türe ve alt türe sahip yapıtın yapıcısı |
...
| [SetImage](../../aspose.pdf/artifact/setimage#setimage)(Stream) | Yapının görüntüsünü ayarlar. |
| [SetImage](../../aspose.pdf/artifact/setimage#setimage_1)(string) | Yapının görüntüsünü ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| enum [ArtifactSubtype](artifact.artifactsubtype) | Olası yapı alt türünün numaralandırılması. |
| enum [ArtifactType](artifact.artifacttype) | Olası yapıt türlerinin numaralandırılması. |
