...
description: Tablo yöntemi. Tek boyutlu veri dizisini tabloya aktarır. Aktarım, her dizinin öğesi için bir hücre alır ve parametrelerde tanımlanan satır ve sütundan başlar. Aktarım sırasında gerekli satırların hala mevcut olmadığı tespit edilirse, gerekli satırlar oluşturulacaktır.
type: docs
weight: 250
