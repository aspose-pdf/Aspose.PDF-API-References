...
description: Sınıf arka plan yapısını tanımlar. Bu yapı sayfanın arka planının ayarlanmasına izin verir.
type: docs
weight: 1350
...
Sınıf, arka plan yapısını tanımlar. Bu yapı, sayfanın arka planının ayarlanmasına izin verir.
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor) { get; set; } | Arka plan yapaylığının arka plan rengini alır veya ayarlar |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage) { get; set; } | Arka plan yapaylığının arka plan görüntüsünü alır veya ayarlar |
