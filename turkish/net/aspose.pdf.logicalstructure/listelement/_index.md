...
description: Aspose.Pdf.LogicalStructure.ListElement sınıfı. Mantıksal yapıdaki Liste yapı elemanını temsil eder
type: docs
weight: 6460
url: /tr/net/aspose.pdf.logicalstructure/listelement/
---
## ListElement sınıfı

Mantıksal yapıdaki Liste yapı elemanını temsil eder.
