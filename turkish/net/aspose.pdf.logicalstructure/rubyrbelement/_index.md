...
description: Aspose.Pdf.LogicalStructure.RubyRBElement sınıfı. Ruby'nin mantıksal yapısındaki RB yapı elemanını temsil eder.
type: docs
weight: 6610
url: /tr/net/aspose.pdf.logicalstructure/rubyrbelement/
---
## RubyRBElement sınıfı

Ruby'nin mantıksal yapısındaki RB yapı elemanını temsil eder.
