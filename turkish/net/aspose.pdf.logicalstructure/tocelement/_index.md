...
description: Aspose.Pdf.LogicalStructure.TOCElement sınıfı. Mantıksal yapıda TOC yapı elemanını temsil eder
type: docs
weight: 6740
url: /tr/net/aspose.pdf.logicalstructure/tocelement/
---
## TOCElement Sınıfı

Mantıksal yapıda TOC yapı elemanını temsil eder.
