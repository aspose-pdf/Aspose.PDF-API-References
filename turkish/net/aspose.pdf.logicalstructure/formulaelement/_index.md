...
description: Mantıksal yapıdaki Formül yapı öğesini temsil eder.
type: docs
weight: 4190
...
Mantıksal yapıdaki Formül yapı öğesini temsil eder.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double) | Görüntüyü geçerli çizim öğesine ekler. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double, double) | Görüntüyü geçerli çizim öğesine ekler. |
