...
description: Aspose.Pdf.LogicalStructure.FormulaElement sınıfı. Mantıksal yapıdaki Formül yapı elemanını temsil eder
type: docs
weight: 6360
url: /tr/net/aspose.pdf.logicalstructure/formulaelement/
---
## FormulaElement sınıfı

Mantıksal yapıdaki Formül yapı elemanını temsil eder.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, üst nesneden ona olan referansı, çocuk nesnelerden ona olan referansları ve belgede ilgili nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
