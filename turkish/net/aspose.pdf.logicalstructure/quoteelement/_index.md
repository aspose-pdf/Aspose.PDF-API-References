...
description: Aspose.Pdf.LogicalStructure.QuoteElement sınıfı. Mantıksal yapıdaki Alıntı yapı öğesini temsil eder
type: docs
weight: 6570
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Mevcut öğe için StructureTextState nesnesini alır. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Bir öğeyi yapıdan, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede ilgili nesneyi kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Bir öğeyi yapıdan, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede ilgili nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna ekler. |
...
* sınıf [ILSTextElement](../ilstextelement/)
