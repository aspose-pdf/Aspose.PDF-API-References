...
description: Aspose.Pdf.LogicalStructure.ListLIElement sınıfı. Listenin mantıksal yapısındaki LI yapı elemanını temsil eder
type: docs
weight: 6480
url: /tr/net/aspose.pdf.logicalstructure/listlielement/
---
## ListLIElement sınıfı

Listenin mantıksal yapısındaki LI yapı elemanını temsil eder.
