...
description: Aspose.Pdf.LogicalStructure.TableTFootElement sınıfı. Tablo yapısının mantıksal yapısındaki TFoot yapı elemanını temsil eder.
type: docs
weight: 6820
url: /tr/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## TableTFootElement sınıfı

Tablo yapısının mantıksal yapısındaki TFoot yapı elemanını temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Yapıdan bir elemanı, ona referansı olan üst nesneden, ona referansı olan çocuk nesnelerden ve belgede karşılık gelen nesneden kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, ona referansı olan üst nesneden, ona referansı olan çocuk nesnelerden ve belgede karşılık gelen nesneden kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna ekler. |
