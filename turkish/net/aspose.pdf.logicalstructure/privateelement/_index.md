...
description: Aspose.Pdf.LogicalStructure.PrivateElement sınıfı. Mantıksal yapıda özel yapı elemanını temsil eder
type: docs
weight: 6560
url: /tr/net/aspose.pdf.logicalstructure/privateelement/
---
## PrivateElement sınıfı

Mantıksal yapıda özel yapı elemanını temsil eder.
