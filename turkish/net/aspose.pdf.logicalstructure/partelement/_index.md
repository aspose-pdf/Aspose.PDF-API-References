...
description: Aspose.Pdf.LogicalStructure.PartElement sınıfı. Mantıksal yapıdaki Parça yapı öğesini temsil eder
type: docs
weight: 6550
url: /tr/net/aspose.pdf.logicalstructure/partelement/
---
## PartElement sınıfı

Mantıksal yapıdaki Parça yapı öğesini temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Yapıdan bir öğeyi, üst nesneden ona olan referansı, çocuk nesnelerden ona olan referansları ve belgede ilgili nesneyi kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir öğeyi, üst nesneden ona olan referansı, çocuk nesnelerden ona olan referansları ve belgede ilgili nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneleri koleksiyonuna ekler. |
