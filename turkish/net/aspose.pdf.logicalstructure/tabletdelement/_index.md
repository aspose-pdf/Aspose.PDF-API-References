...
description: Aspose.Pdf.LogicalStructure.TableTDElement sınıfı. Tablo yapısının mantıksal yapısında TD yapı elemanını temsil eder
type: docs
weight: 6810
url: /tr/net/aspose.pdf.logicalstructure/tabletdelement/
---
## TableTDElement sınıfı

Tablo yapısının mantıksal yapısında TD yapı elemanını temsil eder.
...
| [AppendChild](../../aspose.pdf.logicalstructure/element/appendchild/)(Element, bool) | Çocuklar koleksiyonuna Eleman ekler. |
...
| [FindElements&lt;T&gt;](../../aspose.pdf.logicalstructure/element/findelements/)(bool) | Verilen türde Elemanları bulur. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Bir elemanı yapıdan, ona referansı üst nesneden, ona referansları çocuk nesnelerden, belgede karşılık gelen nesneden kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Bir elemanı yapıdan, ona referansı üst nesneden, ona referansları çocuk nesnelerden, ve belgede karşılık gelen nesneden kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
