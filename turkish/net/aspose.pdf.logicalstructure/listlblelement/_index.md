...
description: Aspose.Pdf.LogicalStructure.ListLblElement sınıfı. Listenin mantıksal yapısındaki Lbl yapı elemanını temsil eder
type: docs
weight: 6490
url: /tr/net/aspose.pdf.logicalstructure/listlblelement/
---
## ListLblElement sınıfı

Listenin mantıksal yapısındaki Lbl yapı elemanını temsil eder.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, üst nesneden ona olan referansı, çocuk nesnelerden ona olan referansları ve belgede karşılık gelen nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
...
* sınıf [ListChildElement](../listchildelement/)
