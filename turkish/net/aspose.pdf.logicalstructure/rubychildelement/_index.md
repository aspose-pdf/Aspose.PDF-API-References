...
description: Mantıksal yapıdaki Rubynin alt öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 4420
...
Mantıksal yapıdaki Ruby'nin alt öğeleri için bir temel sınıfı temsil eder.
