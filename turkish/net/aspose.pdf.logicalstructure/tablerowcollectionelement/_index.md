...
description: Mantıksal yapıdaki Tablo Başı Gövdesi ve Ayak öğelerinin alt öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 4620
...
Mantıksal yapıdaki Tablo Başı, Gövdesi ve Ayak öğelerinin alt öğeleri için bir temel sınıfı temsil eder.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | Oluşturur[`TableTRElement`](../tabletrelement) ve mevcut tabloya ekledi. |
