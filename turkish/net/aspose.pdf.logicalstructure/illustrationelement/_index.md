...
description: Mantıksal yapıdaki örnek yapı öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 4250
...
Mantıksal yapıdaki örnek yapı öğeleri için bir temel sınıfı temsil eder.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage)(string, double) | Görüntüyü geçerli çizim öğesine ekler. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage_1)(string, double, double) | Görüntüyü geçerli çizim öğesine ekler. |
