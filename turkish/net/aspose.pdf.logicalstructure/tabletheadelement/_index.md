...
description: Aspose.Pdf.LogicalStructure.TableTHeadElement sınıfı. Tablo mantıksal yapısındaki THead yapı elemanını temsil eder.
type: docs
weight: 6840
url: /tr/net/aspose.pdf.logicalstructure/tabletheadelement/
---
## TableTHeadElement sınıfı

Tablo mantıksal yapısındaki THead yapı elemanını temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Yapıdan bir elemanı, ona referansı olan üst nesneden, ona referansı olan çocuk nesnelerden ve belgedeki karşılık gelen nesneden kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, ona referansı olan üst nesneden, ona referansı olan çocuk nesnelerden ve belgedeki karşılık gelen nesneden kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna ekler. |
