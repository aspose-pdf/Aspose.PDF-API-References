...
description: Aspose.Pdf.LogicalStructure.BLSElement sınıfı. Mantıksal yapıdaki blok seviyesindeki yapı öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 6240
url: /tr/net/aspose.pdf.logicalstructure/blselement/
---
## BLSElement sınıfı

Mantıksal yapıdaki blok seviyesindeki yapı öğeleri için bir temel sınıfı temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Bir öğeyi yapıdan, ona olan bir referansı üst nesneden, ona olan referansları çocuk nesnelerden ve belgede karşılık gelen nesneyi kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Bir öğeyi yapıdan, ona olan bir referansı üst nesneden, ona olan referansları çocuk nesnelerden ve belgede karşılık gelen nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna ekler. |
