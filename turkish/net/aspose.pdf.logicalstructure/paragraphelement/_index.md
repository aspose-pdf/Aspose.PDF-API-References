...
description: Aspose.Pdf.LogicalStructure.ParagraphElement sınıfı. Mantıksal yapıdaki Paragraf yapı elemanını temsil eder
type: docs
weight: 6540
url: /tr/net/aspose.pdf.logicalstructure/paragraphelement/
---
## ParagraphElement sınıfı

Mantıksal yapıdaki Paragraf yapı elemanını temsil eder.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | Mevcut eleman için StructureTextState nesnesini alır. |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Bir elemanı yapıdan, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede karşılık gelen nesneyi kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Bir elemanı yapıdan, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede karşılık gelen nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna ekler. |
...
* sınıf [BLSTextElement](../blstextelement/)
