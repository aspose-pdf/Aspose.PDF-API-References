...
description: Aspose.Pdf.LogicalStructure.DocumentElement sınıfı. Mantıksal yapıdaki belge yapı öğesini temsil eder
type: docs
weight: 6310
url: /tr/net/aspose.pdf.logicalstructure/documentelement/
---
## DocumentElement sınıfı

Mantıksal yapıdaki belge yapı öğesini temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Yapıdan bir öğeyi, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede karşılık gelen nesneyi kaldırır. |
