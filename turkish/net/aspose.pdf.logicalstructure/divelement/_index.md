...
description: Aspose.Pdf.LogicalStructure.DivElement sınıfı. Mantıksal yapıdaki Div yapı elemanını temsil eder
type: docs
weight: 6300
url: /tr/net/aspose.pdf.logicalstructure/divelement/
---
## DivElement sınıfı

Mantıksal yapıdaki Div yapı elemanını temsil eder.
