...
description: Aspose.Pdf.LogicalStructure.RubyRPElement sınıfı. Ruby'nin mantıksal yapısındaki RP yapı elemanını temsil eder.
type: docs
weight: 6620
url: /tr/net/aspose.pdf.logicalstructure/rubyrpelement/
---
## RubyRPElement sınıfı

Ruby'nin mantıksal yapısındaki RP yapı elemanını temsil eder.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve belgede ilgili nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
...
* sınıf [RubyChildElement](../rubychildelement/)
