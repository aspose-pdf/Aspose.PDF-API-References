...
description: Aspose.Pdf.LogicalStructure.TableChildElement sınıfı. Mantıksal yapıda Tablo'nun çocuk öğeleri için bir temel sınıfı temsil eder
type: docs
weight: 6770
url: /tr/net/aspose.pdf.logicalstructure/tablechildelement/
---
## TableChildElement sınıfı

Mantıksal yapıda Tablo'nun çocuk öğeleri için bir temel sınıfı temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [AppendChild](../../aspose.pdf.logicalstructure/element/appendchild/)(Element, bool) | Çocuklar koleksiyonuna Element ekler. |
