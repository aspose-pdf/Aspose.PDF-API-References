...
description: Aspose.Pdf.LogicalStructure.ILSElement sınıfı. Mantıksal yapıdaki satır içi düzey yapı öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 6390
url: /tr/net/aspose.pdf.logicalstructure/ilselement/
---
## ILSElement Sınıfı

Mantıksal yapıdaki satır içi düzey yapı öğeleri için bir temel sınıfı temsil eder.
