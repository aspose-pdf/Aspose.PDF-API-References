...
description: Aspose.Pdf.LogicalStructure.WarichuChildElement sınıfı. Mantıksal yapıdaki Warichu'nun çocuk öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 6860
url: /tr/net/aspose.pdf.logicalstructure/warichuchildelement/
---
## WarichuChildElement sınıfı

Mantıksal yapıdaki Warichu'nun çocuk öğeleri için bir temel sınıfı temsil eder.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Bir öğeyi yapıdan, ona ait referansı üst nesneden, ona ait referansları çocuk nesnelerden ve ilgili nesneyi belgede kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
