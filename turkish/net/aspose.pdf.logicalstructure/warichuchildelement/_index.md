...
description: Mantıksal yapıdaki Warichunun alt öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 4690
...
Mantıksal yapıdaki Warichu'nun alt öğeleri için bir temel sınıfı temsil eder.
