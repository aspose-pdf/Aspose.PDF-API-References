...
description: Aspose.Pdf.LogicalStructure.CodeElement sınıfı. Mantıksal yapıda Kod yapı elemanını temsil eder
type: docs
weight: 6290
url: /tr/net/aspose.pdf.logicalstructure/codeelement/
---
## CodeElement sınıfı

Mantıksal yapıda Kod yapı elemanını temsil eder.
