...
description: Aspose.Pdf.LogicalStructure.NonStructElement sınıfı. Mantıksal yapıda NonStruct yapı elemanını temsil eder
type: docs
weight: 6510
url: /tr/net/aspose.pdf.logicalstructure/nonstructelement/
---
## NonStructElement sınıfı

Mantıksal yapıda NonStruct yapı elemanını temsil eder.
