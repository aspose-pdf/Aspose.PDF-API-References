...
description: Aspose.Pdf.LogicalStructure.FigureElement sınıfı. Mantıksal yapıdaki Şekil yapı elemanını temsil eder
type: docs
weight: 6340
url: /tr/net/aspose.pdf.logicalstructure/figureelement/
---
## FigureElement sınıfı

Mantıksal yapıdaki Şekil yapı elemanını temsil eder.
