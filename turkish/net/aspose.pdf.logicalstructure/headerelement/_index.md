...
description: Aspose.Pdf.LogicalStructure.HeaderElement sınıfı. Mantıksal yapıdaki Başlık yapı elemanını temsil eder
type: docs
weight: 6380
url: /tr/net/aspose.pdf.logicalstructure/headerelement/
---
## HeaderElement sınıfı

Mantıksal yapıdaki Başlık yapı elemanını temsil eder.
