...
description: Mantıksal yapıdaki yapı öğelerini gruplamak için bir temel sınıfı temsil eder.
type: docs
weight: 4200
...
Mantıksal yapıdaki yapı öğelerini gruplamak için bir temel sınıfı temsil eder.
