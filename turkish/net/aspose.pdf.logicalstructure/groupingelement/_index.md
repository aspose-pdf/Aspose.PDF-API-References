...
description: Aspose.Pdf.LogicalStructure.GroupingElement sınıfı. Mantıksal yapıdaki yapı elemanlarını gruplamak için bir temel sınıfı temsil eder.
type: docs
weight: 6370
url: /tr/net/aspose.pdf.logicalstructure/groupingelement/
---
## GroupingElement sınıfı

Mantıksal yapıdaki yapı elemanlarını gruplamak için bir temel sınıfı temsil eder.
