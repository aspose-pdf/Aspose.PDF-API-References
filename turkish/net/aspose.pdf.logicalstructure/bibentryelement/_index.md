...
description: Aspose.Pdf.LogicalStructure.BibEntryElement sınıfı. Mantıksal yapıdaki BibEntry yapı elemanını temsil eder
type: docs
weight: 6260
url: /tr/net/aspose.pdf.logicalstructure/bibentryelement/
---
## BibEntryElement sınıfı

Mantıksal yapıdaki BibEntry yapı elemanını temsil eder.
