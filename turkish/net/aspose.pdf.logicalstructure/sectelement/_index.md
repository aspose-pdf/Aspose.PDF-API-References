...
description: Aspose.Pdf.LogicalStructure.SectElement sınıfı. Mantıksal yapıdaki Sect yapı elemanını temsil eder
type: docs
weight: 6640
url: /tr/net/aspose.pdf.logicalstructure/sectelement/
---
## SectElement sınıfı

Mantıksal yapıdaki Sect yapı elemanını temsil eder.
