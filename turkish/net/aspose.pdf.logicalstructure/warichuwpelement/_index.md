...
description: Aspose.Pdf.LogicalStructure.WarichuWPElement sınıfı. Warichu'nun mantıksal yapısındaki WP yapı elemanını temsil eder.
type: docs
weight: 6880
url: /tr/net/aspose.pdf.logicalstructure/warichuwpelement/
---
## WarichuWPElement sınıfı

Warichu'nun mantıksal yapısındaki WP yapı elemanını temsil eder.
