...
description: Aspose.Pdf.LogicalStructure.ListLBodyElement sınıfı. Listenin mantıksal yapısındaki LBody yapı elemanını temsil eder
type: docs
weight: 6470
url: /tr/net/aspose.pdf.logicalstructure/listlbodyelement/
---
## ListLBodyElement sınıfı

Listenin mantıksal yapısındaki LBody yapı elemanını temsil eder.
