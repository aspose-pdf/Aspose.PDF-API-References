...
description: Aspose.Pdf.LogicalStructure.FormElement sınıfı. Mantıksal yapıdaki Form yapı elemanını temsil eder
type: docs
weight: 6350
url: /tr/net/aspose.pdf.logicalstructure/formelement/
---
## FormElement Sınıfı

Mantıksal yapıdaki Form yapı elemanını temsil eder.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | Yapıdan bir elemanı, ona olan referansı üst nesneden, ona olan referansları çocuk nesnelerden ve belgede ilgili nesneyi kaldırır. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Yapıdan bir elemanı, ona olan referansı üst nesneden, ona olan referansları çocuk nesnelerden ve belgede ilgili nesneyi kaldırır. Kaldırılan nesnenin çocuk nesnelerini, kaldırılan nesnenin eski üst çocuk nesneler koleksiyonuna, kaldırılan nesnenin indeksinden başlayarak ekler. |
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | Mevcut illüstrasyon elemanına resim ekler. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | Mevcut illüstrasyon elemanına resim ekler. |
...
* sınıf [IllustrationElement](../illustrationelement/)
