...
description: Mantıksal yapıdaki Listenin alt öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 4280
...
Mantıksal yapıdaki Listenin alt öğeleri için bir temel sınıfı temsil eder.
