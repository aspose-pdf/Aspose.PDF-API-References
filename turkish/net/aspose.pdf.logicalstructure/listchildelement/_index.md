...
description: Aspose.Pdf.LogicalStructure.ListChildElement sınıfı. Mantıksal yapıdaki Liste'nin çocuk öğeleri için bir temel sınıfı temsil eder.
type: docs
weight: 6450
url: /tr/net/aspose.pdf.logicalstructure/listchildelement/
---
## ListChildElement sınıfı

Mantıksal yapıdaki Liste'nin çocuk öğeleri için bir temel sınıfı temsil eder.
