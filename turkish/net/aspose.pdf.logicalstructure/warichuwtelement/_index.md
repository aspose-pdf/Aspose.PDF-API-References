...
description: Aspose.Pdf.LogicalStructure.WarichuWTElement sınıfı. Warichu'nun mantıksal yapısındaki WT yapı elemanını temsil eder.
type: docs
weight: 6890
url: /tr/net/aspose.pdf.logicalstructure/warichuwtelement/
---
## WarichuWTElement sınıfı

Warichu'nun mantıksal yapısındaki WT yapı elemanını temsil eder.
...
* sınıf [WarichuChildElement](../warichuchildelement/)
