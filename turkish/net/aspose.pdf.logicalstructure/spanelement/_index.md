...
description: Aspose.Pdf.LogicalStructure.SpanElement sınıfı. Mantıksal yapıdaki Span yapı elemanını temsil eder
type: docs
weight: 6650
url: /tr/net/aspose.pdf.logicalstructure/spanelement/
---
## SpanElement sınıfı

Mantıksal yapıdaki Span yapı elemanını temsil eder.
