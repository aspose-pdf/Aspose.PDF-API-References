...
description: "توقيع ملف PDF باستخدام توقيعات رقمية منفصلة."
type: docs
url: /ar/javascript-cpp/security/asposepdfsignpkcs7detached/
---

_توقيع ملف PDF باستخدام توقيعات رقمية منفصلة._
