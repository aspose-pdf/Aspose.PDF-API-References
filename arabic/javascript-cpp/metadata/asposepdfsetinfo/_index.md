...
type: docs
url: /ar/javascript-cpp/metadata/asposepdfsetinfo/
---

_تعيين المعلومات (البيانات الوصفية) في ملف PDF._
...
لِـ 'title'، 'creator'، 'author'، 'subject'، 'keywords'، 'creation' و 'mod'، إذا لم تحتاج إلى تعيين قيمة، استخدم undefined أو "" (سلسلة فارغة)
