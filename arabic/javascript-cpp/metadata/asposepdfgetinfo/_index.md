...
description: "الحصول على المعلومات (البيانات الوصفية) من ملف PDF."
type: docs
url: /ar/javascript-cpp/metadata/asposepdfgetinfo/
---

_احصل على المعلومات (البيانات الوصفية) من ملف PDF._
