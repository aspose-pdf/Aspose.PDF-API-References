...
description: فئة تمثل حقل مربع نص .
type: docs
weight: 3250
...
| اسم | وصف |
| --- | --- |
| [TextBoxField](textboxfield#constructor)() | إنشاء مثيل لـ TextBoxField. |
| [TextBoxField](textboxfield#constructor_1)(Document) | المُنشئ الذي يجب استخدامه مع المولد. |
