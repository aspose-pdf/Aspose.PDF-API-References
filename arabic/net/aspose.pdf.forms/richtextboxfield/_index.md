...
description: يصف Class مكون محرر النص المنسق.
type: docs
weight: 3180
...
يصف Class مكون محرر النص المنسق.
...
| اسم | وصف |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | مُنشئ حقل Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | الحصول على أو تعيين قيمة نص منسق مع الترميز. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | الحصول على أو تعيين تبرير لمربع النص المنسق. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue) { get; set; } | الحصول على قيمة نص منسق أو تعيينها. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | الحصول على سلسلة نمط افتراضية لحقل النص المنسق أو تعيينها. |
