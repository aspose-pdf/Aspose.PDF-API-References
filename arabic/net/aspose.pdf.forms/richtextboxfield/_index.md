---
title: "الفئة RichTextBoxField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Forms.RichTextBoxField. تصف الفئة مكوّن محرر النص الغني."
type: docs
weight: 5350
...
الفئة تصف مكوّن محرر النص الغني.
...
| الاسم | الوصف |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | منشئ حقل Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | يحصل أو يعيّن قيمة النص الغني المنسق مع العلامات. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | يحصل أو يعيّن محاذاة صندوق النص الغني. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | يحصل أو يعيّن قيمة النص الغني. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | يحصل أو يعيّن سلسلة النمط الافتراضية لحقل النص المنسق. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | قيمة حقل النص المنسق. |
