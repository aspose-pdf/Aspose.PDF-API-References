---
title: "الفئة ChoiceField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Forms.ChoiceField. تمثّل الفئة الأساسية لحقول الاختيار"
type: docs
weight: 5110
...
| الاسم | الوصف |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | ينشئ حقل اختيار (للمُولّد) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | منشئ للفئة ChoiceField. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | منشئ للفئة ChoiceField. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | يضيف خيارًا جديدًا بقيمة تصدير واسم محددين. |
