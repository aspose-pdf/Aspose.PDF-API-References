...
description: فئة Aspose.Pdf.Forms.PasswordBoxField. تصف الفئة حقل نص لإدخال كلمة المرور
type: docs
weight: 5200
url: /ar/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField class

تصف الفئة حقل نص لإدخال كلمة المرور.
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | يستورد البيانات إلى الحقل المحدد من تدفق JSON، باستخدام الاسم الكامل المحدد في متغير 'fieldFullNameInJSON' للتطابق. |
