...
description: حقل التاريخ مع عرض التقويم.
type: docs
weight: 2960
...
| اسم | وصف |
| --- | --- |
| [DateField](datefield#constructor)() | يقوم بتهيئة مثيل جديد لملف[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | المُنشئ الذي يجب استخدامه مع المولد. |
| [DateField](datefield#constructor_2)(Document, Rectangle) | يقوم بتهيئة مثيل جديد لملف[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | يقوم بتهيئة مثيل جديد لملف[`DateField`](../datefield) |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat) { get; set; } | الحصول على تنسيق التاريخ أو تحديده. |
...
| [Value](../../aspose.pdf.forms/datefield/value) { get; set; } | الحصول على التاريخ أو تحديده . |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | تم رفض إضافة الصورة لهذا الحقل . (2 methods) |
...
DateField dateField = حقل تاريخ جديد (صفحة ، مستقيم) doc.Form.Add (dateField) dateField.Init (صفحة)
