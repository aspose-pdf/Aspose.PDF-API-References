---
title: "الفئة BarcodeField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Forms.BarcodeField. فئة تمثل حقل الباركود."
type: docs
weight: 5070
...
| الاسم | الوصف |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | يُهيئ نسخة جديدة من فئة `BarcodeField`. |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | يُهيئ نسخة جديدة من فئة `BarcodeField`. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | يعيد قيمة عددية تمثل معامل تصحيح الخطأ. بالنسبة لـ PDF417، يجب أن تكون من 0 إلى 8. بالنسبة لـ QRCode، يجب أن تكون من 0 إلى 3 (0 لـ 'L'، 1 لـ 'M'، 2 لـ 'Q'، و3 لـ 'H'). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | يحصل على الدقة، بالنقطة لكل بوصة (dpi)، التي يُرسم بها كائن الباركود. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | يحدد أي تقنية باركود أو رموز يجب استخدامها في هذه التعليقة، راجع [`Symbology`](./symbology/) للحصول على التفاصيل. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | يحصل على المسافة العمودية بين وحدتي باركود، مقاسة بالبكسل. يجب أن تكون نسبة XSymHeight/XSymWidth قيمة صحيحة. بالنسبة لـ PDF417، النطاق المقبول للنسبة هو من 1 إلى 4. بالنسبة لـ QRCode و DataMatrix، يجب أن تكون هذه النسبة دائمًا 1. |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | يحصل على المسافة الأفقية، بالبكسل، بين وحدتي باركود. |
