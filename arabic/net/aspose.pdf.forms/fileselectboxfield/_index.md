...
description: فئة Aspose.Pdf.Forms.FileSelectBoxField. حقل لعنصر صندوق اختيار الملفات
type: docs
weight: 5060
url: /ar/net/aspose.pdf.forms/fileselectboxfield/
---
## FileSelectBoxField class

حقل لعنصر صندوق اختيار الملفات.
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | يحصل أو يحدد محاذاة النص العمودية للتعليق. |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | يحصل أو يحدد قيمة صحيحة تشير إلى ترتيب Z للرسم. سيتم وضع رسم ذو ZIndex أكبر فوق الرسم ذو ZIndex أصغر. يمكن أن تكون ZIndex سلبية. سيتم وضع رسم ذو ZIndex سلبية خلف النص في الصفحة. |
