...
description: تمثل الفئة عنصر حقل RadioButton .
type: docs
weight: 3170
...
تمثل الفئة عنصر حقل RadioButton .
...
| اسم | وصف |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | إنشاء مثيل RadioButtonOptionField جديد. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | لتكوين زر إشعاعي بالمسرح المحدد بالصفحة المحددة. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption) { get; set; } | الحصول على التسمية التوضيحية أو تعيينها . |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname) { get; set; } | الحصول على اسم الخيار أو تعيينه. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style) { get; set; } | الحصول على نمط مربع الاختيار أو تعيينه. |
