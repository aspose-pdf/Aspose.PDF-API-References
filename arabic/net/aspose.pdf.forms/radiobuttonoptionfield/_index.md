---
title: "الفئة RadioButtonOptionField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Forms.RadioButtonOptionField class. الفئة تمثل عنصر حقل RadioButton."
type: docs
weight: 5340
...
الفئة تمثل عنصرًا من حقل RadioButton.
...
| الاسم | الوصف |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | إنشاء نسخة جديدة من RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | ينشئ radiobutton في المستطيل المحدد على الصفحة المحددة. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | الحصول على أو تعيين التسمية. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | يحصل أو يعيّن اسم الخيار. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | يحصل أو يعيّن نمط مربع الاختيار. |
