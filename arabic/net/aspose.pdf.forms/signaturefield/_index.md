---
title: "فئة SignatureField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Forms.SignatureField. تمثّل حقل نموذج التوقيع"
type: docs
weight: 5410
...
| الاسم | الوصف |
| --- | --- |
| [SignatureField](signaturefield/#constructor)(Document, Rectangle) | يُهيّئ نسخة جديدة من الفئة `SignatureField`. |
| [SignatureField](signaturefield/#constructor_1)(Page, Rectangle) | يُهيّئ نسخة جديدة من الفئة `SignatureField`. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | يحصل على كائن التوقيع. يحتوي هذا الكائن على بيانات التوقيع المتعلقة بمعايير التشفير بالمفتاح العام. الفئات [`PKCS1`](../pkcs1/)، [`PKCS7`](../pkcs7/) و[`PKCS7Detached`](../pkcs7detached/) تمثّل جميع الأنواع المدعومة من كائنات التوقيع. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | يستخرج شهادة X.509 الوحيدة بتنسيق DER كدفق. |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | يستخرج كائن شهادة X.509 الوحيدة. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | يستخرج صورة التوقيع كدفق مشفر بصيغة JPEG. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | يستخرج صورة التوقيع كدفق مشفر. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign)(Signature) | وقّع المستند باستخدام حقل التوقيع هذا. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign_1)(Signature, Stream, string) | يوقّع المستند باستخدام حقل التوقيع هذا. |
