...
| اسم | وصف |
| --- | --- |
| [SignatureField](signaturefield#constructor)(Document, Rectangle) | تهيئة مثيل جديد لملف[`SignatureField`](../signaturefield) فئة . |
| [SignatureField](signaturefield#constructor_1)(Page, Rectangle) | تهيئة مثيل جديد لملف[`SignatureField`](../signaturefield) فئة . |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature) { get; } | الحصول على كائن التوقيع . يحتوي هذا الكائن على بيانات التوقيع المتعلقة بمعايير تشفير المفتاح العام . الفئات[`PKCS1`](../pkcs1) و[`PKCS7`](../pkcs7) و[`PKCS7Detached`](../pkcs7detached) يمثل جميع أنواع كائنات التوقيع المدعومة. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate)() | لاستخراج شهادة X.509 المفردة بتنسيق DER كتدفق. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage)() | استخراج صورة التوقيع كدفق مشفر بتنسيق jpeg . |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage#extractimage_1)(ImageFormat) | استخراج صورة التوقيع كدفق مشفر. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign)(Signature) | وقّع على المستند باستخدام حقل التوقيع هذا. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign#sign_1)(Signature, Stream, string) | توقيع المستند باستخدام حقل التوقيع هذا. |
