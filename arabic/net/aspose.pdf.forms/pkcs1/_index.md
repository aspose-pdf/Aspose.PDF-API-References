...
description: يمثل كائن التوقيع فيما يتعلق بمعيار PKCS  1 . يتم استخدام خوارزمية تشفير RSA وطريقة SHA-1 للتوقيع.
type: docs
weight: 3120
...
يمثل كائن التوقيع فيما يتعلق بمعيار PKCS # 1 . يتم استخدام خوارزمية تشفير RSA وطريقة SHA-1 للتوقيع.
...
| اسم | وصف |
| --- | --- |
| [PKCS1](pkcs1#constructor)() | تهيئة مثيل جديد لملف[`PKCS1`](../pkcs1) فئة . |
| [PKCS1](pkcs1#constructor_1)(Stream) | تهيئة مثيل جديد لملف[`PKCS1`](../pkcs1) فئة . |
| [PKCS1](pkcs1#constructor_2)(Stream, string) | تهيئة مثيل جديد لملف[`PKCS1`](../pkcs1) فئة . |
| [PKCS1](pkcs1#constructor_3)(string, string) | تهيئة مثيل جديد لملف[`PKCS1`](../pkcs1) فئة . |
