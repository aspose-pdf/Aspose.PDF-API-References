---
title: "الفئة ListBoxField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Forms.ListBoxField. تمثل الفئة حقل ListBox."
type: docs
weight: 5250
...
| الاسم | الوصف |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | منشئ ListBoxField لاستخدامه في Generator. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | منشئ حقل ListBox. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | يحصل أو يعيّن فهرس العنصر المحدد. تُرقم العناصر بدءًا من 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | يحصل أو يعيّن مصفوفة العناصر المحددة في قائمة التحديد المتعدد. بالنسبة لقائمة التحديد الأحادي تُعيد مصفوفة تحتوي على عنصر واحد. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | يحصل أو يعيّن فهرس العنصر العلوي المرئي في القائمة. |
