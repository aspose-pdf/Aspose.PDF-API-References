...
description: تمثل الفئة حقل ListBox .
type: docs
weight: 3080
...
| اسم | وصف |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | مُنشئ ListBoxField لاستخدامه في المولد. |
| [ListBoxField](listboxfield#constructor_1)(Document, Rectangle) | مُنشئ حقل ListBox . |
| [ListBoxField](listboxfield#constructor_2)(Page, Rectangle) | إنشاء حقل ListBox جديد . |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | الحصول على فهرس العنصر المحدد أو تعيينه. العناصر مرقمة من 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | الحصول على أو تعيين مجموعة من العناصر المحددة في قائمة التحديد المتعدد. لقائمة محددة بإرجاع مصفوفة تحتوي على عنصر واحد. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex) { get; set; } | الحصول على أو تعيين فهرس لأعلى عنصر مرئي في القائمة. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption)(string) | إضافة خيار جديد بالاسم المحدد. |
