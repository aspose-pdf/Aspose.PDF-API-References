...
description: فئة Aspose.Pdf.Forms.ListBoxField. تمثل الفئة حقل ListBox
type: docs
weight: 5130
url: /ar/net/aspose.pdf.forms/listboxfield/
---
## فئة ListBoxField

تمثل الفئة حقل ListBox.
...
| الاسم | الوصف |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | منشئ لحقل ListBox ليتم استخدامه في المولد. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | منشئ لحقل ListBox. |
| [ListBoxField](listboxfield/#constructor_2)(Page, Rectangle) | ينشئ حقل ListBox جديد. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | يحصل أو يحدد فهرس العنصر المحدد. العناصر مرقمة من 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | يحصل أو يحدد مصفوفة العناصر المحددة في قائمة التحديد المتعدد. لقائمة التحديد الفردي، تعيد مصفوفة تحتوي على عنصر واحد. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | يحصل أو يحدد فهرس العنصر العلوي المرئي في القائمة. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string, string) | يضيف خيارًا جديدًا بالقيمة المحددة للاستخدام والاسم. |
