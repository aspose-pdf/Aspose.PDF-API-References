...
description: يمثل كائن PKCS  7 الذي يتوافق مع مواصفات PKCS  7 في Internet RFC 2315  PKCS  7 بنية الرسائل المشفرة  الإصدار 1.5. تم دمج ملخص الرسالة الأصلية الموقعة على نطاق بايت المستند باعتباره PKCS  العادي 7 حقل بيانات التوقيع. لن يتم تغليف أي بيانات في حقل البيانات الموقّعة PKCS  7.
type: docs
weight: 3140
...
| اسم | وصف |
| --- | --- |
| [PKCS7Detached](pkcs7detached#constructor)() | تهيئة مثيل جديد لملف[`PKCS7Detached`](../pkcs7detached) فئة . |
| [PKCS7Detached](pkcs7detached#constructor_1)(Stream) | تهيئة مثيل جديد لملف[`PKCS7Detached`](../pkcs7detached) فئة . |
| [PKCS7Detached](pkcs7detached#constructor_2)(Stream, string) | تهيئة مثيل جديد لملف[`PKCS7Detached`](../pkcs7detached) فئة . |
| [PKCS7Detached](pkcs7detached#constructor_3)(string, string) | تهيئة مثيل جديد لملف[`PKCS7Detached`](../pkcs7detached) فئة . |
