...
description: فئة Aspose.Pdf.Forms.ComboBoxField. فئة تمثل حقل Combobox في النموذج
type: docs
weight: 5000
url: /ar/net/aspose.pdf.forms/comboboxfield/
---
## ComboBoxField class

فئة تمثل حقل Combobox في النموذج.
...
| Name | Description |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | مُنشئ لـ ComboBoxField لاستخدامه في المولد. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | ينشئ حقل CombBox للعمل مع المولد. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | مُنشئ لحقل Combobox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | مُنشئ لحقل Combobox. |
...
| [AnnotationIndex](../../aspose.pdf.forms/field/annotationindex/) { get; set; } | يحصل أو يحدد فهرس هذه التعليق على الصفحة. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | يحصل أو يحدد حالة تحرير الحقل. |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | خاصية لدعم المولد. تُستخدم عندما يتم إضافة الحقل إلى الرأس أو التذييل. إذا كانت القيمة true، سيتم إنشاء هذا الحقل مرة واحدة وسيكون مظهره مرئيًا في جميع صفحات الوثيقة. إذا كانت القيمة false، سيتم إنشاء حقل منفصل لكل صفحة من صفحات الوثيقة. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | يحصل أو يحدد فهرس الخيار المحدد. تسمح هذه الخاصية بتغيير الاختيار. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | يحصل أو يحدد حالة نشاط التدقيق الإملائي. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string) | يضيف خيارًا جديدًا بالاسم المحدد. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string, string) | يضيف خيارًا جديدًا بالقيمة المحددة للتصدير والاسم. |
...
| [GetCheckedStateName](../../aspose.pdf.annotations/widgetannotation/getcheckedstatename/)() | يُرجع اسم الحالة "المؤشر" وفقًا لأسماء الحالات الموجودة. |
