---
title: "الفئة ComboBoxField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Forms.ComboBoxField. الفئة التي تمثل حقل القائمة المنسدلة في النموذج"
type: docs
weight: 5120
...
| الاسم | الوصف |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | منشئ لـ ComboBoxField لاستخدامه في المولد. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | ينشئ حقل CombBox للعمل مع المولد. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | منشئ لحقل Combobox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | منشئ لحقل Combobox. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | يحصل أو يعيّن حالة القابلية للتحرير للحقل. |
...
| virtual [Options](../../aspose.pdf.forms/choicefield/options/) { get; } | يحصل على مجموعة خيارات الاختيار. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | يحصل أو يعيّن فهرس الخيار المحدد. تسمح هذه الخاصية بتغيير الاختيار. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | يحصل أو يعيّن حالة نشاط التدقيق الإملائي. |
...
| override [Value](../../aspose.pdf.forms/choicefield/value/) { get; set; } | يحصل أو يعيّن قيمة الحقل. |
