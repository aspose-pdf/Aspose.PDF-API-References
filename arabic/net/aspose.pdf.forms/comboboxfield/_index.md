...
description: فئة تمثل حقل Combobox بالشكل.
type: docs
weight: 2950
...
| اسم | وصف |
| --- | --- |
| [ComboBoxField](comboboxfield#constructor)() | مُنشئ ComboBoxField لاستخدامه في المولد. |
| [ComboBoxField](comboboxfield#constructor_1)(Document) | إنشاء حقل CombBox للعمل مع المولد. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | مُنشئ حقل Combobox. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | مُنشئ حقل Combobox. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable) { get; set; } | الحصول على أو تعيين الحالة القابلة للتحرير للحقل. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck) { get; set; } | الحصول على حالة نشاط التهجئة الإملائية أو تعيينها. |
