...
description: "فئة Aspose.Pdf.Forms.PKCS7. تمثل كائن PKCS7 المتوافق مع مواصفة PKCS7 في RFC 2315 للإنترنت PKCS 7 Cryptographic Message Syntax الإصدار 1.5. يتم تضمين ملخص SHA1 لنطاق بايتات المستند في حقل PKCS7 SignedData."
type: docs
weight: 5300
...
يمثل كائن PKCS#7 المتوافق مع مواصفة PKCS#7 في RFC 2315 على الإنترنت، PKCS #7: صيغ الرسائل المشفرة، الإصدار 1.5. يتم تضمين `SHA1 digest` لنطاق بايتات المستند في حقل PKCS#7 SignedData.
...
| الاسم | الوصف |
| --- | --- |
| [PKCS7](pkcs7/#constructor)() | يُهيئ نسخة جديدة من الفئة `PKCS7`. |
| [PKCS7](pkcs7/#constructor_1)(Stream, string) | يُهيئ نسخة جديدة من الفئة `PKCS7`. |
| [PKCS7](pkcs7/#constructor_2)(string, string) | يُهيئ نسخة جديدة من الفئة `PKCS7`. |
