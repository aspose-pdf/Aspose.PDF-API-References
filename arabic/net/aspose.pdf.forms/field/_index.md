...
description: "Aspose.Pdf.Forms.Field الفئة. الفئة الأساسية لحقول النماذج القابلة للتعبئة"
type: docs
weight: 5170
...
| الاسم | الوصف |
| --- | --- |
| [Field](field/)(Document) | ينشئ حقلًا للاستخدام في Generator. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | إذا كان صحيحًا فسيتم تقليل حجم الخط لتناسب النص مع المستطيل المحدد. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | يستورد البيانات إلى الحقول المحددة من دفق JSON، بناءً على مطابقة دقيقة لأسماء الحقول الكاملة. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | يستورد البيانات إلى الحقل المحدد من دفق JSON، باستخدام الاسم الكامل المحدد في المتغيّر 'fieldFullNameInJSON' للمطابقة. |
