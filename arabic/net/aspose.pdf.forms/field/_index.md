...
description: فئة Aspose.Pdf.Forms.Field. الفئة الأساسية لحقول نموذج Acro
type: docs
weight: 5050
...
| الاسم | الوصف |
| --- | --- |
| [Field](field/)(Document) | ينشئ حقل للاستخدام في المولد. |
...
| [Item](../../aspose.pdf.forms/field/item/) { get; } | يحصل على الحقل الفرعي الموجود في هذا الحقل بواسطة اسم الحقل الفرعي. (2 فهارس) |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | إذا كانت القيمة true، فسيتم تقليل حجم الخط ليتناسب النص مع المستطيل المحدد. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | الحد الأقصى لحجم الخط الذي يمكن استخدامه لمحتويات الحقل. -1 لعدم التحقق من الحجم. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | الحد الأدنى لحجم الخط الذي يمكن استخدامه لمحتويات الحقل. -1 لعدم التحقق من الحجم. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | ينسخ الحقول الفرعية لهذا الحقل إلى مصفوفة بدءًا من الفهرس المحدد. |
...
| [GetCheckedStateName](../../aspose.pdf.annotations/widgetannotation/getcheckedstatename/)() | تعيد اسم حالة "محدد" وفقًا لأسماء الحالات الموجودة. |
| [GetEnumerator](../../aspose.pdf.forms/field/getenumerator/)() | تعيد عداد الحقول المحتواة. |
| [GetRectangle](../../aspose.pdf.annotations/annotation/getrectangle/)(bool) | تعيد مستطيل التعليق مع الأخذ في الاعتبار دوران الصفحة. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | تستورد البيانات إلى الحقول المحددة من تدفق JSON، بناءً على مطابقة دقيقة لأسماء الحقول الكاملة. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | تستورد البيانات إلى الحقل المحدد من تدفق JSON، باستخدام الاسم الكامل المحدد في متغير 'fieldFullNameInJSON' للمطابقة. |
