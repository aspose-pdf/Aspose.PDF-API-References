---
title: "الفئة NumberField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Forms.NumberField الفئة. حقل نص مع أحرف صالحة محددة"
type: docs
weight: 5260
...
| الاسم | الوصف |
| --- | --- |
| [NumberField](numberfield/#constructor)() | يُنشئ نسخة جديدة من الفئة `NumberField`. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | يُنشئ نسخة جديدة من الفئة `NumberField`. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | يُنشئ نسخة جديدة من الفئة `NumberField`. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | يحصل أو يعيّن الأحرف المسموح بها. |
