...
| اسم | وصف |
| --- | --- |
| [RadioButtonField](radiobuttonfield#constructor)(Document) | مُنشئ RadioButtonField . |
| [RadioButtonField](radiobuttonfield#constructor_1)(Page) | مُنشئ RadiouttonField |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options) { get; } | الحصول على مجموعة من خيارات زر الاختيار. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex) { get; } | يحصل على فهرس الصفحة الذي يحتوي على حقل RadioButton هذا. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | الحصول على فهرس العنصر المحدد أو تعيينه. بدأ ترقيم العناصر من 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style) { get; set; } | نمط مربع الحقل . |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value) { get; set; } | الحصول على قيمة الحقل أو تعيينها. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | يضيف حقل خيار جديد إلى RadioButton field |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | إضافة خيار إلى زر Radion. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | إضافة خيار زر الاختيار مع مستطيل محدد. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption)(string, string) | يضيف خيارًا جديدًا بقيمة واسم تصدير محددين. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition)(Point) | نقل كافة العناصر الفرعية لزر الاختيار إلى مواضع محددة على الصفحة. |
