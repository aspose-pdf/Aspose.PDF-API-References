...
description: حقل زر ضغط فئة represnets .
type: docs
weight: 2920
...
| اسم | وصف |
| --- | --- |
| [ButtonField](buttonfield#constructor)() | مُنشئ حقل الزر للمولد. |
| [ButtonField](buttonfield#constructor_1)(Document, Rectangle) | مُنشئ ButtonField. |
| [ButtonField](buttonfield#constructor_2)(Page, Rectangle) | مُنشئ ButtonField . |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | الحصول على أو تعيين التسمية التوضيحية البديلة للزر التي يجب عرضها عند الضغط على زر الماوس داخل المنطقة النشطة . |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | الحصول على أو تعيين رمز بديل يتم عرضه عند الضغط على زر الماوس داخل منطقته النشطة. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | الحصول على كائن مناسب للرمز يحدد كيفية عرض رمز التعليق التوضيحي لعنصر واجهة المستخدم داخل مستطيل التعليق التوضيحي. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition) { get; set; } | الحصول على أو تعيين موضع التسمية التوضيحية للرمز . |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption) { get; set; } | الحصول على تسمية توضيحية عادية أو تعيينها. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon) { get; set; } | الحصول على أو تعيين الرمز العادي للزر الذي سيتم عرضه عندما لا يتفاعل مع المستخدم. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | الحصول على أو تعيين التسمية التوضيحية للزر التي يتم عرضها عندما يقوم المستخدم بتدوير المؤشر إلى المنطقة النشطة دون الضغط على زر الماوس. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | الحصول على أو تعيين رمز التمرير للزر الذي سيتم عرضه عندما يقوم المستخدم بتدوير المؤشر إلى المنطقة النشطة دون الضغط على زر الماوس. |
