---
title: "الفئة ButtonField"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Forms.ButtonField. الفئة تمثّل حقل زر الضغط"
type: docs
weight: 5090
...
| الاسم | الوصف |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | منشئ حقل الزر للمُولّد. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | يحصل أو يعيّن التسمية البديلة للزر التي ستُعرض عندما يُضغط زر الفأرة داخل المنطقة النشطة له. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | يحصل أو يعيّن الأيقونة البديلة التي ستُعرض عندما يُضغط زر الفأرة داخل المنطقة النشطة له. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | يحصل على كائن ملاءمة الأيقونة الذي يحدد كيفية عرض أيقونة التعليق التوضيحي للعنصر داخل مستطيل التعليق الخاص به. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | يحصل أو يعيّن موضع تسمية الأيقونة. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | يحصل أو يعيّن التسمية العادية. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | يحصل أو يعيّن الأيقونة العادية للزر التي ستُعرض عندما لا يتفاعل مع المستخدم. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | يحصل أو يعيّن تسمية التمرير للزر التي ستُعرض عندما يمرّر المستخدم المؤشر إلى منطقته النشطة دون ضغط زر الفأرة. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | يحصل أو يعيّن أيقونة التمرير للزر التي ستُعرض عندما يمرّر المستخدم المؤشر إلى منطقته النشطة دون ضغط زر الفأرة. |
...
| virtual [Value](../../aspose.pdf.forms/field/value/) { get; set; } | يحصل أو يعيّن قيمة الحقل. |
