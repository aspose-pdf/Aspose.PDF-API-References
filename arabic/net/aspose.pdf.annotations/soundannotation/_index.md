...
description: يمثل تعليقًا توضيحيًا صوتيًا يحتوي على صوت مسجل من ميكروفون الكمبيوتر أو تم استيراده من ملف.
type: docs
weight: 1080
...
يمثل تعليقًا توضيحيًا صوتيًا يحتوي على صوت مسجل من ميكروفون الكمبيوتر أو تم استيراده من ملف.
...
| اسم | وصف |
| --- | --- |
| [SoundAnnotation](soundannotation#constructor)(Page, Rectangle, string) | إنشاء تعليق توضيحي صوتي جديد في الصفحة المحددة. |
| [SoundAnnotation](soundannotation#constructor_1)(Page, Rectangle, string, SoundSampleData) | إنشاء تعليق توضيحي صوتي جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | الحصول على أو تعيين رمز لاستخدامه في عرض التعليق التوضيحي. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | يحصل على كائن صوتي يحدد الصوت الذي سيتم تشغيله عند تنشيط التعليق التوضيحي. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
