---
title: "الفئة SoundAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.SoundAnnotation. تمثّل تعليقًا صوتيًا يحتوي على صوت مسجّل من ميكروفون الحاسوب أو مستورد من ملف."
type: docs
weight: 2630
...
يمثل تعليق توضيحي صوتي يحتوي على صوت مسجل من ميكروفون الحاسوب أو مستورد من ملف.
...
| الاسم | الوصف |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | ينشئ توضيح صوت جديد على الصفحة المحددة. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | ينشئ توضيح صوت جديد على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | يحصل أو يعيّن أيقونة لاستخدامها في عرض التعليق التوضيحي. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | يحصل على كائن صوت يحدد الصوت الذي سيُشغل عندما يتم تنشيط التعليق التوضيحي. |
