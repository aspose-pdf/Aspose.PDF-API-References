...
description: يمثل التعليق التوضيحي المنبثق الذي يعرض النص في نافذة منبثقة للدخول والتحرير.
type: docs
weight: 940
...
يمثل التعليق التوضيحي المنبثق الذي يعرض النص في نافذة منبثقة للدخول والتحرير.
...
| اسم | وصف |
| --- | --- |
| [PopupAnnotation](popupannotation#constructor)(Document) | المُنشئ. لاستخدامها في المولد. |
| [PopupAnnotation](popupannotation#constructor_1)(Page, Rectangle) | إنشاء تعليق توضيحي منبثق جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open) { get; set; } | الحصول على علامة تحدد ما إذا كان يجب عرض التعليق التوضيحي المنبثق مفتوحًا في البداية أم لا. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex) { get; } | يحصل على فهرس للصفحة التي تحتوي على تعليق توضيحي. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent) { get; set; } | الحصول على أو تعيين التعليق التوضيحي الرئيسي الذي يجب أن يقترن به هذا التعليق التوضيحي المنبثق . إذا كان هذا الإدخال موجودًا ، يجب أن تتجاوز إدخالات التعليق التوضيحي الأصلي وإدخالات M و C و T تلك الموجودة في التعليق التوضيحي المنبثق نفسه. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
