...
description: فئة Aspose.Pdf.Annotations.TextMarkupAnnotation. فئة أساسية مجردة لتعليقات النصوص
type: docs
weight: 2670
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | يحصل أو يحدد مصفوفة من النقاط تحدد إحداثيات n رباعيات الأضلاع. كل رباعي يحيط بكلمة أو مجموعة من الكلمات المتجاورة في النص الأساسي للتعليق. |
