---
title: "الفئة TextMarkupAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.TextMarkupAnnotation. الفئة الأساسية المجردة لتعليقات توضيح النص"
type: docs
weight: 2770
url: /ar/net/aspose.pdf.annotations/textmarkupannotation/
---
## TextMarkupAnnotation class

فئة أساسية مجردة لتعليمات التعليقات التوضيحية للعلامات النصية.
...
| abstract [AnnotationType](../../aspose.pdf.annotations/annotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| الاسم | الوصف |
| --- | --- |
| abstract [Accept](../../aspose.pdf.annotations/annotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق التوضيحي. |
