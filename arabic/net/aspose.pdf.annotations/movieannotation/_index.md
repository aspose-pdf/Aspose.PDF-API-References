...
description: يمثل تعليقًا توضيحيًا لفيلم يحتوي على رسومات متحركة وصوت لعرضه على شاشة الكمبيوتر ومن خلال مكبرات الصوت. عند تنشيط التعليق التوضيحي  يتم تشغيل الفيلم.
type: docs
weight: 730
...
يمثل تعليقًا توضيحيًا لفيلم يحتوي على رسومات متحركة وصوت لعرضه على شاشة الكمبيوتر ومن خلال مكبرات الصوت. عند تنشيط التعليق التوضيحي ، يتم تشغيل الفيلم.
...
| [MovieAnnotation](movieannotation#constructor_1)(Page, Rectangle, string) | إنشاء تعليق توضيحي صوتي جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/movieannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
| [Appearance](../../aspose.pdf.annotations/annotation/appearance) { get; } | الحصول على قاموس مظهر التعليق التوضيحي. |
| [Aspect](../../aspose.pdf.annotations/movieannotation/aspect) { get; set; } | الحصول على أو تحديد عرض وارتفاع الصندوق المحيط بالفيلم ، بالبكسل. |
...
| [File](../../aspose.pdf.annotations/movieannotation/file) { get; set; } | الحصول على أو تعيين مواصفات ملف تحدد ملف الفيلم الذي يصف نفسه بنفسه. |
...
| [Poster](../../aspose.pdf.annotations/movieannotation/poster) { get; set; } | الحصول على أو تعيين علامة أو دفق يحدد ما إذا كان سيتم عرض صورة الملصق التي تمثل الفيلم وكيفية عرضها. إذا كان هذا صحيحًا ، فيجب استرداد صورة الملصق من ملف الفيلم إذا كانت خاطئة ، فلن يتم عرض أي ملصق. |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect) { get; set; } | الحصول على مستطيل التعليق التوضيحي أو تعيينه. |
| [Rotate](../../aspose.pdf.annotations/movieannotation/rotate) { get; set; } | الحصول على أو تحديد عدد الدرجات التي يجب أن يدور بها الفيلم في اتجاه عقارب الساعة بالنسبة إلى الصفحة. يجب أن تكون القيمة من مضاعفات 90. |
...
| [Title](../../aspose.pdf.annotations/movieannotation/title) { get; set; } | الحصول على عنوان التعليق التوضيحي للفيلم أو تحديده. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/movieannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
