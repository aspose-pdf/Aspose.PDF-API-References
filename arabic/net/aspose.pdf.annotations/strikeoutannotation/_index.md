---
title: "الفئة StrikeOutAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation class. يمثل تعليقا بخط شطب يظهر كخط شطب في نص المستند"
type: docs
weight: 2730
...
يمثل تعليق توضيحي شطب يظهر كشطب في نص المستند.
...
| الاسم | الوصف |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | ينشئ تعليقا جديدا من نوع StrikeOut على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
