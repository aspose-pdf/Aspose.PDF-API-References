...
description: يمثل تعليقًا توضيحيًا شطبًا يظهر في شكل شطب في نص المستند.
type: docs
weight: 1180
...
يمثل تعليقًا توضيحيًا شطبًا يظهر في شكل شطب في نص المستند.
...
| اسم | وصف |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation)(Page, Rectangle) | إنشاء تعليق توضيحي StrikeOut جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
