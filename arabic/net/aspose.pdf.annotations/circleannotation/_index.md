...
description: فئة تمثل التعليق التوضيحي للدائرة .
type: docs
weight: 250
...
فئة تمثل التعليق التوضيحي للدائرة .
...
| اسم | وصف |
| --- | --- |
| [CircleAnnotation](circleannotation#constructor)(Document) | مُنشئ التعليق التوضيحي للدائرة. |
| [CircleAnnotation](circleannotation#constructor_1)(Page, Rectangle) | إنشاء تعليق توضيحي لدائرة جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
