---
title: "الفئة CaretAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.CaretAnnotation. فئة تمثل تعليقا من نوع Caret."
type: docs
weight: 1650
...
| الاسم | الوصف |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | منشئ للاستخدام في Generator. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | ينشئ تعليقا جديدًا من نوع Caret على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | يحصل أو يعيّن مستطيل caret. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | يحصل أو يعيّن الرمز المرتبط بـ caret. |
