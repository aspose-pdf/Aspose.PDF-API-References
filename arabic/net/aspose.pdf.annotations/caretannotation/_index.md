...
description: فئة تمثل التعليق التوضيحي بمؤشر الإقحام .
type: docs
weight: 220
...
فئة تمثل التعليق التوضيحي بمؤشر الإقحام .
...
| [CaretAnnotation](caretannotation#constructor_1)(Page, Rectangle) | إنشاء تعليق توضيحي جديد بمؤشر الإقحام في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame) { get; set; } | الحصول على مستطيل علامة الإقحام أو تعيينه . |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol) { get; set; } | الحصول على أو تعيين الرمز المرتبط بمؤشر الإقحام . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
