...
description: يمثل تعليقًا توضيحيًا متعدد الخطوط مشابهًا للمضلع  فيما عدا أن الرأس الأول والأخير غير متصلين ضمنيًا.
type: docs
weight: 930
...
يمثل تعليقًا توضيحيًا متعدد الخطوط مشابهًا للمضلع ، فيما عدا أن الرأس الأول والأخير غير متصلين ضمنيًا.
...
| اسم | وصف |
| --- | --- |
| [PolylineAnnotation](polylineannotation)(Page, Rectangle, Point[]) | إنشاء تعليق توضيحي متعدد الخطوط جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
