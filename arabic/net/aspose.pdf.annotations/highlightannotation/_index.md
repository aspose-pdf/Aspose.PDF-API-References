...
description: يمثل تعليقًا توضيحيًا مميزًا يبرز نطاقًا من النص في المستند.
type: docs
weight: 490
...
يمثل تعليقًا توضيحيًا مميزًا يبرز نطاقًا من النص في المستند.
...
| اسم | وصف |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | إنشاء تعليق توضيحي جديد لإبراز الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
