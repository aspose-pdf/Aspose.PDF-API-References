...
description: "Aspose.Pdf.Annotations.HighlightAnnotation class. تمثل تعليقة تمييز تُبرز نطاقًا من النص في المستند"
type: docs
weight: 1960
...
يمثل ملاحظة تمييز تُبرز نطاقاً من النص في المستند.
...
| الاسم | الوصف |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | ينشئ تعليقة تمييز جديدة على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
