---
title: "فئة PolyAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Annotations.PolyAnnotation. فئة أساسية مجردة لتعليقات poly Annotation"
type: docs
weight: 2380
...
فئة أساسية مجردة للتعليقات التوضيحية المتعددة.
