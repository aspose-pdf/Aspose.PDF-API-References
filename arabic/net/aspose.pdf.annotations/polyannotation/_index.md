...
description: فئة Aspose.Pdf.Annotations.PolyAnnotation. فئة أساسية مجردة للتعليقات المتعددة
type: docs
weight: 2290
url: /ar/net/aspose.pdf.annotations/polyannotation/
---
## فئة PolyAnnotation
...
| abstract [AnnotationType](../../aspose.pdf.annotations/annotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | يحصل أو يحدد نمط نهاية السطر الثاني. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | يحصل أو يحدد نية التعليق المتعدد أو الخط المتعدد. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | يحصل أو يحدد نمط نهاية السطر الأول. |
...
| الاسم | الوصف |
| --- | --- |
| abstract [Accept](../../aspose.pdf.annotations/annotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق. |
...
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | يمسح الحالة ونموذج الحالة للتعليق. على سبيل المثال، يمسح حالة المراجعة لتعليق. لاحظ أن الحالة مخزنة في تعليق نصي آخر يحتوي على مفاتيح الحالة ونموذج الحالة. |
