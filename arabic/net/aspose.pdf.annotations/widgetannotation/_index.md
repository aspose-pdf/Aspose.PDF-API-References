...
description: فئة تمثل التعليق التوضيحي للأداة .
type: docs
weight: 1260
...
فئة تمثل التعليق التوضيحي للأداة .
...
| اسم | وصف |
| --- | --- |
| [WidgetAnnotation](widgetannotation)(Document) | إنشاء تعليق توضيحي (يُستخدم للمولد) |
