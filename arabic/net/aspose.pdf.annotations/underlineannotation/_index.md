---
title: "فئة UnderlineAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Annotations.UnderlineAnnotation. تمثل تعليقة تحتية تظهر كخط سفلي في نص المستند"
type: docs
weight: 2800
...
يمثل توضيح تسطير يظهر كخط سفلي في نص المستند.
...
| الاسم | الوصف |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | ينشئ تعليقة تحتية جديدة على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
