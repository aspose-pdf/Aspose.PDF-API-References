...
description: يمثل تعليقًا توضيحيًا مسطرًا يظهر كتسطير في نص المستند.
type: docs
weight: 1240
...
يمثل تعليقًا توضيحيًا مسطرًا يظهر كتسطير في نص المستند.
...
| اسم | وصف |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | إنشاء تعليق توضيحي جديد تسطير في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
