...
description: Aspose.Pdf.Annotations.UnderlineAnnotation class. يمثل تعليق خط تحت يظهر كخط تحت في نص الوثيقة
type: docs
weight: 2700
url: /ar/net/aspose.pdf.annotations/underlineannotation/
---
## UnderlineAnnotation class

يمثل تعليق خط تحت يظهر كخط تحت في نص الوثيقة.
...
| Name | Description |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | ينشئ تعليق خط تحت جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
...
| [InReplyTo](../../aspose.pdf.annotations/markupannotation/inreplyto/) { get; set; } | مرجع إلى التعليق الذي "يرد عليه" هذا التعليق. يجب أن يكون كلا التعليقين في نفس صفحة الوثيقة. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | يحصل أو يحدد مصفوفة من النقاط تحدد إحداثيات n رباعيات الأضلاع. كل رباعي يحيط بكلمة أو مجموعة من الكلمات المتجاورة في النص الذي تحت التعليق. |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | يحصل أو يحدد قيمة صحيحة تشير إلى ترتيب Z للرسم. سيتم وضع الرسم الذي لديه ZIndex أكبر فوق الرسم الذي لديه ZIndex أصغر. يمكن أن تكون ZIndex سالبة. سيتم وضع الرسم الذي لديه ZIndex سالب خلف النص في الصفحة. |

## Methods

| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق. |
...
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | Clears state and state model for the annotation. على سبيل المثال، يمسح حالة المراجعة لتعليق. لاحظ أن الحالة مخزنة في تعليق نص آخر يحتوي على مفاتيح الحالة ونموذج الحالة. |
