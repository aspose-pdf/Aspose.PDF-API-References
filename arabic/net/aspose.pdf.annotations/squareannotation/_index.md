...
description: فئة Aspose.Pdf.Annotations.SquareAnnotation. فئة تمثل التعليق المربع
type: docs
weight: 2590
...
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | ينشئ تعليق مربع جديد على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
