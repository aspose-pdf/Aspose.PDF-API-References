---
title: "الفئة SquareAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Annotations.SquareAnnotation class. فئة تمثل تعليقا مربعا"
type: docs
weight: 2690
...
| الاسم | الوصف |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | منشئ للاستخدام مع Generator. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | ينشئ تعليقا جديدا من نوع Square على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | المستطيل الذي يصف الفروقات العددية بين مستطيلين: مدخل Rect في التعليق والحدود الفعلية للمربع أو الدائرة الأساسية. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | لون داخلي يُستخدم لملء مستطيل أو إهليلج التعليق. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق. |
