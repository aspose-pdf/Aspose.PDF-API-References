...
description: فئة Aspose.Pdf.Annotations.PolygonAnnotation. فئة تمثل تعليق مضلع
type: docs
weight: 2310
...
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | ينشئ تعليق مضلع جديد على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | يحصل أو يحدد نمط نهاية الخط الثاني. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | يحصل أو يحدد نية تعليق المضلع أو الخط المتعدد. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | يحصل أو يحدد اللون الداخلي الذي سيتم استخدامه لملء نهايات خطوط التعليق. |
| [IsFirstParagraphInColumn](../../aspose.pdf/baseparagraph/isfirstparagraphincolumn/) { get; set; } | يحصل أو يحدد قيمة بوليانية تشير إلى ما إذا كانت هذه الفقرة ستكون في العمود التالي. القيمة الافتراضية هي خطأ. (لإنشاء PDF) |
| [IsInLineParagraph](../../aspose.pdf/baseparagraph/isinlineparagraph/) { get; set; } | يحصل أو يحدد ما إذا كانت الفقرة في السطر. القيمة الافتراضية هي خطأ. (لإنشاء PDF) |
| [IsInNewPage](../../aspose.pdf/baseparagraph/isinnewpage/) { get; set; } | يحصل أو يحدد قيمة بوليانية تجبر هذه الفقرة على التوليد في صفحة جديدة. القيمة الافتراضية هي خطأ. (لإنشاء PDF) |
| [IsKeptWithNext](../../aspose.pdf/baseparagraph/iskeptwithnext/) { get; set; } | يحصل أو يحدد قيمة بوليانية تشير إلى ما إذا كانت الفقرة الحالية تبقى في نفس الصفحة مع الفقرة التالية. القيمة الافتراضية هي خطأ. (لإنشاء PDF) |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | يحصل أو يحدد نمط نهاية الخط الأول. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | يحصل أو يحدد مصفوفة من النقاط تمثل الإحداثيات الأفقية والعمودية لكل رأس. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق. |
