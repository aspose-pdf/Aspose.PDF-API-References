---
title: "الفئة PolygonAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.PolygonAnnotation. فئة تمثل تعليقا مضلعًا"
type: docs
weight: 2400
...
| الاسم | الوصف |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | منشئ للاستخدام مع Generator. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | ينشئ تعليقا مضلعًا جديدًا على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليقات التوضيحية. |
