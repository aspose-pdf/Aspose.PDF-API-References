---
title: "الفئة FileAttachmentAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.FileAttachmentAnnotation. تصف الفئة ملاحظة إرفاق ملف"
type: docs
weight: 1800
...
| الاسم | الوصف |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | ينشئ ملاحظة FileAttachment جديدة على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | المواصفات الخاصة بالملف المرتبط بهذه الملاحظة. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | يحصل أو يعيّن الأيقونة التي ستُستخدم في عرض الملاحظة. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | يحصل أو يعيّن شفافية الأيقونة من 0 إلى 1: 0 - شفافة تمامًا، 1 - غير شفافة تمامًا. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة الملاحظة. |
