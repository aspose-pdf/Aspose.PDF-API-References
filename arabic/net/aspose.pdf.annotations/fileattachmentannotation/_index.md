...
description: يصف الفصل التعليق التوضيحي لمرفق الملف.
type: docs
weight: 330
...
يصف الفصل التعليق التوضيحي لمرفق الملف.
...
| اسم | وصف |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation)(Page, Rectangle, FileSpecification) | إنشاء تعليق توضيحي لمرفق ملف جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file) { get; set; } | مواصفات الملف المرتبط بهذا التعليق التوضيحي. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon) { get; set; } | الحصول على أو تعيين الرمز الذي يجب استخدامه في عرض التعليق التوضيحي. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity) { get; set; } | الحصول على أو تعيين تعتيم الرمز من 0 إلى 1: 0 - شفاف تمامًا ، 1 - معتم تمامًا . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي . |
