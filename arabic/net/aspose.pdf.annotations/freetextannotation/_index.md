...
description: يمثل تعليقًا توضيحيًا نصيًا مجانيًا يعرض النص مباشرة على الصفحة. بخلاف التعليق التوضيحي للنص العادي  ليس للتعليق التوضيحي للنص الحر حالة مفتوحة أو مغلقة بدلاً من عرضه في نافذة منبثقة  يكون النص مرئيًا دائمًا.
type: docs
weight: 430
...
يمثل تعليقًا توضيحيًا نصيًا مجانيًا يعرض النص مباشرة على الصفحة. بخلاف التعليق التوضيحي للنص العادي ، ليس للتعليق التوضيحي للنص الحر حالة مفتوحة أو مغلقة بدلاً من عرضه في نافذة منبثقة ، يكون النص مرئيًا دائمًا.
...
| اسم | وصف |
| --- | --- |
| [FreeTextAnnotation](freetextannotation#constructor)(Document, DefaultAppearance) | مُنشئ للاستخدام مع المولد . |
| [FreeTextAnnotation](freetextannotation#constructor_1)(Page, Rectangle, DefaultAppearance) | إنشاء تعليق توضيحي نص حر جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/freetextannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Callout](../../aspose.pdf.annotations/freetextannotation/callout) { get; set; } | صفيف نقطة يحدد سطر وسيلة الشرح . |
...
| [DefaultAppearance](../../aspose.pdf.annotations/freetextannotation/defaultappearance) { get; set; } | الحصول على سلسلة المظهر الافتراضية أو تعيينها لاستخدامها في تنسيق النص. |
| [DefaultAppearanceObject](../../aspose.pdf.annotations/freetextannotation/defaultappearanceobject) { get; } | كائن يمثل المظهر الافتراضي للتعليق التوضيحي FreeText . |
| [DefaultStyle](../../aspose.pdf.annotations/freetextannotation/defaultstyle) { get; set; } | الحصول على سلسلة نمط افتراضية أو تعيينها. |
| [EndingStyle](../../aspose.pdf.annotations/freetextannotation/endingstyle) { get; set; } | الحصول على أو تعيين نمط نهاية السطر لنقطة نهاية السطر. |
...
| [Intent](../../aspose.pdf.annotations/freetextannotation/intent) { get; set; } | الحصول على أو تحديد الغرض من التعليق التوضيحي للنص الحر. |
...
| [Justification](../../aspose.pdf.annotations/freetextannotation/justification) { get; set; } | الحصول على أو تعيين رمز يحدد شكل التربيع (التبرير) لاستخدامه في عرض نص التعليق التوضيحي. |
...
| [Rotate](../../aspose.pdf.annotations/freetextannotation/rotate) { get; set; } | زاوية دوران الشرح. |
| [StartingStyle](../../aspose.pdf.annotations/freetextannotation/startingstyle) { get; set; } | الحصول على أو تعيين نمط نهاية السطر لنقطة نهاية السطر . O هذه الخاصية قديمة ، يرجى استخدام EndingStyle. |
...
| [TextRectangle](../../aspose.pdf.annotations/freetextannotation/textrectangle) { get; set; } | مستطيل يصف الاختلافات العددية بين مستطيلين: إدخال المستطيل للتعليق التوضيحي والمستطيل الموجود بداخل هذا المستطيل. المستطيل الداخلي هو المكان الذي يجب عرض نص التعليق التوضيحي فيه. |
| [TextStyle](../../aspose.pdf.annotations/freetextannotation/textstyle) { get; set; } | الحصول على أو تعيين نمط النص في المظهر. عند تغيير نمط النص ، يتم تحديث مظهر النص. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/freetextannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
