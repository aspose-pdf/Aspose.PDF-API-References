...
description: "Aspose.Pdf.Annotations.ScreenAnnotation class. تعليق توضيحي للشاشة يحدد منطقة من الصفحة يمكن تشغيل مقاطع الوسائط فيها"
type: docs
weight: 2610
...
تعليق توضيحي شاشة يحدد منطقة من الصفحة يمكن تشغيل مقاطع الوسائط فيها.
...
| الاسم | الوصف |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | ينشئ تعليق توضيحي للشاشة جديد على الصفحة المحددة. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | يحصل أو يضبط إجراءً يتم تنفيذه عندما يتم تنشيط التعليق التوضيحي. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | يحصل أو يضبط عنوان التعليق التوضيحي للشاشة. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق. |
