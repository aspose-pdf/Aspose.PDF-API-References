...
description: تعليق توضيحي على الشاشة يحدد منطقة من الصفحة يمكن تشغيل مقاطع الوسائط عليها.
type: docs
weight: 1060
...
تعليق توضيحي على الشاشة يحدد منطقة من الصفحة يمكن تشغيل مقاطع الوسائط عليها.
...
| اسم | وصف |
| --- | --- |
| [ScreenAnnotation](screenannotation)(Page, Rectangle, string) | إنشاء تعليق توضيحي جديد على الشاشة في الصفحة المحددة. |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action) { get; } | الحصول على أو تعيين إجراء ليتم تنفيذه عند تنشيط التعليق التوضيحي. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title) { get; set; } | الحصول على عنوان التعليق التوضيحي على الشاشة أو تحديده. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
