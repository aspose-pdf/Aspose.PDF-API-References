---
title: "الفئة PrinterMarkAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.PrinterMarkAnnotation. فئة مجردة تمثل تعليقا علامة طابعة"
type: docs
weight: 2440
url: /ar/net/aspose.pdf.annotations/printermarkannotation/
---
## PrinterMarkAnnotation class

فئة مجردة تمثل تعليق توضيحي لعلامة الطابعة.
...
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks)(Document, PrinterMarksKind) | يضيف علامات الطابعة إلى جميع الصفحات في المستند المحدد. |
| static [AddPrinterMarks](../../aspose.pdf.annotations/printermarkannotation/addprintermarks/#addprintermarks_1)(Page, PrinterMarksKind) | يضيف علامات الطابعة إلى الصفحة المحددة. |
