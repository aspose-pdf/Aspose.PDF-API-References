---
title: "الفئة TextAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.TextAnnotation. تمثل تعليقًا توضيحيًا نصيًا هو ملاحظة لاصقة مرفقة بنقطة في مستند PDF."
type: docs
weight: 2750
...
يمثل تعليق توضيحي نصي هو 'ملاحظة لاصقة' مرفقة بنقطة في مستند PDF.
...
| الاسم | الوصف |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | منشئ للتعليق التوضيحي عند استخدامه في Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | ينشئ تعليق Text جديد على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | يحصل أو يعيّن أيقونة لاستخدامها في عرض التعليق التوضيحي. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | يحصل أو يعيّن علامة تحدد ما إذا كان يجب عرض التعليق التوضيحي مفتوحًا في البداية. |
