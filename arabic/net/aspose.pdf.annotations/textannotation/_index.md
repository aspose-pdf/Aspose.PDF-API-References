...
description: يمثل تعليقًا توضيحيًا نصيًا ملاحظة لاصقة مرفقة بنقطة في مستند PDF.
type: docs
weight: 1200
...
يمثل تعليقًا توضيحيًا نصيًا "ملاحظة لاصقة" مرفقة بنقطة في مستند PDF.
...
| اسم | وصف |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | مُنشئ التعليقات التوضيحية عند استخدامه في المولد. |
| [TextAnnotation](textannotation#constructor_1)(Page, Rectangle) | إنشاء تعليق توضيحي نصي جديد في الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype) { get; } | يحصل على نوع التعليق التوضيحي . |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon) { get; set; } | الحصول على أو تعيين رمز لاستخدامه في عرض التعليق التوضيحي. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open) { get; set; } | الحصول على علامة أو تعيينها لتحديد ما إذا كان يجب عرض التعليق التوضيحي مفتوحًا في البداية. |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | الحصول على أو تعيين الحالة التي يجب تعيين التعليق التوضيحي الأصلي عليها. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق التوضيحي. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | يحدّث نقطتي البداية والنهاية وفقًا لتحويل المصفوفة. |
