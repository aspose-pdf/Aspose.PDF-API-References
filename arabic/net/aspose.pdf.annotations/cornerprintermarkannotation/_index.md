...
description: فئة Aspose.Pdf.Annotations.CornerPrinterMarkAnnotation. تمثل أنواع التعليقات التي توضع في زوايا الصفحة المطبوعة
type: docs
weight: 1630
...
تمثل أنواع التعليقات التي توضع في زوايا الصفحة المطبوعة.
