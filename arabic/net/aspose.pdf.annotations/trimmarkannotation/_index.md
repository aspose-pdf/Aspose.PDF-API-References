---
title: "الفئة TrimMarkAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.TrimMarkAnnotation. تمثل تعليقا لعلامة القص"
type: docs
weight: 2790
url: /ar/net/aspose.pdf.annotations/trimmarkannotation/
---
## TrimMarkAnnotation class

يمثل توضيح علامة القص.
...
| الاسم | الوصف |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | ينشئ مثالا جديدًا من الفئة `TrimMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق التوضيحي. |
...
توضع علامات القص في زوايا الصفحة المطبوعة لتحديد المكان الذي يجب قص الصفحة فيه.
