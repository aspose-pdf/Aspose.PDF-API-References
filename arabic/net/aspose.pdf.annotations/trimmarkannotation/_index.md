...
description: Aspose.Pdf.Annotations.TrimMarkAnnotation class. يمثل تعليق علامة القص
type: docs
weight: 2690
...
| Name | Description |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | يقوم بتهيئة مثيل جديد من فئة `TrimMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق. |
...
تُوضع علامات القص في زوايا الصفحة المطبوعة للإشارة إلى المكان الذي يجب قص الصفحة فيه.
