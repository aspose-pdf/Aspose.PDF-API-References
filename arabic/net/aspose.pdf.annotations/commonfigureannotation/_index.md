...
description: فئة Aspose.Pdf.Annotations.CommonFigureAnnotation. فئة مجردة تمثل التعليق الشكلي المشترك
type: docs
weight: 1620
...
فئة مجردة تمثل التعليق الشكلي المشترك.
...
| Name | Description |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | مُنشئ للاستخدام في المولد. |
