---
title: "الفئة CommonFigureAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Annotations.CommonFigureAnnotation. فئة مجردة تمثل تعليق الشكل المشترك"
type: docs
weight: 1710
url: /ar/net/aspose.pdf.annotations/commonfigureannotation/
---
## CommonFigureAnnotation class

فئة تجريدية تمثل تعليقًا توضيحيًا شائعًا.
...
| الاسم | الوصف |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | منشئ للاستخدام في Generator. |
