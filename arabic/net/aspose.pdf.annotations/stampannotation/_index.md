---
title: "الفئة StampAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Annotations.StampAnnotation. تمثل تعليقا بطاقة مطاطية. هذا النوع من التعليقات يعرض نصًا أو رسومات تهدف إلى الظهور كما لو تم ختمها على الصفحة ببطاقة مطاطية."
type: docs
weight: 2710
url: /ar/net/aspose.pdf.annotations/stampannotation/
---
## StampAnnotation class

يمثل تعليق توضيحي ختم مطاطي. هذا النوع من التعليقات التوضيحية يعرض نصًا أو رسومات تبدو كما لو أنها مختومة على الصفحة بختم مطاطي.
...
| الاسم | الوصف |
| --- | --- |
| [StampAnnotation](stampannotation/#constructor)(Document) | منشئ |
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | ينشئ تعليقا جديدًا من نوع Stamp على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/stampannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | يحصل أو يعيّن الأيقونة للختم المطاطي. |
| [Image](../../aspose.pdf.annotations/stampannotation/image/) { get; set; } | يحصل أو يعيّن صورة التعليق. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | يقبل زائر [`AnnotationSelector`](../annotationselector/) عند تصفح مجموعة التعليقات. |
...
المقتطف البرمجي التالي يوضح كيفية إضافة طابعين إلى الصفحة الأولى من مستند pdf. يأتي مستند الإدخال من inFile ويتم حفظ التغييرات في outFile. الطابع الأول له أيقونة NotForPublicRelease والثاني يأتي بصورة من rubber.jpg.
