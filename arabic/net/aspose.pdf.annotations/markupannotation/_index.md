...
description: فئة الملخص تمثل التعليق التوضيحي للترميز .
type: docs
weight: 640
...
فئة الملخص تمثل التعليق التوضيحي للترميز .
...
| اسم | وصف |
| --- | --- |
| [MarkupAnnotation](markupannotation)(Document) | مُنشئ التعليق التوضيحي للترميز. |
