---
title: "الفئة BleedMarkAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.Annotations.BleedMarkAnnotation. تمثّل تعليقة علامة قص"
type: docs
weight: 1590
url: /ar/net/aspose.pdf.annotations/bleedmarkannotation/
---
## BleedMarkAnnotation class

يمثل تعليق توضيحي لعلامة النزيف.
...
| الاسم | الوصف |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Page, PrinterMarkCornerPosition) | يُنشئ مثيلاً جديدًا للفئة `BleedMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | يحصل أو يضبط موضع العلامة على الصفحة. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق التوضيحي. |
...
توضع علامات القص في زوايا الصفحة المطبوعة لتحديد مكان قص الصفحة والمسافة المسموح بها للانحراف عن علامات القص.
