---
title: "فئة SquigglyAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Annotations.SquigglyAnnotation class. يمثل التعليق المتعرج الذي يظهر كخط سفلي متعرّج في نص المستند"
type: docs
weight: 2700
...
يمثل التعليق التوضيحي المتعرج الذي يظهر كخط سفلي متعرج في نص المستند.
...
| الاسم | الوصف |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | ينشئ تعليق Squiggly جديد على الصفحة المحددة. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | يحصل أو يضبط مصفوفة من النقاط التي تحدد إحداثيات n رباعيات. كل رباعية تشمل كلمة أو مجموعة من الكلمات المتجاورة في النص الأساسي للتعليق. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | يقبل كائن الزائر لمعالجة التعليق. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textmarkupannotation/changeafterresize/)(Matrix) | يحدّث QuadPoints وفقاً لتحويل المصفوفة. |
...
| [GetMarkedText](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtext/)() | يحصل على النص تحت التعليق التوضيحي كقيمة نصية. |
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | يحصل على النص تحت التعليق التوضيحي كـ [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/). |
