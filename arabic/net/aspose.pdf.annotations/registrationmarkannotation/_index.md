...
description: فئة Aspose.Pdf.Annotations.RegistrationMarkAnnotation. تمثل تعليق علامة التسجيل
type: docs
weight: 2410
...
| Name | Description |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | يقوم بتهيئة مثيل جديد من فئة `RegistrationMarkAnnotation` على الصفحة المعطاة في الموقع المعطى. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | يحصل على نوع التعليق. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | يحصل أو يحدد موقع علامة التسجيل على الصفحة. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق. |
...
علامات التسجيل هي رموز تُضاف إلى لوحات الطباعة أو الشاشات لضمان المحاذاة الصحيحة للألوان أثناء عملية الطباعة.
