---
title: "فئة RegistrationMarkAnnotation"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.Annotations.RegistrationMarkAnnotation class. يمثل تعليق علامة التسجيل"
type: docs
weight: 2500
url: /ar/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation class

يمثل تعليق توضيحي علامة التسجيل.
...
| الاسم | الوصف |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | يُنشئ مثيلاً جديداً من الفئة `RegistrationMarkAnnotation` على الصفحة المحددة في الموقع المحدد. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | الحصول على نوع التعليقة. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | يحصل أو يضبط موضع علامة التسجيل على الصفحة. |
...
| الاسم | الوصف |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | يقبل الزائر لمعالجة التعليق التوضيحي. |
...
علامات التسجيل هي رموز تُضاف إلى ألواح الطباعة أو الشاشات لضمان محاذاة صحيحة للألوان أثناء عملية الطباعة.
