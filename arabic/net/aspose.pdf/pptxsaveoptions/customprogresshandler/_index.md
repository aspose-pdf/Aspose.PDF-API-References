...
description: يمكن استخدام هذا المعالج لمعالجة تقدم التحويل events fe يمكن استخدامه لإظهار شريط التقدم أو الرسائل حول المقدار الحالي للصفحات المعالجة  مثال على كود المعالج الذي يظهر التقدم على وحدة التحكم هو
type: docs
weight: 20
