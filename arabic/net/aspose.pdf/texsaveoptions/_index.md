...
description: حفظ الخيارات للتصدير إلى تنسيق TeX
type: docs
weight: 6590
...
حفظ الخيارات للتصدير إلى تنسيق TeX
...
| [OutDirectoryPath](../../aspose.pdf/texsaveoptions/outdirectorypath) { get; set; } | خاصيةoutDirectoryPath المعلمة . |
| [PagesCount](../../aspose.pdf/texsaveoptions/pagescount) { get; } | إرجاع عدد الصفحات بعد التحويل. |
...
| اسم | وصف |
| --- | --- |
| [AddFontEncs](../../aspose.pdf/texsaveoptions/addfontencs)(params string[]) | يضيف ترميز الخط إلى قائمة ترميز الخط |
| [ClearFontEncs](../../aspose.pdf/texsaveoptions/clearfontencs)() | يمسح قائمة ترميز الخط |
