...
description: فئة Aspose.Pdf.BaseParagraph. تمثل كائن أساسي مجرد يمكن إضافته إلى pagedoc.Paragraphs.Add
type: docs
weight: 2840
...
تمثل كائن أساسي مجرد يمكن إضافته إلى الصفحة (doc.Paragraphs.Add()).
