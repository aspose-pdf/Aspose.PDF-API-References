...
description: "حقل DocSaveOptions. يمكن استخدام هذا المعالج لمعالجة أحداث تقدم التحويل، على سبيل المثال يمكن استخدامه لعرض شريط تقدم أو رسائل حول عدد الصفحات المعالجة حاليًا. مثال على شفرة المعالج التي تُظهر التقدم في وحدة التحكم هو"
type: docs
weight: 140
