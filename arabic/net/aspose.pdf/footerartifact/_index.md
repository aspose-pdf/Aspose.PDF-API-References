...
description: يصف قطعة أثرية في التذييل. يمكن استخدام هذا لضبط تذييل الصفحة.
type: docs
weight: 2880
...
يصف قطعة أثرية في التذييل. يمكن استخدام هذا لضبط تذييل الصفحة.
...
| اسم | وصف |
| --- | --- |
| [FooterArtifact](footerartifact)() | إنشاء مثيل الأداة التذييل . |
