---
title: "الفئة FooterArtifact"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.FooterArtifact. تصف كائن التذييل. يمكن استخدام هذا لتعيين تذييل الصفحة."
type: docs
weight: 5050
...
يصف قطعة التذييل. يمكن استخدامها لتعيين تذييل الصفحة.
...
| الاسم | الوصف |
| --- | --- |
| [FooterArtifact](footerartifact/)() | ينشئ مثيل Footer Artifact. |
