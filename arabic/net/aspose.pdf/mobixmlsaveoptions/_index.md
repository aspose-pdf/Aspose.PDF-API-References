---
title: "الفئة MobiXmlSaveOptions"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.MobiXmlSaveOptions. خيارات الحفظ للتصدير إلى صيغة Xml"
type: docs
weight: 7120
...
| الاسم | الوصف |
| --- | --- |
| [MobiXmlSaveOptions](mobixmlsaveoptions/)() | البناء الافتراضي. |
