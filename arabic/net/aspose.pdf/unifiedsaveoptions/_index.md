...
description: تمثل هذه الفئة خيارات الحفظ للحفظ أن يستخدم طريقة تحويل موحدة مع نموذج مستند داخلي موحد
type: docs
weight: 7280
...
تمثل هذه الفئة خيارات الحفظ للحفظ أن يستخدم طريقة تحويل موحدة (مع نموذج مستند داخلي موحد)
