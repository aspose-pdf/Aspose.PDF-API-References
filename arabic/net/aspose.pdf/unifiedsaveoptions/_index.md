---
title: "الفئة UnifiedSaveOptions"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.UnifiedSaveOptions. تمثل هذه الفئة خيارات الحفظ التي تستخدم طريقة تحويل موحدة مع نموذج مستند داخلي موحد"
type: docs
weight: 11330
...
| الاسم | الوصف |
| --- | --- |
| [UnifiedSaveOptions](unifiedsaveoptions/)() | البناء الافتراضي. |
