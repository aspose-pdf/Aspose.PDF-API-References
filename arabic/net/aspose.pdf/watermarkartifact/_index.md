...
description: فئة Aspose.Pdf.WatermarkArtifact. تصف الفئة عنصر العلامة المائية. يمكن استخدام هذا لـ
type: docs
weight: 11310
...
تصف الفئة عنصر العلامة المائية. يمكن استخدام هذا لـ
...
| Name | Description |
| --- | --- |
| [WatermarkArtifact](watermarkartifact/)() | ينشئ مثيلًا لعنصر العلامة المائية. |
