...
description: يصف Class قطعة أثرية للعلامة المائية. يمكن استخدام هذا في
type: docs
weight: 7360
...
يصف Class قطعة أثرية للعلامة المائية. يمكن استخدام هذا في
...
| اسم | وصف |
| --- | --- |
| [WatermarkArtifact](watermarkartifact)() | إنشاء مثيل لعنصر العلامة المائية . |
