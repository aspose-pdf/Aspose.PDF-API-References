---
title: "فئة HeaderArtifact"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.HeaderArtifact. تصف الفئة قطعة HeaderArtifact. قد تُستخدم هذه القطعة لتعيين عنوان الصفحة"
type: docs
weight: 5540
...
فئة تصف قطعة الرأس. يمكن استخدام هذه القطعة لتعيين عنوان الصفحة.
...
| الاسم | الوصف |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | ينشئ مثيل Header Artifact. |
