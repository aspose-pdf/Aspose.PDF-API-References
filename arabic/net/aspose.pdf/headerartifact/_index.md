...
description: يصف الفصل قطعة أثرية من Heaader. يمكن استخدام هذه القطعة الفنية لتعيين عنوان الصفحة.
type: docs
weight: 3340
...
يصف الفصل قطعة أثرية من Heaader. يمكن استخدام هذه القطعة الفنية لتعيين عنوان الصفحة.
...
| اسم | وصف |
| --- | --- |
| [HeaderArtifact](headerartifact)() | إنشاء مثيل Header Artifact. |
