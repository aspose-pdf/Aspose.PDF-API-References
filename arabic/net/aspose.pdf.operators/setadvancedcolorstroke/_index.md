...
description: فئة تمثل مشغل SCN ضبط اللون لعمليات التمسيد .
type: docs
weight: 5330
...
فئة تمثل مشغل SCN (ضبط اللون لعمليات التمسيد) .
...
| اسم | وصف |
| --- | --- |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor)() | تهيئة المشغل . |
| [SetAdvancedColorStroke](setadvancedcolorstroke#constructor_1)(double) | مُنشئ مشغل SCN |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/setadvancedcolorstroke/accept)(IOperatorSelector) | يقبل كائن الزائر بمعالجة عامل التشغيل. |
| override [getColor](../../aspose.pdf.operators/setadvancedcolorstroke/getcolor)() | إرجاع اللون المحدد بواسطة عامل التشغيل . |
