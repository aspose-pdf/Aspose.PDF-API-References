---
title: "فئة ListChildElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.LogicalStructure.ListChildElement. تمثّل فئة أساسية لعناصر الأطفال الخاصة بـ List في الهيكل المنطقي"
type: docs
weight: 6590
...
يمثل فئة أساسية لعناصر الأطفال للقائمة في البنية المنطقية.
