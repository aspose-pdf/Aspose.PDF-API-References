...
description: Aspose.Pdf.LogicalStructure.TableRowCollectionElement class. يمثل فئة أساسية لعناصر الأطفال من رأس الجدول والجسم والقدم في الهيكل المنطقي
type: docs
weight: 6790
url: /ar/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## TableRowCollectionElement class

يمثل فئة أساسية لعناصر الأطفال من رأس الجدول والجسم والقدم في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالعنصر المحذوف في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر المحذوف. |
