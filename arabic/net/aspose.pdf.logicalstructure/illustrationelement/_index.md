...
description: فئة Aspose.Pdf.LogicalStructure.IllustrationElement. تمثل فئة أساسية لعناصر هيكل التوضيح في الهيكل المنطقي
type: docs
weight: 6420
...
تمثل فئة أساسية لعناصر هيكل التوضيح في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج الكائنات الفرعية للعنصر المحذوف في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر المحذوف. |
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | إضافة صورة إلى عنصر التوضيح الحالي. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | إضافة صورة إلى عنصر التوضيح الحالي. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XForm) | ربط عنصر الهيكل بـ XForm في تدفق المحتوى. |
