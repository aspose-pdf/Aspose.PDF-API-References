---
title: "فئة IllustrationElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.LogicalStructure.IllustrationElement. تمثل فئة أساسية لعناصر بنية التوضيح في البنية المنطقية"
type: docs
weight: 6560
...
يمثل فئة أساسية لعناصر بنية التوضيح في البنية المنطقية.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | يضيف صورة إلى عنصر التوضيح الحالي. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | يضيف صورة إلى عنصر التوضيح الحالي. |
