...
description: يمثل عنصر بنية الارتباط في الهيكل المنطقي.
type: docs
weight: 4270
...
يمثل عنصر بنية الارتباط في الهيكل المنطقي.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions) { get; set; } | الحصول على الأوصاف البديلة للتعليق التوضيحي أو تعيينها. النص الذي سيتم عرضه للتعليق التوضيحي أو ، إذا كان هذا النوع من التعليقات التوضيحية لا يعرض نصًا ، فسيكون وصفًا بديلاً لمحتويات التعليق التوضيحي في شكل يمكن للبشر قراءته. |
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink) { get; set; } | الحصول على الارتباط التشعبي لعنصر الارتباط أو تعيينه. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/linkelement/structuretextstate) { get; } | يحصلStructureTextState كائن للعنصر الحالي. |
...
| [SetText](../../aspose.pdf.logicalstructure/linkelement/settext)(string) | إلحاق محتوى نصي بعنصر النص الحالي. |
