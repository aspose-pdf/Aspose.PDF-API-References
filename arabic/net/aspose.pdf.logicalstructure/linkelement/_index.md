---
title: "الفئة LinkElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.LogicalStructure.LinkElement. تمثل عنصر بنية Link في البنية المنطقية"
type: docs
weight: 6580
...
يمثل عنصر بنية الرابط في البنية المنطقية.
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink/) { get; set; } | يحصل أو يحدد Hyperlink لعنصر Link. |
