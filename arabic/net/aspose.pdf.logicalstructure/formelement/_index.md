...
description: فئة Aspose.Pdf.LogicalStructure.FormElement. تمثل عنصر هيكل النموذج في الهيكل المنطقي
type: docs
weight: 6350
url: /ar/net/aspose.pdf.logicalstructure/formelement/
---
## FormElement class

تمثل عنصر هيكل النموذج في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يُدرج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
