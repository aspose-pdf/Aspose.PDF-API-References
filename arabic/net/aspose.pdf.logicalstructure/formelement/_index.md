...
description: يمثل عنصر بنية النموذج في البنية المنطقية.
type: docs
weight: 4180
...
يمثل عنصر بنية النموذج في البنية المنطقية.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double) | إلحاق الصورة بعنصر الرسم التوضيحي الحالي. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double, double) | إلحاق الصورة بعنصر الرسم التوضيحي الحالي. |
