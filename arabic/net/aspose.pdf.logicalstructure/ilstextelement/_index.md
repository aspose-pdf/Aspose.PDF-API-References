...
description: فئة Aspose.Pdf.LogicalStructure.ILSTextElement. تمثل فئة أساسية لعناصر بنية النص على مستوى السطر في الهيكل المنطقي
type: docs
weight: 6400
...
تمثل فئة أساسية لعناصر بنية النص على مستوى السطر في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج الكائنات الفرعية للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
