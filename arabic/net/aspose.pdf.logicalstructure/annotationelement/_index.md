...
description: Aspose.Pdf.LogicalStructure.AnnotationElement class. يمثل فئة أساسية لعناصر هيكل التعليق في الهيكل المنطقي
type: docs
weight: 6190
url: /ar/net/aspose.pdf.logicalstructure/annotationelement/
---
## AnnotationElement class

يمثل فئة أساسية لعناصر هيكل التعليق في الهيكل المنطقي.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | يحصل أو يحدد الأوصاف البديلة للتعليق. النص الذي سيتم عرضه للتعليق أو، إذا كان هذا النوع من التعليق لا يعرض نصًا، وصف بديل لمحتويات التعليق بشكل مقروء للبشر. |
...
| [InsertChild](../../aspose.pdf.logicalstructure/element/insertchild/)(Element, int, bool) | إدراج عنصر إلى مجموعة الأطفال في الفهرس المحدد. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج الكائنات الفرعية للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال السابقة له بدءًا من فهرس العنصر الذي تمت إزالته. |
| [RemoveChild](../../aspose.pdf.logicalstructure/element/removechild/)(int) | إزالة الطفل في. |
