---
title: "الفئة AnnotationElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.LogicalStructure.AnnotationElement فئة. يمثل فئة أساسية لعناصر بنية التعليقات التوضيحية في البنية المنطقية"
type: docs
weight: 6330
...
يمثل فئة أساسية لعناصر بنية التعليق في البنية المنطقية.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | يحصل أو يعيّن الوصف البديل للتعليق التوضيحي. النص الذي سيُعرض للتعليق أو، إذا كان هذا النوع من التعليقات لا يعرض نصًا، وصف بديل لمحتوى التعليق بصيغة قابلة للقراءة البشرية. |
