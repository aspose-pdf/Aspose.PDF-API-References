...
description: فئة Aspose.Pdf.LogicalStructure.FormulaElement. تمثل عنصر هيكل المعادلة في الهيكل المنطقي
type: docs
weight: 6360
url: /ar/net/aspose.pdf.logicalstructure/formulaelement/
---
## FormulaElement class

تمثل عنصر هيكل المعادلة في الهيكل المنطقي.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | إضافة صورة إلى عنصر التوضيح الحالي. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | إضافة صورة إلى عنصر التوضيح الحالي. |
