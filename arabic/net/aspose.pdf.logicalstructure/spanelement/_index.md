...
description: فئة Aspose.Pdf.LogicalStructure.SpanElement. تمثل عنصر هيكلي من نوع Span في الهيكل المنطقي
type: docs
weight: 6650
...
تمثل عنصر هيكلي من نوع Span في الهيكل المنطقي.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | يحصل على كائن StructureTextState للعنصر الحالي. |
...
| [ChangeParentElement](../../aspose.pdf.logicalstructure/structureelement/changeparentelement/)(StructureElement, bool) | تغيير العنصر الأب للعنصر الهيكلي الحالي |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XImage) | ربط عنصر هيكلي بالصورة XImage. |
