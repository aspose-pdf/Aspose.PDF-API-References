...
description: فئة Aspose.Pdf.LogicalStructure.NonStructElement. تمثل عنصر هيكلي غير هيكلي في الهيكل المنطقي
type: docs
weight: 6510
url: /ar/net/aspose.pdf.logicalstructure/nonstructelement/
---
## NonStructElement class

تمثل عنصر هيكلي غير هيكلي في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
