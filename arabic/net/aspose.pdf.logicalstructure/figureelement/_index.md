---
title: "الفئة FigureElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "Aspose.Pdf.LogicalStructure.FigureElement class. يمثل عنصر بنية Figure في البنية المنطقية"
type: docs
weight: 6480
...
يمثل عنصر بنية Figure في البنية المنطقية.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | يضيف صورة إلى عنصر التوضيح الحالي. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | يضيف صورة إلى عنصر التوضيح الحالي. |
