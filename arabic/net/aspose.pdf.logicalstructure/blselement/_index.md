...
description: فئة Aspose.Pdf.LogicalStructure.BLSElement. تمثل فئة أساسية لعناصر الهيكل على مستوى الكتلة في الهيكل المنطقي
type: docs
weight: 6240
...
تمثل فئة أساسية لعناصر الهيكل على مستوى الكتلة في الهيكل المنطقي.
