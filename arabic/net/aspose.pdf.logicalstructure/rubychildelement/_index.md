...
description: فئة Aspose.Pdf.LogicalStructure.RubyChildElement. تمثل فئة أساسية لعناصر الأطفال من Ruby في الهيكل المنطقي
type: docs
weight: 6590
url: /ar/net/aspose.pdf.logicalstructure/rubychildelement/
---
## RubyChildElement class

تمثل فئة أساسية لعناصر الأطفال من Ruby في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصر من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال السابقة للأب بدءًا من فهرس العنصر الذي تمت إزالته. |
