---
title: "فئة RubyChildElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.LogicalStructure.RubyChildElement. تمثّل فئة أساسية لعناصر الأطفال الخاصة بـ Ruby في الهيكل المنطقي"
type: docs
weight: 6730
...
يمثل فئة أساسية لعناصر الأطفال للـ Ruby في البنية المنطقية.
