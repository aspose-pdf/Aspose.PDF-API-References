...
description: فئة Aspose.Pdf.LogicalStructure.NoteElement. تمثل عنصر هيكل الملاحظة في الهيكل المنطقي
type: docs
weight: 6520
url: /ar/net/aspose.pdf.logicalstructure/noteelement/
---
## NoteElement class

تمثل عنصر هيكل الملاحظة في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يُدرج الكائنات الفرعية للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال السابقة له بدءًا من فهرس العنصر الذي تمت إزالته. |
