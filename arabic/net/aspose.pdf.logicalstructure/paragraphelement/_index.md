...
description: يمثل عنصر بنية الفقرة في الهيكل المنطقي.
type: docs
weight: 4370
...
يمثل عنصر بنية الفقرة في الهيكل المنطقي.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate) { get; } | يحصلStructureTextState كائن للعنصر الحالي. |
...
| [SetText](../../aspose.pdf.logicalstructure/blstextelement/settext)(string) | إلحاق محتوى نصي بعنصر النص الحالي. |
