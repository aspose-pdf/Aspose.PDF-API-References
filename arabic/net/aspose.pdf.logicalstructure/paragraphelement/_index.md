...
description: فئة Aspose.Pdf.LogicalStructure.ParagraphElement. تمثل عنصر هيكل الفقرة في الهيكل المنطقي
type: docs
weight: 6540
url: /ar/net/aspose.pdf.logicalstructure/paragraphelement/
---
## ParagraphElement class

تمثل عنصر هيكل الفقرة في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصر من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج الكائنات الفرعية للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
