...
description: فئة Aspose.Pdf.LogicalStructure.DivElement. تمثل عنصر هيكل Div في الهيكل المنطقي
type: docs
weight: 6300
url: /ar/net/aspose.pdf.logicalstructure/divelement/
---
## DivElement class

تمثل عنصر هيكل Div في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يُدرج الكائنات الفرعية للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالعنصر الأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
