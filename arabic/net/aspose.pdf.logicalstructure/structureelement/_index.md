...
description: فئة Aspose.Pdf.LogicalStructure.StructureElement. تمثل فئة أساسية لعناصر الهيكل في الهيكل المنطقي
type: docs
weight: 6700
url: /ar/net/aspose.pdf.logicalstructure/structureelement/
---
## StructureElement class

تمثل فئة أساسية لعناصر الهيكل في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصر من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال للوالد السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_2)(Annotation) | ربط عنصر الهيكل بالتعليق. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag)(Artifact) | ربط عنصر الهيكل بالأثر. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_1)(BDC) | ربط عنصر الهيكل بمشغل BDC لتدفق المحتوى. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_3)(XForm) | ربط عنصر الهيكل بتدفق المحتوى XForm. |
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/#tag_4)(XImage) | ربط عنصر الهيكل بالصورة XImage. |
