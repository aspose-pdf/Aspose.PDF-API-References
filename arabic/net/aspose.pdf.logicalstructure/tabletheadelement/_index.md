...
description: فئة Aspose.Pdf.LogicalStructure.TableTHeadElement. تمثل عنصر هيكل THead في الهيكل المنطقي للجدول
type: docs
weight: 6840
url: /ar/net/aspose.pdf.logicalstructure/tabletheadelement/
---
## Class TableTHeadElement

تمثل عنصر هيكل THead في الهيكل المنطقي للجدول.
