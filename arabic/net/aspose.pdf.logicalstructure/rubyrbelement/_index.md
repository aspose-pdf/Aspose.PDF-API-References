...
description: فئة Aspose.Pdf.LogicalStructure.RubyRBElement. تمثل عنصر هيكل RB في الهيكل المنطقي للروبي
type: docs
weight: 6610
url: /ar/net/aspose.pdf.logicalstructure/rubyrbelement/
---
## فئة RubyRBElement

تمثل عنصر هيكل RB في الهيكل المنطقي للروبي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصر من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
...
* فئة [RubyChildElement](../rubychildelement/)
