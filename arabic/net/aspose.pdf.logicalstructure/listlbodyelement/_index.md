...
description: فئة Aspose.Pdf.LogicalStructure.ListLBodyElement. تمثل عنصر هيكل LBody في الهيكل المنطقي للقائمة
type: docs
weight: 6470
url: /ar/net/aspose.pdf.logicalstructure/listlbodyelement/
---
## فئة ListLBodyElement

تمثل عنصر هيكل LBody في الهيكل المنطقي للقائمة.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج الكائنات الفرعية للعنصر المحذوف في مجموعة كائنات الأطفال السابقة له بدءًا من فهرس العنصر المحذوف. |
