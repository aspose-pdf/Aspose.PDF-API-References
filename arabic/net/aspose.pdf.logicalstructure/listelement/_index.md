...
description: فئة Aspose.Pdf.LogicalStructure.ListElement. تمثل عنصر هيكل القائمة في الهيكل المنطقي
type: docs
weight: 6460
url: /ar/net/aspose.pdf.logicalstructure/listelement/
---
## فئة ListElement

تمثل عنصر هيكل القائمة في الهيكل المنطقي.
