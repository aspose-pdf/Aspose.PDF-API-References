...
description: Aspose.Pdf.LogicalStructure.BLSTextElement class. يمثل فئة أساسية لعناصر هيكل النص على مستوى الكتلة في الهيكل المنطقي
type: docs
weight: 6250
...
يمثل فئة أساسية لعناصر هيكل النص على مستوى الكتلة في الهيكل المنطقي.
