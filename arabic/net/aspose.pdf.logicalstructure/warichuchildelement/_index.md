...
description: Aspose.Pdf.LogicalStructure.WarichuChildElement class. يمثل فئة أساسية لعناصر الأطفال من Warichu في الهيكل المنطقي
type: docs
weight: 6860
url: /ar/net/aspose.pdf.logicalstructure/warichuchildelement/
---
## WarichuChildElement class

يمثل فئة أساسية لعناصر الأطفال من Warichu في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالكائن الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالوالد السابق بدءًا من فهرس الكائن الذي تمت إزالته. |
