---
title: "فئة WarichuChildElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.LogicalStructure.WarichuChildElement. تمثل فئة أساسية لعناصر الأطفال للـ Warichu في البنية المنطقية"
type: docs
weight: 7000
...
يمثل فئة أساسية لعناصر الأطفال للـ Warichu في الهيكل المنطقي.
