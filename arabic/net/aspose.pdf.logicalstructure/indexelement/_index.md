...
description: فئة Aspose.Pdf.LogicalStructure.IndexElement. تمثل عنصر هيكل الفهرس في الهيكل المنطقي
type: docs
weight: 6430
url: /ar/net/aspose.pdf.logicalstructure/indexelement/
---
## فئة IndexElement

تمثل عنصر هيكل الفهرس في الهيكل المنطقي.
...
* فئة [GroupingElement](../groupingelement/)
