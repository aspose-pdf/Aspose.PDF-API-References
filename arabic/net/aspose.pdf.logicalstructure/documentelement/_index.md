...
description: Aspose.Pdf.LogicalStructure.DocumentElement class. يمثل عنصر هيكل المستند في الهيكل المنطقي
type: docs
weight: 6310
url: /ar/net/aspose.pdf.logicalstructure/documentelement/
---
## DocumentElement class

يمثل عنصر هيكل المستند في الهيكل المنطقي.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | يزيل: عنصر من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، الكائن المقابل من المستند. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من المستند. يقوم بإدراج كائنات الأطفال للعنصر المحذوف في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر المحذوف. |
