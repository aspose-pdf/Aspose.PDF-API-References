...
description: فئة Aspose.Pdf.LogicalStructure.AnnotElement. تمثل عنصر الهيكل المعلق في الهيكل المنطقي
type: docs
weight: 6180
url: /ar/net/aspose.pdf.logicalstructure/annotelement/
---
## AnnotElement class

تمثل عنصر الهيكل المعلق في الهيكل المنطقي.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | يحصل أو يحدد الأوصاف البديلة للتعليق. نص يجب أن يتم عرضه للتعليق أو، إذا كان هذا النوع من التعليق لا يعرض نصًا، وصف بديل لمحتويات التعليق بشكل مقروء للبشر. |
