...
description: فئة Aspose.Pdf.LogicalStructure.TableCellElement. تمثل فئة أساسية لعناصر خلايا الجدول TH و TD في الهيكل المنطقي
type: docs
weight: 6760
...
تمثل فئة أساسية لعناصر خلايا الجدول (TH و TD) في الهيكل المنطقي.
...
| [Margin](../../aspose.pdf.logicalstructure/tablecellelement/margin/) { get; set; } | يحصل أو يحدد الحشوة. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يُدرج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال للأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
