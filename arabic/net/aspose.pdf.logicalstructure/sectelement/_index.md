...
description: فئة Aspose.Pdf.LogicalStructure.SectElement. تمثل عنصر هيكل Sect في الهيكل المنطقي
type: docs
weight: 6640
url: /ar/net/aspose.pdf.logicalstructure/sectelement/
---
## SectElement class

تمثل عنصر هيكل Sect في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
