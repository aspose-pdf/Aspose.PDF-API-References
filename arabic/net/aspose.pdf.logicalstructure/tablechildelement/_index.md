---
title: "فئة TableChildElement"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "فئة Aspose.Pdf.LogicalStructure.TableChildElement. تمثل فئة أساسية لعناصر الأطفال في الجدول في البنية المنطقية"
type: docs
weight: 6910
...
يمثل فئة أساسية لعناصر الأطفال للجدول في الهيكل المنطقي.
