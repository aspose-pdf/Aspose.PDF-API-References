...
description: فئة Aspose.Pdf.LogicalStructure.TableChildElement. تمثل فئة أساسية لعناصر الأطفال في الجدول في الهيكل المنطقي
type: docs
weight: 6770
url: /ar/net/aspose.pdf.logicalstructure/tablechildelement/
---
## Class TableChildElement

تمثل فئة أساسية لعناصر الأطفال في الجدول في الهيكل المنطقي.
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | يزيل: عنصر من الهيكل، مرجع له من الكائن الوالد، مراجع له من كائنات الأطفال، الكائن المقابل من الوثيقة. |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصر من الهيكل، مرجع له من الكائن الوالد، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالعنصر الذي تمت إزالته في مجموعة كائنات الأطفال الخاصة بالوالد السابق بدءًا من فهرس العنصر الذي تمت إزالته. |
