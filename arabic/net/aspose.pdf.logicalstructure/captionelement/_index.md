...
description: فئة Aspose.Pdf.LogicalStructure.CaptionElement. تمثل عنصر هيكل التسمية في الهيكل المنطقي
type: docs
weight: 6280
url: /ar/net/aspose.pdf.logicalstructure/captionelement/
---
## CaptionElement class

تمثل عنصر هيكل التسمية في الهيكل المنطقي.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من الكائنات الفرعية، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال الخاصة بالعنصر المزال في مجموعة كائنات الأطفال الخاصة بالأب السابق بدءًا من فهرس العنصر المزال. |
