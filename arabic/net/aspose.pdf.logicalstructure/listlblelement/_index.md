...
description: فئة Aspose.Pdf.LogicalStructure.ListLblElement. تمثل عنصر هيكل Lbl في الهيكل المنطقي للقائمة
type: docs
weight: 6490
url: /ar/net/aspose.pdf.logicalstructure/listlblelement/
---
## فئة ListLblElement

تمثل عنصر هيكل Lbl في الهيكل المنطقي للقائمة.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | يزيل عنصرًا من الهيكل، مرجع له من الكائن الأب، مراجع له من كائنات الأطفال، والكائن المقابل من الوثيقة. يقوم بإدراج كائنات الأطفال للعنصر الذي تمت إزالته في مجموعة كائنات الأطفال السابقة للأب بدءًا من فهرس العنصر الذي تمت إزالته. |
