---
title: "الفئة RunStepListResponse"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.AI.RunStepListResponse. تمثّل استجابة قائمة تحتوي على بيانات خطوة التشغيل"
type: docs
weight: 1130
url: /ar/net/aspose.pdf.ai/runsteplistresponse/
---
## RunStepListResponse class

يمثل استجابة قائمة تحتوي على بيانات خطوة التنفيذ.
...
| الاسم | الوصف |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | البناء الافتراضي. |
