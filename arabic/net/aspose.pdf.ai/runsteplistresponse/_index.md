...
description: فئة Aspose.Pdf.AI.RunStepListResponse. تمثل استجابة قائمة تحتوي على بيانات خطوات التشغيل
type: docs
weight: 1050
...
تمثل استجابة قائمة تحتوي على بيانات خطوات التشغيل.
...
| Name | Description |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | المُنشئ الافتراضي. |
