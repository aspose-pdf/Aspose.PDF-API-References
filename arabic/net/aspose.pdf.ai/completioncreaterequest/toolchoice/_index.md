...
description: خاصية CompletionCreateRequest. تحصل أو تعين كائنًا يتحكم في أي أداة إن وجدت يتم استدعاؤها بواسطة النموذج. تعني none أن النموذج لن يستدعي أي أداة وبدلاً من ذلك يولد رسالة. تعني auto أن النموذج يمكنه الاختيار بين توليد رسالة أو استدعاء أداة أو أكثر. تعني required أن النموذج يجب أن يستدعي أداة أو أكثر. تحديد أداة معينة عبر  يجبر النموذج على استدعاء تلك الأداة. none هو الإعداد الافتراضي عندما لا توجد أدوات. auto هو الإعداد الافتراضي إذا كانت الأدوات موجودة.
type: docs
weight: 150
