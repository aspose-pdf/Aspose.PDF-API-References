---
title: "الفئة ThreadMessageListResponse"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.AI.ThreadMessageListResponse. تمثل استجابة قائمة تحتوي على بيانات رسائل الخيط."
type: docs
weight: 1230
url: /ar/net/aspose.pdf.ai/threadmessagelistresponse/
---
## ThreadMessageListResponse class

يمثل استجابة قائمة تحتوي على بيانات رسائل السلسلة.
...
| الاسم | الوصف |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | البناء الافتراضي. |
