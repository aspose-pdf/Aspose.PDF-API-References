...
description: Aspose.Pdf.AI.ThreadMessageListResponse class. تمثل استجابة قائمة تحتوي على بيانات رسالة الخيط
type: docs
weight: 1140
...
تمثل استجابة قائمة تحتوي على بيانات رسالة الخيط.
...
| Name | Description |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | المُنشئ الافتراضي. |
