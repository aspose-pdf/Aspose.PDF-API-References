---
title: "الواجهة IChatCopilot"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "واجهة Aspose.Pdf.AI.IChatCopilot. تمثل مساعدًا للدردشة للتفاعل مع المستندات عبر نماذج الذكاء الاصطناعي"
type: docs
weight: 490
...
يمثل مساعد دردشة للتفاعل مع المستندات عبر نماذج الذكاء الاصطناعي.
...
| [GetResponseAsync](../../aspose.pdf.ai/ichatcopilot/getresponseasync/#getresponseasync)(List&lt;string&gt;, CancellationToken?) | يحصل بشكل غير متزامن على استجابة للقائمة المعطاة من الرسائل. |
...
| [SaveResponseAsync](../../aspose.pdf.ai/ichatcopilot/saveresponseasync/#saveresponseasync_1)(List&lt;string&gt;, string, CancellationToken?) | يحفظ الاستجابات للقائمة المعطاة من الرسائل بشكل غير متزامن إلى ملف PDF. |
...
| [SaveResponseAsync](../../aspose.pdf.ai/ichatcopilot/saveresponseasync/#saveresponseasync)(List&lt;string&gt;, string, SaveFormat, CancellationToken?) | يحفظ الاستجابات للقائمة المعطاة من الرسائل بشكل غير متزامن إلى ملف بالتنسيق المحدد. |
