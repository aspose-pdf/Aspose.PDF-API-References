...
description: "طريقة IOpenAIClient. تُنشئ خيطًا وتشغيلًا داخله بشكل غير متزامن"
type: docs
weight: 60
...
ينشئ خيطًا وتشغيلًا داخله بشكل غير متزامن.
...
مهمة تمثل العملية غير المتزامنة. يحتوي نتيجة المهمة على الاستجابة من إنشاء الخيط والتشغيل.
