---
title: "الفئة PdfAValidateOptions"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Plugins.PdfAValidateOptions. تمثل خيارات التحقق من توافق PDF/A لمستندات PDF باستخدام إضافة PdfAConverter."
type: docs
weight: 9180
...
تمثل خيارات التحقق من توافق PDF/A لمستندات PDF باستخدام إضافة [`PdfAConverter`](../pdfaconverter/).
...
| الاسم | الوصف |
| --- | --- |
| [PdfAValidateOptions](pdfavalidateoptions/)() | البناء الافتراضي. |
