---
title: "الفئة PdfAOptionsBase"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Plugins.PdfAOptionsBase. تمثل الفئة الأساسية لخيارات المكوّن الإضافي PdfAConverter. توفر هذه الفئة الخصائص والطرق لتكوين عملية التحويل والتحقق من PDF/A"
type: docs
weight: 9160
...
تمثل الفئة الأساسية لخيارات المكوّن الإضافي [`PdfAConverter`](../pdfaconverter/). توفر هذه الفئة الخصائص والطرق لتكوين عملية التحويل والتحقق من PDF/A.
