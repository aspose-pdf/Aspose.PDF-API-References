---
title: "الفئة FormCheckBoxFieldSetOptions"
second_title: "مرجع API لـ Aspose.PDF لـ .NET"
description: "الفئة Aspose.Pdf.Plugins.FormCheckBoxFieldSetOptions. تمثل خيارات تعيين الخصائص في CheckboxField بواسطة ملحق FormEditor"
type: docs
weight: 8720
url: /ar/net/aspose.pdf.plugins/formcheckboxfieldsetoptions/
---
## FormCheckBoxFieldSetOptions class

تمثل خيارات تعيين الخصائص في CheckboxField بواسطة ملحق [`FormEditor`](../formeditor/).
...
| الاسم | الوصف |
| --- | --- |
| [FormCheckBoxFieldSetOptions](formcheckboxfieldsetoptions/)() | البناء الافتراضي. |
...
| [Checked](../../aspose.pdf.plugins/formcheckboxfieldsetoptions/checked/) { get; set; } | يحصل/يضبط القيمة لتحديد الخاصية Checked للحقل المعدل (إذا سيتم ضبطها). |
...
| [Rect](../../aspose.pdf.plugins/formfieldsetoptions/rect/) { get; set; } | Rectangle التي يتم تعيينها إلى الحقل(ات). |
...
| [Style](../../aspose.pdf.plugins/formcheckboxfieldsetoptions/style/) { get; set; } | يحصل/يضبط القيمة لتحديد الخاصية BoxStyle للحقل المعدل (إذا سيتم ضبطها). |
