...
description: "فئة تمثّل عامل k (تعيين لون CMYK للعمليات غير المتسلسلة)."
type: docs
weight: 530
url: /ar/java/com.aspose.pdf.operators/setcmykcolor/
---
**Inheritance:**
...
فئة تمثّل عامل k (تعيين لون CMYK للعمليات غير المتسلسلة).

## المنشئات

| منشئ | الوصف |
| --- | --- |
| [SetCMYKColor](#SetCMYKColor-double-double-double-double-) | يقوم بتهيئة المشغل. |
