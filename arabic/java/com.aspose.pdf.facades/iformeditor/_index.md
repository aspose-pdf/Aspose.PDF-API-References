...
type: docs
weight: 260
url: /ar/java/com.aspose.pdf.facades/iformeditor/
---
```
...
| [getDocument](#getDocument--) | يحصل على المستند الذي يعمل عليه FormEditor. |
...
| [setSrcFileName](#setSrcFileName-java.lang.String-) | يحدد اسم ملف المصدر. |
...
يحصل على المستند الذي يعمل عليه FormEditor.
