...
description: "إعادة بناء جدول المراجع المتقاطع لملف PDF وهياكل التذييل."
type: docs
url: /ar/nodejs-cpp/organize/asposepdfrebuildxrefandtrailer/
---

_إعادة بناء جدول المراجع المتقاطع و هياكل التريلر لملف PDF._
