...
description: "تعيين المعلومات (البيانات الوصفية) في ملف PDF."
type: docs
url: /ar/nodejs-cpp/metadata/asposepdfsetinfo/
---

_حدد المعلومات (البيانات الوصفية) في ملف PDF._
...
بالنسبة إلى 'title'، 'creator'، 'author'، 'subject'، 'keywords'، 'creation' و 'mod'، إذا لم تحتاج إلى تعيين قيمة، استخدم undefined أو "" (سلسلة فارغة)
