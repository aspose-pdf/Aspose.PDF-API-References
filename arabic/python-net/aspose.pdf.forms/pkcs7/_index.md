...
description: "يمثل كائن PKCS#7 المتوافق مع مواصفة PKCS#7 في RFC 2315 على الإنترنت، <br/>            PKCS #7: بنية الرسائل المشفرة، الإصدار 1.5.<br/>            يتم تضمين تجزئة SHA1 لنطاق بايتات المستند في حقل PKCS#7 SignedData."
type: docs
weight: 190
url: /ar/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

يمثل كائن PKCS#7 المتوافق مع مواصفة PKCS#7 في RFC 2315 على الإنترنت، <br/>            PKCS #7: بنية الرسائل المشفرة، الإصدار 1.5.<br/>            يتم تضمين تجزئة SHA1 لنطاق بايتات المستند في حقل PKCS#7 SignedData.

يعرض نوع PKCS7 الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| PKCS7() | يُنشئ مثيلًا جديدًا من الفئة [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/). |
| PKCS7(pfx, password) | يُنشئ مثيلًا جديدًا من الفئة PKCS7 |
| PKCS7(pfx, password) | يُنشئ مثيلًا جديدًا من الفئة PKCS7 |
## الخصائص
| الاسم | الوصف |
| :- | :- |
