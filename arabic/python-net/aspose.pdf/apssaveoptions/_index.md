...
description: "خيارات الحفظ للتصدير إلى تنسيق APS XML."
type: docs
weight: 20
url: /ar/python-net/aspose.pdf/apssaveoptions/
---
...
يعرض نوع ApsSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| ApsSaveOptions() | يُنشئ مثيلاً جديدًا لفئة ApsSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
