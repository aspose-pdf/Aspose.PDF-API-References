...
type: docs
weight: 1290
url: /ar/python-net/aspose.pdf/pptxsaveoptions/
---
...
يعرض نوع PptxSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| PptxSaveOptions() | يُنشئ مثيلاً جديدًا من الفئة PptxSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
...
| slides_as_images | إذا تم تعيينه إلى true فإن كل المحتوى يُتعرف عليه كصور (واحدة لكل صفحة) |
| image_resolution | يحصل أو يعيّن دقة الصورة (dpi). القيمة الافتراضية هي 192 dpi. |
| separate_images | إذا تم تعيينه إلى true فإن الصور تُفصل عن جميع الرسومات الأخرى |
| optimize_text_boxes | يُبدّل التعرف على أعمدة النص |
