...
type: docs
weight: 320
url: /ar/python-net/aspose.pdf/epubsaveoptions/
---
...
يعرض نوع EpubSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| EpubSaveOptions() | ينشئ مثيلاً جديداً من فئة EpubSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
...
| content_recognition_mode | عند تحويل ملف PDF (الذي عادةً ما يكون بتخطيط ثابت)،<br/>            تحاول محرك التحويل إجراء التجميع والتحليل متعدد المستويات لاستعادة<br/>            نية مؤلف المستند الأصلي وإنتاج نتيجة بتخطيط تدفق.<br/>               تقوم هذه الخاصية بضبط ذلك التحويل للطريقة<br/>            المرغوبة للتعرف على المحتوى. |
