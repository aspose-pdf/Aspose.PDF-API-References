...
description: "خيارات الحفظ لتنسيق PdfXml."
type: docs
weight: 1260
url: /ar/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
يعرض نوع PdfXmlSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| PdfXmlSaveOptions() | ينشئ مثيلاً جديدًا من الفئة PdfXmlSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
