...
type: docs
weight: 1810
url: /ar/python-net/aspose.pdf/xpssaveoptions/
---
...
نوع XpsSaveOptions يعرض الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| XpsSaveOptions() | يُنشئ مثيلاً جديدًا من الفئة XpsSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
...
| save_transparent_texts | يشير إلى ما إذا كان يجب الحفاظ على النص الشفاف (المُستخرج عبر OCR). |
