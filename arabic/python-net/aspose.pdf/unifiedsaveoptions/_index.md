...
description: "هذه الفئة تمثل خيارات الحفظ لعملية الحفظ التي <br/>            تستخدم طريقة تحويل موحدة (مع نموذج مستند داخلي موحد)"
type: docs
weight: 1590
url: /ar/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

هذه الفئة تمثل خيارات الحفظ لعملية الحفظ التي <br/>            تستخدم طريقة تحويل موحدة (مع نموذج مستند داخلي موحد)

يعرض نوع UnifiedSaveOptions الأعضاء التالية:
## المُنشئات
| الاسم | الوصف |
| :- | :- |
| UnifiedSaveOptions() | يُنشئ مثيلاً جديدًا من الفئة UnifiedSaveOptions |
## الخصائص
| الاسم | الوصف |
| :- | :- |
