...
description: 表示有助于将pdf文档页面保存为gif的图像设备。
type: docs
weight: 17
...
表示有助于将pdf文档页面保存为gif的图像设备。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [GifDevice()](#GifDevice--) | 使用默认分辨率初始化 GifDevice 类的新实例。 |
| [GifDevice(Resolution resolution)](#GifDevice-com.aspose.pdf.devices.Resolution-) | 初始化 GifDevice 类的新实例。 |
| [GifDevice(int width, int height, Resolution resolution)](#GifDevice-int-int-com.aspose.pdf.devices.Resolution-) | 使用提供的图像尺寸和分辨率初始化 GifDevice 类的新实例。 |
| [GifDevice(PageSize pageSize, Resolution resolution)](#GifDevice-com.aspose.pdf.PageSize-com.aspose.pdf.devices.Resolution-) | 使用提供的页面大小和分辨率初始化 GifDevice 类的新实例。 |
| [GifDevice(int width, int height)](#GifDevice-int-int-) | 使用提供的图像尺寸、默认分辨率 (=150) 初始化 GifDevice 类的新实例。 |
| [GifDevice(PageSize pageSize)](#GifDevice-com.aspose.pdf.PageSize-) | 使用提供的页面大小、默认分辨率 (=150) 初始化 GifDevice 类的新实例。 |
## 方法
...
| [process(Page page, OutputStream output)](#process-com.aspose.pdf.Page-java.io.OutputStream-) | 将页面转换为 gif 并将其保存在输出流中。 |
| [process(Page page, String outputFileName)](#process-com.aspose.pdf.Page-java.lang.String-) | 在给定页面上执行一些操作并将结果保存到文件中。 |
| [processInternal(Page page, System.IO.Stream output)](#processInternal-com.aspose.pdf.Page-com.aspose.ms.System.IO.Stream-) | 将页面转换为 gif 并将其保存在输出流中。 |
...
使用提供的图像尺寸和分辨率初始化 GifDevice 类的新实例。
...
使用提供的图像尺寸、默认分辨率 (=150) 初始化 GifDevice 类的新实例。
...
使用提供的页面大小、默认分辨率 (=150) 初始化 GifDevice 类的新实例。
...
| output | java.io.OutputStream | 带有 gif 图像的输出流。 |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 要转换的页面。 |
| output | com.aspose.ms.System.IO.Stream | 带有 gif 图像的输出流。 |
