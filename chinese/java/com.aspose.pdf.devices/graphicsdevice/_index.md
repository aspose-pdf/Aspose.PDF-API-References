...
description: 表示有助于将 pdf 文档页面呈现为图形的图像设备。
type: docs
weight: 18
url: /zh/java/com.aspose.pdf.devices/graphicsdevice/
---
**遗产：**
...
| [process(Page page, System.IO.Stream output)](#process-com.aspose.pdf.Page-com.aspose.ms.System.IO.Stream-) | 在给定页面上执行一些操作，例如将页面转换为图形图像。 |
...
| [processInternal(Page page, System.IO.Stream output)](#processInternal-com.aspose.pdf.Page-com.aspose.ms.System.IO.Stream-) | 内部方法 |
...
使用提供的图像尺寸和分辨率初始化 GraphicsDevice 类的新实例。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| origin | [Point](../../com.aspose.pdf/point) | 左上图像坐标 |
| paperWidth | int | 图像自动调整大小的宽度 |
| paperHeight | int | 图像自动调整大小的高度 |
| marginBounds | com.aspose.ms.System.Drawing.Rectangle | 矩形对象 |
| scaleFactor | float | 输出图像的比例因子。 |
| resolution | [Resolution](../../com.aspose.pdf.devices/resolution) | 结果图像文件的分辨率，请参阅分辨率类。 |
| rotateDegrees | int | 学位 |
| autoSize | boolean | 布尔值 |
| verticalAlignment | int | VerticalAlignment 元素 |
| horizontalAlignment | int | 水平对齐元素 |
| isXpsPrinting | boolean | 布尔值 |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 页面对象 |
| output | com.aspose.ms.System.IO.Stream | 内部对象 |
