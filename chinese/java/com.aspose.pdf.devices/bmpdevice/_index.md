...
| 构造函数 | 描述 |
| --- | --- |
| [BmpDevice()](#BmpDevice--) | 使用默认分辨率初始化 BmpDevice 类的新实例。 |
| [BmpDevice(Resolution resolution)](#BmpDevice-com.aspose.pdf.devices.Resolution-) | 初始化 BmpDevice 类的新实例。 |
| [BmpDevice(int width, int height, Resolution resolution)](#BmpDevice-int-int-com.aspose.pdf.devices.Resolution-) | 使用提供的图像尺寸和分辨率初始化 BmpDevice 类的新实例。 |
| [BmpDevice(PageSize pageSize, Resolution resolution)](#BmpDevice-com.aspose.pdf.PageSize-com.aspose.pdf.devices.Resolution-) | 使用提供的页面大小和分辨率初始化 BmpDevice 类的新实例。 |
| [BmpDevice(int width, int height)](#BmpDevice-int-int-) | 使用提供的图像尺寸、默认分辨率 (=150) 初始化 BmpDevice 类的新实例。 |
| [BmpDevice(PageSize pageSize)](#BmpDevice-com.aspose.pdf.PageSize-) | 使用提供的页面大小、默认分辨率 (=150) 初始化 BmpDevice 类的新实例。 |
## 方法
...
| [process(Page page, OutputStream output)](#process-com.aspose.pdf.Page-java.io.OutputStream-) | 将页面转换为 bmp 并将其保存在输出流中。 |
| [process(Page page, String outputFileName)](#process-com.aspose.pdf.Page-java.lang.String-) | 在给定页面上执行一些操作并将结果保存到文件中。 |
| [processInternal(Page page, System.IO.Stream output)](#processInternal-com.aspose.pdf.Page-com.aspose.ms.System.IO.Stream-) | 仅供内部使用！ |
...
使用提供的图像尺寸、默认分辨率 (=150) 初始化 BmpDevice 类的新实例。
...
使用提供的页面大小、默认分辨率 (=150) 初始化 BmpDevice 类的新实例。
...
| output | java.io.OutputStream | 带有 bmp 图像的输出流。 |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 要转换的页面。 |
| output | com.aspose.ms.System.IO.Stream | 带有 bmp 图像的输出流。 |
