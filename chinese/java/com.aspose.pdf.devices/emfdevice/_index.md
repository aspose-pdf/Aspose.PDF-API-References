...
| 构造函数 | 描述 |
| --- | --- |
| [EmfDevice()](#EmfDevice--) | 使用写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例。 |
| [EmfDevice(Resolution resolution)](#EmfDevice-com.aspose.pdf.devices.Resolution-) | 初始化 EmfDevice 类的新实例。 |
| [EmfDevice(int width, int height)](#EmfDevice-int-int-) | 使用提供的图像尺寸和写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例 (=150) |
| [EmfDevice(PageSize pageSize)](#EmfDevice-com.aspose.pdf.PageSize-) | 使用提供的页面大小和写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例 (=150) |
| [EmfDevice(int width, int height, Resolution resolution)](#EmfDevice-int-int-com.aspose.pdf.devices.Resolution-) | 使用提供的图像尺寸和写入 emf 的光栅图像的分辨率初始化 JpegDevice 类的新实例。 |
| [EmfDevice(PageSize pageSize, Resolution resolution)](#EmfDevice-com.aspose.pdf.PageSize-com.aspose.pdf.devices.Resolution-) | 使用提供的页面大小和写入 emf 的光栅图像的分辨率初始化 JpegDevice 类的新实例。 |
## 方法
...
| [process(Page page, OutputStream output)](#process-com.aspose.pdf.Page-java.io.OutputStream-) | 将页面转换为 emf 并将其保存在输出流中。 |
| [process(Page page, String outputFileName)](#process-com.aspose.pdf.Page-java.lang.String-) | 在给定页面上执行一些操作并将结果保存到文件中。 |
| [processInternal(Page page, System.IO.Stream output)](#processInternal-com.aspose.pdf.Page-com.aspose.ms.System.IO.Stream-) | 将页面转换为 emf 并将其保存在输出流中。 |
...
使用写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| resolution | [Resolution](../../com.aspose.pdf.devices/resolution) | 写入 emf 的光栅图像的分辨率，请参阅分辨率类。 |
...
使用提供的图像尺寸和写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例 (=150)
...
使用提供的页面大小和写入 emf 的光栅图像的默认分辨率初始化 EmfDevice 类的新实例 (=150)
...
使用提供的图像尺寸和写入 emf 的光栅图像的分辨率初始化 JpegDevice 类的新实例。
...
使用提供的页面大小和写入 emf 的光栅图像的分辨率初始化 JpegDevice 类的新实例。
...
| output | java.io.OutputStream | 带有 emf 图像的输出流。 |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 要转换的页面。 |
| output | com.aspose.ms.System.IO.Stream | 带有 emf 图像的输出流。 |
