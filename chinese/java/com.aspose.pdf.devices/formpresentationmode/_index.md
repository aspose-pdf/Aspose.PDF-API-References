...
description: 用于指定打印或转为图像pdf文档时的表单呈现方式。
type: docs
weight: 16
url: /zh/java/com.aspose.pdf.devices/formpresentationmode/
---
**遗产：**
...
用于指定打印或转为图像pdf文档时的表单呈现方式。
## 领域

| 场地 | 描述 |
| --- | --- |
| [Editor](#Editor) | 指定编辑器表单呈现模式。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Production](#Production) | 指定生产表单呈现模式（默认使用）。 |
## 方法
...
某些产品使用编辑器模式来显示表单。在编辑器模式下，一些表单元素的显示方式与它们在表单设计器中的显示方式相同。
