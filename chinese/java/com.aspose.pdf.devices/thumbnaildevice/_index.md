...
| 构造函数 | 描述 |
| --- | --- |
| [ThumbnailDevice()](#ThumbnailDevice--) | 初始化一个新的实例[ThumbnailDevice](../../com.aspose.pdf.devices/thumbnaildevice)具有默认缩略图大小（200x200 像素）的类。 |
| [ThumbnailDevice(int width, int height)](#ThumbnailDevice-int-int-) | 初始化一个新的实例[ThumbnailDevice](../../com.aspose.pdf.devices/thumbnaildevice)班级。 |
## 方法
...
| [processInternal(Page page, OutputStream output)](#processInternal-com.aspose.pdf.Page-java.io.OutputStream-) | 将页面转换为缩略图 png 并将其保存在输出流中。 |
...
初始化一个新的实例[ThumbnailDevice](../../com.aspose.pdf.devices/thumbnaildevice)具有默认缩略图大小（200x200 像素）的类。
...
初始化一个新的实例[ThumbnailDevice](../../com.aspose.pdf.devices/thumbnaildevice)班级。
