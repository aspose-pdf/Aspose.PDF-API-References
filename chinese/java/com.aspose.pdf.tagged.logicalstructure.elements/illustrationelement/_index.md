...
description: 表示逻辑结构中插图结构元素的基类。
type: docs
weight: 14
url: /zh/java/com.aspose.pdf.tagged.logicalstructure.elements/illustrationelement/
---
**遗产：**
...
| [setImage(String imageSrc)](#setImage-java.lang.String-) | 将图像附加到当前插图元素。 |
| [setImage(String imageSrc, double imageResolution)](#setImage-java.lang.String-double-) | 将图像附加到当前插图元素。 |
| [setImage(String imageSrc, double imageWidth, double imageHeight)](#setImage-java.lang.String-double-double-) | 将图像附加到当前插图元素。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| imageSrc | java.lang.String | 图片来源。 |
