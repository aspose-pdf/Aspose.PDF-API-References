...
description: 表示 F 运算符使用非零缠绕规则填充路径的类。
type: docs
weight: 51
url: /zh/java/com.aspose.pdf.operators/obsoletefill/
---
**遗产：**
...
| [ObsoleteFill(int index, ICommand command)](#ObsoleteFill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
