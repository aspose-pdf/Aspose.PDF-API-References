...
description: 更改文本位置 Tm Td 等运算符的抽象基类。
type: docs
weight: 89
url: /zh/java/com.aspose.pdf.operators/textplaceoperator/
---
**遗产：**
...
更改文本位置（Tm、Td 等）的运算符的抽象基类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [TextPlaceOperator()](#TextPlaceOperator--) | 新 TextPlaceOperator 的构造函数。 |
| [TextPlaceOperator(TextProperties textProperties)](#TextPlaceOperator-com.aspose.pdf.facades.TextProperties-) | 接受 TextProperties 的 TextPlaceOperator 的构造函数。 |
## 方法
...
接受 TextProperties 的 TextPlaceOperator 的构造函数。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| textProperties | [TextProperties](../../com.aspose.pdf.facades/textproperties) | 文本属性值 |
