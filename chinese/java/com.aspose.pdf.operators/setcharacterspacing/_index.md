...
description: 表示 Tc 运算符集字符间距的类。
type: docs
weight: 60
url: /zh/java/com.aspose.pdf.operators/setcharacterspacing/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetCharacterSpacing(int index, ICommand command)](#SetCharacterSpacing-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetCharacterSpacing(double charSpacing)](#SetCharacterSpacing-double-) | 初始化运算符。 |
## 方法
...
| [getCharSpacing()](#getCharSpacing--) | 获取字符间距。 |
| [getClass()](#getClass--) |  |
...
| [notifyAll()](#notifyAll--) |  |
| [reset()](#reset--) | 仅供内部使用 |
| [setCharSpacing(double value)](#setCharSpacing-double-) | 设置字符间距。 |
