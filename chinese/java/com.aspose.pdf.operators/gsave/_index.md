...
description: 表示 q 运算符保存图形状态的类。
type: docs
weight: 41
url: /zh/java/com.aspose.pdf.operators/gsave/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [GSave(int index, ICommand command)](#GSave-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [GSave()](#GSave--) | q 运算符的构造函数。 |
## 方法
