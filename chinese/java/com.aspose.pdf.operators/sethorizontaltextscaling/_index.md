...
description: 表示 Tz 运算符设置水平文本缩放的类。
type: docs
weight: 72
url: /zh/java/com.aspose.pdf.operators/sethorizontaltextscaling/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetHorizontalTextScaling(int index, ICommand command)](#SetHorizontalTextScaling-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetHorizontalTextScaling(double horizintalScaling)](#SetHorizontalTextScaling-double-) | 初始化运算符。 |
## 方法
...
| [getHorizontalScaling()](#getHorizontalScaling--) | 获取水平缩放比例。 |
...
| [notifyAll()](#notifyAll--) |  |
| [reset()](#reset--) | 仅供内部使用 |
| [setHorizontalScaling(double value)](#setHorizontalScaling-double-) | 设置水平缩放。 |
