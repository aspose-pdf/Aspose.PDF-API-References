...
description: 表示 h 运算符关闭路径的类。
type: docs
weight: 19
url: /zh/java/com.aspose.pdf.operators/closepath/
---
**遗产：**
...
| [ClosePath(int index, ICommand command)](#ClosePath-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
