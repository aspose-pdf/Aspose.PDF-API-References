...
| 构造函数 | 描述 |
| --- | --- |
| [SetColorSpace(String name)](#SetColorSpace-java.lang.String-) | 初始化运算符。 |
| [SetColorSpace(int index, ICommand command)](#SetColorSpace-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
