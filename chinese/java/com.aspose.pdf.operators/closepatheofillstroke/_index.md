...
type: docs
weight: 20
url: /zh/java/com.aspose.pdf.operators/closepatheofillstroke/
---
**遗产：**
...
类代表 b\* 运算符（使用奇偶规则关闭、填充和描边路径）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ClosePathEOFillStroke()](#ClosePathEOFillStroke--) | 初始化运算符。 |
| [ClosePathEOFillStroke(int index, ICommand command)](#ClosePathEOFillStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
...
| [getCommandName()](#getCommandName--) | 返回运算符的文本表示。 |
