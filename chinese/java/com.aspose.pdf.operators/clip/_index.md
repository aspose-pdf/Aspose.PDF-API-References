...
type: docs
weight: 18
url: /zh/java/com.aspose.pdf.operators/clip/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [Clip(int index, ICommand command)](#Clip-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [Clip()](#Clip--) | 编写程序的构造函数。 |
## 方法
