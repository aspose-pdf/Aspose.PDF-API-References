...
description: 更改当前文本状态 Tc Tf TL 等运算符的抽象基类。
type: docs
weight: 91
url: /zh/java/com.aspose.pdf.operators/textstateoperator/
---
**遗产：**
...
更改当前文本状态（Tc、Tf、TL 等）的运算符的抽象基类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [TextStateOperator()](#TextStateOperator--) | 新 TextStateOperator 的构造函数。 |
| [TextStateOperator(TextProperties textProperties)](#TextStateOperator-com.aspose.pdf.facades.TextProperties-) | 允许传递 TextProperties 的 TextStateoperator 的构造函数。 |
## 方法
...
允许传递 TextProperties 的 TextStateoperator 的构造函数。
