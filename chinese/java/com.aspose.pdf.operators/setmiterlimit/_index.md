...
description: 表示 M 运算符设置斜接限制的类。
type: docs
weight: 76
url: /zh/java/com.aspose.pdf.operators/setmiterlimit/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetMiterLimit(int index, ICommand command)](#SetMiterLimit-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetMiterLimit(double miterLimit)](#SetMiterLimit-double-) | 初始化运算符。 |
## 方法
...
| [getMiterLimit()](#getMiterLimit--) | 获取斜接限制。 |
...
| [setMiterLimit(double value)](#setMiterLimit-double-) | 设置斜接限制。 |
