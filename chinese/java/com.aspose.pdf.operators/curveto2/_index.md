...
description: 表示 y 运算符将曲线附加到复制的路径最终点的类。
type: docs
weight: 26
...
表示 y 运算符的类（将曲线附加到路径，复制最终点）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CurveTo2(int index, ICommand command)](#CurveTo2-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [CurveTo2(double x1, double y1, double x3, double y3)](#CurveTo2-double-double-double-double-) | 初始化曲线运算符。 |
## 方法
