...
description: 表示 f 运算符填充路径的类，具有非零缠绕数规则。
type: docs
weight: 37
url: /zh/java/com.aspose.pdf.operators/fill/
---
**遗产：**
...
表示 f 运算符的类（使用非零缠绕数规则填充路径）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Fill(int index, ICommand command)](#Fill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [Fill()](#Fill--) | 初始化新的 f 运算符。 |
## 方法
