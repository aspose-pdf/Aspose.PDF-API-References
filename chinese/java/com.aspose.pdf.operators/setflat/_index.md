...
| 构造函数 | 描述 |
| --- | --- |
| [SetFlat(double flatness)](#SetFlat-double-) | 初始化运算符。 |
| [SetFlat(int index, ICommand command)](#SetFlat-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
...
| [notifyAll()](#notifyAll--) |  |
| [reset()](#reset--) | 仅供内部使用 |
| [setFlatness(double value)](#setFlatness-double-) | 设置平面度。 |
