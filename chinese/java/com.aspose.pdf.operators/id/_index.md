...
type: docs
weight: 43
url: /zh/java/com.aspose.pdf.operators/id/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [ID(int index, ICommand command)](#ID-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
