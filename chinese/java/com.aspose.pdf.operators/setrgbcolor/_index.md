...
description: "表示 rg 运算符的类（为非描边运算符设置 RGB 颜色）。"
type: docs
weight: 710
...
| 构造函数 | 描述 |
| --- | --- |
| [SetRGBColor](#SetRGBColor-java.awt.Color-) | 使用颜色初始化操作符。 |
| [SetRGBColor](#SetRGBColor-double-double-double-) | 写入程序的构造函数。 |
| [SetRGBColor](#SetRGBColor-int-com.aspose.pdf.engine.commondata.pagecontent.operators.color.SetRGBNonstrokingColor-) | 操作符类的构造函数。 |
