...
type: docs
weight: 77
url: /zh/java/com.aspose.pdf.operators/setrgbcolor/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetRGBColor(int index, ICommand command)](#SetRGBColor-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetRGBColor(double r, double g, double b)](#SetRGBColor-double-double-double-) | 编写程序的构造函数。 |
| [SetRGBColor(Color color)](#SetRGBColor-java.awt.Color-) | 用颜色初始化运算符。 |
## 方法
