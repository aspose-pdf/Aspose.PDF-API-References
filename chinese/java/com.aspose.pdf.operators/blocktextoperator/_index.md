...
description: 文本块运算符的抽象基类，即
type: docs
weight: 17
url: /zh/java/com.aspose.pdf.operators/blocktextoperator/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [BlockTextOperator()](#BlockTextOperator--) | 新运算符的构造函数。 |
| [BlockTextOperator(TextProperties textProperties)](#BlockTextOperator-com.aspose.pdf.facades.TextProperties-) | 接受 TextProperties 的 BlockTextOperator 的构造函数。 |
## 方法
...
接受 TextProperties 的 BlockTextOperator 的构造函数。
