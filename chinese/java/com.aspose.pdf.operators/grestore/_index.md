...
description: 表示 Q 运算符恢复图形状态的类。
type: docs
weight: 39
url: /zh/java/com.aspose.pdf.operators/grestore/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [GRestore(int index, ICommand command)](#GRestore-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [GRestore()](#GRestore--) | Q 运算符的构造函数。 |
## 方法
