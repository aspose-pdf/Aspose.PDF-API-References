...
| 构造函数 | 描述 |
| --- | --- |
| [MoveTextPosition(int index, ICommand command)](#MoveTextPosition-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 初始化运算符。 |
| [MoveTextPosition(double x, double y)](#MoveTextPosition-double-double-) | 初始化运算符。 |
## 方法
