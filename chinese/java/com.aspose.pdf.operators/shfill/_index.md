...
description: 表示 sh 运算符绘制区域的类，带有阴影图案。
type: docs
weight: 85
url: /zh/java/com.aspose.pdf.operators/shfill/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [ShFill()](#ShFill--) | 初始化运算符。 |
| [ShFill(int index, ICommand command)](#ShFill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [ShFill(String shadingName)](#ShFill-java.lang.String-) | 初始化运算符。 |
## 方法
...
| [setName(String value)](#setName-java.lang.String-) | 设置着色名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| shadingName | java.lang.String | 字符串着色名称。 |
