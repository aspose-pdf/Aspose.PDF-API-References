...
description: 表示 j 运算符集线连接样式的类。
type: docs
weight: 74
url: /zh/java/com.aspose.pdf.operators/setlinejoin/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetLineJoin()](#SetLineJoin--) | 初始化运算符。 |
| [SetLineJoin(int join)](#SetLineJoin-int-) |  |
| [SetLineJoin(int index, ICommand command)](#SetLineJoin-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
