...
| 构造函数 | 描述 |
| --- | --- |
| [SetGray(int index, ICommand command)](#SetGray-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetGray(double gray)](#SetGray-double-) | 编写程序的构造函数。 |
## 方法
