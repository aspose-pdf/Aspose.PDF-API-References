...
description: 表示 TD 运算符移动位置和设置行距的类。
type: docs
weight: 47
...
表示 TD 运算符的类（移动位置和设置前导）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [MoveTextPositionSetLeading(int index, ICommand command)](#MoveTextPositionSetLeading-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [MoveTextPositionSetLeading(double x, double y)](#MoveTextPositionSetLeading-double-double-) | 初始化运算符。 |
## 方法
...
| [setX(double value)](#setX-double-) | 文本位置的 X 坐标。 |
| [setY(double value)](#setY-double-) | 文本位置的 Y 坐标。 |
