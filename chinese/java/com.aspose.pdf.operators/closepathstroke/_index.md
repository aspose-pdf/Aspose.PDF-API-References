...
description: 表示 s 运算符关闭和描边路径的类。
type: docs
weight: 22
url: /zh/java/com.aspose.pdf.operators/closepathstroke/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [ClosePathStroke(int index, ICommand command)](#ClosePathStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [ClosePathStroke()](#ClosePathStroke--) | 初始化运算符。 |
## 方法
