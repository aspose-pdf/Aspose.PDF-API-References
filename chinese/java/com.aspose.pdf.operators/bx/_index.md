...
type: docs
weight: 14
url: /zh/java/com.aspose.pdf.operators/bx/
---
**遗产：**
...
| --- | --- |
| [BX()](#BX--) | 初始化运算符。 |
| [BX(int index, ICommand command)](#BX-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
...
| [getCommandName()](#getCommandName--) | 返回命令名称的文本表示。 |
