...
description: 代表Ts 运算符集文本上升的类。
type: docs
weight: 83
url: /zh/java/com.aspose.pdf.operators/settextrise/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SetTextRise(int index, ICommand command)](#SetTextRise-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetTextRise(double textRise)](#SetTextRise-double-) | 初始化运算符。 |
## 方法
...
| [getTextRise()](#getTextRise--) | 获取文本上升。 |
| [hashCode()](#hashCode--) |  |
...
| [setTextRise(double value)](#setTextRise-double-) | 设置文本上升。 |
