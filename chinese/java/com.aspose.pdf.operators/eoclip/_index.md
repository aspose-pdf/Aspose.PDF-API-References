...
type: docs
weight: 31
url: /zh/java/com.aspose.pdf.operators/eoclip/
---
**遗产：**
...
代表W的类\运算符（使用奇偶规则设置剪切路径）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EOClip()](#EOClip--) | 初始化运算符。 |
| [EOClip(int index, ICommand command)](#EOClip-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
