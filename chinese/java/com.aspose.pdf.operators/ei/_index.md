...
description: 表示 EI 运算符结束内联图像对象的类。
type: docs
weight: 29
url: /zh/java/com.aspose.pdf.operators/ei/
---
**遗产：**
...
表示 EI 运算符（结束内联图像对象）的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EI()](#EI--) | 初始化运算符。 |
| [EI(int index, ICommand command)](#EI-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
