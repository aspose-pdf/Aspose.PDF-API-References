...
| 构造函数 | 描述 |
| --- | --- |
| [SetTextMatrix(int index, ICommand command)](#SetTextMatrix-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 初始化运算符。 |
| [SetTextMatrix(double a, double b, double c, double d, double e, double f)](#SetTextMatrix-double-double-double-double-double-double-) | 初始化运算符。 |
| [SetTextMatrix(Matrix m)](#SetTextMatrix-com.aspose.pdf.Matrix-) | 通过矩阵初始化运算符。 |
## 方法
