...
description: 表示图形状态参数字典中 gs 运算符集参数的类。
type: docs
weight: 40
url: /zh/java/com.aspose.pdf.operators/gs/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [GS(int index, ICommand command)](#GS-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [GS(String name)](#GS-java.lang.String-) | 初始化 gs 运算符。 |
## 方法
...
| [setName(String value)](#setName-java.lang.String-) | 设置图形状态资源的名称。 |
| [toString()](#toString--) | 返回运算符的字符串表示。 |
