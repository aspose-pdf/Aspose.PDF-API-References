...
description: 文本相关运算符的抽象基类 TJ Tj Tm BT ET 等。
type: docs
weight: 88
url: /zh/java/com.aspose.pdf.operators/textoperator/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [TextOperator()](#TextOperator--) | 新运算符的构造函数。 |
| [TextOperator(TextProperties textProperties)](#TextOperator-com.aspose.pdf.facades.TextProperties-) | 接受文本属性的文本运算符。 |
## 方法
