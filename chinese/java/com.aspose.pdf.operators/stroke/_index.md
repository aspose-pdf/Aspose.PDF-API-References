...
type: docs
weight: 87
url: /zh/java/com.aspose.pdf.operators/stroke/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [Stroke(int index, ICommand command)](#Stroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
