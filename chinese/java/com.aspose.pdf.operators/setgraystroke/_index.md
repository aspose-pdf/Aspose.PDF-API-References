...
| 构造函数 | 描述 |
| --- | --- |
| [SetGrayStroke(int index, ICommand command)](#SetGrayStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetGrayStroke(double gray)](#SetGrayStroke-double-) | 使用指定的颜色初始化运算符。 |
## 方法
