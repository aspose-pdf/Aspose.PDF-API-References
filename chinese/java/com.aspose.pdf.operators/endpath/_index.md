...
description: 表示没有填充或描边的 n 运算符结束路径的类。
type: docs
weight: 36
url: /zh/java/com.aspose.pdf.operators/endpath/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [EndPath(int index, ICommand command)](#EndPath-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [EndPath()](#EndPath--) | 编写程序的构造函数。 |
## 方法
