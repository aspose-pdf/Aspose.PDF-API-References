...
description: 代表 DP 操作符指定标记内容点的类。
type: docs
weight: 27
...
代表 DP 运算符的类（指定标记的内容点）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DP(String tag)](#DP-java.lang.String-) | 初始化运算符。 |
| [DP(int index, ICommand command)](#DP-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
