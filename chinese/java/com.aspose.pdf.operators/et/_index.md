...
description: 表示运算符 ET 文本块结束的类。
type: docs
weight: 34
url: /zh/java/com.aspose.pdf.operators/et/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [ET(int index, ICommand command)](#ET-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [ET()](#ET--) | 编写程序的构造函数。 |
## 方法
