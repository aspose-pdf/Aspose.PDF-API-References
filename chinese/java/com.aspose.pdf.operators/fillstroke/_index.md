...
description: 表示使用非零绕组规则的 B 运算符填充和描边路径的类
type: docs
weight: 38
url: /zh/java/com.aspose.pdf.operators/fillstroke/
---
**遗产：**
...
| [FillStroke(int index, ICommand command)](#FillStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
