...
type: docs
weight: 45
url: /zh/java/com.aspose.pdf.operators/mp/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [MP(String tag)](#MP-java.lang.String-) | 初始化运算符。 |
| [MP(int index, ICommand command)](#MP-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
