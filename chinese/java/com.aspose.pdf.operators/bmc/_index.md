...
type: docs
weight: 12
url: /zh/java/com.aspose.pdf.operators/bmc/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [BMC(int index, ICommand command)](#BMC-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [BMC(String tag)](#BMC-java.lang.String-) | 编写程序的构造函数。 |
## 方法
