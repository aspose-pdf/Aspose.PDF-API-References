...
type: docs
weight: 11
url: /zh/java/com.aspose.pdf.operators/bi/
---
**遗产：**
...
| --- | --- |
| [BI()](#BI--) | 初始化运算符。 |
| [BI(int index, ICommand command)](#BI-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
