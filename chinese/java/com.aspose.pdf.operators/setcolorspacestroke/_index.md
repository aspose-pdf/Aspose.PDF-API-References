...
| 构造函数 | 描述 |
| --- | --- |
| [SetColorSpaceStroke(int index, ICommand command)](#SetColorSpaceStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetColorSpaceStroke(String name)](#SetColorSpaceStroke-java.lang.String-) | 初始化运算符。 |
## 方法
...
| [setName(String value)](#setName-java.lang.String-) | 设置颜色空间名称。 |
| [toCommand()](#toCommand--) |  |
