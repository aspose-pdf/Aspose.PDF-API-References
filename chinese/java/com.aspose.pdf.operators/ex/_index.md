...
description: 表示 EX 运算符的类 兼容性部分结束。
type: docs
weight: 35
url: /zh/java/com.aspose.pdf.operators/ex/
---
**遗产：**
...
| --- | --- |
| [EX()](#EX--) | 初始化运算符。 |
| [EX(int index, ICommand command)](#EX-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
