...
| 构造函数 | 描述 |
| --- | --- |
| [SetLineWidth(int index, ICommand command)](#SetLineWidth-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
| [SetLineWidth(double width)](#SetLineWidth-double-) | 使用宽度值初始化运算符。 |
## 方法
...
| [setWidth(double value)](#setWidth-double-) | 设置线条的宽度。 |
