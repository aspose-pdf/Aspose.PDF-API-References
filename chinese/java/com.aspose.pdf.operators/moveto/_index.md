...
description: 表示 operators.m 的类移动到并开始新的子路径。
type: docs
weight: 48
...
| [setX(double value)](#setX-double-) | X坐标 |
| [setY(double value)](#setY-double-) | Y坐标 |
...
Inintalizes 新的 Operator.m（移动到）运算符。
