...
description: 表示 Tr 运算符设置文本呈现模式的类。
type: docs
weight: 82
url: /zh/java/com.aspose.pdf.operators/settextrenderingmode/
---
**遗产：**
...
表示 Tr 运算符的类（设置文本呈现模式）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SetTextRenderingMode()](#SetTextRenderingMode--) | 初始化运算符。 |
| [SetTextRenderingMode(int index, ICommand command)](#SetTextRenderingMode-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
## 方法
