...
description: 表示 f 运算符使用奇偶规则填充路径的类。
type: docs
weight: 32
url: /zh/java/com.aspose.pdf.operators/eofill/
---
**遗产：**
...
代表 f 的类\运算符（使用奇偶规则填充路径）。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EOFill(int index, ICommand command)](#EOFill-int-com.aspose.pdf.engine.commondata.pagecontent.operators.commands.ICommand-) | 运算符类的构造函数。 |
