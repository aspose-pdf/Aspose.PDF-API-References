...
type: docs
weight: 18
url: /zh/java/com.aspose.pdf.text/substitutionfontcategories/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [AllEmbeddedFonts](#AllEmbeddedFonts) | 所有嵌入的字体都被替换。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TheSameNamedEmbeddedFonts](#TheSameNamedEmbeddedFonts) | 与系统字体同名的字体。 |
## 方法
...
与系统字体同名的字体。这些字体大多可以安全地替换为相同命名的系统字体。
