...
description: 表示方形注释的类。
type: docs
weight: 333
url: /zh/java/com.aspose.pdf/squareannotation/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [SquareAnnotation(IDocument document)](#SquareAnnotation-com.aspose.pdf.IDocument-) | 与生成器一起使用的构造函数。 |
| [SquareAnnotation(Page page, Rectangle rect)](#SquareAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的方形注释。 |
## 方法
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 将创建注释的文档。 |
