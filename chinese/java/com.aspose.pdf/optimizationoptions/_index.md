...
| [getMaximumImageDimension()](#getMaximumImageDimension--) | 指定最大图像尺寸。 |
...
| [getResolution()](#getResolution--) | 使用 CompressIamges 标志时指定新图像 dpi。 |
...
| [setMaximumImageDimension(int dimension)](#setMaximumImageDimension-int-) | 指定最大图像尺寸。 |
...
| [setResolution(int dpi)](#setResolution-int-) | 使用 CompressIamges 标志时指定新图像 dpi。 |
...
**退货：**
[OptimizationOptions](../../com.aspose.pdf/optimizationoptions) - 优化选项对象。
### equals(Object arg0) {#equals-java.lang.Object-}
```
