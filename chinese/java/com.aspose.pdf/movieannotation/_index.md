...
description: 表示包含要在计算机屏幕上和通过扬声器呈现的动画图形和声音的电影注释。
type: docs
weight: 224
...
表示包含要在计算机屏幕上和通过扬声器呈现的动画图形和声音的电影注释。当注释被激活时，电影被播放。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [MovieAnnotation(IDocument document, String movieFile)](#MovieAnnotation-com.aspose.pdf.IDocument-java.lang.String-) | 与生成器一起使用的构造函数。 |
| [MovieAnnotation(Page page, Rectangle rect, String movieFile)](#MovieAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.lang.String-) | 在指定页面上创建新的声音注释。 |
## 方法
...
| [getAspect()](#getAspect--) | 获取或设置影片的宽度和高度\\ufffds 边界框，以像素为单位。 |
...
| [setAspect(Point value)](#setAspect-com.aspose.pdf.Point-) | 获取或设置影片的宽度和高度\\ufffds 边界框，以像素为单位。 |
...
| [setFile(FileSpecification value)](#setFile-com.aspose.pdf.FileSpecification-) | 设置标识自描述电影文件的文件规范。 |
...
| [setPoster(boolean value)](#setPoster-boolean-) | 获取或设置一个标志或流，指定是否以及如何显示表示电影的海报图像。 |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | 设置注释矩形。 |
| [setRotate(int value)](#setRotate-int-) | 获取或设置影片相对于页面顺时针旋转的度数。 |
| [setTextHorizontalAlignment(int value)](#setTextHorizontalAlignment-int-) | 设置注释的文本对齐方式。 |
| [setTitle(String value)](#setTitle-java.lang.String-) | 设置电影注释的标题。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建电影注释的文档。 |
| movieFile | java.lang.String | 电影文件的名称。 |
...
| movieFile | java.lang.String | 激活注释时要播放的电影文件。 |
...
**退货：**
int - 作为 int 值的 AnnotationType 元素
...
获取或设置一个标志或流，指定是否以及如何显示表示电影的海报图像。如果为真，则海报图像应从电影文件中检索；如果是虚假的，则不得展示海报。
...
获取或设置影片相对于页面顺时针旋转的度数。该值应为 90 的倍数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Point](../../com.aspose.pdf/point) | 点实例 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [FileSpecification](../../com.aspose.pdf/filespecification) | 文件规范对象 |
