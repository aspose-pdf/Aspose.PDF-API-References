...
| 构造函数 | 描述 |
| --- | --- |
| [LineAnnotation(IDocument document, Point start, Point end)](#LineAnnotation-com.aspose.pdf.IDocument-com.aspose.pdf.Point-com.aspose.pdf.Point-) | 与生成器一起使用的构造函数。 |
| [LineAnnotation(Page page, Rectangle rect, Point start, Point end)](#LineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.Point-com.aspose.pdf.Point-) | 在指定页面上创建新的线注释。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 接受访客注解处理。 |
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | 根据矩阵变换更新起点和终点。 |
...
| [getCaptionOffset()](#getCaptionOffset--) | 获取字幕文本相对于其正常位置的偏移量。 |
| [getCaptionPosition()](#getCaptionPosition--) | 获取注释标题位置。 |
...
| [getEnding()](#getEnding--) | 获取线的终点。 |
| [getEndingStyle()](#getEndingStyle--) | 获取线终点的结束样式。 |
...
| [getIntent()](#getIntent--) | 获取线条注释的意图。 |
| [getInteriorColor()](#getInteriorColor--) | 获取注释的内部颜色。 |
| [getLeaderLine()](#getLeaderLine--) | 获取引出线长度。 |
| [getLeaderLineExtension()](#getLeaderLineExtension--) | 获取引出线延伸的长度。 |
| [getLeaderLineOffset()](#getLeaderLineOffset--) | 获取引导线偏移量。 |
...
| [getShowCaption()](#getShowCaption--) | 获取确定内容必须显示为标题的布尔标志。 |
| [getStarting()](#getStarting--) | 获取线的起点。 |
| [getStartingStyle()](#getStartingStyle--) | 获取线起点的线结束样式。 |
...
| [setCaptionOffset(Point value)](#setCaptionOffset-com.aspose.pdf.Point-) | 设置标题文本与其正常位置的偏移量。 |
| [setCaptionPosition(int value)](#setCaptionPosition-int-) | 设置注释标题位置。 |
| [setColor(Color value)](#setColor-com.aspose.pdf.Color-) | 设置注释颜色。 |
| [setContents(String value)](#setContents-java.lang.String-) | 设置注释文本。 |
| [setEnding(Point value)](#setEnding-com.aspose.pdf.Point-) | 设置线结束点。 |
| [setEndingStyle(int value)](#setEndingStyle-int-) | 设置线终点的结束样式。 |
...
| [setIntent(int value)](#setIntent-int-) | 设置线注释的意图。 |
| [setInteriorColor(Color value)](#setInteriorColor-com.aspose.pdf.Color-) | 设置注释的内部颜色。 |
| [setKeptWithNext(boolean value)](#setKeptWithNext-boolean-) | 设置一个布尔值，指示当前段落是否与下一段保持在同一页面中。 |
| [setLeaderLine(double value)](#setLeaderLine-double-) | 设置引出线长度。 |
| [setLeaderLineExtension(double value)](#setLeaderLineExtension-double-) | 设置引出线延伸的长度。 |
| [setLeaderLineOffset(double value)](#setLeaderLineOffset-double-) | 设置引出线偏移。 |
| [setMargin(MarginInfo value)](#setMargin-com.aspose.pdf.MarginInfo-) | 设置段落的外边距（用于生成 pdf） |
| [setMeasure(Measure value)](#setMeasure-com.aspose.pdf.Measure-) | 为此注释指定的测量单位。 |
...
| [setShowCaption(boolean value)](#setShowCaption-boolean-) | 设置布尔标志，确定内容必须显示为标题。 |
| [setStarting(Point value)](#setStarting-com.aspose.pdf.Point-) | 设置线的起点。 |
| [setStartingStyle(int value)](#setStartingStyle-int-) | 设置线起点的线结束样式。 |
...
| start | [Point](../../com.aspose.pdf/point) | 初始点。 |
| end | [Point](../../com.aspose.pdf/point) | 终点。 |
...
| start | [Point](../../com.aspose.pdf/point) | 一个点，指定直线的起始坐标。 |
| end | [Point](../../com.aspose.pdf/point) | 一个点，指定线的结束坐标。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| transform | [Matrix](../../com.aspose.pdf/matrix) | 指定转换的矩阵。 |
...
**退货：**
[Measure](../../com.aspose.pdf/measure) 测量对象
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Point](../../com.aspose.pdf/point) | 点值 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Measure](../../com.aspose.pdf/measure) | 测量对象 |
