...
description: 默认情况下应用替换文本操作的范围 REPLACE_FIRST 保留此过时选项以保持兼容性。
type: docs
weight: 11
...
应用替换文本操作的范围 REPLACE\_FIRST 默认保留这个过时的选项是为了兼容性。它影响 PdfContentEditor，对 TextFragmentAbsorber 没有影响。
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [REPLACE_ALL](#REPLACE-ALL) | 替换所有受影响页面上出现的所有文本 |
| [REPLACE_FIRST](#REPLACE-FIRST) | 仅替换每个受影响页面上第一次出现的文本 |
## 方法
