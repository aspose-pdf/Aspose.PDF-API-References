...
| 构造函数 | 描述 |
| --- | --- |
| [CaretAnnotation(IDocument document)](#CaretAnnotation-com.aspose.pdf.IDocument-) | 在 Generator 中使用的构造函数。 |
| [CaretAnnotation(Page page, Rectangle rect)](#CaretAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的 Caret 注释。 |
## 方法
...
| [getSymbol()](#getSymbol--) | 获取与插入符号关联的符号。 |
...
| [setFrame(Rectangle value)](#setFrame-com.aspose.pdf.Rectangle-) | 设置插入符矩形。 |
...
| [setSymbol(int value)](#setSymbol-int-) | 设置导入的输出页面大小。 |
...
**退货：**
[Rectangle](../../com.aspose.pdf/rectangle) 插入符号矩形。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.pdf/rectangle) | 插入符号矩形。 |
