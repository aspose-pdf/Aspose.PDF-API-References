...
| 构造函数 | 描述 |
| --- | --- |
| [ButtonField()](#ButtonField--) | 生成器的按钮字段构造函数。 |
| [ButtonField(Page page, Rectangle rect)](#ButtonField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | ButtonField 构造函数。 |
| [ButtonField(IDocument doc, Rectangle rect)](#ButtonField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | ButtonField 构造器。 |
## 领域
...
| [addImage(BufferedImage image, boolean fillArea)](#addImage-java.awt.image.BufferedImage-boolean-) | 将图像添加到现场资源并绘制它。 |
...
| [getAlternateCaption()](#getAlternateCaption--) | 获取按钮的备用标题，当在其活动区域内按下鼠标按钮时应显示该标题。 |
| [getAlternateIcon()](#getAlternateIcon--) | 获取替代图标，当在其活动区域内按下鼠标按钮时应显示该图标。 |
...
| [getIconFit()](#getIconFit--) | 获取图标适合对象，指定小部件注释的图标应如何在其注释矩形内显示。 |
...
| [getNormalCaption()](#getNormalCaption--) | 获取正常的标题。 |
| [getNormalIcon()](#getNormalIcon--) | 获取按钮的正常图标，当它不与用户交互时应显示该图标。 |
...
| [getRolloverCaption()](#getRolloverCaption--) | 获取按钮的滚动标题，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该标题。 |
| [getRolloverIcon()](#getRolloverIcon--) | 获取按钮的滚动图标，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该图标。 |
...
| [setAlternateCaption(String value)](#setAlternateCaption-java.lang.String-) | 设置按钮的替代标题，当在其活动区域内按下鼠标按钮时应显示该标题。 |
| [setAlternateIcon(XForm value)](#setAlternateIcon-com.aspose.pdf.XForm-) | 设置在其活动区域内按下鼠标按钮时应显示的备用图标。 |
...
| [setICPosition(int value)](#setICPosition-int-) | 设置图标标题位置。 |
...
| [setNormalCaption(String value)](#setNormalCaption-java.lang.String-) | 设置普通标题。 |
| [setNormalIcon(XForm value)](#setNormalIcon-com.aspose.pdf.XForm-) | 设置按钮的正常图标，当它不与用户交互时应显示。 |
...
| [setRolloverCaption(String value)](#setRolloverCaption-java.lang.String-) | 设置按钮的滚动标题，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该标题。 |
| [setRolloverIcon(XForm value)](#setRolloverIcon-com.aspose.pdf.XForm-) | 设置按钮的滚动图标，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该图标。 |
...
| [setValue(String value)](#setValue-java.lang.String-) | 设定值。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置按钮的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 按钮在页面上放置的矩形。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建新字段的文档。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 矩形 hwere 按钮放置在页面上。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| image | java.awt.image.BufferedImage | 将图像添加到文本字段中。 |
...
获取按钮的备用标题，当在其活动区域内按下鼠标按钮时应显示该标题。
...
获取图标适合对象，指定小部件注释的图标应如何在其注释矩形内显示。

**退货：**
[IconFit](../../com.aspose.pdf/iconfit) -IconFit 对象
...
获取按钮的滚动标题，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该标题。
...
获取按钮的滚动图标，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该图标。
...
设置按钮的替代标题，当在其活动区域内按下鼠标按钮时应显示该标题。
...
设置在其活动区域内按下鼠标按钮时应显示的备用图标。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [XForm](../../com.aspose.pdf/xform) | 变形对象 |
...
设置按钮的滚动标题，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该标题。
...
设置按钮的滚动图标，当用户将光标滚动到其活动区域而不按下鼠标按钮时应显示该图标。
