...
description: 表示可在结果文档中用于绘制边框或其他线条的线条类型
type: docs
weight: 12
url: /zh/java/com.aspose.pdf/saveoptions.htmlborderlinetype/
---
**遗产：**
...
| [Groove](#Groove) | 将显示格罗夫线 |
| [Inset](#Inset) | 将显示插入线 |
| [None](#None) | 不会显示任何行 |
| [Outset](#Outset) | 将显示起始行 |
| [Ridge](#Ridge) | 将显示骑行线 |
| [Solid](#Solid) | 将显示实线 |
## 方法
