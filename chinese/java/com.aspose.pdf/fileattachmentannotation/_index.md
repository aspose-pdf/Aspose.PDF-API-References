...
| 构造函数 | 描述 |
| --- | --- |
| [FileAttachmentAnnotation(Page page, Rectangle rect, FileSpecification fileSpec)](#FileAttachmentAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.FileSpecification-) | 在指定页面上创建新的 FileAttachment 注释。 |
## 方法
...
| [getFile()](#getFile--) | 获取与此注释关联的文件的规范。 |
...
| [setFile(FileSpecification value)](#setFile-com.aspose.pdf.FileSpecification-) | 设置与此注释关联的文件的规范。 |
...
| fileSpec | [FileSpecification](../../com.aspose.pdf/filespecification) | 描述应该与注释绑定的文件。 |
...
**退货：**
[FileSpecification](../../com.aspose.pdf/filespecification) - 文件规范。
### getFlags() {#getFlags--}
```
public int getFlags()
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [FileSpecification](../../com.aspose.pdf/filespecification) | 文件规范。 |
