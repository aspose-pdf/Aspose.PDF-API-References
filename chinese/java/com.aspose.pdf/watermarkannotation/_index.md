...
| 构造函数 | 描述 |
| --- | --- |
| [WatermarkAnnotation(Page page, Rectangle rect)](#WatermarkAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | Watermark 注释类的构造函数。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 申请访客注解。 |
...
| [getFixedPrint()](#getFixedPrint--) | 固定水印注释的打印对象。 |
...
| [setOpacity(double value)](#setOpacity-double-) | 获取或设置注释的不透明度。 |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | 设置注释矩形。 |
| [setText(FormattedText text)](#setText-com.aspose.pdf.facades.FormattedText-) | 设置注释的文本。 |
| [setTextAndState(String[] text, TextState textState)](#setTextAndState-java.lang.String---com.aspose.pdf.TextState-) | 设置注释的文本。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 应放置注释的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 注释的位置。 |
...
**退货：**
[FixedPrint](../../com.aspose.pdf/fixedprint) - 固定打印对象
### getFlags() {#getFlags--}
```
public int getFlags()
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| text | [FormattedText](../../com.aspose.pdf.facades/formattedtext) | FormattedText 文本值。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| text | java.lang.String[] | 字符串数组（文本值） |
