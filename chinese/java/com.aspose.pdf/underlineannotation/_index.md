...
type: docs
weight: 395
url: /zh/java/com.aspose.pdf/underlineannotation/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [UnderlineAnnotation(Page page, Rectangle rect)](#UnderlineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的下划线注释。 |
## 方法
