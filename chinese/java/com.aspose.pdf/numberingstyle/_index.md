...
description: PageLabel 类支持的页码样式的枚举。
type: docs
weight: 230
url: /zh/java/com.aspose.pdf/numberingstyle/
---
**遗产：**
...
| [LettersLowercase](#LettersLowercase) | 小写拉丁字母（a、b、c...）。 |
| [LettersUppercase](#LettersUppercase) | 大写拉丁字母（A、B、C...）。 |
| [None](#None) | 没有编号。 |
| [NumeralsArabic](#NumeralsArabic) | 阿拉伯十进制数。 |
| [NumeralsRomanLowercase](#NumeralsRomanLowercase) | 小写罗马数字 (i, ii, iii...)。 |
| [NumeralsRomanUppercase](#NumeralsRomanUppercase) | 大写罗马数字（I、II、III...）。 |
## 方法
