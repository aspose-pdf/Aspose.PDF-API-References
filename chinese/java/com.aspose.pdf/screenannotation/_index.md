...
description: 一种屏幕注释，指定可以在其上播放媒体剪辑的页面区域。
type: docs
weight: 321
...
一种屏幕注释，指定可以在其上播放媒体剪辑的页面区域。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ScreenAnnotation(Page page, Rectangle rect, String mediaFile)](#ScreenAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-java.lang.String-) | 在指定页面上创建新的屏幕注释。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 表示接受方法 |
...
| [getAction()](#getAction--) | 获取激活注释时要执行的操作。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAction(PdfAction value)](#setAction-com.aspose.pdf.PdfAction-) | 设置注释激活时要执行的操作。 |
...
| [setTitle(String value)](#setTitle-java.lang.String-) | 设置屏幕注释的标题。 |
