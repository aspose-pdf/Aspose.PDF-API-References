...
description: 表示 pdf 文档中签名对象的抽象类。
type: docs
weight: 323
...
表示 pdf 文档中签名对象的抽象类。签名是具有签名对象值的字段，最后包含用于验证文档有效性的数据。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Signature()](#Signature--) | 初始化 Signature 类的新实例。 |
| [Signature(String pfx, String password)](#Signature-java.lang.String-java.lang.String-) | 初始化 Signature 类的新实例。 |
| [Signature(InputStream pfx, String password)](#Signature-java.io.InputStream-java.lang.String-) | 初始化 Signature 类的新实例。 |
## 方法
