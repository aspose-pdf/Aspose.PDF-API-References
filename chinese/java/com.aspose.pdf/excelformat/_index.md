...
description: 允许指定 .xls/xml 或 .xlsx 文件格式。
type: docs
weight: 10
url: /zh/java/com.aspose.pdf/excelsaveoptions.excelformat/
---
**遗产：**
...
允许指定 .xls/xml 或 .xlsx 文件格式。默认值为 XLSX；
## 领域

| 场地 | 描述 |
| --- | --- |
| [CSV](#CSV) | 逗号分隔值 (CSV) 文件格式 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ODS](#ODS) | OpenDocument电子表格 |
| [XLSM](#XLSM) | 启用宏的 Office Open XML (.xlsm) 文件格式 |
| [XLSX](#XLSX) | Office Open XML (.xlsx) 文件格式 |
| [XMLSpreadSheet2003](#XMLSpreadSheet2003) | Excel 2003 XML 格式 |
## 方法
...
启用宏的 Office Open XML (.xlsm) 文件格式
