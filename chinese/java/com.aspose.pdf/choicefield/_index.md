...
| 构造函数 | 描述 |
| --- | --- |
| [ChoiceField(Page page, Rectangle rect)](#ChoiceField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | ChoiceField 的构造函数。 |
| [ChoiceField(IDocument doc)](#ChoiceField-com.aspose.pdf.IDocument-) | 创建选择字段（用于生成器） |
| [ChoiceField(IDocument doc, Rectangle rect)](#ChoiceField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | ChoiceField 的构造函数。 |
## 领域
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 字段所在的页面。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建选择字段的文档。 |
