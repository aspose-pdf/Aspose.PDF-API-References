...
```
 ...
 APS 到流量转换\*!!!不要从 C 移植\可能领先于 .Net 版本 !!!!
## 构造函数
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [render(ApsNode node)](#render-com.aspose.foundation.rendering.ApsNode-) | 将布局节点及其所有内容呈现到 Excel 文档中。 |
...
| [visitGlyphs(ApsGlyphs glyphs)](#visitGlyphs-com.aspose.foundation.rendering.ApsGlyphs-) | 访问字形。 |
| [visitGroup(ApsGroup arg0)](#visitGroup-com.aspose.foundation.rendering.ApsGroup-) |  |
| [visitImage(ApsImage image)](#visitImage-com.aspose.foundation.rendering.ApsImage-) | 访问图像。 |
...
将布局节点及其所有内容呈现到 Excel 文档中。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| node | com.aspose.foundation.rendering.ApsNode | ap 节点。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| glyphs | com.aspose.foundation.rendering.ApsGlyphs | 内部实例 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| image | com.aspose.foundation.rendering.ApsImage | 图片。 |
