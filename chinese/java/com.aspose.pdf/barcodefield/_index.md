...
| 构造函数 | 描述 |
| --- | --- |
| [BarcodeField(Page page, Rectangle rect)](#BarcodeField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 初始化 BarcodeField 类的新实例。 |
| [BarcodeField(IDocument doc, Rectangle rect)](#BarcodeField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | 初始化 BarcodeField 类的新实例。 |
## 领域
...
| [getResolution()](#getResolution--) | 获取呈现条形码对象的分辨率，以每英寸点数 (dpi) 为单位。 |
| [getScrollable()](#getScrollable--) | 获取字段的可滚动标志。 |
| [getSpellCheck()](#getSpellCheck--) | 获取字段的拼写检查标志。 |
| [getStates()](#getStates--) | 获取标注的外观字典。 |
| [getSymbology()](#getSymbology--) | 指定要在此注释上使用的条形码或字形技术，有关详细信息，请参阅符号系统。 |
...
| [getXSymHeight()](#getXSymHeight--) | 获取两个条形码模块之间的垂直距离，以像素为单位。 |
| [getXSymWidth()](#getXSymWidth--) | 获取两个条形码模块之间的水平距离（以像素为单位）。 |
...
初始化 BarcodeField 类的新实例。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置新条形码的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 条形码大小以矩形给出。 |
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 将在页面上放置字段的矩形。 |
...
获取表示纠错系数的整数值。对于 PDF417，应为 0 到 8。对于 QRCode，应为 0 到 3（0 为\\u2018L\ \u2019, 1 个\\u2018M\ \u2019, 2 为\\u2018Q\\u2019，以及 3 个\\u2018H\\u2019）。
...
指定要在此注释上使用的条形码或字形技术，有关详细信息，请参阅符号系统。
...
获取两个条形码模块之间的垂直距离，以像素为单位。 XSymHeight/XSymWidth 比率应为整数值。对于 PDF417，可接受的比率范围是 1 到 4。对于 QRCode 和 DataMatrix，该比率应始终为 1
