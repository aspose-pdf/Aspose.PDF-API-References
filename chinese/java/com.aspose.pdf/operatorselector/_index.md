...
| 构造函数 | 描述 |
| --- | --- |
| [OperatorSelector](#OperatorSelector--) | 初始化 {@code Selector} 类的新实例。 |
| [OperatorSelector](#OperatorSelector-com.aspose.pdf.Operator-) | 初始化 {@code Selector} 类的新实例。 |
