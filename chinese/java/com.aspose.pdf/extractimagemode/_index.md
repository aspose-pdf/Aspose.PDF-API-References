...
| 场地 | 描述 |
| --- | --- |
| [ActuallyUsed](#ActuallyUsed) | 定义图像提取模式，在该模式下，仅提取页面上实际显示的那些图像。 |
| [DefinedInResources](#DefinedInResources) | 定义图像提取模式，其中提取特定页面资源中定义的所有图像。 |
...
定义图像提取模式，在该模式下，仅提取页面上实际显示的那些图像。
