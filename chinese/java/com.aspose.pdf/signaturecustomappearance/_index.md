...
| 构造函数 | 描述 |
| --- | --- |
| [SignatureCustomAppearance()](#SignatureCustomAppearance--) | 初始化的新实例[SignatureCustomAppearance](../../com.aspose.pdf/signaturecustomappearance)班级。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getBackgroundColor()](#getBackgroundColor--) | 获取/设置背景颜色。 |
| [getClass()](#getClass--) |  |
| [getContactInfoLabel()](#getContactInfoLabel--) | 获取/设置联系信息标签。 |
| [getCulture()](#getCulture--) | 获取/设置文化信息值。 |
| [getDateSignedAtLabel()](#getDateSignedAtLabel--) | 获取/设置日期签名标签。 |
| [getDateTimeFormat()](#getDateTimeFormat--) | 获取/设置日期时间格式。 |
| [getDateTimeLocalFormat()](#getDateTimeLocalFormat--) | 获取/设置日期时间本地格式。 |
| [getDigitalSignedLabel()](#getDigitalSignedLabel--) | 获取/设置数字签名标签。 |
| [getDigitalSubjectFormat()](#getDigitalSubjectFormat--) | 获取/设置主题字符串中元素顺序的格式。 |
| [getFontFamilyName()](#getFontFamilyName--) | 获取/设置字体系列名称。 |
| [getFontSize()](#getFontSize--) | 获取/设置字体大小。 |
| [getForegroundColor()](#getForegroundColor--) | 获取/设置前景颜色（文本颜色）。 |
| [getLocationLabel()](#getLocationLabel--) | 获取/设置位置标签。 |
| [getReasonLabel()](#getReasonLabel--) | 获取/设置原因标签。 |
| [getRotation()](#getRotation--) | 获取或设置签名旋转。 |
| [hashCode()](#hashCode--) |  |
| [isShowContactInfo()](#isShowContactInfo--) | 获取/设置联系信息可见性。 |
| [isShowLocation()](#isShowLocation--) | 获取/设置位置可见性。 |
| [isShowReason()](#isShowReason--) | 获取/设置原因可见性。 |
| [isUseDigitalSubjectFormat()](#isUseDigitalSubjectFormat--) | 获取/设置 DigitalSubjectFormat 的使用状态（\#getDigitalSubjectFormat.getDigitalSubjectFormat/\#setDigitalSubjectFormat(int[]).setDigitalSubjectFormat(int[])). |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.pdf.Color-) | 获取/设置背景颜色。 |
| [setContactInfoLabel(String value)](#setContactInfoLabel-java.lang.String-) | 获取/设置联系信息标签。 |
| [setCulture(Locale value)](#setCulture-java.util.Locale-) | 获取/设置文化信息值。 |
| [setDateSignedAtLabel(String value)](#setDateSignedAtLabel-java.lang.String-) | 获取/设置日期签名标签。 |
| [setDateTimeFormat(String value)](#setDateTimeFormat-java.lang.String-) | 获取/设置日期时间格式。 |
| [setDateTimeLocalFormat(String value)](#setDateTimeLocalFormat-java.lang.String-) | 获取/设置日期时间本地格式。 |
| [setDigitalSignedLabel(String value)](#setDigitalSignedLabel-java.lang.String-) | 获取/设置数字签名标签。 |
| [setDigitalSubjectFormat(int[] value)](#setDigitalSubjectFormat-int---) | 获取/设置主题字符串中元素顺序的格式。 |
| [setFontFamilyName(String value)](#setFontFamilyName-java.lang.String-) | 获取/设置字体系列名称。 |
| [setFontSize(double value)](#setFontSize-double-) | 获取/设置字体大小。 |
| [setForegroundColor(Color value)](#setForegroundColor-com.aspose.pdf.Color-) | 获取/设置前景颜色（文本颜色）。 |
| [setLocationLabel(String value)](#setLocationLabel-java.lang.String-) | 获取/设置位置标签。 |
| [setReasonLabel(String value)](#setReasonLabel-java.lang.String-) | 获取/设置原因标签。 |
| [setRotation(int value)](#setRotation-int-) | 获取或设置签名旋转。 |
| [setShowContactInfo(boolean value)](#setShowContactInfo-boolean-) | 获取/设置联系信息可见性。 |
| [setShowLocation(boolean value)](#setShowLocation-boolean-) | 获取/设置位置可见性。 |
| [setShowReason(boolean value)](#setShowReason-boolean-) | 获取/设置原因可见性。 |
| [setUseDigitalSubjectFormat(boolean value)](#setUseDigitalSubjectFormat-boolean-) | 获取/设置 DigitalSubjectFormat 的使用状态（\#getDigitalSubjectFormat.getDigitalSubjectFormat/\#setDigitalSubjectFormat(int[]).setDigitalSubjectFormat(int[])). |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化的新实例[SignatureCustomAppearance](../../com.aspose.pdf/signaturecustomappearance)班级。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Color](../../com.aspose.pdf/color) | com.aspose.pdf.Color 实例 |
