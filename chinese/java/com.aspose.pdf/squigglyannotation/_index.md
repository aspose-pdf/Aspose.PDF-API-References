...
description: 表示在文档文本中显示为锯齿状下划线的波浪注释。
type: docs
weight: 334
url: /zh/java/com.aspose.pdf/squigglyannotation/
---
**遗产：**
...
表示在文档文本中显示为锯齿状下划线的波浪注释。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SquigglyAnnotation(Page page, Rectangle rect)](#SquigglyAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的 Squiggly 注释。 |
## 方法
