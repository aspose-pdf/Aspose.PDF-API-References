...
description: 标注状态对应的状态模型。
type: docs
weight: 21
url: /zh/java/com.aspose.pdf/annotationstatemodel/
---
**遗产：**
...
| [Marked](#Marked) | 注释已被用户标记（或取消标记）。 |
| [Review](#Review) | 注释已被用户审阅（接受、拒绝、取消、完成、无）。 |
| [Undefined](#Undefined) | 未定义状态模型。 |
## 方法
