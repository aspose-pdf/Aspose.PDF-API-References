...
description: 定义将 pdf 文档转换为文本时可以使用的不同模式。
type: docs
weight: 10
...
定义将 pdf 文档转换为文本时可以使用的不同模式。请参见 TextDevice 类。
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MemorySaving](#MemorySaving) | 节省内存的提取。 |
| [Pure](#Pure) | 用一些格式化例程表示 pdf 内容。 |
| [Raw](#Raw) | 按原样表示 pdf 内容，即不带格式。 |
## 方法
...
节省内存的提取。它与“原始”模式几乎相同，但运行速度稍快并且使用的内存更少。
