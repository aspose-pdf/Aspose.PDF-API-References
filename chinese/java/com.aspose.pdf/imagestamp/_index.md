...
| 构造函数 | 描述 |
| --- | --- |
| [ImageStamp(InputStream image)](#ImageStamp-java.io.InputStream-) | 初始化 ImageStamp 类的新实例。 |
| [ImageStamp(String fileName)](#ImageStamp-java.lang.String-) | 在指定文件中逐个创建图像戳记。 |
## 方法
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [put(Page page)](#put-com.aspose.pdf.Page-) | 在页面上添加图形标记。 |
...
| [setHeight(double value)](#setHeight-double-) | 设置图像高度。 |
...
| [setWidth(double value)](#setWidth-double-) | 设置图像宽度。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| fileName | java.lang.String | 包含图像的文件的名称。 |
