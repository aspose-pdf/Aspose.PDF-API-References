...
| 构造函数 | 描述 |
| --- | --- |
| [StampAnnotation(IDocument document)](#StampAnnotation-com.aspose.pdf.IDocument-) | 构造函数 |
| [StampAnnotation(Page page, Rectangle rect)](#StampAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的 Stamp 注释。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 浏览注释集合时接受 AnnotationSelector 访问者。 |
...
| [setIcon(int value)](#setIcon-int-) | 设置橡皮图章的图标。 |
| [setImage(InputStream value)](#setImage-java.io.InputStream-) | 设置注释的图像。 |
