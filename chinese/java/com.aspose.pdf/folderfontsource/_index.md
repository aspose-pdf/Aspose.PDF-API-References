...
| 构造函数 | 描述 |
| --- | --- |
| [FolderFontSource](#FolderFontSource-java.lang.String-) | 初始化 {@code FolderFontSource} 类的新实例。 |

## 方法

| 方法 | 描述 |
| --- | --- |
| [equals](#equals-java.lang.Object-) | 检查文件夹字体源对象是否相等。 |
| [getFolderPath](#getFolderPath--) | 包含字体文件的文件夹路径。 |
...
初始化 {@code FolderFontSource} 类的新实例。
