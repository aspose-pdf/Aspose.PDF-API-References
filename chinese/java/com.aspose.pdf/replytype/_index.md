...
description: 枚举注释和 InReplyTo 指定的注释之间的关系类型。
type: docs
weight: 309
...
枚举关系的种类（\\u201爬行类型\\u201d) 在注释和 InReplyTo 指定的注释之间。
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Group](#Group) | 批注与 InReplyTo 指定的批注分组。 |
| [Reply](#Reply) | 批注被视为对 InReplyTo 指定的批注的回复。 |
...
批注被视为对 InReplyTo 指定的批注的回复。查看器应用程序不应单独显示对注释的回复，而应以线程评论的形式一起显示。
