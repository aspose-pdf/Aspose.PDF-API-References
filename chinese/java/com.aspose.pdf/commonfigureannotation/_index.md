...
description: 表示普通图形注释的抽象类。
type: docs
weight: 70
url: /zh/java/com.aspose.pdf/commonfigureannotation/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [CommonFigureAnnotation(IDocument document)](#CommonFigureAnnotation-com.aspose.pdf.IDocument-) | 在生成器中使用的构造函数。 |
## 方法
...
| [getFrame()](#getFrame--) | 描述两个矩形之间数值差异的矩形：注释的 Rect 条目和底层正方形或圆形的实际边界。 |
...
| [getInteriorColor()](#getInteriorColor--) | 填充注释的矩形或椭圆的内部颜色。 |
...
| [setFrame(Rectangle value)](#setFrame-com.aspose.pdf.Rectangle-) | 描述两个矩形之间数值差异的矩形：注释的 Rect 条目和底层正方形或圆形的实际边界。 |
...
| [setInteriorColor(Color value)](#setInteriorColor-com.aspose.pdf.Color-) | 填充注释的矩形或椭圆的内部颜色。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 放置注释的文档。 |
...
描述两个矩形之间数值差异的矩形：注释的 Rect 条目和底层正方形或圆形的实际边界。

**退货：**
[Rectangle](../../com.aspose.pdf/rectangle) - 矩形框
...
**退货：**
[Color](../../com.aspose.pdf/color) 填充注释的矩形或椭圆的内部颜色。
### getMargin() {#getMargin--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.pdf/rectangle) | 矩形框 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Color](../../com.aspose.pdf/color) | 内饰颜色 |
