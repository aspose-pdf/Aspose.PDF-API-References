...
| 方法 | 描述 |
| --- | --- |
| [equals(Object obj)](#equals-java.lang.Object-) | 检查系统字体源对象是否相等。 |
| [getClass()](#getClass--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 将进行比较的系统字体源对象。 |

**退货：**
boolean - 如果两个对象都是系统字体源则为 True，否则为 false。
### getClass() {#getClass--}
```
...
**退货：**
com.aspose.font.FontDefinition[] - 字体定义[目的
### hashCode() {#hashCode--}
```
public int hashCode()
```
