...
description: 表示文本注释，它是附加到 PDF 文档中某个点的便签。
type: docs
weight: 362
...
| 构造函数 | 描述 |
| --- | --- |
| [TextAnnotation(IDocument document)](#TextAnnotation-com.aspose.pdf.IDocument-) | 在生成器中使用时的注释构造函数。 |
| [TextAnnotation(Page page, Rectangle rect)](#TextAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的文本注释。 |
...
| [getOpen()](#getOpen--) | 获取一个标志，该标志指定注释最初是否应显示为打开状态。 |
...
| [getState()](#getState--) | 获取应将原始注释设置到的状态。 |
| [getStateModel()](#getStateModel--) | 获取状态模型 |
...
| [setOpen(boolean value)](#setOpen-boolean-) | 设置一个标志，指定注释最初是否应该显示为打开状态。 |
...
| [setState(int value)](#setState-int-) | 设置应设置原始注释的状态。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建文本注释的文档。 |
