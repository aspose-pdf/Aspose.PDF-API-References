...
| 构造函数 | 描述 |
| --- | --- |
| [ListBoxField()](#ListBoxField--) | 在生成器中使用的 ListBoxField 的构造函数。 |
| [ListBoxField(Page page, Rectangle rect)](#ListBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 创建新的列表框字段。 |
| [ListBoxField(IDocument doc, Rectangle rect)](#ListBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | ListBox 字段的构造函数。 |
## 领域
...
| [getTopIndex()](#getTopIndex--) | 获取列表顶部可见元素的索引。 |
...
| [setSelected(int value)](#setSelected-int-) | 获取所选项目的索引。 |
| [setSelectedItems(int[] value)](#setSelectedItems-int---) | 设置多选列表中所选项目的数组。 |
...
| [setTopIndex(int value)](#setTopIndex-int-) | 设置列表顶部可见元素的索引。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 将放置列表框的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 列表框将放置在页面上的矩形。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 该字段所属的文档。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 放置列表框的矩形。 |
...
设置多选列表中所选项目的数组。对于单选列表，返回包含单个项目的数组。
