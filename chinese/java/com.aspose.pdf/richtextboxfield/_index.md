...
description: 类描述富文本编辑器组件。
type: docs
weight: 313
url: /zh/java/com.aspose.pdf/richtextboxfield/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [RichTextBoxField(Page page, Rectangle rect)](#RichTextBoxField-com.aspose.pdf.Page-java.awt.Rectangle-) | 富文本框字段的构造函数。 |
| [RichTextBoxField(Page page, Rectangle rect)](#RichTextBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 富文本框字段的构造函数。 |
## 领域
...
| [getFormattedValue()](#getFormattedValue--) | 获取带标记的格式化富文本值。 |
...
| [getJustify()](#getJustify--) | 获取富文本框的对齐方式。 |
...
| [getValue()](#getValue--) | 获取 RichTextField 的值。 |
...
| [setFormattedValue(String value)](#setFormattedValue-java.lang.String-) | 使用标记设置格式化的富文本值。 |
...
| [setJustify(int value)](#setJustify-int-) | 设置富文本框的对齐方式。 |
...
| [setRichTextValue(String value)](#setRichTextValue-java.lang.String-) | 设置富文本值。 |
...
| [setStyle(String value)](#setStyle-java.lang.String-) | 设置富文本字段的默认样式字符串。 |
...
| [setValue(String value)](#setValue-java.lang.String-) | 设置 RichTextField 的值。 |
...
| rect | java.awt.Rectangle | java.awt.Rectangle 字段在页面上的位置。 |
...
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置字段的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | com.aspose.pdf.Rectangle 字段在页面上的位置。 |
