...
| 构造函数 | 描述 |
| --- | --- |
| [CheckboxField(Page page, Rectangle rect)](#CheckboxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | CheckboxField 类的构造函数。 |
| [CheckboxField(IDocument doc, Rectangle rect)](#CheckboxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | CheckboxField 类的构造函数。 |
| [CheckboxField()](#CheckboxField--) | 创建 CheckboxField 的实例。 |
| [CheckboxField(IDocument doc)](#CheckboxField-com.aspose.pdf.IDocument-) | 与生成器一起使用的构造函数。 |
## 领域
...
| [getAllowedStates()](#getAllowedStates--) | 返回允许状态列表。 |
...
| [getNormalCaption()](#getNormalCaption--) | 获取字段的正常标题。 |
| [getOnActivated()](#getOnActivated--) | 获取激活注释时应执行的操作。 |
| [getOnState()](#getOnState--) | 返回复选框的“选中”状态的状态名称。 |
...
| [setChecked(boolean value)](#setChecked-boolean-) | 设置复选框的状态。 |
...
| [setExportValue(String value)](#setExportValue-java.lang.String-) | 获取或设置 CheckBox 字段的导出值。 |
...
| [setStyle(int value)](#setStyle-int-) | 设置复选框的样式。 |
...
| [setValue(String value)](#setValue-java.lang.String-) | 设置复选框字段的值。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 将放置复选框的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 复选框的位置和大小。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 将在何处创建新字段的文档。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 将在其中创建新字段的矩形。 |
...
返回复选框的“选中”状态的状态名称。如果存在或除“关闭”和“否”之外的任何其他值，则为“是”；
