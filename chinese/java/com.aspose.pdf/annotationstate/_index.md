...
type: docs
weight: 20
url: /zh/java/com.aspose.pdf/annotationstate/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [Accepted](#Accepted) | 用户同意更改。 |
| [Cancelled](#Cancelled) | 更改已被取消。 |
| [Completed](#Completed) | 更改已完成。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Marked](#Marked) | 注释已被用户标记。 |
| [None](#None) | 用户未对更改做出任何说明。 |
| [Rejected](#Rejected) | 用户不同意更改。 |
| [Undefined](#Undefined) | 未定义状态。 |
| [Unmarked](#Unmarked) | 注释未被用户标记。 |
## 方法
