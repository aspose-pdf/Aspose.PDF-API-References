...
description: 使用 X509Certificate2 创建分离的 PKCS7Detached 签名。
type: docs
weight: 106
...
| 构造函数 | 描述 |
| --- | --- |
| [ExternalSignature(System.Security.Cryptography.X509Certificates.X509Certificate2 certificate)](#ExternalSignature-com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2-) | 创建分离的 PKCS\#7 使用 X509Certificate2 分离签名。 |
## 方法
...
| [getCertificate()](#getCertificate--) | 带有私钥的证书。 |
| [getClass()](#getClass--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| certificate | com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2 | 带有私钥的证书 |
...
**退货：**
com.aspose.ms.System.Security.Cryptography.X509Certificates.X509Certificate2 - 带有私钥的 X509Certificate2 实例
### getClass() {#getClass--}
```
