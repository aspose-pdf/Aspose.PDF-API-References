...
description: 表示指向文档中其他位置的超文本链接或要执行的操作。
type: docs
weight: 200
...
表示指向文档中其他位置的超文本链接或要执行的操作。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LinkAnnotation(Page page, Rectangle rect)](#LinkAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的链接注释。 |
## 方法
...
| [getAction()](#getAction--) | 获取激活链接注释时要执行的操作。 |
...
| [getDestination()](#getDestination--) | 获取注释激活时要显示的目的地。 |
...
| [getHighlighting()](#getHighlighting--) | 获取在其活动区域内按下或按住鼠标按钮时要使用的视觉效果。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAction(PdfAction value)](#setAction-com.aspose.pdf.PdfAction-) | 设置激活链接注释时要执行的操作。 |
...
| [setDestination(IAppointment value)](#setDestination-com.aspose.pdf.IAppointment-) | 设置注释激活时要显示的目的地。 |
...
| [setHighlighting(int value)](#setHighlighting-int-) | 设置在其活动区域内按下或按住鼠标按钮时要使用的视觉效果。 |
...
获取在其活动区域内按下或按住鼠标按钮时要使用的视觉效果。

**退货：**
int - HighlightingMode 元素
...
设置在其活动区域内按下或按住鼠标按钮时要使用的视觉效果。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | HighlightingMode 元素 |
