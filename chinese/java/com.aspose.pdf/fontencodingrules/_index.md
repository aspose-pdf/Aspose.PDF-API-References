...
| 场地 | 描述 |
| --- | --- |
| [DecreaseToUnicodePriorityLevel](#DecreaseToUnicodePriorityLevel) | ToUnicode 是一种特殊的机制，有助于将输入代码解码为 unicode 符号。 |
| [Default](#Default) | 保留编码逻辑“原样”——符合 PDF 规范 |
...
ToUnicode 是一种特殊的机制，有助于将输入代码解码为 unicode 符号。根据规范，必须首先使用所有机制来获取特定输入代码的 unicode 符号。但是某些文档具有非标准字体，要正确转换这些文档，可能需要降低 ToUnicode 优先级并使用其他机制来解码输入代码。
