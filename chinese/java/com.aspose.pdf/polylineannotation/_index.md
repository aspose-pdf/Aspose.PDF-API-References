...
description: 表示折线注释，类似于多边形，只是第一个和最后一个顶点没有隐式连接。
type: docs
weight: 289
url: /zh/java/com.aspose.pdf/polylineannotation/
---
**遗产：**
...
表示类似于多边形的折线注释，只是第一个和最后一个顶点没有隐式连接。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PolylineAnnotation(Page page, Rectangle rect, Point[] vertices)](#PolylineAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.Point---) | 在指定页面上创建新的折线注释。 |
## 方法
