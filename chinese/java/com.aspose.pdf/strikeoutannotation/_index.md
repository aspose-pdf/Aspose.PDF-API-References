...
description: 表示在文档文本中显示为删除线的删除线注释。
type: docs
weight: 339
url: /zh/java/com.aspose.pdf/strikeoutannotation/
---
**遗产：**
...
表示在文档文本中显示为删除线的删除线注释。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [StrikeOutAnnotation(Page page, Rectangle rect)](#StrikeOutAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的 StrikeOut 注释。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 接受访问者对象以处理注释。 |
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | 根据矩阵变换更新 QuadPoints。 |
...
| [getMarkedText()](#getMarkedText--) | 获取标记注释下的文本作为字符串。 |
| [getMarkedTextFragments()](#getMarkedTextFragments--) | 获取标记注释下的文本作为 TextFragmentCollection 。 |
...
**退货：**
java.lang.String - 包含标记注释下的文本的字符串。
...
获取标记注释下的文本作为 TextFragmentCollection 。

**退货：**
[TextFragmentCollection](../../com.aspose.pdf/textfragmentcollection) - 包含标记注释下的 TextFragment 的 TextFragmentCollection。
