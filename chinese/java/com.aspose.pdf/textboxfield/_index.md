...
| 构造函数 | 描述 |
| --- | --- |
| [TextBoxField(IDocument doc)](#TextBoxField-com.aspose.pdf.IDocument-) | 应该与生成器一起使用的构造函数。 |
| [TextBoxField()](#TextBoxField--) | 创建 TextBoxField 的实例。 |
| [TextBoxField(Page page, Rectangle rect)](#TextBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | TextBox 字段的构造函数。 |
| [TextBoxField(IDocument doc, Rectangle rect)](#TextBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | TextBox 字段的构造函数。 |
## 领域
