...
description: 具有指定有效字符的文本字段
type: docs
weight: 228
url: /zh/java/com.aspose.pdf/numberfield/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [NumberField()](#NumberField--) | 初始化一个新的实例[NumberField](../../com.aspose.pdf/numberfield)班级。 |
| [NumberField(Page page, Rectangle rect)](#NumberField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 初始化一个新的实例[NumberField](../../com.aspose.pdf/numberfield)班级。 |
| [NumberField(Document doc, Rectangle rect)](#NumberField-com.aspose.pdf.Document-com.aspose.pdf.Rectangle-) | 初始化一个新的实例[NumberField](../../com.aspose.pdf/numberfield)班级。 |
## 领域
...
| [getAllowedChars()](#getAllowedChars--) | 获取或设置允许的字符。 |
...
| [setAllowedChars(String value)](#setAllowedChars-java.lang.String-) | 获取或设置允许的字符。 |
...
初始化一个新的实例[NumberField](../../com.aspose.pdf/numberfield)班级。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置文本字段的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 字段将放置在页面上的矩形。 |
