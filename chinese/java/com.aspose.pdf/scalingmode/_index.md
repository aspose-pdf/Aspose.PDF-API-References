...
type: docs
weight: 319
url: /zh/java/com.aspose.pdf/scalingmode/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [Anamorphic](#Anamorphic) | 缩放图标以准确填充注释矩形。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Proportional](#Proportional) | 缩放图标以适应注释矩形的宽度或高度，同时保持图标的原始纵横比。 |
## 方法
...
缩放图标以适应注释矩形的宽度或高度，同时保持图标的原始纵横比。
