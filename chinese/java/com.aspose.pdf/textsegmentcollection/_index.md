...
| 方法 | 描述 |
| --- | --- |
| [add(TextSegment segment)](#add-com.aspose.pdf.TextSegment-) | 在指定索引处添加文本段元素。 |
| [clear()](#clear--) | 清除集合中的所有项目。 |
| [contains(TextSegment item)](#contains-com.aspose.pdf.TextSegment-) | 确定集合是否包含特定值。 |
| [copyTo(TextSegment[] array, int index)](#copyTo-com.aspose.pdf.TextSegment---int-) | 将整个集合复制到兼容的一维数组，从目标数组的指定索引开始 |
| [delete(int index)](#delete-int-) | 删除指定索引处的文本段元素。 |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getSyncRoot()](#getSyncRoot--) | 获取可用于同步对集合的访问的对象。 |
| [get_Item(int index)](#get-Item-int-) | 获取指定索引处的文本段元素。 |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(TextSegment item)](#remove-com.aspose.pdf.TextSegment-) | 从集合中删除指定的项目。 |
| [size()](#size--) | 获取集合中实际包含的 TextSegment 对象元素的数量。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| segment | [TextSegment](../../com.aspose.pdf/textsegment) | 文本段对象 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| item | [TextSegment](../../com.aspose.pdf/textsegment) | 要在集合中定位的对象 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| array | [TextSegment\[\]](../../com.aspose.pdf/textsegment) | 将被复制的对象数组。 |
...
**退货：**
java.util.Iterator<com.aspose.pdf.TextSegment> - 枚举器对象。
### notify() {#notify--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| item | [TextSegment](../../com.aspose.pdf/textsegment) | 要删除的对象 |
