...
description: 类描述 RichMediaAnnotation，它允许将视频/音频数据嵌入到 PDF 文档中。
type: docs
weight: 312
...
类描述 RichMediaAnnotation，它允许将视频/音频数据嵌入到 PDF 文档中。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [RichMediaAnnotation(Page page, Rectangle rect)](#RichMediaAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 初始化 RichMediaAnnotation。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 接受此注释的访问者。 |
| [addCustomData(String name, InputStream data)](#addCustomData-java.lang.String-java.io.InputStream-) | 添加自定义命名数据（例如 flash 脚本所需的数据）。 |
...
| [getCustomPlayer()](#getCustomPlayer--) | 设置或获取自定义 Flash 播放器以播放视频/音频数据。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setActivateOn(int value)](#setActivateOn-int-) | 激活应用程序的事件。 |
...
| [setContent(String fileName, InputStream audio)](#setContent-java.lang.String-java.io.InputStream-) | 设置内容流。 |
| [setContents(String value)](#setContents-java.lang.String-) | 设置注释文本。 |
| [setCustomFlashVariables(String value)](#setCustomFlashVariables-java.lang.String-) | 设置或获取传递给播放器的 flash 变量。 |
| [setCustomPlayer(InputStream value)](#setCustomPlayer-java.io.InputStream-) | 设置或获取自定义 Flash 播放器以播放视频/音频数据。 |
...
| [setPoster(InputStream imageStream)](#setPoster-java.io.InputStream-) | 设置注释的海报。 |
...
| [setType(int value)](#setType-int-) | 获取或设置内容类型。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 正在创建对象的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 矩形坐标。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| visitor | [AnnotationSelector](../../com.aspose.pdf/annotationselector) | 访客实例。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| name | java.lang.String | 数据的名称。 |
| data | java.io.InputStream | 数据。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| fileName | java.lang.String | 流的名称。 |
| audio | java.io.InputStream | 数据流。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| imageStream | java.io.InputStream | 包含海报图像的流。 |
