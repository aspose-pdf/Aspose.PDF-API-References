...
| 构造函数 | 描述 |
| --- | --- |
| [RedactionAnnotation(IDocument document)](#RedactionAnnotation-com.aspose.pdf.IDocument-) | RedactionAnnotation 的构造函数。 |
| [RedactionAnnotation(Page page, Rectangle rect)](#RedactionAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | RedactAnnotation 的构造函数。 |
## 方法
...
| [flatten()](#flatten--) | 展平注释即删除注释并添加其内容 |
...
| [getBorderColor()](#getBorderColor--) | 获取在编辑未激活时绘制的边框颜色。 |
...
| [getDefaultAppearance()](#getDefaultAppearance--) | 获取或设置用于设置文本格式的默认外观字符串。 |
| [getEngineDict()](#getEngineDict--) | 仅限内部 |
| [getEngineObj()](#getEngineObj--) | 仅供内部使用 |
| [getFillColor()](#getFillColor--) | 获取颜色以填充注释。 |
...
| [getOverlayText()](#getOverlayText--) | 要在编辑注释上打印的文本。 |
...
| [getQuadPoint()](#getQuadPoint--) | 指定要删除的内容区域坐标的 8xN 数字数组。 |
| [getQuadPoints()](#getQuadPoints--) | 获取指定 n 个四边形坐标的点数组。 |
...
| [getTextAlignment()](#getTextAlignment--) | 获取叠加文本的对齐方式。 |
...
| [isRepeat()](#isRepeat--) | 如果 true 覆盖文本将在注释上重复。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [redact()](#redact--) | 扁平化注释并编辑页面内容（即删除编辑注释下的文本和图像内容） |
| [redactExact()](#redactExact--) | 扁平化注释并编辑页面内容（即删除恰好在编辑注释下的文本和图像内容） |
...
| [setBorderColor(Color value)](#setBorderColor-com.aspose.pdf.Color-) | 设置在编辑未激活时绘制的边框颜色。 |
| [setColor(Color value)](#setColor-com.aspose.pdf.Color-) | 设置注释颜色。 |
| [setContents(String value)](#setContents-java.lang.String-) | 设置注释文本。 |
| [setDefaultAppearance(String value)](#setDefaultAppearance-java.lang.String-) | 获取或设置用于设置文本格式的默认外观字符串。 |
| [setFillColor(Color value)](#setFillColor-com.aspose.pdf.Color-) | 设置颜色以填充注释。 |
...
| [setFontSize(double fontSize)](#setFontSize-double-) | 要在编辑注释上打印的文本的字体大小。 |
...
| [setOverlayText(String value)](#setOverlayText-java.lang.String-) | 要在编辑注释上打印的文本。 |
| [setPopup(PopupAnnotation value)](#setPopup-com.aspose.pdf.PopupAnnotation-) | 用于输入或编辑与此注释关联的文本的弹出式注释。 |
| [setQuadPoint(Point[] value)](#setQuadPoint-com.aspose.pdf.Point---) | 指定要删除的内容区域坐标的 8xN 数字数组。 |
| [setQuadPoints(Point[] value)](#setQuadPoints-com.aspose.pdf.Point---) | 设置指定 n 个四边形坐标的点数组。 |
| [setRect(Rectangle value)](#setRect-com.aspose.pdf.Rectangle-) | 设置注释矩形。 |
| [setRepeat(boolean value)](#setRepeat-boolean-) | 如果 true 覆盖文本将在注释上重复。 |
...
| [setTextAlignment(int value)](#setTextAlignment-int-) | 设置覆盖文本的对齐方式。 |
...
RedactionAnnotation 的构造函数。在生成器中使用。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建新注释的文档。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 将放置注释的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 页面上的注释位置。 |
...
获取指定 n 个四边形坐标的点数组。每个四边形包含注释下方文本中的一个词或一组连续词。

**退货：**
com.aspose.pdf.点[] - 点值数组
### getRect() {#getRect--}
```
...
扁平化注释并编辑页面内容（即删除恰好在编辑注释下的文本和图像内容）
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Point\[\]](../../com.aspose.pdf/point) | 点阵 |
...
设置指定 n 个四边形坐标的点数组。每个四边形包含注释下方文本中的一个词或一组连续词。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Point\[\]](../../com.aspose.pdf/point) | 点值数组 |
