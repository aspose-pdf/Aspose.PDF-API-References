...
description: 表示多边形注释的类。
type: docs
weight: 288
url: /zh/java/com.aspose.pdf/polygonannotation/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [PolygonAnnotation(IDocument document, Point[] vertices)](#PolygonAnnotation-com.aspose.pdf.IDocument-com.aspose.pdf.Point---) | 与生成器一起使用的构造函数。 |
| [PolygonAnnotation(Page page, Rectangle rect, Point[] vertices)](#PolygonAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-com.aspose.pdf.Point---) | 在指定页面上创建新的多边形注释。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [accept(AnnotationSelector visitor)](#accept-com.aspose.pdf.AnnotationSelector-) | 接受访问者对象进行注解处理。 |
| [changeAfterResize(Matrix transform)](#changeAfterResize-com.aspose.pdf.Matrix-) | 根据矩阵变换更新顶点中的点。 |
...
| [getEndingStyle()](#getEndingStyle--) | 获取第二行结尾的样式。 |
...
| [getInteriorColor()](#getInteriorColor--) | 获取用于填充注释行尾的内部颜色。 |
...
| [getStartingStyle()](#getStartingStyle--) | 获取第一行结尾的样式。 |
...
| [getVertices()](#getVertices--) | 获取表示每个顶点的水平和垂直坐标的点数组。 |
...
| [setEndingStyle(int value)](#setEndingStyle-int-) | 设置第二行结尾的样式。 |
...
| [setIntent(int value)](#setIntent-int-) | 设置多边形或折线注释的目的。 |
| [setInteriorColor(Color value)](#setInteriorColor-com.aspose.pdf.Color-) | 设置用于填充注释行尾的内部颜色。 |
...
| [setStartingStyle(int value)](#setStartingStyle-int-) | 设置第一行结尾的样式。 |
...
| [setVertices(Point[] value)](#setVertices-com.aspose.pdf.Point---) | 设置代表每个顶点的水平和垂直坐标的点数组。 |
...
| vertices | [Point\[\]](../../com.aspose.pdf/point) | 点数组。 |
...
| vertices | [Point\[\]](../../com.aspose.pdf/point) | 多边形顶点数组。 |
...
**退货：**
[Measure](../../com.aspose.pdf/measure) 测量实例
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Measure](../../com.aspose.pdf/measure) | 测量实例 |
