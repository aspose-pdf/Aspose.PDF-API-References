...
description: 类表示 RadioButton 字段的项目。
type: docs
weight: 299
url: /zh/java/com.aspose.pdf/radiobuttonoptionfield/
---
**遗产：**
...
类表示 RadioButton 字段的项目。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [RadioButtonOptionField()](#RadioButtonOptionField--) | 创建新的 RadioButtonOptionField 实例。 |
| [RadioButtonOptionField(Page page, Rectangle rect)](#RadioButtonOptionField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面的指定矩形中创建单选按钮。 |
## 领域
...
| [getOptionName_Rename_Namesake()](#getOptionName-Rename-Namesake--) | 获取选项的名称。 |
...
| [setCaption(TextFragment value)](#setCaption-com.aspose.pdf.TextFragment-) | 设置标题。 |
...
| [setOptionName(String value)](#setOptionName-java.lang.String-) | 设置选项的名称。 |
| [setOptionName_Rename_Namesake(String value)](#setOptionName-Rename-Namesake-java.lang.String-) | 设置选项的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置 RadioButton 的页面； |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | RadioButton 的矩形。 |
