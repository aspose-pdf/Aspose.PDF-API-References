...
type: docs
weight: 400
url: /zh/java/com.aspose.pdf/warningtype/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [CompatibilityIssue](#CompatibilityIssue) | 已知问题会阻止某些用户代理或以前版本的用户代理打开文档。 |
| [DataLoss](#DataLoss) | 加载后的文档树或保存后创建的文档中的文本/图表/图像或其他数据完全丢失。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvalidInputStreamType](#InvalidInputStreamType) | 输入流类型无效 |
| [MajorFormattingLoss](#MajorFormattingLoss) | 与原始文档相比，格式损失较大。 |
| [MinorFormattingLoss](#MinorFormattingLoss) | 与原始文档相比，格式损失较小。 |
| [SourceFileCorruption](#SourceFileCorruption) | 文件已损坏。 |
| [UnexpectedContent](#UnexpectedContent) | 该文件包含意外内容。 |
## 方法
...
加载后的文档树或保存后创建的文档中的文本/图表/图像或其他数据完全丢失。
...
与原始文档相比，格式损失较大。这适用于格式损失很大但数据仍然存在的情况。
