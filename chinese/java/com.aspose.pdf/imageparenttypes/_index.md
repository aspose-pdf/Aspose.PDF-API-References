...
description: 枚举可能的图像父图像类型图像可以属于 HTML 页面或 SVG 父图像
type: docs
weight: 22
url: /zh/java/com.aspose.pdf/htmlsaveoptions.imageparenttypes/
---
**遗产：**
...
枚举可能的图像父图像类型图像可以属于 HTML 页面或 SVG 父图像
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HtmlPage](#HtmlPage) | 图片属于 HTML 页面本身 |
| [SvgImage](#SvgImage) | 图像嵌入到 SVG 图像中 |
## 方法
