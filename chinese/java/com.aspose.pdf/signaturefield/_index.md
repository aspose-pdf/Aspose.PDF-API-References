...
| 构造函数 | 描述 |
| --- | --- |
| [SignatureField(Page page, Rectangle rect)](#SignatureField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 初始化 SignatureField 类的新实例。 |
| [SignatureField(IDocument doc, Rectangle rect)](#SignatureField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | 初始化 SignatureField 类的新实例。 |
## 领域
...
| [extractCertificate()](#extractCertificate--) | 将 DER 格式的单个 X.509 证书提取为流。 |
| [extractImage()](#extractImage--) | 将签名的图像提取为 jpeg 编码流。 |
| [extractImage(ImageType format)](#extractImage-com.aspose.pdf.ImageType-) | 提取签名的图像作为编码流。 |
...
| [getSignature()](#getSignature--) | 获取签名对象。 |
...
| [sign(Signature signature)](#sign-com.aspose.pdf.Signature-) | 使用此签名字段签署文档。 |
| [sign(Signature signature, InputStream pfx, String pass)](#sign-com.aspose.pdf.Signature-java.io.InputStream-java.lang.String-) | 使用此签名字段签署文档。 |
...
初始化 SignatureField 类的新实例。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 应放置签名字段的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 签名域的位置和大小。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 应放置签名字段的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 签名域的位置和大小。 |
...
**退货：**
java.io.InputStream - 如果成功找到图像则返回 jpeg 编码的流对象；否则为空。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| format | [ImageType](../../com.aspose.pdf/imagetype) | 用于编码的图像格式。 |

**退货：**
java.io.InputStream - 如果成功找到图像则返回编码流对象；否则为空。
### flatten() {#flatten--}
```
public void flatten()
```
...
获取签名对象。该对象包含有关公钥加密标准的签名数据。类 PKCS1 、 PKCS7 和 PKCS7Detached 代表所有支持的签名对象类型。

**退货：**
[Signature](../../com.aspose.pdf/signature) 签名对象
### getStates() {#getStates--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| signature | [Signature](../../com.aspose.pdf/signature) | 签名对象，请参阅 PKCS1 、 PKCS7 和 PKCS7Detached 。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| signature | [Signature](../../com.aspose.pdf/signature) | 签名对象，请参阅 PKCS1 、 PKCS7 、 PKCS7Detached 。 |
| pfx | java.io.InputStream | 使用证书流式传输。 |
| pass | java.lang.String | 在 pfx 中访问 private 的密码。 |
