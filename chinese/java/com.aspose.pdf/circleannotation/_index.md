...
type: docs
weight: 61
url: /zh/java/com.aspose.pdf/circleannotation/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [CircleAnnotation(IDocument document)](#CircleAnnotation-com.aspose.pdf.IDocument-) | 圆注释的构造函数。 |
| [CircleAnnotation(Page page, Rectangle rect)](#CircleAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的圆形注释。 |
## 方法
...
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 设置注释边框的必需矩形。 |
