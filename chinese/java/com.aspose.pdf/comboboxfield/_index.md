...
description: 表示表单的组合框字段的类。
type: docs
weight: 69
url: /zh/java/com.aspose.pdf/comboboxfield/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [ComboBoxField()](#ComboBoxField--) | 在生成器中使用的 ComboBoxField 的构造函数。 |
| [ComboBoxField(IDocument doc)](#ComboBoxField-com.aspose.pdf.IDocument-) | 创建 CombBox 字段以与生成器一起使用。 |
| [ComboBoxField(Page page, Rectangle rect)](#ComboBoxField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | ComboBox 字段的构造函数。 |
| [ComboBoxField(IDocument doc, Rectangle rect)](#ComboBoxField-com.aspose.pdf.IDocument-com.aspose.pdf.Rectangle-) | 组合框字段的构造函数。 |
## 领域
...
| [addOption(String optionName)](#addOption-java.lang.String-) | 添加具有指定名称的新选项。 |
...
| [getEditable()](#getEditable--) | 获取字段的可编辑状态。 |
...
| [getSelected()](#getSelected--) | 获取所选选项的索引。 |
| [getSelectedItems()](#getSelectedItems--) | 设置所选项目的数组。 |
| [getSpellCheck()](#getSpellCheck--) | 获取拼写检查活动状态。 |
...
| [setEditable(boolean value)](#setEditable-boolean-) | 设置字段的可编辑状态。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建字段的文档。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置字段的页面。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 定义页面上字段大小和位置的矩形。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 应在何处创建字段的文档。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 定义字段大小和位置的矩形。 |
