...
description: 表示符合 Internet RFC 2315 PKCS 7 加密消息语法版本 1.5 中的 PKCS7 规范的 PKCS7 对象。
type: docs
weight: 256
url: /zh/java/com.aspose.pdf/pkcs7detached/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [PKCS7Detached(InputStream image)](#PKCS7Detached-java.io.InputStream-) | 初始化 PKCS7Detached 类的新实例。 |
| [PKCS7Detached()](#PKCS7Detached--) | 初始化 PKCS7Detached 类的新实例。 |
| [PKCS7Detached(String pfx, String password)](#PKCS7Detached-java.lang.String-java.lang.String-) | 初始化 PKCS7Detached 类的新实例。 |
| [PKCS7Detached(InputStream pfx, String password)](#PKCS7Detached-java.io.InputStream-java.lang.String-) | 初始化 PKCS7Detached 类的新实例。 |
## 方法
