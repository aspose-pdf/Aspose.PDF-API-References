...
type: docs
weight: 264
url: /zh/java/com.aspose.pdf/pagelayout/
---
**遗产：**
...
| [OneColumn](#OneColumn) | 在一列中显示页面。 |
| [SinglePage](#SinglePage) | 单页。 |
| [TwoColumnLeft](#TwoColumnLeft) | 在两列中显示页面，左侧为奇数页。 |
| [TwoColumnRight](#TwoColumnRight) | 分两列显示页面，奇数页在右侧。 |
| [TwoPageLeft](#TwoPageLeft) | 一次显示两页，奇数页在左边。 |
| [TwoPageRight](#TwoPageRight) | 一次显示两页，奇数页在右边。 |
## 方法
