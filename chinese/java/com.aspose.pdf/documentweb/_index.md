...
description: 表示 DocumentWeb 类
type: docs
weight: 95
url: /zh/java/com.aspose.pdf/documentweb/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [DocumentWeb()](#DocumentWeb--) | 初始化空的 DocumentWeb。 |
| [DocumentWeb(InputStream input)](#DocumentWeb-java.io.InputStream-) | 从输入流初始化新的 DocumentWeb 实例。 |
| [DocumentWeb(InputStream input, String password)](#DocumentWeb-java.io.InputStream-java.lang.String-) |  |
| [DocumentWeb(InputStream input, LoadOptions options)](#DocumentWeb-java.io.InputStream-com.aspose.pdf.LoadOptions-) | 从流中打开现有的 DocumentWeb，提供必要的转换以获得 pdf DocumentWeb。 |
| [DocumentWeb(String filename, LoadOptions options)](#DocumentWeb-java.lang.String-com.aspose.pdf.LoadOptions-) |  |
| [DocumentWeb(String filename)](#DocumentWeb-java.lang.String-) | 只需使用 filename 初始化 DocumentWeb。 |
| [DocumentWeb(String filename, String password)](#DocumentWeb-java.lang.String-java.lang.String-) | 初始化 DocumentWeb 类的新实例以使用加密的 DocumentWeb。 |
## 领域
...
| [getMetadataStream()](#getMetadataStream--) | 仅供内部使用！ |
...
| [getPdfFormat()](#getPdfFormat--) | 获取 PDF 格式。 |
...
| [processParagraphs()](#processParagraphs--) | 将文档存储到生成器中。 |
...
| [save(System.IO.Stream output)](#save-com.aspose.ms.System.IO.Stream-) | 仅供内部使用 |
...
| [save(HttpServletResponse response, String outputFileName, int disposition, SaveOptions options)](#save-javax.servlet.http.HttpServletResponse-java.lang.String-int-com.aspose.pdf.SaveOptions-) | 使用保存选项将文档保存到响应流。 |
...
| [setAbsentFontTryToSubstitute(boolean substitute)](#setAbsentFontTryToSubstitute-boolean-) | 设置标志以替换丢失的字体。 |
...
从输入流初始化新的 DocumentWeb 实例。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| input | java.io.InputStream | 使用 pdf DocumentWeb 流式传输。 |
...
从流中打开现有的 DocumentWeb，提供必要的转换以获得 pdf DocumentWeb。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| input | java.io.InputStream | 要转换为 pdf DocumentWeb 的输入流。 |
| options | [LoadOptions](../../com.aspose.pdf/loadoptions) | 表示将输入转换为 pdf DocumentWeb 的属性。 |
...
只需使用 filename 初始化 DocumentWeb。与 DocumentWeb(Stream) 相同。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| filename | java.lang.String | pdf DocumentWeb 文件的名称。 |
...
初始化 DocumentWeb 类的新实例以使用加密的 DocumentWeb。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| filename | java.lang.String | DocumentWeb 文件名。 |
...
**退货：**
boolean - 布尔值 True - 如果文档已修复；否则，假的。
### close() {#close--}
```
public void close()
```
...
**退货：**
[PdfFormat](../../com.aspose.pdf/pdfformat) PDF格式
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| output | com.aspose.ms.System.IO.Stream | 仅供内部使用 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| response | javax.servlet.http.HttpServletResponse | 封装 HTTP 响应信息。 |
| outputFileName | java.lang.String | 简单的文件名，即没有路径。 |
| disposition | int | 表示 MIME 协议 Content-Disposition 标头。 |
| options | [SaveOptions](../../com.aspose.pdf/saveoptions) | 保存选项。 |
