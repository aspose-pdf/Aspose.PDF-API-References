...
| [DocumentWeb](#DocumentWeb-java.io.InputStream-) | 初始化空的 DocumentWeb。 |
| [DocumentWeb](#DocumentWeb-java.io.InputStream-com.aspose.pdf.LoadOptions-) | 初始化空的 DocumentWeb。 |
| [DocumentWeb](#DocumentWeb-java.io.InputStream-java.lang.String-) | 初始化空的 DocumentWeb。 |
| [DocumentWeb](#DocumentWeb-java.lang.String-) | 初始化空的 DocumentWeb。 |
| [DocumentWeb](#DocumentWeb-java.lang.String-com.aspose.pdf.LoadOptions-) | 初始化空的 DocumentWeb。 |
| [DocumentWeb](#DocumentWeb-java.lang.String-java.lang.String-) | 初始化空的 DocumentWeb。 |
...
| [getDestinations](#getDestinations--) | 已弃用。 |
...
| [isCenterWindow](#isCenterWindow--) | 获取标志，指定文档窗口的位置是否居中显示在屏幕上。 |
...
| [isManualDisposeEnabled](#isManualDisposeEnabled--) | 默认情况下，save 方法会关闭内部流并释放内存资源。 |
...
| [optimize](#optimize--) | 线性化文档以实现 - 尽快打开首页； - 尽快显示下一页或通过链接跳转到下一页； - 当页面数据通过慢速通道传输时，随数据到达逐步显示页面（优先显示最有用的数据）； - 允许用户交互，例如点击链接，即使在整个页面尚未接收和显示完毕时也能执行。 |
...
| [save](#save--) | 增量保存文档（即 |
| [save](#save-javax.servlet.http.HttpServletResponse-java.lang.String-com.aspose.pdf.ContentDisposition-com.aspose.pdf.SaveOptions-) | 使用保存选项将文档保存到响应流中。 |
| [save](#save-java.io.OutputStream-) | 将文档存储到流中。 |
| [save](#save-java.io.OutputStream-com.aspose.pdf.SaveFormat-) | 将文档以新名称和文件格式保存。 |
| [save](#save-java.io.OutputStream-com.aspose.pdf.SaveOptions-) | 使用新名称保存文档并设置其保存选项。 |
| [save](#save-com.aspose.pdf.SaveOptions-) | 使用保存选项保存文档。 |
| [save](#save-com.aspose.ms.System.IO.Stream-) | 仅供内部使用 |
| [save](#save-java.lang.String-) | 将文档保存到指定文件中。 |
| [save](#save-java.lang.String-com.aspose.pdf.SaveFormat-) | 将文档以新名称和文件格式保存。 |
...
| [setAbsentFontTryToSubstitute](#setAbsentFontTryToSubstitute-boolean-) | 设置标志以替换缺失的字体。 |
...
| [setIgnoreCorruptedObjects](#setIgnoreCorruptedObjects-boolean-) | 获取或设置忽略源文件错误的标志。 |
| [setLinearized](#setLinearized-boolean-) | 设置一个值，指示文档是否已线性化。 |
| [setManualDisposeEnabled](#setManualDisposeEnabled-boolean-) | 默认情况下，save 方法会关闭内部流并释放内存资源。 |
...
线性化文档以实现 - 尽快打开首页； - 尽快显示下一页或通过链接跳转到下一页； - 当页面数据通过慢速通道传输时，随数据到达逐步显示页面（优先显示最有用的数据）； - 允许用户交互，例如点击链接，即使在整个页面尚未接收和显示完毕时也能执行。
