...
description: Enum RenderModeType 渲染模式类型集
type: docs
weight: 303
url: /zh/java/com.aspose.pdf/rendermodetype/
---
**遗产：**
...
Enum RenderModeType：一组渲染模式类型
## 领域

| 场地 | 描述 |
| --- | --- |
| [BoundingBox](#BoundingBox) | “边界框”渲染模式。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Illustration](#Illustration) | “插图”渲染模式。 |
...
| [Transparent](#Transparent) | “透明”渲染模式。 |
...
| [Vertices](#Vertices) | “顶点”渲染模式。 |
| [Wireframe](#Wireframe) | “线框”渲染模式。 |
## 方法
