...
| 构造函数 | 描述 |
| --- | --- |
| [RadioButtonField(Page page, Rectangle rect)](#RadioButtonField-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 设置单选按钮字段 |
| [RadioButtonField(Page page)](#RadioButtonField-com.aspose.pdf.Page-) | RadiouttonField 的构造函数 |
| [RadioButtonField(IDocument doc)](#RadioButtonField-com.aspose.pdf.IDocument-) | RadioButtonField 的构造函数。 |
## 领域
...
| [add(RadioButtonOptionField newItem)](#add-com.aspose.pdf.RadioButtonOptionField-) | 向 RadioButton 字段添加新的选项字段 |
| [add(WidgetAnnotation item)](#add-com.aspose.pdf.WidgetAnnotation-) |  |
| [addOption(String optionName)](#addOption-java.lang.String-) | 向单选按钮添加选项。 |
| [addOption(String optionName, Rectangle rect)](#addOption-java.lang.String-com.aspose.pdf.Rectangle-) | 添加到具有指定矩形的单选按钮选项。 |
| [addOption(String export, String name)](#addOption-java.lang.String-java.lang.String-) | 添加具有指定导出值和名称的新选项。 |
...
| [deleteOption(String optionName)](#deleteOption-java.lang.String-) | 按名称删除选项。 |
...
| [getCommitImmediately()](#getCommitImmediately--) | 获取对选择更改标志的提交。 |
...
| [getPageIndex()](#getPageIndex--) | 获取包含此 RadioButton 字段的页面的索引。 |
...
| [getSelected()](#getSelected--) | 获取所选项目的索引。 |
| [getSelectedItems()](#getSelectedItems--) | 设置所选项目的数组。 |
...
| [setCommitImmediately(boolean value)](#setCommitImmediately-boolean-) | 设置选择更改标志的提交。 |
...
| [setMultiSelect(boolean value)](#setMultiSelect-boolean-) | 设置多选标志。 |
...
| [setPosition(Point point)](#setPosition-com.aspose.pdf.Point-) | 将单选按钮的所有子项移动到页面上的指定位置。 |
...
| [setSelected(int value)](#setSelected-int-) | 设置所选项目的索引。 |
| [setSelectedItems(int[] value)](#setSelectedItems-int---) | 设置所选项目的数组。 |
| [setSharedField(boolean value)](#setSharedField-boolean-) | 生成器支持的属性。 |
| [setStyle(int value)](#setStyle-int-) | 字段框的样式。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | [Page](../../com.aspose.pdf/page) | 放置单选按钮的页面。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建单选按钮的文档。 |
...
向 RadioButton 字段添加新的选项字段

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| newItem | [RadioButtonOptionField](../../com.aspose.pdf/radiobuttonoptionfield) | 应添加的项目。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| optionName | java.lang.String | 将添加的选项的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| optionName | java.lang.String | 新选项的名称。 |
| rect | [Rectangle](../../com.aspose.pdf/rectangle) | 新项目矩形。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| export | java.lang.String | 出口价值。 |
| name | java.lang.String | 新选项的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| optionName | java.lang.String | 必须删除的选项的名称。 |
...
**退货：**
[OptionCollection](../../com.aspose.pdf/optioncollection) - 选项集合对象
### getPage() {#getPage--}
```
public Page getPage()
```
...
设置所选项目的数组。对于多选列表，数组包含不止一项。对于单选列表，它包含单个项目。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| point | [Point](../../com.aspose.pdf/point) | 设置 RadioButton 字段注释的位置。 |
