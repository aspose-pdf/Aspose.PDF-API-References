...
| [Inaccessible](#Inaccessible) | Pdf 文档受密码保护，但用户和所有者密码都不为空，并且没有定义任何密码或提供的密码不正确。 |
| [None](#None) | PDF 文档不受密码保护。 |
| [Owner](#Owner) | 使用更改权限密码（完全访问权限）打开了 Pdf 文档。 |
| [User](#User) | 使用文档打开密码（访问受限）打开了 Pdf 文档。 |
## 方法
...
Pdf 文档受密码保护，但用户和所有者密码都不为空，并且没有定义任何密码或提供的密码不正确。所以不可能推断出密码的类型。
