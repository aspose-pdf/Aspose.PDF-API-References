...
description: 指示分数值显示方式的值。
type: docs
weight: 10
url: /zh/java/com.aspose.pdf/measure.numberformat.fractionstyle/
---
**遗产：**
...
| [Round](#Round) | 将小数值四舍五入为最接近的整数。 |
| [ShowAsDecimal](#ShowAsDecimal) | 将分数值显示为小数部分。 |
| [ShowAsFraction](#ShowAsFraction) | 将分数值显示为分数。 |
| [Truncate](#Truncate) | 截断以实现整个单位。 |
## 方法
