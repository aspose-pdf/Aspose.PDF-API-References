...
description: 表示在弹出窗口中显示文本以供输入和编辑的弹出式注释。
type: docs
weight: 290
...
表示在弹出窗口中显示文本以供输入和编辑的弹出式注释。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PopupAnnotation(IDocument document)](#PopupAnnotation-com.aspose.pdf.IDocument-) | 构造函数。在生成器中使用。 |
| [PopupAnnotation(Page page, Rectangle rect)](#PopupAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的 Popup 注释。 |
## 方法
...
| [getOpen()](#getOpen--) | 获取一个标志，该标志指定弹出式批注最初是否应显示为打开状态。 |
...
| [getParent()](#getParent--) | 获取与此弹出式注释关联的父注释。 |
...
| [setOpen(boolean value)](#setOpen-boolean-) | 设置一个标志，指定弹出注释最初是否应显示为打开状态。 |
| [setParent(MarkupAnnotation value)](#setParent-com.aspose.pdf.MarkupAnnotation-) | 设置与此弹出注释关联的父注释。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| document | [IDocument](../../com.aspose.pdf/idocument) | 将在其中创建新弹出注释的文档。 |
...
获取与此弹出式注释关联的父注释。如果此条目存在，则父注释的内容、M、C 和 T 条目应覆盖弹出注释本身的条目。

**退货：**
[Annotation](../../com.aspose.pdf/annotation) - 标记注释对象
...
设置与此弹出注释关联的父注释。如果此条目存在，则父注释的内容、M、C 和 T 条目应覆盖弹出注释本身的条目。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [MarkupAnnotation](../../com.aspose.pdf/markupannotation) | MarkupAnnotation 对象 |
