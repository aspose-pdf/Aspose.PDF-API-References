...
description: Enum PDF3DActivation 设置 3D 注释激活模式。
type: docs
weight: 242
url: /zh/java/com.aspose.pdf/pdf3dactivation/
---
**遗产：**
...
| [activatedUserOrScriptAction](#activatedUserOrScriptAction) | 由用户或脚本操作激活 |
| [activeWhenOpen](#activeWhenOpen) | 打开时的活动 |
| [activeWhenVisible](#activeWhenVisible) | 可见时激活 |
## 方法
