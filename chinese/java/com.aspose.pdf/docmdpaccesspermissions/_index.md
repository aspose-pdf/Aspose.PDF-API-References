...
授予此文档的访问权限。有效值为：1 - 不允许更改文档；对文档的任何更改都会使签名无效。 2 - 允许的更改包括填写表格、实例化页面模板和签名；其他更改会使签名无效。 3 - 允许的更改与 2 相同，以及注释创建、删除和修改；其他更改会使签名无效。
## 领域
...
3 - 允许的更改与 2 相同，以及注释创建、删除和修改；其他更改会使签名无效。
...
2 - 允许的更改包括填写表格、实例化页面模板和签名；其他更改会使签名无效。
