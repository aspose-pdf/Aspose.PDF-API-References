...
description: 枚举在 Pdf 到 Html 转换期间可以保存为外部资源的可能类型的图像文件
type: docs
weight: 18
url: /zh/java/com.aspose.pdf/htmlsaveoptions.htmlimagetype/
---
**遗产：**
...
枚举在 Pdf 到 Html 转换期间可以保存为外部资源的可能类型的图像文件
## 领域
...
| [Svg](#Svg) | SVG 格式 |
| [Tiff](#Tiff) | Tiff 格式 |
| [Unknown](#Unknown) | 未知 - 意味着转换器无法检测内容本身的类型 |
| [ZippedSvg](#ZippedSvg) | 压缩的 Svg 格式 |
## 方法
