...
type: docs
weight: 222
url: /zh/java/com.aspose.pdf/mhtloadoptions/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [MhtLoadOptions()](#MhtLoadOptions--) | 创建用于将 html 转换为基本路径为空的 pdf 文档的加载选项。 |
## 方法
...
| [getPageInfo()](#getPageInfo--) | 获取或设置文档页面信息 |
...
**退货：**
[PageInfo](../../com.aspose.pdf/pageinfo) 页面信息实例
