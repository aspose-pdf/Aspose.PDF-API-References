...
type: docs
weight: 11
url: /zh/java/com.aspose.pdf/textformattingoptions.wordwrapmode/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [ByWords](#ByWords) | 自动换行只换行完整的单词。 |
| [DiscretionaryHyphenation](#DiscretionaryHyphenation) | 执行任意断字。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NoWrap](#NoWrap) | 不执行包装 |
| [Undefined](#Undefined) | 未设置 WordWrapMode。 |
## 方法
...
自动换行只换行完整的单词。如果无法换行完整的单词，则尝试使用任意断字
...
未设置 WordWrapMode。将使用上层结构（表格单元格、段落等）的环绕策略。
