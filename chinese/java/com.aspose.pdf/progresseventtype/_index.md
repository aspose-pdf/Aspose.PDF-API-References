...
description: 此枚举描述了可能在转换期间发生的进度事件类型
type: docs
weight: 296
url: /zh/java/com.aspose.pdf/progresseventtype/
---
**遗产：**
...
此枚举描述了可能在转换期间发生的进度事件类型
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ResultPageCreated](#ResultPageCreated) | 意味着发生的事件通知在物理导出之前创建一个结果页面 |
| [ResultPageSaved](#ResultPageSaved) | 意味着发生的事件通知一个结果页面保存完成 |
| [SourcePageAnalysed](#SourcePageAnalysed) | 意味着发生的事件通知转换前对其中一个页面的分析结束 |
| [TotalProgress](#TotalProgress) | 表示发生的事件通知转换的总进度 |
## 方法
