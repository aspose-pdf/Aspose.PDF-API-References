...
description: 表示突出显示文档中文本范围的突出显示注释。
type: docs
weight: 153
url: /zh/java/com.aspose.pdf/highlightannotation/
---
**遗产：**
...
表示突出显示文档中文本范围的突出显示注释。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [HighlightAnnotation(Page page, Rectangle rect)](#HighlightAnnotation-com.aspose.pdf.Page-com.aspose.pdf.Rectangle-) | 在指定页面上创建新的突出显示注释。 |
## 方法
