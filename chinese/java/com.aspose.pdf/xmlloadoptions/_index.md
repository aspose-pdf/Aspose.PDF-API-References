...
description: 表示将 XML 文件加载/导入 pdf 文档的选项。
type: docs
weight: 415
url: /zh/java/com.aspose.pdf/xmlloadoptions/
---
**遗产：**
...
表示将 XML 文件加载/导入 pdf 文档的选项。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [XmlLoadOptions()](#XmlLoadOptions--) | 创建没有 xsl 数据的 XmlLoadOptions 对象。 |
| [XmlLoadOptions(String xslFile)](#XmlLoadOptions-java.lang.String-) | 使用 xsl 数据创建 XmlLoadOptions 对象。 |
| [XmlLoadOptions(InputStream xslStream)](#XmlLoadOptions-java.io.InputStream-) | 使用 xsl 数据创建 XmlLoadOptions 对象。 |
## 方法
...
创建没有 xsl 数据的 XmlLoadOptions 对象。
...
使用 xsl 数据创建 XmlLoadOptions 对象。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| xslFile | java.lang.String | 字符串 Xsl 文件，将 xml 文档转换为 pdf 文档。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| xslStream | java.io.InputStream | InputStream Xsl 流将 xml 文档转换为 pdf 文档。 |
