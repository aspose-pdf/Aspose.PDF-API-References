...
description: pdf 文件无效时抛出的异常。
type: docs
weight: 23
url: /zh/java/com.aspose.pdf.exceptions/invalidpdffileformatexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [InvalidPdfFileFormatException(String message)](#InvalidPdfFileFormatException-java.lang.String-) | 初始化 InvalidPdfFileFormatException 类的新实例。 |
## 方法
