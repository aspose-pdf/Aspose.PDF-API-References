...
type: docs
weight: 19
url: /zh/java/com.aspose.pdf.exceptions/invalidcgmfileformatexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [InvalidCgmFileFormatException()](#InvalidCgmFileFormatException--) | 初始化 InvalidCgmFileFormatException 类的新实例。 |
| [InvalidCgmFileFormatException(String message)](#InvalidCgmFileFormatException-java.lang.String-) | 初始化 InvalidCgmFileFormatException 类的新实例。 |
## 方法
