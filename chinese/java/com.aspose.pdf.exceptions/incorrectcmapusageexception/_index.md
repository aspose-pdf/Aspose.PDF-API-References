...
type: docs
weight: 16
url: /zh/java/com.aspose.pdf.exceptions/incorrectcmapusageexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [IncorrectCMapUsageException(String message)](#IncorrectCMapUsageException-java.lang.String-) | 初始化 IncorrectCMapUsageException 类的新实例。 |
## 方法
