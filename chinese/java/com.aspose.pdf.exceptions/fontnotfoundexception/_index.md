...
type: docs
weight: 15
url: /zh/java/com.aspose.pdf.exceptions/fontnotfoundexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [FontNotFoundException(String message)](#FontNotFoundException-java.lang.String-) | 初始化 FontNotFoundException 类的新实例。 |
## 方法
...
### FontNotFoundException(String message) {#FontNotFoundException-java.lang.String-}
```
