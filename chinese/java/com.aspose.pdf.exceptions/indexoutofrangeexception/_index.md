...
description: 表示在 PDF 应用程序执行期间发生的索引超出范围错误。
type: docs
weight: 18
url: /zh/java/com.aspose.pdf.exceptions/indexoutofrangeexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [IndexOutOfRangeException(String message)](#IndexOutOfRangeException-java.lang.String-) | 初始化 PdfException 类的新实例。 |
## 方法
