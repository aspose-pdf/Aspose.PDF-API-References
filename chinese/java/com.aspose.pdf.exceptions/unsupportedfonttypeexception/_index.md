...
type: docs
weight: 31
url: /zh/java/com.aspose.pdf.exceptions/unsupportedfonttypeexception/
---
**遗产：**
...
| 构造函数 | 描述 |
| --- | --- |
| [UnsupportedFontTypeException(String message)](#UnsupportedFontTypeException-java.lang.String-) | 初始化 UnsupportedFontTypeException 类的新实例。 |
## 方法
...
初始化 UnsupportedFontTypeException 类的新实例。
