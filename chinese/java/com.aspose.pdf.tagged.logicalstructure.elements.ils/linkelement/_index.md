...
| [getAlternateDescriptions()](#getAlternateDescriptions--) | 获取或设置注释的替代说明。 |
...
| [setAlternateDescriptions(String value)](#setAlternateDescriptions-java.lang.String-) | 获取或设置注释的替代说明。 |
...
| [setHyperlink(Hyperlink value)](#setHyperlink-com.aspose.pdf.Hyperlink-) | 获取或设置链接元素的超链接。 |
...
获取或设置注释的替代说明。应为注释显示的文本，或者，如果这种类型的注释不显示文本，则为人类可读形式的注释内容的替代描述。
...
**退货：**
[Hyperlink](../../com.aspose.pdf/hyperlink) - 超链接实例
### getID() {#getID--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [Hyperlink](../../com.aspose.pdf/hyperlink) | 超链接实例 |
