...
description: 表示逻辑结构中的引用结构元素。
type: docs
weight: 18
url: /zh/java/com.aspose.pdf.tagged.logicalstructure.elements.ils/quoteelement/
---
**遗产：**
...
| [getS()](#getS--) |  |
| [getStructureTextState()](#getStructureTextState--) | 获取当前元素的 StructureTextState 对象。 |
