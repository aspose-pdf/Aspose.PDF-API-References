...
| --- | --- |
| [Line()](#Line--) | 仅供内部使用 |
| [Line(float[] positionArray)](#Line-float---) | 初始化 Line 类的新实例。 |
## 方法
...
| [getPositionArray()](#getPositionArray--) | 获取表示位置数组的对象。该数组由直线各控制点的坐标组成。直接地。 |
| [getText()](#getText--) | 获取或设置形状的文本 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setGraphInfo(GraphInfo value)](#setGraphInfo-com.aspose.pdf.GraphInfo-) | 设置指示图形信息的对象，如颜色、线宽等。 |
| [setPositionArray(float[] value)](#setPositionArray-float---) | 设置指示位置数组的对象。该数组由线的每个控制点的坐标组成。直接地。 |
...
设置指示位置数组的对象。该数组由线的每个控制点的坐标组成。直接地。
