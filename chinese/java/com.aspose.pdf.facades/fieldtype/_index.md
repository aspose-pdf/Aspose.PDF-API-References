...
description: 可能的字段类型的枚举。
type: docs
weight: 22
url: /zh/java/com.aspose.pdf.facades/fieldtype/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [Barcode](#Barcode) | 条形码字段。 |
| [CheckBox](#CheckBox) | 复选框字段。 |
| [ComboBox](#ComboBox) | 组合框字段。 |
| [DateTime](#DateTime) | 日期/时间字段 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Image](#Image) | 图像字段。 |
| [InvalidNameOrType](#InvalidNameOrType) | 字段类型无效。 |
| [ListBox](#ListBox) | 列表框字段。 |
| [MultiLineText](#MultiLineText) | 多行文本字段。 |
| [Numeric](#Numeric) | 数字字段 |
| [PushButton](#PushButton) | 按钮字段。 |
| [Radio](#Radio) | 单选按钮字段。 |
| [Signature](#Signature) | 签名字段。 |
| [Text](#Text) | 文本域。 |
## 方法
