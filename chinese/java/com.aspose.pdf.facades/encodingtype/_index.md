...
description: 枚举文本使用的编码类型。
type: docs
weight: 20
url: /zh/java/com.aspose.pdf.facades/encodingtype/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [Cp1250](#Cp1250) | Windows 文本编码名称。 |
| [Cp1252](#Cp1252) | Windows 文本编码名称。 |
| [Cp1257](#Cp1257) | Windows 文本编码名称。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Identity_h](#Identity-h) | 横写的 Unicode 编码。 |
| [Identity_v](#Identity-v) | 竖写的 Unicode 编码。 |
| [Macroman](#Macroman) | 拉丁文本的 Mac OS 标准编码。 |
| [Winansi](#Winansi) | Windows ansi 编码。 |
## 方法
