...
description: 类代表混合色彩空间。
type: docs
weight: 13
url: /zh/java/com.aspose.pdf.facades/blendingcolorspace/
---
**遗产：**
...
| 场地 | 描述 |
| --- | --- |
| [Auto](#Auto) | 混合颜色空间是自动确定的。 |
| [DeviceCMYK](#DeviceCMYK) | 混合颜色空间设置为 DeviceCMYK。 |
| [DeviceRGB](#DeviceRGB) | 混合色彩空间设置为 DeviceRGB。 |
| [DontChange](#DontChange) | 混合颜色空间没有改变。 |
