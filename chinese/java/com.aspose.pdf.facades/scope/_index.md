...
description: 应用替换文本操作的范围默认为 REPLACE_FIRST
type: docs
weight: 11
url: /zh/java/com.aspose.pdf.facades/replacetextstrategy.scope/
---
**遗产：**
...
应用替换文本操作的范围 REPLACE\_FIRST 默认
## 领域

| 场地 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ReplaceAll](#ReplaceAll) | 替换所有受影响页面上出现的所有文本 |
| [ReplaceFirst](#ReplaceFirst) | 仅替换每个受影响页面上第一次出现的文本 |
## 方法
