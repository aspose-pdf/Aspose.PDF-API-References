...
type: docs
weight: 32
url: /zh/java/com.aspose.pdf.facades/keysize/
---
**遗产：**
...
128 位密钥。 RC4 和 AES 算法都可以使用这样的密钥大小。
...
256 位密钥。这样的密钥大小只能与 AES 一起使用，并且可以被最新的 Adobe Reader 版本（从 v.9 开始）识别。
...
40 位密钥。这种密钥大小与 RC4 算法一起使用，并提供低级别的安全性。尽管如此，旧版本的 pdf 文档只能使用此类密钥进行加密（v. 1.3 及更低版本）；
