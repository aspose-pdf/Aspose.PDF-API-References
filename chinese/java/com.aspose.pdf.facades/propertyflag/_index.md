...
description: 可能的字段标志的枚举。
type: docs
weight: 56
url: /zh/java/com.aspose.pdf.facades/propertyflag/
---
**遗产：**
...
| [InvalidFlag](#InvalidFlag) | 无效的字段标志。 |
| [NoExport](#NoExport) | 字段不可导出。 |
| [ReadOnly](#ReadOnly) | 字段是只读的。 |
| [Required](#Required) | 字段是必需的。 |
## 方法
