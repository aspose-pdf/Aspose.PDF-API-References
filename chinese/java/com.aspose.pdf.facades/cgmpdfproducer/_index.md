...
description: 表示从计算机图形 MetafileCGM 格式生成 PDF 的类。
type: docs
weight: 16
url: /zh/java/com.aspose.pdf.facades/cgmpdfproducer/
---
**遗产：**
...
表示从计算机图形图元文件 (CGM) 格式生成 PDF 的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CgmPdfProducer(ImportOptions options)](#CgmPdfProducer-com.aspose.pdf.ImportOptions-) | 构造函数 |
## 方法
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| options | [ImportOptions](../../com.aspose.pdf/importoptions) | 导入选项对象 |
