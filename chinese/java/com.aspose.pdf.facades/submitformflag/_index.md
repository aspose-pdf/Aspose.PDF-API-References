...
type: docs
weight: 62
url: /zh/java/com.aspose.pdf.facades/submitformflag/
---
**遗产：**
...
| [Fdf](#Fdf) | 数据将以 FDF 格式返回。 |
| [FdfWithComments](#FdfWithComments) | 数据将以带有注释的 FDF 格式返回。 |
| [Html](#Html) | 数据将以 HTML 格式返回。 |
| [Pdf](#Pdf) | 将提交整个 PDF 文件。 |
| [Xfdf](#Xfdf) | 数据将以 XFDF 格式返回。 |
| [XfdfWithComments](#XfdfWithComments) | 数据将以带有注释的 XFDF 格式返回。 |
## 方法
