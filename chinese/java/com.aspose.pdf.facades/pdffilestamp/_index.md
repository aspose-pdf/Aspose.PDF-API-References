...
| 构造函数 | 描述 |
| --- | --- |
| [PdfFileStamp()](#PdfFileStamp--) | PdfFileStamp 的构造函数。 |
| [PdfFileStamp(IDocument document)](#PdfFileStamp-com.aspose.pdf.IDocument-) | 在文档的基础上初始化新的 PdfFileStamp 对象。 |
| [PdfFileStamp(IDocument document, OutputStream outputStream)](#PdfFileStamp-com.aspose.pdf.IDocument-java.io.OutputStream-) | 在文档的基础上初始化新的 PdfFileStamp 对象。 |
| [PdfFileStamp(IDocument document, String outputFile)](#PdfFileStamp-com.aspose.pdf.IDocument-java.lang.String-) | 在文档的基础上初始化新的 PdfFileStamp 对象。 |
| [PdfFileStamp(InputStream inputStream, OutputStream outputStream)](#PdfFileStamp-java.io.InputStream-java.io.OutputStream-) | PdfFileStamp 的构造函数。 |
| [PdfFileStamp(InputStream inputStream, OutputStream outputStream, boolean keepSecurity)](#PdfFileStamp-java.io.InputStream-java.io.OutputStream-boolean-) | PdfFileStamp 的构造函数。 |
| [PdfFileStamp(String inputFile, String outputFile)](#PdfFileStamp-java.lang.String-java.lang.String-) | PdfFileStamp 的构造函数。 |
| [PdfFileStamp(String inputFile, String outputFile, boolean keepSecurity)](#PdfFileStamp-java.lang.String-java.lang.String-boolean-) | PdfFileStamp 的构造函数。 |
## 领域
...
Obsolete("使用 bindPdf(inputFile) 方法进行门面初始化。")
...
Obsolete("使用 Save(outputFile) 方法获取外观结果。")
