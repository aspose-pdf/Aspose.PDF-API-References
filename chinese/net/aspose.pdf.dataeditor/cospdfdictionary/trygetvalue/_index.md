...
description: CosPdfDictionary 方法。用于访问简单数据类型，如字符串、名称、布尔值、数字。对于其他类型返回 null
type: docs
weight: 170
url: /zh/net/aspose.pdf.dataeditor/cospdfdictionary/trygetvalue/
---
## CosPdfDictionary.TryGetValue 方法
...
如果 [`ICosPdfPrimitive`](../../icospdfprimitive/) 是字符串、名称、布尔值、数字，则返回 true。对于所有其他类型返回 false。
