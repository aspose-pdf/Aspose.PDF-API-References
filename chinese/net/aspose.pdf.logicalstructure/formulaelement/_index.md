---
title: "类 FormulaElement"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.LogicalStructure.FormulaElement 类。表示逻辑结构中的 Formula 结构元素。"
type: docs
weight: 6500
url: /zh/net/aspose.pdf.logicalstructure/formulaelement/
---
## FormulaElement class

表示逻辑结构中的 Formula 结构元素。
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | 将图像追加到当前插图元素。 |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | 将图像追加到当前插图元素。 |
