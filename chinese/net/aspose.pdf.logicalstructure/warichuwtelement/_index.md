...
description: Aspose.Pdf.LogicalStructure.WarichuWTElement class. 表示 Warichu 的逻辑结构中的 WT 结构元素
type: docs
weight: 6890
url: /zh/net/aspose.pdf.logicalstructure/warichuwtelement/
---
## WarichuWTElement class

表示 Warichu 的逻辑结构中的 WT 结构元素。
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 从结构中移除一个元素，从父对象中移除对它的引用，从子对象中移除对它的引用，以及从文档中移除相应的对象。将被移除对象的子对象插入到其前父对象的子对象集合中，从被移除对象的索引开始。 |
