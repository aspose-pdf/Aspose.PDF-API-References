...
description: Aspose.Pdf.LogicalStructure.BibEntryElement 类。表示逻辑结构中的 BibEntry 结构元素
type: docs
weight: 6260
url: /zh/net/aspose.pdf.logicalstructure/bibentryelement/
---
## BibEntryElement class

表示逻辑结构中的 BibEntry 结构元素。
