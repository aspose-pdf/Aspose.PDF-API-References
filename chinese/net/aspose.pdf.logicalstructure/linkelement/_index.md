...
description: "Aspose.Pdf.LogicalStructure.LinkElement 类。表示逻辑结构中的 Link 结构元素"
type: docs
weight: 6580
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | 获取或设置注释的备用描述。该文本将显示在注释上，或者如果此类注释不显示文本，则提供注释内容的人类可读形式的备用描述。 |
