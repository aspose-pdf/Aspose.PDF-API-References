---
title: "类 RubyRTElement"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.LogicalStructure.RubyRTElement 类。表示 Ruby 逻辑结构中的 RT 结构元素"
type: docs
weight: 6770
url: /zh/net/aspose.pdf.logicalstructure/rubyrtelement/
---
## RubyRTElement class

表示 Ruby 逻辑结构中的 RT 结构元素。
