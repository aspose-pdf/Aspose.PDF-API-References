...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | 获取或设置注释的替代描述。应显示的注释文本，或者如果这种类型的注释不显示文本，则为注释内容的可读形式的替代描述。 |
