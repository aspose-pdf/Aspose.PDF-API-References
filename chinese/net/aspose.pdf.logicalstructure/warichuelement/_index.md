...
description: Aspose.Pdf.LogicalStructure.WarichuElement class. 表示逻辑结构中的 Warichu 结构元素
type: docs
weight: 6870
url: /zh/net/aspose.pdf.logicalstructure/warichuelement/
---
## WarichuElement class

表示逻辑结构中的 Warichu 结构元素。
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 从结构中移除一个元素、父对象中的引用、子对象中的引用，以及文档中的相应对象。将被移除对象的子对象插入到其前父子对象集合中，从被移除对象的索引开始。 |
