---
title: "类 TableTFootElement"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.LogicalStructure.TableTFootElement 类。表示表的逻辑结构中的 TFoot 结构元素。"
type: docs
weight: 6960
url: /zh/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## TableTFootElement class

表示表格逻辑结构中的 TFoot 结构元素。
