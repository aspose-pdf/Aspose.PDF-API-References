...
description: Aspose.Pdf.LogicalStructure.BlockQuoteElement 类。表示逻辑结构中的 BlockQuote 结构元素
type: docs
weight: 6270
url: /zh/net/aspose.pdf.logicalstructure/blockquoteelement/
---
## BlockQuoteElement 类

表示逻辑结构中的 BlockQuote 结构元素。
