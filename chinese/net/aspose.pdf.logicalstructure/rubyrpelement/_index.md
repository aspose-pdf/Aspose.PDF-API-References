...
description: Aspose.Pdf.LogicalStructure.RubyRPElement 类。表示 Ruby 的逻辑结构中的 RP 结构元素
type: docs
weight: 6620
url: /zh/net/aspose.pdf.logicalstructure/rubyrpelement/
---
## RubyRPElement class

表示 Ruby 的逻辑结构中的 RP 结构元素。
