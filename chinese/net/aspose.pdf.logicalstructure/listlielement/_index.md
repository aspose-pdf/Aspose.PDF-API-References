...
description: Aspose.Pdf.LogicalStructure.ListLIElement 类。表示列表逻辑结构中的 LI 结构元素
type: docs
weight: 6480
url: /zh/net/aspose.pdf.logicalstructure/listlielement/
---
## ListLIElement 类
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 从结构中移除一个元素，从父对象中移除对它的引用，从子对象中移除对它的引用，并从文档中移除相应对象。将被移除对象的子对象插入到其前父子对象集合中，从被移除对象的索引开始。 |
