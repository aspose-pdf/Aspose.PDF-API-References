...
description: Aspose.Pdf.LogicalStructure.TableTBodyElement 类。表示表的逻辑结构中的 TBody 结构元素
type: docs
weight: 6800
url: /zh/net/aspose.pdf.logicalstructure/tabletbodyelement/
---
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | 创建 [`TableTRElement`](../tabletrelement/) 并将其添加到当前表。 |
