...
description: Aspose.Pdf.LogicalStructure.WarichuChildElement 类。表示逻辑结构中 Warichu 的子元素的基类
type: docs
weight: 6860
url: /zh/net/aspose.pdf.logicalstructure/warichuchildelement/
---
## WarichuChildElement class

表示逻辑结构中 Warichu 的子元素的基类。
