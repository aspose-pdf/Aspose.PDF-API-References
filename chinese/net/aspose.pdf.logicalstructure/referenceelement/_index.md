---
title: "类 ReferenceElement"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.LogicalStructure.ReferenceElement 类。表示逻辑结构中的引用结构元素"
type: docs
weight: 6720
url: /zh/net/aspose.pdf.logicalstructure/referenceelement/
---
## ReferenceElement class

表示逻辑结构中的 Reference 结构元素。
