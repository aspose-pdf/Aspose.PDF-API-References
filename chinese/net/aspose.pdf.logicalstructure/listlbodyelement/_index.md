...
description: Aspose.Pdf.LogicalStructure.ListLBodyElement 类。表示列表逻辑结构中的 LBody 结构元素
type: docs
weight: 6470
url: /zh/net/aspose.pdf.logicalstructure/listlbodyelement/
---
## ListLBodyElement class

表示列表逻辑结构中的 LBody 结构元素。
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | 移除：结构中的一个元素，父对象中的对它的引用，子对象中的对它的引用，文档中的相应对象。 |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 从结构中移除一个元素，从父对象中移除对它的引用，从子对象中移除对它的引用，并从文档中移除相应对象。将被移除对象的子对象插入到其前父对象的子对象集合中，从被移除对象的索引开始。 |
