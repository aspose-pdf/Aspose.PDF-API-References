...
description: Aspose.Pdf.LogicalStructure.TableRowCollectionElement 类。表示逻辑结构中表头、主体和脚的子元素的基类
type: docs
weight: 6790
url: /zh/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## TableRowCollectionElement class

表示逻辑结构中表头、主体和脚的子元素的基类。
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | 创建 [`TableTRElement`](../tabletrelement/) 并将其添加到当前表中。 |
