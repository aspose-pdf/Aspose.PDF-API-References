...
| static readonly [Checked](../../aspose.pdf.logicalstructure/attributekey/checked) | 检查属性（PrintField 属性所有者）。 |
| static readonly [Color](../../aspose.pdf.logicalstructure/attributekey/color) | 颜色属性（布局属性所有者）。 |
| static readonly [ColSpan](../../aspose.pdf.logicalstructure/attributekey/colspan) | ColSpan 属性（表属性所有者）。 |
...
| static readonly [Padding](../../aspose.pdf.logicalstructure/attributekey/padding) | 填充属性（布局属性所有者）。 |
| static readonly [Placement](../../aspose.pdf.logicalstructure/attributekey/placement) | 放置属性（布局属性所有者）。 |
| static readonly [Role](../../aspose.pdf.logicalstructure/attributekey/role) | 角色属性（PrintField 属性所有者）。 |
| static readonly [RowSpan](../../aspose.pdf.logicalstructure/attributekey/rowspan) | RowSpan 属性（表属性所有者）。 |
...
| static readonly [Scope](../../aspose.pdf.logicalstructure/attributekey/scope) | 范围属性（表属性所有者）。 |
...
| static readonly [Summary](../../aspose.pdf.logicalstructure/attributekey/summary) | 摘要属性（表属性所有者）。 |
...
| static readonly [Width](../../aspose.pdf.logicalstructure/attributekey/width) | 宽度属性（布局属性所有者）。 |
