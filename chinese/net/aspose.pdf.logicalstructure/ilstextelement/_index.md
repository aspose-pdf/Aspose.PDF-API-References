...
description: Aspose.Pdf.LogicalStructure.ILSTextElement 类。表示逻辑结构中行内文本结构元素的基类
type: docs
weight: 6400
url: /zh/net/aspose.pdf.logicalstructure/ilstextelement/
---
## ILSTextElement 类
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | 获取当前元素的 StructureTextState 对象。 |
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | 移除：结构中的一个元素，父对象中的引用，子对象中的引用，以及文档中的相应对象。 |
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 从结构中移除一个元素，从父对象中移除对它的引用，从子对象中移除对它的引用，以及从文档中移除相应对象。将被移除对象的子对象插入到其前父对象的子对象集合中，从被移除对象的索引开始。 |
