...
description: Aspose.Pdf.LogicalStructure.FigureElement 类。表示逻辑结构中的图形结构元素
type: docs
weight: 6340
url: /zh/net/aspose.pdf.logicalstructure/figureelement/
---
## FigureElement class
...
| [Remove](../../aspose.pdf.logicalstructure/structureelement/remove/)() | 从结构中移除：一个元素，从父对象中移除对它的引用，从子对象中移除对它的引用，从文档中移除相应的对象。 |
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | 将图像附加到当前插图元素。 |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | 将图像附加到当前插图元素。 |
