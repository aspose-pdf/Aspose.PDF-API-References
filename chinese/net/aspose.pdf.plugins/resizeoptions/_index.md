...
description: Aspose.Pdf.Plugins.ResizeOptions 类。表示优化器插件的调整选项
type: docs
weight: 9190
url: /zh/net/aspose.pdf.plugins/resizeoptions/
---
## ResizeOptions 类

表示 [`Optimizer`](../optimizer/) 插件的调整选项。
...
| 名称 | 描述 |
| --- | --- |
| [ResizeOptions](resizeoptions/)() | 默认构造函数。 |
...
| [Outputs](../../aspose.pdf.plugins/organizerbaseoptions/outputs/) { get; } | 获取用于保存操作结果的添加目标集合。 |
| [PageSize](../../aspose.pdf.plugins/resizeoptions/pagesize/) { get; set; } | 获取或设置新页面大小。 |
