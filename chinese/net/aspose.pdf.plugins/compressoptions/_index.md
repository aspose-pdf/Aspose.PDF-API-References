...
description: Aspose.Pdf.Plugins.CompressOptions 类。表示优化器插件的压缩选项
type: docs
weight: 8490
url: /zh/net/aspose.pdf.plugins/compressoptions/
---
## CompressOptions 类

表示 [`Optimizer`](../optimizer/) 插件的压缩选项。
...
| 名称 | 描述 |
| --- | --- |
| [CompressOptions](compressoptions/)() | 默认构造函数。 |
