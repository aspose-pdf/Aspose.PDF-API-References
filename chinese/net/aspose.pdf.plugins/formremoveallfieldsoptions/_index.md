---
title: "类 FormRemoveAllFieldsOptions"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Plugins.FormRemoveAllFieldsOptions 类。表示通过 FormEditor 插件在文档中移除所有字段的选项。"
type: docs
weight: 8910
url: /zh/net/aspose.pdf.plugins/formremoveallfieldsoptions/
---
## FormRemoveAllFieldsOptions class

表示通过 [`FormEditor`](../formeditor/) 插件在文档中移除所有字段的选项。
...
| 名称 | 描述 |
| --- | --- |
| [FormRemoveAllFieldsOptions](formremoveallfieldsoptions/)() | 默认构造函数。 |
