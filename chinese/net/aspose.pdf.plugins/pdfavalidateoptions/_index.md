---
title: "类 PdfAValidateOptions"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Plugins.PdfAValidateOptions 类。表示使用 PdfAConverter 插件验证 PDF 文档 PDF/A 合规性的选项"
type: docs
weight: 9180
...
表示使用 [`PdfAConverter`](../pdfaconverter/) 插件验证 PDF 文档 PDF/A 合规性的选项。
