...
description: 表示处理文档的 TaggedPdf 内容的接口
type: docs
weight: 6520
...
| 姓名 | 描述 |
| --- | --- |
| [RootElement](../../aspose.pdf.tagged/itaggedcontent/rootelement) { get; } | 获取根[`StructureElement`](../../aspose.pdf.logicalstructure/structureelement)PDF文档的逻辑结构。 |
| [StructTreeRootElement](../../aspose.pdf.tagged/itaggedcontent/structtreerootelement) { get; } | 获取[`StructTreeRootElement`](../../aspose.pdf.logicalstructure/structtreerootelement)PDF 文档。 |
| [StructureTextState](../../aspose.pdf.tagged/itaggedcontent/structuretextstate) { get; } | 得到[`StructureTextState`](../../aspose.pdf.logicalstructure/structuretextstate)整个文档的设置。 |
...
| [CreateHeaderElement](../../aspose.pdf.tagged/itaggedcontent/createheaderelement#createheaderelement_1)(int) | 创建[`HeaderElement`](../../aspose.pdf.logicalstructure/headerelement)与水平。 |
...
| [SetLanguage](../../aspose.pdf.tagged/itaggedcontent/setlanguage)(string) | 为 pdf 文档设置自然语言。 |
