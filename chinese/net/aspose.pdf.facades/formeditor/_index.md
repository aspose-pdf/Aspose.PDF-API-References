...
description: "Aspose.Pdf.Facades.FormEditor 类。用于编辑表单、添加/删除字段等的类"
type: docs
weight: 4450
...
| 名称 | 描述 |
| --- | --- |
| [ConvertTo](../../aspose.pdf.facades/formeditor/convertto/) { set; } | 设置 PDF 文件格式。结果文件将以指定的文件格式保存。如果未指定此属性，则文件将以默认的 PDF 格式保存，且不进行转换。 |
...
| [Facade](../../aspose.pdf.facades/formeditor/facade/) { get; set; } | 设置字段的可视属性。 |
...
| [RadioGap](../../aspose.pdf.facades/formeditor/radiogap/) { get; set; } | 用于记录两个相邻单选按钮之间像素间距的成员，默认值为 50。 |
| [RadioHoriz](../../aspose.pdf.facades/formeditor/radiohoriz/) { get; set; } | 指示单选按钮是水平还是垂直排列的标志，默认值为 true。 |
...
| [AddFieldScript](../../aspose.pdf.facades/formeditor/addfieldscript/)(string, string) | 为 PushButton 字段添加 JavaScript。如果已有旧事件，新事件将添加在其后。 |
| [AddListItem](../../aspose.pdf.facades/formeditor/addlistitem/#addlistitem)(string, string) | 向列表框添加新项。 |
| [AddListItem](../../aspose.pdf.facades/formeditor/addlistitem/#addlistitem_1)(string, string[]) | 向现有列表框字段添加带导出值的新项，仅适用于 AcroForm 下拉框字段。 |
...
| override [Close](../../aspose.pdf.facades/formeditor/close/)() | 关闭 facade。 |
...
| [CopyInnerField](../../aspose.pdf.facades/formeditor/copyinnerfield/#copyinnerfield_1)(string, string, int, float, float) | 将现有字段复制到由页码和坐标共同指定的新位置。将生成一个新文档，其中包含源文档的所有内容，除了新复制的字段。 |
...
| [CopyOuterField](../../aspose.pdf.facades/formeditor/copyouterfield/#copyouterfield_1)(string, string, int) | 将现有字段从一个 PDF 文档复制到另一个文档，使用指定的页码和原始坐标。注意：仅适用于 AcroForm 字段（不包括单选框）。 |
| [CopyOuterField](../../aspose.pdf.facades/formeditor/copyouterfield/#copyouterfield_2)(string, string, int, float, float) | 将现有字段从一个 PDF 文档复制到另一个文档，使用指定的页码和坐标。注意：仅适用于 AcroForm 字段（不包括单选框）。 |
| [DecorateField](../../aspose.pdf.facades/formeditor/decoratefield/#decoratefield)() | 更改 PDF 文档中所有字段的可视属性。 |
| [DecorateField](../../aspose.pdf.facades/formeditor/decoratefield/#decoratefield_1)(FieldType) | 更改指定字段类型的所有字段的可视属性。 |
| [DecorateField](../../aspose.pdf.facades/formeditor/decoratefield/#decoratefield_2)(string) | 更改指定字段的可视属性。 |
...
| [RemoveFieldAction](../../aspose.pdf.facades/formeditor/removefieldaction/)(string) | 移除字段的提交操作。 |
| [RenameField](../../aspose.pdf.facades/formeditor/renamefield/)(string, string) | 更改字段的名称。 |
| [ResetFacade](../../aspose.pdf.facades/formeditor/resetfacade/)() | 将所有可视属性重置为空值。 |
| [ResetInnerFacade](../../aspose.pdf.facades/formeditor/resetinnerfacade/)() | 将内部外观的所有可视属性重置为空值。 |
...
| [SetFieldCombNumber](../../aspose.pdf.facades/formeditor/setfieldcombnumber/)(string, int) | 为常规单行文本字段设置梳子数量（字段会自动划分为与 combNumber 参数值等量的等间距位置，即梳子）。 |
| [SetFieldLimit](../../aspose.pdf.facades/formeditor/setfieldlimit/)(string, int) | 设置文本字段的最大字符数。 |
| [SetFieldScript](../../aspose.pdf.facades/formeditor/setfieldscript/)(string, string) | 为 PushButton 字段设置 JavaScript。如果存在旧的 JavaScript，将被新代码替换。 |
