...
| [Log](../../aspose.pdf.facades/pdffilesanitization/log) { get; } | 文件保存后，您可以检查对文件做了什么。 |
| [UseTrimBottom](../../aspose.pdf.facades/pdffilesanitization/usetrimbottom) { get; set; } | 允许删除 pdf 数据后的数据 |
