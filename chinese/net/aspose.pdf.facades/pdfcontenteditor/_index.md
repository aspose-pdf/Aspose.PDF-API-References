...
| [PdfContentEditor](pdfcontenteditor#constructor_1)(Document) | 在*document*的基础上初始化新的[`PdfContentEditor`](../pdfcontenteditor)对象。 |
...
| [CreateApplicationLink](../../aspose.pdf.facades/pdfcontenteditor/createapplicationlink#createapplicationlink)(Rectangle, string, int) | 创建链接以启动 PDF 文档中的应用程序。 |
| [CreateApplicationLink](../../aspose.pdf.facades/pdfcontenteditor/createapplicationlink#createapplicationlink_1)(Rectangle, string, int, Color) | 创建链接以启动 PDF 文档中的应用程序。 |
| [CreateApplicationLink](../../aspose.pdf.facades/pdfcontenteditor/createapplicationlink#createapplicationlink_2)(Rectangle, string, int, Color, Enum[]) | 创建链接以启动 PDF 文档中的应用程序。 |
...
| [CreateCustomActionLink](../../aspose.pdf.facades/pdfcontenteditor/createcustomactionlink)(Rectangle, int, Color, Enum[]) | 创建指向 PDF 文档中自定义操作的链接。 |
...
| [CreateLine](../../aspose.pdf.facades/pdfcontenteditor/createline)(Rectangle, string, float, float, float, float, int, int, Color, string, int[], string[]) | 创建行注释。 |
...
| [CreateWebLink](../../aspose.pdf.facades/pdfcontenteditor/createweblink#createweblink)(Rectangle, string, int) | 在 PDF 文档中创建 Web 链接。 |
| [CreateWebLink](../../aspose.pdf.facades/pdfcontenteditor/createweblink#createweblink_1)(Rectangle, string, int, Color) | 在 PDF 文档中创建 Web 链接。 |
| [CreateWebLink](../../aspose.pdf.facades/pdfcontenteditor/createweblink#createweblink_2)(Rectangle, string, int, Color, Enum[]) | 在 PDF 文档中创建 Web 链接。 |
...
| [DeleteImage](../../aspose.pdf.facades/pdfcontenteditor/deleteimage#deleteimage_1)(int, int[]) | 删除指定页面上的指定图片。 |
| [DeleteStamp](../../aspose.pdf.facades/pdfcontenteditor/deletestamp)(int, int[]) | 通过戳索引删除指定页面上的多个戳。 |
| [DeleteStampById](../../aspose.pdf.facades/pdfcontenteditor/deletestampbyid#deletestampbyid)(int) | 从文档的所有页面中按 ID 删除戳记。 |
| [DeleteStampById](../../aspose.pdf.facades/pdfcontenteditor/deletestampbyid#deletestampbyid_1)(int, int) | 删除指定页面上的戳记 ID。 |
| [DeleteStampByIds](../../aspose.pdf.facades/pdfcontenteditor/deletestampbyids#deletestampbyids_1)(int[]) | 从文档的所有页面中删除具有指定 ID 的图章。 |
| [DeleteStampByIds](../../aspose.pdf.facades/pdfcontenteditor/deletestampbyids#deletestampbyids)(int, int[]) | 删除指定页面上多个戳ID的戳。 |
...
| [MoveStamp](../../aspose.pdf.facades/pdfcontenteditor/movestamp)(int, int, double, double) | 改变印章在页面上的位置。 |
...
| [ReplaceImage](../../aspose.pdf.facades/pdfcontenteditor/replaceimage)(int, int, string) | 将PDF文档指定页面上的指定图像替换为另一个图像。 |
...
| [ReplaceText](../../aspose.pdf.facades/pdfcontenteditor/replacetext#replacetext_1)(string, int, string, TextState) | 替换指定页面上 PDF 文件中的文本。[`TextState`](../../aspose.pdf.text/textstate)对象（字体系列，颜色）可以指定为替换文本。 |
...
| const [DocumentWillSave](../../aspose.pdf.facades/pdfcontenteditor/documentwillsave) | 文档事件类型。在保存前执行一个动作。 |
