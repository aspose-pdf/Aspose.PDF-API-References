...
| [Image](../../aspose.pdf.facades/stampinfo/image/) { get; } | 获取印章的图像。如果印章不包含图像（例如文本印章），可能为 null。 |
| [IndexOnPage](../../aspose.pdf.facades/stampinfo/indexonpage/) { get; } | 获取印章在 page 上的索引。 |
| [Rectangle](../../aspose.pdf.facades/stampinfo/rectangle/) { get; } | 获取放置印章的矩形。 |
