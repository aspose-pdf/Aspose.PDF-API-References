...
表示用于编辑 PDF 文件页面的类，包括旋转页面、缩放页面、移动位置和更改页面大小。
...
| [HorizontalAlignment](../../aspose.pdf.facades/pdfpageeditor/horizontalalignment/) { get; set; } | 获取或设置原始 PDF 内容在结果页面上的水平对齐方式，默认是 AlignmentType.Left。 |
| [PageRotations](../../aspose.pdf.facades/pdfpageeditor/pagerotations/) { get; set; } | 哈希表包含页码和旋转角度，键表示页码，键的值表示以度为单位的旋转角度。 |
| [PageSize](../../aspose.pdf.facades/pdfpageeditor/pagesize/) { get; set; } | 获取或设置输出文件的页面大小。 |
| [ProcessPages](../../aspose.pdf.facades/pdfpageeditor/processpages/) { get; set; } | 获取或设置要编辑的页码。默认情况下，会编辑每一页。 |
| [Rotation](../../aspose.pdf.facades/pdfpageeditor/rotation/) { get; set; } | 获取或设置页面的旋转角度，旋转必须为 0、90、180 或 270。默认值为 0。 |
| [TransitionDuration](../../aspose.pdf.facades/pdfpageeditor/transitionduration/) { get; set; } | 获取或设置过渡效果的持续时间。 |
| [TransitionType](../../aspose.pdf.facades/pdfpageeditor/transitiontype/) { get; set; } | 获取或设置在演示过程中从另一页切换到此页时使用的过渡样式。 |
| [VerticalAlignmentType](../../aspose.pdf.facades/pdfpageeditor/verticalalignmenttype/) { get; set; } | 获取或设置原始 PDF 内容在结果页面上的垂直对齐方式，默认是 VerticalAlignmentType.Bottom。 |
...
| [GetPageRotation](../../aspose.pdf.facades/pdfpageeditor/getpagerotation/)(int) | 返回指定页面的旋转角度。 |
| [GetPages](../../aspose.pdf.facades/pdfpageeditor/getpages/)() | 返回页面的总数。 |
...
| const [TBWIPE](../../aspose.pdf.facades/pdfpageeditor/tbwipe/) | 上下擦除 |
