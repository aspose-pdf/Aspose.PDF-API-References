...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | 获取或设置允许单选按钮没有选定值的标志。如果 `true`，始终只能选中一个单选按钮；选择当前已选中的按钮不会产生任何效果。如果 `false`，点击已选中的按钮会取消选中，使所有按钮均未选中。 |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | 获取或设置所选项的索引。项目编号从 1 开始。 |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | 向 radion 按钮添加选项。 |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | 使用指定的矩形向单选按钮添加选项。 |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | 将单选按钮的所有子项移动到页面上指定的位置。 |
