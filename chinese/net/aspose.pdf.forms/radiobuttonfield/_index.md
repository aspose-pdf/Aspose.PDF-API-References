...
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex) { get; } | 获取包含此 RadioButton 字段的页面的索引。 |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected) { get; set; } | 获取或设置所选项目的索引。项目编号从 1 开始。 |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add)(RadioButtonOptionField) | 将新选项字段添加到 RadioButton 字段 |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption)(string) | 添加选项到单选按钮。 |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption#addoption_1)(string, Rectangle) | 添加到带有指定矩形的单选按钮选项。 |
