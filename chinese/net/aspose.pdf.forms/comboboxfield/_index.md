...
description: Aspose.Pdf.Forms.ComboBoxField 类。表示表单的组合框字段
type: docs
weight: 5000
url: /zh/net/aspose.pdf.forms/comboboxfield/
---
## ComboBoxField class
...
| Name | Description |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | 用于生成器的 ComboBoxField 构造函数。 |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | 创建与生成器一起使用的 CombBox 字段。 |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | 组合框字段的构造函数。 |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | 组合框字段的构造函数。 |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately/) { get; set; } | 获取或设置选择更改标志。 |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | 获取或设置字段的可编辑状态。 |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | 生成器支持的属性。当字段添加到页眉或页脚时使用。如果为 true，则此字段将创建一次，并且其外观将在文档的所有页面上可见。如果为 false，则每个文档页面将创建单独的字段。 |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | 获取或设置拼写检查活动状态。 |
