...
description: 表示表单的 Combobox 字段的类
type: docs
weight: 2950
...
| 姓名 | 描述 |
| --- | --- |
| [ComboBoxField](comboboxfield#constructor)() | 要在生成器中使用的 ComboBoxField 的构造函数。 |
| [ComboBoxField](comboboxfield#constructor_1)(Document) | 创建组合框字段以使用 Generator. |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately) { get; set; } | 获取或设置选择更改标志的提交。 |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems) { get; set; } | 获取或设置所选项目的数组。对于多选列表数组包含多于一项。对于单个选择列表，它包含单个项目。 |
