---
title: "类 ComboBoxField"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Forms.ComboBoxField 类。类表示表单的组合框字段"
type: docs
weight: 5120
...
| 名称 | 描述 |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | 用于 Generator 的 ComboBoxField 构造函数。 |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | 创建用于与 Generator 配合工作的 CombBox 字段。 |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Combobox 字段的构造函数。 |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Combobox Field 的构造函数。 |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | 获取或设置 spellchaeck 活动状态。 |
