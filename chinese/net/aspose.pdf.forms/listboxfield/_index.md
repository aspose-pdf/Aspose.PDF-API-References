...
| 姓名 | 描述 |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | 要在 Generator. 中使用的 ListBoxField 的构造函数 |
| [ListBoxField](listboxfield#constructor_1)(Document, Rectangle) | ListBox 字段的构造函数。 |
| [ListBoxField](listboxfield#constructor_2)(Page, Rectangle) | 创建新的列表框字段。 |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | 获取或设置所选项目的索引。项目编号从 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | 获取或设置多选列表中选定项的数组。对于单选列表返回带有单个项目的数组。 |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex) { get; set; } | 获取或设置列表顶部可见元素的索引。 |
