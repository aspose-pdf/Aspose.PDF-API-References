...
| 姓名 | 描述 |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | 用于生成器的 ListBoxField 的构造函数。 |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | 获取或设置所选项目的索引。项目从 1 开始编号。 |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | 获取或设置多选列表中选定项目的数组。对于单选列表，返回包含单个项目的数组。 |
