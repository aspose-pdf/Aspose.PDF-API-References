...
| 姓名 | 描述 |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | 初始化[`BarcodeField`](../barcodefield)类的新实例。 |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | 初始化[`BarcodeField`](../barcodefield)类的新实例。 |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } | 获取表示纠错系数的整数值。 对于 PDF417，应为 0 到 8。对于 QRCode，应为 0 到 3 (0 表示“L”，1 表示“M”，2 表示“Q” �，3 代表‘H’)。 |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | 指定要在此注释上使用哪种条形码或字形技术， 请参见Symbology了解详情。 |
