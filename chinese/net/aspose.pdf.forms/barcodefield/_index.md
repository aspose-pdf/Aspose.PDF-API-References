...
| 姓名 | 描述 |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | 初始化[`BarcodeField`](../barcodefield)类. |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | 初始化[`BarcodeField`](../barcodefield)类. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc) { get; } | 获取表示纠错系数的整数值。 对于 PDF417，应为 0 到 8。对于 QRCode，应为 0 到 3 （“L”为 0，“M”为 1，“Q”为 2，“H”为 3）。 |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution) { get; } | 获取呈现条形码对象的分辨率，以每英寸点数 (dpi) 为单位。 |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable) { get; set; } | 获取或设置字段的可滚动标志。如果真字段可以滚动。 |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck) { get; set; } | 获取或设置字段的拼写检查标志。如果真字段应进行拼写检查。 |
| [States](../../aspose.pdf.annotations/annotation/states) { get; } | 获取注解的外观字典。 |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | 指定要在此注释上使用哪种条形码或字形技术， 见[`Symbology`](./symbology)有关详细信息。 |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight) { get; } | 获取两个条码模块之间的垂直距离，以像素为单位。 XSymHeight/XSymWidth 比率应为整数值。 对于 PDF417，可接受的比率范围是 1 到 4。对于 QRCode 和 DataMatrix， 此比率应始终为 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth) { get; } | 获取两个条码模块之间的水平距离，以像素为单位。 |
