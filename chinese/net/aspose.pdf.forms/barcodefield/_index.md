...
description: Aspose.Pdf.Forms.BarcodeField 类。类表示条形码字段
type: docs
weight: 4950
url: /zh/net/aspose.pdf.forms/barcodefield/
---
## BarcodeField 类
...
| 名称 | 描述 |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | 初始化 `BarcodeField` 类的新实例。 |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | 初始化 `BarcodeField` 类的新实例。 |
...
| [AlternateName](../../aspose.pdf.forms/field/alternatename/) { get; set; } | 获取或设置字段的备用名称（在用户界面中识别字段时应使用的备用字段名称）。备用名称在 Adobe Acrobat 中用作字段工具提示。 |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | 获取条形码对象的标题。 |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | 获取表示错误校正系数的整数值。对于 PDF417，应为 0 到 8。对于 QRCode，应为 0 到 3（0 表示 'L'，1 表示 'M'，2 表示 'Q'，3 表示 'H'）。 |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | 获取条形码对象渲染的分辨率，以每英寸点数（dpi）为单位。 |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | 指定此注释上要使用的条形码或字形技术，详细信息请参见 [`Symbology`](./symbology/)。 |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | 获取两个条形码模块之间的垂直距离，以像素为单位。比例 XSymHeight/XSymWidth 应为整数值。对于 PDF417，接受的比例范围为 1 到 4。对于 QRCode 和 DataMatrix，此比例应始终为 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | 获取两个条形码模块之间的水平距离，以像素为单位。 |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | 从 JSON 流中将数据导入指定字段，使用 'fieldFullNameInJSON' 变量中指定的完全名称进行匹配。 |
