...
description: Aspose.Pdf.Forms.Field 类。Acro 表单字段的基类
type: docs
weight: 5050
url: /zh/net/aspose.pdf.forms/field/
---
## 字段类
...
| 名称 | 描述 |
| --- | --- |
| [Field](field/)(Document) | 创建用于生成器的字段。 |
...
| [Item](../../aspose.pdf.forms/field/item/) { get; } | 通过子字段名称获取包含在此字段中的子字段。 (2 个索引器) |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | 如果为 true，则字体大小将减少以适应指定矩形中的文本。 |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | 可用于字段内容的最大字体大小。-1 表示不检查大小。 |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | 可用于字段内容的最小字体大小。-1 表示不检查大小。 |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | 将此字段的子字段复制到从指定索引开始的数组中。 |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | 从 JSON 流中将数据导入指定字段，基于字段全名的精确匹配。 |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | 从 JSON 流中将数据导入指定字段，使用在 'fieldFullNameInJSON' 变量中指定的全名进行匹配。 |
