...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | 如果为 true，则字体大小将减小以使文本适合指定的矩形。 |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | 可用于字段内容的Maximail 字体大小。 -1 不检查大小。 |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize) { get; set; } | 可用于字段内容的最小字体大小。 -1 不检查大小。 |
