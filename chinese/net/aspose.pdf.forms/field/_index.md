...
| 名称 | 描述 |
| --- | --- |
| [Field](field/)(Document) | 创建用于 Generator 的字段。 |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | 如果为 true，则字体大小将被缩小以适应指定矩形内的文本。 |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | 将此字段的子字段复制到数组中，从指定索引开始。 |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | 从 JSON 流中导入数据到指定字段，基于字段完整名称的精确匹配。 |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | 从 JSON 流中导入数据到指定字段，使用 'fieldFullNameInJSON' 变量中指定的完整名称进行匹配。 |
