...
| 姓名 | 描述 |
| --- | --- |
| [Config](../../aspose.pdf.forms/xfa/config) { get; } | XFA 表单的 XFA Config 组件。 |
...
| [Item](../../aspose.pdf.forms/xfa/item) { get; set; } | 获取集合数据节点值根据*path*. |
...
| [XDP](../../aspose.pdf.forms/xfa/xdp) { get; } | XML 数据包（周围 XML 容器内的所有 XFA 表单组件）。 |
