...
description: 代表pdf文档中签名对象的抽象类 签名是具有签名对象值的字段最后包含用于验证文档有效性的数据 
type: docs
weight: 3210
...
代表pdf文档中签名对象的抽象类。 签名是具有签名对象值的字段，最后包含用于验证文档有效性的数据 。
...
| 姓名 | 描述 |
| --- | --- |
| [Signature](signature#constructor)() | 初始化[`Signature`](../signature)类的新实例。 |
| [Signature](signature#constructor_1)(Stream, string) | 初始化[`Signature`](../signature)类的新实例。 |
| [Signature](signature#constructor_2)(string, string) | 初始化[`Signature`](../signature)类的新实例。 |
