...
description: Aspose.Pdf.Forms.TextBoxField 类。表示文本框字段的类
type: docs
weight: 5320
...
| 名称 | 描述 |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | 应与生成器一起使用的构造函数。 |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | 文本框字段的构造函数。 |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | 文本框字段的构造函数。 |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | 文本框字段的构造函数。 |
