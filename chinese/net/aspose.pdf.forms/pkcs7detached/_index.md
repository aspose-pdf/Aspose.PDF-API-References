...
description: 表示符合 Internet RFC 2315 中的 PKCS7 规范的 PKCS7 对象 PKCS7加密消息语法版本 1.5 将文档字节范围内的原始签名消息摘要合并为普通 PKCS 7 签名数据字段 PKCS7 SignedData 字段中不应封装任何数据
type: docs
weight: 3140
...
| 姓名 | 描述 |
| --- | --- |
| [PKCS7Detached](pkcs7detached#constructor)() | 初始化[`PKCS7Detached`](../pkcs7detached)类. |
| [PKCS7Detached](pkcs7detached#constructor_1)(Stream) | 初始化[`PKCS7Detached`](../pkcs7detached)类. |
| [PKCS7Detached](pkcs7detached#constructor_2)(Stream, string) | 初始化[`PKCS7Detached`](../pkcs7detached)类. |
| [PKCS7Detached](pkcs7detached#constructor_3)(string, string) | 初始化[`PKCS7Detached`](../pkcs7detached)类. |
