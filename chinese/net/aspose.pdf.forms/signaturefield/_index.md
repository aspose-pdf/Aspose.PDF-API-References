---
title: "类 SignatureField"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Forms.SignatureField 类。表示签名表单字段"
type: docs
weight: 5410
...
| 名称 | 描述 |
| --- | --- |
| [SignatureField](signaturefield/#constructor)(Document, Rectangle) | 初始化 `SignatureField` 类的新实例。 |
| [SignatureField](signaturefield/#constructor_1)(Page, Rectangle) | 初始化 `SignatureField` 类的新实例。 |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | 获取签名对象。此对象包含有关公钥密码标准的签名数据。类 [`PKCS1`](../pkcs1/)、[`PKCS7`](../pkcs7/) 和 [`PKCS7Detached`](../pkcs7detached/) 表示所有受支持的签名对象类型。 |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | 提取单个 X.509 证书（DER 格式）为流。 |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | 提取单个 X.509 证书对象。 |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | 提取签名的图像为 jpeg 编码的流。 |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | 提取签名的图像为编码的流。 |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign_1)(Signature, Stream, string) | 使用此签名字段签署文档。 |
