...
| [IsInNewPage](../../aspose.pdf/baseparagraph/isinnewpage/) { get; set; } | 获取或设置一个布尔值，强制此段落生成在新页面。默认值为 false。（用于 PDF 生成） |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | 获取签名对象。此对象包含有关公钥密码标准的签名数据。类 [`PKCS1`](../pkcs1/)、[`PKCS7`](../pkcs7/) 和 [`PKCS7Detached`](../pkcs7detached/) 代表所有支持的签名对象类型。 |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | 以 DER 格式提取单个 X.509 证书作为流。 |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | 提取签名的图像作为 JPEG 编码流。 |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | 提取签名的图像作为编码流。 |
