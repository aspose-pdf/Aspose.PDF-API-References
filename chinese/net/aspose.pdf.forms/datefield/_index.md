...
type: docs
weight: 2960
url: /zh/net/aspose.pdf.forms/datefield/
---
## DateField class
...
| 姓名 | 描述 |
| --- | --- |
| [DateField](datefield#constructor)() | 初始化[`DateField`](../datefield) |
| [DateField](datefield#constructor_1)(Document) | 应与 Generator. 一起使用的构造函数 |
| [DateField](datefield#constructor_2)(Document, Rectangle) | 初始化[`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | 初始化[`DateField`](../datefield) |
...
| [DateFormat](../../aspose.pdf.forms/datefield/dateformat) { get; set; } | 获取或设置日期格式。 |
...
| [Value](../../aspose.pdf.forms/datefield/value) { get; set; } | 获取或设置日期。 |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage#addimage)(Image) | 此字段的图像添加被拒绝。 (2 methods) |
...
| [Init](../../aspose.pdf.forms/datefield/init)(Page) | 初始化 JS Action. |
