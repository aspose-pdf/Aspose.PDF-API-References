...
| [DateField](datefield#constructor_1)(Document) | 构造函数，应该与生成器一起使用。 |
| [DateField](datefield#constructor_2)(Document, Rectangle) | 初始化一个新的实例 [`DateField`](../datefield) |
| [DateField](datefield#constructor_3)(Page, Rectangle) | 初始化一个新的实例 [`DateField`](../datefield) |
...
| [Init](../../aspose.pdf.forms/datefield/init)(Page) | 初始化 JS 动作。 |
...
DateField dateField =新的日期字段（页面，矩形）； doc.Form.Add(dateField); dateField.Init(page);
