...
description: "Aspose.Pdf.Forms.DateField 类。带日历视图的日期字段"
type: docs
weight: 5130
...
| 名称 | 描述 |
| --- | --- |
| [DateField](datefield/#constructor)() | 初始化 `DateField` 的新实例 |
| [DateField](datefield/#constructor_1)(Document) | 应与 Generator 一起使用的构造函数。 |
| [DateField](datefield/#constructor_2)(Document, Rectangle) | 初始化 `DateField` 的新实例 |
| [DateField](datefield/#constructor_3)(Page, Rectangle) | 初始化 `DateField` 的新实例 |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | 此字段不允许添加图像。（2 种方法） |
...
| [Init](../../aspose.pdf.forms/datefield/init/)(Page) | 初始化 JS 操作。 |
