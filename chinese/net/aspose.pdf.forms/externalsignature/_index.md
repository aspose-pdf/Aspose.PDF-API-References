---
title: "类 ExternalSignature"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Forms.ExternalSignature 类。使用 X509Certificate2 创建分离的 PKCS7 签名。它支持没有可导出私钥的 USB 智能卡令牌"
type: docs
weight: 5160
...
使用 X509Certificate2 创建分离的 PKCS#7 签名。它支持 USB 智能卡、没有可导出私钥的令牌。
...
| 名称 | 描述 |
| --- | --- |
| [ExternalSignature](externalsignature/#constructor)(X509Certificate2) | 使用 X509Certificate2 创建分离的 PKCS#7 `(detached)` 签名。它支持没有可导出私钥的 USB 智能卡、令牌。 |
| [ExternalSignature](externalsignature/#constructor_4)(string, bool) | 使用 X509Certificate2 作为 Base64 字符串创建 PKCS#7 签名。 |
| [ExternalSignature](externalsignature/#constructor_3)(string, DigestHashAlgorithm) | 使用 X509Certificate2 作为 Base64 字符串创建 PKCS#7 `(detached)` 签名。 |
| [ExternalSignature](externalsignature/#constructor_2)(X509Certificate2, bool) | 使用 X509Certificate2 创建分离的 PKCS#7 签名。它支持 USB 智能卡、没有可导出私钥的令牌。 |
| [ExternalSignature](externalsignature/#constructor_1)(X509Certificate2, DigestHashAlgorithm) | 使用 X509Certificate2 创建分离的 PKCS#7 `(detached)` 签名。它支持没有可导出私钥的 USB 智能卡、令牌。 |
