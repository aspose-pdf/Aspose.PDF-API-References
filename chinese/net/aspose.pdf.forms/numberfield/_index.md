...
description: Aspose.Pdf.Forms.NumberField 类。具有指定有效字符的文本字段
type: docs
weight: 5140
url: /zh/net/aspose.pdf.forms/numberfield/
---
## NumberField 类
...
| 名称 | 描述 |
| --- | --- |
| [NumberField](numberfield/#constructor)() | 初始化 `NumberField` 类的新实例。 |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | 初始化 `NumberField` 类的新实例。 |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | 初始化 `NumberField` 类的新实例。 |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | 获取或设置允许的字符。 |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | 向字段添加条形码 128。字段值将更改为代码，字段变为只读。 |
