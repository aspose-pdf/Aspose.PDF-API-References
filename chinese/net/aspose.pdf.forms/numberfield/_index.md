...
| 姓名 | 描述 |
| --- | --- |
| [NumberField](numberfield#constructor)() | 初始化[`NumberField`](../numberfield)类的新实例。 |
| [NumberField](numberfield#constructor_1)(Document, Rectangle) | 初始化[`NumberField`](../numberfield)类的新实例。 |
| [NumberField](numberfield#constructor_2)(Page, Rectangle) | 初始化[`NumberField`](../numberfield)类的新实例。 |
