...
description: Aspose.Pdf.Forms.RadioButtonOptionField 类。类表示单选按钮字段的项
type: docs
weight: 5220
url: /zh/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## RadioButtonOptionField 类
...
| 名称 | 描述 |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | 创建新的 RadioButtonOptionField 实例。 |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | 在指定页面的指定矩形中创建单选按钮。 |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | 获取或设置标题。 |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | 获取此字段中子字段的数量。 (例如单选按钮字段中的项目数量)。 |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | 获取或设置选项的名称。 |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | 获取或设置复选框的样式。 |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | 获取或设置一个 int 值，指示图形的 Z 顺序。具有较大 ZIndex 的图形将放置在具有较小 ZIndex 的图形上方。ZIndex 可以为负数。具有负 ZIndex 的图形将放置在页面的文本后面。 |
