...
| 姓名 | 描述 |
| --- | --- |
| [ButtonField](buttonfield#constructor)() | Generator 的按钮字段构造函数。 |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | 获取或设置在其活动区域内按下鼠标按钮时应显示的按钮的备用标题 。 |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | 获取或设置在其活动区域内按下鼠标按钮时应显示的备用图标。 |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | 获取图标适合对象，指定小部件注释的图标应如何在其注释矩形中显示。 |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption) { get; set; } | 获取或设置普通字幕。 |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon) { get; set; } | 获取或设置不与用户交互时应显示的按钮的普通图标。 |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | 获取或设置当用户将光标 滚动到其活动区域而不按下鼠标按钮时应显示的按钮的翻转标题。 |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | 获取或设置当用户 将光标滚动到其活动区域而不按下鼠标按钮时应显示的按钮的翻转图标。 |
