...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | 获取图标适合对象，指定小部件注释的图标应如何显示在其注释矩形中。 |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | 获取或设置按钮的翻转标题，当用户将光标 滚动到其活动区域而不按下鼠标按钮时应显示该标题。 |
