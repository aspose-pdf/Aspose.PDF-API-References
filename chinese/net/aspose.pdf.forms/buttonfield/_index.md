...
description: "Aspose.Pdf.Forms.ButtonField 类。该类表示推送按钮字段。"
type: docs
weight: 5090
...
| 名称 | 描述 |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | 用于 Generator 的按钮字段构造函数。 |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | 获取或设置按钮的备用标题，当在其活动区域内按下鼠标按钮时显示该标题。 |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | 获取或设置备用图标，该图标将在鼠标按钮在其活动区域内被按下时显示。 |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | 获取或设置普通标题。 |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | 获取或设置按钮的普通图标，该图标将在未与用户交互时显示。 |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | 获取或设置按钮的悬停标题，当用户将光标移入其活动区域且未按下鼠标按钮时显示。 |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | 获取或设置按钮的悬停图标，当用户将光标移入其活动区域且未按下鼠标按钮时显示。 |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | 向字段资源中添加图像并绘制它。 |
