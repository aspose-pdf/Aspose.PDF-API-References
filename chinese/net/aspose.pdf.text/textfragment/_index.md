...
| 姓名 | 描述 |
| --- | --- |
| [TextFragment](textfragment#constructor)() | 初始化[`TextFragment`](../textfragment)对象的新实例。 |
| [TextFragment](textfragment#constructor_2)(string) | 创建 Aspose.Pdf.Text.TextFragment 对象使用单个 [`TextSegment`](../textsegment) 里面的对象。 指定段内的文本字符串。 |
| [TextFragment](textfragment#constructor_1)(TabStops) | 初始化的新实例[`TextFragment`](../textfragment) 对象的新实例 [`TabStops`](../tabstops) 位置。 |
| [TextFragment](textfragment#constructor_3)(string, TabStops) | 使用单个TextSegment创建 对象 [`TextFragment`](../textfragment) 对象内部和预定义的[`TabStops`](../tabstops)位置。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [BaselinePosition](../../aspose.pdf.text/textfragment/baselineposition) { get; set; } | 获取文本的文本位置，用[`TextFragment`](../textfragment)对象表示。 Position 结构的 YIndent 表示文本片段的基线坐标。 |
...
| [Position](../../aspose.pdf.text/textfragment/position) { get; set; } | 获取或设置文本的文本位置，用[`TextFragment`](../textfragment)对象表示。 |
...
| [Segments](../../aspose.pdf.text/textfragment/segments) { get; set; } | 获取当前[`TextFragment`](../textfragment)的文本段。 |
| [Text](../../aspose.pdf.text/textfragment/text) { get; set; } | 获取或设置String文本对象[`TextFragment`](../textfragment)对象代表。 |
| [TextState](../../aspose.pdf.text/textfragment/textstate) { get; } | 获取或设置[`TextFragment`](../textfragment)对象所代表的文本的文本状态。 |
...
| [IsolateTextSegments](../../aspose.pdf.text/textfragment/isolatetextsegments)(int, int) | 获取[`TextSegment`](../textsegment)(s) 表示TextFragment文本。 |

### 评论

简而言之，[`TextFragment`](../textfragment)对象包含[`TextSegment`](../textsegment)对象的列表。 详细说明: Pdf中的pdf文档文本由两个基本对象表示:[`TextFragment`](../textfragment)和[`TextSegment`](../textsegment) 区别它们之间的关系主要取决于上下文。 让我们考虑以下场景。用户搜索文本“hello world”以对其进行操作、更改其属性、外观等 &lt;code&gt; Document doc = new Document(docFile); TextFragmentAbsorber 吸收器 = new TextFragmentAbsorber("hello world"); doc.Pages[1].Accept(absorber); &lt;/code&gt; 物理上 pdf 文本的表示非常复杂。 文本“hello world”可能由几个物理上独立的文本段组成。 Aspose.Pdf 文本模型基本建立了[`TextFragment`](../textfragment)object 提供单一的在物理[`TextSegment`](../textsegment)表示用户查询的对象集上设置的逻辑操作。 在文本搜索场景中，[`TextFragment`](../textfragment)是逻辑的“hello world”文本表示， 和[`TextSegment`](../textsegment)对象集合表示构造“hello world”文本对象的所有物理段。 所以，[`TextFragment`](../textfragment)接近于逻辑文本表示。 和[`TextSegment`](../textsegment)接近于物理文本表示。 显然每个[`TextSegment`](../textsegment)对象可能有它自己的字体、颜色、定位属性。 [`TextFragment`](../textfragment)提供简单的方法来更改文本及其属性:设置字体、设置字体大小、设置字体颜色等 同时[`TextSegment`](../textsegment)对象可以访问并且用户可以使用TextSegment对象独立。 请注意，更改 TextFragment 属性可能会更改内部[`Segments`](./segments)集合，因为 TextFragment 是一个聚合对象 它可以重新排列内部段或将它们合并为单个段。 如果您的要求是保持[`Segments`](./segments)集合不变，请单独更改内部段。
