...
description: FontSubstitutionCollection 方法。将整个集合复制到兼容的一维数组，从目标数组的指定索引开始
type: docs
weight: 80
url: /zh/net/aspose.pdf.text/fontsubstitutioncollection/copyto/
---
## FontSubstitutionCollection.CopyTo 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| array | FontSubstitution[] | 将被复制的对象数组。 |
