...
| [TextState](textstate/#constructor_2)(Color) | 创建具有前景色规范的文本状态对象。 |
| [TextState](textstate/#constructor_1)(double) | 创建具有字号规范的文本状态对象。 |
| [TextState](textstate/#constructor_4)(string) | 创建具有字体族规范的文本状态对象。 |
| [TextState](textstate/#constructor_3)(Color, double) | 创建具有前景色和字号规范的文本状态对象。 |
| [TextState](textstate/#constructor_6)(string, double) | 创建具有字体族和字号规范的文本状态对象。 |
| [TextState](textstate/#constructor_5)(string, bool, bool) | 创建具有字体族和字体样式规范的文本状态对象。 |
...
| virtual [CoordinateOrigin](../../aspose.pdf.text/textstate/coordinateorigin/) { get; set; } | 获取或设置文本的 CoordinateOrigin。如果 CoordinateOrigin 为 Descender，则文本的 Y 坐标对应于字体的最低点。如果 CoordinateOrigin 为 BaseLine，则文本的 Y 坐标对应于字体的基线。默认值为 Descender。如果字体的 Descent 值过大，文本可能会比其他字体渲染得更高。在这种情况下，可以选择 CoordinateOrigin 为 BaseLine，以获得更好的文本渲染。 |
...
| virtual [ForegroundColor](../../aspose.pdf.text/textstate/foregroundcolor/) { get; set; } | 获取或设置文本的前景颜色。 |
...
| virtual [StrokingColor](../../aspose.pdf.text/textstate/strokingcolor/) { get; set; } | 获取或设置文本的前景颜色。 |
