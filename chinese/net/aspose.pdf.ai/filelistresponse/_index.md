---
title: "类 FileListResponse"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.FileListResponse 类。表示包含文件响应列表的文件列表响应"
type: docs
weight: 410
url: /zh/net/aspose.pdf.ai/filelistresponse/
---
...
| 名称 | 描述 |
| --- | --- |
| [FileListResponse](filelistresponse/)() | 默认构造函数。 |
...
| [Object](../../aspose.pdf.ai/filelistresponse/object/) { get; set; } | 获取或设置对象类型，该类型始终为 list。 |
