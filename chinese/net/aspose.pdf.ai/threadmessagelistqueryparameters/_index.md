---
title: "类 ThreadMessageListQueryParameters"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.ThreadMessageListQueryParameters 类。列出线程消息的查询参数对象"
type: docs
weight: 1220
...
| [RunId](../../aspose.pdf.ai/threadmessagelistqueryparameters/runid/) { get; set; } | 按生成这些消息的运行 ID 过滤消息。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/threadmessagelistqueryparameters/getqueryparameters/)() | 获取列出线程消息的查询参数。 |
