...
description: OpenAIClient 方法。等待特定线程消息异步完成
type: docs
weight: 480
url: /zh/net/aspose.pdf.ai/openaiclient/waitforthreadmessagetocompleteasync/
---
## OpenAIClient.WaitForThreadMessageToCompleteAsync 方法
...
| threadMessageId | 字符串 | 监控直到完成的消息 ID。 |
