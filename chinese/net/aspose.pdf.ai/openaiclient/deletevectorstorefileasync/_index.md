...
description: OpenAIClient 方法。异步删除向量存储中的文件
type: docs
weight: 180
url: /zh/net/aspose.pdf.ai/openaiclient/deletevectorstorefileasync/
---
## OpenAIClient.DeleteVectorStoreFileAsync 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| vectorStoreId | 字符串 | 包含要删除的文件的向量存储的 ID。 |
