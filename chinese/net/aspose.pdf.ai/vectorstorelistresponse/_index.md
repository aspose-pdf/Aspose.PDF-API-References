---
title: "类 VectorStoreListResponse"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.VectorStoreListResponse 类。表示包含向量存储数据的列表响应"
type: docs
weight: 1460
url: /zh/net/aspose.pdf.ai/vectorstorelistresponse/
---
...
| 名称 | 描述 |
| --- | --- |
| [VectorStoreListResponse](vectorstorelistresponse/)() | 默认构造函数。 |
