---
title: "类 VectorStoreFileBatchFileListResponse"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.VectorStoreFileBatchFileListResponse 类。表示包含向量存储文件批次数据的列表响应"
type: docs
weight: 1390
url: /zh/net/aspose.pdf.ai/vectorstorefilebatchfilelistresponse/
---
...
| 名称 | 描述 |
| --- | --- |
| [VectorStoreFileBatchFileListResponse](vectorstorefilebatchfilelistresponse/)() | 默认构造函数。 |
