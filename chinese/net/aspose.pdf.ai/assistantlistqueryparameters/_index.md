---
title: "类 AssistantListQueryParameters"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.AssistantListQueryParameters 类。表示列出助理时的查询参数对象"
type: docs
weight: 110
...
| 名称 | 描述 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/assistantlistqueryparameters/getqueryparameters/)() | 获取列出助理的查询参数。 |
