---
title: "类 VectorStoreResponse"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.AI.VectorStoreResponse 类。向量存储对象。"
type: docs
weight: 1480
...
| 名称 | 描述 |
| --- | --- |
| [CreatedAt](../../aspose.pdf.ai/vectorstoreresponse/createdat/) { get; set; } | 获取或设置向量存储创建时的 Unix 时间戳（秒）。 |
...
| [ExpiresAt](../../aspose.pdf.ai/vectorstoreresponse/expiresat/) { get; set; } | 获取或设置向量存储过期时的 Unix 时间戳（秒）。 |
| [FileCounts](../../aspose.pdf.ai/vectorstoreresponse/filecounts/) { get; set; } | 获取或设置已处理的文件数量。 |
...
| [Id](../../aspose.pdf.ai/vectorstoreresponse/id/) { get; set; } | 获取或设置标识符，可在 API 端点中引用。 |
| [IsSuccessful](../../aspose.pdf.ai/baseresponse/issuccessful/) { get; } | 指示响应是否成功。 |
| [LastActiveAt](../../aspose.pdf.ai/vectorstoreresponse/lastactiveat/) { get; set; } | 获取或设置向量存储最近一次活跃时的 Unix 时间戳（秒）。 |
| [Metadata](../../aspose.pdf.ai/vectorstoreresponse/metadata/) { get; set; } | 获取或设置一组可附加到对象的 16 个键值对。这对于以结构化格式存储对象的附加信息很有用。键的最大长度为 64 个字符，值的最大长度为 512 个字符。 |
...
| [Status](../../aspose.pdf.ai/vectorstoreresponse/status/) { get; set; } | 获取或设置向量存储的状态，可为 expired、in_progress 或 completed。状态为 completed 表示向量存储已准备好使用。 |
