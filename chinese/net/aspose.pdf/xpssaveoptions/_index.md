...
| 姓名 | 描述 |
| --- | --- |
| [BatchSize](../../aspose.pdf/xpssaveoptions/batchsize) { get; set; } | 如果批量转换适用，则定义批量大小 到源格式和目标格式对。 |
...
| [SaveTransparentTexts](../../aspose.pdf/xpssaveoptions/savetransparenttexts) { get; set; } | 表示是否保留透明（OCR）文本。 |
