...
| override [GetXml](../../aspose.pdf/xmppdfaextensionvaluetype/getxml/)(XmlDocument) | 返回表示值类型的 XML 元素列表（在 XML 树中）。 |
| [Remove](../../aspose.pdf/xmppdfaextensionvaluetype/remove/)(XmpPdfAExtensionField) | 从字段列表中移除该字段。 |
