---
title: "类 PsSaveOptions"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.PsSaveOptions 类。导出为 PS PostScript 或 EPS 格式的保存选项。"
type: docs
weight: 9890
...
导出为 PS（PostScript）或 EPS 格式的保存选项。
...
| [EmbedFont](../../aspose.pdf/pssaveoptions/embedfont/) { get; set; } | 获取/设置指示是否必须在生成的 PS 文档中嵌入字体的标志。 |
| [EmbedFontAs](../../aspose.pdf/pssaveoptions/embedfontas/) { get; set; } | 获取/设置在生成的 PS 文档中嵌入字体的类型。 |
