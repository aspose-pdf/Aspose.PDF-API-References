...
description: 表示 Collection12.3.5 Collections的类
type: docs
weight: 1480
...
| [Add](../../aspose.pdf/embeddedfilecollection/add)(string, FileSpecification) | 使用指定键将文件添加到嵌入文件。 |
| [CopyTo](../../aspose.pdf/embeddedfilecollection/copyto)(FileSpecification[], int) | 将 FileSpecification 对象的数组复制到集合中。 |
| [Delete](../../aspose.pdf/embeddedfilecollection/delete)() | 从文档中删除所有嵌入的文件。 |
