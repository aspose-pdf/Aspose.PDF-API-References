...
| [Cells](../../aspose.pdf/row/cells/) { get; set; } | 获取该行的单元格。 |
...
| [IsInNewPage](../../aspose.pdf/row/isinnewpage/) { get; set; } | 获取固定行是否在新页面——具有此属性的页面应打印到下一页，默认 false； |
| [IsRowBroken](../../aspose.pdf/row/isrowbroken/) { get; set; } | 获取行是否可以在两页之间断开 |
| [MinRowHeight](../../aspose.pdf/row/minrowheight/) { get; set; } | 获取行高； |
...
| 名称 | 描述 |
| --- | --- |
| [Clone](../../aspose.pdf/row/clone/)() | 克隆该行。 |
