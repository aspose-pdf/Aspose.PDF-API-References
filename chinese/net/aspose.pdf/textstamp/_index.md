...
| 姓名 | 描述 |
| --- | --- |
| [TextStamp](textstamp#constructor)(FormattedText) | 使用 formattedText 对象初始化[`TextStamp`](../textstamp)类的新实例 |
| [TextStamp](textstamp#constructor_1)(string) | 初始化[`TextStamp`](../textstamp)类的新实例。 |
| [TextStamp](textstamp#constructor_2)(string, TextState) | 初始化[`TextStamp`](../textstamp)类的新实例。 |
...
| [TextState](../../aspose.pdf/textstamp/textstate) { get; } | 获取戳记的文本属性。有关详细信息，请参见[`TextState`](./textstate)。 |
...
| override [Put](../../aspose.pdf/textstamp/put)(Page) | 在页面上添加文字标记。 |
