...
description: "Aspose.Pdf.BoundsCheckableList1T 类。表示围绕 System.Collections.Generic.List 的 BoundsCheckableList 包装器"
type: docs
weight: 3040
...
| [Item](../../aspose.pdf/boundscheckablelist-1/item/) { get; set; } | 获取或设置集合中的段落。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [Add](../../aspose.pdf/boundscheckablelist-1/add/)(T) | 根据 \"boundsCheckMode\" 参数，将对象添加到 System.Collections.Generic.List 的末尾。 |
...
| [GetEnumerator](../../aspose.pdf/boundscheckablelist-1/getenumerator/)() | 返回遍历 System.Collections.Generic.List 的枚举器。 |
| [IndexOf](../../aspose.pdf/boundscheckablelist-1/indexof/)(T) | 搜索指定的对象并返回其在整个 System.Collections.Generic.List 中首次出现的零基索引。 |
| [Insert](../../aspose.pdf/boundscheckablelist-1/insert/)(int, T) | 在指定索引处将元素插入到 System.Collections.Generic.List 中。 |
| [Remove](../../aspose.pdf/boundscheckablelist-1/remove/)(T) | 从 System.Collections.Generic.List 中移除特定对象的首次出现。 |
