...
type: docs
weight: 10
url: /zh/net/aspose.pdf/boundsoutofrangeexception/boundsoutofrangeexception/
---
...
使用指定的错误消息，初始化 [`BoundsOutOfRangeException`](../) 类的新实例。
...
使用指定的错误消息和项目尺寸，初始化 [`BoundsOutOfRangeException`](../) 类的新实例。
