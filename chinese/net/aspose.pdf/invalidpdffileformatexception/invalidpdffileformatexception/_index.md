...
description: 初始化InvalidPdfFileFormatExceptionaspose.pdf/invalidpdffileformatexception类的新实例
type: docs
weight: 10
...
初始化[`InvalidPdfFileFormatException`](../../invalidpdffileformatexception)类的新实例。
...
使用指定的错误消息初始化[`InvalidPdfFileFormatException`](../../invalidpdffileformatexception) 类的新实例以及对导致此异常的内部异常的引用。
