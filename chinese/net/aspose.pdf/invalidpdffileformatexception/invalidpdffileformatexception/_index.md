...
description: "InvalidPdfFileFormatException 构造函数。初始化 InvalidPdfFileFormatException 类的新实例"
type: docs
weight: 10
...
初始化 [`InvalidPdfFileFormatException`](../) 类的新实例。
...
使用指定的错误消息和指向导致此异常的内部异常的引用，初始化 [`InvalidPdfFileFormatException`](../) 类的新实例。
...
使用指向导致此异常的内部异常的引用，初始化 [`InvalidPdfFileFormatException`](../) 类的新实例。
