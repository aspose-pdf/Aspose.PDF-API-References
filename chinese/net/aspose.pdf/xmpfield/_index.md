...
| [IsEmpty](../../aspose.pdf/xmpfield/isempty) { get; } | 获取一个指示此实例是否为空的值。 |
...
| [ToArray](../../aspose.pdf/xmpfield/toarray)() | 以数组的形式获取值。 |
| [ToStructure](../../aspose.pdf/xmpfield/tostructure)() | 以结构形式获取值。 |
