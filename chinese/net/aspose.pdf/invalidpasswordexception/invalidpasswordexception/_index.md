...
description: InvalidPasswordException 构造函数。初始化 InvalidPasswordException 类的新实例
type: docs
weight: 10
...
初始化 [`InvalidPasswordException`](../) 类的新实例。
...
使用指定的错误消息和对导致此异常的内部异常的引用初始化 [`InvalidPasswordException`](../) 类的新实例。
...
使用对导致此异常的内部异常的引用初始化 [`InvalidPasswordException`](../) 类的新实例。
