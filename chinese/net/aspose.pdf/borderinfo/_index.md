...
| [Left](../../aspose.pdf/borderinfo/left/) { get; set; } | 获取或设置指示边框左侧的对象。 |
| [Right](../../aspose.pdf/borderinfo/right/) { get; set; } | 获取或设置指示边框右侧的对象。 |
| [RoundedBorderRadius](../../aspose.pdf/borderinfo/roundedborderradius/) { get; set; } | 获取或设置圆角边框半径 |
| [Top](../../aspose.pdf/borderinfo/top/) { get; set; } | 获取或设置指示顶部边框的对象。 |
