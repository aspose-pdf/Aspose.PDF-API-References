...
description: "Aspose.Pdf.ImageStamp 类。表示图形印章。"
type: docs
weight: 6060
...
| override [Height](../../aspose.pdf/imagestamp/height/) { get; set; } | 获取或设置图像高度。设置此图像可垂直缩放图像。 |
...
| [Quality](../../aspose.pdf/imagestamp/quality/) { get; set; } | 获取或设置图像印章的质量（百分比）。有效值为 0..100%。 |
...
| override [Width](../../aspose.pdf/imagestamp/width/) { get; set; } | 获取或设置图像宽度。设置此属性可水平缩放图像。 |
| override [XIndent](../../aspose.pdf/imagestamp/xindent/) { get; set; } | 获取和设置水平印章坐标，起点为左侧。 |
| override [YIndent](../../aspose.pdf/imagestamp/yindent/) { get; set; } | 获取和设置垂直印章坐标，起点为底部。 |
