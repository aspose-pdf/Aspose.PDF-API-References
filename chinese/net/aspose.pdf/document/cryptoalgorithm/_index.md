...
description: 如果文档被加密则获取安全设置 如果文档未加密则在 .net 1.1 中将引发相应的异常否则对于其他 .net 版本CryptoAlgorithm 将为空
type: docs
weight: 70
...
如果文档被加密，则获取安全设置。 如果文档未加密，则在 .net 1.1 中将引发相应的异常，否则对于其他 .net 版本，CryptoAlgorithm 将为空。
