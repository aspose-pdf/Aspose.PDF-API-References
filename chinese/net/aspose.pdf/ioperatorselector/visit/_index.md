...
* 命名空间 [Aspose.Pdf](../../ioperatorselector)
* 部件 [Aspose.PDF](../../../)
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| G | SetGrayStroke | 设置灰度运算符（用于描边操作）。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| cs | SetColorSpace | 设置色彩空间运算符（用于非描边操作）。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| __ | SetSpacingMoveToNextLineShowText | 设置单词和字符间距，移动到下一行，并显示文本运算符。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| textOperator | TextOperator | 通用文本运算符，用于选择对应的pdf运算符集。 |
