...
description: Aspose.Pdf.Annotations.TrimMarkAnnotation 类。表示一个修剪标记注释
type: docs
weight: 2690
url: /zh/net/aspose.pdf.annotations/trimmarkannotation/
---
## TrimMarkAnnotation 类
...
| 名称 | 描述 |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | 初始化 `TrimMarkAnnotation` 类的新实例。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | 获取或设置标记在页面上的位置。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | 接受访问者以进行注释处理。 |
...
修剪标记放置在打印页面的角落，以指示页面应修剪的位置。

### 另请参阅

* 类 [CornerPrinterMarkAnnotation](../cornerprintermarkannotation/)
