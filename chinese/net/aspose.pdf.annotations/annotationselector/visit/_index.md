...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| trimMark | TrimMarkAnnotation | 用于选择的 [`TrimMarkAnnotation`](../../trimmarkannotation/) 对象。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| bleedMark | BleedMarkAnnotation | 用于选择的 [`BleedMarkAnnotation`](../../bleedmarkannotation/) 对象。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| registrationMark | RegistrationMarkAnnotation | 用于选择的 [`RegistrationMarkAnnotation`](../../registrationmarkannotation/) 对象。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pageInformation | PageInformationAnnotation | 用于选择的 [`PageInformationAnnotation`](../../pageinformationannotation/) 对象。 |
