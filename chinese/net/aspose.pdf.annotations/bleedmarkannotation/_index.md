...
description: Aspose.Pdf.Annotations.BleedMarkAnnotation 类。表示一个出血标记注释
type: docs
weight: 1500
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | 接受访问者进行注释处理。 |
...
出血标记放置在打印页面的角落，以指示页面将被修剪的位置以及允许偏离修剪标记的距离。
