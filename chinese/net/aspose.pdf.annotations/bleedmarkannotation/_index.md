...
description: "Aspose.Pdf.Annotations.BleedMarkAnnotation 类。表示出血标记注释"
type: docs
weight: 1590
url: /zh/net/aspose.pdf.annotations/bleedmarkannotation/
---
...
| 名称 | 描述 |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Page, PrinterMarkCornerPosition) | 初始化 `BleedMarkAnnotation` 类的新实例。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | 接受用于注释处理的访问者。 |
...
出血标记放置在打印页面的四角，用于指示页面的裁剪位置以及允许偏离裁剪线的距离。
