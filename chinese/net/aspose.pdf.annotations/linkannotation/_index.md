...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination) { get; set; } | 激活注解时显示的目的地。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
