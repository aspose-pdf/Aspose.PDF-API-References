...
description: Aspose.Pdf.Annotations.LinkAnnotation 类。表示文档中指向其他位置的超文本链接或要执行的操作
type: docs
weight: 2010
...
| 名称 | 描述 |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Page, Rectangle) | 在指定页面上创建新的链接注释。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | 激活链接注释时要执行的操作。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination/) { get; set; } | 激活注释时要显示的目标。 |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | 鼠标按钮在其活动区域内按下或保持时使用的视觉效果。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
