...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype) { get; } | 获取注释类型。 |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination) { get; set; } | 激活注释时显示的目的地。 |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting) { get; set; } | 在其活动区域内按下或按住鼠标按钮时使用的视觉效果。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
