...
description: 类描述了允许将视频/音频数据嵌入 PDF 文档的 RichMediaAnnotation
type: docs
weight: 1030
...
类描述了允许将视频/音频数据嵌入 PDF 文档的 RichMediaAnnotation。
...
| [AddCustomData](../../aspose.pdf.annotations/richmediaannotation/addcustomdata)(string, Stream) | 添加自定义命名数据（例如 Flash 脚本所需的）。 |
