---
title: "类 FileAttachmentAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.FileAttachmentAnnotation 类。该类描述文件附件注释。"
type: docs
weight: 1800
url: /zh/net/aspose.pdf.annotations/fileattachmentannotation/
---
...
| 名称 | 描述 |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | 在指定页面上创建新的文件附件注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | 此注释关联的文件规范。 |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | 获取或设置用于显示注释的图标。 |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | 获取或设置图标的不透明度，范围 0 到 1：0 - 完全透明，1 - 完全不透明。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
