...
| 姓名 | 描述 |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation)(Page, Rectangle, FileSpecification) | 在指定页面上创建新的 FileAttachment 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype) { get; } | 获取注释类型。 |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file) { get; set; } | 与此注释关联的文件的规范。 |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity) { get; set; } | 获取或设置图标的不透明度，从 0 到 1：0 - 完全透明，1 - 完全不透明。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
