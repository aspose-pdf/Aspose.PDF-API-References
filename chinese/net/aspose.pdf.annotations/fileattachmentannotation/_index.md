...
description: Aspose.Pdf.Annotations.FileAttachmentAnnotation 类。类描述文件附件注释
type: docs
weight: 1710
url: /zh/net/aspose.pdf.annotations/fileattachmentannotation/
---
## FileAttachmentAnnotation 类
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | 与此注释关联的文件规范。 |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | 获取或设置图标的不透明度，范围从 0 到 1：0 - 完全透明，1 - 完全不透明。 |
