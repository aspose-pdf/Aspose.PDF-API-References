...
description: 表示在文档文本中显示为锯齿状下划线的波浪状注释
type: docs
weight: 1150
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
