---
title: "类 SquigglyAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.SquigglyAnnotation 类。表示文档文本中出现的锯齿形下划线注释。"
type: docs
weight: 2700
url: /zh/net/aspose.pdf.annotations/squigglyannotation/
---
## SquigglyAnnotation class

表示在文档文本中出现锯齿形下划线的波浪注释。
...
| 名称 | 描述 |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | 在指定页面上创建新的 Squiggly 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
