...
description: Aspose.Pdf.Annotations.SquigglyAnnotation class. 表示在文档文本中作为锯齿状下划线出现的波浪注释
type: docs
weight: 2600
...
| Name | Description |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | 在指定页面上创建新的波浪注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | 获取注释类型。 |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | 获取或设置一个点数组，指定 n 个四边形的坐标。每个四边形包含注释下方文本中的一个单词或一组连续单词。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
