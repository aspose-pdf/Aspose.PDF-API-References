...
description: Aspose.Pdf.Annotations.PolylineAnnotation 类。表示与多边形相似的折线注释，除了第一个和最后一个顶点没有隐式连接
type: docs
weight: 2320
...
| 名称 | 描述 |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | 在指定页面上创建新的折线注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | 获取或设置第二条线段的结束样式。 |
...
| virtual [Hyperlink](../../aspose.pdf/baseparagraph/hyperlink/) { get; set; } | 获取或设置用于 PDF 生成的片段超链接。 |
| [InReplyTo](../../aspose.pdf.annotations/markupannotation/inreplyto/) { get; set; } | 指向此注释的“回复”注释的引用。两个注释必须在文档的同一页面上。 |
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | 获取或设置多边形或折线注释的意图。 |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | 获取或设置用于填充注释线段结束的内部颜色。 |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | 获取或设置第一条线段的结束样式。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polylineannotation/changeafterresize/)(Matrix) | 根据矩阵变换更新 Vertices 中的点。 |
