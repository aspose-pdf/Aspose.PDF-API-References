...
description: 表示折线注释类似于多边形只是第一个和最后一个顶点没有隐式连接
type: docs
weight: 930
...
表示折线注释，类似于多边形，只是第一个和最后一个顶点没有隐式连接。
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype) { get; } | 获取注释类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
