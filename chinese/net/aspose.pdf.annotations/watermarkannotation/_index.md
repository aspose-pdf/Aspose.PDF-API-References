...
| 姓名 | 描述 |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Watermark 注释类的构造函数。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype) { get; } | 获取注解类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | 申请访客注释。 |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext)(FormattedText) | 设置注释文本。 |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate)(string[], TextState) | 设置注释文本。 |
