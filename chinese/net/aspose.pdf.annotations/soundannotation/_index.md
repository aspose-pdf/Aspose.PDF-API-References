...
description: 表示声音注释其中包含从计算机的麦克风录制或从文件导入的声音
type: docs
weight: 1080
...
表示声音注释，其中包含从计算机的麦克风录制或从文件导入的声音。
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype) { get; } | 获取注释类型。 |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | 获取一个声音对象，定义激活注解时要播放的声音。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
