...
description: Aspose.Pdf.Annotations.SoundAnnotation 类。表示一个包含从计算机麦克风录制的声音或从文件导入的声音的声音注释
type: docs
weight: 2530
...
表示一个包含从计算机麦克风录制的声音或从文件导入的声音的声音注释。
...
| Name | Description |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 在指定页面上创建新的声音注释。 |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 在指定页面上创建新的声音注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | 获取一个声音对象，定义在激活注释时播放的声音。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
