...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | 获取定义激活注释时要播放的声音的声音对象。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
