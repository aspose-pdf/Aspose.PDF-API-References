---
title: "SoundAnnotation 类"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.SoundAnnotation 类。表示一种声音注释，其中包含从计算机麦克风录制的声音或从文件导入的声音。"
type: docs
weight: 2630
url: /zh/net/aspose.pdf.annotations/soundannotation/
---
...
| 名称 | 描述 |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 在指定的 Page 上创建新的 Sound 注释。 |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 在指定的 Page 上创建新的 Sound 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | 获取或设置用于显示注释的图标。 |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | 获取一个声音对象，定义在注释被激活时要播放的声音。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
