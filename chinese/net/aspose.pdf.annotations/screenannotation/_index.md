---
title: "类 ScreenAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.ScreenAnnotation 类。屏幕注释，指定页面上可播放媒体剪辑的区域"
type: docs
weight: 2610
...
| 名称 | 描述 |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | 在指定页面上创建新的 Screen 注释。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | 获取或设置在注释被激活时执行的操作。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | 获取或设置 screen 注释的标题。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
