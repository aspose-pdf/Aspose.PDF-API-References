...
description: Aspose.Pdf.Annotations.ScreenAnnotation 类。一个屏幕注释，指定可以播放媒体剪辑的页面区域
type: docs
weight: 2510
...
| 名称 | 描述 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | 获取或设置在激活注释时要执行的操作。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
