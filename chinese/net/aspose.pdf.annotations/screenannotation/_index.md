...
| 姓名 | 描述 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action) { get; } | 获取或设置激活注释时要执行的操作。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
