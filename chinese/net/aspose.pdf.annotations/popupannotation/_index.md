---
title: "类 PopupAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.PopupAnnotation 类。表示弹出注释，可在弹出窗口中显示文本以进行输入和编辑"
type: docs
weight: 2420
...
| 名称 | 描述 |
| --- | --- |
| [PopupAnnotation](popupannotation/#constructor)(Document) | 构造函数。用于在 Generator 中使用。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | 获取或设置一个标志，指定 pop-up 注释是否应初始显示为打开状态。 |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | 获取包含注释的页面索引。 |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | 获取或设置此 pop-up 注释应关联的父注释。如果存在此条目，父注释的 Contents、M、C 和 T 条目将覆盖该 pop-up 注释本身的对应条目。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
