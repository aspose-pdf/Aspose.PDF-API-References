---
title: "类 SquareAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.SquareAnnotation 类。表示方形批注的类"
type: docs
weight: 2690
...
| 名称 | 描述 |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | 用于 Generator 的构造函数。 |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | 在指定页面上创建新的方形批注。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
