...
| 姓名 | 描述 |
| --- | --- |
| [PolygonAnnotation](polygonannotation#constructor)(Document, Point[]) | 与 Generator. 一起使用的构造函数 |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype) { get; } | 获取注释类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept)(AnnotationSelector) | 接受访问者对象进行注释处理。 |
