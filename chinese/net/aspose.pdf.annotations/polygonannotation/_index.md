...
| 名称 | 描述 |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | 用于 Generator 的构造函数。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
