...
description: Aspose.Pdf.Annotations.CircleAnnotation 类。表示圆形注释的类
type: docs
weight: 1590
url: /zh/net/aspose.pdf.annotations/circleannotation/
---
...
| Name | Description |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | 圆形注释的构造函数。 |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | 在指定页面上创建新的圆形注释。 |
...
| virtual [ActiveState](../../aspose.pdf.annotations/annotation/activestate/) { get; set; } | 获取或设置当前注释的外观状态。 |
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | 描述两个矩形之间数值差异的矩形：注释的 Rect 条目和基础正方形或圆形的实际边界。 |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | 用于填充注释的矩形或椭圆的内部颜色。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
