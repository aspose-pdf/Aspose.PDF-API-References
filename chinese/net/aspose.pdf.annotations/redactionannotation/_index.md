---
title: "类 RedactionAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.RedactionAnnotation 类。表示 Redact 注释。"
type: docs
weight: 2490
...
| 名称 | 描述 |
| --- | --- |
| [RedactionAnnotation](redactionannotation/#constructor)(Document) | RedactionAnnotation 的构造函数。用于 Generator 中。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [BorderColor](../../aspose.pdf.annotations/redactionannotation/bordercolor/) { get; set; } | 获取或设置在未激活脱敏时绘制的边框颜色。 |
...
| [FillColor](../../aspose.pdf.annotations/redactionannotation/fillcolor/) { get; set; } | 获取或设置用于填充注释的颜色。 |
| [Flags](../../aspose.pdf.annotations/annotation/flags/) { get; set; } | Annotation 的标志。 |
| [FontSize](../../aspose.pdf.annotations/redactionannotation/fontsize/) { get; set; } | 获取或设置 OverlayText 的字体大小。 |
...
| [OverlayText](../../aspose.pdf.annotations/redactionannotation/overlaytext/) { get; set; } | 获取或设置在脱敏注释上打印的文本。 |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint/) { get; set; } | 一个 8xN 数组，指定要删除的内容区域的坐标。 |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect/) { get; set; } | 获取或设置注释矩形。 |
| [Repeat](../../aspose.pdf.annotations/redactionannotation/repeat/) { get; set; } | 如果为 true，覆盖文本将在注释上重复显示。 |
...
| [TextAlignment](../../aspose.pdf.annotations/redactionannotation/textalignment/) { get; set; } | 获取或设置 Overlay Text 的对齐方式。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | 将注释扁平化，即移除注释并添加其 |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | 将注释扁平化并脱敏页面内容（即移除脱敏注释下的文本和图像） |
