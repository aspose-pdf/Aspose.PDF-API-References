...
description: Aspose.Pdf.Annotations.RedactionAnnotation 类。表示红色注释
type: docs
weight: 2400
...
| Name | Description |
| --- | --- |
| [RedactionAnnotation](redactionannotation/#constructor)(Document) | RedactionAnnotation 的构造函数。用于生成器中。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [BorderColor](../../aspose.pdf.annotations/redactionannotation/bordercolor/) { get; set; } | 获取或设置在红色注释未激活时绘制的边框颜色。 |
...
| [FillColor](../../aspose.pdf.annotations/redactionannotation/fillcolor/) { get; set; } | 获取或设置填充注释的颜色。 |
...
| [OverlayText](../../aspose.pdf.annotations/redactionannotation/overlaytext/) { get; set; } | 获取或设置要在红色注释上打印的文本。 |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint/) { get; set; } | 一个 8xN 数字数组，指定要删除的内容区域的坐标。 |
| virtual [Rect](../../aspose.pdf.annotations/annotation/rect/) { get; set; } | 获取或设置注释矩形。 |
| [Repeat](../../aspose.pdf.annotations/redactionannotation/repeat/) { get; set; } | 如果为 true，覆盖文本将在注释上重复。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | 扁平化注释，即移除注释并添加其 |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | 扁平化注释并删除页面内容（即移除红色注释下的文本和图像） |
