...
description: Aspose.Pdf.Annotations.InkAnnotation 类。表示由一个或多个不相连的路径组成的手写涂鸦
type: docs
weight: 1920
...
| 名称 | 描述 |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Ink 注释的构造函数，用于生成器。 |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Ink 注释线条末端的样式。 |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | 获取或设置独立线条的手势列表，这些线条由 Point[] 数组表示。 |
| [InReplyTo](../../aspose.pdf.annotations/markupannotation/inreplyto/) { get; set; } | 对此注释“回复”的注释的引用。两个注释必须位于文档的同一页面上。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
