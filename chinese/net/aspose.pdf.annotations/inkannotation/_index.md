...
description: "Aspose.Pdf.Annotations.InkAnnotation 类。表示由一个或多个不相连路径组成的手绘涂鸦。"
type: docs
weight: 2010
...
| 名称 | 描述 |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Generator 的 Ink 注释构造函数。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Ink 注释线端点的样式。 |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | 获取或设置由 Point[] 数组表示的独立线段手势列表。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
