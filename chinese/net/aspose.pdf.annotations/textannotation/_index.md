...
description: Aspose.Pdf.Annotations.TextAnnotation 类。表示附加在 PDF 文档某一点的文本注释，即便签。
type: docs
weight: 2650
...
| 名称 | 描述 |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | 用于生成器时的注释构造函数。 |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | 获取或设置一个标志，指定注释是否应最初显示为打开。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | 用空主体覆盖基类中的定义。 |
