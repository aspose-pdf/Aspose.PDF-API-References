...
description: 表示文本注释它是附加到 PDF 文档中某个点的便签
type: docs
weight: 1200
...
| 姓名 | 描述 |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | 在生成器中使用时用于注解的构造函数。 |
| [TextAnnotation](textannotation#constructor_1)(Page, Rectangle) | 在指定页面上创建新的文本注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype) { get; } | 获取注释类型。 |
...
| [Open](../../aspose.pdf.annotations/textannotation/open) { get; set; } | 获取或设置一个标志，指定注释最初是否应打开显示。 |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | 获取或设置原始注释应设置的状态。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | 根据矩阵变换更新起点和终点。 |
