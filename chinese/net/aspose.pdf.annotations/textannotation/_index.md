---
title: "类 TextAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.TextAnnotation 类。表示附加在 PDF 文档中某一点的便签式文本注释。"
type: docs
weight: 2750
url: /zh/net/aspose.pdf.annotations/textannotation/
---
## TextAnnotation class

表示附着在 PDF 文档中某点的“便签”文本注释。
...
| 名称 | 描述 |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | 在 Generator 中使用时的注释构造函数。 |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | 在指定页面上创建新的 Text 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | 获取或设置用于显示注释的图标。 |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | 获取或设置指定注释是否应初始展开的标志。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | 使用空实现覆盖基类中的定义。 |
