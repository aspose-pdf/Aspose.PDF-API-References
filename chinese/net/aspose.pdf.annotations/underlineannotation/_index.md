---
title: "类 UnderlineAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.UnderlineAnnotation 类。表示文档文本中显示为下划线的下划线批注。"
type: docs
weight: 2800
...
| 名称 | 描述 |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | 在指定页面上创建新的下划线批注。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
