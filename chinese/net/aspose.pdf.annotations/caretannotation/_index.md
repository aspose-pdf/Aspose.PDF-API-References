...
| 名称 | 描述 |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | 用于生成器的构造函数。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | 获取或设置光标矩形。 |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | 获取或设置与光标相关的符号。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
