---
title: "类 CaretAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.CaretAnnotation 类。表示 Caret 注释的类"
type: docs
weight: 1650
url: /zh/net/aspose.pdf.annotations/caretannotation/
---
...
| 名称 | 描述 |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Generator 中使用的构造函数。 |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | 在指定页面上创建新的 Caret 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | 获取或设置 caret 矩形。 |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | 获取或设置与 caret 关联的符号。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
