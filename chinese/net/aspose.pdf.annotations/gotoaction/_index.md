...
description: 表示将视图更改为指定目标页面位置和放大系数的首选操作
type: docs
weight: 450
...
| [GoToAction](gotoaction#constructor_2)(Document, string) | 与命名目的地相关联的动作。 |
...
| 姓名 | 描述 |
| --- | --- |
| virtual [Destination](../../aspose.pdf.annotations/gotoaction/destination) { get; set; } | 获取或设置要跳转到的目的地。 |
