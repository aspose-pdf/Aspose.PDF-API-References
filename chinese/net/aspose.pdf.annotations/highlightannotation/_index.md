...
description: 表示突出显示文档中的文本范围的高亮注释
type: docs
weight: 490
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | 获取注释类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
