...
description: 表示突出显示文档中的文本范围的突出显示注释
type: docs
weight: 490
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注释。 |
