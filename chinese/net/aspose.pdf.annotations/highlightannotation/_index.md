...
description: Aspose.Pdf.Annotations.HighlightAnnotation class. 表示一个高亮注释，用于突出文档中的一段文本
type: docs
weight: 1870
...
| Name | Description |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | 在指定页面上创建新的高亮注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
