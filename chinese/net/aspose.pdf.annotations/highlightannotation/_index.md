---
title: "类 HighlightAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.HighlightAnnotation 类。表示在文档中突出显示一段文本的高亮注释"
type: docs
weight: 1960
url: /zh/net/aspose.pdf.annotations/highlightannotation/
---
## HighlightAnnotation class

表示高亮注释，用于突出显示文档中的一段文本。
...
| 名称 | 描述 |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | 在指定页面上创建新的 Highlight 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | 获取或设置一个点数组，用于指定 n 个四边形的坐标。每个四边形包含注释下方文本中的一个单词或一组连续的单词。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
...
| [GetMarkedText](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtext/)() | 以字符串形式获取标记注释下的文本。 |
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | 以 [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/) 形式获取标记注释下的文本。 |
