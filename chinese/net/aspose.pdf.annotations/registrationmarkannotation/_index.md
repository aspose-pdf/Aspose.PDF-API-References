...
description: Aspose.Pdf.Annotations.RegistrationMarkAnnotation 类。表示一个注册标记注释
type: docs
weight: 2410
url: /zh/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation 类
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | 获取或设置注册标记在页面上的位置。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | 接受访问者进行注释处理。 |
...
注册标记是添加到印刷版或屏幕上的符号，以确保在印刷过程中颜色的正确对齐。

### 另请参见

* 类 [PrinterMarkAnnotation](../printermarkannotation/)
