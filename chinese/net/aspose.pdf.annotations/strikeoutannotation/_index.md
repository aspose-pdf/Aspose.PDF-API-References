...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype) { get; } | 获取注释类型。 |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints) { get; set; } | 获取或设置指定 n 个四边形坐标的点数组。每个四边形包含注释下的文本中的一个单词或一组连续单词。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept)(AnnotationSelector) | 接受访问者对象来处理注解。 |
