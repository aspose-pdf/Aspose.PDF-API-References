---
title: "类 StrikeOutAnnotation"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation 类。表示文档文本中出现的删除线注释"
type: docs
weight: 2730
url: /zh/net/aspose.pdf.annotations/strikeoutannotation/
---
...
| 名称 | 描述 |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | 在指定页面上创建新的 StrikeOut 注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | 获取 Annotation 的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理该注释。 |
