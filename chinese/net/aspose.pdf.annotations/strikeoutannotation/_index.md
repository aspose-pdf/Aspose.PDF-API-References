...
description: Aspose.Pdf.Annotations.StrikeOutAnnotation 类。表示在文档文本中以删除线形式出现的删除线注释
type: docs
weight: 2630
url: /zh/net/aspose.pdf.annotations/strikeoutannotation/
---
## StrikeOutAnnotation 类

表示在文档文本中以删除线形式出现的删除线注释。
...
| 名称 | 描述 |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | 在指定页面上创建新的删除线注释。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | 获取注释的类型。 |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | 获取或设置一个点数组，指定 n 个四边形的坐标。每个四边形包含注释底层文本中的一个单词或一组连续的单词。 |
...
| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | 接受访问者对象以处理注释。 |
