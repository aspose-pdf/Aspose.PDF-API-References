...
description: "Aspose.Pdf.Operators.DP 类。表示 DP 操作符，指定标记内容点的类"
type: docs
weight: 7410
...
| [Tag](../../aspose.pdf.operators/dp/tag/) { get; set; } | 获取或设置标记内容标签 |

## 方法

| 名称 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/dp/accept/)(IOperatorSelector) | 接受访问者对象以处理操作符。 |
