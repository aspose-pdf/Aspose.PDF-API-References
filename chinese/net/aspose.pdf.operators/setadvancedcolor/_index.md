...
description: 表示 scn 运算符的类为非笔划操作设置颜色
type: docs
weight: 5320
...
| 姓名 | 描述 |
| --- | --- |
| [SetAdvancedColor](setadvancedcolor#constructor)() | 初始化运算符。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.pdf.operators/setadvancedcolor/accept)(IOperatorSelector) | 接受访问者对象来处理操作员。 |
| override [getColor](../../aspose.pdf.operators/setadvancedcolor/getcolor)() | 返回运算符指定的颜色。 |
