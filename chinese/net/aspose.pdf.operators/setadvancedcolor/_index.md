---
title: "类 SetAdvancedColor"
second_title: "Aspose.PDF for .NET API 参考"
description: "Aspose.Pdf.Operators.SetAdvancedColor 类。类表示 scn 运算符设置非描边操作的颜色"
type: docs
weight: 7700
...
| [SetAdvancedColor](setadvancedcolor/#constructor_1)(double) | scn 运算符的构造函数。 |
| [SetAdvancedColor](setadvancedcolor/#constructor_6)(string) | scn 运算符的构造函数。 |
| [SetAdvancedColor](setadvancedcolor/#constructor_4)(double, string) | scn 运算符的构造函数。 |
| [SetAdvancedColor](setadvancedcolor/#constructor_5)(double[], string) | scn 运算符的构造函数。 |
| [SetAdvancedColor](setadvancedcolor/#constructor_3)(double, double, double, string) | scn 运算符的构造函数。 |
| [SetAdvancedColor](setadvancedcolor/#constructor_2)(double, double, double, double, string) | scn 运算符的构造函数。 |
