...
description: "表示符合 Internet RFC 2315 中 PKCS#7 规范的 PKCS#7 对象，<br/>            PKCS #7：密码消息语法，版本 1.5。<br/>            文档字节范围的 SHA1 摘要被封装在 PKCS#7 SignedData 字段中。"
type: docs
weight: 190
url: /zh/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

表示符合 Internet RFC 2315 中 PKCS#7 规范的 PKCS#7 对象，<br/>            PKCS #7：密码消息语法，版本 1.5。<br/>            文档字节范围的 SHA1 摘要被封装在 PKCS#7 SignedData 字段中。

PKCS7 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| PKCS7() | 初始化 [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) 类的新实例。 |
| PKCS7(pfx, password) | 初始化 PKCS7 类的新实例 |
| PKCS7(pfx, password) | 初始化 PKCS7 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
