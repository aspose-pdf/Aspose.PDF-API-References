...
description: "表示 ListBox 字段的类。"
type: docs
weight: 140
url: /zh/python-net/aspose.pdf.forms/listboxfield/
---
...
ListBoxField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| ListBoxField() | 用于 Generator 的 ListBoxField 构造函数。 |
| ListBoxField(page, rect) | 初始化 ListBoxField 类的新实例 |
| ListBoxField(doc, rect) | 初始化 ListBoxField 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| selected | 获取或设置所选项的索引。项目从 1 开始编号。 |
| selected_items | 获取或设置多选列表中所选项的数组。对于单选列表，返回仅包含一个项目的数组。 |
| options | 获取选项集合。 |
| top_index | 获取或设置列表中顶部可见元素的索引。 |
## Indexer
| 名称 | 描述 |
| :- | :- |
