...
description: "描述富文本编辑器组件的类。"
type: docs
weight: 240
url: /zh/python-net/aspose.pdf.forms/richtextboxfield/
---
...
RichTextBoxField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| RichTextBoxField(page, rect) | 初始化 RichTextBoxField 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| style | 获取或设置富文本字段的默认样式字符串。 |
| rich_text_value | 获取或设置富文本值。 |
| formatted_value | 获取或设置带标记的格式化富文本值。 |
| justify | 获取或设置富文本框的对齐方式。 |
## Indexer
| 名称 | 描述 |
| :- | :- |
