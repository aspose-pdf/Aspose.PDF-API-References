...
description: "使用 X509Certificate2 创建分离的 PKCS#7Detached 签名。它支持 USB 智能卡、不可导出私钥的令牌。"
type: docs
weight: 80
url: /zh/python-net/aspose.pdf.forms/externalsignature/
---

## ExternalSignature class

使用 X509Certificate2 创建分离的 PKCS#7Detached 签名。它支持 USB 智能卡、不可导出私钥的令牌。

ExternalSignature 类型公开以下成员：
## 属性
| 名称 | 描述 |
| :- | :- |
