...
description: "带日历视图的日期字段。"
type: docs
weight: 60
url: /zh/python-net/aspose.pdf.forms/datefield/
---
...
| 名称 | 描述 |
| :- | :- |
| DateField() | 初始化一个新的 [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) 实例 |
| DateField(doc) | 初始化 DateField 类的新实例 |
| DateField(page, rect) | 初始化 DateField 类的新实例 |
| DateField(doc, rect) | 初始化 DateField 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
