...
description: "表示 RadioButton 字段项的类。"
type: docs
weight: 230
url: /zh/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---
...
RadioButtonOptionField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| RadioButtonOptionField() | 创建新的 RadioButtonOptionField 实例。 |
| RadioButtonOptionField(page, rect) | 初始化 RadioButtonOptionField 类的新实例。 |
## 属性
| 名称 | 描述 |
| :- | :- |
