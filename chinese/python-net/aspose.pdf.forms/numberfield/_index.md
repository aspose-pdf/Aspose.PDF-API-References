...
description: "带有指定有效字符的文本字段"
type: docs
weight: 150
url: /zh/python-net/aspose.pdf.forms/numberfield/
---
...
NumberField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| NumberField() | 初始化一个新的 [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/) 类实例。 |
| NumberField(page, rect) | 初始化 NumberField 类的新实例。 |
| NumberField(doc, rect) | 初始化 NumberField 类的新实例。 |
## 属性
| 名称 | 描述 |
| :- | :- |
