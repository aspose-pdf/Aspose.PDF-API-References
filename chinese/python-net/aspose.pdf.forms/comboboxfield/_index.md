...
description: "表示表单中组合框字段的类。"
type: docs
weight: 50
url: /zh/python-net/aspose.pdf.forms/comboboxfield/
---
...
ComboBoxField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| ComboBoxField() | 用于 Generator 的 ComboBoxField 构造函数。 |
| ComboBoxField(doc) | 初始化 ComboBoxField 类的新实例 |
| ComboBoxField(page, rect) | 初始化 ComboBoxField 类的新实例 |
| ComboBoxField(doc, rect) | 初始化 ComboBoxField 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| selected | 获取或设置所选选项的索引。此属性允许更改选择。 |
| selected_items | 获取或设置所选项目的数组。对于多选列表，数组包含多个项目。对于单选列表，数组仅包含一个项目。 |
| options | 获取选项集合。 |
| editable | 获取或设置字段的可编辑状态。 |
| spell_check | 获取或设置拼写检查活动状态。 |
## Indexer
| 名称 | 描述 |
| :- | :- |
...
| 名称 | 描述 |
| :- | :- |
| add_option(option_name) | 添加具有指定名称的新选项。 |
| add_option(export, name) | 添加具有指定名称的新选项。 |
| clone() | None |
