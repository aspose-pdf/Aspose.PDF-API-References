...
type: docs
weight: 270
url: /zh/python-net/aspose.pdf.forms/signaturefield/
---
...
SignatureField 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| SignatureField(page, rect) | 初始化 SignatureField 类的新实例。 |
| SignatureField(doc, rect) | 初始化 SignatureField 类的新实例。 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| signature | 获取签名对象。<br/>此对象包含有关公钥密码学标准的签名数据。<br/>类 [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/)、[PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) 和 [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) <br/>表示所有受支持的签名对象类型。 |
## Indexer
| 名称 | 描述 |
| :- | :- |
...
| 名称 | 描述 |
| :- | :- |
| sign(signature, pfx, pass) | 使用此签名字段对文档进行签名。 |
| sign(signature) | 使用此签名字段对文档进行签名。 |
| extract_image() | 提取签名的图像为 JPEG 编码流。 |
| extract_image(format) | 提取签名的图像为编码流。 |
| clone() | None |
...
| extract_certificate() | 提取单个 X.509 证书（DER 格式）作为流。 |
