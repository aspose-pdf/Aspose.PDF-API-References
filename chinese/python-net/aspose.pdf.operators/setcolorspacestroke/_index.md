...
description: "表示 CS 操作符的类（为描边操作设置颜色）。"
type: docs
weight: 560
url: /zh/python-net/aspose.pdf.operators/setcolorspacestroke/
---

## SetColorSpaceStroke class

表示 CS 操作符的类（为描边操作设置颜色）。

SetColorSpaceStroke 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| SetColorSpaceStroke(name) | 初始化 SetColorSpaceStroke 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
