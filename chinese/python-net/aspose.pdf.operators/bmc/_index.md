...
description: "表示 BMC 操作符的类（Begin marked-content sequence）。"
type: docs
weight: 30
url: /zh/python-net/aspose.pdf.operators/bmc/
---

## BMC class

表示 BMC 操作符的类（Begin marked-content sequence）。

BMC 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| BMC(tag) | 初始化 BMC 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
