...
description: "表示高亮注释，用于突出显示文档中的一段文本。"
type: docs
weight: 310
url: /zh/python-net/aspose.pdf.annotations/highlightannotation/
---
...
HighlightAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| HighlightAnnotation(page, rect) | 初始化 HighlightAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
