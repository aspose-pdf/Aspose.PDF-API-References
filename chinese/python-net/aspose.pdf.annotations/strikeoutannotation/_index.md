...
description: "表示在文档文本中出现删除线的划线注释。"
type: docs
weight: 800
url: /zh/python-net/aspose.pdf.annotations/strikeoutannotation/
---
...
StrikeOutAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| StrikeOutAnnotation(page, rect) | 初始化 StrikeOutAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
