...
type: docs
weight: 770
url: /zh/python-net/aspose.pdf.annotations/squareannotation/
---
...
SquareAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| SquareAnnotation(document) | 初始化 SquareAnnotation 类的新实例 |
| SquareAnnotation(page, rect) | 初始化 SquareAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| interior_color | 用于填充注释矩形或椭圆的内部颜色。 |
| frame | 描述两个矩形之间数值差异的矩形：<br/>            注释的 Rect 条目以及底层正方形或圆形的实际边界。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| clone() | None |
| get_rectangle(consider_rotation) | None |
| accept(visitor) | 接受访问者以处理注释。 |
| flatten() | None |
