...
description: "表示指向文档其他位置的超链接或要执行的操作。"
type: docs
weight: 390
url: /zh/python-net/aspose.pdf.annotations/linkannotation/
---

## LinkAnnotation class

表示指向文档其他位置的超链接或要执行的操作。

LinkAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| LinkAnnotation(page, rect) | 初始化 LinkAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| 外观 | 获取该注释的外观字典。 |
| 页面索引 | 获取包含注释的页面索引。 |
| action | 链接注释激活时要执行的操作。 |
| destination | 注释激活时要显示的目标。 |
| 高亮 | 在其活动区域内按下或保持鼠标按钮时使用的视觉效果。 |
## 方法
| 名称 | 描述 |
| :- | :- |
