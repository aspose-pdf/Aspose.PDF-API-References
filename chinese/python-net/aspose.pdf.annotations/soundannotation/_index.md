...
type: docs
weight: 740
url: /zh/python-net/aspose.pdf.annotations/soundannotation/
---
...
SoundAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | 初始化 SoundAnnotation 类的新实例 |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | 初始化 SoundAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| icon | 获取或设置用于显示注释的图标。 |
| sound_data | 获取一个声音对象，定义在激活注释时播放的声音。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| clone() | None |
