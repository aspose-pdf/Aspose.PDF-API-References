...
description: "指定页面上可播放媒体剪辑区域的屏幕注释。"
type: docs
weight: 720
url: /zh/python-net/aspose.pdf.annotations/screenannotation/
---
...
ScreenAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | 初始化 ScreenAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
