...
description: "表示在文档文本中显示为锯齿形下划线的波浪注释。"
type: docs
weight: 780
url: /zh/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

表示在文档文本中显示为锯齿形下划线的波浪注释。

SquigglyAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| SquigglyAnnotation(page, rect) | 初始化 SquigglyAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
