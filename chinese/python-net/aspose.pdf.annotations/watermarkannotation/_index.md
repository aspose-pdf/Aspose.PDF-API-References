...
description: "描述 Watermark 注释对象的类。"
type: docs
weight: 860
url: /zh/python-net/aspose.pdf.annotations/watermarkannotation/
---
...
WatermarkAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| WatermarkAnnotation(page, rect) | 初始化 WatermarkAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
