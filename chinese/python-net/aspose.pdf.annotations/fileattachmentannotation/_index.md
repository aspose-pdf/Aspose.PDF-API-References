...
type: docs
weight: 170
url: /zh/python-net/aspose.pdf.annotations/fileattachmentannotation/
---
...
FileAttachmentAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | 初始化 FileAttachmentAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| opacity | 获取或设置图标的不透明度，范围从 0 到 1：0 - 完全透明，1 - 完全不透明。 |
