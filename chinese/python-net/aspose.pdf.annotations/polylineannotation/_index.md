...
description: "表示折线注释，其类似于多边形，但首尾顶点未隐式连接。"
type: docs
weight: 660
url: /zh/python-net/aspose.pdf.annotations/polylineannotation/
---

## PolylineAnnotation class

表示折线注释，其类似于多边形，但首尾顶点未隐式连接。

PolylineAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| PolylineAnnotation(page, rect, vertices) | 初始化 PolylineAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| measure | 此注释指定的测量单位。 |
| vertices | 获取或设置一个点数组，表示每个顶点的水平和垂直坐标。 |
| interior_color | 获取或设置用于填充注释线端点的内部颜色。 |
| starting_style | 获取或设置第一条线端点的样式。 |
| ending_style | 获取或设置第二条线端点的样式。 |
| intent | 获取或设置多边形或折线注释的意图。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| clone() | None |
...
| flatten() | None |
| change_after_resize(transform) | 根据矩阵变换更新 Vertices 中的点。 |
