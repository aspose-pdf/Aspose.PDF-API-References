...
description: "表示由一个或多个不相连路径组成的手绘“涂鸦”。"
type: docs
weight: 350
url: /zh/python-net/aspose.pdf.annotations/inkannotation/
---
...
InkAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| InkAnnotation(document, ink_list) | 初始化 InkAnnotation 类的新实例 |
| InkAnnotation(page, rect, ink_list) | 初始化 InkAnnotation 类的新实例 |
| InkAnnotation(page, rect, ink_list) | 初始化 InkAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| cap_style | 墨注释线端的样式。 |
| ink_list | 获取或设置由 Point[] 数组表示的独立线手势列表。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| clone() | None |
...
| change_after_resize(transform) | 根据矩阵变换更新 InkList 中的点。 |
