...
type: docs
weight: 80
url: /zh/python-net/aspose.pdf.annotations/caretannotation/
---
...
CaretAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| CaretAnnotation(document) | 初始化 CaretAnnotation 类的新实例 |
| CaretAnnotation(page, rect) | 初始化 CaretAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
