...
description: "表示 widget 注释的类。"
type: docs
weight: 870
url: /zh/python-net/aspose.pdf.annotations/widgetannotation/
---
...
WidgetAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| WidgetAnnotation(doc) | 初始化 WidgetAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
