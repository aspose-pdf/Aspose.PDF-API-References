...
description: "表示橡皮图章注释。 <br/>             此类注释显示旨在看起来像用橡皮图章盖在页面上的文本或图形。"
type: docs
weight: 790
url: /zh/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

表示橡皮图章注释。 <br/>             此类注释显示旨在看起来像用橡皮图章盖在页面上的文本或图形。

StampAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| StampAnnotation(document) | 初始化 StampAnnotation 类的新实例 |
| StampAnnotation(page, rect) | 初始化 StampAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| accept(visitor) | 在浏览注释集合时接受 [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) 访问者。 |
