...
description: "类 PDF3DAnnotation。此类不可被继承。"
type: docs
weight: 510
url: /zh/python-net/aspose.pdf.annotations/pdf3dannotation/
---
...
PDF3DAnnotation 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| PDF3DAnnotation(page, rect, pdf_3d_artwork) | 初始化 PDF3DAnnotation 类的新实例 |
| PDF3DAnnotation(page, rect, pdf_3d_artwork, activation) | 初始化 PDF3DAnnotation 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| 外观 | 获取该注释的外观字典。 |
| 页面索引 | 获取包含注释的页面索引。 |
| pdf_3d_artwork | 获取 3D 艺术作品。 |
| lighting_scheme | 获取照明方案。 |
| content | 获取或设置内容。 |
| render_mode | 获取渲染模式。 |
| view_array | 获取视图数组。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| set_image_preview(filename) | 设置图像预览。 |
| set_image_preview(image) | 设置图像预览。 |
...
| set_default_view_index(index) | 设置默认视图的索引。 |
| clear_image_preview() | 清除图像预览。 |
| get_image_preview() | 获取图像预览。 |
