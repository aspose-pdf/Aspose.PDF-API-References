...
description: "表示表格逻辑结构中的 TH 结构元素。"
type: docs
weight: 660
url: /zh/python-net/aspose.pdf.logicalstructure/tablethelement/
---
...
| expansion_text | None |
| actual_text | None |
| background_color | 获取或设置单元格的背景颜色。 |
| 边框 | 获取或设置单元格的边框。 |
| is_no_border | 获取或设置单元格是否有边框。 |
| margin | 获取或设置填充。 |
| 对齐 | 获取或设置单元格对齐方式。 |
| default_cell_text_state | 获取或设置默认单元格文本状态。 |
| is_word_wrapped | 获取或设置单元格文本的自动换行。 |
| vertical_alignment | 获取或设置垂直对齐方式。 |
| col_span | 获取或设置列跨度。 |
| row_span | 获取或设置行跨度。 |
