...
type: docs
weight: 320
url: /zh/python-net/aspose.pdf/epubsaveoptions/
---
...
EpubSaveOptions 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| EpubSaveOptions() | 初始化 EpubSaveOptions 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| content_recognition_mode | 当 PDF 文件（通常具有固定布局）被转换时，<br/>            转换引擎尝试执行分组和多层分析以恢复<br/>            原始文档作者的意图，并生成流式布局的结果。<br/>               此属性可针对不同的<br/>            内容识别的理想方法进行调节。 |
