...
description: "类描述背景 artifact。此 artifact 允许设置页面的背景。"
type: docs
weight: 50
url: /zh/python-net/aspose.pdf/backgroundartifact/
---
...
| background_color | 获取或设置背景工件的背景颜色 |
| background_image | 获取或设置背景工件的背景图像 |
## 方法
| 名称 | 描述 |
| :- | :- |
