...
type: docs
weight: 690
url: /zh/python-net/aspose.pdf/imagestamp/
---
...
| 名称 | 描述 |
| :- | :- |
| ImageStamp(image) | 初始化 ImageStamp 类的新实例 |
| ImageStamp(file_name) | 初始化 ImageStamp 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| width | 获取或设置图像宽度。设置此属性可水平缩放图像。 |
| 高度 | 获取或设置图像高度。设置此属性可垂直缩放图像。 |
...
| image | 获取用于盖章的图像流。 |
| quality | 获取或设置图像盖章的质量（百分比）。有效值为 0..100%。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| put(page) | 在页面上添加图形盖章。 |
