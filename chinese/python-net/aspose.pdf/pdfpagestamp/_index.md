...
description: "类表示使用 PDF 页面作为印章的印章。"
type: docs
weight: 1230
url: /zh/python-net/aspose.pdf/pdfpagestamp/
---
...
PdfPageStamp 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| PdfPageStamp(pdf_page) | 初始化 PdfPageStamp 类的新实例 |
| PdfPageStamp(file_name, page_index) | 初始化 PdfPageStamp 类的新实例 |
| PdfPageStamp(stream, page_index) | 初始化 PdfPageStamp 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
