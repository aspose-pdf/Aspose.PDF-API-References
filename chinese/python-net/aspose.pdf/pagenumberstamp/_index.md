...
description: "表示页码印章，用于给页面编号。"
type: docs
weight: 1140
url: /zh/python-net/aspose.pdf/pagenumberstamp/
---
...
PageNumberStamp 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| PageNumberStamp(format) | 初始化 PageNumberStamp 类的新实例 |
| PageNumberStamp() | 初始化 [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/) 类的新实例。格式设置为 "#"。 |
| PageNumberStamp(formatted_text) | 初始化 PageNumberStamp 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
...
| format | 用于标记页码的字符串值。<br/>            值必须包含字符 '#'，该字符在标记过程中会被页码替换。 |
| starting_number | 获取或设置起始页的页码值。其他页将从该值开始编号。 |
| numbering_style | 此印章使用的编号样式。 |
## 方法
| 名称 | 描述 |
| :- | :- |
| put(page) | 添加页码。 |
