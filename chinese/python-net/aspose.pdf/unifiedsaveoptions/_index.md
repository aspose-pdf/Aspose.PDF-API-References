...
description: "此类表示用于保存的保存选项，<br/>            使用统一的转换方式（具有统一的内部文档模型）"
type: docs
weight: 1590
url: /zh/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

此类表示用于保存的保存选项，<br/>            使用统一的转换方式（具有统一的内部文档模型）

UnifiedSaveOptions 类型公开以下成员：
## 构造函数
| 名称 | 描述 |
| :- | :- |
| UnifiedSaveOptions() | 初始化 UnifiedSaveOptions 类的新实例 |
## 属性
| 名称 | 描述 |
| :- | :- |
