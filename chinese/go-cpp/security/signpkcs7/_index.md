...
description: "使用 PKCS#7 数字签名对 PDF-document 进行签名。"
type: docs
url: /zh/go-cpp/security/signpkcs7/
---

_使用 PKCS#7 数字签名对 PDF-document 进行签名._
...
func main() {
	...
	// SignPKCS7 使用 PKCS#7 数字签名对 PDF-document 进行签名
