...
description: "使用 PKCS#7 分离数字签名对 PDF-document 进行签名。"
type: docs
url: /zh/go-cpp/security/signpkcs7detached/
---

_使用 PKCS#7 Detached 数字签名对 PDF-document 进行签名._
...
func main() {
	...
	// SignPKCS7Detached 使用 PKCS#7 Detached 数字签名对 PDF-document 进行签名
