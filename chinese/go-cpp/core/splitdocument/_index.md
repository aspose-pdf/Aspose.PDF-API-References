...
description: "通过从源 PDF 文档中提取页面创建多个新的 PDF 文档。"
type: docs
url: /zh/go-cpp/core/splitdocument/
---

_通过从源 PDF 文档中提取页面来创建多个新的 PDF 文档。_
...
func main() {
	...
	// SplitDocument(document *Document, pagerange string) 创建多个新的 PDF 文档
