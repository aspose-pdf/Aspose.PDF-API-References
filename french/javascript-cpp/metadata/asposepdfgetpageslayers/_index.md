...
description: "Obtenir la liste des calques d'un fichier PDF."
type: docs
url: /fr/javascript-cpp/metadata/asposepdfgetpageslayers/
---

_Obtenir la liste des calques d'un fichier PDF._
