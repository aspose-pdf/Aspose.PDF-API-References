...
description: "Obtenir les informations (métadonnées) d'un fichier PDF."
type: docs
url: /fr/javascript-cpp/metadata/asposepdfgetinfo/
---

_Obtenir les informations (métadonnées) d'un fichier PDF._
