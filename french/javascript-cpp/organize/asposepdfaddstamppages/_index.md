...
description: "Ajouter un tampon aux pages spécifiques d'un fichier PDF."
type: docs
url: /fr/javascript-cpp/organize/asposepdfaddstamppages/
---

_Ajouter un tampon aux pages spécifiques d'un fichier PDF._
