...
description: "Remplacer le texte sur les pages d'un fichier PDF."
type: docs
url: /fr/javascript-cpp/organize/asposepdfreplacetextpages/
---

_Remplacer le texte sur les pages d'un fichier PDF._
