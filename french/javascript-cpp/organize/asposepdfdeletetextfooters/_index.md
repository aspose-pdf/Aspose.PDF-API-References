...
description: "Supprimer les pieds de page de texte d'un fichier PDF."
type: docs
url: /fr/javascript-cpp/organize/asposepdfdeletetextfooters/
---

_Supprimer les pieds de texte d'un fichier PDF._
