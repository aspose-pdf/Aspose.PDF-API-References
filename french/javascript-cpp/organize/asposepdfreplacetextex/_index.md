...
description: "Remplacer plusieurs fragments de texte dans un fichier PDF avec contrôle d'alignement."
type: docs
url: /fr/javascript-cpp/organize/asposepdfreplacetextex/
---

_Remplacer plusieurs fragments de texte dans un fichier PDF avec contrôle d'alignement._
...
La direction peut également être imposée explicitement en préfixant `replaceText`
avec des caractères Unicode spéciaux:
`\u200F` (RTL) ou `\u200E` (LTR), de préférence comme premier caractère
