...
type: docs
weight: 270
url: /fr/python-net/aspose.pdf.forms/signaturefield/
---
...
Le type SignatureField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| SignatureField(page, rect) | Initialise une nouvelle instance de la classe SignatureField |
| SignatureField(doc, rect) | Initialise une nouvelle instance de la classe SignatureField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| signature | Obtient l’objet de signature.<br/>            Cet objet contient des données de signature concernant les normes cryptographiques à clé publique.<br/>            Les classes [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/), [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) et [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) <br/>            représentent tous les types d’objets de signature pris en charge. |
## Indexer
| Nom | Description |
| :- | :- |
...
| Nom | Description |
| :- | :- |
| sign(signature, pfx, pass) | Signe le document en utilisant ce champ de signature. |
| sign(signature) | Signe le document en utilisant ce champ de signature. |
| extract_image() | Extrait l’image de la signature sous forme de flux encodé JPEG. |
| extract_image(format) | Extrait l'image de la signature sous forme de flux encodé. |
| clone() | Aucun |
...
| extract_certificate() | Extrait le certificat X.509 unique au format DER sous forme de flux. |
