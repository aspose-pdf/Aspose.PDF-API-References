...
description: "Classe décrivant le composant éditeur de texte enrichi."
type: docs
weight: 240
url: /fr/python-net/aspose.pdf.forms/richtextboxfield/
---
...
Le type RichTextBoxField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| RichTextBoxField(page, rect) | Initialise une nouvelle instance de la classe RichTextBoxField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| valeur | Valeur du RichTextField. |
...
| style | Obtient ou définit la chaîne de style par défaut du champ de texte enrichi. |
| rich_text_value | Obtient ou définit la valeur du texte enrichi. |
| formatted_value | Obtient ou définit la valeur formatée du texte enrichi avec balisage. |
| justify | Obtient ou définit l'alignement du champ de texte enrichi. |
## Indexer
| Nom | Description |
| :- | :- |
