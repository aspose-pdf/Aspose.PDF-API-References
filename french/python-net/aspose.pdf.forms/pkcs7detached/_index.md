...
description: "Représente l'objet PKCS#7 conforme à la spécification PKCS#7 de la RFC 2315 d'Internet, <br/>            PKCS #7 : Cryptographic Message Syntax, version 1.5.<br/>            Le condensat du message signé original sur la plage d'octets du document est incorporé comme le champ SignedData normal de PKCS#7. <br/>            Aucune donnée ne doit être encapsulée dans le champ SignedData de PKCS#7."
type: docs
weight: 200
url: /fr/python-net/aspose.pdf.forms/pkcs7detached/
---
...
Le type PKCS7Detached expose les membres suivants:
## Constructeurs
| Nom | Description |
| :- | :- |
| PKCS7Detached(image) | Initialise une nouvelle instance de la classe PKCS7Detached |
| PKCS7Detached() | Initialise une nouvelle instance de la classe [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/). |
| PKCS7Detached(pfx, password) | Initialise une nouvelle instance de la classe PKCS7Detached |
| PKCS7Detached(pfx, password) | Initialise une nouvelle instance de la classe PKCS7Detached |
## Propriétés
| Nom | Description |
| :- | :- |
