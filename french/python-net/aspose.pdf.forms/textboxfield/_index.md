...
description: "Classe représentant le champ zone de texte."
type: docs
weight: 280
url: /fr/python-net/aspose.pdf.forms/textboxfield/
---

## TextBoxField class

Classe représentant le champ zone de texte.

Le type TextBoxField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| TextBoxField(doc) | Initialise une nouvelle instance de la classe TextBoxField |
| TextBoxField() | Créer une instance de TextBoxField. |
| TextBoxField(page, rect) | Initialise une nouvelle instance de la classe TextBoxField |
| TextBoxField(doc, rect) | Initialise une nouvelle instance de la classe TextBoxField |
## Propriétés
| Nom | Description |
| :- | :- |
