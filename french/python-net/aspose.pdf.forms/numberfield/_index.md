...
description: "Champ texte avec caractères valides spécifiés"
type: docs
weight: 150
url: /fr/python-net/aspose.pdf.forms/numberfield/
---

## NumberField class

Champ texte avec caractères valides spécifiés

Le type NumberField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| NumberField() | Initialise une nouvelle instance de la classe [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/). |
| NumberField(page, rect) | Initialise une nouvelle instance de la classe NumberField |
| NumberField(doc, rect) | Initialise une nouvelle instance de la classe NumberField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| allowed_chars | Obtient ou définit les caractères autorisés. |
## Indexer
| Nom | Description |
| :- | :- |
