...
description: "Classe représentant le champ ListBox."
type: docs
weight: 140
url: /fr/python-net/aspose.pdf.forms/listboxfield/
---

## ListBoxField class

Classe représentant le champ ListBox.

Le type ListBoxField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| ListBoxField() | Constructeur pour ListBoxField à utiliser dans Generator. |
| ListBoxField(page, rect) | Initialise une nouvelle instance de la classe ListBoxField |
| ListBoxField(doc, rect) | Initialise une nouvelle instance de la classe ListBoxField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| sélectionné | Obtient ou définit l'index de l'élément sélectionné. Les éléments sont numérotés à partir de 1. |
| selected_items | Obtient ou définit le tableau des éléments sélectionnés dans la liste à sélection multiple. Pour une liste à sélection unique, renvoie un tableau contenant un seul élément. |
| options | Obtient la collection des options de choix. |
| top_index | Obtient ou définit l'index de l'élément visible supérieur de la liste. |
## Indexer
| Nom | Description |
| :- | :- |
