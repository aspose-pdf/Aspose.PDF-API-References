...
type: docs
weight: 220
url: /fr/python-net/aspose.pdf.forms/radiobuttonfield/
---
...
Le type RadioButtonField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| RadioButtonField(page) | Initialise une nouvelle instance de la classe RadioButtonField |
| RadioButtonField(doc) | Initialise une nouvelle instance de la classe RadioButtonField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| nom_complet | Aucun |
| apparence | Aucun |
| indice_page | Obtient l'index de la page qui contient ce champ RadioButton. |
...
| sélectionné | Obtient ou définit l'index de l'élément sélectionné. La numérotation des éléments commence à 1. |
...
| options | Obtient la collection d'options du bouton radio. |
| style | Style de la boîte du champ. |
## Indexer
| Nom | Description |
| :- | :- |
...
| Nom | Description |
| :- | :- |
| add_option(option_name, rect) | Ajouter  à l'option de bouton radio avec le rectangle spécifié. |
| add_option(option_name) | Ajouter  à l'option de bouton radio avec le rectangle spécifié. |
| add_option(export, name) | Ajouter  à l'option de bouton radio avec le rectangle spécifié. |
| clone() | Aucun |
...
| set_position(point) | Déplacer tous les sous-éléments du bouton radio vers les positions spécifiées sur la page. |
| delete_option(option_name) | Supprime l'option par son nom. |
| add(new_item) | Ajoute un nouveau champ d'option au champ RadioButton |
