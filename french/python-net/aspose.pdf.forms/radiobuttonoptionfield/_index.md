...
description: "Classe représentant l'élément du champ RadioButton."
type: docs
weight: 230
url: /fr/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---
...
Le type RadioButtonOptionField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| RadioButtonOptionField() | Crée une nouvelle instance de RadioButtonOptionField. |
| RadioButtonOptionField(page, rect) | Initialise une nouvelle instance de la classe RadioButtonOptionField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| option_name | Obtient ou définit le nom de l'option. |
| caption | Obtient ou définit la légende. |
| style | Obtient ou définit le style de la case à cocher. |
## Indexer
| Nom | Description |
| :- | :- |
