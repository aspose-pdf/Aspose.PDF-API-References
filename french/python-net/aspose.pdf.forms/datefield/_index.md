...
description: "Champ de date avec affichage du calendrier."
type: docs
weight: 60
url: /fr/python-net/aspose.pdf.forms/datefield/
---
...
Le type DateField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| DateField() | Initialise une nouvelle instance de [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Initialise une nouvelle instance de la classe DateField |
| DateField(page, rect) | Initialise une nouvelle instance de la classe DateField |
| DateField(doc, rect) | Initialise une nouvelle instance de la classe DateField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| valeur | Obtient ou définit la Date. |
...
| date_format | Obtient ou définit le format de date. |
## Indexer
| Nom | Description |
| :- | :- |
...
| Nom | Description |
| :- | :- |
| add_image(image) | L'ajout d'image est refusé pour ce champ. |
| add_image(image) | L'ajout d'image est refusé pour ce champ. |
| clone() | Aucun |
...
| init(page) | Initialise l'action JS. |
