...
description: "Classe représentant le champ de liste déroulante du formulaire."
type: docs
weight: 50
url: /fr/python-net/aspose.pdf.forms/comboboxfield/
---

## ComboBoxField class

Classe représentant le champ de liste déroulante du formulaire.

Le type ComboBoxField expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| ComboBoxField() | Constructeur pour ComboBoxField à utiliser dans Generator. |
| ComboBoxField(doc) | Initialise une nouvelle instance de la classe ComboBoxField |
| ComboBoxField(page, rect) | Initialise une nouvelle instance de la classe ComboBoxField |
| ComboBoxField(doc, rect) | Initialise une nouvelle instance de la classe ComboBoxField |
## Propriétés
| Nom | Description |
| :- | :- |
...
| commit_immediately | Obtient ou définit le drapeau de validation lors du changement de sélection. |
| multi_select | Obtient ou définit le drapeau de sélection multiple. |
| sélectionné | Obtient ou définit l'index de l'option sélectionnée. Cette propriété permet de modifier la sélection. |
| selected_items | Obtient ou définit le tableau des éléments sélectionnés. Pour une liste à sélection multiple, le tableau contient plus d'un élément. Pour une liste à sélection unique, il ne contient qu'un seul élément. |
| options | Obtient la collection des options de choix. |
| editable | Obtient ou définit le statut modifiable du champ. |
| spell_check | Obtient ou définit le statut de l'activité de la vérification orthographique. |
## Indexer
| Nom | Description |
| :- | :- |
...
| Nom | Description |
| :- | :- |
| add_option(option_name) | Ajoute une nouvelle option avec le nom spécifié. |
| add_option(export, name) | Ajoute une nouvelle option avec le nom spécifié. |
| clone() | Aucun |
...
| delete_option(option_name) | Supprime l'option par son nom. |
