...
description: "Représente une annotation de texte qui est un « sticky note » attaché à un point du document PDF."
type: docs
weight: 820
url: /fr/python-net/aspose.pdf.annotations/textannotation/
---

## TextAnnotation class

Représente une annotation de texte qui est un « sticky note » attaché à un point du document PDF.

Le type TextAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| TextAnnotation(document) | Initialise une nouvelle instance de la classe TextAnnotation |
| TextAnnotation(page, rect) | Initialise une nouvelle instance de la classe TextAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| ouvrir | Obtient ou définit un indicateur spécifiant si l'annotation doit être affichée ouverte initialement. |
| icon | Obtient ou définit une icône à utiliser pour l'affichage de l'annotation. |
| state | Obtient ou définit l'état auquel l'annotation originale doit être définie. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
