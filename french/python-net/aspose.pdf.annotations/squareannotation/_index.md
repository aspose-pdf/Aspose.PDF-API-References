...
description: "Classe représentant une annotation carrée."
type: docs
weight: 770
url: /fr/python-net/aspose.pdf.annotations/squareannotation/
---
...
Le type SquareAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| SquareAnnotation(document) | Initialise une nouvelle instance de la classe SquareAnnotation |
| SquareAnnotation(page, rect) | Initialise une nouvelle instance de la classe SquareAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| accept(visitor) | Accepte un visiteur pour traiter l'annotation. |
| flatten() | Aucun |
