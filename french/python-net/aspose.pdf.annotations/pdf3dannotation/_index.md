...
type: docs
weight: 510
url: /fr/python-net/aspose.pdf.annotations/pdf3dannotation/
---
...
Le type PDF3DAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| PDF3DAnnotation(page, rect, pdf_3d_artwork) | Initialise une nouvelle instance de la classe PDF3DAnnotation |
| PDF3DAnnotation(page, rect, pdf_3d_artwork, activation) | Initialise une nouvelle instance de la classe PDF3DAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| pdf_3d_artwork | Obtient l'œuvre 3D. |
| lighting_scheme | Obtient le schéma d'éclairage. |
| contenu | Obtient ou définit le contenu. |
| render_mode | Obtient le mode de rendu. |
| view_array | Obtient le tableau de vues. |
## Méthodes
| Nom | Description |
| :- | :- |
| set_image_preview(filename) | Définit l'aperçu de l'image. |
| set_image_preview(image) | Définit l'aperçu de l'image. |
...
| set_default_view_index(index) | Définit l'index de la vue par défaut. |
| clear_image_preview() | Efface l'aperçu de l'image. |
| get_image_preview() | Obtient l'aperçu de l'image. |
