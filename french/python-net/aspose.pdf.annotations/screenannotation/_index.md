...
description: "Une annotation d'écran qui spécifie une région d'une page sur laquelle des clips médias peuvent être lus."
type: docs
weight: 720
url: /fr/python-net/aspose.pdf.annotations/screenannotation/
---

## ScreenAnnotation class

Une annotation d'écran qui spécifie une région d'une page sur laquelle des clips médias peuvent être lus.

Le type ScreenAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | Initialise une nouvelle instance de la classe ScreenAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| title | Obtient ou définit le titre de l'annotation d'écran. |
| action | Obtient ou définit une action à exécuter lorsque l'annotation est activée. |
## Méthodes
| Nom | Description |
| :- | :- |
