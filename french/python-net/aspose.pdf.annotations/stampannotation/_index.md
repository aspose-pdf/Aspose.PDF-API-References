...
description: "Représente une annotation de tampon en caoutchouc. <br/>             Ce type d'annotation affiche du texte ou des graphiques destinés à ressembler à un tampon apposé sur la page."
type: docs
weight: 790
url: /fr/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

Représente une annotation de tampon en caoutchouc. <br/>             Ce type d'annotation affiche du texte ou des graphiques destinés à ressembler à un tampon apposé sur la page.

Le type StampAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| StampAnnotation(document) | Initialise une nouvelle instance de la classe StampAnnotation |
| StampAnnotation(page, rect) | Initialise une nouvelle instance de la classe StampAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| icon | Obtient ou définit l'icône du tampon en caoutchouc. |
| image | Obtient ou définit l'image de l'annotation. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
| get_rectangle(consider_rotation) | Renvoie le rectangle de l'annotation en tenant compte de la rotation de la page. |
| accept(visitor) | Accepte le visiteur [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) lors de la navigation dans la collection d'annotations. |
