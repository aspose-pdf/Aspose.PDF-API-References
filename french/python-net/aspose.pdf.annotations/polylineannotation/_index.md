...
description: "Représente une annotation de polyligne similaire à un polygone, sauf que le premier et le dernier sommet ne sont pas implicitement reliés."
type: docs
weight: 660
url: /fr/python-net/aspose.pdf.annotations/polylineannotation/
---

## PolylineAnnotation class

Représente une annotation de polyligne similaire à un polygone, sauf que le premier et le dernier sommet ne sont pas implicitement reliés.

Le type PolylineAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| PolylineAnnotation(page, rect, vertices) | Initialise une nouvelle instance de la classe PolylineAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| vertices | Obtient ou définit un tableau de points représentant les coordonnées horizontales et verticales de chaque sommet. |
| interior_color | Obtient ou définit la couleur intérieure avec laquelle remplir les terminaisons de ligne de l'annotation. |
| starting_style | Obtient ou définit le style de la première terminaison de ligne. |
| ending_style | Obtient ou définit le style de la deuxième terminaison de ligne. |
| intent | Obtient ou définit l'intention de l'annotation polygone ou polyligne. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
...
| flatten() | Aucun |
| change_after_resize(transform) | Met à jour les points dans Vertices, selon la transformation matricielle. |
