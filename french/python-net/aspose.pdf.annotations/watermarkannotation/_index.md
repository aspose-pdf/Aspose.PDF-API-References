...
description: "Classe décrivant l'objet d'annotation Watermark."
type: docs
weight: 860
url: /fr/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Classe décrivant l'objet d'annotation Watermark.

Le type WatermarkAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| WatermarkAnnotation(page, rect) | Initialise une nouvelle instance de la classe WatermarkAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| type_annotation | Obtient le type d'annotation. |
...
| fixed_print | Objet d'impression fixe de l'annotation Watermark. |
| opacité | Obtient ou définit l'opacité de l'annotation. |
## Méthodes
| Nom | Description |
| :- | :- |
...
| accept(visitor) | Applique le visiteur à l'annotation. |
...
| set_text(text) | Définit le texte de l'annotation. |
| set_text_and_state(text, text_state) | Définit le texte de l'annotation. |
