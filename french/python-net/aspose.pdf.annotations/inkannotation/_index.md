...
type: docs
weight: 350
url: /fr/python-net/aspose.pdf.annotations/inkannotation/
---

## InkAnnotation class

Représente un "scribble" à main levée composé d'un ou plusieurs chemins disjoints.

Le type InkAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| InkAnnotation(document, ink_list) | Initialise une nouvelle instance de la classe InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Initialise une nouvelle instance de la classe InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Initialise une nouvelle instance de la classe InkAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| cap_style | Style des terminaisons de ligne de l'annotation d'encre. |
| ink_list | Obtient ou définit la liste des gestes qui sont des lignes indépendantes représentées par des tableaux Point[]. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
...
| change_after_resize(transform) | Met à jour les points dans InkList, selon la transformation matricielle. |
