...
type: docs
weight: 740
url: /fr/python-net/aspose.pdf.annotations/soundannotation/
---
...
Le type SoundAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Initialise une nouvelle instance de la classe SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Initialise une nouvelle instance de la classe SoundAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| sound_data | Obtient un objet son définissant le son à jouer lorsque l'annotation est activée. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
