...
description: "La classe décrit l'annotation de pièce jointe de fichier."
type: docs
weight: 170
url: /fr/python-net/aspose.pdf.annotations/fileattachmentannotation/
---
...
Le type FileAttachmentAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | Initialise une nouvelle instance de la classe FileAttachmentAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| opacité | Obtient ou définit l'opacité de l'icône de 0 à 1 : 0 – complètement transparent, 1 – complètement opaque. |
...
| file | La spécification du fichier associé à cette annotation. |
| icon | Obtient ou définit l'icône qui doit être utilisée pour afficher l'annotation. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
| get_rectangle(consider_rotation) | Renvoie le rectangle de l'annotation en tenant compte de la rotation de la page. |
| accept(visitor) | Accepte l'objet visiteur pour traiter l'annotation. |
