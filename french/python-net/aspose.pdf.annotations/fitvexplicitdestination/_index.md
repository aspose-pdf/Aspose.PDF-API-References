...
Le type FitVExplicitDestination expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| FitVExplicitDestination(page, left) | Initialise une nouvelle instance de la classe FitVExplicitDestination |
| FitVExplicitDestination(document, page_number, left) | Initialise une nouvelle instance de la classe FitVExplicitDestination |
| FitVExplicitDestination(page_number, left) | Initialise une nouvelle instance de la classe FitVExplicitDestination |
## Propriétés
| Nom | Description |
| :- | :- |
| page | Obtient l'objet de la page de destination |
| page_number | Obtient le numéro de page de destination |
| left | Obtient la coordonnée horizontale left positionnée au bord gauche de la fenêtre. |
## Méthodes
| Nom | Description |
| :- | :- |
...
| to_string() | Convertit l'état de l'objet en valeur de chaîne. Exemple : "1 FitV 100". |
