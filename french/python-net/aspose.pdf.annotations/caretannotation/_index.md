...
description: "Classe représentant l'annotation Caret."
type: docs
weight: 80
url: /fr/python-net/aspose.pdf.annotations/caretannotation/
---
...
Le type CaretAnnotation expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| CaretAnnotation(document) | Initialise une nouvelle instance de la classe CaretAnnotation |
| CaretAnnotation(page, rect) | Initialise une nouvelle instance de la classe CaretAnnotation |
## Propriétés
| Nom | Description |
| :- | :- |
...
| cadre | Obtient ou définit le rectangle du caret. |
| symbole | Obtient ou définit le symbole associé au caret. |
## Méthodes
| Nom | Description |
| :- | :- |
| clone() | Aucun |
