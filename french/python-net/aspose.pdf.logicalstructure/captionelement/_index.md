...
description: "Représente l'élément de structure Caption dans la structure logique."
type: docs
weight: 110
url: /fr/python-net/aspose.pdf.logicalstructure/captionelement/
---

## CaptionElement class

Représente l'élément de structure Caption dans la structure logique.

Le type CaptionElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
