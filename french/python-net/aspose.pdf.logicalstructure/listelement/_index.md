...
description: "Représente l'élément de structure List dans la structure logique."
type: docs
weight: 290
url: /fr/python-net/aspose.pdf.logicalstructure/listelement/
---

## ListElement class

Représente l'élément de structure List dans la structure logique.

Le type ListElement expose les membres suivants:
## Propriétés
| Nom | Description |
| :- | :- |
