...
description: "Représente une classe de base pour les éléments enfants du Ruby dans la structure logique."
type: docs
weight: 420
url: /fr/python-net/aspose.pdf.logicalstructure/rubychildelement/
---

## RubyChildElement class

Représente une classe de base pour les éléments enfants du Ruby dans la structure logique.

Le type RubyChildElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
