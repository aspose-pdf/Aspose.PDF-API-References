...
description: "Représente une classe de base pour les éléments de structure d'illustration dans la structure logique."
type: docs
weight: 250
url: /fr/python-net/aspose.pdf.logicalstructure/illustrationelement/
---
...
Le type IllustrationElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
| parent_element | Obtient l'élément parent. |
| child_elements | Obtient la collection d'enfants de |
...
| Nom | Description |
| :- | :- |
| set_image(image_src, image_resolution) | Ajoute l'image à l'élément d'illustration actuel. |
| set_image(image_src, image_width, image_height) | Ajoute l'image à l'élément d'illustration actuel. |
| append_child(element) | Ajouter |
