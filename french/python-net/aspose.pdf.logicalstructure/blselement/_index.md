...
description: "Représente une classe de base pour les éléments de structure de niveau bloc dans la structure logique."
type: docs
weight: 70
url: /fr/python-net/aspose.pdf.logicalstructure/blselement/
---

## BLSElement class

Représente une classe de base pour les éléments de structure de niveau bloc dans la structure logique.

Le type BLSElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
