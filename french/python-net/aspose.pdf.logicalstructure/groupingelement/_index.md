...
description: "Représente une classe de base pour regrouper des éléments de structure dans la structure logique."
type: docs
weight: 200
url: /fr/python-net/aspose.pdf.logicalstructure/groupingelement/
---

## GroupingElement class

Représente une classe de base pour regrouper des éléments de structure dans la structure logique.

Le type GroupingElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
