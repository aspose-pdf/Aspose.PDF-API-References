...
description: "Représente une classe de base pour les éléments enfants de la List dans la structure logique."
type: docs
weight: 280
url: /fr/python-net/aspose.pdf.logicalstructure/listchildelement/
---

## ListChildElement class

Représente une classe de base pour les éléments enfants de la List dans la structure logique.

Le type ListChildElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
