...
description: "Représente une classe de base pour les éléments de texte de niveau en ligne dans la structure logique."
type: docs
weight: 230
url: /fr/python-net/aspose.pdf.logicalstructure/ilstextelement/
---

## ILSTextElement class

Représente une classe de base pour les éléments de texte de niveau en ligne dans la structure logique.

Le type ILSTextElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
