...
description: "Représente une classe de base pour les éléments enfants de la Table dans la structure logique."
type: docs
weight: 600
url: /fr/python-net/aspose.pdf.logicalstructure/tablechildelement/
---

## TableChildElement class

Représente une classe de base pour les éléments enfants de la Table dans la structure logique.

Le type TableChildElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
