...
description: "Représente une classe de base pour les éléments enfants du Table Head, Body et Foot dans la structure logique."
type: docs
weight: 620
url: /fr/python-net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---

## TableRowCollectionElement class

Représente une classe de base pour les éléments enfants du Table Head, Body et Foot dans la structure logique.

Le type TableRowCollectionElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
