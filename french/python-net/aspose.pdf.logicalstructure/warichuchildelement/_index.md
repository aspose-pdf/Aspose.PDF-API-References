...
description: "Représente une classe de base pour les éléments enfants du Warichu dans la structure logique."
type: docs
weight: 690
url: /fr/python-net/aspose.pdf.logicalstructure/warichuchildelement/
---

## WarichuChildElement class

Représente une classe de base pour les éléments enfants du Warichu dans la structure logique.

Le type WarichuChildElement expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
