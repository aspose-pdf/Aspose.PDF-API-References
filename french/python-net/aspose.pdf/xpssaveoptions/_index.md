...
type: docs
weight: 1810
url: /fr/python-net/aspose.pdf/xpssaveoptions/
---
...
| Nom | Description |
| :- | :- |
| XpsSaveOptions() | Initialise une nouvelle instance de la classe XpsSaveOptions |
## Propriétés
| Nom | Description |
| :- | :- |
...
| save_transparent_texts | Indique s'il faut préserver le texte transparent (OCRisé). |
