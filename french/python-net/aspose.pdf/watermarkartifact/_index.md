...
description: "La classe décrit l'artefact de filigrane. Cela peut être utilisé pour"
type: docs
weight: 1640
url: /fr/python-net/aspose.pdf/watermarkartifact/
---
...
Le type WatermarkArtifact expose les membres suivants:
## Constructeurs
| Nom | Description |
| :- | :- |
| WatermarkArtifact() | Crée une instance de Watermark artifact. |
## Propriétés
| Nom | Description |
| :- | :- |
