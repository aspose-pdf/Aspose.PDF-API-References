...
description: "Décrit l'artefact de pied de page. Cela peut être utilisé pour définir le pied de page de la page."
type: docs
weight: 400
url: /fr/python-net/aspose.pdf/footerartifact/
---

## FooterArtifact class

Décrit l'artefact de pied de page. Cela peut être utilisé pour définir le pied de page de la page.

Le type FooterArtifact expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| FooterArtifact() | Crée une instance de Footer Artifact. |
## Propriétés
| Nom | Description |
| :- | :- |
