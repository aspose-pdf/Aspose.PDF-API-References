...
description: "Classe décrivant l'artefact d'arrière-plan. Cet artefact permet de définir l'arrière-plan de la page."
type: docs
weight: 50
url: /fr/python-net/aspose.pdf/backgroundartifact/
---
...
Le type BackgroundArtifact expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| BackgroundArtifact() | Initialise l'objet BackgroundArtifact. |
## Propriétés
| Nom | Description |
| :- | :- |
...
| background_color | Obtient ou définit la couleur bacground de l'artefact d'arrière-plan |
| background_image | Obtient ou définit l'image bacground de l'artefact d'arrière-plan |
## Méthodes
| Nom | Description |
| :- | :- |
