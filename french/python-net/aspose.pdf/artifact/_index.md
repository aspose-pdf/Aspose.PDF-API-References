...
description: "Classe représentant l'objet PDF Artifact."
type: docs
weight: 30
url: /fr/python-net/aspose.pdf/artifact/
---
...
Le type Artifact expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| Artifact(type, sub_type) | Initialise une nouvelle instance de la classe Artifact |
| Artifact(type, sub_type) | Initialise une nouvelle instance de la classe Artifact |
## Propriétés
| Nom | Description |
| :- | :- |
