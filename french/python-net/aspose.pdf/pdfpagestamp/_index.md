...
description: "La classe représente un tampon qui utilise une page PDF comme tampon."
type: docs
weight: 1230
url: /fr/python-net/aspose.pdf/pdfpagestamp/
---
...
Le type PdfPageStamp expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| PdfPageStamp(pdf_page) | Initialise une nouvelle instance de la classe PdfPageStamp |
| PdfPageStamp(file_name, page_index) | Initialise une nouvelle instance de la classe PdfPageStamp |
| PdfPageStamp(stream, page_index) | Initialise une nouvelle instance de la classe PdfPageStamp |
## Propriétés
| Nom | Description |
| :- | :- |
...
| pdf_page | Obtient ou définit la page qui sera utilisée comme tampon. |
## Méthodes
| Nom | Description |
| :- | :- |
| put(page) | Place le tampon sur la page spécifiée. |
