...
description: "Options d'enregistrement pour le format PdfXml."
type: docs
weight: 1260
url: /fr/python-net/aspose.pdf/pdfxmlsaveoptions/
---

## PdfXmlSaveOptions class

Options d'enregistrement pour le format PdfXml.

Le type PdfXmlSaveOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| PdfXmlSaveOptions() | Initialise une nouvelle instance de la classe PdfXmlSaveOptions |
## Propriétés
| Nom | Description |
| :- | :- |
