...
description: "Options d'enregistrement pour l'exportation au format Xml"
type: docs
weight: 960
url: /fr/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
Le type MobiXmlSaveOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| MobiXmlSaveOptions() | Initialise une nouvelle instance de la classe MobiXmlSaveOptions |
## Propriétés
| Nom | Description |
| :- | :- |
