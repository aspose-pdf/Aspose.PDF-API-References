...
description: "Cette classe représente les options d'enregistrement pour l'enregistrement qui <br/>            utilise une méthode de conversion unifiée (avec un modèle de document interne unifié)"
type: docs
weight: 1590
url: /fr/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Cette classe représente les options d'enregistrement pour l'enregistrement qui <br/>            utilise une méthode de conversion unifiée (avec un modèle de document interne unifié)

Le type UnifiedSaveOptions expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| UnifiedSaveOptions() | Initialise une nouvelle instance de la classe UnifiedSaveOptions |
## Propriétés
| Nom | Description |
| :- | :- |
