...
type: docs
weight: 690
url: /fr/python-net/aspose.pdf/imagestamp/
---
...
Le type ImageStamp expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| ImageStamp(image) | Initialise une nouvelle instance de la classe ImageStamp |
| ImageStamp(file_name) | Initialise une nouvelle instance de la classe ImageStamp |
## Propriétés
| Nom | Description |
| :- | :- |
...
| largeur | Obtient ou définit la largeur de l'image. La définition de cette propriété permet de mettre à l'échelle l'image horizontalement. |
| hauteur | Obtient ou définit la hauteur de l'image. La définition de cette propriété permet de mettre à l'échelle l'image verticalement. |
...
| image | Obtient le flux d'image utilisé pour le tamponnage. |
| qualité | Obtient ou définit la qualité du tampon d'image en pourcentage. Les valeurs valides sont de 0 à 100 %. |
## Méthodes
| Nom | Description |
| :- | :- |
| put(page) | Ajoute un tampon graphique sur la page. |
