...
description: "Représente le tampon textuel."
type: docs
weight: 1550
url: /fr/python-net/aspose.pdf/textstamp/
---
...
Le type TextStamp expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| TextStamp(value) | Initialise une nouvelle instance de la classe TextStamp |
| TextStamp(value, text_state) | Initialise une nouvelle instance de la classe TextStamp |
| TextStamp(formatted_text) | Initialise une nouvelle instance de la classe TextStamp |
## Propriétés
| Nom | Description |
| :- | :- |
...
| Nom | Description |
| :- | :- |
| put(page) | Ajoute un tampon textuel sur la page. |
