...
type: docs
weight: 390
url: /fr/python-net/aspose.pdf.text/textfragment/
---
...
Le type TextFragment expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| TextFragment() | Initialise une nouvelle instance de l'objet [TextFragment](/pdf/python-net/aspose.pdf.text/textfragment/). |
| TextFragment(tab_stops) | Initialise une nouvelle instance de la classe TextFragment |
| TextFragment(text) | Initialise une nouvelle instance de la classe TextFragment |
| TextFragment(text, tab_stops) | Initialise une nouvelle instance de la classe TextFragment |
## Propriétés
| Nom | Description |
| :- | :- |
...
| clone_with_segments() | Clone le fragment avec tous les segments. |
