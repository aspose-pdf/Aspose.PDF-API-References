...
description: "Classe représentant l'opérateur n (terminer le chemin sans remplissage ni tracé)."
type: docs
weight: 270
url: /fr/python-net/aspose.pdf.operators/endpath/
---

## EndPath class

Classe représentant l'opérateur n (terminer le chemin sans remplissage ni tracé).

Le type EndPath expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| EndPath() | Initialise l'opérateur. |
## Propriétés
| Nom | Description |
| :- | :- |
