...
description: "Classe représentant l'opérateur BI (Begin inline image obect)."
type: docs
weight: 20
url: /fr/python-net/aspose.pdf.operators/bi/
---
...
Le type BI expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| BI() | Initialise l'opérateur. |
## Propriétés
| Nom | Description |
| :- | :- |
