...
description: "Classe représentant l'opérateur W* (définir le chemin de découpe en utilisant la règle pair-impaire)."
type: docs
weight: 220
url: /fr/python-net/aspose.pdf.operators/eoclip/
---

## EOClip class

Classe représentant l'opérateur W* (définir le chemin de découpe en utilisant la règle pair-impaire).

Le type EOClip expose les membres suivants :
## Propriétés
| Nom | Description |
| :- | :- |
