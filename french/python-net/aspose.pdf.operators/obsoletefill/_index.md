...
description: "Classe représentant l'opérateur F (remplir le chemin en utilisant la règle du nombre de tours non nul)."
type: docs
weight: 420
url: /fr/python-net/aspose.pdf.operators/obsoletefill/
---
...
Le type ObsoleteFill expose les membres suivants :
## Constructeurs
| Nom | Description |
| :- | :- |
| ObsoleteFill() | Initialise l'opérateur. |
## Propriétés
| Nom | Description |
| :- | :- |
