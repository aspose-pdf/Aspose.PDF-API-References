...
description: La classe représente le champ ListBox.
type: docs
weight: 3080
...
| Nom | La description |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | Constructeur pour ListBoxField à utiliser dans Generator. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | Obtient ou définit l'index de l'élément sélectionné. Les articles sont numérotés à partir de 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | Obtient ou définit le tableau des éléments sélectionnés dans la liste à sélection multiple. Pour une liste à sélection unique, renvoie un tableau avec un seul élément. |
