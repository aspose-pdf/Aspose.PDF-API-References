---
title: "Classe ListBoxField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Forms.ListBoxField. La classe représente le champ ListBox."
type: docs
weight: 5250
...
La classe représente le champ ListBox.
...
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Obtient ou définit le tableau des éléments sélectionnés dans la liste à sélection multiple. Pour une liste à sélection unique, renvoie un tableau contenant un seul élément. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Obtient ou définit l'index de l'élément visible supérieur de la liste. |
