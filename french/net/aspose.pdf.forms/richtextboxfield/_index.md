...
La classe décrit le composant éditeur de texte enrichi.
...
| Nom | Description |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Constructeur pour le champ de zone de texte enrichi. |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtient ou définit le drapeau qui indique si le champ est divisé en positions espacées. |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | Propriété pour le support du générateur. Utilisé lorsque le champ est ajouté à l'en-tête ou au pied de page. Si true, ce champ sera créé une fois et son apparence sera visible sur toutes les pages du document. Si false, un champ séparé sera créé pour chaque page du document. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Obtient ou définit la justification de la zone de texte enrichi. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Obtient ou définit le drapeau multiligne du champ. Si Multiline est true, le champ peut contenir plusieurs lignes de texte. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Obtient ou définit la valeur de texte enrichi. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Obtient ou définit le drapeau défilable du champ. Si true, le champ peut être défilé. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtient ou définit le drapeau de vérification orthographique pour le champ. Si true, le champ sera vérifié pour l'orthographe. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Valeur de RichTextField. |
...
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage/)(Image) | Ajoute une image dans les ressources du champ et l'affiche. |
