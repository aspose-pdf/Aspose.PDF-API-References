...
description: La classe décrit le composant de léditeur de texte enrichi.
type: docs
weight: 3180
...
La classe décrit le composant de l'éditeur de texte enrichi.
...
| Nom | La description |
| --- | --- |
| [RichTextBoxField](richtextboxfield)(Page, Rectangle) | Constructeur pour le champ Zone de texte enrichi. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Obtient ou définit une valeur de texte enrichi formatée avec un balisage. |
