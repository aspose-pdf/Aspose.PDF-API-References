---
title: "Classe RichTextBoxField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Forms.RichTextBoxField. La classe décrit le composant éditeur de texte enrichi."
type: docs
weight: 5350
url: /fr/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField class

Classe décrivant le composant éditeur de texte enrichi.
...
| Nom | Description |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Constructeur pour le champ Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Obtient ou définit la valeur de texte enrichi formatée avec balisage. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Obtient ou définit l'alignement du texte du champ texte enrichi. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Obtient ou définit la valeur du texte enrichi. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Obtient ou définit la chaîne de style par défaut du champ de texte enrichi. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Valeur du RichTextField. |
