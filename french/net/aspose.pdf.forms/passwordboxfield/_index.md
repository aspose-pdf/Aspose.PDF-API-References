...
description: Classe Aspose.Pdf.Forms.PasswordBoxField. La classe décrit un champ de texte pour entrer un mot de passe
type: docs
weight: 5200
url: /fr/net/aspose.pdf.forms/passwordboxfield/
---
## Classe PasswordBoxField

La classe décrit un champ de texte pour entrer un mot de passe.
