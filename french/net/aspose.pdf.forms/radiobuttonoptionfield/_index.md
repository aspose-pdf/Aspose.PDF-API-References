...
description: La classe représente lélément du champ RadioButton.
type: docs
weight: 3170
...
La classe représente l'élément du champ RadioButton.
...
| Nom | La description |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor)() | Créer une nouvelle instance de RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield#constructor_1)(Page, Rectangle) | Crée un bouton radio dans le recangle spécifié sur la page spécifiée. |
