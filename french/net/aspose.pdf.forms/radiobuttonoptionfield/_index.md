---
title: "Classe RadioButtonOptionField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Forms.RadioButtonOptionField. La classe représente un élément du champ RadioButton."
type: docs
weight: 5340
url: /fr/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## RadioButtonOptionField class

Classe représentant l'élément du champ RadioButton.
...
| Nom | Description |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Crée une nouvelle instance de RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | Crée un bouton radio dans le rectangle spécifié sur la page spécifiée. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Obtient ou définit la légende. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Obtient ou définit le nom de l'option. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Obtient ou définit le style de la case à cocher. |
