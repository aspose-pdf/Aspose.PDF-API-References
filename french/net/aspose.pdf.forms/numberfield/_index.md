...
description: Champ de texte avec des caractères valides spécifiés
type: docs
weight: 3090
...
| Nom | La description |
| --- | --- |
| [NumberField](numberfield#constructor)() | Initialise une nouvelle instance du[`NumberField`](../numberfield) classe. |
| [NumberField](numberfield#constructor_1)(Document, Rectangle) | Initialise une nouvelle instance du[`NumberField`](../numberfield) classe. |
| [NumberField](numberfield#constructor_2)(Page, Rectangle) | Initialise une nouvelle instance du[`NumberField`](../numberfield) classe. |
