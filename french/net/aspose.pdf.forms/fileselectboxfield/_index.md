...
description: Classe Aspose.Pdf.Forms.FileSelectBoxField. Champ pour l'élément de boîte de sélection de fichiers
type: docs
weight: 5060
url: /fr/net/aspose.pdf.forms/fileselectboxfield/
---
## Classe FileSelectBoxField

Champ pour l'élément de boîte de sélection de fichiers.
...
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtient ou définit le drapeau de vérification orthographique pour le champ. Si vrai, le champ sera vérifié orthographiquement. |
