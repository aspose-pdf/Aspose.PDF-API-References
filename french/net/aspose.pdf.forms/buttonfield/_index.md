---
title: "Classe ButtonField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Aspose.Pdf.Forms.ButtonField class. Classe représente le champ de bouton poussoir"
type: docs
weight: 5090
url: /fr/net/aspose.pdf.forms/buttonfield/
---
## ButtonField class

La classe représente le champ de bouton poussoir.
...
| Nom | Description |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Constructeur du champ bouton pour le Générateur. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | Constructeur ButtonField. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | Constructeur ButtonField. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Obtient ou définit la légende alternative du bouton qui doit être affichée lorsque le bouton de la souris est enfoncé dans sa zone active. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Obtient ou définit l'icône alternative qui doit être affichée lorsque le bouton de la souris est enfoncé dans sa zone active. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Obtient l'objet d'ajustement d'icône spécifiant comment l'icône de l'annotation du widget doit être affichée dans son rectangle d'annotation. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Obtient ou définit la position de la légende de l'icône. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Obtient ou définit la légende normale. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Obtient ou définit l'icône normale du bouton qui doit être affichée lorsqu'il n'interagit pas avec l'utilisateur. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Obtient ou définit la légende de survol du bouton qui doit être affichée lorsque l'utilisateur déplace le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Obtient ou définit l'icône de survol du bouton qui doit être affichée lorsque l'utilisateur déplace le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Ajoute une image aux ressources du champ et la dessine. |
