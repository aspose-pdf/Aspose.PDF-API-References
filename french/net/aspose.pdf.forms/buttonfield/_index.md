...
description: La classe représente le champ du bouton poussoir.
type: docs
weight: 2920
...
La classe représente le champ du bouton poussoir.
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | Obtient ou définit une légende alternative du bouton qui doit être affiché lorsque le bouton de la souris est enfoncé dans sa zone active. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | Obtient ou définit une autre icône qui doit être affichée lorsque le bouton de la souris est enfoncé dans sa zone active. |
...
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon) { get; set; } | Obtient ou définit l'icône normale du bouton qui doit être affiché lorsqu'il n'interagit pas avec l'utilisateur. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | Obtient ou définit la légende de survol du bouton qui doit être affichée lorsque l'utilisateur fait rouler le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | Obtient ou définit l'icône de survol du bouton qui doit être affiché lorsque l'utilisateur fait rouler le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage)(Image) | Ajoute une image dans les ressources de champ et la dessine. |
