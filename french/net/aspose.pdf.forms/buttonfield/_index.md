...
description: Classe Aspose.Pdf.Forms.ButtonField. Classe représentant le champ de bouton poussoir
type: docs
weight: 4970
...
| Nom | Description |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Constructeur de champ de bouton pour le générateur. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | Constructeur de ButtonField. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | Constructeur de ButtonField. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Obtient ou définit la légende alternative du bouton qui sera affichée lorsque le bouton de la souris est pressé dans sa zone active. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Obtient ou définit l'icône alternative qui sera affichée lorsque le bouton de la souris est pressé dans sa zone active. |
| [AlternateName](../../aspose.pdf.forms/field/alternatename/) { get; set; } | Obtient ou définit le nom alternatif du champ (Un nom de champ alternatif qui sera utilisé à la place du nom de champ réel chaque fois que le champ sera identifié dans l'interface utilisateur). Le nom alternatif est utilisé comme info-bulle de champ dans Adobe Acrobat. |
...
| virtual [Hyperlink](../../aspose.pdf/baseparagraph/hyperlink/) { get; set; } | Obtient ou définit le lien hypertexte de fragment (pour le générateur PDF). |
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Obtient l'objet de dimensionnement d'icône spécifiant comment l'icône de l'annotation de widget doit être affichée dans son rectangle d'annotation. |
...
| [MappingName](../../aspose.pdf.forms/field/mappingname/) { get; set; } | Obtient ou définit le nom de mappage du champ qui sera utilisé lors de l'exportation des données de champ de formulaire interactif depuis le document. |
...
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Obtient ou définit l'icône normale du bouton qui sera affichée lorsqu'il n'interagit pas avec l'utilisateur. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Obtient ou définit la légende de survol du bouton qui sera affichée lorsque l'utilisateur fait passer le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Obtient ou définit l'icône de survol du bouton qui sera affichée lorsque l'utilisateur fait passer le curseur dans sa zone active sans appuyer sur le bouton de la souris. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Ajoute une image dans les ressources du champ et l'affiche. |
