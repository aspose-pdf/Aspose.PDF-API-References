...
description: Classe Aspose.Pdf.Forms.ChoiceField. Représente la classe de base pour les champs de choix
type: docs
weight: 4990
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Obtient ou définit l'index de l'option sélectionnée. Cette propriété permet de changer la sélection. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Importe des données dans les champs spécifiés à partir d'un flux JSON, en fonction d'une correspondance exacte des noms complets des champs. |
