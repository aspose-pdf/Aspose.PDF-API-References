...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption#addoption_1)(string, string) | Ajoute une nouvelle option avec la valeur et le nom d'exportation spécifiés. |
