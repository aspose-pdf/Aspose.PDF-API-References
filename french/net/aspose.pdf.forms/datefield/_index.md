...
Champ de date avec vue calendrier.
...
| [DateField](datefield/#constructor_1)(Document) | Constructeur qui doit être utilisé avec le générateur. |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | L'ajout d'image est refusé pour ce champ. (2 méthodes) |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Importe des données dans les champs spécifiés à partir d'un flux JSON, basé sur une correspondance exacte des noms complets des champs. |
