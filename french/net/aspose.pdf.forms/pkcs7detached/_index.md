...
description: Représente lobjet PKCS7 conforme à la spécification PKCS7 dans Internet RFC 2315 PKCS 7  Cryptographic Message Syntax Version 1.5. Le résumé de message signé dorigine sur la plage doctets du document est incorporé en tant que PKCS normal 7 Champ SignedData. Aucune donnée ne doit être encapsulée dans le champ PKCS7 SignedData.
type: docs
weight: 3140
...
| Nom | La description |
| --- | --- |
| [PKCS7Detached](pkcs7detached#constructor)() | Initialise la nouvelle instance du[`PKCS7Detached`](../pkcs7detached) classe. |
| [PKCS7Detached](pkcs7detached#constructor_1)(Stream) | Initialise la nouvelle instance du[`PKCS7Detached`](../pkcs7detached) classe. |
| [PKCS7Detached](pkcs7detached#constructor_2)(Stream, string) | Initialise la nouvelle instance du[`PKCS7Detached`](../pkcs7detached) classe. |
| [PKCS7Detached](pkcs7detached#constructor_3)(string, string) | Initialise la nouvelle instance du[`PKCS7Detached`](../pkcs7detached) classe. |
