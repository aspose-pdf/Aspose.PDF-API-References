...
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Taille de police maximale pouvant être utilisée pour le contenu du champ. -1 pour ne pas vérifier la taille. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Taille de police minimale pouvant être utilisée pour le contenu du champ. -1 pour ne pas vérifier la taille. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Copie les sous-champs de ce champ dans le tableau à partir de l'index spécifié. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Importe les données dans les champs spécifiés à partir d'un flux JSON, en se basant sur une correspondance exacte des noms complets des champs. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Importe les données dans le champ spécifié à partir d'un flux JSON, en utilisant le nom complet indiqué dans la variable 'fieldFullNameInJSON' pour la correspondance. |
