---
title: "Classe ComboBoxField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Forms.ComboBoxField. Classe représentant le champ Combobox du formulaire"
type: docs
weight: 5120
url: /fr/net/aspose.pdf.forms/comboboxfield/
---
## ComboBoxField class

Classe représentant le champ Combobox du formulaire.
...
| Nom | Description |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Constructeur pour ComboBoxField à utiliser dans Generator. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Crée le champ CombBox pour fonctionner avec Generator. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Constructeur pour le champ Combobox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Constructeur pour le champ Combobox. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Obtient ou définit le statut modifiable du champ. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Obtient ou définit l'index de l'option sélectionnée. Cette propriété permet de modifier la sélection. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Obtient ou définit le statut de l'activité de vérification orthographique. |
