...
description: Classe représentant le champ Combobox du formulaire.
type: docs
weight: 2950
...
| [ComboBoxField](comboboxfield#constructor_1)(Document) | Crée un champ CombBox pour fonctionner avec Generator. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | Constructeur pour le champ Combobox. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | Constructeur pour Combobox Field. |
...
| virtual [Options](../../aspose.pdf.forms/choicefield/options) { get; } | Obtient une collection d'options de choix. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected) { get; set; } | Obtient ou définit l'index de l'option sélectionnée. Cette propriété permet de changer de sélection. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck) { get; set; } | Obtient ou définit le statut d'activité du correcteur orthographique. |
