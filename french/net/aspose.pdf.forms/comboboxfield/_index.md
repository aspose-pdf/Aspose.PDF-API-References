...
| Nom | Description |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Constructeur pour ComboBoxField à utiliser dans le générateur. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Crée un champ CombBox à utiliser avec le générateur. |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Obtient ou définit le statut éditable du champ. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Obtient ou définit le statut d'activité de vérification orthographique. |
