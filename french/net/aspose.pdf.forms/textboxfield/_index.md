...
description: Classe Aspose.Pdf.Forms.TextBoxField. Classe représentant un champ de zone de texte
type: docs
weight: 5320
...
Classe représentant un champ de zone de texte.
...
| Nom | Description |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Constructeur qui doit être utilisé avec le générateur. |
