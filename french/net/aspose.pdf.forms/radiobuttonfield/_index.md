...
description: "Aspose.Pdf.Forms.RadioButtonField class. Classe représentant le champ de bouton radio."
type: docs
weight: 5330
...
| [MultiSelect](../../aspose.pdf.forms/choicefield/multiselect/) { get; set; } | Obtient ou définit le drapeau de sélection multiple. |
| [Name](../../aspose.pdf.annotations/annotation/name/) { get; set; } | Obtient ou définit le nom de l'annotation sur la page. |
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Obtient ou définit le drapeau qui permet au bouton radio de ne pas avoir de valeur sélectionnée. Si `true`, exactement un bouton radio doit être sélectionné en permanence ; sélectionner le bouton actuellement sélectionné n’a aucun effet. Si `false`, cliquer sur le bouton sélectionné le désélectionne, laissant aucun bouton sélectionné. |
...
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Obtient l’indice de la page qui contient ce champ RadioButton. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Obtient ou définit l’indice de l’élément sélectionné. La numérotation des éléments commence à 1. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Obtient ou définit le tableau des éléments sélectionnés. Pour une liste à sélection multiple, le tableau contient plus d'un élément. Pour une liste à sélection unique, il contient un seul élément. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtient le dictionnaire d'apparence de l'annotation. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Style de la boîte du champ. |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Ajoute une option au bouton radion. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Ajoute une option au bouton radio avec le rectangle spécifié. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Déplace tous les sous‑éléments du bouton radio aux positions spécifiées sur la page. |
