...
description: Propriété du formulaire. Si elle est définie, le document contient des signatures qui peuvent être invalidées si le fichier est enregistré (écrit) d'une manière qui altère son contenu précédent, par opposition à une mise à jour incrémentielle.
type: docs
weight: 130
