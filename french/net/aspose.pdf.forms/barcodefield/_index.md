...
description: La classe représente le champ de code-barres.
type: docs
weight: 2900
...
| Nom | La description |
| --- | --- |
| [BarcodeField](barcodefield#constructor)(Document, Rectangle) | Initialise la nouvelle instance du[`BarcodeField`](../barcodefield) classe. |
| [BarcodeField](barcodefield#constructor_1)(Page, Rectangle) | Initialise la nouvelle instance du[`BarcodeField`](../barcodefield) classe. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology) { get; } | Spécifie la technologie de code à barres ou de glyphe à utiliser sur cette annotation, voir[`Symbology`](./symbology) pour plus de détails. |
