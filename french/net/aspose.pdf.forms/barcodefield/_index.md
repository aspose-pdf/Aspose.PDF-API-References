...
description: Classe Aspose.Pdf.Forms.BarcodeField. La classe représente un champ de code-barres
type: docs
weight: 4950
...
La classe représente un champ de code-barres.
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Obtient une valeur entière représentant le coefficient de correction d'erreur. Pour PDF417, doit être compris entre 0 et 8. Pour QRCode, doit être compris entre 0 et 3 (0 pour 'L', 1 pour 'M', 2 pour 'Q', et 3 pour 'H'). |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtient ou définit un drapeau qui indique si le champ est divisé en positions espacées. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Obtient ou définit le drapeau de multilignes du champ. Si Multiline est vrai, le champ peut contenir plusieurs lignes de texte. |
...
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtient ou définit le drapeau de vérification orthographique pour le champ. Si vrai, le champ sera vérifié pour l'orthographe. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtient le dictionnaire d'apparence de l'annotation. |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Spécifie quelle technologie de code-barres ou de glyphe doit être utilisée sur cette annotation, voir [`Symbology`](./symbology/) pour plus de détails. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Ajoute un code-barres 128 dans le champ. La valeur du champ sera changée en code et le champ deviendra en lecture seule. |
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage/)(Image) | Ajoute une image dans les ressources du champ et la dessine. |
