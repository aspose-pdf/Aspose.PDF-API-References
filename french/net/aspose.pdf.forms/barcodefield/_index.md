---
title: "Classe BarcodeField"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Forms.BarcodeField. Classe représentant le champ de code-barres."
type: docs
weight: 5070
url: /fr/net/aspose.pdf.forms/barcodefield/
---
## BarcodeField class
...
| Nom | Description |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | Initialise une nouvelle instance de la classe `BarcodeField`. |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | Initialise une nouvelle instance de la classe `BarcodeField`. |
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | Obtient ou définit les caractéristiques de bordure de l'annotation. [`Border`](../../aspose.pdf.annotations/annotation/border/) |
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Obtient la légende de l'objet code-barres. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Obtient une valeur entière représentant le coefficient de correction d'erreur. Pour PDF417, elle doit être comprise entre 0 et 8. Pour QRCode, elle doit être comprise entre 0 et 3 (0 pour 'L', 1 pour 'M', 2 pour 'Q' et 3 pour 'H'). |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtient ou définit le drapeau indiquant si le champ est divisé en positions espacées. |
...
| [IsSharedField](../../aspose.pdf.forms/field/issharedfield/) { get; set; } | Propriété pour la prise en charge du générateur. Utilisée lorsque le champ est ajouté à l'en-tête ou au pied de page. Si true, ce champ sera créé une fois et son apparence sera visible sur toutes les pages du document. Si false, un champ séparé sera créé pour chaque page du document. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Obtient ou définit le drapeau multiligne du champ. Si Multiline est vrai, le champ peut contenir plusieurs lignes de texte. |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Obtient la résolution, en points par pouce (dpi), à laquelle l'objet code-barres est rendu. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Obtient ou définit le drapeau défilable du champ. Si vrai, le champ peut être défilé. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtient ou définit le drapeau de vérification orthographique pour le champ. Si vrai, le champ doit être vérifié orthographiquement. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtient le dictionnaire d'apparence de l'annotation. |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Spécifie la technologie de code-barres ou de glyphe à utiliser sur cette annotation, voir [`Symbology`](./symbology/) pour plus de détails. |
| [SyncRoot](../../aspose.pdf.forms/field/syncroot/) { get; } | Objet de synchronisation. |
| [TabOrder](../../aspose.pdf.forms/field/taborder/) { get; set; } | Obtient ou définit l'ordre d'onglet du champ. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | Obtient la distance verticale entre deux modules de code-barres, mesurée en pixels. Le rapport XSymHeight/XSymWidth doit être une valeur entière. Pour PDF417, la plage de rapport acceptable est de 1 à 4. Pour QRCode et DataMatrix, ce rapport doit toujours être 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | Obtient la distance horizontale, en pixels, entre deux modules de code-barres. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Ajoute le code-barres 128 dans le champ. La valeur du champ sera remplacée par le code et le champ deviendra en lecture seule. |
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage/)(Image) | Ajoute une image aux ressources du champ et la dessine. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/)(WidgetAnnotation[], int) | Copie les sous-champs de ce champ dans le tableau à partir de l'index spécifié. |
...
| [ExportValueToJson](../../aspose.pdf.forms/field/exportvaluetojson/)(Stream, bool) | Exporte le contenu du champ spécifié dans un flux JSON. Les valeurs des champs bouton ne sont pas exportées. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Importe les données dans les champs spécifiés à partir d'un flux JSON, en se basant sur une correspondance exacte des noms complets des champs. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | Importe les données dans le champ spécifié à partir d'un flux JSON, en utilisant le nom complet indiqué dans la variable 'fieldFullNameInJSON' pour la correspondance. |
| [Recalculate](../../aspose.pdf.forms/field/recalculate/)() | Recalcule tous les champs calculés du formulaire. |
