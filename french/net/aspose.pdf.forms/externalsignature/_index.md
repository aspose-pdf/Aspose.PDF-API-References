...
| Nom | La description |
| --- | --- |
| [ExternalSignature](externalsignature)(X509Certificate2) | Crée une signature détachée PKCS#7Detached à l'aide d'un X509Certificate2. Il prend en charge les cartes à puce USB, les jetons sans clés privées exportables. |
...
| [Certificate](../../aspose.pdf.forms/externalsignature/certificate) { get; } | Le certificat avec la clé privée. |
