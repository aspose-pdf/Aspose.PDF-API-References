---
title: "Classe PdfAValidateOptions"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Plugins.PdfAValidateOptions. Représente les options de validation de la conformité PDF/A des documents PDF avec le plugin PdfAConverter"
type: docs
weight: 9180
url: /fr/net/aspose.pdf.plugins/pdfavalidateoptions/
---
## PdfAValidateOptions class

Représente les options de validation de la conformité PDF/A des documents PDF avec le plugin [`PdfAConverter`](../pdfaconverter/).
...
| Nom | Description |
| --- | --- |
| [PdfAValidateOptions](pdfavalidateoptions/)() | Le constructeur par défaut. |
