...
description: Classe Aspose.Pdf.Plugins.PdfAValidateOptions. Représente les options pour valider la conformité PDF/A des documents PDF avec le plugin PdfAConverter
type: docs
weight: 9030
...
Représente les options pour valider la conformité PDF/A des documents PDF avec le [`PdfAConverter`](../pdfaconverter/) plugin.
