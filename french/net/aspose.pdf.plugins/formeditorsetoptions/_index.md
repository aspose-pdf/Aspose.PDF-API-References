...
description: Classe Aspose.Pdf.Plugins.FormEditorSetOptions. Représente les options pour définir les propriétés des champs (pas des annotations)
type: docs
weight: 8660
...
| Nom | Description |
| --- | --- |
| [FormEditorSetOptions](formeditorsetoptions/)(SelectField, FormFieldSetOptions) | Initialise une nouvelle instance de l'objet `FormEditorSetOptions`, dans laquelle les valeurs assignées aux propriétés du champ sont spécifiées. |
