...
| Nom | Description |
| --- | --- |
| [SignOptions](signoptions/#constructor)(Stream, string) | Initialise une nouvelle instance de l'objet `SignOptions` avec les options par défaut. |
| [SignOptions](signoptions/#constructor_1)(string, string) | Initialise une nouvelle instance de l'objet `SignOptions` avec les options par défaut. |
...
| [Location](../../aspose.pdf.plugins/signoptions/location/) { get; set; } | Le lieu de la signature. |
...
| [PageNumber](../../aspose.pdf.plugins/signoptions/pagenumber/) { get; set; } | Le numéro de page sur lequel la signature est effectuée. |
