...
description: Classe Aspose.Pdf.Plugins.MergeOptions. Représente les options de fusion pour le plugin Merger
type: docs
weight: 8930
url: /fr/net/aspose.pdf.plugins/mergeoptions/
---
## Classe MergeOptions

Représente les options de fusion pour le plugin [`Merger`](../merger/).
...
| Nom | Description |
| --- | --- |
| [MergeOptions](mergeoptions/)() | Le constructeur par défaut. |
