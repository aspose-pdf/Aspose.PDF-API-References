---
title: "Classe FormEditorRemoveOptions"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Plugins.FormEditorRemoveOptions. Classe de base pour les classes d'options de suppression de champs dans le document par le plugin FormEditor"
type: docs
weight: 8780
url: /fr/net/aspose.pdf.plugins/formeditorremoveoptions/
---
## FormEditorRemoveOptions class

Classe de base pour les classes d'options de suppression de champs dans le document par le plugin [`FormEditor`](../formeditor/).
