...
| virtual [Position](../../aspose.pdf.vector/graphicelement/position/) { get; set; } | Obtient ou définit la position dans l'espace de coordonnées actuel. Si [`Parent`](./parent/) n'est pas !:null, alors l'élément possède un espace de coordonnées xForm. |
...
| [SaveToSvg](../../aspose.pdf.vector/graphicelement/savetosvg/#savetosvg_1)(string) | Convertit l'élément en un seul fichier image SVG. |
