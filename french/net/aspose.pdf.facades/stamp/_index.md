...
description: "Classe Aspose.Pdf.Facades.Stamp. Classe représentant le tampon"
type: docs
weight: 4840
...
| [IsBackground](../../aspose.pdf.facades/stamp/isbackground/) { get; set; } | Obtient ou définit le statut d'arrière-plan. Si true, le tampon sera placé en arrière-plan de la page estampillée. Par défaut, il est défini sur false. |
...
| [Pages](../../aspose.pdf.facades/stamp/pages/) { get; set; } | Obtient ou définit un tableau avec les numéros de pages qui seront affectés par le tampon. Si Pages = null, toutes les pages du document sont affectées. |
| [Quality](../../aspose.pdf.facades/stamp/quality/) { get; set; } | Obtient ou définit la qualité du tampon image en pourcentage. Valeurs valides 0..100%. |
...
| [SetImageSize](../../aspose.pdf.facades/stamp/setimagesize/)(float, float) | Définit la taille du tampon image. L'image sera mise à l'échelle selon les valeurs spécifiées. |
