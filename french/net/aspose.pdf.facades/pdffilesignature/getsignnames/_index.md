...
description: "PdfFileSignature method. Obtient les noms de toutes les signatures non vides"
type: docs
weight: 230
...
| --- | --- | --- |
| onlyActive | Boolean | si vrai, ne renvoie que les signatures actives ; sinon, renvoie toutes les signatures. |
