...
Ajoute les pages, choisies dans portFile dans la plage de startPage à endPage, dans portFile à la fin de firstInputFile.
...
Ajoute les pages, choisies dans portStream dans la plage de startPage à endPage, dans portStream à la fin de firstInputStream.
...
| startPage | Int32 | La page commence dans le flux portFile. |
| endPage | Int32 | La page se termine dans le flux portFile. |
