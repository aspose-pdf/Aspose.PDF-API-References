...
description: "Méthode TextFragmentCollection. Copie l'intégralité de la collection dans un tableau unidimensionnel compatible en commençant à l'index spécifié du tableau cible"
type: docs
weight: 90
url: /fr/net/aspose.pdf.text/textfragmentcollection/copyto/
---
...
| --- | --- | --- |
| tableau | TextFragment[] | Tableau d'objets qui seront copiés. |
