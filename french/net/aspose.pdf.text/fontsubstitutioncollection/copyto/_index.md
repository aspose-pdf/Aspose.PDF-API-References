...
description: "Méthode FontSubstitutionCollection. Copie l'intégralité de la collection dans un tableau unidimensionnel compatible en commençant à l'index spécifié du tableau cible"
type: docs
weight: 80
...
| --- | --- | --- |
| tableau | FontSubstitution[] | Tableau d'objets qui seront copiés. |
