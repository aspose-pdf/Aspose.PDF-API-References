...
description: Classe Aspose.Pdf.Annotations.HighlightAnnotation. Représente une annotation de surlignage qui met en évidence une plage de texte dans le document
type: docs
weight: 1870
...
| Nom | Description |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Crée une nouvelle annotation de surlignage sur la page spécifiée. |
...
| [GetMarkedText](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtext/)() | Obtient le texte sous l'annotation de surlignage sous forme de chaîne. |
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | Obtient le texte sous l'annotation de surlignage sous forme de [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/). |
