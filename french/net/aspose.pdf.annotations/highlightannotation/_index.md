...
description: Représente une annotation de surbrillance qui met en surbrillance une plage de texte dans le document.
type: docs
weight: 490
...
Représente une annotation de surbrillance qui met en surbrillance une plage de texte dans le document.
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | Obtient le type d'annotation. |
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
