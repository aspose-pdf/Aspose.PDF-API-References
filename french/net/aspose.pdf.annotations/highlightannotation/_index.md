...
description: "Aspose.Pdf.Annotations.HighlightAnnotation classe. Représente une annotation de surlignage qui met en évidence une plage de texte dans le document"
type: docs
weight: 1960
url: /fr/net/aspose.pdf.annotations/highlightannotation/
---
## HighlightAnnotation class

Représente une annotation de surlignage qui met en évidence une plage de texte dans le document.
...
| Nom | Description |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Crée une nouvelle annotation Highlight sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
