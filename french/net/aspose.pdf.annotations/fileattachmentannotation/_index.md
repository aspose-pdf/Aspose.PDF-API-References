...
description: Classe Aspose.Pdf.Annotations.FileAttachmentAnnotation. La classe décrit l'annotation de pièce jointe de fichier
type: docs
weight: 1710
url: /fr/net/aspose.pdf.annotations/fileattachmentannotation/
---
## Classe FileAttachmentAnnotation

La classe décrit l'annotation de pièce jointe de fichier.
...
| Nom | Description |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | Crée une nouvelle annotation de pièce jointe de fichier sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | La spécification du fichier associé à cette annotation. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Obtient ou définit l'icône qui doit être utilisée pour afficher l'annotation. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Obtient ou définit l'opacité de l'icône de 0 à 1 : 0 - complètement transparent, 1 - complètement opaque. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
