...
description: Classe Aspose.Pdf.Annotations.RegistrationMarkAnnotation. Représente une annotation de Marque d'Enregistrement
type: docs
weight: 2410
...
Représente une annotation de Marque d'Enregistrement.
...
| Nom | Description |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Initialise une nouvelle instance de la classe `RegistrationMarkAnnotation` sur la page donnée à l'emplacement donné. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Obtient ou définit la position de la marque d'enregistrement sur une page. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Accepte le visiteur pour le traitement de l'annotation. |
...
Les marques d'enregistrement sont des symboles ajoutés aux plaques ou écrans d'impression pour garantir un alignement correct des couleurs pendant le processus d'impression.
