...
description: "Aspose.Pdf.Annotations.RegistrationMarkAnnotation class. Représente une annotation de repère d'enregistrement"
type: docs
weight: 2500
url: /fr/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation class

Représente une annotation de repère d'enregistrement.
...
| Nom | Description |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Initialise une nouvelle instance de la classe `RegistrationMarkAnnotation` sur la page donnée à l'emplacement indiqué. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Obtient ou définit la position du repère d'enregistrement sur une page. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Accepte un visiteur pour le traitement de l'annotation. |
...
Les repères d'enregistrement sont des symboles ajoutés aux plaques d'impression ou aux écrans pour garantir un alignement correct des couleurs pendant le processus d'impression.
