...
description: Représente un gribouillis à main levée composé dun ou plusieurs chemins disjoints.
type: docs
weight: 540
...
Représente un "gribouillis" à main levée composé d'un ou plusieurs chemins disjoints.
...
| Nom | La description |
| --- | --- |
| [InkAnnotation](inkannotation#constructor)(Document, IList&lt;Point[]&gt;) | Constructeur pour l'annotation d'encre pour le générateur. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle) { get; set; } | Style des fins de ligne d'annotation manuscrite. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize)(Matrix) | Met à jour les points dans InkList, selon la transformation matricielle. |
