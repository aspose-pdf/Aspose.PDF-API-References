...
description: Classe Aspose.Pdf.Annotations.InkAnnotation. Représente un gribouillage à main levée composé d'un ou plusieurs chemins disjoints
type: docs
weight: 1920
url: /fr/net/aspose.pdf.annotations/inkannotation/
---
...
| Nom | Description |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Constructeur pour l'annotation Ink pour le générateur. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Crée une nouvelle annotation Ink sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Style des terminaisons de ligne de l'annotation Ink. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Obtient ou définit la liste des gestes qui sont des lignes indépendantes représentées par des tableaux Point[]. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Met à jour les points dans InkList, selon la transformation de matrice. |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | Définit l'état de révision pour une annotation. Les états Marqué et Non marqué sont ignorés car ils n'appartiennent pas au modèle d'état de révision. L'état est défini par l'utilisateur qui a créé l'annotation cible. La valeur est prise à partir de la propriété Title de l'annotation cible. Notez que l'état est stocké dans d'autres annotations de texte qui ont des clés d'état et de modèle d'état. |
