...
description: Représente une annotation de soulignement qui apparaît sous forme de soulignement dans le texte du document.
type: docs
weight: 1240
...
Représente une annotation de soulignement qui apparaît sous forme de soulignement dans le texte du document.
...
| Nom | La description |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | Crée une nouvelle annotation Souligné sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype) { get; } | Obtient le type d'annotation. |
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
