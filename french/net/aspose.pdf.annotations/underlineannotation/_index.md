...
description: "Classe Aspose.Pdf.Annotations.UnderlineAnnotation. Représente une annotation de soulignement qui apparaît comme un soulignement dans le texte du document"
type: docs
weight: 2800
url: /fr/net/aspose.pdf.annotations/underlineannotation/
---
## UnderlineAnnotation class

Représente une annotation de soulignement qui apparaît comme un soulignement dans le texte du document.
...
| Nom | Description |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | Crée une nouvelle annotation Underline sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
