...
description: "Aspose.Pdf.Annotations.TrimMarkAnnotation classe. Représente une annotation Trim Mark"
type: docs
weight: 2790
url: /fr/net/aspose.pdf.annotations/trimmarkannotation/
---
## TrimMarkAnnotation class

Représente une annotation de repère de coupe.
...
| Nom | Description |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | Initialise une nouvelle instance de la classe `TrimMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | Accepte un visiteur pour le traitement de l'annotation. |
...
Les repères de coupe sont placés aux coins d'une page imprimée pour indiquer où la page doit être découpée.
