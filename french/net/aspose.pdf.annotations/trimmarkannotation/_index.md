...
description: Classe Aspose.Pdf.Annotations.TrimMarkAnnotation. Représente une annotation de marque de coupe
type: docs
weight: 2690
...
Représente une annotation de marque de coupe.
...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | Accepte le visiteur pour le traitement de l'annotation. |
...
Les marques de coupe sont placées aux coins d'une page imprimée pour indiquer où la page doit être découpée.
