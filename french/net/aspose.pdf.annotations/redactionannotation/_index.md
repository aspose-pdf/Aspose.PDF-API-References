---
title: "Classe RedactionAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Aspose.Pdf.Annotations.RedactionAnnotation classe. Représente l'annotation de rédaction"
type: docs
weight: 2490
...
| Nom | Description |
| --- | --- |
| [RedactionAnnotation](redactionannotation/#constructor)(Document) | Constructeur pour RedactionAnnotation. À utiliser dans Generator. |
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [DefaultAppearance](../../aspose.pdf.annotations/redactionannotation/defaultappearance/) { get; set; } | Obtient ou définit la chaîne d'apparence par défaut à utiliser lors du formatage du texte. |
...
| [TextAlignment](../../aspose.pdf.annotations/redactionannotation/textalignment/) { get; set; } | Obtient ou définit l'alignement de Overlay Text. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | Aplati l'annotation, c.-à-d. supprime l'annotation et ajoute son |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | Aplati l'annotation et masque le contenu de la page (c.-à-d. supprime le texte et l'image sous l'annotation masquée) |
