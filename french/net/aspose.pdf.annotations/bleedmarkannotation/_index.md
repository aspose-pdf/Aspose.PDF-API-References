---
title: "Classe BleedMarkAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Annotations.BleedMarkAnnotation. Représente une annotation de marque de fond perdu"
type: docs
weight: 1590
...
Représente une annotation de repère de débordement.
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Accepte un visiteur pour le traitement de l'annotation. |
...
Les marques de fond perdu sont placées aux coins d’une page imprimée pour indiquer où la page doit être découpée et jusqu’à quel point elle peut s’écarter des repères de coupe.
