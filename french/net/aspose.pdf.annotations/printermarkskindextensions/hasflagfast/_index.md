...
| --- | --- | --- |
| value | PrinterMarksKind | La valeur actuelle de l'énumération [`PrinterMarksKind`](../../printermarkskind/). |
| flag | PrinterMarksKind | Le drapeau à vérifier. |

### Valeur de retour

`true` si le drapeau est inclus dans la valeur actuelle ; sinon, `false`.
