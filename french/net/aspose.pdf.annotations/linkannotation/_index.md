---
title: "Classe LinkAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Aspose.Pdf.Annotations.LinkAnnotation class. Représente soit un lien hypertexte vers une destination ailleurs dans le document, soit une action à effectuer."
type: docs
weight: 2100
...
| Nom | Description |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Page, Rectangle) | Crée une nouvelle annotation Link sur la page spécifiée. |

## Propriétés

| Nom | Description |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | Une action à effectuer lorsque l'annotation link est activée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | L'effet visuel à utiliser lorsque le bouton de la souris est enfoncé ou maintenu dans sa zone active. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
