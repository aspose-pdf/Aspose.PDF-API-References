...
| Nom | Description |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Constructeur à utiliser avec le générateur. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | Obtient ou définit le point de fin de la ligne. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Obtient ou définit le style de fin pour le point de fin de la ligne. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | Obtient ou définit la longueur de la ligne de leader. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | Obtient ou définit la longueur de l'extension de la ligne de leader. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Obtient ou définit le décalage de la ligne de leader. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Obtient ou définit un drapeau booléen qui détermine si le contenu doit être affiché comme légende. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Obtient ou définit le point de départ de la ligne. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Obtient ou définit le style de début de ligne pour le point de départ de la ligne. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Met à jour les points de départ et de fin, selon la transformation de matrice. |
