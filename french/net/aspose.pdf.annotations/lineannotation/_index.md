...
description: Classe représentant lannotation de ligne.
type: docs
weight: 600
...
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition) { get; set; } | Obtient ou définit la position de la légende d'annotation. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending) { get; set; } | Obtient ou définit le point de fin de ligne. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle) { get; set; } | Obtient ou définit le style de fin pour le point final de la ligne. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline) { get; set; } | Obtient ou définit la longueur de la ligne de repère. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension) { get; set; } | Obtient ou définit la longueur de l'extension de la ligne de repère. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset) { get; set; } | Obtient ou définit le décalage de la ligne de repère. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption) { get; set; } | Obtient ou définit un indicateur booléen qui détermine que le contenu doit être affiché en tant que légende. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting) { get; set; } | Obtient ou définit le point de départ de la ligne. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle) { get; set; } | Obtient ou définit le style de fin de ligne pour le point de départ de la ligne. |
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept)(AnnotationSelector) | Accepte le visiteur pour le traitement des annotations. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize)(Matrix) | Met à jour les points de début et de fin, selon la transformation matricielle. |
