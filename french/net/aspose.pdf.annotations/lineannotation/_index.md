---
title: "Classe LineAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.Annotations.LineAnnotation. Classe représentant une annotation de ligne"
type: docs
weight: 2070
url: /fr/net/aspose.pdf.annotations/lineannotation/
---
...
| Nom | Description |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Constructeur à utiliser avec Generator. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Crée une nouvelle annotation de ligne sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Obtient ou définit le décalage du texte de la légende par rapport à sa position normale. |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition/) { get; set; } | Obtient ou définit la position de la légende de l'annotation. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | Obtient ou définit le point final de la ligne. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Obtient ou définit le style de terminaison pour le point final de la ligne. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | Obtient ou définit l'intention de l'annotation de ligne. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor/) { get; set; } | Obtient ou définit la couleur intérieure de l'annotation. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | Obtient ou définit la longueur de la ligne directrice. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | Obtient ou définit la longueur de l'extension de la ligne directrice. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Obtient ou définit le décalage de la ligne directrice. |
...
| [Measure](../../aspose.pdf.annotations/lineannotation/measure/) { get; set; } | Unités de mesure spécifiées pour cette annotation. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Obtient ou définit le drapeau booléen qui détermine si le contenu doit être affiché comme légende. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Obtient ou définit le point de départ de la ligne. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Obtient ou définit le style de terminaison de ligne pour le point de départ. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept/)(AnnotationSelector) | Accepte le visiteur pour le traitement de l'annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Met à jour les points de départ et d'arrivée, selon la transformation matricielle. |
