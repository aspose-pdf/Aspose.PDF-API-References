...
description: Classe Aspose.Pdf.Annotations.CornerPrinterMarkAnnotation. Représente les types d'annotations qui sont placés dans les coins de la page imprimée
type: docs
weight: 1630
...
Représente les types d'annotations qui sont placés dans les coins de la page imprimée.
