...
description: "Aspose.Pdf.Annotations.PolygonAnnotation classe. Classe représentant une annotation de polygone"
type: docs
weight: 2400
...
Classe représentant l'annotation polygon.
...
| Nom | Description |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Constructeur à utiliser avec Generator. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Crée une nouvelle annotation Polygon sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour le traitement des annotations. |
