...
description: Classe Aspose.Pdf.Annotations.PolygonAnnotation. Classe représentant une annotation polygonale
type: docs
weight: 2310
url: /fr/net/aspose.pdf.annotations/polygonannotation/
---
## Classe PolygonAnnotation

Classe représentant une annotation polygonale.
...
| Nom | Description |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Document, Point[]) | Constructeur à utiliser avec le générateur. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Page, Rectangle, Point[]) | Crée une nouvelle annotation polygonale sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Obtient ou définit le style de la fin de la deuxième ligne. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Obtient ou définit l'intention de l'annotation polygonale ou polyligne. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Obtient ou définit la couleur intérieure avec laquelle remplir les extrémités de ligne de l'annotation. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Obtient ou définit le style de la première ligne de fin. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour le traitement de l'annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Met à jour les points dans Vertices, selon la transformation de la matrice. |
