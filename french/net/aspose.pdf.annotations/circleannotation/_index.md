...
description: "Aspose.Pdf.Annotations.CircleAnnotation classe. Classe représentant l'annotation Circle"
type: docs
weight: 1680
...
| Nom | Description |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Constructeur pour l'annotation Cercle. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
