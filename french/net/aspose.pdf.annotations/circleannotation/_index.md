...
description: Classe Aspose.Pdf.Annotations.CircleAnnotation. Classe représentant l'annotation Circle
type: docs
weight: 1590
...
Classe représentant l'annotation Circle.
...
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Crée une nouvelle annotation Circle sur la page spécifiée. |
...
| [IsFirstParagraphInColumn](../../aspose.pdf/baseparagraph/isfirstparagraphincolumn/) { get; set; } | Obtient ou définit une valeur booléenne indiquant si ce paragraphe sera dans la colonne suivante. Par défaut, c'est faux. (pour la génération de pdf) |
...
| [IsKeptWithNext](../../aspose.pdf/baseparagraph/iskeptwithnext/) { get; set; } | Obtient ou définit une valeur booléenne indiquant si le paragraphe actuel reste sur la même page que le paragraphe suivant. Par défaut, c'est faux. (pour la génération de pdf) |
