...
| [Item](../../aspose.pdf.annotations/appearancedictionary/item/) { get; set; } | Représente une forme pratique pour obtenir les flux d'apparence. |
| [Keys](../../aspose.pdf.annotations/appearancedictionary/keys/) { get; } | Obtient les clés du dictionnaire. Si le dictionnaire d'apparence possède des sous-dictionnaires, alors [`Keys`](./keys/) contient les valeurs (N&#x7C;R&#x7C;D).state, où N - apparence normale, R - apparence au survol, D - apparence enfoncée et state - le nom de l'état (par ex. On, Off pour les cases à cocher). |
| [SyncRoot](../../aspose.pdf.annotations/appearancedictionary/syncroot/) { get; } | Obtient un objet pouvant être utilisé pour synchroniser l'accès au dictionnaire. |
...
| Nom | Description |
| --- | --- |
| [Add](../../aspose.pdf.annotations/appearancedictionary/add/#add)(KeyValuePair&lt;string, XForm&gt;) | Ajoute une paire clé-valeur dans le dictionnaire. |
...
| [CopyTo](../../aspose.pdf.annotations/appearancedictionary/copyto/#copyto)(XForm[], int) | Copie les éléments du dictionnaire dans un tableau, en commençant à un indice de tableau particulier. |
