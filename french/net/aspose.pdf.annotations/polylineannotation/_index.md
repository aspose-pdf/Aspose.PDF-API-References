...
description: Classe Aspose.Pdf.Annotations.PolylineAnnotation. Représente une annotation polyline qui est similaire à un polygone, sauf que le premier et le dernier sommet ne sont pas implicitement connectés.
type: docs
weight: 2320
...
Représente une annotation polyline qui est similaire à un polygone, sauf que le premier et le dernier sommet ne sont pas implicitement connectés.
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Obtient ou définit l'intention de l'annotation polygonale ou polyline. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Obtient ou définit le style de la première fin de ligne. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Met à jour les points dans Vertices, selon la transformation de matrice. |
