---
title: "Classe StrikeOutAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation class. Représente une annotation de texte barré qui apparaît comme un texte barré dans le document"
type: docs
weight: 2730
...
Représente une annotation de barré qui apparaît comme un texte barré dans le document.
...
| Nom | Description |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | Crée une nouvelle annotation StrikeOut sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
