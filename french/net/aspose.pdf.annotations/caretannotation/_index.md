...
| Nom | Description |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Constructeur pour l'utilisation dans Generator. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Obtient ou définit le rectangle du caret. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
