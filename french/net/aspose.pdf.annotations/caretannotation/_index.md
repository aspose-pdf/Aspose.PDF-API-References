...
description: Classe Aspose.Pdf.Annotations.CaretAnnotation. Classe représentant l'annotation Caret
type: docs
weight: 1560
url: /fr/net/aspose.pdf.annotations/caretannotation/
---
## Classe CaretAnnotation

Classe représentant l'annotation Caret.
...
| Nom | Description |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Constructeur à utiliser dans le générateur. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Crée une nouvelle annotation Caret sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Obtient ou définit le rectangle de caret. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Obtient ou définit le symbole associé au caret. |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | Obtient ou définit une valeur entière indiquant l'ordre Z du graphique. Un graphique avec un ZIndex plus grand sera placé au-dessus du graphique avec un ZIndex plus petit. Le ZIndex peut être négatif. Un graphique avec un ZIndex négatif sera placé derrière le texte sur la page. |

## Méthodes

| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
