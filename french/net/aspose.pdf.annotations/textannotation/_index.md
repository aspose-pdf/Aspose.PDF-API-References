---
title: "Classe TextAnnotation"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Aspose.Pdf.Annotations.TextAnnotation classe. Représente une annotation texte qui est une note autocollante attachée à un point dans le document PDF."
type: docs
weight: 2750
...
Représente une annotation de texte qui est une « note autocollante » attachée à un point du document PDF.
...
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Crée une nouvelle annotation Text sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Obtient ou définit une icône à utiliser pour l'affichage de l'annotation. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Obtient ou définit un indicateur spécifiant si l'annotation doit être affichée ouverte initialement. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
