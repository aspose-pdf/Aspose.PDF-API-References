...
description: Représente une annotation de texte qui est une note autocollante attachée à un point dans le document PDF.
type: docs
weight: 1200
...
| Nom | La description |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | Constructeur pour l'annotation lorsqu'il est utilisé dans Generator. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open) { get; set; } | Obtient ou définit un indicateur spécifiant si l'annotation doit initialement être affichée ouverte. |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | Obtient ou définit l'état auquel l'annotation d'origine doit être définie. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | Met à jour les points de début et de fin, selon la transformation matricielle. |
