...
description: Classe Aspose.Pdf.Annotations.TextAnnotation. Représente une annotation de texte qui est une note autocollante attachée à un point dans le document PDF
type: docs
weight: 2650
url: /fr/net/aspose.pdf.annotations/textannotation/
---
## Classe TextAnnotation

Représente une annotation de texte qui est une 'note autocollante' attachée à un point dans le document PDF.
...
| Nom | Description |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Constructeur pour l'annotation lorsqu'elle est utilisée dans le générateur. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Crée une nouvelle annotation de texte sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Obtient ou définit une icône à utiliser pour afficher l'annotation. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Obtient ou définit un drapeau spécifiant si l'annotation doit être affichée initialement ouverte. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Remplace la définition dans la classe de base par un corps vide. |
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | Efface l'état et le modèle d'état de l'annotation. Par exemple, efface le statut de révision pour une annotation. Notez que l'état est stocké dans d'autres annotations de texte qui ont des clés d'état et de modèle d'état. |
