...
description: "Aspose.Pdf.Annotations.SquigglyAnnotation class. Représente l'annotation ondulée qui apparaît comme un soulignement irrégulier dans le texte d'un document"
type: docs
weight: 2700
...
Représente l'annotation ondulée qui apparaît comme un soulignement irrégulier dans le texte d'un document.
...
| Nom | Description |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Crée une nouvelle annotation ondulée sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Obtient le type de l'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Accepte un objet visiteur pour traiter l'annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textmarkupannotation/changeafterresize/)(Matrix) | Met à jour les QuadPoints, selon la transformation matricielle. |
...
| [GetMarkedText](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtext/)() | Obtient le texte sous l'annotation de balisage sous forme de chaîne. |
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | Obtient le texte sous l'annotation de balisage sous forme de [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/). |
