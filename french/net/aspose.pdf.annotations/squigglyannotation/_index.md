...
description: Classe Aspose.Pdf.Annotations.SquigglyAnnotation. Représente l'annotation squiggly qui apparaît comme un soulignement en zigzag dans le texte d'un document
type: docs
weight: 2600
url: /fr/net/aspose.pdf.annotations/squigglyannotation/
---
## Classe SquigglyAnnotation

Représente l'annotation squiggly qui apparaît comme un soulignement en zigzag dans le texte d'un document.
...
| Nom | Description |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Crée une nouvelle annotation Squiggly sur la page spécifiée. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Obtient le type d'annotation. |
...
| Nom | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Accepte l'objet visiteur pour traiter l'annotation. |
