...
description: Représente lannotation ondulée qui apparaît sous la forme dun soulignement irrégulier dans le texte dun document.
type: docs
weight: 1150
...
Représente l'annotation ondulée qui apparaît sous la forme d'un soulignement irrégulier dans le texte d'un document.
...
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments)() | Obtient le texte sous l'annotation de balisage comme[`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection) . |
