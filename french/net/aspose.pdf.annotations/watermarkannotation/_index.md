...
description: La classe décrit lobjet dannotation Watermark.
type: docs
weight: 1250
...
| Nom | La description |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Constructeur pour la classe d'annotations Watermark. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint) { get; } | Objet d'impression fusionné de l'annotation Watermark. |
...
| Nom | La description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Appliquer le visiteur pour l'annotation. |
