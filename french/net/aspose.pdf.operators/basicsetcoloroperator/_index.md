...
description: Classe Aspose.Pdf.Operators.BasicSetColorOperator. Classe de base pour les opérateurs de définition de couleur
type: docs
weight: 7160
...
Classe de base pour les opérateurs de définition de couleur.
