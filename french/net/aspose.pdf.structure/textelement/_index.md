...
description: "Classe Aspose.Pdf.Structure.TextElement. Élément texte général de la structure logique du document"
type: docs
weight: 10370
...
| [Text](../../aspose.pdf.structure/textelement/text/) { get; } | Obtient la valeur de l'élément de structure texte. |
