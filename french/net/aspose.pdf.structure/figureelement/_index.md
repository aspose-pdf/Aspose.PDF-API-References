...
description: "Classe Aspose.Pdf.Structure.FigureElement. Classe représentant la figure de la structure logique"
type: docs
weight: 10340
...
Classe représentant la figure de la structure logique.
...
| [Image](../../aspose.pdf.structure/figureelement/image/) { get; } | Obtient la valeur de l'élément de structure figure. |
