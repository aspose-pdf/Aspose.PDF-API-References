...
| Nom | Description |
| --- | --- |
| static [MatchTimeout](../../aspose.pdf/regexmanager/matchtimeout/) { get; set; } | Obtient ou définit le délai d'attente pour les opérations Regex dans toute la bibliothèque. La valeur par défaut est de 1000 ms. |
