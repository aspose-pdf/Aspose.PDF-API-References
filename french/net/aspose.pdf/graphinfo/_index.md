...
| Nom | Description |
| --- | --- |
| [GraphInfo](graphinfo/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [Color](../../aspose.pdf/graphinfo/color/) { get; set; } | Obtient ou définit un objet [`Color`](./color/) qui indique la couleur du graphique. |
...
| [FillColor](../../aspose.pdf/graphinfo/fillcolor/) { get; set; } | Obtient ou définit un objet [`Color`](./color/) qui indique la couleur de remplissage du graphique. |
| [IsDoubled](../../aspose.pdf/graphinfo/isdoubled/) { get; set; } | Obtient ou définit si la bordure est doublée. |
