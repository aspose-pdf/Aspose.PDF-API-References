...
Initialise une nouvelle instance de la classe [`InvalidPdfFileFormatException`](../).
...
Initialise une nouvelle instance de la classe [`InvalidPdfFileFormatException`](../) avec un message d'erreur spécifié et une référence à l'exception interne qui est la cause de cette exception.
...
Initialise une nouvelle instance de la classe [`InvalidPdfFileFormatException`](../) avec une référence à l'exception interne qui est la cause de cette exception.
