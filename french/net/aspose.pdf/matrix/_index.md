...
| Nom | Description |
| --- | --- |
| [A](../../aspose.pdf/matrix/a/) { get; set; } | Membre A de la matrice de transformation. |
...
| [Data](../../aspose.pdf/matrix/data/) { get; } | Obtient les données de la Matrix sous forme de tableau. |
...
| Nom | Description |
| --- | --- |
| static [Rotation](../../aspose.pdf/matrix/rotation/#rotation_1)(double) | Crée une matrice pour l'angle de rotation donné. |
| static [Rotation](../../aspose.pdf/matrix/rotation/#rotation)(Rotation) | Crée une matrice pour la rotation donnée. |
| static [Scale](../../aspose.pdf/matrix/scale/)(double, double, Matrix) | Applique un redimensionnement à la matrice donnée. |
| static [Skew](../../aspose.pdf/matrix/skew/)(double, double) | Crée une matrice pour l'angle de rotation donné. |
| static [Translate](../../aspose.pdf/matrix/translate/)(double, double, Matrix) | Déplace une matrice du montant spécifié dans les directions x et y. |
...
| [Transform](../../aspose.pdf/matrix/transform/#transform_1)(Rectangle) | Transforme le rectangle. Si l'angle n'est pas un multiple de 90 ° alors le rectangle englobant est renvoyé. |
...
| [UnScale](../../aspose.pdf/matrix/unscale/)(double, double, out double, out double) | Ramène x1 et y1 à l'échelle et renvoie x et y avant la transformation de la matrice en utilisant la formule suivante : x = (D * x1 - C * y1) / (A * D - C * B) ; y = (A * y1 - B * x1) / (A * D - C * B) ; |
| [UnTransform](../../aspose.pdf/matrix/untransform/)(double, double, out double, out double) | Ramène x1 et y1 et renvoie x et y avant la transformation de la matrice en utilisant la formule suivante : x = (D * x1 - C * y1 + C * F) / (A * D - C * B) ; y = (A * y1 - B * x1 + B * E) / (A * D - C * B). |
