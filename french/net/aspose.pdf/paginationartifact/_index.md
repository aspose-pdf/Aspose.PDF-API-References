...
description: "Aspose.Pdf.PaginationArtifact classe. Représente une classe de base abstraite pour les artefacts de pagination dans un document"
type: docs
weight: 8400
...
| [Subset](../../aspose.pdf/paginationartifact/subset/) { get; set; } | Obtient ou définit le sous‑ensemble de pages auquel l'artefact s'applique (par ex., toutes les pages, pages paires, pages impaires). |
