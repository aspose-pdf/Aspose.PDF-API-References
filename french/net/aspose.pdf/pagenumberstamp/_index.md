...
description: "Classe Aspose.Pdf.PageNumberStamp. Représente le tampon de numéro de page et est utilisé pour numéroter les pages."
type: docs
weight: 8370
...
Représente le tampon de numéro de page et est utilisé pour numéroter les pages.
...
| Nom | Description |
| --- | --- |
| [PageNumberStamp](pagenumberstamp/#constructor)() | Initialise une nouvelle instance de la classe `PageNumberStamp`. Le format est défini sur "#". |
| [PageNumberStamp](pagenumberstamp/#constructor_1)(FormattedText) | Crée un PageNumberStamp à partir d'un texte formaté. |
| [PageNumberStamp](pagenumberstamp/#constructor_2)(string) | Initialise une nouvelle instance de la classe `PageNumberStamp`. |
...
| [AutoAdjustFontSizeToFitStampRectangle](../../aspose.pdf/textstamp/autoadjustfontsizetofitstamprectangle/) { get; set; } | Si activé, la taille de la police sera automatiquement ajustée pour correspondre au rectangle du tampon de taille : [`Width`](../textstamp/width/) et [`Height`](../textstamp/height/). La largeur et la hauteur par défaut sont dérivées du rectangle de la page. |
...
| [Format](../../aspose.pdf/pagenumberstamp/format/) { get; set; } | Valeur de chaîne pour le tamponnage des numéros de page. La valeur doit inclure le caractère '#' qui est remplacé par le numéro de page lors du processus de tamponnage. |
...
| [StartingNumber](../../aspose.pdf/pagenumberstamp/startingnumber/) { get; set; } | Obtient ou définit la valeur du numéro de la page de départ. Les autres pages seront numérotées à partir de cette valeur. |
| [TextAlignment](../../aspose.pdf/textstamp/textalignment/) { get; set; } | Alignement du texte à l'intérieur du tampon. |
| [TextState](../../aspose.pdf/textstamp/textstate/) { get; } | Obtient les propriétés texte du tampon. Voir [`TextState`](../textstamp/textstate/) pour plus de détails. |
...
| override [Put](../../aspose.pdf/pagenumberstamp/put/)(Page) | Ajoute le numéro de page. |
