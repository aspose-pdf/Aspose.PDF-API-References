...
description: Classe Aspose.Pdf.PageNumberStamp. Représente un tampon de numéro de page et est utilisé pour numéroter les pages
type: docs
weight: 8230
...
Représente un tampon de numéro de page et est utilisé pour numéroter les pages.
...
| [PageNumberStamp](pagenumberstamp/#constructor_1)(FormattedText) | Crée un PageNumberStamp par texte formaté. |
...
| [Format](../../aspose.pdf/pagenumberstamp/format/) { get; set; } | Valeur de chaîne pour tamponner les numéros de page. La valeur doit inclure le caractère '#' qui est remplacé par le numéro de page lors du processus de tamponnage. |
...
| [TextState](../../aspose.pdf/textstamp/textstate/) { get; } | Obtient les propriétés du texte du tampon. Voir [`TextState`](../textstamp/textstate/) pour plus de détails. |
