...
description: Enregistrer les options dexportation au format TeX
type: docs
weight: 6590
...
Enregistrer les options d'exportation au format TeX
...
| [OutDirectoryPath](../../aspose.pdf/texsaveoptions/outdirectorypath) { get; set; } | Propriété pour_outDirectoryPath paramètre. |
...
| Nom | La description |
| --- | --- |
| [AddFontEncs](../../aspose.pdf/texsaveoptions/addfontencs)(params string[]) | Ajoute un codage de police à la liste de codage de police |
| [ClearFontEncs](../../aspose.pdf/texsaveoptions/clearfontencs)() | Efface la liste d'encodage des polices |
