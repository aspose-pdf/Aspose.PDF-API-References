...
Classe représentant l'objet PDF Artifact.
...
| Nom | Description |
| --- | --- |
| [Artifact](artifact/#constructor)(ArtifactType, ArtifactSubtype) | Constructeur de l'artifact avec le type et le sous-type spécifiés |
| [Artifact](artifact/#constructor_1)(string, string) | Constructeur de l'artifact avec le type et le sous-type spécifiés |
...
| enum [ArtifactType](../../aspose.pdf/artifact.artifacttype) | Énumération des types d'artefacts possibles. |
