...
description: Enregistrer les options pour le format PdfXml.
type: docs
weight: 6100
...
Enregistrer les options pour le format PdfXml.
...
| Nom | La description |
| --- | --- |
| [PdfXmlSaveOptions](pdfxmlsaveoptions)() | Default_Constructor |
