...
description: Classe Aspose.Pdf.BackgroundArtifact. La classe décrit l'artefact de fond. Cet artefact permet de définir l'arrière-plan de la page
type: docs
weight: 2810
...
La classe décrit l'artefact de fond. Cet artefact permet de définir l'arrière-plan de la page.
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | Obtient ou définit la couleur de fond de l'artefact de fond |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | Obtient ou définit l'image de fond de l'artefact de fond |
...
| [Subtype](../../aspose.pdf/artifact/subtype/) { get; set; } | Obtient le sous-type de l'artefact. Si l'artefact a un sous-type non standard, le nom du sous-type peut être lu via CustomSubtype. |
