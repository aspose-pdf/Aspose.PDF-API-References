...
description: La classe décrit lartefact darrière-plan. Cet artefact permet de définir larrière-plan de la page.
type: docs
weight: 1350
...
La classe décrit l'artefact d'arrière-plan. Cet artefact permet de définir l'arrière-plan de la page.
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor) { get; set; } | Obtient ou définit la couleur d'arrière-plan de l'artefact d'arrière-plan |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage) { get; set; } | Obtient ou définit l'image d'arrière-plan de l'artefact d'arrière-plan |
