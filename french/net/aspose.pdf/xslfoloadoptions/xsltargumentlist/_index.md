...
description: Propriété XslFoLoadOptions. XsltArgumentList pour insérer des valeurs dans des paramètres xls existants. Le fichier XLS a un paramètre 'animal' sans valeur. XsltArgumentList args = new XsltArgumentList(); args.AddParam("animal", "", "cat"); maintenant le convertisseur suppose qu'il y a un paramètre 'animal' avec la valeur 'cat' dans le fichier XLS.
type: docs
weight: 30
