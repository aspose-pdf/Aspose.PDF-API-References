...
description: Classe Aspose.Pdf.FooterArtifact. Décrit l'artefact de pied de page. Cela peut être utilisé pour définir le pied de page de la page
type: docs
weight: 4930
...
| Nom | Description |
| --- | --- |
| [FooterArtifact](footerartifact/)() | Crée une instance d'artefact de pied de page. |
