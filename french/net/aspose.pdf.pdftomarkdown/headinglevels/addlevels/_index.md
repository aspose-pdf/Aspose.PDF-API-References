...
| --- | --- | --- |
| fontSizes | ICollection`1 | Les valeurs doivent être triées par ordre décroissant. |

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentException | Si la valeur n'est pas triée ou si la valeur est inférieure à un. |
