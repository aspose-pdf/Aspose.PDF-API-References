...
description: "Classe Aspose.Pdf.AI.RunListResponse. Représente une réponse de liste contenant des données d'exécution"
type: docs
weight: 1080
url: /fr/net/aspose.pdf.ai/runlistresponse/
---
## RunListResponse class

Représente une réponse de liste contenant les données d'exécution.
...
| Nom | Description |
| --- | --- |
| [RunListResponse](runlistresponse/)() | Le constructeur par défaut. |
