...
description: "Classe Aspose.Pdf.AI.OpenAISummaryCopilotOptions. Représente les options de configuration du OpenAICopilot"
type: docs
weight: 1010
...
| [MaxPromptTokens](../../aspose.pdf.ai/openaisummarycopilotoptions/maxprompttokens/) { get; set; } | Obtient ou définit le nombre maximal de jetons d'invite pouvant être utilisés au cours de l'exécution. |
...
| static [Create](../../aspose.pdf.ai/openaisummarycopilotoptions/create/#create_1)(Action&lt;OpenAISummaryCopilotOptions&gt;) | Crée une instance de `OpenAISummaryCopilotOptions` et la configure en utilisant le délégué fourni. |
| [GetOptions](../../aspose.pdf.ai/openaisummarycopilotoptions/getoptions/)() | Obtient le `OpenAISummaryCopilotOptions` actuel. |
...
| [WithMaxCompletionTokens](../../aspose.pdf.ai/openaisummarycopilotoptions/withmaxcompletiontokens/)(int?) | Définit le nombre maximal de jetons de complétion pour les options du copilote de résumé. |
| [WithMaxPromptTokens](../../aspose.pdf.ai/openaisummarycopilotoptions/withmaxprompttokens/)(int?) | Définit le nombre maximal de jetons d'invite pour les options du copilote de résumé. |
