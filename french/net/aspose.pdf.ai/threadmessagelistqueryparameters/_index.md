...
description: "Classe Aspose.Pdf.AI.ThreadMessageListQueryParameters. Objet des paramètres de requête pour l'énumération des messages de fil"
type: docs
weight: 1220
...
Objet des paramètres de requête pour lister les messages du fil.
...
| [RunId](../../aspose.pdf.ai/threadmessagelistqueryparameters/runid/) { get; set; } | Filtre les messages par l'ID d'exécution qui les a générés. |

## Méthodes

| Nom | Description |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/threadmessagelistqueryparameters/getqueryparameters/)() | Obtient les paramètres de requête pour l'énumération des messages de fil. |
