...
description: Classe Aspose.Pdf.AI.RunStepListResponse. Représente une réponse de liste contenant des données d'étape d'exécution
type: docs
weight: 1050
url: /fr/net/aspose.pdf.ai/runsteplistresponse/
---
## Classe RunStepListResponse

Représente une réponse de liste contenant des données d'étape d'exécution.
...
| Nom | Description |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | Le constructeur par défaut. |
