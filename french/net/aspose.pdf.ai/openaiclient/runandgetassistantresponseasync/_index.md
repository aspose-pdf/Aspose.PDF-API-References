...
description: "Méthode OpenAIClient. Exécute l'assistant avec le threadId spécifié et runCreateRequest et récupère de manière asynchrone la réponse de l'assistant"
type: docs
weight: 450
