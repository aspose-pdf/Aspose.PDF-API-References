...
description: Méthode OpenAIClient. Crée un thread et un run à l'intérieur de celui-ci de manière asynchrone
type: docs
weight: 60
url: /fr/net/aspose.pdf.ai/openaiclient/createthreadandrunasync/
---
## Méthode OpenAIClient.CreateThreadAndRunAsync
