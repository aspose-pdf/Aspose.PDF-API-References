...
| [CreatedAt](../../aspose.pdf.ai/fileresponse/createdat/) { get; set; } | Obtient ou définit l'horodatage Unix (en secondes) du moment où le fichier a été créé. |
...
| [Object](../../aspose.pdf.ai/fileresponse/object/) { get; set; } | Obtient ou définit le type d'objet, qui est toujours file. |
| [Purpose](../../aspose.pdf.ai/fileresponse/purpose/) { get; set; } | Obtient ou définit le but prévu du fichier. Les valeurs prises en charge sont assistants, assistants_output, batch, batch_output, fine-tune, fine-tune-results et vision. |
