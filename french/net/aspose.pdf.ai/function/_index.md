...
| Nom | Description |
| --- | --- |
| [Function](function/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [Description](../../aspose.pdf.ai/function/description/) { get; set; } | Obtient ou définit une description de ce que fait la fonction, utilisée par le modèle pour choisir quand et comment appeler la fonction. |
