...
| --- | --- | --- |
| imageDescriptionCopilot | IImageDescriptionCopilot | Le copilote de description d'image. |
| outputDirectory | String | Le répertoire de sortie où enregistrer les fichiers PDF de sortie. |
