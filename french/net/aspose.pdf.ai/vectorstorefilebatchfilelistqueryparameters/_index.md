...
description: "Classe Aspose.Pdf.AI.VectorStoreFileBatchFileListQueryParameters. Objet de paramètres de requête pour lister les fichiers de lot du vector store."
type: docs
weight: 1380
...
Objet des paramètres de requête pour lister les fichiers du lot de fichiers du magasin vectoriel.
...
| [Filter](../../aspose.pdf.ai/vectorstorefilebatchfilelistqueryparameters/filter/) { get; set; } | Obtient ou définit un filtre par statut de fichier. L’une des valeurs : in_progress, completed, failed, cancelled. |
...
| Nom | Description |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorefilebatchfilelistqueryparameters/getqueryparameters/)() | Obtient les paramètres de requête pour lister les fichiers de lot du store. |
