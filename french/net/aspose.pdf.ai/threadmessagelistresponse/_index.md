...
description: Classe Aspose.Pdf.AI.ThreadMessageListResponse. Représente une réponse de liste contenant des données de message de fil
type: docs
weight: 1140
url: /fr/net/aspose.pdf.ai/threadmessagelistresponse/
---
## Classe ThreadMessageListResponse

Représente une réponse de liste contenant des données de message de fil.
