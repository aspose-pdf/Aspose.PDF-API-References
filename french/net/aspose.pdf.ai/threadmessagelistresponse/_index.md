---
title: "Classe ThreadMessageListResponse"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.AI.ThreadMessageListResponse. Représente une réponse de liste contenant les données des messages de fil."
type: docs
weight: 1230
url: /fr/net/aspose.pdf.ai/threadmessagelistresponse/
---
## ThreadMessageListResponse class

Représente une réponse de liste contenant les données des messages du fil.
...
| Nom | Description |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | Le constructeur par défaut. |
