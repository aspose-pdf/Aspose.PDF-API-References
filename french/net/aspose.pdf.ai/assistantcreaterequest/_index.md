...
description: "Aspose.Pdf.AI.AssistantCreateRequest classe. Objet de requête pour créer un assistant"
type: docs
weight: 100
url: /fr/net/aspose.pdf.ai/assistantcreaterequest/
---
## AssistantCreateRequest class

Objet de requête pour créer un assistant.
...
| Nom | Description |
| --- | --- |
| [AssistantCreateRequest](assistantcreaterequest/)() | Le constructeur par défaut. |
