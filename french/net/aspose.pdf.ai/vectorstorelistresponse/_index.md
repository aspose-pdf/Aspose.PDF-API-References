...
description: Classe Aspose.Pdf.AI.VectorStoreListResponse. Représente une réponse de liste contenant des données de magasin de vecteurs
type: docs
weight: 1370
url: /fr/net/aspose.pdf.ai/vectorstorelistresponse/
---
## Classe VectorStoreListResponse

Représente une réponse de liste contenant des données de magasin de vecteurs.
...
| Nom | Description |
| --- | --- |
| [VectorStoreListResponse](vectorstorelistresponse/)() | Le constructeur par défaut. |
