...
description: Représente lélément de structure TD dans la structure logique de la table.
type: docs
weight: 4640
url: /fr/net/aspose.pdf.logicalstructure/tabletdelement/
---
## TableTDElement class

Représente l'élément de structure TD dans la structure logique de la table.
...
| [Alignment](../../aspose.pdf.logicalstructure/tablecellelement/alignment) { get; set; } | Obtient ou définit l'alignement des cellules. |
...
| [DefaultCellTextState](../../aspose.pdf.logicalstructure/tablecellelement/defaultcelltextstate) { get; set; } | Obtient ou définit l'état du texte de cellule par défaut. |
...
| [IsNoBorder](../../aspose.pdf.logicalstructure/tablecellelement/isnoborder) { get; set; } | Obtient ou définit la bordure de la cellule. |
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped) { get; set; } | Obtient ou définit le mot de texte de la cellule enveloppé. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/tablecellelement/structuretextstate) { get; } | ObtientStructureTextState objet pour l'élément actuel. |
...
| [SetText](../../aspose.pdf.logicalstructure/tablecellelement/settext)(string) | Ajoute le contenu du texte à l'élément de texte actuel. |
