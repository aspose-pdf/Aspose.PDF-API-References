...
description: Représente lélément de structure de formulaire dans la structure logique.
type: docs
weight: 4180
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double) | Ajoute l'image à l'élément d'illustration actuel. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage)(string, double, double) | Ajoute l'image à l'élément d'illustration actuel. |
