...
description: Classe Aspose.Pdf.LogicalStructure.ILSElement. Représente une classe de base pour les éléments de structure de niveau en ligne dans la structure logique
type: docs
weight: 6390
