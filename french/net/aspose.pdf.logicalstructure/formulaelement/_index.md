...
description: Classe Aspose.Pdf.LogicalStructure.FormulaElement. Représente l'élément de structure de formule dans la structure logique
type: docs
weight: 6360
url: /fr/net/aspose.pdf.logicalstructure/formulaelement/
---
## Classe FormulaElement

Représente l'élément de structure de formule dans la structure logique.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double) | Ajoute une image à l'élément d'illustration actuel. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/)(string, double, double) | Ajoute une image à l'élément d'illustration actuel. |
