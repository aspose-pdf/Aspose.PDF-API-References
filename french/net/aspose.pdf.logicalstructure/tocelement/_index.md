...
description: Classe Aspose.Pdf.LogicalStructure.TOCElement. Représente un élément de structure de table des matières dans la structure logique
type: docs
weight: 6740
url: /fr/net/aspose.pdf.logicalstructure/tocelement/
---
## Classe TOCElement

Représente un élément de structure de table des matières dans la structure logique.
