...
description: Classe Aspose.Pdf.LogicalStructure.LinkElement. Représente l'élément de structure de lien dans la structure logique
type: docs
weight: 6440
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink/) { get; set; } | Obtient ou définit le lien hypertexte pour l'élément de lien. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/linkelement/structuretextstate/) { get; } | Obtient l'objet StructureTextState pour l'élément actuel. |
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XImage) | Lier un élément de structure à l'XImage. |
