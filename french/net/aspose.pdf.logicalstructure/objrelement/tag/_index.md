...
description: "Méthode OBJRElement. Lier un élément de structure au flux de contenu opérateur BDC"
type: docs
weight: 10
url: /fr/net/aspose.pdf.logicalstructure/objrelement/tag/
---
## Tag(BDC) {#tag_1}
...
| --- | --- | --- |
| bdc | BDC | Opérateur bdc du flux de contenu. |

### Valeur de retour

Élément MCRElementStructure.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| annotation | Annotation | Annotation Pdf. |
