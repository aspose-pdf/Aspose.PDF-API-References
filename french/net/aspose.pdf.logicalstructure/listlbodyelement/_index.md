...
description: Classe Aspose.Pdf.LogicalStructure.ListLBodyElement. Représente l'élément de structure LBody dans la structure logique de la liste
type: docs
weight: 6470
url: /fr/net/aspose.pdf.logicalstructure/listlbodyelement/
---
## Classe ListLBodyElement

Représente l'élément de structure LBody dans la structure logique de la liste.
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XImage) | Lie un élément de structure à l'XImage. |
| override [ToString](../../aspose.pdf.logicalstructure/structureelement/tostring/)() | Renvoie une chaîne qui représente l'objet actuel. |

### Voir aussi

* classe [ListChildElement](../listchildelement/)
