...
description: Classe Aspose.Pdf.LogicalStructure.ILSTextElement. Représente une classe de base pour les éléments de structure de texte en ligne dans la structure logique
type: docs
weight: 6400
...
Représente une classe de base pour les éléments de structure de texte en ligne dans la structure logique.
