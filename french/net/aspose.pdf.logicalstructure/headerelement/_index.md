...
description: Classe Aspose.Pdf.LogicalStructure.HeaderElement. Représente l'élément de structure d'en-tête dans la structure logique
type: docs
weight: 6380
url: /fr/net/aspose.pdf.logicalstructure/headerelement/
---
## Classe HeaderElement

Représente l'élément de structure d'en-tête dans la structure logique.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | Obtient l'objet StructureTextState pour l'élément actuel. |
...
| [SetTag](../../aspose.pdf.logicalstructure/structureelement/settag/)(string) | Définit une étiquette personnalisée pour l'élément de structure. |
