...
description: Représente une classe de base pour les éléments de structure de texte au niveau du bloc dans la structure logique.
type: docs
weight: 4080
...
Représente une classe de base pour les éléments de structure de texte au niveau du bloc dans la structure logique.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate) { get; } | ObtientStructureTextState objet pour l'élément actuel. |
...
| [SetText](../../aspose.pdf.logicalstructure/blstextelement/settext)(string) | Ajoute le contenu du texte à l'élément de texte actuel. |
