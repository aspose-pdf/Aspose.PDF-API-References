...
description: Classe Aspose.Pdf.LogicalStructure.BLSTextElement. Représente une classe de base pour les éléments de structure de texte de niveau bloc dans la structure logique
type: docs
weight: 6250
