...
description: Représente une classe de base pour les éléments enfants de la table dans une structure logique.
type: docs
weight: 4600
...
Représente une classe de base pour les éléments enfants de la table dans une structure logique.
