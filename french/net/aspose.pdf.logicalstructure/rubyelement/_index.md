...
description: Classe Aspose.Pdf.LogicalStructure.RubyElement. Représente un élément de structure Ruby dans la structure logique
type: docs
weight: 6600
...
Représente un élément de structure Ruby dans la structure logique.
