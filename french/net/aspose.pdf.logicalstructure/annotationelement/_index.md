...
description: Classe Aspose.Pdf.LogicalStructure.AnnotationElement. Représente une classe de base pour les éléments de structure d'annotation dans la structure logique
type: docs
weight: 6190
url: /fr/net/aspose.pdf.logicalstructure/annotationelement/
---
## Classe AnnotationElement

Représente une classe de base pour les éléments de structure d'annotation dans la structure logique.
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(XImage) | Lien d'un élément de structure à l'XImage. |
