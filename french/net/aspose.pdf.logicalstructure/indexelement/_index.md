...
description: Classe Aspose.Pdf.LogicalStructure.IndexElement. Représente l'élément de structure d'index dans la structure logique
type: docs
weight: 6430
...
Représente l'élément de structure d'index dans la structure logique.
