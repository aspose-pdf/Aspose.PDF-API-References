...
description: Classe Aspose.Pdf.LogicalStructure.NonStructElement. Représente un élément de structure NonStruct dans la structure logique
type: docs
weight: 6510
url: /fr/net/aspose.pdf.logicalstructure/nonstructelement/
---
## Classe NonStructElement

Représente un élément de structure NonStruct dans la structure logique.
