...
description: Classe Aspose.Pdf.LogicalStructure.ListChildElement. Représente une classe de base pour les éléments enfants de la Liste dans la structure logique
type: docs
weight: 6450
url: /fr/net/aspose.pdf.logicalstructure/listchildelement/
---
## Classe ListChildElement

Représente une classe de base pour les éléments enfants de la Liste dans la structure logique.
