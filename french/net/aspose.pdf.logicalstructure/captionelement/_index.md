...
description: Classe Aspose.Pdf.LogicalStructure.CaptionElement. Représente l'élément de structure de légende dans la structure logique
type: docs
weight: 6280
url: /fr/net/aspose.pdf.logicalstructure/captionelement/
---
## Classe CaptionElement

Représente l'élément de structure de légende dans la structure logique.
