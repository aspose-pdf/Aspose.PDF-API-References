...
description: Classe Aspose.Pdf.LogicalStructure.ReferenceElement. Représente l'élément de structure de référence dans la structure logique
type: docs
weight: 6580
url: /fr/net/aspose.pdf.logicalstructure/referenceelement/
---
## Classe ReferenceElement

Représente l'élément de structure de référence dans la structure logique.
