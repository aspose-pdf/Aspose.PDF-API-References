...
description: Classe Aspose.Pdf.LogicalStructure.CodeElement. Représente un élément de structure de code dans la structure logique
type: docs
weight: 6290
...
Représente un élément de structure de code dans la structure logique.
