...
description: Classe Aspose.Pdf.LogicalStructure.TableRowCollectionElement. Représente une classe de base pour les éléments enfants de l'en-tête, du corps et du pied de table dans la structure logique
type: docs
weight: 6790
url: /fr/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## Classe TableRowCollectionElement

Représente une classe de base pour les éléments enfants de l'en-tête, du corps et du pied de table dans la structure logique.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | Crée [`TableTRElement`](../tabletrelement/) et l'ajoute à la table actuelle. |
