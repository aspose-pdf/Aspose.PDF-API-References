...
description: Représente une classe de base pour les éléments enfants de la tête du corps et du pied de table dans une structure logique.
type: docs
weight: 4620
...
Représente une classe de base pour les éléments enfants de la tête, du corps et du pied de table dans une structure logique.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | Crée[`TableTRElement`](../tabletrelement) et l'a ajouté à la table actuelle. |
