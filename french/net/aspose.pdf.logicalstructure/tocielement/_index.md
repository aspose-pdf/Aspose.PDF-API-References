...
description: Classe Aspose.Pdf.LogicalStructure.TOCIElement. Représente un élément de structure TOCI dans la structure logique
type: docs
weight: 6750
...
Représente un élément de structure TOCI dans la structure logique.
