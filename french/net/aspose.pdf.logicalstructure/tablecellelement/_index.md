...
description: Classe Aspose.Pdf.LogicalStructure.TableCellElement. Représente une classe de base pour les éléments de cellule de tableau TH et TD dans la structure logique
type: docs
weight: 6760
...
| override [Tag](../../aspose.pdf.logicalstructure/structureelement/tag/)(Artifact) | Lie un élément de structure à l'artéfact. |
