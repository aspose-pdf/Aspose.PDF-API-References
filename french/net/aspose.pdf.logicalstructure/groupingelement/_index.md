---
title: "Classe GroupingElement"
second_title: "Référence de l'API Aspose.PDF pour .NET"
description: "Classe Aspose.Pdf.LogicalStructure.GroupingElement. Représente une classe de base pour les éléments de structure de regroupement dans la structure logique"
type: docs
weight: 6510
url: /fr/net/aspose.pdf.logicalstructure/groupingelement/
---
## GroupingElement class

Représente une classe de base pour regrouper les éléments de structure dans la structure logique.
