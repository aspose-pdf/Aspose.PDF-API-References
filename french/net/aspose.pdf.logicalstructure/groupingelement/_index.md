...
description: Classe Aspose.Pdf.LogicalStructure.GroupingElement. Représente une classe de base pour regrouper des éléments de structure dans une structure logique
type: docs
weight: 6370
...
Représente une classe de base pour regrouper des éléments de structure dans une structure logique.
