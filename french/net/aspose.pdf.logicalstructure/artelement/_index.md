...
description: Classe Aspose.Pdf.LogicalStructure.ArtElement. Représente un élément de structure Art dans la structure logique
type: docs
weight: 6200
...
Représente un élément de structure Art dans la structure logique.
