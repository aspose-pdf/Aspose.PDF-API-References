...
description: Classe Aspose.Pdf.LogicalStructure.BlockQuoteElement. Représente l'élément de structure BlockQuote dans la structure logique
type: docs
weight: 6270
url: /fr/net/aspose.pdf.logicalstructure/blockquoteelement/
---
## Classe BlockQuoteElement

Représente l'élément de structure BlockQuote dans la structure logique.
