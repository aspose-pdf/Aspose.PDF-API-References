...
description: "Crypter le PDF-document."
type: docs
url: /fr/go-cpp/security/encrypt/
---

_Chiffrer le document PDF._
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) chiffre le document PDF
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
