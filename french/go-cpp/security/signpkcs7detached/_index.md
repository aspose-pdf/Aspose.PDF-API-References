...
type: docs
url: /fr/go-cpp/security/signpkcs7detached/
---

_Signer un document PDF en utilisant des signatures numériques PKCS#7 détachées._
...
func main() {
	...
	// SignPKCS7Detached signe un document PDF en utilisant des signatures numériques PKCS#7 détachées
