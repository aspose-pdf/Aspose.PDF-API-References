...
type: docs
url: /fr/go-cpp/security/signpkcs7/
---

_Signer un document PDF en utilisant des signatures numériques PKCS#7._
...
func main() {
	...
	// SignPKCS7 signe un document PDF en utilisant des signatures numériques PKCS#7
