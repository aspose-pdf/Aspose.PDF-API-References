...
description: "Définir la taille de la page."
type: docs
url: /fr/go-cpp/organize/pagesetsize/
---

_Définir la taille de la page._
...
func main() {
	...
	defer pdf.Close()
	// PageSetSize(num int32, pageSize int32) définit la taille de la page
