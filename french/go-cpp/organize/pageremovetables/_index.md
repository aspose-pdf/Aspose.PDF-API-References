...
description: "Supprimer les tableaux de la page."
type: docs
url: /fr/go-cpp/organize/pageremovetables/
---

_Supprimer les tables dans la page._
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveTables(num int32) supprime les tables dans la page
