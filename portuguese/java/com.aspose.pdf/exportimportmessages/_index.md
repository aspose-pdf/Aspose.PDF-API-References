...
description: "Contém várias mensagens de erro para operações de exportação e importação de campos de formulário."
type: docs
weight: 1330
url: /pt/java/com.aspose.pdf/exportimportmessages/
---
**Inheritance:**
...
Contém várias mensagens de erro para operações de exportação e importação de campos de formulário.
