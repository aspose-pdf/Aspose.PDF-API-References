...
description: "Esta classe é usada para selecionar operadores usando a ideia de modelo Visitor."
type: docs
weight: 3200
url: /pt/java/com.aspose.pdf/operatorselector/
---
**Inheritance:**
...
Esta classe é usada para selecionar operadores usando a ideia de modelo Visitor.

## Construtores

| Construtor | Descrição |
| --- | --- |
| [OperatorSelector](#OperatorSelector--) | Inicializa uma nova instância da classe {@code Selector}. |
| [OperatorSelector](#OperatorSelector-com.aspose.pdf.Operator-) | Inicializa uma nova instância da classe {@code Selector}. |
...
Inicializa uma nova instância da classe {@code Selector}.
