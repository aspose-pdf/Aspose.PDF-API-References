...
description: "Remover cabeçalhos de texto na página."
type: docs
url: /pt/go-cpp/organize/pageremovetextheaders/
---

_Remover cabeçalhos de texto na página._
...
func main() {
        ...
        defer pdf.Close()
        // PageRemoveTextHeaders(num int32) remove cabeçalhos de texto na página
