...
description: "Validar um PDF-documento para conformidade com o formato PDF."
type: docs
url: /pt/go-cpp/organize/validate/
---

_Valide um PDF-document para conformidade com o formato PDF._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) valida PDF-document para conformidade PDF/A
	ok, logStr, err := pdf.Validate(asposepdf.PDF_A_2A)
	if err != nil {
		log.Fatal("Validate PDF/A error:", err)
	}

	// Imprima o resultado da validação e o log completo
