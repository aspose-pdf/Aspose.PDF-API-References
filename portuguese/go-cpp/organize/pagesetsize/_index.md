...
description: "Definir tamanho da página."
type: docs
url: /pt/go-cpp/organize/pagesetsize/
---

_Define o tamanho da página._
...
func main() {
	...
	defer pdf.Close()
	// PageSetSize(num int32, pageSize int32) define o tamanho da página
