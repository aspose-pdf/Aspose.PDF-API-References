...
description: "Remover anotações na página."
type: docs
url: /pt/go-cpp/organize/pageremoveannotations/
---

_Remover anotações na página._
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveAnnotations(num int32) remove anotações na página
