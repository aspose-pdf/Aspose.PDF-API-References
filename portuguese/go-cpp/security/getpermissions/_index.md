...
description: "Obtém permissões para documento PDF."
type: docs
url: /pt/go-cpp/security/getpermissions/
---

_Obtém permissões para documento PDF._
...
func main() {
	...
	defer pdf.Close()
	// GetPermissions() obtém as permissões atuais do documento PDF
