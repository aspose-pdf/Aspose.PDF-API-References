...
description: "Classe representando o operador f* (preencher caminho usando a regra par‑impar)."
type: docs
weight: 230
url: /pt/python-net/aspose.pdf.operators/eofill/
---

## EOFill class

Classe representando o operador f* (preencher caminho usando a regra par‑impar).

O tipo EOFill expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| EOFill() | Inicializa o operador. |
## Propriedades
| Nome | Descrição |
| :- | :- |
