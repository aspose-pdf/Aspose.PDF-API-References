...
description: "Classe que representa o campo de caixa de seleção."
type: docs
weight: 30
url: /pt/python-net/aspose.pdf.forms/checkboxfield/
---

## CheckboxField class

Classe que representa o campo de caixa de seleção.

O tipo CheckboxField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| CheckboxField(page, rect) | Inicializa uma nova instância da classe **CheckboxField** |
| CheckboxField(doc, rect) | Inicializa uma nova instância da classe **CheckboxField** |
| CheckboxField() | Criar instância de **CheckboxField**. |
| CheckboxField(doc) | Inicializa uma nova instância da classe **CheckboxField** |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| valor | Obtém ou define o valor do campo de caixa de seleção. |
...
| allowed_states | Retorna a lista de estados permitidos. |
| style | Obtém ou define o estilo da caixa de seleção. |
| checked | Obtém ou define o estado da caixa de seleção. |
| export_value | Obtém ou define o valor de exportação do campo CheckBox. |
## Indexer
| Nome | Descrição |
| :- | :- |
...
| Nome | Descrição |
| :- | :- |
| clone() | Clona a caixa de seleção. |
