...
description: "Classe que representa o campo de botão de opção."
type: docs
weight: 220
url: /pt/python-net/aspose.pdf.forms/radiobuttonfield/
---

## RadioButtonField class

Classe que representa o campo de botão de opção.

O tipo RadioButtonField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| RadioButtonField(page) | Inicializa uma nova instância da classe RadioButtonField |
| RadioButtonField(doc) | Inicializa uma nova instância da classe RadioButtonField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| aparência | Nenhum |
| índice_da_página | Obtém o índice da página que contém este campo RadioButton. |
| ao_ativar | Nenhum |
| realce | Nenhum |
| pai | Nenhum |
...
| selecionado | Obtém ou define o índice do item selecionado. A numeração dos itens começa em 1. |
...
| opções | Obtém a coleção de opções do botão de rádio. |
| style | Estilo da caixa de campo. |
## Indexer
| Nome | Descrição |
| :- | :- |
...
| Nome | Descrição |
| :- | :- |
| add_option(option_name, rect) | Adicionar à opção de botão de rádio com retângulo especificado. |
| add_option(option_name) | Adicionar à opção de botão de rádio com retângulo especificado. |
| add_option(export, name) | Adicionar à opção de botão de rádio com retângulo especificado. |
| clone() | Nenhum |
...
| set_position(point) | Mover todos os subitens do botão de rádio para posições especificadas na página. |
| delete_option(option_name) | Exclui a opção pelo seu nome. |
| add(new_item) | Adiciona novo campo de opção ao campo RadioButton. |
