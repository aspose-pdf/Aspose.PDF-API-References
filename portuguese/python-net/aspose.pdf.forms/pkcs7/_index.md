...
description: "Representa o objeto PKCS#7 que está em conformidade com a especificação PKCS#7 no RFC 2315 da Internet, <br/>            PKCS #7: Sintaxe de Mensagem Criptográfica, Versão 1.5.<br/>            O digest SHA1 do intervalo de bytes do documento é encapsulado no campo SignedData do PKCS#7."
type: docs
weight: 190
url: /pt/python-net/aspose.pdf.forms/pkcs7/
---

## PKCS7 class

Representa o objeto PKCS#7 que está em conformidade com a especificação PKCS#7 no RFC 2315 da Internet, <br/>            PKCS #7: Sintaxe de Mensagem Criptográfica, Versão 1.5.<br/>            O digest SHA1 do intervalo de bytes do documento é encapsulado no campo SignedData do PKCS#7.

O tipo PKCS7 expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| PKCS7() | Inicializa nova instância da classe [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) |
| PKCS7(pfx, password) | Inicializa uma nova instância da classe PKCS7 |
| PKCS7(pfx, password) | Inicializa uma nova instância da classe PKCS7 |
## Propriedades
| Nome | Descrição |
| :- | :- |
