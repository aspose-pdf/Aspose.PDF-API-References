...
description: "Classe descreve campo de texto para inserção de senha."
type: docs
weight: 210
url: /pt/python-net/aspose.pdf.forms/passwordboxfield/
---

## PasswordBoxField class

Classe descreve campo de texto para inserção de senha.

O tipo PasswordBoxField expõe os seguintes membros:
## Propriedades
| Nome | Descrição |
| :- | :- |
