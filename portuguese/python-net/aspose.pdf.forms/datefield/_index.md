...
description: "Campo de data com visualização de calendário."
type: docs
weight: 60
url: /pt/python-net/aspose.pdf.forms/datefield/
---
...
O tipo DateField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| DateField() | Inicializa uma nova instância de [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Inicializa uma nova instância da classe DateField |
| DateField(page, rect) | Inicializa uma nova instância da classe DateField |
| DateField(doc, rect) | Inicializa uma nova instância da classe DateField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| date_format | Obtém ou define o formato da data. |
## Indexer
| Nome | Descrição |
| :- | :- |
...
| Nome | Descrição |
| :- | :- |
| add_image(image) | Adição de imagem negada para este campo. |
| add_image(image) | Adição de imagem negada para este campo. |
| clone() | Nenhum |
...
| init(page) | Inicializa a ação JS. |
