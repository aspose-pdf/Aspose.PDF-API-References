...
description: "Representa o objeto de assinatura de acordo com o padrão PKCS#1.<br/>            O algoritmo de criptografia RSA e o método de digestão SHA-1 são usados para assinatura."
type: docs
weight: 180
url: /pt/python-net/aspose.pdf.forms/pkcs1/
---

## PKCS1 class

Representa o objeto de assinatura de acordo com o padrão PKCS#1.<br/>            O algoritmo de criptografia RSA e o método de digestão SHA-1 são usados para assinatura.

O tipo PKCS1 expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| PKCS1(image) | Inicializa uma nova instância da classe PKCS1 |
| PKCS1() | Inicializa uma nova instância da classe [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/). |
| PKCS1(pfx, password) | Inicializa uma nova instância da classe PKCS1 |
| PKCS1(pfx, password) | Inicializa uma nova instância da classe PKCS1 |
## Propriedades
| Nome | Descrição |
| :- | :- |
