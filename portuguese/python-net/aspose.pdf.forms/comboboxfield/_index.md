...
description: "Classe que representa o campo Combobox do formulário."
type: docs
weight: 50
url: /pt/python-net/aspose.pdf.forms/comboboxfield/
---
...
O tipo ComboBoxField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| ComboBoxField() | Construtor para ComboBoxField a ser usado no Generator. |
| ComboBoxField(doc) | Inicializa uma nova instância da classe ComboBoxField |
| ComboBoxField(page, rect) | Inicializa uma nova instância da classe ComboBoxField |
| ComboBoxField(doc, rect) | Inicializa uma nova instância da classe ComboBoxField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| editável | Obtém ou define o status editável do campo. |
| spell_check | Obtém ou define o status da atividade de verificação ortográfica. |
## Indexer
| Nome | Descrição |
| :- | :- |
