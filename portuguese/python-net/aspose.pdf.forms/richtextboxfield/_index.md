...
description: "Classe descreve o componente de editor de texto rico."
type: docs
weight: 240
url: /pt/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Classe descreve o componente de editor de texto rico.

O tipo RichTextBoxField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| RichTextBoxField(page, rect) | Inicializa uma nova instância da classe RichTextBoxField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| style | Obtém ou define a string de estilo padrão do campo de texto rico. |
| rich_text_value | Obtém ou define o valor do texto rico. |
| formatted_value | Obtém ou define o valor formatado de texto rico com marcação. |
| justify | Obtém ou define o alinhamento da caixa de texto rico. |
## Indexer
| Nome | Descrição |
| :- | :- |
