...
type: docs
weight: 280
url: /pt/python-net/aspose.pdf.forms/textboxfield/
---
...
O tipo TextBoxField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| TextBoxField(doc) | Inicializa uma nova instância da classe TextBoxField |
| TextBoxField() | Cria uma instância de TextBoxField. |
| TextBoxField(page, rect) | Inicializa uma nova instância da classe TextBoxField |
| TextBoxField(doc, rect) | Inicializa uma nova instância da classe TextBoxField |
## Propriedades
| Nome | Descrição |
| :- | :- |
