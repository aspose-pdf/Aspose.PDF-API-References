...
description: "Classe que representa o item do campo RadioButton."
type: docs
weight: 230
url: /pt/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---

## RadioButtonOptionField class

Classe que representa o item do campo RadioButton.

O tipo RadioButtonOptionField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| RadioButtonOptionField() | Cria uma nova instância de RadioButtonOptionField. |
| RadioButtonOptionField(page, rect) | Inicializa uma nova instância da classe RadioButtonOptionField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| option_name | Obtém ou define o nome da opção. |
| caption | Obtém ou define a legenda. |
