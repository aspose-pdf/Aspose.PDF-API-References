...
description: "Campo de texto com caracteres válidos especificados"
type: docs
weight: 150
url: /pt/python-net/aspose.pdf.forms/numberfield/
---
...
O tipo NumberField expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| NumberField() | Inicializa uma nova instância da classe [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/). |
| NumberField(page, rect) | Inicializa uma nova instância da classe NumberField |
| NumberField(doc, rect) | Inicializa uma nova instância da classe NumberField |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| allowed_chars | Obtém ou define os caracteres permitidos. |
## Indexer
| Nome | Descrição |
| :- | :- |
