...
description: "Opções de salvamento para exportação para o formato Xml"
type: docs
weight: 960
url: /pt/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
O tipo MobiXmlSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| MobiXmlSaveOptions() | Inicializa uma nova instância da classe MobiXmlSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
