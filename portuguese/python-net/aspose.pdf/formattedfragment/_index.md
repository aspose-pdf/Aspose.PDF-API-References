...
description: "Representa fragmento formatado abstrato."
type: docs
weight: 410
url: /pt/python-net/aspose.pdf/formattedfragment/
---

## FormattedFragment class

Representa fragmento formatado abstrato.

O tipo FormattedFragment expõe os seguintes membros:
## Propriedades
| Nome | Descrição |
| :- | :- |
