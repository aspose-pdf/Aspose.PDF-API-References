...
description: "Classe representa objeto PDF Artifact."
type: docs
weight: 30
url: /pt/python-net/aspose.pdf/artifact/
---

## Artifact class

Classe representa objeto PDF Artifact.

O tipo Artifact expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| Artifact(type, sub_type) | Inicializa uma nova instância da classe Artifact |
| Artifact(type, sub_type) | Inicializa uma nova instância da classe Artifact |
## Propriedades
| Nome | Descrição |
| :- | :- |
