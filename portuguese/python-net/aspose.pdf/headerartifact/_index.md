...
description: "A classe descreve o artefato Heaader. Este artifacgt pode ser usado para definir o cabeçalho da página."
type: docs
weight: 440
url: /pt/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

A classe descreve o artefato Heaader. Este artifacgt pode ser usado para definir o cabeçalho da página.

O tipo HeaderArtifact expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| HeaderArtifact() | Cria uma instância de Header Artifact. |
## Propriedades
| Nome | Descrição |
| :- | :- |
