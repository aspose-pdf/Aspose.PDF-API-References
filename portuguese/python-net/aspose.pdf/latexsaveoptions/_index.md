...
type: docs
weight: 800
url: /pt/python-net/aspose.pdf/latexsaveoptions/
---
...
O tipo LaTeXSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| LaTeXSaveOptions() | Inicializa uma nova instância da classe LaTeXSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
| warning_handler | Nenhum |
| save_format | Nenhum |
| close_response | Nenhum |
