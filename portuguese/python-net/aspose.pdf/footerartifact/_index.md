...
description: "Descreve o artefato de rodapé. Isso pode ser usado para definir o rodapé da página."
type: docs
weight: 400
url: /pt/python-net/aspose.pdf/footerartifact/
---
...
O tipo FooterArtifact expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| FooterArtifact() | Cria uma instância de Footer Artifact. |
## Propriedades
| Nome | Descrição |
| :- | :- |
