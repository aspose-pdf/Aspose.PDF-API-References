...
type: docs
weight: 690
url: /pt/python-net/aspose.pdf/imagestamp/
---
...
O tipo ImageStamp expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| ImageStamp(image) | Inicializa uma nova instância da classe ImageStamp |
| ImageStamp(file_name) | Inicializa uma nova instância da classe ImageStamp |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| largura | Obtém ou define a largura da imagem. Definir esta propriedade permite dimensionar a imagem horizontalmente. |
| altura | Obtém ou define a altura da imagem. Definir esta propriedade permite dimensionar a imagem verticalmente. |
...
| image | Obtém o fluxo de imagem usado para carimbar. |
| qualidade | Obtém ou define a qualidade do carimbo de imagem em porcentagem. Valores válidos são 0..100%. |
## Métodos
| Nome | Descrição |
| :- | :- |
| put(page) | Adiciona um carimbo gráfico na página. |
