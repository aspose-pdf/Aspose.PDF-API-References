...
description: "Uma classe abstrata para vários tipos de selos que vêm como descendentes."
type: docs
weight: 1440
url: /pt/python-net/aspose.pdf/stamp/
---

## Stamp class

Uma classe abstrata para vários tipos de selos que vêm como descendentes.
...
| Nome | Descrição |
| :- | :- |
| put(page) | Adiciona um selo na página. |
