...
type: docs
weight: 1810
url: /pt/python-net/aspose.pdf/xpssaveoptions/
---
...
O tipo XpsSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| XpsSaveOptions() | Inicializa uma nova instância da classe XpsSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| save_transparent_texts | Indica se deve preservar texto transparente (OCRizado). |
