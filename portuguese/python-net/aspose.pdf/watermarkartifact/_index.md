...
description: "Classe descreve o artefato de marca d'água. Isso pode ser usado para"
type: docs
weight: 1640
url: /pt/python-net/aspose.pdf/watermarkartifact/
---

## WatermarkArtifact class

Classe descreve o artefato de marca d'água. Isso pode ser usado para

O tipo WatermarkArtifact expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| WatermarkArtifact() | Cria uma instância do artefato Watermark. |
## Propriedades
| Nome | Descrição |
| :- | :- |
