...
type: docs
weight: 820
url: /pt/python-net/aspose.pdf/latexloadoptions/
---
...
O tipo LatexLoadOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| LatexLoadOptions() | Inicializa uma nova instância da classe LatexLoadOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
