...
description: "Opções de salvamento para o formato PdfXml."
type: docs
weight: 1260
url: /pt/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
O tipo PdfXmlSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| PdfXmlSaveOptions() | Inicializa uma nova instância da classe PdfXmlSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
