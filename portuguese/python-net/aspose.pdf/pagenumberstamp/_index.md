...
description: "Representa o carimbo de número de página e é usado para numerar páginas."
type: docs
weight: 1140
url: /pt/python-net/aspose.pdf/pagenumberstamp/
---

## PageNumberStamp class

Representa o carimbo de número de página e é usado para numerar páginas.

O tipo PageNumberStamp expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| PageNumberStamp(format) | Inicializa uma nova instância da classe PageNumberStamp |
| PageNumberStamp() | Inicializa uma nova instância da classe [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/). O formato é definido como "#". |
| PageNumberStamp(formatted_text) | Inicializa uma nova instância da classe PageNumberStamp |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| format | Valor string para carimbar números de página. <br/>            O valor deve incluir o caractere '#' que é substituído pelo número da página no processo de carimbo. |
| starting_number | Obtém ou define o valor do número da página inicial. As demais páginas serão numeradas a partir desse valor. |
| numbering_style | Estilo de numeração usado por este carimbo. |
## Métodos
| Nome | Descrição |
| :- | :- |
| put(page) | Adiciona número de página. |
