...
description: "Opções de salvamento para exportação para o formato XML do APS."
type: docs
weight: 20
url: /pt/python-net/aspose.pdf/apssaveoptions/
---

## ApsSaveOptions class

Opções de salvamento para exportação para o formato XML do APS.

O tipo ApsSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| ApsSaveOptions() | Inicializa uma nova instância da classe ApsSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
