...
description: "Esta classe representa opções de salvamento que <br/>            utiliza um modo de conversão unificado (com modelo interno de documento unificado)"
type: docs
weight: 1590
url: /pt/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Esta classe representa opções de salvamento que <br/>            utiliza um modo de conversão unificado (com modelo interno de documento unificado)

O tipo UnifiedSaveOptions expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| UnifiedSaveOptions() | Inicializa uma nova instância da classe UnifiedSaveOptions |
## Propriedades
| Nome | Descrição |
| :- | :- |
