...
description: "Classe que representa a anotação Círculo."
type: docs
weight: 100
url: /pt/python-net/aspose.pdf.annotations/circleannotation/
---

## CircleAnnotation class

Classe que representa a anotação Círculo.

O tipo CircleAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| CircleAnnotation(document) | Inicializa uma nova instância da classe CircleAnnotation |
| CircleAnnotation(page, rect) | Inicializa uma nova instância da classe CircleAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| interior_color | Cor interna com a qual preencher o retângulo ou elipse da anotação. |
| quadro | O retângulo que descreve as diferenças numéricas entre dois retângulos:<br/>            a entrada Rect da anotação e os limites reais do quadrado ou círculo subjacente. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
