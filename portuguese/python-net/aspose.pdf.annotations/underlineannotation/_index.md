...
description: "Representa uma anotação de sublinhado que aparece como sublinhado no texto do documento."
type: docs
weight: 850
url: /pt/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

Representa uma anotação de sublinhado que aparece como sublinhado no texto do documento.

O tipo UnderlineAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| UnderlineAnnotation(page, rect) | Inicializa uma nova instância da classe UnderlineAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| quad_points | Obtém ou define um array de pontos que especifica as coordenadas de n quadriláteros. Cada quadrilátero abrange uma palavra ou um grupo de palavras contíguas no texto subjacente à anotação. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
...
| flatten() | Nenhum |
| change_after_resize(transform) | Atualiza os QuadPoints, de acordo com a transformação matricial. |
| get_marked_text() | Obtém o texto sob a anotação de marcação como string. |
| get_marked_text_fragments() | Obtém o texto sob a anotação de marcação como [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/). |
