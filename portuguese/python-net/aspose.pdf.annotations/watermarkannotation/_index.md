...
description: "Classe que descreve o objeto de anotação Watermark."
type: docs
weight: 860
url: /pt/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Classe que descreve o objeto de anotação Watermark.

O tipo WatermarkAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| WatermarkAnnotation(page, rect) | Inicializa uma nova instância da classe WatermarkAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| fixed_print | Objeto de impressão fixa da anotação Watermark. |
| opacidade | Obtém ou define a opacidade da anotação. |
## Métodos
| Nome | Descrição |
| :- | :- |
...
| accept(visitor) | Aplica visitante à anotação. |
...
| set_text(text) | Define o texto da anotação. |
| set_text_and_state(text, text_state) | Define o texto da anotação. |
