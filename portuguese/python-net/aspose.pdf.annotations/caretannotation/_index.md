...
type: docs
weight: 80
url: /pt/python-net/aspose.pdf.annotations/caretannotation/
---
...
O tipo CaretAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| CaretAnnotation(document) | Inicializa uma nova instância da classe CaretAnnotation |
| CaretAnnotation(page, rect) | Inicializa uma nova instância da classe CaretAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| quadro | Obtém ou define o retângulo do cursor. |
| símbolo | Obtém ou define o símbolo associado ao cursor. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
