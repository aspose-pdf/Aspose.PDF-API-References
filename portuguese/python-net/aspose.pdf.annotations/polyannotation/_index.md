...
description: "Classe base abstrata para poli-anotações."
type: docs
weight: 640
url: /pt/python-net/aspose.pdf.annotations/polyannotation/
---

## PolyAnnotation class

Classe base abstrata para poli-anotações.

O tipo PolyAnnotation expõe os seguintes membros:
## Propriedades
| Nome | Descrição |
| :- | :- |
