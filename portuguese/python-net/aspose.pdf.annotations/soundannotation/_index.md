...
type: docs
weight: 740
url: /pt/python-net/aspose.pdf.annotations/soundannotation/
---
...
O tipo SoundAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Inicializa uma nova instância da classe SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Inicializa uma nova instância da classe SoundAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| sound_data | Obtém um objeto de som que define o som a ser reproduzido quando a anotação é ativada. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
