...
description: "Representa uma anotação de realce que destaca um intervalo de texto no documento."
type: docs
weight: 310
url: /pt/python-net/aspose.pdf.annotations/highlightannotation/
---

## HighlightAnnotation class

Representa uma anotação de realce que destaca um intervalo de texto no documento.

O tipo HighlightAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| HighlightAnnotation(page, rect) | Inicializa uma nova instância da classe HighlightAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
