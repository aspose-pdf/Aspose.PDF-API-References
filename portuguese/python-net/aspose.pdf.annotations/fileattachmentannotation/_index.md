...
description: "Classe descreve anotação de anexo de arquivo."
type: docs
weight: 170
url: /pt/python-net/aspose.pdf.annotations/fileattachmentannotation/
---

## FileAttachmentAnnotation class

Classe descreve anotação de anexo de arquivo.

O tipo FileAttachmentAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| FileAttachmentAnnotation(page, rect, file_spec) | Inicializa uma nova instância da classe FileAttachmentAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| opacidade | Obtém ou define a opacidade do ícone de 0 a 1: 0 - completamente transparente, 1 - completamente opaco. |
...
| file | A especificação do arquivo associado a esta anotação. |
| icon | Obtém ou define o ícone que deve ser usado na exibição da anotação. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
| get_rectangle(consider_rotation) | Retorna o retângulo da anotação levando em consideração a rotação da página. |
| accept(visitor) | Aceita objeto visitante para processar a anotação. |
