...
type: docs
weight: 820
url: /pt/python-net/aspose.pdf.annotations/textannotation/
---
...
O tipo TextAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| TextAnnotation(document) | Inicializa uma nova instância da classe TextAnnotation |
| TextAnnotation(page, rect) | Inicializa uma nova instância da classe TextAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| open | Obtém ou define um sinalizador que especifica se a anotação deve ser exibida inicialmente aberta. |
| icon | Obtém ou define um ícone a ser usado na exibição da anotação. |
| state | Obtém ou define o estado ao qual a anotação original deve ser configurada. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
