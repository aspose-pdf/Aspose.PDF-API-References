...
description: "Representa uma anotação de tachado que aparece como um risco no texto do documento."
type: docs
weight: 800
url: /pt/python-net/aspose.pdf.annotations/strikeoutannotation/
---

## StrikeOutAnnotation class

Representa uma anotação de tachado que aparece como um risco no texto do documento.

O tipo StrikeOutAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| StrikeOutAnnotation(page, rect) | Inicializa uma nova instância da classe StrikeOutAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
