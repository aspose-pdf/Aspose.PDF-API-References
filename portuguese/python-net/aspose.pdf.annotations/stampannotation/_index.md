...
description: "Representa anotação de carimbo de borracha. <br/>             Este tipo de anotação exibe texto ou gráficos que parecem ter sido carimbados na página com um carimbo de borracha."
type: docs
weight: 790
url: /pt/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

Representa anotação de carimbo de borracha. <br/>             Este tipo de anotação exibe texto ou gráficos que parecem ter sido carimbados na página com um carimbo de borracha.

O tipo StampAnnotation expõe os seguintes membros:
## Construtores
| Nome | Descrição |
| :- | :- |
| StampAnnotation(document) | Inicializa uma nova instância da classe StampAnnotation |
| StampAnnotation(page, rect) | Inicializa uma nova instância da classe StampAnnotation |
## Propriedades
| Nome | Descrição |
| :- | :- |
...
| icon | Obtém ou define o ícone para o selo de borracha. |
| image | Obtém ou define a imagem da anotação. |
## Métodos
| Nome | Descrição |
| :- | :- |
| clone() | Nenhum |
| get_rectangle(consider_rotation) | Retorna o retângulo da anotação levando em consideração a rotação da página. |
| accept(visitor) | Aceita o visitante [AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) ao percorrer a coleção de anotações. |
