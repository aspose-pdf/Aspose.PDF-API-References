...
description: "Substituir múltiplos fragmentos de texto em um arquivo PDF com controle de alinhamento."
type: docs
url: /pt/nodejs-cpp/organize/asposepdfreplacetextex/
---

_Substituir múltiplos fragmentos de texto em um arquivo PDF com controle de alinhamento._
...
A direção também pode ser forçada explicitamente ao prefixar `replaceText`
com caracteres Unicode especiais:
`\u200F` (RTL) ou `\u200E` (LTR), preferencialmente como o primeiro caractere
