...
description: "Definir informações (metadados) em um arquivo PDF."
type: docs
url: /pt/nodejs-cpp/metadata/asposepdfsetinfo/
---
...
Para 'title', 'creator', 'author', 'subject', 'keywords', 'creation' e 'mod', se não precisar definir um valor, use undefined ou "" (string vazia)
