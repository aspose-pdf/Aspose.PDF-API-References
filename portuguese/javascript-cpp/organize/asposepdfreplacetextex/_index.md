...
description: "Substitua vários fragmentos de texto em um arquivo PDF com controle de alinhamento."
type: docs
url: /pt/javascript-cpp/organize/asposepdfreplacetextex/
---
...
`\u200F` (RTL) ou `\u200E` (LTR), de preferência como o primeiro caractere
