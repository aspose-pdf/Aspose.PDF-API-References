...
description: "Salve o BLOB de representação de string no Memory FS para processamento."
type: docs
url: /pt/javascript-cpp/core/asposepdfpreparebase64/
---

_Salve a representação em string do BLOB no sistema de arquivos em memória para processamento._
