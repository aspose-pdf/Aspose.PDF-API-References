...
description: "Obtenha informações (metadados) de um arquivo PDF."
type: docs
url: /pt/javascript-cpp/metadata/asposepdfgetinfo/
---

_Obter informações (metadados) de um arquivo PDF._
