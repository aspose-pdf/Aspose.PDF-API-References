...
description: "Defina informações (metadados) em um arquivo PDF."
type: docs
url: /pt/javascript-cpp/metadata/asposepdfsetinfo/
---

_Definir informações (metadados) em um arquivo PDF._
...
Para 'title', 'creator', 'author', 'subject', 'keywords', 'creation' e 'mod', se não precisar definir o valor, use undefined ou \"\" (string vazia)
