...
description: "Converter um arquivo PDF para PDF (páginas separadas)."
type: docs
url: /pt/javascript-cpp/convert/asposepdfpagestopdf/
---

_Converter um arquivo PDF para PDF (páginas separadas)._
