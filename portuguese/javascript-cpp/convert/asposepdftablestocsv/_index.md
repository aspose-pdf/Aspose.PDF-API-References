...
description: "Converter um arquivo PDF para CSV (extrair tabelas)."
type: docs
url: /pt/javascript-cpp/convert/asposepdftablestocsv/
---

_Converter um arquivo PDF para CSV (extrair tabelas)._
