...
description: Classe Aspose.Pdf.Annotations.HighlightAnnotation. Representa uma anotação de destaque que destaca uma faixa de texto no documento
type: docs
weight: 1870
url: /pt/net/aspose.pdf.annotations/highlightannotation/
---
## Classe HighlightAnnotation

Representa uma anotação de destaque que destaca uma faixa de texto no documento.
...
| Nome | Descrição |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Página, Retângulo) | Cria uma nova anotação de destaque na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
