...
description: Classe Aspose.Pdf.Annotations.CommonFigureAnnotation. Classe abstrata representando anotação de figura comum
type: docs
weight: 1620
url: /pt/net/aspose.pdf.annotations/commonfigureannotation/
---
## Classe CommonFigureAnnotation

Classe abstrata representando anotação de figura comum.
...
| Nome | Descrição |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | Construtor para uso no Gerador. |
