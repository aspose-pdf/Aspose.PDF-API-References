...
---
## Propriedade FreeTextAnnotation.Justification

Obtém ou define um código especificando a forma de quadding (justificação) a ser usada na exibição do texto da anotação.
