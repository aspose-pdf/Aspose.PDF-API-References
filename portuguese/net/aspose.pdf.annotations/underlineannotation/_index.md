...
description: Classe Aspose.Pdf.Annotations.UnderlineAnnotation. Representa uma anotação sublinhada que aparece como um sublinhado no texto do documento
type: docs
weight: 2700
url: /pt/net/aspose.pdf.annotations/underlineannotation/
---
## Classe UnderlineAnnotation

Representa uma anotação sublinhada que aparece como um sublinhado no texto do documento.
...
| Nome | Descrição |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Página, Retângulo) | Cria uma nova anotação sublinhada na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
