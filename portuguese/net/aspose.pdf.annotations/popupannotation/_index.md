...
description: Classe Aspose.Pdf.Annotations.PopupAnnotation. Representa a anotação pop-up que exibe texto em uma janela pop-up para entrada e edição
type: docs
weight: 2330
url: /pt/net/aspose.pdf.annotations/popupannotation/
---
## Classe PopupAnnotation

Representa a anotação pop-up que exibe texto em uma janela pop-up para entrada e edição.
...
| Nome | Descrição |
| --- | --- |
| [PopupAnnotation](popupannotation/#constructor)(Document) | Construtor. para uso no Gerador. |
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | Cria uma nova anotação Popup na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Obtém ou define um sinalizador que especifica se a anotação pop-up deve ser exibida inicialmente aberta. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | Obtém o índice da página que contém a anotação. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Obtém ou define a anotação pai com a qual esta anotação pop-up deve ser associada. Se esta entrada estiver presente, os conteúdos, M, C e T da anotação pai substituirão os da própria anotação pop-up. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Aceita o objeto visitante para processar a anotação. |
