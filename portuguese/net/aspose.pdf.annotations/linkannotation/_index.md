...
description: Classe Aspose.Pdf.Annotations.LinkAnnotation. Representa um link de hipertexto para um destino em outro lugar no documento ou uma ação a ser executada
type: docs
weight: 2010
url: /pt/net/aspose.pdf.annotations/linkannotation/
---
## Classe LinkAnnotation

Representa um link de hipertexto para um destino em outro lugar no documento ou uma ação a ser executada.
...
| Nome | Descrição |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Página, Retângulo) | Cria uma nova anotação de link na página especificada. |

## Propriedades

| Nome | Descrição |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | Uma ação a ser executada quando a anotação de link é ativada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/linkannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination/) { get; set; } | Um destino a ser exibido quando a anotação é ativada. |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | O efeito visual a ser usado quando o botão do mouse é pressionado ou mantido pressionado dentro de sua área ativa. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
