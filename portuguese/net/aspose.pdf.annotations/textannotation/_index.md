...
description: Classe Aspose.Pdf.Annotations.TextAnnotation. Representa uma anotação de texto que é uma nota adesiva anexada a um ponto no documento PDF
type: docs
weight: 2650
url: /pt/net/aspose.pdf.annotations/textannotation/
---
## Classe TextAnnotation

Representa uma anotação de texto que é uma 'nota adesiva' anexada a um ponto no documento PDF.
...
| Nome | Descrição |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Construtor para anotação quando usada no Gerador. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Cria uma nova anotação de texto na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Obtém ou define um ícone a ser usado na exibição da anotação. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Obtém ou define uma flag especificando se a anotação deve ser exibida inicialmente aberta. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Substitui a definição na classe base com um corpo vazio. |
