...
description: Classe Aspose.Pdf.Annotations.CornerPrinterMarkAnnotation. Representa tipos de anotação que são colocados nos cantos da página impressa
type: docs
weight: 1630
url: /pt/net/aspose.pdf.annotations/cornerprintermarkannotation/
---
## Classe CornerPrinterMarkAnnotation

Representa tipos de anotação que são colocados nos cantos da página impressa.
