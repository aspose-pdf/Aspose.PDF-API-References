...
description: Classe Aspose.Pdf.Annotations.SoundAnnotation. Representa uma anotação de som que contém som gravado do microfone do computador ou importado de um arquivo
type: docs
weight: 2530
url: /pt/net/aspose.pdf.annotations/soundannotation/
---
## Classe SoundAnnotation

Representa uma anotação de som que contém som gravado do microfone do computador ou importado de um arquivo.
...
| Nome | Descrição |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | Cria uma nova anotação de som na página especificada. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | Cria uma nova anotação de som na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | Obtém ou define um ícone a ser usado na exibição da anotação. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | Obtém um objeto de som definindo o som a ser reproduzido quando a anotação é ativada. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
