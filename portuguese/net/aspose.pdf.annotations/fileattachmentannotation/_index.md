...
description: Classe Aspose.Pdf.Annotations.FileAttachmentAnnotation. A classe descreve a anotação de anexo de arquivo
type: docs
weight: 1710
url: /pt/net/aspose.pdf.annotations/fileattachmentannotation/
---
## Classe FileAttachmentAnnotation

A classe descreve a anotação de anexo de arquivo.
...
| Nome | Descrição |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Página, Retângulo, EspecificaçãoDeArquivo) | Cria uma nova anotação de anexo de arquivo na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | A especificação do arquivo associado a esta anotação. |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | Obtém ou define o ícone que deve ser usado na exibição da anotação. |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | Obtém ou define a opacidade do ícone de 0 a 1: 0 - completamente transparente, 1 - completamente opaco. |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Obtém ou define uma string de texto rico a ser exibida na janela pop-up quando a anotação for aberta. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | Aceita o objeto visitante para processar a anotação. |
