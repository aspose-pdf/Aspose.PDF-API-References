...
description: Classe Aspose.Pdf.Annotations.SquareAnnotation. Classe que representa a anotação quadrada
type: docs
weight: 2590
url: /pt/net/aspose.pdf.annotations/squareannotation/
---
## Classe SquareAnnotation

Classe que representa a anotação quadrada.
...
| Nome | Descrição |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Construtor para uso com o Gerador. |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | Cria uma nova anotação quadrada na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | Aceita um visitante para processar a anotação. |
