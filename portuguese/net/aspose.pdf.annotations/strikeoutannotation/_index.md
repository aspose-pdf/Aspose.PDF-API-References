...
description: Classe Aspose.Pdf.Annotations.StrikeOutAnnotation. Representa uma anotação de riscado que aparece como um riscado no texto do documento
type: docs
weight: 2630
url: /pt/net/aspose.pdf.annotations/strikeoutannotation/
---
## Classe StrikeOutAnnotation

Representa uma anotação de riscado que aparece como um riscado no texto do documento.
...
| Nome | Descrição |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Página, Retângulo) | Cria uma nova anotação de riscado na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [FullName](../../aspose.pdf.annotations/annotation/fullname/) { get; } | Obtém o nome qualificado completo da anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
