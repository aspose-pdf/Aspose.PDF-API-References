...
description: Classe Aspose.Pdf.Annotations.PolyAnnotation. Classe base abstrata para anotações poligonais
type: docs
weight: 2290
url: /pt/net/aspose.pdf.annotations/polyannotation/
---
## Classe PolyAnnotation

Classe base abstrata para anotações poligonais.
