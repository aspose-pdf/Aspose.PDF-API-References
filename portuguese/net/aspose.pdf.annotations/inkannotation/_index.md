...
description: Classe Aspose.Pdf.Annotations.InkAnnotation. Representa um rabisco à mão livre composto por um ou mais caminhos disjuntos
type: docs
weight: 1920
url: /pt/net/aspose.pdf.annotations/inkannotation/
---
## Classe InkAnnotation

Representa um "rabisco" à mão livre composto por um ou mais caminhos disjuntos.
...
| Nome | Descrição |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Construtor para anotação de tinta para o Gerador. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Cria uma nova anotação de tinta na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Estilo das extremidades da linha da anotação de tinta. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Obtém ou define a lista de gestos que são linhas independentes representadas por arrays de Point[]. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Atualiza os pontos na InkList, de acordo com a transformação da matriz. |
