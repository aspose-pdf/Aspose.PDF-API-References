...
description: Classe Aspose.Pdf.Annotations.BleedMarkAnnotation. Representa uma anotação de marca de sangria
type: docs
weight: 1500
url: /pt/net/aspose.pdf.annotations/bleedmarkannotation/
---
## Classe BleedMarkAnnotation

Representa uma anotação de marca de sangria.
...
| Nome | Descrição |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Página, PosiçãoDoCantoDaMarcaDeImpressão) | Inicializa uma nova instância da classe `BleedMarkAnnotation`. |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Aceita visitante para processamento de anotação. |
...
As marcas de sangria são colocadas nos cantos de uma página impressa para indicar onde a página deve ser cortada e quão longe ela pode se desviar das marcas de corte.
