...
description: Classe Aspose.Pdf.Annotations.ScreenAnnotation. Uma anotação de tela que especifica uma região de uma página na qual clipes de mídia podem ser reproduzidos
type: docs
weight: 2510
url: /pt/net/aspose.pdf.annotations/screenannotation/
---
...
| Nome | Descrição |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Página, Retângulo, string) | Cria uma nova anotação de tela na página especificada. |

## Propriedades

| Nome | Descrição |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Obtém ou define uma ação a ser realizada quando a anotação é ativada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Obtém ou define o título da anotação de tela. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
