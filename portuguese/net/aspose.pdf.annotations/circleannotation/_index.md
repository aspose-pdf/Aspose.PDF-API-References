...
description: Classe Aspose.Pdf.Annotations.CircleAnnotation. Classe que representa a anotação de círculo
type: docs
weight: 1590
url: /pt/net/aspose.pdf.annotations/circleannotation/
---
## Classe CircleAnnotation

Classe que representa a anotação de círculo.
...
| Nome | Descrição |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Construtor para anotação de círculo. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Cria uma nova anotação de círculo na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | O retângulo que descreve as diferenças numéricas entre dois retângulos: a entrada Rect da anotação e os limites reais do quadrado ou círculo subjacente. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | Cor interior com a qual preencher o retângulo ou elipse da anotação. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
