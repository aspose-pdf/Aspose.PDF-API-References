...
description: Classe Aspose.Pdf.Annotations.PolylineAnnotation. Representa a anotação de polilinha que é semelhante ao polígono, exceto que o primeiro e o último vértice não estão implicitamente conectados
type: docs
weight: 2320
url: /pt/net/aspose.pdf.annotations/polylineannotation/
---
## Classe PolylineAnnotation

Representa a anotação de polilinha que é semelhante ao polígono, exceto que o primeiro e o último vértice não estão implicitamente conectados.
...
| Nome | Descrição |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Página, Retângulo, Ponto[]) | Cria uma nova anotação de polilinha na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Obtém ou define a intenção da anotação de polígono ou polilinha. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Obtém ou define a cor interior com a qual preencher os finais da linha da anotação. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Obtém ou define o estilo do primeiro final da linha. |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | Obtém ou define um valor int que indica a ordem Z do gráfico. Um gráfico com maior ZIndex será colocado sobre o gráfico com menor ZIndex. ZIndex pode ser negativo. Gráficos com ZIndex negativo serão colocados atrás do texto na página. |

## Métodos

| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
