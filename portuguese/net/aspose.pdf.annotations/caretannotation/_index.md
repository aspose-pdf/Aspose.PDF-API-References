...
description: Classe Aspose.Pdf.Annotations.CaretAnnotation. Classe que representa a anotação Caret
type: docs
weight: 1560
url: /pt/net/aspose.pdf.annotations/caretannotation/
---
...
| Nome | Descrição |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Construtor para uso no Gerador. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Cria uma nova anotação Caret na página especificada. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Obtém o tipo de anotação. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Obtém ou define o retângulo do caret. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Obtém ou define o símbolo associado ao caret. |
...
| Nome | Descrição |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Aceita um objeto visitante para processar a anotação. |
