...
description: Classe Aspose.Pdf.Plugins.OptimizeOptions. Representa opções de otimização para o plugin Optimizer
type: docs
weight: 8960
url: /pt/net/aspose.pdf.plugins/optimizeoptions/
---
## Classe OptimizeOptions

Representa opções de otimização para o plugin [`Optimizer`](../optimizer/).
...
| Nome | Descrição |
| --- | --- |
| [OptimizeOptions](optimizeoptions/)() | O construtor padrão. |
