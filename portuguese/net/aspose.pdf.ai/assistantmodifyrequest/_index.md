...
description: Classe Aspose.Pdf.AI.AssistantModifyRequest. Objeto de solicitação para modificar um assistente
type: docs
weight: 130
url: /pt/net/aspose.pdf.ai/assistantmodifyrequest/
---
## Classe AssistantModifyRequest

Objeto de solicitação para modificar um assistente.
...
| Nome | Descrição |
| --- | --- |
| [AssistantModifyRequest](assistantmodifyrequest/)() | O construtor padrão. |
...
| [Model](../../aspose.pdf.ai/assistantcreaterequest/model/) { get; set; } | Obtém ou define o ID do modelo a ser usado. Você pode usar a API List models para ver todos os seus modelos disponíveis ou consultar nossa visão geral do Modelo para descrições deles. |
