...
description: Classe Aspose.Pdf.AI.RunStepListQueryParameters. Objeto de parâmetros de consulta para listar etapas de execução
type: docs
weight: 1040
url: /pt/net/aspose.pdf.ai/runsteplistqueryparameters/
---
## Classe RunStepListQueryParameters

Objeto de parâmetros de consulta para listar etapas de execução.
...
| Nome | Descrição |
| --- | --- |
| [RunStepListQueryParameters](runsteplistqueryparameters/)() | O construtor padrão. |
...
| Nome | Descrição |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runsteplistqueryparameters/getqueryparameters/)() | Obtém os parâmetros de consulta para listar etapas de execução. |
