...
description: Classe Aspose.Pdf.AI.RunListResponse. Representa uma resposta de lista contendo dados de execução
type: docs
weight: 1000
url: /pt/net/aspose.pdf.ai/runlistresponse/
---
## Classe RunListResponse

Representa uma resposta de lista contendo dados de execução.
...
| Nome | Descrição |
| --- | --- |
| [RunListResponse](runlistresponse/)() | O construtor padrão. |
