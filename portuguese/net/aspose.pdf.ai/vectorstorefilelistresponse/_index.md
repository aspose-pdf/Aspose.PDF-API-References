...
description: Classe Aspose.Pdf.AI.VectorStoreFileListResponse. Representa uma resposta de lista contendo dados de arquivos de armazenamento vetorial
type: docs
weight: 1340
url: /pt/net/aspose.pdf.ai/vectorstorefilelistresponse/
---
## Classe VectorStoreFileListResponse

Representa uma resposta de lista contendo dados de arquivos de armazenamento vetorial.
...
| Nome | Descrição |
| --- | --- |
| [VectorStoreFileListResponse](vectorstorefilelistresponse/)() | O construtor padrão. |
...
| Nome | Descrição |
| --- | --- |
| [GetFileIdList](../../aspose.pdf.ai/vectorstorefilelistresponse/getfileidlist/)() | Obtém a lista de IDs de arquivos do armazenamento vetorial. |
