...
description: Método IOpenAIClient. Exclui uma mensagem dentro de um thread de forma assíncrona
type: docs
weight: 160
url: /pt/net/aspose.pdf.ai/iopenaiclient/deletethreadmessageasync/
---
...
| --- | --- | --- |
| threadId | String | O ID do thread contendo a mensagem a ser excluída. |
