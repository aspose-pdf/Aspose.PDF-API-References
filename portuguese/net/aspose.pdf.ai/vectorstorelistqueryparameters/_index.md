...
description: Classe Aspose.Pdf.AI.VectorStoreListQueryParameters. Objeto de parâmetros de consulta para listar lojas de vetores
type: docs
weight: 1360
url: /pt/net/aspose.pdf.ai/vectorstorelistqueryparameters/
---
## Classe VectorStoreListQueryParameters

Objeto de parâmetros de consulta para listar lojas de vetores.
...
| Nome | Descrição |
| --- | --- |
| [VectorStoreListQueryParameters](vectorstorelistqueryparameters/)() | O construtor padrão. |
...
| Nome | Descrição |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorelistqueryparameters/getqueryparameters/)() | Obtém os parâmetros de consulta para listar lojas de vetores. |
