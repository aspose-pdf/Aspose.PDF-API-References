...
description: Classe Aspose.Pdf.AI.RunStepListResponse. Representa uma resposta de lista contendo dados de etapas de execução
type: docs
weight: 1050
url: /pt/net/aspose.pdf.ai/runsteplistresponse/
---
## Classe RunStepListResponse

Representa uma resposta de lista contendo dados de etapas de execução.
...
| Nome | Descrição |
| --- | --- |
| [RunStepListResponse](runsteplistresponse/)() | O construtor padrão. |
