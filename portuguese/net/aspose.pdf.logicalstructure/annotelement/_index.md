...
description: Classe Aspose.Pdf.LogicalStructure.AnnotElement. Representa o elemento de estrutura Annot na estrutura lógica
type: docs
weight: 6180
url: /pt/net/aspose.pdf.logicalstructure/annotelement/
---
## Classe AnnotElement

Representa o elemento de estrutura Annot na estrutura lógica.
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | Obtém ou define as Descrições Alternativas para a anotação. Texto que deve ser exibido para a anotação ou, se esse tipo de anotação não exibir texto, uma descrição alternativa do conteúdo da anotação em forma legível por humanos. |
...
| [ChangeParentElement](../../aspose.pdf.logicalstructure/structureelement/changeparentelement/)(StructureElement, bool) | Altera o elemento pai do elemento de estrutura atual. |
| [ClearChilds](../../aspose.pdf.logicalstructure/element/clearchilds/)() | Limpa todos os filhos. |
| [ClearId](../../aspose.pdf.logicalstructure/structureelement/clearid/)() | Limpa o ID do elemento de estrutura. |
| [FindElements&lt;T&gt;](../../aspose.pdf.logicalstructure/element/findelements/)(bool) | Encontra elementos de um tipo específico. |
