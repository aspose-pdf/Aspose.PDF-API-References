...
description: Classe Aspose.Pdf.LogicalStructure.ILSTextElement. Representa uma classe base para elementos de estrutura de texto em nível de linha na estrutura lógica
type: docs
weight: 6400
url: /pt/net/aspose.pdf.logicalstructure/ilstextelement/
---
## Classe ILSTextElement

Representa uma classe base para elementos de estrutura de texto em nível de linha na estrutura lógica.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Obtém o objeto StructureTextState para o elemento atual. |
