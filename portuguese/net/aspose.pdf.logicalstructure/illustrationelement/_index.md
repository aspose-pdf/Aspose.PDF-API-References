...
description: Classe Aspose.Pdf.LogicalStructure.IllustrationElement. Representa uma classe base para elementos de estrutura de ilustração na estrutura lógica
type: docs
weight: 6420
url: /pt/net/aspose.pdf.logicalstructure/illustrationelement/
---
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | Anexa uma imagem ao elemento de ilustração atual. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | Anexa uma imagem ao elemento de ilustração atual. |
