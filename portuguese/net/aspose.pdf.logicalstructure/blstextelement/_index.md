...
description: Classe Aspose.Pdf.LogicalStructure.BLSTextElement. Representa uma classe base para elementos de estrutura de texto em nível de bloco na estrutura lógica
type: docs
weight: 6250
url: /pt/net/aspose.pdf.logicalstructure/blstextelement/
---
## Classe BLSTextElement

Representa uma classe base para elementos de estrutura de texto em nível de bloco na estrutura lógica.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | Obtém o objeto StructureTextState para o elemento atual. |
