...
description: Classe Aspose.Pdf.LogicalStructure.ILSElement. Representa uma classe base para elementos de estrutura em nível de linha na estrutura lógica
type: docs
weight: 6390
url: /pt/net/aspose.pdf.logicalstructure/ilselement/
---
## Classe ILSElement

Representa uma classe base para elementos de estrutura em nível de linha na estrutura lógica.
