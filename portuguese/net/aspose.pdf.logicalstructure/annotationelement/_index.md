...
description: Classe Aspose.Pdf.LogicalStructure.AnnotationElement. Representa uma classe base para elementos de estrutura de anotação na estrutura lógica
type: docs
weight: 6190
url: /pt/net/aspose.pdf.logicalstructure/annotationelement/
---
## Classe AnnotationElement

Representa uma classe base para elementos de estrutura de anotação na estrutura lógica.
