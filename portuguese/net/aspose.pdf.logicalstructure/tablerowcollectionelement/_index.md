...
description: Classe Aspose.Pdf.LogicalStructure.TableRowCollectionElement. Representa uma classe base para elementos filhos do Cabeçalho, Corpo e Rodapé da Tabela na estrutura lógica
type: docs
weight: 6790
url: /pt/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## Classe TableRowCollectionElement

Representa uma classe base para elementos filhos do Cabeçalho, Corpo e Rodapé da Tabela na estrutura lógica.
