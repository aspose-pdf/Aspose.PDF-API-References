...
description: Classe Aspose.Pdf.WatermarkArtifact. A classe descreve o artefato de marca d'água. Isso pode ser usado para
type: docs
weight: 11310
url: /pt/net/aspose.pdf/watermarkartifact/
---
## Classe WatermarkArtifact

A classe descreve o artefato de marca d'água. Isso pode ser usado para
...
| Nome | Descrição |
| --- | --- |
| [WatermarkArtifact](watermarkartifact/)() | Cria uma instância do artefato de marca d'água. |
