...
description: Propriedade PptxSaveOptions. Este manipulador pode ser usado para lidar com eventos de progresso de conversão, por exemplo, pode ser usado para mostrar uma barra de progresso ou mensagens sobre a quantidade atual de páginas processadas. Um exemplo de código de manipuladores que mostra o progresso no console é
type: docs
weight: 20
url: /pt/net/aspose.pdf/pptxsaveoptions/customprogresshandler/
---
## Propriedade PptxSaveOptions.CustomProgressHandler

Este manipulador pode ser usado para lidar com eventos de progresso de conversão, por exemplo, pode ser usado para mostrar uma barra de progresso ou mensagens sobre a quantidade atual de páginas processadas. Um exemplo de código do manipulador que mostra o progresso no console é :
