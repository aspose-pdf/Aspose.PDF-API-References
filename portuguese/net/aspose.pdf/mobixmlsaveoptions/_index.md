...
description: Classe Aspose.Pdf.MobiXmlSaveOptions. Opções de salvamento para exportação para o formato Xml
type: docs
weight: 6980
url: /pt/net/aspose.pdf/mobixmlsaveoptions/
---
...
| Nome | Descrição |
| --- | --- |
| [MobiXmlSaveOptions](mobixmlsaveoptions/)() | O construtor padrão. |
