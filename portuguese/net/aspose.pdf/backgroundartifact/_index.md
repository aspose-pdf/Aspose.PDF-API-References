...
description: Classe Aspose.Pdf.BackgroundArtifact. A classe descreve o artefato de fundo. Este artefato permite definir o fundo da página
type: docs
weight: 2810
url: /pt/net/aspose.pdf/backgroundartifact/
---
## Classe BackgroundArtifact

A classe descreve o artefato de fundo. Este artefato permite definir o fundo da página.
...
| Nome | Descrição |
| --- | --- |
| [BackgroundArtifact](backgroundartifact/)() | Inicializa o objeto BackgroundArtifact. |
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | Obtém ou define a cor de fundo do artefato de fundo |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | Obtém ou define a imagem de fundo do artefato de fundo |
