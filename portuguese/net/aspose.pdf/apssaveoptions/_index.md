...
description: Classe Aspose.Pdf.ApsSaveOptions. Opções de salvamento para exportação para o formato XML APS
type: docs
weight: 2760
url: /pt/net/aspose.pdf/apssaveoptions/
---
## Classe ApsSaveOptions

Opções de salvamento para exportação para o formato XML APS.
...
| Nome | Descrição |
| --- | --- |
| [ApsSaveOptions](apssaveoptions/)() | O construtor padrão. |
...
O seguinte exemplo mostra como converter um arquivo PDF para um arquivo APS
