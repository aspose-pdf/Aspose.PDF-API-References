...
description: Classe Aspose.Pdf.HeaderArtifact. A classe descreve o artefato de cabeçalho. Este artefato pode ser usado para definir o cabeçalho da página
type: docs
weight: 5420
url: /pt/net/aspose.pdf/headerartifact/
---
## Classe HeaderArtifact

A classe descreve o artefato de cabeçalho. Este artefato pode ser usado para definir o cabeçalho da página.
...
| Nome | Descrição |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Cria uma instância do artefato de cabeçalho. |
