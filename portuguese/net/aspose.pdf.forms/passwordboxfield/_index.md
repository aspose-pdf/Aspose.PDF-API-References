...
description: Classe Aspose.Pdf.Forms.PasswordBoxField. A classe descreve um campo de texto para inserir senha
type: docs
weight: 5200
url: /pt/net/aspose.pdf.forms/passwordboxfield/
---
## Classe PasswordBoxField

A classe descreve um campo de texto para inserir senha.
...
| [ExportValueToJson](../../aspose.pdf.forms/field/exportvaluetojson/)(Stream, bool) | Exporta o conteúdo do campo especificado para um stream JSON. Os valores do campo de botão não são exportados. |
