...
description: Classe Aspose.Pdf.Forms.FileSelectBoxField. Campo para elemento de caixa de seleção de arquivo
type: docs
weight: 5060
url: /pt/net/aspose.pdf.forms/fileselectboxfield/
---
## Classe FileSelectBoxField

Campo para elemento de caixa de seleção de arquivo.
