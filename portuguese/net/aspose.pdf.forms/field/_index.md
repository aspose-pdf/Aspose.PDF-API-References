...
description: Classe Aspose.Pdf.Forms.Field. Classe base para campos de formulário acro
type: docs
weight: 5050
url: /pt/net/aspose.pdf.forms/field/
---
## Classe Campo
...
| Nome | Descrição |
| --- | --- |
| [Field](field/)(Document) | Cria um campo para uso no Gerador. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Se verdadeiro, o tamanho da fonte será reduzido para caber o texto no retângulo especificado. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Tamanho máximo da fonte que pode ser usado para o conteúdo do campo. -1 para não verificar o tamanho. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Tamanho mínimo da fonte que pode ser usado para o conteúdo do campo. -1 para não verificar o tamanho. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Copia subcampos deste campo para um array começando do índice especificado. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Importa dados para os campos especificados a partir de um stream JSON, com base em uma correspondência exata dos nomes completos dos campos. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Importa dados para o campo especificado a partir de um stream JSON, usando o nome completo especificado na variável 'fieldFullNameInJSON' para correspondência. |
