...
description: Classe Aspose.Pdf.Forms.CheckboxField. Classe que representa um campo de checkbox
type: docs
weight: 4980
url: /pt/net/aspose.pdf.forms/checkboxfield/
---
## Classe CheckboxField

Classe que representa um campo de checkbox
...
| Nome | Descrição |
| --- | --- |
| [CheckboxField](checkboxfield/#constructor_1)(Document) | Construtor a ser usado com o Gerador. |
| [CheckboxField](checkboxfield/#constructor_2)(Document, Rectangle) | Construtor para a classe CheckboxField. |
| [CheckboxField](checkboxfield/#constructor_3)(Page, Rectangle) | Construtor para a classe CheckboxField. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate/) { get; set; } | Obtém ou define o estado de aparência atual da anotação. |
| [AllowedStates](../../aspose.pdf.forms/checkboxfield/allowedstates/) { get; } | Retorna a lista de estados permitidos. |
...
| [Checked](../../aspose.pdf.forms/checkboxfield/checked/) { get; set; } | Obtém ou define o estado da caixa de seleção. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue/) { get; set; } | Obtém ou define o valor de exportação do campo CheckBox. |
...
| [Style](../../aspose.pdf.forms/checkboxfield/style/) { get; set; } | Obtém ou define o estilo da caixa de seleção. |
...
| override [Value](../../aspose.pdf.forms/checkboxfield/value/) { get; set; } | Obtém ou define o valor do campo de caixa de seleção. |
...
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption)(string) | Adiciona uma nova caixa de seleção a um grupo de caixas de seleção, no qual no máximo uma das caixas de seleção pode estar marcada a qualquer momento. A nova caixa de seleção é adicionada ao final do grupo. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_1)(string, Rectangle) | Adiciona uma nova caixa de seleção a um grupo de caixas de seleção, no qual no máximo uma das caixas de seleção pode estar marcada a qualquer momento. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_2)(string, int, Rectangle) | Adiciona uma nova caixa de seleção a um grupo de caixas de seleção, no qual no máximo uma das caixas de seleção pode estar marcada a qualquer momento. |
...
| override [Clone](../../aspose.pdf.forms/checkboxfield/clone/)() | Clona a caixa de seleção. |
...
| [ExportToJson](../../aspose.pdf.annotations/widgetannotation/exporttojson/)(Stream, ExportFieldsToJsonOptions) | Exporta o campo de formulário PDF especificado para o formato JSON e grava o resultado no stream fornecido. |
| [ExportToJson](../../aspose.pdf.annotations/widgetannotation/exporttojson/)(string, ExportFieldsToJsonOptions) | Exporta o campo de formulário PDF especificado para o formato JSON e grava o resultado no arquivo especificado. |
...
| [GetCheckedStateName](../../aspose.pdf.annotations/widgetannotation/getcheckedstatename/)() | Retorna o nome do estado "marcado" de acordo com os nomes de estado existentes. |
...
O exemplo demonstra como criar um campo de checkbox de múltiplos valores.
