...
description: Classe Aspose.Pdf.Forms.ButtonField. Classe representa campo de botão pressionável
type: docs
weight: 4970
url: /pt/net/aspose.pdf.forms/buttonfield/
---
## Classe ButtonField

Classe representa campo de botão pressionável.
...
| Nome | Descrição |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Construtor do campo de botão para o Gerador. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | Construtor do ButtonField. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | Construtor do ButtonField. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Obtém ou define a legenda alternativa do botão que será exibida quando o botão do mouse for pressionado em sua área ativa. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Obtém ou define o ícone alternativo que será exibido quando o botão do mouse for pressionado em sua área ativa. |
| [AlternateName](../../aspose.pdf.forms/field/alternatename/) { get; set; } | Obtém ou define o nome alternativo do campo (Um nome de campo alternativo que será usado no lugar do nome real do campo sempre que o campo for identificado na interface do usuário). O nome alternativo é usado como dica de ferramenta do campo no Adobe Acrobat. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Obtém o objeto de ajuste do ícone especificando como o ícone da anotação do widget deve ser exibido dentro de seu retângulo de anotação. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Obtém ou define a posição da legenda do ícone. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Obtém ou define a legenda normal. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Obtém ou define o ícone normal do botão que será exibido quando não estiver interagindo com o usuário. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Obtém ou define a legenda de rollover do botão que será exibida quando o usuário passar o cursor em sua área ativa sem pressionar o botão do mouse. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Obtém ou define o ícone de rollover do botão que será exibido quando o usuário passar o cursor em sua área ativa sem pressionar o botão do mouse. |
...
| [AddImage](../../aspose.pdf.forms/buttonfield/addimage/)(Image) | Adiciona imagem aos recursos do campo e a desenha. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Importa dados para os campos especificados de um stream JSON, com base em uma correspondência exata dos nomes completos dos campos. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | Importa dados para o campo especificado de um stream JSON, usando o nome completo especificado na variável 'fieldFullNameInJSON' para correspondência. |
