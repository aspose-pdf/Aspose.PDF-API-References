...
description: Classe Aspose.Pdf.Forms.RadioButtonOptionField. Classe representa item do campo RadioButton
type: docs
weight: 5220
url: /pt/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## Classe RadioButtonOptionField

Classe representa item do campo RadioButton.
...
| Nome | Descrição |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Cria uma nova instância de RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Página, Retângulo) | Cria um botão de rádio no retângulo especificado na página especificada. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Obtém ou define a legenda. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Obtém ou define o nome da opção. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Obtém ou define o estilo da caixa de seleção. |
