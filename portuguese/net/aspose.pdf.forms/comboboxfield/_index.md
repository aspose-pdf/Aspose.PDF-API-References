...
description: Classe Aspose.Pdf.Forms.ComboBoxField. Classe que representa o campo ComboBox do formulário
type: docs
weight: 5000
url: /pt/net/aspose.pdf.forms/comboboxfield/
---
## Classe ComboBoxField

Classe que representa o campo ComboBox do formulário.
...
| Nome | Descrição |
| --- | --- |
| [ComboBoxField](comboboxfield/#constructor)() | Construtor para ComboBoxField a ser usado no Gerador. |
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Cria o campo CombBox para trabalhar com o Gerador. |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Construtor para o campo ComboBox. |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Construtor para o campo ComboBox. |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | Obtém o número de subcampos neste campo. (Por exemplo, o número de itens no campo de botão de rádio). |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | Obtém ou define o status editável do campo. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected/) { get; set; } | Obtém ou define o índice da opção selecionada. Esta propriedade permite mudar a seleção. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | Obtém ou define o status da atividade de verificação ortográfica. |
...
| virtual [DeleteOption](../../aspose.pdf.forms/choicefield/deleteoption/)(string) | Deleta a opção pelo seu nome. |
