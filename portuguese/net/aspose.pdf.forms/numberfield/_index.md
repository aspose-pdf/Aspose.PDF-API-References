...
description: Classe Aspose.Pdf.Forms.NumberField. Campo de Texto com caracteres válidos especificados
type: docs
weight: 5140
url: /pt/net/aspose.pdf.forms/numberfield/
---
## Classe NumberField

Campo de Texto com caracteres válidos especificados
...
| Nome | Descrição |
| --- | --- |
| [NumberField](numberfield/#constructor)() | Inicializa uma nova instância da classe `NumberField`. |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | Inicializa uma nova instância da classe `NumberField`. |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | Inicializa uma nova instância da classe `NumberField`. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | Obtém ou define os caracteres permitidos. |
