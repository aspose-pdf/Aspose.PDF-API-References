...
description: Classe Aspose.Pdf.Forms.BarcodeField. Classe representa campo de código de barras
type: docs
weight: 4950
url: /pt/net/aspose.pdf.forms/barcodefield/
---
## Classe BarcodeField
...
| Nome | Descrição |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | Inicializa uma nova instância da classe `BarcodeField`. |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | Inicializa uma nova instância da classe `BarcodeField`. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Obtém a legenda do objeto de código de barras. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Obtém um valor inteiro representando o coeficiente de correção de erro. Para PDF417, deve ser de 0 a 8. Para QRCode, deve ser de 0 a 3 (0 para 'L', 1 para 'M', 2 para 'Q' e 3 para 'H'). |
| [Exportable](../../aspose.pdf.annotations/widgetannotation/exportable/) { get; set; } | Obtém ou define o sinalizador exportável do campo. |
| [Flags](../../aspose.pdf.annotations/annotation/flags/) { get; set; } | Sinais da anotação. |
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Obtém ou define o sinalizador que indica se o campo é dividido em posições espaçadas. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Obtém ou define o sinalizador de múltiplas linhas do campo. Se Multiline for verdadeiro, o campo pode conter várias linhas de texto. |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Obtém a resolução, em pontos por polegada (dpi), na qual o objeto de código de barras é renderizado. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Obtém ou define o sinalizador de rolagem do campo. Se verdadeiro, o campo pode ser rolado. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Obtém ou define o sinalizador de verificação ortográfica para o campo. Se verdadeiro, o campo será verificado ortograficamente. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtém o dicionário de aparência da anotação. |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Especifica qual tecnologia de código de barras ou glifo deve ser usada nesta anotação, veja [`Symbology`](./symbology/) para detalhes. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | Obtém a distância vertical entre dois módulos de código de barras, medida em pixels. A razão XSymHeight/XSymWidth deve ser um valor inteiro. Para PDF417, a faixa de razão aceitável é de 1 a 4. Para QRCode e DataMatrix, essa razão deve ser sempre 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | Obtém a distância horizontal, em pixels, entre dois módulos de código de barras. |
...
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage/)(Image) | Adiciona imagem aos recursos do campo e a desenha. |
