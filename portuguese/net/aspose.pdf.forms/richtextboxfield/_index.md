...
description: Classe Aspose.Pdf.Forms.RichTextBoxField. Classe descreve o componente do editor de texto rico
type: docs
weight: 5230
url: /pt/net/aspose.pdf.forms/richtextboxfield/
---
## Classe RichTextBoxField

Classe descreve o componente do editor de texto rico.
...
| Nome | Descrição |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Página, Retângulo) | Construtor para o campo Rich Text Box. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Obtém ou define o valor de texto rico formatado com marcação. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Obtém ou define a justificação da caixa de texto rica. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Obtém ou define o valor de texto rico. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Obtém ou define a string de estilo padrão do campo de texto rico. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Valor do RichTextField. |
