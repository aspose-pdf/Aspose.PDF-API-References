...
description: Classe Aspose.Pdf.Forms.ChoiceField. Representa a classe base para campos de escolha
type: docs
weight: 4990
url: /pt/net/aspose.pdf.forms/choicefield/
---
## Classe ChoiceField
...
| Nome | Descrição |
| --- | --- |
| [ChoiceField](choicefield/#constructor)(Document) | Cria um campo de escolha (para o Gerador) |
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | Construtor para ChoiceField. |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | Construtor para ChoiceField. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | Adiciona uma nova opção com o nome especificado. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | Adiciona uma nova opção com o valor de exportação e nome especificados. |
