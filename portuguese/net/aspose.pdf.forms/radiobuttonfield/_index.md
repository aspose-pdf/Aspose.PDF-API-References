...
description: Classe Aspose.Pdf.Forms.RadioButtonField. Classe que representa um campo de botão de opção
type: docs
weight: 5210
url: /pt/net/aspose.pdf.forms/radiobuttonfield/
---
...
| Nome | Descrição |
| --- | --- |
| [RadioButtonField](radiobuttonfield/#constructor)(Document) | Construtor para RadioButtonField. |
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Construtor para RadioButtonField |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Obtém ou define a flag que permite que o botão de opção não tenha valor selecionado. Se `true`, exatamente um botão de opção deve ser selecionado o tempo todo; selecionar o botão atualmente selecionado não tem efeito. Se `false`, clicar no botão selecionado o desmarcará, deixando nenhum botão selecionado. |
...
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options/) { get; } | Obtém a coleção de opções do botão de opção. |
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Obtém o índice da página que contém este campo RadioButton. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Obtém ou define o índice do item selecionado. A numeração dos itens começa em 1. |
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Obtém ou define o array de itens selecionados. Para lista de multisseleção, o array contém mais de um item. Para lista de seleção única, contém um único item. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Obtém o dicionário de aparência da anotação. |
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Estilo da caixa do campo. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value/) { get; set; } | Obtém ou define o valor do campo. |
...
| [Add](../../aspose.pdf.forms/radiobuttonfield/add/)(RadioButtonOptionField) | Adiciona um novo campo de opção ao campo RadioButton |
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Adiciona opção ao botão de opção. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Adiciona ao botão de opção com retângulo especificado. |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string, string) | Adiciona nova opção com valor de exportação e nome especificados. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Move todos os subitens do botão de opção para as posições especificadas na página. |
