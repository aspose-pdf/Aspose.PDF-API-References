...
description: Método MarkdownDiffOutputGenerator. Gera a saída com base nas diferenças entre os textos e a salva em um arquivo
type: docs
weight: 20
url: /pt/net/aspose.pdf.comparison/markdowndiffoutputgenerator/generateoutput/
---
...
| --- | --- | --- |
| diffrences | List`1 | A lista de diferenças entre os textos. |
...
| --- | --- | --- |
| diffrences | List`1 | A lista de diferenças entre os textos. |
| targetFilePath | String | O caminho do arquivo de destino para salvar a saída. |
