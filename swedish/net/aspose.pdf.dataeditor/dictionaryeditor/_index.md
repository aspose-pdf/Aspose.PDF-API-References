---
title: "Klass DictionaryEditor"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.DataEditor.DictionaryEditor klass. En klass för att komma åt ett dokumentträd, ordbok, dokumentordbok, sidordbok, resursordbok."
type: docs
weight: 3590
...
En klass för att komma åt ett dokuments trädordbok (dokumentordbok, sidordbok, resursordbok).
...
| [Item](../../aspose.pdf.dataeditor/dictionaryeditor/item/) { get; set; } | Hämtar eller anger elementet med den angivna nyckeln. |
...
| Namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.pdf.dataeditor/dictionaryeditor/add/#add)(KeyValuePair&lt;string, ICosPdfPrimitive&gt;) | Ställ in [`ICosPdfPrimitive`](../icospdfprimitive/) till ordbok. |
| [Add](../../aspose.pdf.dataeditor/dictionaryeditor/add/#add_1)(string, ICosPdfPrimitive) | Ställ in [`ICosPdfPrimitive`](../icospdfprimitive/) till ordbok. |
| [Clear](../../aspose.pdf.dataeditor/dictionaryeditor/clear/)() | Tar bort alla objekt från `DictionaryEditor`. |
| [Contains](../../aspose.pdf.dataeditor/dictionaryeditor/contains/)(KeyValuePair&lt;string, ICosPdfPrimitive&gt;) | Avgör om `DictionaryEditor` innehåller ett specifikt värde. |
| [ContainsKey](../../aspose.pdf.dataeditor/dictionaryeditor/containskey/)(string) | Avgör om `DictionaryEditor` innehåller ett element med den angivna nyckeln. |
...
| [TryGetValue](../../aspose.pdf.dataeditor/dictionaryeditor/trygetvalue/)(string, out ICosPdfPrimitive) | För åtkomst till enkla datatyper som string, name, bool, number. Returnerar null för andra typer. |
