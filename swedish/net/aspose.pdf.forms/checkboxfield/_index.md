...
| Namn | Beskrivning |
| --- | --- |
| [CheckboxField](checkboxfield/#constructor_1)(Document) | Konstruktor att använda med Generator. |
| [CheckboxField](checkboxfield/#constructor_2)(Document, Rectangle) | Konstruktor för CheckboxField-klass. |
| [CheckboxField](checkboxfield/#constructor_3)(Page, Rectangle) | Konstruktor för CheckboxField-klass. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate/) { get; set; } | Hämtar eller anger aktuellt annoteringsutseende. |
...
| [Checked](../../aspose.pdf.forms/checkboxfield/checked/) { get; set; } | Hämtar eller anger tillståndet för kryssrutan. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue/) { get; set; } | Hämtar eller anger exportvärde för CheckBox-fältet. |
...
| [Style](../../aspose.pdf.forms/checkboxfield/style/) { get; set; } | Hämtar eller anger stil för kryssruta. |
...
| override [Value](../../aspose.pdf.forms/checkboxfield/value/) { get; set; } | Hämtar eller anger värde för kryssruta. |
...
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption)(string) | Lägger till en ny kryssruta i en kryssrutegrupp, där högst en av kryssrutorna kan vara markerad åt gången. Den nya kryssrutan läggs till längst ner i gruppen. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_1)(string, Rectangle) | Lägger till en ny kryssruta i en kryssrutegrupp, där högst en av kryssrutorna kan vara markerad åt gången. |
| [AddOption](../../aspose.pdf.forms/checkboxfield/addoption/#addoption_2)(string, int, Rectangle) | Lägger till en ny kryssruta i en kryssrutegrupp, där högst en av kryssrutorna kan vara markerad åt gången. |
...
| override [Clone](../../aspose.pdf.forms/checkboxfield/clone/)() | Klona kryssrutan. |
...
Exemplet visar hur man skapar ett flervärdeskryssrutfält.
...
// Ange värdet för det första alternativet i kryssrutegruppen
checkbox.ExportValue = "option 1";

// Lägg till ett nytt alternativ precis under de befintliga
checkbox.AddOption("option 2");

// Lägg till ett nytt alternativ i den angivna rektangeln
checkbox.AddOption("option 3", new Rectangle(100, 100, 120, 120));

document.Form.Add(checkbox);

// Välj den tillagda kryssrutan
