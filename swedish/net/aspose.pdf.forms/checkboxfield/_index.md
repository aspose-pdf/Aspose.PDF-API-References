...
description: Klass som representerar kryssruta field
type: docs
weight: 2930
...
Klass som representerar kryssruta field
...
| namn | Beskrivning |
| --- | --- |
| [CheckboxField](checkboxfield#constructor)() | Skapa instans av CheckboxField. |
| [CheckboxField](checkboxfield#constructor_1)(Document) | Konstruktör att använda med Generator. |
| [CheckboxField](checkboxfield#constructor_2)(Document, Rectangle) | Konstruktör för CheckboxField class. |
| [CheckboxField](checkboxfield#constructor_3)(Page, Rectangle) | Konstruktör för CheckboxField class. |
...
| override [ActiveState](../../aspose.pdf.forms/checkboxfield/activestate) { get; set; } | Hämtar eller ställer in aktuellt annoteringsutseendeläge. |
| [AllowedStates](../../aspose.pdf.forms/checkboxfield/allowedstates) { get; } | Returnerar en lista över tillåtna tillstånd. |
...
| [Checked](../../aspose.pdf.forms/checkboxfield/checked) { get; set; } | Hämtar eller ställer in tillstånd för kryssrutan. |
...
| [ExportValue](../../aspose.pdf.forms/checkboxfield/exportvalue) { get; set; } | Hämtar eller ställer in exportvärdet för CheckBox-fältet. |
...
| [Style](../../aspose.pdf.forms/checkboxfield/style) { get; set; } | Hämtar eller ställer in stil på kryssrutan. |
...
| override [Value](../../aspose.pdf.forms/checkboxfield/value) { get; set; } | Hämtar eller ställer in värdet på kryssrutans fält. |
