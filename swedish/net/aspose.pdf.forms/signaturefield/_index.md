---
title: "Klass SignatureField"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Forms.SignatureField klass. Representerar signaturformulärfält"
type: docs
weight: 5410
url: /sv/net/aspose.pdf.forms/signaturefield/
---
...
| Namn | Beskrivning |
| --- | --- |
| [SignatureField](signaturefield/#constructor)(Document, Rectangle) | Initierar en ny instans av klassen `SignatureField`. |
| [SignatureField](signaturefield/#constructor_1)(Page, Rectangle) | Initierar en ny instans av klassen `SignatureField`. |
...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | Hämtar signaturobjektet. Detta objekt innehåller signaturdata enligt offentliga nyckelkryptografiska standarder. Klasserna [`PKCS1`](../pkcs1/), [`PKCS7`](../pkcs7/) och [`PKCS7Detached`](../pkcs7detached/) representerar alla stödda typer av signaturobjekt. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | Extraherar det enda X.509-certifikatet i DER-format som en ström. |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | Extraherar det enda X.509-certifikatobjektet. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | Extraherar signaturens bild som jpeg-kodad ström. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | Extraherar signaturens bild som kodad ström. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign)(Signature) | Signera dokumentet med detta signaturfält. |
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign_1)(Signature, Stream, string) | Signerar dokumentet med detta signaturfält. |
