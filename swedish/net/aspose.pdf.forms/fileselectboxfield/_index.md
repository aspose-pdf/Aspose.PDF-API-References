...
description: Aspose.Pdf.Forms.FileSelectBoxField klass. Fält för filvalselement
type: docs
weight: 5060
url: /sv/net/aspose.pdf.forms/fileselectboxfield/
---
## FileSelectBoxField klass

Fält för filvalselement.
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Lägger till streckkod 128 i fältet. Fältets värde kommer att ändras till koden och fältet blir skrivskyddat. |
