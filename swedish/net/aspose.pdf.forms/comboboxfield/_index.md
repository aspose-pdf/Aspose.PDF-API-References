...
description: Klass som representerar Combobox-fältet i formuläret.
type: docs
weight: 2950
...
| namn | Beskrivning |
| --- | --- |
| [ComboBoxField](comboboxfield#constructor)() | Constructor för ComboBoxField som ska användas i Generator. |
| [ComboBoxField](comboboxfield#constructor_1)(Document) | Skapar CombBox-fält för att arbeta med Generator. |
| [ComboBoxField](comboboxfield#constructor_2)(Document, Rectangle) | Konstruktör för Combobox-fältet. |
| [ComboBoxField](comboboxfield#constructor_3)(Page, Rectangle) | Konstruktör för Combobox Field. |
...
| virtual [Options](../../aspose.pdf.forms/choicefield/options) { get; } | Får samling av valmöjligheter. |
...
| virtual [Selected](../../aspose.pdf.forms/choicefield/selected) { get; set; } | Hämtar eller ställer in index för valt alternativ. Den här egenskapen gör det möjligt att ändra urval. |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck) { get; set; } | Får eller ställer in stavningskontrollaktivitetsstatus. |
...
| override [Value](../../aspose.pdf.forms/choicefield/value) { get; set; } | Hämtar eller ställer in fältets värde. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption)(string) | Lägger till nytt alternativ med angivet namn. |
