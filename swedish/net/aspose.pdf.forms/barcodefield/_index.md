---
title: "Klass BarcodeField"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Forms.BarcodeField klass. Klass som representerar streckkodsfält"
type: docs
weight: 5070
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Hämtar rubriken för streckkodobjektet. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Hämtar ett heltalsvärde som representerar felkorrigeringskoefficienten. För PDF417 ska det vara från 0 till 8. För QRCode ska det vara från 0 till 3 (0 för 'L', 1 för 'M', 2 för 'Q' och 3 för 'H'). |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | Hämtar eller anger flagga som indikerar om fältet är delat i separata positioner. |
...
| [MaxLen](../../aspose.pdf.forms/textboxfield/maxlen/) { get; set; } | Hämtar eller anger maximal längd på text i fältet. |
...
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | Hämtar eller anger flerradig flagga för fältet. Om Multiline är true kan fältet innehålla flera rader text. |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Hämtar upplösningen, i punkter per tum (dpi), som streckkodobjektet renderas med. |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | Hämtar eller anger rullningsbar flagga för fältet. Om true kan fältet rullas. |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | Hämtar eller anger stavningskontrollflagga för fältet. Om true ska fältet stavningskontrolleras. |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Hämtar utseendeordbok för annotationen. |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Anger vilken streckkod- eller glyfteknik som ska användas på denna annotation, se [`Symbology`](./symbology/) för detaljer. |
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | Hämtar eller anger vertikal textjustering för annotation. |
| override [Value](../../aspose.pdf.forms/textboxfield/value/) { get; set; } | Hämtar eller anger värde för fältet. |
...
| [AddBarcode](../../aspose.pdf.forms/textboxfield/addbarcode/)(string) | Lägger till barcode 128 i fältet. Fältvärdet kommer att ändras till koden och fältet blir skrivskyddat. |
