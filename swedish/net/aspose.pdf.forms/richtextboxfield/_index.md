...
description: Aspose.Pdf.Forms.RichTextBoxField klass. Klassen beskriver komponenten för rika textredigerare
type: docs
weight: 5230
url: /sv/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField klass

Klassen beskriver komponenten för rika textredigerare.
...
| Namn | Beskrivning |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Konstruktör för Rich Text Box-fält. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Hämtar eller ställer in det formaterade rika textvärdet med markup. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Hämtar eller ställer in justeringen av rutan för rik text. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Hämtar eller ställer in det rika textvärdet. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Hämtar eller ställer in standardstilsträngen för det rika textfältet. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Värdet av RichTextField. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/)(WidgetAnnotation[], int) | Kopierar underfälten av detta fält till en array som börjar från angivet index. |
