---
title: "Klass RichTextBoxField"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Forms.RichTextBoxField-klass. Klassen beskriver komponenten för rik textredigerare"
type: docs
weight: 5350
url: /sv/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField class

Klassen beskriver komponenten för rik textredigerare.
...
| Namn | Beskrivning |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Konstruktor för Rich Text Box-fältet. |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | Hämtar eller anger formaterat riktextvärde med markup. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | Hämtar eller anger justering av rich text box. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | Hämtar eller anger riktextvärde. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | Hämtar eller anger standardstilssträng för rich text-fältet. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | Värde för RichTextField. |
