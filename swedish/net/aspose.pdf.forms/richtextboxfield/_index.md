...
description: Klass beskriver rich text editor-komponent.
type: docs
weight: 3180
...
Klass beskriver rich text editor-komponent.
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue) { get; set; } | Hämtar eller ställer in formaterat RTF-värde med markering. |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify) { get; set; } | Hämtar eller ställer in motivering av rich text-rutan. |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue) { get; set; } | Hämtar eller ställer in rich text-värde. |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style) { get; set; } | Hämtar eller ställer in standardformatsträngen för rich text-fältet. |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value) { get; set; } | Värde av RichTextField. |
