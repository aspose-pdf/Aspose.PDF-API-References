---
title: "Klass RadioButtonField"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Forms.RadioButtonField-klass. Klass som representerar radioknappsfält."
type: docs
weight: 5330
...
Klassen som representerar radioknappfält.
...
| Namn | Beskrivning |
| --- | --- |
| [RadioButtonField](radiobuttonfield/#constructor)(Document) | Konstruktor för RadioButtonField. |
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Konstruktor för RadiouttonField |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Hämtar eller anger flaggan som tillåter radioknappen att ha inget valt värde. Om `true` ska exakt en radioknapp vara vald hela tiden; att välja den redan valda knappen har ingen effekt. Om `false` avmarkerar ett klick på den valda knappen den, så att ingen knapp är vald. |
...
| override [PageIndex](../../aspose.pdf.forms/radiobuttonfield/pageindex/) { get; } | Hämtar sidindex för den sida som innehåller detta RadioButton-fält. |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | Hämtar eller anger index för valt objekt. Numrering av objekt startar från 1. |
...
| [Style](../../aspose.pdf.forms/radiobuttonfield/style/) { get; set; } | Stil för fältbox. |
...
| override [Value](../../aspose.pdf.forms/radiobuttonfield/value/) { get; set; } | Hämtar eller anger värde för fältet. |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Lägg till alternativ till radion-knappen. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Lägg till alternativ till radioknappen med specificerad rektangel. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Flytta alla underobjekt för radioknappen till specificerade positioner på sidan. |
