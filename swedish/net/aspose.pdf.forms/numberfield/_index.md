...
description: Textfält med angivna giltiga tecken
type: docs
weight: 3090
...
Textfält med angivna giltiga tecken
...
| namn | Beskrivning |
| --- | --- |
| [NumberField](numberfield#constructor)() | Initierar en ny instans av[`NumberField`](../numberfield) class. |
| [NumberField](numberfield#constructor_1)(Document, Rectangle) | Initierar en ny instans av[`NumberField`](../numberfield) class. |
| [NumberField](numberfield#constructor_2)(Page, Rectangle) | Initierar en ny instans av[`NumberField`](../numberfield) class. |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars) { get; set; } | Hämtar eller ställer in tillåtna tecken. |
