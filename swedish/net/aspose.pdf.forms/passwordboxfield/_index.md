...
description: Aspose.Pdf.Forms.PasswordBoxField klass. Klassen beskriver textfält för att ange lösenord
type: docs
weight: 5200
url: /sv/net/aspose.pdf.forms/passwordboxfield/
---
## PasswordBoxField klass
...
| [FullName](../../aspose.pdf.annotations/annotation/fullname/) { get; } | Hämtar det fullständiga kvalificerade namnet på annoteringen. |
...
| [MappingName](../../aspose.pdf.forms/field/mappingname/) { get; set; } | Hämtar eller ställer in mappingsnamnet för fältet som ska användas vid export av interaktiva fältdata från dokumentet. |
