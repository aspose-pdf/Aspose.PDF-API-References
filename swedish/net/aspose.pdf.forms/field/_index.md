...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle) { get; set; } | Om sant kommer teckenstorleken att reduceras för att passa texten till den angivna rektangeln. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize) { get; set; } | Maximail teckenstorlek som kan användas för fältinnehåll. -1 för att inte kontrollera storleken. |
