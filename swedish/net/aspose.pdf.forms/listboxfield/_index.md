...
| Namn | Beskrivning |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | Konstruktor för ListBoxField att användas i Generator. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | Konstruktor för ListBox-fält. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | Hämtar eller anger index för det valda objektet. Objekt är numrerade från 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Hämtar eller anger array av de valda objekten i flervalslistan. För enkelvalslista returneras en array med ett enda objekt. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Hämtar eller anger index för det översta synliga elementet i listan. |
