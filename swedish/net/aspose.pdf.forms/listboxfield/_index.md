...
| namn | Beskrivning |
| --- | --- |
| [ListBoxField](listboxfield#constructor)() | Constructor för ListBoxField som ska användas i Generator. |
| [ListBoxField](listboxfield#constructor_1)(Document, Rectangle) | Konstruktör för ListBox-fält. |
| [ListBoxField](listboxfield#constructor_2)(Page, Rectangle) | Skapar nytt ListBox-fält. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected) { set; } | Hämtar eller ställer in index för det valda objektet. Objekten är numrerade från 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems) { set; } | Hämtar eller ställer in array av de markerade objekten i flervalslistan. För en enda lista returnerar array med enstaka objekt. |
