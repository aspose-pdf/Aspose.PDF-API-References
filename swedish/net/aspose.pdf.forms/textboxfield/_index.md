...
Klassen som representerar textrutefält.
...
| Namn | Beskrivning |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Konstruktor som bör användas med Generator. |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | Konstruktor för TextBox-fält. |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | Konstruktor för TextBox-fält. |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | Konstruktor för TextBox-fält. |
