...
description: Klass som representerar textrutans fält.
type: docs
weight: 3250
...
Klass som representerar textrutans fält.
...
| namn | Beskrivning |
| --- | --- |
| [TextBoxField](textboxfield#constructor)() | Skapa instans av TextBoxField. |
| [TextBoxField](textboxfield#constructor_1)(Document) | Constructor som ska användas med Generator. |
| [TextBoxField](textboxfield#constructor_2)(Document, Rectangle) | Konstruktör av TextBox-fältet. |
| [TextBoxField](textboxfield#constructor_3)(Page, Rectangle) | Konstruktör av TextBox-fältet. |
