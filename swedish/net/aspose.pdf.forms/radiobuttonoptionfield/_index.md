...
description: "Aspose.Pdf.Forms.RadioButtonOptionField klass. Klassen representerar ett objekt av RadioButton-fält"
type: docs
weight: 5340
...
Klassen representerar ett objekt i RadioButton-fältet.
...
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | Skapar radioknapp i den angivna rektangeln på den angivna sidan. |
...
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Hämtar eller anger rubrik. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Hämtar eller anger namn på alternativet. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Hämtar eller anger stil för kryssruta. |
