...
description: Aspose.Pdf.Forms.RadioButtonOptionField klass. Klassen representerar objektet av RadioButton-fältet
type: docs
weight: 5220
url: /sv/net/aspose.pdf.forms/radiobuttonoptionfield/
---
## RadioButtonOptionField klass

Klassen representerar objektet av RadioButton-fältet.
...
| Namn | Beskrivning |
| --- | --- |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor)() | Skapar en ny instans av RadioButtonOptionField. |
| [RadioButtonOptionField](radiobuttonoptionfield/#constructor_1)(Page, Rectangle) | Skapar radioknapp i den angivna rektangeln på angiven sida. |
...
| virtual [ActiveState](../../aspose.pdf.annotations/annotation/activestate/) { get; set; } | Hämtar eller ställer in den aktuella annoteringens utseende. |
| [AlternateName](../../aspose.pdf.forms/field/alternatename/) { get; set; } | Hämtar eller ställer in det alternativa namnet för fältet (Ett alternativt fältnamn som ska användas istället för det faktiska fältnamnet där fältet ska identifieras i användargränssnittet). Det alternativa namnet används som fältverktygstips i Adobe Acrobat. |
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | Hämtar eller ställer in annoteringens kantlinjekarakteristika. [`Border`](../../aspose.pdf.annotations/annotation/border/) |
| [Caption](../../aspose.pdf.forms/radiobuttonoptionfield/caption/) { get; set; } | Hämtar eller ställer in rubriken. |
...
| [OptionName](../../aspose.pdf.forms/radiobuttonoptionfield/optionname/) { get; set; } | Hämtar eller ställer in namnet på alternativet. |
...
| [Style](../../aspose.pdf.forms/radiobuttonoptionfield/style/) { get; set; } | Hämtar eller ställer in stilen för kryssrutan. |
