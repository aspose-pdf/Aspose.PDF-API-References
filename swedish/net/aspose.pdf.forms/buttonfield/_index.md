...
description: Klass representerar tryckknappsfält.
type: docs
weight: 2920
...
Klass representerar tryckknappsfält.
...
| namn | Beskrivning |
| --- | --- |
| [ButtonField](buttonfield#constructor)() | Knappfältskonstruktör för Generator. |
| [ButtonField](buttonfield#constructor_1)(Document, Rectangle) | ButtonField konstruktor. |
| [ButtonField](buttonfield#constructor_2)(Page, Rectangle) | ButtonField-konstruktör. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption) { get; set; } | Hämtar eller ställer in alternativ bildtext för knappen som ska visas när musknappen trycks ned inom dess aktiva område. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon) { get; set; } | Hämtar eller ställer in alternativ ikon som ska visas när musknappen trycks ned inom dess aktiva område. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit) { get; } | Hämtar ikonpassningsobjekt som anger hur widgetkommentarens ikon ska visas inom dess anteckningsrektangel. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition) { get; set; } | Hämtar eller ställer in ikontextposition. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption) { get; set; } | Får eller ställer in normal bildtext. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption) { get; set; } | Hämtar eller ställer in rollover-text för knappen som ska visas när användaren rullar markören till dess aktiva område utan att trycka på musknappen. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon) { get; set; } | Hämtar eller ställer in överrullningsikonen för knappen som ska visas när användaren rullar markören till sitt aktiva område utan att trycka på musknappen. |
