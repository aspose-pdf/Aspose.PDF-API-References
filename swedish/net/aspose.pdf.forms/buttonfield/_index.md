---
title: "Klass ButtonField"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Forms.ButtonField klass. Klassen representerar tryckknappsfält"
type: docs
weight: 5090
...
Klassen representerar tryckknappsfält.
...
| Namn | Beskrivning |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Konstruktor för knappfält för Generator. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Hämtar eller anger alternativ rubrik för knappen som ska visas när musknappen trycks ned inom dess aktiva område. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Hämtar eller anger alternativ ikon som ska visas när musknappen trycks ned inom dess aktiva område. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Hämtar ikonpassningsobjekt som specificerar hur widget-annotationens ikon ska visas inom dess annotationsrektangel. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Hämtar eller anger ikonkaptionsposition. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Hämtar eller anger normal rubrik. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Hämtar eller anger normal ikon för knappen som ska visas när den inte interagerar med användaren. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Hämtar eller anger rullningsrubrik för knappen som ska visas när användaren för muspekaren in i dess aktiva område utan att trycka på musknappen. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Hämtar eller anger rullningsikon för knappen som ska visas när användaren för muspekaren in i dess aktiva område utan att trycka på musknappen. |
