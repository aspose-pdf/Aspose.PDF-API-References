...
| Namn | Beskrivning |
| --- | --- |
| [Brightness](../../aspose.pdf.devices/tiffsettings/brightness/) { get; set; } | Hämtar eller anger ett värdegräns för färgtransformeringen i vitt och svart. Denna parameter kan tillämpas med EncoderValue.CompressionCCITT4, EncoderValue.CompressionCCITT3, EncoderValue.CompressionRle eller ColorDepth.Format1bpp == 1 |
| [Compression](../../aspose.pdf.devices/tiffsettings/compression/) { get; set; } | Hämtar eller anger komprimeringstypen. |
| [CoordinateType](../../aspose.pdf.devices/tiffsettings/coordinatetype/) { get; set; } | Hämtar eller anger sidkoordinattypen (Media/Crop‑boxar). CropBox‑värdet används som standard. |
| [Depth](../../aspose.pdf.devices/tiffsettings/depth/) { get; set; } | Hämtar eller anger färgdjupet. |
| [Margins](../../aspose.pdf.devices/tiffsettings/margins/) { get; } | Hämtar marginalerna. |
| [Shape](../../aspose.pdf.devices/tiffsettings/shape/) { get; set; } | Hämtar eller anger typ av formen. |
| [SkipBlankPages](../../aspose.pdf.devices/tiffsettings/skipblankpages/) { get; set; } | Hämtar eller anger ett värde som indikerar om tomma sidor ska hoppas över. |
