...
description: "PdfAnnotationEditor‑metod. Ändrar författaren till annotationerna på det angivna sidintervallet."
type: docs
weight: 130
...
Modifierar författaren till annotationerna på det angivna sidintervallet.
