...
description: PdfViewer-händelse. Inträffar innan utskriften börjar och gör det möjligt att tillhandahålla anpassade utskriftsbehandlare istället för den förvalda.
type: docs
weight: 200
url: /sv/net/aspose.pdf.facades/pdfviewer/customprint/
---
## PdfViewer.CustomPrint-händelse

Inträffar innan utskriften börjar och gör det möjligt att tillhandahålla anpassade utskriftsbehandlare istället för den förvalda.
...
Exemplet visar hur man skriver ut från Aspose.PDF på Linux-system. Följande kod är främst inriktad på att skriva ut från Aspose.PDF på Linux-system. Användare av Windows-system kan fortsätta använda den förvalda PdfViewer-utskriftsimplementeringen utan att tillhandahålla en CustomPrint-behandlare.

### Förutsättningar

1. På utskriftsserverns system bör CUPS vara installerat och konfigurerat:
* sudo apt update && apt install cups
* sudo service cups start
* om du ska skriva ut dokument på samma system där Aspose.PDF-aktiverade appen körs, behöver du ingen ytterligare CUPS-konfiguration. Om du behöver skriva ut från ett annat system, vänligen hänvisa till CUPS-dokumentationen om hur man tillåter åtkomst till utskriftsservern via nätverket.
2. En skrivare kan ställas in med hjälp av CUPS webbgränssnitt. Valfritt kan du använda en virtuell PDF-skrivare:
* sudo apt install printer-driver-cups-pdf
* sudo service cups restart
* vänligen se till att den virtuella PDF-skrivaren dök upp i listan över tillgängliga skrivare i CUPS webbgränssnitt (vid http://localhost:631/printers/ med standard CUPS-inställningar)
3. Om ditt klientsystem (där Aspose.PDF-aktiverade appen körs) är annorlunda än utskriftsservern, behöver du installera och köra CUPS där också:
* sudo apt update && apt install cups
* sudo service cups start

### Hur man skriver ut ett dokument med lp-kommandot
...
### Hur man skriver ut ett dokument med ipptool
...
* klass [CustomPrintEventArgs](../../../aspose.pdf.printing/customprinteventargs/)
* klass [PdfViewer](../)
