---
title: "Klass ILSTextElement"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.LogicalStructure.ILSTextElement klass. Representerar en bas-klass för inlinelevel text struktur-element i den logiska strukturen"
type: docs
weight: 6540
...
Representerar en basklass för inline-nivå textstrukturelement i logisk struktur.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Hämtar StructureTextState-objekt för aktuellt element. |
