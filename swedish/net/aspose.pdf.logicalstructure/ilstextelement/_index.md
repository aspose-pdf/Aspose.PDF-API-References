...
description: Aspose.Pdf.LogicalStructure.ILSTextElement klass. Representerar en basklass för inline-nivå textstruktur element i logisk struktur
type: docs
weight: 6400
url: /sv/net/aspose.pdf.logicalstructure/ilstextelement/
---
## ILSTextElement klass

Representerar en basklass för inline-nivå textstruktur element i logisk struktur.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | Hämtar StructureTextState objekt för nuvarande element. |
...
* gränssnitt [ITextElement](../itextelement/)
