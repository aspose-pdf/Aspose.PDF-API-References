...
description: Representerar en basklass för barnelement i Warichu i logisk struktur.
type: docs
weight: 4690
...
Representerar en basklass för barnelement i Warichu i logisk struktur.
