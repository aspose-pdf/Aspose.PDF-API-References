...
description: StructureTypeStandard-fält. Annotation PDF 1.5 En koppling mellan en del av ILSE:s innehåll och en motsvarande PDF-annotering. Annot ska användas för alla PDF-annoteringar utom länkannoteringar och widgetannoteringar
type: docs
weight: 10
