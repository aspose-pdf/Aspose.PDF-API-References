...
description: Representerar en basklass för strukturelement på blocknivå i logisk struktur.
type: docs
weight: 4070
...
Representerar en basklass för strukturelement på blocknivå i logisk struktur.
