...
description: Aspose.Pdf.LogicalStructure.TableChildElement klass. Representerar en basklass för barn element av Tabellen i logisk struktur
type: docs
weight: 6770
url: /sv/net/aspose.pdf.logicalstructure/tablechildelement/
---
## TableChildElement klass

Representerar en basklass för barn element av Tabellen i logisk struktur.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Tar bort ett element från strukturen, en referens till det från föräldraobjektet, referenser till det från barnobjekt, och det motsvarande objektet från dokumentet. Infogar barnobjekt av det borttagna objektet i dess tidigare förälders barnobjekt kollektion som börjar vid indexet för det borttagna objektet. |
