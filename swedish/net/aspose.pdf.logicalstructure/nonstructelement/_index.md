...
description: Aspose.Pdf.LogicalStructure.NonStructElement klass. Representerar NonStruct struktur element i logisk struktur
type: docs
weight: 6510
url: /sv/net/aspose.pdf.logicalstructure/nonstructelement/
---
## NonStructElement klass

Representerar NonStruct struktur element i logisk struktur.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Tar bort ett element från strukturen, en referens till det från föräldraobjektet, referenser till det från barnobjekt, och det motsvarande objektet från dokumentet. Infogar barnobjekten av det borttagna objektet i dess tidigare förälders barnobjekt kollektion som börjar vid indexet av det borttagna objektet. |
