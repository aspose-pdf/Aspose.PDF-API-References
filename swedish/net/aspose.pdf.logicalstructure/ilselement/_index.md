...
description: Representerar en basklass för strukturelement på inline-nivå i logisk struktur.
type: docs
weight: 4220
...
Representerar en basklass för strukturelement på inline-nivå i logisk struktur.
