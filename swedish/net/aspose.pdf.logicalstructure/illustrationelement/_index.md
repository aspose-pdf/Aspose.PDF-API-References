...
description: Representerar en basklass för illustrationsstrukturelement i logisk struktur.
type: docs
weight: 4250
...
Representerar en basklass för illustrationsstrukturelement i logisk struktur.
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage)(string, double) | Lägger till bild till aktuellt illustrationselement. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage#setimage_1)(string, double, double) | Lägger till bild till aktuellt illustrationselement. |
