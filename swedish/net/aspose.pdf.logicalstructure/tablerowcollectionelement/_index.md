...
description: Representerar en basklass för barnelement i bordshuvud kropp och fot i logisk struktur.
type: docs
weight: 4620
...
Representerar en basklass för barnelement i bordshuvud, kropp och fot i logisk struktur.
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr)() | Skapar[`TableTRElement`](../tabletrelement) och lade till den i nuvarande tabell. |
