...
description: Aspose.Pdf.LogicalStructure.TableTFootElement klass. Representerar TFoot struktur element i den logiska strukturen av tabellen
type: docs
weight: 6820
url: /sv/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## TableTFootElement klass

Representerar TFoot struktur element i den logiska strukturen av tabellen.
...
| Namn | Beskrivning |
| --- | --- |
| [AppendChild](../../aspose.pdf.logicalstructure/element/appendchild/)(Element, bool) | Lägger till Element till samlingen av barn. |
...
| [InsertChild](../../aspose.pdf.logicalstructure/element/insertchild/)(Element, int, bool) | Infogar Element till samlingen av barn vid angiven index. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Tar bort ett element från strukturen, en referens till det från föräldraobjektet, referenser till det från barnobjekt, och det motsvarande objektet från dokumentet. Infogar barnobjekten av det borttagna objektet i dess tidigare förälders barnobjekts samling som börjar vid indexet för det borttagna objektet. |
