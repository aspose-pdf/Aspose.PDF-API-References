...
description: Aspose.Pdf.LogicalStructure.RubyChildElement klass. Representerar en basklass för barn element av Ruby i logisk struktur
type: docs
weight: 6590
url: /sv/net/aspose.pdf.logicalstructure/rubychildelement/
---
## RubyChildElement klass

Representerar en basklass för barn element av Ruby i logisk struktur.
...
| Namn | Beskrivning |
| --- | --- |
| [AppendChild](../../aspose.pdf.logicalstructure/element/appendchild/)(Element, bool) | Lägger till Element i kollektionen av barn. |
| [ChangeParentElement](../../aspose.pdf.logicalstructure/structureelement/changeparentelement/)(StructureElement, bool) | Ändrar föräldraelement för nuvarande struktur element |
...
| [InsertChild](../../aspose.pdf.logicalstructure/element/insertchild/)(Element, int, bool) | Infogar Element i kollektionen av barn vid angiven index. |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Tar bort ett element från strukturen, en referens till det från föräldraobjektet, referenser till det från barnobjekt, och det motsvarande objektet från dokumentet. Infogar barnobjekten av det borttagna objektet i dess tidigare förälders barnobjektskollektion som börjar vid indexet för det borttagna objektet. |
...
* klass [StructureElement](../structureelement/)
