...
description: Representerar en basklass för textstrukturelement på blocknivå i logisk struktur.
type: docs
weight: 4080
...
Representerar en basklass för textstrukturelement på blocknivå i logisk struktur.
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate) { get; } | BlirStructureTextState objekt för aktuellt element. |
...
| [SetText](../../aspose.pdf.logicalstructure/blstextelement/settext)(string) | Lägger till textinnehåll till aktuellt textelement. |
