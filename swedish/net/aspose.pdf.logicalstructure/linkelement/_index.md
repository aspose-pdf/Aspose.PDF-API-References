...
description: Aspose.Pdf.LogicalStructure.LinkElement klass. Representerar länkstrukturens element i den logiska strukturen
type: docs
weight: 6440
...
Representerar länkstrukturens element i den logiska strukturen.
...
| [Hyperlink](../../aspose.pdf.logicalstructure/linkelement/hyperlink/) { get; set; } | Hämtar eller sätter Hyperlänk för länk elementet. |
...
| [StructureTextState](../../aspose.pdf.logicalstructure/linkelement/structuretextstate/) { get; } | Hämtar StructureTextState-objektet för det aktuella elementet. |
...
* klass [AnnotationElement](../annotationelement/)
