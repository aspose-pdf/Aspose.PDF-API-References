---
title: "Klass HeaderArtifact"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.HeaderArtifact-klass. Klassen beskriver Header-artifakt. Detta artefakt kan användas för att ange rubriken på sidan"
type: docs
weight: 5540
...
Klass beskriver sidhuvudartefakt. Detta artefakt kan användas för att ange rubrik på sidan.
...
| Namn | Beskrivning |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Skapar en Header-artifakt-instans. |
