...
description: Klass beskriver Header-artefakt. Denna artifacgt kan användas för att ställa in rubriken på sidan.
type: docs
weight: 3340
...
Klass beskriver Header-artefakt. Denna artifacgt kan användas för att ställa in rubriken på sidan.
...
| namn | Beskrivning |
| --- | --- |
| [HeaderArtifact](headerartifact)() | Skapar Header Artifact-instans. |
