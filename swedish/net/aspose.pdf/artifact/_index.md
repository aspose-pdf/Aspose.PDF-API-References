...
| namn | Beskrivning |
| --- | --- |
| [Artifact](artifact#constructor)(ArtifactType, ArtifactSubtype) | Konstruktör av artefakt med angiven typ och undertyp |
| [Artifact](artifact#constructor_1)(string, string) | Konstruktör av artefakt med angiven typ och undertyp |
...
| [SetImage](../../aspose.pdf/artifact/setimage#setimage)(Stream) | Ställer in bilden av artefakten. |
| [SetImage](../../aspose.pdf/artifact/setimage#setimage_1)(string) | Ställer in bilden av artefakten. |
...
| namn | Beskrivning |
| --- | --- |
| enum [ArtifactSubtype](artifact.artifactsubtype) | Uppräkning av möjliga artefakter undertyp. |
| enum [ArtifactType](artifact.artifacttype) | Uppräkning av möjliga artefakttyper. |
