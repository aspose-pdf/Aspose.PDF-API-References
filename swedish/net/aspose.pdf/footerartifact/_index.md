---
title: "Klass FooterArtifact"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.FooterArtifact klass. Beskriver sidfotartefakt. Detta kan användas för att sätta sidfot på sidan."
type: docs
weight: 5050
...
Beskriver sidfotartefakt. Detta kan användas för att ange sidfot på sidan.
...
| Namn | Beskrivning |
| --- | --- |
| [FooterArtifact](footerartifact/)() | Skapar Footer Artifact-instans. |
