...
description: Beskriver sidfotsartefakt. Detta kan användas för att sätta sidfot på sidan.
type: docs
weight: 2880
...
Beskriver sidfotsartefakt. Detta kan användas för att sätta sidfot på sidan.
...
| namn | Beskrivning |
| --- | --- |
| [FooterArtifact](footerartifact)() | Skapar sidfotsartefaktinstans. |
