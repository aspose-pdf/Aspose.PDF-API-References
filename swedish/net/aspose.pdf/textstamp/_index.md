---
title: "Klass TextStamp"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.TextStamp-klass. Representerar textstämpling."
type: docs
weight: 11270
...
| [AutoAdjustFontSizeToFitStampRectangle](../../aspose.pdf/textstamp/autoadjustfontsizetofitstamprectangle/) { get; set; } | Om aktiverat kommer teckenstorleken att automatiskt justeras för att passa stämpelrektangeln med storleken: [`Width`](./width/) och [`Height`](./height/). Standardbredd och -höjd hämtas från sidrektangeln. |
...
| [TextState](../../aspose.pdf/textstamp/textstate/) { get; } | Hämtar textegenskaperna för stämpeln. Se [`TextState`](./textstate/) för detaljer. |
...
| override [Put](../../aspose.pdf/textstamp/put/)(Page) | Lägger till en textstämpel på sidan. |
...
| Namn | Beskrivning |
| --- | --- |
| enum [NoCharacterAction](../../aspose.pdf/textstamp.nocharacteraction) | Åtgärd att utföra om teckensnittet inte innehåller det erforderliga tecknet. |
