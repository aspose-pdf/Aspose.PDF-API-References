...
description: Representerar sidnummerstämpel och används för att numrera sidor.
type: docs
weight: 5890
...
| namn | Beskrivning |
| --- | --- |
| [PageNumberStamp](pagenumberstamp#constructor)() | Initierar en ny instans av[`PageNumberStamp`](../pagenumberstamp) klass. Formatet är inställt på "#". |
| [PageNumberStamp](pagenumberstamp#constructor_1)(FormattedText) | Skapar sidnummerstämpel med formaterad text. |
| [PageNumberStamp](pagenumberstamp#constructor_2)(string) | Initierar en ny instans av[`PageNumberStamp`](../pagenumberstamp) class. |
...
| [Format](../../aspose.pdf/pagenumberstamp/format) { get; set; } | Strängvärde för stämpling av sidnummer. Värdet måste innehålla tecknet '#' som ersätts med sidnumret under stämplingen. |
...
| [StartingNumber](../../aspose.pdf/pagenumberstamp/startingnumber) { get; set; } | Hämtar eller ställer in värdet på antalet startsidor. Andra sidor kommer att numreras från detta värde. |
| [TextAlignment](../../aspose.pdf/textstamp/textalignment) { get; set; } | Justering av texten inuti stämpeln. |
| [TextState](../../aspose.pdf/textstamp/textstate) { get; } | Hämtar textegenskaper för stämpeln. Ser[`TextState`](../textstamp/textstate) för detaljer. |
