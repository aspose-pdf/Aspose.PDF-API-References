...
description: "PptxSaveOptions-egenskapen. Denna hanterare kan användas för att hantera konverteringsförlopps‑händelser, t.ex. för att visa en förloppsindikator eller meddelanden om det aktuella antalet bearbetade sidor. Exempel på kod för en hanterare som visar förloppet i konsolen är"
type: docs
weight: 20
