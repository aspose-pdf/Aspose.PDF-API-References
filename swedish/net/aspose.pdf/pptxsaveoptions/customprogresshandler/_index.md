...
description: PptxSaveOptions-egenskap. Denna hanterare kan användas för att hantera konverteringsprogress-händelser, t.ex. den kan användas för att visa en progressindikator eller meddelanden om nuvarande antal bearbetade sidor, exempel på hanterarens kod som visar progress i konsolen är
type: docs
weight: 20
url: /sv/net/aspose.pdf/pptxsaveoptions/customprogresshandler/
---
## PptxSaveOptions.CustomProgressHandler-egenskap

Denna hanterare kan användas för att hantera konverteringsprogress-händelser, t.ex. den kan användas för att visa en progressindikator eller meddelanden om nuvarande antal bearbetade sidor, exempel på hanterarens kod som visar progress i konsolen är :
