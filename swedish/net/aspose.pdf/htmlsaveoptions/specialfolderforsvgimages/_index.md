...
description: HtmlSaveOptions-fält. Hämtar eller ställer in sökväg till katalogen där endast SVG-bilder måste sparas om de stöts på under sparande av dokumentet som HTML. Om parametern är tom eller null kommer SVG-filer (om några) att sparas tillsammans med andra bildfiler (nära utdatafilen) eller i en speciell mapp för bilder (om det anges i alternativet SpecialImagesFolderIfAny). Det påverkar ingenting om egenskapen CustomImageSavingStrategy framgångsrikt har använts för att bearbeta relevant bildfil.
type: docs
weight: 450
