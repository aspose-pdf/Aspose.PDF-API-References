...
description: CssUrlRequestInfo-fält. Ska sättas av anpassad kod om den inte kan eller inte bör definiera URL som kommer att användas i den genererade HTML:en för referens av den CSS:en. Om det är sant kommer CSS-filen att sparas på standard sätt på standard plats
type: docs
weight: 20
