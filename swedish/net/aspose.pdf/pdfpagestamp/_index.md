...
description: Klass representerar stämpel som använder PDF-sida som stämpel.
type: docs
weight: 6070
...
Klass representerar stämpel som använder PDF-sida som stämpel.
...
| namn | Beskrivning |
| --- | --- |
| [PdfPageStamp](pdfpagestamp#constructor)(Page) | Konstruktör av PdfPageStamp. |
| [PdfPageStamp](pdfpagestamp#constructor_1)(Stream, int) | Skapar pdf-sidastämpel från angiven sida i dokumentet från strömmen. |
| [PdfPageStamp](pdfpagestamp#constructor_2)(string, int) | Skapar PDF-sidastämpel från angiven sida i dokumentet i angiven fil. |
...
| [PdfPage](../../aspose.pdf/pdfpagestamp/pdfpage) { get; set; } | Hämtar eller ställer in sida som ska användas som stämpel. |
...
| override [Put](../../aspose.pdf/pdfpagestamp/put)(Page) | Sätt stämpel på den angivna sidan. |
