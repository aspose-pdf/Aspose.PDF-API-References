---
title: "Klass VectorStoreFileListQueryParameters"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.AI.VectorStoreFileListQueryParameters klass. Objekt för frågeparametrar för att lista vector store files"
type: docs
weight: 1420
...
Objekt för frågeparametrar för att lista vektorlagerfiler.
...
| [Filter](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/filter/) { get; set; } | Hämtar eller anger ett filter efter filstatus. En av in_progress, completed, failed, cancelled. |
...
| Namn | Beskrivning |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/vectorstorefilelistqueryparameters/getqueryparameters/)() | Hämtar frågeparametrarna för att lista vector store files. |
