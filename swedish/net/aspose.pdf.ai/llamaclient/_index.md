...
| Namn | Beskrivning |
| --- | --- |
| [CreateCompletionAsync](../../aspose.pdf.ai/llamaclient/createcompletionasync/)(LlamaChatCompletionRequest, CancellationToken?) | Skapar en chatt‑slutförande‑förfrågan i Llama‑tjänsten. |
