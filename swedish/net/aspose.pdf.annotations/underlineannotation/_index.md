---
title: "Klassen UnderlineAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.UnderlineAnnotation class. Representerar en understrykningsannotation som visas som en understrykning i dokumentets text."
type: docs
weight: 2800
...
| Namn | Beskrivning |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | Skapar en ny understrykningsannotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
