...
description: Aspose.Pdf.Annotations.UnderlineAnnotation klass. Representerar en understrykning som visas som en understrykning i texten i dokumentet
type: docs
weight: 2700
url: /sv/net/aspose.pdf.annotations/underlineannotation/
---
## UnderlineAnnotation klass

Representerar en understrykning som visas som en understrykning i texten i dokumentet.
...
| Namn | Beskrivning |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | Skapar en ny understrykning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | Hämtar typ av annotering. |
...
| [QuadPoints](../../aspose.pdf.annotations/textmarkupannotation/quadpoints/) { get; set; } | Hämtar eller ställer in en array av punkter som specificerar koordinaterna för n fyrhörningar. Varje fyrhörning omfattar ett ord eller en grupp av sammanhängande ord i texten under annoteringen. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta annoteringen. |
...
| [GetMarkedText](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtext/)() | Hämtar text under markup-annoteringen som sträng. |
| [GetMarkedTextFragments](../../aspose.pdf.annotations/textmarkupannotation/getmarkedtextfragments/)() | Hämtar text under markup-annoteringen som [`TextFragmentCollection`](../../aspose.pdf.text/textfragmentcollection/). |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | Ställer in granskningsstatus för en annotering. Markerade och omarkerade tillstånd ignoreras eftersom de inte tillhör granskningsmodell. Tillståndet ställs in av användaren som skapade den aktuella annoteringen. Värdet tas från Title-egenskapen för den aktuella annoteringen. Observera att tillståndet lagras i andra textannoteringar som har tillstånds- och tillståndsmodellnycklar. |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | Ställer in granskningsstatus för en annotering. Markerade och omarkerade tillstånd ignoreras eftersom de inte tillhör granskningsmodell. Observera att tillståndet lagras i andra textannoteringar som har tillstånds- och tillståndsmodellnycklar. |
