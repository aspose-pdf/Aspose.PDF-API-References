...
description: Representerar en understrykningskommentar som visas som en understrykning i dokumentets text.
type: docs
weight: 1240
...
Representerar en understrykningskommentar som visas som en understrykning i dokumentets text.
...
| namn | Beskrivning |
| --- | --- |
| [UnderlineAnnotation](underlineannotation)(Page, Rectangle) | Skapar ny understrykningsanteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype) { get; } | Får typ av anteckning. |
