...
description: "Aspose.Pdf.Annotations.CommonFigureAnnotation-klass. Abstrakt klass som representerar en gemensam figure annotation"
type: docs
weight: 1710
...
Abstrakt klass som representerar en gemensam figurannotation.
...
| Namn | Beskrivning |
| --- | --- |
| [CommonFigureAnnotation](commonfigureannotation/)(Document) | Konstruktor för användning i Generator. |
