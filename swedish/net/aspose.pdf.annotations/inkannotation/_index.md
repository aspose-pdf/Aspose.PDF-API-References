...
description: Representerar en klotter på fri hand som består av en eller flera disjunkta banor.
type: docs
weight: 540
...
Representerar en "klotter" på fri hand som består av en eller flera disjunkta banor.
...
| [InkAnnotation](inkannotation#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Skapar ny bläckanteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle) { get; set; } | Stil för ändelser av bläckanteckningsrader. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist) { get; set; } | Hämtar eller ställer in en lista med gester som är oberoende linjer som representeras av Point[]-matriser. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize)(Matrix) | Uppdaterar punkterna i InkList, enligt matristransformationen. |
