---
title: "Klass InkAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.InkAnnotation klass. Representerar en frihandsritning bestående av en eller flera separata banor"
type: docs
weight: 2010
...
| Namn | Beskrivning |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Konstruktor för Ink-annotation för Generator. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Skapar ny Ink-annotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Stil för ink-annotationens linjeändar. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Hämtar eller anger lista över gester som är oberoende linjer representerade av Point[]-arrayer. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Uppdaterar punkterna i InkList enligt matrisomvandlingen. |
