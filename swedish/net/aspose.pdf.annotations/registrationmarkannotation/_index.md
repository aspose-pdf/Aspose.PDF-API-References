---
title: "Klass RegistrationMarkAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.RegistrationMarkAnnotation-klass. Representerar en Registreringsmarkör-annotering."
type: docs
weight: 2500
...
Representerar en Registreringsmärkesanteckning.
...
| Namn | Beskrivning |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | Initierar en ny instans av klassen `RegistrationMarkAnnotation` på den angivna sidan på den angivna platsen. |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | Hämtar eller anger positionen för registreringsmarkören på en sida. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | Accepterar besökare för annoteringsbearbetning. |
...
Registreringsmarkörer är symboler som läggs till på tryckplåtar eller skärmar för att säkerställa korrekt färgjustering under tryckprocessen.
