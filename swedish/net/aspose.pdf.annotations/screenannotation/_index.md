---
title: "Klass ScreenAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.ScreenAnnotation-klass. En skärmannotation som specificerar ett område på en sida där medieklipp kan spelas upp"
type: docs
weight: 2610
...
En skärmanteckning som specificerar ett område på en sida där mediaklipp kan spelas.
...
| Namn | Beskrivning |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | Skapar ny Screen-annotation på den angivna sidan. |

## Egenskaper

| Namn | Beskrivning |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Hämtar eller anger en åtgärd som ska utföras när annotationen aktiveras. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Hämtar eller anger titeln på skärmannotationen. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
