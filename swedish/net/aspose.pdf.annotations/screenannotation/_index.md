...
description: En skärmkommentar som anger en region på en sida där medieklipp kan spelas upp.
type: docs
weight: 1060
...
En skärmkommentar som anger en region på en sida där medieklipp kan spelas upp.
...
| namn | Beskrivning |
| --- | --- |
| [ScreenAnnotation](screenannotation)(Page, Rectangle, string) | Skapar ny skärmkommentar på den angivna sidan. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action) { get; } | Hämtar eller ställer in en åtgärd som ska utföras när anteckningen aktiveras. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title) { get; set; } | Hämtar eller ställer in titeln på skärmkommentaren. |
