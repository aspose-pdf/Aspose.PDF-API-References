...
description: Abstrakt klass som representerar uppmärkningskommentarer.
type: docs
weight: 640
...
Abstrakt klass som representerar uppmärkningskommentarer.
...
| namn | Beskrivning |
| --- | --- |
| [MarkupAnnotation](markupannotation)(Document) | Konstruktör för uppmärkningskommentarer. |
