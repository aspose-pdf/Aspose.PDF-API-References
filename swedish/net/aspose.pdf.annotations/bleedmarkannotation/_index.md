...
description: Aspose.Pdf.Annotations.BleedMarkAnnotation klass. Representerar en Bleed Mark-anteckning
type: docs
weight: 1500
url: /sv/net/aspose.pdf.annotations/bleedmarkannotation/
---
## BleedMarkAnnotation klass

Representerar en Bleed Mark-anteckning.
...
| Namn | Beskrivning |
| --- | --- |
| [BleedMarkAnnotation](bleedmarkannotation/)(Page, PrinterMarkCornerPosition) | Initierar en ny instans av `BleedMarkAnnotation` klassen. |
...
| override [AnnotationType](../../aspose.pdf.annotations/bleedmarkannotation/annotationtype/) { get; } | Hämtar typ av anteckning. |
...
| [Position](../../aspose.pdf.annotations/cornerprintermarkannotation/position/) { get; set; } | Hämtar eller ställer in positionen för markeringen på sidan. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | Accepterar besökare för anteckningsbehandling. |
...
Bleed marks placeras i hörnen av en tryckt sida för att indikera var sidan ska trimmas och hur långt den får avvika från trimmärkena.
