---
title: "Klass StrikeOutAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation klass. Representerar en genomstruken annotering som visas som en genomstrykning i dokumentets text."
type: docs
weight: 2730
...
Representerar en genomstruken annotation som visas som en genomstrykning i dokumentets text.
...
| Namn | Beskrivning |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | Skapar ny StrikeOut-annotering på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/strikeoutannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
