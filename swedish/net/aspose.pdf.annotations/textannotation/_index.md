...
description: Representerar en textkommentar som är en klisterlapp fäst vid en punkt i PDF-dokumentet.
type: docs
weight: 1200
...
Representerar en textkommentar som är en �klisterlapp� fäst vid en punkt i PDF-dokumentet.
...
| namn | Beskrivning |
| --- | --- |
| [TextAnnotation](textannotation#constructor)(Document) | Konstruktör för anteckning när den används i Generator. |
| [TextAnnotation](textannotation#constructor_1)(Page, Rectangle) | Skapar ny textkommentar på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon) { get; set; } | Hämtar eller ställer in en ikon som ska användas för att visa anteckningen. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open) { get; set; } | Hämtar eller ställer in en flagga som anger om anteckningen initialt ska visas öppen. |
...
| [State](../../aspose.pdf.annotations/textannotation/state) { get; set; } | Hämtar eller ställer in tillståndet som den ursprungliga kommentaren ska ställas in. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize)(Matrix) | Uppdaterar start- och slutpunkterna, enligt matristransformeringen. |
