---
title: "Klassen TextAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.TextAnnotation-klass. Representerar en textanteckning som är en klistrig lapp fäst vid en punkt i PDF-dokumentet"
type: docs
weight: 2750
...
| Namn | Beskrivning |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Konstruktor för anteckning när den används i Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Skapar en ny Text-anteckning på den angivna sidan. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Hämtar eller anger en ikon som ska användas för att visa anteckningen. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Hämtar eller anger en flagga som specificerar om anteckningen initialt ska visas öppen. |
