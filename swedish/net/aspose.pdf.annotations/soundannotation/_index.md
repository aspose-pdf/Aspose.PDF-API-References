---
title: "Klass SoundAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.SoundAnnotation class. Representerar en ljudanteckning som innehåller ljud inspelat från datorns mikrofon eller importerat från en fil"
type: docs
weight: 2630
...
| Namn | Beskrivning |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | Skapar en ny Sound-anteckning på den angivna sidan. |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | Skapar en ny Sound-anteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | Hämtar eller anger en ikon som ska användas för att visa anteckningen. |
