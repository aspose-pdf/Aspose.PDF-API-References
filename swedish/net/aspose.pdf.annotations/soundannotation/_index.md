...
description: Representerar en ljudkommentar som innehåller ljud inspelat från datorns mikrofon eller importerat från en fil.
type: docs
weight: 1080
...
Representerar en ljudkommentar som innehåller ljud inspelat från datorns mikrofon eller importerat från en fil.
...
| namn | Beskrivning |
| --- | --- |
| [SoundAnnotation](soundannotation#constructor)(Page, Rectangle, string) | Skapar en ny ljudkommentar på den angivna sidan. |
| [SoundAnnotation](soundannotation#constructor_1)(Page, Rectangle, string, SoundSampleData) | Skapar en ny ljudkommentar på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon) { get; set; } | Hämtar eller ställer in en ikon som ska användas för att visa anteckningen. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata) { get; } | Hämtar ett ljudobjekt som definierar ljudet som ska spelas när anteckningen aktiveras. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
