---
title: "Klass WatermarkAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.WatermarkAnnotation klass. Klass som beskriver Watermark-annoteringsobjekt."
type: docs
weight: 2810
...
Klass som beskriver vattenstämpel‑annotationsobjekt.
...
| Namn | Beskrivning |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation/)(Page, Rectangle) | Konstruktor för Watermark-annoteringsklass. |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype/) { get; } | Hämtar annoteringstyp. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint/) { get; } | Fuxed utskriftsobjekt för Watermark-annotering. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity/) { get; set; } | Hämtar eller anger opacitet för annoteringen. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept/)(AnnotationSelector) | Applicera besökare för annotering. |
...
| [SetText](../../aspose.pdf.annotations/watermarkannotation/settext/)(FormattedText) | Ange text för annoteringen. |
| [SetTextAndState](../../aspose.pdf.annotations/watermarkannotation/settextandstate/)(string[], TextState) | Ange text för annoteringen. |
