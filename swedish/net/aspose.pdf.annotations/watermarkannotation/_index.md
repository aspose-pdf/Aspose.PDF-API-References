...
description: Klass beskriver vattenmärkesanteckningsobjekt.
type: docs
weight: 1250
...
Klass beskriver vattenmärkesanteckningsobjekt.
...
| namn | Beskrivning |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)(Page, Rectangle) | Konstruktör för vattenmärkesanteckningsklass. |
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype) { get; } | Hämtar anteckningstyp. |
...
| [FixedPrint](../../aspose.pdf.annotations/watermarkannotation/fixedprint) { get; } | Fuxed utskriftsobjekt med vattenstämpelkommentar. |
...
| [Opacity](../../aspose.pdf.annotations/watermarkannotation/opacity) { get; set; } | Hämtar eller ställer in opaciteten för annoteringen. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept)(AnnotationSelector) | Ansök besökare för anteckning. |
