...
| namn | Beskrivning |
| --- | --- |
| [FitVExplicitDestination](fitvexplicitdestination#constructor_2)(int, double) | Skapar explicit fjärrdestination. |
...
| namn | Beskrivning |
| --- | --- |
| [Left](../../aspose.pdf.annotations/fitvexplicitdestination/left) { get; } | Får den horisontella koordinaten placerad till vänster vid fönstrets vänstra kant. |
