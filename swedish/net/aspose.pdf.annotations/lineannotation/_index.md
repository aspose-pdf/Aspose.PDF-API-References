...
description: Klass som representerar linjekommentar.
type: docs
weight: 600
...
Klass som representerar linjekommentar.
...
| [LineAnnotation](lineannotation#constructor_1)(Page, Rectangle, Point, Point) | Skapar ny radkommentar på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset) { get; set; } | Hämtar eller ställer in bildtextförskjutning från sin normala position. |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition) { get; set; } | Hämtar eller ställer in kommentarstextposition. |
...
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle) { get; set; } | Hämtar eller ställer in slutstil för linjens slutpunkt. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent) { get; set; } | Hämtar eller ställer in syftet med radkommentaren. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor) { get; set; } | Hämtar eller ställer in interiörfärgen på annoteringen. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline) { get; set; } | Hämtar eller ställer in ledarlinjens längd. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension) { get; set; } | Hämtar eller ställer in längden på ledarlinjeförlängningen. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset) { get; set; } | Får eller ställer in ledarlinjeförskjutning. |
| [Margin](../../aspose.pdf/baseparagraph/margin) { get; set; } | Hämtar eller ställer in en yttre marginal för stycke (för pdf-generering) |
| [Measure](../../aspose.pdf.annotations/lineannotation/measure) { get; set; } | Måttenheter som har angetts för denna anteckning. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption) { get; set; } | Hämtar eller ställer in boolesk flagga som bestämmer innehållet måste visas som bildtext. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting) { get; set; } | Hämtar eller ställer in startpunkten för linjen. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle) { get; set; } | Hämtar eller ställer in linjeslutstil för linjestartpunkt. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept)(AnnotationSelector) | Accepterar besökare till anteckningsbearbetning. |
