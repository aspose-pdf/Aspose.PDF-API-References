---
title: "Klass LineAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.LineAnnotation klass. Klass som representerar linjeannotation"
type: docs
weight: 2070
...
Klass som representerar en linje‑annotation.
...
| Namn | Beskrivning |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Konstruktor för användning med Generator. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Skapar en ny linjeannotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Hämtar eller anger bildtextens förskjutning från dess normala position. |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition/) { get; set; } | Hämtar eller anger annotationens bildtextposition. |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | Hämtar eller anger linjens slutpunkt. |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | Hämtar eller anger avslutningsstil för linjens slutpunkt. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | Hämtar eller anger avsikten med linjeannotation. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor/) { get; set; } | Hämtar eller anger annotationens inre färg. |
...
| [LeaderLine](../../aspose.pdf.annotations/lineannotation/leaderline/) { get; set; } | Hämtar eller anger ledarlinjens längd. |
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | Hämtar eller anger längden på förlängning av ledarlinje. |
| [LeaderLineOffset](../../aspose.pdf.annotations/lineannotation/leaderlineoffset/) { get; set; } | Hämtar eller anger förskjutning för ledarlinje. |
| [Margin](../../aspose.pdf/baseparagraph/margin/) { get; set; } | Hämtar eller anger en yttre marginal för stycket (för pdf-generering) |
| [Measure](../../aspose.pdf.annotations/lineannotation/measure/) { get; set; } | Måttenheter som anges för denna anteckning. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Hämtar eller anger ett booleskt flagga som bestämmer om innehållet ska visas som rubrik. |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | Hämtar eller anger startpunkten för linjen. |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | Hämtar eller anger stil för linjeavslut för linjens startpunkt. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Uppdaterar start- och slutpunkterna enligt matrisomvandlingen. |
