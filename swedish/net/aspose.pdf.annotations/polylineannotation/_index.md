---
title: "Klass PolylineAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.PolylineAnnotation class. Representerar en polylinjeanteckning som liknar en polygon förutom att den första och sista hörnet inte är implicit kopplade"
type: docs
weight: 2410
...
Representerar polylinjeanteckning som liknar polygon, förutom att den första och sista vertexen inte är implicit anslutna.
...
| Namn | Beskrivning |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | Skapar en ny Polyline-anteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Hämtar eller anger stilen för den andra linjeänden. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Hämtar eller anger avsikten med polygon- eller polylinjeanteckningen. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Hämtar eller anger fyllningsfärgen som används för att fylla anteckningens linjeändar. |
...
| [Measure](../../aspose.pdf.annotations/polyannotation/measure/) { get; set; } | Måttenheter som anges för denna anteckning. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Hämtar eller anger stilen för den första linjeänden. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Hämtar eller anger en array av punkter som representerar de horisontella och vertikala koordinaterna för varje hörn. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Uppdaterar punkterna i Vertices enligt matrisomvandlingen. |
