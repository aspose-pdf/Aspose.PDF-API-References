...
description: Representerar polylinjekommentarer som liknar polygon förutom att den första och sista vertexen inte är implicit anslutna.
type: docs
weight: 930
...
Representerar polylinjekommentarer som liknar polygon, förutom att den första och sista vertexen inte är implicit anslutna.
...
| namn | Beskrivning |
| --- | --- |
| [PolylineAnnotation](polylineannotation)(Page, Rectangle, Point[]) | Skapar ny Polyline-anteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle) { get; set; } | Hämtar eller ställer in stilen för andra radslut. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent) { get; set; } | Hämtar eller ställer in syftet med polygon- eller polylinjekommentaren. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor) { get; set; } | Hämtar eller ställer in den inre färgen som annoteringens radslut ska fyllas med. |
...
| [Measure](../../aspose.pdf.annotations/polyannotation/measure) { get; set; } | Måttenheter som har angetts för denna anteckning. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle) { get; set; } | Hämtar eller ställer in stilen för första radslut. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices) { get; set; } | Hämtar eller ställer in en matris med punkter som representerar de horisontella och vertikala koordinaterna för varje vertex. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize)(Matrix) | Uppdaterar punkterna i Vertices, enligt matristransformen. |
