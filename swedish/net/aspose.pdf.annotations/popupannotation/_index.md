---
title: "Klass PopupAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.PopupAnnotation-klass. Representerar popup-annotation som visar text i ett popup-fönster för inmatning och redigering"
type: docs
weight: 2420
...
Representerar popup-anteckningen som visar text i ett popup-fönster för inmatning och redigering.
...
| Namn | Beskrivning |
| --- | --- |
| [PopupAnnotation](popupannotation/#constructor)(Document) | Konstruktor. för användning i Generator. |
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | Skapar en ny Popup-annotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Hämtar eller anger en flagga som specificerar om popup-annotation ska visas öppen från början. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | Hämtar index för sidan som innehåller annoteringen. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Hämtar eller anger den överordnade annotationen som denna popup-annotation ska vara associerad med. Om detta fält finns, ska överordnad annoterings innehåll, M, C och T-uppgifter åsidosätta motsvarande uppgifter i popup-annotation själv. |
