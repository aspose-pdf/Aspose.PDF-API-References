...
description: Klass som representerar Caret-anteckning.
type: docs
weight: 220
...
Klass som representerar Caret-anteckning.
...
| namn | Beskrivning |
| --- | --- |
| [CaretAnnotation](caretannotation#constructor)(Document) | Konstruktör för usign in Generator. |
| [CaretAnnotation](caretannotation#constructor_1)(Page, Rectangle) | Skapar ny Caret-anteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame) { get; set; } | Hämtar eller ställer in caret-rektangel. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol) { get; set; } | Hämtar eller ställer in symbol associerad med caret. |
