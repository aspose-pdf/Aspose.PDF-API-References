---
title: "Klass CaretAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.CaretAnnotation class. Klass som representerar en Caret-annotation"
type: docs
weight: 1650
...
| Namn | Beskrivning |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Konstruktor för användning i Generator. |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | Skapar en ny Caret-annotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/caretannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Hämtar eller anger caret-rektangel. |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Hämtar eller anger symbol som är associerad med caret. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
