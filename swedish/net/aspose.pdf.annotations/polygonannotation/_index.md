...
description: Klass som representerar polygonanteckning.
type: docs
weight: 920
...
| [PolygonAnnotation](polygonannotation#constructor_1)(Page, Rectangle, Point[]) | Skapar ny polygonanteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype) { get; } | Får typ av anteckning. |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept)(AnnotationSelector) | Accepterar besöksobjekt för anteckningsbearbetning. |
