...
description: Representerar den snirkliga anteckningen som visas som en ojämn understrykning i texten i ett dokument.
type: docs
weight: 1150
...
Representerar den snirkliga anteckningen som visas som en ojämn understrykning i texten i ett dokument.
...
| namn | Beskrivning |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation)(Page, Rectangle) | Skapar ny Squiggly-anteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype) { get; } | Får typ av anteckning. |
