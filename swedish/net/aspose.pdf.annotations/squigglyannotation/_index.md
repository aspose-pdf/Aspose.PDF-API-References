...
description: Aspose.Pdf.Annotations.SquigglyAnnotation klass. Representerar den squiggly-annoteringen som visas som en taggig understrykning i texten i ett dokument
type: docs
weight: 2600
url: /sv/net/aspose.pdf.annotations/squigglyannotation/
---
## SquigglyAnnotation klass

Representerar den squiggly-annoteringen som visas som en taggig understrykning i texten i ett dokument.
...
| Namn | Beskrivning |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Skapar en ny Squiggly-annotering på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Hämtar typ av annotering. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta annoteringen. |
