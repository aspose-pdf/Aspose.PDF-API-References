---
title: "Klass SquigglyAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.SquigglyAnnotation klass. Representerar den krusiga annotationen som visas som en ojämn understrykning i dokumentets text"
type: docs
weight: 2700
...
Representerar den krusiga annotationen som visas som en ojämn understrykning i texten i ett dokument.
...
| Namn | Beskrivning |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | Skapar en ny krusig annotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
