...
description: Representerar en markeringsanteckning som framhäver ett intervall av text i dokumentet.
type: docs
weight: 490
...
Representerar en markeringsanteckning som framhäver ett intervall av text i dokumentet.
...
| namn | Beskrivning |
| --- | --- |
| [HighlightAnnotation](highlightannotation)(Page, Rectangle) | Skapar en ny höjdpunktsanteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype) { get; } | Får typ av anteckning. |
