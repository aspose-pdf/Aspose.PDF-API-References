---
title: "Klass HighlightAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.HighlightAnnotation-klass. Representerar en markeringsannotation som markerar ett textområde i dokumentet"
type: docs
weight: 1960
...
Representerar en markerings‑annotation som markerar ett textområde i dokumentet.
...
| Namn | Beskrivning |
| --- | --- |
| [HighlightAnnotation](highlightannotation/)(Page, Rectangle) | Skapar en ny markeringsannotation på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/highlightannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/highlightannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
