...
description: Klass som representerar cirkelanteckning.
type: docs
weight: 250
...
Klass som representerar cirkelanteckning.
...
| namn | Beskrivning |
| --- | --- |
| [CircleAnnotation](circleannotation#constructor)(Document) | Konstruktör för cirkelkommentarer. |
| [CircleAnnotation](circleannotation#constructor_1)(Page, Rectangle) | Skapar ny cirkelanteckning på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype) { get; } | Får typ av anteckning. |
