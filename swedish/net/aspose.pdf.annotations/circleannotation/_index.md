---
title: "Klass CircleAnnotation"
second_title: "Aspose.PDF för .NET API‑referens"
description: "Aspose.Pdf.Annotations.CircleAnnotation class. Klass som representerar cirkelannotering"
type: docs
weight: 1680
...
| Namn | Beskrivning |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Konstruktor för cirkelannotering. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Skapar ny cirkelannotering på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Hämtar typ av annotation. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | Inre färg som används för att fylla annoteringens rektangel eller ellips. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Accepterar besökarobjekt för att bearbeta anteckningen. |
