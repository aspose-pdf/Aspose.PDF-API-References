...
description: Aspose.Pdf.Annotations.CircleAnnotation klass. Klass som representerar cirkelannotering
type: docs
weight: 1590
url: /sv/net/aspose.pdf.annotations/circleannotation/
---
## CircleAnnotation klass

Klass som representerar cirkelannotering.
...
| Namn | Beskrivning |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | Konstruktör för cirkelannotering. |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | Skapar en ny cirkelannotering på den angivna sidan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | Hämtar typ av annotering. |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | Rektangeln som beskriver de numeriska skillnaderna mellan två rektanglar: Rect-posten för annoteringen och de faktiska gränserna för den underliggande kvadraten eller cirkeln. |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | Inre färg som ska fylla annoteringens rektangel eller ellips. |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Hämtar eller ställer in en rik textsträng som ska visas i popup-fönstret när annoteringen öppnas. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | Accepterar besöksobjekt för att bearbeta annoteringen. |
