...
description: "Representerar en movie‑annotation som innehåller animerad grafik och ljud som ska visas på datorskärmen och genom högtalarna. När annotationen aktiveras spelas filmen upp."
type: docs
weight: 480
url: /sv/python-net/aspose.pdf.annotations/movieannotation/
---

## MovieAnnotation class

Representerar en movie‑annotation som innehåller animerad grafik och ljud som ska visas på datorskärmen och genom högtalarna. När annotationen aktiveras spelas filmen upp.

MovieAnnotation-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| MovieAnnotation(document, movie_file) | Initierar en ny instans av MovieAnnotation-klassen |
| MovieAnnotation(page, rect, movie_file) | Initierar en ny instans av MovieAnnotation-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| titel | Hämtar eller anger titeln på filmannoteringen. |
| fil | Hämtar eller anger en filspecificering som identifierar en självbeskrivande filmfil. |
| poster | Hämtar eller anger en flagga eller ström som specificerar om och hur en posterbild som representerar filmen ska visas. Om true, hämtas posterbilden från filmfilen; om false visas ingen poster. |
| aspect | Hämtar eller anger bredden och höjden på filmens omgivningsruta, i pixlar. |
| rotera | Hämtar eller anger antalet grader som filmen ska roteras medurs i förhållande till sidan. Värdet ska vara en multipel av 90. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
