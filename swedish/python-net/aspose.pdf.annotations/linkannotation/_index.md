...
description: "Representerar antingen en hypertext‑länk till en destination någon annanstans i dokumentet eller en åtgärd som ska utföras."
type: docs
weight: 390
url: /sv/python-net/aspose.pdf.annotations/linkannotation/
---

## LinkAnnotation class

Representerar antingen en hypertext‑länk till en destination någon annanstans i dokumentet eller en åtgärd som ska utföras.

Typen LinkAnnotation exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| LinkAnnotation(page, rect) | Initierar en ny instans av klassen LinkAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| action | En åtgärd som ska utföras när länkanoteringen aktiveras. |
| destination | En destination som ska visas när annoteringen aktiveras. |
| markering | Den visuella effekten som ska användas när musknappen trycks ned eller hålls ned inom dess aktiva område. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
