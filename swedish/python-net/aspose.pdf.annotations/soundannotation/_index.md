...
description: "Representerar en ljud‑annotation som innehåller ljud inspelat från datorns mikrofon eller importerat från en fil."
type: docs
weight: 740
url: /sv/python-net/aspose.pdf.annotations/soundannotation/
---

## SoundAnnotation class

Representerar en ljud‑annotation som innehåller ljud inspelat från datorns mikrofon eller importerat från en fil.

Typen SoundAnnotation exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Initierar en ny instans av klassen SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Initierar en ny instans av klassen SoundAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| sound_data | Hämtar ett ljudobjekt som definierar ljudet som ska spelas när annoteringen aktiveras. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
| clone() | Ingen |
