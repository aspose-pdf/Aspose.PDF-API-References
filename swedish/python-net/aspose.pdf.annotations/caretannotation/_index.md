...
description: "Klass som representerar Caret-annotering."
type: docs
weight: 80
url: /sv/python-net/aspose.pdf.annotations/caretannotation/
---
...
CaretAnnotation-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| CaretAnnotation(document) | Initierar en ny instans av klassen CaretAnnotation |
| CaretAnnotation(page, rect) | Initierar en ny instans av klassen CaretAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| frame | Hämtar eller anger caret-rektangel. |
| symbol | Hämtar eller anger symbol som är associerad med caret. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
| clone() | Ingen |
