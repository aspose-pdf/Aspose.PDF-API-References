...
type: docs
weight: 670
url: /sv/python-net/aspose.pdf.annotations/popupannotation/
---
...
Typen PopupAnnotation exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| PopupAnnotation(document) | Initierar en ny instans av klassen PopupAnnotation |
| PopupAnnotation(page, rect) | Initierar en ny instans av klassen PopupAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| öppna | Hämtar eller anger en flagga som specificerar om popup-anteckningen initialt ska visas öppen. |
| förälder | Hämtar eller anger den överordnade anteckningen som denna popup-anteckning ska vara associerad med.<br/>            Om detta fält finns, ska den överordnade anteckningens Innehåll, M, C och T‑fält åsidosätta motsvarande fält i själva popup‑anteckningen. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
