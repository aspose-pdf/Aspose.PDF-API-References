...
description: "Representerar en understrykningannotation som visas som en understrykning i dokumentets text."
type: docs
weight: 850
url: /sv/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

Representerar en understrykningannotation som visas som en understrykning i dokumentets text.

Typen UnderlineAnnotation exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| UnderlineAnnotation(page, rect) | Initierar en ny instans av klassen UnderlineAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| quad_points | Hämtar eller anger en array av punkter som specificerar koordinaterna för n fyrhörningar. Varje fyrhörning omfattar ett ord eller en grupp av sammanhängande ord i den text som ligger under annoteringen. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
| clone() | Ingen |
...
| flatten() | Ingen |
| change_after_resize(transform) | Uppdaterar QuadPoints enligt matrisomvandlingen. |
| get_marked_text() | Hämtar text under markup-annotation som sträng. |
| get_marked_text_fragments() | Hämtar text under markup-annotation som [TextFragmentCollection](/pdf/python-net/aspose.pdf.text/textfragmentcollection/). |
