...
description: "En skärm‑annotation som specificerar ett område på en sida där mediaklipp kan spelas upp."
type: docs
weight: 720
url: /sv/python-net/aspose.pdf.annotations/screenannotation/
---

## ScreenAnnotation class

En skärm‑annotation som specificerar ett område på en sida där mediaklipp kan spelas upp.

ScreenAnnotation-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| ScreenAnnotation(page, rect, media_file) | Initierar en ny instans av ScreenAnnotation-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| titel | Hämtar eller anger titeln på skärmannoteringen. |
| action | Hämtar eller anger en åtgärd som ska utföras när annoteringen aktiveras. |
## Metoder
| Namn | Beskrivning |
| :- | :- |
