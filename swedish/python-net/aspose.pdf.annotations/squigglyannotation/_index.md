...
description: "Representerar den krusiga annotationen som visas som en ojämn understrykning i dokumentets text."
type: docs
weight: 780
url: /sv/python-net/aspose.pdf.annotations/squigglyannotation/
---
...
Typen SquigglyAnnotation exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| SquigglyAnnotation(page, rect) | Initierar en ny instans av klassen SquigglyAnnotation |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
