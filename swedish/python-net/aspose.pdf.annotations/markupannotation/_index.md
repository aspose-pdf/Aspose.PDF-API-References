...
description: "Abstrakt klass som representerar markup‑annotation."
type: docs
weight: 400
url: /sv/python-net/aspose.pdf.annotations/markupannotation/
---

## MarkupAnnotation class

Abstrakt klass som representerar markup‑annotation.

Typen MarkupAnnotation visar följande medlemmar:
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
