...
description: "Representerar en highlight‑annotation som markerar ett textintervall i dokumentet."
type: docs
weight: 310
url: /sv/python-net/aspose.pdf.annotations/highlightannotation/
---

## HighlightAnnotation class

Representerar en highlight‑annotation som markerar ett textintervall i dokumentet.

HighlightAnnotation-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| HighlightAnnotation(page, rect) | Initierar en ny instans av HighlightAnnotation-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
