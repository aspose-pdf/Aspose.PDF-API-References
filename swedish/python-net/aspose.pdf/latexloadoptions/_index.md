...
type: docs
weight: 820
url: /sv/python-net/aspose.pdf/latexloadoptions/
---
...
Typen LatexLoadOptions exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| LatexLoadOptions() | Initierar en ny instans av klassen LatexLoadOptions |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
