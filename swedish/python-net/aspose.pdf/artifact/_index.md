...
description: "Klassen representerar PDF Artifact-objekt."
type: docs
weight: 30
url: /sv/python-net/aspose.pdf/artifact/
---
...
Artifact-typen exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| Artifact(type, sub_type) | Initierar en ny instans av Artifact-klassen |
| Artifact(type, sub_type) | Initierar en ny instans av Artifact-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
