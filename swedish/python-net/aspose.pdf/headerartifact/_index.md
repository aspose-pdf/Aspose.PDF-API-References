...
description: "Klassen beskriver Heaader-element. Detta element kan användas för att sätta rubrik på sidan."
type: docs
weight: 440
url: /sv/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

Klassen beskriver Heaader-element. Detta element kan användas för att sätta rubrik på sidan.

Typen HeaderArtifact visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| HeaderArtifact() | Skapar en Header Artifact-instans. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
