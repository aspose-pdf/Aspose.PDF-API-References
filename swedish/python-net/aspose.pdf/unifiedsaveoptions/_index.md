...
description: "Denna klass representerar sparalternativ för sparande som <br/>            använder enhetlig konverteringsmetod (med enhetlig intern dokumentmodell)"
type: docs
weight: 1590
url: /sv/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Denna klass representerar sparalternativ för sparande som <br/>            använder enhetlig konverteringsmetod (med enhetlig intern dokumentmodell)

Typen UnifiedSaveOptions exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| UnifiedSaveOptions() | Initierar en ny instans av klassen UnifiedSaveOptions |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
