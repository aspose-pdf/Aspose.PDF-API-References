...
description: "Klassen beskriver bakgrundsartefakt. Denna artefakt gör det möjligt att ställa in bakgrunden på sidan."
type: docs
weight: 50
url: /sv/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Klassen beskriver bakgrundsartefakt. Denna artefakt gör det möjligt att ställa in bakgrunden på sidan.

Typen BackgroundArtifact exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| BackgroundArtifact() | Initierar BackgroundArtifact-objekt. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| background_color | Hämtar eller anger bakgrundsfärg för bakgrundsartefakt |
| background_image | Hämtar eller anger bakgrundsbild för bakgrundsartefakt |
## Metoder
| Namn | Beskrivning |
| :- | :- |
