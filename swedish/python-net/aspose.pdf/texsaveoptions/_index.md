...
type: docs
weight: 1540
url: /sv/python-net/aspose.pdf/texsaveoptions/
---
...
Typen TeXSaveOptions exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| TeXSaveOptions() | Initierar en ny instans av klassen TeXSaveOptions |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
