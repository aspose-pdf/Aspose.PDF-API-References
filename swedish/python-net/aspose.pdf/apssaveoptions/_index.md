...
description: "Spara alternativ för export till APS XML-format."
type: docs
weight: 20
url: /sv/python-net/aspose.pdf/apssaveoptions/
---
...
ApsSaveOptions-typen exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| ApsSaveOptions() | Initierar en ny instans av ApsSaveOptions-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
