...
description: "Klassen beskriver vattenstämpelartefakt. Detta kan användas för att"
type: docs
weight: 1640
url: /sv/python-net/aspose.pdf/watermarkartifact/
---
...
WatermarkArtifact-typen exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| WatermarkArtifact() | Skapar en instans av Watermark-artifactet. |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
