...
description: "Spara alternativ för PdfXml-format."
type: docs
weight: 1260
url: /sv/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
PdfXmlSaveOptions-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| PdfXmlSaveOptions() | Initierar en ny instans av klassen PdfXmlSaveOptions |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
