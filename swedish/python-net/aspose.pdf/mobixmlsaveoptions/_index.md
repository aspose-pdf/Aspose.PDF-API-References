...
type: docs
weight: 960
url: /sv/python-net/aspose.pdf/mobixmlsaveoptions/
---
...
Typen MobiXmlSaveOptions exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| MobiXmlSaveOptions() | Initierar en ny instans av klassen MobiXmlSaveOptions |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
