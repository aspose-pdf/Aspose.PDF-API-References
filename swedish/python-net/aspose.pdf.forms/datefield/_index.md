...
type: docs
weight: 60
url: /sv/python-net/aspose.pdf.forms/datefield/
---
...
DateField-typen exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| DateField() | Initierar en ny instans av [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Initierar en ny instans av DateField-klassen |
| DateField(page, rect) | Initierar en ny instans av DateField-klassen |
| DateField(doc, rect) | Initierar en ny instans av DateField-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| value | Hämtar eller inställer datum. |
...
| date_format | Hämtar eller inställer datumformatet. |
## Indexer
| Namn | Beskrivning |
| :- | :- |
...
| Namn | Beskrivning |
| :- | :- |
| add_image(image) | Bildtillägg nekas för detta fält. |
| add_image(image) | Bildtillägg nekas för detta fält. |
| clone() | Ingen |
...
| init(page) | Initierar JS-åtgärden. |
