...
description: "Klass beskriver textfält för inmatning av lösenord."
type: docs
weight: 210
url: /sv/python-net/aspose.pdf.forms/passwordboxfield/
---

## PasswordBoxField class

Klass beskriver textfält för inmatning av lösenord.

PasswordBoxField-typen visar följande medlemmar:
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
