...
description: "Klass som representerar kombinationsrutfält i formuläret."
type: docs
weight: 50
url: /sv/python-net/aspose.pdf.forms/comboboxfield/
---

## ComboBoxField class

Klass som representerar kombinationsrutfält i formuläret.

ComboBoxField-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| ComboBoxField() | Konstruktor för ComboBoxField som ska användas i Generator. |
| ComboBoxField(doc) | Initierar en ny instans av ComboBoxField-klassen |
| ComboBoxField(page, rect) | Initierar en ny instans av ComboBoxField-klassen |
| ComboBoxField(doc, rect) | Initierar en ny instans av ComboBoxField-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| selected | Hämtar eller anger index för valt alternativ. Denna egenskap tillåter att ändra urvalet. |
...
| redigerbar | Hämtar eller anger redigeringsstatus för fältet. |
| spell_check | Hämtar eller anger stavningskontrollens aktivitetsstatus. |
## Indexer
| Namn | Beskrivning |
| :- | :- |
