...
description: "Textfält med specificerade giltiga tecken"
type: docs
weight: 150
url: /sv/python-net/aspose.pdf.forms/numberfield/
---
...
NumberField-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| NumberField() | Initierar en ny instans av klassen [NumberField](/pdf/python-net/aspose.pdf.forms/numberfield/). |
| NumberField(page, rect) | Initierar en ny instans av NumberField-klassen |
| NumberField(doc, rect) | Initierar en ny instans av NumberField-klassen |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| allowed_chars | Hämtar eller anger de tillåtna tecknen. |
## Indexer
| Namn | Beskrivning |
| :- | :- |
