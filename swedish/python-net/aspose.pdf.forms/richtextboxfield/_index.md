...
description: "Klass beskriver komponenten för rik textredigerare."
type: docs
weight: 240
url: /sv/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Klass beskriver komponenten för rik textredigerare.

RichTextBoxField-typen visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| RichTextBoxField(page, rect) | Initierar en ny instans av klassen RichTextBoxField |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| style | Hämtar eller anger standardstilssträng för rich text-fältet. |
| rich_text_value | Hämtar eller anger rich text-värde. |
| formatted_value | Hämtar eller anger formaterat rich text-värde med markup. |
| justify | Hämtar eller anger justering för rich text-rutan. |
## Indexer
| Namn | Beskrivning |
| :- | :- |
