...
description: "En abstrakt klass som representerar signaturobjekt i pdf‑dokumentet. <br/>            Signaturer är fält med värden av signaturobjekt, där de sista innehåller data som används för<br/>            att verifiera dokumentets giltighet."
type: docs
weight: 250
url: /sv/python-net/aspose.pdf.forms/signature/
---

## Signature class

En abstrakt klass som representerar signaturobjekt i pdf‑dokumentet. <br/>            Signaturer är fält med värden av signaturobjekt, där de sista innehåller data som används för<br/>            att verifiera dokumentets giltighet.

Signature-typen visar följande medlemmar:
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
