...
description: "Klass som representerar textrutefält."
type: docs
weight: 280
url: /sv/python-net/aspose.pdf.forms/textboxfield/
---
...
TextBoxField-typen exponerar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| TextBoxField(doc) | Initierar en ny instans av klassen TextBoxField |
| TextBoxField() | Skapa en instans av TextBoxField. |
| TextBoxField(page, rect) | Initierar en ny instans av klassen TextBoxField |
| TextBoxField(doc, rect) | Initierar en ny instans av klassen TextBoxField |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
