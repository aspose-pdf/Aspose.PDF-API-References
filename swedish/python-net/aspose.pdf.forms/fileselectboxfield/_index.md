...
description: "Fält för filväljarknappselement."
type: docs
weight: 100
url: /sv/python-net/aspose.pdf.forms/fileselectboxfield/
---

## FileSelectBoxField class

Fält för filväljarknappselement.

FileSelectBoxField-typen exponerar följande medlemmar:
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
