...
description: "Klass representerar ett objekt i RadioButton‑fältet."
type: docs
weight: 230
url: /sv/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---

## RadioButtonOptionField class

Klass representerar ett objekt i RadioButton‑fältet.

Typen RadioButtonOptionField visar följande medlemmar:
## Konstruktörer
| Namn | Beskrivning |
| :- | :- |
| RadioButtonOptionField() | Skapa en ny instans av RadioButtonOptionField. |
| RadioButtonOptionField(page, rect) | Initierar en ny instans av klassen RadioButtonOptionField |
## Egenskaper
| Namn | Beskrivning |
| :- | :- |
...
| option_name | Hämtar eller anger namn på alternativet. |
| caption | Hämtar eller anger rubrik. |
| style | Hämtar eller anger stil för kryssruta. |
## Indexer
| Namn | Beskrivning |
| :- | :- |
