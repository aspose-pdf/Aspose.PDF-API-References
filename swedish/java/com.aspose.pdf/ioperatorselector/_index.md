...
description: "Definierar en besökare för att besöka olika pdf-operatorer."
type: docs
weight: 2520
url: /sv/java/com.aspose.pdf/ioperatorselector/
---
```
public interface IOperatorSelector
```

Definierar en besökare för att besöka olika pdf-operatorer.
