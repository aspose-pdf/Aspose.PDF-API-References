...
description: "System::setter_decrement_wrap‑metod. Översättaren översätter C#‑s pre‑dekrement‑uttryck som riktar sig mot en instans egenskap som har setter och getter definierade, till anrop av denna funktion (överladdning för konstant getter) i C++."
type: docs
weight: 38700
...
Översättaren översätter C#‑s pre‑dekrement‑uttryck som riktar sig mot en instans egenskap som har setter och getter definierade, till anrop av denna funktion (överladdning för konstant getter).
...
Översättaren översätter C#‑s pre‑dekrement‑uttryck som riktar sig mot en instans egenskap som har setter och getter definierade, till anrop av denna funktion (överladdning för icke‑konstant getter).
...
Översättaren översätter C#‑s pre‑dekrement‑uttryck som riktar sig mot en klass egenskap som har setter och getter definierade, till anrop av denna funktion.
