...
description: "System::IO::BasicSTDOStreamWrapper::Write metod. Om omslagsläget är binärt, skriver den angivna delintervallet av byte från den angivna byte‑arrayen till strömmen, annars konverteras det angivna delintervallet av byte från den angivna byte‑arrayen till char_type‑typen och skriver sedan resultatet till strömmen i C++."
type: docs
weight: 700
