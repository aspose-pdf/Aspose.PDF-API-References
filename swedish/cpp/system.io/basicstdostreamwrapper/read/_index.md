...
description: "System::IO::BasicSTDOStreamWrapper::Read metod. Om omslagsläget är binärt, läser den angivna mängden byte från strömmen, annars läses det angivna antalet tecken och konverteras till uint8_t‑typen. Skriver resultatet av läsningen till den angivna byte‑arrayen. Stöds inte! i C++."
type: docs
weight: 400
...
Om omslagsläget är binärt läses det angivna antalet byte från strömmen, annars läses det angivna antalet tecken och konverteras till uint8_t‑typen. Skriver resultatet av läsningen till den angivna bytearrayen. Stöds inte!
