...
description: "Hämta behörigheter för PDF-dokument."
type: docs
url: /sv/go-cpp/security/getpermissions/
---

_Hämta behörigheter för PDF-dokument._
...
func main() {
	...
	defer pdf.Close()
	// GetPermissions() hämtar aktuella behörigheter för PDF-dokument
