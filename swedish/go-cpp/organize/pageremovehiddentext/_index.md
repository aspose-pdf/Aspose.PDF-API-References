...
description: "Ta bort dold text på sidan."
type: docs
url: /sv/go-cpp/organize/pageremovehiddentext/
---

_Ta bort dold text på sidan._
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveHiddenText(num int32) tar bort dold text på sidan
