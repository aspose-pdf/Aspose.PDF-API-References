...
description: "Konvertera ett PDF-dokument till ett PDF-dokument med det angivna PDF-formatet."
type: docs
url: /sv/go-cpp/organize/convert/
---

_Konvertera ett PDF-dokument till ett PDF-dokument med det angivna PDF-formatet._
...
```go
// Uppräkning av möjliga konverteringsfelåtgärder.
...
func main() {
	...
	// Convert(pdfFormat PdfFormat, action ConvertErrorAction) konverterar PDF-dokument till PDF/A
	...
	// Spara konverterat PDF-dokument
