...
description: "Ställ in sidans storlek."
type: docs
url: /sv/go-cpp/organize/pagesetsize/
---

_Ställ in sidans storlek._
...
func main() {
	...
	defer pdf.Close()
	// PageSetSize(num int32, pageSize int32) sätter storlek på sidan
