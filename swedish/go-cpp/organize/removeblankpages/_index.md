...
description: "Ta bort tomma sidor från PDF-dokument."
type: docs
url: /sv/go-cpp/organize/removeblankpages/
---

_Ta bort tomma sidor från PDF-dokument._
...
func main() {
	...
	defer pdf.Close()
	// RemoveBlankPages() tar bort tomma sidor från PDF-dokument
