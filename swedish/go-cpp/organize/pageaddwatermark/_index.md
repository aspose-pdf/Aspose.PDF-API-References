...
description: "Lägg till vattenstämpel på sidan."
type: docs
url: /sv/go-cpp/organize/pageaddwatermark/
---

_Lägg till vattenstämpel på sidan._
...
func main() {
        ...
        defer pdf.Close()
        // PageAddWatermark(num int32, text string, fontName string, fontSize float64, foregroundColor string, xPosition int32, yPosition int32, rotation int32, isBackground bool, opacity float64) lägger till vattenstämpel på sidan
