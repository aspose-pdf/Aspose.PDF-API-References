...
description: "Validasi PDF-document untuk kepatuhan terhadap format PDF."
type: docs
url: /id/go-cpp/organize/validate/
---

_Validasi PDF-document untuk kepatuhan dengan format PDF._
...
func main() {
	...
	// Validate(pdfFormat PdfFormat) memvalidasi PDF-document untuk kepatuhan PDF/A
