...
description: "Tambahkan watermark pada halaman."
type: docs
url: /id/go-cpp/organize/pageaddwatermark/
---

_Tambahkan watermark pada halaman._
...
func main() {
        ...
        defer pdf.Close()
        // PageAddWatermark(num int32, text string, fontName string, fontSize float64, foregroundColor string, xPosition int32, yPosition int32, rotation int32, isBackground bool, opacity float64) menambahkan watermark pada halaman
