...
description: "Hapus tabel di halaman."
type: docs
url: /id/go-cpp/organize/pageremovetables/
---

_Hapus tabel di halaman._
...
func main() {
	...
	defer pdf.Close()
	// PageRemoveTables(num int32) menghapus tabel di halaman
