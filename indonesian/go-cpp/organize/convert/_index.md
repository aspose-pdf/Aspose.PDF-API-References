...
description: "Konversi PDF-document menjadi PDF-document dengan format PDF yang ditentukan."
type: docs
url: /id/go-cpp/organize/convert/
---
...
```go
// Enumerasi aksi kesalahan konversi yang mungkin.
...
func main() {
	...
	// Convert(pdfFormat PdfFormat, action ConvertErrorAction) mengonversi PDF-document ke PDF/A
	...
	// Simpan PDF-document yang dikonversi
