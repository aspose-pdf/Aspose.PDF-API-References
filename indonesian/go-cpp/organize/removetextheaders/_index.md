...
description: "Hapus header teks dari PDF-document."
type: docs
url: /id/go-cpp/organize/removetextheaders/
---

_Hapus header teks dari PDF-document._
...
func main() {
        ...
        defer pdf.Close()
        // RemoveTextHeaders() menghapus header teks dari PDF-document
