...
description: "Hapus footer teks di halaman."
type: docs
url: /id/go-cpp/organize/pageremovetextfooters/
---

_Hapus footer teks di halaman._
...
func main() {
        ...
        defer pdf.Close()
        // PageRemoveTextFooters(num int32) menghapus footer teks di halaman
