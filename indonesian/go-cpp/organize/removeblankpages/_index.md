...
description: "Hapus halaman kosong dari PDF-document."
type: docs
url: /id/go-cpp/organize/removeblankpages/
---

_Hapus halaman kosong dari PDF-document._
...
func main() {
	...
	defer pdf.Close()
	// RemoveBlankPages() menghapus halaman kosong dari PDF-document
