...
description: "Hapus skrip java dari PDF-document."
type: docs
url: /id/go-cpp/organize/removejavascripts/
---

_Hapus skrip Java dari dokumen PDF._
...
func main() {
	...
	defer pdf.Close()
	// RemoveJavaScripts() menghapus skrip Java dari dokumen PDF
