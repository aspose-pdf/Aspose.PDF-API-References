...
description: "Enkripsi PDF-dokumen."
type: docs
url: /id/go-cpp/security/encrypt/
---
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) mengenkripsi dokumen PDF
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
