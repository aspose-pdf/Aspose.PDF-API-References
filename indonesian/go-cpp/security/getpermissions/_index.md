...
description: "Dapatkan izin untuk dokumen PDF."
type: docs
url: /id/go-cpp/security/getpermissions/
---

_Dapatkan izin untuk dokumen PDF._
...
func main() {
	...
	defer pdf.Close()
	// GetPermissions() mendapatkan izin saat ini dari dokumen PDF
