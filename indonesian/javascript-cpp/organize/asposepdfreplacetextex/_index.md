...
description: "Ganti beberapa fragmen teks dalam file PDF dengan kontrol penyelarasan."
type: docs
url: /id/javascript-cpp/organize/asposepdfreplacetextex/
---

_Ganti beberapa fragmen teks dalam file PDF dengan kontrol perataan._
...
Arah juga dapat dipaksa secara eksplisit dengan menambahkan awalan `replaceText`
dengan karakter Unicode khusus:
`\u200F` (RTL) atau `\u200E` (LTR), sebaiknya sebagai karakter pertama
