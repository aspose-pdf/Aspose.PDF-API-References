...
| A5 | `11` | Kertas A5 (148 mm x 210 mm). |
| B4 | `12` | Kertas B4 (250 mm x 353 mm). |
| B5 | `13` | Kertas B5 (176 mm x 250 mm). |
| Folio | `14` | Kertas folio (8.5 in. x 13 in.). |
| Quarto | `15` | Kertas quarto (215 mm x 275 mm). |
| Standard10x14 | `16` | Kertas standar (10 in. x 14 in.). |
| Standard11x17 | `17` | Kertas standar (11 in. x 17 in.). |
| Note | `18` | Kertas catatan (8.5 in. x 11 in.). |
| Number9Envelope | `19` | Amplop #9 (3.875 in. x 8.875 in.). |
| Number10Envelope | `20` | Amplop #10 (4.125 in. x 9.5 in.). |
| Number11Envelope | `21` | Amplop #11 (4.5 in. x 10.375 in.). |
| Number12Envelope | `22` | Amplop #12 (4.75 in. x 11 in.). |
| Number14Envelope | `23` | Amplop #14 (5 in. x 11.5 in.). |
| CSheet | `24` | Kertas C (17 in. x 22 in.). |
| DSheet | `25` | Kertas D (22 in. x 34 in.). |
| ESheet | `26` | Kertas E (34 in. x 44 in.). |
| DLEnvelope | `27` | Amplop DL (110 mm x 220 mm). |
| C5Envelope | `28` | Amplop C5 (162 mm x 229 mm). |
| C3Envelope | `29` | Amplop C3 (324 mm x 458 mm). |
| C4Envelope | `30` | Amplop C4 (229 mm x 324 mm). |
| C6Envelope | `31` | Amplop C6 (114 mm x 162 mm). |
| C65Envelope | `32` | Amplop C65 (114 mm x 229 mm). |
| B4Envelope | `33` | Amplop B4 (250 mm x 353 mm). |
| B5Envelope | `34` | Amplop B5 (176 mm x 250 mm). |
| B6Envelope | `35` | Amplop B6 (176 mm x 125 mm). |
...
| JapaneseDoublePostcard | `69` | Kartu pos ganda Jepang (200 mm x 148 mm). |
| A6 | `70` | Kertas A6 (105 mm x 148 mm). |
| JapaneseEnvelopeKakuNumber2 | `71` | Amplop Kaku #2 Jepang. |
...
| B4JisRotated | `79` | Kertas JIS B4 diputar (364 mm x 257 mm). |
| B5JisRotated | `80` | Kertas JIS B5 diputar (257 mm x 182 mm). |
| JapanesePostcardRotated | `81` | Kartu pos Jepang diputar (148 mm x 100 mm). |
| JapaneseDoublePostcardRotated | `82` | Kartu pos ganda Jepang diputar (148 mm x 200 mm). |
| A6Rotated | `83` | Kertas A6 diputar (148 mm x 105 mm). |
| JapaneseEnvelopeKakuNumber2Rotated | `84` | Amplop Kaku #2 Jepang diputar. |
| JapaneseEnvelopeKakuNumber3Rotated | `85` | Amplop Kaku #3 Jepang diputar. |
| JapaneseEnvelopeChouNumber3Rotated | `86` | Amplop Chou #3 Jepang diputar. |
| JapaneseEnvelopeChouNumber4Rotated | `87` | Amplop Chou #4 Jepang diputar. |
| B6Jis | `88` | Amplop B6 (176 mm x 125 mm). |
...
| PrcEnvelopeNumber4 | `99` | Amplop #4 (110 mm x 208 mm). |
| PrcEnvelopeNumber5 | `100` | Amplop #5 (110 mm x 220 mm). |
| PrcEnvelopeNumber6 | `101` | Amplop #6 (120 mm x 230 mm). |
| PrcEnvelopeNumber7 | `102` | Amplop #7 (160 mm x 230 mm). |
