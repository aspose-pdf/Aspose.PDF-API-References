...
| Nama | Deskripsi |
| --- | --- |
| [ConcatenateMatrix](concatenatematrix/#constructor)(Matrix) | Menginisialisasi operator dengan matriks. |
| [ConcatenateMatrix](concatenatematrix/#constructor_1)(double, double, double, double, double, double) | Menginisialisasi operator. |
...
| [Matrix](../../aspose.pdf.operators/concatenatematrix/matrix/) { get; set; } | Argumen matriks dari operator. |
