...
---
## Properti CompletionCreateRequest.Stream

Mendapatkan atau mengatur apakah akan menggunakan streaming. Jika diatur, delta pesan parsial akan dikirim, seperti di ChatGPT. Token akan dikirim sebagai data-only server-sent events saat tersedia, dengan stream diakhiri oleh pesan data: [DONE].
