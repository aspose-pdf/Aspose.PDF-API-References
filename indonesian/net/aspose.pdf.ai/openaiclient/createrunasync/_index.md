...
description: Metode OpenAIClient. Membuat sebuah run dalam thread yang ditentukan secara asinkron
type: docs
weight: 50
url: /id/net/aspose.pdf.ai/openaiclient/createrunasync/
---
## Metode OpenAIClient.CreateRunAsync

Membuat sebuah run dalam thread yang ditentukan secara asinkron.
