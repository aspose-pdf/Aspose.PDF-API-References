...
description: Kelas Aspose.Pdf.Annotations.PolylineAnnotation. Mewakili anotasi poligon yang mirip dengan poligon kecuali bahwa titik awal dan akhir tidak terhubung secara implisit
type: docs
weight: 2320
...
Mewakili anotasi poligon yang mirip dengan poligon, kecuali bahwa titik awal dan akhir tidak terhubung secara implisit.
...
| Nama | Deskripsi |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Halaman, Rectangle, Point[]) | Membuat anotasi Polyline baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Mendapatkan jenis anotasi. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Mendapatkan atau mengatur gaya akhir garis kedua. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Mendapatkan atau mengatur niat dari anotasi poligon atau poligon. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Mendapatkan atau mengatur gaya akhir garis pertama. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Mendapatkan atau mengatur array titik yang mewakili koordinat horizontal dan vertikal dari setiap titik. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Menerima objek pengunjung untuk memproses anotasi. |
...
* kelas [PolyAnnotation](../polyannotation/)
