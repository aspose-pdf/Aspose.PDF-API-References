---
title: "Kelas PolylineAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Annotations.PolylineAnnotation. Mewakili anotasi polyline yang mirip dengan poligon kecuali bahwa vertex pertama dan terakhir tidak terhubung secara implisit"
type: docs
weight: 2410
url: /id/net/aspose.pdf.annotations/polylineannotation/
---
## PolylineAnnotation class

Mewakili anotasi polyline yang mirip dengan poligon, kecuali bahwa vertex pertama dan terakhir tidak terhubung secara implisit.
...
| Nama | Deskripsi |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | Membuat anotasi Polyline baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | Mendapatkan atau mengatur gaya akhir baris kedua. |
...
| [Intent](../../aspose.pdf.annotations/polyannotation/intent/) { get; set; } | Mendapatkan atau mengatur maksud anotasi poligon atau polyline. |
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | Mendapatkan atau mengatur warna interior yang digunakan untuk mengisi akhir garis anotasi. |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | Mendapatkan atau mengatur gaya akhir baris pertama. |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | Mendapatkan atau mengatur array titik yang mewakili koordinat horizontal dan vertikal setiap vertex. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | Menerima objek visitor untuk memproses anotasi. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/polyannotation/changeafterresize/)(Matrix) | Memperbarui titik-titik dalam Vertices, sesuai dengan transformasi matriks. |
