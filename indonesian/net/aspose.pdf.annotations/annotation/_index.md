...
description: "Aspose.Pdf.Annotations.Annotation class. Kelas yang mewakili objek anotasi"
type: docs
weight: 1500
url: /id/net/aspose.pdf.annotations/annotation/
---
## Annotation class

Kelas yang merepresentasikan objek anotasi.
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | Mendapatkan atau mengatur karakteristik batas anotasi. [`Border`](./border/) |
...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert/) { get; set; } | Jika true, tampilan anotasi akan diperbarui sebelum mengonversi dokumen PF menjadi gambar. Ini memungkinkan konversi bidang secara benar tetapi mungkin memerlukan lebih banyak waktu. |
| static [UseFontSubset](../../aspose.pdf.annotations/annotation/usefontsubset/) { get; set; } | Jika properti ini diatur ke true, font akan ditambahkan ke dokumen sebagai subset. Nilai default adalah true. |
