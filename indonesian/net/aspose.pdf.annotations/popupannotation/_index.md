...
description: Kelas Aspose.Pdf.Annotations.PopupAnnotation. Mewakili anotasi pop-up yang menampilkan teks dalam jendela pop-up untuk entri dan pengeditan
type: docs
weight: 2330
...
Mewakili anotasi pop-up yang menampilkan teks dalam jendela pop-up untuk entri dan pengeditan.
...
| [PopupAnnotation](popupannotation/#constructor_1)(Page, Rectangle) | Membuat anotasi Popup baru di halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/popupannotation/annotationtype/) { get; } | Mendapatkan jenis anotasi. |
...
| [Open](../../aspose.pdf.annotations/popupannotation/open/) { get; set; } | Mendapatkan atau mengatur bendera yang menentukan apakah anotasi pop-up harus ditampilkan terbuka pada awalnya. |
| virtual [PageIndex](../../aspose.pdf.annotations/annotation/pageindex/) { get; } | Mendapatkan indeks halaman yang berisi anotasi. |
| [Parent](../../aspose.pdf.annotations/popupannotation/parent/) { get; set; } | Mendapatkan atau mengatur anotasi induk yang akan diasosiasikan dengan anotasi pop-up ini. Jika entri ini ada, Konten, M, C, dan T dari anotasi induk akan menggantikan yang dari anotasi pop-up itu sendiri. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/popupannotation/accept/)(AnnotationSelector) | Menerima objek pengunjung untuk memproses anotasi. |
