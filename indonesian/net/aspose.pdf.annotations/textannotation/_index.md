---
title: "Kelas TextAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Annotations.TextAnnotation. Mewakili anotasi teks yang berupa catatan tempel yang terpasang pada suatu titik dalam dokumen PDF"
type: docs
weight: 2750
...
| Nama | Deskripsi |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Konstruktor untuk anotasi ketika digunakan dalam Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Membuat anotasi Text baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Mendapatkan atau mengatur ikon yang akan digunakan untuk menampilkan anotasi. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Mendapatkan atau mengatur flag yang menentukan apakah anotasi harus ditampilkan terbuka secara awal. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Menerima objek visitor untuk memproses anotasi. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Menimpa definisi dalam kelas dasar dengan tubuh kosong. |
