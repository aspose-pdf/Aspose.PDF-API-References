...
description: Kelas Aspose.Pdf.Annotations.TextAnnotation. Mewakili anotasi teks yang merupakan catatan tempel yang terpasang pada suatu titik dalam dokumen PDF
type: docs
weight: 2650
url: /id/net/aspose.pdf.annotations/textannotation/
---
## Kelas TextAnnotation

Mewakili anotasi teks yang merupakan 'catatan tempel' yang terpasang pada suatu titik dalam dokumen PDF.
...
| Nama | Deskripsi |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Konstruktor untuk anotasi saat digunakan dalam Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Membuat anotasi Teks baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Mendapatkan jenis anotasi. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Mendapatkan atau menetapkan ikon yang akan digunakan untuk menampilkan anotasi. |
...
| [Modified](../../aspose.pdf.annotations/annotation/modified/) { get; set; } | Mendapatkan atau menetapkan tanggal dan waktu saat anotasi terakhir dimodifikasi. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Mendapatkan atau menetapkan bendera yang menentukan apakah anotasi harus ditampilkan terbuka pada awalnya. |
...
| [RichText](../../aspose.pdf.annotations/markupannotation/richtext/) { get; set; } | Mendapatkan atau menetapkan string teks kaya yang akan ditampilkan di jendela pop-up saat anotasi dibuka. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | Menerima objek pengunjung untuk memproses anotasi. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | Mengganti definisi dalam kelas dasar dengan tubuh kosong. |
