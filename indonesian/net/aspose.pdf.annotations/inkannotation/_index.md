---
title: "Kelas InkAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Annotations.InkAnnotation. Mewakili coretan tangan bebas yang terdiri dari satu atau lebih jalur terpisah"
type: docs
weight: 2010
...
Merepresentasikan "scribble" tangan bebas yang terdiri dari satu atau lebih jalur terpisah.
...
| Nama | Deskripsi |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList&lt;Point[]&gt;) | Konstruktor untuk anotasi Ink bagi Generator. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList&lt;Point[]&gt;) | Membuat anotasi Ink baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Gaya akhir garis anotasi ink. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Mendapatkan atau mengatur daftar gestur yang merupakan garis independen yang direpresentasikan oleh array Point[]. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Menerima objek visitor untuk memproses anotasi. |
