...
| Nama | Deskripsi |
| --- | --- |
| [PolygonAnnotation](polygonannotation/#constructor)(Dokumen, Point[]) | Konstruktor untuk digunakan dengan Generator. |
| [PolygonAnnotation](polygonannotation/#constructor_1)(Halaman, Rectangle, Point[]) | Membuat anotasi Polygon baru di halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/polygonannotation/annotationtype/) { get; } | Mendapatkan jenis anotasi. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polygonannotation/accept/)(AnnotationSelector) | Menerima objek pengunjung untuk pemrosesan anotasi. |
