---
title: "Kelas ScreenAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Aspose.Pdf.Annotations.ScreenAnnotation kelas. Anotasi layar yang menentukan wilayah halaman tempat klip media dapat diputar"
type: docs
weight: 2610
url: /id/net/aspose.pdf.annotations/screenannotation/
---
...
| Nama | Deskripsi |
| --- | --- |
| [ScreenAnnotation](screenannotation/)(Page, Rectangle, string) | Membuat anotasi Screen baru pada halaman yang ditentukan. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [Action](../../aspose.pdf.annotations/screenannotation/action/) { get; } | Mendapatkan atau mengatur aksi yang akan dilakukan ketika anotasi diaktifkan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/screenannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [Title](../../aspose.pdf.annotations/screenannotation/title/) { get; set; } | Mendapatkan atau mengatur judul anotasi screen. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/screenannotation/accept/)(AnnotationSelector) | Menerima objek visitor untuk memproses anotasi. |
