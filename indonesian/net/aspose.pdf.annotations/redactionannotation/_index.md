---
title: "Kelas RedactionAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Aspose.Pdf.Annotations.RedactionAnnotation class. Mewakili anotasi Redact"
type: docs
weight: 2490
...
| Nama | Deskripsi |
| --- | --- |
| [RedactionAnnotation](redactionannotation/#constructor)(Document) | Konstruktor untuk RedactionAnnotation. Untuk digunakan dalam Generator. |
| [RedactionAnnotation](redactionannotation/#constructor_1)(Page, Rectangle) | Konstruktor untuk RedactAnnotation. |
...
| override [AnnotationType](../../aspose.pdf.annotations/redactionannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [BorderColor](../../aspose.pdf.annotations/redactionannotation/bordercolor/) { get; set; } | Mendapatkan atau mengatur warna border yang digambar ketika redaksi tidak aktif. |
...
| [DefaultAppearance](../../aspose.pdf.annotations/redactionannotation/defaultappearance/) { get; set; } | Mendapatkan atau mengatur string tampilan default yang akan digunakan dalam memformat teks. |
| [FillColor](../../aspose.pdf.annotations/redactionannotation/fillcolor/) { get; set; } | Mendapatkan atau mengatur warna untuk mengisi anotasi. |
| [Flags](../../aspose.pdf.annotations/annotation/flags/) { get; set; } | Flag annotation. |
| [FontSize](../../aspose.pdf.annotations/redactionannotation/fontsize/) { get; set; } | Mendapatkan atau mengatur ukuran font untuk OverlayText. |
...
| [OverlayText](../../aspose.pdf.annotations/redactionannotation/overlaytext/) { get; set; } | Mendapatkan atau mengatur teks yang akan dicetak pada anotasi redaksi. |
...
| [QuadPoint](../../aspose.pdf.annotations/redactionannotation/quadpoint/) { get; set; } | Array berukuran 8xN angka yang menentukan koordinat wilayah konten yang dimaksud untuk dihapus. |
...
| [TextAlignment](../../aspose.pdf.annotations/redactionannotation/textalignment/) { get; set; } | Mendapatkan atau mengatur. Penjajaran Overlay Text. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/redactionannotation/accept/)(AnnotationSelector) | Menerima objek visitor untuk memproses anotasi. |
...
| override [Flatten](../../aspose.pdf.annotations/redactionannotation/flatten/)() | Meratakan anotasi yaitu menghapus anotasi dan menambahkan miliknya |
...
| [Redact](../../aspose.pdf.annotations/redactionannotation/redact/)() | Meratakan anotasi dan menyensor konten halaman (yaitu menghapus teks dan gambar di bawah anotasi yang disensor) |
