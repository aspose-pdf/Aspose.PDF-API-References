...
| override [AnnotationType](../../aspose.pdf.annotations/trimmarkannotation/annotationtype/) { get; } | Mendapatkan jenis anotasi. |
...
Tanda potong ditempatkan di sudut halaman yang dicetak untuk menunjukkan di mana halaman harus dipotong.
