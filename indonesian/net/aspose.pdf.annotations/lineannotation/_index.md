---
title: "Kelas LineAnnotation"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Aspose.Pdf.Annotations.LineAnnotation kelas. Kelas yang mewakili anotasi garis"
type: docs
weight: 2070
...
| Nama | Deskripsi |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Konstruktor untuk digunakan dengan Generator. |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | Membuat anotasi Line baru pada halaman yang ditentukan. |
...
| override [AnnotationType](../../aspose.pdf.annotations/lineannotation/annotationtype/) { get; } | Mendapatkan tipe annotation. |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | Mendapatkan atau mengatur offset teks keterangan dari posisi normalnya. |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | Mendapatkan atau mengatur maksud anotasi garis. |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor/) { get; set; } | Mendapatkan atau mengatur warna interior anotasi. |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | Mendapatkan atau mengatur flag boolean yang menentukan apakah konten harus ditampilkan sebagai keterangan. |
...
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | Memperbarui titik Mulai dan Akhir, sesuai dengan transformasi matriks. |
