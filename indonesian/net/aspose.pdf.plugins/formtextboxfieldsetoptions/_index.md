---
title: "Kelas FormTextBoxFieldSetOptions"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Aspose.Pdf.Plugins.FormTextBoxFieldSetOptions class. Mewakili opsi untuk mengatur properti dalam TextBoxField oleh plugin FormEditor"
type: docs
weight: 8940
...
Mewakili opsi untuk mengatur properti dalam TextBoxField oleh plugin [`FormEditor`](../formeditor/).
...
| [ForceCombs](../../aspose.pdf.plugins/formtextboxfieldsetoptions/forcecombs/) { get; set; } | Mendapatkan/mengatur nilai untuk menentukan properti ForceCombs untuk bidang yang dimodifikasi (jika akan diatur). |
...
| [MaxLen](../../aspose.pdf.plugins/formtextboxfieldsetoptions/maxlen/) { get; set; } | Mendapatkan/mengatur nilai untuk menentukan properti MaxLen untuk bidang yang dimodifikasi (jika akan diatur). |
...
| [Multiline](../../aspose.pdf.plugins/formtextboxfieldsetoptions/multiline/) { get; set; } | Mendapatkan/mengatur nilai untuk menentukan properti Multiline untuk bidang yang dimodifikasi (jika akan diatur). |
...
| [Rect](../../aspose.pdf.plugins/formfieldsetoptions/rect/) { get; set; } | Rectangle yang akan diatur ke field(s). |
...
| [SpellCheck](../../aspose.pdf.plugins/formtextboxfieldsetoptions/spellcheck/) { get; set; } | Mendapatkan/mengatur nilai untuk menentukan properti SpellCheck untuk bidang yang dimodifikasi (jika akan diatur). |
