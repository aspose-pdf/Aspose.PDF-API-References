...
type: docs
weight: 10
url: /id/net/aspose.pdf.generator/boundsoutofrangeexception/boundsoutofrangeexception/
---
## BoundsOutOfRangeException() {#constructor}

Menginisialisasi instance baru dari kelas [`BoundsOutOfRangeException`](../).
...
Menginisialisasi instance baru dari kelas [`BoundsOutOfRangeException`](../) dengan pesan kesalahan yang ditentukan.
