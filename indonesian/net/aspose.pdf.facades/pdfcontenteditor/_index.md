...
| [PdfContentEditor](pdfcontenteditor/#constructor_1)(Document) | Menginisialisasi objek `PdfContentEditor` baru berdasarkan *document*. |
...
| [TextEditOptions](../../aspose.pdf.facades/pdfcontenteditor/texteditoptions/) { get; set; } | Mendapatkan atau mengatur opsi penyuntingan teks. |
...
| Nama | Deskripsi |
| --- | --- |
| [AddDocumentAdditionalAction](../../aspose.pdf.facades/pdfcontenteditor/adddocumentadditionalaction/)(string, string) | Menambahkan aksi tambahan untuk acara dokumen. |
...
| override [BindPdf](../../aspose.pdf.facades/pdfcontenteditor/bindpdf/#bindpdf_1)(Stream) | Mengikat aliran PDF untuk penyuntingan. |
...
| [CreateCustomActionLink](../../aspose.pdf.facades/pdfcontenteditor/createcustomactionlink/)(Rectangle, int, Color, Enum[]) | Membuat tautan ke aksi khusus dalam dokumen PDF. |
...
| [CreatePdfDocumentLink](../../aspose.pdf.facades/pdfcontenteditor/createpdfdocumentlink/#createpdfdocumentlink)(Rectangle, string, int, int) | Membuat tautan ke halaman dokumen PDF lain. |
| [CreatePdfDocumentLink](../../aspose.pdf.facades/pdfcontenteditor/createpdfdocumentlink/#createpdfdocumentlink_1)(Rectangle, string, int, int, Color) | Membuat tautan ke halaman dokumen PDF lain. |
| [CreatePdfDocumentLink](../../aspose.pdf.facades/pdfcontenteditor/createpdfdocumentlink/#createpdfdocumentlink_2)(Rectangle, string, int, int, Color, Enum[]) | Membuat tautan ke halaman dokumen PDF lain. |
| [CreatePolygon](../../aspose.pdf.facades/pdfcontenteditor/createpolygon/)(LineInfo, int, Rectangle, string) | Membuat anotasi poligon. |
| [CreatePolyLine](../../aspose.pdf.facades/pdfcontenteditor/createpolyline/)(LineInfo, int, Rectangle, string) | Membuat anotasi polyline. |
...
| [ExtractLink](../../aspose.pdf.facades/pdfcontenteditor/extractlink/)() | Mengekstrak koleksi instance Link yang terdapat dalam dokumen PDF. |
...
| [RemoveDocumentOpenAction](../../aspose.pdf.facades/pdfcontenteditor/removedocumentopenaction/)() | Menghapus aksi buka dari dokumen. Operasi ini berguna saat menggabungkan beberapa dokumen yang menggunakan aksi 'GoTo' eksplisit saat memulai. |
...
| [ReplaceText](../../aspose.pdf.facades/pdfcontenteditor/replacetext/#replacetext_1)(string, int, string, TextState) | Mengganti teks dalam file PDF pada halaman yang ditentukan. Objek [`TextState`](../../aspose.pdf.text/textstate/) (famili font, warna) dapat ditentukan untuk teks yang diganti. |
...
| Nama | Deskripsi |
| --- | --- |
| const [DocumentClose](../../aspose.pdf.facades/pdfcontenteditor/documentclose/) | Tipe peristiwa dokumen. Menutup dokumen. |
| const [DocumentOpen](../../aspose.pdf.facades/pdfcontenteditor/documentopen/) | Tipe peristiwa dokumen. Membuka dokumen. |
| const [DocumentPrinted](../../aspose.pdf.facades/pdfcontenteditor/documentprinted/) | Tipe peristiwa dokumen. Menjalankan aksi setelah pencetakan. |
| const [DocumentSaved](../../aspose.pdf.facades/pdfcontenteditor/documentsaved/) | Tipe peristiwa dokumen. Menjalankan aksi setelah penyimpanan. |
| const [DocumentWillPrint](../../aspose.pdf.facades/pdfcontenteditor/documentwillprint/) | Tipe peristiwa dokumen. Menjalankan aksi sebelum pencetakan. |
| const [DocumentWillSave](../../aspose.pdf.facades/pdfcontenteditor/documentwillsave/) | Jenis peristiwa dokumen. Menjalankan aksi sebelum menyimpan. |
