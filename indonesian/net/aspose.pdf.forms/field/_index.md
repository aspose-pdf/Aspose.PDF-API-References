...
description: "Kelas Aspose.Pdf.Forms.Field. Kelas dasar untuk bidang formulir akro"
type: docs
weight: 5170
...
| Nama | Deskripsi |
| --- | --- |
| [Field](field/)(Document) | Membuat bidang untuk digunakan dalam Generator. |
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | Jika true maka ukuran font akan diperkecil untuk menyesuaikan teks ke persegi panjang yang ditentukan. |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | Ukuran font maksimum yang dapat digunakan untuk isi bidang. -1 untuk tidak memeriksa ukuran. |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | Ukuran font minimal yang dapat digunakan untuk isi bidang. -1 untuk tidak memeriksa ukuran. |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | Menyalin subbidang dari bidang ini ke dalam array mulai dari indeks yang ditentukan. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | Mengimpor data ke bidang-bidang yang ditentukan dari aliran JSON, berdasarkan kecocokan tepat nama lengkap bidang. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | Mengimpor data ke bidang yang ditentukan dari aliran JSON, menggunakan nama lengkap yang ditentukan dalam variabel 'fieldFullNameInJSON' untuk pencocokan. |
