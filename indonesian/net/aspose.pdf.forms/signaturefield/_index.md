...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | Mendapatkan objek tanda tangan. Objek ini berisi data tanda tangan terkait standar kriptografi kunci publik. Kelas [`PKCS1`](../pkcs1/), [`PKCS7`](../pkcs7/) dan [`PKCS7Detached`](../pkcs7detached/) mewakili semua tipe objek tanda tangan yang didukung. |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | Mengekstrak sertifikat X.509 tunggal dalam format DER sebagai aliran. |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | Mengekstrak objek sertifikat X.509 tunggal. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage)() | Mengekstrak gambar tanda tangan sebagai aliran terenkode jpeg. |
| [ExtractImage](../../aspose.pdf.forms/signaturefield/extractimage/#extractimage_1)(ImageFormat) | Mengekstrak gambar tanda tangan sebagai aliran terenkode. |
...
| [Sign](../../aspose.pdf.forms/signaturefield/sign/#sign)(Signature) | Tandatangani dokumen menggunakan bidang tanda tangan ini. |
