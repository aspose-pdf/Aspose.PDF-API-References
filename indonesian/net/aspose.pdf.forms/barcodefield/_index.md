...
description: Kelas Aspose.Pdf.Forms.BarcodeField. Kelas ini mewakili bidang barcode
type: docs
weight: 4950
url: /id/net/aspose.pdf.forms/barcodefield/
---
## Kelas BarcodeField

Kelas ini mewakili bidang barcode.
...
| Nama | Deskripsi |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Dokumen, Rectangle) | Menginisialisasi instance baru dari kelas `BarcodeField`. |
| [BarcodeField](barcodefield/#constructor_1)(Halaman, Rectangle) | Menginisialisasi instance baru dari kelas `BarcodeField`. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Mendapatkan keterangan objek barcode. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Mendapatkan nilai integer yang mewakili koefisien koreksi kesalahan. Untuk PDF417, harus dari 0 hingga 8. Untuk QRCode, harus dari 0 hingga 3 (0 untuk 'L', 1 untuk 'M', 2 untuk 'Q', dan 3 untuk 'H'). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Mendapatkan resolusi, dalam titik-per-inci (dpi), di mana objek barcode dirender. |
...
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | Menentukan teknologi barcode atau glyph mana yang akan digunakan pada anotasi ini, lihat [`Symbology`](./symbology/) untuk detail. |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | Mendapatkan jarak vertikal antara dua modul barcode, diukur dalam piksel. Rasio XSymHeight/XSymWidth harus merupakan nilai integer. Untuk PDF417, rentang rasio yang dapat diterima adalah dari 1 hingga 4. Untuk QRCode dan DataMatrix, rasio ini harus selalu 1 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | Mendapatkan jarak horizontal, dalam piksel, antara dua modul barcode. |
...
| [ExportToJson](../../aspose.pdf.annotations/widgetannotation/exporttojson/)(Stream, ExportFieldsToJsonOptions) | Mengekspor bidang formulir PDF yang ditentukan ke format JSON dan menulis hasilnya ke stream yang disediakan. |
...
| [ExportValueToJson](../../aspose.pdf.forms/field/exportvaluetojson/)(Stream, bool) | Mengekspor konten dari bidang yang ditentukan ke dalam stream JSON. Nilai bidang tombol tidak diekspor. |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream) | Mengimpor data ke dalam bidang yang ditentukan dari stream JSON, berdasarkan kecocokan tepat dengan nama lengkap bidang. |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/)(Stream, string) | Mengimpor data ke dalam bidang yang ditentukan dari stream JSON, menggunakan nama lengkap yang ditentukan dalam variabel 'fieldFullNameInJSON' untuk pencocokan. |
