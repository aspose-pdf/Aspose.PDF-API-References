---
title: "Kelas BarcodeField"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Forms.BarcodeField. Kelas yang mewakili bidang kode batang"
type: docs
weight: 5070
...
| Nama | Deskripsi |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | Menginisialisasi instance baru dari kelas `BarcodeField`. |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | Menginisialisasi instance baru dari kelas `BarcodeField`. |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | Mendapatkan keterangan dari objek kode batang. |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | Mendapatkan nilai integer yang mewakili koefisien koreksi kesalahan. Untuk PDF417, harus antara 0 hingga 8. Untuk QRCode, harus antara 0 hingga 3 (0 untuk 'L', 1 untuk 'M', 2 untuk 'Q', dan 3 untuk 'H'). |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | Mendapatkan resolusi, dalam titik per inci (dpi), pada mana objek kode batang dirender. |
