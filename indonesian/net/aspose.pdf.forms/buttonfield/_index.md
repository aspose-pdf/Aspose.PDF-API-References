---
title: "Kelas ButtonField"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Forms.ButtonField. Kelas yang merepresentasikan bidang tombol tekan."
type: docs
weight: 5090
...
Kelas mewakili bidang tombol tekan.
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Mendapatkan atau mengatur caption alternatif tombol yang akan ditampilkan ketika tombol mouse ditekan dalam area aktifnya. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Mendapatkan atau mengatur ikon alternatif yang akan ditampilkan ketika tombol mouse ditekan dalam area aktifnya. |
...
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Mendapatkan atau mengatur posisi caption ikon. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Mendapatkan atau mengatur caption normal. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Mendapatkan atau mengatur ikon normal tombol yang akan ditampilkan ketika tidak berinteraksi dengan pengguna. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Mendapatkan atau mengatur caption rollover tombol yang akan ditampilkan ketika pengguna menggerakkan kursor ke area aktifnya tanpa menekan tombol mouse. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Mendapatkan atau mengatur ikon rollover tombol yang akan ditampilkan ketika pengguna menggerakkan kursor ke area aktifnya tanpa menekan tombol mouse. |
