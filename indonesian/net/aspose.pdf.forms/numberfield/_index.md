...
description: Kelas Aspose.Pdf.Forms.NumberField. Field Teks dengan karakter yang valid ditentukan
type: docs
weight: 5140
...
Field Teks dengan karakter yang valid ditentukan
...
| [Required](../../aspose.pdf.annotations/widgetannotation/required/) { get; set; } | Mendapatkan atau mengatur status wajib dari field. |
...
| [GetCheckedStateName](../../aspose.pdf.annotations/widgetannotation/getcheckedstatename/)() | Mengembalikan nama dari status "tercentang" sesuai dengan nama status yang ada. |
