---
title: "Kelas RadioButtonField"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.Forms.RadioButtonField. Kelas yang merepresentasikan bidang tombol radio."
type: docs
weight: 5330
...
| Nama | Deskripsi |
| --- | --- |
| [RadioButtonField](radiobuttonfield/#constructor)(Document) | Konstruktor untuk RadioButtonField. |
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | Konstruktor untuk RadiouttonField |
...
| [CommitImmediately](../../aspose.pdf.forms/choicefield/commitimmediately/) { get; set; } | Mendapatkan atau mengatur flag commit pada perubahan pilihan. |
...
| [MultiSelect](../../aspose.pdf.forms/choicefield/multiselect/) { get; set; } | Mendapatkan atau mengatur flag multiseleksi. |
| [Name](../../aspose.pdf.annotations/annotation/name/) { get; set; } | Mendapatkan atau mengatur nama anotasi pada halaman. |
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | Mendapatkan atau mengatur flag yang memungkinkan tombol radio tidak memiliki nilai terpilih. Jika `true`, tepat satu tombol radio harus dipilih setiap saat; memilih tombol yang sudah dipilih tidak berpengaruh. Jika `false`, mengklik tombol yang dipilih akan membatalkannya, sehingga tidak ada tombol yang dipilih. |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | Mendapatkan atau mengatur array item yang dipilih. Untuk daftar multiselect, array berisi lebih dari satu item. Untuk daftar pilihan tunggal, array berisi satu item. |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | Tambahkan opsi ke radion button. |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | Tambahkan opsi ke tombol radio dengan persegi panjang yang ditentukan. |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | Pindahkan semua subitem tombol radio ke posisi yang ditentukan pada halaman. |
