...
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | Konstruktor untuk bidang ListBox. |
| [ListBoxField](listboxfield/#constructor_2)(Page, Rectangle) | Membuat bidang ListBox baru. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | Mendapatkan atau mengatur indeks item yang dipilih. Item diberi nomor mulai dari 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Mendapatkan atau mengatur array item yang dipilih dalam daftar multiseleksi. Untuk daftar satu pilihan mengembalikan array dengan satu item. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Mendapatkan atau mengatur indeks elemen teratas yang terlihat dalam daftar. |
