...
Opsi penyimpanan untuk mengekspor ke format PS (PostScript) atau EPS.
...
| [EmbedFont](../../aspose.pdf/pssaveoptions/embedfont/) { get; set; } | Mendapatkan/mengatur flag yang menunjukkan apakah font harus disematkan dalam dokumen PS yang dihasilkan. |
| [EmbedFontAs](../../aspose.pdf/pssaveoptions/embedfontas/) { get; set; } | Mendapatkan/mengatur tipe di mana font harus disematkan dalam dokumen PS yang dihasilkan. |
