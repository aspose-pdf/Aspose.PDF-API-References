...
Menginisialisasi instance baru dari kelas [`InvalidPdfFileFormatException`](../).
...
Menginisialisasi instance baru dari kelas [`InvalidPdfFileFormatException`](../) dengan referensi ke pengecualian dalam yang menjadi penyebab pengecualian ini.
