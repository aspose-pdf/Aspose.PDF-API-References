...
description: Properti XslFoLoadOptions. XsltArgumentList untuk menyisipkan nilai ke dalam parameter xls yang ada. File XLS memiliki parameter 'animal' tanpa nilai. XsltArgumentList args = new XsltArgumentList(); args.AddParam("animal", "", "cat"); sekarang konverter mengasumsikan bahwa ada parameter 'animal' dengan nilai 'cat' di file XLS.
type: docs
weight: 30
