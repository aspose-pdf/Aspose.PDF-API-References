...
type: docs
weight: 30
url: /id/net/aspose.pdf/headinglevels/addlevels/
---
...
| --- | --- | --- |
| fontSizes | ICollection`1 | Nilai harus diurutkan dalam urutan menurun. |

### Pengecualian

| pengecualian | kondisi |
| --- | --- |
| ArgumentException | Jika nilai tidak diurutkan atau nilai kurang dari satu. |
