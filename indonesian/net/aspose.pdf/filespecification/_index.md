---
title: "Kelas FileSpecification"
second_title: "Referensi API Aspose.PDF untuk .NET"
description: "Kelas Aspose.Pdf.FileSpecification. Kelas yang mewakili file tersemat"
type: docs
weight: 4970
...
| Nama | Deskripsi |
| --- | --- |
| [FileSpecification](filespecification/#constructor)() | Buat spesifikasi file kosong baru. |
...
| Nama | Deskripsi |
| --- | --- |
| [AFRelationship](../../aspose.pdf/filespecification/afrelationship/) { get; set; } | Hubungan file terkait. |
| [CollectionItem](../../aspose.pdf/filespecification/collectionitem/) { get; } | Mendapatkan item koleksi dari spesifikasi file. |
| [Contents](../../aspose.pdf/filespecification/contents/) { get; set; } | Mendapatkan atau mengatur file konten. Properti ini mengembalikan data yang dimuat ke memori yang dapat menyebabkan pengecualian Out of memory untuk data besar. Untuk mengurangi penggunaan memori silakan gunakan StreamContents. |
...
| [Encoding](../../aspose.pdf/filespecification/encoding/) { get; set; } | Mendapatkan atau mengatur format enkoding. Nilai yang mungkin: Zip - file dikompresi dengan ZIP, None - file tidak dikompresi. |
...
| [MIMEType](../../aspose.pdf/filespecification/mimetype/) { get; set; } | Mendapatkan subtipe dari file tersemat |
...
| [StreamContents](../../aspose.pdf/filespecification/streamcontents/) { get; } | Mendapatkan konten file sebagai stream. Konten tidak dimuat ke memori sehingga memungkinkan mengurangi penggunaan memori. Namun stream ini tidak mendukung penempatan posisi dan properti Length. Jika Anda membutuhkan fitur ini silakan gunakan properti Contents sebagai gantinya. |
...
| Nama | Deskripsi |
| --- | --- |
| [Dispose](../../aspose.pdf/filespecification/dispose/)() | Membuang konten. |
| [GetValue](../../aspose.pdf/filespecification/getvalue/)(string) | Mendapatkan parameter khusus aplikasi. |
| [SetValue](../../aspose.pdf/filespecification/setvalue/)(string, string) | Mengatur parameter khusus aplikasi. |
