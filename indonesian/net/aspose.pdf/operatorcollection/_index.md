---
title: "Kelas OperatorCollection"
...
| override [IsReadOnly](../../aspose.pdf/operatorcollection/isreadonly/) { get; } | Mendapatkan nilai yang menunjukkan apakah koleksi bersifat read-only. |
...
| [Add](../../aspose.pdf/operatorcollection/add/#add_2)(ICollection&lt;Operator&gt;) | Menambahkan ke koleksi semua operator dari koleksi lain. |
| override [Add](../../aspose.pdf/operatorcollection/add/#add)(Operator) | Menambahkan operator baru ke dalam koleksi. |
| [Add](../../aspose.pdf/operatorcollection/add/#add_1)(Operator[]) | Menambahkan operator di akhir operator konten. |
...
| override [Contains](../../aspose.pdf/operatorcollection/contains/)(Operator) | Mengembalikan true jika koleksi berisi operator yang diberikan. |
...
| [Dispose](../../aspose.pdf/operatorcollection/dispose/)() | Melakukan tugas yang ditentukan aplikasi yang terkait dengan pembebasan, pelepasan, atau pengaturan ulang sumber daya yang tidak dikelola. |
...
| [ResumeUpdate](../../aspose.pdf/operatorcollection/resumeupdate/#resumeupdate_1)(bool) | Melanjutkan pembaruan dokumen. Memperbarui aliran konten jika ada perubahan yang tertunda. Menandai semua operator sebagai "changed" jika parameter invalidate bernilai true. |
