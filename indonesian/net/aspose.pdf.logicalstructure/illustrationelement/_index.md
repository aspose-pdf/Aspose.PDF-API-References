...
description: Kelas Aspose.Pdf.LogicalStructure.IllustrationElement. Mewakili kelas dasar untuk elemen struktur ilustrasi dalam struktur logis
type: docs
weight: 6420
url: /id/net/aspose.pdf.logicalstructure/illustrationelement/
---
## Kelas IllustrationElement

Mewakili kelas dasar untuk elemen struktur ilustrasi dalam struktur logis.
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | Menghapus elemen dari struktur, referensi ke elemen dari objek induk, referensi ke elemen dari objek anak, dan objek yang sesuai dari dokumen. Menyisipkan objek anak dari objek yang dihapus ke dalam koleksi objek anak induk sebelumnya mulai dari indeks objek yang dihapus. |
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | Menambahkan gambar ke elemen ilustrasi saat ini. |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | Menambahkan gambar ke elemen ilustrasi saat ini. |
...
* kelas [StructureElement](../structureelement/)
