...
description: "Kelas menjelaskan komponen editor teks kaya."
type: docs
weight: 240
url: /id/python-net/aspose.pdf.forms/richtextboxfield/
---

## RichTextBoxField class

Kelas menjelaskan komponen editor teks kaya.

Tipe RichTextBoxField menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| RichTextBoxField(page, rect) | Menginisialisasi instance baru dari kelas RichTextBoxField |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| value | Nilai dari RichTextField. |
...
| style | Mendapatkan atau mengatur string gaya default dari bidang teks kaya. |
| rich_text_value | Mendapatkan atau mengatur nilai teks kaya. |
| formatted_value | Mendapatkan atau mengatur nilai teks kaya terformat dengan markup. |
| justify | Mendapatkan atau mengatur perataan kotak teks kaya. |
## Indexer
| Nama | Deskripsi |
| :- | :- |
