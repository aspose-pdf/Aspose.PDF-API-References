...
type: docs
weight: 270
url: /id/python-net/aspose.pdf.forms/signaturefield/
---
...
Tipe SignatureField menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| SignatureField(page, rect) | Menginisialisasi instance baru dari kelas SignatureField |
| SignatureField(doc, rect) | Menginisialisasi instance baru dari kelas SignatureField |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| signature | Mendapatkan objek tanda tangan.<br/>            Objek ini berisi data tanda tangan terkait standar kriptografi kunci publik.<br/>            Kelas [PKCS1](/pdf/python-net/aspose.pdf.forms/pkcs1/), [PKCS7](/pdf/python-net/aspose.pdf.forms/pkcs7/) dan [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) <br/>            mewakili semua jenis objek tanda tangan yang didukung. |
## Indexer
| Nama | Deskripsi |
| :- | :- |
...
| Nama | Deskripsi |
| :- | :- |
| sign(signature, pfx, pass) | Menandatangani dokumen menggunakan bidang tanda tangan ini. |
| sign(signature) | Menandatangani dokumen menggunakan bidang tanda tangan ini. |
| extract_image() | Mengekstrak gambar tanda tangan sebagai aliran yang dikodekan jpeg. |
| extract_image(format) | Mengekstrak gambar tanda tangan sebagai aliran yang terenkode. |
| clone() | None |
...
| extract_certificate() | Mengekstrak satu sertifikat X.509 dalam format DER sebagai aliran. |
