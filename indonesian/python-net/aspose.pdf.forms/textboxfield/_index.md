...
type: docs
weight: 280
url: /id/python-net/aspose.pdf.forms/textboxfield/
---
...
Tipe TextBoxField menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| TextBoxField(doc) | Menginisialisasi sebuah instance baru dari kelas TextBoxField |
| TextBoxField() | Buat instance dari TextBoxField. |
| TextBoxField(page, rect) | Menginisialisasi sebuah instance baru dari kelas TextBoxField |
| TextBoxField(doc, rect) | Menginisialisasi sebuah instance baru dari kelas TextBoxField |
## Properti
| Nama | Deskripsi |
| :- | :- |
