...
type: docs
weight: 30
url: /id/python-net/aspose.pdf.forms/checkboxfield/
---
...
Tipe CheckboxField menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| CheckboxField(page, rect) | Menginisialisasi instance baru dari kelas CheckboxField |
| CheckboxField(doc, rect) | Menginisialisasi instance baru dari kelas CheckboxField |
| CheckboxField() | Buat instance CheckboxField. |
| CheckboxField(doc) | Menginisialisasi instance baru dari kelas CheckboxField |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| value | Mendapatkan atau mengatur nilai bidang kotak centang. |
...
| allowed_states | Mengembalikan daftar status yang diizinkan. |
| style | Mendapatkan atau mengatur gaya kotak centang. |
| checked | Mendapatkan atau mengatur status kotak centang. |
| export_value | Mendapatkan atau mengatur nilai ekspor bidang CheckBox. |
## Indexer
| Nama | Deskripsi |
| :- | :- |
...
| Nama | Deskripsi |
| :- | :- |
| clone() | Menggandakan kotak centang. |
