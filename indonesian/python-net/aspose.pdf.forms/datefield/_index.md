...
description: "Bidang tanggal dengan tampilan kalender."
type: docs
weight: 60
url: /id/python-net/aspose.pdf.forms/datefield/
---
...
Tipe DateField memperlihatkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| DateField() | Menginisialisasi sebuah instance baru dari [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) |
| DateField(doc) | Menginisialisasi sebuah instance baru dari kelas DateField |
| DateField(page, rect) | Menginisialisasi sebuah instance baru dari kelas DateField |
| DateField(doc, rect) | Menginisialisasi sebuah instance baru dari kelas DateField |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| value | Mendapatkan atau mengatur Date. |
...
| date_format | Mendapatkan atau mengatur format tanggal. |
## Indexer
| Nama | Deskripsi |
| :- | :- |
...
| Nama | Deskripsi |
| :- | :- |
| add_image(image) | Penambahan gambar ditolak untuk bidang ini. |
| add_image(image) | Penambahan gambar ditolak untuk bidang ini. |
| clone() | None |
...
| init(page) | Menginisialisasi JS Action. |
