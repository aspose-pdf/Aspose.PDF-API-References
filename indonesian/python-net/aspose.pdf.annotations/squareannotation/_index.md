...
description: "Kelas yang mewakili anotasi persegi."
type: docs
weight: 770
url: /id/python-net/aspose.pdf.annotations/squareannotation/
---

## SquareAnnotation class

Kelas yang mewakili anotasi persegi.

Tipe SquareAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| SquareAnnotation(document) | Menginisialisasi sebuah instance baru dari kelas SquareAnnotation |
| SquareAnnotation(page, rect) | Menginisialisasi sebuah instance baru dari kelas SquareAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| interior_color | Warna interior yang digunakan untuk mengisi persegi panjang atau elips anotasi. |
| bingkai | Persegi panjang yang menggambarkan perbedaan numerik antara dua persegi panjang:<br/>            entri Rect dari anotasi dan batas sebenarnya dari persegi atau lingkaran yang mendasarinya. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
| get_rectangle(consider_rotation) | None |
| accept(visitor) | Menerima pengunjung untuk memproses anotasi. |
| flatten() | None |
