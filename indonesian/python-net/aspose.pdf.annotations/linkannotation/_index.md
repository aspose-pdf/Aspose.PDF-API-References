...
description: "Merepresentasikan baik tautan hiperteks ke tujuan di tempat lain dalam dokumen maupun aksi yang akan dilakukan."
type: docs
weight: 390
url: /id/python-net/aspose.pdf.annotations/linkannotation/
---

## LinkAnnotation class

Merepresentasikan baik tautan hiperteks ke tujuan di tempat lain dalam dokumen maupun aksi yang akan dilakukan.

Tipe LinkAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| LinkAnnotation(page, rect) | Menginisialisasi instance baru dari kelas LinkAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| action | Aksi yang akan dilakukan ketika anotasi tautan diaktifkan. |
| tujuan | Tujuan yang akan ditampilkan ketika anotasi diaktifkan. |
| highlighting | Efek visual yang akan digunakan ketika tombol mouse ditekan atau ditahan di dalam area aktifnya. |
## Metode
| Nama | Deskripsi |
| :- | :- |
