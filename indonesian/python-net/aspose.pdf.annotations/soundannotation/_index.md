...
type: docs
weight: 740
url: /id/python-net/aspose.pdf.annotations/soundannotation/
---
...
Tipe SoundAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | Menginisialisasi sebuah instance baru dari kelas SoundAnnotation |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | Menginisialisasi sebuah instance baru dari kelas SoundAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| sound_data | Mendapatkan objek suara yang mendefinisikan suara yang akan diputar ketika anotasi diaktifkan. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
