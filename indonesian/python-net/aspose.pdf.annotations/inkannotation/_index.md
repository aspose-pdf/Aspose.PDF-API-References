...
description: "Mewakili \"scribble\" bebas yang terdiri dari satu atau lebih jalur terpisah."
type: docs
weight: 350
url: /id/python-net/aspose.pdf.annotations/inkannotation/
---

## InkAnnotation class

Mewakili "scribble" bebas yang terdiri dari satu atau lebih jalur terpisah.

Tipe InkAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| InkAnnotation(document, ink_list) | Menginisialisasi instance baru dari kelas InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Menginisialisasi instance baru dari kelas InkAnnotation |
| InkAnnotation(page, rect, ink_list) | Menginisialisasi instance baru dari kelas InkAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| cap_style | Gaya akhir garis anotasi tinta. |
| ink_list | Mendapatkan atau mengatur daftar gestur yang merupakan garis independen yang direpresentasikan oleh array Point[]. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
...
| change_after_resize(transform) | Memperbarui titik-titik dalam InkList, sesuai dengan transformasi matriks. |
