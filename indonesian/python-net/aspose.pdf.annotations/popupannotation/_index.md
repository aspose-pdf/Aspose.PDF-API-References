...
type: docs
weight: 670
url: /id/python-net/aspose.pdf.annotations/popupannotation/
---
...
Tipe PopupAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| PopupAnnotation(document) | Menginisialisasi sebuah instance baru dari kelas PopupAnnotation |
| PopupAnnotation(page, rect) | Menginisialisasi sebuah instance baru dari kelas PopupAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| buka | Mendapatkan atau mengatur flag yang menentukan apakah anotasi pop-up harus awalnya ditampilkan terbuka. |
| parent | Mendapatkan atau mengatur anotasi induk yang akan dikaitkan dengan anotasi pop-up ini.<br/>            Jika entri ini ada, isi, M, C, dan T dari anotasi induk akan menggantikan yang ada pada anotasi pop-up itu sendiri. |
## Metode
| Nama | Deskripsi |
| :- | :- |
