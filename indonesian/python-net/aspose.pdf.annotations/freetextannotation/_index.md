...
description: "Mewakili anotasi teks bebas yang menampilkan teks langsung pada halaman. Tidak seperti anotasi teks biasa, anotasi teks bebas tidak memiliki keadaan terbuka atau tertutup; alih-alih ditampilkan dalam jendela pop-up, teks selalu terlihat."
type: docs
weight: 260
url: /id/python-net/aspose.pdf.annotations/freetextannotation/
---
...
Tipe FreeTextAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| FreeTextAnnotation(document, appearance) | Menginisialisasi sebuah instance baru dari kelas FreeTextAnnotation |
| FreeTextAnnotation(page, rect, appearance) | Menginisialisasi sebuah instance baru dari kelas FreeTextAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| starting_style | Mendapatkan atau mengatur gaya akhir garis untuk titik akhir garis.<br/>            OProperti ini sudah usang, silakan gunakan EndingStyle. |
| ending_style | Mendapatkan atau mengatur gaya akhir garis untuk titik akhir garis. |
| justification | Mendapatkan atau mengatur kode yang menentukan bentuk penataan (justifikasi) yang akan digunakan dalam menampilkan teks anotasi. |
| default_appearance | Mendapatkan atau mengatur string tampilan default yang akan digunakan dalam memformat teks. |
| default_appearance_object | Objek yang mewakili tampilan default anotasi FreeText. |
| intent | Mendapatkan atau mengatur maksud anotasi teks bebas. |
| default_style | Mendapatkan atau mengatur string gaya default. |
| text_style | Mendapatkan atau mengatur gaya teks dalam tampilan. Ketika gaya teks diubah, tampilan teks diperbarui. |
| putar | Sudut rotasi anotasi. |
| panggilan | Array titik yang menentukan garis panggilan. |
| text_rectangle | Persegi panjang yang menjelaskan perbedaan numerik antara dua persegi panjang: entri Rect dari anotasi<br/>             dan persegi panjang yang berada di dalam persegi panjang tersebut. Persegi panjang dalam adalah tempat teks anotasi harus ditampilkan. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
