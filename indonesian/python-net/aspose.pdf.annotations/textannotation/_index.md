...
type: docs
weight: 820
url: /id/python-net/aspose.pdf.annotations/textannotation/
---

## TextAnnotation class

Mewakili anotasi teks yang merupakan “sticky note” yang terpasang pada suatu titik dalam dokumen PDF.

Tipe TextAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| TextAnnotation(document) | Menginisialisasi sebuah instance baru dari kelas TextAnnotation |
| TextAnnotation(page, rect) | Menginisialisasi sebuah instance baru dari kelas TextAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| buka | Mendapatkan atau mengatur flag yang menentukan apakah anotasi harus ditampilkan terbuka secara awal. |
| icon | Mendapatkan atau mengatur ikon yang akan digunakan untuk menampilkan anotasi. |
| state | Mendapatkan atau mengatur keadaan yang harus ditetapkan pada anotasi asli. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
