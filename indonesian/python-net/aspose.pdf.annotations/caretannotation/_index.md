...
type: docs
weight: 80
url: /id/python-net/aspose.pdf.annotations/caretannotation/
---
...
Tipe CaretAnnotation menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| CaretAnnotation(document) | Menginisialisasi instance baru dari kelas CaretAnnotation |
| CaretAnnotation(page, rect) | Menginisialisasi instance baru dari kelas CaretAnnotation |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| bingkai | Mendapatkan atau mengatur persegi caret. |
| symbol | Mendapatkan atau mengatur simbol yang terkait dengan caret. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| clone() | None |
