...
description: "Kelas menjelaskan artefak latar belakang. Artefak ini memungkinkan mengatur latar belakang halaman."
type: docs
weight: 50
url: /id/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Kelas menjelaskan artefak latar belakang. Artefak ini memungkinkan mengatur latar belakang halaman.

Tipe BackgroundArtifact menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| BackgroundArtifact() | Menginisialisasi objek BackgroundArtifact. |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| background_color | Mendapatkan atau mengatur warna latar belakang artefak latar belakang |
| background_image | Mendapatkan atau mengatur gambar latar belakang artefak latar belakang |
## Metode
| Nama | Deskripsi |
| :- | :- |
