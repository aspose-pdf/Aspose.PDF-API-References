...
description: "Kelas yang menjelaskan artefak watermark. Ini dapat digunakan untuk"
type: docs
weight: 1640
url: /id/python-net/aspose.pdf/watermarkartifact/
---

## WatermarkArtifact class

Kelas yang menjelaskan artefak watermark. Ini dapat digunakan untuk

Tipe WatermarkArtifact menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| WatermarkArtifact() | Membuat instance Watermark artifact. |
## Properti
| Nama | Deskripsi |
| :- | :- |
