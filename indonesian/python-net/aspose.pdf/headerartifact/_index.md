...
description: "Kelas menggambarkan artefak Heaader. Artefak ini dapat digunakan untuk mengatur heading halaman."
type: docs
weight: 440
url: /id/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

Kelas menggambarkan artefak Heaader. Artefak ini dapat digunakan untuk mengatur heading halaman.

Tipe HeaderArtifact menampilkan anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| HeaderArtifact() | Membuat instance Header Artifact. |
## Properti
| Nama | Deskripsi |
| :- | :- |
