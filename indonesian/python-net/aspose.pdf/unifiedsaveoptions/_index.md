...
description: "Kelas ini mewakili opsi penyimpanan untuk penyimpanan yang <br/> menggunakan cara konversi terpadu (dengan model dokumen internal terpadu)"
type: docs
weight: 1590
url: /id/python-net/aspose.pdf/unifiedsaveoptions/
---

## UnifiedSaveOptions class

Kelas ini mewakili opsi penyimpanan untuk penyimpanan yang <br/> menggunakan cara konversi terpadu (dengan model dokumen internal terpadu)

Tipe UnifiedSaveOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| UnifiedSaveOptions() | Menginisialisasi sebuah instance baru dari kelas UnifiedSaveOptions |
## Properti
| Nama | Deskripsi |
| :- | :- |
