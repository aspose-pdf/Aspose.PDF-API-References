...
description: "Opsi penyimpanan untuk ekspor ke format TeX"
type: docs
weight: 1540
url: /id/python-net/aspose.pdf/texsaveoptions/
---
...
Tipe TeXSaveOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| TeXSaveOptions() | Menginisialisasi sebuah instance baru dari kelas TeXSaveOptions |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| out_directory_path | Properti untuk |
| pages_count | Mengembalikan jumlah halaman setelah konversi. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| add_font_encs(font_encs) | Menambahkan pengkodean font ke daftar pengkodean font |
| clear_font_encs() | Menghapus daftar enkoding font |
