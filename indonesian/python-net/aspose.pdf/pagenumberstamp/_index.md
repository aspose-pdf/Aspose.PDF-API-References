...
type: docs
weight: 1140
url: /id/python-net/aspose.pdf/pagenumberstamp/
---
...
Tipe PageNumberStamp menyajikan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| PageNumberStamp(format) | Menginisialisasi instance baru dari kelas PageNumberStamp |
| PageNumberStamp() | Menginisialisasi instance baru dari kelas [PageNumberStamp](/pdf/python-net/aspose.pdf/pagenumberstamp/). Format diatur ke "#". |
| PageNumberStamp(formatted_text) | Menginisialisasi instance baru dari kelas PageNumberStamp |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| format | Nilai string untuk menandai nomor halaman. <br/>            Nilai harus menyertakan karakter '#' yang akan digantikan dengan nomor halaman dalam proses penandaan. |
| starting_number | Mendapatkan atau mengatur nilai nomor halaman awal. Halaman lainnya akan diberi nomor mulai dari nilai ini. |
| numbering_style | Gaya penomoran yang digunakan oleh stempel ini. |
## Metode
| Nama | Deskripsi |
| :- | :- |
| put(page) | Menambahkan nomor halaman. |
