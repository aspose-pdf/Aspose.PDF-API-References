...
type: docs
weight: 1310
url: /id/python-net/aspose.pdf/psloadoptions/
---
...
Tipe PsLoadOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| PsLoadOptions() | Menginisialisasi instance baru dari kelas PsLoadOptions |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| fonts_folders | Mendapatkan atau mengatur jalur folder font. |
