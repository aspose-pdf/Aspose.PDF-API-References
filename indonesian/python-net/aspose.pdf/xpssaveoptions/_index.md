...
type: docs
weight: 1810
url: /id/python-net/aspose.pdf/xpssaveoptions/
---
...
Tipe XpsSaveOptions menampilkan anggota-anggota berikut:
## Konstruktor
| Nama | Deskripsi |
| :- | :- |
| XpsSaveOptions() | Menginisialisasi instance baru dari kelas XpsSaveOptions |
## Properti
| Nama | Deskripsi |
| :- | :- |
...
| save_transparent_texts | Menunjukkan apakah harus mempertahankan teks transparan (OCR'ed). |
