...
description: "Menambahkan watermark pada halaman."
type: docs
url: /id/rust-cpp/organize/page_add_watermark/
---

_Menambahkan watermark pada halaman._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Tambahkan watermark pada halaman
