...
description: "Menambahkan watermark ke PDF-document."
type: docs
url: /id/rust-cpp/organize/add_watermark/
---

_Menambahkan watermark ke PDF-document._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Tambahkan watermark ke PDF-document
    pdf.add_watermark(
        "WATERMARK",
        "Arial",
        16.0,
