...
description: "Membuat beberapa PDF-document baru dengan mengekstrak halaman dari PDF-document sumber."
type: docs
url: /id/rust-cpp/core/split_document/
---

_Membuat beberapa PDF-document baru dengan mengekstrak halaman dari PDF-document sumber._
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Membuat beberapa PDF-document baru dengan mengekstrak halaman dari PDF-document sumber
