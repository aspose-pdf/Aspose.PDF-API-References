...
description: "Tandatangani dokumen PDF menggunakan tanda tangan digital PKCS#7 Terpisah."
type: docs
url: /id/rust-cpp/security/sign_pkcs7_detached/
---
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Tandatangani dokumen PDF menggunakan tanda tangan digital PKCS#7 Detached
