...
description: "Kelas yang mewakili operator K (mengatur warna CMYK untuk operasi stroking)."
type: docs
weight: 540
url: /id/java/com.aspose.pdf.operators/setcmykcolorstroke/
---
**Inheritance:**
...
Kelas yang mewakili operator K (mengatur warna CMYK untuk operasi stroking).

## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [SetCMYKColorStroke](#SetCMYKColorStroke-double-double-double-double-) | Menginisialisasi operator. |
| [SetCMYKColorStroke](#SetCMYKColorStroke-int-com.aspose.pdf.engine.commondata.pagecontent.operators.color.SetCMYKStrokingColor-) | Konstruktor untuk kelas operator. |
...
| [getColor](#getColor--) | Mengembalikan warna RGB |
