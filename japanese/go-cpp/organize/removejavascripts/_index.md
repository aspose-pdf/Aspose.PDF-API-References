...
description: "PDF-document から JavaScript を削除します。"
type: docs
url: /ja/go-cpp/organize/removejavascripts/
---

_PDFドキュメントからJavaScriptを削除します._
...
func main() {
	...
	defer pdf.Close()
	// RemoveJavaScripts() PDFドキュメントからJavaScriptを削除します
