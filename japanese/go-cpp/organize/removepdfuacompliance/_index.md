...
description: "PDFドキュメントからPDF/UA準拠を削除する。"
type: docs
url: /ja/go-cpp/organize/removepdfuacompliance/
---

_PDF ドキュメントから PDF/UA 準拠を削除します。_
...
func main() {
	...
	defer pdf.Close()
	// RemovePdfUaCompliance() は PDF ドキュメントから PDF/UA 準拠を削除します
