...
description: "PDFドキュメントを暗号化します。"
type: docs
url: /ja/go-cpp/security/encrypt/
---

_PDF-document を暗号化します。_
...
func main() {
	...
	defer pdf.Close()
	// Encrypt(userPassword, ownerPassword, permissions, cryptoAlgorithm, usePdf20) は PDF-document を暗号化します
	err = pdf.Encrypt(
		"userpass",
		"ownerpass",
