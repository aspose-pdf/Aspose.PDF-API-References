...
description: "PKCS#7 デタッチド デジタル署名を使用して PDFドキュメントに署名します。"
type: docs
url: /ja/go-cpp/security/signpkcs7detached/
---

_PKCS#7 Detached デジタル署名を使用して PDF-document に署名します。_
...
func main() {
	...
	// SignPKCS7Detached は PKCS#7 Detached デジタル署名を使用して PDF-document に署名します
