...
description: "PDF ドキュメントを 2 つの新しい PDF ドキュメントに分割します。"
type: docs
url: /ja/go-cpp/core/splitatpage/
---

_PDF ドキュメントを 2 つの新しい PDF ドキュメントに分割します。_
...
func main() {
	...
	// SplitAtPage(document *Document, page int) は、2 つの新しい PDF ドキュメントを作成します
