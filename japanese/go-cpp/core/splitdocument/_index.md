...
description: "ソース PDF ドキュメントからページを抽出して複数の新しい PDF ドキュメントを作成します。"
type: docs
url: /ja/go-cpp/core/splitdocument/
---

_元の PDF ドキュメントからページを抽出して複数の新しい PDF ドキュメントを作成します。_
...
func main() {
	...
	// SplitDocument(document *Document, pagerange string) は、複数の新しい PDF ドキュメントを作成します
