---
title: "クラス LineAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.LineAnnotation クラス。線アノテーションを表すクラスです。"
type: docs
weight: 2070
...
| 名前 | 説明 |
| --- | --- |
| [LineAnnotation](lineannotation/#constructor)(Document, Point, Point) | Generator と共に使用するためのコンストラクタです。 |
| [LineAnnotation](lineannotation/#constructor_1)(Page, Rectangle, Point, Point) | 指定されたページに新しい線アノテーションを作成します。 |
...
| [CaptionOffset](../../aspose.pdf.annotations/lineannotation/captionoffset/) { get; set; } | キャプションテキストの通常位置からのオフセットを取得または設定します。 |
| [CaptionPosition](../../aspose.pdf.annotations/lineannotation/captionposition/) { get; set; } | アノテーションのキャプション位置を取得または設定します。 |
...
| [Ending](../../aspose.pdf.annotations/lineannotation/ending/) { get; set; } | 線の終点を取得または設定します。 |
| [EndingStyle](../../aspose.pdf.annotations/lineannotation/endingstyle/) { get; set; } | 線の終点の終了スタイルを取得または設定します。 |
...
| [Intent](../../aspose.pdf.annotations/lineannotation/intent/) { get; set; } | 線アノテーションの意図を取得または設定します。 |
| [InteriorColor](../../aspose.pdf.annotations/lineannotation/interiorcolor/) { get; set; } | アノテーションの内部色を取得または設定します。 |
...
| [LeaderLineExtension](../../aspose.pdf.annotations/lineannotation/leaderlineextension/) { get; set; } | リーダーライン拡張の長さを取得または設定します。 |
...
| [Measure](../../aspose.pdf.annotations/lineannotation/measure/) { get; set; } | この注釈に指定された測定単位です。 |
...
| [ShowCaption](../../aspose.pdf.annotations/lineannotation/showcaption/) { get; set; } | 内容をキャプションとして表示するかどうかを決定するブールフラグを取得または設定します。 |
| [Starting](../../aspose.pdf.annotations/lineannotation/starting/) { get; set; } | 線の開始点を取得または設定します。 |
| [StartingStyle](../../aspose.pdf.annotations/lineannotation/startingstyle/) { get; set; } | 線の開始点に対する終了スタイルを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/lineannotation/accept/)(AnnotationSelector) | アノテーション処理のためのビジターを受け入れます。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/lineannotation/changeafterresize/)(Matrix) | 行列変換に従って開始点と終了点を更新します。 |
