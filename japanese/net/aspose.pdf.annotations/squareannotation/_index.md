...
description: Aspose.Pdf.Annotations.SquareAnnotation クラス。四角形注釈を表すクラス
type: docs
weight: 2590
url: /ja/net/aspose.pdf.annotations/squareannotation/
---
## SquareAnnotation クラス
...
| 名前 | 説明 |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Generator と一緒に使用するためのコンストラクタ。 |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しい四角形注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squareannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Frame](../../aspose.pdf.annotations/commonfigureannotation/frame/) { get; set; } | 2つの矩形の間の数値的な違いを説明する矩形：注釈の Rect エントリと基になる四角形または円の実際の境界。 |
...
| [InteriorColor](../../aspose.pdf.annotations/commonfigureannotation/interiorcolor/) { get; set; } | 注釈の矩形または楕円を塗りつぶすための内部色。 |
...
| [Opacity](../../aspose.pdf.annotations/markupannotation/opacity/) { get; set; } | 注釈を描画するために使用される定数不透明度値を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターを受け入れます。 |
