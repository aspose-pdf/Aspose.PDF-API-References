...
| 名前 | 説明 |
| --- | --- |
| [SquareAnnotation](squareannotation/#constructor)(Document) | Generator と共に使用するためのコンストラクタです。 |
| [SquareAnnotation](squareannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しい Square 注釈を作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squareannotation/accept/)(AnnotationSelector) | アノテーションを処理するビジターを受け入れます。 |
