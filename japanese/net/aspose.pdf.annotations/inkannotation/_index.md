---
title: "クラス InkAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.InkAnnotation クラス。1 つまたは複数の切れ目のあるパスで構成されたフリーハンドの落書きを表します"
type: docs
weight: 2010
...
1つ以上の切れ目のあるパスで構成されるフリーハンドの「落書き」を表します。
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Ink 注釈の線端のスタイル。 |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | ポイント配列（Point[]）で表される独立した線としてのジェスチャーのリストを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | 行列変換に従って InkList のポイントを更新します。 |
