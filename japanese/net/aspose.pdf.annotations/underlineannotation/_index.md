---
title: "クラス UnderlineAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.UnderlineAnnotation クラス。文書のテキストに下線として表示される下線アノテーションを表します。"
type: docs
weight: 2800
...
| 名前 | 説明 |
| --- | --- |
| [UnderlineAnnotation](underlineannotation/)(Page, Rectangle) | 指定されたページに新しい Underline アノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/underlineannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/underlineannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
