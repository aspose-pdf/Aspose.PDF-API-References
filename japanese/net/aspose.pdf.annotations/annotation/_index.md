---
title: "クラス Annotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.Annotation クラス。アノテーションオブジェクトを表すクラス"
type: docs
weight: 1500
...
| [Border](../../aspose.pdf.annotations/annotation/border/) { get; set; } | アノテーションの枠線特性を取得または設定します。[`Border`](./border/) |
...
| static [UpdateAppearanceOnConvert](../../aspose.pdf.annotations/annotation/updateappearanceonconvert/) { get; set; } | true の場合、PF ドキュメントを画像に変換する前にアノテーションの外観が更新されます。これによりフィールドが正しく変換されますが、時間がかかる可能性があります。 |
