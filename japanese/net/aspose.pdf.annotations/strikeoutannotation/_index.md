---
title: "クラス StrikeOutAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.StrikeOutAnnotation クラス。文書のテキスト内で取り消し線として表示されるストライクアウト注釈を表します。"
type: docs
weight: 2730
...
文書のテキストに取り消し線として表示される取り消し線注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [StrikeOutAnnotation](strikeoutannotation/)(Page, Rectangle) | 指定されたページに新しい StrikeOut 注釈を作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/strikeoutannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
