---
title: "クラス PolylineAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.PolylineAnnotation クラス。最初と最後の頂点が暗黙的に接続されていない点でポリゴンに似たポリラインアノテーションを表します。"
type: docs
weight: 2410
...
ポリライン注釈はポリゴンに似ていますが、最初と最後の頂点は暗黙的に接続されません。
...
| 名前 | 説明 |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | 指定されたページに新しいポリラインアノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | 2番目の線端のスタイルを取得または設定します。 |
...
| [InteriorColor](../../aspose.pdf.annotations/polyannotation/interiorcolor/) { get; set; } | 注釈の線端を塗りつぶすための内部色を取得または設定します。 |
...
| [Measure](../../aspose.pdf.annotations/polyannotation/measure/) { get; set; } | この注釈に指定された測定単位です。 |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | 最初の線端のスタイルを取得または設定します。 |
...
| [Vertices](../../aspose.pdf.annotations/polyannotation/vertices/) { get; set; } | 各頂点の水平および垂直座標を表すポイントの配列を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
