...
description: Aspose.Pdf.Annotations.PolylineAnnotation クラス。最初と最後の頂点が暗黙的に接続されていない点を除いて、ポリゴンに似たポリライン注釈を表します。
type: docs
weight: 2320
url: /ja/net/aspose.pdf.annotations/polylineannotation/
---
## PolylineAnnotation クラス

最初と最後の頂点が暗黙的に接続されていない点を除いて、ポリゴンに似たポリライン注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [PolylineAnnotation](polylineannotation/)(Page, Rectangle, Point[]) | 指定されたページに新しいポリライン注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/polylineannotation/annotationtype/) { get; } | 注釈の種類を取得します。 |
...
| [EndingStyle](../../aspose.pdf.annotations/polyannotation/endingstyle/) { get; set; } | 2番目の線の終端スタイルを取得または設定します。 |
...
| virtual [Hyperlink](../../aspose.pdf/baseparagraph/hyperlink/) { get; set; } | フラグメントハイパーリンク（PDFジェネレーター用）を取得または設定します。 |
...
| [StartingStyle](../../aspose.pdf.annotations/polyannotation/startingstyle/) { get; set; } | 最初の線の終端スタイルを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/polylineannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターオブジェクトを受け入れます。 |
