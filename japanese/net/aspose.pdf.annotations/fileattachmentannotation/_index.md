---
title: "クラス FileAttachmentAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.FileAttachmentAnnotation クラス。ファイル添付アノテーションを記述するクラスです。"
type: docs
weight: 1800
...
| 名前 | 説明 |
| --- | --- |
| [FileAttachmentAnnotation](fileattachmentannotation/)(Page, Rectangle, FileSpecification) | 指定された Page に新しい FileAttachment アノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/fileattachmentannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [File](../../aspose.pdf.annotations/fileattachmentannotation/file/) { get; set; } | このアノテーションに関連付けられたファイルの仕様です。 |
...
| [Icon](../../aspose.pdf.annotations/fileattachmentannotation/icon/) { get; set; } | アノテーションの表示に使用されるアイコンを取得または設定します。 |
...
| [Opacity](../../aspose.pdf.annotations/fileattachmentannotation/opacity/) { get; set; } | アイコンの不透明度を 0 から 1 の範囲で取得または設定します：0 は完全に透明、1 は完全に不透明です。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/fileattachmentannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
