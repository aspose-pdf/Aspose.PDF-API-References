---
title: "クラス BleedMarkAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.BleedMarkAnnotation クラス。ブリードマーク注釈を表します"
type: docs
weight: 1590
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/bleedmarkannotation/accept/)(AnnotationSelector) | アノテーション処理のためにビジターを受け入れます。 |
...
ブリードマークは印刷されたページの角に配置され、ページのトリム位置とトリムマークからどれだけ離れてもよいかを示します。
