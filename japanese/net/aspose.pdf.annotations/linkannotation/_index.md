...
description: Aspose.Pdf.Annotations.LinkAnnotation クラス。文書内の他の場所へのハイパーテキストリンクまたは実行されるアクションを表します。
type: docs
weight: 2010
...
文書内の他の場所へのハイパーテキストリンクまたは実行されるアクションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [LinkAnnotation](linkannotation/)(Page, Rectangle) | 指定されたページに新しいリンク注釈を作成します。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Action](../../aspose.pdf.annotations/linkannotation/action/) { get; set; } | リンク注釈がアクティブ化されたときに実行されるアクション。 |
...
| [Destination](../../aspose.pdf.annotations/linkannotation/destination/) { get; set; } | 注釈がアクティブ化されたときに表示される宛先。 |
...
| [Highlighting](../../aspose.pdf.annotations/linkannotation/highlighting/) { get; set; } | マウスボタンが押されているか、アクティブエリア内で保持されているときに使用される視覚効果。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/linkannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターオブジェクトを受け入れます。 |
