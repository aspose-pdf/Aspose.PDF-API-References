---
title: "クラス CircleAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.CircleAnnotation クラス。円アノテーションを表すクラス"
type: docs
weight: 1680
...
| 名前 | 説明 |
| --- | --- |
| [CircleAnnotation](circleannotation/#constructor)(Document) | 円アノテーションのコンストラクタ。 |
| [CircleAnnotation](circleannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しい円アノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/circleannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/circleannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
