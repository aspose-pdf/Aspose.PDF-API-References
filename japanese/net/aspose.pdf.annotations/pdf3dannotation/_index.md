---
title: "クラス PDF3DAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.PDF3DAnnotation クラス。クラス PDF3DAnnotation。このクラスは継承できません。"
type: docs
weight: 2240
...
| override [AnnotationType](../../aspose.pdf.annotations/pdf3dannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Pdf3DArtwork](../../aspose.pdf.annotations/pdf3dannotation/pdf3dartwork/) { get; } | 3D アートワークを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/pdf3dannotation/accept/)(AnnotationSelector) | アノテーション処理のためにビジターを受け入れます。 |
