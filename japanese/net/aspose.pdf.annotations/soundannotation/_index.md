---
title: "クラス SoundAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.SoundAnnotation クラス。コンピュータのマイクから録音された音声またはファイルからインポートされた音声を含むサウンドアノテーションを表します。"
type: docs
weight: 2630
...
コンピュータのマイクから録音した音声、またはファイルからインポートした音声を含むサウンド注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 指定されたページに新しいサウンドアノテーションを作成します。 |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 指定されたページに新しいサウンドアノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | 注釈の表示に使用されるアイコンを取得または設定します。 |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | アノテーションがアクティブになったときに再生される音声を定義するサウンドオブジェクトを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
