...
description: Aspose.Pdf.Annotations.SoundAnnotation クラス。コンピュータのマイクから録音された音声またはファイルからインポートされた音声を含む音声注釈を表します。
type: docs
weight: 2530
url: /ja/net/aspose.pdf.annotations/soundannotation/
---
## SoundAnnotation クラス

コンピュータのマイクから録音された音声またはファイルからインポートされた音声を含む音声注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [SoundAnnotation](soundannotation/#constructor)(Page, Rectangle, string) | 指定されたページに新しい音声注釈を作成します。 |
| [SoundAnnotation](soundannotation/#constructor_1)(Page, Rectangle, string, SoundSampleData) | 指定されたページに新しい音声注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | 注釈の種類を取得します。 |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | 注釈を表示するために使用されるアイコンを取得または設定します。 |
| [InReplyTo](../../aspose.pdf.annotations/markupannotation/inreplyto/) { get; set; } | この注釈が「返信する」注釈への参照です。両方の注釈は文書の同じページに存在する必要があります。 |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | 注釈がアクティブ化されたときに再生される音声を定義する音声オブジェクトを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターオブジェクトを受け入れます。 |
| virtual [ChangeAfterResize](../../aspose.pdf.annotations/annotation/changeafterresize/)(Matrix) | マトリックス変換に従ってパラメータと外観を更新します。 |
| [ClearState](../../aspose.pdf.annotations/markupannotation/clearstate/)() | 注釈の状態と状態モデルをクリアします。たとえば、注釈のレビュー状態をクリアします。他のテキスト注釈に保存されている状態に注意してください。 |
...
| [GetState](../../aspose.pdf.annotations/markupannotation/getstate/)() | 注釈の状態を取得します。他のテキスト注釈に保存されている状態に注意してください。 |
| [GetStateModel](../../aspose.pdf.annotations/markupannotation/getstatemodel/)() | 注釈の状態モデルを取得します。他のテキスト注釈に保存されている状態に注意してください。 |
| [SetMarkedState](../../aspose.pdf.annotations/markupannotation/setmarkedstate/)(bool) | 注釈のマークされた状態と未マークの状態を設定します。他のテキスト注釈に保存されている状態に注意してください。 |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 注釈のレビュー状態を設定します。マークされた状態と未マークの状態は、レビュー状態モデルに属していないため無視されます。状態は、ターゲット注釈を作成したユーザーによって設定されます。値はターゲット注釈の Title プロパティから取得されます。他のテキスト注釈に保存されている状態に注意してください。 |
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState, string) | 注釈のレビュー状態を設定します。マークされた状態と未マークの状態は、レビュー状態モデルに属していないため無視されます。他のテキスト注釈に保存されている状態に注意してください。 |
