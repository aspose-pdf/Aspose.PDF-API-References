...
| 名前 | 説明 |
| --- | --- |
| [TrimMarkAnnotation](trimmarkannotation/)(Page, PrinterMarkCornerPosition) | 新しい `TrimMarkAnnotation` クラスのインスタンスを初期化します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/trimmarkannotation/accept/)(AnnotationSelector) | アノテーション処理のためにビジターを受け入れます。 |
...
トリムマークは印刷されたページの角に配置され、ページをどこでトリミングするかを示します。
