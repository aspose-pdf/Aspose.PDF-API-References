---
title: "クラス CaretAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.CaretAnnotation クラス。Caret 注釈を表すクラスです。"
type: docs
weight: 1650
...
| 名前 | 説明 |
| --- | --- |
| [CaretAnnotation](caretannotation/#constructor)(Document) | Generator で使用するためのコンストラクタ。 |
| [CaretAnnotation](caretannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しい Caret 注釈を作成します。 |
...
| [Frame](../../aspose.pdf.annotations/caretannotation/frame/) { get; set; } | Caret の矩形を取得または設定します。 |
...
| [Symbol](../../aspose.pdf.annotations/caretannotation/symbol/) { get; set; } | Caret に関連付けられたシンボルを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/caretannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
