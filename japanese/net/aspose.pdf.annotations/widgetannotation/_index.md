---
title: "クラス WidgetAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.WidgetAnnotation クラス。ウィジェット注釈を表すクラス"
type: docs
weight: 2820
url: /ja/net/aspose.pdf.annotations/widgetannotation/
---
...
| 名前 | 説明 |
| --- | --- |
| [WidgetAnnotation](widgetannotation/)(Document) | 注釈を作成 (Generator 用) |
...
| [ExportToJson](../../aspose.pdf.annotations/widgetannotation/exporttojson/#exporttojson)(Stream, ExportFieldsToJsonOptions) | 指定された PDF フォームフィールドを JSON 形式でエクスポートし、結果を提供されたストリームに書き込みます。 |
| [ExportToJson](../../aspose.pdf.annotations/widgetannotation/exporttojson/#exporttojson_1)(string, ExportFieldsToJsonOptions) | 指定された PDF フォームフィールドを JSON 形式でエクスポートし、結果を指定されたファイルに書き込みます。 |
