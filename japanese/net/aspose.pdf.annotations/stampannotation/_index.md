---
title: "クラス StampAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.StampAnnotation クラス。ゴムスタンプ注釈を表します。このタイプの注釈は、ページにゴムスタンプで押されたかのように見えるテキストまたはグラフィックを表示します。"
type: docs
weight: 2710
...
| 名前 | 説明 |
| --- | --- |
| [StampAnnotation](stampannotation/#constructor)(Document) | コンストラクタ |
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しい Stamp 注釈を作成します。 |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | ゴムスタンプのアイコンを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | 注釈コレクションを閲覧するとき、[`AnnotationSelector`](../annotationselector/) ビジターを受け入れます。 |
...
次のコードスニペットは、最初の PDF ドキュメントページに 2 つのスタンプを追加する方法を示しています。入力ドキュメントは inFile から取得され、変更は outFile に保存されます。最初のスタンプはアイコン NotForPublicRelease を持ち、2 番目のスタンプは rubber.jpg の画像を使用します。
