...
description: Aspose.Pdf.Annotations.StampAnnotation クラス。ラバースタンプ注釈を表します。このタイプの注釈は、ページにラバースタンプで押されたように見えるテキストやグラフィックスを表示します。
type: docs
weight: 2610
url: /ja/net/aspose.pdf.annotations/stampannotation/
---
## StampAnnotation クラス

ラバースタンプ注釈を表します。このタイプの注釈は、ページにラバースタンプで押されたように見えるテキストやグラフィックスを表示します。
...
| 名前 | 説明 |
| --- | --- |
| [StampAnnotation](stampannotation/#constructor)(Document) | コンストラクター |
| [StampAnnotation](stampannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しいスタンプ注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/stampannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Icon](../../aspose.pdf.annotations/stampannotation/icon/) { get; set; } | ラバースタンプのアイコンを取得または設定します。 |
| [Image](../../aspose.pdf.annotations/stampannotation/image/) { get; set; } | 注釈の画像を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/stampannotation/accept/)(AnnotationSelector) | 注釈コレクションをブラウズする際に [`AnnotationSelector`](../annotationselector/) ビジターを受け入れます。 |
...
| [SetReviewState](../../aspose.pdf.annotations/markupannotation/setreviewstate/)(AnnotationState) | 注釈のレビュー状態を設定します。マークされた状態と未マークの状態は、レビュー状態モデルに属さないため無視されます。状態は、ターゲット注釈を作成したユーザーによって設定されます。値は、ターゲット注釈の Title プロパティから取得されます。状態は、状態および statemodel キーを持つ他のテキスト注釈に保存されます。 |
...
次のコードスニペットは、最初の PDF ドキュメントページに 2 つのスタンプを追加する方法を示しています。入力ドキュメントは inFile から取得され、変更は outFile に保存されます。最初のスタンプはアイコン NotForPublicRelease を持ち、2 番目は rubber.jpg からの画像を持っています。
