...
description: Aspose.Pdf.Annotations.RegistrationMarkAnnotation クラス。Registration Mark 注釈を表します
type: docs
weight: 2410
url: /ja/net/aspose.pdf.annotations/registrationmarkannotation/
---
## RegistrationMarkAnnotation クラス

Registration Mark 注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [RegistrationMarkAnnotation](registrationmarkannotation/)(Page, PrinterMarkSidePosition) | 指定されたページの指定された位置に `RegistrationMarkAnnotation` クラスの新しいインスタンスを初期化します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/registrationmarkannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | ページ上の登録マークの位置を取得または設定します。 |
...
| [ZIndex](../../aspose.pdf/baseparagraph/zindex/) { get; set; } | グラフの Z-オーダーを示す int 値を取得または設定します。ZIndex が大きいグラフは、ZIndex が小さいグラフの上に配置されます。ZIndex は負の値にすることができます。負の ZIndex を持つグラフは、ページ内のテキストの後ろに配置されます。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | 注釈処理のためのビジターを受け入れます。 |
...
登録マークは、印刷プロセス中に色の適切な整列を確保するために印刷プレートやスクリーンに追加されるシンボルです。
