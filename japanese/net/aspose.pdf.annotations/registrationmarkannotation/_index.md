---
title: "クラス RegistrationMarkAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.RegistrationMarkAnnotation クラス。レジストレーションマークアノテーションを表します。"
type: docs
weight: 2500
...
| [Position](../../aspose.pdf.annotations/registrationmarkannotation/position/) { get; set; } | ページ上のレジストレーションマークの位置を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/registrationmarkannotation/accept/)(AnnotationSelector) | アノテーション処理のためにビジターを受け入れます。 |
...
レジストレーションマークは、印刷プロセス中に色の正確な位置合わせを確保するために印刷版やスクリーンに追加されるシンボルです。
