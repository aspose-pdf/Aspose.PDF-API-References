---
title: "クラス WatermarkAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.WatermarkAnnotation クラス。Watermark 注釈オブジェクトを記述するクラス"
type: docs
weight: 2810
...
| override [AnnotationType](../../aspose.pdf.annotations/watermarkannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/watermarkannotation/accept/)(AnnotationSelector) | 注釈に対してビジターを適用します。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/watermarkannotation/changeafterresize/)(Matrix) | 基底クラスの定義を空の本体でオーバーライドします。 |
