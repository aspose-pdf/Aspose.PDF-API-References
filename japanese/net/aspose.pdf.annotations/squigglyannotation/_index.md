---
title: "クラス SquigglyAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.SquigglyAnnotation クラス。文書のテキストにジグザグの下線として表示されるスキューアノテーションを表します。"
type: docs
weight: 2700
...
文書のテキストに波状の下線として表示されるスキギィ注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | 指定されたページに新しいスキューアノテーションを作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
