...
description: Aspose.Pdf.Annotations.SquigglyAnnotation クラス。文書のテキストに鋸歯状の下線として表示されるスキグリー注釈を表します。
type: docs
weight: 2600
url: /ja/net/aspose.pdf.annotations/squigglyannotation/
---
## SquigglyAnnotation クラス

文書のテキストに鋸歯状の下線として表示されるスキグリー注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [SquigglyAnnotation](squigglyannotation/)(Page, Rectangle) | 指定されたページに新しいスキグリー注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/squigglyannotation/annotationtype/) { get; } | 注釈の種類を取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/squigglyannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターオブジェクトを受け入れます。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textmarkupannotation/changeafterresize/)(Matrix) | マトリックス変換に従って QuadPoints を更新します。 |
