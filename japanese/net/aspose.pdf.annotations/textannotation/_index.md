...
description: Aspose.Pdf.Annotations.TextAnnotation クラス。PDF ドキュメントのポイントに添付された付箋のテキスト注釈を表します。
type: docs
weight: 2650
url: /ja/net/aspose.pdf.annotations/textannotation/
---
## TextAnnotation クラス

PDF ドキュメントのポイントに添付された「付箋」のテキスト注釈を表します。
...
| 名前 | 説明 |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Generator で使用される注釈のコンストラクタ。 |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | 指定されたページに新しいテキスト注釈を作成します。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | 注釈の種類を取得します。 |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | 注釈を表示するために使用されるアイコンを取得または設定します。 |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | 注釈が最初に表示されるときに開いているべきかどうかを指定するフラグを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | 注釈を処理するためにビジターオブジェクトを受け入れます。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | 空の本体で基底クラスの定義をオーバーライドします。 |
