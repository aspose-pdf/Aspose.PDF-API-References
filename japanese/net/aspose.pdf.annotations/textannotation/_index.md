---
title: "クラス TextAnnotation"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Annotations.TextAnnotation クラス。PDF ドキュメントのポイントに添付された付箋ノートであるテキスト注釈を表します。"
type: docs
weight: 2750
...
| 名前 | 説明 |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Generator で使用される際の注釈のコンストラクタです。 |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | 注釈のタイプを取得します。 |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | 注釈の表示に使用されるアイコンを取得または設定します。 |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | 注釈が最初に開いた状態で表示されるかどうかを指定するフラグを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/textannotation/accept/)(AnnotationSelector) | アノテーションを処理するためのビジタオブジェクトを受け入れます。 |
| override [ChangeAfterResize](../../aspose.pdf.annotations/textannotation/changeafterresize/)(Matrix) | 基底クラスの定義を空の本体でオーバーライドします。 |
