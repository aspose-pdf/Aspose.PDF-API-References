---
title: "クラス ComboBoxField"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.ComboBoxField クラス。クラスはフォームのコンボボックスフィールドを表します"
type: docs
weight: 5120
...
| [ComboBoxField](comboboxfield/#constructor_1)(Document) | Generator と連携して使用する CombBox フィールドを作成します。 |
| [ComboBoxField](comboboxfield/#constructor_2)(Document, Rectangle) | Combobox フィールドのコンストラクタ。 |
| [ComboBoxField](comboboxfield/#constructor_3)(Page, Rectangle) | Combobox フィールドのコンストラクタ。 |
...
| [Editable](../../aspose.pdf.forms/comboboxfield/editable/) { get; set; } | フィールドの編集可能ステータスを取得または設定します。 |
...
| [SpellCheck](../../aspose.pdf.forms/comboboxfield/spellcheck/) { get; set; } | スペルチェックのアクティビティステータスを取得または設定します。 |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string) | 指定された名前で新しいオプションを追加します。 |
