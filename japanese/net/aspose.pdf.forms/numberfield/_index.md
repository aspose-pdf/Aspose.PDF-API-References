---
title: "クラス NumberField"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.NumberField クラス。指定された有効文字を持つテキストフィールド"
type: docs
weight: 5260
url: /ja/net/aspose.pdf.forms/numberfield/
---
## NumberField class
...
| 名前 | 説明 |
| --- | --- |
| [NumberField](numberfield/#constructor)() | `NumberField` クラスの新しいインスタンスを初期化します。 |
| [NumberField](numberfield/#constructor_1)(Document, Rectangle) | `NumberField` クラスの新しいインスタンスを初期化します。 |
| [NumberField](numberfield/#constructor_2)(Page, Rectangle) | `NumberField` クラスの新しいインスタンスを初期化します。 |
...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | 許可された文字を取得または設定します。 |
