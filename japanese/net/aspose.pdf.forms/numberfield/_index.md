...
| [AllowedChars](../../aspose.pdf.forms/numberfield/allowedchars/) { get; set; } | 許可されている文字を取得または設定します。 |
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | 注釈のテキストの垂直配置を取得または設定します。 |
