...
description: "Aspose.Pdf.Forms.PKCS1 クラス。PKCS1 標準に関する署名オブジェクトを表します。署名には RSA 暗号化アルゴリズムと SHA1 ダイジェスト方式が使用されます。"
type: docs
weight: 5290
...
PKCS#1 標準に関する署名オブジェクトを表します。署名には RSA 暗号化アルゴリズムと SHA-1 ダイジェスト方式が使用されます。
