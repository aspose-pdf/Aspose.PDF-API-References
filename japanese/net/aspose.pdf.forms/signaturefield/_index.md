...
| [Signature](../../aspose.pdf.forms/signaturefield/signature/) { get; } | 署名オブジェクトを取得します。このオブジェクトは公開鍵暗号標準に関する署名データを含みます。クラス[`PKCS1`](../pkcs1/)、[`PKCS7`](../pkcs7/) および [`PKCS7Detached`](../pkcs7detached/) は、サポートされているすべての署名オブジェクトのタイプを表します。 |
...
| [ExtractCertificate](../../aspose.pdf.forms/signaturefield/extractcertificate/)() | 単一の X.509 証明書を DER 形式のストリームとして抽出します。 |
| [ExtractCertificateObject](../../aspose.pdf.forms/signaturefield/extractcertificateobject/)() | 単一の X.509 証明書オブジェクトを抽出します。 |
