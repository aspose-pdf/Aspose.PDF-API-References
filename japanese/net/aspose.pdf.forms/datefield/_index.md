...
description: "Aspose.Pdf.Forms.DateField クラス。カレンダー表示付きの日付フィールド"
type: docs
weight: 5130
...
| [DateField](datefield/#constructor_1)(Document) | Generator と共に使用すべきコンストラクタです。 |
...
| [AddImage](../../aspose.pdf.forms/datefield/addimage/#addimage)(Image) | このフィールドへの画像追加は許可されていません。(2 メソッド) |
