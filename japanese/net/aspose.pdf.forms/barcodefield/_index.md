---
title: "BarcodeField クラス"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.BarcodeField クラス。クラスはバーコード フィールドを表します。"
type: docs
weight: 5070
url: /ja/net/aspose.pdf.forms/barcodefield/
---
## BarcodeField class
...
| 名前 | 説明 |
| --- | --- |
| [BarcodeField](barcodefield/#constructor)(Document, Rectangle) | `BarcodeField` クラスの新しいインスタンスを初期化します。 |
| [BarcodeField](barcodefield/#constructor_1)(Page, Rectangle) | `BarcodeField` クラスの新しいインスタンスを初期化します。 |
...
| [Caption](../../aspose.pdf.forms/barcodefield/caption/) { get; } | バーコード オブジェクトのキャプションを取得します。 |
...
| [ECC](../../aspose.pdf.forms/barcodefield/ecc/) { get; } | 誤り訂正係数を表す整数値を取得します。PDF417 の場合は 0 から 8 の範囲です。QRCode の場合は 0 から 3 の範囲で、0 は 'L'、1 は 'M'、2 は 'Q'、3 は 'H' を表します。 |
...
| [ForceCombs](../../aspose.pdf.forms/textboxfield/forcecombs/) { get; set; } | フィールドが間隔付きの位置に分割されているかを示すフラグを取得または設定します。 |
...
| [MaxLen](../../aspose.pdf.forms/textboxfield/maxlen/) { get; set; } | フィールド内のテキストの最大長さを取得または設定します。 |
| [Modified](../../aspose.pdf.annotations/annotation/modified/) { get; set; } | Annotation が最近変更された日時を取得または設定します。 |
| [Multiline](../../aspose.pdf.forms/textboxfield/multiline/) { get; set; } | フィールドのマルチライン フラグを取得または設定します。Multiline が true の場合、フィールドは複数行のテキストを含むことができます。 |
...
| [Resolution](../../aspose.pdf.forms/barcodefield/resolution/) { get; } | バーコード オブジェクトがレンダリングされる解像度（ドット毎インチ (dpi)）を取得します。 |
| [Scrollable](../../aspose.pdf.forms/textboxfield/scrollable/) { get; set; } | フィールドのスクロール可能フラグを取得または設定します。true の場合、フィールドはスクロールできます。 |
| [SpellCheck](../../aspose.pdf.forms/textboxfield/spellcheck/) { get; set; } | フィールドのスペルチェック フラグを取得または設定します。true の場合、フィールドはスペルチェックされます。 |
| [States](../../aspose.pdf.annotations/annotation/states/) { get; } | Annotation の外観辞書を取得します。 |
| [Symbology](../../aspose.pdf.forms/barcodefield/symbology/) { get; } | このアノテーションで使用するバーコードまたはグリフ技術を指定します。詳細は [`Symbology`](./symbology/) を参照してください。 |
...
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | アノテーションのテキスト垂直位置揃えを取得または設定します。 |
...
| [XSymHeight](../../aspose.pdf.forms/barcodefield/xsymheight/) { get; } | 2 つのバーコードモジュール間の垂直距離（ピクセル単位）を取得します。比率 XSymHeight/XSymWidth は整数でなければなりません。PDF417 の場合、許容される比率範囲は 1 から 4 です。QRCode および DataMatrix の場合、この比率は常に 1 です。 |
| [XSymWidth](../../aspose.pdf.forms/barcodefield/xsymwidth/) { get; } | 2 つのバーコードモジュール間の水平距離（ピクセル単位）を取得します。 |
...
| [AddImage](../../aspose.pdf.forms/textboxfield/addimage/)(Image) | フィールドのリソースに画像を追加し、描画します。 |
