...
| [RadioButtonField](radiobuttonfield/#constructor_1)(Page) | RadiouttonField のコンストラクタ |
...
| [NoToggleToOff](../../aspose.pdf.forms/radiobuttonfield/notoggletooff/) { get; set; } | ラジオボタンが選択された値を持たないことを許可するフラグを取得または設定します。`true` の場合、常に正確に1つのラジオボタンが選択されます。現在選択されているボタンを選択しても効果はありません。`false` の場合、選択されたボタンをクリックすると選択が解除され、ボタンが選択されていない状態になります。 |
| [OnActivated](../../aspose.pdf.annotations/widgetannotation/onactivated/) { get; set; } | Annotation がアクティブ化されたときに実行されるアクションです。 |
| override [Options](../../aspose.pdf.forms/radiobuttonfield/options/) { get; } | ラジオボタンのオプションコレクションを取得します。 |
...
| override [Selected](../../aspose.pdf.forms/radiobuttonfield/selected/) { get; set; } | 選択された項目のインデックスを取得または設定します。項目の番号は 1 から開始します。 |
...
| override [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption)(string) | radion ボタンにオプションを追加します。 |
| [AddOption](../../aspose.pdf.forms/radiobuttonfield/addoption/#addoption_1)(string, Rectangle) | 指定された矩形でラジオボタンのオプションを追加します。 |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string, string) | 指定されたエクスポート値と名前で新しいオプションを追加します。 |
...
| override [SetPosition](../../aspose.pdf.forms/radiobuttonfield/setposition/)(Point) | ラジオボタンのすべてのサブアイテムをページ上の指定位置に移動します。 |
