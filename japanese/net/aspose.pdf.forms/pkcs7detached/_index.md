---
title: "クラス PKCS7Detached"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.PKCS7Detached クラス。インターネット RFC 2315 PKCS 7 暗号メッセージ構文バージョン 1.5 の PKCS7 仕様に準拠した PKCS7 オブジェクトを表します。ドキュメントのバイト範囲に対する元の署名メッセージダイジェストが通常の PKCS7 SignedData フィールドに組み込まれます。PKCS7 SignedData フィールドにはデータがカプセル化されません。"
type: docs
weight: 5310
...
Internet RFC 2315、PKCS #7: Cryptographic Message Syntax、Version 1.5 の PKCS#7 仕様に準拠した PKCS#7 オブジェクトを表します。ドキュメントのバイト範囲に対する元の署名メッセージダイジェストが通常の PKCS#7 SignedData フィールドとして組み込まれます。PKCS#7 SignedData フィールドにはデータがカプセル化されません。
