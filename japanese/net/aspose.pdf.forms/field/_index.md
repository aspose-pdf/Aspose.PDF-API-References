...
description: "Aspose.Pdf.Forms.Field クラス。Acro フォームフィールドの基本クラスです。"
type: docs
weight: 5170
...
| static [FitIntoRectangle](../../aspose.pdf.forms/field/fitintorectangle/) { get; set; } | true の場合、フォントサイズが縮小され、テキストが指定された矩形に収まります。 |
| static [MaxFontSize](../../aspose.pdf.forms/field/maxfontsize/) { get; set; } | フィールド内容に使用できる最大フォントサイズ。サイズをチェックしない場合は -1 を指定します。 |
| static [MinFontSize](../../aspose.pdf.forms/field/minfontsize/) { get; set; } | フィールド内容に使用できる最小フォントサイズ。サイズをチェックしない場合は -1 を指定します。 |
...
| [CopyTo](../../aspose.pdf.forms/field/copyto/#copyto)(WidgetAnnotation[], int) | このフィールドのサブフィールドを、指定されたインデックスから配列にコピーします。 |
...
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson)(Stream) | フィールドの完全名が完全一致することに基づき、JSON ストリームから指定されたフィールドにデータをインポートします。 |
| [ImportValueFromJson](../../aspose.pdf.forms/field/importvaluefromjson/#importvaluefromjson_1)(Stream, string) | JSON ストリームから指定されたフィールドにデータをインポートします。マッチングには 'fieldFullNameInJSON' 変数で指定された完全名を使用します。 |
