---
title: "クラス RichTextBoxField"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.RichTextBoxField クラス。クラスはリッチテキストエディタコンポーネントを記述します"
type: docs
weight: 5350
url: /ja/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField class

リッチテキストエディタ コンポーネントを記述するクラスです。
...
| 名前 | 説明 |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | Rich Text Box フィールドのコンストラクタ。 |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | 書式設定されたリッチテキスト値（マークアップ付き）を取得または設定します。 |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | リッチテキストボックスの配置（ジャスティフィケーション）を取得または設定します。 |
...
| [RichTextValue](../../aspose.pdf.forms/richtextboxfield/richtextvalue/) { get; set; } | リッチテキスト値を取得または設定します。 |
...
| [Style](../../aspose.pdf.forms/richtextboxfield/style/) { get; set; } | リッチテキストフィールドのデフォルトスタイル文字列を取得または設定します。 |
...
| override [Value](../../aspose.pdf.forms/richtextboxfield/value/) { get; set; } | RichTextField の値。 |
