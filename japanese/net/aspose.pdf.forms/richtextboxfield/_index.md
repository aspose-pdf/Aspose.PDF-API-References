...
description: Aspose.Pdf.Forms.RichTextBoxField クラス。クラスはリッチテキストエディタコンポーネントを説明します
type: docs
weight: 5230
url: /ja/net/aspose.pdf.forms/richtextboxfield/
---
## RichTextBoxField クラス

クラスはリッチテキストエディタコンポーネントを説明します。
...
| 名前 | 説明 |
| --- | --- |
| [RichTextBoxField](richtextboxfield/)(Page, Rectangle) | リッチテキストボックスフィールドのコンストラクタ。 |
...
| [FormattedValue](../../aspose.pdf.forms/richtextboxfield/formattedvalue/) { get; set; } | マークアップ付きのフォーマットされたリッチテキスト値を取得または設定します。 |
...
| [Justify](../../aspose.pdf.forms/richtextboxfield/justify/) { get; set; } | リッチテキストボックスの整列を取得または設定します。 |
...
| [TextHorizontalAlignment](../../aspose.pdf.annotations/annotation/texthorizontalalignment/) { get; set; } | アノテーションのテキストの整列を取得または設定します。 |
| [TextVerticalAlignment](../../aspose.pdf.forms/textboxfield/textverticalalignment/) { get; set; } | アノテーションのテキストの垂直整列を取得または設定します。 |
