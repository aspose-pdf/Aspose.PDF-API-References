---
title: "クラス TextBoxField"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Forms.TextBoxField クラス。テキスト ボックス フィールドを表すクラスです。"
type: docs
weight: 5440
url: /ja/net/aspose.pdf.forms/textboxfield/
---
## TextBoxField class

テキストボックス フィールドを表すクラスです。
...
| 名前 | 説明 |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Generator と共に使用すべきコンストラクタです。 |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | TextBox フィールドのコンストラクタです。 |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | TextBox フィールドのコンストラクタです。 |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | TextBox フィールドのコンストラクタです。 |
