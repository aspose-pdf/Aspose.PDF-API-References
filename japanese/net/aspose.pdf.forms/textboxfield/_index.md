...
description: Aspose.Pdf.Forms.TextBoxField クラス。テキストボックスフィールドを表すクラス
type: docs
weight: 5320
...
| 名前 | 説明 |
| --- | --- |
| [TextBoxField](textboxfield/#constructor_1)(Document) | Generator と共に使用すべきコンストラクタ。 |
| [TextBoxField](textboxfield/#constructor_2)(Document, Rectangle) | TextBox フィールドのコンストラクタ。 |
| [TextBoxField](textboxfield/#constructor_3)(Page, Rectangle) | TextBox フィールドのコンストラクタ。 |
| [TextBoxField](textboxfield/#constructor_4)(Page, Rectangle[]) | TextBox フィールドのコンストラクタ。 |
