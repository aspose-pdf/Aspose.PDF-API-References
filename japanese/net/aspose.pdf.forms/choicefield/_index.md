...
description: Aspose.Pdf.Forms.ChoiceField クラス。選択フィールドの基本クラスを表します
type: docs
weight: 4990
...
| [ChoiceField](choicefield/#constructor_1)(Document, Rectangle) | ChoiceField のコンストラクタ。 |
| [ChoiceField](choicefield/#constructor_2)(Page, Rectangle) | ChoiceField のコンストラクタ。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Actions](../../aspose.pdf.annotations/widgetannotation/actions/) { get; } | アノテーションアクションを取得します。（2 つのプロパティ） |
...
| [Count](../../aspose.pdf.forms/field/count/) { get; } | このフィールド内のサブフィールドの数を取得します。（例えば、ラジオボタンフィールド内の項目数）。 |
...
| [Item](../../aspose.pdf.forms/field/item/) { get; } | サブフィールドの名前によってこのフィールドに含まれるサブフィールドを取得します。（2 つのインデクサ） |
| [MappingName](../../aspose.pdf.forms/field/mappingname/) { get; set; } | インタラクティブフォームフィールドデータをドキュメントからエクスポートする際に使用されるフィールドのマッピング名を取得または設定します。 |
...
| virtual [SelectedItems](../../aspose.pdf.forms/choicefield/selecteditems/) { get; set; } | 選択されたアイテムの配列を取得または設定します。マルチ選択リストの場合、配列には複数のアイテムが含まれます。単一選択リストの場合、単一のアイテムが含まれます。 |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption)(string) | 指定された名前の新しいオプションを追加します。 |
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/#addoption_1)(string, string) | 指定されたエクスポート値と名前の新しいオプションを追加します。 |
