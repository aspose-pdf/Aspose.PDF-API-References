...
description: Aspose.Pdf.Forms.FileSelectBoxField クラス。ファイル選択ボックス要素のフィールド
type: docs
weight: 5060
url: /ja/net/aspose.pdf.forms/fileselectboxfield/
---
## FileSelectBoxField クラス
...
| [IsInNewPage](../../aspose.pdf/baseparagraph/isinnewpage/) { get; set; } | この段落が新しいページで生成されるかどうかを示すブール値を取得または設定します。デフォルトは false です。(PDF 生成用) |
...
| [TabOrder](../../aspose.pdf.forms/field/taborder/) { get; set; } | フィールドのタブ順を取得または設定します。 |
