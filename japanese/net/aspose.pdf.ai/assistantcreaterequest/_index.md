---
title: "クラス AssistantCreateRequest"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "クラス Aspose.Pdf.AI.AssistantCreateRequest。アシスタント作成のリクエストオブジェクトです。"
type: docs
weight: 100
...
| 名前 | 説明 |
| --- | --- |
| [AssistantCreateRequest](assistantcreaterequest/)() | デフォルトコンストラクタです。 |
