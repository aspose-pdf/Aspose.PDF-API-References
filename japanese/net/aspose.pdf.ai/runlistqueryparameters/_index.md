---
title: "クラス RunListQueryParameters"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.AI.RunListQueryParameters クラス。実行一覧取得のためのクエリパラメータオブジェクトです。"
type: docs
weight: 1070
url: /ja/net/aspose.pdf.ai/runlistqueryparameters/
---
## RunListQueryParameters class

実行一覧取得のクエリパラメータオブジェクトです。
...
| 名前 | 説明 |
| --- | --- |
| [RunListQueryParameters](runlistqueryparameters/)() | デフォルトコンストラクタです。 |
...
| 名前 | 説明 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runlistqueryparameters/getqueryparameters/)() | 実行一覧取得のクエリパラメータを取得します。 |
