...
description: Aspose.Pdf.AI.RunListQueryParameters クラス。実行をリストするためのクエリパラメータオブジェクト
type: docs
weight: 990
url: /ja/net/aspose.pdf.ai/runlistqueryparameters/
---
## RunListQueryParameters クラス

実行をリストするためのクエリパラメータオブジェクト。
...
| 名前 | 説明 |
| --- | --- |
| [RunListQueryParameters](runlistqueryparameters/)() | デフォルトコンストラクタ。 |
...
| 名前 | 説明 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runlistqueryparameters/getqueryparameters/)() | 実行をリストするためのクエリパラメータを取得します。 |
