---
title: "クラス AssistantListResponse"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.AI.AssistantListResponse クラス。アシスタントの応答リストを含むレスポンスを表します。"
type: docs
weight: 120
...
| 名前 | 説明 |
| --- | --- |
| [AssistantListResponse](assistantlistresponse/)() | デフォルトコンストラクタです。 |
