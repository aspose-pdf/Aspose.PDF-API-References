---
title: "クラス BaseListQueryParameters"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.AI.BaseListQueryParameters クラス。オブジェクト一覧取得のための基本クエリパラメータです。"
type: docs
weight: 160
...
| 名前 | 説明 |
| --- | --- |
| [BaseListQueryParameters](baselistqueryparameters/)() | デフォルトコンストラクタです。 |
