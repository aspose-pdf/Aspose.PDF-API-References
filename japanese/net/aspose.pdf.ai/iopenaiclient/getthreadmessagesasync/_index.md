...
description: IOpenAIClient メソッド。特定のスレッドのメッセージのリストを非同期で取得します
type: docs
weight: 290
url: /ja/net/aspose.pdf.ai/iopenaiclient/getthreadmessagesasync/
---
## IOpenAIClient.GetThreadMessagesAsync メソッド
