...
description: IOpenAIClient メソッド。新しいベクターストアを作成し、非同期で完了するのを待ちます
type: docs
weight: 90
url: /ja/net/aspose.pdf.ai/iopenaiclient/createvectorstoreandwaittocompleteasync/
---
## IOpenAIClient.CreateVectorStoreAndWaitToCompleteAsync メソッド
