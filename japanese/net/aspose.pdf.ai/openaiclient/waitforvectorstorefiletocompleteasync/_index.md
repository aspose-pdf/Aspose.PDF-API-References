...
description: OpenAIClient メソッド。特定のベクターストアファイルが非同期で完了するのを待ちます
type: docs
weight: 490
url: /ja/net/aspose.pdf.ai/openaiclient/waitforvectorstorefiletocompleteasync/
---
## OpenAIClient.WaitForVectorStoreFileToCompleteAsync メソッド
