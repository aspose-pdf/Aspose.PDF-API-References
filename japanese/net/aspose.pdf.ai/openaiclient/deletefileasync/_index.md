...
description: OpenAIClient メソッド。特定のファイルを非同期で削除します
type: docs
weight: 140
url: /ja/net/aspose.pdf.ai/openaiclient/deletefileasync/
---
## OpenAIClient.DeleteFileAsync メソッド
...
非同期操作を表すタスク。タスクの結果には、削除操作のステータスが含まれます。
