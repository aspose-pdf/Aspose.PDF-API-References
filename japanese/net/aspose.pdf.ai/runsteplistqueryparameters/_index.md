---
title: "クラス RunStepListQueryParameters"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.AI.RunStepListQueryParameters クラス。実行ステップの一覧取得用クエリパラメータオブジェクトです。"
type: docs
weight: 1120
...
| 名前 | 説明 |
| --- | --- |
| [RunStepListQueryParameters](runsteplistqueryparameters/)() | デフォルトコンストラクタです。 |
...
| 名前 | 説明 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/runsteplistqueryparameters/getqueryparameters/)() | 実行ステップの一覧取得用クエリパラメータを取得します。 |
