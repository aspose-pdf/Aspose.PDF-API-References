---
title: "クラス RunListResponse"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.AI.RunListResponse クラス。ランデータを含むリストレスポンスを表します。"
type: docs
weight: 1080
url: /ja/net/aspose.pdf.ai/runlistresponse/
---
## RunListResponse class

実行データを含むリストレスポンスを表します。
...
| 名前 | 説明 |
| --- | --- |
| [RunListResponse](runlistresponse/)() | デフォルトコンストラクタです。 |
