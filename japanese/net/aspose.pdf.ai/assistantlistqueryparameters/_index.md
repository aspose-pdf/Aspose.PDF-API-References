...
description: Aspose.Pdf.AI.AssistantListQueryParameters クラス。アシスタントをリストするためのクエリパラメータオブジェクトを表します。
type: docs
weight: 110
url: /ja/net/aspose.pdf.ai/assistantlistqueryparameters/
---
## AssistantListQueryParameters クラス

アシスタントをリストするためのクエリパラメータオブジェクトを表します。
...
| 名前 | 説明 |
| --- | --- |
| [AssistantListQueryParameters](assistantlistqueryparameters/)() | デフォルトコンストラクタ。 |
...
| 名前 | 説明 |
| --- | --- |
| [GetQueryParameters](../../aspose.pdf.ai/assistantlistqueryparameters/getqueryparameters/)() | アシスタントをリストするためのクエリパラメータを取得します。 |
