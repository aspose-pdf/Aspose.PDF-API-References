...
description: Aspose.Pdf.LogicalStructure.TableTHElement クラス。テーブルの論理構造における TH 構造要素を表します。
type: docs
weight: 6830
url: /ja/net/aspose.pdf.logicalstructure/tablethelement/
---
## TableTHElement クラス

テーブルの論理構造における TH 構造要素を表します。
...
| [IsWordWrapped](../../aspose.pdf.logicalstructure/tablecellelement/iswordwrapped/) { get; set; } | セルのテキストが折り返されるかどうかを取得または設定します。 |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 構造から要素を削除し、親オブジェクトからの参照、子オブジェクトからの参照、およびドキュメントからの対応するオブジェクトを削除します。削除されたオブジェクトの子オブジェクトを元の親の子オブジェクトコレクションに挿入します。 |
...
* クラス [TableCellElement](../tablecellelement/)
