---
title: "クラス WarichuChildElement"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.LogicalStructure.WarichuChildElement クラス。論理構造における Warichu の子要素の基底クラスを表します。"
type: docs
weight: 7000
...
論理構造内の割注 (Warichu) の子要素の基底クラスを表します。
