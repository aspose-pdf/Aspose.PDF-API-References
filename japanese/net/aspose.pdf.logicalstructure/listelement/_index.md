---
title: "クラス ListElement"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.LogicalStructure.ListElement クラス。論理構造内のリスト構造要素を表します。"
type: docs
weight: 6600
url: /ja/net/aspose.pdf.logicalstructure/listelement/
---
## ListElement class

論理構造におけるリスト構造要素を表します。
