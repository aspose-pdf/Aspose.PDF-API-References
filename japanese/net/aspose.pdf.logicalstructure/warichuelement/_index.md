...
description: Aspose.Pdf.LogicalStructure.WarichuElement クラス。論理構造における Warichu 構造要素を表します。
type: docs
weight: 6870
url: /ja/net/aspose.pdf.logicalstructure/warichuelement/
---
## WarichuElement クラス

論理構造における Warichu 構造要素を表します。
