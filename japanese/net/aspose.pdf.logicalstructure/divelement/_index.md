...
description: Aspose.Pdf.LogicalStructure.DivElement クラス。論理構造における Div 構造要素を表します。
type: docs
weight: 6300
url: /ja/net/aspose.pdf.logicalstructure/divelement/
---
## DivElement クラス

論理構造における Div 構造要素を表します。
...
* クラス [GroupingElement](../groupingelement/)
