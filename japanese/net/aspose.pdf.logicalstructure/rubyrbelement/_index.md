...
description: Aspose.Pdf.LogicalStructure.RubyRBElement クラス。Ruby の論理構造における RB 構造要素を表します。
type: docs
weight: 6610
url: /ja/net/aspose.pdf.logicalstructure/rubyrbelement/
---
## RubyRBElement クラス

Ruby の論理構造における RB 構造要素を表します。
