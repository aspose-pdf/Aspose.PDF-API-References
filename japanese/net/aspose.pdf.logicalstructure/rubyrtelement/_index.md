...
description: Aspose.Pdf.LogicalStructure.RubyRTElement クラス。Ruby の論理構造における RT 構造要素を表します。
type: docs
weight: 6630
url: /ja/net/aspose.pdf.logicalstructure/rubyrtelement/
---
## RubyRTElement クラス

Ruby の論理構造における RT 構造要素を表します。
...
* クラス [RubyChildElement](../rubychildelement/)
