...
description: Aspose.Pdf.LogicalStructure.NonStructElement クラス。論理構造における NonStruct 構造要素を表します。
type: docs
weight: 6510
url: /ja/net/aspose.pdf.logicalstructure/nonstructelement/
---
## NonStructElement クラス

論理構造における NonStruct 構造要素を表します。
