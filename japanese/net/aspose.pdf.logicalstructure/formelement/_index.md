...
description: Aspose.Pdf.LogicalStructure.FormElement クラス。論理構造におけるフォーム構造要素を表します
type: docs
weight: 6350
url: /ja/net/aspose.pdf.logicalstructure/formelement/
---
## FormElement クラス

論理構造におけるフォーム構造要素を表します。
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 構造から要素を削除し、親オブジェクトからの参照、子オブジェクトからの参照、およびドキュメントからの対応するオブジェクトを削除します。削除されたオブジェクトの子オブジェクトをその元の親の子オブジェクトコレクションに挿入します。 |
