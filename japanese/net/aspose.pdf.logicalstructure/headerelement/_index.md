...
description: Aspose.Pdf.LogicalStructure.HeaderElement クラス。論理構造におけるヘッダー構造要素を表します。
type: docs
weight: 6380
url: /ja/net/aspose.pdf.logicalstructure/headerelement/
---
## HeaderElement クラス

論理構造におけるヘッダー構造要素を表します。
...
* クラス [BLSTextElement](../blstextelement/)
