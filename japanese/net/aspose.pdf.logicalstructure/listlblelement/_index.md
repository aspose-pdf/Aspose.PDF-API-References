...
description: Aspose.Pdf.LogicalStructure.ListLblElement クラス。リストの論理構造における Lbl 構造要素を表します
type: docs
weight: 6490
url: /ja/net/aspose.pdf.logicalstructure/listlblelement/
---
## ListLblElement クラス

リストの論理構造における Lbl 構造要素を表します。
