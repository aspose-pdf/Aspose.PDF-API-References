...
description: Aspose.Pdf.LogicalStructure.TableTFootElement クラス。テーブルの論理構造における TFoot 構造要素を表します。
type: docs
weight: 6820
url: /ja/net/aspose.pdf.logicalstructure/tabletfootelement/
---
## TableTFootElement クラス

テーブルの論理構造における TFoot 構造要素を表します。
...
* クラス [TableRowCollectionElement](../tablerowcollectionelement/)
