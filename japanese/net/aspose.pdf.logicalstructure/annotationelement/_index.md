---
title: "クラス AnnotationElement"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.LogicalStructure.AnnotationElement クラス。論理構造内のアノテーション構造要素の基底クラスを表します。"
type: docs
weight: 6330
url: /ja/net/aspose.pdf.logicalstructure/annotationelement/
---
## AnnotationElement class

論理構造内の注釈構造要素の基底クラスを表します。
