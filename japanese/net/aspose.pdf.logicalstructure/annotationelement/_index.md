...
description: Aspose.Pdf.LogicalStructure.AnnotationElement クラス。論理構造における注釈構造要素の基本クラスを表します。
type: docs
weight: 6190
url: /ja/net/aspose.pdf.logicalstructure/annotationelement/
---
## AnnotationElement クラス

論理構造における注釈構造要素の基本クラスを表します。
...
| [AlternateDescriptions](../../aspose.pdf.logicalstructure/annotationelement/alternatedescriptions/) { get; set; } | 注釈の代替説明を取得または設定します。注釈のために表示されるテキスト、またはこのタイプの注釈がテキストを表示しない場合は、注釈の内容の人間が読み取れる形式の代替説明です。 |
