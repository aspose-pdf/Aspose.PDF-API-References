---
title: "クラス BLSTextElement"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.LogicalStructure.BLSTextElement クラス。論理構造内のブロックレベルテキスト構造要素の基底クラスを表します。"
type: docs
weight: 6390
url: /ja/net/aspose.pdf.logicalstructure/blstextelement/
---
## BLSTextElement class

論理構造内のブロックレベルテキスト構造要素の基底クラスを表します。
...
| [StructureTextState](../../aspose.pdf.logicalstructure/blstextelement/structuretextstate/) { get; } | 現在の要素の StructureTextState オブジェクトを取得します。 |
