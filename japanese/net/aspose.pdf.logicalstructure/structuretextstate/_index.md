...
| 名前 | 説明 |
| --- | --- |
| [BackgroundColor](../../aspose.pdf.logicalstructure/structuretextstate/backgroundcolor/) { get; set; } | テキストの背景色を取得または設定します。 |
| [CharacterSpacing](../../aspose.pdf.logicalstructure/structuretextstate/characterspacing/) { get; set; } | テキストの文字間隔を取得または設定します。 |
| [Font](../../aspose.pdf.logicalstructure/structuretextstate/font/) { get; set; } | テキストのフォントを取得または設定します。 |
