...
description: Aspose.Pdf.LogicalStructure.NoteElement クラス。論理構造におけるノート構造要素を表します。
type: docs
weight: 6520
url: /ja/net/aspose.pdf.logicalstructure/noteelement/
---
## NoteElement クラス

論理構造におけるノート構造要素を表します。
...
| [StructureTextState](../../aspose.pdf.logicalstructure/ilstextelement/structuretextstate/) { get; } | 現在の要素の StructureTextState オブジェクトを取得します。 |
...
| [RemoveAndMoveItsChildObjectsToItsParent](../../aspose.pdf.logicalstructure/structureelement/removeandmoveitschildobjectstoitsparent/)(bool) | 構造から要素を削除し、親オブジェクトからの参照、子オブジェクトからの参照、およびドキュメントからの対応するオブジェクトを削除します。削除されたオブジェクトの子オブジェクトをその以前の親の子オブジェクトコレクションに挿入し、削除されたオブジェクトのインデックスから開始します。 |
...
* クラス [ILSTextElement](../ilstextelement/)
