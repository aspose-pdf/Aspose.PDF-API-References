...
description: Aspose.Pdf.LogicalStructure.ListLBodyElement クラス。リストの論理構造における LBody 構造要素を表します。
type: docs
weight: 6470
url: /ja/net/aspose.pdf.logicalstructure/listlbodyelement/
---
## ListLBodyElement クラス

リストの論理構造における LBody 構造要素を表します。
...
* クラス [ListChildElement](../listchildelement/)
