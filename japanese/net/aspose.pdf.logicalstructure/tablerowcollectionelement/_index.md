---
title: "クラス TableRowCollectionElement"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.LogicalStructure.TableRowCollectionElement クラス。論理構造におけるテーブルのヘッド、ボディ、フットの子要素の基底クラスを表します。"
type: docs
weight: 6930
...
論理構造内のテーブルヘッド、ボディ、フットの子要素の基底クラスを表します。
