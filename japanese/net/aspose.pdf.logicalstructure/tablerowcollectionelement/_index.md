...
description: Aspose.Pdf.LogicalStructure.TableRowCollectionElement クラス。論理構造におけるテーブルのヘッダー、ボディ、およびフットの子要素のための基本クラスを表します。
type: docs
weight: 6790
url: /ja/net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---
## TableRowCollectionElement クラス

論理構造におけるテーブルのヘッダー、ボディ、およびフットの子要素のための基本クラスを表します。
...
| virtual [CreateTR](../../aspose.pdf.logicalstructure/tablerowcollectionelement/createtr/)() | [`TableTRElement`](../tabletrelement/) を作成し、現在のテーブルに追加します。 |
