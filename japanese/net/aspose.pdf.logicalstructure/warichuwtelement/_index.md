...
description: Aspose.Pdf.LogicalStructure.WarichuWTElement クラス。Warichu の論理構造における WT 構造要素を表します。
type: docs
weight: 6890
url: /ja/net/aspose.pdf.logicalstructure/warichuwtelement/
---
## WarichuWTElement クラス

Warichu の論理構造における WT 構造要素を表します。
...
* クラス [WarichuChildElement](../warichuchildelement/)
