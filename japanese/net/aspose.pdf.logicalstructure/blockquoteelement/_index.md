...
description: Aspose.Pdf.LogicalStructure.BlockQuoteElement クラス。論理構造における BlockQuote 構造要素を表します。
type: docs
weight: 6270
url: /ja/net/aspose.pdf.logicalstructure/blockquoteelement/
---
## BlockQuoteElement クラス

論理構造における BlockQuote 構造要素を表します。
