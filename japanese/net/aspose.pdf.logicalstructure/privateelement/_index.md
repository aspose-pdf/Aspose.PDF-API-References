...
description: Aspose.Pdf.LogicalStructure.PrivateElement クラス。論理構造におけるプライベート構造要素を表します
type: docs
weight: 6560
url: /ja/net/aspose.pdf.logicalstructure/privateelement/
---
## PrivateElement クラス

論理構造におけるプライベート構造要素を表します。
