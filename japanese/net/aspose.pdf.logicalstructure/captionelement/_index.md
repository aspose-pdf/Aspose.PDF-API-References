...
description: Aspose.Pdf.LogicalStructure.CaptionElement クラス。論理構造におけるキャプション構造要素を表します。
type: docs
weight: 6280
url: /ja/net/aspose.pdf.logicalstructure/captionelement/
---
## CaptionElement クラス

論理構造におけるキャプション構造要素を表します。
