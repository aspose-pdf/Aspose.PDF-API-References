...
description: Aspose.Pdf.LogicalStructure.BLSElement クラス。論理構造におけるブロックレベル構造要素の基底クラスを表します。
type: docs
weight: 6240
url: /ja/net/aspose.pdf.logicalstructure/blselement/
---
## BLSElement クラス

論理構造におけるブロックレベル構造要素の基底クラスを表します。
