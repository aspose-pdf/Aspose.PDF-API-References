...
description: Aspose.Pdf.LogicalStructure.TOCIElement クラス。論理構造における TOCI 構造要素を表します
type: docs
weight: 6750
url: /ja/net/aspose.pdf.logicalstructure/tocielement/
---
## TOCIElement クラス

論理構造における TOCI 構造要素を表します。
