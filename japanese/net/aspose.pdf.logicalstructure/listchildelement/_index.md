...
description: Aspose.Pdf.LogicalStructure.ListChildElement クラス。論理構造におけるリストの子要素のための基本クラスを表します。
type: docs
weight: 6450
url: /ja/net/aspose.pdf.logicalstructure/listchildelement/
---
## ListChildElement クラス

論理構造におけるリストの子要素のための基本クラスを表します。
