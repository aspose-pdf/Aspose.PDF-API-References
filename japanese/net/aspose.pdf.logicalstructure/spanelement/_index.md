...
description: Aspose.Pdf.LogicalStructure.SpanElement クラス。論理構造における Span 構造要素を表します
type: docs
weight: 6650
url: /ja/net/aspose.pdf.logicalstructure/spanelement/
---
## SpanElement クラス

論理構造における Span 構造要素を表します。
