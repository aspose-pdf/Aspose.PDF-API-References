...
description: Aspose.Pdf.LogicalStructure.WarichuWPElement クラス。Warichu の論理構造における WP 構造要素を表します。
type: docs
weight: 6880
url: /ja/net/aspose.pdf.logicalstructure/warichuwpelement/
---
## WarichuWPElement クラス

Warichu の論理構造における WP 構造要素を表します。
