...
description: Aspose.Pdf.LogicalStructure.IllustrationElement クラス。論理構造におけるイラスト構造要素の基本クラスを表します。
type: docs
weight: 6420
url: /ja/net/aspose.pdf.logicalstructure/illustrationelement/
---
## IllustrationElement クラス

論理構造におけるイラスト構造要素の基本クラスを表します。
...
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage)(string, double) | 現在のイラスト要素に画像を追加します。 |
| virtual [SetImage](../../aspose.pdf.logicalstructure/illustrationelement/setimage/#setimage_1)(string, double, double) | 現在のイラスト要素に画像を追加します。 |
