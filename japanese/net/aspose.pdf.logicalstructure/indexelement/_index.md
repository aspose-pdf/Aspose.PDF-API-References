...
description: Aspose.Pdf.LogicalStructure.IndexElement クラス。論理構造におけるインデックス構造要素を表します。
type: docs
weight: 6430
url: /ja/net/aspose.pdf.logicalstructure/indexelement/
---
## IndexElement クラス

論理構造におけるインデックス構造要素を表します。
