...
description: Aspose.Pdf.LogicalStructure.DocumentElement クラス。論理構造におけるドキュメント構造要素を表します。
type: docs
weight: 6310
url: /ja/net/aspose.pdf.logicalstructure/documentelement/
---
## DocumentElement クラス

論理構造におけるドキュメント構造要素を表します。
