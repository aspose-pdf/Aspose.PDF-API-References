...
description: Aspose.Pdf.LogicalStructure.RubyRPElement クラス。Ruby の論理構造における RP 構造要素を表します。
type: docs
weight: 6620
url: /ja/net/aspose.pdf.logicalstructure/rubyrpelement/
---
## RubyRPElement クラス

Ruby の論理構造における RP 構造要素を表します。
