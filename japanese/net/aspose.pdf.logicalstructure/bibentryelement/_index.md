...
description: Aspose.Pdf.LogicalStructure.BibEntryElement クラス。論理構造における BibEntry 構造要素を表します
type: docs
weight: 6260
url: /ja/net/aspose.pdf.logicalstructure/bibentryelement/
---
## BibEntryElement クラス

論理構造における BibEntry 構造要素を表します。
