...
description: Aspose.Pdf.LogicalStructure.SectElement クラス。論理構造における Sect 構造要素を表します。
type: docs
weight: 6640
url: /ja/net/aspose.pdf.logicalstructure/sectelement/
---
## SectElement クラス

論理構造における Sect 構造要素を表します。
