...
description: Aspose.Pdf.LogicalStructure.TableTBodyElement クラス。テーブルの論理構造における TBody 構造要素を表します。
type: docs
weight: 6800
url: /ja/net/aspose.pdf.logicalstructure/tabletbodyelement/
---
## TableTBodyElement クラス

テーブルの論理構造における TBody 構造要素を表します。
