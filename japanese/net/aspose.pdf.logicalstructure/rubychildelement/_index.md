...
description: Aspose.Pdf.LogicalStructure.RubyChildElement クラス。論理構造におけるルビーの子要素の基本クラスを表します
type: docs
weight: 6590
url: /ja/net/aspose.pdf.logicalstructure/rubychildelement/
---
## RubyChildElement クラス

論理構造におけるルビーの子要素の基本クラスを表します。
