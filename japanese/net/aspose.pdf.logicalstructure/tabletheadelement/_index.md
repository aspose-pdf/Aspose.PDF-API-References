...
description: Aspose.Pdf.LogicalStructure.TableTHeadElement クラス。テーブルの論理構造における THead 構造要素を表します。
type: docs
weight: 6840
url: /ja/net/aspose.pdf.logicalstructure/tabletheadelement/
---
## TableTHeadElement クラス

テーブルの論理構造における THead 構造要素を表します。
