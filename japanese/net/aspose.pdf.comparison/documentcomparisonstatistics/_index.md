---
title: "クラス DocumentComparisonStatistics"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Comparison.DocumentComparisonStatistics クラス。ドキュメント比較統計クラスを表します。"
type: docs
weight: 3280
url: /ja/net/aspose.pdf.comparison/documentcomparisonstatistics/
---
...
| 名前 | 説明 |
| --- | --- |
| [DocumentComparisonStatistics](documentcomparisonstatistics/)() | デフォルトコンストラクタです。 |
...
| [PagesStatistics](../../aspose.pdf.comparison/documentcomparisonstatistics/pagesstatistics/) { get; } | ページ統計のリストを取得および設定します。 |
