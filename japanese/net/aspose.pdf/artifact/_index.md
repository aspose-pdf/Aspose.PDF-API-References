...
description: "Aspose.Pdf.Artifact クラス。クラスは PDF Artifact オブジェクトを表します"
type: docs
weight: 2870
...
| 名前 | 説明 |
| --- | --- |
| [Artifact](artifact/#constructor)(ArtifactType, ArtifactSubtype) | 指定されたタイプとサブタイプを持つアーティファクトのコンストラクタ |
| [Artifact](artifact/#constructor_1)(string, string) | 指定されたタイプとサブタイプを持つアーティファクトのコンストラクタ |
...
| enum [ArtifactType](../../aspose.pdf/artifact.artifacttype) | 可能なアーティファクトタイプの列挙です。 |
