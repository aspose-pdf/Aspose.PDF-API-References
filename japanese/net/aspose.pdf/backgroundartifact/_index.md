---
title: "クラス BackgroundArtifact"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.BackgroundArtifact クラス。クラスは背景アーティファクトを記述します。このアーティファクトを使用するとページの背景を設定できます。"
type: docs
weight: 2920
url: /ja/net/aspose.pdf/backgroundartifact/
---
## BackgroundArtifact class

クラスは背景アーティファクトを記述します。このアーティファクトは Page の背景を設定できるようにします。
...
| 名前 | 説明 |
| --- | --- |
| [BackgroundArtifact](backgroundartifact/)() | BackgroundArtifact オブジェクトを初期化します。 |
...
| [BackgroundColor](../../aspose.pdf/backgroundartifact/backgroundcolor/) { get; set; } | 背景アーティファクトの背景色を取得または設定します。 |
| [BackgroundImage](../../aspose.pdf/backgroundartifact/backgroundimage/) { get; set; } | 背景アーティファクトの背景画像を取得または設定します。 |
