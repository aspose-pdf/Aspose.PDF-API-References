...
description: Aspose.Pdf.BackgroundArtifact クラス。クラスは背景アーティファクトを説明します。このアーティファクトはページの背景を設定することを可能にします。
type: docs
weight: 2810
url: /ja/net/aspose.pdf/backgroundartifact/
---
## BackgroundArtifact クラス

クラスは背景アーティファクトを説明します。このアーティファクトはページの背景を設定することを可能にします。
