---
title: "クラス DjvuLoadOptions"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.DjvuLoadOptions クラス。DJVU のロードオプションを説明します。"
type: docs
weight: 3860
...
| 名前 | 説明 |
| --- | --- |
| [DjvuLoadOptions](djvuloadoptions/)() | デフォルトコンストラクタです。 |
