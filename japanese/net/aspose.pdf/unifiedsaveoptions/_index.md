---
title: "クラス UnifiedSaveOptions"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.UnifiedSaveOptions クラス。このクラスは、統一された内部 Document モデルを使用した統一変換方式で保存するための保存オプションを表します。"
type: docs
weight: 11330
...
このクラスは、統一された内部ドキュメントモデルを使用した統一変換方式で保存するための保存オプションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [UnifiedSaveOptions](unifiedsaveoptions/)() | デフォルトコンストラクタです。 |
