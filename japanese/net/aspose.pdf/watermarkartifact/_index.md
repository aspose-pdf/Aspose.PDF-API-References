---
title: "クラス WatermarkArtifact"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.WatermarkArtifact クラス。クラスは透かしアーティファクトを記述します。これは次のために使用できます"
type: docs
weight: 11500
...
| 名前 | 説明 |
| --- | --- |
| [WatermarkArtifact](watermarkartifact/)() | Watermark アーティファクトのインスタンスを作成します。 |
