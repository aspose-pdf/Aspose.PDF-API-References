---
title: "クラス HeaderArtifact"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.HeaderArtifact クラス。クラスはヘッダーアーティファクトを説明します。このアーティファクトはページのヘッダーを設定するために使用できます。"
type: docs
weight: 5540
...
ヘッダーアーティファクトを記述するクラスです。このアーティファクトはページのヘッディングを設定するために使用できます。
...
| 名前 | 説明 |
| --- | --- |
| [HeaderArtifact](headerartifact/)() | Header Artifact のインスタンスを作成します。 |
