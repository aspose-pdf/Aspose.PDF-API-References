---
title: "クラス BatesNArtifact"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.BatesNArtifact クラス。Bates 番号付けアーティファクトを表すクラスです。"
type: docs
weight: 2960
...
クラスは Bates Numbering アーティファクトを記述します。
...
| 名前 | 説明 |
| --- | --- |
| [BatesNArtifact](batesnartifact/)() | `BatesNArtifact` クラスの新しいインスタンスを初期化します。このコンストラクタは内部用で、デフォルト値を持つヘッダーアーティファクトのインスタンスを作成します。 |
...
| [EndPage](../../aspose.pdf/paginationartifact/endpage/) { get; set; } | アーティファクトの終了ページ番号を取得または設定します。値は 0 以上でなければなりません。0 未満の値が設定された場合、0 に調整されます。デフォルト値の 0 は終了ページの境界がないことを意味します。 |
...
| [NumberOfDigits](../../aspose.pdf/batesnartifact/numberofdigits/) { get; set; } | Bates 番号付けの桁数を取得または設定します。値は 3 から 15 の範囲（含む）でなければなりません。3 未満の値が設定された場合は 3 に、15 を超える値が設定された場合は 15 に調整されます。デフォルト値は 6 です。 |
...
| [Prefix](../../aspose.pdf/batesnartifact/prefix/) { get; set; } | Bates 番号に追加するプレフィックスを取得または設定します。 |
...
| [StartPage](../../aspose.pdf/paginationartifact/startpage/) { get; set; } | アーティファクトの開始ページ番号を取得または設定します。値は 1 以上でなければなりません。1 未満の値が設定された場合、1 に調整されます。 |
...
| [Suffix](../../aspose.pdf/batesnartifact/suffix/) { get; set; } | Bates 番号に追加するサフィックスを取得または設定します。 |
