---
title: "クラス PsSaveOptions"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.PsSaveOptions クラス。PS（PostScript）または EPS 形式へのエクスポート用の保存オプションです。"
type: docs
weight: 9890
...
PS（PostScript）または EPS 形式へのエクスポート用保存オプションです。
...
| [EmbedFontAs](../../aspose.pdf/pssaveoptions/embedfontas/) { get; set; } | 結果の PS ドキュメントにフォントを埋め込む形式を取得または設定します。 |
