...
description: SetRGBColorStroke メソッド。オペレーターを処理するためのビジターオブジェクトを受け入れます
type: docs
weight: 50
url: /ja/net/aspose.pdf.operators/setrgbcolorstroke/accept/
---
## SetRGBColorStroke.Accept メソッド
