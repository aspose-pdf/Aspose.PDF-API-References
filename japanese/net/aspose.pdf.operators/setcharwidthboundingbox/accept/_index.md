...
description: SetCharWidthBoundingBox メソッド。オペレーターを処理するためのビジターオブジェクトを受け入れます
type: docs
weight: 80
url: /ja/net/aspose.pdf.operators/setcharwidthboundingbox/accept/
---
## SetCharWidthBoundingBox.Accept メソッド
