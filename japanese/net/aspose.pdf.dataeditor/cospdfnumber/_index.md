...
| 名前 | 説明 |
| --- | --- |
| [CosPdfNumber](cospdfnumber/#constructor)() | `CosPdfNumber` クラスの新しいインスタンスを初期化します。 |
| [CosPdfNumber](cospdfnumber/#constructor_1)(double) | `CosPdfNumber` クラスの新しいインスタンスを初期化します。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Value](../../aspose.pdf.dataeditor/cospdfnumber/value/) { get; } | 値を取得します。 |
