---
title: "クラス SplitOptions"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Plugins.SplitOptions クラス。Splitter プラグインの分割オプションを表します。"
type: docs
weight: 9420
url: /ja/net/aspose.pdf.plugins/splitoptions/
---
## SplitOptions class

`[`Splitter`](../splitter/)` プラグインの分割オプションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [SplitOptions](splitoptions/)() | デフォルトコンストラクタです。 |
