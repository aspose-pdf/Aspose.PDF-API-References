---
title: "クラス PdfAValidateOptions"
second_title: "Aspose.PDF for .NET API リファレンス"
description: "Aspose.Pdf.Plugins.PdfAValidateOptions クラス。PdfAConverter プラグインを使用して PDF 文書の PDF/A 準拠性を検証するオプションを表します。"
type: docs
weight: 9180
...
[`PdfAConverter`](../pdfaconverter/) プラグインを使用して PDF 文書の PDF/A 準拠性を検証するオプションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [PdfAValidateOptions](pdfavalidateoptions/)() | デフォルトコンストラクタです。 |
