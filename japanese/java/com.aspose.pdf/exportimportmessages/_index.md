...
description: "フォームフィールドのエクスポートおよびインポート操作に関するさまざまなエラーメッセージを含みます。"
type: docs
weight: 1330
url: /ja/java/com.aspose.pdf/exportimportmessages/
---
**Inheritance:**
...
フォームフィールドのエクスポートおよびインポート操作に関するさまざまなエラーメッセージを含みます。
