...
description: "論理構造内の Paragraph 構造要素を表します。"
type: docs
weight: 370
url: /ja/python-net/aspose.pdf.logicalstructure/paragraphelement/
---

## ParagraphElement class

論理構造内の Paragraph 構造要素を表します。

ParagraphElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
