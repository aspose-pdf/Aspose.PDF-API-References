...
description: "論理構造内の NonStruct 構造要素を表します。"
type: docs
weight: 340
url: /ja/python-net/aspose.pdf.logicalstructure/nonstructelement/
---

## NonStructElement class

論理構造内の NonStruct 構造要素を表します。

NonStructElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
