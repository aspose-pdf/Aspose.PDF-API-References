...
description: "論理構造内のグループ化構造要素の基底クラスを表します。"
type: docs
weight: 200
url: /ja/python-net/aspose.pdf.logicalstructure/groupingelement/
---

## GroupingElement class

論理構造内のグループ化構造要素の基底クラスを表します。

GroupingElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
