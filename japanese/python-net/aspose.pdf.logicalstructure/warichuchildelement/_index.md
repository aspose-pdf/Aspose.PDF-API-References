...
description: "論理構造における Warichu の子要素の基底クラスを表します。"
type: docs
weight: 690
url: /ja/python-net/aspose.pdf.logicalstructure/warichuchildelement/
---

## WarichuChildElement class

論理構造における Warichu の子要素の基底クラスを表します。

WarichuChildElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
