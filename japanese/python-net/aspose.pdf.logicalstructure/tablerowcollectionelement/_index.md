...
description: "論理構造における Table Head、Body、Foot の子要素の基底クラスを表します。"
type: docs
weight: 620
url: /ja/python-net/aspose.pdf.logicalstructure/tablerowcollectionelement/
---

## TableRowCollectionElement class

論理構造における Table Head、Body、Foot の子要素の基底クラスを表します。

TableRowCollectionElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
...
| create_tr() | [TableTRElement](/pdf/python-net/aspose.pdf.logicalstructure/tabletrelement/) を作成し、現在のテーブルに追加しました。 |
