...
description: "論理構造内の List の子要素の基底クラスを表します。"
type: docs
weight: 280
url: /ja/python-net/aspose.pdf.logicalstructure/listchildelement/
---

## ListChildElement class

論理構造内の List の子要素の基底クラスを表します。

ListChildElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
