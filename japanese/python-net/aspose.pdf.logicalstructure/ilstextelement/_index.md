...
description: "論理構造内のインラインレベルテキスト構造要素の基底クラスを表します。"
type: docs
weight: 230
url: /ja/python-net/aspose.pdf.logicalstructure/ilstextelement/
---

## ILSTextElement class

論理構造内のインラインレベルテキスト構造要素の基底クラスを表します。

ILSTextElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
