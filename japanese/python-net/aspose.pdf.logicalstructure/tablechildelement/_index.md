...
description: "論理構造における Table の子要素の基底クラスを表します。"
type: docs
weight: 600
url: /ja/python-net/aspose.pdf.logicalstructure/tablechildelement/
---

## TableChildElement class

論理構造における Table の子要素の基底クラスを表します。

TableChildElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
