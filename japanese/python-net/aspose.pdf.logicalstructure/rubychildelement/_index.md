...
description: "論理構造における Ruby の子要素の基底クラスを表します。"
type: docs
weight: 420
url: /ja/python-net/aspose.pdf.logicalstructure/rubychildelement/
---

## RubyChildElement class

論理構造における Ruby の子要素の基底クラスを表します。

RubyChildElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
