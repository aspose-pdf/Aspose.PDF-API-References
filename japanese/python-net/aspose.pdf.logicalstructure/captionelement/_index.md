...
description: "論理構造における Caption 構造要素を表します。"
type: docs
weight: 110
url: /ja/python-net/aspose.pdf.logicalstructure/captionelement/
---

## CaptionElement class

論理構造における Caption 構造要素を表します。

CaptionElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
