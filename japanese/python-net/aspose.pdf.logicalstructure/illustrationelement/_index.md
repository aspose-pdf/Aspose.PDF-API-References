...
description: "論理構造内の illustration 構造要素の基底クラスを表します。"
type: docs
weight: 250
url: /ja/python-net/aspose.pdf.logicalstructure/illustrationelement/
---

## IllustrationElement class

論理構造内の illustration 構造要素の基底クラスを表します。

IllustrationElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | 親要素を取得します。 |
| child_elements | 子要素のコレクションを取得します |
...
| 名前 | 説明 |
| :- | :- |
| set_image(image_src, image_resolution) | 画像を現在の illustration 要素に追加します。 |
| set_image(image_src, image_width, image_height) | 画像を現在の illustration 要素に追加します。 |
| append_child(element) | 追加 |
