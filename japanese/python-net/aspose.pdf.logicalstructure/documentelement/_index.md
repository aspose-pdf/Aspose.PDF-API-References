...
description: "論理構造における Document 構造要素を表します。"
type: docs
weight: 140
url: /ja/python-net/aspose.pdf.logicalstructure/documentelement/
---

## DocumentElement class

論理構造における Document 構造要素を表します。

DocumentElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
