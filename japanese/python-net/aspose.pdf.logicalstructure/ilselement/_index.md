...
description: "論理構造内のインラインレベル構造要素の基底クラスを表します。"
type: docs
weight: 220
url: /ja/python-net/aspose.pdf.logicalstructure/ilselement/
---

## ILSElement class

論理構造内のインラインレベル構造要素の基底クラスを表します。

ILSElement 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
