...
description: "論理構造内の Reference 構造要素を表します。"
type: docs
weight: 410
url: /ja/python-net/aspose.pdf.logicalstructure/referenceelement/
---

## ReferenceElement class

論理構造内の Reference 構造要素を表します。

ReferenceElement 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
| parent_element | None |
