...
description: "テキストボックスフィールドを表すクラスです。"
type: docs
weight: 280
url: /ja/python-net/aspose.pdf.forms/textboxfield/
---

## TextBoxField class

テキストボックスフィールドを表すクラスです。

TextBoxField 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| TextBoxField(doc) | TextBoxField クラスの新しいインスタンスを初期化します |
| TextBoxField() | TextBoxField のインスタンスを作成します。 |
| TextBoxField(page, rect) | TextBoxField クラスの新しいインスタンスを初期化します |
| TextBoxField(doc, rect) | TextBoxField クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
