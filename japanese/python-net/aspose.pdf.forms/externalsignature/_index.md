...
description: "X509Certificate2 を使用して分離型 PKCS#7Detached 署名を作成します。エクスポート可能なプライベートキーを持たない USB スマートカードやトークンをサポートします。"
type: docs
weight: 80
url: /ja/python-net/aspose.pdf.forms/externalsignature/
---

## ExternalSignature class

X509Certificate2 を使用して分離型 PKCS#7Detached 署名を作成します。エクスポート可能なプライベートキーを持たない USB スマートカードやトークンをサポートします。

ExternalSignature 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
