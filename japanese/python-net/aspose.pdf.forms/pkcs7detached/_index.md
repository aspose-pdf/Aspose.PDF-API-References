...
description: "インターネット RFC 2315 の PKCS#7 仕様に準拠した PKCS#7 オブジェクトを表します。<br/>            PKCS #7: 暗号メッセージ構文、バージョン 1.5。<br/>            文書のバイト範囲に対する元の署名メッセージダイジェストが通常の PKCS#7 SignedData フィールドとして組み込まれます。<br/>            PKCS#7 SignedData フィールドにはデータがカプセル化されません。"
type: docs
weight: 200
url: /ja/python-net/aspose.pdf.forms/pkcs7detached/
---

## PKCS7Detached class

インターネット RFC 2315 の PKCS#7 仕様に準拠した PKCS#7 オブジェクトを表します。<br/>            PKCS #7: 暗号メッセージ構文、バージョン 1.5。<br/>            文書のバイト範囲に対する元の署名メッセージダイジェストが通常の PKCS#7 SignedData フィールドとして組み込まれます。<br/>            PKCS#7 SignedData フィールドにはデータがカプセル化されません。

PKCS7Detached 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| PKCS7Detached(image) | PKCS7Detached クラスの新しいインスタンスを初期化します |
| PKCS7Detached() | [PKCS7Detached](/pdf/python-net/aspose.pdf.forms/pkcs7detached/) クラスの新しいインスタンスを初期化します。 |
| PKCS7Detached(pfx, password) | PKCS7Detached クラスの新しいインスタンスを初期化します |
| PKCS7Detached(pfx, password) | PKCS7Detached クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
