...
description: "PDF 文書内の署名オブジェクトを表す抽象クラスです。<br/>            署名は署名オブジェクトの値を持つフィールドで、最後のものは文書の有効性を検証するために使用されるデータを含みます。"
type: docs
weight: 250
url: /ja/python-net/aspose.pdf.forms/signature/
---

## Signature class

PDF 文書内の署名オブジェクトを表す抽象クラスです。<br/>            署名は署名オブジェクトの値を持つフィールドで、最後のものは文書の有効性を検証するために使用されるデータを含みます。

Signature 型は次のメンバーを公開します:
## プロパティ
| 名前 | 説明 |
| :- | :- |
