...
type: docs
weight: 20
url: /ja/python-net/aspose.pdf.forms/buttonfield/
---
...
ButtonField 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| ButtonField() | Generator 用のボタン フィールド コンストラクタ。 |
| ButtonField(page, rect) | ButtonField クラスの新しいインスタンスを初期化します |
| ButtonField(doc, rect) | ButtonField クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| normal_caption | 通常のキャプションを取得または設定します。 |
| rollover_caption | ユーザーがマウスボタンを押さずにカーソルを <br/>            アクティブ領域に移動したときに表示されるボタンのロールオーバーキャプションを取得または設定します。 |
| alternate_caption | ボタンの代替キャプションを取得または設定します。<br/>            アクティブ領域内でマウスボタンが押されたときに表示されます。 |
| normal_icon | ユーザーと対話していないときに表示されるボタンの通常アイコンを取得または設定します。 |
| rollover_icon | ユーザーがマウスボタンを押さずにカーソルを <br/>            アクティブ領域に移動したときに表示されるボタンのロールオーバーアイコンを取得または設定します。 |
| alternate_icon | アクティブ領域内でマウスボタンが押されたときに表示される代替アイコンを取得または設定します。 |
| icon_fit | ウィジェット注釈のアイコンが注釈矩形内でどのように表示されるかを指定する icon fit オブジェクトを取得します。 |
| ic_position | アイコンキャプションの位置を取得または設定します。 |
## Indexer
| 名前 | 説明 |
| :- | :- |
