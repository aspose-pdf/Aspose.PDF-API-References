...
description: "フォームのコンボボックスフィールドを表すクラスです。"
type: docs
weight: 50
url: /ja/python-net/aspose.pdf.forms/comboboxfield/
---

## ComboBoxField class

フォームのコンボボックスフィールドを表すクラスです。

The ComboBoxField 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| ComboBoxField() | Generator で使用するための ComboBoxField のコンストラクタです。 |
| ComboBoxField(doc) | ComboBoxField クラスの新しいインスタンスを初期化します |
| ComboBoxField(page, rect) | ComboBoxField クラスの新しいインスタンスを初期化します |
| ComboBoxField(doc, rect) | ComboBoxField クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| editable | フィールドの編集可能ステータスを取得または設定します。 |
| spell_check | スペルチェック アクティビティのステータスを取得または設定します。 |
## Indexer
| 名前 | 説明 |
| :- | :- |
