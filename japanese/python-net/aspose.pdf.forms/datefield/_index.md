...
description: "カレンダー表示付きの日付フィールド。"
type: docs
weight: 60
url: /ja/python-net/aspose.pdf.forms/datefield/
---
...
DateField 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| DateField() | 新しい [DateField](/pdf/python-net/aspose.pdf.forms/datefield/) のインスタンスを初期化します |
| DateField(doc) | DateField クラスの新しいインスタンスを初期化します |
| DateField(page, rect) | DateField クラスの新しいインスタンスを初期化します |
| DateField(doc, rect) | DateField クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| 名前 | 説明 |
| :- | :- |
| add_image(image) | このフィールドへの画像追加は許可されていません。 |
| add_image(image) | このフィールドへの画像追加は許可されていません。 |
| clone() | None |
