...
description: "RadioButton フィールドの項目を表すクラスです。"
type: docs
weight: 230
url: /ja/python-net/aspose.pdf.forms/radiobuttonoptionfield/
---
...
RadioButtonOptionField 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| RadioButtonOptionField() | 新しい RadioButtonOptionField インスタンスを作成します。 |
| RadioButtonOptionField(page, rect) | RadioButtonOptionField クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| option_name | オプションの名前を取得または設定します。 |
