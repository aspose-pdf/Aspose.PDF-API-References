...
description: "PDF テキストのフラグメントを表します。"
type: docs
weight: 390
url: /ja/python-net/aspose.pdf.text/textfragment/
---
...
TextFragment 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| TextFragment() | 新しい [TextFragment](/pdf/python-net/aspose.pdf.text/textfragment/) オブジェクトのインスタンスを初期化します。 |
| TextFragment(tab_stops) | TextFragment クラスの新しいインスタンスを初期化します |
| TextFragment(text) | TextFragment クラスの新しいインスタンスを初期化します |
| TextFragment(text, tab_stops) | TextFragment クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| clone_with_segments() | すべてのセグメントを含むフラグメントをクローンします。 |
