...
description: "線幅を設定する w 演算子を表すクラス。"
type: docs
weight: 660
url: /ja/python-net/aspose.pdf.operators/setlinewidth/
---
...
SetLineWidth 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| SetLineWidth(width) | SetLineWidth クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
| index | ページの演算子リストにおける演算子インデックス。 |
| width | 線の幅を取得または設定します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
