...
description: "B 演算子を表すクラス（非ゼロ巻き数規則でパスを塗りつぶしとストローク）。"
type: docs
weight: 290
url: /ja/python-net/aspose.pdf.operators/fillstroke/
---

## FillStroke class

B 演算子を表すクラス（非ゼロ巻き数規則でパスを塗りつぶしとストローク）。

FillStroke 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| FillStroke() | 演算子を初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
