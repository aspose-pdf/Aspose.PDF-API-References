...
description: "ストローク操作の色を設定する CS 演算子を表すクラス。"
type: docs
weight: 560
url: /ja/python-net/aspose.pdf.operators/setcolorspacestroke/
---

## SetColorSpaceStroke class

ストローク操作の色を設定する CS 演算子を表すクラス。

SetColorSpaceStroke 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| SetColorSpaceStroke(name) | SetColorSpaceStroke クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
| index | ページの演算子リストにおける演算子インデックス。 |
| name | カラースペース名を取得または設定します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
