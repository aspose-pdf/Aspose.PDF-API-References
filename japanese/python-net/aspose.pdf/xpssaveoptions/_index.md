...
type: docs
weight: 1810
url: /ja/python-net/aspose.pdf/xpssaveoptions/
---
...
XpsSaveOptions 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| XpsSaveOptions() | XpsSaveOptions クラスの新しいインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| save_transparent_texts | 透明な（OCR された）テキストを保持するかどうかを示します。 |
