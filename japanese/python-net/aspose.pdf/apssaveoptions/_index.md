...
description: "APS XML 形式へのエクスポート用の保存オプション。"
type: docs
weight: 20
url: /ja/python-net/aspose.pdf/apssaveoptions/
---

## ApsSaveOptions class

APS XML 形式へのエクスポート用の保存オプション。

ApsSaveOptions 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| ApsSaveOptions() | ApsSaveOptions クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
