...
description: "TeX 形式へのエクスポート用保存オプション"
type: docs
weight: 1540
url: /ja/python-net/aspose.pdf/texsaveoptions/
---
...
TeXSaveOptions 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| TeXSaveOptions() | TeXSaveOptions クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
