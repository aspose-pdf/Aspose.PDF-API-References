...
description: ".mht ファイルを PDF ドキュメントに読み込み/インポートするためのオプションを表します。"
type: docs
weight: 950
url: /ja/python-net/aspose.pdf/mhtloadoptions/
---

## MhtLoadOptions class

.mht ファイルを PDF ドキュメントに読み込み/インポートするためのオプションを表します。

MhtLoadOptions 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| MhtLoadOptions() | MhtLoadOptions クラスの新しいインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
