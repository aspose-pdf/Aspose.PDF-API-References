...
description: "Classは背景アーティファクトを記述します。このアーティファクトはページの背景を設定できるようにします。"
type: docs
weight: 50
url: /ja/python-net/aspose.pdf/backgroundartifact/
---

## BackgroundArtifact class

Classは背景アーティファクトを記述します。このアーティファクトはページの背景を設定できるようにします。

BackgroundArtifact 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| BackgroundArtifact() | BackgroundArtifact オブジェクトを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| background_color | 背景アーティファクトの bacground カラーを取得または設定します |
| background_image | 背景アーティファクトの bacground 画像を取得または設定します |
## メソッド
| 名前 | 説明 |
| :- | :- |
