...
description: "PdfXml 形式の保存オプションです。"
type: docs
weight: 1260
url: /ja/python-net/aspose.pdf/pdfxmlsaveoptions/
---
...
PdfXmlSaveOptions 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| PdfXmlSaveOptions() | PdfXmlSaveOptions クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
