...
description: "Classは APS のロードオプションを説明します。"
type: docs
weight: 10
url: /ja/python-net/aspose.pdf/apsloadoptions/
---

## ApsLoadOptions class

Classは APS のロードオプションを説明します。

ApsLoadOptions 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| ApsLoadOptions() | ApsLoadOptions クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
