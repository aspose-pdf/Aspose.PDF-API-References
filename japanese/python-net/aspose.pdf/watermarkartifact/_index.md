...
description: "クラスは透かしアーティファクトを記述します。これは次のように使用できます。"
type: docs
weight: 1640
url: /ja/python-net/aspose.pdf/watermarkartifact/
---

## WatermarkArtifact class

クラスは透かしアーティファクトを記述します。これは次のように使用できます。

WatermarkArtifact 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| WatermarkArtifact() | Watermark アーティファクトのインスタンスを作成します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
