...
description: "Classは PDF アーティファクト オブジェクトを表します。"
type: docs
weight: 30
url: /ja/python-net/aspose.pdf/artifact/
---

## Artifact class

Classは PDF アーティファクト オブジェクトを表します。

Artifact 型は以下のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| Artifact(type, sub_type) | Artifact クラスの新しいインスタンスを初期化します |
| Artifact(type, sub_type) | Artifact クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
