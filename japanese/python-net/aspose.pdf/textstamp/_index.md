...
type: docs
weight: 1550
url: /ja/python-net/aspose.pdf/textstamp/
---
...
TextStamp 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| TextStamp(value) | TextStamp クラスの新しいインスタンスを初期化します |
| TextStamp(value, text_state) | TextStamp クラスの新しいインスタンスを初期化します |
| TextStamp(formatted_text) | TextStamp クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
