...
type: docs
weight: 690
url: /ja/python-net/aspose.pdf/imagestamp/
---
...
ImageStamp 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| ImageStamp(image) | ImageStamp クラスの新しいインスタンスを初期化します |
| ImageStamp(file_name) | ImageStamp クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| width | 画像の幅を取得または設定します。このプロパティを設定すると、画像を水平方向にスケールできます。 |
| height | 画像の高さを取得または設定します。このプロパティを設定すると、画像を垂直方向にスケールできます。 |
...
| image | スタンプに使用される画像ストリームを取得します。 |
| quality | 画像スタンプの品質をパーセンテージで取得または設定します。有効な値は 0..100% です。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
| put(page) | ページにグラフィックスタンプを追加します。 |
