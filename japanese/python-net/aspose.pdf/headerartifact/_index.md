...
description: "クラスはヘッダーアーティファクトを記述します。これはページのヘッディングを設定するために使用できます。"
type: docs
weight: 440
url: /ja/python-net/aspose.pdf/headerartifact/
---

## HeaderArtifact class

クラスはヘッダーアーティファクトを記述します。これはページのヘッディングを設定するために使用できます。

HeaderArtifact 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| HeaderArtifact() | Header Artifact のインスタンスを作成します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
