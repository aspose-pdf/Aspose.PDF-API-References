...
description: "線アノテーションを表すクラスです。"
type: docs
weight: 380
url: /ja/python-net/aspose.pdf.annotations/lineannotation/
---
...
LineAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| LineAnnotation(document, start, end) | LineAnnotation クラスの新しいインスタンスを初期化します。 |
| LineAnnotation(page, rect, start, end) | LineAnnotation クラスの新しいインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| 開始 | 線の開始点を取得または設定します。 |
| starting_style | 線の開始点に対する終端スタイルを取得または設定します。 |
| 終了 | 線の終了点を取得または設定します。 |
| ending_style | 線の終了点に対する終端スタイルを取得または設定します。 |
| interior_color | 注釈の内部色を取得または設定します。 |
| リーダーライン | リーダーラインの長さを取得または設定します。 |
| リーダーライン拡張 | リーダーライン拡張の長さを取得または設定します。 |
| show_caption | コンテンツをキャプションとして表示するかどうかを決定するブールフラグを取得または設定します。 |
| leader_line_offset | リーダーラインのオフセットを取得または設定します。 |
| caption_offset | キャプションテキストの通常位置からのオフセットを取得または設定します。 |
| caption_position | 注釈キャプションの位置を取得または設定します。 |
| measure | このアノテーションに指定された測定単位です。 |
| intent | ライン注釈の意図を取得または設定します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
| clone() | None |
| get_rectangle(consider_rotation) | ページの回転を考慮した注釈の矩形を返します。 |
| accept(visitor) | 注釈処理のビジターを受け入れます。 |
| flatten() | 注釈内容をページに直接配置します、<br/>            注釈オブジェクトは削除されます。 |
| change_after_resize(transform) | 行列変換に従って開始点と終了点を更新します。 |
