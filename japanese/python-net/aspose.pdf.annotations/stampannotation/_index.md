...
description: "ゴム印アノテーションを表します。 <br/>             このタイプのアノテーションは、ページにゴム印で押されたかのように見えるテキストまたはグラフィックを表示します。"
type: docs
weight: 790
url: /ja/python-net/aspose.pdf.annotations/stampannotation/
---

## StampAnnotation class

ゴム印アノテーションを表します。 <br/>             このタイプのアノテーションは、ページにゴム印で押されたかのように見えるテキストまたはグラフィックを表示します。

StampAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| StampAnnotation(document) | StampAnnotation クラスの新しいインスタンスを初期化します |
| StampAnnotation(page, rect) | StampAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| icon | ゴムスタンプのアイコンを取得または設定します。 |
| image | 注釈の画像を取得または設定します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
| clone() | None |
| get_rectangle(consider_rotation) | ページの回転を考慮した注釈の矩形を返します。 |
| accept(visitor) | 注釈コレクションを閲覧するときに、[AnnotationSelector](/pdf/python-net/aspose.pdf.annotations/annotationselector/) ビジターを受け入れます。 |
