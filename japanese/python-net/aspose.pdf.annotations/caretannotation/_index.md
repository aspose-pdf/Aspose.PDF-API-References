...
description: "Caret アノテーションを表すクラスです。"
type: docs
weight: 80
url: /ja/python-net/aspose.pdf.annotations/caretannotation/
---

## CaretAnnotation class

Caret アノテーションを表すクラスです。

CaretAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| CaretAnnotation(document) | CaretAnnotation クラスの新しいインスタンスを初期化します |
| CaretAnnotation(page, rect) | CaretAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| frame | キャレット矩形を取得または設定します。 |
| symbol | キャレットに関連付けられたシンボルを取得または設定します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
| clone() | None |
