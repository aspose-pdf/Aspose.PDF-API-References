...
description: "ポップアップウィンドウにテキストを表示し、入力および編集が可能なポップアップアノテーションを表します。"
type: docs
weight: 670
url: /ja/python-net/aspose.pdf.annotations/popupannotation/
---

## PopupAnnotation class

ポップアップウィンドウにテキストを表示し、入力および編集が可能なポップアップアノテーションを表します。

PopupAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| PopupAnnotation(document) | PopupAnnotation クラスの新しいインスタンスを初期化します |
| PopupAnnotation(page, rect) | PopupAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| open | ポップアップ注釈が最初に開いた状態で表示されるかどうかを指定するフラグを取得または設定します。 |
| parent | このポップアップ注釈が関連付けられる親注釈を取得または設定します。<br/>            このエントリが存在する場合、親注釈の Contents、M、C、T エントリはポップアップ注釈自体のそれらを上書きします。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
