...
description: "文書のテキストに取り消し線として表示されるストライクアウトアノテーションを表します。"
type: docs
weight: 800
url: /ja/python-net/aspose.pdf.annotations/strikeoutannotation/
---

## StrikeOutAnnotation class

文書のテキストに取り消し線として表示されるストライクアウトアノテーションを表します。

StrikeOutAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| StrikeOutAnnotation(page, rect) | StrikeOutAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
