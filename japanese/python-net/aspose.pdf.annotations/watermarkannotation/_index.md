...
description: "Watermark アノテーションオブジェクトを記述するクラスです。"
type: docs
weight: 860
url: /ja/python-net/aspose.pdf.annotations/watermarkannotation/
---

## WatermarkAnnotation class

Watermark アノテーションオブジェクトを記述するクラスです。

WatermarkAnnotation 型は次のメンバーを公開します:
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| WatermarkAnnotation(page, rect) | WatermarkAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| flags | 注釈のフラグ。 |
| annotation_type | アノテーションのタイプを取得します。 |
