...
description: "共通図形アノテーションを表す抽象クラスです。"
type: docs
weight: 110
url: /ja/python-net/aspose.pdf.annotations/commonfigureannotation/
---

## CommonFigureAnnotation class

共通図形アノテーションを表す抽象クラスです。

CommonFigureAnnotation 型は次のメンバーを公開します：
## プロパティ
| 名前 | 説明 |
| :- | :- |
