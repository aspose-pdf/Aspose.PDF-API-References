...
description: "コンピュータのマイクで録音した音声またはファイルからインポートした音声を含むサウンドアノテーションを表します。"
type: docs
weight: 740
url: /ja/python-net/aspose.pdf.annotations/soundannotation/
---

## SoundAnnotation class

コンピュータのマイクで録音した音声またはファイルからインポートした音声を含むサウンドアノテーションを表します。

SoundAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| SoundAnnotation(page, rect, sound_file) | SoundAnnotation クラスの新しいインスタンスを初期化します |
| SoundAnnotation(page, rect, sound_file, sound_sample_data) | SoundAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
...
| icon | 注釈の表示に使用されるアイコンを取得または設定します。 |
| sound_data | アノテーションが有効化されたときに再生されるサウンドを定義するサウンドオブジェクトを取得します。 |
## メソッド
| 名前 | 説明 |
| :- | :- |
| clone() | None |
