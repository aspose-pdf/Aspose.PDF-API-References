...
description: "文書のテキストにジグザグの下線として表示されるスキギィアノテーションを表します。"
type: docs
weight: 780
url: /ja/python-net/aspose.pdf.annotations/squigglyannotation/
---

## SquigglyAnnotation class

文書のテキストにジグザグの下線として表示されるスキギィアノテーションを表します。

SquigglyAnnotation 型は次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| SquigglyAnnotation(page, rect) | SquigglyAnnotation クラスの新しいインスタンスを初期化します。 |
## プロパティ
| 名前 | 説明 |
| :- | :- |
