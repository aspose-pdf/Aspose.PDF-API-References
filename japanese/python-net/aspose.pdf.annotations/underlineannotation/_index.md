...
description: "文書のテキストに下線として表示されるアンダーラインアノテーションを表します。"
type: docs
weight: 850
url: /ja/python-net/aspose.pdf.annotations/underlineannotation/
---

## UnderlineAnnotation class

文書のテキストに下線として表示されるアンダーラインアノテーションを表します。

UnderlineAnnotation タイプは次のメンバーを公開します：
## コンストラクター
| 名前 | 説明 |
| :- | :- |
| UnderlineAnnotation(page, rect) | UnderlineAnnotation クラスの新しいインスタンスを初期化します |
## プロパティ
| 名前 | 説明 |
| :- | :- |
