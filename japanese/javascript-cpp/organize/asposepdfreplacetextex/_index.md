...
description: "PDFファイル内の複数のテキストフラグメントを配置制御で置換します。"
type: docs
url: /ja/javascript-cpp/organize/asposepdfreplacetextex/
---

_PDFファイル内の複数のテキストフラグメントを配置制御付きで置換する。_
...
`replaceText` の前に付けることで、方向を明示的に強制することもできます。
特別なUnicode文字で:
