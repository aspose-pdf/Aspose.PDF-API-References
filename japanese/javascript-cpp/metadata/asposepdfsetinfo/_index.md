...
type: docs
url: /ja/javascript-cpp/metadata/asposepdfsetinfo/
---

_PDFファイルに情報（メタデータ）を設定します。_
...
「title」「creator」「author」「subject」「keywords」「creation」「mod」の各項目で値を設定する必要がない場合は、undefined または ""（空文字列）を使用してください。
